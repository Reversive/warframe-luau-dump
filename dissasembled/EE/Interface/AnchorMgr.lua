...
main <?:0,0> (8 instructions, 32 bytes at 00000160D831A0B0)
...
function #1 <?:4,360> (66 instructions, 264 bytes at 00000160D831A1A0)
2 params, 6 slots, 0 upvalues, 0 locals, 38 constants, 11 functions
	...
	15	[15]	SETTABLE 	R2 K17 R3 ; R2[0x00000001] := R3
	...
	52	[221]	SETTABLE 	R2 K32 R4 ; R2["GetOriginalCoords"] := R4
