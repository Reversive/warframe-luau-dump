...
main <?:0,0> (3 instructions, 12 bytes at 0000016084D5AD70)
...
function #1 <?:6,73> (190 instructions, 760 bytes at 0000016084D5AE60)
1 param, 30 slots, 0 upvalues, 0 locals, 40 constants, 0 functions
	...
	5	[8]	SETTABLE 	R1 K2 R0 ; R1["TrackedGameplayPickup"] := R0
