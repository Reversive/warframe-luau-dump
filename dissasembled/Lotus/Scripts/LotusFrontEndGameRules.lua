...
main <?:0,0> (33 instructions, 132 bytes at 0000016098C82660)
...
function #1 <?:4,5> (1 instruction, 4 bytes at 0000016098C82A00)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[5]	RETURN   	R0 1 ; return 

function #2 <?:7,8> (1 instruction, 4 bytes at 0000016098C82AD0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[8]	RETURN   	R0 1 ; return 

function #3 <?:10,11> (1 instruction, 4 bytes at 0000016098C82BA0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[11]	RETURN   	R0 1 ; return 

function #4 <?:16,18> (1 instruction, 4 bytes at 0000016098C82C70)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[18]	RETURN   	R0 1 ; return 

function #5 <?:25,27> (1 instruction, 4 bytes at 0000016098C82D40)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[27]	RETURN   	R0 1 ; return 

function #6 <?:32,63> (112 instructions, 448 bytes at 0000016098C82E10)
...
function #7 <?:67,68> (1 instruction, 4 bytes at 0000016098C83040)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[68]	RETURN   	R0 1 ; return 

function #8 <?:70,71> (1 instruction, 4 bytes at 0000016098C83110)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[71]	RETURN   	R0 1 ; return 

function #9 <?:76,77> (1 instruction, 4 bytes at 0000016098C831E0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[77]	RETURN   	R0 1 ; return 

function #10 <?:82,84> (1 instruction, 4 bytes at 0000016098C832B0)
5 params, 5 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[84]	RETURN   	R0 1 ; return 

function #11 <?:89,91> (1 instruction, 4 bytes at 0000016098C83380)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[91]	RETURN   	R0 1 ; return 

function #12 <?:96,97> (1 instruction, 4 bytes at 0000016098C83450)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[97]	RETURN   	R0 1 ; return 

function #13 <?:99,100> (1 instruction, 4 bytes at 0000016098C83520)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
