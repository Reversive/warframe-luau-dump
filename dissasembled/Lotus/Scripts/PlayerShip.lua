...
main <?:0,0> (211 instructions, 844 bytes at 0000016084D50D80)
...
function #1 <?:139,198> (147 instructions, 588 bytes at 0000016084D539E0)
...
function #2 <?:200,254> (234 instructions, 936 bytes at 00000160950401F0)
...
function #3 <?:256,269> (35 instructions, 140 bytes at 0000016084D53AC0)
...
function #4 <?:271,279> (16 instructions, 64 bytes at 0000016084D53B50)
...
function #5 <?:281,285> (7 instructions, 28 bytes at 0000016084D53CD0)
...
function #6 <?:287,295> (21 instructions, 84 bytes at 0000016084D53D60)
...
function #7 <?:297,327> (55 instructions, 220 bytes at 0000016084D53F30)
...
function #8 <?:329,346> (37 instructions, 148 bytes at 0000016084D540B0)
...
function #9 <?:348,400> (100 instructions, 400 bytes at 0000016084D541F0)
...
function #10 <?:402,410> (24 instructions, 96 bytes at 0000016084D54410)
...
function #11 <?:412,529> (321 instructions, 1284 bytes at 0000016084D54610)
...
function #12 <?:531,533> (6 instructions, 24 bytes at 0000016084D54700)
...
function #13 <?:535,537> (6 instructions, 24 bytes at 0000016084D54790)
1 param, 5 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #14 <?:539,541> (6 instructions, 24 bytes at 0000016084D54820)
1 param, 5 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #15 <?:543,565> (48 instructions, 192 bytes at 0000016084D548B0)
...
function #16 <?:567,570> (3 instructions, 12 bytes at 0000016084D54B70)
...
function #17 <?:572,581> (15 instructions, 60 bytes at 0000016084D54C40)
...
function #18 <?:583,661> (185 instructions, 740 bytes at 0000016084D54D20)
...
function #19 <?:663,689> (69 instructions, 276 bytes at 0000016084D54E60)
...
function #20 <?:692,783> (243 instructions, 972 bytes at 0000016084D54EF0)
...
function #21 <?:785,802> (39 instructions, 156 bytes at 0000016084D54F80)
...
function #22 <?:804,814> (28 instructions, 112 bytes at 0000016084D55190)
...
function #23 <?:816,828> (5 instructions, 20 bytes at 0000016084D55220)
...
function #24 <?:830,836> (18 instructions, 72 bytes at 0000016084D552B0)
...
function #25 <?:838,874> (103 instructions, 412 bytes at 0000016084D55480)
...
function #26 <?:876,953> (171 instructions, 684 bytes at 0000016084D556A0)
...
function #27 <?:955,957> (3 instructions, 12 bytes at 0000016084D55730)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[956]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[956]	CALL     	R0 1 1 ; R0()
	3	[957]	RETURN   	R0 1 ; return 

function #28 <?:959,997> (19 instructions, 76 bytes at 0000016084D557E0)
...
function #29 <?:999,1085> (280 instructions, 1120 bytes at 0000016084D559A0)
...
function #30 <?:1087,1089> (3 instructions, 12 bytes at 0000016084D55A30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1088]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1088]	CALL     	R0 1 1 ; R0()
	3	[1089]	RETURN   	R0 1 ; return 

function #31 <?:1091,1093> (3 instructions, 12 bytes at 0000016084D55B00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1092]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1092]	CALL     	R0 1 1 ; R0()
	3	[1093]	RETURN   	R0 1 ; return 

function #32 <?:1095,1439> (915 instructions, 3660 bytes at 0000016084D55BD0)
0 params, 59 slots, 8 upvalues, 0 locals, 145 constants, 0 functions
	...
	603	[1313]	SETTABLE 	R47 K107 R40 ; R47[0x07000010] := R40
...
function #33 <?:1441,1444> (5 instructions, 20 bytes at 0000016084D55EA0)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #34 <?:1446,1448> (3 instructions, 12 bytes at 0000016084D55F30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1447]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1447]	CALL     	R0 1 1 ; R0()
	3	[1448]	RETURN   	R0 1 ; return 

function #35 <?:1451,1469> (37 instructions, 148 bytes at 0000016084D56000)
...
function #36 <?:1471,1485> (24 instructions, 96 bytes at 0000016084D561F0)
...
function #37 <?:1487,1621> (258 instructions, 1032 bytes at 0000016084D563E0)
...
function #38 <?:1623,1629> (8 instructions, 32 bytes at 0000016084D56470)
...
function #39 <?:1631,1641> (21 instructions, 84 bytes at 0000016084D565A0)
...
function #40 <?:1643,1653> (30 instructions, 120 bytes at 0000016084D567F0)
...
function #41 <?:1655,1664> (27 instructions, 108 bytes at 0000016084D569A0)
...
function #42 <?:1666,1672> (24 instructions, 96 bytes at 0000016084D56B30)
...
function #43 <?:1674,1680> (21 instructions, 84 bytes at 0000016084D56D50)
...
function #44 <?:1682,2078> (936 instructions, 3744 bytes at 0000016084D56F50)
...
function #45 <?:2080,2084> (13 instructions, 52 bytes at 0000016084D57270)
...
function #46 <?:2086,2121> (80 instructions, 320 bytes at 0000016084D57400)
1 param, 24 slots, 0 upvalues, 0 locals, 19 constants, 0 functions
	...
	55	[2113]	SETTABLE 	R12 K14 R18 ; R12["heading"] := R18
	...
	62	[2114]	SETTABLE 	R12 K16 R18 ; R12["pitch"] := R18
	...
	69	[2115]	SETTABLE 	R12 K17 R18 ; R12["bank"] := R18
...
function #47 <?:2123,2156> (84 instructions, 336 bytes at 0000016084D574E0)
...
function #48 <?:2158,2179> (51 instructions, 204 bytes at 0000016084D57570)
...
function #49 <?:2181,2201> (20 instructions, 80 bytes at 0000016084D57600)
...
function #50 <?:2203,2392> (504 instructions, 2016 bytes at 0000016084D57A50)
...
function #51 <?:2395,2400> (13 instructions, 52 bytes at 0000016084D57AE0)
...
function #52 <?:2402,2419> (17 instructions, 68 bytes at 0000016084D57C60)
...
function #53 <?:2421,2428> (34 instructions, 136 bytes at 0000016084D57E00)
...
function #54 <?:2430,2522> (319 instructions, 1276 bytes at 0000016084D57FB0)
...
function #55 <?:2524,2551> (59 instructions, 236 bytes at 0000016084D58040)
...
function #56 <?:2553,2573> (42 instructions, 168 bytes at 0000016084D580D0)
...
function #57 <?:2575,2608> (60 instructions, 240 bytes at 0000016084D58160)
...
function #58 <?:2610,2614> (12 instructions, 48 bytes at 0000016084D582C0)
