...
main <?:0,0> (57 instructions, 228 bytes at 00000160E38C4250)
...
function #1 <?:18,28> (25 instructions, 100 bytes at 00000160E3A4A240)
...
function #2 <?:30,42> (36 instructions, 144 bytes at 0000016098C84FD0)
0 params, 3 slots, 1 upvalue, 0 locals, 13 constants, 0 functions
	...
	30	[37]	SETTABLE 	R0 K9 R1 ; R0[0x00000001] := R1
...
function #3 <?:44,59> (36 instructions, 144 bytes at 0000016098CBB860)
...
function #4 <?:61,76> (38 instructions, 152 bytes at 0000016098CBB930)
...
function #5 <?:78,80> (4 instructions, 16 bytes at 0000016098CBB9C0)
...
function #6 <?:82,91> (26 instructions, 104 bytes at 0000016098CBBA90)
...
function #7 <?:93,136> (106 instructions, 424 bytes at 0000016098CBBB60)
...
function #8 <?:138,153> (43 instructions, 172 bytes at 0000016098CBBDC0)
...
function #9 <?:155,206> (135 instructions, 540 bytes at 0000016098CBBE50)
...
function #10 <?:210,212> (4 instructions, 16 bytes at 0000016098CBC0D0)
...
function #11 <?:214,216> (3 instructions, 12 bytes at 0000016098CBC1A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[215]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[215]	CALL     	R0 1 1 ; R0()
	3	[216]	RETURN   	R0 1 ; return 

function #12 <?:218,300> (193 instructions, 772 bytes at 0000016098CBC270)
