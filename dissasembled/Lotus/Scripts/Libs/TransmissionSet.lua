...
main <?:0,0> (117 instructions, 468 bytes at 0000025274F900B0)
...
function #1 <?:11,16> (11 instructions, 44 bytes at 0000025274F90D30)
...
function #2 <?:18,53> (91 instructions, 364 bytes at 0000025274F90EC0)
...
function #3 <?:55,114> (158 instructions, 632 bytes at 0000025274F9C250)
...
function #4 <?:117,142> (56 instructions, 224 bytes at 0000025274F9C9A0)
...
function #5 <?:145,159> (36 instructions, 144 bytes at 0000025274F9CCA0)
...
function #6 <?:162,176> (31 instructions, 124 bytes at 0000025274F9CE90)
...
function #7 <?:179,188> (28 instructions, 112 bytes at 0000025274F9D060)
...
function #8 <?:191,214> (54 instructions, 216 bytes at 0000025274F9D210)
...
function #9 <?:217,232> (45 instructions, 180 bytes at 0000025274F9D4F0)
...
function #10 <?:235,252> (45 instructions, 180 bytes at 0000025274F9D7B0)
...
function #11 <?:254,271> (52 instructions, 208 bytes at 0000025274F9DA40)
...
function #12 <?:273,277> (14 instructions, 56 bytes at 0000025274F9DD00)
...
function #13 <?:279,328> (116 instructions, 464 bytes at 0000025274F9DEB0)
...
function #14 <?:330,332> (10 instructions, 40 bytes at 0000025274F9E4C0)
...
function #15 <?:335,344> (22 instructions, 88 bytes at 0000025274F9E600)
...
function #16 <?:346,407> (129 instructions, 516 bytes at 0000025274F9E7C0)
...
function #17 <?:409,412> (9 instructions, 36 bytes at 0000025274F9EE00)
...
function #18 <?:414,419> (14 instructions, 56 bytes at 0000025274F9EF10)
...
function #19 <?:421,443> (69 instructions, 276 bytes at 0000025274F9F160)
4 params, 10 slots, 1 upvalue, 0 locals, 13 constants, 0 functions
	...
	7	[422]	SETTABLE 	R4 K1 R5 ; 
main <?:0,0> (117 instructions, 468 bytes at 00000160C689E940)
0+ params, 14 slots, 0 upvalues, 0 locals, 29 constants, 24 functions
	1	[1]	GETGLOBAL	R0 K0 ; R0 := 0xaeabecda
	2	[1]	VARARG   	R1 R2 ; R1 := R2 := ...
	3	[1]	GETGLOBAL	R2 K1 ; R2 := package
...
function #1 <?:11,16> (11 instructions, 44 bytes at 00000160C689F5C0)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
	1	[12]	GETGLOBAL	R0 K0 ; R0 := _T
	2	[12]	GETTABLE 	R0 R0 K1 ; R0 := R0["PlayerDead"]
	3	[12]	TEST     	R0 0 ; if not R0 then PC := 11
...
function #2 <?:18,53> (91 instructions, 364 bytes at 00000160C689F750)
2 params, 6 slots, 2 upvalues, 0 locals, 13 constants, 0 functions
	1	[19]	GETUPVAL 	R2 U0 ; R2 := U0
	2	[19]	CALL     	R2 1 2 ; R2 := R2()
	3	[19]	TEST     	R2 0 ; if not R2 then PC := 6
...
function #3 <?:55,114> (158 instructions, 632 bytes at 00000160C689FC10)
6 params, 13 slots, 3 upvalues, 0 locals, 21 constants, 0 functions
	1	[58]	GETGLOBAL	R7 K0 ; R7 := 0x7b998233
	2	[58]	GETGLOBAL	R8 K1 ; R8 := 0xbe190284
	3	[58]	CALL     	R7 2 2 ; R7 := R7(R8)
...
function #4 <?:117,142> (56 instructions, 224 bytes at 00000160C68A00D0)
5 params, 17 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
	1	[118]	LOADK    	R5 := 0.000000
	2	[119]	GETGLOBAL	R6 K0 ; R6 := 0x7b998233
	3	[119]	MOVE     	R7 R0 ; R7 := R0
...
function #5 <?:145,159> (36 instructions, 144 bytes at 00000160C68A9810)
5 params, 12 slots, 5 upvalues, 0 locals, 1 constant, 0 functions
	1	[146]	GETUPVAL 	R5 U0 ; R5 := U0
	2	[146]	CALL     	R5 1 2 ; R5 := R5()
	3	[146]	TEST     	R5 0 ; if not R5 then PC := 6
...
function #6 <?:162,176> (31 instructions, 124 bytes at 00000160C68A9A00)
4 params, 11 slots, 5 upvalues, 0 locals, 1 constant, 0 functions
	1	[163]	GETUPVAL 	R4 U0 ; R4 := U0
	2	[163]	CALL     	R4 1 2 ; R4 := R4()
	3	[163]	TEST     	R4 0 ; if not R4 then PC := 6
...
function #7 <?:179,188> (28 instructions, 112 bytes at 00000160C68A9BD0)
4 params, 12 slots, 3 upvalues, 0 locals, 1 constant, 0 functions
	1	[180]	GETUPVAL 	R4 U0 ; R4 := U0
	2	[180]	CALL     	R4 1 2 ; R4 := R4()
	3	[180]	TEST     	R4 0 ; if not R4 then PC := 6
...
function #8 <?:191,214> (54 instructions, 216 bytes at 00000160C68A9D80)
3 params, 18 slots, 3 upvalues, 0 locals, 6 constants, 0 functions
	1	[192]	GETUPVAL 	R3 U0 ; R3 := U0
	2	[192]	CALL     	R3 1 2 ; R3 := R3()
	3	[192]	TEST     	R3 0 ; if not R3 then PC := 6
...
function #9 <?:217,232> (45 instructions, 180 bytes at 00000160C68AA060)
3 params, 15 slots, 3 upvalues, 0 locals, 8 constants, 0 functions
	1	[218]	GETUPVAL 	R3 U0 ; R3 := U0
	2	[218]	CALL     	R3 1 2 ; R3 := R3()
	3	[218]	TEST     	R3 0 ; if not R3 then PC := 6
...
function #10 <?:235,252> (45 instructions, 180 bytes at 00000160C68AA320)
5 params, 11 slots, 5 upvalues, 0 locals, 5 constants, 0 functions
	1	[236]	GETUPVAL 	R5 U0 ; R5 := U0
	2	[236]	CALL     	R5 1 2 ; R5 := R5()
	3	[236]	TEST     	R5 0 ; if not R5 then PC := 6
...
function #11 <?:254,271> (52 instructions, 208 bytes at 00000160C68AA5B0)
4 params, 11 slots, 3 upvalues, 0 locals, 6 constants, 0 functions
	1	[255]	GETUPVAL 	R4 U0 ; R4 := U0
	2	[255]	CALL     	R4 1 2 ; R4 := R4()
	3	[255]	TEST     	R4 0 ; if not R4 then PC := 6
...
function #12 <?:273,277> (14 instructions, 56 bytes at 00000160C68AA870)
1 param, 3 slots, 0 upvalues, 0 locals, 3 constants, 0 functions
	1	[274]	GETGLOBAL	R1 K0 ; R1 := 0x7b998233
	2	[274]	GETGLOBAL	R2 K1 ; R2 := _T
	3	[274]	GETTABLE 	R2 R2 K2 ; R2 := R2["MissionTransmissionSet"]
...
function #13 <?:279,328> (116 instructions, 464 bytes at 00000160C68AAA20)
5 params, 19 slots, 6 upvalues, 0 locals, 18 constants, 0 functions
	1	[280]	GETUPVAL 	R5 U0 ; R5 := U0
	2	[280]	CALL     	R5 1 2 ; R5 := R5()
	3	[280]	TEST     	R5 0 ; if not R5 then PC := 6
...
function #14 <?:330,332> (10 instructions, 40 bytes at 00000160C68AB030)
4 params, 10 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[331]	GETUPVAL 	R4 U0 ; R4 := U0
	2	[331]	GETGLOBAL	R5 K0 ; R5 := 0x89326c93
	3	[331]	SELF     	R5 R5 K1 ; R6 := R5; R5 := R5[0xfb64e76c]
...
function #15 <?:335,344> (22 instructions, 88 bytes at 00000160C68AB170)
3 params, 14 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
	1	[336]	TEST     	R1 0 ; if not R1 then PC := 7
	2	[336]	JMP      	7 ; PC := 7
	3	[337]	GETUPVAL 	R3 U0 ; R3 := U0
...
function #16 <?:346,407> (129 instructions, 516 bytes at 00000160C68AB330)
4 params, 29 slots, 5 upvalues, 0 locals, 22 constants, 0 functions
	1	[347]	GETUPVAL 	R4 U0 ; R4 := U0
	2	[347]	CALL     	R4 1 2 ; R4 := R4()
	3	[347]	TEST     	R4 0 ; if not R4 then PC := 6
...
function #17 <?:409,412> (9 instructions, 36 bytes at 00000160C68AB970)
2 params, 5 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[410]	GETUPVAL 	R2 U0 ; R2 := U0
	2	[410]	MOVE     	R3 R0 ; R3 := R0
	3	[410]	MOVE     	R4 R1 ; R4 := R1
...
function #18 <?:414,419> (14 instructions, 56 bytes at 00000160C68ABA80)
2 params, 6 slots, 0 upvalues, 0 locals, 7 constants, 0 functions
	1	[415]	GETGLOBAL	R2 K0 ; R2 := _T
	2	[415]	GETTABLE 	R2 R2 K1 ; R2 := R2["InWorldTransmissionsLoading"]
	3	[415]	SETTABLE 	R2 R1 K2 ; R2[R1] := nil
...
function #19 <?:421,443> (69 instructions, 276 bytes at 00000160C68ABCD0)
4 params, 10 slots, 1 upvalue, 0 locals, 13 constants, 0 functions
	1	[422]	GETGLOBAL	R4 K0 ; R4 := _T
	2	[422]	GETGLOBAL	R5 K0 ; R5 := _T
	3	[422]	GETTABLE 	R5 R5 K1 ; R5 := R5["InWorldTransmissionsLoading"]
...
function #20 <?:445,447> (22 instructions, 88 bytes at 00000160C68AC170)
...
function #21 <?:449,451> (4 instructions, 16 bytes at 00000160C68AC3A0)
...
function #22 <?:453,459> (15 instructions, 60 bytes at 00000160C68AC470)
...
function #23 <?:461,463> (7 instructions, 28 bytes at 00000160C68AC5E0)
...
function #24 <?:465,467> (4 instructions, 16 bytes at 00000160C68AC710)
