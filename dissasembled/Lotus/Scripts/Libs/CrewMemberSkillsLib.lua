...
main <?:0,0> (351 instructions, 1404 bytes at 00000160FEA813B0)
...
function #1 <?:6,6> (8 instructions, 32 bytes at 00000160FEA80BB0)
1 param, 5 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
	...
	5	[6]	SETTABLE 	R3 K2 R4 ; R3[0x07000010] := R4
	6	[6]	TAILCALL 	R1 3 0 ; R1,... := R1(R2,R3)
	7	[6]	RETURN   	R1 0 ; return R1,... 
	8	[6]	RETURN   	R0 1 ; return 

function #2 <?:406,427> (44 instructions, 176 bytes at 00000160FD8D0A80)
...
function #3 <?:429,460> (55 instructions, 220 bytes at 00000160FB336330)
...
function #4 <?:462,472> (23 instructions, 92 bytes at 000001608095FF00)
...
function #5 <?:474,537> (171 instructions, 684 bytes at 00000160FFA57A10)
