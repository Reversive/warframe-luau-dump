...
main <?:0,0> (159 instructions, 636 bytes at 00000160FEB4FBE0)
...
function #1 <?:20,25> (13 instructions, 52 bytes at 00000160FEB50D30)
...
function #2 <?:27,43> (37 instructions, 148 bytes at 00000160FEB50EB0)
2 params, 7 slots, 1 upvalue, 0 locals, 18 constants, 0 functions
	...
	17	[34]	SETTABLE 	R2 K12 R3 ; R2[0xbe190284] := R3
...
function #3 <?:45,75> (69 instructions, 276 bytes at 00000160FEB511D0)
...
function #4 <?:77,86> (24 instructions, 96 bytes at 00000160FEB515A0)
...
function #5 <?:88,96> (18 instructions, 72 bytes at 00000160FEB51770)
...
function #6 <?:98,116> (43 instructions, 172 bytes at 00000160FEB518F0)
...
function #7 <?:118,143> (45 instructions, 180 bytes at 00000160FEB51C90)
...
function #8 <?:145,155> (28 instructions, 112 bytes at 00000160FEB51F90)
0 params, 11 slots, 0 upvalues, 0 locals, 12 constants, 0 functions
...
function #9 <?:157,169> (20 instructions, 80 bytes at 000001609594F700)
...
function #10 <?:171,209> (106 instructions, 424 bytes at 000001609594F8B0)
...
function #11 <?:213,234> (55 instructions, 220 bytes at 00000160959500C0)
...
function #12 <?:236,257> (51 instructions, 204 bytes at 0000016095950490)
...
function #13 <?:259,263> (16 instructions, 64 bytes at 0000016095950880)
...
function #14 <?:265,272> (24 instructions, 96 bytes at 00000160959509F0)
...
function #15 <?:274,297> (66 instructions, 264 bytes at 0000016095950BE0)
...
function #16 <?:299,330> (85 instructions, 340 bytes at 0000016095951190)
...
function #17 <?:332,358> (65 instructions, 260 bytes at 00000160959517C0)
1 param, 10 slots, 2 upvalues, 0 locals, 21 constants, 0 functions
	...
	28	[342]	SETTABLE 	R1 K13 R9 ; R1["canProgress"] := R9
	29	[342]	SETTABLE 	R1 K12 R8 ; R1[0x00800011] := R8
	...
	45	[349]	SETTABLE 	R3 K12 R6 ; R3[0x00800011] := R6
	...
	56	[351]	SETTABLE 	R3 K19 R6 ; R3["keyChainName"] := R6
	57	[352]	JMP      	61 ; PC := 61
...
function #18 <?:360,362> (3 instructions, 12 bytes at 0000016095951C60)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[361]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[361]	CALL     	R0 1 1 ; R0()
	3	[362]	RETURN   	R0 1 ; return 

function #19 <?:364,388> (74 instructions, 296 bytes at 0000016095951D30)
...
function #20 <?:390,401> (23 instructions, 92 bytes at 0000016095952230)
...
function #21 <?:403,409> (31 instructions, 124 bytes at 00000160959523F0)
...
function #22 <?:413,415> (6 instructions, 24 bytes at 00000160959526D0)
...
function #23 <?:417,419> (6 instructions, 24 bytes at 00000160959527C0)
2 params, 6 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #24 <?:421,441> (61 instructions, 244 bytes at 00000160959528B0)
...
function #25 <?:443,449> (14 instructions, 56 bytes at 0000016095952C10)
...
function #26 <?:453,462> (42 instructions, 168 bytes at 0000016095952D80)
...
function #27 <?:464,475> (29 instructions, 116 bytes at 0000016095953080)
...
function #28 <?:477,523> (125 instructions, 500 bytes at 0000016095953300)
...
function #29 <?:527,532> (17 instructions, 68 bytes at 0000016095953980)
...
function #30 <?:534,545> (27 instructions, 108 bytes at 0000016095953B20)
...
function #31 <?:547,552> (17 instructions, 68 bytes at 0000016095953D30)
...
function #32 <?:556,558> (4 instructions, 16 bytes at 0000016095953ED0)
...
function #33 <?:562,564> (3 instructions, 12 bytes at 0000016095953FC0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[563]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[563]	CALL     	R0 1 1 ; R0()
	3	[564]	RETURN   	R0 1 ; return 

function #34 <?:566,568> (4 instructions, 16 bytes at 0000016095954090)
...
function #35 <?:572,595> (44 instructions, 176 bytes at 0000016095954160)
...
function #36 <?:597,649> (103 instructions, 412 bytes at 00000160959544B0)
...
function #37 <?:651,686> (103 instructions, 412 bytes at 000001608DB997A0)
...
function #38 <?:688,696> (30 instructions, 120 bytes at 000001608DB99D00)
...
function #39 <?:698,727> (47 instructions, 188 bytes at 000001608DB99F10)
...
function #40 <?:729,741> (38 instructions, 152 bytes at 000001608DB9A460)
...
function #41 <?:743,745> (5 instructions, 20 bytes at 000001608DB9A720)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #42 <?:747,776> (129 instructions, 516 bytes at 000001608DB9A810)
...
function #43 <?:780,991> (583 instructions, 2332 bytes at 000001608DB9AFF0)
7 params, 56 slots, 10 upvalues, 0 locals, 115 constants, 0 functions
	...
	510	[960]	SETTABLE 	R47 K104 R46 ; R47["canRespawn"] := R46
...
function #44 <?:993,1029> (97 instructions, 388 bytes at 000001608DB9D5E0)
...
function #45 <?:1033,1117> (241 instructions, 964 bytes at 000001608DB9DD20)
