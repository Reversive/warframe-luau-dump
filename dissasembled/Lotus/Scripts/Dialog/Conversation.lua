...
main <?:0,0> (144 instructions, 576 bytes at 00000160FAFE7480)
...
function #1 <?:61,63> (2 instructions, 8 bytes at 00000160FAFE7D10)
2 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[62]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[63]	RETURN   	R0 1 ; return 

function #2 <?:65,73> (14 instructions, 56 bytes at 00000160FAFE7DE0)
...
function #3 <?:75,123> (122 instructions, 488 bytes at 00000160FAFE7F90)
...
function #4 <?:125,133> (18 instructions, 72 bytes at 00000160FAFE8070)
...
function #5 <?:135,151> (35 instructions, 140 bytes at 000001608B9AC280)
...
function #6 <?:153,175> (55 instructions, 220 bytes at 000001608B9AC500)
...
function #7 <?:177,226> (105 instructions, 420 bytes at 000001608B9AC8A0)
...
function #8 <?:228,284> (127 instructions, 508 bytes at 000001608B9ACE90)
3 params, 13 slots, 6 upvalues, 0 locals, 32 constants, 0 functions
	...
	57	[252]	SETTABLE 	R5 K17 R1 ; R5["mItemType"] := R1
...
function #9 <?:286,294> (14 instructions, 56 bytes at 000001608B9AD550)
2 params, 4 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #10 <?:296,345> (115 instructions, 460 bytes at 000001608B9AD700)
...
function #11 <?:347,459> (250 instructions, 1000 bytes at 000001608B9ADD50)
8 params, 17 slots, 3 upvalues, 0 locals, 60 constants, 4 functions
	...
	84	[375]	SETTABLE 	R10 K24 R11 ; R10[0x00000001] := R11
	85	[376]	GETTABLE 	R11 R10 K24 ; R11 := R10["Level"]
	86	[376]	ADD      	R11 R11 K27 ; R11 := R11 + 1.000000
	87	[376]	SETTABLE 	R10 K24 R11 ; R10[0x00000001] := R11
	...
	111	[395]	SETTABLE 	R12 K33 R13 ; R12[0x1b8d05fd] := R13
	...
	154	[413]	SETTABLE 	R12 K42 R13 ; R12["MenuOnFocusedCallback"] := R13
	...
	164	[420]	SETTABLE 	R12 K44 R13 ; R12[0xdd25e9d1] := R13
...
function #12 <?:461,462> (1 instruction, 4 bytes at 000001608B9AEF20)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[462]	RETURN   	R0 1 ; return 

function #13 <?:464,628> (136 instructions, 544 bytes at 000001608B9AEFF0)
9 params, 29 slots, 3 upvalues, 0 locals, 35 constants, 7 functions
	...
	58	[522]	SETTABLE 	R17 K23 R2 ; R17[0x7b998233] := R2
	...
	65	[528]	SETTABLE 	R17 K27 R18 ; R17[0x8e7c3b5e] := R18
	66	[529]	SETTABLE 	R15 K22 R17 ; R15[1.000000] := R17
	67	[530]	NEWTABLE 	R17 0 4 ; R17 := {}
	68	[531]	SETTABLE 	R17 K23 R3 ; R17[0x7b998233] := R3
	...
	75	[537]	SETTABLE 	R17 K27 R18 ; R17[0x8e7c3b5e] := R18
	76	[538]	SETTABLE 	R15 K28 R17 ; R15[0x25d99d89] := R17
	77	[539]	NEWTABLE 	R17 0 4 ; R17 := {}
	78	[540]	SETTABLE 	R17 K23 R4 ; R17[0x7b998233] := R4
	...
	85	[546]	SETTABLE 	R17 K27 R18 ; R17[0x8e7c3b5e] := R18
...
function #14 <?:630,632> (2 instructions, 8 bytes at 000001608B9B0880)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[631]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[632]	RETURN   	R0 1 ; return 

function #15 <?:634,643> (16 instructions, 64 bytes at 000001608B9B0950)
...
function #16 <?:645,680> (70 instructions, 280 bytes at 000001608B9B0AD0)
...
function #17 <?:682,704> (47 instructions, 188 bytes at 000001608B9B0C90)
...
function #18 <?:706,730> (62 instructions, 248 bytes at 00000160E3D21480)
...
function #19 <?:732,734> (2 instructions, 8 bytes at 00000160E3D219C0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[733]	SETUPVAL 	R1 U0 ; U0 := R1
	2	[734]	RETURN   	R0 1 ; return 

function #20 <?:736,738> (3 instructions, 12 bytes at 00000160E3D21A90)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[737]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[737]	RETURN   	R1 2 ; return R1 
	3	[738]	RETURN   	R0 1 ; return 

function #21 <?:740,950> (447 instructions, 1788 bytes at 00000160E3D21B60)
...
function #22 <?:952,959> (19 instructions, 76 bytes at 00000160E3D23C20)
...
function #23 <?:961,970> (29 instructions, 116 bytes at 00000160E3D23DA0)
...
function #24 <?:972,976> (28 instructions, 112 bytes at 00000160E3D23FD0)
...
function #25 <?:978,984> (33 instructions, 132 bytes at 00000160E3D241E0)
...
function #26 <?:986,993> (24 instructions, 96 bytes at 00000160E3D24430)
...
function #27 <?:995,1002> (24 instructions, 96 bytes at 00000160E3D24610)
1 param, 6 slots, 0 upvalues, 0 locals, 6 constants, 0 functions
