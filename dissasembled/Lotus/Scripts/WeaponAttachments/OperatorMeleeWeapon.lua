...
main <?:0,0> (310 instructions, 1240 bytes at 000001608FEE1D10)
0+ params, 21 slots, 0 upvalues, 0 locals, 54 constants, 14 functions
	...
	11	[37]	SETTABLE 	R2 K4 R3 ; R2["tag"] := R3
	...
	30	[46]	SETTABLE 	R3 K4 R4 ; R3["tag"] := R4
	...
	44	[51]	SETTABLE 	R4 K4 R5 ; R4["tag"] := R5
	...
	70	[61]	SETTABLE 	R5 K4 R6 ; R5["tag"] := R6
	...
	93	[67]	SETTABLE 	R6 K4 R7 ; R6["tag"] := R7
	...
	112	[76]	SETTABLE 	R7 K4 R8 ; R7["tag"] := R8
	...
	131	[82]	SETTABLE 	R8 K4 R9 ; R8["tag"] := R9
	...
	145	[90]	SETTABLE 	R9 K4 R10 ; R9["tag"] := R10
	...
	157	[95]	SETTABLE 	R10 K4 R11 ; R10["tag"] := R11
...
function #1 <?:121,129> (36 instructions, 144 bytes at 0000016095E42630)
...
function #2 <?:131,137> (22 instructions, 88 bytes at 0000016095E42980)
...
function #3 <?:139,145> (22 instructions, 88 bytes at 0000016095E42B80)
1 param, 7 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
...
function #4 <?:147,206> (208 instructions, 832 bytes at 0000016095E42D80)
3 params, 11 slots, 9 upvalues, 0 locals, 28 constants, 1 function
	...
	18	[157]	SETTABLE 	R6 K2 R7 ; R6["DURATION"] := R7
	...
	27	[158]	SETTABLE 	R6 K5 R7 ; R6["DAMAGE"] := R7
	...
	46	[162]	SETTABLE 	R6 K11 R7 ; R6["PERCENT"] := R7
	...
	122	[182]	SETTABLE 	R6 K5 R7 ; R6["DAMAGE"] := R7
	...
	143	[187]	SETTABLE 	R6 K2 R7 ; R6["DURATION"] := R7
	...
	171	[195]	SETTABLE 	R6 K2 R7 ; R6["DURATION"] := R7
	...
	183	[199]	SETTABLE 	R6 K2 R7 ; R6["DURATION"] := R7
	...
	192	[200]	SETTABLE 	R6 K5 R7 ; R6["DAMAGE"] := R7
...
function #5 <?:208,246> (102 instructions, 408 bytes at 0000016095E43890)
...
function #6 <?:248,272> (71 instructions, 284 bytes at 0000016095E22460)
...
function #7 <?:274,300> (79 instructions, 316 bytes at 0000016095E228E0)
...
function #8 <?:302,362> (187 instructions, 748 bytes at 0000016095E22DF0)
...
function #9 <?:368,376> (21 instructions, 84 bytes at 0000016095E23630)
...
function #10 <?:379,388> (22 instructions, 88 bytes at 0000016095E23830)
...
function #11 <?:390,412> (79 instructions, 316 bytes at 000001608FEC3DC0)
...
function #12 <?:414,455> (142 instructions, 568 bytes at 000001608FEC4320)
1 param, 19 slots, 1 upvalue, 0 locals, 36 constants, 0 functions
	...
	95	[443]	SETTABLE 	R9 K25 R10 ; R9[0xe6c96384] := R10
...
function #13 <?:457,634> (497 instructions, 1988 bytes at 000001608FEC4AE0)
10 params, 54 slots, 11 upvalues, 0 locals, 86 constants, 0 functions
	...
	424	[609]	SETTABLE 	R43 K72 R44 ; R43[0x0a000032] := R44
...
function #14 <?:636,661> (94 instructions, 376 bytes at 000001608FEC58C0)
