...
main <?:0,0> (169 instructions, 676 bytes at 000001608A6EE280)
...
function #1 <?:55,57> (8 instructions, 32 bytes at 000001608A6EE890)
...
function #2 <?:59,70> (26 instructions, 104 bytes at 000001608A6EE9B0)
3 params, 10 slots, 2 upvalues, 0 locals, 9 constants, 0 functions
	...
	19	[65]	SETTABLE 	R5 K2 R6 ; R5[0x35c16153] := R6
...
function #3 <?:75,89> (28 instructions, 112 bytes at 000001608A6EEBE0)
...
function #4 <?:91,157> (201 instructions, 804 bytes at 000001608A6EEE00)
...
function #5 <?:162,164> (1 instruction, 4 bytes at 000001608A6EEF30)
3 params, 3 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[164]	RETURN   	R0 1 ; return 

function #6 <?:166,168> (1 instruction, 4 bytes at 000001608A6EEFC0)
3 params, 3 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[168]	RETURN   	R0 1 ; return 

function #7 <?:171,179> (21 instructions, 84 bytes at 000001608A6EF050)
...
function #8 <?:181,225> (147 instructions, 588 bytes at 000001608A6EF1F0)
...
function #9 <?:229,230> (1 instruction, 4 bytes at 000001608A6EF280)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[230]	RETURN   	R0 1 ; return 

function #10 <?:233,238> (16 instructions, 64 bytes at 000001608A6EF350)
...
function #11 <?:240,242> (4 instructions, 16 bytes at 000001608A6EF4F0)
...
function #12 <?:244,265> (69 instructions, 276 bytes at 000001608A6EF5F0)
...
function #13 <?:267,308> (102 instructions, 408 bytes at 000001608A6EF680)
...
function #14 <?:310,312> (1 instruction, 4 bytes at 000001608A6EF7D0)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[312]	RETURN   	R0 1 ; return 

function #15 <?:314,391> (215 instructions, 860 bytes at 000001608A6EF8A0)
...
function #16 <?:393,399> (15 instructions, 60 bytes at 000001608A6EFF80)
...
function #17 <?:401,422> (83 instructions, 332 bytes at 000001608A6F00D0)
...
function #18 <?:424,443> (54 instructions, 216 bytes at 000001608A6F0420)
...
function #19 <?:445,459> (36 instructions, 144 bytes at 000001608A6F07C0)
...
function #20 <?:461,549> (250 instructions, 1000 bytes at 000001608A6F0A70)
...
function #21 <?:551,570> (49 instructions, 196 bytes at 000001608A6F1190)
...
function #22 <?:572,636> (205 instructions, 820 bytes at 00000160FC4376C0)
...
function #23 <?:638,646> (31 instructions, 124 bytes at 00000160FC437F70)
...
function #24 <?:648,653> (15 instructions, 60 bytes at 00000160FC438200)
...
function #25 <?:655,659> (12 instructions, 48 bytes at 00000160FC438380)
...
function #26 <?:661,693> (75 instructions, 300 bytes at 00000160FC438490)
...
function #27 <?:695,706> (32 instructions, 128 bytes at 00000160FC438910)
...
function #28 <?:708,717> (20 instructions, 80 bytes at 00000160FC438B90)
