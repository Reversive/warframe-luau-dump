...
main <?:0,0> (243 instructions, 972 bytes at 00000160FEB948B0)
...
function #1 <?:59,65> (14 instructions, 56 bytes at 00000160FEB95600)
...
function #2 <?:67,69> (3 instructions, 12 bytes at 00000160FEB95730)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[68]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[68]	CALL     	R0 1 1 ; R0()
	3	[69]	RETURN   	R0 1 ; return 

function #3 <?:71,88> (56 instructions, 224 bytes at 000001608BD4CEE0)
...
function #4 <?:90,92> (3 instructions, 12 bytes at 00000160FB8C1570)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[91]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[91]	CALL     	R0 1 1 ; R0()
	3	[92]	RETURN   	R0 1 ; return 

function #5 <?:97,129> (79 instructions, 316 bytes at 00000160FB8C1640)
...
function #6 <?:132,149> (26 instructions, 104 bytes at 00000160FB8C1D80)
...
function #7 <?:153,155> (3 instructions, 12 bytes at 00000160FB8C1FA0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[154]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[154]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[155]	RETURN   	R0 1 ; return 

function #8 <?:157,170> (33 instructions, 132 bytes at 00000160FB8C2070)
...
function #9 <?:172,183> (22 instructions, 88 bytes at 00000160FB8C2330)
...
function #10 <?:185,192> (15 instructions, 60 bytes at 00000160FB8C2650)
...
function #11 <?:194,200> (11 instructions, 44 bytes at 00000160FB8C27D0)
...
function #12 <?:202,207> (29 instructions, 116 bytes at 00000160FB8C28A0)
...
function #13 <?:209,229> (37 instructions, 148 bytes at 00000160FB8C2B10)
...
function #14 <?:231,247> (51 instructions, 204 bytes at 00000160FB8C3070)
...
function #15 <?:249,265> (51 instructions, 204 bytes at 00000160FB8C3400)
0 params, 6 slots, 7 upvalues, 0 locals, 19 constants, 0 functions
...
function #16 <?:267,283> (51 instructions, 204 bytes at 00000160FB8C3790)
0 params, 6 slots, 7 upvalues, 0 locals, 19 constants, 0 functions
...
function #17 <?:285,300> (46 instructions, 184 bytes at 00000160FB8C3B20)
0 params, 6 slots, 6 upvalues, 0 locals, 17 constants, 0 functions
	...
	33	[292]	SETTABLE 	R1 K11 R2 ; R1[0x46610c50] := R2
...
function #18 <?:302,317> (46 instructions, 184 bytes at 00000160FB8C3E70)
0 params, 6 slots, 6 upvalues, 0 locals, 17 constants, 0 functions
...
function #19 <?:319,413> (354 instructions, 1416 bytes at 00000160FB8C41F0)
0 params, 26 slots, 8 upvalues, 0 locals, 85 constants, 1 function
	...
	175	[399]	SETTABLE 	R23 K57 R24 ; R23[0x00000001] := R24
	...
	220	[400]	SETTABLE 	R23 K57 R24 ; R23[0x00000001] := R24
	...
	265	[401]	SETTABLE 	R23 K57 R24 ; R23[0x00000001] := R24
	...
	310	[402]	SETTABLE 	R23 K57 R24 ; R23[0x00000001] := R24
...
function #20 <?:415,751> (94 instructions, 376 bytes at 00000160FB8C5850)
...
function #21 <?:753,756> (5 instructions, 20 bytes at 000001609063B5F0)
...
function #22 <?:758,772> (29 instructions, 116 bytes at 000001609063B6E0)
...
function #23 <?:774,794> (61 instructions, 244 bytes at 000001609063BB60)
...
function #24 <?:796,853> (153 instructions, 612 bytes at 000001609063BFA0)
...
function #25 <?:855,866> (22 instructions, 88 bytes at 00000160FEB4D560)
...
function #26 <?:868,936> (209 instructions, 836 bytes at 00000160FEB4D740)
...
function #27 <?:938,940> (3 instructions, 12 bytes at 00000160FEB4E210)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[939]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[939]	RETURN   	R0 2 ; return R0 
	3	[940]	RETURN   	R0 1 ; return 

function #28 <?:942,946> (12 instructions, 48 bytes at 00000160FEB4E2E0)
...
function #29 <?:948,952> (12 instructions, 48 bytes at 00000160FEB4E430)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #30 <?:954,958> (15 instructions, 60 bytes at 00000160FEB4E580)
...
function #31 <?:960,968> (4 instructions, 16 bytes at 00000160FEB4E6F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #32 <?:970,975> (8 instructions, 32 bytes at 00000160FEB4E7C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #33 <?:977,980> (4 instructions, 16 bytes at 00000160FEB4E8B0)
...
function #34 <?:982,984> (6 instructions, 24 bytes at 00000160FEB4E980)
...
function #35 <?:986,989> (15 instructions, 60 bytes at 00000160FEB4EAB0)
...
function #36 <?:991,1006> (34 instructions, 136 bytes at 00000160FEB4EC40)
...
function #37 <?:1008,1009> (1 instruction, 4 bytes at 00000160FEB4EFE0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1009]	RETURN   	R0 1 ; return 

function #38 <?:1011,1028> (24 instructions, 96 bytes at 00000160FEB4F0B0)
...
function #39 <?:1030,1032> (6 instructions, 24 bytes at 00000160FEB4F400)
...
function #40 <?:1034,1043> (10 instructions, 40 bytes at 00000160FEB4F510)
