...
main <?:0,0> (514 instructions, 2056 bytes at 00000160F5BD4310)
...
function #1 <?:78,80> (2 instructions, 8 bytes at 00000160F5BD5B90)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[79]	RETURN   	R0 2 ; return R0 
	2	[80]	RETURN   	R0 1 ; return 

function #2 <?:82,84> (3 instructions, 12 bytes at 00000160F5BD5C60)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[83]	NEWTABLE 	R0 0 0 ; R0 := {}
	2	[83]	RETURN   	R0 2 ; return R0 
	3	[84]	RETURN   	R0 1 ; return 

function #3 <?:87,89> (2 instructions, 8 bytes at 00000160F5BD5D30)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[88]	RETURN   	R0 2 ; return R0 
	2	[89]	RETURN   	R0 1 ; return 

function #4 <?:91,108> (37 instructions, 148 bytes at 00000160F5BD5E00)
...
function #5 <?:110,156> (108 instructions, 432 bytes at 00000160F5BD6080)
...
function #6 <?:158,159> (1 instruction, 4 bytes at 00000160F5BD6670)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[159]	RETURN   	R0 1 ; return 

function #7 <?:161,163> (3 instructions, 12 bytes at 00000160F5BD6740)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[162]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[162]	RETURN   	R0 2 ; return R0 
	3	[163]	RETURN   	R0 1 ; return 

function #8 <?:165,182> (50 instructions, 200 bytes at 00000160F5BD6810)
...
function #9 <?:184,186> (3 instructions, 12 bytes at 00000160F5BD6C40)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[185]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[185]	CALL     	R0 1 1 ; R0()
	3	[186]	RETURN   	R0 1 ; return 

function #10 <?:188,200> (24 instructions, 96 bytes at 00000160F5BD6D10)
...
function #11 <?:202,218> (49 instructions, 196 bytes at 00000160F5BD6F20)
...
function #12 <?:220,230> (11 instructions, 44 bytes at 00000160F5BD72D0)
...
function #13 <?:232,274> (95 instructions, 380 bytes at 00000160F5BD7550)
...
function #14 <?:276,287> (28 instructions, 112 bytes at 00000160F5BD7B90)
...
function #15 <?:289,291> (6 instructions, 24 bytes at 00000160F5BD7D60)
...
function #16 <?:293,360> (150 instructions, 600 bytes at 00000160F5BD7E70)
0 params, 16 slots, 4 upvalues, 0 locals, 41 constants, 4 functions
	...
	98	[323]	SETTABLE 	R14 K31 R0 ; R14["CAPACITY_REMAINING"] := R0
	...
	108	[325]	SETTABLE 	R14 K31 R0 ; R14["CAPACITY_REMAINING"] := R0
...
function #17 <?:364,406> (97 instructions, 388 bytes at 000001608291AAC0)
0 params, 9 slots, 9 upvalues, 0 locals, 27 constants, 2 functions
	...
	41	[394]	SETTABLE 	R5 K9 R2 ; R5[0x79a9e9d3] := R2
	42	[394]	SETTABLE 	R4 K8 R5 ; R4[0x8fbd942d] := R5
	43	[394]	SETTABLE 	R4 K10 R1 ; R4[0xd1586535] := R1
	...
	59	[394]	SETTABLE 	R4 K13 R5 ; R4["SHOWSISTER"] := R5
...
function #18 <?:408,412> (18 instructions, 72 bytes at 000001608291B440)
...
function #19 <?:414,427> (39 instructions, 156 bytes at 000001608291B580)
...
function #20 <?:429,462> (78 instructions, 312 bytes at 000001608291B820)
...
function #21 <?:464,496> (49 instructions, 196 bytes at 000001608291BC00)
...
function #22 <?:498,556> (132 instructions, 528 bytes at 000001608291BF20)
...
function #23 <?:558,730> (163 instructions, 652 bytes at 000001608291C790)
...
function #24 <?:732,864> (396 instructions, 1584 bytes at 000001608291EB80)
...
function #25 <?:866,991> (346 instructions, 1384 bytes at 000001608291F0D0)
...
function #26 <?:993,1113> (294 instructions, 1176 bytes at 00000160933780E0)
...
function #27 <?:1115,1119> (12 instructions, 48 bytes at 0000016093379940)
...
function #28 <?:1121,1123> (2 instructions, 8 bytes at 0000016093379AA0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1122]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1123]	RETURN   	R0 1 ; return 

function #29 <?:1125,1127> (2 instructions, 8 bytes at 0000016093379B70)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1126]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1127]	RETURN   	R0 1 ; return 

function #30 <?:1129,1131> (2 instructions, 8 bytes at 0000016093379C40)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1130]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1131]	RETURN   	R0 1 ; return 

function #31 <?:1133,1135> (2 instructions, 8 bytes at 0000016093379D10)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1134]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1135]	RETURN   	R0 1 ; return 

function #32 <?:1137,1139> (2 instructions, 8 bytes at 0000016093379DE0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1138]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1139]	RETURN   	R0 1 ; return 

function #33 <?:1141,1143> (2 instructions, 8 bytes at 0000016093379EB0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1142]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1143]	RETURN   	R0 1 ; return 

function #34 <?:1145,1150> (17 instructions, 68 bytes at 0000016093379F80)
...
function #35 <?:1152,1154> (4 instructions, 16 bytes at 000001609337A120)
...
function #36 <?:1156,1160> (14 instructions, 56 bytes at 000001609337A1F0)
...
function #37 <?:1162,1164> (2 instructions, 8 bytes at 000001609337A380)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1163]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1164]	RETURN   	R0 1 ; return 

function #38 <?:1166,1168> (2 instructions, 8 bytes at 000001609337A450)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1167]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1168]	RETURN   	R0 1 ; return 

function #39 <?:1170,1172> (2 instructions, 8 bytes at 000001609337A520)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1171]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1172]	RETURN   	R0 1 ; return 

function #40 <?:1174,1176> (2 instructions, 8 bytes at 000001609337A5F0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1175]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1176]	RETURN   	R0 1 ; return 

function #41 <?:1178,1180> (2 instructions, 8 bytes at 000001609337A6C0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1179]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1180]	RETURN   	R0 1 ; return 

function #42 <?:1182,1184> (2 instructions, 8 bytes at 000001609337A790)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1183]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1184]	RETURN   	R0 1 ; return 

function #43 <?:1186,1192> (5 instructions, 20 bytes at 0000016083610EC0)
...
function #44 <?:1194,1196> (6 instructions, 24 bytes at 0000016083610FD0)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #45 <?:1198,1200> (2 instructions, 8 bytes at 00000160836110E0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1199]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1200]	RETURN   	R0 1 ; return 

function #46 <?:1202,1204> (5 instructions, 20 bytes at 00000160836111B0)
...
function #47 <?:1206,1208> (6 instructions, 24 bytes at 00000160836112C0)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #48 <?:1210,1216> (12 instructions, 48 bytes at 00000160836113D0)
...
function #49 <?:1218,1224> (12 instructions, 48 bytes at 00000160836114E0)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #50 <?:1226,1232> (12 instructions, 48 bytes at 0000016083611630)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #51 <?:1234,1245> (25 instructions, 100 bytes at 0000016083611780)
...
function #52 <?:1247,1258> (25 instructions, 100 bytes at 00000160836119C0)
1 param, 7 slots, 3 upvalues, 0 locals, 10 constants, 0 functions
...
function #53 <?:1260,1262> (2 instructions, 8 bytes at 0000016083611C00)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1261]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1262]	RETURN   	R0 1 ; return 

function #54 <?:1264,1266> (6 instructions, 24 bytes at 0000016083611CD0)
...
function #55 <?:1268,1270> (3 instructions, 12 bytes at 0000016083611DF0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1269]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1269]	CALL     	R0 1 1 ; R0()
	3	[1270]	RETURN   	R0 1 ; return 

function #56 <?:1272,1274> (3 instructions, 12 bytes at 0000016083611EC0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1273]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1273]	CALL     	R0 1 1 ; R0()
	3	[1274]	RETURN   	R0 1 ; return 

function #57 <?:1276,1280> (8 instructions, 32 bytes at 0000016083611F90)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #58 <?:1282,1288> (12 instructions, 48 bytes at 00000160836120C0)
...
function #59 <?:1290,1292> (3 instructions, 12 bytes at 0000016083612210)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1291]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1291]	CALL     	R0 1 1 ; R0()
	3	[1292]	RETURN   	R0 1 ; return 

function #60 <?:1294,1302> (21 instructions, 84 bytes at 00000160836122E0)
...
function #61 <?:1304,1366> (248 instructions, 992 bytes at 00000160836124C0)
...
function #62 <?:1368,1378> (20 instructions, 80 bytes at 00000160836130C0)
...
function #63 <?:1380,1382> (5 instructions, 20 bytes at 0000016083613240)
...
function #64 <?:1386,1390> (12 instructions, 48 bytes at 0000016083613330)
...
function #65 <?:1392,1396> (12 instructions, 48 bytes at 0000016083613480)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #66 <?:1398,1403> (21 instructions, 84 bytes at 00000160836135D0)
...
function #67 <?:1405,1409> (14 instructions, 56 bytes at 00000160836137B0)
...
function #68 <?:1411,1415> (14 instructions, 56 bytes at 0000016083613930)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #69 <?:1417,1421> (18 instructions, 72 bytes at 0000016083613AB0)
...
function #70 <?:1423,1427> (14 instructions, 56 bytes at 0000016083613C50)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #71 <?:1429,1433> (14 instructions, 56 bytes at 0000016083613DD0)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #72 <?:1435,1439> (18 instructions, 72 bytes at 0000016083613F50)
1 param, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #73 <?:1441,1450> (38 instructions, 152 bytes at 00000160836140F0)
...
function #74 <?:1452,1458> (23 instructions, 92 bytes at 0000016083614390)
...
function #75 <?:1460,1472> (38 instructions, 152 bytes at 0000016083614560)
...
function #76 <?:1474,1479> (20 instructions, 80 bytes at 00000160836147F0)
...
function #77 <?:1481,1486> (20 instructions, 80 bytes at 0000016083614990)
2 params, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #78 <?:1488,1493> (21 instructions, 84 bytes at 0000016083614B30)
2 params, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #79 <?:1495,1500> (21 instructions, 84 bytes at 0000016083614CF0)
2 params, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #80 <?:1502,1507> (14 instructions, 56 bytes at 0000016083614EB0)
...
function #81 <?:1509,1514> (14 instructions, 56 bytes at 0000016083615010)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #82 <?:1516,1520> (8 instructions, 32 bytes at 0000016083615170)
0 params, 3 slots, 2 upvalues, 0 locals, 1 constant, 0 functions
...
function #83 <?:1522,1525> (8 instructions, 32 bytes at 0000016083615280)
0 params, 3 slots, 2 upvalues, 0 locals, 1 constant, 0 functions
...
function #84 <?:1527,1531> (11 instructions, 44 bytes at 0000016083615390)
...
function #85 <?:1533,1537> (11 instructions, 44 bytes at 00000160836154E0)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #86 <?:1539,1543> (11 instructions, 44 bytes at 0000016083615630)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #87 <?:1545,1549> (11 instructions, 44 bytes at 0000016083615780)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #88 <?:1551,1555> (11 instructions, 44 bytes at 00000160836158D0)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #89 <?:1557,1561> (11 instructions, 44 bytes at 0000016097A92A30)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #90 <?:1563,1565> (6 instructions, 24 bytes at 0000016097A92B80)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #91 <?:1567,1576> (27 instructions, 108 bytes at 0000016097A92C80)
...
function #97 <?:1607,1611> (6 instructions, 24 bytes at 0000016097A93440)
...
function #98 <?:1613,1617> (12 instructions, 48 bytes at 0000016097A935A0)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
