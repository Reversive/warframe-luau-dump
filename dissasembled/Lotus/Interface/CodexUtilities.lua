...
main <?:0,0> (84 instructions, 336 bytes at 00000160C68953F0)
...
function #1 <?:49,51> (3 instructions, 12 bytes at 00000160C68963A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[50]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[50]	RETURN   	R0 2 ; return R0 
	3	[51]	RETURN   	R0 1 ; return 

function #2 <?:53,77> (60 instructions, 240 bytes at 00000160C6896470)
...
function #3 <?:79,91> (19 instructions, 76 bytes at 00000160C6896850)
...
function #4 <?:93,257> (462 instructions, 1848 bytes at 00000160C68969D0)
...
function #5 <?:259,261> (8 instructions, 32 bytes at 00000160C6898210)
...
function #6 <?:263,276> (45 instructions, 180 bytes at 00000160C6898320)
...
function #7 <?:278,280> (6 instructions, 24 bytes at 00000160C6898870)
...
function #8 <?:284,472> (414 instructions, 1656 bytes at 00000160C6898960)
...
function #9 <?:474,476> (10 instructions, 40 bytes at 00000160C6899B60)
...
function #10 <?:478,529> (133 instructions, 532 bytes at 00000160C6899C70)
...
function #11 <?:531,607> (170 instructions, 680 bytes at 00000160C689A440)
