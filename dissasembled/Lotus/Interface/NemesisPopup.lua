...
main <?:0,0> (168 instructions, 672 bytes at 00000160F5898BD0)
...
function #1 <?:75,96> (41 instructions, 164 bytes at 00000160F5898DF0)
...
function #2 <?:100,104> (11 instructions, 44 bytes at 00000160F58990E0)
...
function #3 <?:106,114> (12 instructions, 48 bytes at 00000160F58991F0)
...
function #4 <?:116,118> (3 instructions, 12 bytes at 00000160F5899390)
...
function #5 <?:120,144> (116 instructions, 464 bytes at 00000160F5899460)
...
function #6 <?:146,150> (7 instructions, 28 bytes at 00000160F5899B80)
...
function #7 <?:152,156> (7 instructions, 28 bytes at 00000160F5899C70)
0 params, 2 slots, 3 upvalues, 0 locals, 0 constants, 0 functions
...
function #8 <?:158,163> (6 instructions, 24 bytes at 00000160F5899D60)
...
function #9 <?:165,181> (49 instructions, 196 bytes at 00000160F5899E50)
...
function #10 <?:183,190> (15 instructions, 60 bytes at 00000160F589A280)
...
function #11 <?:192,359> (519 instructions, 2076 bytes at 00000160F589A4C0)
...
function #12 <?:361,422> (101 instructions, 404 bytes at 00000160F5C7B7B0)
...
function #13 <?:424,433> (18 instructions, 72 bytes at 00000160F5C7BBA0)
...
function #14 <?:435,436> (1 instruction, 4 bytes at 0000016084C733B0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[436]	RETURN   	R0 1 ; return 

function #15 <?:438,464> (48 instructions, 192 bytes at 0000016084C73480)
...
function #16 <?:466,471> (12 instructions, 48 bytes at 0000016084C73930)
0 params, 2 slots, 3 upvalues, 0 locals, 2 constants, 0 functions
...
function #17 <?:473,519> (137 instructions, 548 bytes at 0000016084C73A70)
...
function #18 <?:521,525> (11 instructions, 44 bytes at 0000016084C74740)
...
function #19 <?:527,529> (3 instructions, 12 bytes at 0000016084C74880)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[528]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[528]	RETURN   	R0 2 ; return R0 
	3	[529]	RETURN   	R0 1 ; return 

function #20 <?:531,538> (13 instructions, 52 bytes at 0000016084C74950)
...
function #21 <?:540,543> (5 instructions, 20 bytes at 0000016084C74AB0)
0 params, 2 slots, 3 upvalues, 0 locals, 0 constants, 0 functions
...
function #22 <?:545,549> (7 instructions, 28 bytes at 0000016084C74BA0)
0 params, 2 slots, 3 upvalues, 0 locals, 0 constants, 0 functions
...
function #23 <?:550,553> (5 instructions, 20 bytes at 0000016084C74C90)
0 params, 2 slots, 3 upvalues, 0 locals, 0 constants, 0 functions
...
function #24 <?:555,559> (7 instructions, 28 bytes at 0000016084C74D80)
0 params, 2 slots, 3 upvalues, 0 locals, 0 constants, 0 functions
