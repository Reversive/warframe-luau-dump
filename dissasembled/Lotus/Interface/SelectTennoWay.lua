...
main <?:0,0> (160 instructions, 640 bytes at 000001608C4C6A10)
...
function #1 <?:44,69> (107 instructions, 428 bytes at 000001608C4C7130)
0 params, 4 slots, 4 upvalues, 0 locals, 22 constants, 0 functions
	...
	7	[47]	SETTABLE 	R0 K0 R1 ; R0[0xae91e43b] := R1
...
function #2 <?:71,94> (41 instructions, 164 bytes at 000001608C4C7900)
...
function #3 <?:96,107> (20 instructions, 80 bytes at 000001608C4C7C90)
...
function #4 <?:109,111> (3 instructions, 12 bytes at 000001608C4C8000)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[110]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[110]	CALL     	R0 1 1 ; R0()
	3	[111]	RETURN   	R0 1 ; return 

function #5 <?:113,124> (23 instructions, 92 bytes at 000001608C4C8090)
...
function #6 <?:126,130> (10 instructions, 40 bytes at 000001608C4C8290)
...
function #7 <?:132,141> (24 instructions, 96 bytes at 000001608C4C83F0)
...
function #8 <?:143,176> (24 instructions, 96 bytes at 000001608C4C85F0)
...
function #9 <?:178,207> (12 instructions, 48 bytes at 00000160F69CBB40)
...
function #10 <?:209,305> (55 instructions, 220 bytes at 00000160F69CC440)
...
function #11 <?:307,326> (28 instructions, 112 bytes at 00000160F69CE0A0)
...
function #12 <?:328,414> (220 instructions, 880 bytes at 00000160F69CE610)
...
function #13 <?:416,419> (17 instructions, 68 bytes at 00000160FCFE0F40)
...
function #14 <?:421,423> (2 instructions, 8 bytes at 00000160FCFE10F0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[422]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[423]	RETURN   	R0 1 ; return 

function #15 <?:425,427> (2 instructions, 8 bytes at 00000160FCFE1180)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[426]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[427]	RETURN   	R0 1 ; return 

function #16 <?:429,456> (88 instructions, 352 bytes at 00000160FCFE1210)
...
function #17 <?:458,490> (66 instructions, 264 bytes at 00000160FCFE1740)
...
function #18 <?:492,500> (15 instructions, 60 bytes at 00000160FCFE1B50)
...
function #19 <?:502,504> (2 instructions, 8 bytes at 00000160FCFE1C80)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[503]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[504]	RETURN   	R0 1 ; return 

function #20 <?:506,508> (3 instructions, 12 bytes at 00000160FCFE1D10)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[507]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[507]	CALL     	R0 1 1 ; R0()
	3	[508]	RETURN   	R0 1 ; return 

function #21 <?:510,512> (3 instructions, 12 bytes at 00000160FCFE1DA0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[511]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[511]	CALL     	R0 1 1 ; R0()
	3	[512]	RETURN   	R0 1 ; return 

function #22 <?:514,516> (3 instructions, 12 bytes at 00000160FCFE1E30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[515]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[515]	CALL     	R0 1 1 ; R0()
	3	[516]	RETURN   	R0 1 ; return 

function #23 <?:518,524> (12 instructions, 48 bytes at 00000160FCFE1EC0)
...
function #24 <?:526,529> (5 instructions, 20 bytes at 00000160FCFE2000)
...
function #25 <?:531,535> (12 instructions, 48 bytes at 00000160FCFE20F0)
...
function #26 <?:537,541> (15 instructions, 60 bytes at 00000160FCFE2240)
...
function #27 <?:543,547> (16 instructions, 64 bytes at 00000160FCFE23B0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #28 <?:549,552> (5 instructions, 20 bytes at 00000160FCFE2520)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #29 <?:554,556> (6 instructions, 24 bytes at 00000160FCFE2610)
...
function #30 <?:558,559> (1 instruction, 4 bytes at 00000160FCFE2740)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[559]	RETURN   	R0 1 ; return 

function #31 <?:561,563> (3 instructions, 12 bytes at 00000160FCFE27D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[562]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[562]	RETURN   	R0 2 ; return R0 
	3	[563]	RETURN   	R0 1 ; return 

function #32 <?:565,567> (6 instructions, 24 bytes at 00000160FCFE2860)
...
function #33 <?:569,570> (1 instruction, 4 bytes at 00000160FCFE2950)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[570]	RETURN   	R0 1 ; return 

function #34 <?:572,574> (3 instructions, 12 bytes at 00000160FCFE29E0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[573]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[573]	RETURN   	R0 2 ; return R0 
	3	[574]	RETURN   	R0 1 ; return 

function #35 <?:576,581> (12 instructions, 48 bytes at 00000160FCFE2A70)
