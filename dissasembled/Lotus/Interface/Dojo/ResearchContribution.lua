...
main <?:0,0> (327 instructions, 1308 bytes at 00000160F8AF9EF0)
...
function #1 <?:55,82> (56 instructions, 224 bytes at 00000160F8AFAE80)
...
function #2 <?:84,101> (56 instructions, 224 bytes at 00000160F8AFB240)
...
function #3 <?:103,110> (23 instructions, 92 bytes at 00000160F8AFB5F0)
...
function #4 <?:112,138> (46 instructions, 184 bytes at 00000160F8AFB8F0)
...
function #5 <?:140,142> (3 instructions, 12 bytes at 00000160F8AFBF50)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[141]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[141]	CALL     	R0 1 1 ; R0()
	3	[142]	RETURN   	R0 1 ; return 

function #6 <?:144,152> (8 instructions, 32 bytes at 00000160F8AFC020)
...
function #7 <?:154,197> (93 instructions, 372 bytes at 00000160F8AFC2A0)
...
function #8 <?:199,213> (68 instructions, 272 bytes at 00000160F8AFCB50)
...
function #9 <?:215,240> (65 instructions, 260 bytes at 00000160F8AFCF50)
...
function #10 <?:242,252> (51 instructions, 204 bytes at 00000160F8AFD3F0)
...
function #11 <?:254,256> (8 instructions, 32 bytes at 00000160F8B33B50)
...
function #12 <?:258,266> (20 instructions, 80 bytes at 00000160F8B33C80)
...
function #13 <?:268,276> (20 instructions, 80 bytes at 00000160F8B33E00)
1 param, 4 slots, 6 upvalues, 0 locals, 2 constants, 0 functions
...
function #14 <?:278,283> (22 instructions, 88 bytes at 00000160F8B33F80)
...
function #15 <?:285,290> (19 instructions, 76 bytes at 00000160F8B341A0)
...
function #16 <?:292,294> (2 instructions, 8 bytes at 00000160F8B34340)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[293]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[294]	RETURN   	R0 1 ; return 

function #17 <?:296,303> (39 instructions, 156 bytes at 00000160F8B34410)
...
function #18 <?:305,461> (237 instructions, 948 bytes at 00000160F8B34650)
1 param, 8 slots, 8 upvalues, 0 locals, 48 constants, 17 functions
	...
	51	[330]	SETTABLE 	R0 K13 R1 ; R0[0x03f57322] := R1
...
function #19 <?:463,471> (15 instructions, 60 bytes at 00000160F8B36E80)
...
function #20 <?:473,799> (575 instructions, 2300 bytes at 00000160F8B36FE0)
0 params, 42 slots, 23 upvalues, 0 locals, 117 constants, 6 functions
	...
	508	[771]	SETTABLE 	R17 K76 R32 ; R17[0x00000001] := R32
...
function #21 <?:801,867> (171 instructions, 684 bytes at 00000160F6CE0280)
...
function #22 <?:869,880> (54 instructions, 216 bytes at 00000160F6CE07D0)
...
function #23 <?:882,916> (100 instructions, 400 bytes at 00000160E3DEF640)
...
function #24 <?:918,941> (73 instructions, 292 bytes at 00000160E3DEFB30)
...
function #25 <?:943,945> (3 instructions, 12 bytes at 00000160E3DEFFB0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[944]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[944]	CALL     	R0 1 1 ; R0()
	3	[945]	RETURN   	R0 1 ; return 

function #26 <?:947,949> (3 instructions, 12 bytes at 00000160E3DF0080)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[948]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[948]	CALL     	R0 1 1 ; R0()
	3	[949]	RETURN   	R0 1 ; return 

function #27 <?:951,974> (50 instructions, 200 bytes at 00000160E3DF0150)
...
function #28 <?:978,1009> (51 instructions, 204 bytes at 00000160E3DF0610)
...
function #29 <?:1011,1018> (19 instructions, 76 bytes at 00000160E3DF0CB0)
...
function #30 <?:1020,1060> (89 instructions, 356 bytes at 00000160E3DF0EA0)
...
function #31 <?:1062,1117> (119 instructions, 476 bytes at 00000160E3DF15F0)
...
function #32 <?:1119,1203> (96 instructions, 384 bytes at 00000160E3DF21A0)
...
function #33 <?:1205,1262> (151 instructions, 604 bytes at 000001608CCE8260)
...
function #34 <?:1264,1267> (17 instructions, 68 bytes at 000001608CCE8A40)
...
function #35 <?:1269,1271> (3 instructions, 12 bytes at 000001608CCE8BF0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1270]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1270]	CALL     	R0 1 1 ; R0()
	3	[1271]	RETURN   	R0 1 ; return 

function #36 <?:1273,1275> (6 instructions, 24 bytes at 000001608CCE8CC0)
...
function #37 <?:1277,1279> (6 instructions, 24 bytes at 000001608CCE8DD0)
1 param, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #38 <?:1281,1283> (3 instructions, 12 bytes at 000001608CCE8EE0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1282]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1282]	CALL     	R0 1 1 ; R0()
	3	[1283]	RETURN   	R0 1 ; return 

function #39 <?:1285,1289> (15 instructions, 60 bytes at 000001608CCE8FB0)
...
function #40 <?:1291,1295> (15 instructions, 60 bytes at 000001608CCE90D0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #41 <?:1297,1298> (1 instruction, 4 bytes at 000001608CCE9240)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1298]	RETURN   	R0 1 ; return 

function #42 <?:1300,1309> (32 instructions, 128 bytes at 000001608CCE9310)
...
function #43 <?:1311,1320> (32 instructions, 128 bytes at 000001608CCE9530)
0 params, 5 slots, 4 upvalues, 0 locals, 6 constants, 0 functions
...
function #44 <?:1322,1326> (7 instructions, 28 bytes at 000001608CCE9750)
...
function #45 <?:1328,1332> (7 instructions, 28 bytes at 000001608CCE9840)
0 params, 2 slots, 2 upvalues, 0 locals, 0 constants, 0 functions
...
function #46 <?:1334,1342> (30 instructions, 120 bytes at 000001608CCE9930)
...
function #47 <?:1344,1352> (30 instructions, 120 bytes at 000001608CCE9B50)
0 params, 5 slots, 3 upvalues, 0 locals, 6 constants, 0 functions
...
function #48 <?:1354,1356> (3 instructions, 12 bytes at 000001608CCE9D70)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1355]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1355]	RETURN   	R0 2 ; return R0 
	3	[1356]	RETURN   	R0 1 ; return 

function #49 <?:1358,1374> (18 instructions, 72 bytes at 000001608CCE9E40)
...
function #50 <?:1376,1378> (3 instructions, 12 bytes at 000001608CCEA2B0)
