...
main <?:0,0> (410 instructions, 1640 bytes at 00000160FE4B5830)
...
function #1 <?:71,73> (3 instructions, 12 bytes at 00000160F8AFF5A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[72]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[72]	RETURN   	R0 2 ; return R0 
	3	[73]	RETURN   	R0 1 ; return 

function #2 <?:75,77> (7 instructions, 28 bytes at 00000160F8AFF670)
...
function #3 <?:79,81> (3 instructions, 12 bytes at 00000160F8AFF780)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[80]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[80]	RETURN   	R0 2 ; return R0 
	3	[81]	RETURN   	R0 1 ; return 

function #4 <?:83,125> (192 instructions, 768 bytes at 00000160F8AFF850)
...
function #5 <?:127,145> (24 instructions, 96 bytes at 00000160F8B004A0)
...
function #6 <?:147,152> (21 instructions, 84 bytes at 00000160F8B00750)
...
function #7 <?:154,165> (41 instructions, 164 bytes at 00000160F8B00980)
...
function #8 <?:167,178> (68 instructions, 272 bytes at 00000160F8B00CC0)
...
function #9 <?:180,198> (57 instructions, 228 bytes at 00000160F8B01100)
...
function #10 <?:200,235> (153 instructions, 612 bytes at 00000160F8B01440)
...
function #11 <?:237,255> (46 instructions, 184 bytes at 00000160F8B01D50)
...
function #12 <?:257,273> (55 instructions, 220 bytes at 00000160F8B02090)
...
function #13 <?:276,291> (31 instructions, 124 bytes at 00000160F8B02590)
...
function #14 <?:293,307> (44 instructions, 176 bytes at 00000160F8B02930)
0 params, 4 slots, 4 upvalues, 0 locals, 14 constants, 0 functions
	...
	43	[305]	SETTABLE 	R0 K12 R1 ; R0[0x09000038] := R1
	44	[307]	RETURN   	R0 1 ; return 

function #15 <?:309,351> (89 instructions, 356 bytes at 00000160F8B02C70)
...
function #16 <?:353,355> (3 instructions, 12 bytes at 00000160F8B390C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[354]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[354]	CALL     	R0 1 1 ; R0()
	3	[355]	RETURN   	R0 1 ; return 

function #17 <?:357,367> (16 instructions, 64 bytes at 00000160F8B39190)
...
function #18 <?:369,373> (20 instructions, 80 bytes at 00000160F8B39310)
...
function #19 <?:375,393> (88 instructions, 352 bytes at 00000160F8B39510)
...
function #20 <?:395,407> (53 instructions, 212 bytes at 00000160F8B39A30)
...
function #21 <?:409,413> (13 instructions, 52 bytes at 00000160F8B39DB0)
...
function #22 <?:415,469> (130 instructions, 520 bytes at 00000160F8B39FE0)
...
function #23 <?:471,476> (16 instructions, 64 bytes at 00000160F8B3AAC0)
...
function #24 <?:478,487> (18 instructions, 72 bytes at 00000160F8B3AC50)
...
function #25 <?:489,501> (28 instructions, 112 bytes at 00000160F8B3AE10)
...
function #26 <?:503,509> (16 instructions, 64 bytes at 00000160F8B3B040)
...
function #27 <?:512,530> (37 instructions, 148 bytes at 00000160F8B3B1B0)
...
function #28 <?:532,540> (27 instructions, 108 bytes at 00000160F8B3B4F0)
...
function #29 <?:542,547> (6 instructions, 24 bytes at 00000160F8B3B6D0)
...
function #30 <?:549,628> (79 instructions, 316 bytes at 00000160F8B3B810)
...
function #31 <?:630,641> (34 instructions, 136 bytes at 00000160F8B3C540)
...
function #32 <?:643,656> (34 instructions, 136 bytes at 00000160F8B3C830)
...
function #33 <?:658,668> (27 instructions, 108 bytes at 00000160F8B3CB00)
...
function #34 <?:670,687> (67 instructions, 268 bytes at 00000160F8B3CD50)
0 params, 20 slots, 4 upvalues, 0 locals, 32 constants, 0 functions
	...
	14	[674]	SETTABLE 	R12 K4 R13 ; R12[0x00000001] := R13
	15	[674]	GETTABLE 	R13 R10 K7 ; R13 := R10["resTotal"]
	16	[674]	SETTABLE 	R12 K6 R13 ; R12[0x08000000] := R13
	17	[674]	GETTABLE 	R13 R10 K9 ; R13 := R10["resIcon"]
	18	[674]	SETTABLE 	R12 K8 R13 ; R12[0x08002000] := R13
	19	[674]	GETTABLE 	R13 R10 K11 ; R13 := R10["resIconThemed"]
	20	[674]	SETTABLE 	R12 K10 R13 ; R12[0x07000038] := R13
...
function #35 <?:689,695> (13 instructions, 52 bytes at 00000160840F5650)
...
function #36 <?:697,743> (131 instructions, 524 bytes at 00000160840F57A0)
...
function #37 <?:745,780> (140 instructions, 560 bytes at 00000160840F6010)
...
function #38 <?:782,788> (25 instructions, 100 bytes at 00000160840F6830)
...
function #39 <?:790,823> (86 instructions, 344 bytes at 00000160840F6A30)
...
function #40 <?:825,834> (21 instructions, 84 bytes at 00000160840F6EC0)
...
function #41 <?:836,853> (31 instructions, 124 bytes at 00000160840F71E0)
...
function #42 <?:856,858> (4 instructions, 16 bytes at 00000160840F7410)
...
function #43 <?:861,863> (3 instructions, 12 bytes at 00000160840F74E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[862]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[862]	CALL     	R0 1 1 ; R0()
	3	[863]	RETURN   	R0 1 ; return 

function #44 <?:865,867> (3 instructions, 12 bytes at 00000160840F75B0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[866]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[866]	RETURN   	R0 2 ; return R0 
	3	[867]	RETURN   	R0 1 ; return 

function #45 <?:869,885> (42 instructions, 168 bytes at 00000160840F7680)
...
function #46 <?:887,889> (3 instructions, 12 bytes at 00000160840F7980)
...
function #47 <?:891,896> (19 instructions, 76 bytes at 00000160840F7A90)
...
function #48 <?:898,951> (142 instructions, 568 bytes at 00000160840F7C50)
...
function #49 <?:953,979> (80 instructions, 320 bytes at 00000160840F8690)
...
function #50 <?:981,985> (6 instructions, 24 bytes at 00000160840F8E80)
...
function #51 <?:987,989> (3 instructions, 12 bytes at 00000160840F8F70)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[988]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[988]	CALL     	R0 1 1 ; R0()
	3	[989]	RETURN   	R0 1 ; return 

function #52 <?:991,993> (3 instructions, 12 bytes at 00000160840F9040)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[992]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[992]	CALL     	R0 1 1 ; R0()
	3	[993]	RETURN   	R0 1 ; return 

function #53 <?:995,1001> (11 instructions, 44 bytes at 00000160840F9110)
...
function #54 <?:1003,1005> (3 instructions, 12 bytes at 00000160840F9260)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1004]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1004]	CALL     	R0 1 1 ; R0()
	3	[1005]	RETURN   	R0 1 ; return 

function #55 <?:1007,1009> (3 instructions, 12 bytes at 00000160840F9330)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1008]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1008]	CALL     	R0 1 1 ; R0()
	3	[1009]	RETURN   	R0 1 ; return 

function #56 <?:1011,1018> (24 instructions, 96 bytes at 00000160840F9400)
...
function #57 <?:1020,1022> (3 instructions, 12 bytes at 00000160840F9620)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1021]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1021]	CALL     	R0 1 1 ; R0()
	3	[1022]	RETURN   	R0 1 ; return 

function #58 <?:1024,1026> (3 instructions, 12 bytes at 000001608FBEA250)
...
function #59 <?:1028,1073> (145 instructions, 580 bytes at 000001608FBEA320)
...
function #60 <?:1075,1173> (326 instructions, 1304 bytes at 000001608FBEAB30)
...
function #61 <?:1175,1185> (15 instructions, 60 bytes at 000001608FBEBCC0)
...
function #62 <?:1187,1195> (24 instructions, 96 bytes at 000001608FBEBE10)
...
function #63 <?:1197,1199> (3 instructions, 12 bytes at 000001608FBEBFD0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1198]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1198]	RETURN   	R0 2 ; return R0 
	3	[1199]	RETURN   	R0 1 ; return 

function #64 <?:1201,1203> (3 instructions, 12 bytes at 000001608FBEC0A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1202]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1202]	CALL     	R0 1 1 ; R0()
	3	[1203]	RETURN   	R0 1 ; return 

function #65 <?:1205,1207> (3 instructions, 12 bytes at 000001608FBEC170)
