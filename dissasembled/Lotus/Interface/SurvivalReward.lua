...
main <?:0,0> (106 instructions, 424 bytes at 0000016084A07B10)
...
function #1 <?:32,34> (3 instructions, 12 bytes at 0000016084A08090)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[33]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[33]	RETURN   	R0 2 ; return R0 
	3	[34]	RETURN   	R0 1 ; return 

function #2 <?:36,41> (9 instructions, 36 bytes at 0000016084A08160)
...
function #3 <?:43,45> (2 instructions, 8 bytes at 0000016084A08360)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[44]	RETURN   	R0 2 ; return R0 
	2	[45]	RETURN   	R0 1 ; return 

function #4 <?:47,49> (2 instructions, 8 bytes at 0000016084A08430)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[48]	RETURN   	R0 2 ; return R0 
	2	[49]	RETURN   	R0 1 ; return 

function #5 <?:51,94> (101 instructions, 404 bytes at 0000016084A08500)
...
function #6 <?:96,102> (15 instructions, 60 bytes at 0000016084A09410)
...
function #7 <?:104,106> (3 instructions, 12 bytes at 0000016084A096B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[105]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[105]	CALL     	R0 1 1 ; R0()
	3	[106]	RETURN   	R0 1 ; return 

function #8 <?:108,133> (87 instructions, 348 bytes at 0000016084A09780)
...
function #9 <?:135,140> (18 instructions, 72 bytes at 0000016084A09CB0)
...
function #10 <?:142,278> (409 instructions, 1636 bytes at 0000016084A09EA0)
6 params, 25 slots, 10 upvalues, 0 locals, 85 constants, 1 function
	...
	24	[155]	SETTABLE 	R8 K9 R1 ; R8["ItemInfo"] := R1
	...
	211	[218]	SETTABLE 	R17 K9 R1 ; R17["ItemInfo"] := R1
	...
	300	[243]	SETTABLE 	R14 K72 R15 ; R14["mUpgradeFingerprint"] := R15
...
function #11 <?:280,287> (14 instructions, 56 bytes at 0000016084A0B6F0)
...
function #12 <?:289,293> (14 instructions, 56 bytes at 0000016084A0B860)
...
function #13 <?:295,316> (77 instructions, 308 bytes at 0000016084A0B9E0)
...
function #14 <?:318,320> (3 instructions, 12 bytes at 0000016097257350)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[319]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[319]	CALL     	R0 1 1 ; R0()
	3	[320]	RETURN   	R0 1 ; return 

function #15 <?:322,403> (169 instructions, 676 bytes at 0000016097257420)
...
function #16 <?:405,407> (3 instructions, 12 bytes at 0000016097257E50)
0 params, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
	1	[406]	GETGLOBAL	R0 K0 ; R0 := 0xb21d546d
	2	[406]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[407]	RETURN   	R0 1 ; return 

function #17 <?:409,411> (3 instructions, 12 bytes at 0000016097257F40)
0 params, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
	1	[410]	GETGLOBAL	R0 K0 ; R0 := 0xb21d546d
	2	[410]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[411]	RETURN   	R0 1 ; return 

function #18 <?:413,454> (151 instructions, 604 bytes at 0000016097258030)
...
function #19 <?:456,475> (44 instructions, 176 bytes at 0000016097258940)
...
function #20 <?:477,479> (3 instructions, 12 bytes at 0000016097258C30)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
