...
main <?:0,0> (252 instructions, 1008 bytes at 0000016098C76AC0)
...
function #1 <?:41,44> (8 instructions, 32 bytes at 0000016098C76FD0)
...
function #2 <?:46,109> (117 instructions, 468 bytes at 0000016098C770B0)
0 params, 27 slots, 0 upvalues, 0 locals, 34 constants, 0 functions
	...
	114	[106]	SETTABLE 	R24 K32 R20 ; R24[0x0300005a] := R20
	115	[106]	SETTABLE 	R24 K33 R21 ; R24["TimeOverride"] := R21
	116	[106]	CALL     	R22 3 1 ; R22(R23,R24)
	117	[109]	RETURN   	R0 1 ; return 

function #3 <?:111,115> (7 instructions, 28 bytes at 0000016098C771A0)
...
function #4 <?:117,166> (128 instructions, 512 bytes at 0000016098C77230)
...
function #5 <?:168,172> (12 instructions, 48 bytes at 0000016098C77360)
...
function #6 <?:174,178> (11 instructions, 44 bytes at 0000016098C77440)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #7 <?:180,187> (19 instructions, 76 bytes at 0000016098C77520)
...
function #8 <?:189,200> (35 instructions, 140 bytes at 0000016098C776D0)
...
function #9 <?:202,206> (15 instructions, 60 bytes at 0000016098C77760)
...
function #10 <?:208,214> (15 instructions, 60 bytes at 0000016098C77900)
...
function #11 <?:216,222> (15 instructions, 60 bytes at 0000016098C77A80)
3 params, 8 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #12 <?:224,230> (15 instructions, 60 bytes at 0000016098C77C00)
3 params, 8 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #13 <?:232,238> (14 instructions, 56 bytes at 0000016098C77D80)
...
function #14 <?:240,246> (15 instructions, 60 bytes at 0000016098C77F00)
3 params, 8 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #15 <?:248,254> (12 instructions, 48 bytes at 0000016098C78080)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #16 <?:256,263> (17 instructions, 68 bytes at 0000016098C78160)
...
function #17 <?:265,271> (12 instructions, 48 bytes at 0000016098C78310)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #18 <?:273,280> (18 instructions, 72 bytes at 0000016098C783F0)
...
function #19 <?:282,289> (17 instructions, 68 bytes at 0000016098C785A0)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #20 <?:291,312> (107 instructions, 428 bytes at 0000016098C78750)
...
function #21 <?:314,331> (75 instructions, 300 bytes at 0000016098C78810)
...
function #22 <?:333,443> (262 instructions, 1048 bytes at 0000016098C788A0)
...
function #23 <?:445,452> (19 instructions, 76 bytes at 0000016098C78C60)
...
function #24 <?:454,520> (190 instructions, 760 bytes at 0000016098C78DB0)
...
function #25 <?:522,531> (22 instructions, 88 bytes at 0000016098C78F50)
...
function #26 <?:533,571> (90 instructions, 360 bytes at 0000016098C79130)
...
function #27 <?:573,577> (15 instructions, 60 bytes at 0000016098C79440)
...
function #28 <?:579,606> (62 instructions, 248 bytes at 0000016098C79610)
...
function #29 <?:608,622> (30 instructions, 120 bytes at 0000016098C797A0)
...
function #30 <?:624,638> (37 instructions, 148 bytes at 0000016098C799B0)
...
function #31 <?:640,674> (89 instructions, 356 bytes at 0000016098C79A40)
...
function #32 <?:676,695> (59 instructions, 236 bytes at 0000016098C79C20)
...
function #33 <?:697,766> (221 instructions, 884 bytes at 0000016098C79D90)
...
function #34 <?:768,771> (17 instructions, 68 bytes at 0000016098C7A0A0)
...
function #35 <?:773,794> (52 instructions, 208 bytes at 0000016098C7A240)
...
function #36 <?:796,798> (5 instructions, 20 bytes at 0000016098C7A3B0)
...
function #37 <?:800,886> (306 instructions, 1224 bytes at 0000016098C7A4A0)
...
function #38 <?:888,899> (16 instructions, 64 bytes at 0000016098C7A6E0)
...
function #39 <?:901,915> (43 instructions, 172 bytes at 0000016098C7A880)
...
function #40 <?:917,928> (37 instructions, 148 bytes at 0000016098C7A9D0)
...
function #41 <?:931,1110> (459 instructions, 1836 bytes at 0000016098C7AAE0)
...
function #42 <?:1112,1119> (31 instructions, 124 bytes at 0000016098C7B790)
...
function #43 <?:1121,1123> (3 instructions, 12 bytes at 0000016098C7BA10)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1122]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1122]	CALL     	R0 1 1 ; R0()
	3	[1123]	RETURN   	R0 1 ; return 

function #44 <?:1125,1208> (182 instructions, 728 bytes at 0000016098C7BAE0)
2 params, 28 slots, 3 upvalues, 0 locals, 51 constants, 0 functions
	...
	105	[1178]	SETTABLE 	R15 K30 R16 ; R15[0x05000044] := R16
...
function #45 <?:1210,1283> (177 instructions, 708 bytes at 0000016098C7BB70)
1 param, 24 slots, 3 upvalues, 0 locals, 49 constants, 0 functions
	...
	100	[1257]	SETTABLE 	R11 K34 R12 ; R11[0x07000038] := R12
...
function #46 <?:1285,1403> (179 instructions, 716 bytes at 0000016098C7BD40)
0 params, 16 slots, 5 upvalues, 0 locals, 53 constants, 4 functions
	...
	166	[1385]	SETTABLE 	R11 K49 R12 ; R11[0x34291f5c] := R12
	...
	174	[1401]	SETTABLE 	R11 K51 R12 ; R11[0xbe190284] := R12
...
function #47 <?:1405,1411> (10 instructions, 40 bytes at 0000016098C7C8F0)
...
function #48 <?:1413,1436> (56 instructions, 224 bytes at 0000016098C7CA70)
...
function #49 <?:1438,1447> (26 instructions, 104 bytes at 0000016098C7CC40)
...
function #50 <?:1449,1475> (93 instructions, 372 bytes at 0000016098C7CCD0)
1 param, 10 slots, 2 upvalues, 0 locals, 20 constants, 0 functions
	...
	69	[1464]	SETTABLE 	R7 K16 R8 ; R7[0x00000001] := R8
	...
	80	[1467]	SETTABLE 	R7 K10 R1 ; R7[0x05000036] := R1
...
function #51 <?:1477,1484> (29 instructions, 116 bytes at 0000016098C7CDB0)
...
function #52 <?:1486,1520> (91 instructions, 364 bytes at 0000016098C7CF60)
...
function #53 <?:1522,1545> (61 instructions, 244 bytes at 0000016098C7CFF0)
...
function #54 <?:1547,1576> (62 instructions, 248 bytes at 0000016098C7D080)
...
function #55 <?:1578,1583> (13 instructions, 52 bytes at 0000016098C7D110)
...
function #56 <?:1585,1647> (178 instructions, 712 bytes at 0000016098C7D2B0)
...
function #57 <?:1649,1651> (5 instructions, 20 bytes at 0000016098C7D340)
2 params, 5 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #58 <?:1653,1837> (467 instructions, 1868 bytes at 0000016098C7D430)
...
function #59 <?:1840,1991> (298 instructions, 1192 bytes at 0000016098C7DE10)
2 params, 45 slots, 5 upvalues, 0 locals, 60 constants, 1 function
	...
	174	[1923]	SETTABLE 	R17 K30 R23 ; R17[0x7b998233] := R23
	...
	182	[1928]	SETTABLE 	R17 K28 R28 ; R17[0x34291f5c] := R28
	...
	246	[1955]	SETTABLE 	R17 K30 R34 ; R17[0x7b998233] := R34
	...
	279	[1982]	SETTABLE 	R42 K50 R43 ; R42[0x450ef75f] := R43
...
function #60 <?:1994,2015> (67 instructions, 268 bytes at 0000016098C7E050)
...
function #61 <?:2017,2047> (88 instructions, 352 bytes at 0000016098C7E130)
...
function #62 <?:2049,2056> (27 instructions, 108 bytes at 0000016098C7E280)
...
function #63 <?:2058,2062> (14 instructions, 56 bytes at 0000016098C7E3F0)
...
function #64 <?:2064,2073> (15 instructions, 60 bytes at 0000016098C7E570)
...
function #65 <?:2076,2086> (35 instructions, 140 bytes at 0000016098C7E6E0)
...
function #66 <?:2088,2107> (72 instructions, 288 bytes at 0000016098C7E850)
...
function #67 <?:2109,2119> (26 instructions, 104 bytes at 0000016098C7E940)
...
function #68 <?:2121,2185> (185 instructions, 740 bytes at 0000016098C7EA30)
8 params, 29 slots, 2 upvalues, 0 locals, 47 constants, 0 functions
	...
	38	[2133]	SETTABLE 	R9 K12 R10 ; R9[0x00000003] := R10
	39	[2133]	SELF     	R10 R0 K15 ; R11 := R0; R10 := R0[0x65d389cb]
	40	[2133]	CALL     	R10 2 2 ; R10 := R10(R11)
	41	[2133]	SETTABLE 	R9 K14 R10 ; R9[0x00000001] := R10
	...
	52	[2135]	SETTABLE 	R9 K12 R10 ; R9[0x00000003] := R10
	53	[2135]	SELF     	R10 R0 K15 ; R11 := R0; R10 := R0[0x65d389cb]
	54	[2135]	CALL     	R10 2 2 ; R10 := R10(R11)
	55	[2135]	SETTABLE 	R9 K14 R10 ; R9[0x00000001] := R10
...
function #69 <?:2187,2303> (399 instructions, 1596 bytes at 0000016098C7EB70)
...
function #70 <?:2305,2307> (5 instructions, 20 bytes at 0000016098C7F250)
2 params, 5 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #71 <?:2309,2311> (12 instructions, 48 bytes at 0000016098C7F340)
...
function #72 <?:2313,2348> (84 instructions, 336 bytes at 0000016098C7F450)
...
function #73 <?:2350,2396> (160 instructions, 640 bytes at 0000016098C7F590)
2 params, 15 slots, 0 upvalues, 0 locals, 40 constants, 0 functions
	...
	80	[2368]	SETTABLE 	R5 K20 R6 ; R5[0x0020803a] := R6
...
function #74 <?:2398,2411> (42 instructions, 168 bytes at 0000016098C7F700)
...
function #75 <?:2413,2418> (14 instructions, 56 bytes at 0000016098C7F7D0)
