...
main <?:0,0> (55 instructions, 220 bytes at 00000160FE60F8A0)
...
function #1 <?:13,15> (8 instructions, 32 bytes at 0000016096B45E30)
...
function #2 <?:17,31> (33 instructions, 132 bytes at 00000160FDE23E80)
...
function #3 <?:33,44> (18 instructions, 72 bytes at 00000160FB8C8F60)
...
function #4 <?:46,69> (45 instructions, 180 bytes at 00000160FB875DB0)
...
function #5 <?:74,93> (38 instructions, 152 bytes at 00000160E3AE0BF0)
...
function #6 <?:95,148> (123 instructions, 492 bytes at 0000016092FBE860)
...
function #7 <?:150,211> (135 instructions, 540 bytes at 0000016093D526D0)
...
function #8 <?:213,222> (28 instructions, 112 bytes at 0000016095946990)
...
function #9 <?:229,342> (278 instructions, 1112 bytes at 0000016095946D60)
...
function #10 <?:344,422> (183 instructions, 732 bytes at 000001608D6BDB50)
2 params, 32 slots, 4 upvalues, 0 locals, 30 constants, 0 functions
	...
	103	[389]	SETTABLE 	R15 K19 R16 ; R15["mColours"] := R16
	...
	177	[417]	SETTABLE 	R28 K29 R19 ; R28["mRawPalette"] := R19
...
function #11 <?:424,535> (269 instructions, 1076 bytes at 00000160F55DF640)
