...
main <?:0,0> (8 instructions, 32 bytes at 0000025274BC94F0)
...
function #1 <?:3,150> (26 instructions, 104 bytes at 0000025274BC95D0)
...
main <?:0,0> (8 instructions, 32 bytes at 00000160C654EEA0)
0+ params, 3 slots, 0 upvalues, 0 locals, 4 constants, 1 function
	1	[1]	GETGLOBAL	R0 K0 ; R0 := 0xaeabecda
	2	[1]	VARARG   	R1 R2 ; R1 := R2 := ...
	3	[1]	GETGLOBAL	R2 K1 ; R2 := package
...
function #1 <?:3,150> (26 instructions, 104 bytes at 00000160C654EFE0)
0 params, 2 slots, 0 upvalues, 0 locals, 13 constants, 9 functions
	1	[4]	NEWTABLE 	R0 0 12 ; R0 := {}
	2	[6]	NEWTABLE 	R1 0 0 ; R1 := {}
	3	[6]	SETTABLE 	R0 K0 R1 ; R0["mTimers"] := R1
