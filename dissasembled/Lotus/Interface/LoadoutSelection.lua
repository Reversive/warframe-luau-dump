...
main <?:0,0> (94 instructions, 376 bytes at 00000160831F9510)
...
function #1 <?:28,30> (4 instructions, 16 bytes at 00000160831F9BA0)
...
function #2 <?:32,175> (303 instructions, 1212 bytes at 00000160831F9C60)
...
function #3 <?:177,179> (1 instruction, 4 bytes at 000001608FECEB00)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[179]	RETURN   	R0 1 ; return 

function #4 <?:181,205> (51 instructions, 204 bytes at 000001608FECEB90)
1 param, 8 slots, 1 upvalue, 0 locals, 15 constants, 0 functions
	...
	11	[185]	SETTABLE 	R2 K3 R0 ; R2[0x0032441c] := R0
...
function #5 <?:207,359> (93 instructions, 372 bytes at 000001608FECEFA0)
...
function #6 <?:361,374> (36 instructions, 144 bytes at 000001608FED22F0)
...
function #7 <?:376,403> (33 instructions, 132 bytes at 000001608FED2620)
...
function #8 <?:405,409> (12 instructions, 48 bytes at 000001608B11CF30)
...
function #9 <?:411,415> (12 instructions, 48 bytes at 000001608B11D080)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #10 <?:417,421> (13 instructions, 52 bytes at 000001608B11D1D0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #11 <?:423,429> (19 instructions, 76 bytes at 000001608B11D340)
...
function #12 <?:431,439> (27 instructions, 108 bytes at 000001608B11D500)
...
function #13 <?:441,459> (56 instructions, 224 bytes at 000001608B11D6F0)
...
function #14 <?:461,465> (10 instructions, 40 bytes at 000001608B11DA40)
...
function #15 <?:467,470> (3 instructions, 12 bytes at 000001608B11DB90)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[469]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[469]	RETURN   	R0 2 ; return R0 
	3	[470]	RETURN   	R0 1 ; return 

function #16 <?:472,475> (3 instructions, 12 bytes at 000001608B11DC20)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[474]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[474]	RETURN   	R0 2 ; return R0 
	3	[475]	RETURN   	R0 1 ; return 

function #17 <?:477,481> (8 instructions, 32 bytes at 000001608B11DCB0)
...
function #18 <?:483,487> (11 instructions, 44 bytes at 000001608B11DE40)
