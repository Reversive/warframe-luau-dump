...
main <?:0,0> (122 instructions, 488 bytes at 000001608B11E1C0)
...
function #1 <?:57,64> (23 instructions, 92 bytes at 000001608B11EC30)
...
function #2 <?:66,74> (25 instructions, 100 bytes at 000001608B11EEC0)
...
function #3 <?:76,80> (11 instructions, 44 bytes at 000001608B11F130)
...
function #4 <?:82,113> (58 instructions, 232 bytes at 000001608B11F2A0)
...
function #5 <?:115,132> (77 instructions, 308 bytes at 000001608B11FCE0)
...
function #6 <?:134,148> (19 instructions, 76 bytes at 000001608B1202A0)
...
function #7 <?:150,176> (21 instructions, 84 bytes at 000001608B120900)
0 params, 4 slots, 2 upvalues, 0 locals, 11 constants, 2 functions
	...
	20	[175]	SETTABLE 	R1 K10 R2 ; R1["mElementDrawCallback"] := R2
	21	[176]	RETURN   	R0 1 ; return 

function #8 <?:178,237> (251 instructions, 1004 bytes at 00000160FCD93AB0)
...
function #9 <?:239,243> (7 instructions, 28 bytes at 00000160FCD94830)
...
function #10 <?:245,246> (1 instruction, 4 bytes at 00000160FCD94930)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[246]	RETURN   	R0 1 ; return 

function #11 <?:248,250> (3 instructions, 12 bytes at 00000160FCD94A00)
...
function #12 <?:252,254> (3 instructions, 12 bytes at 00000160FCD94AD0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[253]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[253]	RETURN   	R0 2 ; return R0 
	3	[254]	RETURN   	R0 1 ; return 

function #13 <?:256,258> (3 instructions, 12 bytes at 00000160FCD94BA0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[257]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[257]	RETURN   	R0 2 ; return R0 
	3	[258]	RETURN   	R0 1 ; return 

function #14 <?:260,268> (42 instructions, 168 bytes at 00000160FCD94C70)
...
function #15 <?:270,279> (27 instructions, 108 bytes at 00000160FCD94F70)
...
function #16 <?:281,283> (5 instructions, 20 bytes at 00000160FCD95170)
...
function #17 <?:285,287> (5 instructions, 20 bytes at 00000160FCD95280)
1 param, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #18 <?:289,291> (4 instructions, 16 bytes at 00000160FCD95390)
...
function #19 <?:293,295> (5 instructions, 20 bytes at 00000160FCD95460)
1 param, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #20 <?:297,299> (5 instructions, 20 bytes at 00000160FCD95570)
1 param, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #21 <?:301,303> (4 instructions, 16 bytes at 00000160FCD95680)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
