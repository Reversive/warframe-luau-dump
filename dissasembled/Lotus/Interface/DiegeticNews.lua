...
main <?:0,0> (142 instructions, 568 bytes at 0000016094AD7650)
...
function #1 <?:29,32> (7 instructions, 28 bytes at 0000016094AD7920)
...
function #2 <?:34,36> (3 instructions, 12 bytes at 0000016094AD7A60)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[35]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[35]	CALL     	R0 1 1 ; R0()
	3	[36]	RETURN   	R0 1 ; return 

function #3 <?:38,47> (28 instructions, 112 bytes at 0000016094AD7AF0)
...
function #4 <?:49,87> (94 instructions, 376 bytes at 0000016094AD7CE0)
...
function #5 <?:89,94> (12 instructions, 48 bytes at 0000016094AD7FD0)
...
function #6 <?:96,127> (109 instructions, 436 bytes at 0000016094AD8110)
...
function #7 <?:129,141> (12 instructions, 48 bytes at 0000016094AD8580)
...
function #8 <?:143,186> (142 instructions, 568 bytes at 0000016094AD8860)
0 params, 19 slots, 9 upvalues, 0 locals, 41 constants, 0 functions
	...
	124	[178]	SETTABLE 	R15 K32 R16 ; R15[0x00000002] := R16
...
function #9 <?:188,305> (77 instructions, 308 bytes at 0000016094AD9190)
...
function #10 <?:307,310> (5 instructions, 20 bytes at 00000160F6D1CB30)
...
function #11 <?:312,321> (44 instructions, 176 bytes at 00000160F6D1CC20)
...
function #12 <?:323,394> (88 instructions, 352 bytes at 00000160F6D1CEC0)
0 params, 8 slots, 7 upvalues, 0 locals, 30 constants, 4 functions
	...
	41	[336]	SETTABLE 	R3 K21 R1 ; R3[0x32302b4a] := R1
...
function #13 <?:396,414> (39 instructions, 156 bytes at 00000160F6D1E080)
...
function #14 <?:416,418> (6 instructions, 24 bytes at 00000160F6D1E320)
...
function #15 <?:420,447> (86 instructions, 344 bytes at 00000160F6D1E410)
...
function #16 <?:449,453> (21 instructions, 84 bytes at 00000160F6D1E8F0)
...
function #17 <?:455,460> (8 instructions, 32 bytes at 00000160F6D1EAB0)
...
function #18 <?:462,464> (7 instructions, 28 bytes at 00000160F6D1EBA0)
...
function #19 <?:466,468> (9 instructions, 36 bytes at 00000160F6D1EC90)
0 params, 2 slots, 2 upvalues, 0 locals, 0 constants, 0 functions
...
function #20 <?:470,474> (12 instructions, 48 bytes at 00000160F6D1EDA0)
...
function #21 <?:476,480> (12 instructions, 48 bytes at 00000160F6D1EEF0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #22 <?:482,486> (15 instructions, 60 bytes at 00000160F6D1F040)
...
function #23 <?:488,492> (12 instructions, 48 bytes at 00000160F6D1F1B0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #24 <?:494,498> (12 instructions, 48 bytes at 00000160F6D1F300)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #25 <?:500,504> (15 instructions, 60 bytes at 00000160F6D1F450)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #26 <?:506,510> (7 instructions, 28 bytes at 00000160F6D1F5C0)
