...
main <?:0,0> (196 instructions, 784 bytes at 000001608F439860)
...
function #1 <?:69,74> (14 instructions, 56 bytes at 000001608F43A0B0)
...
function #2 <?:76,95> (49 instructions, 196 bytes at 000001608F43A260)
...
function #3 <?:97,106> (18 instructions, 72 bytes at 000001608F43A5B0)
...
function #4 <?:108,110> (3 instructions, 12 bytes at 000001608F43A760)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[109]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[109]	CALL     	R0 1 1 ; R0()
	3	[110]	RETURN   	R0 1 ; return 

function #5 <?:112,124> (36 instructions, 144 bytes at 000001608F43A830)
...
function #6 <?:126,137> (46 instructions, 184 bytes at 000001608F43AC70)
...
function #7 <?:139,159> (91 instructions, 364 bytes at 000001608F43B060)
...
function #8 <?:161,163> (10 instructions, 40 bytes at 000001608F43B540)
...
function #9 <?:165,178> (36 instructions, 144 bytes at 000001608F43B690)
...
function #10 <?:180,200> (82 instructions, 328 bytes at 000001608F43B930)
...
function #11 <?:202,220> (32 instructions, 128 bytes at 000001608F43C0E0)
...
function #12 <?:222,239> (7 instructions, 28 bytes at 000001608F43C2F0)
...
function #13 <?:241,313> (126 instructions, 504 bytes at 000001608F43C700)
...
function #14 <?:315,627> (118 instructions, 472 bytes at 0000016094408A50)
...
function #15 <?:629,630> (1 instruction, 4 bytes at 000001608CC5C4D0)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[630]	RETURN   	R0 1 ; return 

function #16 <?:632,637> (14 instructions, 56 bytes at 000001608CC5C5A0)
...
function #17 <?:639,645> (21 instructions, 84 bytes at 000001608CC5C740)
...
function #18 <?:647,667> (55 instructions, 220 bytes at 000001608CC5CA20)
...
function #19 <?:669,674> (16 instructions, 64 bytes at 000001608CC5CE20)
...
function #20 <?:676,680> (13 instructions, 52 bytes at 000001608CC5CFE0)
...
function #21 <?:682,692> (27 instructions, 108 bytes at 000001608CC5D180)
...
function #22 <?:694,770> (61 instructions, 244 bytes at 000001608CC5D420)
...
function #23 <?:772,793> (103 instructions, 412 bytes at 000001608CC5E5C0)
...
function #24 <?:795,864> (184 instructions, 736 bytes at 000001608CC5F1C0)
...
function #25 <?:866,887> (39 instructions, 156 bytes at 000001608CC5FD40)
...
function #26 <?:889,907> (34 instructions, 136 bytes at 000001608CC5FFD0)
...
function #27 <?:909,915> (14 instructions, 56 bytes at 000001608CC60250)
...
function #28 <?:917,923> (14 instructions, 56 bytes at 000001608BE826E0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #29 <?:925,931> (11 instructions, 44 bytes at 000001608BE82850)
...
function #30 <?:933,939> (11 instructions, 44 bytes at 000001608BE829A0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #31 <?:941,943> (3 instructions, 12 bytes at 000001608BE82AF0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[942]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[942]	RETURN   	R0 2 ; return R0 
	3	[943]	RETURN   	R0 1 ; return 

function #32 <?:945,947> (3 instructions, 12 bytes at 000001608BE82BC0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[946]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[946]	RETURN   	R0 2 ; return R0 
	3	[947]	RETURN   	R0 1 ; return 

function #33 <?:949,959> (22 instructions, 88 bytes at 000001608BE82C90)
...
function #34 <?:961,979> (13 instructions, 52 bytes at 000001608BE82EA0)
...
function #35 <?:981,987> (30 instructions, 120 bytes at 000001608BE83400)
