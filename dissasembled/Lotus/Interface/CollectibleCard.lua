...
main <?:0,0> (62 instructions, 248 bytes at 0000016092C46A90)
...
function #1 <?:22,35> (35 instructions, 140 bytes at 000001609A4E0200)
...
function #2 <?:37,45> (25 instructions, 100 bytes at 000001609A4E05F0)
...
function #3 <?:47,53> (26 instructions, 104 bytes at 000001609A4E07E0)
...
function #4 <?:55,61> (24 instructions, 96 bytes at 000001609A4E0AE0)
...
function #5 <?:63,80> (76 instructions, 304 bytes at 000001609A4E0D20)
...
function #6 <?:82,87> (13 instructions, 52 bytes at 000001609A4E10F0)
...
function #7 <?:89,124> (102 instructions, 408 bytes at 000001609A4E11D0)
...
function #8 <?:126,150> (61 instructions, 244 bytes at 000001609A4E1830)
...
function #9 <?:152,154> (3 instructions, 12 bytes at 000001609A4E1BB0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[153]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[153]	RETURN   	R0 2 ; return R0 
	3	[154]	RETURN   	R0 1 ; return 

function #10 <?:156,158> (3 instructions, 12 bytes at 000001609A4E1C80)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[157]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[157]	RETURN   	R0 2 ; return R0 
	3	[158]	RETURN   	R0 1 ; return 

function #11 <?:160,164> (7 instructions, 28 bytes at 000001609A4E1D50)
