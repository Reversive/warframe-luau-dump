...
main <?:0,0> (86 instructions, 344 bytes at 00000160860EFB80)
...
function #1 <?:23,29> (16 instructions, 64 bytes at 00000160860F0030)
...
function #2 <?:31,48> (99 instructions, 396 bytes at 00000160860F0160)
0 params, 9 slots, 4 upvalues, 0 locals, 26 constants, 0 functions
	...
	14	[33]	SETTABLE 	R0 K3 R1 ; R0["Background1Object"] := R1
	...
	21	[34]	SETTABLE 	R0 K5 R1 ; R0["Content"] := R1
...
function #3 <?:50,144> (38 instructions, 152 bytes at 00000160860F0760)
0 params, 5 slots, 5 upvalues, 0 locals, 14 constants, 4 functions
	...
	24	[80]	SETTABLE 	R2 K10 R3 ; R2[0xc0a3774b] := R3
	...
	31	[123]	SETTABLE 	R2 K11 R3 ; R2["mElementDrawCallback"] := R3
...
function #4 <?:146,157> (30 instructions, 120 bytes at 00000160860F22E0)
...
function #5 <?:159,165> (25 instructions, 100 bytes at 00000160860F25E0)
...
function #6 <?:167,184> (26 instructions, 104 bytes at 00000160860F2780)
...
function #7 <?:186,230> (128 instructions, 512 bytes at 00000160860F2990)
...
function #8 <?:232,238> (22 instructions, 88 bytes at 00000160860F3240)
...
function #9 <?:240,243> (21 instructions, 84 bytes at 00000160860F33E0)
...
function #10 <?:245,250> (17 instructions, 68 bytes at 00000160860F35C0)
...
function #11 <?:252,256> (15 instructions, 60 bytes at 00000160860F38A0)
...
function #12 <?:258,261> (8 instructions, 32 bytes at 00000160860F3A30)
...
function #13 <?:263,266> (15 instructions, 60 bytes at 00000160860F3B40)
...
function #14 <?:268,286> (60 instructions, 240 bytes at 00000160860F3CE0)
...
function #15 <?:288,306> (69 instructions, 276 bytes at 00000160860F4090)
0 params, 7 slots, 8 upvalues, 0 locals, 16 constants, 3 functions
	...
	58	[303]	SETTABLE 	R0 K13 R1 ; R0["TaskListSetChallenges"] := R1
	...
	68	[305]	SETTABLE 	R0 K15 R1 ; R0[0xc1a36e10] := R1
	69	[306]	RETURN   	R0 1 ; return 

function #16 <?:308,320> (41 instructions, 164 bytes at 0000016085C2E770)
