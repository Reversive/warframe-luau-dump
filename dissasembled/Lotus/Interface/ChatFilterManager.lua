...
main <?:0,0> (146 instructions, 584 bytes at 000001608BE04FE0)
...
function #1 <?:27,29> (3 instructions, 12 bytes at 000001608BE05930)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[28]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[28]	RETURN   	R0 2 ; return R0 
	3	[29]	RETURN   	R0 1 ; return 

function #2 <?:31,39> (28 instructions, 112 bytes at 000001608BE059C0)
...
function #3 <?:41,43> (4 instructions, 16 bytes at 000001608BE05BB0)
...
function #4 <?:45,59> (31 instructions, 124 bytes at 000001608BE05CB0)
...
function #5 <?:61,72> (73 instructions, 292 bytes at 000001608BE05F50)
...
function #6 <?:74,130> (122 instructions, 488 bytes at 000001608BE06920)
1 param, 17 slots, 5 upvalues, 0 locals, 25 constants, 0 functions
	...
	86	[114]	SETTABLE 	R10 K10 R11 ; R10["Include"] := R11
	...
	95	[118]	SETTABLE 	R11 K10 R12 ; R11["Include"] := R12
...
function #7 <?:132,138> (14 instructions, 56 bytes at 000001608BE07090)
...
function #8 <?:140,142> (3 instructions, 12 bytes at 000001608BE071C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[141]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[141]	CALL     	R0 1 1 ; R0()
	3	[142]	RETURN   	R0 1 ; return 

function #9 <?:144,150> (29 instructions, 116 bytes at 000001608BE07290)
...
function #10 <?:152,236> (53 instructions, 212 bytes at 000001608BE07560)
...
function #11 <?:238,261> (60 instructions, 240 bytes at 00000160F5CF7300)
...
function #12 <?:263,278> (88 instructions, 352 bytes at 00000160F5CF7850)
...
function #13 <?:280,339> (260 instructions, 1040 bytes at 00000160F5CF7FE0)
...
function #14 <?:341,343> (6 instructions, 24 bytes at 00000160F5CF90E0)
...
function #15 <?:345,347> (2 instructions, 8 bytes at 00000160FB0E5B80)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[346]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[347]	RETURN   	R0 1 ; return 

function #16 <?:349,352> (13 instructions, 52 bytes at 00000160FB0E5C50)
...
function #17 <?:354,360> (6 instructions, 24 bytes at 00000160FB0E5E40)
...
function #18 <?:362,369> (18 instructions, 72 bytes at 00000160FB0E5F30)
...
function #19 <?:371,373> (3 instructions, 12 bytes at 00000160FB0E60F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[372]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[372]	CALL     	R0 1 1 ; R0()
	3	[373]	RETURN   	R0 1 ; return 

function #20 <?:375,379> (15 instructions, 60 bytes at 00000160FB0E61C0)
...
function #21 <?:381,385> (12 instructions, 48 bytes at 00000160FB0E6330)
...
function #22 <?:387,391> (12 instructions, 48 bytes at 00000160FB0E6480)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #23 <?:393,396> (14 instructions, 56 bytes at 00000160FB0E65D0)
...
function #24 <?:398,401> (14 instructions, 56 bytes at 00000160FB0E6760)
0 params, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #25 <?:403,406> (11 instructions, 44 bytes at 00000160FB0E68F0)
0 params, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #26 <?:408,412> (6 instructions, 24 bytes at 00000160FB0E6A60)
...
function #27 <?:414,418> (14 instructions, 56 bytes at 00000160FB0E6B50)
...
function #28 <?:420,424> (24 instructions, 96 bytes at 00000160FB0E6CD0)
...
function #29 <?:426,430> (6 instructions, 24 bytes at 00000160FB0E6F60)
...
function #30 <?:432,436> (24 instructions, 96 bytes at 00000160FB0E7050)
...
function #31 <?:438,442> (8 instructions, 32 bytes at 00000160FB0E7230)
...
function #32 <?:444,448> (6 instructions, 24 bytes at 00000160FB0E7350)
