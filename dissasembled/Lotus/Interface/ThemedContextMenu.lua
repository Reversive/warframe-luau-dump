...
main <?:0,0> (40 instructions, 160 bytes at 00000160F8206540)
...
function #1 <?:9,91> (44 instructions, 176 bytes at 0000016086C112A0)
...
function #2 <?:93,118> (59 instructions, 236 bytes at 0000016093A3FC20)
...
function #3 <?:120,128> (30 instructions, 120 bytes at 0000016092B85760)
...
function #4 <?:130,135> (15 instructions, 60 bytes at 0000016092B75AD0)
...
function #5 <?:137,178> (83 instructions, 332 bytes at 00000160937496E0)
...
function #6 <?:180,182> (3 instructions, 12 bytes at 000001608EA9A4A0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[181]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[181]	RETURN   	R0 2 ; return R0 
	3	[182]	RETURN   	R0 1 ; return 

function #7 <?:184,185> (1 instruction, 4 bytes at 000001608DCE8950)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[185]	RETURN   	R0 1 ; return 

function #8 <?:187,191> (12 instructions, 48 bytes at 0000016087CFA580)
...
function #9 <?:193,197> (12 instructions, 48 bytes at 0000016087CF9B40)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
