...
main <?:0,0> (429 instructions, 1716 bytes at 00000160951097A0)
...
function #1 <?:103,124> (42 instructions, 168 bytes at 000001609510A8E0)
...
function #2 <?:126,128> (20 instructions, 80 bytes at 000001609510AAF0)
...
function #3 <?:131,133> (8 instructions, 32 bytes at 000001609510AC90)
...
function #4 <?:136,138> (7 instructions, 28 bytes at 000001609510ADC0)
...
function #5 <?:140,147> (49 instructions, 196 bytes at 000001609510AEF0)
...
function #6 <?:149,158> (57 instructions, 228 bytes at 000001609510B230)
...
function #7 <?:160,166> (34 instructions, 136 bytes at 000001609510B510)
...
function #8 <?:168,170> (7 instructions, 28 bytes at 000001609510B780)
...
function #9 <?:172,194> (51 instructions, 204 bytes at 000001609510B870)
...
function #10 <?:196,206> (37 instructions, 148 bytes at 000001609510BBB0)
...
function #11 <?:208,256> (142 instructions, 568 bytes at 000001609510BE00)
...
function #12 <?:258,274> (30 instructions, 120 bytes at 000001609510C480)
...
function #13 <?:276,303> (93 instructions, 372 bytes at 000001609510C680)
...
function #14 <?:305,493> (656 instructions, 2624 bytes at 000001609510CAF0)
0 params, 71 slots, 38 upvalues, 0 locals, 51 constants, 0 functions
	...
	352	[404]	SETTABLE 	R21 K7 R22 ; R21[2.000000] := R22
	...
	430	[431]	SETTABLE 	R39 K7 R40 ; R39[2.000000] := R40
...
function #15 <?:495,513> (51 instructions, 204 bytes at 000001609510D950)
...
function #16 <?:515,523> (16 instructions, 64 bytes at 0000016086C154B0)
...
function #17 <?:525,527> (3 instructions, 12 bytes at 0000016086C156C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[526]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[526]	CALL     	R0 1 1 ; R0()
	3	[527]	RETURN   	R0 1 ; return 

function #18 <?:529,532> (4 instructions, 16 bytes at 0000016086C15790)
...
function #19 <?:534,546> (29 instructions, 116 bytes at 0000016086C15860)
...
function #20 <?:548,564> (111 instructions, 444 bytes at 0000016086C15C50)
...
function #21 <?:566,690> (483 instructions, 1932 bytes at 0000016086C16390)
...
function #22 <?:692,734> (231 instructions, 924 bytes at 0000016086C17FC0)
...
function #23 <?:736,792> (91 instructions, 364 bytes at 0000016086C18D10)
0 params, 7 slots, 10 upvalues, 0 locals, 30 constants, 9 functions
	...
	34	[743]	SETTABLE 	R2 K8 R3 ; R2[0x9cff6533] := R3
	...
	39	[745]	SETTABLE 	R2 K12 R3 ; R2[0x1a94c9cc] := R3
...
function #24 <?:794,810> (43 instructions, 172 bytes at 0000016093AD31A0)
...
function #25 <?:812,833> (99 instructions, 396 bytes at 0000016093AD34E0)
0 params, 11 slots, 4 upvalues, 0 locals, 16 constants, 0 functions
	...
	34	[820]	SETTABLE 	R8 K7 R9 ; R8["mIsRect"] := R9
...
function #26 <?:835,840> (21 instructions, 84 bytes at 0000016093AD39C0)
...
function #27 <?:842,849> (16 instructions, 64 bytes at 0000016093AD3CA0)
...
function #28 <?:851,880> (82 instructions, 328 bytes at 0000016093AD3E20)
...
function #29 <?:882,893> (28 instructions, 112 bytes at 0000016093AD42A0)
...
function #30 <?:895,915> (58 instructions, 232 bytes at 0000016093AD44D0)
...
function #31 <?:917,972> (161 instructions, 644 bytes at 0000016093AD4870)
...
function #32 <?:974,1094> (394 instructions, 1576 bytes at 0000016093AD5C40)
1 param, 34 slots, 15 upvalues, 0 locals, 84 constants, 1 function
	...
	233	[1038]	SETTABLE 	R14 K51 R15 ; R14[0x07000000] := R15
	...
	248	[1039]	SETTABLE 	R14 K54 R15 ; R14[0x0000001b] := R15
...
function #33 <?:1096,1179> (311 instructions, 1244 bytes at 00000160950CFD30)
...
function #34 <?:1181,1276> (260 instructions, 1040 bytes at 00000160950D0D70)
...
function #35 <?:1278,1289> (20 instructions, 80 bytes at 00000160950D1A80)
...
function #36 <?:1291,1295> (25 instructions, 100 bytes at 00000160950D1C70)
...
function #37 <?:1297,1302> (24 instructions, 96 bytes at 00000160950D1EA0)
...
function #38 <?:1304,1308> (11 instructions, 44 bytes at 00000160950D20A0)
...
function #39 <?:1310,1314> (12 instructions, 48 bytes at 00000160950D21E0)
...
function #40 <?:1316,1320> (12 instructions, 48 bytes at 00000160950D2330)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #41 <?:1322,1326> (16 instructions, 64 bytes at 00000160950D2480)
...
function #42 <?:1328,1332> (12 instructions, 48 bytes at 00000160950D25F0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #43 <?:1334,1338> (12 instructions, 48 bytes at 00000160950D2740)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #44 <?:1340,1344> (16 instructions, 64 bytes at 00000160950D2890)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #45 <?:1346,1348> (3 instructions, 12 bytes at 00000160950D2A00)
