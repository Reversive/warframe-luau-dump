...
main <?:0,0> (385 instructions, 1540 bytes at 00000160FDEB6A70)
...
function #1 <?:124,131> (23 instructions, 92 bytes at 00000160FDEB7EE0)
...
function #2 <?:133,135> (5 instructions, 20 bytes at 00000160FDEB8120)
...
function #3 <?:137,145> (15 instructions, 60 bytes at 00000160FDEB8210)
...
function #4 <?:147,158> (19 instructions, 76 bytes at 00000160FDEB8430)
...
function #5 <?:160,172> (36 instructions, 144 bytes at 00000160FDEB8660)
...
function #6 <?:174,180> (19 instructions, 76 bytes at 00000160FDEB8BA0)
...
function #7 <?:182,201> (34 instructions, 136 bytes at 00000160F6F16E50)
...
function #8 <?:203,209> (11 instructions, 44 bytes at 00000160F6F170B0)
...
function #9 <?:211,213> (3 instructions, 12 bytes at 00000160F6F17200)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[212]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[212]	CALL     	R0 1 1 ; R0()
	3	[213]	RETURN   	R0 1 ; return 

function #10 <?:215,225> (22 instructions, 88 bytes at 00000160F6F172B0)
...
function #11 <?:227,236> (28 instructions, 112 bytes at 00000160F6F174F0)
...
function #12 <?:238,251> (61 instructions, 244 bytes at 00000160F6F17760)
...
function #13 <?:253,283> (128 instructions, 512 bytes at 00000160F6F17D20)
...
function #14 <?:285,315> (34 instructions, 136 bytes at 00000160F6F183D0)
...
function #15 <?:317,362> (95 instructions, 380 bytes at 00000160F6F18E60)
...
function #16 <?:364,393> (68 instructions, 272 bytes at 00000160F6F19300)
...
function #17 <?:395,429> (149 instructions, 596 bytes at 00000160F6F19830)
...
function #18 <?:431,473> (111 instructions, 444 bytes at 00000160F6F1A210)
...
function #19 <?:475,658> (96 instructions, 384 bytes at 00000160F6F1AA30)
0 params, 7 slots, 24 upvalues, 0 locals, 27 constants, 11 functions
	...
	66	[602]	SETTABLE 	R1 K21 R2 ; R1[0x8010000a] := R2
	...
	85	[635]	SETTABLE 	R1 K25 R2 ; R1[0x00000001] := R2
...
function #20 <?:660,770> (292 instructions, 1168 bytes at 0000016083245520)
...
function #21 <?:772,776> (15 instructions, 60 bytes at 00000160832464E0)
...
function #22 <?:778,784> (13 instructions, 52 bytes at 0000016083246650)
...
function #23 <?:786,794> (53 instructions, 212 bytes at 00000160832467A0)
...
function #24 <?:796,875> (212 instructions, 848 bytes at 0000016083246AD0)
...
function #25 <?:877,890> (32 instructions, 128 bytes at 00000160832476F0)
...
function #26 <?:892,912> (58 instructions, 232 bytes at 0000016083247910)
...
function #27 <?:914,934> (62 instructions, 248 bytes at 00000160873B7F40)
...
function #28 <?:936,950> (34 instructions, 136 bytes at 00000160873B8360)
...
function #29 <?:952,1006> (165 instructions, 660 bytes at 00000160873B85F0)
...
function #30 <?:1008,1026> (29 instructions, 116 bytes at 00000160873B8F10)
...
function #31 <?:1028,1147> (290 instructions, 1160 bytes at 00000160873B9370)
...
function #32 <?:1149,1180> (76 instructions, 304 bytes at 00000160873BA360)
...
function #33 <?:1182,1187> (22 instructions, 88 bytes at 00000160873BA7F0)
...
function #34 <?:1189,1195> (14 instructions, 56 bytes at 00000160873BA9E0)
...
function #35 <?:1197,1203> (14 instructions, 56 bytes at 00000160873BAB50)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #36 <?:1205,1211> (11 instructions, 44 bytes at 00000160873BACC0)
...
function #37 <?:1213,1219> (11 instructions, 44 bytes at 00000160873BAE10)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #38 <?:1221,1227> (14 instructions, 56 bytes at 00000160873BAF60)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #39 <?:1229,1235> (14 instructions, 56 bytes at 00000160873BB0D0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #40 <?:1237,1243> (11 instructions, 44 bytes at 00000160873BB240)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #41 <?:1245,1251> (11 instructions, 44 bytes at 00000160873BB390)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #42 <?:1253,1255> (3 instructions, 12 bytes at 00000160873BB4E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1254]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1254]	RETURN   	R0 2 ; return R0 
	3	[1255]	RETURN   	R0 1 ; return 

function #43 <?:1257,1259> (3 instructions, 12 bytes at 00000160873BB5B0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1258]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1258]	RETURN   	R0 2 ; return R0 
	3	[1259]	RETURN   	R0 1 ; return 

function #44 <?:1261,1264> (5 instructions, 20 bytes at 00000160873BB680)
...
function #45 <?:1266,1276> (1 instruction, 4 bytes at 00000160873BB770)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1276]	RETURN   	R0 1 ; return 

function #46 <?:1278,1331> (121 instructions, 484 bytes at 00000160873BB840)
...
function #47 <?:1333,1335> (8 instructions, 32 bytes at 00000160873BC000)
...
function #48 <?:1337,1339> (3 instructions, 12 bytes at 00000160873BC190)
