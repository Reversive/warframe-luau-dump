...
main <?:0,0> (12 instructions, 48 bytes at 0000016098CBF0B0)
...
function #1 <?:5,121> (69 instructions, 276 bytes at 0000016098CBF1D0)
4 params, 13 slots, 1 upvalue, 0 locals, 27 constants, 6 functions
	...
	44	[63]	SETTABLE 	R4 K21 R5 ; R4["Update"] := R5
	45	[93]	CLOSURE  	R5 3 ; R5 := closure(Function #4)
	46	[93]	SETTABLE 	R4 K22 R5 ; R4["Redraw"] := R5
