...
main <?:0,0> (8 instructions, 32 bytes at 0000025274F59DE0)
...
function #1 <?:3,199> (86 instructions, 344 bytes at 0000025274F59EF0)
...
main <?:0,0> (8 instructions, 32 bytes at 00000160C6864030)
0+ params, 3 slots, 0 upvalues, 0 locals, 4 constants, 1 function
	1	[1]	GETGLOBAL	R0 K0 ; R0 := 0xaeabecda
	2	[1]	VARARG   	R1 R2 ; R1 := R2 := ...
	3	[1]	GETGLOBAL	R2 K1 ; R2 := package
...
function #1 <?:3,199> (86 instructions, 344 bytes at 00000160C6865220)
4 params, 12 slots, 0 upvalues, 0 locals, 43 constants, 13 functions
	1	[4]	GETGLOBAL	R4 K0 ; R4 := 0x2d0fad09
	2	[4]	LOADK    	R5 K1 ; R5 := "EE.Interface.Utilities"
	3	[4]	CALL     	R4 2 2 ; R4 := R4(R5)
