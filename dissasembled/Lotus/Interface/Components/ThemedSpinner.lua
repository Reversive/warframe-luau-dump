...
main <?:0,0> (20 instructions, 80 bytes at 00000160D824E9C0)
...
function #1 <?:7,168> (117 instructions, 468 bytes at 00000160D824EC10)
3 params, 10 slots, 3 upvalues, 0 locals, 41 constants, 11 functions
	...
	3	[11]	SETTABLE 	R3 K1 R1 ; R3[0x00000035] := R1
	...
	37	[148]	SETTABLE 	R3 K22 R4 ; R3[0x00000034] := R4
