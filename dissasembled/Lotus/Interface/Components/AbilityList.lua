...
main <?:0,0> (46 instructions, 184 bytes at 00000160821F2BE0)
...
function #1 <?:13,66> (123 instructions, 492 bytes at 00000160821972A0)
10 params, 22 slots, 1 upvalue, 0 locals, 40 constants, 0 functions
	...
	80	[51]	SETTABLE 	R16 K20 R12 ; R16[0x71e9ac81] := R12
	...
	92	[53]	SETTABLE 	R16 K25 R15 ; R16[0x00fa676f] := R15
	...
	102	[55]	SETTABLE 	R16 K28 R17 ; R16[0xf64b7262] := R17
	...
	113	[57]	SETTABLE 	R16 K31 R17 ; R16[0x6c97a788] := R17
	...
	118	[59]	SETTABLE 	R16 K37 R5 ; R16[0xd5181643] := R5
...
function #2 <?:68,70> (14 instructions, 56 bytes at 0000016082160BE0)
...
function #3 <?:72,352> (79 instructions, 316 bytes at 0000016097B22F50)
2 params, 9 slots, 4 upvalues, 0 locals, 52 constants, 9 functions
	...
	47	[105]	SETTABLE 	R3 K42 R4 ; R3[0x25312c9b] := R4
	...
	57	[205]	SETTABLE 	R3 K45 R4 ; R3[0xbd496aa1] := R4
