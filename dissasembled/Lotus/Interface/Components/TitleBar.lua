...
main <?:0,0> (34 instructions, 136 bytes at 0000025274E684B0)
...
function #1 <?:12,168> (62 instructions, 248 bytes at 0000025274E673F0)
...
main <?:0,0> (34 instructions, 136 bytes at 00000160C67744A0)
0+ params, 4 slots, 0 upvalues, 0 locals, 19 constants, 1 function
	1	[1]	GETGLOBAL	R0 K0 ; R0 := 0xaeabecda
	2	[1]	VARARG   	R1 R2 ; R1 := R2 := ...
	3	[1]	GETGLOBAL	R2 K1 ; R2 := package
...
function #1 <?:12,168> (62 instructions, 248 bytes at 00000160C67733E0)
5 params, 10 slots, 3 upvalues, 0 locals, 32 constants, 10 functions
	1	[13]	NEWTABLE 	R5 0 19 ; R5 := {}
	2	[15]	SETTABLE 	R5 K0 R0 ; R5["mMovie"] := R0
	3	[16]	SETTABLE 	R5 K1 R1 ; R5["mClipName"] := R1
