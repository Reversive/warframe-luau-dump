...
main <?:0,0> (8 instructions, 32 bytes at 0000025274E5E4E0)
...
function #1 <?:3,166> (56 instructions, 224 bytes at 0000025274E5E5F0)
...
main <?:0,0> (8 instructions, 32 bytes at 00000160C676A4D0)
0+ params, 3 slots, 0 upvalues, 0 locals, 4 constants, 1 function
	1	[1]	GETGLOBAL	R0 K0 ; R0 := 0xaeabecda
	2	[1]	VARARG   	R1 R2 ; R1 := R2 := ...
	3	[1]	GETGLOBAL	R2 K1 ; R2 := package
...
function #1 <?:3,166> (56 instructions, 224 bytes at 00000160C676A5E0)
2 params, 8 slots, 0 upvalues, 0 locals, 41 constants, 6 functions
	1	[5]	GETGLOBAL	R2 K0 ; R2 := 0x2d0fad09
	2	[5]	LOADK    	R3 K1 ; R3 := "EE.Interface.Utilities"
	3	[5]	CALL     	R2 2 2 ; R2 := R2(R3)
