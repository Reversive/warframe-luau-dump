...
main <?:0,0> (8 instructions, 32 bytes at 0000016098CBF990)
...
8 params, 13 slots, 0 upvalues, 0 locals, 84 constants, 15 functions
	...
	72	[242]	SETTABLE 	R8 K66 R9 ; R8["SetDefaultColors"] := R9
	...
	76	[276]	SETTABLE 	R8 K68 R9 ; R8["RollOut"] := R9
