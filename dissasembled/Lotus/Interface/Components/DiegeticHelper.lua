...
main <?:0,0> (12 instructions, 48 bytes at 0000016095D83350)
...
function #1 <?:5,294> (71 instructions, 284 bytes at 00000160F54FC920)
1 param, 5 slots, 1 upvalue, 0 locals, 65 constants, 8 functions
	1	[6]	NEWTABLE 	R1 0 27 ; R1 := {}
	2	[8]	SETTABLE 	R1 K0 R0 ; R1["mMovie"] := R0
	...
	23	[15]	SETTABLE 	R1 K13 R2 ; R1["mSmoothCursorY"] := R2
	...
	49	[39]	SETTABLE 	R1 K51 R2 ; R1[0x00000000] := R2
	...
	58	[105]	SETTABLE 	R1 K59 R2 ; R1[0x00000001] := R2
	...
	64	[189]	SETTABLE 	R1 K62 R2 ; R1[0x00000000] := R2
