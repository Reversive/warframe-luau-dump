...
main <?:0,0> (64 instructions, 256 bytes at 0000016098CC1850)
...
function #1 <?:21,26> (10 instructions, 40 bytes at 0000016098CC1B30)
...
function #2 <?:27,158> (269 instructions, 1076 bytes at 0000016098CC1C40)
1 param, 52 slots, 1 upvalue, 0 locals, 37 constants, 0 functions
	1	[28]	NEWTABLE 	R1 0 0 ; R1 := {}
	2	[28]	SETTABLE 	R0 K0 R1 ; R0[0x0c000032] := R1
...
function #3 <?:159,171> (15 instructions, 60 bytes at 0000016098CC2360)
...
function #4 <?:172,184> (22 instructions, 88 bytes at 0000016098CC2490)
