...
main <?:0,0> (16 instructions, 64 bytes at 00000160FD342490)
...
function #1 <?:6,378> (132 instructions, 528 bytes at 0000016098BE6000)
3 params, 11 slots, 2 upvalues, 0 locals, 81 constants, 16 functions
	...
	36	[18]	SETTABLE 	R4 K18 R5 ; R4["mInitialRootX"] := R5
	...
	42	[20]	SETTABLE 	R4 K22 R5 ; R4["Modes"] := R5
	...
	66	[36]	SETTABLE 	R4 K52 R5 ; R4[0x25312c9b] := R5
	...
	75	[43]	SETTABLE 	R4 K58 R5 ; R4[0xc0a3774b] := R5
	76	[47]	CLOSURE  	R5 1 ; R5 := closure(Function #2)
	77	[47]	SETTABLE 	R4 K60 R5 ; R4[0x087cbd3f] := R5
	78	[51]	CLOSURE  	R5 2 ; R5 := closure(Function #3)
	79	[51]	SETTABLE 	R4 K61 R5 ; R4[0x659d451f] := R5
	80	[60]	CLOSURE  	R5 3 ; R5 := closure(Function #4)
	81	[60]	GETUPVAL 	R0 U0 ; R0 := U0
	82	[60]	SETTABLE 	R4 K62 R5 ; R4[0x0032441c] := R5
	...
	116	[321]	SETTABLE 	R4 K73 R5 ; R4[0x00000000] := R5
