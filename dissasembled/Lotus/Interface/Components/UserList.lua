...
main <?:0,0> (20 instructions, 80 bytes at 0000016092A33A60)
...
function #1 <?:7,1038> (569 instructions, 2276 bytes at 0000016092A33BE0)
9 params, 33 slots, 3 upvalues, 0 locals, 202 constants, 41 functions
	...
	121	[66]	SETTABLE 	R10 K68 R13 ; R10["GetParentEnv"] := R13
	122	[79]	CLOSURE  	R13 1 ; R13 := closure(Function #2)
	123	[79]	SETTABLE 	R10 K69 R13 ; R10["HideMenus"] := R13
	124	[102]	CLOSURE  	R13 2 ; R13 := closure(Function #3)
	125	[102]	SETTABLE 	R10 K70 R13 ; R10["GetPlanetAndNodeFromNodeName"] := R13
	126	[136]	CLOSURE  	R13 3 ; R13 := closure(Function #4)
	127	[136]	GETUPVAL 	R0 U0 ; R0 := U0
	128	[136]	SETTABLE 	R10 K71 R13 ; R10[0x6f43746e] := R13
	129	[175]	CLOSURE  	R13 4 ; R13 := closure(Function #5)
	130	[175]	GETUPVAL 	R0 U2 ; R0 := U2
	131	[175]	GETUPVAL 	R0 U1 ; R0 := U1
	132	[175]	SETTABLE 	R10 K72 R13 ; R10["GetSessionPlayers"] := R13
	133	[177]	GETTABLE 	R13 R10 K74 ; R13 := R10["Redraw"]
	134	[177]	SETTABLE 	R10 K73 R13 ; R10["_UserList_Redraw"] := R13
	135	[204]	CLOSURE  	R13 5 ; R13 := closure(Function #6)
	136	[204]	SETTABLE 	R10 K74 R13 ; R10["Redraw"] := R13
	...
	160	[473]	SETTABLE 	R10 K83 R13 ; R10["OnDraw"] := R13
	...
	164	[485]	SETTABLE 	R10 K85 R13 ; R10["GetUsers"] := R13
	165	[526]	CLOSURE  	R13 12 ; R13 := closure(Function #13)
	166	[526]	SETTABLE 	R10 K86 R13 ; R10["BuildUser"] := R13
	...
	174	[594]	SETTABLE 	R10 K89 R13 ; R10["HookUpCallbacks"] := R13
	...
	186	[633]	SETTABLE 	R10 K94 R13 ; R10["_NextCategory"] := R13
	...
	233	[742]	SETTABLE 	R13 K83 R14 ; R13["OnDraw"] := R14
	...
	491	[982]	SETTABLE 	R24 K193 R25 ; R24[0x7f5022cf] := R25
	...
	495	[986]	SETTABLE 	R24 K194 R25 ; R24[0x3f3e4d12] := R25
	...
	503	[1024]	SETTABLE 	R24 K196 R25 ; R24[0x42b04007] := R25
