...
main <?:0,0> (431 instructions, 1724 bytes at 00000160985A4960)
...
function #1 <?:107,173> (235 instructions, 940 bytes at 00000160985A4FF0)
...
function #2 <?:175,177> (5 instructions, 20 bytes at 00000160985A5DF0)
...
function #3 <?:179,181> (3 instructions, 12 bytes at 00000160985A5EE0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[180]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[180]	RETURN   	R0 2 ; return R0 
	3	[181]	RETURN   	R0 1 ; return 

function #4 <?:183,192> (38 instructions, 152 bytes at 00000160985A5FB0)
...
function #5 <?:194,283> (494 instructions, 1976 bytes at 00000160985A62A0)
...
function #6 <?:285,297> (41 instructions, 164 bytes at 00000160985A77B0)
...
function #7 <?:299,307> (24 instructions, 96 bytes at 00000160985A7AD0)
...
function #8 <?:309,314> (11 instructions, 44 bytes at 00000160FBFB95D0)
...
function #9 <?:316,331> (39 instructions, 156 bytes at 00000160FBFB96E0)
...
function #10 <?:333,374> (117 instructions, 468 bytes at 00000160FBFB9930)
...
function #11 <?:376,378> (3 instructions, 12 bytes at 00000160FBFB9FC0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[377]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[377]	CALL     	R0 1 1 ; R0()
	3	[378]	RETURN   	R0 1 ; return 

function #12 <?:380,407> (104 instructions, 416 bytes at 00000160FBFBA090)
0 params, 8 slots, 5 upvalues, 0 locals, 32 constants, 2 functions
	...
	21	[385]	SETTABLE 	R3 K9 R0 ; R3["Tips"] := R0
...
function #13 <?:409,421> (26 instructions, 104 bytes at 00000160FBFBA9E0)
...
function #14 <?:423,647> (370 instructions, 1480 bytes at 00000160FBFBAB70)
...
function #15 <?:649,662> (20 instructions, 80 bytes at 00000160FBFBCBB0)
...
function #16 <?:664,676> (40 instructions, 160 bytes at 00000160FBFBD010)
...
function #17 <?:678,955> (1065 instructions, 4260 bytes at 00000160FBFBD290)
...
function #18 <?:957,969> (44 instructions, 176 bytes at 00000160FBFBD9E0)
3 params, 7 slots, 1 upvalue, 0 locals, 20 constants, 0 functions
	...
	18	[963]	SETTABLE 	R4 K6 R5 ; R4[0x00000000] := R5
	...
	24	[966]	SETTABLE 	R4 K13 R5 ; R4[0x46610c50] := R5
...
function #19 <?:971,973> (7 instructions, 28 bytes at 00000160FBFF8810)
...
function #20 <?:975,981> (15 instructions, 60 bytes at 00000160FBFF8930)
...
function #21 <?:983,989> (15 instructions, 60 bytes at 00000160FBFF8AB0)
1 param, 8 slots, 3 upvalues, 0 locals, 4 constants, 0 functions
...
function #22 <?:991,997> (21 instructions, 84 bytes at 00000160FBFF8C30)
...
function #23 <?:999,1243> (371 instructions, 1484 bytes at 00000160FBFF8E00)
0 params, 11 slots, 23 upvalues, 0 locals, 121 constants, 7 functions
	...
	130	[1160]	SETTABLE 	R1 K61 R2 ; R1["mOnPressedCallback"] := R2
	131	[1161]	GETUPVAL 	R1 U0 ; R1 := U0
	132	[1169]	CLOSURE  	R2 3 ; R2 := closure(Function #4)
	133	[1169]	GETUPVAL 	R0 U21 ; R0 := U21
	134	[1169]	SETTABLE 	R1 K62 R2 ; R1["AdditionalFilterFunction"] := R2
	...
	143	[1170]	SETTABLE 	R3 K64 R4 ; R3["Name"] := R4
	...
	156	[1183]	SETTABLE 	R3 K64 R4 ; R3["Name"] := R4
	...
	169	[1196]	SETTABLE 	R3 K64 R4 ; R3["Name"] := R4
...
function #24 <?:1245,1255> (23 instructions, 92 bytes at 0000016096409130)
...
function #25 <?:1257,1300> (67 instructions, 268 bytes at 0000016096409280)
...
function #26 <?:1302,1305> (13 instructions, 52 bytes at 0000016096409E00)
...
function #27 <?:1307,1342> (140 instructions, 560 bytes at 000001609640A020)
...
function #28 <?:1344,1404> (179 instructions, 716 bytes at 000001609640AB70)
...
function #29 <?:1406,1416> (30 instructions, 120 bytes at 000001609640B520)
...
function #30 <?:1418,1449> (80 instructions, 320 bytes at 000001609640B790)
...
function #31 <?:1451,1552> (408 instructions, 1632 bytes at 000001609640BC30)
0 params, 10 slots, 15 upvalues, 0 locals, 87 constants, 0 functions
	...
	161	[1492]	SETTABLE 	R3 K34 R4 ; R3[0xe6b41adb] := R4
...
function #32 <?:1554,1571> (88 instructions, 352 bytes at 000001609640C4B0)
1 param, 10 slots, 1 upvalue, 0 locals, 18 constants, 0 functions
	...
	5	[1555]	SETTABLE 	R1 K0 R2 ; R1["Timer"] := R2
	...
	31	[1560]	SETTABLE 	R1 K3 R2 ; R1["TargetX"] := R2
...
function #33 <?:1573,1627> (155 instructions, 620 bytes at 000001608BCBA660)
0 params, 13 slots, 9 upvalues, 0 locals, 30 constants, 1 function
	...
	127	[1615]	SETTABLE 	R7 K26 R3 ; R7[0x659d451f] := R3
	128	[1615]	SETTABLE 	R7 K27 R4 ; R7[0x53902f66] := R4
...
function #34 <?:1629,1645> (128 instructions, 512 bytes at 000001608BCBB040)
...
function #35 <?:1647,1675> (131 instructions, 524 bytes at 000001608BCBB860)
...
function #36 <?:1677,1706> (89 instructions, 356 bytes at 000001608BCBC160)
...
function #37 <?:1708,1717> (19 instructions, 76 bytes at 000001608BCBCA20)
...
function #38 <?:1719,1726> (22 instructions, 88 bytes at 000001608BCBCC50)
...
function #39 <?:1728,1771> (148 instructions, 592 bytes at 000001608BCBCEA0)
...
function #40 <?:1773,1790> (67 instructions, 268 bytes at 000001608BCBD690)
...
function #41 <?:1792,1799> (21 instructions, 84 bytes at 000001608BCBDB30)
...
function #42 <?:1801,1820> (37 instructions, 148 bytes at 000001608BCBDD80)
...
function #43 <?:1822,1863> (110 instructions, 440 bytes at 000001608BCBDFF0)
0 params, 19 slots, 6 upvalues, 0 locals, 32 constants, 1 function
	...
	106	[1862]	SETTABLE 	R17 K30 R18 ; R17[0x03f57322] := R18
...
function #44 <?:1865,1880> (59 instructions, 236 bytes at 00000160F5CC6750)
...
function #45 <?:1882,1886> (5 instructions, 20 bytes at 00000160F5CC6BA0)
...
function #46 <?:1888,1889> (1 instruction, 4 bytes at 00000160F5CC6CD0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1889]	RETURN   	R0 1 ; return 

function #47 <?:1891,1895> (12 instructions, 48 bytes at 00000160F5CC6DA0)
...
function #48 <?:1897,1901> (12 instructions, 48 bytes at 00000160F5CC6EF0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #49 <?:1903,1907> (16 instructions, 64 bytes at 00000160F5CC7040)
...
function #50 <?:1909,1913> (21 instructions, 84 bytes at 00000160F5CC71B0)
...
function #51 <?:1915,1922> (17 instructions, 68 bytes at 00000160F5CC7380)
...
function #52 <?:1924,1932> (19 instructions, 76 bytes at 00000160F5CC7540)
...
function #53 <?:1934,1953> (30 instructions, 120 bytes at 00000160F5CC76D0)
...
function #54 <?:1955,1957> (5 instructions, 20 bytes at 00000160F5CC78F0)
...
function #55 <?:1959,1961> (5 instructions, 20 bytes at 00000160F5CC79E0)
0 params, 3 slots, 2 upvalues, 0 locals, 0 constants, 0 functions
...
function #56 <?:1963,1969> (16 instructions, 64 bytes at 00000160F5CC7AD0)
...
function #57 <?:1971,1977> (16 instructions, 64 bytes at 00000160F5CC7C50)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #58 <?:1979,1985> (20 instructions, 80 bytes at 00000160F5CC7DD0)
...
function #59 <?:1987,1991> (14 instructions, 56 bytes at 00000160F5CC7F70)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #60 <?:1993,1997> (14 instructions, 56 bytes at 00000160F5CC80F0)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #61 <?:1999,2003> (18 instructions, 72 bytes at 00000160F5CC8270)
1 param, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #62 <?:2005,2008> (5 instructions, 20 bytes at 00000160F5CC8410)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #63 <?:2010,2015> (14 instructions, 56 bytes at 00000160F5CC8500)
...
function #64 <?:2017,2022> (14 instructions, 56 bytes at 00000160F5CC8660)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #65 <?:2024,2028> (10 instructions, 40 bytes at 00000160F5CC87C0)
...
function #66 <?:2030,2036> (19 instructions, 76 bytes at 00000160F5CC8910)
...
function #67 <?:2038,2052> (42 instructions, 168 bytes at 00000160F5CC8AD0)
...
function #68 <?:2054,2064> (19 instructions, 76 bytes at 00000160F5CC8D90)
...
function #69 <?:2066,2068> (3 instructions, 12 bytes at 00000160F5CC8F10)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[2067]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[2067]	RETURN   	R0 2 ; return R0 
	3	[2068]	RETURN   	R0 1 ; return 

function #70 <?:2070,2075> (12 instructions, 48 bytes at 00000160F5CC8FE0)
...
function #71 <?:2077,2098> (50 instructions, 200 bytes at 00000160F5CC9140)
