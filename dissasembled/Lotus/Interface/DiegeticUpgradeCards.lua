...
main <?:0,0> (1016 instructions, 4064 bytes at 000001609A48A940)
...
function #1 <?:223,225> (3 instructions, 12 bytes at 0000016092B984D0)
...
function #2 <?:227,229> (3 instructions, 12 bytes at 0000016092B985A0)
0 params, 2 slots, 0 upvalues, 0 locals, 1 constant, 0 functions
	1	[228]	GETGLOBAL	R0 K0 ; R0 := mCards
	2	[228]	RETURN   	R0 2 ; return R0 
	3	[229]	RETURN   	R0 1 ; return 

function #3 <?:231,233> (2 instructions, 8 bytes at 0000016092B98690)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[232]	RETURN   	R0 2 ; return R0 
	2	[233]	RETURN   	R0 1 ; return 

function #4 <?:235,237> (2 instructions, 8 bytes at 0000016092B98760)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[236]	RETURN   	R0 2 ; return R0 
	2	[237]	RETURN   	R0 1 ; return 

function #5 <?:239,241> (7 instructions, 28 bytes at 0000016092B98830)
...
function #6 <?:243,254> (26 instructions, 104 bytes at 0000016092B98950)
...
function #7 <?:256,263> (19 instructions, 76 bytes at 0000016092B98B60)
...
function #8 <?:265,276> (36 instructions, 144 bytes at 0000016092B98D20)
...
function #9 <?:278,397> (304 instructions, 1216 bytes at 0000016092B98F50)
0 params, 15 slots, 6 upvalues, 0 locals, 66 constants, 0 functions
	...
	227	[366]	SETTABLE 	R9 K44 R10 ; R9["MenuSuitAvatar"] := R10
	...
	279	[383]	SETTABLE 	R9 K56 R10 ; R9["mSentinelMode"] := R10
	...
	289	[389]	SETTABLE 	R9 K58 R10 ; R9["suitTable"] := R10
...
function #10 <?:399,425> (85 instructions, 340 bytes at 0000016092B99EA0)
...
function #11 <?:427,429> (3 instructions, 12 bytes at 0000016092B9A4E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[428]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[428]	CALL     	R0 1 1 ; R0()
	3	[429]	RETURN   	R0 1 ; return 

function #12 <?:431,459> (148 instructions, 592 bytes at 0000016092B9A5B0)
...
function #13 <?:461,467> (13 instructions, 52 bytes at 00000160F4D11A90)
...
function #14 <?:469,485> (75 instructions, 300 bytes at 00000160F4D11C10)
...
function #15 <?:487,491> (15 instructions, 60 bytes at 00000160F4D12110)
...
function #16 <?:493,495> (7 instructions, 28 bytes at 00000160F4D122A0)
...
function #17 <?:497,499> (7 instructions, 28 bytes at 00000160F4D123D0)
1 param, 5 slots, 0 upvalues, 0 locals, 3 constants, 0 functions
...
function #18 <?:501,503> (7 instructions, 28 bytes at 00000160F4D12500)
1 param, 5 slots, 0 upvalues, 0 locals, 3 constants, 0 functions
...
function #19 <?:505,507> (7 instructions, 28 bytes at 00000160F4D12630)
1 param, 5 slots, 0 upvalues, 0 locals, 3 constants, 0 functions
...
function #20 <?:509,517> (17 instructions, 68 bytes at 00000160F4D12760)
...
function #21 <?:519,521> (8 instructions, 32 bytes at 00000160F4D128E0)
...
function #22 <?:523,525> (11 instructions, 44 bytes at 00000160F4D12A10)
...
function #23 <?:527,537> (37 instructions, 148 bytes at 00000160F4D12B70)
...
function #24 <?:539,541> (8 instructions, 32 bytes at 00000160F4D12DF0)
0 params, 3 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #25 <?:543,584> (141 instructions, 564 bytes at 00000160F4D12F20)
...
function #26 <?:586,588> (8 instructions, 32 bytes at 00000160F4D13650)
...
function #27 <?:590,592> (12 instructions, 48 bytes at 00000160F4D13790)
0 params, 2 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #28 <?:594,596> (11 instructions, 44 bytes at 00000160F4D138F0)
0 params, 2 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #29 <?:598,601> (23 instructions, 92 bytes at 00000160F4D13A50)
...
function #30 <?:603,843> (645 instructions, 2580 bytes at 00000160F4D13C80)
...
function #31 <?:845,903> (213 instructions, 852 bytes at 00000160F4D156D0)
...
function #32 <?:905,977> (174 instructions, 696 bytes at 00000160F4D15D40)
...
function #33 <?:979,1078> (244 instructions, 976 bytes at 000001608A641010)
0 params, 50 slots, 4 upvalues, 0 locals, 66 constants, 1 function
	...
	220	[1070]	SETTABLE 	R45 K54 R46 ; R45[0xd0130c60] := R46
...
function #34 <?:1080,1082> (8 instructions, 32 bytes at 000001608A641E50)
...
function #35 <?:1084,1091> (18 instructions, 72 bytes at 000001608A641FA0)
...
function #36 <?:1093,1108> (34 instructions, 136 bytes at 000001608A642160)
...
function #37 <?:1110,1153> (162 instructions, 648 bytes at 000001608A6423F0)
...
function #38 <?:1155,1163> (24 instructions, 96 bytes at 000001608A642DE0)
...
function #39 <?:1165,1167> (3 instructions, 12 bytes at 000001608A643000)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1166]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1166]	CALL     	R0 1 1 ; R0()
	3	[1167]	RETURN   	R0 1 ; return 

function #40 <?:1169,1192> (44 instructions, 176 bytes at 000001608A6430D0)
...
function #41 <?:1194,1270> (212 instructions, 848 bytes at 000001608A643390)
...
function #42 <?:1272,1288> (43 instructions, 172 bytes at 000001608A643C70)
0 params, 7 slots, 3 upvalues, 0 locals, 16 constants, 0 functions
	...
	13	[1279]	SETTABLE 	R1 K3 R2 ; R1[0x00000000] := R2
...
function #43 <?:1290,1332> (146 instructions, 584 bytes at 000001608A643FD0)
...
function #44 <?:1334,1396> (179 instructions, 716 bytes at 000001608A644720)
0 params, 22 slots, 0 upvalues, 0 locals, 61 constants, 0 functions
	...
	92	[1376]	SETTABLE 	R14 K30 R15 ; R14["AbilityIndex"] := R15
	...
	97	[1379]	SETTABLE 	R14 K33 R15 ; R14["SourceAvatar"] := R15
	...
	102	[1380]	SETTABLE 	R14 K34 R15 ; R14["SourceAvatarAlternateSuit"] := R15
	...
	114	[1381]	SETTABLE 	R14 K35 R15 ; R14["Name"] := R15
	...
	119	[1382]	SETTABLE 	R14 K42 R15 ; R14["Level"] := R15
	...
	124	[1383]	SETTABLE 	R14 K44 R15 ; R14["Locked"] := R15
...
function #45 <?:1398,1420> (77 instructions, 308 bytes at 000001608A644940)
...
function #46 <?:1422,1430> (13 instructions, 52 bytes at 000001608182A1F0)
...
function #47 <?:1432,1449> (49 instructions, 196 bytes at 000001608182A360)
...
function #48 <?:1451,1624> (460 instructions, 1840 bytes at 000001608182A6D0)
...
function #49 <?:1626,1644> (60 instructions, 240 bytes at 000001608182C330)
...
function #50 <?:1646,1898> (802 instructions, 3208 bytes at 000001608182C6E0)
6 params, 30 slots, 11 upvalues, 0 locals, 109 constants, 0 functions
	...
	85	[1672]	SETTABLE 	R2 K23 R11 ; R2[0x00000000] := R11
	...
	91	[1675]	SETTABLE 	R2 K29 R11 ; R2[0x00000004] := R11
	...
	99	[1679]	SETTABLE 	R9 K23 R11 ; R9[0x00000000] := R11
	...
	105	[1682]	SETTABLE 	R9 K29 R11 ; R9[0x00000004] := R11
	...
	305	[1730]	SETTABLE 	R2 K23 R13 ; R2[0x00000000] := R13
	...
	311	[1733]	SETTABLE 	R2 K29 R13 ; R2[0x00000004] := R13
	...
	319	[1737]	SETTABLE 	R9 K23 R13 ; R9[0x00000000] := R13
	...
	325	[1740]	SETTABLE 	R9 K29 R13 ; R9[0x00000004] := R13
...
function #51 <?:1900,1909> (50 instructions, 200 bytes at 0000016081866F80)
...
function #52 <?:1911,1918> (22 instructions, 88 bytes at 0000016081867370)
...
function #53 <?:1920,1950> (59 instructions, 236 bytes at 0000016081867560)
...
function #54 <?:1952,2197> (261 instructions, 1044 bytes at 0000016081867990)
...
function #55 <?:2199,2285> (257 instructions, 1028 bytes at 000001608186AF30)
...
function #56 <?:2289,2293> (15 instructions, 60 bytes at 0000016080347AD0)
...
function #57 <?:2295,2299> (15 instructions, 60 bytes at 0000016080347C60)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #58 <?:2301,2306> (20 instructions, 80 bytes at 0000016080347DF0)
...
function #59 <?:2308,2313> (20 instructions, 80 bytes at 0000016080347FD0)
1 param, 5 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
...
function #60 <?:2315,2319> (15 instructions, 60 bytes at 00000160803481B0)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #61 <?:2321,2325> (15 instructions, 60 bytes at 0000016080348340)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #62 <?:2327,2332> (20 instructions, 80 bytes at 00000160803484D0)
1 param, 5 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
...
function #63 <?:2334,2339> (20 instructions, 80 bytes at 00000160803486B0)
1 param, 5 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
...
function #64 <?:2341,2372> (13 instructions, 52 bytes at 0000016080348890)
...
function #65 <?:2375,2432> (27 instructions, 108 bytes at 0000016080349050)
...
function #66 <?:2434,2850> (742 instructions, 2968 bytes at 0000016080349CB0)
0 params, 35 slots, 10 upvalues, 0 locals, 169 constants, 17 functions
	...
	153	[2583]	SETTABLE 	R1 K66 R2 ; R1[0x00000001] := R2
...
function #67 <?:2852,2868> (35 instructions, 140 bytes at 000001608365E390)
...
function #68 <?:2870,2875> (20 instructions, 80 bytes at 000001608365E5E0)
...
function #69 <?:2877,2981> (280 instructions, 1120 bytes at 000001608365E750)
...
function #70 <?:2983,2992> (15 instructions, 60 bytes at 00000160FDF4DA50)
...
function #71 <?:2994,3063> (321 instructions, 1284 bytes at 00000160FDF4DBC0)
...
function #72 <?:3067,3082> (48 instructions, 192 bytes at 00000160FDF4EEA0)
...
function #73 <?:3084,3240> (458 instructions, 1832 bytes at 00000160FDF4F140)
2 params, 66 slots, 11 upvalues, 0 locals, 78 constants, 0 functions
	...
	439	[3230]	SETTABLE 	R57 K1 R17 ; R57[0xa9188a47] := R17
...
function #74 <?:3242,3244> (4 instructions, 16 bytes at 00000160FDF50680)
0 params, 2 slots, 0 upvalues, 0 locals, 2 constants, 0 functions
...
function #75 <?:3246,3265> (38 instructions, 152 bytes at 00000160FDF507B0)
...
function #76 <?:3267,3269> (3 instructions, 12 bytes at 00000160FDF50B20)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[3268]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[3268]	CALL     	R0 1 1 ; R0()
	3	[3269]	RETURN   	R0 1 ; return 

function #77 <?:3271,3281> (24 instructions, 96 bytes at 00000160FDF50BF0)
...
function #78 <?:3283,3296> (55 instructions, 220 bytes at 00000160FDF50E00)
3 params, 16 slots, 1 upvalue, 0 locals, 13 constants, 0 functions
	...
	41	[3290]	SETTABLE 	R8 K10 R9 ; R8[0x00000009] := R9
...
function #79 <?:3298,3310> (20 instructions, 80 bytes at 00000160936B3A40)
...
function #80 <?:3312,3326> (21 instructions, 84 bytes at 00000160936B3D70)
...
function #81 <?:3328,3330> (3 instructions, 12 bytes at 00000160936B40D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[3329]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[3329]	CALL     	R0 1 1 ; R0()
	3	[3330]	RETURN   	R0 1 ; return 

function #82 <?:3334,3368> (42 instructions, 168 bytes at 00000160936B41A0)
...
function #83 <?:3370,3403> (42 instructions, 168 bytes at 00000160936B48C0)
1 param, 11 slots, 1 upvalue, 0 locals, 14 constants, 1 function
...
function #84 <?:3406,3425> (72 instructions, 288 bytes at 00000160936B4FA0)
...
function #85 <?:3427,3447> (21 instructions, 84 bytes at 00000160936B53A0)
...
function #86 <?:3449,3518> (171 instructions, 684 bytes at 00000160936B55F0)
...
function #87 <?:3520,3554> (121 instructions, 484 bytes at 00000160936B5EF0)
...
function #88 <?:3556,3564> (34 instructions, 136 bytes at 00000160936B65E0)
...
function #89 <?:3568,3587> (63 instructions, 252 bytes at 00000160936B6840)
...
function #90 <?:3589,3743> (375 instructions, 1500 bytes at 00000160936B6B50)
...
function #91 <?:3745,3749> (8 instructions, 32 bytes at 00000160936B7BC0)
...
function #92 <?:3751,3761> (11 instructions, 44 bytes at 00000160936B7CF0)
...
function #93 <?:3763,3765> (4 instructions, 16 bytes at 00000160936B7E30)
...
function #94 <?:3767,3797> (84 instructions, 336 bytes at 00000160936B7F00)
...
function #95 <?:3799,4060> (52 instructions, 208 bytes at 00000160936B83E0)
0 params, 4 slots, 10 upvalues, 0 locals, 12 constants, 2 functions
	...
	29	[3818]	SETTABLE 	R0 K7 R1 ; R0["ActionSelectionDone"] := R1
	...
	46	[4057]	SETTABLE 	R0 K10 R1 ; R0["GetActionsInfo"] := R1
...
function #96 <?:4062,4079> (65 instructions, 260 bytes at 0000016084E16310)
...
function #97 <?:4081,4091> (23 instructions, 92 bytes at 0000016084E16740)
...
function #98 <?:4093,4095> (3 instructions, 12 bytes at 0000016084E16930)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[4094]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[4094]	CALL     	R0 1 1 ; R0()
	3	[4095]	RETURN   	R0 1 ; return 

function #99 <?:4097,4109> (23 instructions, 92 bytes at 0000016084E16A00)
...
function #100 <?:4111,4273> (472 instructions, 1888 bytes at 0000016084E16C10)
...
function #101 <?:4276,4286> (27 instructions, 108 bytes at 0000016084E17C50)
...
function #102 <?:4288,4307> (40 instructions, 160 bytes at 0000016084E50B20)
...
function #103 <?:4309,4326> (61 instructions, 244 bytes at 0000016084E50DC0)
...
function #104 <?:4328,4332> (19 instructions, 76 bytes at 0000016084E511D0)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #105 <?:4334,4338> (19 instructions, 76 bytes at 0000016084E51380)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #106 <?:4340,4344> (23 instructions, 92 bytes at 0000016084E51530)
...
function #107 <?:4346,4350> (19 instructions, 76 bytes at 0000016084E51710)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #108 <?:4352,4356> (19 instructions, 76 bytes at 0000016084E518C0)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #109 <?:4358,4362> (23 instructions, 92 bytes at 0000016084E51A70)
1 param, 5 slots, 0 upvalues, 0 locals, 6 constants, 0 functions
...
function #110 <?:4364,4368> (16 instructions, 64 bytes at 0000016084E51C50)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #111 <?:4370,4374> (16 instructions, 64 bytes at 0000016084E51D80)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #112 <?:4376,4380> (16 instructions, 64 bytes at 0000016084E51F00)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #113 <?:4382,4386> (16 instructions, 64 bytes at 0000016084E52080)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #114 <?:4388,4392> (16 instructions, 64 bytes at 0000016084E52200)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #115 <?:4394,4398> (16 instructions, 64 bytes at 0000016084E52380)
0 params, 2 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #116 <?:4400,4411> (40 instructions, 160 bytes at 0000016084E52500)
...
function #117 <?:4413,4415> (6 instructions, 24 bytes at 0000016084E527C0)
...
function #118 <?:4417,4555> (274 instructions, 1096 bytes at 0000016084E528F0)
2 params, 61 slots, 8 upvalues, 0 locals, 61 constants, 0 functions
	...
	91	[4461]	SETTABLE 	R16 K21 R22 ; R16["mName"] := R22
	92	[4462]	GETTABLE 	R22 R15 K22 ; R22 := R15["mInstalled"]
	93	[4462]	SETTABLE 	R16 K22 R22 ; R16["mInstalled"] := R22
	...
	105	[4469]	SETTABLE 	R22 K28 R16 ; R22[0x399826a5] := R16
	...
	198	[4512]	SETTABLE 	R44 K28 R43 ; R44[0x399826a5] := R43
	...
	216	[4522]	SETTABLE 	R43 K21 R50 ; R43["mName"] := R50
	217	[4523]	SETTABLE 	R43 K22 R46 ; R43["mInstalled"] := R46
...
function #119 <?:4557,4572> (35 instructions, 140 bytes at 0000016084E536E0)
...
function #120 <?:4574,4586> (46 instructions, 184 bytes at 0000016084E53940)
...
function #121 <?:4588,4595> (37 instructions, 148 bytes at 0000016084E53C40)
...
function #122 <?:4597,4601> (8 instructions, 32 bytes at 0000016084E53ED0)
...
function #123 <?:4602,4606> (8 instructions, 32 bytes at 0000016084E53FF0)
2 params, 3 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #124 <?:4608,4613> (10 instructions, 40 bytes at 0000016084E54110)
...
function #125 <?:4614,4619> (10 instructions, 40 bytes at 0000016084E54250)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #126 <?:4621,4626> (10 instructions, 40 bytes at 0000016084E54390)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #127 <?:4627,4632> (10 instructions, 40 bytes at 0000016084E544D0)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #128 <?:4634,4647> (46 instructions, 184 bytes at 0000016084E54610)
...
function #129 <?:4649,4662> (46 instructions, 184 bytes at 0000016084E54950)
0 params, 5 slots, 2 upvalues, 0 locals, 16 constants, 0 functions
...
function #130 <?:4664,4666> (3 instructions, 12 bytes at 0000016084E54C90)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[4665]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[4665]	CALL     	R0 1 1 ; R0()
	3	[4666]	RETURN   	R0 1 ; return 

function #131 <?:4668,4669> (1 instruction, 4 bytes at 0000016084E54D60)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[4669]	RETURN   	R0 1 ; return 

function #132 <?:4671,4682> (17 instructions, 68 bytes at 0000016084E54E30)
...
function #133 <?:4684,4686> (5 instructions, 20 bytes at 000001609571E7F0)
...
function #134 <?:4688,4703> (44 instructions, 176 bytes at 000001609571E8E0)
...
function #135 <?:4705,4716> (25 instructions, 100 bytes at 000001609571EBB0)
...
function #136 <?:4718,4730> (31 instructions, 124 bytes at 000001609571EE40)
...
function #137 <?:4732,4744> (28 instructions, 112 bytes at 000001609571F0B0)
...
function #138 <?:4746,4775> (78 instructions, 312 bytes at 000001609571F2F0)
...
function #139 <?:4777,4801> (67 instructions, 268 bytes at 000001609571F780)
...
function #140 <?:4803,4876> (62 instructions, 248 bytes at 000001609571FBE0)
...
function #141 <?:4878,4882> (12 instructions, 48 bytes at 0000016095720AA0)
...
function #142 <?:4884,4888> (12 instructions, 48 bytes at 0000016095720C00)
1 param, 5 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #143 <?:4890,4894> (15 instructions, 60 bytes at 0000016095720D60)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #144 <?:4896,4901> (20 instructions, 80 bytes at 0000016095720EF0)
1 param, 5 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
...
function #145 <?:4903,4928> (95 instructions, 380 bytes at 00000160957210D0)
...
function #146 <?:4930,5125> (74 instructions, 296 bytes at 0000016095721750)
0 params, 10 slots, 8 upvalues, 0 locals, 30 constants, 9 functions
	...
	46	[4990]	SETTABLE 	R1 K23 R2 ; R1["mOnFocusedCallback"] := R2
...
function #147 <?:5127,5129> (15 instructions, 60 bytes at 000001609575AFA0)
...
function #148 <?:5131,5173> (182 instructions, 728 bytes at 000001609575B150)
...
function #149 <?:5175,5235> (162 instructions, 648 bytes at 000001609575B9D0)
...
function #150 <?:5237,5283> (84 instructions, 336 bytes at 000001609575CEA0)
0 params, 8 slots, 1 upvalue, 0 locals, 39 constants, 3 functions
	...
	58	[5277]	SETTABLE 	R2 K29 R3 ; R2[0x05000000] := R3
...
function #151 <?:5285,5345> (183 instructions, 732 bytes at 000001609575DBC0)
2 params, 18 slots, 1 upvalue, 0 locals, 39 constants, 0 functions
	...
	60	[5298]	SETTABLE 	R11 K17 R6 ; R11["ITEM"] := R6
	...
	76	[5301]	SETTABLE 	R12 K17 R7 ; R12["ITEM"] := R7
	...
	115	[5313]	SETTABLE 	R13 K26 R14 ; R13["TYPE"] := R14
...
function #152 <?:5347,5423> (293 instructions, 1172 bytes at 000001609575E840)
...
function #153 <?:5425,5482> (200 instructions, 800 bytes at 000001609575E8D0)
0 params, 25 slots, 4 upvalues, 0 locals, 47 constants, 0 functions
	...
	175	[5467]	SETTABLE 	R15 K45 R18 ; R15["mUpgradeFingerprint"] := R18
...
function #154 <?:5484,5509> (70 instructions, 280 bytes at 000001609575E960)
0 params, 8 slots, 2 upvalues, 0 locals, 22 constants, 0 functions
	...
	35	[5497]	SETTABLE 	R3 K11 R4 ; R3["desiredRot"] := R4
	...
	46	[5499]	SETTABLE 	R3 K14 R4 ; R3["lerpHead"] := R4
	...
	57	[5502]	SETTABLE 	R4 K17 R5 ; R4["positions"] := R5
...
function #155 <?:5511,5533> (81 instructions, 324 bytes at 000001609575E9F0)
...
function #156 <?:5535,5554> (53 instructions, 212 bytes at 00000160806C0170)
...
function #157 <?:5556,5691> (231 instructions, 924 bytes at 00000160806C04B0)
0 params, 20 slots, 2 upvalues, 0 locals, 70 constants, 6 functions
	...
	71	[5665]	SETTABLE 	R4 K38 R1 ; R4[0x42b04007] := R1
	...
	84	[5665]	SETTABLE 	R4 K43 R5 ; R4[0xa32f5156] := R5
	...
	148	[5677]	SETTABLE 	R11 K38 R1 ; R11[0x42b04007] := R1
	...
	158	[5677]	SETTABLE 	R11 K43 R12 ; R11[0xa32f5156] := R12
	...
	211	[5688]	SETTABLE 	R16 K38 R1 ; R16[0x42b04007] := R1
	...
	221	[5688]	SETTABLE 	R16 K43 R17 ; R16[0xa32f5156] := R17
...
function #158 <?:5693,5707> (46 instructions, 184 bytes at 00000160806C2B40)
...
function #159 <?:5709,6101> (1540 instructions, 6160 bytes at 0000016086C79510)
0 params, 42 slots, 24 upvalues, 0 locals, 303 constants, 1 function
	...
	860	[5941]	SETTABLE 	R19 K198 R20 ; R19["Slots"] := R20
...
function #160 <?:6103,6172> (165 instructions, 660 bytes at 0000016086C7DEF0)
...
function #161 <?:6174,6183> (36 instructions, 144 bytes at 000001608B0F5C30)
...
function #162 <?:6185,6194> (19 instructions, 76 bytes at 000001608B0F5EE0)
...
function #163 <?:6196,6217> (69 instructions, 276 bytes at 000001608B0F60E0)
...
function #164 <?:6219,6220> (1 instruction, 4 bytes at 000001608B0F6540)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[6220]	RETURN   	R0 1 ; return 

function #165 <?:6222,6294> (205 instructions, 820 bytes at 000001608B0F6610)
...
function #166 <?:6296,6303> (18 instructions, 72 bytes at 000001608B0F7170)
...
function #167 <?:6305,6317> (50 instructions, 200 bytes at 000001608B0F73C0)
...
function #168 <?:6319,6331> (28 instructions, 112 bytes at 000001608B0F7780)
...
function #169 <?:6334,6358> (87 instructions, 348 bytes at 000001608B0F7A50)
...
function #170 <?:6360,6383> (77 instructions, 308 bytes at 000001608B0F7FC0)
...
function #171 <?:6385,6404> (63 instructions, 252 bytes at 000001608B0F8610)
...
function #172 <?:6406,6541> (88 instructions, 352 bytes at 000001608B0F8960)
...
function #173 <?:6543,6634> (291 instructions, 1164 bytes at 000001608B0F9E60)
1 param, 36 slots, 6 upvalues, 0 locals, 63 constants, 0 functions
	...
	122	[6585]	SETTABLE 	R24 K31 R10 ; R24["ITEM"] := R10
	...
	213	[6614]	SETTABLE 	R30 K31 R24 ; R30["ITEM"] := R24
	...
	274	[6627]	SETTABLE 	R35 K31 R29 ; R35["ITEM"] := R29
...
function #174 <?:6636,6638> (4 instructions, 16 bytes at 0000016080681D80)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #175 <?:6640,6650> (19 instructions, 76 bytes at 0000016080681E50)
...
function #176 <?:6652,6664> (34 instructions, 136 bytes at 0000016080682000)
...
function #177 <?:6668,6681> (26 instructions, 104 bytes at 00000160806822B0)
...
function #178 <?:6683,6702> (45 instructions, 180 bytes at 00000160806824E0)
...
function #179 <?:6704,6828> (72 instructions, 288 bytes at 0000016080682810)
...
function #180 <?:6830,6850> (33 instructions, 132 bytes at 0000016080683DC0)
...
function #181 <?:6852,6871> (46 instructions, 184 bytes at 0000016080683FF0)
...
function #182 <?:6873,6898> (68 instructions, 272 bytes at 00000160806843D0)
...
function #183 <?:6900,6909> (19 instructions, 76 bytes at 00000160806849F0)
...
function #184 <?:6911,6985> (222 instructions, 888 bytes at 0000016080684C10)
0 params, 33 slots, 4 upvalues, 0 locals, 72 constants, 0 functions
	...
	185	[6972]	SETTABLE 	R27 K61 R17 ; R27[0x08000038] := R17
	...
	200	[6981]	SETTABLE 	R28 K61 R17 ; R28[0x08000038] := R17
...
function #185 <?:6987,7039> (71 instructions, 284 bytes at 00000160831CECC0)
0 params, 9 slots, 6 upvalues, 0 locals, 24 constants, 2 functions
	...
	31	[6992]	SETTABLE 	R8 K14 R0 ; R8["ITEM_NAME"] := R0
...
function #186 <?:7041,7064> (47 instructions, 188 bytes at 00000160831CF770)
...
function #187 <?:7066,7069> (15 instructions, 60 bytes at 00000160831CFA60)
...
function #188 <?:7071,7074> (10 instructions, 40 bytes at 00000160831CFC30)
...
function #189 <?:7076,7078> (3 instructions, 12 bytes at 00000160831CFDD0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[7077]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[7077]	CALL     	R0 1 1 ; R0()
	3	[7078]	RETURN   	R0 1 ; return 

function #190 <?:7080,7083> (15 instructions, 60 bytes at 00000160831CFEA0)
0 params, 5 slots, 0 upvalues, 0 locals, 9 constants, 0 functions
	...
	14	[7082]	SETTABLE 	R0 K6 R1 ; R0[0xd17bf72c] := R1
	15	[7083]	RETURN   	R0 1 ; return 

function #191 <?:7085,7088> (10 instructions, 40 bytes at 00000160831D00C0)
0 params, 5 slots, 0 upvalues, 0 locals, 8 constants, 0 functions
...
function #192 <?:7090,7109> (52 instructions, 208 bytes at 00000160831D0260)
...
function #193 <?:7111,7115> (10 instructions, 40 bytes at 00000160831D0780)
...
function #194 <?:7117,7121> (11 instructions, 44 bytes at 00000160831D0890)
...
function #195 <?:7123,7126> (12 instructions, 48 bytes at 00000160831D09E0)
...
function #196 <?:7128,7130> (7 instructions, 28 bytes at 00000160831D0B40)
...
function #197 <?:7132,7185> (159 instructions, 636 bytes at 00000160831D0C50)
...
function #198 <?:7187,7202> (54 instructions, 216 bytes at 00000160831D1490)
...
function #199 <?:7204,7209> (19 instructions, 76 bytes at 00000160831D1870)
...
function #200 <?:7211,7227> (40 instructions, 160 bytes at 00000160831D1A80)
...
function #201 <?:7229,7254> (31 instructions, 124 bytes at 00000160831D1D40)
...
function #202 <?:7256,7265> (21 instructions, 84 bytes at 00000160831D22E0)
...
function #203 <?:7267,7269> (1 instruction, 4 bytes at 00000160831D24D0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[7269]	RETURN   	R0 1 ; return 

function #204 <?:7271,7275> (16 instructions, 64 bytes at 00000160831D25A0)
1 param, 5 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #205 <?:7277,7279> (3 instructions, 12 bytes at 00000160831D2730)
...
function #206 <?:7281,7283> (1 instruction, 4 bytes at 00000160831D2840)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[7283]	RETURN   	R0 1 ; return 

function #207 <?:7285,7287> (3 instructions, 12 bytes at 00000160831D2910)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[7286]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[7286]	RETURN   	R0 2 ; return R0 
	3	[7287]	RETURN   	R0 1 ; return 

function #208 <?:7289,7291> (3 instructions, 12 bytes at 00000160831D29E0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[7290]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[7290]	RETURN   	R0 2 ; return R0 
	3	[7291]	RETURN   	R0 1 ; return 

function #209 <?:7293,7295> (5 instructions, 20 bytes at 00000160831D2AB0)
2 params, 5 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #210 <?:7297,7303> (30 instructions, 120 bytes at 00000160831D2BA0)
