...
main <?:0,0> (460 instructions, 1840 bytes at 000001608BB282F0)
...
function #1 <?:126,128> (3 instructions, 12 bytes at 000001608BB293F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[127]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[127]	RETURN   	R0 2 ; return R0 
	3	[128]	RETURN   	R0 1 ; return 

function #2 <?:130,141> (29 instructions, 116 bytes at 000001608BB294C0)
...
function #3 <?:143,145> (3 instructions, 12 bytes at 0000016095877890)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[144]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[144]	CALL     	R0 1 1 ; R0()
	3	[145]	RETURN   	R0 1 ; return 

function #4 <?:147,159> (31 instructions, 124 bytes at 0000016095877940)
...
function #5 <?:162,167> (19 instructions, 76 bytes at 0000016095877C00)
...
function #6 <?:169,232> (248 instructions, 992 bytes at 0000016095877FF0)
...
function #7 <?:234,253> (163 instructions, 652 bytes at 0000016095879090)
...
function #8 <?:255,420> (687 instructions, 2748 bytes at 0000016095879820)
...
function #9 <?:422,430> (37 instructions, 148 bytes at 000001608BB207B0)
...
function #10 <?:432,440> (37 instructions, 148 bytes at 000001608BB20AD0)
1 param, 8 slots, 1 upvalue, 0 locals, 9 constants, 0 functions
...
function #11 <?:442,446> (6 instructions, 24 bytes at 000001608BB20DB0)
...
function #12 <?:448,452> (6 instructions, 24 bytes at 000001608BB20E90)
2 params, 4 slots, 0 upvalues, 0 locals, 1 constant, 0 functions
...
function #13 <?:454,465> (34 instructions, 136 bytes at 000001608BB20FA0)
...
function #14 <?:467,486> (64 instructions, 256 bytes at 000001608BB21360)
...
function #15 <?:488,540> (165 instructions, 660 bytes at 000001608BB21760)
...
function #16 <?:542,544> (10 instructions, 40 bytes at 000001608BB220C0)
...
function #17 <?:546,614> (24 instructions, 96 bytes at 000001608BB22220)
...
function #18 <?:616,690> (253 instructions, 1012 bytes at 000001608BB23290)
...
function #19 <?:692,730> (93 instructions, 372 bytes at 000001608BB13CD0)
...
function #20 <?:732,760> (104 instructions, 416 bytes at 000001608BB14390)
...
function #21 <?:762,786> (100 instructions, 400 bytes at 000001608BB148D0)
...
function #22 <?:788,820> (108 instructions, 432 bytes at 000001608BB14FC0)
...
function #23 <?:822,828> (10 instructions, 40 bytes at 000001608BB15740)
...
function #24 <?:830,837> (28 instructions, 112 bytes at 000001608BB15890)
...
function #25 <?:839,847> (26 instructions, 104 bytes at 000001608BB15A90)
...
function #26 <?:849,857> (17 instructions, 68 bytes at 000001608BB15C90)
...
function #27 <?:859,879> (69 instructions, 276 bytes at 000001608BB15E30)
...
function #28 <?:881,901> (71 instructions, 284 bytes at 000001608BB16290)
...
function #29 <?:903,923> (52 instructions, 208 bytes at 000001608BB16770)
...
function #30 <?:925,944> (51 instructions, 204 bytes at 000001608BB16B20)
...
function #31 <?:946,1041> (306 instructions, 1224 bytes at 000001608BB16EC0)
...
function #32 <?:1043,1045> (3 instructions, 12 bytes at 000001608BB18300)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1044]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1044]	CALL     	R0 1 1 ; R0()
	3	[1045]	RETURN   	R0 1 ; return 

function #33 <?:1047,1049> (2 instructions, 8 bytes at 000001608BB183D0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1048]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1049]	RETURN   	R0 1 ; return 

function #34 <?:1051,1060> (23 instructions, 92 bytes at 000001608BB184A0)
...
function #35 <?:1062,1069> (21 instructions, 84 bytes at 000001608BB186E0)
0 params, 4 slots, 3 upvalues, 0 locals, 8 constants, 0 functions
...
function #36 <?:1071,1120> (130 instructions, 520 bytes at 000001608BB188E0)
...
function #37 <?:1122,1126> (14 instructions, 56 bytes at 000001608BB191A0)
...
function #38 <?:1128,1167> (44 instructions, 176 bytes at 000001608BB34800)
...
function #39 <?:1169,1275> (93 instructions, 372 bytes at 000001608BB34B00)
0 params, 7 slots, 10 upvalues, 0 locals, 39 constants, 6 functions
	...
	52	[1197]	SETTABLE 	R1 K29 R2 ; R1[0xbd496aa1] := R2
...
function #40 <?:1277,1280> (5 instructions, 20 bytes at 000001608BB366F0)
...
function #41 <?:1282,1469> (739 instructions, 2956 bytes at 000001608BB36810)
...
function #42 <?:1471,1519> (162 instructions, 648 bytes at 000001608BB38E80)
...
function #43 <?:1521,1542> (79 instructions, 316 bytes at 000001608BB396D0)
4 params, 12 slots, 6 upvalues, 0 locals, 15 constants, 0 functions
	...
	78	[1541]	SETTABLE 	R6 K14 R7 ; R6[0xae91e43b] := R7
	79	[1542]	RETURN   	R0 1 ; return 

function #44 <?:1544,1550> (14 instructions, 56 bytes at 000001608BB398B0)
...
function #45 <?:1552,1558> (16 instructions, 64 bytes at 000001608BB19640)
...
function #46 <?:1560,1568> (20 instructions, 80 bytes at 000001608BB197D0)
...
function #47 <?:1570,1574> (18 instructions, 72 bytes at 000001608BB19980)
...
function #48 <?:1576,1584> (30 instructions, 120 bytes at 000001608BB19B50)
...
function #49 <?:1586,1597> (52 instructions, 208 bytes at 000001608BB19D60)
...
function #50 <?:1599,1652> (110 instructions, 440 bytes at 000001608BB1A0F0)
...
function #51 <?:1654,1656> (3 instructions, 12 bytes at 000001608BB1B2E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1655]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1655]	CALL     	R0 1 1 ; R0()
	3	[1656]	RETURN   	R0 1 ; return 

function #52 <?:1673,1678> (20 instructions, 80 bytes at 000001608BB1B3B0)
...
function #53 <?:1680,1685> (15 instructions, 60 bytes at 000001608BB1B550)
...
function #54 <?:1687,1689> (3 instructions, 12 bytes at 000001608BB1B6D0)
...
function #55 <?:1691,1701> (40 instructions, 160 bytes at 000001608BB1B7E0)
...
function #56 <?:1703,1709> (25 instructions, 100 bytes at 000001608BB1BA60)
...
function #57 <?:1711,1715> (23 instructions, 92 bytes at 000001608BB1BC70)
...
function #58 <?:1717,1719> (3 instructions, 12 bytes at 000001608BB1BE60)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1718]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1718]	RETURN   	R0 2 ; return R0 
	3	[1719]	RETURN   	R0 1 ; return 

function #59 <?:1721,1723> (3 instructions, 12 bytes at 000001608BB1BF30)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1722]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1722]	RETURN   	R0 2 ; return R0 
	3	[1723]	RETURN   	R0 1 ; return 

function #60 <?:1725,1727> (7 instructions, 28 bytes at 000001608BB1C000)
...
function #61 <?:1729,1731> (7 instructions, 28 bytes at 000001608BB1C120)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #62 <?:1733,1735> (7 instructions, 28 bytes at 000001608BB1C240)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #63 <?:1737,1739> (7 instructions, 28 bytes at 000001608BB1C360)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #64 <?:1741,1745> (15 instructions, 60 bytes at 000001608BB1C480)
...
function #65 <?:1747,1749> (3 instructions, 12 bytes at 000001608BB1C5E0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
