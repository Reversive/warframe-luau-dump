...
main <?:0,0> (43 instructions, 172 bytes at 000001608D0EF100)
...
function #1 <?:11,51> (114 instructions, 456 bytes at 000001608D0EF430)
...
function #2 <?:53,55> (3 instructions, 12 bytes at 0000016084E1AF80)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[54]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[54]	CALL     	R0 1 1 ; R0()
	3	[55]	RETURN   	R0 1 ; return 

function #3 <?:57,78> (77 instructions, 308 bytes at 0000016084E1B050)
0 params, 7 slots, 5 upvalues, 0 locals, 23 constants, 0 functions
	...
	47	[67]	SETTABLE 	R2 K9 R3 ; R2[0xbe190284] := R3
...
function #4 <?:80,96> (38 instructions, 152 bytes at 0000016084E1B540)
...
function #5 <?:98,273> (111 instructions, 444 bytes at 0000016084E1B820)
3 params, 15 slots, 6 upvalues, 0 locals, 30 constants, 4 functions
	...
	73	[134]	SETTABLE 	R8 K22 R9 ; R8["ValidateTile"] := R9
	...
	88	[168]	SETTABLE 	R8 K24 R9 ; R8["BrowseDone"] := R9
	...
	95	[189]	SETTABLE 	R8 K26 R9 ; R8["GetTileSorting"] := R9
	...
	105	[269]	SETTABLE 	R8 K28 R9 ; R8["GetAllTiles"] := R9
