...
main <?:0,0> (271 instructions, 1084 bytes at 0000016088288A00)
...
function #1 <?:63,64> (1 instruction, 4 bytes at 0000016089C2B9F0)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[64]	RETURN   	R0 1 ; return 

function #2 <?:66,68> (5 instructions, 20 bytes at 0000016089467180)
...
function #3 <?:70,75> (15 instructions, 60 bytes at 0000016088275230)
...
function #4 <?:77,89> (49 instructions, 196 bytes at 0000016093C00D60)
...
function #5 <?:91,121> (75 instructions, 300 bytes at 00000160F6F81E10)
...
function #6 <?:123,126> (6 instructions, 24 bytes at 000001609115C370)
...
function #7 <?:129,177> (19 instructions, 76 bytes at 0000016081824AE0)
...
function #8 <?:179,194> (45 instructions, 180 bytes at 00000160882C6B20)
...
function #9 <?:196,219> (41 instructions, 164 bytes at 000001609252CB70)
...
function #10 <?:221,223> (5 instructions, 20 bytes at 000001608C8A3A30)
2 params, 5 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #11 <?:225,240> (36 instructions, 144 bytes at 000001608C879C10)
...
function #12 <?:242,267> (75 instructions, 300 bytes at 000001608C7E27B0)
...
function #13 <?:269,392> (357 instructions, 1428 bytes at 000001608C7E20A0)
0 params, 35 slots, 14 upvalues, 0 locals, 85 constants, 1 function
	...
	303	[375]	SETTABLE 	R29 K70 R30 ; R29["HideHud"] := R30
...
function #14 <?:394,408> (40 instructions, 160 bytes at 00000160F4A4DCF0)
2 params, 6 slots, 2 upvalues, 0 locals, 21 constants, 0 functions
	...
	12	[400]	SETTABLE 	R3 K8 R2 ; R3[0x056dcf06] := R2
	13	[401]	SETTABLE 	R3 K9 R1 ; R3[0x141378c6] := R1
	...
	23	[402]	SETTABLE 	R3 K10 R4 ; R3[0xbad4316f] := R4
...
function #15 <?:410,422> (52 instructions, 208 bytes at 00000160F55DB900)
...
function #16 <?:424,437> (52 instructions, 208 bytes at 00000160F55D9B20)
...
function #17 <?:439,445> (15 instructions, 60 bytes at 000001608E711410)
...
function #18 <?:447,468> (125 instructions, 500 bytes at 000001608E712D00)
...
function #19 <?:470,515> (62 instructions, 248 bytes at 000001608E712050)
...
function #20 <?:517,537> (48 instructions, 192 bytes at 0000016093D81360)
...
function #21 <?:539,554> (38 instructions, 152 bytes at 0000016092B40930)
...
function #22 <?:556,558> (3 instructions, 12 bytes at 000001609456D110)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[557]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[557]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[558]	RETURN   	R0 1 ; return 

function #23 <?:560,634> (180 instructions, 720 bytes at 00000160944A8AA0)
0 params, 10 slots, 5 upvalues, 0 locals, 45 constants, 3 functions
	...
	57	[618]	SETTABLE 	R5 K26 R6 ; R5[0xdf29a9d6] := R6
	...
	84	[621]	SETTABLE 	R5 K26 R6 ; R5[0xdf29a9d6] := R6
	...
	111	[624]	SETTABLE 	R5 K26 R6 ; R5[0xdf29a9d6] := R6
	...
	138	[627]	SETTABLE 	R5 K26 R6 ; R5[0xdf29a9d6] := R6
	...
	153	[629]	SETTABLE 	R5 K26 R6 ; R5[0xdf29a9d6] := R6
...
function #24 <?:636,646> (22 instructions, 88 bytes at 00000160F4E621D0)
...
function #25 <?:648,650> (3 instructions, 12 bytes at 00000160E3C933B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[649]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[649]	CALL     	R0 1 1 ; R0()
	3	[650]	RETURN   	R0 1 ; return 

function #26 <?:652,661> (16 instructions, 64 bytes at 000001608AFEFE70)
...
function #27 <?:663,679> (50 instructions, 200 bytes at 0000016086C101B0)
...
function #28 <?:681,689> (16 instructions, 64 bytes at 0000016090A341B0)
...
function #29 <?:691,713> (44 instructions, 176 bytes at 0000016090A337F0)
0 params, 2 slots, 1 upvalue, 0 locals, 16 constants, 0 functions
	...
	22	[700]	SETTABLE 	R0 K7 R1 ; R0["HideHud"] := R1
...
function #30 <?:715,749> (39 instructions, 156 bytes at 0000016093A50F70)
...
function #31 <?:751,755> (32 instructions, 128 bytes at 0000016091F31830)
...
function #32 <?:757,852> (254 instructions, 1016 bytes at 00000160916E97E0)
...
function #33 <?:854,993> (280 instructions, 1120 bytes at 0000016093D37D60)
0 params, 14 slots, 25 upvalues, 0 locals, 54 constants, 3 functions
	...
	229	[982]	SETTABLE 	R8 K38 R2 ; R8[0x7b998233] := R2
...
function #34 <?:995,999> (22 instructions, 88 bytes at 00000160FCCA35F0)
...
function #35 <?:1001,1005> (12 instructions, 48 bytes at 00000160FCCA37A0)
...
function #36 <?:1007,1011> (13 instructions, 52 bytes at 00000160FCCA38F0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #37 <?:1013,1015> (7 instructions, 28 bytes at 00000160FCCA3A60)
...
function #38 <?:1017,1019> (7 instructions, 28 bytes at 00000160FCCA3AF0)
1 param, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #39 <?:1021,1026> (25 instructions, 100 bytes at 00000160FCCA3B80)
...
function #40 <?:1028,1030> (3 instructions, 12 bytes at 00000160FCCA3DD0)
...
function #41 <?:1032,1036> (18 instructions, 72 bytes at 00000160FCCA3EA0)
0 params, 2 slots, 4 upvalues, 0 locals, 2 constants, 0 functions
...
function #42 <?:1038,1042> (6 instructions, 24 bytes at 00000160FCCA3FF0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #43 <?:1044,1046> (3 instructions, 12 bytes at 00000160FCCA4080)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
