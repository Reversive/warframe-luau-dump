...
main <?:0,0> (555 instructions, 2220 bytes at 0000016090018560)
...
function #1 <?:106,108> (4 instructions, 16 bytes at 0000016081EC6070)
...
function #2 <?:112,121> (38 instructions, 152 bytes at 0000016081EC6140)
...
function #3 <?:123,125> (3 instructions, 12 bytes at 0000016081EC63E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[124]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[124]	CALL     	R0 1 1 ; R0()
	3	[125]	RETURN   	R0 1 ; return 

function #4 <?:127,143> (62 instructions, 248 bytes at 0000016081EC64B0)
...
function #5 <?:145,149> (12 instructions, 48 bytes at 0000016081EC6AA0)
...
function #6 <?:151,176> (55 instructions, 220 bytes at 0000016081EC6BD0)
...
function #7 <?:178,190> (50 instructions, 200 bytes at 0000016081EC7160)
...
function #8 <?:192,202> (24 instructions, 96 bytes at 0000016081EC74E0)
...
function #9 <?:204,245> (71 instructions, 284 bytes at 0000016081EC7690)
...
function #10 <?:247,267> (43 instructions, 172 bytes at 0000016081EC7DD0)
...
function #11 <?:269,351> (155 instructions, 620 bytes at 0000016081EC8230)
...
function #12 <?:353,376> (71 instructions, 284 bytes at 0000016081EC9190)
...
function #13 <?:378,384> (12 instructions, 48 bytes at 0000016081EC9590)
...
function #14 <?:386,388> (8 instructions, 32 bytes at 0000016081EC96D0)
...
function #15 <?:390,394> (15 instructions, 60 bytes at 00000160933EDB10)
...
function #16 <?:396,400> (15 instructions, 60 bytes at 00000160933EDCA0)
1 param, 4 slots, 3 upvalues, 0 locals, 5 constants, 0 functions
...
function #17 <?:402,457> (156 instructions, 624 bytes at 00000160933EDE30)
...
function #18 <?:459,486> (60 instructions, 240 bytes at 00000160933EE6C0)
...
function #19 <?:488,517> (47 instructions, 188 bytes at 00000160933EEA60)
...
function #20 <?:519,573> (105 instructions, 420 bytes at 00000160933EF100)
...
function #21 <?:575,605> (90 instructions, 360 bytes at 00000160933EFCE0)
...
function #22 <?:607,712> (185 instructions, 740 bytes at 00000160933F03B0)
...
function #23 <?:714,757> (65 instructions, 260 bytes at 00000160933F2010)
0 params, 7 slots, 4 upvalues, 0 locals, 32 constants, 5 functions
	...
	55	[748]	SETTABLE 	R1 K29 R2 ; R1["mOnUnfocusedCallback"] := R2
...
function #24 <?:759,852> (284 instructions, 1136 bytes at 0000016083696FD0)
0 params, 30 slots, 12 upvalues, 0 locals, 61 constants, 3 functions
	...
	36	[764]	SETTABLE 	R8 K10 R5 ; R8[0x7b998233] := R5
	...
	164	[794]	SETTABLE 	R22 K31 R21 ; R22["mItemType"] := R21
	...
	174	[797]	SETTABLE 	R18 K33 R24 ; R18[0x23d5322f] := R24
	175	[798]	GETTABLE 	R24 R18 K33 ; R24 := R18["ArcaneMaxRank"]
	176	[798]	SETTABLE 	R18 K36 R24 ; R18[0xbd496aa1] := R24
	...
	181	[803]	SETTABLE 	R18 K38 R24 ; R18[0x46610c50] := R24
...
function #25 <?:854,909> (209 instructions, 836 bytes at 0000016083698180)
...
function #26 <?:911,972> (224 instructions, 896 bytes at 0000016083698C40)
1 param, 47 slots, 9 upvalues, 0 locals, 52 constants, 0 functions
	...
	171	[962]	SETTABLE 	R35 K38 R36 ; R35["Height"] := R36
	...
	182	[963]	SETTABLE 	R35 K41 R36 ; R35["YPos"] := R36
...
function #27 <?:974,986> (77 instructions, 308 bytes at 0000016083699780)
...
function #28 <?:988,1104> (347 instructions, 1388 bytes at 0000016083699D70)
...
function #29 <?:1106,1116> (42 instructions, 168 bytes at 000001608369B4D0)
...
function #30 <?:1118,1176> (135 instructions, 540 bytes at 000001609AB0DE50)
...
function #31 <?:1178,1180> (3 instructions, 12 bytes at 000001609AB0E710)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1179]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[1179]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[1180]	RETURN   	R0 1 ; return 

function #32 <?:1182,1184> (3 instructions, 12 bytes at 000001609AB0E7E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1183]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1183]	CALL     	R0 1 1 ; R0()
	3	[1184]	RETURN   	R0 1 ; return 

function #33 <?:1186,1198> (29 instructions, 116 bytes at 000001609AB0E8B0)
...
function #34 <?:1200,1212> (23 instructions, 92 bytes at 000001609AB0EAB0)
...
function #35 <?:1214,1218> (8 instructions, 32 bytes at 000001609AB0ED20)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #36 <?:1220,1230> (19 instructions, 76 bytes at 000001609AB0EE50)
...
function #37 <?:1232,1234> (3 instructions, 12 bytes at 000001609AB0EFF0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1233]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1233]	CALL     	R0 1 1 ; R0()
	3	[1234]	RETURN   	R0 1 ; return 

function #38 <?:1236,1237> (1 instruction, 4 bytes at 000001609AB0F0C0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1237]	RETURN   	R0 1 ; return 

function #39 <?:1239,1318> (166 instructions, 664 bytes at 000001609AB0F190)
...
function #40 <?:1320,1326> (14 instructions, 56 bytes at 000001609AB0FA20)
...
function #41 <?:1328,1334> (11 instructions, 44 bytes at 000001609AB0FB90)
...
function #42 <?:1336,1342> (11 instructions, 44 bytes at 000001609AB0FCE0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #43 <?:1344,1350> (14 instructions, 56 bytes at 000001609AB0FE30)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #44 <?:1352,1358> (11 instructions, 44 bytes at 000001609AB0FFA0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #45 <?:1360,1366> (11 instructions, 44 bytes at 000001609AB100F0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #46 <?:1368,1374> (16 instructions, 64 bytes at 000001609AB10240)
...
function #47 <?:1376,1382> (16 instructions, 64 bytes at 000001609AB103C0)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #48 <?:1384,1390> (19 instructions, 76 bytes at 000001609AB10540)
...
function #49 <?:1392,1397> (26 instructions, 104 bytes at 000001609AB106E0)
...
function #50 <?:1399,1404> (26 instructions, 104 bytes at 000001609AB10850)
0 params, 2 slots, 2 upvalues, 0 locals, 5 constants, 0 functions
...
function #51 <?:1406,1411> (17 instructions, 68 bytes at 000001609AB10A40)
...
function #52 <?:1413,1424> (21 instructions, 84 bytes at 000001609AB10BD0)
...
function #53 <?:1426,1435> (16 instructions, 64 bytes at 000001609AB10DB0)
...
function #54 <?:1437,1484> (147 instructions, 588 bytes at 000001609AB10F50)
...
function #55 <?:1486,1488> (2 instructions, 8 bytes at 000001609AB116D0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1487]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1488]	RETURN   	R0 1 ; return 

function #56 <?:1490,1492> (2 instructions, 8 bytes at 000001609AB117A0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1491]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1492]	RETURN   	R0 1 ; return 

function #57 <?:1494,1501> (20 instructions, 80 bytes at 000001609AB11870)
...
function #58 <?:1503,1509> (18 instructions, 72 bytes at 000001609AB11A10)
...
function #59 <?:1511,1520> (27 instructions, 108 bytes at 000001609AB11BB0)
...
function #60 <?:1522,1528> (22 instructions, 88 bytes at 000001609AB11E50)
1 param, 4 slots, 3 upvalues, 0 locals, 4 constants, 0 functions
...
function #61 <?:1530,1533> (4 instructions, 16 bytes at 000001609AB12010)
...
function #62 <?:1535,1537> (2 instructions, 8 bytes at 000001609AB120E0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1536]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1537]	RETURN   	R0 1 ; return 

function #63 <?:1539,1541> (2 instructions, 8 bytes at 000001609AB121B0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1540]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1541]	RETURN   	R0 1 ; return 

function #64 <?:1543,1545> (2 instructions, 8 bytes at 000001609AB12280)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1544]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1545]	RETURN   	R0 1 ; return 

function #65 <?:1547,1549> (2 instructions, 8 bytes at 000001609AB12350)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1548]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1549]	RETURN   	R0 1 ; return 

function #66 <?:1551,1553> (6 instructions, 24 bytes at 000001609AB12420)
...
function #67 <?:1555,1557> (2 instructions, 8 bytes at 000001609AB12530)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1556]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1557]	RETURN   	R0 1 ; return 

function #68 <?:1559,1563> (15 instructions, 60 bytes at 000001609AB12600)
1 param, 3 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #69 <?:1565,1567> (6 instructions, 24 bytes at 000001609AB12760)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #70 <?:1569,1607> (91 instructions, 364 bytes at 000001609AB12870)
...
function #71 <?:1610,1614> (4 instructions, 16 bytes at 000001609A488160)
1 param, 2 slots, 2 upvalues, 0 locals, 0 constants, 0 functions
...
function #72 <?:1616,1620> (8 instructions, 32 bytes at 000001609A488230)
...
function #73 <?:1622,1624> (2 instructions, 8 bytes at 000001609A488340)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1623]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1624]	RETURN   	R0 1 ; return 

function #74 <?:1626,1628> (2 instructions, 8 bytes at 000001609A488410)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1627]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1628]	RETURN   	R0 1 ; return 

function #75 <?:1630,1632> (6 instructions, 24 bytes at 000001609A4884E0)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #79 <?:1646,1648> (3 instructions, 12 bytes at 000001609A4888F0)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
	1	[1647]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[1647]	SETTABLE 	R1 K0 R0 ; R1["PriceTagOverride"] := R0
	3	[1648]	RETURN   	R0 1 ; return 

function #80 <?:1650,1652> (3 instructions, 12 bytes at 000001609A4889E0)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
	1	[1651]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[1651]	SETTABLE 	R1 K0 R0 ; R1["BundleTag"] := R0
	3	[1652]	RETURN   	R0 1 ; return 

function #81 <?:1654,1656> (7 instructions, 28 bytes at 000001609A488AD0)
1 param, 3 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #82 <?:1658,1660> (7 instructions, 28 bytes at 000001609A488BF0)
1 param, 3 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #83 <?:1662,1665> (23 instructions, 92 bytes at 000001609A488D10)
...
function #84 <?:1667,1670> (23 instructions, 92 bytes at 000001609A488F40)
...
function #85 <?:1672,1674> (3 instructions, 12 bytes at 000001609A489180)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1673]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1673]	CALL     	R0 1 1 ; R0()
	3	[1674]	RETURN   	R0 1 ; return 

function #86 <?:1676,1693> (50 instructions, 200 bytes at 000001609A489250)
...
function #87 <?:1695,1707> (35 instructions, 140 bytes at 000001609A489610)
...
function #88 <?:1709,1716> (18 instructions, 72 bytes at 000001609A489930)
...
function #89 <?:1718,1725> (18 instructions, 72 bytes at 000001609A489AB0)
...
function #90 <?:1727,1729> (3 instructions, 12 bytes at 000001609A489C30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1728]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1728]	RETURN   	R0 2 ; return R0 
	3	[1729]	RETURN   	R0 1 ; return 

function #91 <?:1731,1733> (3 instructions, 12 bytes at 000001609A489D00)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1732]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1732]	RETURN   	R0 2 ; return R0 
	3	[1733]	RETURN   	R0 1 ; return 

function #92 <?:1735,1737> (6 instructions, 24 bytes at 000001609A489DD0)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #93 <?:1739,1741> (3 instructions, 12 bytes at 000001609A489EE0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
