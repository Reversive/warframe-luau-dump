...
main <?:0,0> (315 instructions, 1260 bytes at 000001608BD79B80)
...
function #1 <?:63,65> (3 instructions, 12 bytes at 000001608BD7AAD0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[64]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[64]	RETURN   	R0 2 ; return R0 
	3	[65]	RETURN   	R0 1 ; return 

function #2 <?:67,69> (8 instructions, 32 bytes at 000001608BD7ABA0)
...
function #3 <?:71,73> (1 instruction, 4 bytes at 000001608BD7ACD0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[73]	RETURN   	R0 1 ; return 

function #4 <?:75,78> (13 instructions, 52 bytes at 000001608BD7ADA0)
...
function #5 <?:80,84> (9 instructions, 36 bytes at 000001608BD7AF10)
...
function #6 <?:86,90> (11 instructions, 44 bytes at 000001608BD7B050)
...
function #7 <?:92,101> (31 instructions, 124 bytes at 000001608BD7B1B0)
...
function #8 <?:103,109> (27 instructions, 108 bytes at 000001608BD7B3D0)
...
function #9 <?:111,120> (19 instructions, 76 bytes at 000001608BD7B6C0)
...
function #10 <?:122,130> (20 instructions, 80 bytes at 000001608BD7B7F0)
...
function #11 <?:132,138> (16 instructions, 64 bytes at 0000016082CB2E20)
...
function #12 <?:140,141> (1 instruction, 4 bytes at 0000016082CB2FA0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[141]	RETURN   	R0 1 ; return 

function #13 <?:143,152> (22 instructions, 88 bytes at 0000016082CB3070)
...
function #14 <?:154,173> (62 instructions, 248 bytes at 0000016082CB3290)
...
function #15 <?:175,186> (49 instructions, 196 bytes at 0000016082CB3640)
...
function #16 <?:188,207> (48 instructions, 192 bytes at 0000016082CB39B0)
...
function #17 <?:209,211> (3 instructions, 12 bytes at 0000016082CB3CE0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[210]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[210]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[211]	RETURN   	R0 1 ; return 

function #18 <?:213,241> (82 instructions, 328 bytes at 0000016082CB3DB0)
...
function #19 <?:243,245> (3 instructions, 12 bytes at 0000016082CB4220)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[244]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[244]	RETURN   	R0 2 ; return R0 
	3	[245]	RETURN   	R0 1 ; return 

function #20 <?:247,249> (3 instructions, 12 bytes at 0000016082CB42F0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[248]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[248]	RETURN   	R0 2 ; return R0 
	3	[249]	RETURN   	R0 1 ; return 

function #21 <?:251,253> (3 instructions, 12 bytes at 0000016082CB43C0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[252]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[252]	RETURN   	R0 2 ; return R0 
	3	[253]	RETURN   	R0 1 ; return 

function #22 <?:255,257> (3 instructions, 12 bytes at 0000016082CB4490)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[256]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[256]	RETURN   	R0 2 ; return R0 
	3	[257]	RETURN   	R0 1 ; return 

function #23 <?:259,261> (1 instruction, 4 bytes at 0000016082CB4560)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[261]	RETURN   	R0 1 ; return 

function #24 <?:263,267> (6 instructions, 24 bytes at 0000016082CB4630)
...
function #25 <?:269,280> (27 instructions, 108 bytes at 0000016082CB4750)
...
function #26 <?:282,290> (17 instructions, 68 bytes at 0000016082CB48C0)
...
function #27 <?:292,294> (2 instructions, 8 bytes at 0000016082CB4A50)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[293]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[294]	RETURN   	R0 1 ; return 

function #28 <?:296,302> (8 instructions, 32 bytes at 0000016082CB4B20)
...
function #29 <?:304,310> (8 instructions, 32 bytes at 0000016082CB4C10)
2 params, 3 slots, 2 upvalues, 0 locals, 0 constants, 0 functions
...
function #30 <?:312,314> (3 instructions, 12 bytes at 0000016082CB4D00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[313]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[313]	CALL     	R0 1 1 ; R0()
	3	[314]	RETURN   	R0 1 ; return 

function #31 <?:316,319> (5 instructions, 20 bytes at 0000016082CB4DD0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #32 <?:321,324> (5 instructions, 20 bytes at 0000016082CB4EC0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #33 <?:326,329> (5 instructions, 20 bytes at 0000016082CB4FB0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #34 <?:331,334> (5 instructions, 20 bytes at 0000016082CB50A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #35 <?:336,340> (8 instructions, 32 bytes at 0000016082CB5190)
...
function #36 <?:342,350> (16 instructions, 64 bytes at 0000016082CB5280)
...
function #37 <?:352,421> (173 instructions, 692 bytes at 0000016082CB53E0)
...
function #38 <?:423,487> (190 instructions, 760 bytes at 0000016082CB5BF0)
0 params, 28 slots, 10 upvalues, 0 locals, 61 constants, 0 functions
	...
	122	[457]	SETTABLE 	R11 K31 R10 ; R11[0x5f56eeab] := R10
...
function #39 <?:489,638> (392 instructions, 1568 bytes at 0000016082CB68E0)
...
function #40 <?:640,757> (453 instructions, 1812 bytes at 000001608CCA3930)
0 params, 24 slots, 16 upvalues, 0 locals, 112 constants, 0 functions
	...
	353	[734]	SETTABLE 	R15 K27 R17 ; R15[0x00000001] := R17
...
function #41 <?:759,774> (38 instructions, 152 bytes at 000001608CCA50C0)
...
function #42 <?:776,778> (3 instructions, 12 bytes at 000001608CCA5390)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[777]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[777]	RETURN   	R0 2 ; return R0 
	3	[778]	RETURN   	R0 1 ; return 

function #43 <?:780,782> (3 instructions, 12 bytes at 000001608CCA5460)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
