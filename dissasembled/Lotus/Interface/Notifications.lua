...
main <?:0,0> (373 instructions, 1492 bytes at 0000016095727570)
0+ params, 79 slots, 0 upvalues, 0 locals, 61 constants, 63 functions
	...
	25	[22]	SETTABLE 	R7 K9 R8 ; R7[0xbe190284] := R8
	...
	31	[23]	SETTABLE 	R8 K9 R9 ; R8[0xbe190284] := R9
	...
	37	[24]	SETTABLE 	R9 K9 R10 ; R9[0xbe190284] := R10
	...
	43	[25]	SETTABLE 	R10 K9 R11 ; R10[0xbe190284] := R11
...
function #1 <?:88,95> (13 instructions, 52 bytes at 0000016095727D70)
...
function #2 <?:97,114> (39 instructions, 156 bytes at 0000016095727EE0)
...
function #3 <?:116,131> (51 instructions, 204 bytes at 0000016095728160)
...
function #4 <?:133,383> (111 instructions, 444 bytes at 00000160957283F0)
...
function #5 <?:385,387> (5 instructions, 20 bytes at 000001609572B580)
...
function #6 <?:389,395> (33 instructions, 132 bytes at 000001609572B670)
...
function #7 <?:397,408> (22 instructions, 88 bytes at 00000160FB112AB0)
...
function #8 <?:410,415> (24 instructions, 96 bytes at 00000160FB112C20)
...
function #9 <?:417,424> (50 instructions, 200 bytes at 00000160FB112DF0)
...
function #10 <?:426,445> (103 instructions, 412 bytes at 00000160FB1131F0)
...
function #11 <?:447,459> (23 instructions, 92 bytes at 00000160FB1139B0)
...
function #12 <?:461,469> (14 instructions, 56 bytes at 00000160FB113B70)
...
function #13 <?:471,486> (30 instructions, 120 bytes at 00000160FB113CE0)
3 params, 13 slots, 0 upvalues, 0 locals, 13 constants, 0 functions
	...
	27	[483]	SETTABLE 	R10 K10 R11 ; R10["Secret"] := R11
	28	[484]	SETTABLE 	R10 K12 R3 ; R10["Owned"] := R3
	29	[479]	CALL     	R8 3 1 ; R8(R9,R10)
	30	[486]	RETURN   	R0 1 ; return 

function #14 <?:487,502> (45 instructions, 180 bytes at 00000160FB113FD0)
...
function #15 <?:504,521> (44 instructions, 176 bytes at 00000160FB1143B0)
...
function #16 <?:523,564> (90 instructions, 360 bytes at 00000160FB114700)
...
function #17 <?:566,634> (143 instructions, 572 bytes at 00000160FB1156B0)
0 params, 4 slots, 2 upvalues, 0 locals, 48 constants, 0 functions
	...
	36	[587]	SETTABLE 	R0 K18 R1 ; R0["YareliQuestKeyChain"] := R1
	...
	44	[591]	SETTABLE 	R0 K20 R1 ; R0[0x8792aaab] := R1
	...
	54	[595]	SETTABLE 	R1 K24 R2 ; R1[0xfbc567eb] := R2
	55	[596]	SETTABLE 	R0 K22 R1 ; R0[0x7b998233] := R1
...
function #18 <?:636,645> (52 instructions, 208 bytes at 00000160FB116610)
...
function #19 <?:647,663> (30 instructions, 120 bytes at 00000160FB1169A0)
...
function #20 <?:665,667> (3 instructions, 12 bytes at 00000160FB116BC0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[666]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[666]	CALL     	R0 1 1 ; R0()
	3	[667]	RETURN   	R0 1 ; return 

function #21 <?:669,729> (178 instructions, 712 bytes at 00000160FB116C90)
...
function #22 <?:731,734> (17 instructions, 68 bytes at 00000160FB1177D0)
...
function #23 <?:736,816> (253 instructions, 1012 bytes at 00000160FB117980)
0 params, 19 slots, 4 upvalues, 0 locals, 40 constants, 0 functions
	...
	103	[779]	SETTABLE 	R16 K14 R17 ; R16[0x08000038] := R17
	104	[779]	GETTABLE 	R17 R8 K16 ; R17 := R8["Value"]
	105	[779]	SETTABLE 	R16 K23 R17 ; R16[0x05000036] := R17
	...
	198	[798]	SETTABLE 	R9 K23 R13 ; R9[0x05000036] := R13
	...
	231	[805]	SETTABLE 	R9 K23 R13 ; R9[0x05000036] := R13
...
function #24 <?:818,830> (21 instructions, 84 bytes at 00000160F625C790)
...
function #25 <?:832,887> (164 instructions, 656 bytes at 00000160F625C950)
...
function #26 <?:889,896> (15 instructions, 60 bytes at 00000160F625D1E0)
...
function #27 <?:898,910> (46 instructions, 184 bytes at 00000160F625D310)
...
function #28 <?:912,950> (72 instructions, 288 bytes at 00000160F625D640)
...
function #29 <?:952,1088> (522 instructions, 2088 bytes at 00000160F625DDE0)
1 param, 28 slots, 5 upvalues, 0 locals, 69 constants, 0 functions
	...
	127	[983]	SETTABLE 	R10 K26 R5 ; R10[0xd1586535] := R5
	128	[984]	GETUPVAL 	R10 U1 ; R10 := U1
	129	[984]	SETTABLE 	R10 K27 R6 ; R10[0xf2deaf69] := R6
	130	[985]	GETUPVAL 	R10 U1 ; R10 := U1
	131	[985]	SETTABLE 	R10 K28 R7 ; R10["PrimeBucks"] := R7
	132	[986]	GETUPVAL 	R10 U1 ; R10 := U1
	133	[986]	SETTABLE 	R10 K29 R8 ; R10[0xfe3be07a] := R8
	134	[987]	GETUPVAL 	R10 U1 ; R10 := U1
	135	[987]	SETTABLE 	R10 K30 R4 ; R10["Extra"] := R4
	136	[988]	GETUPVAL 	R10 U1 ; R10 := U1
	137	[988]	SETTABLE 	R10 K31 R3 ; R10[0x2a1108a9] := R3
...
function #30 <?:1090,1141> (112 instructions, 448 bytes at 00000160F625F4D0)
...
function #31 <?:1143,1151> (20 instructions, 80 bytes at 00000160F625FB80)
2 params, 7 slots, 2 upvalues, 0 locals, 8 constants, 0 functions
...
function #32 <?:1153,1157> (16 instructions, 64 bytes at 00000160F625FE20)
...
function #33 <?:1159,1161> (4 instructions, 16 bytes at 00000160F6260010)
...
function #34 <?:1163,1174> (19 instructions, 76 bytes at 00000160F62600E0)
...
function #35 <?:1176,1217> (104 instructions, 416 bytes at 00000160F6260480)
...
function #36 <?:1219,1234> (29 instructions, 116 bytes at 00000160F6260A20)
...
function #37 <?:1236,1245> (16 instructions, 64 bytes at 00000160F6260F50)
...
function #38 <?:1247,1249> (3 instructions, 12 bytes at 00000160F62610B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1248]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1248]	CALL     	R0 1 1 ; R0()
	3	[1249]	RETURN   	R0 1 ; return 

function #39 <?:1251,1285> (81 instructions, 324 bytes at 0000016080688C80)
...
function #40 <?:1287,1300> (34 instructions, 136 bytes at 0000016080689210)
...
function #41 <?:1302,1362> (133 instructions, 532 bytes at 0000016080689570)
...
function #42 <?:1364,1494> (314 instructions, 1256 bytes at 000001608068A000)
...
function #43 <?:1496,1852> (911 instructions, 3644 bytes at 000001608068AF40)
0 params, 73 slots, 17 upvalues, 0 locals, 116 constants, 8 functions
	...
	604	[1733]	SETTABLE 	R31 K99 R32 ; R31["Label"] := R32
	...
	740	[1768]	SETTABLE 	R48 K109 R42 ; R48["SYNDICATE"] := R42
	741	[1768]	CALL     	R46 3 2 ; R46 := R46(R47,R48)
	742	[1768]	SETTABLE 	R45 K99 R46 ; R45["Label"] := R46
...
function #44 <?:1854,1862> (17 instructions, 68 bytes at 000001608068D8F0)
...
function #45 <?:1864,1963> (266 instructions, 1064 bytes at 000001608068DAD0)
...
function #46 <?:1965,1971> (10 instructions, 40 bytes at 000001608068DD60)
...
function #47 <?:1973,1975> (4 instructions, 16 bytes at 0000016092A30960)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #48 <?:1977,1981> (8 instructions, 32 bytes at 0000016092A30A10)
...
function #49 <?:1983,1985> (3 instructions, 12 bytes at 0000016092A30B30)
...
function #50 <?:1987,1990> (8 instructions, 32 bytes at 0000016092A30C00)
...
function #51 <?:1992,1999> (34 instructions, 136 bytes at 0000016092A30D10)
...
function #52 <?:2001,2017> (71 instructions, 284 bytes at 0000016092A30F60)
0 params, 10 slots, 6 upvalues, 0 locals, 27 constants, 0 functions
	...
	70	[2015]	SETTABLE 	R2 K26 R3 ; R2["gToolTip"] := R3
	71	[2017]	RETURN   	R0 1 ; return 

function #53 <?:2019,2031> (54 instructions, 216 bytes at 0000016092A31490)
...
function #54 <?:2033,2042> (36 instructions, 144 bytes at 0000016092A31870)
...
function #55 <?:2044,2052> (18 instructions, 72 bytes at 0000016092A31B30)
...
function #56 <?:2054,2074> (63 instructions, 252 bytes at 0000016092A31D60)
...
function #57 <?:2076,2098> (99 instructions, 396 bytes at 0000016092A32230)
...
function #58 <?:2100,2118> (29 instructions, 116 bytes at 0000016092A32880)
...
function #59 <?:2120,2128> (18 instructions, 72 bytes at 0000016092A32C10)
0 params, 5 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
...
function #60 <?:2130,2140> (34 instructions, 136 bytes at 0000016092A32E50)
...
function #61 <?:2142,2144> (3 instructions, 12 bytes at 0000016092A330F0)
...
function #62 <?:2146,2148> (3 instructions, 12 bytes at 0000016092A33200)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[2147]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[2147]	RETURN   	R0 2 ; return R0 
	3	[2148]	RETURN   	R0 1 ; return 

function #63 <?:2150,2152> (4 instructions, 16 bytes at 0000016092A332D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
