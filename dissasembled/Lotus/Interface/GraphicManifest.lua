...
main <?:0,0> (138 instructions, 552 bytes at 0000016084A37BD0)
...
function #1 <?:19,21> (3 instructions, 12 bytes at 0000016084A37F20)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[20]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[20]	RETURN   	R0 2 ; return R0 
	3	[21]	RETURN   	R0 1 ; return 

function #2 <?:23,25> (7 instructions, 28 bytes at 0000016084A37FF0)
...
function #3 <?:27,48> (36 instructions, 144 bytes at 0000016084A38170)
...
function #4 <?:50,56> (15 instructions, 60 bytes at 0000016084A38670)
...
function #5 <?:58,68> (30 instructions, 120 bytes at 0000016084A387E0)
...
function #6 <?:70,75> (16 instructions, 64 bytes at 0000016084A38B50)
...
function #7 <?:77,82> (22 instructions, 88 bytes at 0000016084A38CF0)
...
function #8 <?:84,133> (76 instructions, 304 bytes at 0000016084A38F10)
0 params, 7 slots, 2 upvalues, 0 locals, 36 constants, 4 functions
	...
	49	[99]	SETTABLE 	R1 K26 R2 ; R1["RectangleVisibleRangeMaterial"] := R2
	...
	55	[101]	SETTABLE 	R1 K30 R2 ; R1[0xaade900e] := R2
	...
	65	[116]	SETTABLE 	R1 K33 R2 ; R1[0x1142c7a8] := R2
	...
	70	[124]	SETTABLE 	R1 K34 R2 ; R1[0x5bced4c4] := R2
	...
	75	[132]	SETTABLE 	R1 K35 R2 ; R1[0xac1b386a] := R2
	76	[133]	RETURN   	R0 1 ; return 

function #9 <?:135,213> (270 instructions, 1080 bytes at 0000016084A39BE0)
...
function #10 <?:215,246> (49 instructions, 196 bytes at 0000016084A3A670)
...
function #11 <?:248,257> (28 instructions, 112 bytes at 0000016094A3ACF0)
...
function #12 <?:259,275> (31 instructions, 124 bytes at 0000016094A3AF80)
...
function #13 <?:277,281> (9 instructions, 36 bytes at 0000016094A3B1F0)
...
function #14 <?:283,289> (17 instructions, 68 bytes at 0000016094A3B340)
...
function #15 <?:291,293> (3 instructions, 12 bytes at 0000016094A3B4E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[292]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[292]	CALL     	R0 1 1 ; R0()
	3	[293]	RETURN   	R0 1 ; return 

function #16 <?:295,297> (4 instructions, 16 bytes at 0000016094A3B5B0)
...
function #17 <?:299,301> (3 instructions, 12 bytes at 0000016094A3B6A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[300]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[300]	CALL     	R0 1 1 ; R0()
	3	[301]	RETURN   	R0 1 ; return 

function #18 <?:303,320> (51 instructions, 204 bytes at 0000016094A3B770)
...
function #19 <?:322,358> (128 instructions, 512 bytes at 0000016094A3BAF0)
...
function #20 <?:360,370> (48 instructions, 192 bytes at 0000016094A3BDD0)
...
function #21 <?:372,416> (175 instructions, 700 bytes at 0000016094B1B490)
...
function #22 <?:418,422> (6 instructions, 24 bytes at 0000016094B1BDC0)
...
function #23 <?:424,426> (3 instructions, 12 bytes at 0000016094B1BF00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[425]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[425]	CALL     	R0 1 1 ; R0()
	3	[426]	RETURN   	R0 1 ; return 

function #24 <?:428,430> (3 instructions, 12 bytes at 0000016094B1BFD0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[429]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[429]	CALL     	R0 1 1 ; R0()
	3	[430]	RETURN   	R0 1 ; return 

function #25 <?:432,434> (3 instructions, 12 bytes at 0000016094B1C0A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[433]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[433]	CALL     	R0 1 1 ; R0()
	3	[434]	RETURN   	R0 1 ; return 

function #26 <?:436,439> (4 instructions, 16 bytes at 0000016094B1C170)
...
function #27 <?:441,443> (6 instructions, 24 bytes at 0000016094B1C270)
...
function #28 <?:445,449> (13 instructions, 52 bytes at 0000016094B1C380)
...
function #29 <?:451,452> (1 instruction, 4 bytes at 0000016094B1C4F0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[452]	RETURN   	R0 1 ; return 

function #30 <?:454,458> (12 instructions, 48 bytes at 0000016094B1C5C0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #31 <?:460,464> (12 instructions, 48 bytes at 0000016094B1C710)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #32 <?:466,468> (3 instructions, 12 bytes at 0000016094B1C860)
...
function #33 <?:470,475> (19 instructions, 76 bytes at 0000016094B1C930)
...
function #34 <?:477,482> (8 instructions, 32 bytes at 0000016094B1CAD0)
...
function #35 <?:484,486> (1 instruction, 4 bytes at 0000016094B1CBC0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[486]	RETURN   	R0 1 ; return 

function #36 <?:488,492> (19 instructions, 76 bytes at 0000016094B1CC90)
...
function #37 <?:494,496> (3 instructions, 12 bytes at 0000016094B1CE50)
