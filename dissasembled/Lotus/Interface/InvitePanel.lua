...
main <?:0,0> (301 instructions, 1204 bytes at 00000160FAC2C010)
...
function #1 <?:56,58> (3 instructions, 12 bytes at 00000160F4E84260)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[57]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[57]	RETURN   	R0 2 ; return R0 
	3	[58]	RETURN   	R0 1 ; return 

function #2 <?:60,62> (5 instructions, 20 bytes at 0000016099099E60)
...
function #3 <?:64,77> (78 instructions, 312 bytes at 0000016099099F80)
0 params, 5 slots, 3 upvalues, 0 locals, 16 constants, 0 functions
	...
	14	[66]	SETTABLE 	R0 K3 R1 ; R0["FloatingContentObject"] := R1
	...
	21	[67]	SETTABLE 	R0 K5 R1 ; R0["FloatingContentHighlight"] := R1
	...
	35	[69]	SETTABLE 	R0 K7 R1 ; R0["Content"] := R1
	...
	49	[71]	SETTABLE 	R0 K9 R1 ; R0["Background1Object"] := R1
	...
	63	[73]	SETTABLE 	R0 K11 R1 ; R0["BackerHighlight"] := R1
...
function #4 <?:79,378> (239 instructions, 956 bytes at 000001609909A400)
0 params, 11 slots, 13 upvalues, 0 locals, 83 constants, 15 functions
	...
	98	[133]	SETTABLE 	R1 K49 R2 ; R1["UpdateCount"] := R2
	...
	165	[335]	SETTABLE 	R1 K64 R2 ; R1["GetClanMembers"] := R2
...
function #5 <?:380,391> (25 instructions, 100 bytes at 00000160980D49E0)
...
function #6 <?:393,397> (11 instructions, 44 bytes at 00000160980D4BF0)
...
function #7 <?:399,403> (6 instructions, 24 bytes at 00000160980D4D40)
...
function #8 <?:405,411> (14 instructions, 56 bytes at 00000160980D4E30)
...
function #9 <?:413,417> (12 instructions, 48 bytes at 00000160FA2F5290)
...
function #10 <?:419,421> (4 instructions, 16 bytes at 00000160FA2F53D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #11 <?:423,433> (29 instructions, 116 bytes at 00000160FA2F54A0)
...
function #12 <?:435,469> (56 instructions, 224 bytes at 00000160FA2F56E0)
...
function #13 <?:471,473> (3 instructions, 12 bytes at 00000160FA2F5A00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[472]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[472]	CALL     	R0 1 1 ; R0()
	3	[473]	RETURN   	R0 1 ; return 

function #14 <?:475,505> (66 instructions, 264 bytes at 00000160FA2F5AD0)
...
function #15 <?:507,509> (6 instructions, 24 bytes at 00000160FA2F5F10)
...
function #16 <?:511,517> (10 instructions, 40 bytes at 00000160FA2F6000)
...
function #17 <?:519,522> (17 instructions, 68 bytes at 00000160FA2F6100)
...
function #18 <?:524,536> (33 instructions, 132 bytes at 00000160FA2F62B0)
...
function #19 <?:538,539> (1 instruction, 4 bytes at 00000160FA2F6530)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[539]	RETURN   	R0 1 ; return 

function #20 <?:541,653> (274 instructions, 1096 bytes at 00000160FA2F6600)
...
function #21 <?:655,657> (3 instructions, 12 bytes at 00000160FA2F7D70)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[656]	LOADK    	R0 := 1.000000
	2	[656]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[657]	RETURN   	R0 1 ; return 

function #22 <?:659,661> (3 instructions, 12 bytes at 00000160FA2F7E40)
...
function #23 <?:663,725> (158 instructions, 632 bytes at 00000160FA2F7F10)
...
function #24 <?:727,737> (40 instructions, 160 bytes at 00000160FA2F8650)
...
function #25 <?:739,771> (71 instructions, 284 bytes at 00000160FA2F8900)
...
function #26 <?:774,779> (17 instructions, 68 bytes at 00000160FA2F8CA0)
...
function #27 <?:781,786> (14 instructions, 56 bytes at 00000160FA2F8E40)
...
function #28 <?:788,792> (15 instructions, 60 bytes at 00000160FA2F8FD0)
...
function #29 <?:794,798> (17 instructions, 68 bytes at 00000160FA2F9140)
...
function #30 <?:800,804> (14 instructions, 56 bytes at 00000160FA2F92E0)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #31 <?:806,810> (18 instructions, 72 bytes at 00000160FA2F9460)
1 param, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #32 <?:812,837> (57 instructions, 228 bytes at 00000160FA2F9600)
...
function #33 <?:839,841> (5 instructions, 20 bytes at 00000160FA2F99C0)
...
function #34 <?:843,884> (116 instructions, 464 bytes at 00000160FA2F9AD0)
2 params, 15 slots, 7 upvalues, 0 locals, 32 constants, 0 functions
	...
	94	[873]	SETTABLE 	R10 K24 R11 ; R10["name"] := R11
...
function #35 <?:886,898> (42 instructions, 168 bytes at 00000160FA2FA130)
...
function #36 <?:900,918> (71 instructions, 284 bytes at 00000160FA2FA480)
...
function #37 <?:920,926> (22 instructions, 88 bytes at 000001608AC05210)
...
function #38 <?:928,930> (3 instructions, 12 bytes at 000001608AC053E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[929]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[929]	CALL     	R0 1 1 ; R0()
	3	[930]	RETURN   	R0 1 ; return 

function #39 <?:932,942> (33 instructions, 132 bytes at 000001608AC054B0)
...
function #40 <?:944,946> (3 instructions, 12 bytes at 000001608AC05830)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[945]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[945]	CALL     	R0 1 1 ; R0()
	3	[946]	RETURN   	R0 1 ; return 

function #41 <?:948,953> (14 instructions, 56 bytes at 000001608AC05900)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #42 <?:955,960> (14 instructions, 56 bytes at 000001608AC05A60)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #43 <?:962,964> (3 instructions, 12 bytes at 000001608AC05BC0)
2 params, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[963]	GETUPVAL 	R2 U0 ; R2 := U0
	2	[963]	CALL     	R2 1 1 ; R2()
	3	[964]	RETURN   	R0 1 ; return 

function #44 <?:966,979> (28 instructions, 112 bytes at 000001608AC05C90)
...
function #45 <?:981,993> (65 instructions, 260 bytes at 000001608AC05EF0)
...
function #46 <?:995,999> (19 instructions, 76 bytes at 000001608AC064F0)
...
function #47 <?:1001,1003> (2 instructions, 8 bytes at 000001608AC066B0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1002]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1003]	RETURN   	R0 1 ; return 

function #48 <?:1005,1007> (2 instructions, 8 bytes at 000001608AC06780)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1006]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1007]	RETURN   	R0 1 ; return 

function #49 <?:1009,1016> (12 instructions, 48 bytes at 000001608AC06850)
...
function #50 <?:1018,1020> (2 instructions, 8 bytes at 000001608AC069A0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1019]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1020]	RETURN   	R0 1 ; return 

function #51 <?:1022,1027> (8 instructions, 32 bytes at 000001608AC06A70)
...
function #52 <?:1029,1037> (14 instructions, 56 bytes at 000001608AC06BA0)
...
function #53 <?:1039,1041> (3 instructions, 12 bytes at 000001608AC06D30)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
