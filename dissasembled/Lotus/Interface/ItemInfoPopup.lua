...
main <?:0,0> (439 instructions, 1756 bytes at 000001608E678EA0)
...
function #1 <?:99,126> (48 instructions, 192 bytes at 000001608E679D00)
...
function #2 <?:128,130> (8 instructions, 32 bytes at 000001608E67A200)
...
function #3 <?:132,140> (21 instructions, 84 bytes at 000001608E67A340)
...
function #4 <?:142,144> (11 instructions, 44 bytes at 000001608E67A4A0)
...
function #5 <?:146,148> (8 instructions, 32 bytes at 000001608E67A5E0)
...
function #6 <?:150,160> (21 instructions, 84 bytes at 000001608E67A6D0)
...
function #7 <?:162,164> (3 instructions, 12 bytes at 000001608E67A8B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[163]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[163]	CALL     	R0 1 1 ; R0()
	3	[164]	RETURN   	R0 1 ; return 

function #8 <?:166,184> (57 instructions, 228 bytes at 000001608E67A980)
...
function #9 <?:186,233> (167 instructions, 668 bytes at 000001608E67ACE0)
...
function #10 <?:235,241> (13 instructions, 52 bytes at 000001608E67B5A0)
...
function #11 <?:243,353> (484 instructions, 1936 bytes at 000001608E67B700)
...
function #12 <?:355,396> (30 instructions, 120 bytes at 000001608E67CE00)
...
function #13 <?:398,427> (106 instructions, 424 bytes at 000001608225F010)
...
function #14 <?:429,438> (47 instructions, 188 bytes at 000001608225F680)
...
function #15 <?:440,516> (26 instructions, 104 bytes at 000001608225FA60)
...
function #16 <?:518,580> (23 instructions, 92 bytes at 0000016082260F20)
...
function #17 <?:583,628> (93 instructions, 372 bytes at 0000016082261DD0)
...
function #18 <?:630,730> (397 instructions, 1588 bytes at 0000016082262B00)
2 params, 32 slots, 10 upvalues, 0 locals, 94 constants, 0 functions
	...
	354	[714]	SETTABLE 	R29 K88 R30 ; R29[0x6c97a788] := R30
...
function #19 <?:732,734> (5 instructions, 20 bytes at 0000016082262D30)
...
function #20 <?:736,743> (10 instructions, 40 bytes at 0000016082262E50)
...
function #21 <?:746,779> (65 instructions, 260 bytes at 00000160835DE670)
...
function #22 <?:781,797> (51 instructions, 204 bytes at 00000160835DE9A0)
...
function #23 <?:799,870> (32 instructions, 128 bytes at 00000160835DEBF0)
...
function #24 <?:872,919> (156 instructions, 624 bytes at 00000160835E0350)
...
function #25 <?:921,933> (28 instructions, 112 bytes at 00000160835E0D40)
...
function #26 <?:935,943> (56 instructions, 224 bytes at 00000160835E0FE0)
...
function #27 <?:945,964> (60 instructions, 240 bytes at 00000160835E1310)
...
function #28 <?:966,983> (51 instructions, 204 bytes at 00000160835E19C0)
...
function #29 <?:985,1038> (197 instructions, 788 bytes at 00000160835E1DA0)
...
function #30 <?:1040,1094> (198 instructions, 792 bytes at 000001609AA2F3F0)
0 params, 16 slots, 6 upvalues, 0 locals, 44 constants, 0 functions
	...
	59	[1054]	SETTABLE 	R7 K10 R8 ; R7[0x51b30e60] := R8
	...
	95	[1062]	SETTABLE 	R11 K21 R12 ; R11[0x5bced4c4] := R12
...
function #31 <?:1096,1210> (306 instructions, 1224 bytes at 000001609AA30180)
...
function #32 <?:1212,1960> (3320 instructions, 13280 bytes at 000001609AA31150)
...
function #33 <?:1962,2280> (1248 instructions, 4992 bytes at 000001609AA32730)
0 params, 87 slots, 32 upvalues, 0 locals, 175 constants, 0 functions
	...
	371	[2048]	SETTABLE 	R17 K64 R18 ; R17[0x5465f8f3] := R18
...
function #34 <?:2282,2376> (337 instructions, 1348 bytes at 00000160F4C79C80)
0 params, 14 slots, 13 upvalues, 0 locals, 63 constants, 0 functions
	...
	180	[2332]	SETTABLE 	R11 K39 R12 ; R11["MAX"] := R12
...
function #35 <?:2378,2381> (19 instructions, 76 bytes at 000001608D052A20)
...
function #36 <?:2383,2488> (296 instructions, 1184 bytes at 000001609908FA50)
...
function #37 <?:2490,2747> (688 instructions, 2752 bytes at 00000160990909F0)
...
function #38 <?:2749,2751> (3 instructions, 12 bytes at 00000160990929E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[2750]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[2750]	CALL     	R0 1 1 ; R0()
	3	[2751]	RETURN   	R0 1 ; return 

function #39 <?:2753,2755> (3 instructions, 12 bytes at 0000016099092AB0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[2754]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[2754]	CALL     	R0 1 1 ; R0()
	3	[2755]	RETURN   	R0 1 ; return 

function #40 <?:2757,2770> (40 instructions, 160 bytes at 0000016099092B80)
...
function #41 <?:2772,2783> (28 instructions, 112 bytes at 0000016099092E30)
...
function #42 <?:2785,2787> (4 instructions, 16 bytes at 0000016099093040)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #43 <?:2789,2791> (4 instructions, 16 bytes at 0000016099093110)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #44 <?:2793,2795> (6 instructions, 24 bytes at 00000160990931E0)
...
function #45 <?:2797,2800> (3 instructions, 12 bytes at 00000160990932F0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[2799]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[2799]	RETURN   	R0 2 ; return R0 
	3	[2800]	RETURN   	R0 1 ; return 

function #46 <?:2802,2811> (25 instructions, 100 bytes at 00000160990933C0)
...
function #47 <?:2813,2816> (5 instructions, 20 bytes at 0000016099093680)
...
function #48 <?:2818,2820> (3 instructions, 12 bytes at 00000160F4C357D0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[2819]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[2819]	RETURN   	R0 2 ; return R0 
	3	[2820]	RETURN   	R0 1 ; return 

function #49 <?:2822,2824> (3 instructions, 12 bytes at 00000160F4C358A0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[2823]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[2823]	RETURN   	R0 2 ; return R0 
	3	[2824]	RETURN   	R0 1 ; return 

function #50 <?:2826,2832> (10 instructions, 40 bytes at 00000160F4C35970)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #51 <?:2834,2839> (14 instructions, 56 bytes at 00000160F4C35AB0)
