...
main <?:0,0> (466 instructions, 1864 bytes at 00000160FC439040)
...
function #1 <?:117,147> (133 instructions, 532 bytes at 00000160FC43A850)
0 params, 5 slots, 5 upvalues, 0 locals, 27 constants, 0 functions
	...
	86	[133]	SETTABLE 	R0 K16 R1 ; R0["FloatingContentHighlightObject"] := R1
...
function #2 <?:149,169> (49 instructions, 196 bytes at 00000160FC43B000)
...
function #3 <?:171,193> (92 instructions, 368 bytes at 00000160FC43B450)
1 param, 11 slots, 0 upvalues, 0 locals, 18 constants, 0 functions
	...
	8	[172]	SETTABLE 	R1 K1 R2 ; R1["PodState"] := R2
	...
	84	[187]	SETTABLE 	R3 K6 R4 ; R3["LastPlayed"] := R4
...
function #4 <?:195,199> (13 instructions, 52 bytes at 000001608A6B3AD0)
...
function #5 <?:201,205> (13 instructions, 52 bytes at 000001608A6B3C00)
0 params, 4 slots, 0 upvalues, 0 locals, 6 constants, 0 functions
...
function #6 <?:207,213> (20 instructions, 80 bytes at 000001608A6B3DA0)
...
function #7 <?:215,234> (59 instructions, 236 bytes at 000001608A6B3F70)
...
function #8 <?:236,311> (139 instructions, 556 bytes at 000001608A6B4310)
...
function #9 <?:313,315> (3 instructions, 12 bytes at 000001608A6B4F40)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[314]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[314]	CALL     	R0 1 1 ; R0()
	3	[315]	RETURN   	R0 1 ; return 

function #10 <?:317,327> (19 instructions, 76 bytes at 000001608A6B5010)
...
function #11 <?:329,353> (63 instructions, 252 bytes at 000001608A6B51D0)
...
function #12 <?:355,357> (3 instructions, 12 bytes at 000001608A6B5660)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[356]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[356]	CALL     	R0 1 1 ; R0()
	3	[357]	RETURN   	R0 1 ; return 

function #13 <?:359,362> (10 instructions, 40 bytes at 000001608A6B5730)
...
function #14 <?:364,375> (12 instructions, 48 bytes at 000001608A6B5850)
...
function #15 <?:377,404> (130 instructions, 520 bytes at 000001608A6B5AE0)
...
function #16 <?:406,453> (101 instructions, 404 bytes at 000001608A6B6200)
...
function #17 <?:455,462> (24 instructions, 96 bytes at 000001608A6B6B00)
...
function #18 <?:464,466> (4 instructions, 16 bytes at 000001608A6B6D00)
...
function #19 <?:468,483> (38 instructions, 152 bytes at 000001608A6B6DD0)
...
function #20 <?:485,491> (8 instructions, 32 bytes at 000001608A6B7070)
...
function #21 <?:493,499> (14 instructions, 56 bytes at 000001608A6B7160)
...
function #22 <?:501,511> (22 instructions, 88 bytes at 000001608A6B7320)
...
function #23 <?:513,530> (32 instructions, 128 bytes at 000001608A6B7510)
...
function #24 <?:532,562> (32 instructions, 128 bytes at 000001608A6B7A40)
...
function #25 <?:564,601> (26 instructions, 104 bytes at 000001608A6B82C0)
...
function #26 <?:603,616> (27 instructions, 108 bytes at 000001608AF765E0)
...
function #27 <?:619,628> (32 instructions, 128 bytes at 000001608AF76880)
...
function #28 <?:630,923> (110 instructions, 440 bytes at 000001608AF76D50)
0 params, 6 slots, 19 upvalues, 0 locals, 36 constants, 14 functions
	...
	56	[719]	SETTABLE 	R1 K26 R2 ; R1["UpdateElementColor"] := R2
...
function #29 <?:925,955> (62 instructions, 248 bytes at 0000016093728AC0)
...
function #30 <?:957,972> (38 instructions, 152 bytes at 0000016093728F10)
...
function #31 <?:974,1039> (328 instructions, 1312 bytes at 00000160937291A0)
0 params, 23 slots, 12 upvalues, 0 locals, 108 constants, 2 functions
	...
	230	[1002]	SETTABLE 	R8 K90 R9 ; R8["XP"] := R9
	231	[1003]	GETTABLE 	R8 R2 R6 ; R8 := R2[R6]
	232	[1003]	SETTABLE 	R8 K92 R6 ; R8["Id"] := R6
...
function #32 <?:1041,1045> (11 instructions, 44 bytes at 000001609372A690)
...
function #33 <?:1047,1151> (305 instructions, 1220 bytes at 000001609372A7E0)
...
function #34 <?:1153,1172> (92 instructions, 368 bytes at 000001609372B680)
...
function #35 <?:1174,1197> (68 instructions, 272 bytes at 000001609372C070)
...
function #36 <?:1199,1225> (44 instructions, 176 bytes at 000001609372C220)
...
function #37 <?:1227,1250> (56 instructions, 224 bytes at 000001609450B0F0)
...
function #38 <?:1252,1280> (101 instructions, 404 bytes at 000001609450B620)
0 params, 9 slots, 3 upvalues, 0 locals, 24 constants, 0 functions
	...
	27	[1259]	SETTABLE 	R0 K9 R1 ; R0[0xf2deaf69] := R1
	...
	49	[1266]	SETTABLE 	R0 K9 R1 ; R0[0xf2deaf69] := R1
	...
	54	[1267]	SETTABLE 	R0 K16 R1 ; R0[0x943ae11e] := R1
	...
	59	[1268]	SETTABLE 	R0 K17 R1 ; R0[0x34291f5c] := R1
...
function #39 <?:1282,1303> (124 instructions, 496 bytes at 000001609450BBA0)
...
function #40 <?:1305,1414> (388 instructions, 1552 bytes at 000001609450C170)
...
function #41 <?:1416,1418> (3 instructions, 12 bytes at 000001609450D6A0)
...
function #42 <?:1420,1427> (10 instructions, 40 bytes at 000001609450D770)
...
function #43 <?:1429,1431> (2 instructions, 8 bytes at 000001609450D880)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1430]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[1431]	RETURN   	R0 1 ; return 

function #44 <?:1433,1435> (4 instructions, 16 bytes at 000001609450D950)
...
function #45 <?:1437,1439> (3 instructions, 12 bytes at 000001609450DA20)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1438]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1438]	CALL     	R0 1 1 ; R0()
	3	[1439]	RETURN   	R0 1 ; return 

function #46 <?:1441,1444> (5 instructions, 20 bytes at 000001609450DAF0)
...
function #47 <?:1446,1452> (12 instructions, 48 bytes at 000001609450DC10)
...
function #48 <?:1454,1458> (12 instructions, 48 bytes at 000001609450DD50)
...
function #49 <?:1460,1464> (15 instructions, 60 bytes at 000001609450DEA0)
...
function #50 <?:1466,1470> (16 instructions, 64 bytes at 000001609450E010)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #51 <?:1472,1475> (5 instructions, 20 bytes at 000001609450E180)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #52 <?:1477,1479> (6 instructions, 24 bytes at 000001609450E270)
...
function #53 <?:1481,1482> (1 instruction, 4 bytes at 000001609450E3A0)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1482]	RETURN   	R0 1 ; return 

function #54 <?:1484,1489> (26 instructions, 104 bytes at 000001609450E470)
0 params, 2 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #55 <?:1491,1493> (3 instructions, 12 bytes at 000001609450E650)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1492]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1492]	RETURN   	R0 2 ; return R0 
	3	[1493]	RETURN   	R0 1 ; return 

function #56 <?:1495,1525> (79 instructions, 316 bytes at 000001609450E720)
...
function #57 <?:1527,1531> (11 instructions, 44 bytes at 000001609450ECE0)
...
function #58 <?:1533,1535> (3 instructions, 12 bytes at 000001609450EE60)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1534]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1534]	CALL     	R0 1 1 ; R0()
	3	[1535]	RETURN   	R0 1 ; return 

function #59 <?:1537,1556> (36 instructions, 144 bytes at 000001609450EF30)
...
function #60 <?:1558,1570> (33 instructions, 132 bytes at 000001609450F2A0)
...
function #61 <?:1572,1594> (66 instructions, 264 bytes at 0000016086142920)
...
function #62 <?:1596,1598> (11 instructions, 44 bytes at 0000016086142DE0)
...
function #63 <?:1600,1605> (34 instructions, 136 bytes at 0000016086143060)
...
function #64 <?:1607,1611> (32 instructions, 128 bytes at 0000016086143320)
...
function #65 <?:1613,1671> (140 instructions, 560 bytes at 0000016086143570)
...
function #66 <?:1673,1693> (51 instructions, 204 bytes at 0000016086143F10)
...
function #67 <?:1695,1702> (18 instructions, 72 bytes at 00000160861442B0)
...
function #68 <?:1704,1706> (3 instructions, 12 bytes at 0000016086144470)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1705]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1705]	CALL     	R0 1 1 ; R0()
	3	[1706]	RETURN   	R0 1 ; return 

function #69 <?:1708,1710> (3 instructions, 12 bytes at 0000016086144540)
