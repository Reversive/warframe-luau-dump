...
main <?:0,0> (381 instructions, 1524 bytes at 0000016097A93FA0)
...
function #1 <?:63,65> (2 instructions, 8 bytes at 0000016097A94E20)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[64]	RETURN   	R0 2 ; return R0 
	2	[65]	RETURN   	R0 1 ; return 

function #2 <?:67,69> (3 instructions, 12 bytes at 0000016097A94EF0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[68]	NEWTABLE 	R0 0 0 ; R0 := {}
	2	[68]	RETURN   	R0 2 ; return R0 
	3	[69]	RETURN   	R0 1 ; return 

function #3 <?:72,74> (2 instructions, 8 bytes at 0000016097A94FC0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[73]	RETURN   	R0 2 ; return R0 
	2	[74]	RETURN   	R0 1 ; return 

function #4 <?:76,89> (28 instructions, 112 bytes at 0000016097A95090)
...
function #5 <?:91,124> (77 instructions, 308 bytes at 0000016097A95290)
...
function #6 <?:126,128> (3 instructions, 12 bytes at 0000016097A956C0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[127]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[127]	RETURN   	R0 2 ; return R0 
	3	[128]	RETURN   	R0 1 ; return 

function #7 <?:130,147> (50 instructions, 200 bytes at 0000016097A95790)
...
function #8 <?:149,151> (3 instructions, 12 bytes at 0000016097A95AB0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[150]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[150]	CALL     	R0 1 1 ; R0()
	3	[151]	RETURN   	R0 1 ; return 

function #9 <?:153,165> (24 instructions, 96 bytes at 0000016097A95B80)
...
function #10 <?:167,183> (49 instructions, 196 bytes at 0000016097A95D90)
...
function #11 <?:185,195> (11 instructions, 44 bytes at 0000016097A96100)
...
function #12 <?:197,238> (78 instructions, 312 bytes at 0000016097A96380)
2 params, 8 slots, 5 upvalues, 0 locals, 9 constants, 1 function
	...
	67	[230]	SETTABLE 	R0 K4 R5 ; R0[0x00000000] := R5
...
function #13 <?:240,242> (6 instructions, 24 bytes at 0000016097A968E0)
...
function #14 <?:246,283> (81 instructions, 324 bytes at 0000016097A969F0)
...
function #15 <?:285,289> (18 instructions, 72 bytes at 0000016097A971A0)
...
function #16 <?:291,304> (38 instructions, 152 bytes at 0000016097A97340)
...
function #17 <?:306,364> (127 instructions, 508 bytes at 000001609A40E230)
...
function #18 <?:366,495> (150 instructions, 600 bytes at 000001609A40E9D0)
...
function #19 <?:497,546> (143 instructions, 572 bytes at 000001609A410420)
...
function #20 <?:548,670> (323 instructions, 1292 bytes at 000001609A410B30)
...
function #21 <?:672,726> (196 instructions, 784 bytes at 000001609A412020)
...
function #22 <?:728,732> (11 instructions, 44 bytes at 000001609A412BB0)
...
function #23 <?:734,736> (2 instructions, 8 bytes at 00000160879990B0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[735]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[736]	RETURN   	R0 1 ; return 

function #24 <?:738,740> (2 instructions, 8 bytes at 0000016087999180)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[739]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[740]	RETURN   	R0 1 ; return 

function #25 <?:742,744> (2 instructions, 8 bytes at 0000016087999250)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[743]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[744]	RETURN   	R0 1 ; return 

function #26 <?:746,748> (2 instructions, 8 bytes at 0000016087999320)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[747]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[748]	RETURN   	R0 1 ; return 

function #27 <?:750,752> (2 instructions, 8 bytes at 00000160879993F0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[751]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[752]	RETURN   	R0 1 ; return 

function #28 <?:754,756> (2 instructions, 8 bytes at 00000160879994C0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[755]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[756]	RETURN   	R0 1 ; return 

function #29 <?:758,763> (17 instructions, 68 bytes at 0000016087999590)
...
function #30 <?:765,767> (4 instructions, 16 bytes at 0000016087999730)
...
function #31 <?:769,772> (6 instructions, 24 bytes at 0000016087999800)
...
function #32 <?:774,776> (2 instructions, 8 bytes at 00000160879998F0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[775]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[776]	RETURN   	R0 1 ; return 

function #33 <?:778,780> (2 instructions, 8 bytes at 00000160879999C0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[779]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[780]	RETURN   	R0 1 ; return 

function #34 <?:782,784> (2 instructions, 8 bytes at 0000016087999A90)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[783]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[784]	RETURN   	R0 1 ; return 

function #35 <?:786,788> (2 instructions, 8 bytes at 0000016087999B60)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[787]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[788]	RETURN   	R0 1 ; return 

function #36 <?:790,792> (2 instructions, 8 bytes at 0000016087999C30)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[791]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[792]	RETURN   	R0 1 ; return 

function #37 <?:794,800> (5 instructions, 20 bytes at 0000016087999D00)
...
function #38 <?:802,804> (6 instructions, 24 bytes at 0000016087999E10)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #39 <?:806,808> (2 instructions, 8 bytes at 0000016087999F20)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[807]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[808]	RETURN   	R0 1 ; return 

function #40 <?:810,812> (5 instructions, 20 bytes at 0000016087999FF0)
...
function #41 <?:814,816> (6 instructions, 24 bytes at 000001608799A100)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #42 <?:818,824> (12 instructions, 48 bytes at 000001608799A210)
...
function #43 <?:826,828> (3 instructions, 12 bytes at 000001608799A360)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[827]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[827]	CALL     	R0 1 1 ; R0()
	3	[828]	RETURN   	R0 1 ; return 

function #44 <?:830,832> (3 instructions, 12 bytes at 000001608799A430)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[831]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[831]	CALL     	R0 1 1 ; R0()
	3	[832]	RETURN   	R0 1 ; return 

function #45 <?:834,838> (8 instructions, 32 bytes at 000001608799A500)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #46 <?:840,847> (17 instructions, 68 bytes at 000001608799A630)
...
function #47 <?:849,851> (3 instructions, 12 bytes at 000001608799A800)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[850]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[850]	CALL     	R0 1 1 ; R0()
	3	[851]	RETURN   	R0 1 ; return 

function #48 <?:853,861> (21 instructions, 84 bytes at 000001608799A8D0)
...
function #49 <?:863,914> (196 instructions, 784 bytes at 000001608799AAB0)
...
function #50 <?:916,918> (5 instructions, 20 bytes at 000001608799B440)
...
function #51 <?:922,926> (12 instructions, 48 bytes at 000001608799B530)
...
function #52 <?:928,932> (12 instructions, 48 bytes at 000001608799B680)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #53 <?:934,939> (21 instructions, 84 bytes at 000001608799B7D0)
...
function #54 <?:941,945> (14 instructions, 56 bytes at 000001608799B9B0)
...
function #55 <?:947,951> (14 instructions, 56 bytes at 000001608799BB30)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #56 <?:953,957> (18 instructions, 72 bytes at 000001608799BCB0)
...
function #57 <?:959,963> (14 instructions, 56 bytes at 000001608799BE50)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #58 <?:965,969> (14 instructions, 56 bytes at 000001608799BFD0)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #59 <?:971,975> (18 instructions, 72 bytes at 000001608799C150)
1 param, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #60 <?:977,982> (14 instructions, 56 bytes at 000001608799C2F0)
...
function #61 <?:984,989> (14 instructions, 56 bytes at 000001608799C450)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #62 <?:991,995> (11 instructions, 44 bytes at 000001608799C5B0)
...
function #63 <?:997,1001> (11 instructions, 44 bytes at 000001608799C700)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #64 <?:1003,1007> (11 instructions, 44 bytes at 000001608799C850)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #65 <?:1009,1013> (11 instructions, 44 bytes at 000001608799C9A0)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #66 <?:1015,1019> (11 instructions, 44 bytes at 000001608799CAF0)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #67 <?:1021,1025> (11 instructions, 44 bytes at 000001608799CC40)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #68 <?:1027,1036> (31 instructions, 124 bytes at 000001608799CD90)
...
function #69 <?:1038,1040> (6 instructions, 24 bytes at 000001608799CFC0)
0 params, 2 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #70 <?:1042,1051> (27 instructions, 108 bytes at 000001608799D0F0)
...
function #71 <?:1057,1059> (3 instructions, 12 bytes at 000001608799D2F0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1058]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1058]	RETURN   	R0 2 ; return R0 
	3	[1059]	RETURN   	R0 1 ; return 

function #72 <?:1061,1063> (3 instructions, 12 bytes at 000001608799D3C0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1062]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1062]	RETURN   	R0 2 ; return R0 
	3	[1063]	RETURN   	R0 1 ; return 

function #73 <?:1065,1067> (3 instructions, 12 bytes at 000001608799D490)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1066]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1066]	RETURN   	R0 2 ; return R0 
	3	[1067]	RETURN   	R0 1 ; return 

function #74 <?:1069,1071> (3 instructions, 12 bytes at 000001608799D560)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
