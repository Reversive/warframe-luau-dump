...
main <?:0,0> (122 instructions, 488 bytes at 0000016080268580)
...
function #1 <?:44,50> (11 instructions, 44 bytes at 00000160802689F0)
...
function #2 <?:52,54> (3 instructions, 12 bytes at 0000016080268B50)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[53]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[53]	CALL     	R0 1 1 ; R0()
	3	[54]	RETURN   	R0 1 ; return 

function #3 <?:56,58> (4 instructions, 16 bytes at 0000016080268C20)
...
function #4 <?:60,98> (245 instructions, 980 bytes at 0000016080268D10)
...
function #5 <?:100,248> (135 instructions, 540 bytes at 00000160FB26A150)
...
function #6 <?:250,285> (123 instructions, 492 bytes at 00000160FB26C7E0)
...
function #7 <?:287,299> (18 instructions, 72 bytes at 00000160FB26CE40)
...
function #8 <?:301,463> (488 instructions, 1952 bytes at 00000160971AD350)
0 params, 58 slots, 14 upvalues, 0 locals, 105 constants, 0 functions
	...
	142	[354]	SETTABLE 	R24 K34 R25 ; R24[0x091c120e] := R25
	...
	151	[357]	SETTABLE 	R23 K37 R24 ; R23[0x67bc869f] := R24
	...
	419	[432]	SETTABLE 	R51 K87 R52 ; R51[0x5e35d4d6] := R52
	420	[433]	SETTABLE 	R51 K89 R43 ; R51[0x67bc869f] := R43
...
function #9 <?:465,470> (28 instructions, 112 bytes at 00000160971AEC60)
...
function #10 <?:472,505> (89 instructions, 356 bytes at 00000160971AEED0)
...
function #11 <?:507,519> (24 instructions, 96 bytes at 00000160971AF6A0)
...
function #12 <?:521,524> (5 instructions, 20 bytes at 00000160971AF880)
...
function #13 <?:526,529> (8 instructions, 32 bytes at 00000160971AF970)
...
function #14 <?:531,537> (8 instructions, 32 bytes at 00000160971AFAA0)
0 params, 2 slots, 2 upvalues, 0 locals, 0 constants, 0 functions
...
function #15 <?:539,548> (13 instructions, 52 bytes at 00000160971AFB90)
...
function #16 <?:550,554> (8 instructions, 32 bytes at 00000160971AFD70)
...
function #17 <?:556,558> (3 instructions, 12 bytes at 00000160971AFE80)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[557]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[557]	CALL     	R0 1 1 ; R0()
	3	[558]	RETURN   	R0 1 ; return 

function #18 <?:560,564> (8 instructions, 32 bytes at 00000160971AFF50)
