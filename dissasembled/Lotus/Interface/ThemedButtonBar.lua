...
main <?:0,0> (111 instructions, 444 bytes at 00000160805F8250)
...
function #1 <?:22,38> (26 instructions, 104 bytes at 0000016084D88E50)
...
function #2 <?:40,52> (24 instructions, 96 bytes at 000001609AA236B0)
...
function #3 <?:54,60> (9 instructions, 36 bytes at 00000160FF8A9F10)
...
function #4 <?:62,64> (4 instructions, 16 bytes at 00000160FD8CB590)
...
function #5 <?:66,75> (18 instructions, 72 bytes at 00000160FD8FB590)
0 params, 7 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #6 <?:77,91> (24 instructions, 96 bytes at 000001609855F3E0)
...
function #7 <?:93,260> (128 instructions, 512 bytes at 0000016098176DF0)
...
function #8 <?:262,303> (103 instructions, 412 bytes at 000001609AA4F810)
5 params, 23 slots, 3 upvalues, 0 locals, 19 constants, 0 functions
	...
	14	[268]	SETTABLE 	R5 K7 R6 ; R5["mIgnoreInput"] := R6
...
function #9 <?:305,308> (7 instructions, 28 bytes at 00000160F7043FB0)
...
function #10 <?:310,389> (55 instructions, 220 bytes at 00000160967A0430)
...
function #11 <?:391,398> (13 instructions, 52 bytes at 0000016082197EE0)
...
function #12 <?:400,402> (4 instructions, 16 bytes at 0000016097B25200)
...
function #13 <?:404,406> (15 instructions, 60 bytes at 00000160F6C13DA0)
...
function #14 <?:408,417> (2 instructions, 8 bytes at 000001608C87DF90)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[416]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[417]	RETURN   	R0 1 ; return 

function #15 <?:419,421> (7 instructions, 28 bytes at 000001609942B600)
...
function #16 <?:423,455> (32 instructions, 128 bytes at 00000160D7F645C0)
...
function #17 <?:457,476> (36 instructions, 144 bytes at 000001608C4F3400)
0 params, 2 slots, 11 upvalues, 0 locals, 12 constants, 0 functions
	...
	12	[461]	SETTABLE 	R0 K5 R1 ; R0[0x00000000] := R1
...
function #18 <?:478,507> (64 instructions, 256 bytes at 000001608C43B600)
...
function #19 <?:510,514> (12 instructions, 48 bytes at 00000160957A38D0)
...
function #20 <?:516,520> (12 instructions, 48 bytes at 000001608BEB7DD0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #21 <?:522,526> (12 instructions, 48 bytes at 000001608BE67540)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #22 <?:528,530> (3 instructions, 12 bytes at 00000160957CA9F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[529]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[529]	CALL     	R0 1 1 ; R0()
	3	[530]	RETURN   	R0 1 ; return 

function #23 <?:532,536> (8 instructions, 32 bytes at 00000160957CCE30)
...
function #24 <?:538,540> (3 instructions, 12 bytes at 0000016095790F50)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
