...
main <?:0,0> (302 instructions, 1208 bytes at 0000016086496DF0)
...
function #1 <?:49,51> (3 instructions, 12 bytes at 00000160864972B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[50]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[50]	RETURN   	R0 2 ; return R0 
	3	[51]	RETURN   	R0 1 ; return 

function #2 <?:53,61> (45 instructions, 180 bytes at 0000016086497360)
...
function #3 <?:63,109> (101 instructions, 404 bytes at 0000016086497640)
...
function #4 <?:111,115> (10 instructions, 40 bytes at 0000016086497AF0)
...
function #5 <?:117,149> (91 instructions, 364 bytes at 0000016086497C50)
...
function #6 <?:151,156> (10 instructions, 40 bytes at 0000016086497D10)
...
function #7 <?:158,183> (67 instructions, 268 bytes at 0000016086497E70)
...
function #8 <?:185,203> (34 instructions, 136 bytes at 0000016086498250)
...
function #9 <?:205,230> (47 instructions, 188 bytes at 0000016086498490)
...
function #10 <?:232,254> (70 instructions, 280 bytes at 00000160864987D0)
...
function #11 <?:256,270> (51 instructions, 204 bytes at 0000016086498C00)
...
function #12 <?:272,276> (6 instructions, 24 bytes at 0000016086498EB0)
...
function #13 <?:278,303> (33 instructions, 132 bytes at 0000016086498FA0)
...
function #14 <?:305,308> (5 instructions, 20 bytes at 0000016086499640)
...
function #15 <?:310,325> (36 instructions, 144 bytes at 00000160864997A0)
...
function #16 <?:327,329> (3 instructions, 12 bytes at 00000160864999F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[328]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[328]	CALL     	R0 1 1 ; R0()
	3	[329]	RETURN   	R0 1 ; return 

function #17 <?:331,340> (19 instructions, 76 bytes at 0000016086499AC0)
...
function #18 <?:342,344> (4 instructions, 16 bytes at 0000016086499C50)
...
function #19 <?:346,368> (73 instructions, 292 bytes at 0000016086499D20)
0 params, 12 slots, 6 upvalues, 0 locals, 20 constants, 0 functions
	...
	36	[353]	SETTABLE 	R9 K10 R10 ; R9[0x018000cc] := R10
...
function #20 <?:370,404> (77 instructions, 308 bytes at 000001608649A210)
...
function #21 <?:406,428> (67 instructions, 268 bytes at 000001608649A6C0)
...
function #22 <?:430,445> (46 instructions, 184 bytes at 000001608649AB40)
...
function #23 <?:447,466> (66 instructions, 264 bytes at 000001608649AE00)
...
function #24 <?:468,472> (11 instructions, 44 bytes at 000001608649B1D0)
...
function #25 <?:474,493> (57 instructions, 228 bytes at 000001608649B350)
...
function #26 <?:496,526> (92 instructions, 368 bytes at 0000016092FC35E0)
...
function #27 <?:528,540> (32 instructions, 128 bytes at 0000016092FC3B00)
...
function #28 <?:542,546> (14 instructions, 56 bytes at 0000016092FC3D80)
...
function #29 <?:548,552> (6 instructions, 24 bytes at 0000016092FC3F00)
...
function #30 <?:554,579> (82 instructions, 328 bytes at 0000016092FC3FF0)
...
function #31 <?:582,586> (8 instructions, 32 bytes at 0000016092FC45A0)
...
function #32 <?:588,652> (167 instructions, 668 bytes at 0000016092FC46F0)
...
function #33 <?:654,658> (12 instructions, 48 bytes at 0000016092FC5460)
...
function #34 <?:660,664> (12 instructions, 48 bytes at 0000016092FC55B0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #35 <?:666,670> (15 instructions, 60 bytes at 0000016092FC5700)
...
function #36 <?:672,701> (76 instructions, 304 bytes at 0000016092FC5870)
...
function #37 <?:703,798> (65 instructions, 260 bytes at 0000016092FC5C80)
...
function #38 <?:800,802> (3 instructions, 12 bytes at 0000016092FC78F0)
...
function #39 <?:804,808> (7 instructions, 28 bytes at 0000016092FC79C0)
...
function #40 <?:810,859> (129 instructions, 516 bytes at 0000016092FC7AD0)
...
function #41 <?:861,863> (3 instructions, 12 bytes at 000001609859EE00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[862]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[862]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[863]	RETURN   	R0 1 ; return 

function #42 <?:865,867> (3 instructions, 12 bytes at 000001608CBDF0F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[866]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[866]	CALL     	R0 1 1 ; R0()
	3	[867]	RETURN   	R0 1 ; return 

function #43 <?:869,874> (12 instructions, 48 bytes at 000001608CBDF1C0)
...
function #44 <?:877,881> (9 instructions, 36 bytes at 000001608CBDF2D0)
...
function #45 <?:883,889> (13 instructions, 52 bytes at 000001608CBDF3E0)
...
function #46 <?:893,895> (6 instructions, 24 bytes at 000001608CBDF540)
...
function #47 <?:898,902> (12 instructions, 48 bytes at 000001608CBDF670)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #48 <?:904,908> (12 instructions, 48 bytes at 000001608CBDF7C0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #49 <?:910,914> (16 instructions, 64 bytes at 000001608CBDF910)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #50 <?:916,920> (15 instructions, 60 bytes at 000001608CBDFA80)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #51 <?:922,929> (21 instructions, 84 bytes at 000001608CBDFBF0)
...
function #52 <?:931,934> (8 instructions, 32 bytes at 000001608CBDFD70)
...
function #53 <?:936,938> (2 instructions, 8 bytes at 000001608CBDFE80)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[937]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[938]	RETURN   	R0 1 ; return 

function #54 <?:940,942> (2 instructions, 8 bytes at 000001608CBDFF50)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[941]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[942]	RETURN   	R0 1 ; return 

function #55 <?:944,946> (2 instructions, 8 bytes at 000001608CBE0020)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[945]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[946]	RETURN   	R0 1 ; return 

function #56 <?:948,950> (2 instructions, 8 bytes at 000001608CBE00F0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[949]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[950]	RETURN   	R0 1 ; return 

function #57 <?:952,954> (2 instructions, 8 bytes at 000001608CBE01C0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[953]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[954]	RETURN   	R0 1 ; return 

function #58 <?:956,958> (6 instructions, 24 bytes at 000001608CBE0290)
