...
main <?:0,0> (55 instructions, 220 bytes at 0000016099C79B00)
...
function #1 <?:15,29> (26 instructions, 104 bytes at 0000016099C5BE40)
...
function #2 <?:31,43> (26 instructions, 104 bytes at 0000016099C5BF90)
...
function #3 <?:45,62> (52 instructions, 208 bytes at 0000016099C5C190)
0 params, 6 slots, 5 upvalues, 0 locals, 15 constants, 0 functions
	...
	36	[56]	SETTABLE 	R4 K11 R5 ; R4[0x7769971f] := R5
	...
	44	[57]	SETTABLE 	R4 K11 R5 ; R4[0x7769971f] := R5
...
function #5 <?:70,139> (195 instructions, 780 bytes at 0000016099C5C5F0)
...
function #6 <?:141,143> (1 instruction, 4 bytes at 0000016099C79080)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[143]	RETURN   	R0 1 ; return 

function #7 <?:145,154> (15 instructions, 60 bytes at 0000016099C798B0)
...
function #8 <?:156,162> (18 instructions, 72 bytes at 0000016099C82700)
