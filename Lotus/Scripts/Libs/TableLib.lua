...
main <?:0,0> (51 instructions, 204 bytes at 00000211153396F0)
0+ params, 8 slots, 0 upvalues, 0 locals, 18 constants, 19 functions
	...
	30	[168]	SETTABLE 	R6 K8 R7 ; R6[0x7b998233] := R7
	31	[182]	CLOSURE  	R7 12 ; R7 := closure(Function #13)
	32	[182]	MOVE     	R0 R2 ; R0 := R2
	33	[182]	SETTABLE 	R6 K9 R7 ; R6[0xcfc01047] := R7
...
function #1 <?:6,13> (8 instructions, 32 bytes at 0000021115339CE0)
...
function #2 <?:15,34> (31 instructions, 124 bytes at 0000021115339DD0)
...
function #3 <?:37,52> (37 instructions, 148 bytes at 0000021115339FB0)
...
function #4 <?:54,64> (19 instructions, 76 bytes at 000002111533A200)
...
function #5 <?:66,72> (15 instructions, 60 bytes at 000002111533A380)
...
function #6 <?:74,92> (36 instructions, 144 bytes at 000002111533A4D0)
...
function #7 <?:97,99> (6 instructions, 24 bytes at 000002111533A6F0)
...
function #8 <?:101,111> (23 instructions, 92 bytes at 000002111533A7E0)
...
function #9 <?:114,119> (12 instructions, 48 bytes at 000002111533A980)
...
function #10 <?:121,136> (35 instructions, 140 bytes at 000002111533AAD0)
...
function #11 <?:139,157> (29 instructions, 116 bytes at 000002111533ACF0)
...
function #12 <?:159,168> (15 instructions, 60 bytes at 000002112D592C80)
...
function #13 <?:170,182> (18 instructions, 72 bytes at 000002112D592DF0)
...
function #14 <?:184,190> (19 instructions, 76 bytes at 000002112D592F70)
...
function #15 <?:192,208> (21 instructions, 84 bytes at 000002112D593110)
...
function #16 <?:210,217> (14 instructions, 56 bytes at 000002112D5932B0)
...
function #17 <?:219,227> (18 instructions, 72 bytes at 000002112D593400)
...
function #18 <?:231,233> (7 instructions, 28 bytes at 000002112D593570)
...
function #19 <?:237,239> (7 instructions, 28 bytes at 000002112D593660)
2 params, 6 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
