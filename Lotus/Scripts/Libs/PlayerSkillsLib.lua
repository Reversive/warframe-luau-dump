...
main <?:0,0> (598 instructions, 2392 bytes at 000002111CFADF60)
0+ params, 16 slots, 0 upvalues, 0 locals, 125 constants, 2 functions
	...
	156	[65]	SETTABLE 	R9 K78 R10 ; R9["filter"] := R10
	...
	160	[69]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	161	[71]	SETLIST  	R8 2 1 ; R8[(1-1)*FPF+i] := R(8+i), 1 <= i <= 2
	162	[71]	SETTABLE 	R7 K74 R8 ; R7[1.000000] := R8
	...
	167	[77]	SETTABLE 	R9 K78 R10 ; R9["filter"] := R10
	168	[79]	SETLIST  	R8 1 1 ; R8[(1-1)*FPF+i] := R(8+i), 1 <= i <= 1
	169	[79]	SETTABLE 	R7 K79 R8 ; R7[2.000000] := R8
	...
	174	[85]	SETTABLE 	R9 K78 R10 ; R9["filter"] := R10
	175	[87]	SETLIST  	R8 1 1 ; R8[(1-1)*FPF+i] := R(8+i), 1 <= i <= 1
	176	[87]	SETTABLE 	R7 K80 R8 ; R7[3.000000] := R8
	...
	181	[93]	SETTABLE 	R9 K78 R10 ; R9["filter"] := R10
	182	[95]	SETLIST  	R8 1 1 ; R8[(1-1)*FPF+i] := R(8+i), 1 <= i <= 1
	183	[95]	SETTABLE 	R7 K81 R8 ; R7[4.000000] := R8
	...
	188	[101]	SETTABLE 	R9 K78 R10 ; R9["filter"] := R10
	189	[103]	SETLIST  	R8 1 1 ; R8[(1-1)*FPF+i] := R(8+i), 1 <= i <= 1
	190	[103]	SETTABLE 	R7 K82 R8 ; R7[5.000000] := R8
	...
	200	[116]	SETTABLE 	R10 K89 R6 ; R10["validType"] := R6
	201	[118]	SETLIST  	R8 2 1 ; R8[(1-1)*FPF+i] := R(8+i), 1 <= i <= 2
	202	[118]	SETTABLE 	R7 K83 R8 ; R7[6.000000] := R8
	...
	216	[135]	SETTABLE 	R9 K96 R10 ; R9["category"] := R10
	...
	221	[141]	SETTABLE 	R10 K89 R5 ; R10["validType"] := R5
	222	[142]	GETGLOBAL	R11 K63 ; R11 := CATEGORY_PLAYER
	223	[142]	SETTABLE 	R10 K96 R11 ; R10["category"] := R11
	...
	232	[153]	SETTABLE 	R7 K98 R8 ; R7[9.000000] := R8
	...
	237	[159]	SETTABLE 	R9 K78 R10 ; R9["filter"] := R10
	238	[161]	SETLIST  	R8 1 1 ; R8[(1-1)*FPF+i] := R(8+i), 1 <= i <= 1
	239	[161]	SETTABLE 	R7 K99 R8 ; R7[10.000000] := R8
	...
	245	[170]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	246	[172]	SETLIST  	R9 1 1 ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
	247	[172]	SETTABLE 	R8 K74 R9 ; R8[1.000000] := R9
	...
	252	[178]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	253	[180]	SETLIST  	R9 1 1 ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
	254	[180]	SETTABLE 	R8 K79 R9 ; R8[2.000000] := R9
	...
	259	[186]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	260	[188]	SETLIST  	R9 1 1 ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
	261	[188]	SETTABLE 	R8 K80 R9 ; R8[3.000000] := R9
	...
	266	[194]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	267	[197]	SETLIST  	R9 1 1 ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
	268	[197]	SETTABLE 	R8 K81 R9 ; R8[4.000000] := R9
	...
	273	[203]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	...
	277	[207]	SETTABLE 	R11 K78 R12 ; R11["filter"] := R12
	278	[209]	SETLIST  	R9 2 1 ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 2
	279	[209]	SETTABLE 	R8 K82 R9 ; R8[5.000000] := R9
	...
	284	[215]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	285	[217]	SETLIST  	R9 1 1 ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
	286	[217]	SETTABLE 	R8 K83 R9 ; R8[6.000000] := R9
	...
	293	[225]	SETTABLE 	R10 K96 R11 ; R10["category"] := R11
	...
	302	[235]	SETTABLE 	R10 K96 R11 ; R10["category"] := R11
	...
	311	[246]	SETTABLE 	R10 K89 R1 ; R10["validType"] := R1
	...
	317	[254]	SETTABLE 	R8 K98 R9 ; R8[9.000000] := R9
	...
	322	[260]	SETTABLE 	R10 K78 R11 ; R10["filter"] := R11
	323	[262]	SETLIST  	R9 1 1 ; R9[(1-1)*FPF+i] := R(9+i), 1 <= i <= 1
	324	[262]	SETTABLE 	R8 K99 R9 ; R8[10.000000] := R9
	...
	330	[271]	SETTABLE 	R11 K78 R12 ; R11["filter"] := R12
	...
	334	[275]	SETTABLE 	R12 K78 R13 ; R12["filter"] := R13
	335	[277]	SETLIST  	R10 2 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 2
	336	[277]	SETTABLE 	R9 K74 R10 ; R9[1.000000] := R10
	...
	341	[283]	SETTABLE 	R11 K78 R12 ; R11["filter"] := R12
	342	[285]	SETLIST  	R10 1 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 1
	343	[285]	SETTABLE 	R9 K79 R10 ; R9[2.000000] := R10
	...
	348	[291]	SETTABLE 	R11 K78 R12 ; R11["filter"] := R12
	349	[293]	SETLIST  	R10 1 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 1
	350	[293]	SETTABLE 	R9 K80 R10 ; R9[3.000000] := R10
	...
	356	[301]	SETTABLE 	R11 K89 R2 ; R11["validType"] := R2
	357	[302]	GETGLOBAL	R12 K64 ; R12 := CATEGORY_ARCHWING
	358	[302]	SETTABLE 	R11 K96 R12 ; R11["category"] := R12
	...
	363	[308]	SETTABLE 	R12 K89 R2 ; R12["validType"] := R2
	364	[309]	GETGLOBAL	R13 K64 ; R13 := CATEGORY_ARCHWING
	365	[309]	SETTABLE 	R12 K96 R13 ; R12["category"] := R13
	...
	370	[315]	SETTABLE 	R13 K89 R2 ; R13["validType"] := R2
	371	[316]	GETGLOBAL	R14 K64 ; R14 := CATEGORY_ARCHWING
	372	[316]	SETTABLE 	R13 K96 R14 ; R13["category"] := R14
	373	[318]	SETLIST  	R10 3 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 3
	374	[318]	SETTABLE 	R9 K81 R10 ; R9[4.000000] := R10
	...
	380	[326]	SETTABLE 	R11 K89 R3 ; R11["validType"] := R3
	381	[327]	GETGLOBAL	R12 K65 ; R12 := CATEGORY_MECH
	382	[327]	SETTABLE 	R11 K96 R12 ; R11["category"] := R12
	383	[329]	SETLIST  	R10 1 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 1
	384	[329]	SETTABLE 	R9 K82 R10 ; R9[5.000000] := R10
	...
	390	[337]	SETTABLE 	R11 K89 R1 ; R11["validType"] := R1
	391	[339]	SETLIST  	R10 1 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 1
	392	[339]	SETTABLE 	R9 K83 R10 ; R9[6.000000] := R10
	...
	398	[347]	SETTABLE 	R11 K89 R1 ; R11["validType"] := R1
	...
	403	[353]	SETTABLE 	R12 K89 R0 ; R12["validType"] := R0
	...
	412	[363]	SETTABLE 	R11 K96 R12 ; R11["category"] := R12
	...
	418	[369]	SETTABLE 	R12 K96 R13 ; R12["category"] := R13
	...
	424	[375]	SETTABLE 	R13 K96 R14 ; R13["category"] := R14
	...
	430	[381]	SETTABLE 	R14 K96 R15 ; R14["category"] := R15
	...
	437	[389]	SETTABLE 	R11 K78 R12 ; R11["filter"] := R12
	438	[391]	SETLIST  	R10 1 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 1
	439	[391]	SETTABLE 	R9 K98 R10 ; R9[9.000000] := R10
	...
	444	[397]	SETTABLE 	R11 K78 R12 ; R11["filter"] := R12
	...
	452	[404]	SETTABLE 	R12 K115 R13 ; R12["validModifiers"] := R13
	453	[405]	SETTABLE 	R12 K89 R1 ; R12["validType"] := R1
	454	[407]	SETLIST  	R10 2 1 ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 2
	455	[407]	SETTABLE 	R9 K99 R10 ; R9[10.000000] := R10
	...
	461	[416]	SETTABLE 	R12 K78 R13 ; R12["filter"] := R13
	462	[418]	SETLIST  	R11 1 1 ; R11[(1-1)*FPF+i] := R(11+i), 1 <= i <= 1
	463	[418]	SETTABLE 	R10 K74 R11 ; R10[1.000000] := R11
	...
	469	[426]	SETTABLE 	R12 K89 R4 ; R12["validType"] := R4
	470	[427]	GETGLOBAL	R13 K63 ; R13 := CATEGORY_PLAYER
	471	[427]	SETTABLE 	R12 K96 R13 ; R12["category"] := R13
	472	[429]	SETLIST  	R11 1 1 ; R11[(1-1)*FPF+i] := R(11+i), 1 <= i <= 1
	473	[429]	SETTABLE 	R10 K79 R11 ; R10[2.000000] := R11
	...
	478	[435]	SETTABLE 	R12 K78 R13 ; R12["filter"] := R13
	479	[437]	SETLIST  	R11 1 1 ; R11[(1-1)*FPF+i] := R(11+i), 1 <= i <= 1
	480	[437]	SETTABLE 	R10 K80 R11 ; R10[3.000000] := R11
	...
	485	[443]	SETTABLE 	R12 K78 R13 ; R12["filter"] := R13
	486	[445]	SETLIST  	R11 1 1 ; R11[(1-1)*FPF+i] := R(11+i), 1 <= i <= 1
	487	[445]	SETTABLE 	R10 K81 R11 ; R10[4.000000] := R11
	...
	492	[451]	SETTABLE 	R12 K78 R13 ; R12["filter"] := R13
	...
	498	[458]	SETTABLE 	R10 K82 R11 ; R10[5.000000] := R11
	...
	505	[467]	SETTABLE 	R10 K83 R11 ; R10[6.000000] := R11
	...
	519	[484]	SETTABLE 	R12 K96 R13 ; R12["category"] := R13
	...
	525	[490]	SETTABLE 	R13 K96 R14 ; R13["category"] := R14
	...
	531	[496]	SETTABLE 	R14 K96 R15 ; R14["category"] := R15
	...
	540	[506]	SETTABLE 	R12 K96 R13 ; R12["category"] := R13
	...
	546	[512]	SETTABLE 	R13 K96 R14 ; R13["category"] := R14
	547	[514]	SETLIST  	R11 2 1 ; R11[(1-1)*FPF+i] := R(11+i), 1 <= i <= 2
	548	[514]	SETTABLE 	R10 K98 R11 ; R10[9.000000] := R11
	...
	553	[520]	SETTABLE 	R12 K78 R13 ; R12["filter"] := R13
	554	[522]	SETLIST  	R11 1 1 ; R11[(1-1)*FPF+i] := R(11+i), 1 <= i <= 1
	555	[522]	SETTABLE 	R10 K99 R11 ; R10[10.000000] := R11
	...
	561	[531]	SETTABLE 	R13 K78 R14 ; R13["filter"] := R14
	562	[533]	SETLIST  	R12 1 1 ; R12[(1-1)*FPF+i] := R(12+i), 1 <= i <= 1
	563	[533]	SETTABLE 	R11 K74 R12 ; R11[1.000000] := R12
	564	[535]	NEWTABLE 	R12 0 0 ; R12 := {}
	565	[537]	SETTABLE 	R11 K79 R12 ; R11[2.000000] := R12
	566	[539]	NEWTABLE 	R12 0 0 ; R12 := {}
	567	[541]	SETTABLE 	R11 K80 R12 ; R11[3.000000] := R12
	568	[543]	NEWTABLE 	R12 0 0 ; R12 := {}
	569	[545]	SETTABLE 	R11 K81 R12 ; R11[4.000000] := R12
	570	[547]	NEWTABLE 	R12 0 0 ; R12 := {}
	571	[549]	SETTABLE 	R11 K82 R12 ; R11[5.000000] := R12
	572	[551]	NEWTABLE 	R12 0 0 ; R12 := {}
	573	[553]	SETTABLE 	R11 K83 R12 ; R11[6.000000] := R12
	...
	582	[567]	SETTABLE 	R13 K78 R14 ; R13["filter"] := R14
	583	[569]	SETLIST  	R12 1 1 ; R12[(1-1)*FPF+i] := R(12+i), 1 <= i <= 1
	584	[569]	SETTABLE 	R11 K98 R12 ; R11[9.000000] := R12
	585	[571]	NEWTABLE 	R12 0 0 ; R12 := {}
	586	[573]	SETTABLE 	R11 K99 R12 ; R11[10.000000] := R12
	587	[576]	NEWTABLE 	R12 0 5 ; R12 := {}
	588	[577]	SETTABLE 	R12 K80 R7 ; R12[3.000000] := R7
	589	[578]	SETTABLE 	R12 K74 R8 ; R12[1.000000] := R8
	590	[579]	SETTABLE 	R12 K79 R9 ; R12[2.000000] := R9
	591	[580]	SETTABLE 	R12 K81 R10 ; R12[4.000000] := R10
	592	[581]	SETTABLE 	R12 K82 R11 ; R12[5.000000] := R11
...
function #1 <?:584,621> (79 instructions, 316 bytes at 0000021123FE77A0)
...
function #2 <?:624,668> (85 instructions, 340 bytes at 000002111BE82CF0)
