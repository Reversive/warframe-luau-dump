...
main <?:0,0> (41 instructions, 164 bytes at 0000021119FA0A10)
...
function #1 <?:12,63> (154 instructions, 616 bytes at 0000021119F9D0A0)
...
function #2 <?:65,67> (3 instructions, 12 bytes at 0000021119F9D700)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[66]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[66]	CALL     	R0 1 1 ; R0()
	3	[67]	RETURN   	R0 1 ; return 

function #3 <?:69,156> (176 instructions, 704 bytes at 0000021124A1D920)
...
function #4 <?:158,170> (37 instructions, 148 bytes at 0000021124A1E970)
...
function #5 <?:172,187> (40 instructions, 160 bytes at 0000021124A1ECF0)
