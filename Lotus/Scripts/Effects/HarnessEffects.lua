...
main <?:0,0> (3 instructions, 12 bytes at 000002111F085AA0)
...
function #1 <?:3,38> (71 instructions, 284 bytes at 0000021133E5DC70)
...
main <?:0,0> (3 instructions, 12 bytes at 0000021120CCC860)
0+ params, 2 slots, 0 upvalues, 0 locals, 1 constant, 1 function
	1	[38]	CLOSURE  	R0 0 ; R0 := closure(Function #1)
	2	[3]	SETGLOBAL	R0 K0 ; CopySuitEnergyColors := R0
	3	[38]	RETURN   	R0 1 ; return 
...
function #1 <?:3,38> (71 instructions, 284 bytes at 0000021120CCC950)
1 param, 14 slots, 0 upvalues, 0 locals, 15 constants, 0 functions
	1	[4]	GETGLOBAL	R1 K0 ; R1 := 0xcbd666e1
	2	[4]	LOADK    	R2 := 1.000000
	3	[4]	CALL     	R1 2 1 ; R1(R2)
...
main <?:0,0> (3 instructions, 12 bytes at 000002112F6663F0)
0+ params, 2 slots, 0 upvalues, 0 locals, 1 constant, 1 function
	1	[38]	CLOSURE  	R0 0 ; R0 := closure(Function #1)
	2	[3]	SETGLOBAL	R0 K0 ; CopySuitEnergyColors := R0
	3	[38]	RETURN   	R0 1 ; return 
...
function #1 <?:3,38> (71 instructions, 284 bytes at 000002111CA532D0)
1 param, 14 slots, 0 upvalues, 0 locals, 15 constants, 0 functions
	1	[4]	GETGLOBAL	R1 K0 ; R1 := 0xcbd666e1
	2	[4]	LOADK    	R2 := 1.000000
	3	[4]	CALL     	R1 2 1 ; R1(R2)
