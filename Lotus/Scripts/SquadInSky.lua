...
main <?:0,0> (258 instructions, 1032 bytes at 000002112958E330)
0+ params, 41 slots, 0 upvalues, 0 locals, 70 constants, 20 functions
	...
	56	[46]	SETTABLE 	R21 K5 R22 ; R21["Lighting"] := R22
	...
	252	[1250]	SETTABLE 	R40 K65 R39 ; R40[0x05000000] := R39
	253	[1251]	SETTABLE 	R40 K66 R33 ; R40["AddMember"] := R33
...
function #1 <?:59,59> (3 instructions, 12 bytes at 000002112958F160)
...
function #2 <?:60,60> (6 instructions, 24 bytes at 000002112958F210)
...
function #3 <?:116,121> (10 instructions, 40 bytes at 000002112958F340)
...
function #4 <?:126,129> (7 instructions, 28 bytes at 000002112958F4B0)
3 params, 4 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
	...
	3	[127]	SETTABLE 	R3 K2 R0 ; R3["position"] := R0
...
function #5 <?:132,170> (62 instructions, 248 bytes at 000002112958F630)
5 params, 21 slots, 2 upvalues, 0 locals, 24 constants, 0 functions
	...
	37	[153]	SETTABLE 	R10 K13 R14 ; R10[0x07000038] := R14
...
function #6 <?:186,467> (426 instructions, 1704 bytes at 000002112958F9E0)
2 params, 79 slots, 5 upvalues, 0 locals, 68 constants, 4 functions
	...
	141	[308]	SETTABLE 	R39 K29 R40 ; R39[0x00000001] := R40
	...
	320	[433]	SETTABLE 	R70 K29 R62 ; R70[0x00000001] := R62
...
function #7 <?:470,525> (25 instructions, 100 bytes at 0000021130525EB0)
...
function #8 <?:527,539> (24 instructions, 96 bytes at 0000021130526B50)
...
function #9 <?:543,687> (353 instructions, 1412 bytes at 0000021125F4C830)
3 params, 49 slots, 14 upvalues, 0 locals, 79 constants, 1 function
	...
	151	[617]	SETTABLE 	R24 K34 R13 ; R24["mColors"] := R13
...
function #10 <?:689,712> (50 instructions, 200 bytes at 0000021125F4DA70)
...
function #11 <?:714,769> (92 instructions, 368 bytes at 0000021125F4DE70)
...
function #12 <?:771,783> (21 instructions, 84 bytes at 0000021125F4E3B0)
...
function #13 <?:785,987> (332 instructions, 1328 bytes at 0000021125F4E730)
...
function #14 <?:989,1018> (47 instructions, 188 bytes at 0000021121B89620)
...
function #15 <?:1020,1037> (56 instructions, 224 bytes at 0000021121B89900)
...
function #16 <?:1039,1053> (30 instructions, 120 bytes at 0000021121B89C10)
...
function #17 <?:1055,1089> (50 instructions, 200 bytes at 0000021121B89DC0)
...
function #18 <?:1090,1092> (3 instructions, 12 bytes at 0000021121B8A0B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1091]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1091]	CALL     	R0 1 1 ; R0()
	3	[1092]	RETURN   	R0 1 ; return 

function #19 <?:1094,1096> (1 instruction, 4 bytes at 0000021121B8A180)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1096]	RETURN   	R0 1 ; return 

function #20 <?:1098,1244> (331 instructions, 1324 bytes at 0000021121B8A250)
1 param, 39 slots, 12 upvalues, 0 locals, 40 constants, 1 function
	...
	181	[1181]	SETTABLE 	R6 K18 R17 ; R6[0x00000001] := R17
	...
	188	[1184]	SETTABLE 	R6 K35 R17 ; R6[0x00000001] := R17
