...
main <?:0,0> (5 instructions, 20 bytes at 00000211389D6560)
0+ params, 2 slots, 0 upvalues, 0 locals, 1 constant, 1 function
	1	[2]	NEWTABLE 	R0 0 1 ; R0 := {}
	2	[47]	CLOSURE  	R1 0 ; R1 := closure(Function #1)
	3	[47]	SETTABLE 	R0 K0 R1 ; R0["GetConstructionProjects"] := R1
	4	[48]	RETURN   	R0 2 ; return R0 
	5	[48]	RETURN   	R0 1 ; return 


function #1 <?:4,47> (97 instructions, 388 bytes at 0000021112F47D70)
