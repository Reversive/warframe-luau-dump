...
main <?:0,0> (12 instructions, 48 bytes at 0000021122A78460)
...
function #1 <?:8,10> (7 instructions, 28 bytes at 0000021122A78580)
...
function #2 <?:13,17> (11 instructions, 44 bytes at 0000021122A78650)
4 params, 6 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
	1	[14]	EQ       	0 R1 K0 ; if R1 ~= "ROUND_WINNER" then PC := 11
	2	[14]	JMP      	11 ; PC := 11
