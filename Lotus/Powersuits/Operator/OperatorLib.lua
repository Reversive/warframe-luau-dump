...
main <?:0,0> (297 instructions, 1188 bytes at 0000021113D848E0)
0+ params, 27 slots, 0 upvalues, 0 locals, 101 constants, 47 functions
	...
	185	[685]	SETTABLE 	R20 K68 R21 ; R20["meleeXp"] := R21
	...
	198	[693]	SETTABLE 	R20 K74 R21 ; R20["meleeCombo"] := R21
	...
	208	[702]	SETTABLE 	R20 K78 R21 ; R20["lightLanding"] := R21
	...
	219	[722]	SETTABLE 	R21 K82 R22 ; R21[0xde321e6f] := R22
	...
	242	[744]	SETTABLE 	R21 K88 R22 ; R21[0x5963daba] := R22
...
function #1 <?:34,117> (230 instructions, 920 bytes at 0000021113D85AB0)
...
function #2 <?:119,129> (11 instructions, 44 bytes at 0000021113D86580)
...
function #3 <?:131,187> (135 instructions, 540 bytes at 0000021113D866D0)
...
function #4 <?:189,207> (38 instructions, 152 bytes at 0000021113D86D40)
...
function #5 <?:209,288> (158 instructions, 632 bytes at 0000021113D86FC0)
...
function #6 <?:290,332> (137 instructions, 548 bytes at 0000021113D87740)
...
function #7 <?:334,336> (7 instructions, 28 bytes at 0000021113D87EB0)
...
function #8 <?:338,396> (139 instructions, 556 bytes at 0000021113D87F40)
...
function #9 <?:398,400> (7 instructions, 28 bytes at 0000021113D88270)
...
function #10 <?:404,431> (56 instructions, 224 bytes at 0000021113D88300)
...
function #11 <?:433,489> (106 instructions, 424 bytes at 000002112FA452F0)
...
function #12 <?:491,514> (56 instructions, 224 bytes at 000002112FA45940)
...
function #13 <?:516,518> (7 instructions, 28 bytes at 000002112FA45CF0)
3 params, 8 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #14 <?:521,534> (41 instructions, 164 bytes at 000002112FA45D80)
...
function #15 <?:536,564> (70 instructions, 280 bytes at 000002112FA46070)
...
function #16 <?:566,577> (26 instructions, 104 bytes at 000002112FA464D0)
...
function #17 <?:579,594> (37 instructions, 148 bytes at 000002112FA466C0)
...
function #18 <?:604,607> (14 instructions, 56 bytes at 000002112FA46930)
...
function #19 <?:613,613> (9 instructions, 36 bytes at 000002112FA46AD0)
...
function #20 <?:619,627> (30 instructions, 120 bytes at 000002112FA46C30)
...
function #21 <?:628,636> (30 instructions, 120 bytes at 000002112FA46E60)
...
function #22 <?:646,646> (9 instructions, 36 bytes at 000002112FA47010)
2 params, 5 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #23 <?:653,653> (8 instructions, 32 bytes at 000002112FA47170)
2 params, 5 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
...
function #24 <?:654,654> (7 instructions, 28 bytes at 000002112FA47250)
...
function #25 <?:663,666> (14 instructions, 56 bytes at 000002112FA47320)
...
function #26 <?:667,670> (14 instructions, 56 bytes at 000002112FA474B0)
...
function #27 <?:681,684> (14 instructions, 56 bytes at 000002112FA475E0)
2 params, 7 slots, 0 upvalues, 0 locals, 5 constants, 0 functions
...
function #28 <?:692,692> (9 instructions, 36 bytes at 000002112FA47770)
...
function #29 <?:698,701> (14 instructions, 56 bytes at 0000021113EE1C20)
2 params, 7 slots, 0 upvalues, 0 locals, 6 constants, 0 functions
...
function #30 <?:710,721> (19 instructions, 76 bytes at 0000021113EE1D70)
...
function #31 <?:727,730> (14 instructions, 56 bytes at 0000021113EE1F20)
2 params, 7 slots, 0 upvalues, 0 locals, 2 constants, 0 functions
...
function #32 <?:737,739> (3 instructions, 12 bytes at 0000021113EE2050)
...
function #33 <?:740,743> (14 instructions, 56 bytes at 0000021113EE2100)
2 params, 7 slots, 0 upvalues, 0 locals, 2 constants, 0 functions
...
function #34 <?:747,1001> (632 instructions, 2528 bytes at 0000021113EE2230)
3 params, 85 slots, 5 upvalues, 0 locals, 84 constants, 0 functions
	...
	175	[825]	SETTABLE 	R27 K48 R28 ; R27["abilityType"] := R28
	...
	355	[903]	SETTABLE 	R46 K48 R47 ; R46["abilityType"] := R47
	...
	543	[975]	SETTABLE 	R74 K48 R75 ; R74["abilityType"] := R75
...
function #35 <?:1003,1068> (233 instructions, 932 bytes at 0000021113EE3E40)
3 params, 10 slots, 5 upvalues, 0 locals, 34 constants, 0 functions
	...
	56	[1015]	SETTABLE 	R4 K12 R5 ; R4[0x0b4bcfb6] := R5
	...
	63	[1016]	SETTABLE 	R4 K14 R5 ; R4[0xebfba9e4] := R5
	...
	79	[1022]	SETTABLE 	R4 K17 R5 ; R4[0xd1586535] := R5
...
function #36 <?:1070,1091> (39 instructions, 156 bytes at 0000021113EE4980)
...
function #37 <?:1093,1106> (36 instructions, 144 bytes at 0000021113EE4C70)
...
function #38 <?:1108,1110> (4 instructions, 16 bytes at 0000021113EE4EB0)
...
function #39 <?:1112,1114> (7 instructions, 28 bytes at 0000021113EE4F80)
...
function #40 <?:1116,1161> (118 instructions, 472 bytes at 0000021113EE5010)
...
function #41 <?:1163,1165> (10 instructions, 40 bytes at 0000021113EE55E0)
...
function #42 <?:1167,1210> (111 instructions, 444 bytes at 0000021113EE56F0)
...
function #43 <?:1212,1224> (22 instructions, 88 bytes at 0000021113EE5B80)
...
function #44 <?:1226,1228> (4 instructions, 16 bytes at 00000211388117B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #45 <?:1230,1348> (329 instructions, 1316 bytes at 0000021138811880)
...
function #46 <?:1350,1417> (194 instructions, 776 bytes at 0000021138812720)
...
function #47 <?:1419,1473> (79 instructions, 316 bytes at 0000021138813090)
