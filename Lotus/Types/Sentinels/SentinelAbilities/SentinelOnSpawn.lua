...
main <?:0,0> (4 instructions, 16 bytes at 00000211311B13A0)
...
function #1 <?:7,39> (77 instructions, 308 bytes at 000002112FC6F7A0)
1 param, 10 slots, 1 upvalue, 0 locals, 22 constants, 0 functions
	...
	37	[19]	SETTABLE 	R3 K9 R4 ; R3[0x78298275] := R4
...
main <?:0,0> (4 instructions, 16 bytes at 00000211239A1210)
0+ params, 2 slots, 0 upvalues, 0 locals, 1 constant, 1 function
	1	[39]	CLOSURE  	R1 0 ; R1 := closure(Function #1)
	2	[39]	MOVE     	R0 R0 ; R0 := R0
	3	[7]	SETGLOBAL	R1 K0 ; DroneHover := R1
...
function #1 <?:7,39> (77 instructions, 308 bytes at 000002112A963D20)
1 param, 10 slots, 1 upvalue, 0 locals, 22 constants, 0 functions
	1	[8]	GETGLOBAL	R1 K0 ; R1 := 0x7b998233
	2	[8]	GETGLOBAL	R2 K1 ; R2 := 0xbe190284
	3	[8]	CALL     	R1 2 2 ; R1 := R1(R2)
