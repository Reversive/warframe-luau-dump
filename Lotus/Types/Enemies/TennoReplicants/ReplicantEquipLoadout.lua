...
main <?:0,0> (20 instructions, 80 bytes at 00000211343E2010)
...
function #1 <?:12,23> (26 instructions, 104 bytes at 00000211343E2340)
...
function #2 <?:25,69> (111 instructions, 444 bytes at 00000211343E2520)
...
function #3 <?:71,102> (67 instructions, 268 bytes at 00000211343E25F0)
...
function #4 <?:104,123> (49 instructions, 196 bytes at 00000211343E2680)
...
main <?:0,0> (20 instructions, 80 bytes at 0000021116593C70)
0+ params, 5 slots, 0 upvalues, 0 locals, 8 constants, 4 functions
	1	[7]	GETGLOBAL	R0 K0 ; R0 := 0x0469f296
	2	[7]	LOADK    	R1 K1 ; R1 := "TENNO"
	3	[7]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #1 <?:12,23> (26 instructions, 104 bytes at 0000021116593E50)
1 param, 9 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
	1	[13]	NEWTABLE 	R1 4 0 ; R1 := {}
	2	[13]	LOADK    	R2 := 0.000000
	3	[13]	LOADK    	R3 := 1.000000
...
function #2 <?:25,69> (111 instructions, 444 bytes at 0000021116594030)
1 param, 14 slots, 3 upvalues, 0 locals, 26 constants, 0 functions
	1	[26]	GETGLOBAL	R1 K0 ; R1 := 0xcbd666e1
	2	[26]	LOADK    	R2 := 0.000000
	3	[26]	CALL     	R1 2 1 ; R1(R2)
...
function #3 <?:71,102> (67 instructions, 268 bytes at 00000211165940C0)
2 params, 8 slots, 0 upvalues, 0 locals, 20 constants, 0 functions
	1	[72]	GETGLOBAL	R2 K0 ; R2 := 0x89326c93
	2	[72]	SELF     	R2 R2 K1 ; R3 := R2; R2 := R2[0x18d05d30]
	3	[72]	CALL     	R2 2 2 ; R2 := R2(R3)
...
function #4 <?:104,123> (49 instructions, 196 bytes at 0000021116594150)
2 params, 6 slots, 0 upvalues, 0 locals, 9 constants, 0 functions
	1	[105]	GETGLOBAL	R2 K0 ; R2 := 0x7b998233
	2	[105]	MOVE     	R3 R0 ; R3 := R0
	3	[105]	CALL     	R2 2 2 ; R2 := R2(R3)
...
main <?:0,0> (20 instructions, 80 bytes at 000002111BB9EBF0)
0+ params, 5 slots, 0 upvalues, 0 locals, 8 constants, 4 functions
	1	[7]	GETGLOBAL	R0 K0 ; R0 := 0x0469f296
	2	[7]	LOADK    	R1 K1 ; R1 := "TENNO"
	3	[7]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #1 <?:12,23> (26 instructions, 104 bytes at 000002112E593A90)
1 param, 9 slots, 0 upvalues, 0 locals, 4 constants, 0 functions
	1	[13]	NEWTABLE 	R1 4 0 ; R1 := {}
	2	[13]	LOADK    	R2 := 0.000000
	3	[13]	LOADK    	R3 := 1.000000
...
function #2 <?:25,69> (111 instructions, 444 bytes at 00000211314E2E50)
1 param, 14 slots, 3 upvalues, 0 locals, 26 constants, 0 functions
	1	[26]	GETGLOBAL	R1 K0 ; R1 := 0xcbd666e1
	2	[26]	LOADK    	R2 := 0.000000
	3	[26]	CALL     	R1 2 1 ; R1(R2)
...
function #3 <?:71,102> (67 instructions, 268 bytes at 000002112DD01D60)
2 params, 8 slots, 0 upvalues, 0 locals, 20 constants, 0 functions
	1	[72]	GETGLOBAL	R2 K0 ; R2 := 0x89326c93
	2	[72]	SELF     	R2 R2 K1 ; R3 := R2; R2 := R2[0x18d05d30]
	3	[72]	CALL     	R2 2 2 ; R2 := R2(R3)
...
function #4 <?:104,123> (49 instructions, 196 bytes at 000002113032A900)
2 params, 6 slots, 0 upvalues, 0 locals, 9 constants, 0 functions
	1	[105]	GETGLOBAL	R2 K0 ; R2 := 0x7b998233
	2	[105]	MOVE     	R3 R0 ; R3 := R0
	3	[105]	CALL     	R2 2 2 ; R2 := R2(R3)
