...
main <?:0,0> (127 instructions, 508 bytes at 000002113037DDB0)
...
function #1 <?:39,52> (40 instructions, 160 bytes at 000002113037E720)
...
function #2 <?:54,61> (27 instructions, 108 bytes at 000002113037E9A0)
...
function #3 <?:63,132> (164 instructions, 656 bytes at 000002113037EBA0)
...
function #4 <?:134,199> (155 instructions, 620 bytes at 000002113037EFF0)
2 params, 37 slots, 4 upvalues, 0 locals, 27 constants, 0 functions
	...
	141	[191]	SETTABLE 	R32 K25 R33 ; R32["player"] := R33
...
function #5 <?:201,203> (6 instructions, 24 bytes at 000002113037F660)
...
function #6 <?:206,280> (167 instructions, 668 bytes at 000002113037F750)
...
function #7 <?:282,285> (9 instructions, 36 bytes at 0000021113AC5730)
...
function #8 <?:287,300> (42 instructions, 168 bytes at 0000021113AC5840)
...
function #9 <?:302,305> (7 instructions, 28 bytes at 0000021113AC5C00)
...
function #10 <?:307,327> (47 instructions, 188 bytes at 0000021113AC5CF0)
...
function #11 <?:329,331> (5 instructions, 20 bytes at 0000021113AC5FB0)
...
function #12 <?:335,903> (2099 instructions, 8396 bytes at 0000021113AC60A0)
4 params, 174 slots, 11 upvalues, 0 locals, 252 constants, 0 functions
	...
	67	[347]	SETTABLE 	R5 K20 R6 ; R5["text"] := R6
	...
	129	[364]	SETTABLE 	R12 K20 R13 ; R12["text"] := R13
	...
	457	[420]	SETTABLE 	R16 K20 R17 ; R16["text"] := R17
	...
	489	[428]	SETTABLE 	R23 K20 R24 ; R23["text"] := R24
	...
	521	[438]	SETTABLE 	R30 K20 R31 ; R30["text"] := R31
	...
	594	[462]	SETTABLE 	R35 K20 R36 ; R35["text"] := R36
	...
	941	[549]	SETTABLE 	R68 K20 R69 ; R68["text"] := R69
	...
	1233	[627]	SETTABLE 	R98 K20 R99 ; R98["text"] := R99
	...
	1422	[677]	SETTABLE 	R110 K20 R111 ; R110["text"] := R111
	...
	1467	[687]	SETTABLE 	R112 K20 R113 ; R112["text"] := R113
	...
	1485	[691]	SETTABLE 	R113 K20 R114 ; R113["text"] := R114
	...
	1734	[770]	SETTABLE 	R137 K20 R130 ; R137["text"] := R130
	...
	1800	[789]	SETTABLE 	R148 K214 R149 ; R148[0xd8f4f9d0] := R149
	...
	1815	[791]	SETTABLE 	R151 K214 R152 ; R151[0xd8f4f9d0] := R152
	...
	1820	[793]	SETTABLE 	R147 K20 R146 ; R147["text"] := R146
	...
	1954	[834]	SETTABLE 	R158 K20 R159 ; R158["text"] := R159
	...
	1978	[843]	SETTABLE 	R159 K20 R160 ; R159["text"] := R160
	...
	2018	[864]	SETTABLE 	R171 K243 R167 ; R171["TITLE"] := R167
	2019	[864]	CALL     	R169 3 2 ; R169 := R169(R170,R171)
	2020	[864]	SETTABLE 	R168 K20 R169 ; R168["text"] := R169
...
function #13 <?:905,907> (8 instructions, 32 bytes at 0000021113B64890)
...
function #14 <?:910,923> (32 instructions, 128 bytes at 0000021113B64980)
...
function #15 <?:925,927> (4 instructions, 16 bytes at 0000021113B64C50)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #16 <?:929,940> (38 instructions, 152 bytes at 0000021113B64D00)
...
function #17 <?:942,953> (47 instructions, 188 bytes at 0000021113B64FE0)
0 params, 8 slots, 3 upvalues, 0 locals, 22 constants, 0 functions
	...
	25	[946]	SETTABLE 	R4 K11 R5 ; R4["ITEM"] := R5
