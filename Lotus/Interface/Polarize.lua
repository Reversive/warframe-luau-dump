...
main <?:0,0> (165 instructions, 660 bytes at 000002117F7D2860)
...
function #1 <?:35,37> (3 instructions, 12 bytes at 000002117F7D2FB0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[36]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[36]	RETURN   	R0 2 ; return R0 
	3	[37]	RETURN   	R0 1 ; return 

function #2 <?:39,41> (2 instructions, 8 bytes at 000002117F7D3080)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[40]	RETURN   	R0 2 ; return R0 
	2	[41]	RETURN   	R0 1 ; return 

function #3 <?:43,45> (3 instructions, 12 bytes at 000002117F7D3150)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[44]	NEWTABLE 	R0 0 0 ; R0 := {}
	2	[44]	RETURN   	R0 2 ; return R0 
	3	[45]	RETURN   	R0 1 ; return 

function #4 <?:48,50> (2 instructions, 8 bytes at 000002117F7D3220)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[49]	RETURN   	R0 2 ; return R0 
	2	[50]	RETURN   	R0 1 ; return 

function #5 <?:52,54> (3 instructions, 12 bytes at 000002117F7D32F0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[53]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[53]	RETURN   	R0 2 ; return R0 
	3	[54]	RETURN   	R0 1 ; return 

function #6 <?:57,61> (10 instructions, 40 bytes at 000002117F7D33C0)
...
function #7 <?:63,67> (10 instructions, 40 bytes at 000002117F7D3510)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #8 <?:69,73> (10 instructions, 40 bytes at 000002117F7D3660)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #9 <?:75,79> (10 instructions, 40 bytes at 000002117F7D37B0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #10 <?:81,83> (8 instructions, 32 bytes at 000002117F7D3900)
...
function #11 <?:85,87> (8 instructions, 32 bytes at 000002117F7D3A80)
...
function #12 <?:89,91> (8 instructions, 32 bytes at 000002117F7D3BF0)
0 params, 3 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #13 <?:93,116> (75 instructions, 300 bytes at 0000021125ED35C0)
...
function #14 <?:119,330> (225 instructions, 900 bytes at 0000021125ED3B60)
...
function #15 <?:332,351> (45 instructions, 180 bytes at 0000021125ED6340)
0 params, 10 slots, 6 upvalues, 0 locals, 13 constants, 1 function
	...
	17	[344]	SETTABLE 	R5 K1 R4 ; R5["mSlot"] := R4
	18	[344]	GETUPVAL 	R6 U4 ; R6 := U4
	19	[344]	GETTABLE 	R6 R6 R4 ; R6 := R6[R4]
	20	[344]	SETTABLE 	R5 K2 R6 ; R5["mValue"] := R6
	...
	31	[345]	SETTABLE 	R8 K8 R9 ; R8["mNewPolarity"] := R9
...
function #16 <?:353,431> (244 instructions, 976 bytes at 0000021125ED6780)
...
function #17 <?:434,456> (32 instructions, 128 bytes at 0000021125ED7A30)
...
function #18 <?:459,465> (22 instructions, 88 bytes at 0000021125ED7C50)
...
function #19 <?:467,469> (3 instructions, 12 bytes at 0000021125ED7F10)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[468]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[468]	CALL     	R0 1 1 ; R0()
	3	[469]	RETURN   	R0 1 ; return 

function #20 <?:471,475> (15 instructions, 60 bytes at 000002117F797130)
...
function #21 <?:477,504> (77 instructions, 308 bytes at 000002117F7972E0)
...
function #22 <?:506,508> (2 instructions, 8 bytes at 000002117F797830)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[507]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[508]	RETURN   	R0 1 ; return 

function #23 <?:510,514> (20 instructions, 80 bytes at 000002117F797900)
...
function #24 <?:516,520> (12 instructions, 48 bytes at 000002117F797AA0)
...
function #25 <?:522,524> (6 instructions, 24 bytes at 000002117F797D20)
...
function #26 <?:527,529> (6 instructions, 24 bytes at 000002117F797E50)
