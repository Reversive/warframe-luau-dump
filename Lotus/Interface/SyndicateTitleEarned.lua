...
main <?:0,0> (50 instructions, 200 bytes at 000002111CB5FF30)
...
function #1 <?:17,67> (127 instructions, 508 bytes at 000002112275C1B0)
...
function #2 <?:69,73> (10 instructions, 40 bytes at 000002112275CDD0)
...
function #3 <?:75,94> (84 instructions, 336 bytes at 000002112275CF20)
...
function #4 <?:96,138> (190 instructions, 760 bytes at 000002112275D5B0)
...
function #5 <?:140,160> (67 instructions, 268 bytes at 000002112275E1F0)
...
function #6 <?:162,168> (16 instructions, 64 bytes at 0000021129A0EBF0)
...
function #7 <?:170,174> (17 instructions, 68 bytes at 0000021129A0ECE0)
...
function #8 <?:176,178> (3 instructions, 12 bytes at 0000021129A0EE30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[177]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[177]	RETURN   	R0 2 ; return R0 
	3	[178]	RETURN   	R0 1 ; return 

function #9 <?:180,182> (3 instructions, 12 bytes at 0000021129A0EF00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[181]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[181]	CALL     	R0 1 1 ; R0()
	3	[182]	RETURN   	R0 1 ; return 

function #10 <?:184,186> (3 instructions, 12 bytes at 0000021129A0EFD0)
