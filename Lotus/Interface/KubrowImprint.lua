...
main <?:0,0> (270 instructions, 1080 bytes at 000002112AEDEC30)
0+ params, 60 slots, 0 upvalues, 0 locals, 46 constants, 45 functions
	...
	45	[64]	SETTABLE 	R34 K13 R35 ; R34[0x0469f296] := R35
...
function #1 <?:74,76> (3 instructions, 12 bytes at 0000021124A54F90)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[75]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[75]	RETURN   	R0 2 ; return R0 
	3	[76]	RETURN   	R0 1 ; return 

function #2 <?:78,86> (45 instructions, 180 bytes at 0000021124A55060)
...
function #3 <?:88,143> (129 instructions, 516 bytes at 0000021135AB5A30)
...
function #4 <?:144,199> (109 instructions, 436 bytes at 0000021135AB6340)
...
function #5 <?:201,206> (10 instructions, 40 bytes at 0000021135AB68D0)
...
function #6 <?:208,273> (240 instructions, 960 bytes at 0000021135AB6A30)
...
function #7 <?:275,293> (34 instructions, 136 bytes at 0000021135AB74E0)
...
function #8 <?:295,320> (47 instructions, 188 bytes at 0000021135AB7720)
...
function #9 <?:322,344> (70 instructions, 280 bytes at 0000021135AB7A20)
...
function #10 <?:346,360> (39 instructions, 156 bytes at 0000021135AB7E10)
...
function #11 <?:362,366> (6 instructions, 24 bytes at 0000021135AB80C0)
...
function #12 <?:368,386> (29 instructions, 116 bytes at 0000021135AB81B0)
...
function #13 <?:388,391> (5 instructions, 20 bytes at 0000021135AB8540)
1 param, 2 slots, 0 upvalues, 0 locals, 2 constants, 0 functions
	1	[389]	GETGLOBAL	R1 K0 ; R1 := _T
	2	[389]	SETTABLE 	R1 K1 R0 ; R1[0xb21930e8] := R0
	3	[390]	OP_LOADBOOL	R1 1 0 ; R1 := true
	4	[390]	RETURN   	R1 2 ; return R1 
	5	[391]	RETURN   	R0 1 ; return 

function #14 <?:393,450> (220 instructions, 880 bytes at 0000021135AB8660)
2 params, 26 slots, 2 upvalues, 0 locals, 43 constants, 0 functions
	...
	179	[431]	SETTABLE 	R13 K31 R14 ; R13[4.000000] := R14
...
function #15 <?:452,476> (51 instructions, 204 bytes at 0000021135AB90E0)
...
function #16 <?:478,480> (4 instructions, 16 bytes at 0000021135AB93C0)
...
function #17 <?:482,497> (32 instructions, 128 bytes at 0000021135AB9490)
...
function #18 <?:499,506> (16 instructions, 64 bytes at 0000021135AB96C0)
...
function #19 <?:508,515> (40 instructions, 160 bytes at 0000021135AB97E0)
...
function #20 <?:517,521> (12 instructions, 48 bytes at 00000211193F2FF0)
...
function #21 <?:523,527> (12 instructions, 48 bytes at 00000211193F3140)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #22 <?:529,533> (15 instructions, 60 bytes at 00000211193F3290)
...
function #23 <?:535,568> (84 instructions, 336 bytes at 00000211193F3400)
...
function #24 <?:570,719> (98 instructions, 392 bytes at 00000211193F3850)
...
function #25 <?:721,768> (132 instructions, 528 bytes at 00000211193F5720)
...
function #26 <?:770,787> (55 instructions, 220 bytes at 00000211193F5F40)
...
function #27 <?:789,798> (26 instructions, 104 bytes at 00000211193F6300)
...
function #28 <?:800,894> (204 instructions, 816 bytes at 00000211193F6570)
0 params, 13 slots, 20 upvalues, 0 locals, 65 constants, 2 functions
	...
	144	[848]	SETTABLE 	R6 K50 R7 ; R6["mAltButtonIcon"] := R7
	...
	152	[851]	SETTABLE 	R6 K54 R7 ; R6[0x4e47534f] := R7
...
function #29 <?:896,898> (3 instructions, 12 bytes at 00000211193F75E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[897]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[897]	CALL     	R0 1 1 ; R0()
	3	[898]	RETURN   	R0 1 ; return 

function #30 <?:900,905> (12 instructions, 48 bytes at 00000211193F76B0)
...
function #31 <?:908,912> (9 instructions, 36 bytes at 00000211193F77F0)
...
function #32 <?:914,920> (13 instructions, 52 bytes at 00000211193F7900)
...
function #33 <?:924,926> (6 instructions, 24 bytes at 00000211193F7A60)
...
function #34 <?:929,933> (12 instructions, 48 bytes at 0000021124A14670)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #35 <?:935,939> (12 instructions, 48 bytes at 0000021124A147C0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #36 <?:941,945> (16 instructions, 64 bytes at 0000021124A14910)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #37 <?:947,951> (15 instructions, 60 bytes at 0000021124A14A80)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #38 <?:953,960> (21 instructions, 84 bytes at 0000021124A14BF0)
...
function #39 <?:962,966> (11 instructions, 44 bytes at 0000021124A14DE0)
...
function #40 <?:968,970> (2 instructions, 8 bytes at 0000021124A14F10)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[969]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[970]	RETURN   	R0 1 ; return 

function #41 <?:972,974> (2 instructions, 8 bytes at 0000021124A14FE0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[973]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[974]	RETURN   	R0 1 ; return 

function #42 <?:976,978> (2 instructions, 8 bytes at 0000021124A150B0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[977]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[978]	RETURN   	R0 1 ; return 

function #43 <?:980,984> (5 instructions, 20 bytes at 0000021124A15180)
...
function #44 <?:986,988> (3 instructions, 12 bytes at 0000021124A15270)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[987]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[987]	RETURN   	R0 2 ; return R0 
	3	[988]	RETURN   	R0 1 ; return 

function #45 <?:990,996> (30 instructions, 120 bytes at 0000021124A15340)
