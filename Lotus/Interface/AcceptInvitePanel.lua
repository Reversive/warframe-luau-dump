...
main <?:0,0> (91 instructions, 364 bytes at 00000211221605B0)
...
function #1 <?:20,49> (110 instructions, 440 bytes at 0000021122160880)
...
function #2 <?:51,53> (4 instructions, 16 bytes at 0000021122160CB0)
...
function #3 <?:55,94> (133 instructions, 532 bytes at 0000021122160D80)
...
function #4 <?:96,145> (119 instructions, 476 bytes at 00000211221611F0)
...
function #5 <?:147,156> (16 instructions, 64 bytes at 0000021122161DC0)
...
function #6 <?:158,172> (59 instructions, 236 bytes at 0000021122161F30)
...
function #7 <?:174,215> (160 instructions, 640 bytes at 0000021122162090)
...
function #8 <?:217,221> (10 instructions, 40 bytes at 0000021122162350)
...
function #9 <?:223,230> (30 instructions, 120 bytes at 00000211221624A0)
...
function #10 <?:232,238> (25 instructions, 100 bytes at 0000021122162760)
...
function #11 <?:240,242> (3 instructions, 12 bytes at 00000211221629B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[241]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[241]	RETURN   	R0 2 ; return R0 
	3	[242]	RETURN   	R0 1 ; return 

function #12 <?:244,248> (11 instructions, 44 bytes at 0000021122162A80)
...
function #13 <?:250,254> (15 instructions, 60 bytes at 0000021122162BC0)
...
function #14 <?:258,267> (27 instructions, 108 bytes at 0000021122162D50)
...
function #15 <?:269,277> (20 instructions, 80 bytes at 0000021122162F80)
...
function #16 <?:279,288> (20 instructions, 80 bytes at 0000021122163110)
...
function #17 <?:290,299> (25 instructions, 100 bytes at 0000021122163290)
...
function #18 <?:301,308> (24 instructions, 96 bytes at 0000021122163470)
...
function #19 <?:310,317> (17 instructions, 68 bytes at 0000021122163650)
...
function #20 <?:319,321> (3 instructions, 12 bytes at 00000211221637D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[320]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[320]	CALL     	R0 1 1 ; R0()
	3	[321]	RETURN   	R0 1 ; return 

function #21 <?:323,325> (3 instructions, 12 bytes at 00000211221638A0)
