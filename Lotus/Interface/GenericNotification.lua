...
main <?:0,0> (153 instructions, 612 bytes at 00000211166C6750)
...
function #1 <?:66,79> (66 instructions, 264 bytes at 00000211166C6CA0)
...
function #2 <?:81,106> (43 instructions, 172 bytes at 00000211166C71B0)
...
function #3 <?:108,115> (14 instructions, 56 bytes at 00000211166C7450)
...
function #4 <?:117,119> (12 instructions, 48 bytes at 00000211166C75E0)
...
function #5 <?:121,127> (26 instructions, 104 bytes at 00000211166C7720)
...
function #6 <?:129,169> (81 instructions, 324 bytes at 00000211166C78B0)
...
function #7 <?:171,182> (24 instructions, 96 bytes at 00000211166C7DE0)
...
function #8 <?:184,284> (329 instructions, 1316 bytes at 000002111B9D7820)
8 params, 27 slots, 15 upvalues, 0 locals, 78 constants, 1 function
	...
	140	[215]	SETTABLE 	R14 K36 R0 ; R14["Label"] := R0
...
function #9 <?:286,287> (1 instruction, 4 bytes at 000002111B9D8C30)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[287]	RETURN   	R0 1 ; return 

function #10 <?:289,351> (241 instructions, 964 bytes at 000002111B9D8D00)
0 params, 2 slots, 2 upvalues, 0 locals, 60 constants, 0 functions
	...
	4	[290]	SETTABLE 	R0 K0 R1 ; R0["Alert"] := R1
	...
	16	[293]	SETTABLE 	R0 K7 R1 ; R0["DroneDestroyed"] := R1
	...
	28	[296]	SETTABLE 	R0 K13 R1 ; R0[0x0032441c] := R1
	...
	124	[321]	SETTABLE 	R0 K0 R1 ; R0["Alert"] := R1
	...
	136	[324]	SETTABLE 	R0 K7 R1 ; R0["DroneDestroyed"] := R1
	...
	148	[327]	SETTABLE 	R0 K13 R1 ; R0[0x0032441c] := R1
...
function #11 <?:353,412> (185 instructions, 740 bytes at 000002111B9D9BA0)
...
function #12 <?:414,423> (27 instructions, 108 bytes at 000002111B9DA7B0)
...
function #13 <?:425,467> (98 instructions, 392 bytes at 000002111B9DA9F0)
...
function #14 <?:469,482> (40 instructions, 160 bytes at 000002111B9DB000)
...
function #15 <?:484,507> (56 instructions, 224 bytes at 000002111B9DB260)
...
function #16 <?:509,524> (28 instructions, 112 bytes at 000002111B9DB580)
...
function #17 <?:526,538> (60 instructions, 240 bytes at 000002111B9DB770)
...
function #18 <?:540,579> (57 instructions, 228 bytes at 000002111B9DB900)
...
function #19 <?:581,583> (4 instructions, 16 bytes at 00000211154121C0)
...
function #20 <?:585,589> (9 instructions, 36 bytes at 0000021115412290)
...
function #21 <?:591,593> (4 instructions, 16 bytes at 00000211154123E0)
...
function #22 <?:595,597> (3 instructions, 12 bytes at 00000211154124B0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
