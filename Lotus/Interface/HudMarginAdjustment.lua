...
main <?:0,0> (146 instructions, 584 bytes at 0000021135BEA8A0)
...
function #1 <?:27,28> (1 instruction, 4 bytes at 0000021135BEAE90)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[28]	RETURN   	R0 1 ; return 

function #2 <?:30,32> (3 instructions, 12 bytes at 0000021135BEAF20)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[31]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[31]	RETURN   	R0 2 ; return R0 
	3	[32]	RETURN   	R0 1 ; return 

function #3 <?:34,37> (18 instructions, 72 bytes at 0000021135BEAFB0)
...
function #4 <?:39,41> (13 instructions, 52 bytes at 0000021135BEB1A0)
...
function #5 <?:44,84> (182 instructions, 728 bytes at 0000021135BEB4E0)
...
function #6 <?:86,95> (39 instructions, 156 bytes at 0000021135BD8170)
...
function #7 <?:97,156> (146 instructions, 584 bytes at 0000021135BD8430)
...
function #8 <?:158,169> (30 instructions, 120 bytes at 0000021135BD8C10)
...
function #9 <?:171,196> (70 instructions, 280 bytes at 0000021135BD8EB0)
...
function #10 <?:198,209> (25 instructions, 100 bytes at 0000021135BD9310)
...
function #11 <?:211,224> (27 instructions, 108 bytes at 0000021135BD9510)
...
function #12 <?:226,230> (7 instructions, 28 bytes at 0000021135BD97A0)
...
function #13 <?:232,239> (12 instructions, 48 bytes at 0000021135BD98B0)
...
function #14 <?:241,245> (12 instructions, 48 bytes at 0000021135BD99E0)
...
function #15 <?:247,249> (5 instructions, 20 bytes at 0000021135BD9B20)
...
function #16 <?:251,253> (3 instructions, 12 bytes at 0000021135BD9C30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[252]	LOADK    	R0 := 0.000000
	2	[252]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[253]	RETURN   	R0 1 ; return 

function #17 <?:255,257> (6 instructions, 24 bytes at 0000021135BD9D00)
2 params, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #18 <?:259,261> (3 instructions, 12 bytes at 0000021135BD9E10)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[260]	LOADK    	R0 := 0.000000
	2	[260]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[261]	RETURN   	R0 1 ; return 

function #19 <?:263,268> (10 instructions, 40 bytes at 0000021135BD9EE0)
...
function #20 <?:270,275> (10 instructions, 40 bytes at 0000021135BDA020)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #21 <?:277,282> (10 instructions, 40 bytes at 0000021135BDA160)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #22 <?:284,289> (10 instructions, 40 bytes at 0000021135BDA2A0)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #23 <?:291,296> (10 instructions, 40 bytes at 0000021135BDA3E0)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #24 <?:298,303> (10 instructions, 40 bytes at 0000021135BDA520)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #25 <?:305,310> (10 instructions, 40 bytes at 0000021135BDA660)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #26 <?:312,317> (10 instructions, 40 bytes at 0000021135BDA7A0)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #27 <?:319,326> (13 instructions, 52 bytes at 0000021135BDA8E0)
...
function #28 <?:328,331> (5 instructions, 20 bytes at 0000021135BDAA40)
...
function #29 <?:333,340> (13 instructions, 52 bytes at 0000021135BDAB30)
...
main <?:0,0> (146 instructions, 584 bytes at 0000021124C71860)
0+ params, 22 slots, 0 upvalues, 0 locals, 28 constants, 29 functions
	1	[3]	GETGLOBAL	R0 K0 ; R0 := 0x2d0fad09
	2	[3]	LOADK    	R1 K1 ; R1 := "EE.Interface.Utilities"
	3	[3]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #1 <?:27,28> (1 instruction, 4 bytes at 0000021133EBDAA0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[28]	RETURN   	R0 1 ; return 

function #2 <?:30,32> (3 instructions, 12 bytes at 0000021130EA6140)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[31]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[31]	RETURN   	R0 2 ; return R0 
	3	[32]	RETURN   	R0 1 ; return 

function #3 <?:34,37> (18 instructions, 72 bytes at 0000021130EA6580)
0 params, 9 slots, 2 upvalues, 0 locals, 4 constants, 1 function
	1	[35]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[35]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[36]	GETGLOBAL	R0 K0 ; R0 := 0x25312c9b
...
function #4 <?:39,41> (13 instructions, 52 bytes at 00000211C9E06150)
0 params, 7 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
	1	[40]	GETGLOBAL	R0 K0 ; R0 := 0xae91e43b
	2	[40]	SELF     	R0 R0 K1 ; R1 := R0; R0 := R0[0x20b98db3]
	3	[40]	LOADK    	R2 K2 ; R2 := "Instructions.text"
...
function #5 <?:44,84> (182 instructions, 728 bytes at 0000021138AD8D90)
0 params, 12 slots, 11 upvalues, 0 locals, 45 constants, 1 function
	1	[45]	GETUPVAL 	R0 U1 ; R0 := U1
	2	[45]	GETTABLE 	R0 R0 K0 ; R0 := R0[0xae6791ba]
	3	[45]	GETGLOBAL	R1 K1 ; R1 := 0xae91e43b
...
function #6 <?:86,95> (39 instructions, 156 bytes at 0000021138AD9200)
0 params, 8 slots, 3 upvalues, 0 locals, 12 constants, 0 functions
	1	[87]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[87]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[87]	CALL     	R0 1 2 ; R0 := R0()
...
function #7 <?:97,156> (146 instructions, 584 bytes at 0000021130EA57B0)
0 params, 15 slots, 11 upvalues, 0 locals, 32 constants, 0 functions
	1	[98]	GETGLOBAL	R0 K0 ; R0 := 0x7b998233
	2	[98]	GETGLOBAL	R1 K1 ; R1 := 0xae91e43b
	3	[98]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #8 <?:158,169> (30 instructions, 120 bytes at 0000021130EA5F10)
0 params, 6 slots, 4 upvalues, 0 locals, 10 constants, 0 functions
	1	[159]	GETGLOBAL	R0 K0 ; R0 := 0x76ea806b
	2	[159]	SELF     	R0 R0 K1 ; R1 := R0; R0 := R0[0x3f3ae64c]
	3	[159]	LOADK    	R2 := 0.000000
...
function #9 <?:171,196> (70 instructions, 280 bytes at 0000021133EBBF20)
0 params, 6 slots, 10 upvalues, 0 locals, 18 constants, 0 functions
	1	[172]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[172]	TEST     	R0 1 ; if R0 then PC := 70
	3	[172]	JMP      	70 ; PC := 70
...
function #10 <?:198,209> (25 instructions, 100 bytes at 0000021133EBC340)
0 params, 6 slots, 4 upvalues, 0 locals, 6 constants, 0 functions
	1	[199]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[199]	TEST     	R0 1 ; if R0 then PC := 25
	3	[199]	JMP      	25 ; PC := 25
...
function #11 <?:211,224> (27 instructions, 108 bytes at 0000021133EBC4C0)
1 param, 5 slots, 2 upvalues, 0 locals, 10 constants, 0 functions
	1	[212]	GETGLOBAL	R1 K0 ; R1 := 0x3d106989
	2	[212]	LOADK    	R2 K1 ; R2 := "HudMarginAdjustment::OnProfileSaved"
	3	[212]	CALL     	R1 2 1 ; R1(R2)
...
function #12 <?:226,230> (7 instructions, 28 bytes at 0000021133EBC700)
0 params, 2 slots, 2 upvalues, 0 locals, 1 constant, 0 functions
	1	[227]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[227]	TEST     	R0 1 ; if R0 then PC := 7
	3	[227]	JMP      	7 ; PC := 7
...
function #13 <?:232,239> (12 instructions, 48 bytes at 0000021133EBC7E0)
0 params, 2 slots, 3 upvalues, 0 locals, 1 constant, 0 functions
	1	[233]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[233]	TEST     	R0 1 ; if R0 then PC := 12
	3	[233]	JMP      	12 ; PC := 12
...
function #14 <?:241,245> (12 instructions, 48 bytes at 0000021133EBC890)
4 params, 9 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[242]	GETGLOBAL	R4 K0 ; R4 := 0x7b998233
	2	[242]	GETUPVAL 	R5 U0 ; R5 := U0
	3	[242]	CALL     	R4 2 2 ; R4 := R4(R5)
...
function #15 <?:247,249> (5 instructions, 20 bytes at 0000021133EBC990)
2 params, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
	1	[248]	GETGLOBAL	R2 K0 ; R2 := 0x03f57322
	2	[248]	MOVE     	R3 R1 ; R3 := R1
	3	[248]	CALL     	R2 2 2 ; R2 := R2(R3)
...
function #16 <?:251,253> (3 instructions, 12 bytes at 0000021133EBCAA0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[252]	LOADK    	R0 := 0.000000
	2	[252]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[253]	RETURN   	R0 1 ; return 

function #17 <?:255,257> (6 instructions, 24 bytes at 0000021133EBCB70)
2 params, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
	1	[256]	GETGLOBAL	R2 K0 ; R2 := 0x03f57322
	2	[256]	MOVE     	R3 R1 ; R3 := R1
	3	[256]	CALL     	R2 2 2 ; R2 := R2(R3)
...
function #18 <?:259,261> (3 instructions, 12 bytes at 0000021133EBCC80)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[260]	LOADK    	R0 := 0.000000
	2	[260]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[261]	RETURN   	R0 1 ; return 

function #19 <?:263,268> (10 instructions, 40 bytes at 0000021133EBCD50)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[264]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[264]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[264]	CALL     	R0 1 2 ; R0 := R0()
...
function #20 <?:270,275> (10 instructions, 40 bytes at 0000021133EBCE90)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[271]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[271]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[271]	CALL     	R0 1 2 ; R0 := R0()
...
function #21 <?:277,282> (10 instructions, 40 bytes at 0000021133EBCFD0)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[278]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[278]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[278]	CALL     	R0 1 2 ; R0 := R0()
...
function #22 <?:284,289> (10 instructions, 40 bytes at 0000021133EBD110)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[285]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[285]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[285]	CALL     	R0 1 2 ; R0 := R0()
...
function #23 <?:291,296> (10 instructions, 40 bytes at 0000021136E0C240)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[292]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[292]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[292]	CALL     	R0 1 2 ; R0 := R0()
...
function #24 <?:298,303> (10 instructions, 40 bytes at 0000021136E0C380)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[299]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[299]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[299]	CALL     	R0 1 2 ; R0 := R0()
...
function #25 <?:305,310> (10 instructions, 40 bytes at 0000021136E0C4C0)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[306]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[306]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[306]	CALL     	R0 1 2 ; R0 := R0()
...
function #26 <?:312,317> (10 instructions, 40 bytes at 0000021136E0C600)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[313]	GETGLOBAL	R0 K0 ; R0 := 0x34291f5c
	2	[313]	GETTABLE 	R0 R0 K1 ; R0 := R0[0x056bfe8b]
	3	[313]	CALL     	R0 1 2 ; R0 := R0()
...
function #27 <?:319,326> (13 instructions, 52 bytes at 0000021136E0C740)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
	1	[320]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[320]	EQ       	1 R0 K0 ; if R0 == nil then PC := 7
	3	[320]	JMP      	7 ; PC := 7
...
function #28 <?:328,331> (5 instructions, 20 bytes at 0000021136E0C8A0)
0 params, 2 slots, 2 upvalues, 0 locals, 0 constants, 0 functions
	1	[329]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[329]	CALL     	R0 1 1 ; R0()
	3	[330]	GETUPVAL 	R0 U1 ; R0 := U1
...
function #29 <?:333,340> (13 instructions, 52 bytes at 0000021136E0C990)
1 param, 4 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
	1	[334]	EQ       	1 R0 K0 ; if R0 == "true" then PC := 4
	2	[334]	JMP      	4 ; PC := 4
	3	[334]	OP_LOADBOOL	R0 0 1 ; R0 := false; PC := 4
