...
main <?:0,0> (177 instructions, 708 bytes at 0000021115412AE0)
...
function #1 <?:36,39> (15 instructions, 60 bytes at 0000021115413220)
...
function #2 <?:41,43> (3 instructions, 12 bytes at 00000211154133B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[42]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[42]	RETURN   	R0 2 ; return R0 
	3	[43]	RETURN   	R0 1 ; return 

function #3 <?:45,47> (2 instructions, 8 bytes at 0000021115413480)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[46]	RETURN   	R0 2 ; return R0 
	2	[47]	RETURN   	R0 1 ; return 

function #4 <?:49,55> (12 instructions, 48 bytes at 0000021115413550)
...
function #5 <?:57,64> (23 instructions, 92 bytes at 00000211154136D0)
...
function #6 <?:66,68> (3 instructions, 12 bytes at 00000211154139D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[67]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[67]	CALL     	R0 1 1 ; R0()
	3	[68]	RETURN   	R0 1 ; return 

function #7 <?:70,81> (24 instructions, 96 bytes at 0000021115413AA0)
...
function #8 <?:83,158> (57 instructions, 228 bytes at 0000021115413CB0)
...
function #9 <?:160,174> (37 instructions, 148 bytes at 0000021115415730)
...
function #10 <?:176,190> (47 instructions, 188 bytes at 0000021115415990)
...
function #11 <?:192,271> (266 instructions, 1064 bytes at 0000021115415CF0)
...
function #12 <?:273,276> (17 instructions, 68 bytes at 0000021127A4CF20)
...
function #13 <?:278,317> (180 instructions, 720 bytes at 0000021127A4D0D0)
...
function #14 <?:319,365> (146 instructions, 584 bytes at 0000021127A4DD70)
...
function #15 <?:367,372> (14 instructions, 56 bytes at 0000021127A4E5B0)
...
function #16 <?:374,376> (3 instructions, 12 bytes at 0000021127A4E730)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[375]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[375]	CALL     	R0 1 1 ; R0()
	3	[376]	RETURN   	R0 1 ; return 

function #17 <?:378,380> (3 instructions, 12 bytes at 0000021127A4E800)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[379]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[379]	CALL     	R0 1 1 ; R0()
	3	[380]	RETURN   	R0 1 ; return 

function #18 <?:382,388> (12 instructions, 48 bytes at 0000021127A4E8D0)
...
function #19 <?:390,420> (118 instructions, 472 bytes at 0000021127A4EA10)
...
function #20 <?:422,424> (5 instructions, 20 bytes at 0000021127A4F030)
...
function #21 <?:426,430> (12 instructions, 48 bytes at 0000021127A4F120)
...
function #22 <?:432,436> (12 instructions, 48 bytes at 0000021127A4F270)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #23 <?:438,442> (16 instructions, 64 bytes at 0000021127A4F3C0)
...
function #24 <?:444,448> (12 instructions, 48 bytes at 0000021127A4F530)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #25 <?:450,454> (12 instructions, 48 bytes at 0000021127A4F670)
0 params, 2 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #26 <?:456,457> (1 instruction, 4 bytes at 0000021127A4F7B0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[457]	RETURN   	R0 1 ; return 

function #27 <?:459,460> (1 instruction, 4 bytes at 0000021127A4F880)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[460]	RETURN   	R0 1 ; return 

function #28 <?:462,465> (5 instructions, 20 bytes at 0000021127A4F950)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #29 <?:467,470> (5 instructions, 20 bytes at 0000021127A4FA40)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #30 <?:472,475> (5 instructions, 20 bytes at 0000021127A4FB30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #31 <?:477,480> (5 instructions, 20 bytes at 0000021127A4FC20)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #32 <?:482,485> (5 instructions, 20 bytes at 0000021127A4FD10)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #33 <?:487,490> (5 instructions, 20 bytes at 0000021127A4FE00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #34 <?:492,495> (5 instructions, 20 bytes at 0000021127A4FEF0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #35 <?:497,500> (5 instructions, 20 bytes at 0000021127A4FFE0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #36 <?:502,504> (6 instructions, 24 bytes at 0000021127A500D0)
...
function #37 <?:506,510> (19 instructions, 76 bytes at 0000021127A50200)
...
function #38 <?:512,514> (3 instructions, 12 bytes at 0000021127A503C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[513]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[513]	RETURN   	R0 2 ; return R0 
	3	[514]	RETURN   	R0 1 ; return 

function #39 <?:516,518> (3 instructions, 12 bytes at 0000021127A50490)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[517]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[517]	CALL     	R0 1 1 ; R0()
	3	[518]	RETURN   	R0 1 ; return 

function #40 <?:520,522> (3 instructions, 12 bytes at 0000021127A50560)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
