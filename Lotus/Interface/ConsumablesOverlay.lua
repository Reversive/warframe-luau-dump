...
main <?:0,0> (371 instructions, 1484 bytes at 0000021120729560)
...
function #1 <?:72,82> (23 instructions, 92 bytes at 0000021138440950)
...
function #2 <?:84,95> (92 instructions, 368 bytes at 0000021138440B30)
...
function #3 <?:97,99> (3 instructions, 12 bytes at 00000211384410A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[98]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[98]	CALL     	R0 1 1 ; R0()
	3	[99]	RETURN   	R0 1 ; return 

function #4 <?:101,110> (19 instructions, 76 bytes at 0000021138441150)
...
function #5 <?:112,119> (18 instructions, 72 bytes at 00000211384413E0)
...
function #6 <?:121,134> (35 instructions, 140 bytes at 0000021138441580)
...
function #7 <?:136,148> (48 instructions, 192 bytes at 0000021138441990)
...
function #8 <?:150,160> (33 instructions, 132 bytes at 0000021138441CE0)
...
function #9 <?:162,188> (66 instructions, 264 bytes at 0000021138441FA0)
...
function #10 <?:190,193> (13 instructions, 52 bytes at 0000021138442560)
...
function #11 <?:195,230> (69 instructions, 276 bytes at 00000211384426F0)
...
function #12 <?:232,248> (34 instructions, 136 bytes at 0000021138442C50)
...
function #13 <?:250,390> (103 instructions, 412 bytes at 0000021138442ED0)
2 params, 11 slots, 8 upvalues, 0 locals, 30 constants, 4 functions
	...
	44	[377]	SETTABLE 	R3 K11 R4 ; R3[0x603636ad] := R4
...
function #14 <?:392,406> (62 instructions, 248 bytes at 0000021118DC0640)
...
function #15 <?:408,419> (41 instructions, 164 bytes at 0000021118DC09B0)
...
function #16 <?:421,580> (255 instructions, 1020 bytes at 0000021118DC0C80)
...
function #17 <?:582,594> (27 instructions, 108 bytes at 0000021118DC2650)
...
function #18 <?:596,712> (139 instructions, 556 bytes at 0000021118DC2850)
0 params, 14 slots, 8 upvalues, 0 locals, 59 constants, 8 functions
	...
	61	[669]	SETTABLE 	R1 K28 R2 ; R1["CalculateX"] := R2
	62	[670]	GETUPVAL 	R1 U0 ; R1 := U0
	63	[677]	CLOSURE  	R2 6 ; R2 := closure(Function #7)
	64	[677]	SETTABLE 	R1 K29 R2 ; R1["CalculateY"] := R2
	65	[678]	GETUPVAL 	R1 U0 ; R1 := U0
	66	[680]	CLOSURE  	R2 7 ; R2 := closure(Function #8)
	67	[680]	SETTABLE 	R1 K30 R2 ; R1["SetupPreInterpolationValues"] := R2
	...
	122	[703]	SETTABLE 	R10 K53 R9 ; R10["mItem"] := R9
...
function #19 <?:714,814> (128 instructions, 512 bytes at 000002112D08D710)
...
function #20 <?:816,1020> (225 instructions, 900 bytes at 000002112D08EE30)
...
function #21 <?:1022,1026> (15 instructions, 60 bytes at 000002112D091580)
...
function #22 <?:1028,1032> (11 instructions, 44 bytes at 000002112D091710)
...
function #23 <?:1034,1051> (79 instructions, 316 bytes at 000002112473CE70)
...
function #24 <?:1053,1088> (120 instructions, 480 bytes at 000002112473D510)
...
function #25 <?:1090,1096> (23 instructions, 92 bytes at 000002112473DC60)
...
function #26 <?:1098,1117> (55 instructions, 220 bytes at 000002112473DE60)
...
function #27 <?:1119,1172> (121 instructions, 484 bytes at 000002112473E150)
...
function #28 <?:1174,1359> (765 instructions, 3060 bytes at 000002112473E7E0)
...
function #29 <?:1361,1373> (21 instructions, 84 bytes at 00000211247413D0)
...
function #30 <?:1375,1390> (31 instructions, 124 bytes at 0000021124741590)
...
function #31 <?:1392,1425> (59 instructions, 236 bytes at 00000211247417B0)
...
function #32 <?:1427,1435> (20 instructions, 80 bytes at 0000021113D5DA20)
...
function #33 <?:1437,1443> (15 instructions, 60 bytes at 0000021113D5DB80)
...
function #34 <?:1445,1451> (15 instructions, 60 bytes at 0000021113D5DCF0)
1 param, 6 slots, 3 upvalues, 0 locals, 3 constants, 0 functions
...
function #35 <?:1453,1460> (21 instructions, 84 bytes at 0000021113D5DE60)
...
function #36 <?:1462,1467> (16 instructions, 64 bytes at 0000021113D5E040)
...
function #37 <?:1469,1474> (16 instructions, 64 bytes at 0000021113D5E1B0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #38 <?:1476,1483> (21 instructions, 84 bytes at 0000021113D5E320)
1 param, 5 slots, 3 upvalues, 0 locals, 6 constants, 0 functions
...
function #39 <?:1485,1491> (16 instructions, 64 bytes at 0000021113D5E500)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #40 <?:1493,1499> (16 instructions, 64 bytes at 0000021113D5E670)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #41 <?:1502,1505> (5 instructions, 20 bytes at 0000021113D5E7E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #42 <?:1508,1511> (5 instructions, 20 bytes at 0000021113D5E8D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #43 <?:1513,1528> (40 instructions, 160 bytes at 0000021113D5E9C0)
...
function #44 <?:1530,1533> (5 instructions, 20 bytes at 0000021113D5EC40)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #45 <?:1535,1538> (5 instructions, 20 bytes at 0000021113D5ED30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #46 <?:1540,1543> (5 instructions, 20 bytes at 0000021113D5EE20)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #47 <?:1545,1548> (5 instructions, 20 bytes at 0000021113D5EF10)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #48 <?:1550,1553> (8 instructions, 32 bytes at 0000021113D5F000)
...
function #49 <?:1555,1558> (8 instructions, 32 bytes at 0000021113D5F120)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #50 <?:1560,1563> (8 instructions, 32 bytes at 0000021113D5F240)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #51 <?:1565,1568> (8 instructions, 32 bytes at 0000021113D5F360)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #52 <?:1570,1573> (8 instructions, 32 bytes at 0000021113D5F480)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #53 <?:1575,1578> (8 instructions, 32 bytes at 0000021113D5F5A0)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #54 <?:1580,1583> (8 instructions, 32 bytes at 0000021113D5F6C0)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #55 <?:1585,1588> (8 instructions, 32 bytes at 0000021113D5F7E0)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #56 <?:1591,1599> (29 instructions, 116 bytes at 0000021113D5F900)
...
function #57 <?:1601,1623> (63 instructions, 252 bytes at 0000021113D5FB10)
...
function #58 <?:1625,1649> (67 instructions, 268 bytes at 0000021113D5FE80)
...
function #59 <?:1651,1657> (17 instructions, 68 bytes at 0000021113D602B0)
...
function #60 <?:1659,1670> (75 instructions, 300 bytes at 0000021113D60480)
...
function #61 <?:1672,1682> (39 instructions, 156 bytes at 0000021113D607F0)
...
function #62 <?:1684,1699> (44 instructions, 176 bytes at 0000021113D60A60)
...
function #63 <?:1701,1706> (25 instructions, 100 bytes at 0000021113D60CF0)
...
function #64 <?:1708,1713> (25 instructions, 100 bytes at 0000021113D60EF0)
0 params, 4 slots, 1 upvalue, 0 locals, 6 constants, 0 functions
...
function #65 <?:1715,1718> (5 instructions, 20 bytes at 0000021113D610F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #66 <?:1720,1722> (3 instructions, 12 bytes at 0000021113D611E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1721]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1721]	RETURN   	R0 2 ; return R0 
	3	[1722]	RETURN   	R0 1 ; return 

function #67 <?:1724,1753> (110 instructions, 440 bytes at 0000021113D612B0)
...
function #68 <?:1755,1757> (3 instructions, 12 bytes at 0000021113D61850)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[1756]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[1756]	CALL     	R0 1 1 ; R0()
	3	[1757]	RETURN   	R0 1 ; return 

function #69 <?:1759,1763> (12 instructions, 48 bytes at 0000021113D61920)
