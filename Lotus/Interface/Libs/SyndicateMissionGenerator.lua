...
main <?:0,0> (108 instructions, 432 bytes at 00000211346EC230)
0+ params, 18 slots, 0 upvalues, 0 locals, 29 constants, 6 functions
	...
	25	[12]	SETTABLE 	R7 K8 R8 ; R7["Type"] := R8
	...
	31	[13]	SETTABLE 	R8 K8 R9 ; R8["Type"] := R9
	...
	37	[14]	SETTABLE 	R9 K8 R10 ; R9["Type"] := R10
	...
	41	[15]	SETTABLE 	R10 K8 R11 ; R10["Type"] := R11
	...
	47	[16]	SETTABLE 	R11 K8 R12 ; R11["Type"] := R12
	...
	53	[17]	SETTABLE 	R12 K8 R13 ; R12["Type"] := R13
...
function #1 <?:20,44> (54 instructions, 216 bytes at 00000211346EC790)
...
function #2 <?:54,209> (411 instructions, 1644 bytes at 00000211346ECAF0)
19 params, 81 slots, 9 upvalues, 0 locals, 91 constants, 0 functions
	...
	143	[119]	SETTABLE 	R40 K28 R3 ; R40[0xcfc01047] := R3
	144	[120]	GETTABLE 	R41 R40 K29 ; R41 := R40["syndicateTitle"]
	145	[120]	SETTABLE 	R41 K30 R23 ; R41[0x23d5322f] := R23
	...
	163	[129]	SETTABLE 	R40 K34 R45 ; R40[0x0469f296] := R45
	164	[132]	SETTABLE 	R40 K35 R35 ; R40[0x0c5e62f9] := R35
	...
	175	[138]	SETTABLE 	R40 K34 R45 ; R40[0x0469f296] := R45
	...
	187	[144]	SETTABLE 	R40 K34 R45 ; R40[0x0469f296] := R45
	...
	244	[169]	SETTABLE 	R40 K34 R51 ; R40[0x0469f296] := R51
	...
	300	[186]	SETTABLE 	R56 K63 R57 ; R56["mSyndicateTitle"] := R57
	...
	305	[191]	SETTABLE 	R56 K69 R52 ; R56["mVisible"] := R52
...
function #3 <?:211,228> (41 instructions, 164 bytes at 00000211346ED4E0)
...
function #4 <?:230,334> (204 instructions, 816 bytes at 00000211295611B0)
2 params, 51 slots, 4 upvalues, 0 locals, 52 constants, 0 functions
	...
	177	[319]	SETTABLE 	R47 K43 R48 ; R47[0x34291f5c] := R48
	...
	181	[321]	SETTABLE 	R47 K46 R48 ; R47[0x4f6851ff] := R48
	...
	187	[323]	SETTABLE 	R47 K48 R48 ; R47[0xce225efa] := R48
...
function #5 <?:336,393> (66 instructions, 264 bytes at 0000021129561E80)
...
function #6 <?:395,524> (200 instructions, 800 bytes at 0000021129562270)
