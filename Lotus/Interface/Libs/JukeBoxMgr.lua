...
main <?:0,0> (360 instructions, 1440 bytes at 0000021138A2FE80)
...
function #1 <?:57,65> (34 instructions, 136 bytes at 0000021121316BF0)
...
function #2 <?:67,73> (8 instructions, 32 bytes at 0000021121316E10)
...
function #3 <?:75,86> (49 instructions, 196 bytes at 0000021121316ED0)
...
function #4 <?:88,93> (21 instructions, 84 bytes at 00000211213171F0)
...
function #5 <?:95,97> (18 instructions, 72 bytes at 00000211213173C0)
...
function #6 <?:99,101> (4 instructions, 16 bytes at 0000021121317540)
...
function #7 <?:103,108> (24 instructions, 96 bytes at 0000021121317610)
...
function #8 <?:110,112> (4 instructions, 16 bytes at 00000211213177C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #9 <?:114,119> (14 instructions, 56 bytes at 0000021121317890)
...
function #10 <?:121,146> (69 instructions, 276 bytes at 0000021121317A00)
...
function #11 <?:148,153> (18 instructions, 72 bytes at 0000021121317DD0)
...
function #12 <?:155,214> (178 instructions, 712 bytes at 0000021121317F70)
...
function #13 <?:216,218> (4 instructions, 16 bytes at 0000021121318830)
...
function #14 <?:220,227> (24 instructions, 96 bytes at 0000021121318900)
...
function #15 <?:229,231> (3 instructions, 12 bytes at 0000021121318B00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[230]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[230]	RETURN   	R0 2 ; return R0 
	3	[231]	RETURN   	R0 1 ; return 

function #16 <?:233,238> (13 instructions, 52 bytes at 0000021121318BD0)
...
function #17 <?:240,242> (3 instructions, 12 bytes at 0000021121318D30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[241]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[241]	CALL     	R0 1 1 ; R0()
	3	[242]	RETURN   	R0 1 ; return 

function #18 <?:244,246> (3 instructions, 12 bytes at 0000021121318E00)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[245]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[245]	RETURN   	R0 2 ; return R0 
	3	[246]	RETURN   	R0 1 ; return 

function #19 <?:248,254> (35 instructions, 140 bytes at 0000021121318ED0)
...
function #20 <?:256,298> (75 instructions, 300 bytes at 0000021121319130)
...
function #21 <?:300,302> (4 instructions, 16 bytes at 0000021121319510)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #22 <?:304,317> (32 instructions, 128 bytes at 00000211213195E0)
...
function #23 <?:319,321> (3 instructions, 12 bytes at 0000021121319800)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[320]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[320]	CALL     	R0 1 1 ; R0()
	3	[321]	RETURN   	R0 1 ; return 

function #24 <?:323,332> (31 instructions, 124 bytes at 00000211213198D0)
...
function #25 <?:334,344> (23 instructions, 92 bytes at 0000021121319AD0)
...
function #26 <?:346,348> (3 instructions, 12 bytes at 0000021121319C80)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[347]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[347]	CALL     	R0 1 1 ; R0()
	3	[348]	RETURN   	R0 1 ; return 

function #27 <?:350,352> (3 instructions, 12 bytes at 0000021121319D50)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[351]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[351]	RETURN   	R0 2 ; return R0 
	3	[352]	RETURN   	R0 1 ; return 

function #28 <?:354,356> (3 instructions, 12 bytes at 0000021121319E20)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[355]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[355]	RETURN   	R0 2 ; return R0 
	3	[356]	RETURN   	R0 1 ; return 

function #29 <?:358,360> (3 instructions, 12 bytes at 0000021121319EF0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[359]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[359]	RETURN   	R0 2 ; return R0 
	3	[360]	RETURN   	R0 1 ; return 

function #30 <?:362,364> (12 instructions, 48 bytes at 0000021121319FC0)
...
function #31 <?:366,368> (2 instructions, 8 bytes at 000002112131A100)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[367]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[368]	RETURN   	R0 1 ; return 

function #32 <?:370,372> (2 instructions, 8 bytes at 000002112131A1D0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[371]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[372]	RETURN   	R0 1 ; return 

function #33 <?:374,387> (37 instructions, 148 bytes at 000002112131A2A0)
...
function #34 <?:389,393> (13 instructions, 52 bytes at 000002112131A4F0)
...
function #35 <?:395,445> (137 instructions, 548 bytes at 000002112131A660)
...
function #36 <?:447,560> (326 instructions, 1304 bytes at 000002112131AC80)
...
function #37 <?:562,586> (44 instructions, 176 bytes at 000002112131B000)
...
function #38 <?:588,606> (52 instructions, 208 bytes at 0000021135801EA0)
...
function #39 <?:608,672> (151 instructions, 604 bytes at 0000021135802190)
...
function #40 <?:674,744> (212 instructions, 848 bytes at 0000021135802A20)
...
function #41 <?:746,752> (27 instructions, 108 bytes at 00000211358035F0)
...
function #42 <?:754,762> (20 instructions, 80 bytes at 0000021135803800)
...
function #43 <?:764,766> (2 instructions, 8 bytes at 0000021135803980)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[765]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[766]	RETURN   	R0 1 ; return 

function #44 <?:768,788> (85 instructions, 340 bytes at 0000021135803A50)
...
function #45 <?:790,795> (20 instructions, 80 bytes at 0000021135803F20)
...
function #46 <?:797,819> (33 instructions, 132 bytes at 0000021135804090)
