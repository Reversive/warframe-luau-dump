...
main <?:0,0> (203 instructions, 812 bytes at 00000211154AAFB0)
...
function #1 <?:43,48> (25 instructions, 100 bytes at 00000211154AB500)
...
function #2 <?:50,92> (128 instructions, 512 bytes at 0000021126A325D0)
...
function #3 <?:94,134> (151 instructions, 604 bytes at 0000021126A33060)
...
function #4 <?:136,187> (145 instructions, 580 bytes at 0000021126A33A40)
...
function #5 <?:189,191> (1 instruction, 4 bytes at 0000021126A34B60)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[191]	RETURN   	R0 1 ; return 

function #6 <?:193,215> (51 instructions, 204 bytes at 0000021126A34C30)
...
function #7 <?:217,220> (5 instructions, 20 bytes at 0000021126A34F30)
...
function #8 <?:222,225> (9 instructions, 36 bytes at 000002112D5F0C10)
...
function #9 <?:227,229> (5 instructions, 20 bytes at 000002112D5F0DA0)
...
function #10 <?:231,233> (6 instructions, 24 bytes at 000002112D5F0EB0)
...
function #11 <?:235,238> (10 instructions, 40 bytes at 000002112D5F0FC0)
...
function #12 <?:240,243> (8 instructions, 32 bytes at 000002112D5F11A0)
...
function #13 <?:245,247> (4 instructions, 16 bytes at 000002112D5F1320)
...
function #14 <?:249,253> (9 instructions, 36 bytes at 000002112D5F13F0)
...
function #15 <?:255,262> (6 instructions, 24 bytes at 000002112D5F1590)
...
function #16 <?:264,266> (4 instructions, 16 bytes at 000002112D5F1870)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #17 <?:268,270> (2 instructions, 8 bytes at 000002112D5F1940)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[269]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[270]	RETURN   	R0 1 ; return 

function #18 <?:272,274> (4 instructions, 16 bytes at 000002112D5F1A10)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #19 <?:276,278> (2 instructions, 8 bytes at 000002112D5F1AE0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[277]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[278]	RETURN   	R0 1 ; return 

function #20 <?:280,282> (4 instructions, 16 bytes at 000002112D5F1BB0)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #21 <?:284,286> (3 instructions, 12 bytes at 000002112D5F1C80)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[285]	OP_LOADBOOL	R1 1 0 ; R1 := true
	2	[285]	SETUPVAL 	R1 U0 ; U0 := R1
	3	[286]	RETURN   	R0 1 ; return 

function #22 <?:288,290> (4 instructions, 16 bytes at 000002112D5F1D50)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #23 <?:292,294> (2 instructions, 8 bytes at 000002112D5F1E20)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[293]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[294]	RETURN   	R0 1 ; return 

function #24 <?:296,298> (2 instructions, 8 bytes at 000002112D5F1EF0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[297]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[298]	RETURN   	R0 1 ; return 

function #25 <?:300,302> (2 instructions, 8 bytes at 000002112D5F1FC0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[301]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[302]	RETURN   	R0 1 ; return 

function #26 <?:304,306> (8 instructions, 32 bytes at 000002112D5F2090)
...
function #27 <?:308,337> (70 instructions, 280 bytes at 000002112D5F21B0)
...
function #28 <?:339,344> (20 instructions, 80 bytes at 000002112D5F2690)
...
function #29 <?:346,348> (3 instructions, 12 bytes at 000002112D5F2850)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[347]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[347]	CALL     	R0 1 1 ; R0()
	3	[348]	RETURN   	R0 1 ; return 

function #30 <?:350,357> (21 instructions, 84 bytes at 000002112D5F2920)
...
function #31 <?:359,376> (54 instructions, 216 bytes at 000002112D5F2B50)
...
function #32 <?:378,381> (5 instructions, 20 bytes at 000002112D5F2F70)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #33 <?:383,388> (13 instructions, 52 bytes at 000002112D5F3060)
...
function #34 <?:390,393> (5 instructions, 20 bytes at 000002112D5F31E0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #35 <?:395,397> (3 instructions, 12 bytes at 000002112D5F32D0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[396]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[396]	RETURN   	R0 2 ; return R0 
	3	[397]	RETURN   	R0 1 ; return 

function #36 <?:399,404> (13 instructions, 52 bytes at 000002112D5F33A0)
...
function #37 <?:406,408> (3 instructions, 12 bytes at 000002112D5F3500)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[407]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[407]	RETURN   	R0 2 ; return R0 
	3	[408]	RETURN   	R0 1 ; return 

function #38 <?:410,413> (5 instructions, 20 bytes at 000002112D5F35D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #39 <?:415,421> (12 instructions, 48 bytes at 000002112D5F36C0)
...
function #40 <?:423,587> (425 instructions, 1700 bytes at 000002112D5F3800)
0 params, 22 slots, 19 upvalues, 0 locals, 87 constants, 2 functions
	...
	93	[487]	SETTABLE 	R10 K35 R11 ; R10[0x00000002] := R11
	...
	105	[490]	SETTABLE 	R10 K35 R11 ; R10[0x00000002] := R11
...
function #41 <?:589,613> (60 instructions, 240 bytes at 00000211284C36A0)
...
function #47 <?:637,661> (44 instructions, 176 bytes at 00000211284C3E90)
...
function #48 <?:663,665> (3 instructions, 12 bytes at 00000211284C42C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[664]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[664]	CALL     	R0 1 1 ; R0()
	3	[665]	RETURN   	R0 1 ; return 

function #49 <?:667,669> (3 instructions, 12 bytes at 00000211284C4390)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
