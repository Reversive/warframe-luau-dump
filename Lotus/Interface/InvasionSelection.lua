...
main <?:0,0> (245 instructions, 980 bytes at 0000021129962EE0)
...
function #1 <?:57,59> (3 instructions, 12 bytes at 00000211240271B0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[58]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[58]	RETURN   	R0 2 ; return R0 
	3	[59]	RETURN   	R0 1 ; return 

function #2 <?:61,63> (3 instructions, 12 bytes at 0000021124027260)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[62]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[62]	RETURN   	R0 2 ; return R0 
	3	[63]	RETURN   	R0 1 ; return 

function #3 <?:65,67> (2 instructions, 8 bytes at 0000021124027330)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[66]	RETURN   	R0 2 ; return R0 
	2	[67]	RETURN   	R0 1 ; return 

function #4 <?:69,71> (2 instructions, 8 bytes at 0000021124027400)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[70]	RETURN   	R0 2 ; return R0 
	2	[71]	RETURN   	R0 1 ; return 

function #5 <?:73,102> (105 instructions, 420 bytes at 00000211240274D0)
...
function #6 <?:104,120> (60 instructions, 240 bytes at 0000021124027C30)
...
function #7 <?:122,124> (3 instructions, 12 bytes at 00000211240280A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[123]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[123]	CALL     	R0 1 1 ; R0()
	3	[124]	RETURN   	R0 1 ; return 

function #8 <?:126,134> (17 instructions, 68 bytes at 0000021124028170)
...
function #9 <?:136,144> (17 instructions, 68 bytes at 0000021124028320)
1 param, 6 slots, 2 upvalues, 0 locals, 5 constants, 0 functions
...
function #10 <?:146,239> (199 instructions, 796 bytes at 00000211240284D0)
...
function #11 <?:241,308> (47 instructions, 188 bytes at 00000211240298D0)
...
function #12 <?:310,429> (472 instructions, 1888 bytes at 000002111B3D09F0)
...
function #13 <?:431,439> (41 instructions, 164 bytes at 000002111B3D25B0)
...
function #14 <?:441,509> (320 instructions, 1280 bytes at 000002111B3D2890)
...
function #15 <?:511,526> (82 instructions, 328 bytes at 000002111B3D3A00)
...
function #16 <?:528,543> (58 instructions, 232 bytes at 000002111B3D41C0)
0 params, 6 slots, 5 upvalues, 0 locals, 22 constants, 0 functions
	...
	36	[539]	SETTABLE 	R4 K12 R5 ; R4[0x07000000] := R5
	...
	48	[539]	SETTABLE 	R4 K18 R5 ; R4["SubInvasions"] := R5
	...
	52	[539]	SETTABLE 	R4 K20 R5 ; R4["Completed"] := R5
...
function #17 <?:545,613> (213 instructions, 852 bytes at 000002111B3D4620)
0 params, 9 slots, 14 upvalues, 0 locals, 48 constants, 0 functions
	...
	208	[609]	SETTABLE 	R4 K47 R1 ; R4["Defender"] := R1
...
function #18 <?:615,623> (36 instructions, 144 bytes at 000002117F7CF270)
...
function #19 <?:625,639> (36 instructions, 144 bytes at 000002117F7CF4E0)
...
function #20 <?:641,659> (31 instructions, 124 bytes at 000002117F7CF780)
...
function #21 <?:661,663> (5 instructions, 20 bytes at 000002117F7CFA30)
...
function #22 <?:665,678> (140 instructions, 560 bytes at 000002117F7CFB40)
...
function #23 <?:680,692> (42 instructions, 168 bytes at 000002117F7D01D0)
...
function #24 <?:694,696> (4 instructions, 16 bytes at 000002117F7D05A0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #25 <?:698,702> (9 instructions, 36 bytes at 000002117F7D0670)
...
function #26 <?:704,716> (42 instructions, 168 bytes at 000002117F7D07C0)
1 param, 8 slots, 6 upvalues, 0 locals, 12 constants, 0 functions
...
function #27 <?:718,720> (4 instructions, 16 bytes at 000002117F7D0AA0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #28 <?:722,726> (9 instructions, 36 bytes at 000002117F7D0B70)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #29 <?:728,730> (7 instructions, 28 bytes at 000002117F7D0CC0)
...
function #30 <?:732,734> (7 instructions, 28 bytes at 000002117F7D0DE0)
0 params, 5 slots, 2 upvalues, 0 locals, 2 constants, 0 functions
...
function #31 <?:736,738> (7 instructions, 28 bytes at 000002117F7D0F00)
...
function #32 <?:740,742> (7 instructions, 28 bytes at 000002117F7D1010)
0 params, 5 slots, 2 upvalues, 0 locals, 1 constant, 0 functions
...
function #33 <?:744,762> (47 instructions, 188 bytes at 000002117F7D1120)
...
function #34 <?:764,771> (47 instructions, 188 bytes at 000002117F7D1470)
0 params, 8 slots, 1 upvalue, 0 locals, 17 constants, 0 functions
...
function #35 <?:773,777> (12 instructions, 48 bytes at 000002117F7D17C0)
...
function #36 <?:779,783> (12 instructions, 48 bytes at 000002117F7D1910)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #37 <?:785,789> (12 instructions, 48 bytes at 000002117F7D1A60)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #38 <?:791,795> (12 instructions, 48 bytes at 000002117F7D1BB0)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #39 <?:797,799> (4 instructions, 16 bytes at 000002117F7D1D00)
...
function #40 <?:801,803> (6 instructions, 24 bytes at 000002117F7D1DF0)
...
function #41 <?:805,811> (18 instructions, 72 bytes at 000002117F7D1F20)
...
function #42 <?:813,815> (3 instructions, 12 bytes at 000002117F7D20F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[814]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[814]	CALL     	R0 1 1 ; R0()
	3	[815]	RETURN   	R0 1 ; return 

function #43 <?:817,818> (1 instruction, 4 bytes at 000002117F7D21C0)
4 params, 4 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[818]	RETURN   	R0 1 ; return 

function #44 <?:820,821> (1 instruction, 4 bytes at 000002117F7D2290)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[821]	RETURN   	R0 1 ; return 

function #45 <?:823,825> (3 instructions, 12 bytes at 000002117F7D2360)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
