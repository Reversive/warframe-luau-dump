...
main <?:0,0> (94 instructions, 376 bytes at 00000211303B71C0)
...
function #1 <?:24,35> (38 instructions, 152 bytes at 00000211303B75E0)
0 params, 11 slots, 1 upvalue, 0 locals, 15 constants, 0 functions
	...
	17	[29]	SETTABLE 	R8 K3 R9 ; R8["Label"] := R9
...
function #2 <?:37,43> (9 instructions, 36 bytes at 00000211303B78D0)
...
function #3 <?:45,58> (25 instructions, 100 bytes at 00000211303B7A20)
...
function #4 <?:60,62> (3 instructions, 12 bytes at 00000211303B7F10)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[61]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[61]	CALL     	R0 1 1 ; R0()
	3	[62]	RETURN   	R0 1 ; return 

function #5 <?:64,198> (55 instructions, 220 bytes at 00000211303B7FE0)
...
function #6 <?:200,224> (86 instructions, 344 bytes at 00000211303BA490)
...
function #7 <?:226,233> (20 instructions, 80 bytes at 00000211303BA9A0)
...
function #8 <?:235,271> (132 instructions, 528 bytes at 00000211303BAC40)
...
function #9 <?:273,288> (43 instructions, 172 bytes at 000002111662B2D0)
...
function #10 <?:290,296> (14 instructions, 56 bytes at 000002111662B570)
...
function #11 <?:298,304> (14 instructions, 56 bytes at 000002111662B6E0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #12 <?:306,312> (14 instructions, 56 bytes at 000002111662B850)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #13 <?:314,318> (7 instructions, 28 bytes at 000002111662B9C0)
...
function #14 <?:320,324> (12 instructions, 48 bytes at 000002111662BAD0)
...
function #15 <?:326,328> (2 instructions, 8 bytes at 000002111662BC20)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[327]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[328]	RETURN   	R0 1 ; return 

function #16 <?:330,332> (2 instructions, 8 bytes at 000002111662BCF0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[331]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[332]	RETURN   	R0 1 ; return 

function #17 <?:334,336> (3 instructions, 12 bytes at 000002111662BDC0)
