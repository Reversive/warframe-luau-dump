...
main <?:0,0> (127 instructions, 508 bytes at 00000211361E2ED0)
...
function #1 <?:23,27> (11 instructions, 44 bytes at 00000211337B8420)
...
function #2 <?:29,40> (45 instructions, 180 bytes at 00000211337B8560)
...
function #3 <?:42,56> (38 instructions, 152 bytes at 00000211337B8920)
...
function #4 <?:58,60> (3 instructions, 12 bytes at 00000211337B8BC0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[59]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[59]	SETUPVAL 	R0 U0 ; U0 := R0
	3	[60]	RETURN   	R0 1 ; return 

function #5 <?:62,75> (31 instructions, 124 bytes at 00000211337B8C90)
...
function #6 <?:77,79> (8 instructions, 32 bytes at 00000211337B8E40)
...
function #7 <?:81,86> (11 instructions, 44 bytes at 00000211220FAF30)
...
function #8 <?:88,123> (116 instructions, 464 bytes at 0000021131087C90)
...
function #9 <?:125,142> (34 instructions, 136 bytes at 00000211268239C0)
...
function #10 <?:144,155> (47 instructions, 188 bytes at 0000021126823C50)
...
function #11 <?:157,162> (12 instructions, 48 bytes at 0000021126823FB0)
...
function #12 <?:164,173> (29 instructions, 116 bytes at 0000021126824110)
...
function #13 <?:175,181> (18 instructions, 72 bytes at 0000021126824330)
...
function #14 <?:183,185> (3 instructions, 12 bytes at 00000211268244F0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[184]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[184]	CALL     	R0 1 1 ; R0()
	3	[185]	RETURN   	R0 1 ; return 

function #15 <?:187,194> (25 instructions, 100 bytes at 00000211268245A0)
...
function #16 <?:196,198> (11 instructions, 44 bytes at 00000211268247D0)
2 params, 6 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #17 <?:200,202> (11 instructions, 44 bytes at 00000211268248E0)
2 params, 6 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #18 <?:204,210> (20 instructions, 80 bytes at 00000211268249F0)
...
function #19 <?:212,214> (5 instructions, 20 bytes at 000002112215F3A0)
...
function #20 <?:216,218> (5 instructions, 20 bytes at 000002112215F490)
1 param, 3 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #21 <?:220,222> (6 instructions, 24 bytes at 000002112215F5A0)
...
function #22 <?:224,240> (58 instructions, 232 bytes at 000002112215F6B0)
...
function #23 <?:242,245> (13 instructions, 52 bytes at 000002112215FA40)
...
function #24 <?:247,260> (49 instructions, 196 bytes at 000002112215FBB0)
...
function #25 <?:262,264> (3 instructions, 12 bytes at 000002112215FF10)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[263]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[263]	RETURN   	R0 2 ; return R0 
	3	[264]	RETURN   	R0 1 ; return 

function #26 <?:266,268> (3 instructions, 12 bytes at 000002112215FFE0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[267]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[267]	CALL     	R0 1 1 ; R0()
	3	[268]	RETURN   	R0 1 ; return 

function #27 <?:270,272> (5 instructions, 20 bytes at 00000211221600B0)
...
function #28 <?:274,278> (19 instructions, 76 bytes at 00000211221601A0)
