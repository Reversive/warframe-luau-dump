...
main <?:0,0> (551 instructions, 2204 bytes at 00000211320C07D0)
...
function #1 <?:133,196> (312 instructions, 1248 bytes at 00000211320C2110)
...
function #2 <?:198,213> (35 instructions, 140 bytes at 00000211320C34A0)
...
function #3 <?:215,273> (152 instructions, 608 bytes at 00000211320C3760)
...
function #4 <?:275,292> (38 instructions, 152 bytes at 00000211320C40B0)
...
function #5 <?:294,321> (52 instructions, 208 bytes at 00000211320C43E0)
...
function #6 <?:323,339> (37 instructions, 148 bytes at 00000211320C4810)
...
function #7 <?:341,362> (42 instructions, 168 bytes at 00000211320C4AB0)
...
function #8 <?:364,377> (36 instructions, 144 bytes at 00000211320C4DD0)
...
function #9 <?:379,385> (12 instructions, 48 bytes at 0000021137D6BD50)
...
function #10 <?:387,434> (70 instructions, 280 bytes at 0000021137D6BE80)
...
function #11 <?:436,473> (88 instructions, 352 bytes at 0000021137D6C330)
...
function #12 <?:475,489> (25 instructions, 100 bytes at 0000021137D6C900)
...
function #13 <?:491,519> (34 instructions, 136 bytes at 0000021137D6CBC0)
...
function #14 <?:521,523> (3 instructions, 12 bytes at 0000021137D6D240)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[522]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[522]	CALL     	R0 1 1 ; R0()
	3	[523]	RETURN   	R0 1 ; return 

function #15 <?:525,527> (3 instructions, 12 bytes at 0000021137D6D310)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[526]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[526]	CALL     	R0 1 1 ; R0()
	3	[527]	RETURN   	R0 1 ; return 

function #16 <?:529,643> (92 instructions, 368 bytes at 0000021137D6D3E0)
0 params, 6 slots, 12 upvalues, 0 locals, 27 constants, 5 functions
	...
	38	[576]	SETTABLE 	R2 K16 R3 ; R2[0xbd2e96ea] := R3
	...
	47	[589]	SETTABLE 	R2 K19 R3 ; R2["TennoWay_BuyVendorItem"] := R3
...
function #17 <?:645,650> (20 instructions, 80 bytes at 0000021137D6F170)
...
function #18 <?:652,654> (3 instructions, 12 bytes at 0000021137D6F3A0)
...
function #19 <?:656,710> (121 instructions, 484 bytes at 0000021137D6F4B0)
0 params, 9 slots, 7 upvalues, 0 locals, 37 constants, 5 functions
	...
	50	[678]	SETTABLE 	R2 K16 R3 ; R2[0x00000001] := R3
...
function #20 <?:712,724> (37 instructions, 148 bytes at 0000021137D70410)
...
function #21 <?:726,785> (252 instructions, 1008 bytes at 0000021135B0F5F0)
...
function #22 <?:787,794> (17 instructions, 68 bytes at 0000021135B104E0)
...
function #23 <?:796,823> (78 instructions, 312 bytes at 0000021135B10650)
...
function #24 <?:825,846> (83 instructions, 332 bytes at 0000021135B10BF0)
...
function #25 <?:848,856> (18 instructions, 72 bytes at 0000021135B111B0)
...
function #26 <?:858,878> (82 instructions, 328 bytes at 0000021135B11380)
...
function #27 <?:880,893> (19 instructions, 76 bytes at 0000021135B11B00)
...
function #28 <?:895,908> (35 instructions, 140 bytes at 0000021135B11F60)
1 param, 6 slots, 2 upvalues, 0 locals, 13 constants, 0 functions
	...
	28	[904]	SETTABLE 	R0 K0 R3 ; R0["mCard"] := R3
	29	[906]	GETTABLE 	R3 R0 K0 ; R3 := R0["mCard"]
	30	[906]	GETTABLE 	R3 R3 K11 ; R3 := R3["mDesc"]
	31	[906]	SETTABLE 	R0 K10 R3 ; R0[0x2d0fad09] := R3
	32	[907]	GETTABLE 	R3 R0 K0 ; R3 := R0["mCard"]
	33	[907]	GETTABLE 	R3 R3 K12 ; R3 := R3["mNextLvlDesc"]
	34	[907]	SETTABLE 	R0 K12 R3 ; R0[0x9383bc56] := R3
	35	[908]	RETURN   	R0 1 ; return 

function #29 <?:910,978> (152 instructions, 608 bytes at 0000021135B12210)
...
function #30 <?:980,987> (32 instructions, 128 bytes at 0000021135B129B0)
...
function #31 <?:989,997> (14 instructions, 56 bytes at 0000021135B12D20)
...
function #32 <?:999,1447> (128 instructions, 512 bytes at 0000021135B12E90)
...
function #33 <?:1449,1464> (41 instructions, 164 bytes at 0000021132087C40)
...
function #34 <?:1466,1472> (21 instructions, 84 bytes at 0000021132087EC0)
...
function #35 <?:1474,1490> (30 instructions, 120 bytes at 00000211320880A0)
...
function #36 <?:1492,1583> (232 instructions, 928 bytes at 00000211320882F0)
...
function #37 <?:1585,1605> (35 instructions, 140 bytes at 0000021132089060)
2 params, 11 slots, 3 upvalues, 0 locals, 9 constants, 0 functions
	...
	6	[1587]	SETTABLE 	R0 K0 R2 ; R0["mLocalX"] := R2
...
function #38 <?:1607,1641> (117 instructions, 468 bytes at 00000211320892D0)
...
function #39 <?:1643,1653> (26 instructions, 104 bytes at 00000211320899C0)
...
function #40 <?:1655,1745> (259 instructions, 1036 bytes at 0000021132089C10)
...
function #41 <?:1747,1806> (96 instructions, 384 bytes at 000002113208A920)
...
function #42 <?:1808,1824> (41 instructions, 164 bytes at 000002113208B240)
...
function #43 <?:1826,1847> (52 instructions, 208 bytes at 00000211251B7DF0)
...
function #44 <?:1849,1853> (20 instructions, 80 bytes at 00000211251B81B0)
...
function #45 <?:1855,1869> (61 instructions, 244 bytes at 00000211251B83A0)
...
function #46 <?:1871,1879> (19 instructions, 76 bytes at 00000211251B8880)
...
function #47 <?:1881,1888> (16 instructions, 64 bytes at 00000211251B8A10)
...
function #48 <?:1890,1963> (135 instructions, 540 bytes at 00000211251B8BA0)
...
function #49 <?:1965,1974> (30 instructions, 120 bytes at 00000211251B9880)
...
function #50 <?:1976,1979> (8 instructions, 32 bytes at 00000211251B9AD0)
...
function #51 <?:1981,1988> (23 instructions, 92 bytes at 00000211251B9BE0)
...
function #52 <?:1990,2066> (185 instructions, 740 bytes at 00000211251B9D70)
...
function #53 <?:2068,2079> (16 instructions, 64 bytes at 00000211251BA6A0)
...
function #54 <?:2081,2083> (4 instructions, 16 bytes at 00000211251BA830)
...
function #55 <?:2085,2098> (55 instructions, 220 bytes at 00000211251BA920)
...
function #56 <?:2100,2225> (491 instructions, 1964 bytes at 00000211251BADE0)
...
function #57 <?:2227,2229> (2 instructions, 8 bytes at 00000211251BBF90)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[2228]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[2229]	RETURN   	R0 1 ; return 

function #58 <?:2231,2233> (3 instructions, 12 bytes at 00000211251BC060)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[2232]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[2232]	CALL     	R0 1 1 ; R0()
	3	[2233]	RETURN   	R0 1 ; return 

function #59 <?:2235,2237> (3 instructions, 12 bytes at 00000211251BC130)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[2236]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[2236]	CALL     	R0 1 1 ; R0()
	3	[2237]	RETURN   	R0 1 ; return 

function #60 <?:2239,2245> (12 instructions, 48 bytes at 00000211251BC200)
...
function #61 <?:2247,2249> (3 instructions, 12 bytes at 00000211251BC340)
...
function #62 <?:2251,2255> (12 instructions, 48 bytes at 00000211251BC410)
...
function #63 <?:2257,2261> (12 instructions, 48 bytes at 00000211251BC560)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #64 <?:2263,2267> (16 instructions, 64 bytes at 00000211336BD150)
...
function #65 <?:2269,2273> (16 instructions, 64 bytes at 00000211336BD2C0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #66 <?:2275,2279> (12 instructions, 48 bytes at 00000211336BD430)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #67 <?:2281,2285> (12 instructions, 48 bytes at 00000211336BD580)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #68 <?:2287,2291> (16 instructions, 64 bytes at 00000211336BD6D0)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #69 <?:2293,2297> (16 instructions, 64 bytes at 00000211336BD840)
1 param, 5 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #70 <?:2299,2303> (10 instructions, 40 bytes at 00000211336BD9B0)
...
function #71 <?:2305,2313> (13 instructions, 52 bytes at 00000211336BDAF0)
...
function #72 <?:2315,2352> (85 instructions, 340 bytes at 00000211336BDC80)
...
function #73 <?:2354,2428> (191 instructions, 764 bytes at 00000211336BE2F0)
...
function #74 <?:2430,2438> (50 instructions, 200 bytes at 00000211336BEED0)
1 param, 10 slots, 2 upvalues, 0 locals, 22 constants, 0 functions
	...
	36	[2436]	SETTABLE 	R6 K13 R7 ; R6["NAME"] := R7
...
function #75 <?:2440,2444> (9 instructions, 36 bytes at 00000211336BF330)
...
function #76 <?:2446,2539> (203 instructions, 812 bytes at 00000211336BF460)
1 param, 27 slots, 11 upvalues, 0 locals, 52 constants, 2 functions
	...
	55	[2464]	SETTABLE 	R7 K15 R8 ; R7[0x03f57322] := R8
	...
	135	[2500]	SETTABLE 	R21 K15 R22 ; R21[0x03f57322] := R22
...
function #77 <?:2541,2544> (5 instructions, 20 bytes at 00000211336C0390)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #78 <?:2546,2548> (6 instructions, 24 bytes at 00000211336C0480)
...
function #79 <?:2551,2563> (46 instructions, 184 bytes at 00000211336C05B0)
...
function #80 <?:2565,2567> (6 instructions, 24 bytes at 00000211336C0860)
...
function #81 <?:2569,2572> (5 instructions, 20 bytes at 00000211336C0970)
...
function #82 <?:2574,2576> (3 instructions, 12 bytes at 00000211336C0A80)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[2575]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[2575]	RETURN   	R0 2 ; return R0 
	3	[2576]	RETURN   	R0 1 ; return 

function #83 <?:2578,2581> (5 instructions, 20 bytes at 00000211336C0B50)
...
function #84 <?:2583,2586> (5 instructions, 20 bytes at 00000211336C0C60)
2 params, 3 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #85 <?:2588,2591> (6 instructions, 24 bytes at 00000211336C0D70)
2 params, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #86 <?:2593,2596> (5 instructions, 20 bytes at 00000211336C0E80)
2 params, 3 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #87 <?:2598,2616> (45 instructions, 180 bytes at 00000211336C0F90)
...
function #88 <?:2618,2620> (3 instructions, 12 bytes at 00000211336C1200)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[2619]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[2619]	RETURN   	R0 2 ; return R0 
	3	[2620]	RETURN   	R0 1 ; return 

function #89 <?:2622,2624> (3 instructions, 12 bytes at 00000211336C12D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
