...
main <?:0,0> (90 instructions, 360 bytes at 0000021126FEFD20)
...
function #1 <?:21,23> (3 instructions, 12 bytes at 0000021126FF01D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[22]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[22]	RETURN   	R0 2 ; return R0 
	3	[23]	RETURN   	R0 1 ; return 

function #2 <?:25,26> (1 instruction, 4 bytes at 0000021126FF02A0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[26]	RETURN   	R0 1 ; return 

function #3 <?:28,35> (17 instructions, 68 bytes at 0000021126FF0370)
...
function #4 <?:38,47> (27 instructions, 108 bytes at 0000021126FF0640)
...
function #5 <?:49,59> (42 instructions, 168 bytes at 0000021126FF0860)
...
function #6 <?:61,138> (182 instructions, 728 bytes at 0000021126FF0C00)
...
function #7 <?:140,161> (32 instructions, 128 bytes at 00000211342860F0)
...
function #8 <?:163,165> (4 instructions, 16 bytes at 0000021134286400)
...
function #9 <?:167,169> (4 instructions, 16 bytes at 00000211342864F0)
0 params, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #10 <?:171,173> (4 instructions, 16 bytes at 00000211342865E0)
0 params, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #11 <?:175,177> (4 instructions, 16 bytes at 00000211342866D0)
0 params, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #12 <?:179,185> (15 instructions, 60 bytes at 00000211342867C0)
...
function #13 <?:187,196> (31 instructions, 124 bytes at 0000021134286930)
...
function #14 <?:198,231> (117 instructions, 468 bytes at 0000021134286BF0)
...
function #15 <?:233,235> (3 instructions, 12 bytes at 00000211342874D0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[234]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[234]	CALL     	R0 1 1 ; R0()
	3	[235]	RETURN   	R0 1 ; return 

function #16 <?:237,240> (8 instructions, 32 bytes at 00000211342875A0)
...
function #17 <?:242,248> (30 instructions, 120 bytes at 00000211342876B0)
