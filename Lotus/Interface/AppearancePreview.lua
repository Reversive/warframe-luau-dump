...
main <?:0,0> (255 instructions, 1020 bytes at 000002111E881E70)
...
function #1 <?:48,50> (3 instructions, 12 bytes at 000002111E882AC0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[49]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[49]	RETURN   	R0 2 ; return R0 
	3	[50]	RETURN   	R0 1 ; return 

function #2 <?:52,61> (25 instructions, 100 bytes at 000002111E882B90)
...
function #3 <?:63,75> (24 instructions, 96 bytes at 000002111E882D90)
...
function #4 <?:77,115> (91 instructions, 364 bytes at 000002111E882F70)
...
function #5 <?:117,152> (91 instructions, 364 bytes at 000002111E883450)
...
function #6 <?:154,181> (91 instructions, 364 bytes at 000002111E883970)
...
function #7 <?:183,193> (39 instructions, 156 bytes at 000002111E883E90)
...
function #8 <?:195,379> (382 instructions, 1528 bytes at 000002111E8841C0)
1 param, 54 slots, 11 upvalues, 0 locals, 66 constants, 0 functions
	...
	34	[211]	SETTABLE 	R4 K5 R5 ; R4["mEquippedItem"] := R5
	...
	51	[212]	SETTABLE 	R4 K10 R5 ; R4["mWeaponInfos"] := R5
	...
	59	[214]	SETTABLE 	R4 K10 R5 ; R4["mWeaponInfos"] := R5
	...
	258	[285]	SETTABLE 	R36 K17 R37 ; R36["mStoreItem"] := R37
...
function #9 <?:381,439> (168 instructions, 672 bytes at 000002111E884E00)
0 params, 27 slots, 9 upvalues, 0 locals, 38 constants, 0 functions
	...
	62	[398]	SETTABLE 	R8 K16 R2 ; R8[0xcd0165a3] := R2
...
function #10 <?:441,496> (153 instructions, 612 bytes at 000002111E885260)
...
function #11 <?:498,515> (43 instructions, 172 bytes at 0000021138801510)
...
function #12 <?:517,527> (43 instructions, 172 bytes at 00000211388017B0)
...
function #13 <?:529,571> (125 instructions, 500 bytes at 0000021138801B70)
...
function #14 <?:573,605> (44 instructions, 176 bytes at 0000021138802270)
...
function #15 <?:607,633> (72 instructions, 288 bytes at 0000021138802960)
...
function #16 <?:635,658> (91 instructions, 364 bytes at 0000021138802E30)
...
function #17 <?:660,696> (105 instructions, 420 bytes at 0000021138803550)
...
function #18 <?:698,699> (1 instruction, 4 bytes at 0000021138803BE0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[699]	RETURN   	R0 1 ; return 

function #19 <?:701,717> (69 instructions, 276 bytes at 0000021138803CB0)
...
function #20 <?:719,731> (27 instructions, 108 bytes at 0000021138804110)
...
function #21 <?:733,795> (93 instructions, 372 bytes at 0000021138804320)
0 params, 7 slots, 6 upvalues, 0 locals, 43 constants, 5 functions
	...
	63	[765]	SETTABLE 	R1 K33 R2 ; R1[0x07000010] := R2
...
function #22 <?:797,860> (204 instructions, 816 bytes at 000002111688A840)
0 params, 11 slots, 16 upvalues, 0 locals, 62 constants, 0 functions
	...
	9	[799]	SETTABLE 	R0 K0 R1 ; R0[0xae91e43b] := R1
...
function #23 <?:862,906> (142 instructions, 568 bytes at 000002111688B410)
...
function #24 <?:908,914> (17 instructions, 68 bytes at 000002111688BB00)
...
function #25 <?:916,925> (14 instructions, 56 bytes at 000002111688BCB0)
...
function #29 <?:941,945> (13 instructions, 52 bytes at 000002111688C110)
...
function #30 <?:947,951> (13 instructions, 52 bytes at 000002111688C280)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #31 <?:953,961> (21 instructions, 84 bytes at 000002111688C3F0)
...
function #32 <?:963,966> (6 instructions, 24 bytes at 000002111688C590)
...
function #33 <?:968,971> (6 instructions, 24 bytes at 000002111688C680)
2 params, 4 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #34 <?:973,977> (10 instructions, 40 bytes at 000002111688C770)
...
function #35 <?:979,983> (10 instructions, 40 bytes at 000002111688C8B0)
0 params, 3 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #36 <?:985,989> (17 instructions, 68 bytes at 000002111688C9F0)
...
function #37 <?:991,999> (10 instructions, 40 bytes at 000002111688CB90)
