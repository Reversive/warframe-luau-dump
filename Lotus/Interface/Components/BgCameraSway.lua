...
main <?:0,0> (8 instructions, 32 bytes at 000002117D6D5BB0)
...
function #1 <?:3,119> (54 instructions, 216 bytes at 0000021126FF1600)
...
main <?:0,0> (8 instructions, 32 bytes at 0000021123D1C460)
0+ params, 3 slots, 0 upvalues, 0 locals, 4 constants, 1 function
	1	[1]	GETGLOBAL	R0 K0 ; R0 := 0xaeabecda
	2	[1]	VARARG   	R1 R2 ; R1 := R2 := ...
	3	[1]	GETGLOBAL	R2 K1 ; R2 := package
...
function #1 <?:3,119> (54 instructions, 216 bytes at 00000211262433C0)
4 params, 10 slots, 0 upvalues, 0 locals, 28 constants, 3 functions
	1	[4]	GETGLOBAL	R4 K0 ; R4 := 0x2d0fad09
	2	[4]	LOADK    	R5 K1 ; R5 := "EE.Interface.Utilities"
	3	[4]	CALL     	R4 2 2 ; R4 := R4(R5)
