...
main <?:0,0> (20 instructions, 80 bytes at 00000211381042B0)
...
function #1 <?:7,462> (113 instructions, 452 bytes at 0000021138104430)
3 params, 8 slots, 3 upvalues, 0 locals, 66 constants, 12 functions
	...
	38	[30]	SETTABLE 	R3 K40 R4 ; R3[0x08000000] := R4
	...
	44	[54]	SETTABLE 	R3 K46 R4 ; R3[0x00000011] := R4
