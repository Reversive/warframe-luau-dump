...
main <?:0,0> (8 instructions, 32 bytes at 00000211193DC980)
...
function #1 <?:4,78> (42 instructions, 168 bytes at 00000211193DCA60)
1 param, 3 slots, 0 upvalues, 0 locals, 24 constants, 11 functions
	...
	38	[68]	SETTABLE 	R1 K22 R2 ; R1[0x07000038] := R2
