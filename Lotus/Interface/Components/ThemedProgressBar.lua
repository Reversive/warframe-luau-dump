...
main <?:0,0> (8 instructions, 32 bytes at 00000211193B2220)
...
function #1 <?:3,171> (85 instructions, 340 bytes at 00000211193B2300)
6 params, 13 slots, 0 upvalues, 0 locals, 35 constants, 9 functions
	...
	17	[16]	SETTABLE 	R8 K6 R1 ; R8[0x8010001a] := R1
	18	[17]	TESTSET  	R9 R2 1 ; if R2 then PC := 21 else R9 := R2 
	19	[17]	JMP      	21 ; PC := 21
	20	[17]	LOADK    	R9 := 100.000000
	21	[17]	SETTABLE 	R8 K7 R9 ; R8[0x00000004] := R9
