...
main <?:0,0> (8 instructions, 32 bytes at 0000021126FF2CC0)
...
function #1 <?:3,235> (102 instructions, 408 bytes at 0000021126FF2DB0)
3 params, 16 slots, 0 upvalues, 0 locals, 37 constants, 12 functions
	...
	20	[14]	SETTABLE 	R9 K8 R1 ; R9[0x25312c9b] := R1
...
main <?:0,0> (8 instructions, 32 bytes at 0000021123D24B80)
0+ params, 3 slots, 0 upvalues, 0 locals, 4 constants, 1 function
	1	[1]	GETGLOBAL	R0 K0 ; R0 := 0xaeabecda
	2	[1]	VARARG   	R1 R2 ; R1 := R2 := ...
	3	[1]	GETGLOBAL	R2 K1 ; R2 := package
...
function #1 <?:3,235> (102 instructions, 408 bytes at 000002112F652070)
3 params, 16 slots, 0 upvalues, 0 locals, 37 constants, 12 functions
	1	[4]	GETGLOBAL	R3 K0 ; R3 := 0x2d0fad09
	2	[4]	LOADK    	R4 K1 ; R4 := "EE.Interface.Utilities"
	3	[4]	CALL     	R3 2 2 ; R3 := R3(R4)
