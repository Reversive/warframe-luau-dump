...
main <?:0,0> (16 instructions, 64 bytes at 000002113543B6E0)
...
function #1 <?:6,386> (104 instructions, 416 bytes at 000002113543B880)
3 params, 10 slots, 2 upvalues, 0 locals, 63 constants, 17 functions
	...
	89	[328]	SETTABLE 	R4 K56 R5 ; R4["SetIconZDepth"] := R5
	90	[339]	CLOSURE  	R5 14 ; R5 := closure(Function #15)
	91	[339]	SETTABLE 	R4 K57 R5 ; R4[0x74c9fe02] := R5
	...
	95	[379]	SETTABLE 	R4 K59 R5 ; R4[0x20b98db3] := R5
