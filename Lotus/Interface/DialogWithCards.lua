...
main <?:0,0> (236 instructions, 944 bytes at 000002112BD58C10)
...
function #1 <?:62,64> (3 instructions, 12 bytes at 000002117E9AA340)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[63]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[63]	RETURN   	R0 2 ; return R0 
	3	[64]	RETURN   	R0 1 ; return 

function #2 <?:66,68> (2 instructions, 8 bytes at 00000211207B7110)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[67]	RETURN   	R0 2 ; return R0 
	2	[68]	RETURN   	R0 1 ; return 

function #3 <?:70,81> (37 instructions, 148 bytes at 00000211207B71C0)
...
function #4 <?:83,101> (63 instructions, 252 bytes at 00000211207B74C0)
0 params, 14 slots, 5 upvalues, 0 locals, 11 constants, 0 functions
	...
	29	[91]	SETTABLE 	R9 K3 R10 ; R9["mUpgradeFingerprint"] := R10
	...
	43	[94]	SETTABLE 	R9 K3 R10 ; R9["mUpgradeFingerprint"] := R10
...
function #5 <?:103,110> (18 instructions, 72 bytes at 00000211207B7830)
...
function #6 <?:112,131> (44 instructions, 176 bytes at 00000211207B79E0)
...
function #7 <?:133,193> (206 instructions, 824 bytes at 00000211207B7C80)
...
function #8 <?:195,310> (450 instructions, 1800 bytes at 000002112BD59C40)
0 params, 35 slots, 17 upvalues, 0 locals, 80 constants, 1 function
	...
	52	[216]	SETTABLE 	R6 K11 R7 ; R6["mItemType"] := R7
	...
	71	[218]	SETTABLE 	R6 K12 R7 ; R6["mUpgradeFingerprint"] := R7
	72	[218]	JMP      	74 ; PC := 74
	73	[220]	SETTABLE 	R6 K12 R2 ; R6["mUpgradeFingerprint"] := R2
...
function #9 <?:312,319> (24 instructions, 96 bytes at 000002112616DEE0)
...
function #10 <?:321,326> (11 instructions, 44 bytes at 000002112616E100)
...
function #11 <?:328,332> (19 instructions, 76 bytes at 000002112616E250)
...
function #12 <?:334,342> (37 instructions, 148 bytes at 000002112616E420)
...
function #13 <?:344,348> (17 instructions, 68 bytes at 000002112616E710)
...
function #14 <?:350,354> (11 instructions, 44 bytes at 000002112616E8C0)
...
function #15 <?:356,409> (44 instructions, 176 bytes at 000002112616EA60)
...
function #16 <?:411,529> (384 instructions, 1536 bytes at 000002112616F6A0)
...
function #17 <?:531,551> (64 instructions, 256 bytes at 00000211261709B0)
...
function #18 <?:553,560> (14 instructions, 56 bytes at 0000021126170D50)
...
function #19 <?:562,564> (4 instructions, 16 bytes at 0000021126170E80)
...
function #20 <?:566,569> (2 instructions, 8 bytes at 0000021126170F50)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[568]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[569]	RETURN   	R0 1 ; return 

function #21 <?:571,573> (4 instructions, 16 bytes at 0000021126171020)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #22 <?:575,577> (2 instructions, 8 bytes at 00000211261710F0)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[576]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[577]	RETURN   	R0 1 ; return 

function #23 <?:579,581> (4 instructions, 16 bytes at 00000211261711C0)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #24 <?:583,592> (19 instructions, 76 bytes at 0000021126171290)
...
function #25 <?:594,596> (3 instructions, 12 bytes at 0000021126171450)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[595]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[595]	CALL     	R0 1 1 ; R0()
	3	[596]	RETURN   	R0 1 ; return 

function #26 <?:598,606> (38 instructions, 152 bytes at 0000021126171520)
...
function #27 <?:608,611> (6 instructions, 24 bytes at 0000021126171920)
...
function #28 <?:613,701> (263 instructions, 1052 bytes at 0000021126171A00)
...
function #29 <?:703,707> (5 instructions, 20 bytes at 00000211261725F0)
...
function #30 <?:709,731> (60 instructions, 240 bytes at 000002111EE14400)
...
function #31 <?:733,737> (15 instructions, 60 bytes at 000002111EE14740)
...
function #32 <?:739,743> (10 instructions, 40 bytes at 000002111EE14900)
...
function #33 <?:745,749> (10 instructions, 40 bytes at 000002111EE14A40)
1 param, 4 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #34 <?:751,753> (3 instructions, 12 bytes at 000002111EE14B80)
...
function #35 <?:755,757> (3 instructions, 12 bytes at 000002111EE14C90)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[756]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[756]	RETURN   	R0 2 ; return R0 
	3	[757]	RETURN   	R0 1 ; return 

function #36 <?:759,761> (3 instructions, 12 bytes at 000002111EE14D60)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[760]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[760]	RETURN   	R0 2 ; return R0 
	3	[761]	RETURN   	R0 1 ; return 

function #37 <?:763,765> (3 instructions, 12 bytes at 000002111EE14E30)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[764]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[764]	RETURN   	R0 2 ; return R0 
	3	[765]	RETURN   	R0 1 ; return 

function #38 <?:767,769> (3 instructions, 12 bytes at 000002111EE14F00)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[768]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[768]	RETURN   	R0 2 ; return R0 
	3	[769]	RETURN   	R0 1 ; return 

function #39 <?:771,772> (1 instruction, 4 bytes at 000002111EE14FD0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[772]	RETURN   	R0 1 ; return 

function #40 <?:774,775> (1 instruction, 4 bytes at 000002111EE150A0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[775]	RETURN   	R0 1 ; return 

function #41 <?:777,778> (1 instruction, 4 bytes at 000002111EE15170)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[778]	RETURN   	R0 1 ; return 

function #42 <?:780,781> (1 instruction, 4 bytes at 000002111EE15240)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[781]	RETURN   	R0 1 ; return 

function #43 <?:783,788> (16 instructions, 64 bytes at 000002111EE15310)
...
function #44 <?:790,792> (3 instructions, 12 bytes at 000002111EE15480)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[791]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[791]	RETURN   	R0 2 ; return R0 
	3	[792]	RETURN   	R0 1 ; return 

function #45 <?:794,796> (3 instructions, 12 bytes at 000002111EE15550)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
