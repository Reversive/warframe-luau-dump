...
main <?:0,0> (424 instructions, 1696 bytes at 00000211142018A0)
0+ params, 69 slots, 0 upvalues, 0 locals, 86 constants, 61 functions
	...
	35	[36]	SETTABLE 	R15 K12 R16 ; R15[0x6d147816] := R16
...
function #1 <?:82,84> (3 instructions, 12 bytes at 0000021114202C70)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[83]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[83]	RETURN   	R0 2 ; return R0 
	3	[84]	RETURN   	R0 1 ; return 

function #2 <?:86,88> (15 instructions, 60 bytes at 0000021114202D40)
...
function #3 <?:90,106> (42 instructions, 168 bytes at 0000021114202ED0)
...
function #4 <?:108,122> (24 instructions, 96 bytes at 00000211142031D0)
...
function #5 <?:124,132> (23 instructions, 92 bytes at 00000211142032D0)
...
function #6 <?:134,136> (4 instructions, 16 bytes at 0000021114203590)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #7 <?:138,213> (221 instructions, 884 bytes at 0000021114203660)
0 params, 37 slots, 10 upvalues, 0 locals, 43 constants, 0 functions
	...
	28	[145]	SETTABLE 	R1 K5 R2 ; R1[0x4e47534f] := R2
	...
	55	[152]	SETTABLE 	R10 K12 R5 ; R10["Id"] := R5
	56	[152]	SETTABLE 	R10 K13 R7 ; R10["Type"] := R7
...
function #8 <?:215,220> (27 instructions, 108 bytes at 00000211142041E0)
...
function #9 <?:222,253> (115 instructions, 460 bytes at 00000211142044A0)
...
function #10 <?:255,273> (51 instructions, 204 bytes at 000002112DB94EF0)
...
function #11 <?:275,309> (69 instructions, 276 bytes at 000002112DB95310)
...
function #12 <?:311,365> (180 instructions, 720 bytes at 000002112DB956F0)
0 params, 22 slots, 9 upvalues, 0 locals, 34 constants, 0 functions
	...
	147	[357]	SETTABLE 	R16 K28 R17 ; R16[0xec9368e2] := R17
...
function #13 <?:367,465> (134 instructions, 536 bytes at 000002112DB96060)
...
function #14 <?:467,468> (1 instruction, 4 bytes at 000002112DB970E0)
2 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[468]	RETURN   	R0 1 ; return 

function #15 <?:470,581> (332 instructions, 1328 bytes at 000002112DB971B0)
...
function #16 <?:583,590> (26 instructions, 104 bytes at 000002112DB981A0)
...
function #17 <?:592,599> (25 instructions, 100 bytes at 000002112DB98400)
...
function #18 <?:601,621> (56 instructions, 224 bytes at 000002112DB98610)
...
function #19 <?:623,687> (265 instructions, 1060 bytes at 000002112DB98A60)
1 param, 20 slots, 6 upvalues, 0 locals, 50 constants, 0 functions
	...
	17	[632]	SETTABLE 	R3 K7 R0 ; R3["Id"] := R0
	...
	72	[645]	SETTABLE 	R8 K3 R9 ; R8["NumCompatItems"] := R9
...
function #20 <?:689,725> (135 instructions, 540 bytes at 000002112DB99710)
...
function #21 <?:727,772> (151 instructions, 604 bytes at 000002112DB997A0)
0 params, 18 slots, 4 upvalues, 0 locals, 33 constants, 0 functions
	...
	106	[758]	SETTABLE 	R9 K2 R10 ; R9[0x00000001] := R10
...
function #22 <?:774,796> (59 instructions, 236 bytes at 000002112E5C8ED0)
...
function #23 <?:798,804> (27 instructions, 108 bytes at 000002112E5C9370)
...
function #24 <?:806,850> (111 instructions, 444 bytes at 000002112E5C95C0)
...
function #25 <?:852,908> (193 instructions, 772 bytes at 000002112E5C9C80)
...
function #26 <?:910,1043> (222 instructions, 888 bytes at 000002112E5CA720)
0 params, 8 slots, 6 upvalues, 0 locals, 88 constants, 9 functions
	...
	23	[914]	SETTABLE 	R1 K12 R2 ; R1[0xae91e43b] := R2
	...
	83	[934]	SETTABLE 	R1 K47 R2 ; R1["mTextElementClips"] := R2
	...
	156	[1012]	SETTABLE 	R3 K63 R4 ; R3["Name"] := R4
	...
	160	[1033]	SETTABLE 	R3 K68 R4 ; R3[0xed1ab921] := R4
	...
	174	[1037]	SETTABLE 	R3 K63 R4 ; R3["Name"] := R4
	...
	191	[1038]	SETTABLE 	R3 K63 R4 ; R3["Name"] := R4
	...
	208	[1039]	SETTABLE 	R3 K63 R4 ; R3["Name"] := R4
...
function #27 <?:1045,1063> (79 instructions, 316 bytes at 000002112E5CC740)
...
function #28 <?:1065,1090> (150 instructions, 600 bytes at 000002112E5CC920)
0 params, 12 slots, 2 upvalues, 0 locals, 46 constants, 0 functions
	...
	122	[1084]	SETTABLE 	R8 K38 R9 ; R8[0xae91e43b] := R9
	...
	127	[1084]	SETTABLE 	R8 K40 R9 ; R8[0x767c0947] := R9
...
function #29 <?:1092,1199> (501 instructions, 2004 bytes at 00000211319A25A0)
...
function #30 <?:1201,1220> (78 instructions, 312 bytes at 00000211319A41D0)
...
function #31 <?:1222,1234> (38 instructions, 152 bytes at 00000211319A4620)
...
function #32 <?:1236,1306> (263 instructions, 1052 bytes at 00000211319A4880)
...
function #33 <?:1308,1312> (12 instructions, 48 bytes at 00000211319A54D0)
...
function #34 <?:1314,1318> (12 instructions, 48 bytes at 00000211319A5620)
1 param, 5 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
...
function #35 <?:1320,1324> (16 instructions, 64 bytes at 00000211319A5770)
...
function #36 <?:1326,1331> (17 instructions, 68 bytes at 00000211319A58E0)
...
function #37 <?:1333,1335> (7 instructions, 28 bytes at 00000211319A5AB0)
...
function #38 <?:1337,1343> (7 instructions, 28 bytes at 00000211319A5BE0)
...
function #39 <?:1345,1347> (3 instructions, 12 bytes at 00000211319A5CD0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[1346]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[1346]	RETURN   	R0 2 ; return R0 
	3	[1347]	RETURN   	R0 1 ; return 

function #40 <?:1349,1354> (17 instructions, 68 bytes at 00000211319A5DA0)
...
function #41 <?:1356,1361> (17 instructions, 68 bytes at 00000211319A5F30)
0 params, 2 slots, 3 upvalues, 0 locals, 3 constants, 0 functions
...
function #42 <?:1363,1365> (6 instructions, 24 bytes at 0000021121C4A220)
...
function #43 <?:1367,1369> (6 instructions, 24 bytes at 0000021121C4A310)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #44 <?:1371,1373> (7 instructions, 28 bytes at 0000021121C4A430)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #45 <?:1375,1377> (7 instructions, 28 bytes at 0000021121C4A550)
2 params, 5 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #46 <?:1379,1385> (18 instructions, 72 bytes at 0000021121C4A670)
...
function #47 <?:1387,1396> (13 instructions, 52 bytes at 0000021121C4A830)
...
function #48 <?:1398,1404> (21 instructions, 84 bytes at 0000021121C4A990)
...
function #49 <?:1406,1410> (17 instructions, 68 bytes at 0000021121C4AB60)
...
function #50 <?:1412,1416> (17 instructions, 68 bytes at 0000021121C4AD00)
1 param, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #51 <?:1418,1422> (21 instructions, 84 bytes at 0000021121C4AEA0)
...
function #52 <?:1424,1428> (19 instructions, 76 bytes at 0000021121C4B060)
...
function #53 <?:1430,1434> (19 instructions, 76 bytes at 0000021121C4B1F0)
0 params, 2 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #54 <?:1436,1440> (19 instructions, 76 bytes at 0000021121C4B380)
0 params, 2 slots, 2 upvalues, 0 locals, 3 constants, 0 functions
...
function #55 <?:1442,1448> (16 instructions, 64 bytes at 0000021121C4B510)
...
function #56 <?:1450,1456> (16 instructions, 64 bytes at 0000021121C4B690)
1 param, 5 slots, 1 upvalue, 0 locals, 4 constants, 0 functions
...
function #57 <?:1458,1464> (20 instructions, 80 bytes at 0000021121C4B810)
1 param, 5 slots, 2 upvalues, 0 locals, 4 constants, 0 functions
...
function #58 <?:1466,1472> (30 instructions, 120 bytes at 0000021121C4B9B0)
...
function #59 <?:1474,1476> (6 instructions, 24 bytes at 0000021121C4BBF0)
...
function #60 <?:1478,1482> (7 instructions, 28 bytes at 0000021121C4BD00)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #61 <?:1484,1486> (3 instructions, 12 bytes at 0000021121C4BE10)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
