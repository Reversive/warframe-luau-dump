...
main <?:0,0> (107 instructions, 428 bytes at 00000211131849F0)
...
function #1 <?:33,37> (9 instructions, 36 bytes at 0000021113184D40)
...
function #2 <?:39,43> (9 instructions, 36 bytes at 0000021113184E50)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #3 <?:45,76> (123 instructions, 492 bytes at 0000021113184F90)
...
function #4 <?:78,231> (578 instructions, 2312 bytes at 0000021113185320)
...
function #5 <?:233,235> (1 instruction, 4 bytes at 0000021113186CE0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[235]	RETURN   	R0 1 ; return 

function #6 <?:237,239> (1 instruction, 4 bytes at 0000021113186DB0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[239]	RETURN   	R0 1 ; return 

function #7 <?:241,243> (3 instructions, 12 bytes at 0000021113186E80)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[242]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[242]	RETURN   	R0 2 ; return R0 
	3	[243]	RETURN   	R0 1 ; return 

function #8 <?:245,246> (1 instruction, 4 bytes at 0000021113186F50)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[246]	RETURN   	R0 1 ; return 

function #9 <?:248,250> (3 instructions, 12 bytes at 0000021113187020)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[249]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[249]	CALL     	R0 1 1 ; R0()
	3	[250]	RETURN   	R0 1 ; return 

function #10 <?:252,254> (3 instructions, 12 bytes at 0000021128BB7510)
...
function #11 <?:256,273> (68 instructions, 272 bytes at 0000021130B30FD0)
...
function #12 <?:275,279> (11 instructions, 44 bytes at 0000021130B313C0)
...
function #13 <?:281,284> (6 instructions, 24 bytes at 0000021130B31500)
...
function #14 <?:286,290> (16 instructions, 64 bytes at 0000021130B31630)
...
function #15 <?:292,297> (20 instructions, 80 bytes at 0000021130B317C0)
...
function #16 <?:299,302> (15 instructions, 60 bytes at 0000021130B319E0)
...
function #17 <?:304,322> (24 instructions, 96 bytes at 0000021130B31BC0)
...
function #18 <?:324,330> (31 instructions, 124 bytes at 0000021130B32010)
...
function #19 <?:332,336> (26 instructions, 104 bytes at 0000021130B32280)
...
function #20 <?:338,347> (18 instructions, 72 bytes at 0000021130B324A0)
...
function #21 <?:349,351> (3 instructions, 12 bytes at 0000021130B32690)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[350]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[350]	RETURN   	R0 2 ; return R0 
	3	[351]	RETURN   	R0 1 ; return 

function #22 <?:353,355> (3 instructions, 12 bytes at 0000021130B32760)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[354]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[354]	CALL     	R0 1 1 ; R0()
	3	[355]	RETURN   	R0 1 ; return 

main <?:0,0> (107 instructions, 428 bytes at 0000021129E8ED30)
0+ params, 18 slots, 0 upvalues, 0 locals, 32 constants, 22 functions
	1	[11]	GETGLOBAL	R0 K0 ; R0 := 0x2d0fad09
	2	[11]	LOADK    	R1 K1 ; R1 := "EE.Interface.AnchorMgr"
	3	[11]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #1 <?:33,37> (9 instructions, 36 bytes at 0000021136384F50)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[34]	GETGLOBAL	R0 K0 ; R0 := 0x7b998233
	2	[34]	GETUPVAL 	R1 U0 ; R1 := U0
	3	[34]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #2 <?:39,43> (9 instructions, 36 bytes at 00000211186DAFE0)
0 params, 2 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
	1	[40]	GETGLOBAL	R0 K0 ; R0 := 0x7b998233
	2	[40]	GETUPVAL 	R1 U0 ; R1 := U0
	3	[40]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #3 <?:45,76> (123 instructions, 492 bytes at 0000021114433680)
0 params, 14 slots, 5 upvalues, 0 locals, 38 constants, 0 functions
	1	[47]	OP_LOADBOOL	R1 0 0 ; R1 := false
	2	[48]	GETGLOBAL	R2 K0 ; R2 := 0x7b998233
	3	[48]	GETGLOBAL	R3 K1 ; R3 := 0x25d99d89
...
function #4 <?:78,231> (578 instructions, 2312 bytes at 0000021122A88BC0)
0 params, 44 slots, 10 upvalues, 0 locals, 137 constants, 0 functions
	1	[79]	GETGLOBAL	R0 K0 ; R0 := 0xae91e43b
	2	[79]	SELF     	R0 R0 K1 ; R1 := R0; R0 := R0[0x58bec6d6]
	3	[79]	LOADK    	R2 := 0.000000
...
function #5 <?:233,235> (1 instruction, 4 bytes at 0000021118585BC0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[235]	RETURN   	R0 1 ; return 

function #6 <?:237,239> (1 instruction, 4 bytes at 0000021132F95660)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[239]	RETURN   	R0 1 ; return 

function #7 <?:241,243> (3 instructions, 12 bytes at 000002111BB1D130)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[242]	OP_LOADBOOL	R0 0 0 ; R0 := false
	2	[242]	RETURN   	R0 2 ; return R0 
	3	[243]	RETURN   	R0 1 ; return 

function #8 <?:245,246> (1 instruction, 4 bytes at 000002112620C050)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[246]	RETURN   	R0 1 ; return 

function #9 <?:248,250> (3 instructions, 12 bytes at 0000021133F992C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[249]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[249]	CALL     	R0 1 1 ; R0()
	3	[250]	RETURN   	R0 1 ; return 

function #10 <?:252,254> (3 instructions, 12 bytes at 000002112F3FC510)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[253]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[253]	CALL     	R1 1 1 ; R1()
	3	[254]	RETURN   	R0 1 ; return 

function #11 <?:256,273> (68 instructions, 272 bytes at 00000211319BCA80)
0 params, 10 slots, 2 upvalues, 0 locals, 17 constants, 0 functions
	1	[257]	GETGLOBAL	R0 K0 ; R0 := 0xb693b6c1
	2	[257]	CALL     	R0 1 2 ; R0 := R0()
	3	[259]	GETGLOBAL	R1 K1 ; R1 := 0xae91e43b
...
function #12 <?:275,279> (11 instructions, 44 bytes at 00000211217673C0)
1 param, 3 slots, 2 upvalues, 0 locals, 6 constants, 0 functions
	1	[276]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[276]	SETTABLE 	R1 K0 K1 ; R1["mFocused"] := true
	3	[277]	GETUPVAL 	R1 U0 ; R1 := U0
...
function #13 <?:281,284> (6 instructions, 24 bytes at 0000021191E961E0)
1 param, 3 slots, 1 upvalue, 0 locals, 3 constants, 0 functions
	1	[282]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[282]	SETTABLE 	R1 K0 K1 ; R1["mFocused"] := false
	3	[283]	GETUPVAL 	R1 U0 ; R1 := U0
...
function #14 <?:286,290> (16 instructions, 64 bytes at 00000211920B2750)
1 param, 4 slots, 1 upvalue, 0 locals, 5 constants, 0 functions
	1	[287]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[287]	GETTABLE 	R1 R1 K0 ; R1 := R1[0x89e663e9]
	3	[287]	CALL     	R1 1 2 ; R1 := R1()
...
function #15 <?:292,297> (20 instructions, 80 bytes at 00000211371D3980)
0 params, 9 slots, 2 upvalues, 0 locals, 12 constants, 0 functions
	1	[293]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[293]	GETTABLE 	R0 R0 K0 ; R0 := R0[0x659d451f]
	3	[293]	GETGLOBAL	R1 K1 ; R1 := 0x0032441c
...
function #16 <?:299,302> (15 instructions, 60 bytes at 00000211920A6990)
0 params, 9 slots, 2 upvalues, 0 locals, 10 constants, 0 functions
	1	[300]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[300]	GETTABLE 	R0 R0 K0 ; R0 := R0[0x8bcd12b6]
	3	[300]	GETUPVAL 	R1 U1 ; R1 := U1
...
function #17 <?:304,322> (24 instructions, 96 bytes at 000002111EDCFD50)
0 params, 5 slots, 1 upvalue, 0 locals, 8 constants, 1 function
	1	[305]	GETGLOBAL	R0 K0 ; R0 := 0x7b998233
	2	[305]	GETGLOBAL	R1 K1 ; R1 := 0x96540e3a
	3	[305]	CALL     	R0 2 2 ; R0 := R0(R1)
...
function #18 <?:324,330> (31 instructions, 124 bytes at 000002111FEE7EE0)
1 param, 10 slots, 2 upvalues, 0 locals, 11 constants, 0 functions
	1	[325]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[325]	GETTABLE 	R1 R1 K0 ; R1 := R1[0x659d451f]
	3	[325]	GETGLOBAL	R2 K1 ; R2 := 0x0032441c
...
function #19 <?:332,336> (26 instructions, 104 bytes at 0000021195231880)
1 param, 10 slots, 1 upvalue, 0 locals, 8 constants, 0 functions
	1	[333]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[333]	GETTABLE 	R1 R1 K0 ; R1 := R1[0x5d10207d]
	3	[333]	LOADK    	R2 := 9.000000
...
function #20 <?:338,347> (18 instructions, 72 bytes at 000002112BDC1EB0)
1 param, 4 slots, 3 upvalues, 0 locals, 9 constants, 0 functions
	1	[339]	GETUPVAL 	R1 U0 ; R1 := U0
	2	[339]	EQ       	0 R1 K0 ; if R1 ~= nil then PC := 5
	3	[339]	JMP      	5 ; PC := 5
...
function #21 <?:349,351> (3 instructions, 12 bytes at 00000211303E77F0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[350]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[350]	RETURN   	R0 2 ; return R0 
	3	[351]	RETURN   	R0 1 ; return 

function #22 <?:353,355> (3 instructions, 12 bytes at 00000211147B47C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[354]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[354]	CALL     	R0 1 1 ; R0()
	3	[355]	RETURN   	R0 1 ; return 
