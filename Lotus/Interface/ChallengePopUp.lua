...
main <?:0,0> (250 instructions, 1000 bytes at 0000021134724BC0)
...
function #1 <?:79,111> (120 instructions, 480 bytes at 0000021134725980)
...
function #2 <?:114,119> (17 instructions, 68 bytes at 0000021134726130)
...
function #3 <?:121,126> (13 instructions, 52 bytes at 000002112397F6B0)
...
function #4 <?:130,135> (22 instructions, 88 bytes at 000002112397F810)
...
function #5 <?:137,236> (309 instructions, 1236 bytes at 000002112397FAB0)
3 params, 29 slots, 14 upvalues, 0 locals, 58 constants, 0 functions
	...
	165	[185]	SETTABLE 	R27 K34 R22 ; R27[0x78298275] := R22
	...
	189	[202]	SETTABLE 	R23 K37 R5 ; R23["Name"] := R5
	...
	228	[210]	SETTABLE 	R28 K45 R23 ; R28["COUNT"] := R23
	...
	296	[224]	SETTABLE 	R28 K45 R23 ; R28["COUNT"] := R23
...
function #6 <?:238,240> (9 instructions, 36 bytes at 0000021123980D10)
...
function #7 <?:243,287> (179 instructions, 716 bytes at 0000021123980E20)
1 param, 13 slots, 8 upvalues, 0 locals, 33 constants, 0 functions
	...
	106	[276]	SETTABLE 	R6 K24 R7 ; R6[0x50a1358a] := R7
...
function #8 <?:289,322> (74 instructions, 296 bytes at 0000021123981980)
1 param, 6 slots, 11 upvalues, 0 locals, 12 constants, 0 functions
	...
	40	[300]	SETTABLE 	R2 K6 R3 ; R2[0x7b998233] := R3
...
function #9 <?:324,326> (4 instructions, 16 bytes at 0000021123981DB0)
...
function #10 <?:328,330> (5 instructions, 20 bytes at 0000021123981E80)
...
function #11 <?:332,334> (4 instructions, 16 bytes at 0000021123981F90)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #12 <?:336,337> (1 instruction, 4 bytes at 0000021123982060)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[337]	RETURN   	R0 1 ; return 

function #13 <?:339,347> (43 instructions, 172 bytes at 0000021123982130)
...
function #14 <?:349,351> (12 instructions, 48 bytes at 0000021123982430)
...
function #15 <?:353,355> (12 instructions, 48 bytes at 0000021123982540)
1 param, 6 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #16 <?:357,367> (45 instructions, 180 bytes at 0000021123982650)
...
function #17 <?:369,371> (3 instructions, 12 bytes at 00000211239829C0)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[370]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[370]	CALL     	R0 1 1 ; R0()
	3	[371]	RETURN   	R0 1 ; return 

function #18 <?:373,398> (30 instructions, 120 bytes at 0000021123982A90)
...
function #19 <?:400,402> (6 instructions, 24 bytes at 0000021123982F50)
...
function #20 <?:404,498> (159 instructions, 636 bytes at 0000021123983060)
...
function #21 <?:500,502> (3 instructions, 12 bytes at 0000021123983F30)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[501]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[501]	CALL     	R0 1 1 ; R0()
	3	[502]	RETURN   	R0 1 ; return 

function #22 <?:504,512> (12 instructions, 48 bytes at 0000021134A3EE60)
...
function #23 <?:514,518> (6 instructions, 24 bytes at 0000021134A3F080)
...
function #24 <?:520,560> (104 instructions, 416 bytes at 0000021134A3F170)
...
function #25 <?:562,604> (190 instructions, 760 bytes at 0000021134A3F6E0)
...
function #26 <?:606,629> (54 instructions, 216 bytes at 0000021134A404B0)
...
function #27 <?:631,632> (1 instruction, 4 bytes at 0000021134A407D0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[632]	RETURN   	R0 1 ; return 

function #28 <?:634,635> (1 instruction, 4 bytes at 0000021134A408A0)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[635]	RETURN   	R0 1 ; return 

function #29 <?:637,660> (146 instructions, 584 bytes at 0000021134A40970)
...
function #30 <?:662,691> (95 instructions, 380 bytes at 0000021134A41250)
...
function #31 <?:693,741> (110 instructions, 440 bytes at 0000021134A418D0)
...
function #32 <?:743,854> (301 instructions, 1204 bytes at 0000021134A41E70)
...
function #33 <?:856,858> (4 instructions, 16 bytes at 0000021134A42C60)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #34 <?:860,869> (1 instruction, 4 bytes at 0000021134A42D30)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[869]	RETURN   	R0 1 ; return 

function #35 <?:871,885> (15 instructions, 60 bytes at 0000021134A42E00)
