...
main <?:0,0> (88 instructions, 352 bytes at 0000021162FCEAD0)
...
function #1 <?:11,32> (119 instructions, 476 bytes at 0000021162FCF1B0)
0 params, 11 slots, 1 upvalue, 0 locals, 22 constants, 0 functions
	...
	66	[23]	SETTABLE 	R5 K3 R6 ; R5["Colors"] := R6
	...
	79	[23]	SETTABLE 	R5 K17 R6 ; R5["ColorCorrection"] := R6
	80	[23]	SETTABLE 	R5 K4 R2 ; R5["Background"] := R2
	81	[23]	SETTABLE 	R5 K5 R3 ; R5["Sounds"] := R3
	82	[23]	SETTABLE 	R4 K2 R5 ; R4["CurrStyle"] := R5
	83	[25]	JMP      	87 ; PC := 87
...
function #2 <?:34,40> (18 instructions, 72 bytes at 0000021162FCF4F0)
...
function #3 <?:42,54> (25 instructions, 100 bytes at 0000021162FCF6B0)
...
function #4 <?:56,84> (59 instructions, 236 bytes at 0000021162FCF810)
...
function #5 <?:86,91> (20 instructions, 80 bytes at 0000021162FCF8F0)
...
function #6 <?:93,99> (19 instructions, 76 bytes at 0000021162FCFAA0)
...
function #7 <?:101,107> (19 instructions, 76 bytes at 0000021162FCFC50)
0 params, 3 slots, 1 upvalue, 0 locals, 5 constants, 0 functions
...
function #8 <?:111,117> (23 instructions, 92 bytes at 0000021162FCFE00)
...
function #9 <?:119,125> (19 instructions, 76 bytes at 0000021162FD00B0)
0 params, 3 slots, 1 upvalue, 0 locals, 5 constants, 0 functions
...
function #10 <?:127,164> (87 instructions, 348 bytes at 0000021162FD0260)
...
function #11 <?:166,168> (6 instructions, 24 bytes at 0000021162FD0360)
...
function #12 <?:170,178> (12 instructions, 48 bytes at 0000021162FD0450)
...
function #13 <?:180,183> (8 instructions, 32 bytes at 0000021162FD0560)
...
function #14 <?:185,277> (225 instructions, 900 bytes at 0000021162FD0650)
2 params, 22 slots, 1 upvalue, 0 locals, 43 constants, 0 functions
	...
	31	[194]	SETTABLE 	R4 K6 R5 ; R4[0x8e7c3b5e] := R5
	...
	42	[199]	SETTABLE 	R4 K10 R5 ; R4[0x6c97a788] := R5
	...
	71	[211]	SETTABLE 	R3 K11 R4 ; R3["exposureConvergeSpeed"] := R4
	...
	118	[229]	SETTABLE 	R7 K24 R8 ; R7["BackgroundMovieDepthOverride"] := R8
...
function #15 <?:279,287> (17 instructions, 68 bytes at 0000021162FD0990)
...
function #16 <?:289,291> (4 instructions, 16 bytes at 0000021162FD0B60)
...
function #17 <?:293,369> (107 instructions, 428 bytes at 0000021162FD0C10)
3 params, 18 slots, 2 upvalues, 0 locals, 26 constants, 1 function
	...
	40	[326]	SETTABLE 	R4 K12 R5 ; R4[0x44537adf] := R5
...
function #18 <?:371,373> (6 instructions, 24 bytes at 0000021162FD0FB0)
3 params, 7 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #19 <?:375,435> (147 instructions, 588 bytes at 0000021162FD10A0)
...
function #20 <?:437,442> (5 instructions, 20 bytes at 0000021162FD1250)
...
function #21 <?:444,462> (57 instructions, 228 bytes at 0000021162FD1340)
...
function #22 <?:464,497> (151 instructions, 604 bytes at 0000021162FD1460)
...
function #23 <?:499,518> (40 instructions, 160 bytes at 0000021162FD1780)
...
function #24 <?:520,544> (71 instructions, 284 bytes at 0000021162FD1AD0)
...
function #25 <?:546,569> (84 instructions, 336 bytes at 0000021162FD1CA0)
