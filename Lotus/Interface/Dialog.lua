...
main <?:0,0> (321 instructions, 1284 bytes at 00000211357CD420)
...
function #1 <?:64,77> (35 instructions, 140 bytes at 00000211357CE3E0)
...
function #2 <?:79,118> (126 instructions, 504 bytes at 00000211357CE870)
...
function #3 <?:120,190> (218 instructions, 872 bytes at 00000211357CF150)
...
function #4 <?:192,253> (181 instructions, 724 bytes at 00000211357CF6F0)
...
function #5 <?:255,257> (1 instruction, 4 bytes at 0000021119275180)
1 param, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[257]	RETURN   	R0 1 ; return 

function #6 <?:259,264> (17 instructions, 68 bytes at 0000021119275250)
...
function #7 <?:266,269> (3 instructions, 12 bytes at 00000211192753F0)
...
function #8 <?:271,326> (211 instructions, 844 bytes at 00000211192754C0)
...
function #9 <?:328,335> (12 instructions, 48 bytes at 00000211192760C0)
...
function #10 <?:337,339> (4 instructions, 16 bytes at 0000021133D064C0)
...
function #11 <?:341,376> (147 instructions, 588 bytes at 0000021133D06570)
...
function #12 <?:378,382> (6 instructions, 24 bytes at 0000021133D06C60)
...
function #13 <?:384,412> (62 instructions, 248 bytes at 0000021133D06D50)
...
function #14 <?:414,433> (55 instructions, 220 bytes at 0000021133D070E0)
...
function #15 <?:435,437> (4 instructions, 16 bytes at 0000021133D075D0)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #16 <?:439,441> (7 instructions, 28 bytes at 0000021133D076A0)
...
function #17 <?:443,445> (2 instructions, 8 bytes at 0000021133D07790)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[444]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[445]	RETURN   	R0 1 ; return 

function #18 <?:447,449> (4 instructions, 16 bytes at 0000021133D07860)
1 param, 3 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
...
function #19 <?:451,453> (2 instructions, 8 bytes at 0000021133D07930)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[452]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[453]	RETURN   	R0 1 ; return 

function #20 <?:455,457> (2 instructions, 8 bytes at 0000021133D07A00)
1 param, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[456]	SETUPVAL 	R0 U0 ; U0 := R0
	2	[457]	RETURN   	R0 1 ; return 

function #21 <?:459,482> (54 instructions, 216 bytes at 0000021133D07AD0)
...
function #22 <?:484,500> (39 instructions, 156 bytes at 0000021133D07E80)
...
function #23 <?:502,506> (6 instructions, 24 bytes at 0000021133D08120)
...
function #24 <?:508,515> (26 instructions, 104 bytes at 0000021133D08240)
...
function #25 <?:517,519> (3 instructions, 12 bytes at 0000021133D08460)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[518]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[518]	CALL     	R0 1 1 ; R0()
	3	[519]	RETURN   	R0 1 ; return 

function #26 <?:521,540> (54 instructions, 216 bytes at 0000021133D08530)
...
function #27 <?:542,548> (15 instructions, 60 bytes at 0000021133D08870)
...
function #28 <?:550,556> (15 instructions, 60 bytes at 0000021133D089F0)
0 params, 2 slots, 3 upvalues, 0 locals, 4 constants, 0 functions
...
function #29 <?:558,564> (15 instructions, 60 bytes at 0000021133D08B70)
0 params, 2 slots, 3 upvalues, 0 locals, 4 constants, 0 functions
...
function #30 <?:566,573> (17 instructions, 68 bytes at 0000021133D08D40)
...
function #31 <?:575,580> (20 instructions, 80 bytes at 0000021133D08ED0)
...
function #32 <?:582,591> (24 instructions, 96 bytes at 0000021133D09070)
...
function #33 <?:593,606> (37 instructions, 148 bytes at 0000021133D09230)
...
function #34 <?:608,611> (5 instructions, 20 bytes at 0000021133D09480)
...
function #35 <?:613,620> (14 instructions, 56 bytes at 0000021133D09590)
...
function #36 <?:622,625> (5 instructions, 20 bytes at 0000021133D096E0)
0 params, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #37 <?:627,633> (17 instructions, 68 bytes at 0000021133D097F0)
...
function #38 <?:635,645> (21 instructions, 84 bytes at 0000021133D09970)
...
function #39 <?:647,731> (194 instructions, 776 bytes at 0000021133D09B90)
0 params, 11 slots, 20 upvalues, 0 locals, 49 constants, 1 function
	...
	62	[702]	SETTABLE 	R5 K28 R6 ; R5["Delay"] := R6
	...
	77	[704]	SETTABLE 	R5 K28 R6 ; R5["Delay"] := R6
	...
	91	[706]	SETTABLE 	R5 K28 R6 ; R5["Delay"] := R6
	...
	111	[708]	SETTABLE 	R5 K28 R6 ; R5["Delay"] := R6
...
function #40 <?:733,781> (111 instructions, 444 bytes at 0000021133D0A8B0)
...
function #41 <?:783,794> (46 instructions, 184 bytes at 000002111BE33920)
...
function #42 <?:796,806> (32 instructions, 128 bytes at 000002111BE33D00)
...
function #43 <?:808,820> (60 instructions, 240 bytes at 000002111BE33F80)
...
function #44 <?:822,849> (63 instructions, 252 bytes at 000002111BE343D0)
...
function #45 <?:851,862> (26 instructions, 104 bytes at 000002111BE34790)
...
function #46 <?:864,866> (7 instructions, 28 bytes at 000002111BE34970)
...
function #47 <?:868,870> (7 instructions, 28 bytes at 000002111BE34A60)
1 param, 4 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #48 <?:872,874> (6 instructions, 24 bytes at 000002111BE34B70)
...
function #49 <?:876,878> (6 instructions, 24 bytes at 000002111BE34C90)
1 param, 4 slots, 1 upvalue, 0 locals, 2 constants, 0 functions
...
function #50 <?:880,882> (4 instructions, 16 bytes at 000002111BE34DB0)
...
function #51 <?:884,886> (6 instructions, 24 bytes at 000002111BE34EB0)
...
function #52 <?:888,901> (22 instructions, 88 bytes at 000002111BE34FC0)
...
function #53 <?:903,905> (6 instructions, 24 bytes at 000002111BE35160)
1 param, 2 slots, 1 upvalue, 0 locals, 1 constant, 0 functions
...
function #58 <?:924,926> (3 instructions, 12 bytes at 000002111BE35610)
0 params, 2 slots, 1 upvalue, 0 locals, 0 constants, 0 functions
	1	[925]	GETUPVAL 	R0 U0 ; R0 := U0
	2	[925]	CALL     	R0 1 1 ; R0()
	3	[926]	RETURN   	R0 1 ; return 

function #59 <?:928,930> (3 instructions, 12 bytes at 000002111BE356E0)
0 params, 2 slots, 0 upvalues, 0 locals, 0 constants, 0 functions
	1	[929]	OP_LOADBOOL	R0 1 0 ; R0 := true
	2	[929]	RETURN   	R0 2 ; return R0 
	3	[930]	RETURN   	R0 1 ; return 

function #60 <?:932,938> (12 instructions, 48 bytes at 000002111BE357B0)
