...
main <?:0,0> (12 instructions, 48 bytes at 00000211236D3C20)
...
function #1 <?:5,360> (170 instructions, 680 bytes at 00000211236D3DE0)
4 params, 13 slots, 1 upvalue, 0 locals, 82 constants, 20 functions
	...
	53	[108]	SETTABLE 	R5 K40 R6 ; R5[0x03001062] := R6
