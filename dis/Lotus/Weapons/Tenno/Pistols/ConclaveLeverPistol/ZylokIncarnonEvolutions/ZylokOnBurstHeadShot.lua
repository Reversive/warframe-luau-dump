...
; Max Stack Size:  6
       ...
       0 [-]: GETIMPORT R4 2 ["MultiShotOnLastBurst"]
...
L 1:   8 [-]: GETIMPORT R5 2 ["MultiShotOnLastBurst"]
       9 [-]: GETTABLE R4 R5 R0
      10 [-]: FASTCALL1 62 R4 L2
      11 [-]: GETIMPORT R3 4 [0x7B998233]
      12 [-]: CALL R3 1 1  
L 2:  13 [-]: JUMPIFNOT R3 L3
      14 [-]: GETIMPORT R3 2 ["MultiShotOnLastBurst"]
      15 [-]: NEWTABLE R4 0 0
      16 [-]: SETTABLE R4 R3 R0
L 3:  17 [-]: GETIMPORT R4 2 ["MultiShotOnLastBurst"]
...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R5 2 ["MultiShotOnLastBurst"]
...
L 0:   4 [-]: JUMPIFNOT R4 L1
       5 [-]: LOADB R4 0   
       6 [-]: RETURN R4 1  
L 1:   7 [-]: GETIMPORT R6 2 ["MultiShotOnLastBurst"]
       8 [-]: GETTABLE R5 R6 R0
...
L 2:  12 [-]: JUMPIFNOT R4 L3
      13 [-]: LOADB R4 0   
      14 [-]: RETURN R4 1  
L 3:  15 [-]: GETIMPORT R7 2 ["MultiShotOnLastBurst"]
...
L 4:  21 [-]: JUMPIFNOT R4 L5
      22 [-]: LOADB R4 0   
      23 [-]: RETURN R4 1  
L 5:  24 [-]: GETIMPORT R6 2 ["MultiShotOnLastBurst"]
      ...
      30 [-]: CALL R5 3 1  
      31 [-]: JUMPIFNOT R5 L6
      32 [-]: GETIMPORT R6 2 ["MultiShotOnLastBurst"]
...
L 3:  18 [-]: NAMECALL R5 R4 K4 [0x14A55974]
      ...
      23 [-]: CALL R6 1 1  
L 4:  24 [-]: JUMPIF R6 L5 
      25 [-]: GETIMPORT R8 6 ["gLotusWeaponType"]
...
L 6:  31 [-]: NAMECALL R6 R4 K8 [0x52DE0ED7]
      ...
      36 [-]: CALL R7 1 1  
L 7:  37 [-]: JUMPIF R7 L8 
      38 [-]: GETIMPORT R9 10 ["gBaseAvatarType"]
...
L 9:  44 [-]: NAMECALL R7 R5 K11 [0x72D56F6B]
      45 [-]: CALL R7 1 1  
      46 [-]: GETIMPORT R10 13 ["gLotusSemiAutomaticStateBehaviorType"]
