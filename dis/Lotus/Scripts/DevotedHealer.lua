...
L 3:  36 [-]: JUMPIF R2 L4 
      ...
      43 [-]: CALL R2 2 0  
      44 [-]: GETIMPORT R2 21 [0x67652851]
      45 [-]: CALL R2 0 1  
      46 [-]: SUB R1 R1 R2 
      47 [-]: GETIMPORT R2 23 [0xCBD666E1]
      48 [-]: LOADN R3 0   
      49 [-]: CALL R2 1 0  
      50 [-]: JUMPBACK L2  
L 4:  51 [-]: LOADN R1 0   
L 5:  52 [-]: GETIMPORT R2 25 [0xE22417E8]
      53 [-]: JUMPIFNOTLT R1 R2 L6
      54 [-]: NAMECALL R2 R0 K26 [0x73901ACF]
      55 [-]: CALL R2 1 1  
      56 [-]: JUMPIF R2 L6 
      57 [-]: GETIMPORT R2 21 [0x67652851]
      58 [-]: CALL R2 0 1  
      59 [-]: ADD R1 R1 R2 
      60 [-]: GETIMPORT R2 23 [0xCBD666E1]
      61 [-]: LOADN R3 0   
      62 [-]: CALL R2 1 0  
      63 [-]: JUMPBACK L5  
...
L 7:  71 [-]: JUMPIF R3 L8 
      ...
      76 [-]: CALL R3 2 0  
L 8:  77 [-]: GETIMPORT R3 4 [0x89326C93]
      78 [-]: GETIMPORT R5 12 [0x27E88FDD]
      79 [-]: NAMECALL R6 R0 K7 [0xD1586535]
      80 [-]: CALL R6 1 1  
      81 [-]: GETIMPORT R7 9 ["ZERO_ROTATION"]
      82 [-]: MOVE R8 R0   
      83 [-]: MOVE R9 R0   
...
L 9:  87 [-]: LOADN R4 1   
      ...
      90 [-]: MOVE R5 R0   
      91 [-]: GETIMPORT R4 14 [0x7B998233]
      92 [-]: CALL R4 1 1  
L10:  93 [-]: JUMPIF R4 L11
      94 [-]: GETIMPORT R6 17 ["CLOAK"]
      95 [-]: MOVE R7 R3   
     ...
     100 [-]: CALL R4 2 0  
     101 [-]: GETIMPORT R5 21 [0x67652851]
     102 [-]: CALL R5 0 1  
     103 [-]: ADD R4 R3 R5 
     104 [-]: ADDK R3 R4 K29 [0.10000000000000001]
     105 [-]: GETIMPORT R4 23 [0xCBD666E1]
     106 [-]: LOADN R5 0   
     107 [-]: CALL R4 1 0  
     108 [-]: JUMPBACK L9  
L11: 109 [-]: GETIMPORT R4 23 [0xCBD666E1]
     110 [-]: LOADN R5 1   
     111 [-]: CALL R4 1 0  
...
L12:  57 [-]: JUMPIF R8 L14
      ...
      63 [-]: GETIMPORT R8 16 [0x67652851]
      64 [-]: CALL R8 0 1  
      65 [-]: ADD R7 R7 R8 
      66 [-]: LOADN R8 5   
      67 [-]: JUMPIFNOTLT R8 R7 L13
      68 [-]: RETURN R0 0  
L13:  69 [-]: GETIMPORT R8 18 [0xCBD666E1]
      70 [-]: LOADN R9 0   
      71 [-]: CALL R8 1 0  
      72 [-]: JUMPBACK L11 
L14:  73 [-]: LOADNIL R8   
...
L18: 119 [-]: LOADN R12 3  
     ...
     122 [-]: MOVE R13 R5  
     123 [-]: GETIMPORT R12 1 [0x7B998233]
     124 [-]: CALL R12 1 1 
L19: 125 [-]: JUMPIF R12 L20
     126 [-]: NAMECALL R12 R5 K9 [0x73901ACF]
     127 [-]: CALL R12 1 1 
     128 [-]: JUMPIFNOT R12 L20
     129 [-]: GETIMPORT R12 16 [0x67652851]
     130 [-]: CALL R12 0 1 
     131 [-]: ADD R11 R11 R12
     132 [-]: GETIMPORT R12 18 [0xCBD666E1]
     133 [-]: LOADN R13 0  
     134 [-]: CALL R12 1 0 
     135 [-]: JUMPBACK L18 
L20: 136 [-]: LOADNIL R14  
     ...
     142 [-]: CALL R12 6 0 
     143 [-]: GETIMPORT R12 18 [0xCBD666E1]
