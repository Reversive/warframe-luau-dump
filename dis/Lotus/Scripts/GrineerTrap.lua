...
L 0:  11 [-]: JUMPIF R2 L4 ; goto L4 if var2
      ...
      14 [-]: JUMPIFNOTLT R3 R2 L4; goto L4 if var3 >= var524878
...
L 5:  28 [-]: NAMECALL R3 R0 K8; var4 = var0; var3 = var0[0xD1586535]
      ...
      39 [-]: MULK R5 R4 K14; var5 = var4 * 0.20000000000000001
      ...
      71 [-]: DIVK R10 R11 K28; var10 = var11 / 5
...
L10: 100 [-]: JUMPIF R11 L35; goto L35 if var11
     ...
     105 [-]: JUMPIFLT R12 R11 L35; goto L35 if var12 < var771820613
...
L11: 112 [-]: LOADN R12 3  ; var12 = 3
     113 [-]: JUMPIFNOTLE R12 R10 L12; goto L12 if var12 > var1073876037
...
L12: 117 [-]: NAMECALL R12 R1 K41; var13 = var1; var12 = var1[0xD2715720]
     ...
     120 [-]: JUMPIFLE R12 R13 L35; goto L35 if var12 <= var2821454
...
L16: 152 [-]: GETTABLE R22 R17 R20; var22 = var17[var20]
     ...
     154 [-]: JUMPIFNOTEQ R2 R21 L17; goto L17 if var2 ~= var-436136635
     ...
     158 [-]: JUMPIFNOTEQ R21 R22 L17; goto L17 if var21 ~= var68635
...
L21: 165 [-]: LOADN R13 1  ; var13 = 1
     ...
     167 [-]: DIVK R15 R11 K52; var15 = var11 / 10
...
L23: 198 [-]: JUMPIF R16 L24; goto L24 if var16
     199 [-]: JUMPIFNOTEQ R15 R1 L32; goto L32 if var15 ~= var2560590
L24: 200 [-]: GETIMPORT R18 39; var18 = 0x67652851
     ...
     206 [-]: JUMPIFNOTLE R16 R9 L26; goto L26 if var16 > var2953294
...
L12:  67 [-]: GETTABLE R15 R10 R13; var15 = var10[var13]
      ...
      69 [-]: JUMPIFNOTEQ R3 R14 L13; goto L13 if var3 ~= var66843
...
L 0:  24 [-]: GETIMPORT R3 18; var3 = 0x4F4E42E0
      25 [-]: JUMPIFNOTLT R2 R3 L10; goto L10 if var2 >= var385876805
...
L 5:  46 [-]: GETTABLE R16 R11 R14; var16 = var11[var14]
      ...
      48 [-]: JUMPIFNOTEQ R3 R15 L6; goto L6 if var3 ~= var67099
...
L 1:  12 [-]: LOADN R4 0   ; var4 = 0
      13 [-]: JUMPIFEQ R2 R4 L2; goto L2 if var2 == var65581
L 2:  14 [-]: RETURN R0 0  ; 
...
L 3:  33 [-]: JUMPIF R6 L24; goto L24 if var6
      ...
      38 [-]: JUMPIFNOTLE R1 R6 L13; goto L13 if var1 > var328014
...
L18: 114 [-]: GETIMPORT R6 5; var6 = 0xEF4D5C81
     115 [-]: JUMPIFNOTEQ R1 R6 L22; goto L22 if var1 ~= var50544203
...
L22: 145 [-]: SUBK R6 R1 K26; var6 = var1 - 0.10000000000000001
...
L23: 149 [-]: GETIMPORT R6 30; var6 = 0xCBD666E1
     150 [-]: LOADK R7 K26 ; var7 = 0.10000000000000001
