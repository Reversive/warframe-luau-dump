...
L 2:  26 [-]: JUMPIF R3 L33
      ...
      38 [-]: LOADN R6 4   
L 3:  39 [-]: GETIMPORT R10 17 [0x14459A1C]
      40 [-]: JUMPIFNOT R10 L13
      41 [-]: GETIMPORT R10 1 [0x89326C93]
      42 [-]: GETIMPORT R12 19 ["gBaseAvatarType"]
      43 [-]: NAMECALL R10 R10 K20 [0xFB669000]
      44 [-]: CALL R10 2 1 
      45 [-]: GETIMPORT R11 22 [0xC8802016]
      46 [-]: MOVE R12 R10 
      47 [-]: CALL R11 1 3 
...
L 6:  59 [-]: JUMPIF R16 L12
      ...
      73 [-]: MOVE R19 R9  
      74 [-]: MOVE R20 R17 
      75 [-]: GETIMPORT R18 29 [0x23D5322F]
      76 [-]: CALL R18 2 0 
L 7:  77 [-]: GETIMPORT R18 31 [0x9C1F3B5A]
      78 [-]: MOVE R19 R8  
      79 [-]: MOVE R20 R16 
      80 [-]: CALL R18 2 0 
      81 [-]: LENGTH R18 R8
      ...
      83 [-]: MOVE R8 R9   
      84 [-]: NEWTABLE R9 0 0
L 8:  85 [-]: GETIMPORT R18 34 [0xB009BBC6]
      86 [-]: GETTABLEKS R19 R17 K35 ["mSpectreType"]
      87 [-]: CALL R18 1 1 
      88 [-]: FASTCALL1 62 R18 L9
      89 [-]: MOVE R20 R18 
      90 [-]: GETIMPORT R19 9 [0x7B998233]
      91 [-]: CALL R19 1 1 
L 9:  92 [-]: JUMPIFNOT R19 L10
      93 [-]: GETIMPORT R19 34 [0xB009BBC6]
...
L11: 101 [-]: NAMECALL R16 R15 K38 [0x2047CFE7]
     ...
     106 [-]: CALL R18 1 -1
     107 [-]: FASTCALL 52 L12
     108 [-]: GETIMPORT R16 29 [0x23D5322F]
     109 [-]: CALL R16 -1 0
L12: 110 [-]: FORGLOOP R11 L4 2 [inext]
L13: 111 [-]: GETIMPORT R10 40 [0xCBD666E1]
     112 [-]: LOADK R11 K41 [0.5]
     113 [-]: CALL R10 1 0 
     114 [-]: LOADK R11 K41 [0.5]
     115 [-]: GETIMPORT R12 43 [0x67652851]
     116 [-]: CALL R12 0 1 
     117 [-]: ADD R10 R11 R12
     118 [-]: ADD R3 R3 R10
     119 [-]: LENGTH R10 R4
...
L14: 129 [-]: LOADNIL R14  
     ...
     131 [-]: GETIMPORT R15 26 [0x55730E1A]
     132 [-]: LOADN R16 1  
     133 [-]: LENGTH R17 R8
     134 [-]: CALL R15 2 1 
     ...
     137 [-]: MOVE R17 R9  
     138 [-]: MOVE R18 R14 
     139 [-]: GETIMPORT R16 29 [0x23D5322F]
     140 [-]: CALL R16 2 0 
L15: 141 [-]: GETIMPORT R16 31 [0x9C1F3B5A]
     142 [-]: MOVE R17 R8  
     143 [-]: MOVE R18 R15 
     144 [-]: CALL R16 2 0 
     145 [-]: LENGTH R16 R8
...
L16: 149 [-]: MOVE R15 R7  
     ...
     152 [-]: GETIMPORT R17 34 [0xB009BBC6]
     153 [-]: GETTABLEKS R18 R14 K35 ["mSpectreType"]
     154 [-]: CALL R17 1 1 
     155 [-]: MOVE R16 R17 
     156 [-]: FASTCALL1 62 R16 L17
     157 [-]: MOVE R18 R16 
     158 [-]: GETIMPORT R17 9 [0x7B998233]
     159 [-]: CALL R17 1 1 
L17: 160 [-]: JUMPIFNOT R17 L18
     161 [-]: GETIMPORT R17 34 [0xB009BBC6]
...
L18: 165 [-]: NAMECALL R17 R16 K44 [0x0A5DBC2F]
     166 [-]: CALL R17 1 1 
     167 [-]: ADD R15 R15 R17
L19: 168 [-]: GETIMPORT R19 7 [0x22F00EFF]
     169 [-]: LOADNIL R20  
     170 [-]: MOVE R21 R5  
     171 [-]: MOVE R22 R15 
     ...
     175 [-]: MOVE R19 R17 
     176 [-]: GETIMPORT R18 9 [0x7B998233]
     177 [-]: CALL R18 1 1 
L20: 178 [-]: JUMPIF R18 L23
     179 [-]: FASTCALL2 52 R4 R17 L21
     180 [-]: MOVE R19 R4  
     181 [-]: MOVE R20 R17 
     182 [-]: GETIMPORT R18 29 [0x23D5322F]
     183 [-]: CALL R18 2 0 
L21: 184 [-]: JUMPXEQKNIL R14 L24
     ...
     188 [-]: MOVE R20 R16 
     189 [-]: GETIMPORT R19 9 [0x7B998233]
     190 [-]: CALL R19 1 1 
...
L23: 197 [-]: GETIMPORT R18 48 [0x3D106989]
...
L26: 205 [-]: GETTABLE R14 R4 R12
     ...
     207 [-]: GETIMPORT R13 9 [0x7B998233]
     208 [-]: CALL R13 1 1 
L27: 209 [-]: JUMPIF R13 L29
     ...
     212 [-]: CALL R14 1 -1
     213 [-]: FASTCALL 62 L28
     214 [-]: GETIMPORT R13 9 [0x7B998233]
     215 [-]: CALL R13 -1 1
...
L29: 223 [-]: GETIMPORT R13 31 [0x9C1F3B5A]
     224 [-]: MOVE R14 R4  
     225 [-]: MOVE R15 R12 
     226 [-]: CALL R13 2 0 
     227 [-]: LOADN R3 0   
...
L30: 229 [-]: GETTABLE R13 R4 R12
     ...
     235 [-]: GETIMPORT R13 48 [0x3D106989]
