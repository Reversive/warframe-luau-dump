...
L 0:  37 [-]: NAMECALL R7 R6 K26; var8 = var6; var7 = var6[0x5C390F04]
      ...
      40 [-]: JUMPIFNOTEQ R7 R8 L1; goto L1 if var7 ~= var1902369
...
L 5:  55 [-]: GETIMPORT R4 11; var4 = 0x89326C93
      ...
      58 [-]: JUMPIFNOT R4 L24; goto L24 if not var4
...
L10: 114 [-]: LOADN R12 32 ; var12 = 32
     115 [-]: JUMPIFNOTEQ R11 R12 L11; goto L11 if var11 ~= var3804193
...
L13: 140 [-]: LOADN R12 2  ; var12 = 2
     141 [-]: JUMPIFNOTEQ R11 R12 L21; goto L21 if var11 ~= var4132129
...
L14: 146 [-]: JUMPIF R12 L21; goto L21 if var12
...
L15: 151 [-]: JUMPIF R12 L21; goto L21 if var12
     152 [-]: GETIMPORT R12 45; var12 = 0xBE190284
     153 [-]: GETIMPORT R14 67; var14 = gLotusBaseGameRulesType
     154 [-]: NAMECALL R12 R12 K68; var13 = var12; var12 = var12[0xF2DEAF69]
     155 [-]: CALL R12 3 2 ; var12 = var12(var13, var14)
     156 [-]: JUMPIFNOT R12 L19; goto L19 if not var12
     157 [-]: GETIMPORT R15 45; var15 = 0xBE190284
     158 [-]: NAMECALL R15 R15 K69; var16 = var15; var15 = var15[0xEF893AEC]
     159 [-]: CALL R15 2 2 ; var15 = var15(var16)
     160 [-]: GETTABLEKS R14 R15 K70; var14 = var15["levelOverride"]
     161 [-]: FASTCALL1 64 R14 L16; 
     162 [-]: GETIMPORT R13 9; var13 = 0x7B998233
     163 [-]: CALL R13 2 2 ; var13 = var13(var14)
L16: 164 [-]: NOT R12 R13  ; var12 = not var13
     165 [-]: JUMPIFNOT R12 L19; goto L19 if not var12
     166 [-]: GETIMPORT R13 73; var13 = 0x7F5022CF[0xA5C556B9]
     167 [-]: GETIMPORT R16 45; var16 = 0xBE190284
     168 [-]: NAMECALL R16 R16 K69; var17 = var16; var16 = var16[0xEF893AEC]
     169 [-]: CALL R16 2 2 ; var16 = var16(var17)
     170 [-]: GETTABLEKS R15 R16 K70; var15 = var16["levelOverride"]
     171 [-]: NAMECALL R15 R15 K26; var16 = var15; var15 = var15[0xED4E0128]
     172 [-]: CALL R15 2 0 ; var15, ... = var15(var16)
     173 [-]: FASTCALL 63 L17; 
     174 [-]: GETIMPORT R14 75; var14 = 0x64FB1586
     175 [-]: CALL R14 0 2 ; var14 = var14(var15, ...)
L17: 176 [-]: LOADK R15 K76; var15 = "EntratiLab/"
     177 [-]: CALL R13 3 2 ; var13 = var13(var14, var15)
     178 [-]: JUMPXEQKNIL R13 L18 NOT; 
     179 [-]: LOADB R12 0 +1; var12 = false
L18: 180 [-]: LOADB R12 1  ; var12 = true
L19: 181 [-]: GETIMPORT R13 78; var13 = _T["SurvivalMissionState"]
     182 [-]: JUMPXEQKN R13 K79 L20 NOT; 
     183 [-]: JUMPIF R12 L20; goto L20 if var12
     184 [-]: GETIMPORT R13 65; var13 = 0x646A04A3
     185 [-]: MOVE R15 R0  ; var15 = var0
     186 [-]: MOVE R16 R6  ; var16 = var6
     187 [-]: MOVE R17 R9  ; var17 = var9
     188 [-]: GETIMPORT R18 55; var18 = 0xC49ED209
     189 [-]: NAMECALL R13 R13 K56; var14 = var13; var13 = var13[0xE4C98581]
     190 [-]: CALL R13 6 1 ; var13(var14, var15, var16, var17, var18)
     191 [-]: JUMP L23     ; goto L23
L20: 192 [-]: GETIMPORT R13 63; var13 = 0xF7EB75C5
     193 [-]: MOVE R15 R0  ; var15 = var0
     194 [-]: MOVE R16 R6  ; var16 = var6
     195 [-]: MOVE R17 R9  ; var17 = var9
     196 [-]: GETIMPORT R18 55; var18 = 0xC49ED209
     197 [-]: NAMECALL R13 R13 K56; var14 = var13; var13 = var13[0xE4C98581]
     198 [-]: CALL R13 6 1 ; var13(var14, var15, var16, var17, var18)
     199 [-]: JUMP L23     ; goto L23
L21: 200 [-]: GETIMPORT R13 63; var13 = 0xF7EB75C5
     201 [-]: FASTCALL1 64 R13 L22; 
     202 [-]: GETIMPORT R12 9; var12 = 0x7B998233
     203 [-]: CALL R12 2 2 ; var12 = var12(var13)
L22: 204 [-]: JUMPIF R12 L23; goto L23 if var12
     205 [-]: GETIMPORT R12 63; var12 = 0xF7EB75C5
     206 [-]: MOVE R14 R0  ; var14 = var0
     207 [-]: MOVE R15 R6  ; var15 = var6
     208 [-]: MOVE R16 R9  ; var16 = var9
     209 [-]: GETIMPORT R17 55; var17 = 0xC49ED209
     210 [-]: NAMECALL R12 R12 K56; var13 = var12; var12 = var12[0xE4C98581]
     211 [-]: CALL R12 6 1 ; var12(var13, var14, var15, var16, var17)
L23: 212 [-]: GETIMPORT R12 80; var12 = _T
     213 [-]: LOADB R13 1  ; var13 = true
     214 [-]: SETTABLEKS R13 R12 K81; var13["idleTimoutReset"] = var12
     215 [-]: GETIMPORT R12 83; var12 = _T["StorageLockerOpenCallback"]
     216 [-]: JUMPIFNOT R12 L24; goto L24 if not var12
     217 [-]: GETIMPORT R12 83; var12 = _T["StorageLockerOpenCallback"]
...
L11:  54 [-]: GETIMPORT R6 12; var6 = 0x89326C93
      ...
      71 [-]: JUMPIFNOTLT R7 R6 L12; goto L12 if var7 >= var2364
...
L13:  86 [-]: GETIMPORT R6 25; var6 = 0xCBD666E1
      87 [-]: LOADK R7 K26 ; var7 = 0.33000001311302185
      88 [-]: CALL R6 2 1  ; var6(var7)
      89 [-]: FASTCALL1 64 R5 L14; 
