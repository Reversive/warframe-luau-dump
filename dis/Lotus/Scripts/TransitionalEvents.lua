...
; Max Stack Size:  10
      ...
      13 [-]: JUMPIFNOTLT R5 R4 L0; goto L0 if var5 >= var197157
...
; Max Stack Size:  11
      ...
      15 [-]: JUMPIFNOTEQ R3 R4 L2; goto L2 if var3 ~= var787790
...
L 0:  20 [-]: JUMPIF R4 L11; goto L11 if var4
      ...
      26 [-]: JUMPIFEQ R5 R6 L1; goto L1 if var5 == var329038
...
L 3:  48 [-]: GETTABLE R8 R4 R7; var8 = var4[var7]
      49 [-]: JUMPIFNOTEQ R8 R0 L4; goto L4 if var8 ~= var1902670
...
L 2:  11 [-]: NAMECALL R1 R0 K6; var2 = var0; var1 = var0[0xEF893AEC]
      ...
      18 [-]: JUMPIFEQ R2 R3 L3; goto L3 if var2 == var590670
      19 [-]: GETIMPORT R3 9; var3 = 0x0469F296
      20 [-]: LOADK R4 K11 ; var4 = "Orokin"
      21 [-]: CALL R3 2 2  ; var3 = var3(var4)
      22 [-]: JUMPIFNOTEQ R2 R3 L4; goto L4 if var2 ~= var918350
...
L13:  89 [-]: GETIMPORT R5 33; var5 = 0xC163F229
      ...
      94 [-]: JUMPIFNOTLE R5 R6 L21; goto L21 if var5 > var919118
...
; Max Stack Size:  15
      ...
      11 [-]: JUMPIFNOTLT R6 R5 L0; goto L0 if var6 >= var262949
...
L 1:  19 [-]: GETIMPORT R4 13; var4 = _T["faction"]
      ...
      21 [-]: JUMPIFNOTEQ R4 R5 L2; goto L2 if var4 ~= var1114190
...
L 2:  25 [-]: GETIMPORT R4 13; var4 = _T["faction"]
      ...
      27 [-]: JUMPIFNOTEQ R4 R5 L3; goto L3 if var4 ~= var1507406
...
L 5:  33 [-]: LOADN R5 1   ; var5 = 1
      34 [-]: JUMPIFNOTLT R5 R4 L6; goto L6 if var5 >= var1287
...
L 7:  44 [-]: JUMPIFNOTLT R6 R5 L13; goto L13 if var6 >= var1799
...
L 8:  56 [-]: GETTABLE R11 R0 R9; var11 = var0[var9]
      57 [-]: DIVK R10 R11 K29; var10 = var11 / 100
      58 [-]: JUMPIFNOTLE R4 R10 L11; goto L11 if var4 > var1967628
      59 [-]: JUMPIFNOTLT R6 R9 L11; goto L11 if var6 >= var2034254
      ...
      65 [-]: JUMPIFNOTLE R10 R11 L10; goto L10 if var10 > var151063607
...
L 0:  10 [-]: GETIMPORT R7 5; var7 = 0xEA25BC87
      ...
      12 [-]: JUMPIFNOTEQ R6 R1 L1; goto L1 if var6 ~= var460366
...
L 2:  17 [-]: GETUPVAL R3 0; var3 = upvalues[0]
      ...
      20 [-]: DIVK R4 R5 K8; var4 = var5 / 100
      21 [-]: JUMPIFNOTLT R4 R3 L3; goto L3 if var4 >= var787278
