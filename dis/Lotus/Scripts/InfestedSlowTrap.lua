...
L 3:  31 [-]: GETIMPORT R7 11 [0x89326C93]
      ...
      62 [-]: CALL R8 1 1  
      63 [-]: MOVE R7 R8   
L 4:  64 [-]: GETIMPORT R8 11 [0x89326C93]
      65 [-]: NAMECALL R8 R8 K31 [0x18D05D30]
      66 [-]: CALL R8 1 1  
      67 [-]: JUMPIF R8 L5 
      68 [-]: RETURN R0 0  
L 5:  69 [-]: GETIMPORT R8 11 [0x89326C93]
      70 [-]: GETIMPORT R10 17 [0x9191FC01]
      71 [-]: MOVE R11 R3  
      72 [-]: MOVE R12 R4  
      73 [-]: MOVE R13 R7  
...
L 8:  95 [-]: NAMECALL R9 R8 K38 [0x65D389CB]
      96 [-]: CALL R9 1 1  
      97 [-]: GETIMPORT R10 40 [0xCDD0C718]
      98 [-]: LOADN R13 1  
      99 [-]: NAMECALL R11 R8 K41 [0x66472BF5]
     100 [-]: CALL R11 2 0 
     101 [-]: GETIMPORT R13 43 ["gTriggerType"]
     102 [-]: NAMECALL R11 R8 K44 [0xC1595BD5]
     103 [-]: CALL R11 2 1 
     104 [-]: GETIMPORT R12 46 [0xC8802016]
     105 [-]: MOVE R13 R11 
     106 [-]: CALL R12 1 3 
...
L12: 118 [-]: JUMPIF R12 L13
     119 [-]: GETIMPORT R12 49 [0x67652851]
     120 [-]: CALL R12 0 1 
     121 [-]: SUB R10 R10 R12
     122 [-]: GETIMPORT R14 51 [0x9BAFFFE3]
     123 [-]: GETIMPORT R15 53 [0xA6D4EAFE]
     124 [-]: MOVE R16 R9  
     125 [-]: GETIMPORT R18 40 [0xCDD0C718]
     126 [-]: DIV R17 R10 R18
     127 [-]: CALL R14 3 -1
     128 [-]: NAMECALL R12 R8 K54 [0x2D9BA74F]
     129 [-]: CALL R12 -1 0
     130 [-]: GETIMPORT R15 40 [0xCDD0C718]
     131 [-]: DIV R14 R10 R15
     ...
     135 [-]: LOADN R16 5  
     136 [-]: LOADN R18 1  
     137 [-]: GETIMPORT R20 40 [0xCDD0C718]
     138 [-]: DIV R19 R10 R20
     139 [-]: SUB R17 R18 R19
     140 [-]: MUL R15 R16 R17
     141 [-]: NAMECALL R12 R8 K55 [0x986D2AB8]
     142 [-]: CALL R12 3 0 
     143 [-]: GETIMPORT R12 57 [0xCBD666E1]
     144 [-]: LOADN R13 0  
     145 [-]: CALL R12 1 0 
     146 [-]: JUMPBACK L11 
L13: 147 [-]: FASTCALL1 62 R8 L14
     148 [-]: MOVE R13 R8  
     149 [-]: GETIMPORT R12 1 [0x7B998233]
     150 [-]: CALL R12 1 1 
