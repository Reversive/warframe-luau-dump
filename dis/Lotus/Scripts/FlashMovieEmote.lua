...
; Max Stack Size:  11
       ...
       0 [-]: GETIMPORT R2 1 [0xED0C54F9]
       1 [-]: GETIMPORT R3 3 [0x0B94D23B]
       2 [-]: GETIMPORT R5 5 [0xCBB5ED2E]
       3 [-]: GETIMPORT R6 7 [0x6980AACD]
       4 [-]: GETIMPORT R7 9 [0x4E02A25C]
       5 [-]: GETIMPORT R8 11 [0x7ED49E49]
       6 [-]: NAMECALL R3 R0 K12 [0x47901F07]
       7 [-]: CALL R3 5 1  
       8 [-]: SETUPVAL R3 0
       9 [-]: GETIMPORT R3 14 [0x89326C93]
      10 [-]: NAMECALL R3 R3 K15 [0x18D05D30]
      11 [-]: CALL R3 1 1  
      12 [-]: JUMPIFNOT R3 L1
      13 [-]: GETIMPORT R4 17 [0x7E227ECE]
      14 [-]: FASTCALL1 62 R4 L0
      15 [-]: GETIMPORT R3 19 [0x7B998233]
      16 [-]: CALL R3 1 1  
L 0:  17 [-]: JUMPIF R3 L1 
      18 [-]: GETIMPORT R5 17 [0x7E227ECE]
      19 [-]: GETIMPORT R6 21 ["EMPTY_SYMBOL"]
      20 [-]: GETIMPORT R7 23 ["ZERO_VECTOR"]
      21 [-]: GETIMPORT R8 25 ["ZERO_ROTATION"]
      22 [-]: MOVE R9 R0   
      23 [-]: LOADN R10 1  
...
L 1:  26 [-]: NAMECALL R3 R0 K26 [0xA5E492D4]
      27 [-]: CALL R3 1 1  
      28 [-]: JUMPIFNOT R3 L2
      29 [-]: GETIMPORT R3 28 [0x9BA7909F]
      30 [-]: GETIMPORT R5 1 [0xED0C54F9]
...
L 3:  21 [-]: JUMPIF R2 L4 
      ...
      26 [-]: CALL R2 3 0  
L 4:  27 [-]: GETIMPORT R2 10 [0x0B94D23B]
      28 [-]: NAMECALL R2 R2 K11 [0x56C01834]
      29 [-]: CALL R2 1 1  
      30 [-]: JUMPIFNOT R2 L6
      31 [-]: GETIMPORT R2 13 [0xCBD666E1]
...
L 2:  12 [-]: JUMPIF R2 L3 
      13 [-]: GETUPVAL R2 1
      14 [-]: MOVE R4 R0   
      15 [-]: GETIMPORT R5 4 [0x6980AACD]
      16 [-]: NAMECALL R2 R2 K5 [0xB6B094B2]
      17 [-]: CALL R2 3 0  
      18 [-]: GETUPVAL R2 1
      19 [-]: GETIMPORT R4 7 [0x4E02A25C]
      20 [-]: GETIMPORT R5 9 [0x7ED49E49]
      ...
      26 [-]: CALL R2 2 0  
L 3:  27 [-]: GETIMPORT R2 13 [0x89326C93]
      28 [-]: NAMECALL R2 R2 K14 [0x18D05D30]
      29 [-]: CALL R2 1 1  
      30 [-]: JUMPIFNOT R2 L6
      31 [-]: GETIMPORT R3 16 [0x7E227ECE]
      32 [-]: FASTCALL1 62 R3 L4
      33 [-]: GETIMPORT R2 1 [0x7B998233]
      34 [-]: CALL R2 1 1  
L 4:  35 [-]: JUMPIF R2 L6 
      36 [-]: GETIMPORT R4 16 [0x7E227ECE]
      ...
      42 [-]: CALL R3 1 1  
L 5:  43 [-]: JUMPIF R3 L6 
      44 [-]: GETIMPORT R3 13 [0x89326C93]
      45 [-]: MOVE R5 R2   
      46 [-]: NAMECALL R3 R3 K18 [0x59C96E77]
      47 [-]: CALL R3 2 0  
      48 [-]: GETIMPORT R3 20 [0x9611FFA4]
      49 [-]: JUMPIFNOT R3 L6
