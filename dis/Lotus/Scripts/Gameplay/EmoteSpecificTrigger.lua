...
L 3:  22 [-]: JUMPIF R2 L5 
      ...
      34 [-]: CALL R2 1 1  
      35 [-]: GETIMPORT R3 9 [0xA69A81E4]
      36 [-]: NAMECALL R3 R3 K5 [0xE223E2B1]
      37 [-]: CALL R3 1 1  
      38 [-]: JUMPIFNOTEQ R2 R3 L5
L 4:  39 [-]: GETIMPORT R2 11 [0xCBD666E1]
      40 [-]: GETIMPORT R3 13 [0x4FCC4FE9]
      41 [-]: CALL R2 1 0  
      42 [-]: GETIMPORT R2 15 [0xC156EB4F]
      43 [-]: GETIMPORT R4 17 [0x80538143]
      44 [-]: NAMECALL R2 R2 K18 [0x8EB2112D]
      45 [-]: CALL R2 2 0  
      46 [-]: RETURN R0 0  
      47 [-]: JUMP L5
     
L 5:  48 [-]: GETIMPORT R2 11 [0xCBD666E1]
      49 [-]: GETIMPORT R3 20 [0x478CD27B]
      50 [-]: CALL R2 1 0  
      51 [-]: JUMPBACK L0  
L 6:  52 [-]: RETURN R0 0  
...
L 2:  16 [-]: JUMPIF R2 L5 
      ...
      22 [-]: CALL R3 1 1  
L 3:  23 [-]: JUMPIF R3 L5 
      24 [-]: GETIMPORT R3 6 [0xCBD666E1]
      25 [-]: GETIMPORT R4 8 [0x4FCC4FE9]
      26 [-]: CALL R3 1 0  
      27 [-]: GETUPVAL R3 0
      28 [-]: MOVE R4 R2   
      29 [-]: CALL R3 1 1  
      30 [-]: JUMPIFNOT R3 L5
      31 [-]: GETIMPORT R4 10 [0xC90A9797]
      32 [-]: FASTCALL1 62 R4 L4
      33 [-]: GETIMPORT R3 1 [0x7B998233]
      34 [-]: CALL R3 1 1  
L 4:  35 [-]: JUMPIF R3 L5 
      36 [-]: GETIMPORT R3 12 [0x20DB7AC8]
      37 [-]: GETIMPORT R5 14 [0x0469F296]
      38 [-]: LOADK R6 K15 ["Cower"]
      39 [-]: CALL R5 1 -1 
      40 [-]: NAMECALL R3 R3 K16 [0x3B4E1EE4]
      41 [-]: CALL R3 -1 1 
      42 [-]: JUMPIF R3 L5 
      43 [-]: GETIMPORT R3 12 [0x20DB7AC8]
      44 [-]: GETIMPORT R5 14 [0x0469F296]
      45 [-]: LOADK R6 K17 ["CowerStart"]
      46 [-]: CALL R5 1 -1 
      47 [-]: NAMECALL R3 R3 K16 [0x3B4E1EE4]
      48 [-]: CALL R3 -1 1 
      49 [-]: JUMPIF R3 L5 
      50 [-]: GETIMPORT R3 12 [0x20DB7AC8]
      51 [-]: GETIMPORT R5 10 [0xC90A9797]
      52 [-]: NAMECALL R3 R3 K16 [0x3B4E1EE4]
      53 [-]: CALL R3 2 1  
      54 [-]: JUMPIF R3 L5 
      55 [-]: GETIMPORT R3 12 [0x20DB7AC8]
      56 [-]: GETIMPORT R5 10 [0xC90A9797]
      57 [-]: NAMECALL R3 R3 K18 [0xCAB39EF8]
      58 [-]: CALL R3 2 0  
      59 [-]: JUMP L5
     
L 5:  60 [-]: GETIMPORT R2 6 [0xCBD666E1]
      61 [-]: GETIMPORT R3 20 [0x478CD27B]
      62 [-]: CALL R2 1 0  
      63 [-]: JUMPBACK L0  
L 6:  64 [-]: RETURN R0 0  
...
L 3:  19 [-]: JUMPIF R2 L5 
      ...
      23 [-]: CALL R2 1 1  
      24 [-]: GETIMPORT R3 6 [0x6B37ABED]
      25 [-]: NAMECALL R3 R3 K4 [0xE223E2B1]
      26 [-]: CALL R3 1 1  
      27 [-]: JUMPIFNOTEQ R2 R3 L4
      28 [-]: GETIMPORT R2 8 [0x478CD27B]
      29 [-]: ADD R1 R1 R2 
      30 [-]: GETIMPORT R2 10 [0xA6BD8963]
      31 [-]: JUMPIFNOTLE R2 R1 L6
      32 [-]: GETIMPORT R2 12 [0xCBD666E1]
      33 [-]: GETIMPORT R3 14 [0x4FCC4FE9]
      34 [-]: CALL R2 1 0  
      35 [-]: GETIMPORT R2 16 [0xC156EB4F]
      36 [-]: GETIMPORT R4 18 [0x80538143]
...
L 5:  43 [-]: LOADN R1 0   
L 6:  44 [-]: GETIMPORT R2 12 [0xCBD666E1]
      45 [-]: GETIMPORT R3 8 [0x478CD27B]
      46 [-]: CALL R2 1 0  
      47 [-]: JUMPBACK L0  
L 7:  48 [-]: RETURN R0 0  
