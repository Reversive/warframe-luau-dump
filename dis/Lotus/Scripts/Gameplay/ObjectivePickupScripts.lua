...
; Max Stack Size:  15
       ...
       0 [-]: GETIMPORT R1 1 [0x55FA50AD]
       1 [-]: JUMPIFNOT R1 L0
       2 [-]: GETIMPORT R1 3 ["_T"]
       3 [-]: SETTABLEKS R0 R1 K4 ["TrackedGameplayPickup"]
L 0:   4 [-]: GETIMPORT R3 6 [0x7ED0A956]
...
L 1:  15 [-]: LOADNIL R1   
      16 [-]: LOADNIL R2   
      17 [-]: GETIMPORT R3 12 [0xC1DD7D1E]
      18 [-]: JUMPIFNOT R3 L14
      19 [-]: GETIMPORT R3 14 [0x89326C93]
      20 [-]: GETIMPORT R5 16 [0x0469F296]
      21 [-]: LOADK R6 K17 ["ExtractionTrigger"]
      22 [-]: CALL R5 1 -1 
      23 [-]: NAMECALL R3 R3 K18 [0xC7FCADA9]
      24 [-]: CALL R3 -1 1 
      25 [-]: GETIMPORT R4 20 [0xC8802016]
      26 [-]: MOVE R5 R3   
      27 [-]: CALL R4 1 3  
...
L 2:  29 [-]: NAMECALL R9 R8 K21 [0xE79E7EF4]
      ...
      32 [-]: MOVE R11 R9  
      33 [-]: GETIMPORT R10 23 [0x7B998233]
      34 [-]: CALL R10 1 1 
L 3:  35 [-]: JUMPIF R10 L5
      36 [-]: NAMECALL R10 R9 K24 [0x22DA1852]
      37 [-]: CALL R10 1 1 
      38 [-]: GETIMPORT R11 16 [0x0469F296]
...
L 7:  51 [-]: JUMPIF R4 L14
      52 [-]: GETIMPORT R4 14 [0x89326C93]
      53 [-]: GETIMPORT R6 28 ["gNpcSpawnPointType"]
...
L13:  87 [-]: JUMPIF R5 L14
      ...
      93 [-]: CALL R5 1 1  
      94 [-]: MOVE R2 R5   
L14:  95 [-]: GETIMPORT R3 14 [0x89326C93]
      96 [-]: NAMECALL R3 R3 K34 [0x18D05D30]
      97 [-]: CALL R3 1 1  
      98 [-]: JUMPIFNOT R3 L25
      99 [-]: GETIMPORT R3 14 [0x89326C93]
...
L15: 106 [-]: FASTCALL1 62 R0 L16
     107 [-]: MOVE R7 R0   
     108 [-]: GETIMPORT R6 23 [0x7B998233]
     109 [-]: CALL R6 1 1  
...
L17: 117 [-]: ADDK R5 R5 K26 [1]
     118 [-]: LOADN R4 0   
L18: 119 [-]: GETIMPORT R6 12 [0xC1DD7D1E]
...
L19: 125 [-]: FASTCALL1 62 R2 L20
     126 [-]: MOVE R7 R2   
     127 [-]: GETIMPORT R6 23 [0x7B998233]
     128 [-]: CALL R6 1 1  
L20: 129 [-]: JUMPIF R6 L21
     ...
     135 [-]: GETIMPORT R9 40 [0xA421AF95]
     136 [-]: LOADN R10 0  
     137 [-]: LOADK R11 K41 [0.5]
     138 [-]: LOADN R12 0  
     139 [-]: CALL R9 3 1  
     140 [-]: ADD R8 R2 R9 
     141 [-]: GETIMPORT R9 43 [0x00046924]
     142 [-]: CALL R9 0 -1 
...
L22: 150 [-]: NAMECALL R6 R0 K29 [0xD1586535]
     ...
     154 [-]: CALL R7 2 1  
     155 [-]: GETIMPORT R8 47 [0x03EA2485]
     156 [-]: MOVE R9 R6   
     157 [-]: MOVE R10 R7  
     158 [-]: CALL R8 2 1  
     159 [-]: LOADK R9 K48 [0.69999999999999996]
     160 [-]: JUMPIFNOTLE R9 R8 L23
     161 [-]: GETIMPORT R11 40 [0xA421AF95]
     162 [-]: LOADN R12 0  
     163 [-]: LOADK R13 K41 [0.5]
     164 [-]: LOADN R14 0  
     165 [-]: CALL R11 3 1 
     166 [-]: ADD R10 R7 R11
     167 [-]: GETIMPORT R11 43 [0x00046924]
     168 [-]: CALL R11 0 -1
     169 [-]: NAMECALL R8 R0 K44 [0x589EF1C1]
     170 [-]: CALL R8 -1 0 
L23: 171 [-]: LOADN R4 0   
     172 [-]: LOADN R5 0   
L24: 173 [-]: GETIMPORT R6 50 [0xCBD666E1]
     174 [-]: LOADN R7 1   
     175 [-]: CALL R6 1 0  
     176 [-]: JUMPBACK L15 
L25: 177 [-]: RETURN R0 0  
