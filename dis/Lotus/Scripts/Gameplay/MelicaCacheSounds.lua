...
L 0:   6 [-]: GETIMPORT R8 1; var8 = 0xFC27255A
       ...
       8 [-]: JUMPIFNOTEQ R7 R2 L1; goto L1 if var7 ~= var394006
...
L 5:  22 [-]: GETIMPORT R7 12; var7 = 0x3C73CAD7
      ...
      33 [-]: JUMPIFNOTLE R6 R8 L6; goto L6 if var6 > var788558
...
L 3:  15 [-]: LENGTH R2 R1 ; var2 = #var1
      ...
      17 [-]: JUMPIFNOTLT R3 R2 L11; goto L11 if var3 >= var787278
...
L 6:  36 [-]: JUMPIF R4 L10; goto L10 if var4
      ...
      40 [-]: JUMPIFNOTLE R4 R2 L10; goto L10 if var4 > var1031
...
; Max Stack Size:  7
       ...
       2 [-]: LOADN R2 0   ; var2 = 0
       3 [-]: JUMPIFNOTLT R2 R1 L0; goto L0 if var2 >= var66126
