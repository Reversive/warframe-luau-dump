...
; Max Stack Size:  14
       ...
       0 [-]: GETIMPORT R4 2 ["MelicaCacheSounds"]
...
L 1:  11 [-]: JUMPIF R5 L7 
      ...
      13 [-]: CALL R5 1 1  
      14 [-]: LOADB R6 1   
      15 [-]: GETIMPORT R9 2 ["MelicaCacheSounds"]
...
L 2:  20 [-]: JUMPIF R7 L4 
      21 [-]: JUMPIFNOT R2 L3
      22 [-]: GETIMPORT R8 2 ["MelicaCacheSounds"]
...
L 4:  29 [-]: JUMPIFNOT R6 L7
      ...
      31 [-]: LOADB R3 0   
L 5:  32 [-]: GETIMPORT R7 2 ["MelicaCacheSounds"]
      33 [-]: MOVE R10 R1  
      34 [-]: MOVE R11 R3  
      35 [-]: LOADN R12 1  
      36 [-]: LOADB R13 0  
      ...
      40 [-]: JUMPIF R3 L6 
      41 [-]: GETIMPORT R8 2 ["MelicaCacheSounds"]
...
; Max Stack Size:  13
       ...
       0 [-]: LOADNIL R3   
       1 [-]: LOADN R6 1   
       2 [-]: GETIMPORT R7 1 [0xFC27255A]
       3 [-]: LENGTH R4 R7 
       4 [-]: LOADN R5 1   
       5 [-]: FORNPREP R4 L2
L 0:   6 [-]: GETIMPORT R8 1 [0xFC27255A]
       7 [-]: GETTABLE R7 R8 R6
...
L 2:  12 [-]: LOADNIL R4   
      ...
      15 [-]: GETIMPORT R4 4 [0x22BD3E03]
      16 [-]: JUMP L5
     
L 3:  17 [-]: JUMPXEQKN R3 K5 L4 NOT [2]
      18 [-]: GETIMPORT R4 7 [0x5A56C3B9]
      19 [-]: JUMP L5
     
L 4:  20 [-]: JUMPXEQKN R3 K8 L5 NOT [3]
      21 [-]: GETIMPORT R4 10 [0xE6C95A57]
L 5:  22 [-]: GETIMPORT R7 12 [0x3C73CAD7]
      23 [-]: LENGTH R6 R7 
      24 [-]: LENGTH R7 R4 
      25 [-]: ADD R5 R6 R7 
      26 [-]: GETIMPORT R6 14 [0x55730E1A]
      27 [-]: LOADN R7 1   
      28 [-]: MOVE R8 R5   
      29 [-]: CALL R6 2 1  
      30 [-]: LOADNIL R7   
      31 [-]: GETIMPORT R9 12 [0x3C73CAD7]
      32 [-]: LENGTH R8 R9 
      33 [-]: JUMPIFNOTLE R6 R8 L6
      34 [-]: GETIMPORT R8 12 [0x3C73CAD7]
      35 [-]: GETTABLE R7 R8 R6
      36 [-]: JUMP L7
     
L 6:  37 [-]: GETIMPORT R10 12 [0x3C73CAD7]
      38 [-]: LENGTH R9 R10
      39 [-]: SUB R8 R6 R9 
...
L 7:  41 [-]: GETUPVAL R8 0
      ...
      45 [-]: LOADB R12 1  
      46 [-]: CALL R8 4 0  
      47 [-]: GETIMPORT R9 16 [0x89A899B5]
      48 [-]: FASTCALL1 62 R9 L8
      49 [-]: GETIMPORT R8 18 [0x7B998233]
      50 [-]: CALL R8 1 1  
L 8:  51 [-]: JUMPIF R8 L9 
      52 [-]: GETIMPORT R8 16 [0x89A899B5]
...
L 1:   4 [-]: JUMPIFNOT R1 L2
       ...
       7 [-]: CALL R1 1 0  
       8 [-]: JUMPBACK L0  
L 2:   9 [-]: GETIMPORT R1 7 [0x3CBDA0FE]
      10 [-]: GETIMPORT R2 1 [0xBE190284]
      11 [-]: NAMECALL R2 R2 K8 [0xFFE25891]
      12 [-]: CALL R2 1 1  
      13 [-]: JUMPIFNOT R2 L3
      14 [-]: GETIMPORT R1 10 [0x37B5B57B]
L 3:  15 [-]: LENGTH R2 R1 
      16 [-]: LOADN R3 0   
      17 [-]: JUMPIFNOTLT R3 R2 L11
      18 [-]: GETIMPORT R3 12 [0x299C413D]
      19 [-]: GETIMPORT R4 12 [0x299C413D]
      20 [-]: MUL R2 R3 R4 
...
L 5:  25 [-]: JUMPIF R3 L11
      ...
      27 [-]: CALL R3 1 1  
      28 [-]: JUMPIFNOT R3 L11
      29 [-]: GETIMPORT R3 15 [0x89326C93]
      30 [-]: NAMECALL R3 R3 K16 [0x78298275]
      31 [-]: CALL R3 1 1  
      32 [-]: FASTCALL1 62 R3 L6
      33 [-]: MOVE R5 R3   
      34 [-]: GETIMPORT R4 3 [0x7B998233]
      35 [-]: CALL R4 1 1  
...
L 8:  54 [-]: JUMPIF R5 L9 
      ...
      57 [-]: CALL R5 1 0  
      58 [-]: JUMPBACK L7  
L 9:  59 [-]: GETIMPORT R5 19 [0x55730E1A]
      60 [-]: GETIMPORT R6 21 [0xEEC466FF]
      61 [-]: GETIMPORT R7 23 [0xFCAF6251]
      62 [-]: CALL R5 2 1  
      63 [-]: GETIMPORT R6 5 [0xCBD666E1]
      64 [-]: MOVE R7 R5   
      65 [-]: CALL R6 1 0  
L10:  66 [-]: GETIMPORT R4 5 [0xCBD666E1]
      67 [-]: LOADN R5 0   
      68 [-]: CALL R4 1 0  
      69 [-]: JUMPBACK L4  
L11:  70 [-]: RETURN R0 0  
...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R2 1 [0xE3208F7A]
       1 [-]: LENGTH R1 R2 
       2 [-]: LOADN R2 0   
       3 [-]: JUMPIFNOTLT R2 R1 L0
       4 [-]: GETIMPORT R2 1 [0xE3208F7A]
       5 [-]: GETIMPORT R3 3 [0x55730E1A]
       6 [-]: LOADN R4 1   
       7 [-]: GETIMPORT R6 1 [0xE3208F7A]
       8 [-]: LENGTH R5 R6 
       9 [-]: CALL R3 2 1  
...
L 1:   7 [-]: NAMECALL R2 R1 K2 [0xDE321E6F]
      ...
      12 [-]: CALL R3 1 1  
L 2:  13 [-]: JUMPIF R3 L3 
      14 [-]: GETIMPORT R5 4 ["gLotusInventoryControllerType"]
