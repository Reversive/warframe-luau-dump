...
L 1:  10 [-]: GETIMPORT R6 2; var6 = _T["VesoMoas"]
      ...
      13 [-]: JUMPIFNOTEQ R0 R4 L3; goto L3 if var0 ~= var-754973627
...
L 4:  26 [-]: JUMPIF R6 L5 ; goto L5 if var6
      ...
      30 [-]: JUMPIFNOTEQ R6 R0 L5; goto L5 if var6 ~= var328214
...
L14: 137 [-]: GETIMPORT R5 41; var5 = 0x733199A5
     138 [-]: JUMPIFNOTLT R3 R5 L17; goto L17 if var3 >= var1799
...
L15: 147 [-]: MUL R12 R13 R14; var12 = var13 * var14
     ...
     151 [-]: CALL R8 3 0  ; var8, ... = var8(var9, var10)
