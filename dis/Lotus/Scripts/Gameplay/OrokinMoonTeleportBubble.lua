...
; Max Stack Size:  14
  ...
  1 [-]: SELF      R1 R0 K0     ; R2 := R0; R1 := R0[0xfae9f648]
  2 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  3 [-]: LOADNIL   R2 R3        ; R2 := R3 := nil
  4 [-]: EQ        0 R1 K2      ; if R1 ~= 0.000000 then PC := 27
  5 [-]: JMP       27           ; PC := 27
 ...
 20 [-]: JMP       24           ; PC := 24
 21 [-]: GETGLOBAL R2 K7        ; R2 := 0x7b7e011e
 22 [-]: GETGLOBAL R3 K8        ; R3 := 0xfd428b3a
 23 [-]: JMP       38           ; PC := 38
 24 [-]: GETGLOBAL R2 K9        ; R2 := 0xb50e8148
 25 [-]: GETGLOBAL R3 K10       ; R3 := 0x0f127fac
 26 [-]: JMP       38           ; PC := 38
 27 [-]: GETGLOBAL R2 K11       ; R2 := 0x8d4e8258
 28 [-]: GETGLOBAL R3 K12       ; R3 := 0x92d256bc
 ...
 35 [-]: SELF      R5 R5 K13    ; R6 := R5; R5 := R5[0xb35f65b4]
 36 [-]: LOADK     R7 0         ; R7 := 0.000000
 37 [-]: CALL      R5 3 1       ; R5(R6,R7)
 38 [-]: GETGLOBAL R5 K14       ; R5 := 0xc8802016
 39 [-]: MOVE      R6 R2        ; R6 := R2
 40 [-]: CALL      R5 2 4       ; R5,R6,R7 := R5(R6)
 41 [-]: JMP       48           ; PC := 48
 42 [-]: GETGLOBAL R10 K15      ; R10 := 0x64fb1586
 43 [-]: GETTABLE  R11 R3 R8    ; R11 := R3[R8]
 44 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 45 [-]: SELF      R11 R9 K16   ; R12 := R9; R11 := R9[0x8eb2112d]
