...
; Max Stack Size:  15
      ...
      38 [-]: GETIMPORT R13 20 [0x33BDD652]
...
L 1:  12 [-]: JUMPIFNOT R1 L2
      ...
      15 [-]: CALL R1 1 0  
      16 [-]: JUMPBACK L0  
L 2:  17 [-]: GETIMPORT R1 7 [0xBE190284]
L 3:  18 [-]: NAMECALL R2 R1 K12 [0xC1F9F0D9]
      ...
      23 [-]: CALL R2 1 0  
      24 [-]: JUMPBACK L3  
L 4:  25 [-]: GETIMPORT R2 14 [0x7799D4DA]
      26 [-]: JUMPXEQKB R2 1 L5 NOT
      27 [-]: GETIMPORT R2 1 [0x3D106989]
      28 [-]: LOADK R3 K15 ["Bailing early because we set this to be hidden"]
      29 [-]: CALL R2 1 0  
      30 [-]: RETURN R0 0  
L 5:  31 [-]: GETIMPORT R2 18 ["gQuestMission"]
      32 [-]: JUMPIFNOT R2 L6
      33 [-]: RETURN R0 0  
L 6:  34 [-]: LOADNIL R2   
      35 [-]: GETUPVAL R5 0
      ...
      38 [-]: CALL R3 3 1  
      39 [-]: GETIMPORT R4 21 [0x14459A1C]
      40 [-]: JUMPIF R4 L7 
      41 [-]: GETUPVAL R6 0
      42 [-]: LOADN R7 0   
      43 [-]: NAMECALL R4 R1 K22 [0x751F061D]
      44 [-]: CALL R4 3 0  
L 7:  45 [-]: GETIMPORT R4 1 [0x3D106989]
      46 [-]: LOADK R6 K23 ["Angel State is "]
      47 [-]: MOVE R7 R3   
      48 [-]: CONCAT R5 R6 R7
      49 [-]: CALL R4 1 0  
      50 [-]: GETIMPORT R4 21 [0x14459A1C]
      51 [-]: JUMPIFNOT R4 L8
...
L 9:  61 [-]: JUMPIFNOT R4 L12
      ...
      74 [-]: MOVE R5 R2   
      75 [-]: GETIMPORT R4 9 [0x7B998233]
      76 [-]: CALL R4 1 1  
L10:  77 [-]: JUMPIFNOT R4 L11
      78 [-]: GETIMPORT R4 21 [0x14459A1C]
      79 [-]: JUMPIFNOT R4 L11
...
L13: 110 [-]: JUMPIF R6 L15
     ...
     118 [-]: CALL R7 1 1  
     119 [-]: GETIMPORT R8 1 [0x3D106989]
     120 [-]: LOADK R9 K40 ["HOST MIGRATION - We have to re-create the context action"]
     121 [-]: CALL R8 1 0  
     122 [-]: GETIMPORT R8 4 [0x89326C93]
     123 [-]: GETIMPORT R10 42 [0xFF87A5D4]
     124 [-]: NAMECALL R14 R5 K43 [0x4C4D93D4]
     125 [-]: CALL R14 1 1 
     126 [-]: GETIMPORT R15 45 [0xA37109D9]
     127 [-]: MUL R13 R14 R15
     128 [-]: ADD R12 R6 R13
     129 [-]: NAMECALL R14 R5 K46 [0x9BA17154]
     130 [-]: CALL R14 1 1 
     131 [-]: GETIMPORT R15 48 [0xC98BC7A1]
     132 [-]: MUL R13 R14 R15
     133 [-]: ADD R11 R12 R13
     134 [-]: MOVE R12 R7  
     135 [-]: MOVE R13 R0  
...
L18: 175 [-]: GETIMPORT R8 1 [0x3D106989]
     ...
     180 [-]: CALL R8 1 0  
     181 [-]: LOADN R10 1  
     182 [-]: GETIMPORT R8 59 [0x79456FCA]
     183 [-]: LOADN R9 1   
     184 [-]: FORNPREP R8 L23
L19: 185 [-]: GETIMPORT R11 61 [0x0C5E62F9]
     186 [-]: LOADN R12 1  
     187 [-]: LENGTH R13 R6
     188 [-]: CALL R11 2 1 
     189 [-]: GETIMPORT R12 64 ["contains"]
     190 [-]: MOVE R13 R7  
     ...
     196 [-]: MOVE R13 R7  
     197 [-]: GETIMPORT R12 66 [0x23D5322F]
     198 [-]: CALL R12 2 0 
L20: 199 [-]: JUMP L22
...
L24: 217 [-]: JUMPIFNOT R8 L26
     ...
     223 [-]: LOADN R9 1   
     224 [-]: FORNPREP R8 L26
L25: 225 [-]: GETIMPORT R11 4 [0x89326C93]
     226 [-]: GETIMPORT R13 71 [0xB30CB55C]
     ...
     239 [-]: CALL R12 2 0 
     240 [-]: GETIMPORT R12 4 [0x89326C93]
     241 [-]: GETIMPORT R14 42 [0xFF87A5D4]
     ...
     247 [-]: CALL R19 1 1 
     248 [-]: GETIMPORT R20 45 [0xA37109D9]
     249 [-]: MUL R18 R19 R20
     250 [-]: ADD R16 R17 R18
     251 [-]: GETTABLE R18 R7 R10
     252 [-]: NAMECALL R18 R18 K46 [0x9BA17154]
     253 [-]: CALL R18 1 1 
     254 [-]: GETIMPORT R19 48 [0xC98BC7A1]
     255 [-]: MUL R17 R18 R19
     256 [-]: ADD R15 R16 R17
     ...
     263 [-]: CALL R12 6 0 
     264 [-]: FORNLOOP R8 L25
L26: 265 [-]: GETIMPORT R8 74 ["TrackActiveChallenge"]
     266 [-]: JUMPIFNOT R8 L32
L27: 267 [-]: GETIMPORT R9 76 ["ZarChallengeState"]
     268 [-]: FASTCALL1 62 R9 L28
     269 [-]: GETIMPORT R8 9 [0x7B998233]
     270 [-]: CALL R8 1 1  
L28: 271 [-]: JUMPIFNOT R8 L29
     272 [-]: GETIMPORT R8 11 [0xCBD666E1]
     273 [-]: LOADN R9 0   
     274 [-]: CALL R8 1 0  
     275 [-]: JUMPBACK L27 
L29: 276 [-]: GETIMPORT R9 79 ["challenge"]
     277 [-]: FASTCALL1 62 R9 L30
     278 [-]: GETIMPORT R8 9 [0x7B998233]
     279 [-]: CALL R8 1 1  
L30: 280 [-]: JUMPIF R8 L32
     281 [-]: GETIMPORT R8 79 ["challenge"]
     282 [-]: GETUPVAL R10 3
     ...
     288 [-]: LOADN R9 1   
     289 [-]: FORNPREP R8 L32
L31: 290 [-]: GETIMPORT R11 4 [0x89326C93]
     291 [-]: GETIMPORT R13 82 [0x366724E1]
     ...
     297 [-]: CALL R17 1 1 
     298 [-]: GETIMPORT R18 84 [0x0AAFB701]
     299 [-]: MUL R16 R17 R18
     300 [-]: ADD R14 R15 R16
...
; Max Stack Size:  15
      ...
      13 [-]: CALL R2 1 1  
      14 [-]: GETIMPORT R3 12 [0x85FE8D36]
      15 [-]: GETIMPORT R4 14 [0x061D0166]
      ...
      26 [-]: CALL R4 2 0  
L 0:  27 [-]: GETIMPORT R2 1 [0x3D106989]
...
L 2:  41 [-]: JUMPIFNOT R3 L5
      42 [-]: GETIMPORT R3 26 [0xCBD666E1]
      43 [-]: LOADN R4 0   
      44 [-]: CALL R3 1 0  
      45 [-]: GETIMPORT R3 6 [0x89326C93]
      46 [-]: GETUPVAL R5 1
...
L 3:  57 [-]: JUMPIF R3 L4 
      ...
      60 [-]: CALL R3 2 0  
L 4:  61 [-]: JUMPBACK L1  
L 5:  62 [-]: GETIMPORT R3 1 [0x3D106989]
      63 [-]: LOADK R4 K28 ["Found Angel Avatar from CrewshipMgr"]
      64 [-]: CALL R3 1 0  
      65 [-]: GETIMPORT R3 6 [0x89326C93]
      66 [-]: GETUPVAL R5 2
...
L 6:  78 [-]: JUMPIF R4 L7 
     ...
     106 [-]: CALL R4 -1 0 
L 7: 107 [-]: GETIMPORT R4 26 [0xCBD666E1]
     108 [-]: LOADN R5 1   
     109 [-]: CALL R4 1 0  
L 8: 110 [-]: FASTCALL1 62 R2 L9
     111 [-]: MOVE R5 R2   
     112 [-]: GETIMPORT R4 24 [0x7B998233]
     113 [-]: CALL R4 1 1  
L 9: 114 [-]: JUMPIFNOT R4 L10
     115 [-]: GETIMPORT R4 6 [0x89326C93]
     116 [-]: GETUPVAL R6 1
     ...
     121 [-]: CALL R4 4 1  
     122 [-]: MOVE R2 R4   
     123 [-]: GETIMPORT R4 26 [0xCBD666E1]
     124 [-]: LOADN R5 0   
     125 [-]: CALL R4 1 0  
     126 [-]: JUMPBACK L8  
L10: 127 [-]: LOADB R6 1   
     ...
     129 [-]: CALL R4 2 0  
     130 [-]: GETIMPORT R4 1 [0x3D106989]
     131 [-]: LOADK R5 K40 ["Enabling Angel Avatar"]
     132 [-]: CALL R4 1 0  
     133 [-]: FASTCALL1 62 R3 L11
     134 [-]: MOVE R5 R3   
     135 [-]: GETIMPORT R4 24 [0x7B998233]
     136 [-]: CALL R4 1 1  
L11: 137 [-]: JUMPIF R4 L12
     138 [-]: GETIMPORT R4 6 [0x89326C93]
     139 [-]: MOVE R6 R3   
     140 [-]: NAMECALL R4 R4 K41 [0x59C96E77]
     141 [-]: CALL R4 2 0  
L12: 142 [-]: GETIMPORT R4 26 [0xCBD666E1]
     143 [-]: LOADN R5 1   
     144 [-]: CALL R4 1 0  
L13: 145 [-]: FASTCALL1 62 R2 L14
     146 [-]: MOVE R5 R2   
     147 [-]: GETIMPORT R4 24 [0x7B998233]
     148 [-]: CALL R4 1 1  
L14: 149 [-]: JUMPIFNOT R4 L15
     150 [-]: GETIMPORT R4 6 [0x89326C93]
     151 [-]: GETUPVAL R6 1
     ...
     156 [-]: CALL R4 4 1  
     157 [-]: MOVE R2 R4   
     158 [-]: GETIMPORT R4 26 [0xCBD666E1]
     159 [-]: LOADN R5 0   
     160 [-]: CALL R4 1 0  
     161 [-]: JUMPBACK L13 
L15: 162 [-]: GETIMPORT R6 43 [0xCC79FF20]
     163 [-]: GETIMPORT R9 45 [0xC39E118F]
     164 [-]: LOADB R10 0  
     165 [-]: LOADN R11 3  
     166 [-]: LOADN R12 1  
     167 [-]: LOADB R13 1  
...
L16: 172 [-]: FASTCALL1 62 R2 L17
     173 [-]: MOVE R5 R2   
     174 [-]: GETIMPORT R4 24 [0x7B998233]
     175 [-]: CALL R4 1 1  
L17: 176 [-]: JUMPIFNOT R4 L18
     177 [-]: GETIMPORT R4 6 [0x89326C93]
     178 [-]: GETUPVAL R6 1
     ...
     183 [-]: CALL R4 4 1  
     184 [-]: MOVE R2 R4   
     185 [-]: GETIMPORT R4 26 [0xCBD666E1]
     186 [-]: LOADN R5 0   
     187 [-]: CALL R4 1 0  
     188 [-]: JUMPBACK L16 
L18: 189 [-]: LOADB R6 0   
     ...
     191 [-]: CALL R4 2 0  
     192 [-]: GETIMPORT R4 6 [0x89326C93]
     193 [-]: NAMECALL R4 R4 K7 [0x18D05D30]
     194 [-]: CALL R4 1 1  
     195 [-]: JUMPIFNOT R4 L19
     196 [-]: GETIMPORT R6 48 [0x1B7F7AD9]
     197 [-]: GETIMPORT R7 50 ["EMPTY_SYMBOL"]
     198 [-]: GETIMPORT R8 52 [0xDA8A779F]
     199 [-]: GETIMPORT R9 54 ["ZERO_ROTATION"]
...
L19: 202 [-]: LOADB R6 1   
     ...
     211 [-]: MOVE R6 R4   
     212 [-]: GETIMPORT R5 24 [0x7B998233]
     213 [-]: CALL R5 1 1  
...
L21: 219 [-]: NAMECALL R5 R2 K58 [0x1AC1655C]
     ...
     239 [-]: CALL R6 3 0  
     240 [-]: GETIMPORT R6 66 ["_T"]
     241 [-]: GETIMPORT R7 68 [0xFDA3B52D]
     242 [-]: SETTABLEKS R7 R6 K69 ["VoidAngelDamagePhases"]
     243 [-]: GETIMPORT R6 6 [0x89326C93]
     244 [-]: GETUPVAL R8 8
     245 [-]: NAMECALL R6 R6 K70 [0xC7FCADA9]
     246 [-]: CALL R6 2 1  
     247 [-]: FASTCALL1 62 R6 L22
     248 [-]: MOVE R8 R6   
     249 [-]: GETIMPORT R7 24 [0x7B998233]
     250 [-]: CALL R7 1 1  
L22: 251 [-]: JUMPIF R7 L25
     252 [-]: GETIMPORT R7 72 [0xCFC01047]
     253 [-]: MOVE R8 R6   
     254 [-]: CALL R7 1 3  
     255 [-]: FORGPREP_NEXT R7 L24
L23: 256 [-]: GETIMPORT R12 6 [0x89326C93]
     257 [-]: MOVE R14 R11 
...
L 1:   6 [-]: GETIMPORT R1 3 [0x89326C93]
      ...
      11 [-]: CALL R2 1 1  
      12 [-]: JUMPIFNOT R2 L4
      13 [-]: GETIMPORT R2 7 [0xCFC01047]
      14 [-]: MOVE R3 R1   
      15 [-]: CALL R2 1 3  
      16 [-]: FORGPREP_NEXT R2 L3
L 2:  17 [-]: GETIMPORT R9 9 [0x20583EE2]
      18 [-]: LOADB R10 0  
      19 [-]: NAMECALL R7 R6 K10 [0x511D26B8]
      20 [-]: CALL R7 3 0  
L 3:  21 [-]: FORGLOOP R2 L2 2
L 4:  22 [-]: GETIMPORT R4 12 [0x33674365]
      23 [-]: LOADB R5 0   
...
L 1:   8 [-]: GETIMPORT R1 6 [0xBE190284]
      ...
      16 [-]: CALL R2 1 0  
      17 [-]: RETURN R0 0  
L 2:  18 [-]: GETIMPORT R2 14 ["PlayerTriedToSpawnAngel"]
      19 [-]: JUMPIF R2 L3 
...
L 3:  24 [-]: GETIMPORT R2 1 [0x89326C93]
      ...
      26 [-]: CALL R2 1 1  
      27 [-]: GETIMPORT R3 17 [0xCFC01047]
      28 [-]: MOVE R4 R2   
      29 [-]: CALL R3 1 3  
      30 [-]: FORGPREP_NEXT R3 L5
L 4:  31 [-]: GETIMPORT R10 19 [0xF1AB00A6]
      32 [-]: LOADB R11 0  
...
L 5:  35 [-]: FORGLOOP R3 L4 2
      ...
      38 [-]: CALL R3 0 0  
      39 [-]: GETIMPORT R3 10 [0x3D106989]
      40 [-]: LOADK R4 K22 ["Starting Timer for Void Angel auto activate"]
      41 [-]: CALL R3 1 0  
      42 [-]: LOADN R3 0   
L 6:  43 [-]: GETIMPORT R4 24 [0x8C9FCE3C]
      44 [-]: JUMPIFNOTLT R3 R4 L7
      45 [-]: GETIMPORT R4 10 [0x3D106989]
      46 [-]: LOADK R6 K25 ["Timer Counting Down: "]
      47 [-]: MOVE R7 R3   
      48 [-]: CONCAT R5 R6 R7
      49 [-]: CALL R4 1 0  
      50 [-]: GETIMPORT R4 27 [0x67652851]
      51 [-]: CALL R4 0 1  
      52 [-]: ADD R3 R3 R4 
      53 [-]: GETIMPORT R4 4 [0xCBD666E1]
      54 [-]: LOADN R5 0   
      55 [-]: CALL R4 1 0  
      56 [-]: JUMPBACK L6  
L 7:  57 [-]: GETIMPORT R4 10 [0x3D106989]
...
L 0:   6 [-]: JUMPIF R2 L1 
      ...
      10 [-]: JUMPIF R2 L2 
L 1:  11 [-]: RETURN R0 0  
L 2:  12 [-]: GETIMPORT R2 5 [0x89326C93]
      13 [-]: GETIMPORT R4 7 [0x1B7F7AD9]
      ...
      24 [-]: CALL R3 1 0  
      25 [-]: GETIMPORT R3 5 [0x89326C93]
      26 [-]: NAMECALL R3 R3 K14 [0x18D05D30]
      27 [-]: CALL R3 1 1  
      28 [-]: JUMPIFNOT R3 L3
      29 [-]: GETIMPORT R3 16 [0xBE190284]
      30 [-]: GETUPVAL R5 1
      31 [-]: LOADN R6 2   
...
L 2:  19 [-]: JUMPIFNOT R3 L3
      20 [-]: RETURN R0 0  
L 3:  21 [-]: GETIMPORT R3 7 [0x0469F296]
      22 [-]: LOADK R4 K8 ["EmissiveTintColorLo"]
      23 [-]: CALL R3 1 1  
      24 [-]: GETIMPORT R4 10 [0x60130201]
      25 [-]: CALL R4 0 1  
      26 [-]: MOVE R7 R4   
      27 [-]: LOADB R8 0   
      28 [-]: NAMECALL R5 R2 K11 [0xA3EF5D65]
      29 [-]: CALL R5 3 0  
      30 [-]: GETIMPORT R5 13 [0xA421AF95]
      31 [-]: GETUPVAL R7 0
...
L 7:  79 [-]: JUMPIF R10 L8
      80 [-]: GETIMPORT R10 24 [0x9BAFFFE3]
      ...
      88 [-]: GETIMPORT R10 24 [0x9BAFFFE3]
      ...
      96 [-]: GETIMPORT R10 24 [0x9BAFFFE3]
     ...
     111 [-]: CALL R10 7 0 
     112 [-]: GETIMPORT R10 27 [0xCBD666E1]
     113 [-]: LOADN R11 0  
     114 [-]: CALL R10 1 0 
     115 [-]: GETIMPORT R11 30 [0x67652851]
     116 [-]: CALL R11 0 1 
