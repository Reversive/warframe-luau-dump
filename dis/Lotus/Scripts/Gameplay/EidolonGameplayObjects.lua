...
L 2:  20 [-]: NAMECALL R8 R7 K9 [0xD2715720]
      ...
      25 [-]: MOVE R9 R2   
      26 [-]: MOVE R10 R7  
      27 [-]: GETIMPORT R8 12 [0x23D5322F]
      28 [-]: CALL R8 2 0  
L 3:  29 [-]: FORGLOOP R3 L2 2 [inext]
      30 [-]: GETIMPORT R3 8 [0xC8802016]
      31 [-]: MOVE R4 R2   
      32 [-]: CALL R3 1 3  
      33 [-]: FORGPREP_INEXT R3 L5
L 4:  34 [-]: GETIMPORT R8 14 [0x11A19C5E]
      35 [-]: MOVE R9 R7   
...
L 3:  18 [-]: NAMECALL R2 R0 K5 [0x2B54251B]
      ...
      20 [-]: MOVE R1 R2   
      21 [-]: JUMPBACK L0  
L 4:  22 [-]: GETIMPORT R2 7 [0x89326C93]
      23 [-]: NAMECALL R2 R2 K8 [0x18D05D30]
      24 [-]: CALL R2 1 1  
      25 [-]: JUMPIFNOT R2 L5
      26 [-]: GETIMPORT R2 10 [0x11A19C5E]
      27 [-]: MOVE R3 R1   
      28 [-]: LOADK R4 K11 ["OnDone"]
      29 [-]: CALL R2 2 0  
L 5:  30 [-]: GETUPVAL R2 0
      31 [-]: GETIMPORT R4 13 ["gBaseMarkerInfoType"]
      32 [-]: NAMECALL R2 R2 K14 [0xC9F6A7D7]
      33 [-]: CALL R2 2 1  
      34 [-]: GETIMPORT R3 17 [0x4A2C3A0F]
      35 [-]: GETUPVAL R4 0
      36 [-]: GETIMPORT R5 19 ["gParticleSysType"]
      37 [-]: LOADB R6 0   
      38 [-]: LOADB R7 1   
      39 [-]: CALL R3 4 0  
...
L 8:  56 [-]: JUMPIFNOT R3 L9
      57 [-]: GETIMPORT R3 17 [0x4A2C3A0F]
      58 [-]: GETUPVAL R4 0
      59 [-]: GETIMPORT R5 19 ["gParticleSysType"]
      60 [-]: LOADB R6 1   
      61 [-]: LOADB R7 1   
      62 [-]: CALL R3 4 0  
