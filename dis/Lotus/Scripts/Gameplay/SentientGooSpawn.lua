...
L 0:   7 [-]: NAMECALL R8 R7 K5; var9 = var7; var8 = var7[0x22DA1852]
      ...
      12 [-]: JUMPIFNOTEQ R8 R9 L1; goto L1 if var8 ~= var592455
...
L 1:   9 [-]: JUMPIF R2 L4 ; goto L4 if var2
      ...
      23 [-]: JUMPIFNOTEQ R3 R4 L4; goto L4 if var3 ~= var1115169
...
L 9:  58 [-]: JUMPIF R5 L10; goto L10 if var5
      ...
      62 [-]: JUMPIFEQ R5 R6 L10; goto L10 if var5 == var65571
      63 [-]: RETURN R0 0  ; 
L10:  64 [-]: GETIMPORT R5 1; var5 = 0x89326C93
      ...
      72 [-]: JUMPIFNOTLE R6 R7 L11; goto L11 if var6 > var65571
      73 [-]: RETURN R0 0  ; 
...
L18: 104 [-]: LOADN R8 1   ; var8 = 1
     ...
     106 [-]: JUMPIFNOTEQ R6 R9 L19; goto L19 if var6 ~= var2230305
...
L20: 112 [-]: NAMECALL R12 R5 K26; var13 = var5; var12 = var5[0x4278F969]
     ...
     115 [-]: JUMPIFLE R12 R13 L28; goto L28 if var12 <= var2559521
...
L23: 165 [-]: JUMPIF R18 L24; goto L24 if var18
     ...
     179 [-]: LOADN R23 86 ; var23 = 86
     180 [-]: LOADN R24 2  ; var24 = 2
     181 [-]: LOADK R25 K60; var25 = 0.64999997615814209
...
L24: 189 [-]: LOADN R17 1  ; var17 = 1
     190 [-]: JUMPIFNOTLT R17 R8 L25; goto L25 if var17 >= var330560
     191 [-]: JUMPIFNOTLT R11 R8 L25; goto L25 if var11 >= var4329761
...
L25: 195 [-]: NAMECALL R17 R5 K26; var18 = var5; var17 = var5[0x4278F969]
     ...
     198 [-]: JUMPIFLE R17 R18 L28; goto L28 if var17 <= var787476
     199 [-]: JUMPIFNOT R4 L27; goto L27 if not var4
     200 [-]: FASTCALL1 64 R3 L26; 
...
L26: 204 [-]: JUMPIF R17 L28; goto L28 if var17
     ...
     208 [-]: JUMPIFNOTEQ R17 R18 L28; goto L28 if var17 ~= var-8648411
...
L 7:  44 [-]: JUMPIF R12 L8; goto L8 if var12
      ...
      47 [-]: LOADK R14 K20; var14 = 0.0010000000474974513
