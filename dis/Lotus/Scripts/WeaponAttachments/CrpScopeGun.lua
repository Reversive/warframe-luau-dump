...
L 6:  37 [-]: NAMECALL R5 R1 K10; var6 = var1; var5 = var1[0x46AFA846]
      ...
      40 [-]: JUMPIFNOTLE R5 R6 L7; goto L7 if var5 > var66887
...
L10:  66 [-]: GETIMPORT R9 22; var9 = 0x20B7F774
      ...
      71 [-]: JUMPIFNOTLE R10 R5 L14; goto L14 if var10 > var68679
...
L 1:  12 [-]: JUMPIF R4 L5 ; goto L5 if var4
      ...
      14 [-]: JUMPIFNOTLT R1 R4 L5; goto L5 if var1 >= var459854
      15 [-]: GETIMPORT R4 7; var4 = 0x6F068685
      16 [-]: LOADN R5 0   ; var5 = 0
      17 [-]: JUMPIFNOTLT R5 R4 L3; goto L3 if var5 >= var591438
...
L 4:  40 [-]: SUB R4 R5 R6 ; var4 = var5 - var6
      ...
      47 [-]: MULK R5 R6 K19; var5 = var6 * 1.8
...
L 2:  33 [-]: JUMPIF R5 L3 ; goto L3 if var5
      ...
      37 [-]: GETIMPORT R10 15; var10 = 0x64FB1586
      38 [-]: GETIMPORT R12 3; var12 = _T["crpScopeGun"]
      39 [-]: GETTABLE R11 R12 R3; var11 = var12[var3]
      40 [-]: CALL R10 2 0 ; var10, ... = var10(var11)
      41 [-]: SETLIST R8 R9 -1 [1]; 
      42 [-]: NAMECALL R5 R4 K16; var6 = var4; var5 = var4[0xF56F3887]
