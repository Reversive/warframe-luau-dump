...
; Max Stack Size:  13
  ...
  7 [-]: GETTABLE  R3 R3 K4     ; R3 := R3[0xac1b386a]
  8 [-]: LEN       R4 R2        ; R4 := # R2
  9 [-]: GETGLOBAL R5 K3        ; R5 := 0x5bced4c4
 10 [-]: GETTABLE  R5 R5 K4     ; R5 := R5[0xac1b386a]
...
; Max Stack Size:  12
 ...
 12 [-]: GETTABLE  R4 R4 K6     ; R4 := R4[0xac1b386a]
 13 [-]: MOVE      R5 R3        ; R5 := R3
 ...
 23 [-]: JMP       25           ; PC := 25
 24 [-]: LOADKB    R11 0 1      ; R11 := false; PC := 25
...
; Max Stack Size:  25
 ...
 39 [-]: GETTABLE  R10 R10 K12  ; R10 := R10[0x23d5322f]
