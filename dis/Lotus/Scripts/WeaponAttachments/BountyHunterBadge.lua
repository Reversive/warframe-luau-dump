...
L 7:  37 [-]: LOADN R3 0   
      ...
      39 [-]: LOADN R1 1   
      40 [-]: RETURN R1 2  
L 8:  41 [-]: GETIMPORT R3 17 [0xF54B75A6]
      42 [-]: JUMPIFNOT R3 L9
...
L 2:   9 [-]: LOADN R1 0   
      ...
      13 [-]: GETIMPORT R6 7 ["gLotusAttractModeGameRulesType"]
      14 [-]: NAMECALL R4 R4 K8 [0xF2DEAF69]
      15 [-]: CALL R4 2 1  
      16 [-]: JUMPIFNOT R4 L6
      17 [-]: GETIMPORT R4 10 [0x9B35B13F]
      18 [-]: LOADN R5 1   
      19 [-]: JUMPIFNOTLE R5 R4 L5
L 3:  20 [-]: GETIMPORT R4 12 [0x76EA806B]
      21 [-]: NAMECALL R4 R4 K13 [0x8792AAAB]
      22 [-]: CALL R4 1 1  
      23 [-]: JUMPIF R4 L4 
      24 [-]: GETIMPORT R4 5 [0xCBD666E1]
      25 [-]: LOADN R5 0   
      26 [-]: CALL R4 1 0  
      27 [-]: JUMPBACK L3  
L 4:  28 [-]: GETIMPORT R4 12 [0x76EA806B]
      29 [-]: LOADN R6 0   
...
L 5:  36 [-]: GETIMPORT R4 12 [0x76EA806B]
      37 [-]: LOADN R6 0   
...
L 8:  52 [-]: JUMPIFNOT R5 L9
      ...
      58 [-]: MOVE R4 R5   
      59 [-]: JUMPBACK L7  
L 9:  60 [-]: GETIMPORT R7 20 ["gBaseAvatarType"]
...
L12:  76 [-]: JUMPIF R6 L18
      77 [-]: GETIMPORT R6 1 [0xBE190284]
      78 [-]: GETIMPORT R8 23 ["gLotusHubGameRulesType"]
      79 [-]: NAMECALL R6 R6 K8 [0xF2DEAF69]
      80 [-]: CALL R6 2 1  
      81 [-]: JUMPIFNOT R6 L18
L13:  82 [-]: GETIMPORT R7 25 [0xE7F2B02F]
...
L14:  88 [-]: JUMPIFNOT R6 L15
      89 [-]: GETIMPORT R6 5 [0xCBD666E1]
      90 [-]: LOADN R7 0   
      91 [-]: CALL R6 1 0  
      92 [-]: JUMPBACK L13 
L15:  93 [-]: GETIMPORT R6 1 [0xBE190284]
      94 [-]: MOVE R8 R4   
      95 [-]: NAMECALL R6 R6 K27 [0x6566F2D4]
      96 [-]: CALL R6 2 1  
      97 [-]: GETIMPORT R7 25 [0xE7F2B02F]
      98 [-]: NAMECALL R7 R7 K26 [0x0441ACA2]
      99 [-]: CALL R7 1 1  
     100 [-]: MOVE R10 R6  
     101 [-]: NAMECALL R8 R7 K28 [0x654FB7FB]
     102 [-]: CALL R8 2 1  
     103 [-]: GETIMPORT R9 12 [0x76EA806B]
     104 [-]: LOADN R11 0  
     ...
     110 [-]: GETIMPORT R9 12 [0x76EA806B]
     111 [-]: LOADN R11 0  
...
L17: 130 [-]: GETIMPORT R9 5 [0xCBD666E1]
     131 [-]: LOADN R10 0  
     132 [-]: CALL R9 1 0  
     133 [-]: JUMPBACK L16 
     134 [-]: JUMP L22
...
L22: 157 [-]: GETUPVAL R4 0
     ...
     160 [-]: MOVE R1 R4   
     161 [-]: MOVE R3 R5   
L23: 162 [-]: GETIMPORT R6 34 [0x0032441C]
     163 [-]: GETTABLEKS R5 R6 K35 ["UIColor_DarkGrey"]
     164 [-]: FASTCALL1 62 R5 L24
     165 [-]: GETIMPORT R4 3 [0x7B998233]
     166 [-]: CALL R4 1 1  
L24: 167 [-]: JUMPIFNOT R4 L25
     168 [-]: GETIMPORT R4 5 [0xCBD666E1]
     169 [-]: LOADN R5 0   
     170 [-]: CALL R4 1 0  
     171 [-]: JUMPBACK L23 
L25: 172 [-]: GETIMPORT R4 37 [0x9BA7909F]
     173 [-]: GETIMPORT R6 39 [0xDD84C646]
     174 [-]: NAMECALL R4 R4 K40 [0xCFBA257F]
     175 [-]: CALL R4 2 1  
     176 [-]: SETUPVAL R4 1
     177 [-]: GETUPVAL R5 1
     178 [-]: FASTCALL1 62 R5 L26
     179 [-]: GETIMPORT R4 3 [0x7B998233]
     180 [-]: CALL R4 1 1  
L26: 181 [-]: JUMPIF R4 L29
     182 [-]: GETUPVAL R4 1
     183 [-]: LOADK R6 K41 ["SetMessage"]
     184 [-]: NEWTABLE R7 0 2
     185 [-]: GETIMPORT R8 43 [0x64FB1586]
     186 [-]: MOVE R9 R1   
     187 [-]: CALL R8 1 1  
     188 [-]: GETIMPORT R9 43 [0x64FB1586]
     189 [-]: MOVE R10 R3  
     190 [-]: CALL R9 1 -1 
     191 [-]: SETLIST R7 R8 -1 [1]
     192 [-]: NAMECALL R4 R4 K44 [0xF56F3887]
     193 [-]: CALL R4 3 0  
     194 [-]: GETIMPORT R4 10 [0x9B35B13F]
     195 [-]: LOADN R5 0   
     ...
     199 [-]: GETUPVAL R4 1
     200 [-]: MOVE R6 R0   
     201 [-]: GETIMPORT R7 46 [0xA421AF95]
     202 [-]: LOADN R8 0   
     203 [-]: LOADK R9 K47 [0.012500000000000001]
     204 [-]: LOADK R10 K48 [-0.050000000000000003]
     205 [-]: CALL R7 3 1  
     206 [-]: GETIMPORT R8 50 [0x00046924]
     207 [-]: LOADN R9 180 
     208 [-]: LOADN R10 0  
     209 [-]: LOADN R11 0  
     210 [-]: CALL R8 3 1  
     211 [-]: GETIMPORT R9 46 [0xA421AF95]
...
L27: 219 [-]: GETUPVAL R4 1
     220 [-]: MOVE R6 R0   
     221 [-]: GETIMPORT R7 46 [0xA421AF95]
     222 [-]: LOADN R8 0   
     223 [-]: LOADK R9 K53 [0.025000000000000001]
     224 [-]: LOADK R10 K48 [-0.050000000000000003]
     225 [-]: CALL R7 3 1  
     226 [-]: GETIMPORT R8 50 [0x00046924]
     227 [-]: LOADN R9 180 
     228 [-]: LOADN R10 0  
     229 [-]: LOADN R11 0  
     230 [-]: CALL R8 3 1  
     231 [-]: GETIMPORT R9 46 [0xA421AF95]
...
L28: 238 [-]: GETUPVAL R4 1
     ...
     246 [-]: CALL R4 2 0  
L29: 247 [-]: GETIMPORT R5 59 [0x0791FBBC]
     248 [-]: LENGTH R4 R5 
     249 [-]: GETIMPORT R6 61 [0x413C48D8]
     250 [-]: LENGTH R5 R6 
     251 [-]: JUMPIFEQ R4 R5 L30
     252 [-]: GETIMPORT R4 63 [0x3D106989]
     253 [-]: LOADK R5 K64 ["Bad data for BountyHunterBadge, need same number of tier materials and tier values"]
     254 [-]: CALL R4 1 0  
     255 [-]: RETURN R0 0  
L30: 256 [-]: GETIMPORT R7 61 [0x413C48D8]
     257 [-]: LENGTH R6 R7 
     258 [-]: LOADN R4 1   
     259 [-]: LOADN R5 -1  
     260 [-]: FORNPREP R4 L33
L31: 261 [-]: GETIMPORT R8 59 [0x0791FBBC]
     262 [-]: GETTABLE R7 R8 R6
     263 [-]: JUMPIFNOTLE R7 R1 L32
     264 [-]: GETIMPORT R9 66 [0x76966039]
     265 [-]: GETIMPORT R11 61 [0x413C48D8]
