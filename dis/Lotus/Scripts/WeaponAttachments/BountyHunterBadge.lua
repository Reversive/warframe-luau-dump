...
L 1:   8 [-]: LOADN R1 0   ; var1 = 0
      ...
      12 [-]: JUMPIFNOTLE R4 R3 L8; goto L8 if var4 > var66075
...
L 7:  37 [-]: LOADN R3 0   ; var3 = 0
      38 [-]: JUMPIFNOTLE R1 R3 L10; goto L10 if var1 > var65863
...
L 2:   9 [-]: LOADN R1 0   ; var1 = 0
      ...
      19 [-]: JUMPIFNOTLE R5 R4 L5; goto L5 if var5 > var787534
...
L15:  93 [-]: GETIMPORT R6 1; var6 = 0xBE190284
     ...
     109 [-]: JUMPIFNOTEQ R8 R9 L16; goto L16 if var8 ~= var788814
...
L26: 181 [-]: JUMPIF R4 L29; goto L29 if var4
     182 [-]: GETUPVAL R4 1; var4 = upvalues[1]
     183 [-]: LOADK R6 K41 ; var6 = "SetMessage"
     184 [-]: NEWTABLE R7 0 2; var7 = {}
     185 [-]: GETIMPORT R8 43; var8 = 0x64FB1586
     186 [-]: MOVE R9 R1   ; var9 = var1
     187 [-]: CALL R8 2 2  ; var8 = var8(var9)
     188 [-]: GETIMPORT R9 43; var9 = 0x64FB1586
     189 [-]: MOVE R10 R3  ; var10 = var3
     190 [-]: CALL R9 2 0  ; var9, ... = var9(var10)
     191 [-]: SETLIST R7 R8 -1 [1]; 
     192 [-]: NAMECALL R4 R4 K44; var5 = var4; var4 = var4[0xF56F3887]
     193 [-]: CALL R4 4 1  ; var4(var5, var6, var7)
     194 [-]: GETIMPORT R4 10; var4 = 0x9B35B13F
     195 [-]: LOADN R5 0   ; var5 = 0
     196 [-]: JUMPIFNOTLT R4 R5 L27; goto L27 if var4 >= var656455
     197 [-]: LOADN R4 10  ; var4 = 10
     198 [-]: JUMPIFNOTLE R4 R1 L27; goto L27 if var4 > var66567
     199 [-]: GETUPVAL R4 1; var4 = upvalues[1]
     200 [-]: MOVE R6 R0   ; var6 = var0
     201 [-]: GETIMPORT R7 46; var7 = 0xA421AF95
     202 [-]: LOADN R8 0   ; var8 = 0
     203 [-]: LOADK R9 K47 ; var9 = 0.012500000000000001
     204 [-]: LOADK R10 K48; var10 = -0.050000000000000003
     205 [-]: CALL R7 4 2  ; var7 = var7(var8, var9, var10)
     206 [-]: GETIMPORT R8 50; var8 = 0x00046924
     207 [-]: LOADN R9 180 ; var9 = 180
     208 [-]: LOADN R10 0  ; var10 = 0
     209 [-]: LOADN R11 0  ; var11 = 0
     210 [-]: CALL R8 4 2  ; var8 = var8(var9, var10, var11)
     211 [-]: GETIMPORT R9 46; var9 = 0xA421AF95
     212 [-]: LOADK R10 K51; var10 = 0.75
     213 [-]: LOADK R11 K51; var11 = 0.75
     214 [-]: LOADK R12 K51; var12 = 0.75
     215 [-]: CALL R9 4 0  ; var9, ... = var9(var10, var11, var12)
     216 [-]: NAMECALL R4 R4 K52; var5 = var4; var4 = var4[0xE395D771]
     217 [-]: CALL R4 0 1  ; var4(var5, ...)
     218 [-]: JUMP L28     ; goto L28
L27: 219 [-]: GETUPVAL R4 1; var4 = upvalues[1]
     220 [-]: MOVE R6 R0   ; var6 = var0
     221 [-]: GETIMPORT R7 46; var7 = 0xA421AF95
     222 [-]: LOADN R8 0   ; var8 = 0
     223 [-]: LOADK R9 K53 ; var9 = 0.025000000000000001
     224 [-]: LOADK R10 K48; var10 = -0.050000000000000003
     225 [-]: CALL R7 4 2  ; var7 = var7(var8, var9, var10)
     226 [-]: GETIMPORT R8 50; var8 = 0x00046924
     227 [-]: LOADN R9 180 ; var9 = 180
     228 [-]: LOADN R10 0  ; var10 = 0
     229 [-]: LOADN R11 0  ; var11 = 0
     230 [-]: CALL R8 4 2  ; var8 = var8(var9, var10, var11)
     231 [-]: GETIMPORT R9 46; var9 = 0xA421AF95
     232 [-]: LOADK R10 K51; var10 = 0.75
     233 [-]: LOADK R11 K51; var11 = 0.75
     234 [-]: LOADK R12 K51; var12 = 0.75
     235 [-]: CALL R9 4 0  ; var9, ... = var9(var10, var11, var12)
     236 [-]: NAMECALL R4 R4 K52; var5 = var4; var4 = var4[0xE395D771]
     237 [-]: CALL R4 0 1  ; var4(var5, ...)
L28: 238 [-]: GETUPVAL R4 1; var4 = upvalues[1]
     239 [-]: LOADK R6 K54 ; var6 = "SetLiteMode"
     240 [-]: LOADK R7 K55 ; var7 = "true"
     241 [-]: NAMECALL R4 R4 K56; var5 = var4; var4 = var4[0xE4162EED]
     242 [-]: CALL R4 4 1  ; var4(var5, var6, var7)
     243 [-]: GETUPVAL R4 1; var4 = upvalues[1]
     244 [-]: MOVE R6 R0   ; var6 = var0
     245 [-]: NAMECALL R4 R4 K57; var5 = var4; var4 = var4[0x263A3CC2]
     246 [-]: CALL R4 3 1  ; var4(var5, var6)
L29: 247 [-]: GETIMPORT R5 59; var5 = 0x0791FBBC
     248 [-]: LENGTH R4 R5 ; var4 = #var5
     249 [-]: GETIMPORT R6 61; var6 = 0x413C48D8
     250 [-]: LENGTH R5 R6 ; var5 = #var6
     251 [-]: JUMPIFEQ R4 R5 L30; goto L30 if var4 == var4129870
     252 [-]: GETIMPORT R4 63; var4 = 0x3D106989
     253 [-]: LOADK R5 K64 ; var5 = "Bad data for BountyHunterBadge, need same number of tier materials and tier values"
     254 [-]: CALL R4 2 1  ; var4(var5)
     255 [-]: RETURN R0 0  ; 
L30: 256 [-]: GETIMPORT R7 61; var7 = 0x413C48D8
     257 [-]: LENGTH R6 R7 ; var6 = #var7
     258 [-]: LOADN R4 1   ; var4 = 1
     259 [-]: LOADN R5 -1  ; var5 = -1
     260 [-]: FORNPREP R4 L33; nforprep start - [escape at L33] -- var4 = iterator
L31: 261 [-]: GETIMPORT R8 59; var8 = 0x0791FBBC
     262 [-]: GETTABLE R7 R8 R6; var7 = var8[var6]
     263 [-]: JUMPIFNOTLE R7 R1 L32; goto L32 if var7 > var4327758
     264 [-]: GETIMPORT R9 66; var9 = 0x76966039
     265 [-]: GETIMPORT R11 61; var11 = 0x413C48D8
     266 [-]: GETTABLE R10 R11 R6; var10 = var11[var6]
     267 [-]: LOADB R11 0  ; var11 = false
     268 [-]: NAMECALL R7 R0 K67; var8 = var0; var7 = var0[0xCDDC3ABB]
     269 [-]: CALL R7 5 1  ; var7(var8, var9, var10, var11)
     270 [-]: RETURN R0 0  ; 
L32: 271 [-]: FORNLOOP R4 L31; nforloop end - iterate + goto L31
L33: 272 [-]: RETURN R0 0  ; 
