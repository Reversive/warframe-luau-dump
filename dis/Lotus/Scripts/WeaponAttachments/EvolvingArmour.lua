...
; Max Stack Size:  11
       ...
       0 [-]: GETIMPORT R2 1 [0xB5CABD9B]
       1 [-]: JUMPIFNOT R2 L3
       2 [-]: GETIMPORT R3 3 [0x25D99D89]
       3 [-]: FASTCALL1 62 R3 L0
       4 [-]: GETIMPORT R2 5 [0x7B998233]
       5 [-]: CALL R2 1 1  
L 0:   6 [-]: JUMPIF R2 L3 
       7 [-]: GETIMPORT R2 3 [0x25D99D89]
...
L 6:  35 [-]: JUMPIF R9 L11
      36 [-]: GETIMPORT R11 8 ["gLotusSuitCustomizationType"]
...
L 7:  48 [-]: LOADN R14 1  
      ...
      51 [-]: CALL R12 3 1 
      52 [-]: GETIMPORT R13 13 [0xC8802016]
      53 [-]: MOVE R14 R12 
      54 [-]: CALL R13 1 3 
...
L 1:   9 [-]: NAMECALL R1 R0 K4 [0x28E744CF]
      ...
      14 [-]: CALL R2 1 1  
L 2:  15 [-]: JUMPIF R2 L3 
      16 [-]: GETIMPORT R4 6 ["gLotusAvatarType"]
...
L 8:  37 [-]: NAMECALL R4 R3 K10 [0xEF980197]
      ...
      41 [-]: LOADB R7 1   
      42 [-]: MOVE R8 R4   
      43 [-]: GETIMPORT R11 12 [0x74DDA92A]
      44 [-]: NAMECALL R9 R1 K13 [0xC9F6A7D7]
      45 [-]: CALL R9 2 1  
      46 [-]: GETIMPORT R10 15 [0x3D106989]
      47 [-]: FASTCALL1 62 R9 L9
      48 [-]: MOVE R12 R9  
      49 [-]: GETIMPORT R11 3 [0x7B998233]
      50 [-]: CALL R11 1 1 
L 9:  51 [-]: CALL R10 1 0 
...
L12:  64 [-]: JUMPIF R12 L13
      65 [-]: GETIMPORT R14 17 ["gHumanPlayerType"]
...
L14:  77 [-]: JUMPIF R7 L15
      78 [-]: GETIMPORT R13 19 [0x67652851]
      79 [-]: CALL R13 0 1 
      80 [-]: ADD R6 R6 R13
      81 [-]: GETIMPORT R13 21 [0xAE4D6B07]
      82 [-]: JUMPIFNOTLE R13 R6 L15
      83 [-]: LOADB R7 1   
      84 [-]: LOADN R6 0   
      85 [-]: MOVE R4 R8   
L15:  86 [-]: GETIMPORT R13 19 [0x67652851]
      87 [-]: CALL R13 0 1 
      88 [-]: ADD R5 R5 R13
      89 [-]: GETIMPORT R13 23 [0xCC266B8E]
...
L18: 101 [-]: JUMPIFNOT R7 L21
     102 [-]: GETIMPORT R14 26 [0xB5C81E3E]
     103 [-]: ADD R13 R4 R14
     104 [-]: JUMPIFNOTLE R13 R8 L21
     105 [-]: GETIMPORT R14 28 [0xF75EB95F]
     106 [-]: FASTCALL1 62 R14 L19
     107 [-]: GETIMPORT R13 3 [0x7B998233]
     108 [-]: CALL R13 1 1 
L19: 109 [-]: JUMPIF R13 L20
     110 [-]: GETIMPORT R15 28 [0xF75EB95F]
     111 [-]: GETIMPORT R16 30 ["EMPTY_SYMBOL"]
     112 [-]: GETIMPORT R17 32 ["ZERO_VECTOR"]
     113 [-]: GETIMPORT R18 34 ["ZERO_ROTATION"]
     114 [-]: MOVE R19 R1  
...
L20: 117 [-]: MOVE R4 R8   
     118 [-]: LOADB R7 0   
     119 [-]: LOADN R5 0   
L21: 120 [-]: GETIMPORT R13 1 [0xCBD666E1]
...
; Max Stack Size:  21
      ...
      10 [-]: CALL R2 3 0  
L 0:  11 [-]: LOADN R2 5   
L 1:  12 [-]: GETIMPORT R4 8 [0xBE190284]
      13 [-]: FASTCALL1 62 R4 L2
      14 [-]: GETIMPORT R3 10 [0x7B998233]
      15 [-]: CALL R3 1 1  
L 2:  16 [-]: JUMPIF R3 L4 
      17 [-]: GETIMPORT R4 12 [0x25D99D89]
...
L 4:  22 [-]: LOADN R3 0   
      ...
      27 [-]: CALL R3 1 0  
      28 [-]: JUMPBACK L1  
L 5:  29 [-]: GETIMPORT R4 8 [0xBE190284]
      30 [-]: FASTCALL1 62 R4 L6
      31 [-]: GETIMPORT R3 10 [0x7B998233]
      32 [-]: CALL R3 1 1  
L 6:  33 [-]: JUMPIF R3 L8 
      34 [-]: GETIMPORT R4 12 [0x25D99D89]
...
L12:  56 [-]: JUMPIFNOT R1 L13
      57 [-]: GETIMPORT R6 19 ["gTennoAvatarType"]
...
L15:  71 [-]: GETUPVAL R5 2
      ...
      73 [-]: CALL R4 0 1  
      74 [-]: JUMPIFNOT R4 L26
      75 [-]: GETIMPORT R5 24 ["InSimulacrum"]
      76 [-]: JUMPIFNOT R5 L16
      77 [-]: LOADB R4 1   
      78 [-]: JUMP L19
    
L16:  79 [-]: GETIMPORT R5 26 [0x89326C93]
      80 [-]: NAMECALL R5 R5 K27 [0xCA9EA368]
      81 [-]: CALL R5 1 1  
      82 [-]: GETIMPORT R6 29 [0xC8802016]
      83 [-]: GETUPVAL R7 3
      84 [-]: CALL R6 1 3  
...
L19:  91 [-]: JUMPIF R4 L33
      92 [-]: LOADB R4 0   
      93 [-]: GETIMPORT R7 31 ["gLotusOperatorAvatarType"]
      94 [-]: NAMECALL R5 R1 K2 [0xF2DEAF69]
      95 [-]: CALL R5 2 1  
      96 [-]: JUMPIFNOT R5 L20
      97 [-]: GETIMPORT R5 26 [0x89326C93]
...
L21: 109 [-]: JUMPIFNOT R4 L33
     110 [-]: GETIMPORT R5 36 ["EvoArmor_Icons"]
     111 [-]: JUMPXEQKNIL R5 L22 NOT
     112 [-]: GETIMPORT R5 37 ["_T"]
     113 [-]: NEWTABLE R6 0 0
     114 [-]: SETTABLEKS R6 R5 K35 ["EvoArmor_Icons"]
L22: 115 [-]: GETIMPORT R5 29 [0xC8802016]
     116 [-]: GETIMPORT R6 39 [0xCDEB224C]
     117 [-]: CALL R5 1 3  
     118 [-]: FORGPREP_INEXT R5 L25
L23: 119 [-]: GETIMPORT R10 41 [0xBA7DFCD2]
     120 [-]: GETIMPORT R12 26 [0x89326C93]
     121 [-]: GETIMPORT R14 43 [0x88EFC25E]
     122 [-]: MOVE R15 R9  
     123 [-]: CALL R14 1 -1
     ...
     127 [-]: CALL R10 -1 0
     128 [-]: GETIMPORT R11 47 [0x6B64699D]
     129 [-]: FASTCALL1 62 R11 L24
     130 [-]: GETIMPORT R10 10 [0x7B998233]
     131 [-]: CALL R10 1 1 
L24: 132 [-]: JUMPIF R10 L25
     133 [-]: GETIMPORT R10 36 ["EvoArmor_Icons"]
     134 [-]: NAMECALL R11 R9 K48 [0xE223E2B1]
     135 [-]: CALL R11 1 1 
     136 [-]: GETIMPORT R12 47 [0x6B64699D]
     137 [-]: SETTABLE R12 R10 R11
L25: 138 [-]: FORGLOOP R5 L23 2 [inext]
     139 [-]: RETURN R0 0  
L26: 140 [-]: GETIMPORT R4 37 ["_T"]
     141 [-]: JUMPXEQKNIL R4 L33
     142 [-]: GETIMPORT R4 50 ["GetScreenRes"]
     143 [-]: JUMPXEQKNIL R4 L33
     144 [-]: GETIMPORT R4 50 ["GetScreenRes"]
     145 [-]: LOADK R5 K51 ["LoadOut"]
     146 [-]: CALL R4 1 1  
     147 [-]: GETIMPORT R5 53 [0x9BA7909F]
     148 [-]: MOVE R7 R4   
     ...
     153 [-]: MOVE R6 R4   
     154 [-]: GETIMPORT R5 10 [0x7B998233]
     155 [-]: CALL R5 1 1  
L27: 156 [-]: JUMPIFNOT R5 L28
     157 [-]: GETIMPORT R5 50 ["GetScreenRes"]
     158 [-]: LOADK R6 K55 ["CustomizeTenno"]
     159 [-]: CALL R5 1 1  
     160 [-]: MOVE R4 R5   
     161 [-]: GETIMPORT R5 53 [0x9BA7909F]
     162 [-]: MOVE R7 R4   
...
L28: 166 [-]: FASTCALL1 62 R4 L29
     167 [-]: MOVE R6 R4   
     168 [-]: GETIMPORT R5 10 [0x7B998233]
     169 [-]: CALL R5 1 1  
L29: 170 [-]: JUMPIF R5 L33
     ...
     174 [-]: CALL R5 3 0  
     175 [-]: GETIMPORT R5 60 ["LoadOutSelectedSlot"]
     176 [-]: GETIMPORT R6 37 ["_T"]
     177 [-]: LOADNIL R7   
     ...
     185 [-]: LOADK R6 K57 [""]
     186 [-]: LOADN R7 0   
     187 [-]: GETIMPORT R8 29 [0xC8802016]
     188 [-]: GETIMPORT R9 39 [0xCDEB224C]
     189 [-]: CALL R8 1 3  
...
L31: 197 [-]: GETIMPORT R13 41 [0xBA7DFCD2]
     ...
     202 [-]: MOVE R7 R13  
     203 [-]: MOVE R13 R6  
     204 [-]: GETIMPORT R16 64 [0x64FB1586]
