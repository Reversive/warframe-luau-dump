...
L 1:  12 [-]: JUMPIF R2 L3 ; goto L3 if var2
      13 [-]: GETIMPORT R2 10; var2 = 0x8B696A72
...
L 2:  19 [-]: LOADB R4 1   ; var4 = true
      20 [-]: NAMECALL R2 R1 K11; var3 = var1; var2 = var1[0x768274D6]
      21 [-]: CALL R2 3 1  ; var2(var3, var4)
L 3:  22 [-]: GETIMPORT R2 13; var2 = 0xB621236F
...
L 4:  28 [-]: JUMPIF R2 L6 ; goto L6 if var2
      29 [-]: NAMECALL R2 R0 K14; var3 = var0; var2 = var0[0x73A8846A]
...
L 5:  35 [-]: JUMPIF R3 L6 ; goto L6 if var3
      ...
      37 [-]: NAMECALL R3 R2 K15; var4 = var2; var3 = var2[0x22F0B321]
      38 [-]: CALL R3 3 1  ; var3(var4, var5)
      39 [-]: MOVE R5 R0   ; var5 = var0
      40 [-]: NAMECALL R3 R2 K15; var4 = var2; var3 = var2[0x22F0B321]
...
L10:  51 [-]: JUMPIF R6 L12; goto L12 if var6
      ...
      53 [-]: JUMPIFNOTLT R5 R6 L12; goto L12 if var5 >= var984654
...
; Max Stack Size:  18
       ...
       4 [-]: LOADN R3 1   ; var3 = 1
       5 [-]: LOADN R4 0   ; var4 = 0
       6 [-]: JUMPIFNOTLT R4 R2 L0; goto L0 if var4 >= var-184482747
...
L 0:  10 [-]: LOADN R6 1   ; var6 = 1
      ...
      12 [-]: MULK R4 R5 K3; var4 = var5 * 0.98999999999999999
...
L 7:  36 [-]: MOVE R8 R0   ; var8 = var0
      ...
      42 [-]: JUMPIFNOTLT R7 R6 L9; goto L9 if var7 >= var2375
...
L 9:  54 [-]: NAMECALL R7 R2 K11; var8 = var2; var7 = var2[0xD6BD1155]
      ...
      58 [-]: JUMPIFNOTLT R9 R7 L10; goto L10 if var9 >= var-184415931
...
L10:  62 [-]: LOADN R11 1  ; var11 = 1
      ...
      64 [-]: MULK R9 R10 K13; var9 = var10 * 0.98999999999999999
