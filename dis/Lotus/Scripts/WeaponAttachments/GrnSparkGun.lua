...
L 0:   4 [-]: GETIMPORT R7 4; var7 = 0x2BFEBDFC
      ...
      11 [-]: JUMPIFNOTLE R6 R2 L2; goto L2 if var6 > var787268
...
L 1:   6 [-]: JUMPIFNOT R2 L2; goto L2 if not var2
       ...
       8 [-]: LOADK R3 K5  ; var3 = 0.10000000000000001
...
L 7:  33 [-]: GETUPVAL R4 0; var4 = upvalues[0]
      ...
      44 [-]: LOADK R7 K17 ; var7 = 0.55000000000000004
...
L 8:  49 [-]: LOADB R4 1   ; var4 = true
      ...
      51 [-]: LOADK R4 K17 ; var4 = 0.55000000000000004
...
L18: 126 [-]: JUMPIFNOTEQ R6 R17 L30; goto L30 if var6 ~= var72519
     127 [-]: LOADN R27 1  ; var27 = 1
     128 [-]: JUMPIFNOTLE R27 R26 L22; goto L22 if var27 > var1377604
...
L23: 156 [-]: GETIMPORT R32 55; var32 = 0x2BFEBDFC
     ...
     163 [-]: JUMPIFNOTLE R31 R26 L25; goto L25 if var31 > var793668
...
L30: 208 [-]: JUMPIFNOTEQ R6 R18 L33; goto L33 if var6 ~= var72470
...
L31: 216 [-]: GETIMPORT R32 55; var32 = 0x2BFEBDFC
     ...
     223 [-]: JUMPIFNOTLE R31 R26 L56; goto L56 if var31 > var12786756
...
L33: 236 [-]: JUMPIFNOTEQ R6 R19 L46; goto L46 if var6 ~= var2033443
     ...
     242 [-]: JUMPIFNOTLE R8 R27 L34; goto L34 if var8 > var329733
     243 [-]: LOADK R8 K5  ; var8 = 0.10000000000000001
...
L36: 263 [-]: LOADN R27 0  ; var27 = 0
     264 [-]: JUMPIFNOTLT R27 R8 L56; goto L56 if var27 >= var4136014
...
L40: 282 [-]: LOADN R28 1  ; var28 = 1
     283 [-]: JUMPIFNOTLE R28 R8 L42; goto L42 if var28 > var35077707
...
L42: 295 [-]: MOVE R28 R13 ; var28 = var13
     ...
     298 [-]: JUMPIFNOTLE R9 R27 L45; goto L45 if var9 > var4398158
...
L43: 311 [-]: GETIMPORT R34 55; var34 = 0x2BFEBDFC
     ...
     318 [-]: JUMPIFNOTLE R33 R28 L56; goto L56 if var33 > var5119556
...
L46: 344 [-]: JUMPIFNOTEQ R6 R20 L52; goto L52 if var6 ~= var1819
...
L57: 393 [-]: LOADK R28 K68; var28 = 0.5
     394 [-]: JUMPIFNOTLT R28 R27 L61; goto L61 if var28 >= var7239
...
L 2:  14 [-]: GETUPVAL R3 0; var3 = upvalues[0]
      ...
      21 [-]: ADDK R5 R6 K6; var5 = var6 + 0.84999999999999998
