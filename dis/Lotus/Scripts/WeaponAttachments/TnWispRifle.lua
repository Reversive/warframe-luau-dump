...
; Max Stack Size:  12
       ...
       5 [-]: LOADK R2 K5  ; var2 = -0.016353099999999999
       6 [-]: LOADK R3 K6  ; var3 = 0.071502200000000002
       7 [-]: LOADK R4 K7  ; var4 = -0.0569623
       8 [-]: CALL R1 4 2  ; var1 = var1(var2, var3, var4)
       9 [-]: GETIMPORT R2 9; var2 = 0x00046924
      10 [-]: LOADK R3 K10 ; var3 = -84.409999999999997
      11 [-]: LOADK R4 K11 ; var4 = 66.879999999999995
      12 [-]: LOADK R5 K12 ; var5 = 76.069999999999993
...
; Max Stack Size:  6
       ...
       1 [-]: LOADK R4 K2  ; var4 = 0.20000000000000001
...
L 0:   6 [-]: JUMPIF R2 L6 ; goto L6 if var2
      ...
      14 [-]: JUMPIFNOTLT R3 R2 L6; goto L6 if var3 >= var50413131
...
L 1:  27 [-]: JUMPIF R3 L5 ; goto L5 if var3
      ...
      33 [-]: JUMPIFNOTLT R4 R3 L4; goto L4 if var4 >= var50478667
...
L 4:  24 [-]: GETGLOBAL R7 K7; var7 = 0x949A4303
      ...
      26 [-]: JUMPIFNOTLT R8 R7 L7; goto L7 if var8 >= var50333725
...
L 6:  37 [-]: JUMPIF R8 L7 ; goto L7 if var8
      ...
      39 [-]: JUMPIFNOTLT R7 R8 L7; goto L7 if var7 >= var657486
...
L 5:  38 [-]: JUMPIF R6 L8 ; goto L8 if var6
      ...
      59 [-]: JUMPIFNOTLT R7 R6 L8; goto L8 if var7 >= var50413131
...
L 8:  56 [-]: JUMPIF R6 L23; goto L23 if var6
      ...
      62 [-]: JUMPIFNOTLT R8 R7 L10; goto L10 if var8 >= var117835282
      63 [-]: DIV R6 R6 R7 ; var6 = var6 / var7
      64 [-]: GETIMPORT R8 15; var8 = 0x07896076
      65 [-]: LOADN R9 0   ; var9 = 0
      66 [-]: JUMPIFNOTLT R9 R8 L9; goto L9 if var9 >= var985166
      67 [-]: GETIMPORT R8 15; var8 = 0x07896076
      68 [-]: LOADN R9 1   ; var9 = 1
      69 [-]: JUMPIFNOTLT R8 R9 L9; goto L9 if var8 >= var1116238
...
L11:  84 [-]: JUMPIF R8 L22; goto L22 if var8
      ...
      92 [-]: JUMPIFEQ R10 R11 L12; goto L12 if var10 == var-553580219
...
L12:  95 [-]: NOT R8 R9    ; var8 = not var9
     ...
     101 [-]: JUMPIFNOTLE R4 R9 L19; goto L19 if var4 > var470025256
     102 [-]: ADDK R4 R4 K28; var4 = var4 + 0.40000000000000002
...
L15: 123 [-]: GETIMPORT R9 32; var9 = 0x83282188
     ...
     125 [-]: JUMPIFNOTLT R10 R9 L18; goto L18 if var10 >= var50413131
...
L19: 145 [-]: NAMECALL R9 R2 K34; var10 = var2; var9 = var2[0xD4CC05B4]
     ...
     147 [-]: JUMPIFEQ R8 R9 L22; goto L22 if var8 == var527126
     ...
     155 [-]: JUMPIFNOTLT R10 R9 L22; goto L22 if var10 >= var50413131
...
L 0:   6 [-]: JUMPIF R2 L6 ; goto L6 if var2
      ...
      12 [-]: JUMPIFNOTLT R3 R2 L6; goto L6 if var3 >= var50413131
