...
; Max Stack Size:  13
 ...
 73 [-]: NOT       R8 R8        ; R8 := not R8
 74 [-]: JMP       77           ; PC := 77
 75 [-]: LOADBOOL  R8 0 1       ; R8 := false; PC := 76
