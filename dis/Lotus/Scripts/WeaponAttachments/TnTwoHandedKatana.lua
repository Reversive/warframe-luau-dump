...
; Max Stack Size:  5
  ...
  8 [-]: JMP       38           ; PC := 38
  9 [-]: GETGLOBAL R1 K2        ; R1 := 0x771fea6a
 10 [-]: SELF      R2 R0 K3     ; R3 := R0; R2 := R0[0x3e65690d]
 11 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 12 [-]: LT        0 R1 R2      ; if R1 >= R2 then PC := 38
 13 [-]: JMP       38           ; PC := 38
 14 [-]: SELF      R1 R0 K4     ; R2 := R0; R1 := R0[0xe1dbaaca]
 15 [-]: GETGLOBAL R3 K2        ; R3 := 0x771fea6a
 16 [-]: CALL      R1 3 2       ; R1 := R1(R2,R3)
 17 [-]: SELF      R2 R1 K5     ; R3 := R1; R2 := R1[0xf2deaf69]
 18 [-]: GETGLOBAL R4 K6        ; R4 := gRevenantKatanaImpactBehaviorType
