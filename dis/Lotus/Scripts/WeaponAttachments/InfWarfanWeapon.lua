...
L 5:  29 [-]: GETTABLEKS R5 R2 K7 ["i"]
      ...
      31 [-]: GETIMPORT R5 10 [0x42DCC9F5]
      32 [-]: GETIMPORT R8 12 [0x67652851]
      33 [-]: CALL R8 0 1  
      34 [-]: GETIMPORT R9 14 [0xCB1118B4]
      35 [-]: DIV R7 R8 R9 
      36 [-]: SUB R6 R4 R7 
      37 [-]: LOADN R7 0   
      38 [-]: LOADN R8 1   
      39 [-]: CALL R5 3 1  
      40 [-]: MOVE R4 R5   
      41 [-]: GETIMPORT R7 17 ["UNLIT_ATTEN"]
      42 [-]: MOVE R8 R4   
      43 [-]: NAMECALL R5 R0 K18 [0x986D2AB8]
      44 [-]: CALL R5 3 0  
      45 [-]: GETIMPORT R7 20 [0x9BAFFFE3]
      46 [-]: GETIMPORT R8 22 [0x2DC24769]
      47 [-]: GETIMPORT R9 24 [0x769A5E6D]
      48 [-]: MOVE R10 R4  
      49 [-]: CALL R7 3 1  
      50 [-]: LOADB R8 1   
...
L 3:  24 [-]: GETTABLEKS R6 R3 K7 ["i"]
      ...
      26 [-]: GETIMPORT R6 10 [0x42DCC9F5]
      27 [-]: GETIMPORT R9 12 [0x67652851]
      28 [-]: CALL R9 0 1  
      29 [-]: GETIMPORT R10 14 [0xCB1118B4]
      30 [-]: DIV R8 R9 R10
      31 [-]: ADD R7 R5 R8 
      32 [-]: LOADN R8 0   
      33 [-]: LOADN R9 1   
      34 [-]: CALL R6 3 1  
      35 [-]: MOVE R5 R6   
      36 [-]: GETIMPORT R8 17 ["UNLIT_ATTEN"]
      37 [-]: MOVE R9 R5   
      38 [-]: NAMECALL R6 R0 K18 [0x986D2AB8]
      39 [-]: CALL R6 3 0  
      40 [-]: GETIMPORT R8 20 [0x9BAFFFE3]
      41 [-]: GETIMPORT R9 22 [0x2DC24769]
      42 [-]: GETIMPORT R10 24 [0x769A5E6D]
      43 [-]: MOVE R11 R5  
      44 [-]: CALL R8 3 1  
      45 [-]: LOADB R9 1   
...
L 4:  34 [-]: JUMPIF R4 L5 
      35 [-]: GETUPVAL R6 0
      36 [-]: GETIMPORT R7 11 ["EMPTY_SYMBOL"]
      37 [-]: GETIMPORT R8 13 ["ZERO_VECTOR"]
...
L 6:  47 [-]: JUMPIF R4 L7 
      ...
      51 [-]: CALL R4 3 0  
L 7:  52 [-]: GETIMPORT R4 20 [0x44797384]
      53 [-]: JUMPIFNOT R4 L8
      54 [-]: GETUPVAL R4 2
      55 [-]: MOVE R5 R0   
      56 [-]: CALL R4 1 0  
