...
L 0:   4 [-]: JUMPIF R2 L2 ; goto L2 if var2
      ...
      11 [-]: JUMPIFNOTLT R5 R3 L1; goto L1 if var5 >= var-184416955
...
L 1:  15 [-]: GETIMPORT R7 6; var7 = 0xA421AF95
      16 [-]: LOADK R8 K7  ; var8 = -0.0235
      17 [-]: GETIMPORT R9 9; var9 = 0x9BAFFFE3
      18 [-]: LOADK R10 K10; var10 = 0.40000000000000002
      19 [-]: LOADK R11 K11; var11 = 0.10000000000000001
...
L 1:   9 [-]: LOADB R5 0   ; var5 = false
      ...
      14 [-]: JUMPIFLT R3 R4 L2; goto L2 if var3 < var459598
      15 [-]: GETIMPORT R3 7; var3 = 0xDECFEEB3
      16 [-]: JUMPIFNOTEQ R1 R3 L4; goto L4 if var1 ~= var590926
...
L 5:  41 [-]: NAMECALL R6 R3 K18; var7 = var3; var6 = var3[0x7A7373F5]
      ...
      43 [-]: JUMPIFNOTEQ R4 R6 L6; goto L6 if var4 ~= var1607
      44 [-]: LOADN R6 0   ; var6 = 0
      45 [-]: JUMPIFNOTLT R6 R5 L6; goto L6 if var6 >= var1377870
