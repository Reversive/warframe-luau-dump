...
L 3:  23 [-]: NOT R4 R5    
      ...
      26 [-]: CALL R4 1 1  
L 4:  27 [-]: GETIMPORT R5 10 [0x5135C7A4]
      28 [-]: JUMPIFNOT R4 L6
      29 [-]: GETIMPORT R7 12 [0xC8F0C0E2]
      30 [-]: FASTCALL1 62 R7 L5
      31 [-]: GETIMPORT R6 6 [0x7B998233]
      32 [-]: CALL R6 1 1  
L 5:  33 [-]: JUMPIF R6 L6 
      34 [-]: GETIMPORT R5 12 [0xC8F0C0E2]
...
L 6:  35 [-]: RETURN R0 0  
L 7:  36 [-]: LOADN R5 1   
      37 [-]: GETIMPORT R6 14 [0x7F1BA612]
      38 [-]: LENGTH R3 R6 
      39 [-]: LOADN R4 1   
      40 [-]: FORNPREP R3 L10
L 8:  41 [-]: GETIMPORT R9 14 [0x7F1BA612]
...
L14:  76 [-]: JUMPIF R7 L15
      ...
      80 [-]: CALL R7 1 1  
      81 [-]: JUMPIFNOT R7 L16
L15:  82 [-]: GETIMPORT R7 22 [0x9C1F3B5A]
...
L17:  87 [-]: GETTABLEKS R5 R3 K18 ["Avatars"]
      88 [-]: LENGTH R4 R5 
      89 [-]: GETIMPORT R5 24 [0x866EF976]
      90 [-]: JUMPIFNOTLE R5 R4 L18
      91 [-]: GETIMPORT R4 24 [0x866EF976]
      92 [-]: JUMPXEQKN R4 K25 L18 [0]
      93 [-]: RETURN R0 0  
L18:  94 [-]: GETIMPORT R4 1 [0x89326C93]
     ...
     102 [-]: CALL R7 1 1  
     103 [-]: GETIMPORT R8 31 [0x20B7F774]
     104 [-]: MOVE R9 R7   
     105 [-]: NAMECALL R11 R1 K32 [0x8FA0B24F]
     106 [-]: CALL R11 1 1 
     107 [-]: SUB R10 R7 R11
     108 [-]: CALL R8 2 1  
     109 [-]: GETIMPORT R9 34 [0x0469F296]
     110 [-]: CALL R9 0 1  
     ...
     128 [-]: MOVE R14 R12 
     129 [-]: GETIMPORT R13 8 [0x7B998233]
     130 [-]: CALL R13 1 1 
...
L20: 133 [-]: LOADB R15 0  
     ...
     150 [-]: MOVE R16 R13 
     151 [-]: GETIMPORT R14 45 [0x23D5322F]
     152 [-]: CALL R14 2 0 
L21: 153 [-]: MOVE R16 R13 
     154 [-]: NAMECALL R14 R0 K46 [0x96585A66]
     155 [-]: CALL R14 2 0 
     156 [-]: GETIMPORT R14 49 [0x35C16153]
     157 [-]: CALL R14 0 1 
     158 [-]: LOADN R17 0  
     159 [-]: LOADB R18 1  
     ...
     170 [-]: CALL R15 2 0 
     171 [-]: GETIMPORT R17 55 [0x8E471DA2]
     172 [-]: GETIMPORT R18 57 ["EMPTY_SYMBOL"]
     173 [-]: GETIMPORT R19 59 ["ZERO_VECTOR"]
     174 [-]: GETIMPORT R20 61 ["ZERO_ROTATION"]
     175 [-]: MOVE R21 R0  
     176 [-]: NAMECALL R15 R13 K62 [0x47901F07]
     177 [-]: CALL R15 6 0 
     178 [-]: GETIMPORT R15 64 [0x4E8AC6BD]
     179 [-]: SETUPVAL R15 1
     180 [-]: SETUPVAL R3 2
     181 [-]: SETUPVAL R0 3
     182 [-]: GETIMPORT R17 34 [0x0469F296]
...
L 1:  14 [-]: JUMPIF R3 L2 
      ...
      17 [-]: CALL R3 2 0  
L 2:  18 [-]: GETIMPORT R3 6 [0x89326C93]
      19 [-]: GETIMPORT R5 8 [0x84FD0E75]
      20 [-]: NAMECALL R6 R0 K9 [0xEF8E8F7F]
      21 [-]: CALL R6 1 1  
      22 [-]: GETIMPORT R7 11 ["ZERO_ROTATION"]
      23 [-]: MOVE R8 R2   
...
L 7:  44 [-]: JUMPIF R6 L11
      ...
      48 [-]: GETIMPORT R8 13 ["gLotusWeaponAttachmentType"]
...
L 8:  55 [-]: GETTABLE R10 R6 R9
      56 [-]: GETIMPORT R12 16 [0xC10FDAA5]
      57 [-]: GETIMPORT R13 18 ["EMPTY_SYMBOL"]
      58 [-]: GETIMPORT R14 20 ["ZERO_VECTOR"]
      59 [-]: GETIMPORT R15 22 ["ZERO_ROTATION"]
      60 [-]: MOVE R16 R2  
...
L10:  66 [-]: MULK R8 R3 K25 [0.94999999999999996]
      ...
      68 [-]: CALL R6 2 0  
      69 [-]: GETIMPORT R6 1 [0xCBD666E1]
      70 [-]: LOADN R7 0   
      71 [-]: CALL R6 1 0  
      72 [-]: GETIMPORT R7 29 [0x67652851]
      73 [-]: CALL R7 0 1  
