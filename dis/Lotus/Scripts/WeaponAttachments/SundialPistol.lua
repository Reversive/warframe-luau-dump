...
; Max Stack Size:  11
      ...
      10 [-]: CALL R4 1 1  
L 0:  11 [-]: JUMPIF R4 L2 
      12 [-]: GETIMPORT R4 9 ["sundialPistol"]
      13 [-]: JUMPXEQKNIL R4 L1 NOT
      14 [-]: GETIMPORT R4 10 ["_T"]
      15 [-]: NEWTABLE R5 0 0
      16 [-]: SETTABLEKS R5 R4 K8 ["sundialPistol"]
L 1:  17 [-]: GETIMPORT R4 9 ["sundialPistol"]
...
L 6:  38 [-]: JUMPIF R4 L7 
      ...
      47 [-]: GETIMPORT R5 22 [0x89326C93]
      48 [-]: GETIMPORT R7 15 [0x5135C7A4]
...
L 1:   8 [-]: NAMECALL R2 R1 K3 [0x5163741E]
      ...
      13 [-]: CALL R3 1 1  
L 2:  14 [-]: JUMPIF R3 L6 
      15 [-]: GETIMPORT R3 6 ["sundialPistol"]
      16 [-]: JUMPXEQKNIL R3 L3 NOT
      17 [-]: GETIMPORT R3 7 ["_T"]
      18 [-]: NEWTABLE R4 0 0
      19 [-]: SETTABLEKS R4 R3 K5 ["sundialPistol"]
L 3:  20 [-]: NAMECALL R3 R2 K8 [0x388577D5]
      21 [-]: CALL R3 1 1  
      22 [-]: GETIMPORT R5 6 ["sundialPistol"]
      23 [-]: GETTABLE R4 R5 R3
      24 [-]: JUMPXEQKNIL R4 L4 NOT
      25 [-]: GETIMPORT R4 6 ["sundialPistol"]
      26 [-]: LOADN R5 1   
      27 [-]: SETTABLE R5 R4 R3
      28 [-]: RETURN R0 0  
L 4:  29 [-]: GETIMPORT R4 6 ["sundialPistol"]
      30 [-]: GETIMPORT R6 10 [0x767ADCAC]
      31 [-]: GETIMPORT R9 6 ["sundialPistol"]
      32 [-]: GETTABLE R8 R9 R3
      33 [-]: ADDK R7 R8 K11 [1]
      34 [-]: FASTCALL2 19 R6 R7 L5
      35 [-]: GETIMPORT R5 14 [0xAC1B386A]
      36 [-]: CALL R5 2 1  
...
L 4:  25 [-]: JUMPIFNOT R4 L5
      26 [-]: RETURN R0 0  
L 5:  27 [-]: GETIMPORT R4 10 ["sundialPistol"]
      28 [-]: JUMPXEQKNIL R4 L6 NOT
      29 [-]: GETIMPORT R4 11 ["_T"]
      30 [-]: NEWTABLE R5 0 0
      31 [-]: SETTABLEKS R5 R4 K9 ["sundialPistol"]
L 6:  32 [-]: GETIMPORT R4 10 ["sundialPistol"]
      ...
      42 [-]: CALL R4 3 1  
      43 [-]: GETIMPORT R7 16 [0x3ED1DBC4]
      44 [-]: LOADB R8 0   
      45 [-]: LOADB R9 0   
      46 [-]: LOADN R10 0  
      47 [-]: GETIMPORT R11 18 [0x0469F296]
      48 [-]: CALL R11 0 1 
      49 [-]: MOVE R12 R4  
...
L 2:  12 [-]: NAMECALL R1 R0 K6 [0x2B54251B]
      ...
      17 [-]: CALL R2 1 1  
L 3:  18 [-]: JUMPIF R2 L4 
      19 [-]: GETIMPORT R4 8 ["gLotusWeaponAttachmentType"]
...
L 9:  43 [-]: GETUPVAL R4 0
      44 [-]: MOVE R5 R0   
      45 [-]: CALL R4 1 0  
      46 [-]: GETIMPORT R4 3 [0xBE190284]
      47 [-]: GETIMPORT R6 14 ["gLotusHubGameRulesType"]
      48 [-]: NAMECALL R4 R4 K9 [0xF2DEAF69]
      49 [-]: CALL R4 2 1  
      50 [-]: JUMPIFNOT R4 L10
      51 [-]: RETURN R0 0  
L10:  52 [-]: GETIMPORT R4 16 [0x00046924]
      53 [-]: CALL R4 0 1  
      54 [-]: LOADB R5 1   
      55 [-]: GETIMPORT R6 19 ["sundialPistol"]
      56 [-]: JUMPXEQKNIL R6 L11 NOT
      57 [-]: GETIMPORT R6 20 ["_T"]
      58 [-]: NEWTABLE R7 0 0
      59 [-]: SETTABLEKS R7 R6 K18 ["sundialPistol"]
L11:  60 [-]: GETIMPORT R7 19 ["sundialPistol"]
      61 [-]: NAMECALL R8 R3 K21 [0x388577D5]
      62 [-]: CALL R8 1 1  
      63 [-]: GETTABLE R6 R7 R8
      64 [-]: JUMPXEQKNIL R6 L12 NOT
      65 [-]: GETIMPORT R6 19 ["sundialPistol"]
...
L14:  79 [-]: JUMPIF R6 L17
      80 [-]: GETIMPORT R6 23 [0x42DCC9F5]
      81 [-]: GETIMPORT R9 19 ["sundialPistol"]
      82 [-]: NAMECALL R10 R3 K21 [0x388577D5]
      83 [-]: CALL R10 1 1 
      84 [-]: GETTABLE R8 R9 R10
      85 [-]: GETIMPORT R9 25 [0x53F338C0]
      86 [-]: DIV R7 R8 R9 
      87 [-]: LOADN R8 0   
      88 [-]: LOADN R9 1   
      89 [-]: CALL R6 3 1  
      90 [-]: GETIMPORT R7 19 ["sundialPistol"]
      91 [-]: NAMECALL R8 R3 K21 [0x388577D5]
      92 [-]: CALL R8 1 1  
      93 [-]: GETIMPORT R9 23 [0x42DCC9F5]
      94 [-]: GETIMPORT R12 19 ["sundialPistol"]
      95 [-]: NAMECALL R13 R3 K21 [0x388577D5]
      96 [-]: CALL R13 1 1 
      97 [-]: GETTABLE R11 R12 R13
      98 [-]: GETIMPORT R13 27 [0xF1E60F76]
      99 [-]: GETIMPORT R14 29 [0x67652851]
     100 [-]: CALL R14 0 1 
     101 [-]: MUL R12 R13 R14
     102 [-]: SUB R10 R11 R12
     103 [-]: LOADN R11 0  
     104 [-]: GETIMPORT R12 31 [0x767ADCAC]
     105 [-]: CALL R9 3 1  
     106 [-]: SETTABLE R9 R7 R8
     107 [-]: GETIMPORT R7 33 [0x5DB3CE80]
     108 [-]: GETIMPORT R8 35 [0xAB6459D1]
     109 [-]: GETIMPORT R9 37 [0xE5156633]
     110 [-]: MOVE R10 R6  
     111 [-]: CALL R7 3 1  
     112 [-]: GETIMPORT R8 39 [0xAE2294FA]
     113 [-]: MOVE R9 R7   
     114 [-]: CALL R8 1 1  
     115 [-]: LOADN R9 0   
...
L15: 118 [-]: NAMECALL R8 R0 K40 [0x89531483]
     119 [-]: CALL R8 1 1  
     120 [-]: GETIMPORT R10 29 [0x67652851]
     121 [-]: CALL R10 0 1 
     122 [-]: MUL R9 R7 R10
     ...
     138 [-]: CALL R10 3 0 
     139 [-]: LOADB R5 0   
L16: 140 [-]: GETIMPORT R8 1 [0xCBD666E1]
     141 [-]: LOADN R9 0   
     142 [-]: CALL R8 1 0  
     143 [-]: JUMPBACK L12 
L17: 144 [-]: RETURN R0 0  
