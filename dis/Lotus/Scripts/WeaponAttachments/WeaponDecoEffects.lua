...
L 8:  40 [-]: JUMPIF R4 L9 
      ...
      43 [-]: CALL R4 2 1  
      44 [-]: JUMPIF R4 L10
L 9:  45 [-]: GETIMPORT R4 3 [0xBE190284]
      46 [-]: GETIMPORT R6 14 ["gLotusHubGameRulesType"]
      47 [-]: NAMECALL R4 R4 K9 [0xF2DEAF69]
      48 [-]: CALL R4 2 1  
      49 [-]: JUMPIFNOT R4 L11
L10:  50 [-]: GETIMPORT R6 16 [0x53264980]
      51 [-]: GETIMPORT R7 18 [0x0E1EBC6B]
...
L14:  65 [-]: JUMPIF R5 L16
      ...
      67 [-]: CALL R5 1 1  
      68 [-]: MOVE R4 R5   
      69 [-]: GETIMPORT R5 22 [0xB9338617]
      70 [-]: JUMPIFNOT R5 L15
      71 [-]: LOADN R5 1   
      72 [-]: SUB R4 R5 R4 
L15:  73 [-]: GETIMPORT R7 16 [0x53264980]
      74 [-]: MOVE R8 R4   
      75 [-]: NAMECALL R5 R0 K19 [0x986D2AB8]
      76 [-]: CALL R5 3 0  
      77 [-]: GETIMPORT R5 1 [0xCBD666E1]
      78 [-]: LOADN R6 0   
      79 [-]: CALL R5 1 0  
      80 [-]: JUMPBACK L12 
L16:  81 [-]: RETURN R0 0  
...
; Max Stack Size:  7
       ...
       6 [-]: CALL R2 1 1  
L 0:   7 [-]: JUMPIF R2 L1 
       8 [-]: GETIMPORT R4 6 [0x5181F53E]
       9 [-]: GETIMPORT R5 6 [0x5181F53E]
      10 [-]: LOADB R6 0   
...
; Max Stack Size:  9
       ...
       3 [-]: CALL R1 1 1  
L 0:   4 [-]: JUMPIF R1 L1 
       5 [-]: GETIMPORT R3 3 ["gLotusWeaponAttachmentType"]
       6 [-]: NAMECALL R1 R0 K4 [0xF2DEAF69]
       7 [-]: CALL R1 2 1  
       8 [-]: JUMPIF R1 L2 
L 1:   9 [-]: RETURN R0 0  
L 2:  10 [-]: GETIMPORT R3 6 [0xD69210B8]
...
L 3:  15 [-]: NAMECALL R1 R0 K8 [0x73A8846A]
      16 [-]: CALL R1 1 1  
      17 [-]: GETIMPORT R4 6 [0xD69210B8]
      18 [-]: GETIMPORT R5 10 ["EMPTY_SYMBOL"]
      19 [-]: GETIMPORT R6 12 [0x3A3A4107]
      20 [-]: GETIMPORT R7 14 [0x49D9EC5C]
      21 [-]: MOVE R8 R1   
