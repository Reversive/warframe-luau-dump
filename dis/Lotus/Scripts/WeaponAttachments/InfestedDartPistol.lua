...
L 5:  28 [-]: NAMECALL R3 R2 K6 [0x388577D5]
      29 [-]: CALL R3 1 1  
      30 [-]: GETIMPORT R4 9 ["infestedDartPistolEquipped"]
      31 [-]: JUMPXEQKNIL R4 L6 NOT
      32 [-]: GETIMPORT R4 10 ["_T"]
      33 [-]: NEWTABLE R5 0 0
      34 [-]: SETTABLEKS R5 R4 K8 ["infestedDartPistolEquipped"]
L 6:  35 [-]: GETIMPORT R4 9 ["infestedDartPistolEquipped"]
      36 [-]: LOADB R5 0   
      37 [-]: SETTABLE R5 R4 R3
      38 [-]: GETIMPORT R6 12 [0x4FA391B2]
      39 [-]: LOADB R7 1   
      40 [-]: LOADB R8 0   
      41 [-]: LOADN R9 0   
...
L 8:  57 [-]: GETIMPORT R6 16 [0x8A827522]
      58 [-]: LOADB R7 0   
      59 [-]: LOADB R8 1   
      60 [-]: LOADN R9 0   
...
L 7:  38 [-]: JUMPIFNOT R5 L8
      ...
      46 [-]: MOVE R4 R5   
      47 [-]: JUMPBACK L6  
L 8:  48 [-]: GETIMPORT R5 11 ["infestedDartPistolEquipped"]
      49 [-]: JUMPXEQKNIL R5 L9 NOT
      50 [-]: GETIMPORT R5 12 ["_T"]
      51 [-]: NEWTABLE R6 0 0
      52 [-]: SETTABLEKS R6 R5 K10 ["infestedDartPistolEquipped"]
L 9:  53 [-]: GETIMPORT R6 11 ["infestedDartPistolEquipped"]
      54 [-]: GETTABLE R5 R6 R3
      55 [-]: JUMPXEQKNIL R5 L10
      56 [-]: GETIMPORT R6 11 ["infestedDartPistolEquipped"]
      57 [-]: GETTABLE R5 R6 R3
      58 [-]: JUMPIFNOT R5 L10
      59 [-]: RETURN R0 0  
L10:  60 [-]: GETIMPORT R5 11 ["infestedDartPistolEquipped"]
      61 [-]: LOADB R6 1   
      62 [-]: SETTABLE R6 R5 R3
      63 [-]: LOADB R5 0   
      64 [-]: LOADN R8 1   
      65 [-]: GETIMPORT R9 14 [0x12D880B1]
      66 [-]: LENGTH R6 R9 
      67 [-]: LOADN R7 1   
      68 [-]: FORNPREP R6 L13
L11:  69 [-]: GETIMPORT R12 14 [0x12D880B1]
...
L13:  77 [-]: JUMPIFNOT R5 L14
      ...
      83 [-]: CALL R6 5 0  
      84 [-]: RETURN R0 0  
L14:  85 [-]: GETIMPORT R8 20 [0xEBF6B9EB]
      86 [-]: LOADB R9 0   
      87 [-]: LOADB R10 1  
      88 [-]: LOADN R11 0  
...
L 6:  33 [-]: NAMECALL R3 R2 K7 [0x388577D5]
      34 [-]: CALL R3 1 1  
      35 [-]: GETIMPORT R4 10 ["infestedDartPistolEquipped"]
      36 [-]: LOADB R5 0   
      37 [-]: SETTABLE R5 R4 R3
      38 [-]: GETIMPORT R6 12 [0xA4BCE0CF]
      39 [-]: LOADB R7 1   
      40 [-]: LOADB R8 0   
      41 [-]: LOADN R9 0   
      42 [-]: NAMECALL R4 R0 K13 [0x5D985C7E]
