...
; Max Stack Size:  6
 ...
 31 [-]: SETGLOBAL R5 K9        ; OnBehaviorChange := R5
...
; Max Stack Size:  15
 ...
 77 [-]: SETTABLE  R9 K20 R10   ; R9[0xab2ae122] := R10
...
; Max Stack Size:  5
  ...
  7 [-]: JMP       13           ; PC := 13
  8 [-]: SELF      R2 R1 K2     ; R3 := R1; R2 := R1[0x72d56f6b]
  9 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 10 [-]: SELF      R2 R2 K3     ; R3 := R2; R2 := R2[0x2d90ee66]
