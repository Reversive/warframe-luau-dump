...
; Max Stack Size:  7
       ...
       1 [-]: JUMPIFNOTLT R1 R0 L0; goto L0 if var1 >= var65863
       2 [-]: LOADN R1 1   ; var1 = 1
       3 [-]: RETURN R1 1  ; 
...
; Max Stack Size:  9
       ...
       2 [-]: JUMPIFNOTLT R3 R2 L0; goto L0 if var3 >= var65863
       3 [-]: LOADN R1 1   ; var1 = 1
       4 [-]: JUMP L2      ; goto L2
...
L 5:  38 [-]: GETIMPORT R4 7; var4 = _T["WaterFightPressure"]
      ...
      46 [-]: DIVK R9 R6 K11; var9 = var6 / 200
...
L 6:  50 [-]: MOVE R3 R4   ; var3 = var4
      ...
      52 [-]: DIVK R8 R5 K16; var8 = var5 / 200
...
L 9: 103 [-]: MOVE R8 R3   ; var8 = var3
     ...
     106 [-]: JUMPIFNOTLT R11 R10 L10; goto L10 if var11 >= var67911
...
L15: 136 [-]: GETIMPORT R16 48; var16 = 0xF8005A8F
     ...
     155 [-]: LOADK R16 K55; var16 = 0.11
     156 [-]: LOADK R17 K56; var17 = 0.14999999999999999
...
L16: 164 [-]: GETIMPORT R16 59; var16 = 0xF36115A7
     ...
     169 [-]: LOADK R15 K56; var15 = 0.14999999999999999
...
L17: 188 [-]: FORGLOOP R9 L15 2 [inext]; 
     ...
     190 [-]: JUMPIFNOTLE R9 R3 L18; goto L18 if var9 > var4131662
...
L18: 205 [-]: LOADN R9 60  ; var9 = 60
     206 [-]: JUMPIFNOTLE R9 R3 L19; goto L19 if var9 > var4918094
...
L19: 221 [-]: JUMPIFNOT R7 L22; goto L22 if not var7
     ...
     229 [-]: DIVK R12 R9 K16; var12 = var9 / 200
...
L 1:  13 [-]: JUMPIF R3 L3 ; goto L3 if var3
      ...
      26 [-]: JUMPIFNOTLE R4 R3 L2; goto L2 if var4 > var787790
