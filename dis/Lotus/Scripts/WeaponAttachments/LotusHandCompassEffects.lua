...
; Max Stack Size:  11
       ...
       6 [-]: MULK R2 R3 K2; var2 = var3 * 0.97999999999999998
...
L 2:  45 [-]: JUMPIFNOTLT R1 R2 L5; goto L5 if var1 >= var50347595
...
L 2:  31 [-]: LOADN R4 1   ; var4 = 1
      32 [-]: JUMPIFNOTLT R1 R4 L6; goto L6 if var1 >= var285279233
      33 [-]: DIVK R4 R1 K17; var4 = var1 / 1
...
L 3:  49 [-]: JUMPIF R8 L38; goto L38 if var8
      ...
      59 [-]: JUMPIFNOTLT R9 R8 L7; goto L7 if var9 >= var2887
...
L13: 129 [-]: LOADN R14 1  ; var14 = 1
     130 [-]: JUMPIFNOTLT R5 R14 L29; goto L29 if var5 >= var50347595
...
L14: 135 [-]: JUMPIF R14 L29; goto L29 if var14
     ...
     152 [-]: LOADK R14 K50; var14 = 0.80000000000000004
     153 [-]: JUMPIFNOTLT R14 R5 L15; goto L15 if var14 >= var-782777
...
L15: 156 [-]: NAMECALL R14 R0 K26; var15 = var0; var14 = var0[0xFF7A9352]
     ...
     160 [-]: JUMPIFNOTLT R14 R8 L26; goto L26 if var14 >= var3611
...
L17: 175 [-]: JUMPIF R18 L18; goto L18 if var18
     ...
     182 [-]: DIVK R18 R19 K51; var18 = var19 / 174
     183 [-]: SETTABLE R18 R6 R17; var18[var6] = var17
     184 [-]: SUBK R18 R8 K27; var18 = var8 - 1
     185 [-]: JUMPIFNOTEQ R17 R18 L19; goto L19 if var17 ~= var69147
...
L22: 223 [-]: LOADK R18 K60; var18 = 0.69999999999999996
     224 [-]: JUMPIFNOTLT R18 R5 L24; goto L24 if var18 >= var286069303
...
L29: 274 [-]: NAMECALL R14 R0 K26; var15 = var0; var14 = var0[0xFF7A9352]
     ...
     278 [-]: JUMPIFNOTLT R14 R8 L31; goto L31 if var14 >= var4167
...
L 2:  29 [-]: LOADN R4 0   ; var4 = 0
      30 [-]: JUMPIFNOTLT R4 R3 L4; goto L4 if var4 >= var50478667
