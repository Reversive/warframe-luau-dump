...
L 4:  21 [-]: GETTABLE R7 R2 R6
      22 [-]: GETIMPORT R9 5 ["gSequencerType"]
...
L 9:  40 [-]: JUMPIFNOT R6 L10
      ...
      44 [-]: CALL R6 1 1  
      45 [-]: MOVE R4 R6   
      46 [-]: GETIMPORT R6 9 [0x67652851]
      47 [-]: CALL R6 0 1  
      48 [-]: SUB R5 R5 R6 
      49 [-]: GETIMPORT R6 11 [0xCBD666E1]
      50 [-]: LOADN R7 0   
      51 [-]: CALL R6 1 0  
      52 [-]: JUMPBACK L8  
L10:  53 [-]: LOADN R6 0   
      54 [-]: LOADK R7 K12 [0.10000000000000001]
      55 [-]: GETIMPORT R8 14 [0x9BA7909F]
      56 [-]: GETIMPORT R10 16 [0xEEF96333]
      57 [-]: NAMECALL R8 R8 K17 [0xBCFB64AB]
      58 [-]: CALL R8 2 1  
      59 [-]: GETIMPORT R9 19 [0x76EA806B]
      60 [-]: LOADN R11 0  
...
L13:  76 [-]: JUMPIF R11 L22
      ...
      86 [-]: CALL R12 4 0 
      87 [-]: GETIMPORT R12 25 [0x47AA89C3]
...
L14:  96 [-]: JUMPIF R12 L15
      97 [-]: GETIMPORT R14 27 [0x5537D2FA]
      98 [-]: GETIMPORT R15 29 ["EMPTY_SYMBOL"]
...
L16: 105 [-]: JUMPIF R12 L21
     106 [-]: GETIMPORT R12 33 ["GetFlashMarker"]
     107 [-]: JUMPXEQKNIL R12 L21
     108 [-]: GETIMPORT R12 33 ["GetFlashMarker"]
     109 [-]: MOVE R13 R0  
     110 [-]: CALL R12 1 1 
...
L17: 115 [-]: JUMPIF R13 L21
     ...
     121 [-]: GETIMPORT R14 38 [0x38F10E85]
     122 [-]: MOVE R15 R8  
...
L19: 146 [-]: MOVE R16 R13 
     ...
     150 [-]: CALL R14 4 0 
L20: 151 [-]: GETIMPORT R14 45 [0x25312C9B]
     152 [-]: MOVE R15 R8  
     153 [-]: MOVE R16 R13 
     154 [-]: LOADN R17 0  
     ...
     167 [-]: MOVE R0 R13  
     168 [-]: CALL R14 8 0 
L21: 169 [-]: GETIMPORT R12 11 [0xCBD666E1]
     170 [-]: LOADN R13 0  
     171 [-]: CALL R12 1 0 
     172 [-]: JUMPBACK L12 
L22: 173 [-]: RETURN R0 0  
