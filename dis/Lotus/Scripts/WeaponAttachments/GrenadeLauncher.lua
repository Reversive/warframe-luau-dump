...
L 2:  14 [-]: GETTABLE R6 R1 R5; var6 = var1[var5]
      ...
      21 [-]: JUMPIFEQ R6 R7 L3; goto L3 if var6 == var461334
...
L 4:  29 [-]: NAMECALL R7 R6 K10; var8 = var6; var7 = var6[0xD2715720]
      ...
      32 [-]: JUMPIFNOTLT R8 R7 L5; goto L5 if var8 >= var1073874757
...
L 4:  33 [-]: NAMECALL R7 R6 K10; var8 = var6; var7 = var6[0xD2715720]
      ...
      36 [-]: JUMPIFNOTLT R8 R7 L5; goto L5 if var8 >= var788302
      37 [-]: GETIMPORT R7 12; var7 = 0xCBD666E1
      38 [-]: GETIMPORT R8 14; var8 = 0xC163F229
      39 [-]: LOADN R9 0   ; var9 = 0
      40 [-]: LOADK R10 K15; var10 = 0.29999999999999999
...
L 7:  41 [-]: NAMECALL R6 R5 K14; var7 = var5; var6 = var5[0x697019D0]
      ...
      45 [-]: JUMPIFNOTLT R6 R2 L8; goto L8 if var6 >= var722510
...
L 8:  54 [-]: LOADN R6 0   ; var6 = 0
      55 [-]: JUMPIFNOTLT R6 R4 L16; goto L16 if var6 >= var1677723205
...
L 9:  67 [-]: JUMPIF R8 L11; goto L11 if var8
      ...
      72 [-]: JUMPIFNOTLT R8 R6 L11; goto L11 if var8 >= var2631
...
L13: 100 [-]: JUMPIF R12 L15; goto L15 if var12
     ...
     105 [-]: JUMPIFNOTLT R12 R6 L15; goto L15 if var12 >= var3655
...
L24: 151 [-]: GETIMPORT R8 11; var8 = 0xCBD666E1
     152 [-]: LOADK R9 K27 ; var9 = 0.20000000000000001
...
L 2:  21 [-]: GETTABLE R9 R1 R8; var9 = var1[var8]
      22 [-]: JUMPIFLE R8 R5 L3; goto L3 if var8 <= var16780059
