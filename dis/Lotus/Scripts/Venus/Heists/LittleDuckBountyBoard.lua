...
L 3:  13 [-]: GETIMPORT R0 8 [0x89326C93]
      ...
      15 [-]: CALL R0 1 1  
      16 [-]: JUMPIF R0 L4 
      17 [-]: GETIMPORT R0 6 [0xCBD666E1]
      18 [-]: LOADN R1 0   
      19 [-]: CALL R0 1 0  
      20 [-]: JUMPBACK L3  
L 4:  21 [-]: LOADN R0 0   
L 5:  22 [-]: GETIMPORT R2 12 ["ActiveJob"]
...
L 6:  26 [-]: JUMPIFNOT R1 L7
      ...
      30 [-]: LOADN R2 0   
      31 [-]: CALL R1 1 0  
      32 [-]: GETIMPORT R1 14 [0x67652851]
      33 [-]: CALL R1 0 1  
      34 [-]: ADD R0 R0 R1 
      35 [-]: JUMPBACK L5  
L 7:  36 [-]: GETIMPORT R1 12 ["ActiveJob"]
      37 [-]: JUMPIFNOT R1 L8
      38 [-]: GETIMPORT R1 16 ["jobType"]
      39 [-]: GETIMPORT R3 18 [0x61A8CDEA]
      40 [-]: NAMECALL R1 R1 K19 [0xF2DEAF69]
      41 [-]: CALL R1 2 1  
      42 [-]: JUMPIF R1 L9 
L 8:  43 [-]: RETURN R0 0  
L 9:  44 [-]: GETIMPORT R2 12 ["ActiveJob"]
      45 [-]: FASTCALL1 62 R2 L10
      46 [-]: GETIMPORT R1 3 [0x7B998233]
      47 [-]: CALL R1 1 1  
L10:  48 [-]: JUMPIF R1 L11
      49 [-]: GETIMPORT R1 6 [0xCBD666E1]
      50 [-]: LOADN R2 0   
      51 [-]: CALL R1 1 0  
      52 [-]: JUMPBACK L9  
L11:  53 [-]: GETIMPORT R1 8 [0x89326C93]
...
L13:  75 [-]: FORGLOOP R3 L12 2 [inext]
      76 [-]: GETIMPORT R3 8 [0x89326C93]
      77 [-]: GETIMPORT R5 21 [0x0469F296]
