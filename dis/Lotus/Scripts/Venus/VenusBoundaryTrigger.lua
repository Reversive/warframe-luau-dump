...
; Max Stack Size:  25
      ...
      13 [-]: CALL R5 1 1  
      14 [-]: GETIMPORT R7 11 ["boundaryEffects"]
      15 [-]: FASTCALL1 62 R7 L0
      16 [-]: GETIMPORT R6 13 [0x7B998233]
      17 [-]: CALL R6 1 1  
L 0:  18 [-]: JUMPIFNOT R6 L1
      19 [-]: GETIMPORT R6 14 ["_T"]
      20 [-]: NEWTABLE R7 0 0
      21 [-]: SETTABLEKS R7 R6 K10 ["boundaryEffects"]
L 1:  22 [-]: GETIMPORT R6 16 [0x20B7F774]
      23 [-]: NAMECALL R7 R1 K17 [0xD1586535]
      24 [-]: CALL R7 1 1  
      25 [-]: GETIMPORT R8 19 ["ZERO_VECTOR"]
      26 [-]: CALL R6 2 1  
      27 [-]: LOADNIL R7   
      28 [-]: NAMECALL R8 R1 K20 [0xA5E492D4]
      29 [-]: CALL R8 1 1  
      30 [-]: JUMPIFNOT R8 L3
      31 [-]: GETIMPORT R10 11 ["boundaryEffects"]
      32 [-]: GETTABLE R9 R10 R4
      33 [-]: FASTCALL1 62 R9 L2
      34 [-]: GETIMPORT R8 13 [0x7B998233]
      35 [-]: CALL R8 1 1  
L 2:  36 [-]: JUMPIFNOT R8 L4
      37 [-]: GETIMPORT R8 11 ["boundaryEffects"]
      38 [-]: GETIMPORT R11 22 [0x5C142C71]
      39 [-]: GETIMPORT R12 24 ["EMPTY_SYMBOL"]
      ...
      46 [-]: CALL R8 1 1  
      47 [-]: MOVE R7 R8   
      48 [-]: GETIMPORT R8 29 [0x6BD52413]
      49 [-]: JUMPIFNOT R8 L4
      50 [-]: GETIMPORT R8 31 ["ShowImpactMessage"]
      51 [-]: GETIMPORT R9 33 [0x603636AD]
...
L 4:  64 [-]: MOVE R10 R3  
      ...
      66 [-]: CALL R8 2 1  
      67 [-]: GETIMPORT R9 37 [0xA421AF95]
      68 [-]: CALL R9 0 1  
      69 [-]: GETIMPORT R10 37 [0xA421AF95]
      70 [-]: CALL R10 0 1 
      71 [-]: GETIMPORT R11 7 [0x89326C93]
      72 [-]: NAMECALL R11 R11 K8 [0x7C1A0374]
      73 [-]: CALL R11 1 1 
L 5:  74 [-]: FASTCALL1 62 R2 L6
      75 [-]: MOVE R13 R2  
      76 [-]: GETIMPORT R12 13 [0x7B998233]
      77 [-]: CALL R12 1 1 
L 6:  78 [-]: JUMPIF R12 L17
      79 [-]: GETIMPORT R13 11 ["boundaryEffects"]
      80 [-]: FASTCALL1 62 R13 L7
      81 [-]: GETIMPORT R12 13 [0x7B998233]
      82 [-]: CALL R12 1 1 
L 7:  83 [-]: JUMPIF R12 L17
      84 [-]: GETIMPORT R14 11 ["boundaryEffects"]
      85 [-]: GETTABLE R13 R14 R4
      86 [-]: FASTCALL1 62 R13 L8
      87 [-]: GETIMPORT R12 13 [0x7B998233]
      88 [-]: CALL R12 1 1 
L 8:  89 [-]: JUMPIF R12 L17
      ...
      93 [-]: MOVE R14 R12 
      94 [-]: GETIMPORT R13 13 [0x7B998233]
      95 [-]: CALL R13 1 1 
L 9:  96 [-]: JUMPIF R13 L16
      97 [-]: JUMPIFEQ R12 R3 L10
      98 [-]: GETIMPORT R13 1 [0xD644C2F1]
...
L10: 105 [-]: MOVE R17 R3  
     ...
     110 [-]: GETIMPORT R15 11 ["boundaryEffects"]
     ...
     116 [-]: LOADK R19 K42 [2]
     117 [-]: GETIMPORT R17 45 [0xA40531D8]
     118 [-]: CALL R17 2 -1
L11: 119 [-]: NAMECALL R14 R14 K46 [0x986D2AB8]
     120 [-]: CALL R14 -1 0
     121 [-]: GETIMPORT R14 49 [0xE83472E3]
     122 [-]: GETIMPORT R16 11 ["boundaryEffects"]
     123 [-]: GETTABLE R15 R16 R4
     124 [-]: LOADN R17 1  
     125 [-]: SUB R16 R17 R13
     126 [-]: CALL R14 2 0 
     127 [-]: GETTABLEKS R14 R11 K50 ["postProcess"]
     128 [-]: GETIMPORT R16 52 [0x9BAFFFE3]
     129 [-]: LOADN R17 10 
     130 [-]: LOADN R18 0  
     131 [-]: MOVE R19 R13 
     132 [-]: CALL R16 3 -1
...
L14: 170 [-]: JUMPIF R14 L15
     ...
     173 [-]: MUL R16 R17 R13
     174 [-]: ADD R14 R15 R16
     175 [-]: GETIMPORT R15 64 [0xF6C6E505]
     176 [-]: NAMECALL R16 R12 K65 [0xEEA7F8C4]
     177 [-]: CALL R16 1 -1
     178 [-]: CALL R15 -1 1
     179 [-]: MOVE R9 R15  
     180 [-]: GETIMPORT R18 67 [0x42DCC9F5]
     181 [-]: LOADK R21 K62 [0.5]
     182 [-]: GETIMPORT R22 69 [0x4FD57545]
     183 [-]: MOVE R23 R9  
     184 [-]: MOVE R24 R10 
     185 [-]: CALL R22 2 1 
     186 [-]: MUL R20 R21 R22
...
L15: 195 [-]: JUMPIFEQ R13 R8 L16
     ...
     198 [-]: GETIMPORT R14 74 [0x3D106989]
     199 [-]: LOADK R15 K75 ["Avatar not in trigger, can maybe hide FX..."]
     200 [-]: CALL R14 1 0 
L16: 201 [-]: GETIMPORT R13 77 [0xCBD666E1]
     202 [-]: LOADN R14 0  
     203 [-]: CALL R13 1 0 
...
L 3:  43 [-]: GETIMPORT R4 19 [0x6BD52413]
      44 [-]: JUMPIFNOT R4 L4
      45 [-]: GETIMPORT R4 21 ["HideImpactMessage"]
      46 [-]: CALL R4 0 0  
L 4:  47 [-]: RETURN R0 0  
