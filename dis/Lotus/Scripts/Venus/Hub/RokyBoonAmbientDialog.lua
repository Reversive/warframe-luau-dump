...
L 0:   4 [-]: JUMPIFNOT R0 L1
       ...
       7 [-]: LOADN R1 0   
       8 [-]: JUMPIFLT R1 R0 L1
       9 [-]: GETIMPORT R0 8 ["CurrentConversation"]
      10 [-]: JUMPIFNOT R0 L2
L 1:  11 [-]: RETURN R0 0  
L 2:  12 [-]: NEWTABLE R0 0 0
      13 [-]: GETIMPORT R1 10 [0xC8802016]
      14 [-]: GETIMPORT R2 12 [0xD53BBF80]
      15 [-]: CALL R1 1 3  
      16 [-]: FORGPREP_INEXT R1 L6
L 3:  17 [-]: GETIMPORT R6 14 [0x89326C93]
      18 [-]: MOVE R8 R5   
...
L 6:  33 [-]: FORGLOOP R1 L3 2 [inext]
      ...
      40 [-]: CALL R1 1 1  
      41 [-]: GETIMPORT R4 24 [0x7ED0A956]
      42 [-]: LOADK R5 K25 ["/Lotus/Powersuits/Yareli/YareliBaseSuit"]
      43 [-]: CALL R4 1 -1 
      44 [-]: NAMECALL R2 R1 K26 [0xF2DEAF69]
      45 [-]: CALL R2 -1 1 
      46 [-]: JUMPIFNOT R2 L7
      47 [-]: GETIMPORT R2 28 [0xBAE80E88]
      48 [-]: SETGLOBAL R2 K29 [0xDFDA639E]
L 7:  49 [-]: GETUPVAL R3 0
      50 [-]: GETTABLEKS R2 R3 K30 [0xC9890F54]
      51 [-]: GETIMPORT R3 32 [0xE91D7466]
      52 [-]: GETGLOBAL R4 K29 [0xDFDA639E]
      53 [-]: CALL R2 2 0  
      54 [-]: GETIMPORT R2 34 [0xCBD666E1]
      55 [-]: LOADK R3 K35 [0.10000000000000001]
      56 [-]: CALL R2 1 0  
L 8:  57 [-]: GETIMPORT R3 2 ["curTransmission"]
      58 [-]: FASTCALL1 62 R3 L9
      59 [-]: GETIMPORT R2 4 [0x7B998233]
      60 [-]: CALL R2 1 1  
L 9:  61 [-]: JUMPIFNOT R2 L10
      62 [-]: GETIMPORT R3 6 ["QueuedTransmissions"]
      63 [-]: LENGTH R2 R3 
      64 [-]: LOADN R3 0   
      65 [-]: JUMPIFLT R3 R2 L10
      66 [-]: GETIMPORT R2 8 ["CurrentConversation"]
      67 [-]: JUMPIFNOT R2 L11
L10:  68 [-]: GETIMPORT R2 34 [0xCBD666E1]
      69 [-]: LOADN R3 0   
      70 [-]: CALL R2 1 0  
      71 [-]: JUMPBACK L8  
L11:  72 [-]: GETIMPORT R2 34 [0xCBD666E1]
      73 [-]: LOADK R3 K35 [0.10000000000000001]
      74 [-]: CALL R2 1 0  
      75 [-]: GETIMPORT R2 10 [0xC8802016]
      76 [-]: MOVE R3 R0   
      77 [-]: CALL R2 1 3  
