...
; Max Stack Size:  14
      ...
      10 [-]: GETIMPORT R3 7 ["AddLogMessage"]
      11 [-]: GETIMPORT R4 9 [0x603636AD]
...
L 1:  18 [-]: NAMECALL R2 R0 K11 [0x2B54251B]
      ...
      34 [-]: CALL R3 1 1  
      35 [-]: GETIMPORT R5 18 ["ZERO_VECTOR"]
      36 [-]: NAMECALL R3 R3 K19 [0xCDADCD5D]
      37 [-]: CALL R3 2 0  
      38 [-]: GETIMPORT R3 21 [0x89326C93]
...
L 2:  43 [-]: NAMECALL R3 R0 K23 [0xF4E253B6]
      44 [-]: CALL R3 1 0  
      45 [-]: GETIMPORT R5 25 ["gLotusFissureHarvesterStateType"]
      46 [-]: NAMECALL R3 R2 K26 [0xC9F6A7D7]
      47 [-]: CALL R3 2 1  
      48 [-]: NAMECALL R4 R3 K27 [0x958B6075]
      49 [-]: CALL R4 1 1  
      50 [-]: GETIMPORT R5 29 [0x08E9C908]
      51 [-]: JUMPIFNOTLT R4 R5 L3
      52 [-]: GETIMPORT R5 21 [0x89326C93]
      53 [-]: GETIMPORT R7 31 [0xB07770D8]
      54 [-]: GETIMPORT R8 18 ["ZERO_VECTOR"]
      55 [-]: GETIMPORT R9 33 ["ZERO_ROTATION"]
      ...
      64 [-]: CALL R6 4 0  
      65 [-]: GETIMPORT R6 38 ["gHeatFissureHarvesters"]
      66 [-]: MOVE R8 R2   
      67 [-]: MOVE R9 R1   
      68 [-]: NAMECALL R6 R6 K39 [0xA11C64EE]
      69 [-]: CALL R6 3 0  
      70 [-]: RETURN R0 0  
L 3:  71 [-]: GETIMPORT R5 21 [0x89326C93]
...
L 4:  78 [-]: GETTABLE R9 R5 R8
      ...
      82 [-]: MOVE R11 R9  
      83 [-]: GETIMPORT R10 43 [0x7B998233]
      84 [-]: CALL R10 1 1 
L 5:  85 [-]: JUMPIF R10 L6
      86 [-]: GETIMPORT R12 45 [0xE688BB4D]
      87 [-]: LOADB R13 0  
      88 [-]: NAMECALL R10 R9 K46 [0x511D26B8]
      89 [-]: CALL R10 3 0 
L 6:  90 [-]: FORNLOOP R6 L4
L 7:  91 [-]: GETIMPORT R6 38 ["gHeatFissureHarvesters"]
      92 [-]: MOVE R8 R3   
      93 [-]: NAMECALL R6 R6 K47 [0x876B78E6]
      94 [-]: CALL R6 2 0  
      95 [-]: GETIMPORT R6 49 [0xBE190284]
      96 [-]: GETUPVAL R8 0
      97 [-]: LOADN R9 0   
      98 [-]: NAMECALL R6 R6 K50 [0x0EB34C69]
      99 [-]: CALL R6 3 1  
     100 [-]: GETIMPORT R7 49 [0xBE190284]
     101 [-]: GETUPVAL R9 0
     102 [-]: ADDK R10 R6 K51 [3]
     103 [-]: NAMECALL R7 R7 K52 [0x751F061D]
     104 [-]: CALL R7 3 0  
     105 [-]: GETIMPORT R8 54 [0xA52C8BB8]
     106 [-]: FASTCALL1 62 R8 L8
     107 [-]: GETIMPORT R7 43 [0x7B998233]
     108 [-]: CALL R7 1 1  
L 8: 109 [-]: JUMPIF R7 L9 
     110 [-]: GETIMPORT R7 21 [0x89326C93]
     111 [-]: GETIMPORT R9 54 [0xA52C8BB8]
