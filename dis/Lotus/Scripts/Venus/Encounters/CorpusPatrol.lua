...
L 4:  47 [-]: GETIMPORT R9 3 [0x89326C93]
      ...
      75 [-]: CALL R14 2 1 
      76 [-]: MOVE R11 R14 
L 5:  77 [-]: GETIMPORT R13 39 [0x36BAD971]
      78 [-]: JUMPIFNOT R13 L6
      79 [-]: LOADN R13 3  
...
L 6:  82 [-]: LOADN R13 0  
      ...
      86 [-]: LOADN R14 1  
      87 [-]: FORNPREP R13 L18
L 7:  88 [-]: GETIMPORT R16 42 [0xCBD666E1]
      89 [-]: LOADN R17 0  
      90 [-]: CALL R16 1 0 
      91 [-]: GETUPVAL R17 1
      92 [-]: GETTABLEKS R16 R17 K43 [0x06D055F9]
      93 [-]: GETIMPORT R17 45 [0x9224ED40]
      94 [-]: JUMPIFNOT R17 L9
...
L 9:  98 [-]: LOADN R18 1  
     ...
     100 [-]: CALL R16 3 1 
     101 [-]: MOVE R19 R10 
     102 [-]: GETIMPORT R20 48 [0x5AA2084E]
     103 [-]: MOVE R21 R6  
     104 [-]: LOADB R22 0  
     105 [-]: LOADB R23 0  
     106 [-]: MOVE R24 R11 
     ...
     109 [-]: CALL R17 8 1 
     110 [-]: LOADNIL R18  
     111 [-]: GETIMPORT R19 51 [0x9A31E2C4]
     112 [-]: JUMPIFNOT R19 L10
     113 [-]: MOVE R21 R17 
     114 [-]: MOVE R22 R0  
     115 [-]: GETIMPORT R23 53 [0x5AB920F5]
     116 [-]: GETIMPORT R24 55 [0xD6238181]
     117 [-]: LOADN R25 0  
     118 [-]: LOADNIL R26  
     119 [-]: MOVE R27 R16 
     ...
     122 [-]: LOADN R30 0  
     123 [-]: LOADNIL R31  
     124 [-]: GETIMPORT R32 51 [0x9A31E2C4]
     125 [-]: GETIMPORT R33 58 [0xFCB93515]
...
L10: 130 [-]: MOVE R21 R17 
     131 [-]: MOVE R22 R0  
     132 [-]: GETIMPORT R23 53 [0x5AB920F5]
     133 [-]: GETIMPORT R24 55 [0xD6238181]
     134 [-]: LOADN R25 0  
     135 [-]: LOADNIL R26  
     136 [-]: MOVE R27 R16 
...
L11: 140 [-]: FASTCALL1 62 R18 L12
     141 [-]: MOVE R20 R18 
     142 [-]: GETIMPORT R19 1 [0x7B998233]
     143 [-]: CALL R19 1 1 
L12: 144 [-]: JUMPIF R19 L14
     145 [-]: GETIMPORT R20 61 [0x74704AF0]
     146 [-]: FASTCALL1 62 R20 L13
     147 [-]: GETIMPORT R19 1 [0x7B998233]
     148 [-]: CALL R19 1 1 
L13: 149 [-]: JUMPIF R19 L14
     150 [-]: NAMECALL R19 R18 K62 [0xBB610E5B]
     151 [-]: CALL R19 1 1 
     152 [-]: GETIMPORT R20 3 [0x89326C93]
     153 [-]: GETIMPORT R22 61 [0x74704AF0]
     154 [-]: NAMECALL R23 R19 K7 [0xD1586535]
     155 [-]: CALL R23 1 1 
     156 [-]: GETIMPORT R24 64 ["ZERO_ROTATION"]
     157 [-]: MOVE R25 R19 
     158 [-]: MOVE R26 R19 
     159 [-]: LOADN R27 1  
     ...
     161 [-]: CALL R20 7 1 
     162 [-]: MOVE R23 R19 
     163 [-]: GETIMPORT R24 67 ["EMPTY_SYMBOL"]
...
L18: 183 [-]: LOADN R13 0  
     ...
     185 [-]: GETIMPORT R13 18 [0x3D106989]
...
L19: 192 [-]: GETIMPORT R13 18 [0x3D106989]
...
L21: 202 [-]: GETIMPORT R3 42 [0xCBD666E1]
     203 [-]: LOADN R4 1   
     204 [-]: CALL R3 1 0  
L22: 205 [-]: LOADN R5 2   
     ...
     207 [-]: CALL R3 2 0  
     208 [-]: NEWTABLE R3 0 0
     209 [-]: GETIMPORT R4 77 [0x762140A8]
...
L27: 246 [-]: LOADN R5 0   
     ...
     249 [-]: CALL R5 1 1  
     250 [-]: JUMPIF R5 L29
     251 [-]: GETIMPORT R5 42 [0xCBD666E1]
     252 [-]: LOADN R6 1   
     253 [-]: CALL R5 1 0  
     254 [-]: LOADB R7 1   
     ...
     256 [-]: CALL R5 2 1  
     257 [-]: MOVE R4 R5   
     258 [-]: GETIMPORT R5 77 [0x762140A8]
...
L35: 303 [-]: GETIMPORT R6 87 [0xD644C2F1]
     ...
     311 [-]: CALL R6 2 0  
     312 [-]: RETURN R0 0  
L36: 313 [-]: GETIMPORT R5 87 [0xD644C2F1]
...
; Max Stack Size:  16
      ...
      26 [-]: MOVE R8 R5   
      27 [-]: MOVE R9 R0   
      28 [-]: GETIMPORT R10 15 [0x5AB920F5]
      29 [-]: GETIMPORT R11 17 [0xD6238181]
      30 [-]: LOADN R12 0  
      31 [-]: LOADNIL R13  
      32 [-]: MOVE R14 R3  
      ...
      38 [-]: MOVE R9 R7   
      39 [-]: GETIMPORT R8 21 [0x7B998233]
      40 [-]: CALL R8 1 1  
L 0:  41 [-]: JUMPIF R8 L2 
      42 [-]: GETIMPORT R9 23 [0x74704AF0]
      43 [-]: FASTCALL1 62 R9 L1
      44 [-]: GETIMPORT R8 21 [0x7B998233]
      45 [-]: CALL R8 1 1  
L 1:  46 [-]: JUMPIF R8 L2 
      47 [-]: GETIMPORT R8 5 [0x89326C93]
      48 [-]: GETIMPORT R10 23 [0x74704AF0]
      49 [-]: NAMECALL R11 R7 K8 [0xD1586535]
      50 [-]: CALL R11 1 1 
      51 [-]: GETIMPORT R12 25 ["ZERO_ROTATION"]
      52 [-]: MOVE R13 R7  
      53 [-]: MOVE R14 R7  
      54 [-]: LOADN R15 1  
      ...
      56 [-]: CALL R8 7 1  
      57 [-]: MOVE R11 R7  
      58 [-]: GETIMPORT R12 28 ["EMPTY_SYMBOL"]
      59 [-]: NAMECALL R9 R8 K29 [0xB6B094B2]
      60 [-]: CALL R9 3 0  
L 2:  61 [-]: GETIMPORT R10 31 [0x47576929]
      62 [-]: LOADB R11 0  
