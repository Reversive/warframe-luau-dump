...
L 0:   5 [-]: NAMECALL R2 R0 K3 [0x2B54251B]
      ...
      11 [-]: CALL R3 1 1  
      12 [-]: GETIMPORT R6 7 ["gLookTriggerType"]
...
L 2:  22 [-]: NAMECALL R7 R2 K12 [0xD1586535]
      23 [-]: CALL R7 1 1  
      24 [-]: GETIMPORT R8 14 [0xB5F96E33]
      25 [-]: NAMECALL R5 R3 K15 [0x44C55B21]
      26 [-]: CALL R5 3 1  
      27 [-]: GETIMPORT R6 18 ["gHeatFissureHarvesters"]
      28 [-]: MOVE R8 R1   
      29 [-]: MOVE R9 R5   
...
L 3:  16 [-]: GETIMPORT R1 1 [0xBE190284]
      ...
      22 [-]: RETURN R0 0  
L 4:  23 [-]: GETIMPORT R2 14 ["HeatModeFissuresOpen"]
      24 [-]: JUMPXEQKNIL R2 L5 NOT
      25 [-]: GETIMPORT R2 15 ["_T"]
      26 [-]: NEWTABLE R3 0 0
      27 [-]: SETTABLEKS R3 R2 K13 ["HeatModeFissuresOpen"]
L 5:  28 [-]: GETIMPORT R3 14 ["HeatModeFissuresOpen"]
      29 [-]: FASTCALL2 52 R3 R0 L6
      30 [-]: MOVE R4 R0   
      31 [-]: GETIMPORT R2 18 [0x23D5322F]
      32 [-]: CALL R2 2 0  
L 6:  33 [-]: RETURN R0 0  
...
; Max Stack Size:  15
       ...
       5 [-]: LOADN R3 1   
       6 [-]: FORNPREP R2 L1
L 0:   7 [-]: GETIMPORT R5 4 [0xBE190284]
       8 [-]: GETTABLE R7 R1 R4
       9 [-]: MOVE R8 R0   
      10 [-]: LOADK R9 K5 [""]
      11 [-]: LOADN R10 0  
...
; Max Stack Size:  18
      ...
      12 [-]: CALL R4 1 1  
      13 [-]: GETIMPORT R5 10 ["ActiveJob"]
      14 [-]: JUMPIFNOT R5 L2
      15 [-]: GETIMPORT R5 2 [0xBE190284]
      16 [-]: NAMECALL R5 R5 K11 [0x33307F92]
      17 [-]: CALL R5 1 1  
      18 [-]: FASTCALL1 62 R5 L0
      19 [-]: MOVE R7 R5   
      20 [-]: GETIMPORT R6 13 [0x7B998233]
      21 [-]: CALL R6 1 1  
L 0:  22 [-]: JUMPIF R6 L1 
      ...
      26 [-]: CALL R6 3 0  
L 1:  27 [-]: RETURN R0 0  
L 2:  28 [-]: GETIMPORT R5 18 ["gHeatFissureHarvesters"]
      29 [-]: MOVE R7 R1   
...
L 3:  37 [-]: JUMPIF R7 L4 
      ...
      55 [-]: CALL R7 1 1  
      56 [-]: GETIMPORT R9 26 ["ZERO_VECTOR"]
      57 [-]: NAMECALL R7 R7 K27 [0xCDADCD5D]
      58 [-]: CALL R7 2 0  
L 4:  59 [-]: GETIMPORT R7 5 [0x89326C93]
...
L 5:  64 [-]: NAMECALL R7 R4 K29 [0x21354A1B]
      ...
      69 [-]: CALL R7 1 0  
      70 [-]: RETURN R0 0  
L 6:  71 [-]: GETIMPORT R9 31 [0xD19AC5E5]
      72 [-]: NAMECALL R7 R2 K32 [0xC9F6A7D7]
      73 [-]: CALL R7 2 1  
      74 [-]: NAMECALL R8 R7 K33 [0xD1586535]
      75 [-]: CALL R8 1 1  
      76 [-]: GETIMPORT R9 35 ["ZERO_ROTATION"]
      77 [-]: GETIMPORT R10 18 ["gHeatFissureHarvesters"]
      78 [-]: MOVE R12 R1  
...
L 7:  85 [-]: JUMPIFNOT R11 L8
      86 [-]: GETIMPORT R13 37 [0x7C3BA29D]
      87 [-]: MOVE R14 R8  
      88 [-]: MOVE R15 R9  
      89 [-]: GETIMPORT R16 39 [0x0469F296]
     ...
     100 [-]: CALL R12 1 1 
     101 [-]: MOVE R6 R12  
     102 [-]: GETIMPORT R12 18 ["gHeatFissureHarvesters"]
     103 [-]: MOVE R14 R6  
...
L 8: 107 [-]: LOADB R13 0  
     ...
     113 [-]: CALL R11 3 0 
L 9: 114 [-]: GETIMPORT R11 18 ["gHeatFissureHarvesters"]
     115 [-]: MOVE R13 R6  
     116 [-]: NAMECALL R11 R11 K46 [0x939626FF]
     117 [-]: CALL R11 2 0 
     118 [-]: NAMECALL R11 R1 K47 [0xDE321E6F]
     119 [-]: CALL R11 1 1 
     120 [-]: GETIMPORT R13 49 [0xB07770D8]
...
L10: 128 [-]: GETIMPORT R4 5 [0x89326C93]
     ...
     144 [-]: CALL R4 -1 1 
     145 [-]: GETIMPORT R6 56 [0x85569D00]
     146 [-]: FASTCALL1 62 R6 L11
     147 [-]: GETIMPORT R5 13 [0x7B998233]
     148 [-]: CALL R5 1 1  
L11: 149 [-]: JUMPIF R5 L12
     150 [-]: GETIMPORT R7 56 [0x85569D00]
     151 [-]: GETIMPORT R8 58 ["EMPTY_SYMBOL"]
     152 [-]: GETIMPORT R9 60 [0xA421AF95]
     153 [-]: LOADN R10 0  
     ...
     158 [-]: CALL R5 -1 0 
L12: 159 [-]: LOADN R7 1   
     160 [-]: GETIMPORT R8 64 ["HeatModeFissuresOpen"]
     161 [-]: LENGTH R5 R8 
     162 [-]: LOADN R6 1   
     163 [-]: FORNPREP R5 L15
L13: 164 [-]: GETIMPORT R9 64 ["HeatModeFissuresOpen"]
     165 [-]: GETTABLE R8 R9 R7
     166 [-]: JUMPIFNOTEQ R8 R2 L14
     167 [-]: GETIMPORT R8 67 [0x9C1F3B5A]
     168 [-]: GETIMPORT R9 64 ["HeatModeFissuresOpen"]
     169 [-]: MOVE R10 R7  
     170 [-]: CALL R8 2 0  
     171 [-]: JUMP L15
    
L14: 172 [-]: FORNLOOP R5 L13
L15: 173 [-]: GETIMPORT R7 69 [0xFC6285CF]
     174 [-]: NAMECALL R5 R2 K70 [0xF2DEAF69]
     175 [-]: CALL R5 2 1  
     176 [-]: JUMPIFNOT R5 L16
     177 [-]: GETIMPORT R5 5 [0x89326C93]
     178 [-]: GETIMPORT R8 72 [0x216299D5]
...
L16: 187 [-]: GETIMPORT R5 5 [0x89326C93]
     188 [-]: GETIMPORT R8 72 [0x216299D5]
