...
; Max Stack Size:  12
 ...
 10 [-]: EQ        0 R1 K3      ; if R1 ~= 120.000000 then PC := 22
 11 [-]: JMP       22           ; PC := 22
 ...
 29 [-]: EQ        0 R1 K3      ; if R1 ~= 120.000000 then PC := 41
 30 [-]: JMP       41           ; PC := 41
...
; Max Stack Size:  14
 ...
 32 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 33 [-]: EQ        0 R1 K9      ; if R1 ~= 120.000000 then PC := 45
 34 [-]: JMP       45           ; PC := 45
 ...
 61 [-]: EQ        0 R1 K9      ; if R1 ~= 120.000000 then PC := 71
 62 [-]: JMP       71           ; PC := 71
