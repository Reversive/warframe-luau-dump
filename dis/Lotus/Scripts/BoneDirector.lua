...
; Max Stack Size:  5
       ...
       0 [-]: GETIMPORT R3 1 [0x39885D68]
       1 [-]: LOADB R4 1   
       2 [-]: NAMECALL R1 R0 K2 [0xA390A429]
       3 [-]: CALL R1 3 0  
       4 [-]: GETIMPORT R3 1 [0x39885D68]
       5 [-]: GETIMPORT R4 4 [0xB9F4987F]
...
; Max Stack Size:  10
       ...
       3 [-]: LOADN R4 1   
       4 [-]: CALL R1 3 1  
       5 [-]: GETIMPORT R4 3 [0x39885D68]
       6 [-]: LOADB R5 0   
       7 [-]: NAMECALL R2 R0 K4 [0x003C792F]
       8 [-]: CALL R2 3 1  
       9 [-]: GETIMPORT R5 3 [0x39885D68]
      10 [-]: LOADB R6 0   
...
; Max Stack Size:  14
       ...
       7 [-]: NAMECALL R2 R0 K4 [0x003C792F]
       8 [-]: CALL R2 3 1  
       9 [-]: GETIMPORT R5 6 [0x67A5F227]
      10 [-]: LOADB R6 0   
      11 [-]: NAMECALL R3 R0 K4 [0x003C792F]
      12 [-]: CALL R3 3 1  
      13 [-]: GETIMPORT R6 6 [0x67A5F227]
      14 [-]: LOADB R7 0   
      15 [-]: NAMECALL R4 R0 K7 [0xEA0832EA]
      16 [-]: CALL R4 3 1  
      17 [-]: GETIMPORT R5 9 [0x492C7F2A]
      18 [-]: SUB R6 R2 R3 
      19 [-]: GETIMPORT R7 11 [0x9516F1C4]
      20 [-]: MOVE R8 R4   
      21 [-]: CALL R7 1 -1 
      22 [-]: CALL R5 -1 1 
      23 [-]: GETIMPORT R8 3 [0x39885D68]
      24 [-]: LOADB R9 1   
      25 [-]: NAMECALL R6 R0 K12 [0xA390A429]
      26 [-]: CALL R6 3 0  
      27 [-]: LOADN R6 0   
L 0:  28 [-]: GETIMPORT R7 14 [0xFA1B5621]
      ...
      33 [-]: CALL R7 1 1  
L 1:  34 [-]: JUMPIF R7 L2 
      35 [-]: GETIMPORT R9 18 [0x66C01AFD]
      36 [-]: LOADB R10 0  
      37 [-]: NAMECALL R7 R0 K19 [0x16E0B3DA]
      38 [-]: CALL R7 3 1  
      39 [-]: JUMPIFNOT R7 L2
      40 [-]: GETIMPORT R9 6 [0x67A5F227]
      41 [-]: LOADB R10 0  
      42 [-]: NAMECALL R7 R0 K7 [0xEA0832EA]
      43 [-]: CALL R7 3 1  
      44 [-]: MOVE R4 R7   
      45 [-]: GETIMPORT R12 6 [0x67A5F227]
      46 [-]: LOADB R13 0  
      47 [-]: NAMECALL R10 R0 K4 [0x003C792F]
      48 [-]: CALL R10 3 1 
      49 [-]: GETIMPORT R11 9 [0x492C7F2A]
      50 [-]: MOVE R12 R5  
      51 [-]: MOVE R13 R4  
      52 [-]: CALL R11 2 1 
      53 [-]: ADD R9 R10 R11
      ...
      59 [-]: CALL R7 2 1  
      60 [-]: MOVE R4 R7   
      61 [-]: GETIMPORT R9 3 [0x39885D68]
      62 [-]: MOVE R10 R4  
      63 [-]: MOVE R11 R3  
      64 [-]: MOVE R12 R1  
      65 [-]: NAMECALL R7 R0 K22 [0x780701F3]
      66 [-]: CALL R7 5 0  
      67 [-]: GETIMPORT R7 24 [0x67652851]
      68 [-]: CALL R7 0 1  
      69 [-]: ADD R6 R6 R7 
      70 [-]: GETIMPORT R7 26 [0xCBD666E1]
      71 [-]: LOADN R8 0   
      72 [-]: CALL R7 1 0  
      73 [-]: JUMPBACK L0  
L 2:  74 [-]: FASTCALL1 62 R0 L3
      75 [-]: MOVE R8 R0   
      76 [-]: GETIMPORT R7 16 [0x7B998233]
      77 [-]: CALL R7 1 1  
L 3:  78 [-]: JUMPIF R7 L4 
      79 [-]: GETIMPORT R9 3 [0x39885D68]
      80 [-]: LOADB R10 0  
