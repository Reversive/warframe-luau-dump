...
L 0:  10 [-]: JUMPIF R6 L1 
      ...
      13 [-]: CALL R6 2 0  
      14 [-]: GETIMPORT R8 7 [0x37D88641]
      15 [-]: GETIMPORT R9 9 ["EMPTY_SYMBOL"]
...
L 5:  44 [-]: FORGLOOP R8 L3 2 [inext]
      45 [-]: GETIMPORT R8 20 [0x1CFB2204]
      46 [-]: JUMPIFNOTLE R7 R8 L6
      47 [-]: JUMPXEQKB R1 0 L6 NOT
      48 [-]: LOADB R1 1   
      49 [-]: GETIMPORT R10 22 [0x520E413D]
      50 [-]: LOADB R11 0  
      51 [-]: LOADN R12 0  
      52 [-]: LOADB R13 1  
      ...
      54 [-]: CALL R8 5 1  
      55 [-]: MOVE R3 R8   
      56 [-]: GETIMPORT R10 25 [0x78403F35]
      57 [-]: GETIMPORT R11 9 ["EMPTY_SYMBOL"]
      58 [-]: NAMECALL R8 R0 K10 [0x47901F07]
      59 [-]: CALL R8 3 1  
      60 [-]: MOVE R4 R8   
      61 [-]: JUMP L10
    
L 6:  62 [-]: GETIMPORT R8 20 [0x1CFB2204]
      63 [-]: JUMPIFNOTLT R8 R7 L10
      64 [-]: JUMPXEQKB R1 1 L10 NOT
      65 [-]: LOADB R1 0   
      66 [-]: GETIMPORT R2 1 [0xD9B70FA2]
...
L 8:  75 [-]: FASTCALL1 62 R4 L9
      76 [-]: MOVE R9 R4   
      77 [-]: GETIMPORT R8 4 [0x7B998233]
      78 [-]: CALL R8 1 1  
L 9:  79 [-]: JUMPIF R8 L10
      80 [-]: NAMECALL R8 R4 K27 [0x467C327C]
      81 [-]: CALL R8 1 0  
L10:  82 [-]: GETIMPORT R8 29 [0xCBD666E1]
      83 [-]: LOADN R9 0   
      84 [-]: CALL R8 1 0  
      85 [-]: GETIMPORT R8 20 [0x1CFB2204]
      86 [-]: JUMPIFNOTLE R7 R8 L11
      87 [-]: GETIMPORT R8 31 [0x67652851]
      88 [-]: CALL R8 0 1  
      89 [-]: SUB R2 R2 R8 
L11:  90 [-]: LOADN R8 0   
      91 [-]: JUMPIFNOTLE R2 R8 L18
      92 [-]: GETIMPORT R8 33 [0xAAF31D1C]
      93 [-]: GETIMPORT R9 35 [0xEEE9C48E]
      94 [-]: GETIMPORT R10 33 [0xAAF31D1C]
      95 [-]: JUMPIFNOTLE R10 R9 L12
      96 [-]: GETIMPORT R8 33 [0xAAF31D1C]
      97 [-]: JUMP L13
    
L12:  98 [-]: GETIMPORT R9 38 [0x3630E649]
      99 [-]: GETIMPORT R10 35 [0xEEE9C48E]
     100 [-]: GETIMPORT R11 33 [0xAAF31D1C]
     101 [-]: CALL R9 2 1  
     102 [-]: MOVE R8 R9   
L13: 103 [-]: GETIMPORT R9 40 [0x00046924]
     104 [-]: CALL R9 0 1  
     105 [-]: LOADN R12 1  
     106 [-]: MOVE R10 R8  
     107 [-]: LOADN R11 1  
     108 [-]: FORNPREP R10 L17
L14: 109 [-]: GETIMPORT R13 38 [0x3630E649]
     110 [-]: LOADN R14 -90
     111 [-]: LOADN R15 90 
     112 [-]: CALL R13 2 1 
     113 [-]: SETTABLEKS R13 R9 K41 ["pitch"]
     114 [-]: GETIMPORT R13 43 [0x492C7F2A]
     115 [-]: GETIMPORT R14 45 [0xA421AF95]
     ...
     120 [-]: MOVE R15 R9  
     121 [-]: CALL R13 2 1 
     122 [-]: GETIMPORT R14 12 [0x89326C93]
     123 [-]: GETIMPORT R16 48 [0x4C730D89]
     ...
     131 [-]: MOVE R16 R14 
     132 [-]: GETIMPORT R15 4 [0x7B998233]
     133 [-]: CALL R15 1 1 
