...
; Max Stack Size:  11
 ...
 99 [-]: JMP       101          ; PC := 101
100 [-]: LOADBOOL  R4 0 1       ; R4 := false; PC := 101
...
; Max Stack Size:  9
 ...
 20 [-]: SELF      R2 R0 K5     ; R3 := R0; R2 := R0[0xde321e6f]
 21 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 22 [-]: SELF      R3 R2 K6     ; R4 := R2; R3 := R2[0xe85a2361]
 23 [-]: GETUPVAL  R5 U3        ; R5 := U3
 24 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 25 [-]: SELF      R4 R0 K7     ; R5 := R0; R4 := R0[0xa5e492d4]
 26 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 27 [-]: TEST      R4 0         ; if not R4 then PC := 42
 28 [-]: JMP       42           ; PC := 42
 29 [-]: SELF      R4 R2 K8     ; R5 := R2; R4 := R2[0x0b5ec5b5]
 ...
 36 [-]: JMP       42           ; PC := 42
 37 [-]: SELF      R4 R3 K9     ; R5 := R3; R4 := R3[0x14cdd993]
 38 [-]: CALL      R4 2 1       ; R4(R5)
 39 [-]: GETUPVAL  R4 U4        ; R4 := U4
 40 [-]: MOVE      R5 R0        ; R5 := R0
 41 [-]: CALL      R4 2 1       ; R4(R5)
 42 [-]: GETGLOBAL R4 K10       ; R4 := 0x89326c93
 43 [-]: SELF      R4 R4 K11    ; R5 := R4; R4 := R4[0x18d05d30]
 44 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 45 [-]: TEST      R4 0         ; if not R4 then PC := 59
 46 [-]: JMP       59           ; PC := 59
 47 [-]: SELF      R4 R2 K12    ; R5 := R2; R4 := R2[0x12dd9da2]
 48 [-]: LOADK     R6 146       ; R6 := 146.000000
 ...
 56 [-]: JMP       59           ; PC := 59
 57 [-]: SELF      R4 R3 K9     ; R5 := R3; R4 := R3[0x14cdd993]
