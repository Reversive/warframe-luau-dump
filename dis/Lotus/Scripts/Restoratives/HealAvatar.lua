...
L 1:  15 [-]: JUMPIF R2 L2 
      ...
      24 [-]: MOVE R4 R0   
      25 [-]: MOVE R5 R1   
      26 [-]: GETIMPORT R6 12 [0x2F6A70E2]
      27 [-]: GETIMPORT R7 14 [0x6845B906]
      28 [-]: CALL R2 5 0  
      29 [-]: GETIMPORT R4 16 [0xD11C33D0]
      30 [-]: GETIMPORT R5 18 ["EMPTY_SYMBOL"]
...
L 1:  11 [-]: JUMPIF R2 L3 
      ...
      29 [-]: CALL R4 2 0  
L 2:  30 [-]: GETIMPORT R4 17 [0xD11C33D0]
      31 [-]: GETIMPORT R5 19 ["EMPTY_SYMBOL"]
...
L 1:  15 [-]: GETTABLE R6 R2 R5
      ...
      30 [-]: MOVE R9 R1   
      31 [-]: GETIMPORT R10 9 [0x2F6A70E2]
      32 [-]: GETIMPORT R11 11 [0x6845B906]
      33 [-]: CALL R6 5 0  
L 2:  34 [-]: GETTABLE R6 R2 R5
      35 [-]: GETIMPORT R8 13 [0xD11C33D0]
      36 [-]: GETIMPORT R9 15 ["EMPTY_SYMBOL"]
...
; Max Stack Size:  13
       ...
       2 [-]: CALL R2 1 1  
       3 [-]: JUMPIFNOT R2 L6
       4 [-]: GETIMPORT R4 4 ["gLotusVehicleAvatarType"]
...
L 2:  28 [-]: JUMPIF R5 L3 
      ...
      36 [-]: CALL R6 -1 1 
      37 [-]: GETIMPORT R9 16 [0x3FAE69FF]
      38 [-]: GETIMPORT R10 18 ["EMPTY_SYMBOL"]
      39 [-]: MOVE R11 R6  
      40 [-]: MOVE R12 R3  
...
L 5:  61 [-]: JUMPIF R5 L6 
      ...
      70 [-]: CALL R5 -1 0 
L 6:  71 [-]: GETIMPORT R2 28 ["IsLiteSortie"]
      72 [-]: JUMPIFNOT R2 L7
...
; Max Stack Size:  29
       ...
       4 [-]: GETIMPORT R4 5 [0xDA9F9B2C]
       5 [-]: DIV R2 R3 R4 
       6 [-]: MOVE R3 R2   
       7 [-]: GETIMPORT R5 7 [0xFA8F7686]
       8 [-]: FASTCALL1 62 R5 L0
       9 [-]: GETIMPORT R4 9 [0x7B998233]
      10 [-]: CALL R4 1 1  
L 0:  11 [-]: GETIMPORT R5 11 [0x601852A6]
      12 [-]: JUMPIFNOT R5 L6
      13 [-]: LOADN R5 0   
      14 [-]: GETIMPORT R8 13 ["gContextActionType"]
      15 [-]: NAMECALL R6 R0 K14 [0xC9F6A7D7]
      16 [-]: CALL R6 2 1  
L 1:  17 [-]: NAMECALL R7 R0 K15 [0x1FACBC07]
      18 [-]: CALL R7 1 1  
      19 [-]: JUMPIF R7 L6 
      20 [-]: GETIMPORT R7 17 [0xCBD666E1]
      21 [-]: LOADN R8 0   
      22 [-]: CALL R7 1 0  
      23 [-]: GETIMPORT R7 19 [0x67652851]
      24 [-]: CALL R7 0 1  
      25 [-]: ADD R5 R5 R7 
      26 [-]: LOADK R7 K20 [1.5]
      27 [-]: JUMPIFNOTLE R7 R5 L5
      28 [-]: GETIMPORT R8 22 [0x616AE2B5]
      29 [-]: FASTCALL1 62 R8 L2
      30 [-]: GETIMPORT R7 9 [0x7B998233]
      31 [-]: CALL R7 1 1  
L 2:  32 [-]: JUMPIF R7 L5 
...
L 4:  41 [-]: LOADN R5 0   
      ...
      48 [-]: GETIMPORT R10 22 [0x616AE2B5]
...
L10:  94 [-]: JUMPIF R7 L40
     ...
     106 [-]: GETIMPORT R9 1 [0x89326C93]
     107 [-]: GETIMPORT R11 48 [0xF1E00E2A]
     108 [-]: MOVE R12 R7  
     109 [-]: MOVE R13 R8  
...
L11: 119 [-]: GETTABLE R12 R1 R11
     ...
     121 [-]: MOVE R14 R12 
     122 [-]: GETIMPORT R13 9 [0x7B998233]
     123 [-]: CALL R13 1 1 
L12: 124 [-]: JUMPIF R13 L32
     ...
     128 [-]: MOVE R15 R13 
     129 [-]: GETIMPORT R14 9 [0x7B998233]
     130 [-]: CALL R14 1 1 
L13: 131 [-]: JUMPIF R14 L14
     132 [-]: GETIMPORT R16 53 ["gLotusVehicleAvatarType"]
...
L15: 143 [-]: JUMPIF R14 L32
     144 [-]: GETIMPORT R16 57 ["gTennoAvatarType"]
     ...
     150 [-]: CALL R14 2 1 
     151 [-]: GETIMPORT R15 36 [0x443A8D0B]
     152 [-]: JUMPIFNOTLE R14 R15 L32
     153 [-]: GETIMPORT R15 1 [0x89326C93]
     154 [-]: NAMECALL R15 R15 K59 [0x18D05D30]
     155 [-]: CALL R15 1 1 
     156 [-]: JUMPIFNOT R15 L32
     157 [-]: GETIMPORT R15 61 [0x6BC75D4B]
     ...
     164 [-]: MOVE R17 R15 
     165 [-]: GETIMPORT R16 9 [0x7B998233]
     166 [-]: CALL R16 1 1 
L16: 167 [-]: JUMPIF R16 L32
     ...
     170 [-]: CALL R16 1 1 
     171 [-]: JUMPIF R16 L32
     172 [-]: GETIMPORT R18 65 [0x2F6A70E2]
     173 [-]: NAMECALL R16 R15 K66 [0xFC80301E]
     174 [-]: CALL R16 2 0 
     175 [-]: NAMECALL R16 R13 K62 [0xDE321E6F]
     176 [-]: CALL R16 1 1 
     177 [-]: GETIMPORT R18 68 [0x4A851630]
     178 [-]: GETIMPORT R19 65 [0x2F6A70E2]
     179 [-]: NAMECALL R16 R16 K69 [0x7BC127AA]
     180 [-]: CALL R16 3 0 
     181 [-]: JUMP L32
    
L17: 182 [-]: GETIMPORT R15 71 [0x3A3F4159]
...
L20: 207 [-]: GETUPVAL R17 3
     ...
     209 [-]: MOVE R19 R13 
     210 [-]: MOVE R20 R15 
     211 [-]: GETIMPORT R21 65 [0x2F6A70E2]
     212 [-]: GETIMPORT R22 77 [0x6845B906]
     213 [-]: CALL R17 5 0 
     214 [-]: JUMP L32
    
L21: 215 [-]: GETIMPORT R15 79 [0x51DCBCC5]
     216 [-]: JUMPIFNOT R15 L30
     217 [-]: LOADN R17 1  
     218 [-]: GETIMPORT R18 81 [0x3929BE52]
     219 [-]: LENGTH R15 R18
     220 [-]: LOADN R16 1  
     221 [-]: FORNPREP R15 L32
L22: 222 [-]: GETIMPORT R20 81 [0x3929BE52]
     223 [-]: GETTABLE R19 R20 R17
     224 [-]: FASTCALL1 62 R19 L23
     225 [-]: GETIMPORT R18 9 [0x7B998233]
     226 [-]: CALL R18 1 1 
L23: 227 [-]: JUMPIF R18 L29
     228 [-]: LOADN R18 0  
     229 [-]: NAMECALL R19 R13 K62 [0xDE321E6F]
     230 [-]: CALL R19 1 1 
     231 [-]: GETIMPORT R20 83 [0xC8802016]
...
L30: 274 [-]: GETIMPORT R15 94 [0x8D3D0477]
     ...
     290 [-]: MOVE R18 R16 
     291 [-]: GETIMPORT R17 9 [0x7B998233]
     292 [-]: CALL R17 1 1 
L31: 293 [-]: JUMPIF R17 L32
     ...
     299 [-]: CALL R20 1 1 
     300 [-]: GETIMPORT R21 65 [0x2F6A70E2]
     301 [-]: ADD R19 R20 R21
     302 [-]: LOADB R20 1  
...
L34: 309 [-]: GETIMPORT R7 19 [0x67652851]
     310 [-]: CALL R7 0 1  
     311 [-]: ADD R3 R3 R7 
     312 [-]: GETGLOBAL R8 K3 [0xE15169D2]
     313 [-]: GETIMPORT R9 19 [0x67652851]
     314 [-]: CALL R9 0 1  
     315 [-]: SUB R7 R8 R9 
...
L36: 331 [-]: JUMPIF R7 L38
     ...
     336 [-]: GETIMPORT R10 103 [0xA40531D8]
     337 [-]: CALL R10 2 1 
L37: 338 [-]: NAMECALL R7 R5 K46 [0x986D2AB8]
     339 [-]: CALL R7 3 0  
L38: 340 [-]: GETIMPORT R7 17 [0xCBD666E1]
     341 [-]: LOADN R8 0   
     342 [-]: CALL R7 1 0  
     343 [-]: JUMPIF R6 L39
     344 [-]: GETUPVAL R9 1
     345 [-]: GETIMPORT R11 41 ["red"]
     346 [-]: DIVK R10 R11 K38 [255]
     347 [-]: GETIMPORT R12 43 ["green"]
     348 [-]: DIVK R11 R12 K38 [255]
     349 [-]: GETIMPORT R13 45 ["blue"]
     ...
     355 [-]: LOADB R6 1   
L39: 356 [-]: JUMPBACK L9  
L40: 357 [-]: GETIMPORT R9 105 ["gLotusEffectDecorationType"]
...
L41: 363 [-]: FASTCALL1 62 R5 L42
     364 [-]: MOVE R8 R5   
     365 [-]: GETIMPORT R7 9 [0x7B998233]
     366 [-]: CALL R7 1 1  
L42: 367 [-]: JUMPIF R7 L43
     368 [-]: NAMECALL R7 R5 K106 [0x1DB57C6B]
     369 [-]: CALL R7 1 0  
L43: 370 [-]: GETIMPORT R9 108 [0x5C8F27E3]
     371 [-]: LOADB R10 1  
     372 [-]: LOADB R11 0  
...
L 0:  28 [-]: MOVE R6 R2   
      ...
      30 [-]: CALL R4 2 0  
L 1:  31 [-]: GETIMPORT R7 10 [0xA421AF95]
      32 [-]: LOADN R8 0   
      33 [-]: LOADN R9 300 
      34 [-]: LOADN R10 0  
      35 [-]: CALL R7 3 1  
...
L 3:  53 [-]: GETTABLEKS R8 R7 K13 ["y"]
      ...
      56 [-]: GETIMPORT R10 15 [0x5DB3CE80]
      57 [-]: MOVE R11 R4  
      58 [-]: MOVE R12 R5  
      ...
      62 [-]: CALL R8 -1 0 
      63 [-]: GETIMPORT R10 18 [0x9BAFFFE3]
      ...
      69 [-]: CALL R8 -1 0 
      70 [-]: GETIMPORT R8 21 [0xCBD666E1]
      71 [-]: LOADN R9 0   
      72 [-]: CALL R8 1 0  
      73 [-]: GETIMPORT R8 23 [0x67652851]
      74 [-]: CALL R8 0 1  
      75 [-]: ADD R6 R6 R8 
...
L 4:  80 [-]: NAMECALL R8 R0 K24 [0xA2880940]
      81 [-]: CALL R8 1 0  
      82 [-]: GETIMPORT R8 26 [0x89326C93]
      83 [-]: GETIMPORT R10 28 [0xB970BCA8]
      84 [-]: MOVE R11 R5  
      85 [-]: GETIMPORT R12 30 ["ZERO_ROTATION"]
      ...
      91 [-]: CALL R8 3 0  
      92 [-]: GETIMPORT R10 33 ["gContextActionType"]
      93 [-]: NAMECALL R8 R1 K34 [0xC9F6A7D7]
      94 [-]: CALL R8 2 1  
      95 [-]: FASTCALL1 62 R8 L5
      96 [-]: MOVE R10 R8  
      97 [-]: GETIMPORT R9 36 [0x7B998233]
      98 [-]: CALL R9 1 1  
L 5:  99 [-]: JUMPIF R9 L6 
     100 [-]: NAMECALL R9 R8 K37 [0x383D2E7D]
     101 [-]: CALL R9 1 0  
     102 [-]: GETIMPORT R11 39 [0xA226F098]
     103 [-]: GETIMPORT R12 41 ["EMPTY_SYMBOL"]
