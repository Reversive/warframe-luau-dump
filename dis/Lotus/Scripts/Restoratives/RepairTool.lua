...
; Max Stack Size:  7
       ...
       3 [-]: CALL R1 1 1  
L 0:   4 [-]: JUMPIF R1 L1 
       5 [-]: GETIMPORT R3 3 [0xBE12A67D]
       6 [-]: NAMECALL R1 R0 K4 [0x35B09371]
       7 [-]: CALL R1 2 0  
L 1:   8 [-]: GETIMPORT R1 7 ["lastMiningSlot"]
       9 [-]: JUMPXEQKNIL R1 L5
...
L 2:  14 [-]: JUMPIF R1 L4 
      ...
      16 [-]: CALL R1 1 1  
      17 [-]: GETIMPORT R2 7 ["lastMiningSlot"]
      18 [-]: JUMPIFNOT R2 L4
...
L 3:  30 [-]: JUMPIF R2 L4 
      ...
      35 [-]: CALL R2 2 1  
      36 [-]: GETIMPORT R4 3 [0xBE12A67D]
      37 [-]: NAMECALL R2 R2 K11 [0xF2DEAF69]
      38 [-]: CALL R2 2 1  
      39 [-]: JUMPIFNOT R2 L4
      40 [-]: GETIMPORT R4 7 ["lastMiningSlot"]
      41 [-]: LOADN R5 0   
      42 [-]: LOADN R6 2   
      43 [-]: NAMECALL R2 R1 K12 [0xC69087F6]
      44 [-]: CALL R2 4 0  
L 4:  45 [-]: GETIMPORT R1 13 ["_T"]
      46 [-]: LOADNIL R2   
...
L 9:  56 [-]: NAMECALL R6 R0 K15 [0xA5E492D4]
      57 [-]: CALL R6 1 1  
      58 [-]: JUMPIFNOT R6 L27
      59 [-]: GETIMPORT R6 18 ["ShowImpactMessage"]
...
L15:  96 [-]: JUMPIF R8 L16
      97 [-]: GETIMPORT R10 22 [0xBE12A67D]
      98 [-]: NAMECALL R8 R7 K30 [0xF2DEAF69]
      99 [-]: CALL R8 2 1  
     100 [-]: JUMPIF R8 L19
L16: 101 [-]: GETIMPORT R8 32 [0xCBD666E1]
     102 [-]: LOADN R9 0   
     103 [-]: CALL R8 1 0  
...
L19: 115 [-]: GETUPVAL R9 2
     ...
     121 [-]: CALL R10 1 1 
     122 [-]: JUMPIF R10 L24
     123 [-]: GETIMPORT R10 27 [0x89326C93]
...
L21: 135 [-]: JUMPIF R12 L22
     ...
     142 [-]: MOVE R12 R8  
     143 [-]: MOVE R13 R11 
     144 [-]: GETIMPORT R14 22 [0xBE12A67D]
     145 [-]: CALL R12 2 1 
     146 [-]: JUMPIFEQ R12 R9 L22
     147 [-]: GETIMPORT R13 32 [0xCBD666E1]
     148 [-]: LOADN R14 0  
     149 [-]: CALL R13 1 0 
     150 [-]: JUMPBACK L20 
...
L24: 155 [-]: FASTCALL1 62 R0 L25
     156 [-]: MOVE R11 R0  
     157 [-]: GETIMPORT R10 1 [0x7B998233]
     158 [-]: CALL R10 1 1 
L25: 159 [-]: JUMPIF R10 L26
     ...
     166 [-]: MOVE R10 R8  
     167 [-]: MOVE R11 R2  
     168 [-]: GETIMPORT R12 22 [0xBE12A67D]
     169 [-]: CALL R10 2 1 
     170 [-]: JUMPIFEQ R10 R9 L26
     171 [-]: GETIMPORT R11 32 [0xCBD666E1]
     172 [-]: LOADN R12 0  
     173 [-]: CALL R11 1 0 
     174 [-]: JUMPBACK L24 
L26: 175 [-]: GETIMPORT R10 27 [0x89326C93]
