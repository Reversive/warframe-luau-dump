...
L 6:  31 [-]: SUBK R9 R6 K5; var9 = var6 - 1
      ...
      35 [-]: JUMPIFNOTEQ R7 R1 L7; goto L7 if var7 ~= var84280103
...
L 0:   3 [-]: LOADN R3 1   ; var3 = 1
       4 [-]: JUMPIFNOTLT R2 R3 L6; goto L6 if var2 >= var50347595
...
L 2:  18 [-]: MOVE R2 R3   ; var2 = var3
      ...
      20 [-]: LOADK R5 K9  ; var5 = 1.7015800000000001
      21 [-]: DIVK R4 R4 K10; var4 = var4 / 0.5
      22 [-]: LOADN R6 1   ; var6 = 1
      23 [-]: JUMPIFNOTLT R4 R6 L3; goto L3 if var4 >= var184878339
      24 [-]: MULK R5 R5 K11; var5 = var5 * 1.5249999999999999
...
L 3:  34 [-]: SUBK R4 R4 K3; var4 = var4 - 2
      35 [-]: MULK R5 R5 K11; var5 = var5 * 1.5249999999999999
...
; Max Stack Size:  27
       ...
       8 [-]: JUMPIFNOTEQ R3 R4 L4; goto L4 if var3 ~= var394574
...
L14: 140 [-]: GETIMPORT R10 38; var10 = 0x03EA2485
     ...
     145 [-]: JUMPIFNOTLT R11 R10 L15; goto L15 if var11 >= var654903811
     146 [-]: MULK R10 R9 K39; var10 = var9 * 20
     147 [-]: ADD R4 R7 R10; var4 = var7 + var10
L15: 148 [-]: MULK R11 R6 K40; var11 = var6 * 0.10000000000000001
     ...
     159 [-]: LOADK R14 K48; var14 = 0.0001
     160 [-]: JUMPIFNOTLT R14 R13 L16; goto L16 if var14 >= var3280462
...
L17: 176 [-]: LOADK R16 K56; var16 = 0.90000000000000002
     177 [-]: JUMPIFNOTLT R16 R15 L18; goto L18 if var16 >= var3673605
     178 [-]: LOADK R14 K56; var14 = 0.90000000000000002
     179 [-]: JUMP L19     ; goto L19
L18: 180 [-]: LOADK R14 K57; var14 = 0.29700000000000004
L19: 181 [-]: GETIMPORT R15 47; var15 = 0xAE2294FA
     182 [-]: MOVE R16 R12 ; var16 = var12
     183 [-]: CALL R15 2 2 ; var15 = var15(var16)
     184 [-]: LOADK R16 K48; var16 = 0.0001
     185 [-]: JUMPIFLT R15 R16 L21; goto L21 if var15 < var3412046
...
L20: 193 [-]: JUMPIFNOTLT R14 R15 L24; goto L24 if var14 >= var2756430
...
L22: 207 [-]: LOADK R16 K56; var16 = 0.90000000000000002
     208 [-]: JUMPIFNOTLT R16 R15 L24; goto L24 if var16 >= var2756430
...
L23: 222 [-]: LOADK R16 K56; var16 = 0.90000000000000002
     223 [-]: JUMPIFNOTLT R16 R15 L24; goto L24 if var16 >= var2756430
