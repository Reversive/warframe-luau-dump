...
; Max Stack Size:  13
      ...
      22 [-]: LOADK R9 K12 ; var9 = 0.23999999999999999
      23 [-]: LOADK R10 K13; var10 = 0.20999999999999999
      24 [-]: CALL R7 4 2  ; var7 = var7(var8, var9, var10)
      25 [-]: GETIMPORT R8 11; var8 = 0xA421AF95
      26 [-]: LOADK R9 K14 ; var9 = 0.20000000000000001
      27 [-]: LOADK R10 K12; var10 = 0.23999999999999999
      28 [-]: LOADK R11 K15; var11 = -0.11
      29 [-]: CALL R8 4 2  ; var8 = var8(var9, var10, var11)
      30 [-]: GETIMPORT R9 11; var9 = 0xA421AF95
      31 [-]: LOADK R10 K16; var10 = -0.20000000000000001
      32 [-]: LOADK R11 K12; var11 = 0.23999999999999999
      33 [-]: LOADK R12 K15; var12 = -0.11
...
; Max Stack Size:  17
      ...
      16 [-]: JUMPIFLT R5 R2 L0; goto L0 if var5 < var1351
      17 [-]: LOADN R5 0   ; var5 = 0
      18 [-]: JUMPIFLT R5 R3 L0; goto L0 if var5 < var1351
      19 [-]: LOADN R5 0   ; var5 = 0
      20 [-]: JUMPIFNOTLT R5 R4 L2; goto L2 if var5 >= var329294
...
L 6:  86 [-]: LOADB R9 0   ; var9 = false
      87 [-]: RETURN R9 1  ; 
L 7:  88 [-]: JUMPIF R8 L11; goto L11 if var8
      89 [-]: GETIMPORT R9 24; var9 = 0x64FB1586
      90 [-]: GETTABLEKS R10 R6 K25; var10 = var6["location"]
      91 [-]: CALL R9 2 2  ; var9 = var9(var10)
      92 [-]: GETIMPORT R10 27; var10 = _T["gDisableStalker"]
      93 [-]: JUMPIF R10 L9; goto L9 if var10
      94 [-]: LOADN R10 0  ; var10 = 0
      95 [-]: JUMPIFEQ R7 R10 L9; goto L9 if var7 == var1509959
      96 [-]: LOADN R10 23 ; var10 = 23
      97 [-]: JUMPIFEQ R7 R10 L9; goto L9 if var7 == var419826204
      98 [-]: GETTABLEKS R10 R6 K28; var10 = var6["alertTag"]
      99 [-]: GETUPVAL R11 4; var11 = upvalues[4]
     100 [-]: JUMPIFEQ R10 R11 L9; goto L9 if var10 == var-1006236900
     101 [-]: GETTABLEKS R11 R6 K29; var11 = var6["conclaveRange"]
     102 [-]: GETTABLEKS R10 R11 K30; var10 = var11["maxValue"]
     103 [-]: LOADN R11 0  ; var11 = 0
     104 [-]: JUMPIFLT R11 R10 L9; goto L9 if var11 < var621152796
     105 [-]: GETTABLEKS R10 R6 K31; var10 = var6["goalId"]
     106 [-]: JUMPXEQKS R10 K32 L9 NOT; 
     107 [-]: GETTABLEKS R10 R6 K33; var10 = var6["sortieId"]
     108 [-]: JUMPXEQKS R10 K32 L9 NOT; 
     109 [-]: GETTABLEKS R11 R6 K34; var11 = var6["keyChainName"]
     110 [-]: FASTCALL1 62 R11 L8; 
     111 [-]: GETIMPORT R10 22; var10 = 0x7B998233
     112 [-]: CALL R10 2 2 ; var10 = var10(var11)
L 8: 113 [-]: JUMPIFNOT R10 L9; goto L9 if not var10
     114 [-]: GETIMPORT R10 37; var10 = 0x7F5022CF[0xA5C556B9]
     115 [-]: MOVE R11 R9  ; var11 = var9
     116 [-]: LOADK R12 K38; var12 = "EventNode"
     117 [-]: CALL R10 3 2 ; var10 = var10(var11, var12)
     118 [-]: JUMPIF R10 L9; goto L9 if var10
     119 [-]: GETTABLEKS R10 R6 K39; var10 = var6["periodicMissionTag"]
     120 [-]: GETUPVAL R12 5; var12 = upvalues[5]
     121 [-]: GETTABLEKS R11 R12 K40; var11 = var12["ELITE_ALERT_PERIODIC_MISSION_TAG"]
     122 [-]: JUMPIFEQ R10 R11 L9; goto L9 if var10 == var-1710880228
     123 [-]: GETTABLEKS R10 R6 K39; var10 = var6["periodicMissionTag"]
     124 [-]: GETUPVAL R12 5; var12 = upvalues[5]
     125 [-]: GETTABLEKS R11 R12 K41; var11 = var12["ELITE_ALERT_PERIODIC_MISSION_TAG_ALT"]
     126 [-]: JUMPIFEQ R10 R11 L9; goto L9 if var10 == var-1006237156
     127 [-]: GETTABLEKS R10 R6 K42; var10 = var6["invasionId"]
     128 [-]: JUMPXEQKS R10 K32 L9 NOT; 
     129 [-]: GETTABLEKS R10 R6 K43; var10 = var6["forceAllyFaction"]
     130 [-]: JUMPIFNOT R10 L11; goto L11 if not var10
L 9: 131 [-]: GETIMPORT R11 5; var11 = _T["ShowImpactMessage"]
     132 [-]: JUMPIFNOT R11 L10; goto L10 if not var11
     133 [-]: GETIMPORT R11 5; var11 = _T["ShowImpactMessage"]
     134 [-]: LOADK R12 K6 ; var12 = "/Lotus/Language/Menu/BaitUnavailable"
     135 [-]: LOADN R13 3  ; var13 = 3
     136 [-]: LOADB R14 1  ; var14 = true
     137 [-]: LOADNIL R15  ; var15 = nil
     138 [-]: LOADB R16 0  ; var16 = false
     139 [-]: CALL R11 6 1 ; var11(var12, var13, var14, var15, var16)
L10: 140 [-]: LOADB R10 0  ; var10 = false
     141 [-]: RETURN R10 1 ; 
L11: 142 [-]: GETIMPORT R9 45; var9 = _T["SecretMiniGameActive"]
     143 [-]: JUMPIF R9 L12; goto L12 if var9
     144 [-]: GETIMPORT R9 27; var9 = _T["gDisableStalker"]
     145 [-]: JUMPIFNOT R9 L14; goto L14 if not var9
L12: 146 [-]: GETIMPORT R10 5; var10 = _T["ShowImpactMessage"]
     147 [-]: JUMPIFNOT R10 L13; goto L13 if not var10
     148 [-]: GETIMPORT R10 5; var10 = _T["ShowImpactMessage"]
     149 [-]: LOADK R11 K6 ; var11 = "/Lotus/Language/Menu/BaitUnavailable"
     150 [-]: LOADN R12 3  ; var12 = 3
     151 [-]: LOADB R13 1  ; var13 = true
     152 [-]: LOADNIL R14  ; var14 = nil
     153 [-]: LOADB R15 0  ; var15 = false
     154 [-]: CALL R10 6 1 ; var10(var11, var12, var13, var14, var15)
L13: 155 [-]: LOADB R9 0   ; var9 = false
     156 [-]: RETURN R9 1  ; 
L14: 157 [-]: NAMECALL R9 R0 K46; var10 = var0; var9 = var0[0xF80FAE85]
     158 [-]: CALL R9 2 2  ; var9 = var9(var10)
     159 [-]: JUMPIFNOT R9 L18; goto L18 if not var9
     160 [-]: NAMECALL R9 R0 K47; var10 = var0; var9 = var0[0xDE321E6F]
     161 [-]: CALL R9 2 2  ; var9 = var9(var10)
     162 [-]: NAMECALL R9 R9 K48; var10 = var9; var9 = var9[0x73D065D7]
     163 [-]: CALL R9 2 2  ; var9 = var9(var10)
     164 [-]: JUMPIF R9 L16; goto L16 if var9
     165 [-]: GETIMPORT R10 5; var10 = _T["ShowImpactMessage"]
     166 [-]: JUMPIFNOT R10 L15; goto L15 if not var10
     167 [-]: GETIMPORT R10 5; var10 = _T["ShowImpactMessage"]
     168 [-]: LOADK R11 K6 ; var11 = "/Lotus/Language/Menu/BaitUnavailable"
     169 [-]: LOADN R12 3  ; var12 = 3
     170 [-]: LOADB R13 1  ; var13 = true
     171 [-]: LOADNIL R14  ; var14 = nil
     172 [-]: LOADB R15 0  ; var15 = false
     173 [-]: CALL R10 6 1 ; var10(var11, var12, var13, var14, var15)
L15: 174 [-]: LOADB R9 0   ; var9 = false
     175 [-]: RETURN R9 1  ; 
L16: 176 [-]: GETIMPORT R9 1; var9 = 0xBE190284
     177 [-]: LOADK R11 K49; var11 = "DummyCallback"
     178 [-]: NAMECALL R9 R9 K50; var10 = var9; var9 = var9[0x6F58E60A]
     179 [-]: CALL R9 3 2  ; var9 = var9(var10, var11)
     180 [-]: JUMPIF R9 L18; goto L18 if var9
     181 [-]: GETIMPORT R10 5; var10 = _T["ShowImpactMessage"]
     182 [-]: JUMPIFNOT R10 L17; goto L17 if not var10
     183 [-]: GETIMPORT R10 5; var10 = _T["ShowImpactMessage"]
     184 [-]: LOADK R11 K6 ; var11 = "/Lotus/Language/Menu/BaitUnavailable"
     185 [-]: LOADN R12 3  ; var12 = 3
     186 [-]: LOADB R13 1  ; var13 = true
     187 [-]: LOADNIL R14  ; var14 = nil
     188 [-]: LOADB R15 0  ; var15 = false
     189 [-]: CALL R10 6 1 ; var10(var11, var12, var13, var14, var15)
L17: 190 [-]: LOADB R9 0   ; var9 = false
     191 [-]: RETURN R9 1  ; 
L18: 192 [-]: LOADB R9 1   ; var9 = true
     193 [-]: RETURN R9 1  ; 
...
L 3:  33 [-]: JUMPIF R7 L4 ; goto L4 if var7
      ...
      38 [-]: JUMPIFNOTEQ R7 R8 L4; goto L4 if var7 ~= var1862272837
