...
L 0:  13 [-]: JUMPIF R3 L1 
      ...
      16 [-]: CALL R3 2 1  
      17 [-]: GETIMPORT R4 11 [0xBD3ECD08]
      18 [-]: JUMPIFNOTLT R4 R3 L2
L 1:  19 [-]: GETIMPORT R3 14 ["ShowImpactMessage"]
      ...
      26 [-]: LOADB R3 0   
      27 [-]: RETURN R3 1  
L 2:  28 [-]: GETIMPORT R3 1 [0x89326C93]
...
L 3:  35 [-]: MOVE R11 R8  
      ...
      37 [-]: CALL R9 2 1  
      38 [-]: GETIMPORT R10 11 [0xBD3ECD08]
      39 [-]: JUMPIFNOTLT R10 R9 L5
      40 [-]: GETIMPORT R9 20 ["fomorianNegator"]
      41 [-]: JUMPXEQKNIL R9 L4 NOT
      42 [-]: GETIMPORT R9 21 ["_T"]
      43 [-]: NEWTABLE R10 0 0
      44 [-]: SETTABLEKS R10 R9 K19 ["fomorianNegator"]
L 4:  45 [-]: GETIMPORT R10 20 ["fomorianNegator"]
      46 [-]: NAMECALL R11 R0 K22 [0x388577D5]
      47 [-]: CALL R11 1 1 
      48 [-]: GETTABLE R9 R10 R11
      49 [-]: JUMPIF R9 L5 
      50 [-]: GETIMPORT R9 14 ["ShowImpactMessage"]
      ...
      55 [-]: LOADB R14 0  
      56 [-]: CALL R9 5 0  
      57 [-]: GETIMPORT R9 20 ["fomorianNegator"]
...
L 4:  27 [-]: JUMPIFEQ R8 R0 L9
      28 [-]: GETIMPORT R10 15 [0x2CB70B14]
      29 [-]: FASTCALL1 62 R10 L5
      30 [-]: GETIMPORT R9 1 [0x7B998233]
      31 [-]: CALL R9 1 1  
L 5:  32 [-]: JUMPIF R9 L6 
      33 [-]: GETIMPORT R11 15 [0x2CB70B14]
      34 [-]: LOADB R12 0  
      35 [-]: LOADN R13 3  
      36 [-]: LOADN R14 1  
      37 [-]: LOADB R15 1  
      ...
      39 [-]: CALL R9 6 0  
L 6:  40 [-]: GETIMPORT R9 3 [0x89326C93]
...
L 8:  53 [-]: JUMPIF R9 L9 
      ...
      56 [-]: CALL R9 2 1  
      57 [-]: GETIMPORT R10 22 [0xBD3ECD08]
      58 [-]: JUMPIFNOTLE R9 R10 L9
      59 [-]: GETIMPORT R9 9 ["_T"]
      60 [-]: GETIMPORT R11 24 ["gPlayersInRange"]
      61 [-]: ADDK R10 R11 K23 [1]
      62 [-]: SETTABLEKS R10 R9 K10 ["gPlayersInRange"]
L 9:  63 [-]: FORGLOOP R4 L4 2 [inext]
      64 [-]: GETIMPORT R5 15 [0x2CB70B14]
      65 [-]: FASTCALL1 62 R5 L10
      66 [-]: GETIMPORT R4 1 [0x7B998233]
      67 [-]: CALL R4 1 1  
L10:  68 [-]: JUMPIF R4 L11
      69 [-]: GETIMPORT R6 26 [0x64FB1586]
      70 [-]: GETIMPORT R7 28 [0x287068AC]
      71 [-]: CALL R6 1 1  
      72 [-]: GETIMPORT R9 15 [0x2CB70B14]
      73 [-]: LOADB R10 0  
      74 [-]: LOADN R11 3  
      75 [-]: LOADN R12 1  
      76 [-]: LOADB R13 1  
