...
; Max Stack Size:  8
       ...
       0 [-]: GETIMPORT R2 2 ["gTrappingEnabled"]
       1 [-]: JUMPIF R2 L1 
       2 [-]: GETIMPORT R2 4 ["ShowImpactMessage"]
       3 [-]: JUMPIFNOT R2 L0
       4 [-]: GETIMPORT R2 4 ["ShowImpactMessage"]
...
L 0:   4 [-]: JUMPIFNOT R2 L1
       5 [-]: RETURN R0 0  
L 1:   6 [-]: GETIMPORT R3 3 [0x9BC624C1]
       7 [-]: FASTCALL1 62 R3 L2
       8 [-]: GETIMPORT R2 1 [0x7B998233]
       9 [-]: CALL R2 1 1  
L 2:  10 [-]: JUMPIF R2 L3 
      11 [-]: GETIMPORT R4 3 [0x9BC624C1]
      12 [-]: LOADB R5 1   
      13 [-]: LOADN R6 3   
      14 [-]: LOADN R7 1   
      15 [-]: LOADB R8 0   
...
L 3:  19 [-]: NAMECALL R2 R0 K5 [0xA5E492D4]
      ...
      21 [-]: JUMPIF R2 L4 
      22 [-]: RETURN R0 0  
L 4:  23 [-]: GETIMPORT R2 8 ["gTrappingGearIndex"]
      24 [-]: JUMPIFNOT R2 L5
      25 [-]: RETURN R0 0  
L 5:  26 [-]: GETIMPORT R2 10 [0x76EA806B]
      27 [-]: LOADN R4 0   
...
L 9:  44 [-]: NAMECALL R4 R3 K13 [0x64D5DC52]
      ...
      48 [-]: GETIMPORT R4 15 ["ShowImpactMessage"]
      49 [-]: JUMPIFNOT R4 L10
      50 [-]: GETIMPORT R4 15 ["ShowImpactMessage"]
...
L18:  85 [-]: JUMPIFNOT R6 L19
      86 [-]: RETURN R0 0  
L19:  87 [-]: GETIMPORT R6 22 [0x89326C93]
      88 [-]: GETIMPORT R8 24 [0x74389DB1]
...
L20:  95 [-]: JUMPIFNOT R7 L21
      96 [-]: GETIMPORT R7 27 [0x3D106989]
      97 [-]: LOADK R9 K28 ["Trap: can't find reference point with tag "]
      98 [-]: GETIMPORT R10 24 [0x74389DB1]
...
L21: 104 [-]: NAMECALL R7 R0 K30 [0xF6EBD926]
     ...
     109 [-]: CALL R8 1 1  
     110 [-]: GETIMPORT R10 34 [0xA421AF95]
     111 [-]: GETTABLEKS R11 R8 K35 ["x"]
     112 [-]: GETTABLEKS R12 R7 K36 ["y"]
     113 [-]: GETTABLEKS R13 R8 K37 ["z"]
     114 [-]: CALL R10 3 1 
     115 [-]: SUB R9 R10 R7
     116 [-]: GETIMPORT R10 39 [0xC2892F65]
     117 [-]: MOVE R11 R9  
     118 [-]: CALL R10 1 0 
     119 [-]: MULK R11 R9 K40 [2]
     120 [-]: ADD R10 R7 R11
     121 [-]: GETIMPORT R12 34 [0xA421AF95]
     122 [-]: LOADN R13 0  
     123 [-]: LOADN R14 2  
     124 [-]: LOADN R15 0  
     125 [-]: CALL R12 3 1 
     126 [-]: ADD R11 R10 R12
     127 [-]: GETIMPORT R12 42 [0x808DC004]
     128 [-]: MOVE R13 R10 
     129 [-]: MOVE R14 R10 
     130 [-]: GETIMPORT R15 34 [0xA421AF95]
     131 [-]: LOADN R16 0  
     132 [-]: LOADN R17 -1 
     133 [-]: LOADN R18 0  
     134 [-]: CALL R15 3 -1
     135 [-]: CALL R12 -1 0
     136 [-]: GETIMPORT R12 34 [0xA421AF95]
     137 [-]: CALL R12 0 1 
     138 [-]: GETIMPORT R13 44 [0x00046924]
     139 [-]: CALL R13 0 1 
     140 [-]: GETIMPORT R14 22 [0x89326C93]
     141 [-]: MOVE R16 R11 
     142 [-]: MOVE R17 R10 
     143 [-]: MOVE R18 R0  
     ...
     149 [-]: CALL R14 8 1 
     150 [-]: JUMPIF R14 L22
     151 [-]: GETIMPORT R15 15 ["ShowImpactMessage"]
...
L22: 159 [-]: MOVE R17 R10 
     ...
     161 [-]: CALL R15 2 1 
     162 [-]: GETIMPORT R16 49 [0x65C0F9F5]
     163 [-]: JUMPIFNOTLT R15 R16 L24
     164 [-]: GETIMPORT R15 15 ["ShowImpactMessage"]
     165 [-]: JUMPIFNOT R15 L23
     166 [-]: GETIMPORT R15 15 ["ShowImpactMessage"]
...
L24: 174 [-]: NAMECALL R15 R0 K51 [0xE79E7EF4]
     ...
     177 [-]: CALL R15 1 1 
     178 [-]: LOADN R18 1  
     179 [-]: GETIMPORT R19 54 [0xAF4ADBD3]
     180 [-]: LENGTH R16 R19
     181 [-]: LOADN R17 1  
     182 [-]: FORNPREP R16 L28
L25: 183 [-]: GETIMPORT R22 54 [0xAF4ADBD3]
     184 [-]: GETTABLE R21 R22 R18
     185 [-]: NAMECALL R19 R15 K55 [0xF2DEAF69]
     186 [-]: CALL R19 2 1 
     187 [-]: JUMPIFNOT R19 L27
     188 [-]: GETIMPORT R19 15 ["ShowImpactMessage"]
     189 [-]: JUMPIFNOT R19 L26
     190 [-]: GETIMPORT R19 15 ["ShowImpactMessage"]
...
L28: 199 [-]: GETIMPORT R16 58 [0xBE190284]
     ...
     205 [-]: CALL R18 0 1 
     206 [-]: GETIMPORT R20 63 [0x0469F296]
     207 [-]: MOVE R21 R17 
     208 [-]: CALL R20 1 -1
     209 [-]: NAMECALL R18 R18 K64 [0x3AD9ED31]
     210 [-]: CALL R18 -1 1
     211 [-]: GETTABLEKS R19 R18 K65 ["locTag"]
     212 [-]: GETIMPORT R20 67 [0x20E8CA12]
     213 [-]: MOVE R21 R13 
     214 [-]: GETIMPORT R22 44 [0x00046924]
     215 [-]: LOADN R23 0  
     216 [-]: LOADN R24 90 
     217 [-]: LOADN R25 0  
     218 [-]: CALL R22 3 -1
     219 [-]: CALL R20 -1 1
     220 [-]: SETUPVAL R20 1
     221 [-]: GETIMPORT R21 34 [0xA421AF95]
     222 [-]: GETTABLEKS R22 R12 K35 ["x"]
     223 [-]: GETTABLEKS R23 R12 K36 ["y"]
     224 [-]: GETTABLEKS R24 R12 K37 ["z"]
     225 [-]: CALL R21 3 1 
     226 [-]: GETIMPORT R22 69 [0x492C7F2A]
     227 [-]: GETIMPORT R23 71 [0xB561E096]
     228 [-]: GETUPVAL R24 1
     229 [-]: CALL R22 2 1 
     230 [-]: ADD R20 R21 R22
     231 [-]: SETUPVAL R20 2
     232 [-]: GETIMPORT R20 73 [0x20B7F774]
     233 [-]: GETUPVAL R21 2
     234 [-]: MOVE R22 R7  
     235 [-]: CALL R20 2 1 
     236 [-]: GETIMPORT R21 67 [0x20E8CA12]
     237 [-]: GETUPVAL R22 1
     238 [-]: GETIMPORT R23 44 [0x00046924]
     ...
     247 [-]: CALL R23 1 1 
     248 [-]: SUB R21 R22 R23
     249 [-]: GETIMPORT R22 27 [0x3D106989]
     ...
     261 [-]: CALL R22 1 0 
     262 [-]: GETIMPORT R22 27 [0x3D106989]
...
L29: 282 [-]: SUBK R29 R26 K82 [1]
     ...
     287 [-]: MOVE R23 R26 
     288 [-]: GETIMPORT R28 84 ["_T"]
     289 [-]: SETTABLEKS R23 R28 K7 ["gTrappingGearIndex"]
     290 [-]: JUMP L31
    
L30: 291 [-]: FORNLOOP R24 L29
L31: 292 [-]: GETIMPORT R24 86 ["gTrappingMapDataType"]
     293 [-]: FASTCALL1 62 R24 L32
     294 [-]: MOVE R26 R24 
     295 [-]: GETIMPORT R25 1 [0x7B998233]
     296 [-]: CALL R25 1 1 
L32: 297 [-]: JUMPIF R25 L39
     ...
     302 [-]: GETIMPORT R26 90 [0x42645DA3]
     303 [-]: MOVE R27 R25 
     304 [-]: CALL R26 1 1 
L33: 305 [-]: NAMECALL R27 R26 K91 [0xD2D3875A]
     306 [-]: CALL R27 1 1 
     307 [-]: JUMPIF R27 L34
     308 [-]: GETIMPORT R27 93 [0xCBD666E1]
...
L35: 319 [-]: GETIMPORT R28 96 [0xB009BBC6]
     320 [-]: MOVE R29 R24 
     321 [-]: CALL R28 1 1 
     322 [-]: FASTCALL1 62 R28 L36
     323 [-]: MOVE R30 R28 
     324 [-]: GETIMPORT R29 1 [0x7B998233]
     325 [-]: CALL R29 1 1 
...
L37: 332 [-]: FASTCALL1 62 R27 L38
     333 [-]: MOVE R29 R27 
     334 [-]: GETIMPORT R28 1 [0x7B998233]
     335 [-]: CALL R28 1 1 
L38: 336 [-]: JUMPIF R28 L40
     337 [-]: MOVE R30 R19 
     338 [-]: GETIMPORT R31 20 [0x3A6DACF1]
     339 [-]: MOVE R32 R27 
     340 [-]: MOVE R33 R21 
     341 [-]: GETUPVAL R34 1
     ...
     344 [-]: CALL R28 7 0 
     345 [-]: RETURN R0 0  
L39: 346 [-]: GETIMPORT R25 27 [0x3D106989]
...
; Max Stack Size:  12
       ...
       9 [-]: GETIMPORT R4 7 [0x89326C93]
      10 [-]: GETIMPORT R6 9 [0xA418E3C5]
      11 [-]: GETUPVAL R7 0
      12 [-]: GETUPVAL R8 1
      13 [-]: LOADNIL R9   
...
L 0:  20 [-]: JUMPIF R5 L1 
      ...
      23 [-]: CALL R5 2 0  
L 1:  24 [-]: GETIMPORT R5 7 [0x89326C93]
