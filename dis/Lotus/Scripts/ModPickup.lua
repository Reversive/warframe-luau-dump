...
L 0:   4 [-]: NAMECALL R5 R0 K0 [0x4528012D]
      ...
      10 [-]: CALL R5 1 1  
L 1:  11 [-]: JUMPIF R5 L4 
      12 [-]: GETIMPORT R7 4 ["gFusionBundleType"]
      13 [-]: NAMECALL R5 R2 K5 [0xF2DEAF69]
      14 [-]: CALL R5 2 1  
      15 [-]: JUMPIFNOT R5 L4
      16 [-]: GETIMPORT R7 7 [0xD83570C9]
      17 [-]: GETIMPORT R8 9 ["EMPTY_SYMBOL"]
      18 [-]: NAMECALL R5 R0 K10 [0x47901F07]
      19 [-]: CALL R5 3 0  
      20 [-]: GETIMPORT R7 12 [0x355127BF]
      21 [-]: GETIMPORT R8 9 ["EMPTY_SYMBOL"]
      22 [-]: GETIMPORT R9 14 [0x5A5AFA64]
      23 [-]: NAMECALL R5 R0 K10 [0x47901F07]
      24 [-]: CALL R5 4 0  
      25 [-]: GETIMPORT R7 16 [0x4B34CB1E]
...
L 5:  40 [-]: JUMPIF R5 L16
      41 [-]: GETIMPORT R7 20 ["gLotusPickUpItemType"]
...
L 7:  54 [-]: NAMECALL R5 R3 K22 [0xF278F8A1]
      ...
      61 [-]: CALL R7 1 1  
L 8:  62 [-]: JUMPIF R7 L9 
      63 [-]: GETIMPORT R9 25 ["gLotusAuraUpgradeType"]
      64 [-]: NAMECALL R7 R5 K5 [0xF2DEAF69]
      65 [-]: CALL R7 2 1  
      66 [-]: JUMPIF R7 L10
L 9:  67 [-]: LOADN R7 3   
      68 [-]: JUMPIFNOTEQ R6 R7 L11
L10:  69 [-]: GETIMPORT R4 27 [0xC4080EEC]
      70 [-]: JUMP L16
...
L12:  75 [-]: JUMPIF R7 L13
      76 [-]: GETIMPORT R9 29 ["gMeleeTreeType"]
      77 [-]: NAMECALL R7 R5 K5 [0xF2DEAF69]
      78 [-]: CALL R7 2 1  
      79 [-]: JUMPIFNOT R7 L13
      80 [-]: GETIMPORT R4 31 [0x42CB7B1F]
      81 [-]: JUMP L16
    
L13:  82 [-]: LOADN R7 2   
      83 [-]: JUMPIFNOTEQ R6 R7 L14
      84 [-]: GETIMPORT R4 33 [0x3209764B]
      85 [-]: GETUPVAL R9 0
      86 [-]: LOADN R10 1  
...
L14: 100 [-]: LOADN R7 1   
     ...
     102 [-]: GETIMPORT R4 38 [0xBE899E15]
     103 [-]: JUMP L16
    
L15: 104 [-]: GETIMPORT R4 40 [0xD7D9EA5A]
...
L17: 109 [-]: JUMPIFNOT R5 L19
     ...
     113 [-]: RETURN R0 0  
L18: 114 [-]: GETIMPORT R5 43 [0xCBD666E1]
...
L20: 121 [-]: JUMPIFNOT R5 L21
     122 [-]: JUMPBACK L0  
L21: 123 [-]: MOVE R7 R4   
     124 [-]: GETIMPORT R8 9 ["EMPTY_SYMBOL"]
     125 [-]: GETIMPORT R9 46 [0xA421AF95]
     126 [-]: LOADN R10 0  
...
L 1:  10 [-]: JUMPIF R4 L10
      ...
      18 [-]: CALL R6 1 1  
L 2:  19 [-]: JUMPIF R6 L3 
      20 [-]: GETIMPORT R8 6 ["gLotusAuraUpgradeType"]
      21 [-]: NAMECALL R6 R4 K7 [0xF2DEAF69]
      22 [-]: CALL R6 2 1  
      23 [-]: JUMPIF R6 L4 
L 3:  24 [-]: LOADN R6 3   
      25 [-]: JUMPIFNOTEQ R5 R6 L5
L 4:  26 [-]: GETIMPORT R3 9 [0xC4080EEC]
      27 [-]: JUMP L12
...
L 5:  28 [-]: FASTCALL1 62 R4 L6
      ...
      31 [-]: CALL R6 1 1  
L 6:  32 [-]: JUMPIF R6 L7 
      33 [-]: GETIMPORT R8 11 ["gMeleeTreeType"]
      34 [-]: NAMECALL R6 R4 K7 [0xF2DEAF69]
      35 [-]: CALL R6 2 1  
      36 [-]: JUMPIFNOT R6 L7
      37 [-]: GETIMPORT R3 13 [0x42CB7B1F]
      38 [-]: JUMP L12
    
L 7:  39 [-]: LOADN R6 2   
      40 [-]: JUMPIFNOTEQ R5 R6 L8
      41 [-]: GETIMPORT R3 15 [0x3209764B]
      42 [-]: GETUPVAL R8 0
      43 [-]: LOADN R9 1   
...
L 8:  57 [-]: LOADN R6 1   
      ...
      59 [-]: GETIMPORT R3 20 [0xBE899E15]
      60 [-]: JUMP L12
    
L 9:  61 [-]: GETIMPORT R3 22 [0xD7D9EA5A]
      62 [-]: JUMP L12
...
L10:  63 [-]: SUBK R1 R1 K23 [1]
      ...
      66 [-]: RETURN R0 0  
L11:  67 [-]: GETIMPORT R4 25 [0xCBD666E1]
...
L13:  74 [-]: JUMPIFNOT R4 L14
      75 [-]: JUMPBACK L0  
L14:  76 [-]: MOVE R6 R3   
      77 [-]: GETIMPORT R7 28 ["EMPTY_SYMBOL"]
      78 [-]: GETIMPORT R8 30 [0xA421AF95]
      79 [-]: LOADN R9 0   
