...
L 3:  24 [-]: SETTABLEKS R4 R3 K6 ["y"]
      25 [-]: GETIMPORT R4 12 [0xAE2294FA]
      26 [-]: MOVE R5 R3   
      27 [-]: CALL R4 1 1  
      28 [-]: MULK R4 R4 K13 [2]
      29 [-]: GETIMPORT R5 15 [0x42DCC9F5]
      30 [-]: MOVE R6 R4   
      31 [-]: LOADN R7 0   
      32 [-]: LOADN R8 1   
      33 [-]: CALL R5 3 1  
      34 [-]: GETIMPORT R6 17 [0x9BAFFFE3]
      35 [-]: GETIMPORT R7 19 [0xD5F1A190]
      36 [-]: GETIMPORT R8 21 [0xCBDE0A1A]
      37 [-]: MOVE R9 R5   
      38 [-]: CALL R6 3 1  
      39 [-]: MOVE R2 R6   
      40 [-]: GETIMPORT R6 17 [0x9BAFFFE3]
      41 [-]: MOVE R7 R1   
      42 [-]: MOVE R8 R2   
      43 [-]: GETIMPORT R9 23 [0x67652851]
      44 [-]: CALL R9 0 -1 
      45 [-]: CALL R6 -1 1 
      46 [-]: MOVE R1 R6   
      47 [-]: GETUPVAL R6 0
...
L 5:  59 [-]: JUMPIF R3 L6 
      ...
      63 [-]: CALL R3 2 0  
L 6:  64 [-]: GETIMPORT R3 29 [0x75599B4A]
      65 [-]: LOADN R4 0   
...
L10:  82 [-]: NAMECALL R3 R0 K30 [0xFA9E477F]
      ...
      85 [-]: CALL R3 1 1  
      86 [-]: GETIMPORT R4 29 [0x75599B4A]
      87 [-]: JUMPIFNOTLT R3 R4 L11
      88 [-]: RETURN R0 0  
L11:  89 [-]: GETIMPORT R3 33 [0x89326C93]
      90 [-]: GETIMPORT R5 35 [0x0469F296]
...
L12:  99 [-]: JUMPIFNOT R4 L13
     100 [-]: GETIMPORT R4 40 ["NoDroneCrawlers"]
     101 [-]: JUMPIFNOT R4 L14
L13: 102 [-]: RETURN R0 0  
L14: 103 [-]: GETIMPORT R4 42 [0x655F78F6]
     104 [-]: JUMPIFNOT R4 L16
     105 [-]: GETIMPORT R4 33 [0x89326C93]
     106 [-]: NAMECALL R4 R4 K43 [0x61BE252A]
     107 [-]: CALL R4 1 1  
     108 [-]: GETIMPORT R6 45 [0x43C9D578]
     109 [-]: LOADN R8 1   
     110 [-]: FASTCALL2 18 R8 R4 L15
     111 [-]: MOVE R9 R4   
     112 [-]: GETIMPORT R7 10 [0xB62ECFE0]
     113 [-]: CALL R7 2 1  
L15: 114 [-]: GETTABLE R5 R6 R7
     115 [-]: GETIMPORT R6 33 [0x89326C93]
     116 [-]: GETIMPORT R8 47 [0x34FAFFAB]
     117 [-]: NAMECALL R9 R0 K48 [0xD1586535]
     118 [-]: CALL R9 1 1  
     119 [-]: LOADN R10 0  
     120 [-]: GETIMPORT R11 50 [0xB298166E]
...
L16: 126 [-]: NAMECALL R4 R0 K52 [0xADBDC520]
     127 [-]: CALL R4 1 1  
     128 [-]: GETIMPORT R5 54 [0x55730E1A]
     129 [-]: LOADN R6 1   
     130 [-]: GETIMPORT R8 56 [0xD75633C4]
     131 [-]: LENGTH R7 R8 
     132 [-]: CALL R5 2 1  
...
L20: 158 [-]: NAMECALL R8 R4 K57 [0x29EF273D]
     159 [-]: CALL R8 1 1  
     160 [-]: GETIMPORT R11 56 [0xD75633C4]
     161 [-]: GETTABLE R10 R11 R5
     162 [-]: NAMECALL R11 R0 K62 [0xF6EBD926]
     163 [-]: CALL R11 1 1 
     164 [-]: GETIMPORT R12 64 [0x122C234D]
     165 [-]: GETIMPORT R13 35 [0x0469F296]
     166 [-]: CALL R13 0 1 
     167 [-]: MOVE R14 R7  
     168 [-]: LOADB R15 1  
...
L21: 175 [-]: JUMPIF R9 L33
     ...
     177 [-]: CALL R9 1 1  
     178 [-]: MOVE R12 R0  
     179 [-]: GETIMPORT R13 68 [0x44374FEB]
     180 [-]: NAMECALL R10 R9 K69 [0xB6B094B2]
     181 [-]: CALL R10 3 0 
     182 [-]: GETIMPORT R12 71 [0xBE105920]
     183 [-]: GETIMPORT R13 64 [0x122C234D]
     ...
     193 [-]: CALL R10 3 0 
     194 [-]: GETIMPORT R12 75 [0xCDA4C457]
     195 [-]: NAMECALL R10 R9 K76 [0x3273BA96]
     196 [-]: CALL R10 2 0 
     197 [-]: GETIMPORT R12 75 [0xCDA4C457]
     198 [-]: NAMECALL R10 R0 K76 [0x3273BA96]
     199 [-]: CALL R10 2 0 
     200 [-]: GETIMPORT R12 78 [0x6DA6D7B8]
     201 [-]: LOADB R13 0  
     202 [-]: LOADN R14 2  
     203 [-]: LOADN R15 2  
     204 [-]: LOADB R16 1  
     ...
     219 [-]: MOVE R13 R11 
     220 [-]: GETIMPORT R12 4 [0x7B998233]
     221 [-]: CALL R12 1 1 
...
L23: 226 [-]: FASTCALL1 62 R6 L24
     227 [-]: MOVE R12 R6  
     228 [-]: GETIMPORT R11 4 [0x7B998233]
     229 [-]: CALL R11 1 1 
...
L26: 242 [-]: NAMECALL R11 R0 K84 [0xE4B9DB64]
     243 [-]: CALL R11 1 1 
     244 [-]: GETIMPORT R13 86 ["cloneTheDeadAbility"]
     245 [-]: FASTCALL1 62 R13 L27
     246 [-]: GETIMPORT R12 4 [0x7B998233]
     247 [-]: CALL R12 1 1 
...
L28: 253 [-]: JUMPIF R12 L30
     ...
     255 [-]: CALL R12 1 1 
     256 [-]: GETIMPORT R15 86 ["cloneTheDeadAbility"]
     257 [-]: GETTABLE R14 R15 R12
     258 [-]: FASTCALL1 62 R14 L29
     259 [-]: GETIMPORT R13 4 [0x7B998233]
     260 [-]: CALL R13 1 1 
L29: 261 [-]: JUMPIF R13 L30
     262 [-]: GETIMPORT R15 89 [0xBC990691]
     263 [-]: GETIMPORT R16 91 ["EMPTY_SYMBOL"]
     264 [-]: GETIMPORT R17 93 ["ZERO_VECTOR"]
     265 [-]: GETIMPORT R18 95 ["ZERO_ROTATION"]
     266 [-]: MOVE R19 R11 
     267 [-]: NAMECALL R13 R9 K96 [0x47901F07]
     268 [-]: CALL R13 6 0 
L30: 269 [-]: GETIMPORT R11 26 [0xCBD666E1]
     270 [-]: LOADK R12 K97 [0.5]
     271 [-]: CALL R11 1 0 
     272 [-]: FASTCALL1 62 R9 L31
     273 [-]: MOVE R12 R9  
     274 [-]: GETIMPORT R11 4 [0x7B998233]
     275 [-]: CALL R11 1 1 
L31: 276 [-]: JUMPIF R11 L33
     277 [-]: FASTCALL1 62 R0 L32
     278 [-]: MOVE R12 R0  
     279 [-]: GETIMPORT R11 4 [0x7B998233]
     280 [-]: CALL R11 1 1 
