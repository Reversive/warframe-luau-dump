...
L 4:  37 [-]: JUMPIFNOT R6 L5
      ...
      47 [-]: GETIMPORT R6 9 ["OrokinTraps"]
      48 [-]: GETIMPORT R8 17 ["_refs"]
      49 [-]: ADDK R7 R8 K16 [1]
      50 [-]: SETTABLEKS R7 R6 K11 ["_refs"]
L 5:  51 [-]: GETIMPORT R7 9 ["OrokinTraps"]
...
L10:  76 [-]: NAMECALL R8 R0 K20 [0x13FE5C2E]
      ...
      80 [-]: GETIMPORT R12 22 [0x78CF4F10]
...
L11:  84 [-]: JUMPIFEQ R2 R9 L18
      ...
      91 [-]: GETIMPORT R10 25 [0x19596E60]
      92 [-]: JUMPIFNOT R10 L12
      93 [-]: NAMECALL R10 R0 K26 [0xDE321E6F]
      94 [-]: CALL R10 1 1 
      95 [-]: LOADN R12 83 
      96 [-]: LOADN R13 2  
      97 [-]: GETIMPORT R14 28 [0x36847BA7]
      98 [-]: NAMECALL R10 R10 K29 [0x5E6704FF]
      99 [-]: CALL R10 4 0 
     100 [-]: JUMP L13
    
L12: 101 [-]: MOVE R12 R4  
     102 [-]: GETIMPORT R13 28 [0x36847BA7]
...
L14: 107 [-]: GETTABLEKS R11 R6 K13 ["_active"]
     ...
     112 [-]: GETIMPORT R10 25 [0x19596E60]
     113 [-]: JUMPIFNOT R10 L15
     114 [-]: NAMECALL R10 R0 K26 [0xDE321E6F]
     115 [-]: CALL R10 1 1 
     116 [-]: LOADN R12 83 
     117 [-]: LOADN R13 2  
     118 [-]: GETIMPORT R14 28 [0x36847BA7]
...
L17: 127 [-]: MOVE R2 R9   
L18: 128 [-]: GETIMPORT R10 35 [0xCBD666E1]
...
L20: 137 [-]: JUMPIF R7 L23
     ...
     143 [-]: GETIMPORT R7 25 [0x19596E60]
     144 [-]: JUMPIFNOT R7 L21
     145 [-]: NAMECALL R7 R0 K26 [0xDE321E6F]
     146 [-]: CALL R7 1 1  
     147 [-]: LOADN R9 83  
     148 [-]: LOADN R10 2  
     149 [-]: GETIMPORT R11 28 [0x36847BA7]
...
L23: 158 [-]: GETTABLEKS R8 R6 K11 ["_refs"]
     ...
     163 [-]: GETIMPORT R7 9 ["OrokinTraps"]
     164 [-]: LOADNIL R8   
     165 [-]: SETTABLE R8 R7 R5
     166 [-]: GETIMPORT R7 9 ["OrokinTraps"]
     167 [-]: GETIMPORT R9 17 ["_refs"]
     168 [-]: SUBK R8 R9 K16 [1]
     169 [-]: SETTABLEKS R8 R7 K11 ["_refs"]
     170 [-]: GETIMPORT R7 17 ["_refs"]
     171 [-]: JUMPXEQKN R7 K31 L24 NOT [0]
     172 [-]: GETIMPORT R7 10 ["_T"]
     173 [-]: LOADNIL R8   
...
; Max Stack Size:  10
      ...
      11 [-]: CALL R3 1 1  
L 0:  12 [-]: JUMPIF R3 L1 
      13 [-]: GETIMPORT R5 2 ["gBaseAvatarType"]
...
L 1:  22 [-]: SETUPVAL R0 0
      ...
      28 [-]: CALL R3 3 0  
      29 [-]: RETURN R0 0  
L 2:  30 [-]: GETIMPORT R4 9 [0x0469F296]
