...
L 6:  31 [-]: JUMPIF R6 L16
      32 [-]: GETIMPORT R7 5 ["curTransmission"]
      33 [-]: FASTCALL1 62 R7 L7
      34 [-]: GETIMPORT R6 7 [0x7B998233]
      35 [-]: CALL R6 1 1  
L 7:  36 [-]: JUMPIF R6 L14
      37 [-]: GETIMPORT R6 5 ["curTransmission"]
      38 [-]: JUMPIFEQ R1 R6 L13
      39 [-]: GETIMPORT R1 5 ["curTransmission"]
...
L 9:  49 [-]: JUMPIFEQ R4 R3 L13
      50 [-]: JUMPIFNOT R3 L11
      51 [-]: JUMPIF R5 L10
      52 [-]: GETIMPORT R9 16 [0x2318FBC2]
      53 [-]: GETIMPORT R10 19 [0x3630E649]
      54 [-]: LOADN R11 1  
      55 [-]: GETIMPORT R13 16 [0x2318FBC2]
      56 [-]: LENGTH R12 R13
      57 [-]: CALL R10 2 1 
      ...
      62 [-]: CALL R6 4 0  
L10:  63 [-]: GETIMPORT R8 13 [0xFAEEAF8A]
      64 [-]: LOADB R9 0   
      65 [-]: LOADB R10 1  
      66 [-]: NAMECALL R6 R0 K20 [0x5D985C7E]
      67 [-]: CALL R6 4 0  
      68 [-]: GETIMPORT R8 13 [0xFAEEAF8A]
      69 [-]: NAMECALL R6 R0 K14 [0x4C91B5D8]
      70 [-]: CALL R6 2 0  
      71 [-]: JUMP L13
    
L11:  72 [-]: JUMPIF R5 L12
      73 [-]: GETIMPORT R9 22 [0x9657AF22]
      74 [-]: GETIMPORT R10 19 [0x3630E649]
      75 [-]: LOADN R11 1  
      76 [-]: GETIMPORT R13 22 [0x9657AF22]
      77 [-]: LENGTH R12 R13
      78 [-]: CALL R10 2 1 
      ...
      83 [-]: CALL R6 4 0  
L12:  84 [-]: GETIMPORT R8 24 [0x9236B565]
      85 [-]: LOADB R9 0   
      86 [-]: LOADB R10 1  
      87 [-]: NAMECALL R6 R0 K20 [0x5D985C7E]
      88 [-]: CALL R6 4 0  
      89 [-]: GETIMPORT R8 24 [0x9236B565]
...
L14:  95 [-]: LOADB R5 1   
L15:  96 [-]: GETIMPORT R6 26 [0xCBD666E1]
      97 [-]: LOADN R7 0   
      98 [-]: CALL R6 1 0  
      99 [-]: JUMPBACK L5  
L16: 100 [-]: RETURN R0 0  
...
L 2:  15 [-]: JUMPIF R4 L3 
      ...
      17 [-]: CALL R4 1 1  
      18 [-]: MUL R5 R4 R4 
      19 [-]: GETIMPORT R6 8 [0x9BAFFFE3]
      20 [-]: LOADK R7 K9 [0.10000000000000001]
      21 [-]: LOADN R8 6   
      22 [-]: MOVE R9 R5   
      23 [-]: CALL R6 3 1  
      24 [-]: MOVE R5 R6   
      25 [-]: GETIMPORT R8 12 ["EMISSIVE_MAP_ATTEN"]
      26 [-]: MOVE R9 R5   
      27 [-]: LOADN R10 0  
      28 [-]: LOADN R11 0  
      29 [-]: LOADN R12 0  
      ...
      32 [-]: CALL R6 7 0  
L 3:  33 [-]: GETIMPORT R4 15 [0xCBD666E1]
      34 [-]: LOADN R5 0   
      35 [-]: CALL R4 1 0  
      36 [-]: JUMPBACK L0  
L 4:  37 [-]: RETURN R0 0  
