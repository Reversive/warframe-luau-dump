...
; Max Stack Size:  2
       ...
       9 [-]: DUPCLOSURE R1 K7; 
      10 [-]: SETGLOBAL R1 K8; "LoidQuestEntityEmissives" = var1
      11 [-]: RETURN R0 0  ; 
...
L 1:  13 [-]: NAMECALL R2 R1 K8; var3 = var1; var2 = var1[0x22DA1852]
      ...
      18 [-]: JUMPIFEQ R2 R4 L2; goto L2 if var2 == var16777990
...
L 7:  36 [-]: JUMPIF R6 L14; goto L14 if var6
      ...
      38 [-]: JUMPIFEQ R1 R6 L13; goto L13 if var1 == var327969
      ...
      46 [-]: JUMPIFEQ R2 R6 L8; goto L8 if var2 == var16777990
      47 [-]: LOADB R3 0 +1; var3 = false
L 8:  48 [-]: LOADB R3 1   ; var3 = true
L 9:  49 [-]: JUMPIFEQ R4 R3 L13; goto L13 if var4 == var1901332
...
L 2:  15 [-]: JUMPIF R4 L3 ; goto L3 if var4
      ...
      20 [-]: LOADK R7 K9  ; var7 = 0.10000000149011612
