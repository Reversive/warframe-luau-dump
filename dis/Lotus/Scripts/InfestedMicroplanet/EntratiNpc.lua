...
; Max Stack Size:  13
       ...
       0 [-]: LOADB R1 0   
       1 [-]: GETIMPORT R4 1 ["gLotusHubNpcEntityType"]
...
L 0:   6 [-]: GETUPVAL R3 0
       ...
       8 [-]: MOVE R3 R0   
       9 [-]: GETIMPORT R4 5 [0x40471ED5]
      10 [-]: GETIMPORT R5 7 [0xEDB2FE65]
      11 [-]: CALL R2 3 0  
      12 [-]: NAMECALL R2 R0 K8 [0xBCC7C28C]
      13 [-]: CALL R2 1 0  
      14 [-]: GETIMPORT R2 10 [0xC163F229]
      15 [-]: GETIMPORT R3 12 [0x81AA1949]
      16 [-]: GETIMPORT R4 14 [0xC8DBDE7B]
      17 [-]: CALL R2 2 1  
...
L 2:  22 [-]: JUMPIF R3 L15
      23 [-]: JUMPIFNOT R1 L13
      24 [-]: GETIMPORT R3 19 ["CurrentConversation"]
      25 [-]: JUMPIFNOT R3 L12
      26 [-]: GETIMPORT R3 21 ["mHubNpc"]
      ...
      33 [-]: GETIMPORT R3 10 [0xC163F229]
      34 [-]: GETIMPORT R4 12 [0x81AA1949]
      35 [-]: GETIMPORT R5 14 [0xC8DBDE7B]
      36 [-]: CALL R3 2 1  
      37 [-]: MOVE R2 R3   
      38 [-]: GETIMPORT R3 25 ["mTransmissionSet"]
      39 [-]: GETIMPORT R5 27 ["curTransmission"]
      40 [-]: FASTCALL1 62 R5 L3
      41 [-]: GETIMPORT R4 16 [0x7B998233]
      42 [-]: CALL R4 1 1  
...
L 4:  48 [-]: JUMPIF R4 L14
      49 [-]: GETIMPORT R5 10 [0xC163F229]
      50 [-]: LOADN R6 0   
      51 [-]: LOADN R7 1   
      52 [-]: CALL R5 2 1  
      53 [-]: GETIMPORT R6 29 [0xEC797C59]
      54 [-]: JUMPIFLT R5 R6 L5
      55 [-]: LOADB R4 0 +1
L 5:  56 [-]: LOADB R4 1   
L 6:  57 [-]: GETIMPORT R5 25 ["mTransmissionSet"]
      58 [-]: JUMPIFNOT R4 L7
      59 [-]: GETUPVAL R7 1
      60 [-]: JUMPIF R7 L8 
...
L 9:  68 [-]: JUMPIF R6 L14
      69 [-]: GETIMPORT R6 19 ["CurrentConversation"]
      70 [-]: MOVE R8 R5   
      71 [-]: LOADNIL R9   
      72 [-]: LOADB R10 0  
      73 [-]: LOADB R11 0  
...
L13:  85 [-]: GETIMPORT R3 19 ["CurrentConversation"]
      86 [-]: JUMPIFNOT R3 L14
      87 [-]: GETIMPORT R3 21 ["mHubNpc"]
      88 [-]: JUMPIFNOTEQ R3 R0 L14
      89 [-]: GETIMPORT R3 10 [0xC163F229]
      90 [-]: GETIMPORT R4 12 [0x81AA1949]
      91 [-]: GETIMPORT R5 14 [0xC8DBDE7B]
      92 [-]: CALL R3 2 1  
      93 [-]: MOVE R2 R3   
      94 [-]: NAMECALL R3 R0 K32 [0x70D8B761]
      95 [-]: CALL R3 1 0  
      96 [-]: LOADB R1 1   
L14:  97 [-]: GETIMPORT R3 34 [0xCBD666E1]
      98 [-]: LOADN R4 0   
      99 [-]: CALL R3 1 0  
     100 [-]: JUMPBACK L1  
L15: 101 [-]: RETURN R0 0  
...
L 0:   6 [-]: GETIMPORT R2 4 [0x89326C93]
       7 [-]: GETIMPORT R4 6 ["gContextActionType"]
       8 [-]: NAMECALL R5 R0 K7 [0xD1586535]
       9 [-]: CALL R5 1 1  
      10 [-]: LOADN R6 10  
      11 [-]: NAMECALL R2 R2 K8 [0x4E5939A5]
      12 [-]: CALL R2 4 1  
      13 [-]: GETIMPORT R3 10 [0xC163F229]
      14 [-]: GETIMPORT R4 12 [0x81AA1949]
      15 [-]: GETIMPORT R5 14 [0xC8DBDE7B]
      16 [-]: CALL R3 2 1  
...
L 2:  21 [-]: JUMPIF R4 L9 
      22 [-]: JUMPIFNOT R1 L7
      23 [-]: GETIMPORT R4 19 ["CurrentConversation"]
      24 [-]: JUMPIFNOT R4 L6
      25 [-]: GETIMPORT R4 21 ["mScriptAction"]
      26 [-]: JUMPIFNOTEQ R4 R2 L6
      27 [-]: GETIMPORT R4 23 [0x67652851]
      28 [-]: CALL R4 0 1  
      29 [-]: SUB R3 R3 R4 
      30 [-]: LOADN R4 0   
      31 [-]: JUMPIFNOTLT R3 R4 L8
      32 [-]: GETIMPORT R4 10 [0xC163F229]
      33 [-]: GETIMPORT R5 12 [0x81AA1949]
      34 [-]: GETIMPORT R6 14 [0xC8DBDE7B]
      35 [-]: CALL R4 2 1  
      36 [-]: MOVE R3 R4   
      37 [-]: GETIMPORT R4 25 ["mTransmissionSet"]
      38 [-]: GETIMPORT R6 27 ["curTransmission"]
      39 [-]: FASTCALL1 62 R6 L3
      40 [-]: GETIMPORT R5 16 [0x7B998233]
      41 [-]: CALL R5 1 1  
L 3:  42 [-]: JUMPIFNOT R5 L8
      ...
      46 [-]: CALL R5 1 1  
L 4:  47 [-]: JUMPIF R5 L8 
      48 [-]: GETIMPORT R5 25 ["mTransmissionSet"]
      49 [-]: GETUPVAL R7 0
      50 [-]: NEWTABLE R8 0 0
      ...
      56 [-]: CALL R6 1 1  
L 5:  57 [-]: JUMPIF R6 L8 
      58 [-]: GETIMPORT R6 19 ["CurrentConversation"]
      59 [-]: MOVE R8 R5   
      60 [-]: LOADNIL R9   
      61 [-]: LOADB R10 0  
      62 [-]: LOADB R11 0  
...
L 7:  68 [-]: GETIMPORT R4 19 ["CurrentConversation"]
      69 [-]: JUMPIFNOT R4 L8
      70 [-]: GETIMPORT R4 21 ["mScriptAction"]
      71 [-]: JUMPIFNOTEQ R4 R2 L8
      72 [-]: GETIMPORT R4 10 [0xC163F229]
      73 [-]: GETIMPORT R5 12 [0x81AA1949]
      74 [-]: GETIMPORT R6 14 [0xC8DBDE7B]
      75 [-]: CALL R4 2 1  
      76 [-]: MOVE R3 R4   
      77 [-]: LOADB R1 1   
L 8:  78 [-]: GETIMPORT R4 31 [0xCBD666E1]
      79 [-]: LOADN R5 0   
      80 [-]: CALL R4 1 0  
      81 [-]: JUMPBACK L1  
L 9:  82 [-]: RETURN R0 0  
...
; Max Stack Size:  18
       ...
       7 [-]: LOADNIL R4   
       8 [-]: LOADB R5 1   
       9 [-]: GETIMPORT R8 5 ["gLotusHubNpcEntityType"]
      10 [-]: NAMECALL R6 R0 K6 [0xF2DEAF69]
      11 [-]: CALL R6 2 1  
      12 [-]: GETUPVAL R8 0
      13 [-]: GETTABLEKS R7 R8 K7 [0x11E86806]
      14 [-]: MOVE R8 R0   
      15 [-]: GETIMPORT R9 9 [0x40471ED5]
      16 [-]: GETIMPORT R10 11 [0xEDB2FE65]
      17 [-]: CALL R7 3 0  
...
L 1:  28 [-]: JUMPIF R7 L16
      29 [-]: GETIMPORT R9 18 ["curTransmission"]
      30 [-]: FASTCALL1 62 R9 L2
      31 [-]: GETIMPORT R8 15 [0x7B998233]
      32 [-]: CALL R8 1 1  
L 2:  33 [-]: NOT R7 R8    
      34 [-]: JUMPIFNOT R7 L3
      35 [-]: GETIMPORT R7 18 ["curTransmission"]
...
L 4:  43 [-]: GETIMPORT R9 22 ["TransmissionSoundInstance"]
      44 [-]: FASTCALL1 62 R9 L5
      45 [-]: GETIMPORT R8 15 [0x7B998233]
      46 [-]: CALL R8 1 1  
L 5:  47 [-]: JUMPIFNOT R8 L8
L 6:  48 [-]: FASTCALL1 62 R4 L7
      49 [-]: MOVE R9 R4   
      50 [-]: GETIMPORT R8 15 [0x7B998233]
      51 [-]: CALL R8 1 1  
L 7:  52 [-]: JUMPIF R8 L13
L 8:  53 [-]: LOADN R8 0   
      54 [-]: FASTCALL1 62 R4 L9
      55 [-]: MOVE R10 R4  
      56 [-]: GETIMPORT R9 15 [0x7B998233]
      57 [-]: CALL R9 1 1  
...
L10:  63 [-]: GETIMPORT R9 22 ["TransmissionSoundInstance"]
      64 [-]: NAMECALL R9 R9 K23 [0xDAE5BCB5]
      65 [-]: CALL R9 1 1  
      66 [-]: MOVE R8 R9   
L11:  67 [-]: MUL R9 R8 R8 
      68 [-]: LOADB R3 1   
      69 [-]: GETIMPORT R10 25 [0x9BAFFFE3]
      70 [-]: LOADK R11 K26 [0.10000000000000001]
      71 [-]: LOADN R12 6  
      72 [-]: MOVE R13 R9  
      73 [-]: CALL R10 3 1 
      74 [-]: MOVE R9 R10  
      75 [-]: GETIMPORT R12 29 ["EMISSIVE_MAP_ATTEN"]
      76 [-]: MOVE R13 R9  
      77 [-]: LOADN R14 0  
      78 [-]: LOADN R15 0  
      79 [-]: LOADN R16 0  
...
L13: 107 [-]: JUMPIFNOT R3 L15
     ...
     109 [-]: JUMPIF R5 L14
     110 [-]: GETIMPORT R10 1 [0x0469F296]
     111 [-]: LOADK R11 K36 ["LoidToOtak"]
     112 [-]: CALL R10 1 -1
     113 [-]: NAMECALL R8 R0 K32 [0xCAB39EF8]
     114 [-]: CALL R8 -1 0 
     115 [-]: GETIMPORT R10 38 [0x41709A03]
     116 [-]: NAMECALL R8 R0 K35 [0x878308DF]
     117 [-]: CALL R8 2 0  
     118 [-]: LOADB R5 1   
L14: 119 [-]: GETIMPORT R10 29 ["EMISSIVE_MAP_ATTEN"]
     120 [-]: LOADN R11 0  
     121 [-]: LOADN R12 0  
     122 [-]: LOADN R13 0  
     123 [-]: LOADN R14 0  
     ...
     126 [-]: CALL R8 7 0  
L15: 127 [-]: GETIMPORT R8 40 [0xCBD666E1]
     128 [-]: LOADN R9 0   
     129 [-]: CALL R8 1 0  
     130 [-]: JUMPBACK L0  
L16: 131 [-]: RETURN R0 0  
...
L 1:  22 [-]: JUMPIF R4 L3 
      ...
      26 [-]: CALL R4 1 1  
L 2:  27 [-]: JUMPIF R4 L3 
      28 [-]: GETIMPORT R4 12 [0xA533083A]
      29 [-]: GETIMPORT R5 12 [0xA533083A]
      30 [-]: MOVE R6 R3   
      31 [-]: CALL R5 1 -1 
      32 [-]: CALL R4 -1 1 
      33 [-]: GETIMPORT R7 5 [0x0469F296]
      34 [-]: LOADK R8 K13 ["GAME_C1_HEAD1"]
      35 [-]: CALL R7 1 1  
      36 [-]: GETIMPORT R8 15 [0x00046924]
      37 [-]: LOADN R10 -20
      38 [-]: MUL R9 R10 R4
      39 [-]: LOADN R11 20 
      40 [-]: MUL R10 R11 R4
      ...
      44 [-]: CALL R5 -1 0 
      45 [-]: GETIMPORT R7 5 [0x0469F296]
      46 [-]: LOADK R8 K17 ["GAME_C1_SPINE3"]
      47 [-]: CALL R7 1 1  
      48 [-]: GETIMPORT R8 15 [0x00046924]
      49 [-]: LOADN R10 -10
      50 [-]: MUL R9 R10 R4
      51 [-]: LOADN R10 0  
      52 [-]: LOADN R12 10 
      ...
      56 [-]: CALL R5 -1 0 
      57 [-]: GETIMPORT R7 5 [0x0469F296]
      58 [-]: LOADK R8 K13 ["GAME_C1_HEAD1"]
      59 [-]: CALL R7 1 1  
      60 [-]: GETIMPORT R8 15 [0x00046924]
      61 [-]: LOADN R10 40 
      62 [-]: MUL R9 R10 R4
      63 [-]: LOADN R11 10 
      64 [-]: MUL R10 R11 R4
      ...
      68 [-]: CALL R5 -1 0 
      69 [-]: GETIMPORT R6 20 [0x67652851]
      70 [-]: CALL R6 0 1  
      71 [-]: MULK R5 R6 K18 [0.29999999999999999]
      72 [-]: ADD R3 R3 R5 
      73 [-]: GETIMPORT R5 1 [0xCBD666E1]
      74 [-]: LOADN R6 0   
      75 [-]: CALL R5 1 0  
      76 [-]: JUMPBACK L0  
L 3:  77 [-]: RETURN R0 0  
...
L 1:   6 [-]: JUMPIF R3 L4 
       ...
       8 [-]: MULK R6 R7 K3 [2]
       9 [-]: GETIMPORT R7 6 [0x107BF6DA]
      10 [-]: MOVE R8 R1   
      11 [-]: CALL R7 1 1  
      12 [-]: MUL R5 R6 R7 
      13 [-]: FASTCALL1 24 R5 L2
      14 [-]: GETIMPORT R4 9 [0x3EDA26FC]
      15 [-]: CALL R4 1 1  
L 2:  16 [-]: FASTCALL1 2 R4 L3
      17 [-]: GETIMPORT R3 11 [0xE4A5B3CA]
      18 [-]: CALL R3 1 1  
L 3:  19 [-]: MOVE R2 R3   
      20 [-]: GETIMPORT R3 13 [0x9BAFFFE3]
      21 [-]: LOADN R4 25  
      22 [-]: LOADN R5 21  
      23 [-]: GETIMPORT R6 15 [0xA533083A]
