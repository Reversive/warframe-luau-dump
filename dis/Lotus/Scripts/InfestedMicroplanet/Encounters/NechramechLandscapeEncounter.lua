...
; Max Stack Size:  44
 ...
 29 [-]: GETTABLE  R6 R6 K12    ; R82 := R6[0x80000000]
 30 [-]: CALL      R6 1 2       ; R6 := R6()
 31 [-]: TEST      R6 0         ; if not R6 then PC := 38
 32 [-]: JMP       38           ; PC := 38
 33 [-]: GETGLOBAL R6 K13       ; R6 := 0x00000000
 34 [-]: TEST      R6 1         ; if R6 then PC := 38
 35 [-]: JMP       38           ; PC := 38
 36 [-]: GETGLOBAL R5 K14       ; R5 := 0x00000000
 37 [-]: LOADBOOL  R2 0 0       ; R2 := false
 38 [-]: SELF      R6 R1 K15    ; R7 := R1; R6 := R1[0x80000000]
 39 [-]: GETGLOBAL R8 K16       ; R8 := 0x00000000
 ...
 47 [-]: GETGLOBAL R7 K0        ; R7 := 0x80000000
 48 [-]: GETGLOBAL R8 K17       ; R8 := 0x00000000
 49 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 50 [-]: TEST      R7 1         ; if R7 then PC := 53
 51 [-]: JMP       53           ; PC := 53
 52 [-]: GETGLOBAL R6 K17       ; R6 := 0x00000000
 53 [-]: LOADBOOL  R7 0 0       ; R7 := false
 54 [-]: GETGLOBAL R8 K4        ; R8 := 0x00000000
 55 [-]: SELF      R8 R8 K18    ; R9 := R8; R8 := R8[0x80000000]
 56 [-]: GETGLOBAL R10 K16      ; R10 := 0x00000000
 57 [-]: LOADK     R11 K19      ; R11 := "LandscapeMechEncounter"
 58 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 59 [-]: SELF      R11 R0 K10   ; R12 := R0; R11 := R0[0x80000000]
 60 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 61 [-]: LOADK     R12 0        ; R12 := 0.000000
 62 [-]: LOADK     R13 100      ; R13 := 100.000000
 63 [-]: CALL      R8 6 2       ; R8 := R8(R9,R10,R11,R12,R13)
 64 [-]: GETGLOBAL R9 K0        ; R9 := 0x80000000
...
149 [-]: SELF      R16 R0 K40   ; R17 := R0; R16 := R0[0x80000000]
150 [-]: LOADK     R18 1        ; R18 := 1.000000
151 [-]: CALL      R16 3 1      ; R16(R17,R18)
152 [-]: JMP       181          ; PC := 181
153 [-]: SELF      R16 R0 K41   ; R17 := R0; R16 := R0[0x00000000]
...
160 [-]: SELF      R22 R21 K31  ; R23 := R21; R22 := R21[0x00000000]
161 [-]: CALL      R22 2 2      ; R22 := R22(R23)
162 [-]: SELF      R23 R22 K32  ; R24 := R22; R23 := R22[0x00000000]
163 [-]: GETGLOBAL R25 K33      ; R25 := 0x00000000
164 [-]: CALL      R23 3 1      ; R23(R24,R25)
165 [-]: GETGLOBAL R23 K42      ; R23 := 0xfffbff00
166 [-]: GETGLOBAL R24 K43      ; R24 := 0x00000000
167 [-]: CALL      R23 2 4      ; R23,R24,R25 := R23(R24)
168 [-]: JMP       175          ; PC := 175
169 [-]: SELF      R28 R22 K44  ; R29 := R22; R28 := R22[0x80000000]
...
194 [-]: JMP       251          ; PC := 251
195 [-]: GETGLOBAL R30 K21      ; R30 := 0xfe53323e
196 [-]: LOADK     R31 1        ; R31 := 1.000000
197 [-]: CALL      R30 2 1      ; R30(R31)
198 [-]: SELF      R30 R0 K47   ; R31 := R0; R30 := R0[0x00000000]
199 [-]: CALL      R30 2 2      ; R30 := R30(R31)
200 [-]: MOVE      R28 R30      ; R28 := R30
201 [-]: GETGLOBAL R30 K48      ; R30 := 0x80000000
202 [-]: TEST      R30 0        ; if not R30 then PC := 232
203 [-]: JMP       232          ; PC := 232
204 [-]: LT        0 K8 R28     ; if 0.000000 >= R28 then PC := 232
205 [-]: JMP       232          ; PC := 232
206 [-]: GETGLOBAL R30 K0       ; R30 := 0x80000000
207 [-]: MOVE      R31 R0       ; R31 := R0
208 [-]: CALL      R30 2 2      ; R30 := R30(R31)
209 [-]: TEST      R30 1        ; if R30 then PC := 232
210 [-]: JMP       232          ; PC := 232
211 [-]: SELF      R30 R0 K41   ; R31 := R0; R30 := R0[0x00000000]
212 [-]: CALL      R30 2 2      ; R30 := R30(R31)
213 [-]: GETTABLE  R30 R30 K49  ; R30 := R30[1.000000]
214 [-]: SELF      R30 R30 K31  ; R31 := R30; R30 := R30[0x00000000]
215 [-]: CALL      R30 2 2      ; R30 := R30(R31)
216 [-]: GETGLOBAL R31 K0       ; R31 := 0x80000000
217 [-]: MOVE      R32 R30      ; R32 := R30
218 [-]: CALL      R31 2 2      ; R31 := R31(R32)
219 [-]: TEST      R31 1        ; if R31 then PC := 231
220 [-]: JMP       231          ; PC := 231
221 [-]: GETGLOBAL R31 K0       ; R31 := 0x80000000
222 [-]: GETGLOBAL R32 K4       ; R32 := 0x00000000
223 [-]: SELF      R32 R32 K50  ; R33 := R32; R32 := R32[0x80000000]
224 [-]: SELF      R34 R30 K10  ; R35 := R30; R34 := R30[0x80000000]
225 [-]: CALL      R34 2 2      ; R34 := R34(R35)
226 [-]: GETGLOBAL R35 K51      ; R35 := 0xffffb19f
...
232 [-]: GETGLOBAL R31 K13      ; R31 := 0x00000000
233 [-]: TEST      R31 1        ; if R31 then PC := 191
234 [-]: JMP       191          ; PC := 191
235 [-]: GETUPVAL  R31 U0       ; R31 := U0
236 [-]: GETTABLE  R31 R31 K12  ; R82 := R31[0x80000000]
...
243 [-]: GETTABLE  R31 R31 K12  ; R82 := R31[0x80000000]
...
250 [-]: JMP       191          ; PC := 191
251 [-]: SELF      R31 R0 K41   ; R32 := R0; R31 := R0[0x00000000]
252 [-]: CALL      R31 2 2      ; R31 := R31(R32)
253 [-]: GETGLOBAL R32 K0       ; R32 := 0x80000000
...
268 [-]: SELF      R36 R36 K31  ; R37 := R36; R36 := R36[0x00000000]
269 [-]: CALL      R36 2 2      ; R36 := R36(R37)
270 [-]: GETGLOBAL R37 K0       ; R37 := 0x80000000
...
276 [-]: JMP       294          ; PC := 294
277 [-]: SELF      R37 R36 K52  ; R38 := R36; R37 := R36[0x80000000]
278 [-]: LOADBOOL  R39 0 0      ; R39 := false
279 [-]: CALL      R37 3 1      ; R37(R38,R39)
280 [-]: SELF      R37 R36 K53  ; R38 := R36; R37 := R36[0x000004e2]
281 [-]: CALL      R37 2 2      ; R37 := R37(R38)
282 [-]: TEST      R37 1        ; if R37 then PC := 288
283 [-]: JMP       288          ; PC := 288
284 [-]: SELF      R37 R36 K54  ; R38 := R36; R37 := R36[0x00000000]
285 [-]: CALL      R37 2 2      ; R37 := R37(R38)
286 [-]: TEST      R37 0        ; if not R37 then PC := 291
287 [-]: JMP       291          ; PC := 291
288 [-]: SELF      R37 R36 K55  ; R38 := R36; R37 := R36[0x80000000]
289 [-]: CALL      R37 2 1      ; R37(R38)
290 [-]: JMP       308          ; PC := 308
291 [-]: SELF      R37 R36 K56  ; R38 := R36; R37 := R36[0x00000000]
292 [-]: CALL      R37 2 1      ; R37(R38)
293 [-]: JMP       308          ; PC := 308
294 [-]: SELF      R37 R36 K57  ; R38 := R36; R37 := R36[0x80000000]
295 [-]: GETGLOBAL R39 K58      ; R39 := 0xfef8bd60
