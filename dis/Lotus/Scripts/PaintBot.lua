...
L 1:  11 [-]: NEWTABLE R2 0 0
      12 [-]: LOADN R5 1   
      13 [-]: GETIMPORT R6 8 ["TINT_NAMES"]
      14 [-]: LENGTH R3 R6 
      15 [-]: LOADN R4 1   
      16 [-]: FORNPREP R3 L4
L 2:  17 [-]: GETIMPORT R8 11 ["CustomizationColorPalette_sDefaultColor"]
      18 [-]: FASTCALL2 52 R2 R8 L3
      19 [-]: MOVE R7 R2   
      20 [-]: GETIMPORT R6 14 [0x23D5322F]
      21 [-]: CALL R6 2 0  
L 3:  22 [-]: FORNLOOP R3 L2
L 4:  23 [-]: GETIMPORT R3 5 ["DojoMgr"]
      24 [-]: MOVE R5 R0   
      25 [-]: MOVE R6 R2   
...
L 0:   4 [-]: JUMPIF R2 L1 
      ...
      10 [-]: RETURN R0 0  
L 1:  11 [-]: NEWTABLE R2 0 0
      12 [-]: GETIMPORT R5 9 ["CustomizationColorPalette_sDefaultColor"]
      13 [-]: FASTCALL2 52 R2 R5 L2
      14 [-]: MOVE R4 R2   
      15 [-]: GETIMPORT R3 12 [0x23D5322F]
      16 [-]: CALL R3 2 0  
L 2:  17 [-]: GETIMPORT R5 9 ["CustomizationColorPalette_sDefaultColor"]
      18 [-]: FASTCALL2 52 R2 R5 L3
      19 [-]: MOVE R4 R2   
      20 [-]: GETIMPORT R3 12 [0x23D5322F]
      21 [-]: CALL R3 2 0  
L 3:  22 [-]: GETIMPORT R5 9 ["CustomizationColorPalette_sDefaultColor"]
      23 [-]: FASTCALL2 52 R2 R5 L4
      24 [-]: MOVE R4 R2   
      25 [-]: GETIMPORT R3 12 [0x23D5322F]
      26 [-]: CALL R3 2 0  
L 4:  27 [-]: GETIMPORT R3 5 ["DojoMgr"]
      28 [-]: MOVE R5 R0   
      29 [-]: MOVE R6 R2   
...
L 3:  17 [-]: MOVE R7 R2   
      ...
      20 [-]: GETIMPORT R9 10 ["CustomizationColorPalette_sDefaultColor"]
      21 [-]: JUMPIFEQ R8 R9 L4
      22 [-]: LOADB R7 0 +1
L 4:  23 [-]: LOADB R7 1   
L 5:  24 [-]: LOADNIL R8   
      25 [-]: JUMPIFNOT R7 L6
      26 [-]: GETIMPORT R9 12 [0x60130201]
      27 [-]: GETIMPORT R10 10 ["CustomizationColorPalette_sDefaultColor"]
      28 [-]: CALL R9 1 1  
      29 [-]: MOVE R8 R9   
      30 [-]: JUMP L7
     
L 6:  31 [-]: GETIMPORT R9 12 [0x60130201]
...
L 3:  16 [-]: MOVE R7 R2   
      ...
      19 [-]: GETIMPORT R9 6 ["CustomizationColorPalette_sDefaultColor"]
      20 [-]: JUMPIFEQ R8 R9 L4
      21 [-]: LOADB R7 0 +1
L 4:  22 [-]: LOADB R7 1   
L 5:  23 [-]: LOADNIL R8   
      24 [-]: JUMPIFNOT R7 L6
      25 [-]: GETIMPORT R9 8 [0x60130201]
      26 [-]: GETIMPORT R10 6 ["CustomizationColorPalette_sDefaultColor"]
      27 [-]: CALL R9 1 1  
      28 [-]: MOVE R8 R9   
      29 [-]: JUMP L7
     
L 6:  30 [-]: GETIMPORT R9 8 [0x60130201]
...
L 4:  30 [-]: NAMECALL R4 R2 K16 [0xE79E7EF4]
      ...
      60 [-]: MOVE R10 R6  
      61 [-]: CALL R8 2 0  
      62 [-]: GETIMPORT R8 29 ["_T"]
      63 [-]: LOADB R9 0   
      64 [-]: SETTABLEKS R9 R8 K24 ["PaintBotColorsActive"]
      65 [-]: GETIMPORT R8 29 ["_T"]
      66 [-]: LOADB R9 0   
      67 [-]: SETTABLEKS R9 R8 K30 ["GenericMessageNoAnimateTyping"]
L 5:  68 [-]: GETIMPORT R8 32 [0x9BA7909F]
      69 [-]: GETIMPORT R10 34 [0x08A5AFB4]
...
L 6:  99 [-]: JUMPXEQKNIL R8 L7 NOT
     100 [-]: GETIMPORT R9 44 [0xCBD666E1]
     101 [-]: LOADN R10 0  
     102 [-]: CALL R9 1 0  
     103 [-]: JUMPBACK L6  
L 7: 104 [-]: LOADNIL R9   
...
L10: 122 [-]: JUMPIFNOT R10 L11
     ...
     127 [-]: CLOSEUPVALS R8
     128 [-]: RETURN R0 0  
L11: 129 [-]: GETIMPORT R10 52 [0xB009BBC6]
     130 [-]: GETIMPORT R11 54 [0x5E9A35DB]
     131 [-]: CALL R10 1 1 
     132 [-]: MOVE R9 R10  
     133 [-]: JUMP L13
...
L12: 134 [-]: GETUPVAL R11 3
     ...
     137 [-]: GETIMPORT R10 52 [0xB009BBC6]
     138 [-]: GETIMPORT R11 57 [0x225828FD]
     139 [-]: CALL R10 1 1 
     140 [-]: MOVE R9 R10  
L13: 141 [-]: FASTCALL1 62 R9 L14
     142 [-]: MOVE R11 R9  
     143 [-]: GETIMPORT R10 8 [0x7B998233]
     144 [-]: CALL R10 1 1 
L14: 145 [-]: JUMPIF R10 L17
     146 [-]: GETIMPORT R10 32 [0x9BA7909F]
     147 [-]: MOVE R12 R9  
...
L18: 182 [-]: JUMPIFNOT R11 L20
     ...
     185 [-]: GETIMPORT R11 8 [0x7B998233]
     186 [-]: CALL R11 1 1 
...
L20: 194 [-]: GETTABLEKS R12 R6 K47 ["pendingColors"]
     ...
     196 [-]: GETIMPORT R11 8 [0x7B998233]
     197 [-]: CALL R11 1 1 
L21: 198 [-]: JUMPIF R11 L22
     199 [-]: GETIMPORT R11 18 ["DojoMgr"]
     200 [-]: MOVE R13 R7  
...
L29: 263 [-]: GETTABLEKS R13 R6 K48 ["pendingLights"]
     ...
     265 [-]: GETIMPORT R12 8 [0x7B998233]
     266 [-]: CALL R12 1 1 
...
L34: 292 [-]: GETUPVAL R12 3
     ...
     295 [-]: GETIMPORT R11 29 ["_T"]
     296 [-]: LOADB R12 1  
     297 [-]: SETTABLEKS R12 R11 K81 ["changingDojoLights"]
     298 [-]: JUMP L37
    
L35: 299 [-]: GETIMPORT R11 29 ["_T"]
     300 [-]: LOADNIL R12  
...
L40: 318 [-]: GETUPVAL R11 6
     ...
     321 [-]: GETIMPORT R10 32 [0x9BA7909F]
     322 [-]: GETIMPORT R12 88 [0x9E024073]
     323 [-]: NAMECALL R10 R10 K89 [0x6DD7AA66]
     324 [-]: CALL R10 2 1 
     325 [-]: FASTCALL1 62 R10 L41
     326 [-]: MOVE R12 R10 
     327 [-]: GETIMPORT R11 8 [0x7B998233]
     328 [-]: CALL R11 1 1 
L41: 329 [-]: JUMPIF R11 L57
     330 [-]: LOADB R11 1  
     331 [-]: SETUPVAL R11 7
     332 [-]: NEWTABLE R11 0 0
     333 [-]: GETIMPORT R12 29 ["_T"]
...
L42: 370 [-]: GETUPVAL R12 7
     ...
     372 [-]: GETIMPORT R12 44 [0xCBD666E1]
     373 [-]: LOADN R13 0  
     374 [-]: CALL R12 1 0 
     375 [-]: JUMPBACK L42 
L43: 376 [-]: GETUPVAL R12 0
     ...
     389 [-]: GETIMPORT R14 99 ["changingDojoLights"]
...
L44: 393 [-]: LOADB R14 0  
     ...
     395 [-]: MOVE R16 R13 
     396 [-]: GETIMPORT R15 8 [0x7B998233]
     397 [-]: CALL R15 1 1 
...
L46: 403 [-]: GETTABLE R18 R11 R17
     ...
     405 [-]: CALL R18 1 1 
     406 [-]: GETIMPORT R19 104 ["CustomizationColorPalette_sDefaultColor"]
...
L52: 436 [-]: JUMPIFNOT R14 L56
     437 [-]: LOADB R15 1  
     438 [-]: SETUPVAL R15 10
     439 [-]: GETIMPORT R15 99 ["changingDojoLights"]
     440 [-]: JUMPIFNOT R15 L53
     441 [-]: GETIMPORT R15 18 ["DojoMgr"]
...
L53: 450 [-]: GETIMPORT R15 18 ["DojoMgr"]
...
L55: 459 [-]: GETUPVAL R16 10
     ...
     461 [-]: GETIMPORT R16 44 [0xCBD666E1]
     462 [-]: LOADN R17 0  
     463 [-]: CALL R16 1 0 
     464 [-]: GETIMPORT R16 108 [0xB693B6C1]
     465 [-]: CALL R16 0 1 
     466 [-]: ADD R15 R15 R16
     467 [-]: LOADN R16 10 
