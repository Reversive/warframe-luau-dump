...
; Max Stack Size:  12
       ...
       6 [-]: CALL R1 1 0  
       7 [-]: GETIMPORT R3 4 [0xB56FDA48]
       8 [-]: GETIMPORT R4 6 [0x9AEB4406]
       9 [-]: NAMECALL R1 R0 K7 [0xCE01CCC2]
      10 [-]: CALL R1 3 0  
      11 [-]: LOADB R3 0   
      12 [-]: NAMECALL R1 R0 K8 [0x2FAEAD12]
      13 [-]: CALL R1 2 0  
      14 [-]: GETIMPORT R3 10 [0x10752C3A]
      15 [-]: NAMECALL R1 R0 K11 [0xE603BAB2]
      16 [-]: CALL R1 2 0  
      17 [-]: GETIMPORT R2 13 [0x9C2A3D55]
      18 [-]: FASTCALL1 62 R2 L0
      19 [-]: GETIMPORT R1 15 [0x7B998233]
      20 [-]: CALL R1 1 1  
L 0:  21 [-]: JUMPIF R1 L6 
      22 [-]: GETIMPORT R2 13 [0x9C2A3D55]
      23 [-]: LENGTH R1 R2 
      24 [-]: LOADN R2 0   
      25 [-]: JUMPIFNOTLT R2 R1 L6
      26 [-]: LOADN R3 1   
      27 [-]: GETIMPORT R4 13 [0x9C2A3D55]
      28 [-]: LENGTH R1 R4 
      29 [-]: LOADN R2 1   
      30 [-]: FORNPREP R1 L5
L 1:  31 [-]: GETIMPORT R5 17 [0xAB8308C3]
      32 [-]: GETTABLE R4 R5 R3
      33 [-]: GETIMPORT R6 13 [0x9C2A3D55]
      34 [-]: GETTABLE R5 R6 R3
      35 [-]: FASTCALL1 62 R5 L2
      36 [-]: MOVE R7 R5   
      37 [-]: GETIMPORT R6 15 [0x7B998233]
      38 [-]: CALL R6 1 1  
L 2:  39 [-]: JUMPIF R6 L3 
      40 [-]: MOVE R8 R5   
      41 [-]: MOVE R9 R4   
...
L 3:  47 [-]: GETIMPORT R6 20 [0x3D106989]
      48 [-]: LOADK R7 K21 ["NULL agent type!"]
      49 [-]: CALL R6 1 0  
L 4:  50 [-]: FORNLOOP R1 L1
L 5:  51 [-]: GETIMPORT R3 4 [0xB56FDA48]
      52 [-]: GETIMPORT R4 6 [0x9AEB4406]
...
L 2:  39 [-]: GETIMPORT R3 2 [0x89326C93]
      ...
      45 [-]: CALL R4 1 1  
      46 [-]: GETIMPORT R5 22 [0xBE190284]
      47 [-]: MOVE R7 R4   
      48 [-]: NAMECALL R5 R5 K23 [0xAEE0D08D]
      49 [-]: CALL R5 2 1  
      50 [-]: MOVE R2 R5   
      51 [-]: GETIMPORT R3 25 ["killCounter"]
      52 [-]: JUMPXEQKNIL R3 L6 NOT
      53 [-]: GETIMPORT R5 26 ["MaxEnemyCount"]
...
L 6: 174 [-]: GETIMPORT R3 9 ["_T"]
     ...
     197 [-]: LOADN R10 1  
     198 [-]: CALL R8 2 0  
     199 [-]: GETIMPORT R9 26 ["MaxEnemyCount"]
     200 [-]: FASTCALL1 12 R9 L7
     201 [-]: GETIMPORT R8 67 [0x55F27C30]
     202 [-]: CALL R8 1 1  
L 7: 203 [-]: GETIMPORT R9 9 ["_T"]
     204 [-]: SETTABLEKS R8 R9 K68 ["IniEnemyCount"]
L 8: 205 [-]: GETIMPORT R9 9 ["_T"]
     ...
     210 [-]: CALL R9 1 1  
     211 [-]: MOVE R8 R9   
     212 [-]: GETIMPORT R9 26 ["MaxEnemyCount"]
     ...
     218 [-]: CALL R9 2 0  
     219 [-]: LOADN R4 3   
L 9: 220 [-]: GETIMPORT R11 26 ["MaxEnemyCount"]
     221 [-]: SUB R10 R8 R11
     222 [-]: FASTCALL1 12 R10 L10
     223 [-]: GETIMPORT R9 67 [0x55F27C30]
     224 [-]: CALL R9 1 1  
L10: 225 [-]: GETTABLEKS R10 R7 K72 ["SetGoalLabel"]
     ...
     235 [-]: CALL R10 1 0 
     236 [-]: JUMPIF R6 L11
     237 [-]: GETIMPORT R10 26 ["MaxEnemyCount"]
     ...
     242 [-]: CALL R10 2 0 
     243 [-]: LOADB R6 1   
L11: 244 [-]: GETIMPORT R10 26 ["MaxEnemyCount"]
     245 [-]: LOADN R11 0  
     246 [-]: JUMPIFLE R10 R11 L12
     247 [-]: GETIMPORT R10 81 [0xCBD666E1]
