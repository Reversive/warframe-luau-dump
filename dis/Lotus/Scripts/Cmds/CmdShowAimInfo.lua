...
L 4:  48 [-]: JUMPIF R8 L5 ; goto L5 if var8
      ...
      56 [-]: GETIMPORT R15 19; var15 = 0x64FB1586
      57 [-]: MOVE R16 R6  ; var16 = var6
      58 [-]: CALL R15 2 2 ; var15 = var15(var16)
      59 [-]: MOVE R10 R15 ; var10 = var15
      60 [-]: LOADK R11 K20; var11 = ", "
      61 [-]: GETIMPORT R15 19; var15 = 0x64FB1586
      ...
      65 [-]: MOVE R12 R15 ; var12 = var15
      66 [-]: LOADK R13 K17; var13 = "\n"
      67 [-]: NAMECALL R14 R5 K22; var15 = var5; var14 = var5[0x22DA1852]
      68 [-]: CALL R14 2 2 ; var14 = var14(var15)
      69 [-]: NAMECALL R14 R14 K23; var15 = var14; var14 = var14[0x6D604BA7]
      70 [-]: CALL R14 2 2 ; var14 = var14(var15)
      71 [-]: CONCAT R7 R8 R14; var7 = var8 .. var14
L 5:  72 [-]: GETIMPORT R8 7; var8 = 0x89326C93
      73 [-]: MOVE R10 R4  ; var10 = var4
      74 [-]: LOADK R11 K24; var11 = 0.025000000000000001
      75 [-]: MOVE R12 R1  ; var12 = var1
      76 [-]: LOADN R13 0  ; var13 = 0
      77 [-]: NAMECALL R8 R8 K25; var9 = var8; var8 = var8[0x9ED3B54E]
      78 [-]: CALL R8 6 1  ; var8(var9, var10, var11, var12, var13)
      79 [-]: GETIMPORT R8 7; var8 = 0x89326C93
      80 [-]: MOVE R10 R6  ; var10 = var6
      81 [-]: LOADK R11 K24; var11 = 0.025000000000000001
      82 [-]: MOVE R12 R0  ; var12 = var0
      83 [-]: LOADN R13 0  ; var13 = 0
      84 [-]: NAMECALL R8 R8 K25; var9 = var8; var8 = var8[0x9ED3B54E]
      85 [-]: CALL R8 6 1  ; var8(var9, var10, var11, var12, var13)
      86 [-]: GETIMPORT R8 7; var8 = 0x89326C93
      87 [-]: MOVE R10 R4  ; var10 = var4
      88 [-]: MOVE R11 R6  ; var11 = var6
      89 [-]: MOVE R12 R1  ; var12 = var1
      90 [-]: LOADN R13 0  ; var13 = 0
      91 [-]: NAMECALL R8 R8 K26; var9 = var8; var8 = var8[0x1CECD8F9]
      ...
      99 [-]: NAMECALL R8 R8 K27; var9 = var8; var8 = var8[0x045C1874]
     100 [-]: CALL R8 7 1  ; var8(var9, var10, var11, var12, var13, var14)
L 6: 101 [-]: GETIMPORT R3 29; var3 = 0xCBD666E1
     102 [-]: LOADN R4 0   ; var4 = 0
     103 [-]: CALL R3 2 1  ; var3(var4)
     104 [-]: JUMPBACK L1  ; goto L1
L 7: 105 [-]: RETURN R0 0  ; 
