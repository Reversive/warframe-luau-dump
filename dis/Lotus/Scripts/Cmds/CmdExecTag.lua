...
L 0:   4 [-]: JUMPXEQKS R1 K2 L1 ["string"]
       5 [-]: RETURN R0 0  
L 1:   6 [-]: GETIMPORT R1 4 [0x0469F296]
       7 [-]: MOVE R2 R0   
       8 [-]: CALL R1 1 1  
       9 [-]: MOVE R0 R1   
      ...
      11 [-]: CALL R1 1 1  
      12 [-]: JUMPIFNOT R1 L2
      13 [-]: GETIMPORT R1 7 ["EMPTY_SYMBOL"]
      14 [-]: JUMPIFNOTEQ R0 R1 L3
L 2:  15 [-]: RETURN R0 0  
L 3:  16 [-]: GETIMPORT R1 9 [0x89326C93]
      17 [-]: MOVE R3 R0   
...
L 4:  24 [-]: GETTABLE R5 R1 R4
      ...
      28 [-]: CALL R6 1 1  
L 5:  29 [-]: JUMPIF R6 L8 
      30 [-]: GETIMPORT R8 14 ["gScriptTriggerType"]
...
L 7:  46 [-]: GETIMPORT R8 20 ["gCinematicType"]
