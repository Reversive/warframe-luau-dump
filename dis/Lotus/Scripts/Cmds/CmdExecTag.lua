...
L 1:   6 [-]: GETIMPORT R1 4; var1 = 0x0469F296
      ...
      14 [-]: JUMPIFNOTEQ R0 R1 L3; goto L3 if var0 ~= var65571
L 2:  15 [-]: RETURN R0 0  ; 
L 3:  16 [-]: GETIMPORT R1 9; var1 = 0x89326C93
      ...
      23 [-]: FORNPREP R2 L10; nforprep start - [escape at L10] -- var2 = iterator
...
L 7:  46 [-]: GETIMPORT R8 20; var8 = gCinematicType
      ...
      53 [-]: JUMP L9      ; goto L9
L 8:  54 [-]: GETIMPORT R8 23; var8 = gCameraSpotBaseType
      55 [-]: NAMECALL R6 R5 K15; var7 = var5; var6 = var5[0xF2DEAF69]
      56 [-]: CALL R6 3 2  ; var6 = var6(var7, var8)
      57 [-]: JUMPIFNOT R6 L9; goto L9 if not var6
      58 [-]: LOADK R8 K24 ; var8 = "Activate"
      59 [-]: NAMECALL R6 R5 K17; var7 = var5; var6 = var5[0x8EB2112D]
      60 [-]: CALL R6 3 1  ; var6(var7, var8)
L 9:  61 [-]: FORNLOOP R2 L4; nforloop end - iterate + goto L4
L10:  62 [-]: RETURN R0 0  ; 
