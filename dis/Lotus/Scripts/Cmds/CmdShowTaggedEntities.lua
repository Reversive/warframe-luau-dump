...
L 1:   7 [-]: GETIMPORT R3 6 [0x64FB1586]
       8 [-]: MOVE R4 R0   
       9 [-]: CALL R3 1 1  
      10 [-]: JUMPXEQKS R3 K7 L3 NOT [""]
L 2:  11 [-]: GETIMPORT R2 9 [0x0469F296]
      12 [-]: CALL R2 0 1  
      13 [-]: JUMPIF R2 L4 
L 3:  14 [-]: GETIMPORT R2 9 [0x0469F296]
      15 [-]: GETIMPORT R3 6 [0x64FB1586]
      16 [-]: MOVE R4 R0   
      17 [-]: CALL R3 1 -1 
      18 [-]: CALL R2 -1 1 
L 4:  19 [-]: MOVE R0 R2   
      20 [-]: GETIMPORT R2 12 ["CmdShowTaggedEntities"]
      21 [-]: JUMPIFNOTEQ R0 R2 L5
      22 [-]: GETIMPORT R2 13 ["_T"]
      23 [-]: LOADNIL R3   
      24 [-]: SETTABLEKS R3 R2 K11 ["CmdShowTaggedEntities"]
      25 [-]: JUMP L7
     
L 5:  26 [-]: GETIMPORT R2 13 ["_T"]
      27 [-]: LOADNIL R3   
      28 [-]: SETTABLEKS R3 R2 K11 ["CmdShowTaggedEntities"]
      29 [-]: GETIMPORT R2 15 [0xCBD666E1]
      30 [-]: LOADN R3 0   
      31 [-]: CALL R2 1 0  
      32 [-]: GETIMPORT R2 13 ["_T"]
      33 [-]: SETTABLEKS R0 R2 K11 ["CmdShowTaggedEntities"]
      34 [-]: GETIMPORT R2 17 ["EMPTY_SYMBOL"]
      35 [-]: JUMPIFNOTEQ R0 R2 L6
      36 [-]: GETIMPORT R2 19 [0xD644C2F1]
      37 [-]: LOADK R3 K20 ["Showing all entities with tags, FYI this kills performance"]
      38 [-]: CALL R2 1 0  
      39 [-]: JUMP L7
     
L 6:  40 [-]: GETIMPORT R2 19 [0xD644C2F1]
      41 [-]: LOADK R4 K21 ["Showing entities with tag \""]
      42 [-]: GETIMPORT R7 6 [0x64FB1586]
      43 [-]: MOVE R8 R0   
      44 [-]: CALL R7 1 1  
      45 [-]: MOVE R5 R7   
      46 [-]: LOADK R6 K22 ["\""]
      ...
      48 [-]: CALL R2 1 0  
L 7:  49 [-]: LOADNIL R2   
L 8:  50 [-]: GETIMPORT R3 12 ["CmdShowTaggedEntities"]
      51 [-]: JUMPXEQKNIL R3 L15
      52 [-]: GETIMPORT R3 12 ["CmdShowTaggedEntities"]
      53 [-]: GETIMPORT R4 17 ["EMPTY_SYMBOL"]
      54 [-]: JUMPIFNOTEQ R3 R4 L9
      55 [-]: GETIMPORT R3 24 [0x89326C93]
      56 [-]: GETIMPORT R5 26 ["gEntityType"]
      57 [-]: NAMECALL R3 R3 K27 [0xFB669000]
      58 [-]: CALL R3 2 1  
      59 [-]: MOVE R2 R3   
      60 [-]: JUMP L10
    
L 9:  61 [-]: GETIMPORT R3 24 [0x89326C93]
      62 [-]: GETIMPORT R5 12 ["CmdShowTaggedEntities"]
...
L11:  70 [-]: GETTABLE R6 R2 R5
      ...
      72 [-]: MOVE R8 R6   
      73 [-]: GETIMPORT R7 30 [0x7B998233]
      74 [-]: CALL R7 1 1  
L12:  75 [-]: JUMPIF R7 L13
      76 [-]: GETIMPORT R9 32 ["gLevelInfoType"]
      ...
      87 [-]: CALL R7 1 1  
      88 [-]: GETIMPORT R8 24 [0x89326C93]
      89 [-]: MOVE R10 R7  
      90 [-]: GETIMPORT R11 38 [0x60130201]
      91 [-]: LOADN R12 255
      92 [-]: LOADN R13 255
      93 [-]: LOADN R14 255
      94 [-]: LOADN R15 255
     ...
     103 [-]: CALL R8 6 0  
     104 [-]: GETIMPORT R8 24 [0x89326C93]
     105 [-]: MOVE R10 R7  
     106 [-]: LOADK R11 K42 [0.012500000000000001]
     107 [-]: GETIMPORT R12 38 [0x60130201]
     108 [-]: LOADN R13 255
     109 [-]: LOADN R14 255
     110 [-]: LOADN R15 255
     111 [-]: LOADN R16 255
...
L14: 117 [-]: GETIMPORT R3 15 [0xCBD666E1]
