...
; Max Stack Size:  11
       ...
       1 [-]: CALL R1 1 1  
       2 [-]: GETIMPORT R3 2 [0xE91DA983]
       3 [-]: NAMECALL R4 R0 K3 [0xF6EBD926]
       4 [-]: CALL R4 1 1  
       5 [-]: GETIMPORT R5 5 ["ZERO_ROTATION"]
       6 [-]: NAMECALL R1 R1 K6 [0x05909209]
       7 [-]: CALL R1 4 0  
       8 [-]: GETIMPORT R1 8 [0x78CA68A2]
       9 [-]: LOADN R2 0   
...
L 1:  18 [-]: JUMPIF R4 L6 
      ...
      20 [-]: CALL R5 1 1  
      21 [-]: GETIMPORT R6 14 [0xE1EB1F56]
      22 [-]: DIV R4 R5 R6 
      23 [-]: GETIMPORT R5 16 [0x42DCC9F5]
      24 [-]: LOADN R6 0   
      25 [-]: LOADN R7 1   
      26 [-]: LOADN R9 1   
      27 [-]: SUB R8 R9 R4 
...
L 3:  53 [-]: GETIMPORT R6 19 [0x67652851]
      54 [-]: CALL R6 0 1  
      55 [-]: SUB R2 R2 R6 
L 4:  56 [-]: LOADK R6 K26 [0.98999999999999999]
      ...
      59 [-]: CALL R6 1 1  
      60 [-]: GETIMPORT R8 29 [0x75A16776]
      61 [-]: NAMECALL R9 R0 K3 [0xF6EBD926]
      62 [-]: CALL R9 1 1  
      63 [-]: GETIMPORT R10 5 ["ZERO_ROTATION"]
      64 [-]: NAMECALL R6 R6 K6 [0x05909209]
      65 [-]: CALL R6 4 0  
      66 [-]: RETURN R0 0  
L 5:  67 [-]: GETIMPORT R6 31 [0xCBD666E1]
      68 [-]: LOADN R7 0   
      69 [-]: CALL R6 1 0  
      70 [-]: JUMPBACK L0  
L 6:  71 [-]: RETURN R0 0  
