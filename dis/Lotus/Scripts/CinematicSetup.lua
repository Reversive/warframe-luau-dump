...
L 3:  54 [-]: GETIMPORT R3 21 [nil]
      55 [-]: MOVE R4 R2   
      56 [-]: DUPCLOSURE R5 K22 []
      57 [-]: CALL R3 2 0  
      58 [-]: LOADN R3 0   
      59 [-]: GETIMPORT R4 24 [nil]
      60 [-]: MOVE R5 R0   
      61 [-]: CALL R4 1 3  
...
L15: 112 [-]: JUMPIF R5 L17
     ...
     117 [-]: MOVE R9 R7   
     118 [-]: GETIMPORT R8 15 [nil]
     119 [-]: CALL R8 1 1  
L16: 120 [-]: NOT R6 R8    
     121 [-]: JUMPIFNOTEQ R7 R4 L18
L17: 122 [-]: GETIMPORT R7 30 [nil]
     123 [-]: LOADN R8 0   
     124 [-]: CALL R7 1 0  
     125 [-]: JUMPBACK L12 
L18: 126 [-]: GETIMPORT R7 24 [nil]
     127 [-]: MOVE R8 R2   
     128 [-]: CALL R7 1 3  
     129 [-]: FORGPREP_INEXT R7 L21
L19: 130 [-]: FASTCALL1 62 R11 L20
     131 [-]: MOVE R13 R11 
     132 [-]: GETIMPORT R12 15 [nil]
     133 [-]: CALL R12 1 1 
...
L 1:  46 [-]: GETIMPORT R4 14 [nil]
      47 [-]: LOADN R5 1   
      48 [-]: GETIMPORT R7 22 [nil]
      49 [-]: LENGTH R6 R7 
      50 [-]: CALL R4 2 1  
      51 [-]: MOVE R3 R4   
      52 [-]: GETIMPORT R4 22 [nil]
      53 [-]: GETTABLE R2 R4 R3
      54 [-]: JUMP L7
     
L 2:  55 [-]: GETIMPORT R3 11 [nil]
      56 [-]: MOVE R4 R1   
...
L 6: 107 [-]: GETIMPORT R3 11 [nil]
     108 [-]: MOVE R4 R1   
     109 [-]: LOADK R5 K32 ["OrokinTower"]
     110 [-]: CALL R3 2 1  
     111 [-]: JUMPXEQKNIL R3 L7
     112 [-]: GETIMPORT R3 14 [nil]
     113 [-]: LOADN R4 1   
     114 [-]: GETIMPORT R6 34 [nil]
     115 [-]: LENGTH R5 R6 
     116 [-]: CALL R3 2 1  
     117 [-]: GETIMPORT R4 34 [nil]
...
L11: 139 [-]: JUMPIF R5 L12
     ...
     148 [-]: ADD R4 R4 R5 
     149 [-]: JUMPBACK L10 
L12: 150 [-]: GETIMPORT R5 47 [nil]
     151 [-]: MOVE R6 R2   
     152 [-]: CALL R5 1 1  
     153 [-]: LOADN R6 1   
     154 [-]: JUMPIFNOTLT R4 R6 L13
     155 [-]: GETIMPORT R6 43 [nil]
     156 [-]: LOADN R8 1   
     157 [-]: SUB R7 R8 R4 
     158 [-]: CALL R6 1 0  
L13: 159 [-]: FASTCALL1 62 R0 L14
     160 [-]: MOVE R7 R0   
     161 [-]: GETIMPORT R6 36 [nil]
     162 [-]: CALL R6 1 1  
L14: 163 [-]: JUMPIF R6 L16
     164 [-]: FASTCALL1 62 R5 L15
     165 [-]: MOVE R7 R5   
     166 [-]: GETIMPORT R6 36 [nil]
     167 [-]: CALL R6 1 1  
