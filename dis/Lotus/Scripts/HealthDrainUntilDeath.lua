...
; Max Stack Size:  8
       ...
       3 [-]: GETIMPORT R3 4 [0x9D87BB3D]
       4 [-]: CALL R2 1 0  
       5 [-]: GETIMPORT R4 7 [0x133FDC3B]
       6 [-]: DIVK R3 R4 K5 [100]
       7 [-]: MUL R2 R1 R3 
...
L 1:  12 [-]: JUMPIF R3 L3 
      ...
      18 [-]: CALL R3 1 1  
      19 [-]: GETIMPORT R4 11 [0xA6348422]
      20 [-]: JUMPIFNOT R4 L2
      21 [-]: SUB R6 R3 R2 
      22 [-]: NAMECALL R4 R0 K12 [0x014DB014]
      23 [-]: CALL R4 2 0  
L 2:  24 [-]: GETIMPORT R4 2 [0xCBD666E1]
      25 [-]: GETIMPORT R5 14 [0x3C786BB5]
      26 [-]: CALL R4 1 0  
      27 [-]: JUMPBACK L0  
L 3:  28 [-]: GETIMPORT R5 16 ["gDynamicCoverType"]
      ...
      34 [-]: CALL R3 2 0  
L 4:  35 [-]: GETIMPORT R3 2 [0xCBD666E1]
      36 [-]: LOADN R5 0   
      37 [-]: GETIMPORT R7 22 [0xD27A04F1]
      38 [-]: SUBK R6 R7 K20 [0.5]
      39 [-]: FASTCALL2 18 R5 R6 L5
      40 [-]: GETIMPORT R4 25 [0xB62ECFE0]
      41 [-]: CALL R4 2 -1 
L 5:  42 [-]: CALL R3 -1 0 
      43 [-]: LOADN R3 0   
L 6:  44 [-]: FASTCALL1 62 R0 L7
      45 [-]: MOVE R5 R0   
      46 [-]: GETIMPORT R4 9 [0x7B998233]
      47 [-]: CALL R4 1 1  
L 7:  48 [-]: JUMPIF R4 L8 
      49 [-]: LOADN R4 1   
      ...
      53 [-]: CALL R4 2 0  
      54 [-]: GETIMPORT R4 2 [0xCBD666E1]
      55 [-]: LOADN R5 0   
      56 [-]: CALL R4 1 0  
      57 [-]: GETIMPORT R5 28 [0x67652851]
      58 [-]: CALL R5 0 1  
...
; Max Stack Size:  6
       ...
       0 [-]: GETIMPORT R3 1 [0x925ABAF6]
       1 [-]: NAMECALL R1 R0 K2 [0xC9F6A7D7]
       2 [-]: CALL R1 2 1  
       3 [-]: GETIMPORT R2 4 [0x77F4180E]
       4 [-]: JUMPIFNOT R2 L1
...
L 0:   9 [-]: JUMPIFNOT R2 L3
      10 [-]: GETIMPORT R4 1 [0x925ABAF6]
      11 [-]: GETIMPORT R5 8 ["EMPTY_SYMBOL"]
