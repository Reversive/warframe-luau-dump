...
L 0:   5 [-]: JUMPIF R2 L1 
       ...
       8 [-]: CALL R2 1 1  
       9 [-]: MOVE R1 R2   
L 1:  10 [-]: GETIMPORT R2 4 [0x89326C93]
...
L 5:  41 [-]: JUMPIF R5 L6 
      ...
      43 [-]: CALL R5 1 1  
      44 [-]: MOVE R3 R5   
L 6:  45 [-]: GETIMPORT R5 14 [0xC163F229]
      46 [-]: GETIMPORT R6 16 [0x01F6CC64]
      47 [-]: GETIMPORT R7 18 [0x100A6A26]
      48 [-]: CALL R5 2 1  
      49 [-]: MUL R4 R3 R5 
...
L 7:  64 [-]: JUMPIFNOT R7 L8
      65 [-]: MOVE R6 R2   
L 8:  66 [-]: GETIMPORT R7 23 [0x20B7F774]
      67 [-]: MOVE R8 R5   
...
L12: 115 [-]: JUMPIF R10 L13
     116 [-]: GETUPVAL R11 0
     117 [-]: GETIMPORT R13 30 [0x45B54F71]
     118 [-]: MOVE R14 R5  
     119 [-]: MOVE R15 R7  
     120 [-]: GETIMPORT R16 33 [0x0469F296]
     121 [-]: CALL R16 0 1 
     122 [-]: MOVE R17 R4  
     123 [-]: LOADB R18 1  
...
L13: 127 [-]: NAMECALL R11 R9 K35 [0xBB610E5B]
     ...
     130 [-]: MOVE R13 R9  
     131 [-]: GETIMPORT R12 1 [0x7B998233]
     132 [-]: CALL R12 1 1 
L14: 133 [-]: JUMPIF R12 L16
     ...
     137 [-]: CALL R12 1 0 
     138 [-]: GETIMPORT R12 39 [0xADED939B]
     139 [-]: JUMPIFNOT R12 L16
     140 [-]: FASTCALL1 62 R2 L15
     141 [-]: MOVE R13 R2  
     142 [-]: GETIMPORT R12 1 [0x7B998233]
     143 [-]: CALL R12 1 1 
...
; Max Stack Size:  7
       ...
       0 [-]: LOADN R1 0   
L 0:   1 [-]: GETIMPORT R2 1 [0xA3F4A174]
       2 [-]: JUMPIFNOTLT R1 R2 L1
       3 [-]: ADDK R2 R1 K2 [2]
       4 [-]: GETIMPORT R3 4 [0x67652851]
       5 [-]: CALL R3 0 1  
       6 [-]: ADD R1 R2 R3 
