...
L 1:  11 [-]: JUMPIF R7 L2 ; goto L2 if var7
      ...
      18 [-]: JUMPIFNOTLT R5 R7 L2; goto L2 if var5 >= var657185
...
L 3:  33 [-]: JUMPIF R7 L7 ; goto L7 if var7
      ...
      35 [-]: JUMPIFLE R7 R5 L4; goto L4 if var7 <= var2294292
      36 [-]: JUMPIFNOT R2 L7; goto L7 if not var2
L 4:  37 [-]: LOADN R5 0   ; var5 = 0
L 5:  38 [-]: LOADN R7 1   ; var7 = 1
      39 [-]: JUMPIFNOTLT R5 R7 L7; goto L7 if var5 >= var853831
      40 [-]: LOADK R7 K13 ; var7 = 0.20000000298023224
      41 [-]: JUMPIFNOTLT R7 R5 L6; goto L6 if var7 >= var919117
...
L 5:  28 [-]: JUMPIF R4 L7 ; goto L7 if var4
      ...
      32 [-]: JUMPIFNOTLT R5 R4 L7; goto L7 if var5 >= var656417
      ...
      41 [-]: MOVE R7 R3   ; var7 = var3
      42 [-]: FASTCALL1 63 R5 L6; 
      43 [-]: MOVE R9 R5   ; var9 = var5
      44 [-]: GETIMPORT R8 12; var8 = 0x64FB1586
      45 [-]: CALL R8 2 2  ; var8 = var8(var9)
L 6:  46 [-]: MOVE R9 R2   ; var9 = var2
      47 [-]: CALL R6 4 1  ; var6(var7, var8, var9)
      48 [-]: JUMP L8      ; goto L8
L 7:  49 [-]: GETIMPORT R4 3; var4 = 0x3D106989
      50 [-]: LOADK R5 K13 ; var5 = "Num operator/twin tags mismatch"
      51 [-]: CALL R4 2 1  ; var4(var5)
L 8:  52 [-]: GETUPVAL R4 3; var4 = upvalues[3]
...
L 2:  15 [-]: LOADN R3 0   ; var3 = 0
      16 [-]: JUMPIFNOTLT R3 R2 L3; goto L3 if var3 >= var459553
...
L 4:  41 [-]: JUMPIF R5 L5 ; goto L5 if var5
      ...
      44 [-]: JUMPIFEQ R5 R4 L5; goto L5 if var5 == var65571
      45 [-]: RETURN R0 0  ; 
...
L10:  71 [-]: JUMPIF R5 L13; goto L13 if var5
      ...
      81 [-]: FASTCALL1 63 R6 L11; 
      82 [-]: MOVE R10 R6  ; var10 = var6
      83 [-]: GETIMPORT R9 25; var9 = 0x64FB1586
      84 [-]: CALL R9 2 2  ; var9 = var9(var10)
L11:  85 [-]: MOVE R10 R2  ; var10 = var2
      86 [-]: CALL R7 4 1  ; var7(var8, var9, var10)
      87 [-]: JUMP L13     ; goto L13
L12:  88 [-]: GETIMPORT R5 14; var5 = 0x3D106989
      89 [-]: LOADK R6 K26 ; var6 = "Num operator/twin tags mismatch"
      90 [-]: CALL R5 2 1  ; var5(var6)
L13:  91 [-]: FASTCALL1 64 R2 L14; 
      92 [-]: MOVE R6 R2   ; var6 = var2
      93 [-]: GETIMPORT R5 12; var5 = 0x7B998233
      94 [-]: CALL R5 2 2  ; var5 = var5(var6)
L14:  95 [-]: JUMPIF R5 L15; goto L15 if var5
...
L15: 101 [-]: GETIMPORT R5 28; var5 = 0x3938D837
     102 [-]: LOADN R6 0   ; var6 = 0
     103 [-]: JUMPIFNOTLT R6 R5 L16; goto L16 if var6 >= var66849
     104 [-]: GETIMPORT R5 1; var5 = 0x89326C93
     105 [-]: NAMECALL R5 R5 K2; var6 = var5; var5 = var5[0x18D05D30]
     106 [-]: CALL R5 2 2  ; var5 = var5(var6)
     107 [-]: JUMPIFNOT R5 L16; goto L16 if not var5
     108 [-]: NAMECALL R5 R0 K29; var6 = var0; var5 = var0[0xDE321E6F]
     109 [-]: CALL R5 2 2  ; var5 = var5(var6)
     110 [-]: GETIMPORT R7 28; var7 = 0x3938D837
     111 [-]: MOVE R8 R0   ; var8 = var0
     112 [-]: GETIMPORT R9 31; var9 = 0x0469F296
     113 [-]: LOADK R10 K32; var10 = "/Lotus/Language/Menu/Global_XP"
     114 [-]: CALL R9 2 0  ; var9, ... = var9(var10)
     115 [-]: NAMECALL R5 R5 K33; var6 = var5; var5 = var5[0x8DB2624F]
     116 [-]: CALL R5 0 1  ; var5(var6, ...)
L16: 117 [-]: GETIMPORT R5 7; var5 = _T
     118 [-]: LOADNIL R6   ; var6 = nil
     119 [-]: SETTABLEKS R6 R5 K8; var6["modTwin"] = var5
     120 [-]: NAMECALL R5 R1 K34; var6 = var1; var5 = var1[0xA2880940]
...
L 1:  22 [-]: GETIMPORT R8 12; var8 = 0xC30807E7
      ...
      24 [-]: JUMPIFNOTEQ R7 R2 L2; goto L2 if var7 ~= var84096041
...
L 6:  33 [-]: NAMECALL R4 R2 K8; var5 = var2; var4 = var2[0x905BB2BD]
      ...
      37 [-]: JUMPIFNOTLT R3 R4 L7; goto L7 if var3 >= var394017
