...
; Max Stack Size:  4
 ...
 12 [-]: GETTABLE  R2 R0 K8     ; R2 := R0[0xc96d0ce6]
...
; Max Stack Size:  4
  ...
  9 [-]: SETTABLE  R0 K4 K5     ; R0["HITTYPE_MELEE"] := 0.000000
 10 [-]: SETTABLE  R0 K6 K7     ; R0["HITTYPE_POWER"] := 1.000000
 11 [-]: SETTABLE  R0 K8 K9     ; R0["HITTYPE_WEAPON"] := 2.000000
 12 [-]: SETTABLE  R0 K10 K11   ; R0["HITTYPE_PARKOUR"] := 3.000000
 13 [-]: SETTABLE  R0 K12 K13   ; R0["HITTYPE_NUM"] := 4.000000
 14 [-]: SETTABLE  R0 K14 K5    ; R0["HITTYPE_EX_NONE"] := 0.000000
 15 [-]: SETTABLE  R0 K15 K7    ; R0["HITTYPE_EX_WEAPON_PRIMARY"] := 1.000000
...
; Max Stack Size:  29
 ...
 14 [-]: JMP       25           ; PC := 25
 15 [-]: SELF      R6 R4 K3     ; R7 := R4; R6 := R4[0xf2deaf69]
 16 [-]: GETGLOBAL R8 K4        ; R8 := gLotusAvatarType
 17 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 18 [-]: TEST      R6 0         ; if not R6 then PC := 25
 19 [-]: JMP       25           ; PC := 25
 20 [-]: SELF      R6 R5 K3     ; R7 := R5; R6 := R5[0xf2deaf69]
 21 [-]: GETGLOBAL R8 K4        ; R8 := gLotusAvatarType
 22 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 23 [-]: TEST      R6 1         ; if R6 then PC := 26
 24 [-]: JMP       26           ; PC := 26
 25 [-]: RETURN    R0 1         ; return 
 26 [-]: SELF      R6 R1 K5     ; R7 := R1; R6 := R1[0xf1f754bc]
 27 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 28 [-]: SELF      R7 R1 K6     ; R8 := R1; R7 := R1[0x14a55974]
 ...
 57 [-]: JMP       63           ; PC := 63
 58 [-]: SELF      R11 R9 K14   ; R12 := R9; R11 := R9[0x099cc093]
 59 [-]: MOVE      R13 R5       ; R13 := R5
 60 [-]: CALL      R11 3 2      ; R11 := R11(R12,R13)
 61 [-]: MOVE      R10 R11      ; R10 := R11
 62 [-]: JMP       66           ; PC := 66
 63 [-]: SELF      R11 R2 K15   ; R12 := R2; R11 := R2[0x5ca33548]
 64 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 65 [-]: MOVE      R10 R11      ; R10 := R11
 66 [-]: LOADK     R11 K13      ; R11 := ""
 67 [-]: SELF      R12 R4 K16   ; R13 := R4; R12 := R4[0x5e651723]
 ...
 73 [-]: JMP       79           ; PC := 79
 74 [-]: SELF      R13 R9 K14   ; R14 := R9; R13 := R9[0x099cc093]
 75 [-]: MOVE      R15 R4       ; R15 := R4
 76 [-]: CALL      R13 3 2      ; R13 := R13(R14,R15)
 77 [-]: MOVE      R11 R13      ; R11 := R13
 78 [-]: JMP       82           ; PC := 82
 79 [-]: SELF      R13 R12 K15  ; R14 := R12; R13 := R12[0x5ca33548]
 ...
 91 [-]: JMP       107          ; PC := 107
 92 [-]: SELF      R13 R7 K3    ; R14 := R7; R13 := R7[0xf2deaf69]
...
116 [-]: SELF      R15 R8 K3    ; R16 := R8; R15 := R8[0xf2deaf69]
...
122 [-]: JMP       152          ; PC := 152
123 [-]: SELF      R15 R8 K3    ; R16 := R8; R15 := R8[0xf2deaf69]
...
129 [-]: JMP       152          ; PC := 152
130 [-]: SELF      R15 R8 K3    ; R16 := R8; R15 := R8[0xf2deaf69]
...
143 [-]: JMP       151          ; PC := 151
144 [-]: SELF      R15 R7 K3    ; R16 := R7; R15 := R7[0xf2deaf69]
...
169 [-]: JMP       215          ; PC := 215
170 [-]: SELF      R17 R16 K31  ; R18 := R16; R17 := R16[0xf7d48ee0]
171 [-]: CALL      R17 2 2      ; R17 := R17(R18)
172 [-]: GETGLOBAL R18 K2       ; R18 := 0x7b998233
173 [-]: MOVE      R19 R17      ; R19 := R17
174 [-]: CALL      R18 2 2      ; R18 := R18(R19)
175 [-]: TEST      R18 1        ; if R18 then PC := 215
176 [-]: JMP       215          ; PC := 215
177 [-]: GETGLOBAL R18 K32      ; R18 := 0x603636ad
178 [-]: SELF      R19 R17 K33  ; R20 := R17; R19 := R17[0xd3a9d01f]
...
185 [-]: JMP       215          ; PC := 215
186 [-]: SELF      R18 R8 K3    ; R19 := R8; R18 := R8[0xf2deaf69]
...
215 [-]: SELF      R18 R1 K37   ; R19 := R1; R18 := R1[0x36822477]
...
236 [-]: GETGLOBAL R21 K42      ; R21 := 0x0a8f62a7
237 [-]: CALL      R21 1 2      ; R21 := R21()
238 [-]: SUB       R21 R21 K43  ; R21 := R21 - 10000.000000
239 [-]: SETTABLE  R20 K41 R21  ; R20["lastHitTime"] := R21
240 [-]: GETGLOBAL R21 K42      ; R21 := 0x0a8f62a7
241 [-]: CALL      R21 1 2      ; R21 := R21()
242 [-]: SUB       R21 R21 K43  ; R21 := R21 - 10000.000000
...
254 [-]: SETTABLE  R21 K45 K46  ; R21["num"] := 0.000000
...
262 [-]: ADD       R21 R21 K48  ; R21 := R21 + 1.000000
...
268 [-]: JMP       273          ; PC := 273
269 [-]: GETGLOBAL R20 K42      ; R20 := 0x0a8f62a7
270 [-]: CALL      R20 1 2      ; R20 := R20()
271 [-]: SETTABLE  R19 K41 R20  ; R19["lastHitTime"] := R20
272 [-]: JMP       276          ; PC := 276
273 [-]: GETGLOBAL R20 K42      ; R20 := 0x0a8f62a7
...
278 [-]: JMP       292          ; PC := 292
279 [-]: GETTABLE  R20 R0 K50   ; R20 := R0[0xf58a38c0]
280 [-]: MOVE      R21 R12      ; R21 := R12
281 [-]: MOVE      R22 R2       ; R22 := R2
282 [-]: MOVE      R23 R13      ; R23 := R13
283 [-]: SELF      R24 R1 K51   ; R25 := R1; R24 := R1[0x36e85886]
284 [-]: CALL      R24 2 2      ; R24 := R24(R25)
285 [-]: SELF      R25 R1 K52   ; R26 := R1; R25 := R1[0xe8b105b3]
286 [-]: CALL      R25 2 2      ; R25 := R25(R26)
287 [-]: MOVE      R26 R14      ; R26 := R14
288 [-]: SELF      R27 R1 K53   ; R28 := R1; R27 := R1[0xf0a798a6]
...
306 [-]: SETTABLE  R20 R10 K46  ; R20[R10] := 0.000000
...
321 [-]: SETTABLE  R20 R11 K46  ; R20[R11] := 0.000000
...
327 [-]: ADD       R21 R21 K48  ; R21 := R21 + 1.000000
...
344 [-]: JMP       355          ; PC := 355
345 [-]: GETTABLE  R20 R0 K58   ; R20 := R0[0x7fd9dc99]
346 [-]: MOVE      R21 R12      ; R21 := R12
347 [-]: MOVE      R22 R2       ; R22 := R2
348 [-]: MOVE      R23 R13      ; R23 := R13
349 [-]: SELF      R24 R1 K51   ; R25 := R1; R24 := R1[0x36e85886]
350 [-]: CALL      R24 2 2      ; R24 := R24(R25)
351 [-]: SELF      R25 R1 K52   ; R26 := R1; R25 := R1[0xe8b105b3]
...
356 [-]: SETTABLE  R20 R11 K46  ; R20[R11] := 0.000000
