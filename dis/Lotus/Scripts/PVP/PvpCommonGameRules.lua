...
; Max Stack Size:  7
       ...
       7 [-]: LOADB R0 1   
       8 [-]: SETUPVAL R0 0
       9 [-]: GETIMPORT R0 7 [0x89326C93]
      10 [-]: NAMECALL R0 R0 K8 [0x18D05D30]
      11 [-]: CALL R0 1 1  
      12 [-]: JUMPIFNOT R0 L1
      13 [-]: GETIMPORT R0 7 [0x89326C93]
...
; Max Stack Size:  7
       ...
       4 [-]: GETUPVAL R3 0
       5 [-]: CALL R3 0 0  
L 0:   6 [-]: GETIMPORT R3 2 [0x89326C93]
       7 [-]: NAMECALL R3 R3 K3 [0x18D05D30]
       8 [-]: CALL R3 1 1  
       9 [-]: JUMPIF R3 L2 
      10 [-]: GETIMPORT R4 6 ["PVPObject"]
      11 [-]: MOVE R3 R4   
      12 [-]: JUMPIFNOT R3 L1
      13 [-]: GETIMPORT R4 6 ["PVPObject"]
      14 [-]: MOVE R3 R4   
      15 [-]: MOVE R5 R0   
      16 [-]: MOVE R6 R1   
      ...
      18 [-]: CALL R3 3 0  
L 1:  19 [-]: RETURN R0 0  
L 2:  20 [-]: GETIMPORT R4 6 ["PVPObject"]
      21 [-]: MOVE R3 R4   
      22 [-]: JUMPIFNOT R3 L3
      23 [-]: GETIMPORT R4 6 ["PVPObject"]
      24 [-]: MOVE R3 R4   
      25 [-]: MOVE R5 R0   
      26 [-]: MOVE R6 R1   
...
; Max Stack Size:  14
       ...
       0 [-]: GETIMPORT R7 2 ["PVPObject"]
       1 [-]: MOVE R6 R7   
       2 [-]: JUMPIFNOT R6 L0
       3 [-]: GETIMPORT R7 2 ["PVPObject"]
       4 [-]: MOVE R6 R7   
       5 [-]: MOVE R8 R0   
       6 [-]: MOVE R9 R1   
       7 [-]: MOVE R10 R2  
...
; Max Stack Size:  6
       ...
       0 [-]: GETIMPORT R3 2 ["PVPObject"]
       1 [-]: MOVE R2 R3   
       2 [-]: JUMPIFNOT R2 L0
       3 [-]: GETIMPORT R3 2 ["PVPObject"]
       4 [-]: MOVE R2 R3   
       5 [-]: MOVE R4 R0   
       6 [-]: MOVE R5 R1   
...
L 6:  38 [-]: GETIMPORT R8 14 [0xBE190284]
...
L 3:  30 [-]: JUMPIF R3 L6 
      ...
      32 [-]: CALL R3 1 1  
      33 [-]: JUMPIF R3 L6 
      34 [-]: GETIMPORT R3 11 [0x603636AD]
      35 [-]: GETIMPORT R4 13 [0x64FB1586]
      ...
      52 [-]: CALL R4 2 0  
L 4:  53 [-]: GETIMPORT R4 22 [0xCBD666E1]
      54 [-]: LOADN R5 0   
      55 [-]: CALL R4 1 0  
      56 [-]: JUMPBACK L4  
      57 [-]: RETURN R0 0  
...
; Max Stack Size:  6
       ...
       0 [-]: GETIMPORT R2 2 ["PvpTeamSelectMovie"]
       1 [-]: JUMPIFNOT R2 L0
       2 [-]: GETIMPORT R2 2 ["PvpTeamSelectMovie"]
       3 [-]: LOADK R4 K3 ["OnPlayersChanged"]
       4 [-]: LOADK R5 K4 [""]
       5 [-]: NAMECALL R2 R2 K5 [0xE4162EED]
       6 [-]: CALL R2 3 0  
       7 [-]: RETURN R0 0  
L 0:   8 [-]: GETIMPORT R3 7 ["PVPObject"]
       9 [-]: MOVE R2 R3   
      10 [-]: JUMPIFNOT R2 L1
      11 [-]: GETIMPORT R3 7 ["PVPObject"]
      12 [-]: MOVE R2 R3   
      13 [-]: MOVE R4 R0   
      14 [-]: MOVE R5 R1   
...
; Max Stack Size:  6
       ...
       5 [-]: NAMECALL R2 R2 K5 [0xE4162EED]
       6 [-]: CALL R2 3 0  
L 0:   7 [-]: GETIMPORT R3 7 ["PVPObject"]
       8 [-]: MOVE R2 R3   
       9 [-]: JUMPIFNOT R2 L1
      10 [-]: GETIMPORT R3 7 ["PVPObject"]
      11 [-]: MOVE R2 R3   
      12 [-]: MOVE R4 R0   
      13 [-]: MOVE R5 R1   
...
; Max Stack Size:  8
       ...
       1 [-]: MOVE R0 R1   
       2 [-]: MOVE R0 R2   
       3 [-]: GETIMPORT R4 2 [0x66EDF04F]
       4 [-]: MOVE R5 R0   
       5 [-]: LOADK R6 K3 ["%$%$.-%$%$"]
       6 [-]: MOVE R7 R3   
       7 [-]: CALL R4 3 2  
       8 [-]: GETIMPORT R6 6 ["AddLogMessage"]
       9 [-]: MOVE R7 R4   
      10 [-]: CALL R6 1 0  
      11 [-]: RETURN R0 0  
...
; Max Stack Size:  5
       ...
       1 [-]: GETIMPORT R2 2 ["PVPObject"]
       2 [-]: MOVE R1 R2   
       3 [-]: JUMPIFNOT R1 L0
       4 [-]: GETIMPORT R3 2 ["PVPObject"]
       5 [-]: MOVE R2 R3   
       6 [-]: GETTABLE R1 R2 R0
       7 [-]: JUMPIFNOT R1 L0
       8 [-]: MOVE R2 R1   
       9 [-]: GETIMPORT R4 2 ["PVPObject"]
      10 [-]: MOVE R3 R4   
      11 [-]: GETVARARGS R4 -1
      12 [-]: CALL R2 -1 0 
L 0:  13 [-]: RETURN R0 0  
...
; Max Stack Size:  4
       ...
       0 [-]: GETIMPORT R1 2 ["exitConfirmed"]
       1 [-]: JUMPIF R1 L0 
       2 [-]: GETUPVAL R2 0
