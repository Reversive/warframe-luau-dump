...
L 2:  15 [-]: JUMPIF R3 L7 ; goto L7 if var3
      ...
      25 [-]: JUMPIFNOTEQ R3 R4 L4; goto L4 if var3 ~= var-536869825
      ...
      33 [-]: JUMPIFNOTLT R5 R4 L3; goto L3 if var5 >= var1593836620
      ...
      39 [-]: JUMPIFNOTLT R4 R5 L3; goto L3 if var4 >= var66566
...
L 4:  65 [-]: GETTABLEKS R4 R0 K18; var4 = var0["PVPSTATE_STARTED"]
      66 [-]: JUMPIFNOTEQ R3 R4 L5; goto L5 if var3 ~= var1593836620
      ...
      71 [-]: JUMPIFNOTLT R1 R4 L5; goto L5 if var1 >= var1962935871
...
L 6:  90 [-]: GETTABLEKS R4 R0 K20; var4 = var0["PVPSTATE_FINISHED"]
      91 [-]: JUMPIFNOTEQ R3 R4 L7; goto L7 if var3 ~= var1542
...
L 0:   7 [-]: CONCAT R4 R5 R6; var4 = var5 .. var6
      ...
      14 [-]: NAMECALL R4 R0 K11; var5 = var0; var4 = var0[0xD5A1AD5F]
      15 [-]: CALL R4 2 2  ; var4 = var4(var5)
      16 [-]: NAMECALL R4 R4 K12; var5 = var4; var4 = var4[0x1FF0012A]
      17 [-]: CALL R4 2 2  ; var4 = var4(var5)
      18 [-]: SUBK R3 R4 K10; var3 = var4 - 30
      19 [-]: GETIMPORT R4 14; var4 = 0x2D0FAD09
      20 [-]: LOADK R5 K15 ; var5 = "Lotus.Interface.LotusUtilities"
      21 [-]: CALL R4 2 2  ; var4 = var4(var5)
      22 [-]: GETIMPORT R5 18; var5 = _T["AddHudTracker"]
      23 [-]: LOADK R6 K19 ; var6 = "PvpEventTimer"
      24 [-]: GETTABLEKS R7 R4 K20; var7 = var4["HT_TIMER"]
      25 [-]: LOADK R8 K21 ; var8 = 0.25
      26 [-]: CALL R5 4 2  ; var5 = var5(var6, var7, var8)
      27 [-]: GETTABLEKS R6 R5 K22; var6 = var5["StartTimer"]
      28 [-]: MOVE R8 R0   ; var8 = var0
      29 [-]: CALL R8 1 2  ; var8 = var8()
      30 [-]: NAMECALL R8 R8 K23; var9 = var8; var8 = var8[0x39406D2F]
      31 [-]: CALL R8 2 2  ; var8 = var8(var9)
      32 [-]: SUB R7 R8 R3 ; var7 = var8 - var3
      33 [-]: LOADB R8 0   ; var8 = false
      34 [-]: LOADB R9 1   ; var9 = true
      35 [-]: CALL R6 4 1  ; var6(var7, var8, var9)
      36 [-]: NAMECALL R6 R0 K11; var7 = var0; var6 = var0[0xD5A1AD5F]
      37 [-]: CALL R6 2 2  ; var6 = var6(var7)
      38 [-]: LOADK R8 K24 ; var8 = ""
      39 [-]: GETTABLEKS R9 R0 K25; var9 = var0["startTransRes"]
      40 [-]: LOADB R10 1  ; var10 = true
      41 [-]: NAMECALL R6 R6 K26; var7 = var6; var6 = var6[0x6B9EEBAC]
      42 [-]: CALL R6 5 1  ; var6(var7, var8, var9, var10)
      43 [-]: LOADK R7 K27 ; var7 = "<p><font color=\"#FFFFFF\"> "
      44 [-]: LOADK R8 K28 ; var8 = "$$"
      45 [-]: GETTABLEKS R13 R0 K29; var13 = var0["pvpEventData"]
      46 [-]: GETTABLEKS R9 R13 K30; var9 = var13["mLocName"]
      47 [-]: LOADK R10 K28; var10 = "$$"
      48 [-]: LOADK R11 K31; var11 = " </font>"
      49 [-]: LOADK R12 K32; var12 = "</p>"
      50 [-]: CONCAT R6 R7 R12; var6 = var7 .. var12
      51 [-]: GETIMPORT R7 34; var7 = 0xC8802016
      52 [-]: GETIMPORT R8 8; var8 = 0x89326C93
      53 [-]: NAMECALL R8 R8 K35; var9 = var8; var8 = var8[0x7D108DDB]
      54 [-]: CALL R8 2 0  ; var8, ... = var8(var9)
      55 [-]: CALL R7 0 4  ; var7, var8, var9 = var7(var8, ...)
      56 [-]: FORGPREP_INEXT R7 L2; 
L 1:  57 [-]: MOVE R14 R11 ; var14 = var11
      58 [-]: MOVE R15 R6  ; var15 = var6
      59 [-]: LOADK R16 K24; var16 = ""
      60 [-]: LOADK R17 K24; var17 = ""
      61 [-]: NAMECALL R12 R2 K36; var13 = var2; var12 = var2[0x03B99283]
      62 [-]: CALL R12 6 1 ; var12(var13, var14, var15, var16, var17)
L 2:  63 [-]: FORGLOOP R7 L1 2 [inext]; 
L 3:  64 [-]: GETIMPORT R3 3; var3 = 0x3D106989
      65 [-]: LOADK R4 K37 ; var4 = "OnEventActivateChange fix up mode"
      66 [-]: CALL R3 2 1  ; var3(var4)
      67 [-]: NOT R5 R1    ; var5 = not var1
      68 [-]: NAMECALL R3 R2 K38; var4 = var2; var3 = var2[0x7D73251E]
      69 [-]: CALL R3 3 1  ; var3(var4, var5)
      70 [-]: NAMECALL R3 R0 K11; var4 = var0; var3 = var0[0xD5A1AD5F]
      71 [-]: CALL R3 2 2  ; var3 = var3(var4)
      72 [-]: NOT R4 R1    ; var4 = not var1
      73 [-]: SETTABLEKS R4 R3 K39; var4["defaultHUDHandling"] = var3
      74 [-]: NAMECALL R3 R0 K11; var4 = var0; var3 = var0[0xD5A1AD5F]
      75 [-]: CALL R3 2 2  ; var3 = var3(var4)
      76 [-]: NOT R5 R1    ; var5 = not var1
      77 [-]: NAMECALL R3 R3 K40; var4 = var3; var3 = var3[0x2827E3EE]
