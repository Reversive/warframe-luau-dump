...
L 5:  34 [-]: JUMPIF R6 L6 ; goto L6 if var6
      ...
      49 [-]: MULK R8 R2 K12; var8 = var2 * 0.94999999999999996
      50 [-]: MULK R9 R2 K13; var9 = var2 * 1.1000000000000001
...
L 7:  63 [-]: LOADN R7 1   ; var7 = 1
      64 [-]: JUMPIFNOTLT R6 R7 L9; goto L9 if var6 >= var1050446
...
L 0:   7 [-]: JUMPIF R1 L2 ; goto L2 if var1
      ...
      13 [-]: JUMPIFEQ R0 R1 L1; goto L1 if var0 == var65546
...
; Max Stack Size:  8
      ...
      22 [-]: JUMPIFNOTEQ R4 R5 L0; goto L0 if var4 ~= var66341
...
; Max Stack Size:  4
       ...
       0 [-]: LOADN R0 0   ; var0 = 0
       1 [-]: GETIMPORT R1 1; var1 = 0x64FB1586
       2 [-]: GETUPVAL R2 0; var2 = upvalues[0]
       3 [-]: CALL R1 2 2  ; var1 = var1(var2)
       4 [-]: JUMPXEQKS R1 K2 L0 NOT; 
       5 [-]: GETUPVAL R1 1; var1 = upvalues[1]
       6 [-]: GETUPVAL R3 2; var3 = upvalues[2]
       7 [-]: NAMECALL R1 R1 K3; var2 = var1; var1 = var1[0x0EB34C69]
       8 [-]: CALL R1 3 2  ; var1 = var1(var2, var3)
       9 [-]: MOVE R0 R1   ; var0 = var1
      10 [-]: JUMP L1      ; goto L1
L 0:  11 [-]: GETUPVAL R1 1; var1 = upvalues[1]
      12 [-]: GETUPVAL R3 3; var3 = upvalues[3]
      13 [-]: NAMECALL R1 R1 K3; var2 = var1; var1 = var1[0x0EB34C69]
      14 [-]: CALL R1 3 2  ; var1 = var1(var2, var3)
      15 [-]: MOVE R0 R1   ; var0 = var1
L 1:  16 [-]: GETUPVAL R2 4; var2 = upvalues[4]
      17 [-]: GETTABLEKS R1 R2 K4; var1 = var2["SAFE"]
      18 [-]: JUMPIFEQ R0 R1 L2; goto L2 if var0 == var65819
...
L 0:   5 [-]: GETUPVAL R3 0; var3 = upvalues[0]
       ...
       8 [-]: CALL R2 2 2  ; var2 = var2(var3)
L 1:   9 [-]: JUMPIF R2 L29; goto L29 if var2
...
L 3:  18 [-]: JUMPIFNOT R2 L4; goto L4 if not var2
      ...
      22 [-]: LOADK R3 K8  ; var3 = 0.10000000000000001
...
L 4:  25 [-]: GETUPVAL R3 1; var3 = upvalues[1]
      ...
      31 [-]: JUMPIFEQ R2 R3 L8; goto L8 if var2 == var263175
      32 [-]: GETUPVAL R4 4; var4 = upvalues[4]
      33 [-]: GETTABLEKS R3 R4 K10; var3 = var4["SAFE"]
      34 [-]: JUMPIFNOTEQ R2 R3 L5; goto L5 if var2 ~= var328455
...
L 5:  39 [-]: GETUPVAL R4 4; var4 = upvalues[4]
      ...
      41 [-]: JUMPIFNOTEQ R2 R3 L6; goto L6 if var2 ~= var328455
...
L 6:  46 [-]: GETUPVAL R4 4; var4 = upvalues[4]
      ...
      48 [-]: JUMPIFNOTEQ R2 R3 L7; goto L7 if var2 ~= var328455
...
L 8:  56 [-]: GETUPVAL R4 4; var4 = upvalues[4]
      ...
      58 [-]: JUMPIFNOTEQ R2 R3 L21; goto L21 if var2 ~= var459527
...
L 9:  70 [-]: JUMPIF R3 L18; goto L18 if var3
      ...
      75 [-]: JUMPIFNOTLT R4 R3 L11; goto L11 if var4 >= var525063
      76 [-]: GETUPVAL R3 8; var3 = upvalues[8]
      77 [-]: LOADN R4 15  ; var4 = 15
      78 [-]: JUMPIFNOTLT R4 R3 L10; goto L10 if var4 >= var328455
...
L11:  89 [-]: GETUPVAL R3 11; var3 = upvalues[11]
      ...
      97 [-]: JUMPIFNOTLT R3 R4 L13; goto L13 if var3 >= var525063
      98 [-]: GETUPVAL R3 8; var3 = upvalues[8]
      99 [-]: LOADN R4 15  ; var4 = 15
     100 [-]: JUMPIFNOTLT R4 R3 L12; goto L12 if var4 >= var328455
...
L13: 115 [-]: LOADN R4 0   ; var4 = 0
     116 [-]: GETIMPORT R5 30; var5 = 0x64FB1586
     117 [-]: GETUPVAL R6 2; var6 = upvalues[2]
     118 [-]: CALL R5 2 2  ; var5 = var5(var6)
     119 [-]: JUMPXEQKS R5 K31 L14 NOT; 
     120 [-]: GETUPVAL R5 1; var5 = upvalues[1]
     121 [-]: GETUPVAL R7 12; var7 = upvalues[12]
     122 [-]: NAMECALL R5 R5 K9; var6 = var5; var5 = var5[0x0EB34C69]
     123 [-]: CALL R5 3 2  ; var5 = var5(var6, var7)
     124 [-]: MOVE R4 R5   ; var4 = var5
     125 [-]: JUMP L15     ; goto L15
L14: 126 [-]: GETUPVAL R5 1; var5 = upvalues[1]
     127 [-]: GETUPVAL R7 13; var7 = upvalues[13]
     128 [-]: NAMECALL R5 R5 K9; var6 = var5; var5 = var5[0x0EB34C69]
     129 [-]: CALL R5 3 2  ; var5 = var5(var6, var7)
     130 [-]: MOVE R4 R5   ; var4 = var5
L15: 131 [-]: GETUPVAL R6 4; var6 = upvalues[4]
     132 [-]: GETTABLEKS R5 R6 K10; var5 = var6["SAFE"]
     133 [-]: JUMPIFEQ R4 R5 L16; goto L16 if var4 == var66331
     134 [-]: LOADB R3 1   ; var3 = true
     135 [-]: JUMP L17     ; goto L17
L16: 136 [-]: LOADB R3 0   ; var3 = false
L17: 137 [-]: JUMPIFNOT R3 L18; goto L18 if not var3
     138 [-]: GETUPVAL R3 8; var3 = upvalues[8]
     139 [-]: LOADN R4 60  ; var4 = 60
     140 [-]: JUMPIFNOTLT R4 R3 L18; goto L18 if var4 >= var328455
     141 [-]: GETUPVAL R3 5; var3 = upvalues[5]
     142 [-]: GETIMPORT R4 33; var4 = 0x591BA993
     143 [-]: CALL R3 2 1  ; var3(var4)
     144 [-]: LOADN R3 0   ; var3 = 0
     145 [-]: SETUPVAL R3 8; upvalues[3] = var8
L18: 146 [-]: GETUPVAL R3 6; var3 = upvalues[6]
     147 [-]: LOADN R4 15  ; var4 = 15
     148 [-]: JUMPIFNOTLT R4 R3 L23; goto L23 if var4 >= var839
     149 [-]: LOADN R3 0   ; var3 = 0
     150 [-]: SETUPVAL R3 6; upvalues[3] = var6
     151 [-]: GETUPVAL R4 9; var4 = upvalues[9]
     152 [-]: FASTCALL1 62 R4 L19; 
     153 [-]: GETIMPORT R3 4; var3 = 0x7B998233
     154 [-]: CALL R3 2 2  ; var3 = var3(var4)
L19: 155 [-]: JUMPIF R3 L20; goto L20 if var3
     156 [-]: GETUPVAL R3 9; var3 = upvalues[9]
     157 [-]: NAMECALL R3 R3 K34; var4 = var3; var3 = var3[0xC69299ED]
     158 [-]: CALL R3 2 2  ; var3 = var3(var4)
     159 [-]: LOADK R4 K8  ; var4 = 0.10000000000000001
     160 [-]: JUMPIFNOTLT R3 R4 L20; goto L20 if var3 >= var328455
     161 [-]: GETUPVAL R3 5; var3 = upvalues[5]
     162 [-]: GETIMPORT R4 36; var4 = 0x120C6E63
     163 [-]: CALL R3 2 1  ; var3(var4)
     164 [-]: JUMP L23     ; goto L23
L20: 165 [-]: GETUPVAL R3 5; var3 = upvalues[5]
     166 [-]: GETIMPORT R4 38; var4 = 0x4DEDE18B
     167 [-]: CALL R3 2 1  ; var3(var4)
     168 [-]: JUMP L23     ; goto L23
L21: 169 [-]: GETUPVAL R4 4; var4 = upvalues[4]
     170 [-]: GETTABLEKS R3 R4 K16; var3 = var4["DROPPED"]
     171 [-]: JUMPIFNOTEQ R2 R3 L22; goto L22 if var2 ~= var393991
     172 [-]: GETUPVAL R3 6; var3 = upvalues[6]
     173 [-]: LOADN R4 15  ; var4 = 15
     174 [-]: JUMPIFNOTLT R4 R3 L23; goto L23 if var4 >= var839
     175 [-]: LOADN R3 0   ; var3 = 0
     176 [-]: SETUPVAL R3 6; upvalues[3] = var6
     177 [-]: GETUPVAL R3 5; var3 = upvalues[5]
     178 [-]: GETIMPORT R4 40; var4 = 0x01AE99FD
     179 [-]: CALL R3 2 1  ; var3(var4)
     180 [-]: JUMP L23     ; goto L23
L22: 181 [-]: GETUPVAL R4 4; var4 = upvalues[4]
     182 [-]: GETTABLEKS R3 R4 K10; var3 = var4["SAFE"]
     183 [-]: JUMPIFNOTEQ R2 R3 L23; goto L23 if var2 ~= var393991
     184 [-]: GETUPVAL R3 6; var3 = upvalues[6]
     185 [-]: LOADN R4 45  ; var4 = 45
     186 [-]: JUMPIFNOTLT R4 R3 L23; goto L23 if var4 >= var839
     187 [-]: LOADN R3 0   ; var3 = 0
     188 [-]: SETUPVAL R3 6; upvalues[3] = var6
     189 [-]: GETUPVAL R3 5; var3 = upvalues[5]
     190 [-]: GETIMPORT R4 42; var4 = 0x3C9B6D02
     191 [-]: CALL R3 2 1  ; var3(var4)
L23: 192 [-]: GETUPVAL R4 4; var4 = upvalues[4]
     193 [-]: GETTABLEKS R3 R4 K13; var3 = var4["STOLEN"]
     194 [-]: JUMPIFEQ R2 R3 L24; goto L24 if var2 == var263175
     195 [-]: GETUPVAL R4 4; var4 = upvalues[4]
     196 [-]: GETTABLEKS R3 R4 K16; var3 = var4["DROPPED"]
     197 [-]: JUMPIFNOTEQ R2 R3 L27; goto L27 if var2 ~= var2950222
L24: 198 [-]: GETIMPORT R4 45; var4 = _T["PVPObject"]
     199 [-]: FASTCALL1 62 R4 L25; 
     200 [-]: GETIMPORT R3 4; var3 = 0x7B998233
     201 [-]: CALL R3 2 2  ; var3 = var3(var4)
L25: 202 [-]: JUMPIF R3 L28; goto L28 if var3
     203 [-]: GETIMPORT R3 45; var3 = _T["PVPObject"]
     204 [-]: GETUPVAL R5 2; var5 = upvalues[2]
     205 [-]: NAMECALL R3 R3 K46; var4 = var3; var3 = var3[0xB99D7656]
     206 [-]: CALL R3 3 2  ; var3 = var3(var4, var5)
     207 [-]: GETUPVAL R4 14; var4 = upvalues[14]
     208 [-]: LOADN R5 5   ; var5 = 5
     209 [-]: JUMPIFNOTLE R5 R4 L26; goto L26 if var5 > var328775
     210 [-]: LOADN R4 5   ; var4 = 5
     211 [-]: JUMPIFNOTLT R3 R4 L26; goto L26 if var3 >= var328711
     212 [-]: GETUPVAL R4 5; var4 = upvalues[5]
     213 [-]: GETIMPORT R5 48; var5 = 0x43E63AEE
     214 [-]: CALL R4 2 1  ; var4(var5)
     215 [-]: LOADN R4 0   ; var4 = 0
     216 [-]: SETUPVAL R4 6; upvalues[4] = var6
L26: 217 [-]: SETUPVAL R3 14; upvalues[3] = var14
     218 [-]: JUMP L28     ; goto L28
L27: 219 [-]: LOADN R3 5   ; var3 = 5
     220 [-]: SETUPVAL R3 14; upvalues[3] = var14
L28: 221 [-]: GETUPVAL R4 6; var4 = upvalues[6]
     222 [-]: GETIMPORT R5 20; var5 = 0x67652851
     223 [-]: CALL R5 1 2  ; var5 = var5()
     224 [-]: ADD R3 R4 R5 ; var3 = var4 + var5
     225 [-]: SETUPVAL R3 6; upvalues[3] = var6
     226 [-]: GETIMPORT R3 7; var3 = 0xCBD666E1
     227 [-]: LOADN R4 0   ; var4 = 0
     228 [-]: CALL R3 2 1  ; var3(var4)
     229 [-]: JUMPBACK L0  ; goto L0
L29: 230 [-]: RETURN R0 0  ; 
