...
; Max Stack Size:  10
       ...
       3 [-]: LOADN R2 2   
       4 [-]: CALL R0 2 0  
       5 [-]: GETIMPORT R0 3 [0xB99426DB]
       6 [-]: GETIMPORT R2 5 [0x752A5F1F]
      ...
      16 [-]: JUMPIFNOT R1 L1
      17 [-]: LOADN R3 1   
      18 [-]: GETIMPORT R4 14 [0xDE0A8020]
      19 [-]: LENGTH R1 R4 
      20 [-]: LOADN R2 1   
      21 [-]: FORNPREP R1 L1
L 0:  22 [-]: GETIMPORT R4 11 [0x89326C93]
      23 [-]: GETIMPORT R6 16 [0x7111BCCF]
      24 [-]: GETIMPORT R7 18 ["ZERO_VECTOR"]
      25 [-]: GETIMPORT R8 20 ["ZERO_ROTATION"]
      26 [-]: GETIMPORT R9 3 [0xB99426DB]
      27 [-]: NAMECALL R4 R4 K21 [0x05909209]
      28 [-]: CALL R4 5 1  
      29 [-]: SETTABLE R4 R0 R3
      30 [-]: GETIMPORT R4 3 [0xB99426DB]
      31 [-]: GETTABLE R6 R0 R3
      32 [-]: GETIMPORT R8 14 [0xDE0A8020]
      33 [-]: GETTABLE R7 R8 R3
      34 [-]: GETIMPORT R8 18 ["ZERO_VECTOR"]
      35 [-]: GETIMPORT R9 20 ["ZERO_ROTATION"]
      36 [-]: NAMECALL R4 R4 K22 [0x3BB4F460]
      37 [-]: CALL R4 5 0  
      38 [-]: FORNLOOP R1 L0
L 1:  39 [-]: GETIMPORT R1 11 [0x89326C93]
...
L 2:  48 [-]: GETTABLE R6 R0 R4
      ...
      50 [-]: GETIMPORT R5 24 [0x7B998233]
      51 [-]: CALL R5 1 1  
L 3:  52 [-]: JUMPIF R5 L4 
      53 [-]: GETIMPORT R5 26 [0x11A19C5E]
...
L 5:  62 [-]: GETIMPORT R2 31 [0xBE190284]
      63 [-]: GETUPVAL R4 1
      64 [-]: MOVE R5 R1   
      65 [-]: NAMECALL R2 R2 K32 [0x751F061D]
      66 [-]: CALL R2 3 0  
L 6:  67 [-]: GETIMPORT R1 3 [0xB99426DB]
      68 [-]: GETIMPORT R3 34 [0x987A8F47]
      69 [-]: LOADB R4 0   
      70 [-]: LOADB R5 0   
      71 [-]: LOADN R6 1   
      72 [-]: GETIMPORT R7 7 [0x0469F296]
      73 [-]: CALL R7 0 1  
...
L 0:  16 [-]: JUMPXEQKN R3 K3 L2 NOT [1]
      17 [-]: GETIMPORT R5 9 [0x95BFF78D]
      18 [-]: FASTCALL1 62 R5 L1
      19 [-]: GETIMPORT R4 11 [0x7B998233]
      20 [-]: CALL R4 1 1  
L 1:  21 [-]: JUMPIF R4 L2 
      22 [-]: GETIMPORT R4 9 [0x95BFF78D]
      23 [-]: LOADN R6 3   
      24 [-]: GETIMPORT R7 13 [0x2F9B2A12]
...
L 4:  56 [-]: JUMPIF R7 L5 
      ...
      60 [-]: CALL R7 2 0  
L 5:  61 [-]: GETIMPORT R5 9 [0x95BFF78D]
      62 [-]: FASTCALL1 62 R5 L6
      63 [-]: GETIMPORT R4 11 [0x7B998233]
      64 [-]: CALL R4 1 1  
L 6:  65 [-]: JUMPIF R4 L7 
      66 [-]: GETIMPORT R4 9 [0x95BFF78D]
      67 [-]: LOADN R6 3   
      68 [-]: GETIMPORT R7 25 [0xD89994AC]
...
; Max Stack Size:  9
       ...
       5 [-]: RETURN R0 0  
L 0:   6 [-]: GETIMPORT R2 5 [0x89326C93]
       7 [-]: NAMECALL R2 R2 K6 [0x18D05D30]
       8 [-]: CALL R2 1 1  
       9 [-]: JUMPIFNOT R2 L6
      10 [-]: GETIMPORT R2 5 [0x89326C93]
      11 [-]: GETIMPORT R4 8 [0x7111BCCF]
