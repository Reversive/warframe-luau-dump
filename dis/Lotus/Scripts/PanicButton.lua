...
; Max Stack Size:  24
 ...
 28 [-]: GETTABLE  R9 R9 K8     ; R82 := R9[0x23d5322f]
 ...
 80 [-]: GETTABLE  R21 R21 K8   ; R82 := R21[0x23d5322f]
...
; Max Stack Size:  35
 ...
 63 [-]: NOT       R17 R1       ; R17 := not R1
 64 [-]: OP_LOADBOOL R18 1 0      ; R18 := true
...
152 [-]: OP_LOADBOOL R34 0 0      ; R34 := false
...
188 [-]: OP_LOADBOOL R37 1 0      ; R37 := true
...
195 [-]: OP_LOADBOOL R37 0 0      ; R37 := false
...
; Max Stack Size:  7
 ...
 18 [-]: GETTABLE  R3 R3 K6     ; R82 := R3[0x44721b30]
 19 [-]: MOVE      R4 R0        ; R4 := R0
 20 [-]: MOVE      R5 R2        ; R5 := R2
...
; Max Stack Size:  8
 ...
 20 [-]: GETTABLE  R3 R3 K6     ; R82 := R3[0x44721b30]
 21 [-]: MOVE      R4 R0        ; R4 := R0
 22 [-]: MOVE      R5 R2        ; R5 := R2
...
; Max Stack Size:  45
 ...
 26 [-]: SETGLOBALHASH R5 K10       ; (0xa9652613) := R5
 27 [-]: GETUPVAL  R5 U2        ; R5 := U2
 28 [-]: GETTABLE  R5 R5 K11    ; R82 := R5[0x67a78dad]
...
109 [-]: OP_LOADBOOL R21 0 0      ; R21 := false
...
130 [-]: OP_LOADBOOL R28 0 0      ; R28 := false
...
155 [-]: OP_LOADBOOL R33 1 0      ; R33 := true
156 [-]: CALL      R31 3 1      ; R31(R32,R33)
157 [-]: SELF      R31 R30 K31  ; R32 := R30; R31 := R30[0x0d91e9d6]
158 [-]: LOADK     R33 1        ; R33 := 1.000000
159 [-]: LOADK     R34 15       ; R34 := 15.000000
160 [-]: LOADK     R35 0        ; R35 := 0.000000
161 [-]: LOADK     R36 500      ; R36 := 500.000000
...
189 [-]: OP_LOADBOOL R34 0 0      ; R34 := false
190 [-]: LOADK     R35 0        ; R35 := 0.000000
191 [-]: OP_LOADBOOL R36 0 0      ; R36 := false
...
199 [-]: OP_LOADBOOL R33 0 0      ; R33 := false
...
205 [-]: JMP       220          ; PC := 220
206 [-]: LOADK     R31 1        ; R31 := 1.000000
207 [-]: LEN       R32 R10      ; R32 := # R10
208 [-]: LOADK     R33 1        ; R33 := 1.000000
...
217 [-]: OP_LOADBOOL R38 0 0      ; R38 := false
...
241 [-]: GETTABLE  R42 R42 K11  ; R82 := R42[0x67a78dad]
...
; Max Stack Size:  26
 ...
 57 [-]: GETTABLE  R4 R4 K22    ; R82 := R4[0xe17b82b0]
