...
; Max Stack Size:  9
       ...
       1 [-]: CALL R1 1 1  
       2 [-]: GETIMPORT R3 2 [0x2D7F296E]
       3 [-]: LOADN R4 25  
       4 [-]: LOADN R5 6   
       5 [-]: LOADN R6 0   
       6 [-]: GETIMPORT R7 4 [0x897D8D0F]
       7 [-]: NAMECALL R1 R1 K5 [0xEB3C14DA]
       8 [-]: CALL R1 6 0  
       9 [-]: GETIMPORT R3 7 [0xAF5F3F44]
...
L 0:  16 [-]: JUMPIFNOT R2 L1
      17 [-]: GETIMPORT R4 7 [0xAF5F3F44]
      18 [-]: GETIMPORT R5 12 ["EMPTY_SYMBOL"]
      19 [-]: GETIMPORT R6 14 ["ZERO_VECTOR"]
      20 [-]: GETIMPORT R7 16 ["ZERO_ROTATION"]
      21 [-]: MOVE R8 R0   
...
L 1:  26 [-]: NAMECALL R2 R1 K18 [0x383D2E7D]
      27 [-]: CALL R2 1 0  
L 2:  28 [-]: GETIMPORT R2 20 [0x9A1BDEB6]
      29 [-]: GETIMPORT R3 22 [0xCBD666E1]
      30 [-]: MOVE R4 R2   
      31 [-]: CALL R3 1 0  
      32 [-]: GETIMPORT R5 7 [0xAF5F3F44]
...
L 0:   4 [-]: JUMPIF R2 L7 
       5 [-]: LOADB R2 0   
       6 [-]: LOADN R5 1   
       7 [-]: GETIMPORT R6 3 [0x320D9A15]
       8 [-]: LENGTH R3 R6 
       9 [-]: LOADN R4 1   
      10 [-]: FORNPREP R3 L3
L 1:  11 [-]: GETIMPORT R7 3 [0x320D9A15]
...
L 3:  19 [-]: LOADN R5 1   
      20 [-]: GETIMPORT R6 6 [0x43BA5FCA]
      21 [-]: LENGTH R3 R6 
      22 [-]: LOADN R4 1   
      23 [-]: FORNPREP R3 L6
L 4:  24 [-]: GETIMPORT R7 6 [0x43BA5FCA]
...
L 0:   6 [-]: JUMPIF R2 L2 
       ...
       9 [-]: CALL R2 1 1  
      10 [-]: JUMPIFNOT R2 L2
      11 [-]: GETIMPORT R3 4 [0x142584A3]
      12 [-]: GETIMPORT R4 6 [0x6A898BF4]
      13 [-]: SUB R2 R3 R4 
...
L 7:  47 [-]: JUMPIF R2 L8 
      ...
      50 [-]: CALL R2 1 0  
L 8:  51 [-]: GETIMPORT R3 4 [0x142584A3]
      52 [-]: GETIMPORT R4 6 [0x6A898BF4]
      53 [-]: ADD R2 R3 R4 
      54 [-]: SETUPVAL R2 0
      55 [-]: RETURN R0 0  
...
L 6:  36 [-]: JUMPIF R3 L7 
      ...
      39 [-]: CALL R3 1 0  
L 7:  40 [-]: RETURN R0 0  
L 8:  41 [-]: GETIMPORT R3 10 [0xCBD666E1]
      42 [-]: LOADN R4 0   
      43 [-]: CALL R3 1 0  
...
L10:  48 [-]: JUMPIFNOT R3 L14
      49 [-]: GETIMPORT R3 10 [0xCBD666E1]
      50 [-]: LOADN R4 0   
      51 [-]: CALL R3 1 0  
      52 [-]: GETIMPORT R3 12 [0xBE190284]
      53 [-]: SETUPVAL R3 6
      54 [-]: GETUPVAL R4 6
...
L12:  60 [-]: GETUPVAL R3 6
      ...
      62 [-]: CALL R3 1 1  
      63 [-]: JUMPIF R3 L13
      64 [-]: GETIMPORT R3 10 [0xCBD666E1]
      65 [-]: LOADN R4 0   
      66 [-]: CALL R3 1 0  
      67 [-]: JUMPBACK L12 
L13:  68 [-]: JUMPBACK L9  
L14:  69 [-]: GETIMPORT R3 2 [0x89326C93]
      70 [-]: NAMECALL R3 R3 K3 [0x18D05D30]
      71 [-]: CALL R3 1 1  
      72 [-]: JUMPIFNOT R3 L15
      73 [-]: GETUPVAL R3 7
      74 [-]: GETIMPORT R4 15 [0x67652851]
      75 [-]: CALL R4 0 -1 
      76 [-]: CALL R3 -1 0 
L15:  77 [-]: JUMPBACK L1  
      78 [-]: RETURN R0 0  
