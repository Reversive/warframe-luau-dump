...
; Max Stack Size:  26
      ...
      27 [-]: LOADK R12 K11; var12 = 0.0099999997764825821
...
L 6:  35 [-]: GETUPVAL R3 1; var3 = upvalues[1]
      ...
      38 [-]: MULK R2 R3 K11; var2 = var3 * 0.30000001192092896
...
L 2:  36 [-]: GETTABLE R11 R3 R10; var11 = var3[var10]
      ...
      39 [-]: JUMPIFNOTEQ R11 R12 L3; goto L3 if var11 ~= var67334
...
L13:  99 [-]: MOVE R8 R11  ; var8 = var11
     ...
     101 [-]: JUMPIFNOTLE R11 R8 L14; goto L14 if var11 > var920865
...
L15: 111 [-]: GETIMPORT R4 27; var4 = 0xC163F229
     ...
     115 [-]: LOADK R5 K28 ; var5 = 0.80000001192092896
     116 [-]: JUMPIFNOTLT R5 R4 L16; goto L16 if var5 >= var132156
...
L13:  85 [-]: JUMPIF R12 L15; goto L15 if var12
      ...
      93 [-]: JUMPIFNOTLT R12 R13 L15; goto L15 if var12 >= var459054
...
L 9:  90 [-]: GETUPVAL R6 0; var6 = upvalues[0]
      ...
      98 [-]: JUMPIFNOTLE R6 R7 L10; goto L10 if var6 > var591420
...
L11: 106 [-]: JUMPIF R6 L12; goto L12 if var6
     ...
     113 [-]: JUMPIFNOTLT R6 R5 L12; goto L12 if var6 >= var329532
