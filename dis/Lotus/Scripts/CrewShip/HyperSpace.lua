...
; Max Stack Size:  23
 ...
 96 [-]: OP_LOADBOOL R17 0 0      ; R17 := false
...
; Max Stack Size:  27
 ...
 98 [-]: SETGLOBALHASH R7 K19       ; (0xf00a1a52) := R7
...
227 [-]: GETTABLE  R18 R18 K52  ; R82 := R18[0xb62ecfe0]
...
354 [-]: OP_LOADBOOL R25 1 0      ; R25 := true
...
; Max Stack Size:  26
 ...
 40 [-]: GETTABLE  R16 R16 K6   ; R82 := R16[0x2f6f2966]
...
133 [-]: OP_LOADBOOL R24 0 0      ; R24 := false
...
138 [-]: OP_LOADBOOL R25 1 0      ; R25 := true
...
252 [-]: GETTABLE  R26 R26 K37  ; R82 := R26[0xf56e23e3]
...
; Max Stack Size:  7
 ...
 62 [-]: JMP       50           ; PC := 50
 63 [-]: OP_LOADBOOL R3 0 0       ; R3 := false
...
119 [-]: JMP       101          ; PC := 101
120 [-]: OP_LOADBOOL R2 1 0       ; R2 := true
121 [-]: JMP       101          ; PC := 101
...
221 [-]: JMP       205          ; PC := 205
222 [-]: OP_LOADBOOL R2 1 0       ; R2 := true
223 [-]: JMP       205          ; PC := 205
...
246 [-]: GETTABLE  R18 R18 K48  ; R82 := R18[0xac1b386a]
...
291 [-]: JMP       240          ; PC := 240
292 [-]: OP_LOADBOOL R2 1 0       ; R2 := true
293 [-]: JMP       240          ; PC := 240
...
; Max Stack Size:  5
  ...
  9 [-]: GETTABLE  R1 R1 K4     ; R82 := R1[0xa5c556b9]
 10 [-]: MOVE      R2 R0        ; R2 := R0
...
292 [-]: OP_LOADBOOL R20 1 0      ; R20 := true
...
362 [-]: OP_LOADBOOL R26 0 0      ; R26 := false
363 [-]: OP_LOADBOOL R27 1 0      ; R27 := true
...
381 [-]: OP_LOADBOOL R32 1 0      ; R32 := true
382 [-]: OP_LOADBOOL R33 1 0      ; R33 := true
...
387 [-]: OP_LOADBOOL R33 0 0      ; R33 := false
388 [-]: CONST     R34 2        ; R34 := 2.000000
389 [-]: CONST     R35 1        ; R35 := 1.000000
390 [-]: OP_LOADBOOL R36 0 0      ; R36 := false
...
470 [-]: GETTABLE  R32 R32 K73  ; R82 := R32[0xb139d7bc]
...
500 [-]: OP_LOADBOOL R38 0 0      ; R38 := false
501 [-]: OP_LOADBOOL R39 1 0      ; R39 := true
...
; Max Stack Size:  13
 ...
 12 [-]: GETTABLE  R2 R2 K6     ; R82 := R2[0x7ab914d8]
 13 [-]: MOVE      R3 R1        ; R3 := R1
 ...
 21 [-]: GETTABLE  R3 R3 K9     ; R82 := R3[0xa5c556b9]
 ...
 39 [-]: GETTABLE  R3 R3 K14    ; R82 := R3[0x8fb85f73]
 ...
 67 [-]: GETTABLE  R3 R3 K21    ; R82 := R3[0x5e35d4d6]
 68 [-]: CALL      R3 1 2       ; R3 := R3()
 69 [-]: GETUPVAL  R4 U0        ; R4 := U0
 70 [-]: GETTABLE  R4 R4 K22    ; R82 := R4[0xf1c8da56]
 ...
 85 [-]: GETTABLE  R7 R7 K9     ; R82 := R7[0xa5c556b9]
 ...
 93 [-]: GETTABLE  R7 R7 K9     ; R82 := R7[0xa5c556b9]
...
; Max Stack Size:  13
 ...
 50 [-]: GETTABLE  R5 R5 K14    ; R82 := R5[0x23d5322f]
 51 [-]: MOVE      R6 R3        ; R6 := R3
 52 [-]: MOVE      R7 R4        ; R7 := R4
 ...
 89 [-]: JMP       91           ; PC := 91
 90 [-]: OP_LOADBOOL R6 0 1       ; R6 := false; PC := 91
...
101 [-]: GETTABLE  R7 R7 K28    ; R82 := R7[0xa5c556b9]
...
109 [-]: GETTABLE  R8 R8 K30    ; R82 := R8[0x0e50f018]
