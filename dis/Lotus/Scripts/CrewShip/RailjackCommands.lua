...
L 0:  21 [-]: JUMPIF R5 L1 
      ...
      26 [-]: CALL R5 3 0  
      27 [-]: RETURN R0 0  
L 1:  28 [-]: GETIMPORT R5 17 [0xD644C2F1]
...
; Max Stack Size:  4
       ...
       3 [-]: JUMPIFNOT R0 L2
       4 [-]: RETURN R0 0  
       5 [-]: GETIMPORT R0 5 ["RailjackStopHullBreach"]
       6 [-]: JUMPIFNOT R0 L0
       7 [-]: GETIMPORT R0 5 ["RailjackStopHullBreach"]
       8 [-]: CALL R0 0 0  
L 0:   9 [-]: GETIMPORT R0 7 ["BreachFailedOverride"]
      10 [-]: JUMPIFNOT R0 L1
      11 [-]: GETIMPORT R0 7 ["BreachFailedOverride"]
      12 [-]: CALL R0 0 0  
      13 [-]: RETURN R0 0  
L 1:  14 [-]: GETIMPORT R0 9 [0xBE190284]
      15 [-]: LOADK R2 K10 ["ReturnToDojo"]
      16 [-]: NAMECALL R0 R0 K11 [0x8A9CA6B8]
      17 [-]: CALL R0 2 0  
      18 [-]: GETIMPORT R0 9 [0xBE190284]
      19 [-]: LOADN R2 0   
      20 [-]: LOADN R3 0   
