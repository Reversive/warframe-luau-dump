...
L 8:  42 [-]: JUMPIFNOT R7 L9
      43 [-]: RETURN R0 0  
L 9:  44 [-]: GETIMPORT R7 11 [0xE231504D]
      45 [-]: JUMPIFNOT R7 L19
      46 [-]: GETIMPORT R7 13 [0x89326C93]
...
L14:  69 [-]: NAMECALL R9 R0 K15 [0x4DF189B1]
      70 [-]: CALL R9 1 1  
      71 [-]: MOVE R7 R9   
      72 [-]: GETIMPORT R9 18 [0x67652851]
      73 [-]: CALL R9 0 1  
      74 [-]: SUB R8 R8 R9 
      75 [-]: GETIMPORT R9 20 [0xCBD666E1]
      76 [-]: LOADN R10 0  
      77 [-]: CALL R9 1 0  
      78 [-]: JUMPBACK L11 
...
L29: 138 [-]: LOADB R8 0   
     ...
     141 [-]: CALL R10 1 1 
     142 [-]: GETIMPORT R11 26 [0x334451AF]
...
L30: 151 [-]: JUMPIF R10 L33
     ...
     155 [-]: MOVE R12 R10 
     156 [-]: GETIMPORT R11 1 [0x7B998233]
     157 [-]: CALL R11 1 1 
...
L35: 198 [-]: JUMPIF R11 L36
     199 [-]: GETIMPORT R11 39 [0xBA7DFCD2]
     200 [-]: MOVE R13 R10 
     201 [-]: GETIMPORT R14 41 [0x0469F296]
...
L36: 206 [-]: GETUPVAL R12 0
     ...
     229 [-]: GETIMPORT R10 49 ["TennoconHijackLinePlayed"]
     230 [-]: JUMPIF R10 L37
     231 [-]: GETIMPORT R10 3 [0xBE190284]
     232 [-]: GETIMPORT R12 51 [0x366813A6]
     233 [-]: NAMECALL R10 R10 K52 [0xC19D05D7]
     234 [-]: CALL R10 2 0 
     235 [-]: GETIMPORT R10 53 ["_T"]
     236 [-]: LOADB R11 1  
     237 [-]: SETTABLEKS R11 R10 K48 ["TennoconHijackLinePlayed"]
L37: 238 [-]: GETIMPORT R10 55 ["FriendlyCrewShipMarkers"]
     239 [-]: JUMPIFNOT R10 L38
     240 [-]: GETIMPORT R12 57 [0x4D558F01]
     241 [-]: NAMECALL R10 R5 K58 [0x0542D42B]
     242 [-]: CALL R10 2 1 
     243 [-]: JUMPIF R10 L38
     244 [-]: GETIMPORT R11 55 ["FriendlyCrewShipMarkers"]
     245 [-]: GETIMPORT R14 57 [0x4D558F01]
     246 [-]: GETIMPORT R15 60 ["EMPTY_SYMBOL"]
     247 [-]: NAMECALL R12 R5 K61 [0x47901F07]
     248 [-]: CALL R12 3 -1
     249 [-]: FASTCALL 52 L38
     250 [-]: GETIMPORT R10 64 [0x23D5322F]
     251 [-]: CALL R10 -1 0
L38: 252 [-]: RETURN R0 0  
...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R3 2 ["infestedCritter"]
...
L 0:   4 [-]: JUMPIF R2 L5 
       ...
       9 [-]: CALL R3 1 1  
L 1:  10 [-]: JUMPIF R3 L2 
      11 [-]: GETIMPORT R5 6 ["gLotusOperatorAvatarType"]
