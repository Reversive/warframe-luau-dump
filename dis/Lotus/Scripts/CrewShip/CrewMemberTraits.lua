...
L 4:  22 [-]: JUMPIF R7 L9 ; goto L9 if var7
      ...
      26 [-]: JUMPIFLT R8 R9 L5; goto L5 if var8 < var16779035
...
L 1:   6 [-]: NAMECALL R2 R0 K2; var3 = var0; var2 = var0[0xC8442850]
       ...
       9 [-]: JUMPIFLT R2 R3 L2; goto L2 if var2 < var16777499
...
L 6:  25 [-]: SETTABLEKS R4 R3 K7; var4["CrewMemberProtectiveShields"] = var3
      ...
      38 [-]: JUMPIFLE R8 R7 L7; goto L7 if var8 <= var16778267
...
L 1:  14 [-]: JUMPIF R6 L2 ; goto L2 if var6
      ...
      22 [-]: JUMPIFNOTEQ R6 R7 L2; goto L2 if var6 ~= var327958
...
L 4:  29 [-]: JUMPIF R2 L5 ; goto L5 if var2
      ...
      33 [-]: GETIMPORT R4 14; var4 = 0x64FB1586
      34 [-]: GETIMPORT R5 16; var5 = 0xE8876699
      35 [-]: CALL R4 2 0  ; var4, ... = var4(var5)
      36 [-]: CALL R2 0 0  ; var2, ... = var2(var3, ...)
      37 [-]: RETURN R2 -1 ; 
L 5:  38 [-]: LOADB R2 0   ; var2 = false
      39 [-]: RETURN R2 1  ; 
...
L 7:  46 [-]: JUMPIF R11 L12; goto L12 if var11
      ...
      51 [-]: JUMPIFNOTEQ R7 R12 L8; goto L8 if var7 ~= var16780059
...
; Max Stack Size:  11
       ...
       5 [-]: GETIMPORT R9 7; var9 = 0x64FB1586
       6 [-]: GETIMPORT R10 9; var10 = 0xE8876699
       7 [-]: CALL R9 2 2  ; var9 = var9(var10)
       8 [-]: GETTABLE R7 R8 R9; var7 = var8[var9]
       9 [-]: SETTABLEKS R7 R6 K1; var7["MANUFACTURER"] = var6
      10 [-]: GETIMPORT R7 12; var7 = cjson[0xB139D7BC]
...
L 2:  14 [-]: GETIMPORT R5 9; var5 = 0x3D106989
      ...
      20 [-]: GETIMPORT R7 16; var7 = 0x64FB1586
      21 [-]: GETIMPORT R8 18; var8 = 0xE8876699
      22 [-]: CALL R7 2 0  ; var7, ... = var7(var8)
      23 [-]: CALL R5 0 2  ; var5 = var5(var6, ...)
      24 [-]: JUMPIF R5 L3 ; goto L3 if var5
      25 [-]: MOVE R8 R4   ; var8 = var4
      26 [-]: NAMECALL R6 R1 K19; var7 = var1; var6 = var1[0x12DD9DA2]
...
; Max Stack Size:  11
       ...
       5 [-]: GETIMPORT R10 6; var10 = 0xE8876699
       6 [-]: CALL R9 2 2  ; var9 = var9(var10)
       7 [-]: GETTABLE R7 R8 R9; var7 = var8[var9]
       8 [-]: SETTABLEKS R7 R6 K1; var7["MANUFACTURER"] = var6
       9 [-]: GETIMPORT R7 9; var7 = cjson[0xB139D7BC]
...
L 7:  39 [-]: JUMPIFNOT R6 L12; goto L12 if not var6
      ...
      42 [-]: DIVK R9 R10 K12; var9 = var10 / 100
