...
; Max Stack Size:  8
       ...
       0 [-]: LOADN R0 0   
       1 [-]: LOADN R1 0   
       2 [-]: GETIMPORT R2 1 [0xCD4DDB6F]
       3 [-]: LOADN R3 2   
       4 [-]: JUMPIFNOTLT R3 R2 L0
       5 [-]: RETURN R0 0  
L 0:   6 [-]: GETIMPORT R2 4 [0x3630E649]
       7 [-]: LOADN R3 1   
       8 [-]: GETIMPORT R5 6 [0x6A2FD613]
       9 [-]: LENGTH R4 R5 
      10 [-]: CALL R2 2 1  
      11 [-]: MOVE R0 R2   
      12 [-]: LOADN R4 1   
      13 [-]: GETIMPORT R5 6 [0x6A2FD613]
      14 [-]: LENGTH R2 R5 
      15 [-]: LOADN R3 1   
      16 [-]: FORNPREP R2 L3
L 1:  17 [-]: JUMPIFEQ R4 R0 L2
      18 [-]: GETIMPORT R6 6 [0x6A2FD613]
      19 [-]: GETTABLE R5 R6 R4
      20 [-]: LOADK R7 K7 ["Lock"]
      21 [-]: NAMECALL R5 R5 K8 [0x8EB2112D]
      22 [-]: CALL R5 2 0  
L 2:  23 [-]: FORNLOOP R2 L1
L 3:  24 [-]: GETIMPORT R2 1 [0xCD4DDB6F]
      25 [-]: LOADN R3 1   
      26 [-]: JUMPIFNOTLT R3 R2 L6
L 4:  27 [-]: GETIMPORT R2 4 [0x3630E649]
      28 [-]: LOADN R3 1   
      29 [-]: GETIMPORT R5 6 [0x6A2FD613]
      30 [-]: LENGTH R4 R5 
      31 [-]: CALL R2 2 1  
      32 [-]: MOVE R1 R2   
      33 [-]: JUMPIFNOTEQ R0 R1 L5
      34 [-]: JUMPBACK L4  
L 5:  35 [-]: GETIMPORT R3 6 [0x6A2FD613]
...
; Max Stack Size:  13
       ...
       3 [-]: NEWTABLE R3 0 0
       4 [-]: LOADN R6 1   
       5 [-]: GETIMPORT R7 1 [0x6A2FD613]
       6 [-]: LENGTH R4 R7 
       7 [-]: LOADN R5 1   
       8 [-]: FORNPREP R4 L1
L 0:   9 [-]: GETIMPORT R8 1 [0x6A2FD613]
      ...
      14 [-]: FORNLOOP R4 L0
L 1:  15 [-]: LOADN R6 1   
      16 [-]: GETIMPORT R7 1 [0x6A2FD613]
      17 [-]: LENGTH R4 R7 
      18 [-]: LOADN R5 1   
      19 [-]: FORNPREP R4 L5
L 2:  20 [-]: LOADNIL R1   
      21 [-]: GETIMPORT R7 1 [0x6A2FD613]
      22 [-]: GETTABLE R0 R7 R6
      23 [-]: NAMECALL R7 R0 K4 [0xD1586535]
      24 [-]: CALL R7 1 1  
      25 [-]: MOVE R2 R7   
      26 [-]: GETIMPORT R7 6 [0x89326C93]
      27 [-]: GETIMPORT R9 8 [0xA3E063C8]
      28 [-]: MOVE R10 R2  
      29 [-]: LOADN R11 0  
      30 [-]: GETIMPORT R12 10 [0xE100A9F9]
      31 [-]: NAMECALL R7 R7 K11 [0xF16592C8]
      32 [-]: CALL R7 5 1  
      33 [-]: MOVE R1 R7   
      34 [-]: FASTCALL1 62 R1 L3
      35 [-]: MOVE R8 R1   
      36 [-]: GETIMPORT R7 13 [0x7B998233]
      37 [-]: CALL R7 1 1  
L 3:  38 [-]: JUMPIF R7 L4 
...
L 5:  48 [-]: GETIMPORT R4 19 [0x239A3949]
      49 [-]: JUMPIFNOT R4 L7
      50 [-]: LENGTH R4 R3 
      51 [-]: LOADN R5 0   
...
L 0:   5 [-]: LOADNIL R0   
       6 [-]: LOADN R3 1   
       7 [-]: GETIMPORT R4 1 [0x6A2FD613]
       8 [-]: LENGTH R1 R4 
       9 [-]: LOADN R2 1   
      10 [-]: FORNPREP R1 L3
L 1:  11 [-]: GETIMPORT R5 1 [0x6A2FD613]
...
L 3:  19 [-]: GETIMPORT R2 5 [0x9185B798]
      20 [-]: FASTCALL1 62 R2 L4
      21 [-]: GETIMPORT R1 7 [0x7B998233]
      22 [-]: CALL R1 1 1  
L 4:  23 [-]: JUMPIF R1 L5 
      24 [-]: GETIMPORT R1 5 [0x9185B798]
      25 [-]: GETIMPORT R3 9 ["gNpcDoorHintType"]
      26 [-]: NAMECALL R1 R1 K10 [0xF2DEAF69]
      27 [-]: CALL R1 2 1  
      28 [-]: JUMPIFNOT R1 L5
      29 [-]: GETIMPORT R1 5 [0x9185B798]
...
; Max Stack Size:  5
       ...
       3 [-]: CALL R1 1 1  
L 0:   4 [-]: JUMPIF R1 L1 
       5 [-]: GETIMPORT R3 3 ["gNpcDoorHintType"]
...
L 5:  28 [-]: GETIMPORT R2 7 [0x226008FF]
      29 [-]: LOADB R4 0   
...
L 1:   6 [-]: GETIMPORT R1 5 [0x89326C93]
      ...
      19 [-]: GETIMPORT R2 1 [0x612DDE9B]
      20 [-]: GETIMPORT R3 12 [0xC8802016]
      21 [-]: MOVE R4 R1   
      22 [-]: CALL R3 1 3  
      23 [-]: FORGPREP_INEXT R3 L3
L 2:  24 [-]: GETIMPORT R10 14 [0x76C673A3]
      25 [-]: MOVE R11 R2  
      26 [-]: NAMECALL R8 R7 K15 [0xCDDC3ABB]
      27 [-]: CALL R8 3 0  
L 3:  28 [-]: FORGLOOP R3 L2 2 [inext]
      29 [-]: RETURN R0 0  
L 4:  30 [-]: GETIMPORT R2 17 [0x3D106989]
