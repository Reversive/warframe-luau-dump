...
; Max Stack Size:  4
       ...
       1 [-]: SETUPVAL R1 0
       2 [-]: RETURN R0 0  
L 0:   3 [-]: GETIMPORT R2 1 [0x3D106989]
...
L 3:  16 [-]: JUMPIF R1 L4 
      ...
      18 [-]: JUMPIF R1 L5 
L 4:  19 [-]: GETIMPORT R1 9 [0x3D106989]
      20 [-]: LOADK R2 K10 ["No missionInfo or no void storm in this mission"]
      21 [-]: CALL R1 1 0  
      22 [-]: RETURN R0 0  
L 5:  23 [-]: GETIMPORT R1 12 [0x89326C93]
...
L 6:  33 [-]: JUMPIF R2 L7 
      ...
      37 [-]: JUMPIFNOT R2 L7
      38 [-]: RETURN R0 0  
L 7:  39 [-]: GETIMPORT R2 1 [0xBE190284]
      40 [-]: GETUPVAL R4 0
...
L 9:  51 [-]: JUMPIFNOT R2 L10
      52 [-]: GETIMPORT R2 5 [0xCBD666E1]
      53 [-]: LOADN R3 0   
      54 [-]: CALL R2 1 0  
      55 [-]: JUMPBACK L8  
L10:  56 [-]: GETIMPORT R2 12 [0x89326C93]
      57 [-]: GETIMPORT R4 21 [0x88EFC25E]
      58 [-]: GETUPVAL R5 2
      59 [-]: CALL R4 1 1  
      60 [-]: GETIMPORT R5 23 ["ZERO_VECTOR"]
      61 [-]: GETIMPORT R6 25 ["ZERO_ROTATION"]
...
; Max Stack Size:  23
      ...
      11 [-]: LOADNIL R3   
      12 [-]: LOADN R4 0   
      13 [-]: GETIMPORT R5 9 [0xBE190284]
      14 [-]: NAMECALL R5 R5 K10 [0xEF893AEC]
      15 [-]: CALL R5 1 1  
      16 [-]: FASTCALL1 62 R5 L0
      17 [-]: MOVE R7 R5   
      18 [-]: GETIMPORT R6 12 [0x7B998233]
      19 [-]: CALL R6 1 1  
L 0:  20 [-]: JUMPIF R6 L3 
      21 [-]: GETTABLEKS R3 R5 K13 ["goalTag"]
      22 [-]: GETIMPORT R6 15 [0xC8802016]
      23 [-]: GETIMPORT R7 17 [0x1BA1E362]
      24 [-]: CALL R6 1 3  
      25 [-]: FORGPREP_INEXT R6 L2
L 1:  26 [-]: JUMPIFNOTEQ R3 R10 L2
      27 [-]: MOVE R4 R9   
      28 [-]: GETIMPORT R11 19 [0x3D106989]
...
L 3:  34 [-]: NAMECALL R6 R2 K21 [0xF37943FF]
      ...
      38 [-]: CALL R6 1 1  
      39 [-]: JUMPIF R6 L5 
L 4:  40 [-]: GETIMPORT R6 24 [0xCBD666E1]
      41 [-]: LOADN R7 0   
      42 [-]: CALL R6 1 0  
      43 [-]: JUMPBACK L3  
L 5:  44 [-]: GETIMPORT R6 5 [0x89326C93]
      45 [-]: GETIMPORT R8 26 ["gEncounterHintType"]
...
L 6:  54 [-]: GETTABLE R12 R6 R11
      ...
      56 [-]: MOVE R14 R12 
      57 [-]: GETIMPORT R13 12 [0x7B998233]
      58 [-]: CALL R13 1 1 
L 7:  59 [-]: JUMPIF R13 L14
      60 [-]: LOADN R15 1  
      61 [-]: GETIMPORT R16 29 [0xFF150CEB]
      62 [-]: LENGTH R13 R16
      63 [-]: LOADN R14 1  
      64 [-]: FORNPREP R13 L14
L 8:  65 [-]: GETIMPORT R18 29 [0xFF150CEB]
      66 [-]: GETTABLE R17 R18 R15
      67 [-]: FASTCALL1 62 R17 L9
      68 [-]: GETIMPORT R16 12 [0x7B998233]
      69 [-]: CALL R16 1 1 
L 9:  70 [-]: JUMPIF R16 L13
      71 [-]: GETIMPORT R19 29 [0xFF150CEB]
...
L12:  98 [-]: FASTCALL2 52 R7 R12 L13
      99 [-]: MOVE R17 R7  
     100 [-]: MOVE R18 R12 
     101 [-]: GETIMPORT R16 37 [0x23D5322F]
     102 [-]: CALL R16 2 0 
...
L15: 105 [-]: LENGTH R9 R7 
     ...
     112 [-]: CALL R9 1 1  
     113 [-]: JUMPIF R9 L17
L16: 114 [-]: GETIMPORT R9 19 [0x3D106989]
...
L18: 122 [-]: NAMECALL R12 R2 K21 [0xF37943FF]
     ...
     126 [-]: CALL R12 1 1 
     127 [-]: JUMPIF R12 L20
L19: 128 [-]: GETIMPORT R12 19 [0x3D106989]
...
L20: 132 [-]: GETTABLE R12 R7 R11
     ...
     134 [-]: MOVE R14 R12 
     135 [-]: GETIMPORT R13 12 [0x7B998233]
     136 [-]: CALL R13 1 1 
L21: 137 [-]: JUMPIF R13 L23
     ...
     144 [-]: MOVE R15 R13 
     145 [-]: GETIMPORT R14 12 [0x7B998233]
     146 [-]: CALL R14 1 1 
L22: 147 [-]: JUMPIF R14 L23
     148 [-]: GETIMPORT R14 19 [0x3D106989]
     ...
     155 [-]: MOVE R15 R8  
     156 [-]: MOVE R16 R12 
     157 [-]: GETIMPORT R14 37 [0x23D5322F]
     158 [-]: CALL R14 2 0 
L23: 159 [-]: GETIMPORT R13 43 [0x9C1F3B5A]
     160 [-]: MOVE R14 R7  
     161 [-]: MOVE R15 R11 
     162 [-]: CALL R13 2 0 
     163 [-]: GETIMPORT R13 24 [0xCBD666E1]
     164 [-]: LOADN R14 0  
     165 [-]: CALL R13 1 0 
     166 [-]: FORNLOOP R9 L18
L24: 167 [-]: GETIMPORT R9 24 [0xCBD666E1]
     168 [-]: LOADN R10 0  
     169 [-]: CALL R9 1 0  
     170 [-]: JUMPBACK L15 
L25: 171 [-]: LENGTH R9 R8 
     ...
     178 [-]: CALL R9 1 1  
     179 [-]: JUMPIF R9 L27
L26: 180 [-]: GETIMPORT R9 19 [0x3D106989]
...
L28: 188 [-]: GETTABLE R12 R8 R11
     ...
     190 [-]: MOVE R14 R12 
     191 [-]: GETIMPORT R13 12 [0x7B998233]
     192 [-]: CALL R13 1 1 
L29: 193 [-]: JUMPIFNOT R13 L30
     194 [-]: GETIMPORT R13 19 [0x3D106989]
     195 [-]: LOADK R14 K44 ["Removing a null hint"]
     196 [-]: CALL R13 1 0 
     197 [-]: GETIMPORT R13 43 [0x9C1F3B5A]
     198 [-]: MOVE R14 R8  
     199 [-]: MOVE R15 R11 
     200 [-]: CALL R13 2 0 
     201 [-]: JUMP L31
...
L30: 202 [-]: NAMECALL R13 R12 K45 [0xEFE6CAD1]
     ...
     206 [-]: GETIMPORT R14 19 [0x3D106989]
     ...
     212 [-]: CALL R14 1 0 
     213 [-]: GETIMPORT R14 43 [0x9C1F3B5A]
     214 [-]: MOVE R15 R8  
     215 [-]: MOVE R16 R11 
     216 [-]: CALL R14 2 0 
L31: 217 [-]: FORNLOOP R9 L28
L32: 218 [-]: GETIMPORT R9 24 [0xCBD666E1]
     219 [-]: LOADN R10 0  
     220 [-]: CALL R9 1 0  
     221 [-]: JUMPBACK L25 
L33: 222 [-]: GETIMPORT R9 19 [0x3D106989]
