...
; Max Stack Size:  7
       ...
       3 [-]: JUMPIFNOTEQ R1 R2 L1; goto L1 if var1 ~= var196942
...
L 1:  20 [-]: GETIMPORT R1 1; var1 = 0x6A1D40E9
      ...
      22 [-]: JUMPIFEQ R1 R2 L2; goto L2 if var1 == var65870
      23 [-]: GETIMPORT R1 1; var1 = 0x6A1D40E9
      24 [-]: GETUPVAL R2 3; var2 = upvalues[3]
      25 [-]: JUMPIFEQ R1 R2 L2; goto L2 if var1 == var65870
      26 [-]: GETIMPORT R1 1; var1 = 0x6A1D40E9
      27 [-]: GETUPVAL R2 4; var2 = upvalues[4]
      28 [-]: JUMPIFNOTEQ R1 R2 L5; goto L5 if var1 ~= var196942
...
L 3:  25 [-]: GETIMPORT R1 14; var1 = 0x6A1D40E9
      ...
      27 [-]: JUMPIFNOTEQ R1 R2 L5; goto L5 if var1 ~= var65870
      ...
      38 [-]: CALL R2 2 2  ; var2 = var2(var3)
L 4:  39 [-]: JUMPIF R2 L14; goto L14 if var2
...
L 5:  44 [-]: GETIMPORT R1 14; var1 = 0x6A1D40E9
      ...
      46 [-]: JUMPIFEQ R1 R2 L6; goto L6 if var1 == var917838
      47 [-]: GETIMPORT R1 14; var1 = 0x6A1D40E9
      48 [-]: GETUPVAL R2 3; var2 = upvalues[3]
      49 [-]: JUMPIFEQ R1 R2 L6; goto L6 if var1 == var917838
      50 [-]: GETIMPORT R1 14; var1 = 0x6A1D40E9
      51 [-]: GETUPVAL R2 4; var2 = upvalues[4]
      52 [-]: JUMPIFNOTEQ R1 R2 L10; goto L10 if var1 ~= var65870
...
L 7:  64 [-]: JUMPIF R2 L14; goto L14 if var2
      65 [-]: GETIMPORT R2 14; var2 = 0x6A1D40E9
      66 [-]: GETUPVAL R3 2; var3 = upvalues[2]
      67 [-]: JUMPIFNOTEQ R2 R3 L8; goto L8 if var2 ~= var1246213
...
L 9:  87 [-]: JUMPIF R3 L14; goto L14 if var3
...
L11: 100 [-]: JUMPIF R1 L12; goto L12 if var1
     101 [-]: GETIMPORT R1 25; var1 = 0x3D106989
     102 [-]: LOADK R3 K26 ; var3 = "Could not find a valid malfunction target ("
     103 [-]: GETIMPORT R6 28; var6 = 0x64FB1586
     104 [-]: GETIMPORT R7 14; var7 = 0x6A1D40E9
     105 [-]: CALL R6 2 2  ; var6 = var6(var7)
     106 [-]: MOVE R4 R6   ; var4 = var6
     107 [-]: LOADK R5 K29 ; var5 = ")!"
     108 [-]: CONCAT R2 R3 R5; var2 = var3 .. var5
     109 [-]: CALL R1 2 1  ; var1(var2)
     110 [-]: JUMP L13     ; goto L13
L12: 111 [-]: GETIMPORT R1 25; var1 = 0x3D106989
     112 [-]: LOADK R2 K30 ; var2 = "Could not find a valid target with an invalid hint (nil)!"
     113 [-]: CALL R1 2 1  ; var1(var2)
L13: 114 [-]: NAMECALL R1 R0 K31; var2 = var0; var1 = var0[0xA2880940]
