...
; Max Stack Size:  7
       ...
       3 [-]: JUMPIF R1 L0 
       4 [-]: RETURN R0 0  
L 0:   5 [-]: GETIMPORT R2 5 ["RandomIceBreachRepairMod"]
...
; Max Stack Size:  7
       ...
       0 [-]: SETUPVAL R0 0
       1 [-]: GETIMPORT R1 1 [0x6A1D40E9]
       2 [-]: GETUPVAL R2 1
       3 [-]: JUMPIFNOTEQ R1 R2 L1
       4 [-]: GETIMPORT R1 3 [0x89326C93]
       5 [-]: GETIMPORT R3 1 [0x6A1D40E9]
       6 [-]: GETUPVAL R4 0
...
L 0:  15 [-]: JUMPIF R2 L5 
      ...
      18 [-]: CALL R2 2 0  
      19 [-]: RETURN R0 0  
L 1:  20 [-]: GETIMPORT R1 1 [0x6A1D40E9]
      21 [-]: GETUPVAL R2 2
      22 [-]: JUMPIFEQ R1 R2 L2
      23 [-]: GETIMPORT R1 1 [0x6A1D40E9]
      24 [-]: GETUPVAL R2 3
      25 [-]: JUMPIFEQ R1 R2 L2
      26 [-]: GETIMPORT R1 1 [0x6A1D40E9]
      27 [-]: GETUPVAL R2 4
      28 [-]: JUMPIFNOTEQ R1 R2 L5
L 2:  29 [-]: GETIMPORT R1 3 [0x89326C93]
      30 [-]: GETIMPORT R3 1 [0x6A1D40E9]
...
L 3:  39 [-]: JUMPIF R2 L5 
      ...
      42 [-]: CALL R2 2 0  
      43 [-]: GETIMPORT R2 3 [0x89326C93]
      44 [-]: GETIMPORT R4 12 [0x0469F296]
...
L 2:  14 [-]: SETUPVAL R0 0
      ...
      24 [-]: CALL R1 3 0  
L 3:  25 [-]: GETIMPORT R1 14 [0x6A1D40E9]
      26 [-]: GETUPVAL R2 1
      27 [-]: JUMPIFNOTEQ R1 R2 L5
      28 [-]: GETIMPORT R1 1 [0x89326C93]
      29 [-]: GETIMPORT R3 14 [0x6A1D40E9]
      30 [-]: GETUPVAL R4 0
...
L 4:  39 [-]: JUMPIF R2 L14
      ...
      42 [-]: CALL R2 2 0  
      43 [-]: RETURN R0 0  
L 5:  44 [-]: GETIMPORT R1 14 [0x6A1D40E9]
      45 [-]: GETUPVAL R2 2
      46 [-]: JUMPIFEQ R1 R2 L6
      47 [-]: GETIMPORT R1 14 [0x6A1D40E9]
      48 [-]: GETUPVAL R2 3
      49 [-]: JUMPIFEQ R1 R2 L6
      50 [-]: GETIMPORT R1 14 [0x6A1D40E9]
      51 [-]: GETUPVAL R2 4
      52 [-]: JUMPIFNOTEQ R1 R2 L10
L 6:  53 [-]: GETIMPORT R1 1 [0x89326C93]
      54 [-]: GETIMPORT R3 14 [0x6A1D40E9]
      55 [-]: GETUPVAL R4 0
...
L 9:  87 [-]: JUMPIF R3 L14
      ...
      94 [-]: CALL R3 -1 0 
      95 [-]: RETURN R0 0  
L10:  96 [-]: GETIMPORT R2 14 [0x6A1D40E9]
      97 [-]: FASTCALL1 62 R2 L11
      98 [-]: GETIMPORT R1 6 [0x7B998233]
      99 [-]: CALL R1 1 1  
L11: 100 [-]: JUMPIF R1 L12
     101 [-]: GETIMPORT R1 25 [0x3D106989]
     102 [-]: LOADK R3 K26 ["Could not find a valid malfunction target ("]
     103 [-]: GETIMPORT R6 28 [0x64FB1586]
     104 [-]: GETIMPORT R7 14 [0x6A1D40E9]
     105 [-]: CALL R6 1 1  
     106 [-]: MOVE R4 R6   
     107 [-]: LOADK R5 K29 [")!"]
     108 [-]: CONCAT R2 R3 R5
...
L12: 111 [-]: GETIMPORT R1 25 [0x3D106989]
