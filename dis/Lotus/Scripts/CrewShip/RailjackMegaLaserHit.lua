...
L 1:   7 [-]: NAMECALL R2 R0 K2 [0x73901ACF]
      ...
      19 [-]: CALL R4 1 1  
L 2:  20 [-]: JUMPIF R4 L4 
      21 [-]: GETIMPORT R5 8 [0xBA7DFCD2]
      22 [-]: FASTCALL1 62 R5 L3
      23 [-]: GETIMPORT R4 1 [0x7B998233]
      24 [-]: CALL R4 1 1  
L 3:  25 [-]: JUMPIF R4 L4 
      26 [-]: GETIMPORT R6 10 ["gTennoAvatarType"]
      27 [-]: NAMECALL R4 R3 K11 [0xF2DEAF69]
      28 [-]: CALL R4 2 1  
      29 [-]: JUMPIFNOT R4 L4
      30 [-]: GETIMPORT R4 8 [0xBA7DFCD2]
...
L 5:  50 [-]: JUMPIF R5 L10
      ...
      53 [-]: CALL R5 1 0  
      54 [-]: RETURN R0 0  
L 6:  55 [-]: GETIMPORT R3 19 [0x3F74C12A]
      56 [-]: LENGTH R2 R3 
      57 [-]: LOADN R3 0   
...
L 7:  70 [-]: NOT R3 R4    
      71 [-]: JUMPIFNOT R3 L8
      72 [-]: GETIMPORT R5 23 ["gAvatarType"]
      ...
      77 [-]: CALL R3 1 1  
      78 [-]: JUMPIFNOT R3 L8
      79 [-]: GETIMPORT R6 26 ["gCrewShipAvatarType"]
...
L 8:  83 [-]: LOADN R4 0   
      84 [-]: JUMPIFNOT R3 L9
      85 [-]: LOADN R4 1   
L 9:  86 [-]: GETIMPORT R8 19 [0x3F74C12A]
      87 [-]: GETIMPORT R9 28 [0x55730E1A]
      88 [-]: LOADN R10 1  
      89 [-]: GETIMPORT R12 19 [0x3F74C12A]
      90 [-]: LENGTH R11 R12
      91 [-]: CALL R9 2 1  
...
L 5:  27 [-]: JUMPIFNOT R3 L6
      28 [-]: RETURN R0 0  
L 6:  29 [-]: GETIMPORT R5 1 [0xB6720A5A]
...
L 9:  45 [-]: JUMPIF R5 L10
      ...
      47 [-]: CALL R5 1 1  
      48 [-]: GETIMPORT R6 13 [0x0C62ABF7]
      49 [-]: CALL R6 0 1  
      50 [-]: JUMPIFNOTLE R6 R5 L10
      51 [-]: NAMECALL R6 R1 K8 [0xDE321E6F]
      52 [-]: CALL R6 1 1  
      53 [-]: GETIMPORT R8 15 [0x79DB96E1]
      54 [-]: LOADN R9 1   
