...
; Max Stack Size:  43
 ...
 27 [-]: GETGLOBAL R5 K11       ; R5 := 0x0c27d048
 28 [-]: LOADKB    R6 0 0       ; R6 := false
 29 [-]: GETGLOBAL R7 K4        ; R7 := 0x89326c93
 30 [-]: SELF      R7 R7 K12    ; R8 := R7; R7 := R7[0xf16592c8]
 31 [-]: GETGLOBAL R9 K13       ; R9 := 0x0469f296
 32 [-]: LOADK     R10 K14      ; R10 := "LandscapeMechEncounter"
 33 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 34 [-]: SELF      R10 R0 K10   ; R11 := R0; R10 := R0[0xd1586535]
...
100 [-]: JMP       109          ; PC := 109
101 [-]: SELF      R14 R12 K26  ; R15 := R12; R14 := R12[0xbb610e5b]
102 [-]: CALL      R14 2 2      ; R14 := R14(R15)
103 [-]: SELF      R15 R14 K27  ; R16 := R14; R15 := R14[0x0cca925a]
104 [-]: GETGLOBAL R17 K28      ; R17 := 0x0094887c
105 [-]: CALL      R15 3 1      ; R15(R16,R17)
106 [-]: SELF      R15 R0 K29   ; R16 := R0; R15 := R0[0x2fb0041c]
107 [-]: MOVE      R17 R12      ; R17 := R12
108 [-]: CALL      R15 3 1      ; R15(R16,R17)
109 [-]: FORLOOP   R8 52        ; R8 += R10; if R8 <= R9 then begin PC := 52; R11 := R8 end
110 [-]: SELF      R15 R0 K30   ; R16 := R0; R15 := R0[0x5b18bb5d]
111 [-]: CONST     R17 1        ; R17 := 1.000000
112 [-]: CALL      R15 3 1      ; R15(R16,R17)
113 [-]: JMP       142          ; PC := 142
114 [-]: SELF      R15 R0 K31   ; R16 := R0; R15 := R0[0x22df603c]
...
204 [-]: GETTABLE  R30 R30 K43  ; R30 := R30[0xf0090084]
...
229 [-]: SELF      R35 R35 K26  ; R36 := R35; R35 := R35[0xbb610e5b]
230 [-]: CALL      R35 2 2      ; R35 := R35(R36)
231 [-]: GETGLOBAL R36 K0       ; R36 := 0x7b998233
...
237 [-]: JMP       255          ; PC := 255
238 [-]: SELF      R36 R35 K44  ; R37 := R35; R36 := R35[0xd6c7e6a5]
239 [-]: LOADKB    R38 0 0      ; R38 := false
240 [-]: CALL      R36 3 1      ; R36(R37,R38)
241 [-]: SELF      R36 R35 K45  ; R37 := R35; R36 := R35[0x449c4562]
242 [-]: CALL      R36 2 2      ; R36 := R36(R37)
243 [-]: TEST      R36 1        ; if R36 then PC := 249
244 [-]: JMP       249          ; PC := 249
245 [-]: SELF      R36 R35 K46  ; R37 := R35; R36 := R35[0x35844cf2]
246 [-]: CALL      R36 2 2      ; R36 := R36(R37)
247 [-]: TEST      R36 0        ; if not R36 then PC := 252
248 [-]: JMP       252          ; PC := 252
249 [-]: SELF      R36 R35 K47  ; R37 := R35; R36 := R35[0xfb3bba96]
250 [-]: CALL      R36 2 1      ; R36(R37)
251 [-]: JMP       269          ; PC := 269
252 [-]: SELF      R36 R35 K48  ; R37 := R35; R36 := R35[0xa2880940]
253 [-]: CALL      R36 2 1      ; R36(R37)
254 [-]: JMP       269          ; PC := 269
255 [-]: SELF      R36 R35 K49  ; R37 := R35; R36 := R35[0x7027c544]
256 [-]: GETGLOBAL R38 K50      ; R38 := 0xcb83a150
257 [-]: LOADKB    R39 1 0      ; R39 := true
258 [-]: CONST     R40 2        ; R40 := 2.000000
259 [-]: CONST     R41 1        ; R41 := 1.000000
260 [-]: LOADKB    R42 1 0      ; R42 := true
...
; Max Stack Size:  12
 ...
 51 [-]: GETTABLE  R8 R8 K9     ; R8 := R8[0xf22cfc77]
 ...
 60 [-]: GETTABLE  R8 R8 K13    ; R8 := R8[0x23d5322f]
