...
L 1:   6 [-]: GETUPVAL R1 0
       7 [-]: LOADNIL R2   
       8 [-]: SETUPVAL R2 0
       9 [-]: GETIMPORT R4 3 ["gDragonBossFlyingAvatarType"]
...
L 2:  18 [-]: JUMPIF R2 L4 
      ...
      20 [-]: CALL R2 1 1  
      21 [-]: GETIMPORT R4 3 ["gDragonBossFlyingAvatarType"]
      22 [-]: NAMECALL R2 R2 K4 [0xF2DEAF69]
      23 [-]: CALL R2 2 1  
      24 [-]: JUMPIFNOT R2 L4
L 3:  25 [-]: GETIMPORT R2 7 ["_T"]
      26 [-]: LOADNIL R3   
...
L 6:  37 [-]: NAMECALL R3 R1 K10 [0xDE321E6F]
      ...
      49 [-]: CALL R4 1 1  
      50 [-]: JUMPIFNOT R4 L7
      51 [-]: GETIMPORT R6 14 [0x2DF3B717]
      52 [-]: GETIMPORT R7 16 ["EMPTY_SYMBOL"]
      53 [-]: NAMECALL R4 R1 K17 [0x47901F07]
      54 [-]: CALL R4 3 1  
      55 [-]: MOVE R3 R4   
      56 [-]: JUMP L8
     
L 7:  57 [-]: GETIMPORT R6 19 [0x5D8DCADF]
      58 [-]: GETIMPORT R7 16 ["EMPTY_SYMBOL"]
      59 [-]: NAMECALL R4 R1 K17 [0x47901F07]
      60 [-]: CALL R4 3 1  
      61 [-]: MOVE R3 R4   
L 8:  62 [-]: GETIMPORT R6 20 ["ActiveTacticalMarker"]
      63 [-]: FASTCALL1 62 R6 L9
      64 [-]: GETIMPORT R5 1 [0x7B998233]
      65 [-]: CALL R5 1 1  
L 9:  66 [-]: NOT R4 R5    
      67 [-]: GETIMPORT R5 7 ["_T"]
      68 [-]: LOADNIL R6   
      69 [-]: SETTABLEKS R6 R5 K8 ["ActiveTacticalMarker"]
      70 [-]: JUMPIFNOT R4 L10
      71 [-]: GETIMPORT R5 22 [0xBE190284]
      72 [-]: NAMECALL R5 R5 K23 [0x603D0EBE]
      73 [-]: CALL R5 1 0  
L10:  74 [-]: GETIMPORT R5 25 [0x89326C93]
...
L13:  96 [-]: JUMPIF R9 L15
     ...
     100 [-]: MOVE R10 R1  
     101 [-]: GETIMPORT R9 1 [0x7B998233]
     102 [-]: CALL R9 1 1  
L14: 103 [-]: JUMPIF R9 L15
     104 [-]: MOVE R11 R3  
     105 [-]: GETIMPORT R12 16 ["EMPTY_SYMBOL"]
     106 [-]: GETIMPORT R13 31 [0xA421AF95]
     107 [-]: CALL R13 0 1 
     108 [-]: GETIMPORT R14 33 [0x00046924]
     109 [-]: CALL R14 0 -1
     110 [-]: NAMECALL R9 R1 K34 [0x3BB4F460]
     111 [-]: CALL R9 -1 0 
L15: 112 [-]: FASTCALL1 62 R8 L16
     113 [-]: MOVE R10 R8  
     114 [-]: GETIMPORT R9 1 [0x7B998233]
     115 [-]: CALL R9 1 1  
...
L24: 182 [-]: SUBK R11 R12 K42 [0.25]
     ...
     187 [-]: CALL R11 2 0 
L25: 188 [-]: GETIMPORT R9 48 [0xCBD666E1]
     189 [-]: LOADN R10 0  
     190 [-]: CALL R9 1 0  
     191 [-]: GETIMPORT R9 50 [0xB693B6C1]
     192 [-]: CALL R9 0 1  
     193 [-]: SUB R7 R7 R9 
     194 [-]: JUMPBACK L11 
...
L29: 208 [-]: JUMPIF R8 L38
     ...
     213 [-]: MOVE R9 R1   
     214 [-]: GETIMPORT R8 1 [0x7B998233]
     215 [-]: CALL R8 1 1  
L30: 216 [-]: JUMPIF R8 L38
     217 [-]: GETIMPORT R8 33 [0x00046924]
...
L31: 235 [-]: JUMPIF R12 L34
     ...
     243 [-]: MOVE R14 R12 
     244 [-]: GETIMPORT R13 1 [0x7B998233]
     245 [-]: CALL R13 1 1 
...
L33: 254 [-]: JUMPIF R14 L34
     ...
     256 [-]: CALL R14 1 1 
     257 [-]: MOVE R9 R14  
     258 [-]: GETIMPORT R14 33 [0x00046924]
...
L41: 306 [-]: JUMPIF R8 L44
     ...
     313 [-]: MOVE R10 R8  
     314 [-]: GETIMPORT R9 1 [0x7B998233]
     315 [-]: CALL R9 1 1  
L42: 316 [-]: JUMPIF R9 L43
     317 [-]: GETIMPORT R11 67 ["gEmplacementType"]
     ...
     323 [-]: CALL R9 2 0  
L43: 324 [-]: GETIMPORT R11 71 [0x2DFE722A]
     325 [-]: LOADB R12 0  
...
L46: 346 [-]: JUMPIF R8 L47
     ...
     349 [-]: CALL R8 2 0  
     350 [-]: GETIMPORT R8 48 [0xCBD666E1]
     351 [-]: LOADN R9 0   
     352 [-]: CALL R8 1 0  
     353 [-]: GETIMPORT R8 50 [0xB693B6C1]
     354 [-]: CALL R8 0 1  
     355 [-]: SUB R7 R7 R8 
     356 [-]: JUMPBACK L45 
L47: 357 [-]: FASTCALL1 62 R5 L48
     358 [-]: MOVE R9 R5   
     359 [-]: GETIMPORT R8 1 [0x7B998233]
     360 [-]: CALL R8 1 1  
L48: 361 [-]: JUMPIF R8 L49
     362 [-]: LOADN R10 0  
     363 [-]: NAMECALL R8 R5 K46 [0xB6DF3E50]
     364 [-]: CALL R8 2 0  
L49: 365 [-]: GETIMPORT R8 48 [0xCBD666E1]
     366 [-]: LOADK R9 K36 [1.5]
     367 [-]: CALL R8 1 0  
     368 [-]: FASTCALL1 62 R1 L50
     369 [-]: MOVE R9 R1   
     370 [-]: GETIMPORT R8 1 [0x7B998233]
     371 [-]: CALL R8 1 1  
...
L 0:   4 [-]: JUMPIF R2 L3 
       ...
       6 [-]: GETIMPORT R4 5 ["gLotusDuviriGameRulesType"]
...
L 5:  29 [-]: JUMPIF R3 L8 
      ...
      33 [-]: CALL R3 1 1  
L 6:  34 [-]: JUMPIF R3 L8 
      35 [-]: GETIMPORT R5 9 ["gLotusAvatarType"]
      36 [-]: NAMECALL R3 R0 K6 [0xF2DEAF69]
      37 [-]: CALL R3 2 1  
      38 [-]: JUMPIFNOT R3 L8
      39 [-]: GETIMPORT R5 9 ["gLotusAvatarType"]
      40 [-]: NAMECALL R3 R2 K6 [0xF2DEAF69]
      41 [-]: CALL R3 2 1  
      42 [-]: JUMPIFNOT R3 L8
      43 [-]: GETIMPORT R6 11 ["gLotusVehicleAvatarType"]
      44 [-]: NAMECALL R4 R2 K6 [0xF2DEAF69]
      45 [-]: CALL R4 2 1  
      46 [-]: NOT R3 R4    
      47 [-]: JUMPIF R3 L7 
      48 [-]: GETIMPORT R5 11 ["gLotusVehicleAvatarType"]
...
; Max Stack Size:  7
       ...
       3 [-]: CALL R3 1 1  
L 0:   4 [-]: JUMPIF R3 L1 
L 1:   5 [-]: GETIMPORT R3 4 ["DuviriTransitionToLobby"]
       6 [-]: JUMPIFNOT R3 L2
       7 [-]: GETIMPORT R3 5 ["_T"]
       8 [-]: LOADNIL R4   
...
L 3:  11 [-]: JUMPIFNOT R2 L4
      ...
      23 [-]: MOVE R1 R2   
      24 [-]: JUMPBACK L2  
L 4:  25 [-]: GETIMPORT R2 15 ["gQuestMission"]
      26 [-]: JUMPIF R2 L5 
