...
; Max Stack Size:  35
 ...
 23 [-]: LOADK     R8 K9        ; R8 := "CometShredder"
 24 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 25 [-]: LOADNIL   R8 R16       ; R8 := R9 := R10 := R11 := R12 := R13 := R14 := R15 := R16 := nil
 26 [-]: LOADK     R17 0        ; R17 := 0.000000
 27 [-]: LOADK     R18 1        ; R18 := 1.000000
 28 [-]: LOADK     R19 2        ; R19 := 2.000000
 29 [-]: LOADK     R20 3        ; R20 := 3.000000
 30 [-]: LOADK     R21 4        ; R21 := 4.000000
 31 [-]: LOADK     R22 10       ; R22 := 10.000000
 32 [-]: LOADNIL   R23 R25      ; R23 := R24 := R25 := nil
 33 [-]: NEWTABLE  R26 0 0      ; R26 := {}
 34 [-]: LOADNIL   R27 R29      ; R27 := R28 := R29 := nil
 35 [-]: CLOSURE   R30 0        ; R30 := closure(Function #1)
 36 [-]: MOVE      R0 R28       ; R0 := R28
 37 [-]: MOVE      R0 R15       ; R0 := R15
 38 [-]: MOVE      R0 R22       ; R0 := R22
 39 [-]: CLOSURE   R31 1        ; R31 := closure(Function #2)
 40 [-]: MOVE      R0 R5        ; R0 := R5
 41 [-]: MOVE      R0 R24       ; R0 := R24
 42 [-]: MOVE      R0 R3        ; R0 := R3
 43 [-]: MOVE      R0 R13       ; R0 := R13
 44 [-]: SETGLOBAL R31 K10      ; ConsoleLocated := R31
 45 [-]: CLOSURE   R31 2        ; R31 := closure(Function #3)
 46 [-]: MOVE      R0 R15       ; R0 := R15
 47 [-]: MOVE      R0 R21       ; R0 := R21
 48 [-]: SETGLOBAL R31 K11      ; ScanComplete := R31
 49 [-]: CLOSURE   R31 3        ; R31 := closure(Function #4)
 ...
 64 [-]: SETGLOBAL R32 K12      ; ShipReady := R32
 65 [-]: CLOSURE   R32 5        ; R32 := closure(Function #6)
 ...
 80 [-]: CLOSURE   R33 6        ; R33 := closure(Function #7)
 81 [-]: MOVE      R0 R9        ; R0 := R9
 82 [-]: MOVE      R0 R8        ; R0 := R8
...
105 [-]: CLOSURE   R34 7        ; R34 := closure(Function #8)
...
116 [-]: SETGLOBAL R34 K13      ; Start := R34
...
; Max Stack Size:  10
  ...
  2 [-]: GETTABLE  R0 R0 K0     ; R0 := R0[0x6696a66c]
 ...
 10 [-]: GETTABLE  R6 R6 K2     ; R6 := R6[0xf22cfc77]
 11 [-]: GETUPVAL  R7 U3        ; R7 := U3
 12 [-]: GETGLOBAL R8 K3        ; R8 := 0x0469f296
 13 [-]: LOADK     R9 K4        ; R9 := "ConsoleLocated"
...
; Max Stack Size:  9
  ...
  2 [-]: LOADK     R1 K1        ; R1 := "COMETSHREDDER: CrewShipInitialize, state="
...
; Max Stack Size:  5
 ...
 11 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x2df8b2ba]
 12 [-]: GETGLOBAL R2 K2        ; R2 := 0x0469f296
 13 [-]: LOADK     R3 K3        ; R3 := "Objective"
 14 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 15 [-]: GETUPVAL  R3 U4        ; R3 := U4
 16 [-]: CALL      R1 3 2       ; R1 := R1(R2,R3)
 17 [-]: MOVE      R0 R1        ; R0 := R1
 18 [-]: GETUPVAL  R1 U5        ; R1 := U5
 19 [-]: SELF      R1 R1 K4     ; R2 := R1; R1 := R1[0xe2871589]
 20 [-]: MOVE      R3 R0        ; R3 := R0
 ...
 40 [-]: EQ        0 R1 R2      ; if R1 ~= R2 then PC := 43
 41 [-]: JMP       43           ; PC := 43
 42 [-]: JMP       71           ; PC := 71
 43 [-]: GETUPVAL  R1 U0        ; R1 := U0
 44 [-]: GETUPVAL  R2 U8        ; R2 := U8
 45 [-]: EQ        0 R1 R2      ; if R1 ~= R2 then PC := 48
 46 [-]: JMP       48           ; PC := 48
 47 [-]: JMP       71           ; PC := 71
 48 [-]: GETUPVAL  R1 U0        ; R1 := U0
 49 [-]: GETUPVAL  R2 U9        ; R2 := U9
 50 [-]: EQ        0 R1 R2      ; if R1 ~= R2 then PC := 71
 51 [-]: JMP       71           ; PC := 71
 52 [-]: GETUPVAL  R1 U10       ; R1 := U10
 53 [-]: SELF      R1 R1 K7     ; R2 := R1; R1 := R1[0x7076b095]
 54 [-]: CALL      R1 2 1       ; R1(R2)
 55 [-]: GETUPVAL  R1 U3        ; R1 := U3
 56 [-]: GETTABLE  R1 R1 K5     ; R1 := R1[0x33d25c2b]
 57 [-]: LOADBOOL  R2 0 0       ; R2 := false
 58 [-]: GETUPVAL  R3 U4        ; R3 := U4
 59 [-]: CALL      R1 3 1       ; R1(R2,R3)
 60 [-]: GETUPVAL  R1 U11       ; R1 := U11
 61 [-]: SELF      R1 R1 K8     ; R2 := R1; R1 := R1[0xfe9dc265]
 62 [-]: LOADK     R3 3         ; R3 := 3.000000
 63 [-]: CALL      R1 3 1       ; R1(R2,R3)
 64 [-]: GETUPVAL  R1 U12       ; R1 := U12
 65 [-]: GETTABLE  R1 R1 K10    ; R1 := R1[0x9742b85b]
 66 [-]: GETUPVAL  R2 U13       ; R2 := U13
 67 [-]: GETGLOBAL R3 K2        ; R3 := 0x0469f296
 68 [-]: LOADK     R4 K11       ; R4 := "ObjectiveComplete"
...
; Max Stack Size:  9
 ...
 17 [-]: LOADK     R2 K6        ; R2 := "COMETSHREDDER: Initialize (1)"
 ...
 45 [-]: GETTABLE  R1 R1 K14    ; R1 := R1[0xd2c39e3e]
 46 [-]: GETGLOBAL R2 K15       ; R2 := 0x0469f296
 47 [-]: LOADK     R3 K16       ; R3 := "EnterPoiAction"
 48 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 49 [-]: GETUPVAL  R3 U2        ; R3 := U2
 50 [-]: SELF      R3 R3 K17    ; R4 := R3; R3 := R3[0x65c63fbe]
 51 [-]: CALL      R3 2 0       ; R3,... := R3(R4)
 52 [-]: CALL      R1 0 2       ; R1 := R1(R2,...)
 53 [-]: SETUPVAL  R1 U11       ; U82 := R11
 54 [-]: GETUPVAL  R1 U2        ; R1 := U2
 55 [-]: SELF      R1 R1 K18    ; R2 := R1; R1 := R1[0xabe61691]
 56 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 57 [-]: SETUPVAL  R1 U13       ; U82 := R13
 58 [-]: GETGLOBAL R1 K5        ; R1 := 0x3d106989
 59 [-]: LOADK     R2 K19       ; R2 := "COMETSHREDDER: Current state="
 60 [-]: GETGLOBAL R3 K20       ; R3 := 0x64fb1586
 61 [-]: GETUPVAL  R4 U13       ; R4 := U13
 62 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 63 [-]: CONCAT    R2 R2 R3     ; R2 := R2 .. R3
 64 [-]: CALL      R1 2 1       ; R1(R2)
 65 [-]: GETUPVAL  R1 U13       ; R1 := U13
 66 [-]: GETUPVAL  R2 U14       ; R2 := U14
 67 [-]: LT        0 R2 R1      ; if R2 >= R1 then PC := 92
 68 [-]: JMP       92           ; PC := 92
 69 [-]: GETUPVAL  R1 U12       ; R1 := U12
 70 [-]: GETTABLE  R1 R1 K21    ; R1 := R1[0x2656fd9e]
 71 [-]: GETUPVAL  R2 U2        ; R2 := U2
 72 [-]: CALL      R1 2 3       ; R1,R2 := R1(R2)
 73 [-]: SETUPVAL  R2 U16       ; U82 := R16
 74 [-]: SETUPVAL  R1 U15       ; U82 := R15
 75 [-]: GETGLOBAL R1 K22       ; R1 := 0x7b998233
 76 [-]: GETUPVAL  R2 U15       ; R2 := U15
 77 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 78 [-]: TEST      R1 1         ; if R1 then PC := 107
 79 [-]: JMP       107          ; PC := 107
 80 [-]: GETUPVAL  R1 U15       ; R1 := U15
 81 [-]: SELF      R1 R1 K23    ; R2 := R1; R1 := R1[0xfa9e477f]
 82 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 83 [-]: GETGLOBAL R2 K22       ; R2 := 0x7b998233
 84 [-]: MOVE      R3 R1        ; R3 := R1
 85 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 86 [-]: TEST      R2 1         ; if R2 then PC := 107
 87 [-]: JMP       107          ; PC := 107
 88 [-]: SELF      R2 R1 K24    ; R3 := R1; R2 := R1[0x0bfb401f]
 89 [-]: GETUPVAL  R4 U2        ; R4 := U2
 90 [-]: CALL      R2 3 1       ; R2(R3,R4)
 91 [-]: JMP       107          ; PC := 107
 92 [-]: GETGLOBAL R2 K5        ; R2 := 0x3d106989
 93 [-]: LOADK     R3 K25       ; R3 := "COMETSHREDDER: Creating a crew ship"
 94 [-]: CALL      R2 2 1       ; R2(R3)
 95 [-]: GETGLOBAL R2 K7        ; R2 := 0xbe190284
 96 [-]: SELF      R2 R2 K26    ; R3 := R2; R2 := R2[0xd7d79b74]
 97 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 98 [-]: SETUPVAL  R2 U17       ; U82 := R17
 99 [-]: GETUPVAL  R2 U17       ; R2 := U17
100 [-]: SELF      R2 R2 K27    ; R3 := R2; R2 := R2[0xe091ca15]
101 [-]: GETGLOBAL R4 K28       ; R4 := 0x93cd7be9
102 [-]: LOADNIL   R5 R5        ; R5 := nil
103 [-]: LOADBOOL  R6 0 0       ; R6 := false
104 [-]: LOADBOOL  R7 1 0       ; R7 := true
105 [-]: LOADK     R8 K29       ; R8 := "ShipReady"
106 [-]: CALL      R2 7 1       ; R2(R3,R4,R5,R6,R7,R8)
107 [-]: GETGLOBAL R2 K22       ; R2 := 0x7b998233
108 [-]: GETUPVAL  R3 U16       ; R3 := U16
109 [-]: CALL      R2 2 2       ; R2 := R2(R3)
110 [-]: TEST      R2 0         ; if not R2 then PC := 116
111 [-]: JMP       116          ; PC := 116
112 [-]: GETGLOBAL R2 K4        ; R2 := 0xcbd666e1
113 [-]: LOADK     R3 0         ; R3 := 0.000000
114 [-]: CALL      R2 2 1       ; R2(R3)
115 [-]: JMP       107          ; PC := 107
116 [-]: GETGLOBAL R2 K5        ; R2 := 0x3d106989
117 [-]: LOADK     R3 K30       ; R3 := "COMETSHREDDER: Crwship ready"
118 [-]: CALL      R2 2 1       ; R2(R3)
119 [-]: GETUPVAL  R2 U18       ; R2 := U18
120 [-]: CALL      R2 1 1       ; R2()
121 [-]: GETUPVAL  R2 U20       ; R2 := U20
122 [-]: SELF      R2 R2 K31    ; R3 := R2; R2 := R2[0x6d604ba7]
123 [-]: CALL      R2 2 2       ; R2 := R2(R3)
124 [-]: GETUPVAL  R3 U2        ; R3 := U2
125 [-]: SELF      R3 R3 K32    ; R4 := R3; R3 := R3[0xed4e0128]
126 [-]: CALL      R3 2 2       ; R3 := R3(R4)
127 [-]: CONCAT    R2 R2 R3     ; R2 := R2 .. R3
128 [-]: SETUPVAL  R2 U19       ; U82 := R19
129 [-]: NEWTABLE  R2 0 1       ; R2 := {}
130 [-]: NEWTABLE  R3 1 0       ; R3 := {}
131 [-]: GETUPVAL  R4 U16       ; R4 := U16
132 [-]: SELF      R4 R4 K34    ; R5 := R4; R4 := R4[0x26e191c7]
133 [-]: CALL      R4 2 2       ; R4 := R4(R5)
134 [-]: ADD       R4 R4 K35    ; R4 := R4 + 1.000000
135 [-]: SETLIST   R3 1 1       ; R3[(1-1)*FPF+i] := R(3+i), 1 <= i <= 1
136 [-]: SETTABLE  R2 K33 R3    ; R2["disallowed"] := R3
137 [-]: SETUPVAL  R2 U21       ; U82 := R21
138 [-]: GETUPVAL  R2 U6        ; R2 := U6
139 [-]: SELF      R2 R2 K36    ; R3 := R2; R2 := R2[0x8abff40e]
140 [-]: GETUPVAL  R4 U22       ; R4 := U22
141 [-]: GETTABLE  R4 R4 K37    ; R4 := R4[0x06d055f9]
142 [-]: GETUPVAL  R5 U13       ; R5 := U13
143 [-]: EQ        1 R5 K38     ; if R5 == 0.000000 then PC := 146
144 [-]: JMP       146          ; PC := 146
145 [-]: LOADBOOL  R5 0 1       ; R5 := false; PC := 146
146 [-]: LOADBOOL  R5 1 0       ; R5 := true
147 [-]: GETUPVAL  R6 U23       ; R6 := U23
148 [-]: GETUPVAL  R7 U13       ; R7 := U13
149 [-]: CALL      R4 4 0       ; R4,... := R4(R5,R6,R7)
150 [-]: CALL      R2 0 1       ; R2(R3,...)
151 [-]: SELF      R2 R0 K39    ; R3 := R0; R2 := R0[0xfe9dc265]
152 [-]: LOADK     R4 2         ; R4 := 2.000000
...
; Max Stack Size:  5
  ...
  2 [-]: LOADK     R2 K1        ; R2 := "COMETSHREDDER: Start"
  3 [-]: CALL      R1 2 1       ; R1(R2)
  4 [-]: GETUPVAL  R1 U0        ; R1 := U0
  5 [-]: MOVE      R2 R0        ; R2 := R0
  6 [-]: CALL      R1 2 1       ; R1(R2)
  7 [-]: GETGLOBAL R1 K0        ; R1 := 0x3d106989
  8 [-]: LOADK     R2 K2        ; R2 := "COMETSHREDDER: Initialize done"
  9 [-]: CALL      R1 2 1       ; R1(R2)
 ...
 31 [-]: LOADK     R3 K10       ; R3 := "COMETSHREDDER: Completed"
 32 [-]: CALL      R2 2 1       ; R2(R3)
 33 [-]: JMP       94           ; PC := 94
 ...
 95 [-]: SELF      R2 R2 K20    ; R3 := R2; R2 := R2[0x588ed000]
