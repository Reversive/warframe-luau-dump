...
; Max Stack Size:  37
 ...
 21 [-]: CONST     R10 99       ; R10 := 99.000000
 22 [-]: GETGLOBAL R11 K6       ; R11 := INVALID
 23 [-]: LOADNIL   R12 R12      ; R12 := nil
 24 [-]: LOADK     R13 K7       ; R13 := 0.100000
 25 [-]: LOADNIL   R14 R24      ; R14 := R15 := R16 := R17 := R18 := R19 := R20 := R21 := R22 := R23 := R24 := nil
 26 [-]: LOADK     R25 K8       ; R25 := "[HC] RETRIEVE COORDINATES FROM PILOT: "
 27 [-]: LOADK     R26 K9       ; R26 := "[HC] PICK UP COORDINATES: "
 28 [-]: GETGLOBAL R27 K10      ; R27 := 0x0469f296
 29 [-]: LOADK     R28 K11      ; R28 := "CrewShipPilot"
 30 [-]: CALL      R27 2 2      ; R27 := R27(R28)
 31 [-]: CLOSURE   R28 0        ; R28 := closure(Function #1)
 32 [-]: MOVE      R0 R3        ; R0 := R3
 33 [-]: SETGLOBAL R28 K12      ; NPCAlertStart := R28
 34 [-]: CLOSURE   R28 1        ; R28 := closure(Function #2)
 35 [-]: MOVE      R0 R3        ; R0 := R3
 36 [-]: SETGLOBAL R28 K13      ; NPCAlertEnd := R28
 37 [-]: CLOSURE   R28 2        ; R28 := closure(Function #3)
 38 [-]: MOVE      R0 R21       ; R0 := R21
 39 [-]: CLOSURE   R29 3        ; R29 := closure(Function #4)
 40 [-]: MOVE      R0 R18       ; R0 := R18
 41 [-]: MOVE      R0 R28       ; R0 := R28
 42 [-]: MOVE      R0 R20       ; R0 := R20
 43 [-]: MOVE      R0 R2        ; R0 := R2
 44 [-]: MOVE      R0 R19       ; R0 := R19
 45 [-]: CLOSURE   R30 4        ; R30 := closure(Function #5)
 46 [-]: MOVE      R0 R11       ; R0 := R11
 47 [-]: MOVE      R0 R10       ; R0 := R10
 48 [-]: CLOSURE   R31 5        ; R31 := closure(Function #6)
 49 [-]: MOVE      R0 R22       ; R0 := R22
 50 [-]: MOVE      R0 R17       ; R0 := R17
 51 [-]: CLOSURE   R32 6        ; R32 := closure(Function #7)
 52 [-]: MOVE      R0 R2        ; R0 := R2
 ...
 59 [-]: CLOSURE   R33 7        ; R33 := closure(Function #8)
 ...
 82 [-]: MOVE      R0 R6        ; R0 := R6
 83 [-]: CLOSURE   R35 9        ; R35 := closure(Function #10)
...
107 [-]: SETGLOBAL R36 K15      ; CrewShipNavDataEncounter := R36
...
; Max Stack Size:  11
 ...
 17 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x2f6f2966]
 18 [-]: GETGLOBAL R2 K2        ; R2 := 0xc5ad911b
 19 [-]: GETUPVAL  R3 U4        ; R3 := U4
 20 [-]: CALL      R1 3 2       ; R1 := R1(R2,R3)
 21 [-]: LEN       R2 R1        ; R2 := # R1
 22 [-]: LT        0 K3 R2      ; if 0.000000 >= R2 then PC := 36
 23 [-]: JMP       36           ; PC := 36
 ...
 29 [-]: SELF      R7 R6 K4     ; R8 := R6; R7 := R6[0x589ef1c1]
 30 [-]: SELF      R9 R0 K5     ; R10 := R0; R9 := R0[0xd1586535]
 31 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 32 [-]: GETGLOBAL R10 K6       ; R10 := ZERO_ROTATION
...
; Max Stack Size:  4
  ...
  6 [-]: SELF      R1 R1 K2     ; R2 := R1; R1 := R1[0x2faead12]
...
; Max Stack Size:  26
  ...
  9 [-]: JMP       74           ; PC := 74
 10 [-]: SELF      R2 R0 K3     ; R3 := R0; R2 := R0[0x1b68b9f9]
 ...
 18 [-]: JMP       22           ; PC := 22
 19 [-]: LEN       R2 R1        ; R2 := # R1
 20 [-]: EQ        0 R2 K4      ; if R2 ~= 0.000000 then PC := 64
 21 [-]: JMP       64           ; PC := 64
 22 [-]: GETGLOBAL R2 K5        ; R2 := 0x89326c93
 23 [-]: SELF      R2 R2 K6     ; R3 := R2; R2 := R2[0x29ef273d]
 24 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 25 [-]: SELF      R2 R2 K7     ; R3 := R2; R2 := R2[0x66905cb0]
 26 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 27 [-]: SELF      R2 R2 K8     ; R3 := R2; R2 := R2[0x4f5a2d3b]
 28 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 29 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0[0x1b68b9f9]
 30 [-]: LOADKB    R5 1 0       ; R5 := true
 31 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 32 [-]: GETTABLE  R4 R3 K9     ; R4 := R3[1.000000]
 33 [-]: SELF      R4 R4 K10    ; R5 := R4; R4 := R4[0x5163741e]
 34 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 35 [-]: GETUPVAL  R5 U0        ; R5 := U0
 36 [-]: GETTABLE  R5 R5 K11    ; R5 := R5[0x40dfe79a]
 37 [-]: MOVE      R6 R2        ; R6 := R2
 38 [-]: MOVE      R7 R4        ; R7 := R4
 39 [-]: GETGLOBAL R8 K12       ; R8 := 0xb7cbd06b
 40 [-]: CONST     R9 1500      ; R9 := 1500.000000
 41 [-]: CONST     R10 6000     ; R10 := 6000.000000
 42 [-]: CALL      R8 3 2       ; R8 := R8(R9,R10)
 43 [-]: CONST     R9 30        ; R9 := 30.000000
 44 [-]: CALL      R5 5 2       ; R5 := R5(R6,R7,R8,R9)
 45 [-]: MOVE      R2 R5        ; R2 := R5
 46 [-]: SELF      R5 R2 K13    ; R6 := R2; R5 := R2[0xf04f37dd]
 47 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 48 [-]: LEN       R6 R5        ; R6 := # R5
 49 [-]: LT        0 K4 R6      ; if 0.000000 >= R6 then PC := 70
 50 [-]: JMP       70           ; PC := 70
 51 [-]: GETGLOBAL R6 K14       ; R6 := 0x55730e1a
 52 [-]: CONST     R7 1         ; R7 := 1.000000
 53 [-]: LEN       R8 R5        ; R8 := # R5
 54 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 55 [-]: GETTABLE  R7 R5 R6     ; R7 := R5[R6]
 56 [-]: SELF      R8 R0 K15    ; R9 := R0; R8 := R0[0xe091ca15]
 57 [-]: GETGLOBAL R10 K16      ; R10 := 0x93cd7be9
 ...
 99 [-]: JMP       111          ; PC := 111
100 [-]: SETUPVAL  R8 U4        ; U82 := R4
101 [-]: GETUPVAL  R9 U4        ; R9 := U4
102 [-]: SELF      R9 R9 K22    ; R10 := R9; R9 := R9[0x47901f07]
103 [-]: GETGLOBAL R11 K23      ; R11 := 0xb3ea4254
104 [-]: GETGLOBAL R12 K24      ; R12 := EMPTY_SYMBOL
105 [-]: CALL      R9 4 1       ; R9(R10,R11,R12)
106 [-]: GETUPVAL  R9 U0        ; R9 := U0
107 [-]: GETTABLE  R9 R9 K25    ; R9 := R9[0x33d25c2b]
108 [-]: LOADKB    R10 1 0      ; R10 := true
109 [-]: GETUPVAL  R11 U1       ; R11 := U1
110 [-]: CALL      R9 3 1       ; R9(R10,R11)
111 [-]: GETUPVAL  R9 U0        ; R9 := U0
112 [-]: GETTABLE  R9 R9 K26    ; R9 := R9[0x2f6f2966]
113 [-]: GETGLOBAL R10 K27      ; R10 := gNpcSpawnPointType
114 [-]: GETUPVAL  R11 U1       ; R11 := U1
115 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
116 [-]: GETGLOBAL R10 K14      ; R10 := 0x55730e1a
...
130 [-]: JMP       212          ; PC := 212
131 [-]: GETGLOBAL R12 K0       ; R12 := 0xbe190284
132 [-]: SELF      R12 R12 K28  ; R13 := R12; R12 := R12[0xef893aec]
133 [-]: CALL      R12 2 2      ; R12 := R12(R13)
134 [-]: GETGLOBAL R13 K14      ; R13 := 0x55730e1a
135 [-]: GETTABLE  R14 R12 K29  ; R14 := R12["minEnemyLevel"]
136 [-]: GETTABLE  R15 R12 K30  ; R15 := R12["maxEnemyLevel"]
137 [-]: CALL      R13 3 2      ; R13 := R13(R14,R15)
138 [-]: GETUPVAL  R14 U5       ; R14 := U5
139 [-]: SELF      R14 R14 K31  ; R15 := R14; R14 := R14[0xfeeea290]
140 [-]: GETGLOBAL R16 K32      ; R16 := 0x5aa2084e
141 [-]: MOVE      R17 R13      ; R17 := R13
142 [-]: LOADKB    R18 1 0      ; R18 := true
143 [-]: LOADKB    R19 0 0      ; R19 := false
144 [-]: GETGLOBAL R20 K33      ; R20 := 0x55d44493
145 [-]: LOADKB    R21 1 0      ; R21 := true
...
151 [-]: JMP       158          ; PC := 158
152 [-]: GETGLOBAL R15 K34      ; R15 := 0xd644c2f1
153 [-]: LOADK     R16 K35      ; R16 := "Enemy target type is Nil -- AI Spec Issue? Tier: "
154 [-]: GETGLOBAL R17 K33      ; R17 := 0x55d44493
155 [-]: CONCAT    R16 R16 R17  ; R16 := R16 .. R17
156 [-]: CALL      R15 2 1      ; R15(R16)
157 [-]: GETGLOBAL R14 K36      ; R14 := 0x058def74
158 [-]: GETUPVAL  R15 U5       ; R15 := U5
159 [-]: SELF      R15 R15 K37  ; R16 := R15; R15 := R15[0x33fc842f]
160 [-]: MOVE      R17 R14      ; R17 := R14
161 [-]: MOVE      R18 R11      ; R18 := R11
162 [-]: GETGLOBAL R19 K38      ; R19 := 0x529c5b23
163 [-]: MOVE      R20 R13      ; R20 := R13
164 [-]: CALL      R15 6 2      ; R15 := R15(R16,R17,R18,R19,R20)
165 [-]: SELF      R16 R15 K39  ; R17 := R15; R16 := R15[0xbb610e5b]
166 [-]: CALL      R16 2 2      ; R16 := R16(R17)
167 [-]: GETGLOBAL R17 K2       ; R17 := 0x7b998233
168 [-]: MOVE      R18 R16      ; R18 := R16
169 [-]: CALL      R17 2 2      ; R17 := R17(R18)
170 [-]: TEST      R17 0        ; if not R17 then PC := 179
171 [-]: JMP       179          ; PC := 179
172 [-]: SELF      R17 R15 K39  ; R18 := R15; R17 := R15[0xbb610e5b]
173 [-]: CALL      R17 2 2      ; R17 := R17(R18)
174 [-]: MOVE      R16 R17      ; R16 := R17
175 [-]: GETGLOBAL R17 K18      ; R17 := 0xcbd666e1
176 [-]: CONST     R18 0        ; R18 := 0.000000
177 [-]: CALL      R17 2 1      ; R17(R18)
178 [-]: JMP       167          ; PC := 167
179 [-]: GETGLOBAL R17 K19      ; R17 := 0x11a19c5e
180 [-]: MOVE      R18 R16      ; R18 := R16
181 [-]: LOADK     R19 K20      ; R19 := "OnKilled"
182 [-]: CALL      R17 3 1      ; R17(R18,R19)
183 [-]: GETUPVAL  R17 U6       ; R17 := U6
184 [-]: SELF      R17 R17 K40  ; R18 := R17; R17 := R17[0x2fb0041c]
185 [-]: MOVE      R19 R15      ; R19 := R15
186 [-]: CALL      R17 3 1      ; R17(R18,R19)
187 [-]: SELF      R17 R16 K41  ; R18 := R16; R17 := R16[0xc1595bd5]
188 [-]: GETGLOBAL R19 K23      ; R19 := 0xb3ea4254
...
; Max Stack Size:  5
  ...
  8 [-]: GETTABLE  R0 R0 K1     ; R0 := R0[0x8ee923fe]
 ...
 15 [-]: GETTABLE  R0 R0 K4     ; R0 := R0[0x3f8a850c]
 16 [-]: GETUPVAL  R1 U3        ; R1 := U3
 17 [-]: GETTABLE  R1 R1 K5     ; R1 := R1[0x603636ad]
 ...
 36 [-]: GETTABLE  R0 R0 K4     ; R0 := R0[0x3f8a850c]
 37 [-]: GETUPVAL  R1 U3        ; R1 := U3
 38 [-]: GETTABLE  R1 R1 K5     ; R1 := R1[0x603636ad]
...
; Max Stack Size:  6
 ...
 24 [-]: JMP       16           ; PC := 16
 25 [-]: SELF      R1 R0 K7     ; R2 := R0; R1 := R0[0x86d3529e]
 ...
 32 [-]: JMP       35           ; PC := 35
 33 [-]: CONST     R1 0         ; R1 := 0.000000
 34 [-]: RETURN    R1 2         ; return R1
 35 [-]: GETUPVAL  R1 U4        ; R1 := U4
 36 [-]: SELF      R1 R1 K9     ; R2 := R1; R1 := R1[0xefe6cad1]
 37 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 38 [-]: NOT       R1 R1        ; R1 :=  R1
 39 [-]: EQ        0 R1 K11     ; if R1 ~= 2.000000 then PC := 45
 40 [-]: JMP       45           ; PC := 45
 41 [-]: GETGLOBAL R1 K6        ; R1 := 0xcbd666e1
 42 [-]: CONST     R2 0         ; R2 := 0.000000
 43 [-]: CALL      R1 2 1       ; R1(R2)
 44 [-]: JMP       35           ; PC := 35
 45 [-]: GETGLOBAL R1 K8        ; R1 := 0x7b998233
 46 [-]: GETGLOBAL R2 K12       ; R2 := 0xbe190284
 47 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 48 [-]: TEST      R1 1         ; if R1 then PC := 72
 49 [-]: JMP       72           ; PC := 72
 50 [-]: GETGLOBAL R1 K12       ; R1 := 0xbe190284
 51 [-]: SELF      R1 R1 K13    ; R2 := R1; R1 := R1[0xef893aec]
 52 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 53 [-]: GETTABLE  R2 R1 K14    ; R2 := R1["enemySpec"]
 54 [-]: SETUPVAL  R2 U5        ; U82 := R5
 55 [-]: GETGLOBAL R2 K8        ; R2 := 0x7b998233
 56 [-]: GETUPVAL  R3 U5        ; R3 := U5
 57 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 58 [-]: TEST      R2 0         ; if not R2 then PC := 72
 59 [-]: JMP       72           ; PC := 72
 60 [-]: GETGLOBAL R2 K15       ; R2 := 0x3a3e5b5d
 61 [-]: SETUPVAL  R2 U5        ; U82 := R5
 62 [-]: GETGLOBAL R2 K15       ; R2 := 0x3a3e5b5d
 63 [-]: SETTABLE  R1 K14 R2    ; R1["enemySpec"] := R2
 64 [-]: GETGLOBAL R2 K12       ; R2 := 0xbe190284
 65 [-]: SELF      R2 R2 K16    ; R3 := R2; R2 := R2[0x0670b198]
 66 [-]: MOVE      R4 R1        ; R4 := R1
 67 [-]: CALL      R2 3 1       ; R2(R3,R4)
 68 [-]: GETUPVAL  R2 U3        ; R2 := U3
 69 [-]: SELF      R2 R2 K17    ; R3 := R2; R2 := R2[0x17db0a42]
 70 [-]: GETUPVAL  R4 U5        ; R4 := U5
 71 [-]: CALL      R2 3 1       ; R2(R3,R4)
 72 [-]: GETGLOBAL R2 K2        ; R2 := 0x89326c93
 73 [-]: SELF      R2 R2 K18    ; R3 := R2; R2 := R2[0x7c1a0374]
 74 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 75 [-]: GETGLOBAL R3 K19       ; R3 := 0x11a19c5e
 76 [-]: MOVE      R4 R2        ; R4 := R2
 77 [-]: LOADK     R5 K20       ; R5 := "NPCAlertStart"
 78 [-]: CALL      R3 3 1       ; R3(R4,R5)
 79 [-]: GETGLOBAL R3 K19       ; R3 := 0x11a19c5e
 80 [-]: MOVE      R4 R2        ; R4 := R2
 81 [-]: LOADK     R5 K21       ; R5 := "NPCAlertEnd"
...
; Max Stack Size:  3
 ...
 24 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x2047cfe7]
 ...
 41 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x2047cfe7]
...
; Max Stack Size:  19
  ...
  1 [-]: SELF      R1 R0 K0     ; R2 := R0; R1 := R0[0x86d3529e]
  2 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 ...
 11 [-]: SELF      R2 R2 K3     ; R3 := R2; R2 := R2[0x8b5b1f58]
 12 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 13 [-]: GETGLOBAL R3 K4        ; R3 := 0xbe190284
 14 [-]: SELF      R3 R3 K5     ; R4 := R3; R3 := R3[0xd7d79b74]
 15 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 16 [-]: SELF      R4 R3 K6     ; R5 := R3; R4 := R3[0x1b68b9f9]
 ...
 25 [-]: GETGLOBAL R11 K1       ; R11 := 0x7b998233
