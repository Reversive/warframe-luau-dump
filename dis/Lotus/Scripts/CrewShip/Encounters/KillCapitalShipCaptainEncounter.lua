...
; Max Stack Size:  44
     ...
     161 [-]: CAPTURE VAL R42; 
     162 [-]: CAPTURE VAL R34; 
     163 [-]: SETGLOBAL R43 K44; "KillCapitalShipCaptain" = var43
     164 [-]: NEWCLOSURE R43 P27; 
     165 [-]: CAPTURE REF R7; 
     166 [-]: CAPTURE VAL R26; 
     167 [-]: SETGLOBAL R43 K45; "OnTouched" = var43
     168 [-]: DUPCLOSURE R43 K46; 
     169 [-]: CAPTURE VAL R29; 
     170 [-]: SETGLOBAL R43 K47; "GalleonDeathAnimate" = var43
     171 [-]: DUPCLOSURE R43 K48; 
     172 [-]: CAPTURE VAL R0; 
     173 [-]: SETGLOBAL R43 K49; "VoidWarningTransmission" = var43
     174 [-]: CLOSEUPVALS R6; 
     175 [-]: RETURN R0 0  ; 
...
L 1:   6 [-]: GETUPVAL R1 0; var1 = upvalues[0]
       ...
       9 [-]: JUMPIFEQ R1 R0 L2; goto L2 if var1 == var1375732037
      10 [-]: NAMECALL R1 R0 K3; var2 = var0; var1 = var0[0x22DA1852]
      11 [-]: CALL R1 2 2  ; var1 = var1(var2)
      12 [-]: GETUPVAL R2 1; var2 = upvalues[1]
      13 [-]: JUMPIFNOTEQ R1 R2 L3; goto L3 if var1 ~= var328014
...
L 5:  45 [-]: LOADN R4 2   ; var4 = 2
      46 [-]: JUMPIFNOTLT R3 R4 L6; goto L6 if var3 >= var198166
...
L 2:  20 [-]: JUMPIF R7 L3 ; goto L3 if var7
      ...
      24 [-]: JUMPIFNOTEQ R7 R8 L3; goto L3 if var7 ~= var83964941
...
L15: 182 [-]: GETUPVAL R0 0; var0 = upvalues[0]
     ...
     211 [-]: JUMPIFNOTLT R1 R4 L16; goto L16 if var1 >= var1966407
...
L 0:  15 [-]: GETIMPORT R2 1; var2 = 0xBE190284
      ...
      21 [-]: JUMPIFEQ R2 R3 L1; goto L1 if var2 == var328202
...
L 4:  49 [-]: JUMPIF R4 L25; goto L25 if var4
      ...
      52 [-]: JUMPIFNOTLT R5 R4 L25; goto L25 if var5 >= var525575
      53 [-]: GETUPVAL R5 8; var5 = upvalues[8]
      54 [-]: SUB R4 R5 R0 ; var4 = var5 - var0
      55 [-]: LOADN R5 0   ; var5 = 0
      56 [-]: JUMPIFNOTLE R4 R5 L5; goto L5 if var4 > var1095
...
L 7:  72 [-]: JUMPIF R3 L25; goto L25 if var3
      ...
      94 [-]: JUMPIFNOTLE R5 R4 L8; goto L8 if var5 > var722183
...
L11: 116 [-]: JUMPIF R4 L12; goto L12 if var4
     ...
     119 [-]: JUMPIFNOTLT R5 R4 L12; goto L12 if var5 >= var787463
...
L16: 153 [-]: JUMPIF R6 L25; goto L25 if var6
     ...
     158 [-]: JUMPIFNOTLT R6 R7 L25; goto L25 if var6 >= var67355
...
L21: 187 [-]: GETUPVAL R3 1; var3 = upvalues[1]
     ...
     201 [-]: JUMPIFNOTLT R6 R5 L22; goto L22 if var6 >= var198437
     ...
     206 [-]: JUMPIFNOTLE R5 R6 L22; goto L22 if var5 > var1246727
...
L 3:  10 [-]: NAMECALL R2 R0 K3; var3 = var0; var2 = var0[0xB40C191A]
      ...
      14 [-]: DIVK R4 R2 K5; var4 = var2 / 2
      15 [-]: JUMPIFNOTLE R3 R4 L4; goto L4 if var3 > var459854
