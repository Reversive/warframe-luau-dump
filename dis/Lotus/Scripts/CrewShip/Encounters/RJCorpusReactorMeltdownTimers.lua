...
; Max Stack Size:  15
  ...
  5 [-]: GETTABLE  R1 R1 K3     ; R82 := R1[0x00000000]
  6 [-]: CALL      R1 1 1       ; R1()
  7 [-]: GETGLOBAL R1 K4        ; R1 := 0x00000000
  8 [-]: SELF      R1 R1 K5     ; R2 := R1; R1 := R1[0x00000000]
  9 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 10 [-]: TEST      R1 0         ; if not R1 then PC := 16
 11 [-]: JMP       16           ; PC := 16
 12 [-]: GETGLOBAL R1 K6        ; R1 := 0x00000000
 13 [-]: SELF      R1 R1 K7     ; R2 := R1; R1 := R1[0xffffffff]
 14 [-]: MOVE      R3 R0        ; R3 := R0
 15 [-]: CALL      R1 3 1       ; R1(R2,R3)
 16 [-]: GETGLOBAL R1 K4        ; R1 := 0x00000000
 17 [-]: SELF      R1 R1 K8     ; R2 := R1; R1 := R1[0xfffe06a5]
 18 [-]: GETGLOBAL R3 K9        ; R3 := 0x00000000
 19 [-]: LOADK     R4 K10       ; R4 := "CrpRJReactorMeltdownAlarm"
 20 [-]: CALL      R3 2 0       ; R3,... := R3(R4)
 21 [-]: CALL      R1 0 2       ; R1 := R1(R2,...)
 22 [-]: GETGLOBAL R2 K11       ; R2 := 0xfffbff00
 23 [-]: MOVE      R3 R1        ; R3 := R1
 24 [-]: CALL      R2 2 4       ; R2,R3,R4 := R2(R3)
 25 [-]: JMP       33           ; PC := 33
 26 [-]: GETGLOBAL R7 K12       ; R7 := 0x80000000
 27 [-]: MOVE      R8 R6        ; R8 := R6
 28 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 29 [-]: TEST      R7 1         ; if R7 then PC := 33
 30 [-]: JMP       33           ; PC := 33
 31 [-]: SELF      R7 R6 K13    ; R8 := R6; R7 := R6[0x80000000]
 32 [-]: CALL      R7 2 1       ; R7(R8)
 33 [-]: TFORLOOP  R2 2         ; R5,R6 :=  R2(R3,R4); if R5 ~= nil then begin PC = 26; R4 := R5 end
 34 [-]: JMP       26           ; PC := 26
 35 [-]: GETGLOBAL R7 K4        ; R7 := 0x00000000
 36 [-]: SELF      R7 R7 K8     ; R8 := R7; R7 := R7[0xfffe06a5]
 37 [-]: GETGLOBAL R9 K9        ; R9 := 0x00000000
 38 [-]: LOADK     R10 K14      ; R10 := "CrpRJReactorShutdownAlarm"
 39 [-]: CALL      R9 2 0       ; R9,... := R9(R10)
 40 [-]: CALL      R7 0 2       ; R7 := R7(R8,...)
 41 [-]: GETGLOBAL R8 K11       ; R8 := 0xfffbff00
 42 [-]: MOVE      R9 R7        ; R9 := R7
 43 [-]: CALL      R8 2 4       ; R8,R9,R10 := R8(R9)
 44 [-]: JMP       52           ; PC := 52
 45 [-]: GETGLOBAL R13 K12      ; R13 := 0x80000000
 46 [-]: MOVE      R14 R12      ; R14 := R12
 47 [-]: CALL      R13 2 2      ; R13 := R13(R14)
 48 [-]: TEST      R13 1        ; if R13 then PC := 52
 49 [-]: JMP       52           ; PC := 52
 50 [-]: SELF      R13 R12 K13  ; R14 := R12; R13 := R12[0x80000000]
...
; Max Stack Size:  16
  ...
  2 [-]: SELF      R5 R5 K1     ; R6 := R5; R5 := R5[0x00000000]
  3 [-]: MOVE      R7 R0        ; R7 := R0
  4 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
  5 [-]: TEST      R5 1         ; if R5 then PC := 50
  6 [-]: JMP       50           ; PC := 50
  7 [-]: GETGLOBAL R5 K0        ; R5 := 0x00000000
  8 [-]: SELF      R5 R5 K2     ; R6 := R5; R5 := R5[0x80000000]
  9 [-]: MOVE      R7 R0        ; R7 := R0
 ...
 17 [-]: SELF      R5 R5 K4     ; R6 := R5; R5 := R5[0x80000000]
 18 [-]: MOVE      R7 R0        ; R7 := R0
 19 [-]: LOADBOOL  R8 1 0       ; R8 := true
 20 [-]: CALL      R5 4 1       ; R5(R6,R7,R8)
 21 [-]: TEST      R4 0         ; if not R4 then PC := 37
 22 [-]: JMP       37           ; PC := 37
 23 [-]: GETGLOBAL R5 K5        ; R5 := 0x00000000
 24 [-]: SELF      R5 R5 K6     ; R6 := R5; R5 := R5[0x00005075]
 25 [-]: GETGLOBAL R7 K7        ; R7 := 0x00000000
 26 [-]: LOADK     R8 K8        ; R8 := "CrpRJReactorMeltdownAlarm"
 27 [-]: CALL      R7 2 0       ; R7,... := R7(R8)
 28 [-]: CALL      R5 0 2       ; R5 := R5(R6,...)
 29 [-]: GETGLOBAL R6 K9        ; R6 := 0x80000000
 30 [-]: MOVE      R7 R5        ; R7 := R5
 31 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 32 [-]: TEST      R6 1         ; if R6 then PC := 50
 33 [-]: JMP       50           ; PC := 50
 34 [-]: SELF      R6 R5 K10    ; R7 := R5; R6 := R5[0x00000000]
 35 [-]: CALL      R6 2 1       ; R6(R7)
 36 [-]: JMP       50           ; PC := 50
 37 [-]: GETGLOBAL R6 K5        ; R6 := 0x00000000
 38 [-]: SELF      R6 R6 K6     ; R7 := R6; R6 := R6[0x00005075]
 39 [-]: GETGLOBAL R8 K7        ; R8 := 0x00000000
 40 [-]: LOADK     R9 K11       ; R9 := "CrpRJReactorShutdownAlarm"
 41 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
 42 [-]: CALL      R6 0 2       ; R6 := R6(R7,...)
 43 [-]: GETGLOBAL R7 K9        ; R7 := 0x80000000
 44 [-]: MOVE      R8 R6        ; R8 := R6
 45 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 46 [-]: TEST      R7 1         ; if R7 then PC := 50
 47 [-]: JMP       50           ; PC := 50
 48 [-]: SELF      R7 R6 K10    ; R8 := R6; R7 := R6[0x00000000]
 49 [-]: CALL      R7 2 1       ; R7(R8)
 50 [-]: GETGLOBAL R7 K0        ; R7 := 0x00000000
 51 [-]: SELF      R7 R7 K12    ; R8 := R7; R7 := R7[0x80000000]
 52 [-]: MOVE      R9 R0        ; R9 := R0
 53 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
 54 [-]: LE        0 R7 K13     ; if R7 > 0.000000 then PC := 69
 55 [-]: JMP       69           ; PC := 69
 56 [-]: GETGLOBAL R8 K5        ; R8 := 0x00000000
 57 [-]: SELF      R8 R8 K14    ; R9 := R8; R8 := R8[0x00000000]
 58 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 59 [-]: TEST      R8 0         ; if not R8 then PC := 69
 60 [-]: JMP       69           ; PC := 69
 61 [-]: GETGLOBAL R8 K15       ; R8 := 0xfe53323e
 62 [-]: LOADK     R9 2         ; R9 := 2.000000
 63 [-]: CALL      R8 2 1       ; R8(R9)
 64 [-]: GETGLOBAL R8 K0        ; R8 := 0x00000000
 65 [-]: SELF      R8 R8 K16    ; R9 := R8; R8 := R8[0x80000000]
 66 [-]: LOADK     R10 0        ; R10 := 0.000000
 67 [-]: CALL      R8 3 1       ; R8(R9,R10)
 68 [-]: JMP       96           ; PC := 96
 69 [-]: TEST      R3 0         ; if not R3 then PC := 96
 70 [-]: JMP       96           ; PC := 96
 71 [-]: GETGLOBAL R8 K9        ; R8 := 0x80000000
 ...
 78 [-]: GETTABLE  R8 R8 K20    ; R82 := R8[0x80000000]
 79 [-]: GETGLOBAL R9 K21       ; R9 := 0x80000000
 80 [-]: MOVE      R10 R1       ; R10 := R1
 81 [-]: NEWTABLE  R11 0 0      ; R11 := {}
 82 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
 83 [-]: LOADK     R10 K22      ; R10 := " "
 84 [-]: GETGLOBAL R11 K23      ; R11 := 0x80000000
 85 [-]: GETTABLE  R11 R11 K24  ; R82 := R11[0x80000000]
...
; Max Stack Size:  8
  ...
  5 [-]: JMP       9            ; PC := 9
  6 [-]: SELF      R1 R0 K1     ; R2 := R0; R1 := R0[0x00000000]
  7 [-]: GETUPVAL  R3 U0        ; R3 := U0
  8 [-]: CALL      R1 3 1       ; R1(R2,R3)
  9 [-]: GETUPVAL  R1 U0        ; R1 := U0
 10 [-]: SELF      R2 R0 K2     ; R3 := R0; R2 := R0[0x80000000]
 11 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 12 [-]: GETUPVAL  R3 U1        ; R3 := U1
 13 [-]: EQ        1 R2 R3      ; if R2 == R3 then PC := 74
 14 [-]: JMP       74           ; PC := 74
 15 [-]: GETGLOBAL R2 K3        ; R2 := 0x00000000
 16 [-]: SELF      R2 R2 K4     ; R3 := R2; R2 := R2[0x00000000]
 17 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 18 [-]: TEST      R2 1         ; if R2 then PC := 74
 19 [-]: JMP       74           ; PC := 74
 20 [-]: GETGLOBAL R2 K3        ; R2 := 0x00000000
 21 [-]: SELF      R2 R2 K5     ; R3 := R2; R2 := R2[0x80000000]
 22 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 23 [-]: TEST      R2 0         ; if not R2 then PC := 26
 24 [-]: JMP       26           ; PC := 26
 25 [-]: JMP       74           ; PC := 74
 26 [-]: SELF      R2 R0 K2     ; R3 := R0; R2 := R0[0x80000000]
 ...
 37 [-]: JMP       63           ; PC := 63
 38 [-]: SELF      R2 R0 K2     ; R3 := R0; R2 := R0[0x80000000]
