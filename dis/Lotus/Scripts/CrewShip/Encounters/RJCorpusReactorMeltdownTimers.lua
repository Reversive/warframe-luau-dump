...
; Max Stack Size:  10
       ...
       2 [-]: CALL R1 1 0  
       3 [-]: GETIMPORT R1 5 ["HideImpactMessage"]
       4 [-]: CALL R1 0 0  
...
L 3:  30 [-]: FORGLOOP R2 L1 2 [inext]
      ...
      36 [-]: CALL R2 -1 1 
      37 [-]: GETIMPORT R3 17 [0xC8802016]
      38 [-]: MOVE R4 R2   
      39 [-]: CALL R3 1 3  
      40 [-]: FORGPREP_INEXT R3 L6
L 4:  41 [-]: FASTCALL1 62 R7 L5
      42 [-]: MOVE R9 R7   
      43 [-]: GETIMPORT R8 19 [0x7B998233]
      44 [-]: CALL R8 1 1  
L 5:  45 [-]: JUMPIF R8 L6 
...
; Max Stack Size:  14
      ...
      18 [-]: CALL R5 3 0  
      19 [-]: JUMPIFNOT R4 L1
      20 [-]: GETIMPORT R5 8 [0x89326C93]
      21 [-]: GETIMPORT R7 10 [0x0469F296]
...
L 1:  34 [-]: GETIMPORT R5 8 [0x89326C93]
      35 [-]: GETIMPORT R7 10 [0x0469F296]
...
L 2:  44 [-]: JUMPIF R6 L3 
      ...
      46 [-]: CALL R6 1 0  
L 3:  47 [-]: GETIMPORT R5 1 [0xBE190284]
      48 [-]: MOVE R7 R0   
      49 [-]: NAMECALL R5 R5 K17 [0xFFDDF768]
      50 [-]: CALL R5 2 1  
      51 [-]: LOADN R6 0   
      52 [-]: JUMPIFNOTLE R5 R6 L4
      53 [-]: GETIMPORT R6 8 [0x89326C93]
      54 [-]: NAMECALL R6 R6 K18 [0x18D05D30]
      55 [-]: CALL R6 1 1  
      56 [-]: JUMPIFNOT R6 L4
      57 [-]: GETIMPORT R6 20 [0xCBD666E1]
      58 [-]: LOADN R7 2   
      59 [-]: CALL R6 1 0  
      60 [-]: GETIMPORT R6 1 [0xBE190284]
      61 [-]: LOADN R8 0   
      62 [-]: NAMECALL R6 R6 K21 [0xF9BFC5D9]
      63 [-]: CALL R6 2 0  
      64 [-]: RETURN R0 0  
L 4:  65 [-]: JUMPIFNOT R3 L7
      66 [-]: GETIMPORT R7 24 ["ShowImpactMessage"]
      67 [-]: FASTCALL1 62 R7 L5
      68 [-]: GETIMPORT R6 14 [0x7B998233]
      69 [-]: CALL R6 1 1  
L 5:  70 [-]: JUMPIF R6 L7 
      71 [-]: GETIMPORT R6 24 ["ShowImpactMessage"]
      72 [-]: GETIMPORT R11 26 [0x603636AD]
      73 [-]: MOVE R12 R1  
      74 [-]: NEWTABLE R13 0 0
      75 [-]: CALL R11 2 1 
      76 [-]: MOVE R8 R11  
      ...
      79 [-]: MOVE R11 R5  
      80 [-]: GETIMPORT R10 30 [0x55F27C30]
      81 [-]: CALL R10 1 1 
...
L 5:  49 [-]: NAMECALL R2 R0 K3 [0x53C3399F]
      ...
      53 [-]: CALL R2 1 1  
      54 [-]: MOVE R1 R2   
L 6:  55 [-]: GETIMPORT R2 19 [0xCBD666E1]
      56 [-]: LOADN R3 0   
      57 [-]: CALL R2 1 0  
      58 [-]: JUMPBACK L2  
L 7:  59 [-]: RETURN R0 0  
