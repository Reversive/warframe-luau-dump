...
; Max Stack Size:  64
 ...
 29 [-]: LOADK     R10 K11      ; R10 := "/EE/Types/Actions/ReplicatedHitSwitch"
 30 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 31 [-]: GETGLOBAL R10 K9       ; R10 := 0x7ed0a956
 32 [-]: LOADK     R11 K12      ; R11 := "/Lotus/Types/Game/MarkerInfos/CrewShipObjectiveMarkerInfoNoReticleAlwaysInRange"
 33 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 34 [-]: LOADK     R11 K13      ; R11 := "/Lotus/Language/RailjackMissions/POIExposeFirstRadiator"
 35 [-]: LOADK     R12 K14      ; R12 := "/Lotus/Language/RailjackMissions/POIDestroyFirstRadiator"
 36 [-]: LOADK     R13 K15      ; R13 := "/Lotus/Language/RailjackMissions/POIExposeSecondRadiator"
 37 [-]: LOADK     R14 K16      ; R14 := "/Lotus/Language/RailjackMissions/POIDestroySecondRadiator"
 38 [-]: LOADK     R15 K17      ; R15 := "/Lotus/Language/RailjackMissions/MissilePlatformReachCore"
 39 [-]: LOADK     R16 K18      ; R16 := "/Lotus/Language/RailjackMissions/POIDestroyCore"
 40 [-]: GETGLOBAL R17 K19      ; R17 := 0x0469f296
 41 [-]: LOADK     R18 K20      ; R18 := "Hide"
 42 [-]: CALL      R17 2 2      ; R17 := R17(R18)
 43 [-]: GETGLOBAL R18 K19      ; R18 := 0x0469f296
 44 [-]: LOADK     R19 K21      ; R19 := "RJMissilePlatformCore"
 45 [-]: CALL      R18 2 2      ; R18 := R18(R19)
 46 [-]: LOADK     R19 K22      ; R19 := "MissilePlatform"
 47 [-]: LOADNIL   R20 R23      ; R20 := R21 := R22 := R23 := nil
 48 [-]: LOADK     R24 0        ; R24 := 0.000000
 49 [-]: LOADK     R25 0        ; R25 := 0.000000
 50 [-]: LOADNIL   R26 R31      ; R26 := R27 := R28 := R29 := R30 := R31 := nil
 51 [-]: LOADK     R32 0        ; R32 := 0.000000
 52 [-]: LOADK     R33 1        ; R33 := 1.000000
 53 [-]: LOADK     R34 2        ; R34 := 2.000000
 54 [-]: LOADK     R35 3        ; R35 := 3.000000
 55 [-]: LOADK     R36 4        ; R36 := 4.000000
 56 [-]: LOADK     R37 5        ; R37 := 5.000000
 57 [-]: LOADK     R38 6        ; R38 := 6.000000
 58 [-]: LOADK     R39 7        ; R39 := 7.000000
 59 [-]: LOADK     R40 8        ; R40 := 8.000000
 60 [-]: LOADK     R41 9        ; R41 := 9.000000
 61 [-]: LOADNIL   R42 R43      ; R42 := R43 := nil
 62 [-]: NEWTABLE  R44 0 0      ; R44 := {}
 63 [-]: LOADNIL   R45 R57      ; R45 := R46 := R47 := R48 := R49 := R50 := R51 := R52 := R53 := R54 := R55 := R56 := R57 := nil
 64 [-]: CLOSURE   R58 0        ; R58 := closure(Function #1)
 65 [-]: MOVE      R0 R47       ; R0 := R47
 66 [-]: MOVE      R0 R52       ; R0 := R52
 67 [-]: MOVE      R0 R29       ; R0 := R29
 68 [-]: MOVE      R0 R37       ; R0 := R37
 69 [-]: MOVE      R0 R48       ; R0 := R48
 70 [-]: MOVE      R0 R53       ; R0 := R53
 71 [-]: MOVE      R0 R39       ; R0 := R39
 72 [-]: SETGLOBAL R58 K23      ; OnDisabled := R58
 73 [-]: CLOSURE   R58 1        ; R58 := closure(Function #2)
 74 [-]: MOVE      R0 R56       ; R0 := R56
 ...
 82 [-]: SETGLOBAL R58 K24      ; OnDestroyed := R58
 83 [-]: CLOSURE   R58 2        ; R58 := closure(Function #3)
 ...
 94 [-]: SETGLOBAL R58 K25      ; FirePort := R58
...
110 [-]: MOVE      R0 R54       ; R0 := R54
111 [-]: MOVE      R0 R1        ; R0 := R1
112 [-]: MOVE      R0 R55       ; R0 := R55
113 [-]: MOVE      R0 R56       ; R0 := R56
114 [-]: MOVE      R0 R18       ; R0 := R18
115 [-]: CLOSURE   R59 4        ; R59 := closure(Function #5)
116 [-]: MOVE      R0 R42       ; R0 := R42
117 [-]: MOVE      R0 R43       ; R0 := R43
118 [-]: MOVE      R0 R22       ; R0 := R22
119 [-]: SETGLOBAL R59 K26      ; ShipReady := R59
120 [-]: CLOSURE   R59 5        ; R59 := closure(Function #6)
...
127 [-]: SETGLOBAL R59 K27      ; OnActivated := R59
128 [-]: CLOSURE   R59 6        ; R59 := closure(Function #7)
129 [-]: MOVE      R0 R29       ; R0 := R29
130 [-]: MOVE      R0 R3        ; R0 := R3
131 [-]: MOVE      R0 R27       ; R0 := R27
132 [-]: CLOSURE   R60 7        ; R60 := closure(Function #8)
...
163 [-]: CLOSURE   R61 8        ; R61 := closure(Function #9)
...
214 [-]: SETGLOBAL R63 K28      ; Start := R63
215 [-]: CLOSURE   R63 11       ; R63 := closure(Function #12)
216 [-]: MOVE      R0 R31       ; R0 := R31
217 [-]: SETGLOBAL R63 K29      ; OnPlayersChanged := R63
...
; Max Stack Size:  4
 ...
 16 [-]: SELF      R1 R1 K0     ; R2 := R1; R1 := R1[0xf4e253b6]
...
; Max Stack Size:  13
  ...
  1 [-]: GETUPVAL  R1 U0        ; R1 := U0
  2 [-]: EQ        0 R0 R1      ; if R0 ~= R1 then PC := 68
  3 [-]: JMP       68           ; PC := 68
  4 [-]: GETUPVAL  R1 U1        ; R1 := U1
  5 [-]: SELF      R1 R1 K0     ; R2 := R1; R1 := R1[0x209398c2]
  6 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  7 [-]: GETUPVAL  R2 U2        ; R2 := U2
  8 [-]: EQ        1 R1 R2      ; if R1 == R2 then PC := 18
  9 [-]: JMP       18           ; PC := 18
 10 [-]: GETUPVAL  R1 U3        ; R1 := U3
 11 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x35b12c08]
 ...
 25 [-]: JMP       32           ; PC := 32
 26 [-]: SELF      R2 R1 K5     ; R3 := R1; R2 := R1[0xf37943ff]
 27 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 28 [-]: TEST      R2 0         ; if not R2 then PC := 32
 29 [-]: JMP       32           ; PC := 32
 30 [-]: SELF      R2 R1 K6     ; R3 := R1; R2 := R1[0xf4e253b6]
 31 [-]: CALL      R2 2 1       ; R2(R3)
 32 [-]: GETUPVAL  R2 U3        ; R2 := U3
 33 [-]: GETTABLE  R2 R2 K7     ; R2 := R2[0x0c97556b]
 34 [-]: LOADBOOL  R3 1 0       ; R3 := true
 35 [-]: GETUPVAL  R4 U6        ; R4 := U6
 36 [-]: CALL      R2 3 1       ; R2(R3,R4)
 37 [-]: GETUPVAL  R2 U7        ; R2 := U7
 38 [-]: SELF      R2 R2 K8     ; R3 := R2; R2 := R2[0xfa9e477f]
 39 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 40 [-]: SELF      R3 R2 K9     ; R4 := R2; R3 := R2[0x55e9211c]
 41 [-]: LOADBOOL  R5 1 0       ; R5 := true
 42 [-]: GETGLOBAL R6 K10       ; R6 := 0x0469f296
 43 [-]: LOADK     R7 K11       ; R7 := "PoiDisabled"
 44 [-]: CALL      R6 2 0       ; R6,... := R6(R7)
 45 [-]: CALL      R3 0 1       ; R3(R4,...)
 46 [-]: GETUPVAL  R3 U4        ; R3 := U4
 47 [-]: SELF      R3 R3 K12    ; R4 := R3; R3 := R3[0x22df603c]
 48 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 49 [-]: GETGLOBAL R4 K13       ; R4 := 0xc8802016
 50 [-]: MOVE      R5 R3        ; R5 := R3
 51 [-]: CALL      R4 2 4       ; R4,R5,R6 := R4(R5)
 52 [-]: JMP       62           ; PC := 62
 53 [-]: SELF      R9 R8 K14    ; R10 := R8; R9 := R8[0xbb610e5b]
 54 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 55 [-]: SELF      R10 R9 K15   ; R11 := R9; R10 := R9[0xf2deaf69]
 56 [-]: GETGLOBAL R12 K16      ; R12 := gAutoTurretAvatarType
 57 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 58 [-]: TEST      R10 0        ; if not R10 then PC := 62
 59 [-]: JMP       62           ; PC := 62
 60 [-]: SELF      R10 R9 K17   ; R11 := R9; R10 := R9[0xf05afc29]
 61 [-]: CALL      R10 2 1      ; R10(R11)
 62 [-]: TFORLOOP  R4 2         ; R7,R8 :=  R4(R5,R6); if R7 ~= nil then begin PC = 53; R6 := R7 end
 63 [-]: JMP       53           ; PC := 53
 64 [-]: GETUPVAL  R10 U4       ; R10 := U4
 65 [-]: SELF      R10 R10 K18  ; R11 := R10; R10 := R10[0xfe9dc265]
 66 [-]: LOADK     R12 3        ; R12 := 3.000000
...
; Max Stack Size:  5
  ...
  6 [-]: JMP       27           ; PC := 27
  7 [-]: GETUPVAL  R1 U2        ; R1 := U2
  8 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x5710748f]
  9 [-]: CALL      R1 2 1       ; R1(R2)
 10 [-]: GETUPVAL  R1 U3        ; R1 := U3
 11 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x5710748f]
 12 [-]: CALL      R1 2 1       ; R1(R2)
 13 [-]: LOADBOOL  R1 0 0       ; R1 := false
 14 [-]: TEST      R1 0         ; if not R1 then PC := 22
 15 [-]: JMP       22           ; PC := 22
 16 [-]: GETUPVAL  R1 U4        ; R1 := U4
 17 [-]: SELF      R1 R1 K2     ; R2 := R1; R1 := R1[0xbd2e96ea]
 18 [-]: LOADK     R3 10        ; R3 := 10.000000
 19 [-]: CLOSURE   R4 0         ; R4 := closure(Function #3.1)
 20 [-]: GETUPVAL  R0 U2        ; R0 := U2
 21 [-]: CALL      R1 4 1       ; R1(R2,R3,R4)
 22 [-]: GETUPVAL  R1 U0        ; R1 := U0
 23 [-]: SELF      R1 R1 K3     ; R2 := R1; R1 := R1[0x8abff40e]
 24 [-]: GETUPVAL  R3 U5        ; R3 := U5
 25 [-]: CALL      R1 3 1       ; R1(R2,R3)
 26 [-]: JMP       52           ; PC := 52
 27 [-]: GETUPVAL  R1 U0        ; R1 := U0
 28 [-]: SELF      R1 R1 K0     ; R2 := R1; R1 := R1[0x209398c2]
 29 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 30 [-]: GETUPVAL  R2 U6        ; R2 := U6
 31 [-]: EQ        0 R1 R2      ; if R1 ~= R2 then PC := 52
 32 [-]: JMP       52           ; PC := 52
 33 [-]: GETUPVAL  R1 U7        ; R1 := U7
 34 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x5710748f]
 35 [-]: CALL      R1 2 1       ; R1(R2)
 36 [-]: GETUPVAL  R1 U8        ; R1 := U8
 37 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x5710748f]
 38 [-]: CALL      R1 2 1       ; R1(R2)
 39 [-]: LOADBOOL  R1 0 0       ; R1 := false
 40 [-]: TEST      R1 0         ; if not R1 then PC := 48
 41 [-]: JMP       48           ; PC := 48
 42 [-]: GETUPVAL  R1 U4        ; R1 := U4
 43 [-]: SELF      R1 R1 K2     ; R2 := R1; R1 := R1[0xbd2e96ea]
 44 [-]: LOADK     R3 10        ; R3 := 10.000000
 45 [-]: CLOSURE   R4 1         ; R4 := closure(Function #3.2)
 46 [-]: GETUPVAL  R0 U7        ; R0 := U7
 47 [-]: CALL      R1 4 1       ; R1(R2,R3,R4)
 48 [-]: GETUPVAL  R1 U0        ; R1 := U0
 49 [-]: SELF      R1 R1 K3     ; R2 := R1; R1 := R1[0x8abff40e]
...
; Max Stack Size:  11
 ...
 39 [-]: SELF      R2 R2 K13    ; R3 := R2; R2 := R2[0xe2871589]
 40 [-]: MOVE      R4 R1        ; R4 := R1
 41 [-]: CALL      R2 3 1       ; R2(R3,R4)
 42 [-]: GETGLOBAL R2 K14       ; R2 := 0xcbd666e1
 43 [-]: LOADK     R3 0         ; R3 := 0.000000
 44 [-]: CALL      R2 2 1       ; R2(R3)
 45 [-]: GETUPVAL  R2 U1        ; R2 := U1
 46 [-]: GETTABLE  R2 R2 K15    ; R2 := R2[0xde6c4f3e]
 47 [-]: GETGLOBAL R3 K2        ; R3 := 0x0469f296
 48 [-]: LOADK     R4 K16       ; R4 := "WeakpointConsole"
 49 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 50 [-]: GETUPVAL  R4 U2        ; R4 := U2
 51 [-]: CALL      R2 3 2       ; R2 := R2(R3,R4)
 52 [-]: LEN       R3 R2        ; R3 := # R2
 53 [-]: LE        0 K17 R3     ; if 2.000000 > R3 then PC := 126
 54 [-]: JMP       126          ; PC := 126
 55 [-]: GETTABLE  R3 R2 K18    ; R3 := R2[1.000000]
 56 [-]: SELF      R3 R3 K19    ; R4 := R3; R3 := R3[0xe79e7ef4]
 57 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 58 [-]: SELF      R3 R3 K20    ; R4 := R3; R3 := R3[0x9435eb6d]
 59 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 60 [-]: GETTABLE  R4 R2 K17    ; R4 := R2[2.000000]
 61 [-]: SELF      R4 R4 K19    ; R5 := R4; R4 := R4[0xe79e7ef4]
 62 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 63 [-]: SELF      R4 R4 K20    ; R5 := R4; R4 := R4[0x9435eb6d]
 64 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 65 [-]: LT        0 R3 R4      ; if R3 >= R4 then PC := 72
 66 [-]: JMP       72           ; PC := 72
 67 [-]: GETTABLE  R3 R2 K17    ; R3 := R2[2.000000]
 68 [-]: SETUPVAL  R3 U7        ; U82 := R7
 69 [-]: GETTABLE  R3 R2 K18    ; R3 := R2[1.000000]
 70 [-]: SETUPVAL  R3 U8        ; U82 := R8
 71 [-]: JMP       76           ; PC := 76
 72 [-]: GETTABLE  R3 R2 K18    ; R3 := R2[1.000000]
 73 [-]: SETUPVAL  R3 U7        ; U82 := R7
 74 [-]: GETTABLE  R3 R2 K17    ; R3 := R2[2.000000]
 75 [-]: SETUPVAL  R3 U8        ; U82 := R8
 76 [-]: GETGLOBAL R3 K14       ; R3 := 0xcbd666e1
 77 [-]: LOADK     R4 1         ; R4 := 1.000000
 78 [-]: CALL      R3 2 1       ; R3(R4)
 79 [-]: GETGLOBAL R3 K0        ; R3 := 0x89326c93
 80 [-]: SELF      R3 R3 K1     ; R4 := R3; R3 := R3[0xc7b81e8d]
 81 [-]: GETGLOBAL R5 K2        ; R5 := 0x0469f296
 82 [-]: LOADK     R6 K21       ; R6 := "SuccessfulHackForwarder"
 83 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 84 [-]: GETUPVAL  R6 U7        ; R6 := U7
 85 [-]: SELF      R6 R6 K22    ; R7 := R6; R6 := R6[0xd1586535]
 86 [-]: CALL      R6 2 0       ; R6,... := R6(R7)
 87 [-]: CALL      R3 0 2       ; R3 := R3(R4,...)
 88 [-]: GETGLOBAL R4 K23       ; R4 := 0x11a19c5e
 89 [-]: MOVE      R5 R3        ; R5 := R3
 90 [-]: LOADK     R6 K24       ; R6 := "FirePort"
 91 [-]: CALL      R4 3 1       ; R4(R5,R6)
 92 [-]: GETGLOBAL R4 K7        ; R4 := 0x3d106989
 93 [-]: LOADK     R5 K25       ; R5 := "ObjectPortHandler "
 94 [-]: SELF      R6 R3 K26    ; R7 := R3; R6 := R3[0xed4e0128]
 95 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 96 [-]: CONCAT    R5 R5 R6     ; R5 := R5 .. R6
 97 [-]: CALL      R4 2 1       ; R4(R5)
 98 [-]: GETGLOBAL R4 K0        ; R4 := 0x89326c93
 99 [-]: SELF      R4 R4 K1     ; R5 := R4; R4 := R4[0xc7b81e8d]
100 [-]: GETGLOBAL R6 K2        ; R6 := 0x0469f296
101 [-]: LOADK     R7 K21       ; R7 := "SuccessfulHackForwarder"
102 [-]: CALL      R6 2 2       ; R6 := R6(R7)
103 [-]: GETUPVAL  R7 U8        ; R7 := U8
104 [-]: SELF      R7 R7 K22    ; R8 := R7; R7 := R7[0xd1586535]
105 [-]: CALL      R7 2 0       ; R7,... := R7(R8)
106 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
107 [-]: MOVE      R3 R4        ; R3 := R4
108 [-]: GETGLOBAL R4 K23       ; R4 := 0x11a19c5e
109 [-]: MOVE      R5 R3        ; R5 := R3
110 [-]: LOADK     R6 K24       ; R6 := "FirePort"
111 [-]: CALL      R4 3 1       ; R4(R5,R6)
112 [-]: GETGLOBAL R4 K7        ; R4 := 0x3d106989
113 [-]: LOADK     R5 K25       ; R5 := "ObjectPortHandler "
114 [-]: SELF      R6 R3 K26    ; R7 := R3; R6 := R3[0xed4e0128]
115 [-]: CALL      R6 2 2       ; R6 := R6(R7)
116 [-]: CONCAT    R5 R5 R6     ; R5 := R5 .. R6
117 [-]: CALL      R4 2 1       ; R4(R5)
118 [-]: GETGLOBAL R4 K23       ; R4 := 0x11a19c5e
119 [-]: GETUPVAL  R5 U7        ; R5 := U7
120 [-]: LOADK     R6 K27       ; R6 := "OnActivated"
121 [-]: CALL      R4 3 1       ; R4(R5,R6)
122 [-]: GETGLOBAL R4 K23       ; R4 := 0x11a19c5e
123 [-]: GETUPVAL  R5 U8        ; R5 := U8
124 [-]: LOADK     R6 K27       ; R6 := "OnActivated"
125 [-]: CALL      R4 3 1       ; R4(R5,R6)
126 [-]: GETUPVAL  R4 U1        ; R4 := U1
127 [-]: GETTABLE  R4 R4 K28    ; R4 := R4[0xd2c39e3e]
128 [-]: GETGLOBAL R5 K2        ; R5 := 0x0469f296
129 [-]: LOADK     R6 K29       ; R6 := "MissilePlatformWeakpoint"
130 [-]: CALL      R5 2 2       ; R5 := R5(R6)
131 [-]: GETUPVAL  R6 U5        ; R6 := U5
132 [-]: SELF      R6 R6 K30    ; R7 := R6; R6 := R6[0x65c63fbe]
133 [-]: CALL      R6 2 0       ; R6,... := R6(R7)
134 [-]: CALL      R4 0 2       ; R4 := R4(R5,...)
135 [-]: GETGLOBAL R5 K31       ; R5 := 0x33bdd652
136 [-]: GETTABLE  R5 R5 K32    ; R5 := R5[0xf21b1d8e]
137 [-]: MOVE      R6 R4        ; R6 := R4
138 [-]: CLOSURE   R7 0         ; R7 := closure(Function #4.1)
139 [-]: CALL      R5 3 1       ; R5(R6,R7)
140 [-]: GETTABLE  R5 R4 K18    ; R5 := R4[1.000000]
141 [-]: SETUPVAL  R5 U9        ; U82 := R9
142 [-]: GETTABLE  R5 R4 K17    ; R5 := R4[2.000000]
143 [-]: SETUPVAL  R5 U10       ; U82 := R10
144 [-]: GETGLOBAL R5 K23       ; R5 := 0x11a19c5e
145 [-]: GETUPVAL  R6 U9        ; R6 := U9
146 [-]: LOADK     R7 K33       ; R7 := "OnDisabled"
147 [-]: CALL      R5 3 1       ; R5(R6,R7)
148 [-]: GETGLOBAL R5 K23       ; R5 := 0x11a19c5e
149 [-]: GETUPVAL  R6 U10       ; R6 := U10
150 [-]: LOADK     R7 K33       ; R7 := "OnDisabled"
151 [-]: CALL      R5 3 1       ; R5(R6,R7)
152 [-]: GETGLOBAL R5 K0        ; R5 := 0x89326c93
153 [-]: SELF      R5 R5 K1     ; R6 := R5; R5 := R5[0xc7b81e8d]
154 [-]: GETGLOBAL R7 K2        ; R7 := 0x0469f296
155 [-]: LOADK     R8 K29       ; R8 := "MissilePlatformWeakpoint"
156 [-]: CALL      R7 2 2       ; R7 := R7(R8)
157 [-]: GETUPVAL  R8 U7        ; R8 := U7
158 [-]: SELF      R8 R8 K22    ; R9 := R8; R8 := R8[0xd1586535]
159 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
160 [-]: CALL      R5 0 2       ; R5 := R5(R6,...)
161 [-]: SETUPVAL  R5 U11       ; U82 := R11
162 [-]: GETGLOBAL R5 K0        ; R5 := 0x89326c93
163 [-]: SELF      R5 R5 K1     ; R6 := R5; R5 := R5[0xc7b81e8d]
164 [-]: GETGLOBAL R7 K2        ; R7 := 0x0469f296
165 [-]: LOADK     R8 K29       ; R8 := "MissilePlatformWeakpoint"
166 [-]: CALL      R7 2 2       ; R7 := R7(R8)
167 [-]: GETUPVAL  R8 U8        ; R8 := U8
168 [-]: SELF      R8 R8 K22    ; R9 := R8; R8 := R8[0xd1586535]
169 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
170 [-]: CALL      R5 0 2       ; R5 := R5(R6,...)
171 [-]: SETUPVAL  R5 U12       ; U82 := R12
172 [-]: GETUPVAL  R5 U1        ; R5 := U1
173 [-]: GETTABLE  R5 R5 K11    ; R5 := R5[0x2df8b2ba]
174 [-]: GETGLOBAL R6 K2        ; R6 := 0x0469f296
175 [-]: LOADK     R7 K34       ; R7 := "UnlockCoreRoom"
176 [-]: CALL      R6 2 2       ; R6 := R6(R7)
177 [-]: GETUPVAL  R7 U2        ; R7 := U2
178 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
179 [-]: SETUPVAL  R5 U13       ; U82 := R13
180 [-]: GETGLOBAL R5 K4        ; R5 := 0x7b998233
181 [-]: GETGLOBAL R6 K35       ; R6 := _T
182 [-]: GETTABLE  R6 R6 K36    ; R6 := R6["AddHudTracker"]
183 [-]: CALL      R5 2 2       ; R5 := R5(R6)
184 [-]: TEST      R5 1         ; if R5 then PC := 206
185 [-]: JMP       206          ; PC := 206
186 [-]: GETGLOBAL R5 K35       ; R5 := _T
187 [-]: GETTABLE  R5 R5 K37    ; R5 := R5[0x8ee923fe]
188 [-]: LOADK     R6 K38       ; R6 := "Cheat"
189 [-]: GETUPVAL  R7 U15       ; R7 := U15
190 [-]: GETTABLE  R7 R7 K39    ; R7 := R7["HT_LABEL"]
191 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
192 [-]: SETUPVAL  R5 U14       ; U82 := R14
193 [-]: LOADK     R5 K40       ; R5 := "<p><font face=\"Noto Sans\" color=\"#FF0000\">"
194 [-]: LOADK     R6 K41       ; R6 := "</font></p>"
195 [-]: GETUPVAL  R7 U14       ; R7 := U14
196 [-]: GETTABLE  R7 R7 K42    ; R7 := R7[0x3f8a850c]
197 [-]: MOVE      R8 R5        ; R8 := R5
198 [-]: LOADK     R9 K43       ; R9 := "LotusGameRules.MissionDebug ENABLED"
199 [-]: MOVE      R10 R6       ; R10 := R6
200 [-]: CONCAT    R8 R8 R10    ; R8 := R8 .. R9 .. R10
201 [-]: CALL      R7 2 1       ; R7(R8)
202 [-]: GETUPVAL  R7 U14       ; R7 := U14
203 [-]: GETTABLE  R7 R7 K44    ; R7 := R7[0x368ad758]
204 [-]: LOADBOOL  R8 0 0       ; R8 := false
205 [-]: CALL      R7 2 1       ; R7(R8)
206 [-]: GETUPVAL  R7 U1        ; R7 := U1
207 [-]: GETTABLE  R7 R7 K11    ; R7 := R7[0x2df8b2ba]
208 [-]: GETGLOBAL R8 K2        ; R8 := 0x0469f296
209 [-]: LOADK     R9 K45       ; R9 := "CoreRoomMarker"
210 [-]: CALL      R8 2 2       ; R8 := R8(R9)
211 [-]: GETUPVAL  R9 U2        ; R9 := U2
212 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
213 [-]: SETUPVAL  R7 U16       ; U82 := R16
214 [-]: GETUPVAL  R7 U1        ; R7 := U1
215 [-]: GETTABLE  R7 R7 K11    ; R7 := R7[0x2df8b2ba]
216 [-]: GETUPVAL  R8 U18       ; R8 := U18
217 [-]: GETUPVAL  R9 U2        ; R9 := U2
218 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
219 [-]: SETUPVAL  R7 U17       ; U82 := R17
220 [-]: GETGLOBAL R7 K23       ; R7 := 0x11a19c5e
221 [-]: GETUPVAL  R8 U17       ; R8 := U17
222 [-]: LOADK     R9 K46       ; R9 := "OnDestroyed"
...
; Max Stack Size:  5
  ...
  4 [-]: SELF      R3 R1 K2     ; R4 := R1; R3 := R1[0x5e651723]
 ...
 13 [-]: SELF      R2 R2 K3     ; R3 := R2; R2 := R2[0xe2e807cc]
 14 [-]: CALL      R2 2 1       ; R2(R3)
 15 [-]: GETUPVAL  R2 U2        ; R2 := U2
 16 [-]: SELF      R2 R2 K3     ; R3 := R2; R2 := R2[0xe2e807cc]
 ...
 23 [-]: SELF      R2 R2 K3     ; R3 := R2; R2 := R2[0xe2e807cc]
 24 [-]: CALL      R2 2 1       ; R2(R3)
 25 [-]: GETUPVAL  R2 U5        ; R2 := U5
 26 [-]: SELF      R2 R2 K3     ; R3 := R2; R2 := R2[0xe2e807cc]
...
; Max Stack Size:  5
  ...
  7 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x9742b85b]
...
; Max Stack Size:  11
 ...
 10 [-]: JMP       13           ; PC := 13
 11 [-]: SELF      R6 R5 K2     ; R7 := R5; R6 := R5[0x383d2e7d]
 12 [-]: CALL      R6 2 1       ; R6(R7)
 13 [-]: TFORLOOP  R1 2         ; R4,R5 :=  R1(R2,R3); if R4 ~= nil then begin PC = 11; R3 := R4 end
 14 [-]: JMP       11           ; PC := 11
 15 [-]: JMP       176          ; PC := 176
 16 [-]: GETUPVAL  R6 U3        ; R6 := U3
 17 [-]: EQ        0 R0 R6      ; if R0 ~= R6 then PC := 34
 18 [-]: JMP       34           ; PC := 34
 19 [-]: GETUPVAL  R6 U4        ; R6 := U4
 20 [-]: SELF      R6 R6 K3     ; R7 := R6; R6 := R6[0xdbf52ecd]
 21 [-]: CALL      R6 2 1       ; R6(R7)
 22 [-]: GETUPVAL  R6 U5        ; R6 := U5
 23 [-]: SELF      R6 R6 K2     ; R7 := R6; R6 := R6[0x383d2e7d]
 24 [-]: CALL      R6 2 1       ; R6(R7)
 25 [-]: GETUPVAL  R6 U6        ; R6 := U6
 26 [-]: GETTABLE  R6 R6 K4     ; R6 := R6[0x4871fe97]
 27 [-]: GETUPVAL  R7 U7        ; R7 := U7
 28 [-]: GETUPVAL  R8 U8        ; R8 := U8
 29 [-]: GETUPVAL  R9 U9        ; R9 := U9
 30 [-]: GETUPVAL  R10 U6       ; R10 := U6
 31 [-]: GETTABLE  R10 R10 K5   ; R10 := R10["GENERIC_ICON"]
 32 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
 33 [-]: JMP       176          ; PC := 176
 34 [-]: GETUPVAL  R6 U10       ; R6 := U10
 35 [-]: EQ        0 R0 R6      ; if R0 ~= R6 then PC := 59
 36 [-]: JMP       59           ; PC := 59
 37 [-]: GETUPVAL  R6 U6        ; R6 := U6
 38 [-]: GETTABLE  R6 R6 K4     ; R6 := R6[0x4871fe97]
 39 [-]: GETUPVAL  R7 U7        ; R7 := U7
 40 [-]: GETUPVAL  R8 U8        ; R8 := U8
 41 [-]: GETUPVAL  R9 U11       ; R9 := U11
 42 [-]: GETUPVAL  R10 U6       ; R10 := U6
 43 [-]: GETTABLE  R10 R10 K6   ; R10 := R10["ATTACK_ICON"]
 44 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
 45 [-]: GETUPVAL  R6 U12       ; R6 := U12
 46 [-]: GETTABLE  R6 R6 K7     ; R6 := R6[0x9742b85b]
 47 [-]: GETUPVAL  R7 U13       ; R7 := U13
 48 [-]: GETGLOBAL R8 K8        ; R8 := 0x0469f296
 49 [-]: LOADK     R9 K9        ; R9 := "WeakpointExposed"
 50 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
 51 [-]: CALL      R6 0 1       ; R6(R7,...)
 52 [-]: GETUPVAL  R6 U14       ; R6 := U14
 53 [-]: SELF      R6 R6 K10    ; R7 := R6; R6 := R6[0xbd2e96ea]
 54 [-]: LOADK     R8 10        ; R8 := 10.000000
 55 [-]: GETUPVAL  R9 U15       ; R9 := U15
 56 [-]: MOVE      R10 R0       ; R10 := R0
 57 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
 58 [-]: JMP       176          ; PC := 176
 59 [-]: GETUPVAL  R6 U16       ; R6 := U16
 60 [-]: EQ        0 R0 R6      ; if R0 ~= R6 then PC := 81
 61 [-]: JMP       81           ; PC := 81
 62 [-]: GETUPVAL  R6 U17       ; R6 := U17
 63 [-]: SELF      R6 R6 K2     ; R7 := R6; R6 := R6[0x383d2e7d]
 64 [-]: CALL      R6 2 1       ; R6(R7)
 65 [-]: GETUPVAL  R6 U6        ; R6 := U6
 66 [-]: GETTABLE  R6 R6 K4     ; R6 := R6[0x4871fe97]
 67 [-]: GETUPVAL  R7 U7        ; R7 := U7
 68 [-]: GETUPVAL  R8 U8        ; R8 := U8
 69 [-]: GETUPVAL  R9 U18       ; R9 := U18
 70 [-]: GETUPVAL  R10 U6       ; R10 := U6
 71 [-]: GETTABLE  R10 R10 K5   ; R10 := R10["GENERIC_ICON"]
 72 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
 73 [-]: GETUPVAL  R6 U12       ; R6 := U12
 74 [-]: GETTABLE  R6 R6 K7     ; R6 := R6[0x9742b85b]
 75 [-]: GETUPVAL  R7 U13       ; R7 := U13
 76 [-]: GETGLOBAL R8 K8        ; R8 := 0x0469f296
 77 [-]: LOADK     R9 K11       ; R9 := "FirstWeakpointDestroyed"
 78 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
 79 [-]: CALL      R6 0 1       ; R6(R7,...)
 80 [-]: JMP       176          ; PC := 176
 81 [-]: GETUPVAL  R6 U19       ; R6 := U19
 82 [-]: EQ        0 R0 R6      ; if R0 ~= R6 then PC := 100
 83 [-]: JMP       100          ; PC := 100
 84 [-]: GETUPVAL  R6 U6        ; R6 := U6
 85 [-]: GETTABLE  R6 R6 K4     ; R6 := R6[0x4871fe97]
 86 [-]: GETUPVAL  R7 U7        ; R7 := U7
 87 [-]: GETUPVAL  R8 U8        ; R8 := U8
 88 [-]: GETUPVAL  R9 U20       ; R9 := U20
 89 [-]: GETUPVAL  R10 U6       ; R10 := U6
 90 [-]: GETTABLE  R10 R10 K6   ; R10 := R10["ATTACK_ICON"]
 91 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
 92 [-]: GETUPVAL  R6 U12       ; R6 := U12
 93 [-]: GETTABLE  R6 R6 K7     ; R6 := R6[0x9742b85b]
 94 [-]: GETUPVAL  R7 U13       ; R7 := U13
 95 [-]: GETGLOBAL R8 K8        ; R8 := 0x0469f296
 96 [-]: LOADK     R9 K9        ; R9 := "WeakpointExposed"
 97 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
 98 [-]: CALL      R6 0 1       ; R6(R7,...)
 99 [-]: JMP       176          ; PC := 176
100 [-]: GETUPVAL  R6 U21       ; R6 := U21
101 [-]: EQ        0 R0 R6      ; if R0 ~= R6 then PC := 122
102 [-]: JMP       122          ; PC := 122
103 [-]: GETUPVAL  R6 U22       ; R6 := U22
104 [-]: SELF      R6 R6 K2     ; R7 := R6; R6 := R6[0x383d2e7d]
105 [-]: CALL      R6 2 1       ; R6(R7)
106 [-]: GETUPVAL  R6 U6        ; R6 := U6
107 [-]: GETTABLE  R6 R6 K4     ; R6 := R6[0x4871fe97]
108 [-]: GETUPVAL  R7 U7        ; R7 := U7
109 [-]: GETUPVAL  R8 U8        ; R8 := U8
110 [-]: GETUPVAL  R9 U23       ; R9 := U23
111 [-]: GETUPVAL  R10 U6       ; R10 := U6
112 [-]: GETTABLE  R10 R10 K5   ; R10 := R10["GENERIC_ICON"]
113 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
114 [-]: GETUPVAL  R6 U12       ; R6 := U12
115 [-]: GETTABLE  R6 R6 K7     ; R6 := R6[0x9742b85b]
116 [-]: GETUPVAL  R7 U13       ; R7 := U13
117 [-]: GETGLOBAL R8 K8        ; R8 := 0x0469f296
118 [-]: LOADK     R9 K12       ; R9 := "SecondWeakpointDestroyed"
119 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
120 [-]: CALL      R6 0 1       ; R6(R7,...)
121 [-]: JMP       176          ; PC := 176
122 [-]: GETUPVAL  R6 U24       ; R6 := U24
123 [-]: EQ        0 R0 R6      ; if R0 ~= R6 then PC := 152
124 [-]: JMP       152          ; PC := 152
125 [-]: GETUPVAL  R6 U22       ; R6 := U22
126 [-]: SELF      R6 R6 K13    ; R7 := R6; R6 := R6[0xf4e253b6]
127 [-]: CALL      R6 2 1       ; R6(R7)
128 [-]: GETUPVAL  R6 U4        ; R6 := U4
129 [-]: SELF      R6 R6 K14    ; R7 := R6; R6 := R6[0x0d59bfae]
130 [-]: LOADK     R8 5         ; R8 := 5.000000
131 [-]: CALL      R6 3 1       ; R6(R7,R8)
132 [-]: GETUPVAL  R6 U25       ; R6 := U25
133 [-]: SELF      R6 R6 K15    ; R7 := R6; R6 := R6[0x8eb2112d]
134 [-]: LOADK     R8 K16       ; R8 := "Execute"
135 [-]: CALL      R6 3 1       ; R6(R7,R8)
136 [-]: GETUPVAL  R6 U6        ; R6 := U6
137 [-]: GETTABLE  R6 R6 K4     ; R6 := R6[0x4871fe97]
138 [-]: GETUPVAL  R7 U7        ; R7 := U7
139 [-]: GETUPVAL  R8 U8        ; R8 := U8
140 [-]: GETUPVAL  R9 U26       ; R9 := U26
141 [-]: GETUPVAL  R10 U6       ; R10 := U6
142 [-]: GETTABLE  R10 R10 K6   ; R10 := R10["ATTACK_ICON"]
143 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
144 [-]: GETUPVAL  R6 U12       ; R6 := U12
145 [-]: GETTABLE  R6 R6 K7     ; R6 := R6[0x9742b85b]
146 [-]: GETUPVAL  R7 U13       ; R7 := U13
147 [-]: GETGLOBAL R8 K8        ; R8 := 0x0469f296
148 [-]: LOADK     R9 K17       ; R9 := "DestroyInteriorWeakpoint"
149 [-]: CALL      R8 2 0       ; R8,... := R8(R9)
150 [-]: CALL      R6 0 1       ; R6(R7,...)
151 [-]: JMP       176          ; PC := 176
152 [-]: GETUPVAL  R6 U27       ; R6 := U27
153 [-]: EQ        0 R0 R6      ; if R0 ~= R6 then PC := 176
154 [-]: JMP       176          ; PC := 176
155 [-]: GETUPVAL  R6 U6        ; R6 := U6
156 [-]: GETTABLE  R6 R6 K18    ; R6 := R6[0x763bb16d]
157 [-]: GETUPVAL  R7 U7        ; R7 := U7
158 [-]: GETUPVAL  R8 U8        ; R8 := U8
159 [-]: CALL      R6 3 1       ; R6(R7,R8)
160 [-]: GETUPVAL  R6 U6        ; R6 := U6
161 [-]: GETTABLE  R6 R6 K18    ; R6 := R6[0x763bb16d]
162 [-]: GETUPVAL  R7 U7        ; R7 := U7
163 [-]: CALL      R6 2 1       ; R6(R7)
164 [-]: GETUPVAL  R6 U28       ; R6 := U28
165 [-]: GETTABLE  R6 R6 K19    ; R6 := R6[0x33d25c2b]
166 [-]: LOADBOOL  R7 0 0       ; R7 := false
167 [-]: GETUPVAL  R8 U29       ; R8 := U29
168 [-]: CALL      R6 3 1       ; R6(R7,R8)
169 [-]: GETUPVAL  R6 U12       ; R6 := U12
170 [-]: GETTABLE  R6 R6 K7     ; R6 := R6[0x9742b85b]
171 [-]: GETUPVAL  R7 U13       ; R7 := U13
172 [-]: GETGLOBAL R8 K8        ; R8 := 0x0469f296
173 [-]: LOADK     R9 K20       ; R9 := "ObjectiveComplete"
...
142 [-]: SELF      R8 R8 K35    ; R9 := R8; R8 := R8[0x8abff40e]
143 [-]: GETUPVAL  R10 U23      ; R10 := U23
144 [-]: GETTABLE  R10 R10 K36  ; R10 := R10[0x06d055f9]
145 [-]: EQ        1 R1 K37     ; if R1 == 0.000000 then PC := 148
146 [-]: JMP       148          ; PC := 148
147 [-]: LOADBOOL  R11 0 1      ; R11 := false; PC := 148
...
153 [-]: SELF      R8 R0 K38    ; R9 := R0; R8 := R0[0xfe9dc265]
...
; Max Stack Size:  21
 ...
 25 [-]: SELF      R7 R7 K6     ; R8 := R7; R7 := R7[0x6cd833c5]
 26 [-]: GETGLOBAL R9 K4        ; R9 := 0x59dc7f80
 27 [-]: GETUPVAL  R10 U1       ; R10 := U1
 28 [-]: SELF      R10 R10 K7   ; R11 := R10; R10 := R10[0x003c792f]
 29 [-]: MOVE      R12 R6       ; R12 := R6
 30 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 31 [-]: GETGLOBAL R11 K8       ; R11 := ZERO_ROTATION
...
; Max Stack Size:  14
 ...
 11 [-]: TEST      R3 1         ; if R3 then PC := 147
 12 [-]: JMP       147          ; PC := 147
 13 [-]: GETGLOBAL R3 K1        ; R3 := 0xbe190284
 14 [-]: SELF      R3 R3 K2     ; R4 := R3; R3 := R3[0x3790d299]
 15 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 16 [-]: TEST      R3 1         ; if R3 then PC := 147
 17 [-]: JMP       147          ; PC := 147
 18 [-]: GETGLOBAL R3 K1        ; R3 := 0xbe190284
 19 [-]: SELF      R3 R3 K3     ; R4 := R3; R3 := R3[0x5d204145]
 20 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 21 [-]: TEST      R3 1         ; if R3 then PC := 147
 22 [-]: JMP       147          ; PC := 147
 23 [-]: SELF      R3 R0 K4     ; R4 := R0; R3 := R0[0xefe6cad1]
 24 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 25 [-]: LE        0 K6 R3      ; if 4.000000 > R3 then PC := 28
 26 [-]: JMP       28           ; PC := 28
 27 [-]: JMP       147          ; PC := 147
 28 [-]: GETGLOBAL R3 K7        ; R3 := 0x67652851
 29 [-]: CALL      R3 1 2       ; R3 := R3()
 30 [-]: MOVE      R1 R3        ; R1 := R3
 31 [-]: GETUPVAL  R3 U3        ; R3 := U3
 32 [-]: SELF      R3 R3 K8     ; R4 := R3; R3 := R3[0x209398c2]
 ...
 41 [-]: GETTABLE  R3 R3 K9     ; R3 := R3[0x368ad758]
 42 [-]: LOADBOOL  R4 0 0       ; R4 := false
 43 [-]: CALL      R3 2 1       ; R3(R4)
 44 [-]: GETUPVAL  R3 U5        ; R3 := U5
 45 [-]: EQ        0 R2 R3      ; if R2 ~= R3 then PC := 68
 46 [-]: JMP       68           ; PC := 68
 47 [-]: GETUPVAL  R3 U6        ; R3 := U6
 48 [-]: GETTABLE  R3 R3 K10    ; R3 := R3[0xe429e04f]
 49 [-]: GETUPVAL  R4 U7        ; R4 := U7
 50 [-]: GETTABLE  R4 R4 K11    ; R4 := R4[1.000000]
 51 [-]: GETUPVAL  R5 U6        ; R5 := U6
 52 [-]: GETTABLE  R5 R5 K12    ; R5 := R5["POI_APPROACH_DISTANCE"]
 53 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 54 [-]: TEST      R3 0         ; if not R3 then PC := 106
 55 [-]: JMP       106          ; PC := 106
 56 [-]: GETUPVAL  R3 U8        ; R3 := U8
 57 [-]: GETTABLE  R3 R3 K13    ; R3 := R3[0x9742b85b]
 58 [-]: GETUPVAL  R4 U9        ; R4 := U9
 59 [-]: GETGLOBAL R5 K14       ; R5 := 0x0469f296
 60 [-]: LOADK     R6 K15       ; R6 := "ObjectiveProximity"
 61 [-]: CALL      R5 2 0       ; R5,... := R5(R6)
 62 [-]: CALL      R3 0 1       ; R3(R4,...)
 63 [-]: GETUPVAL  R3 U3        ; R3 := U3
 64 [-]: SELF      R3 R3 K16    ; R4 := R3; R3 := R3[0x8abff40e]
 65 [-]: GETUPVAL  R5 U10       ; R5 := U10
 66 [-]: CALL      R3 3 1       ; R3(R4,R5)
 67 [-]: JMP       106          ; PC := 106
 68 [-]: GETUPVAL  R3 U10       ; R3 := U10
 69 [-]: EQ        0 R2 R3      ; if R2 ~= R3 then PC := 83
 70 [-]: JMP       83           ; PC := 83
 71 [-]: GETUPVAL  R3 U6        ; R3 := U6
 72 [-]: GETTABLE  R3 R3 K17    ; R3 := R3[0x6696a66c]
 73 [-]: GETUPVAL  R4 U11       ; R4 := U11
 74 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 75 [-]: LEN       R4 R3        ; R4 := # R3
 76 [-]: LT        0 K18 R4     ; if 0.000000 >= R4 then PC := 106
 77 [-]: JMP       106          ; PC := 106
 78 [-]: GETUPVAL  R4 U3        ; R4 := U3
 79 [-]: SELF      R4 R4 K16    ; R5 := R4; R4 := R4[0x8abff40e]
 80 [-]: GETUPVAL  R6 U12       ; R6 := U12
 81 [-]: CALL      R4 3 1       ; R4(R5,R6)
 82 [-]: JMP       106          ; PC := 106
 83 [-]: GETUPVAL  R4 U13       ; R4 := U13
 84 [-]: EQ        0 R2 R4      ; if R2 ~= R4 then PC := 106
 85 [-]: JMP       106          ; PC := 106
 86 [-]: GETUPVAL  R4 U6        ; R4 := U6
 87 [-]: GETTABLE  R4 R4 K17    ; R4 := R4[0x6696a66c]
 88 [-]: GETUPVAL  R5 U11       ; R5 := U11
 89 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 90 [-]: GETGLOBAL R5 K19       ; R5 := 0xc8802016
 91 [-]: MOVE      R6 R4        ; R6 := R4
 92 [-]: CALL      R5 2 4       ; R5,R6,R7 := R5(R6)
 93 [-]: JMP       104          ; PC := 104
 94 [-]: SELF      R10 R9 K20   ; R11 := R9; R10 := R9[0xbebad19f]
 95 [-]: GETUPVAL  R12 U14      ; R12 := U14
 96 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 97 [-]: LT        0 R10 K21    ; if R10 >= 15.000000 then PC := 104
 98 [-]: JMP       104          ; PC := 104
 99 [-]: GETUPVAL  R10 U3       ; R10 := U3
100 [-]: SELF      R10 R10 K16  ; R11 := R10; R10 := R10[0x8abff40e]
101 [-]: GETUPVAL  R12 U15      ; R12 := U15
102 [-]: CALL      R10 3 1      ; R10(R11,R12)
103 [-]: JMP       106          ; PC := 106
104 [-]: TFORLOOP  R5 2         ; R8,R9 :=  R5(R6,R7); if R8 ~= nil then begin PC = 94; R7 := R8 end
105 [-]: JMP       94           ; PC := 94
106 [-]: GETUPVAL  R10 U5       ; R10 := U5
107 [-]: LT        0 R10 R2     ; if R10 >= R2 then PC := 121
108 [-]: JMP       121          ; PC := 121
109 [-]: GETUPVAL  R10 U16      ; R10 := U16
110 [-]: SELF      R10 R10 K22  ; R11 := R10; R10 := R10[0x73ac8bee]
111 [-]: GETUPVAL  R12 U11      ; R12 := U11
112 [-]: SELF      R12 R12 K23  ; R13 := R12; R12 := R12[0x26e191c7]
113 [-]: CALL      R12 2 0      ; R12,... := R12(R13)
114 [-]: CALL      R10 0 2      ; R10 := R10(R11,...)
115 [-]: LT        0 K18 R10    ; if 0.000000 >= R10 then PC := 121
116 [-]: JMP       121          ; PC := 121
117 [-]: GETUPVAL  R10 U17      ; R10 := U17
118 [-]: SELF      R10 R10 K24  ; R11 := R10; R10 := R10[0xfaa69527]
119 [-]: MOVE      R12 R1       ; R12 := R1
120 [-]: CALL      R10 3 1      ; R10(R11,R12)
121 [-]: GETUPVAL  R10 U17      ; R10 := U17
122 [-]: GETTABLE  R10 R10 K25  ; R10 := R10["mCleanedUp"]
123 [-]: TEST      R10 1        ; if R10 then PC := 139
124 [-]: JMP       139          ; PC := 139
125 [-]: GETUPVAL  R10 U18      ; R10 := U18
126 [-]: EQ        0 R2 R10     ; if R2 ~= R10 then PC := 139
127 [-]: JMP       139          ; PC := 139
128 [-]: GETUPVAL  R10 U16      ; R10 := U16
129 [-]: SELF      R10 R10 K22  ; R11 := R10; R10 := R10[0x73ac8bee]
130 [-]: GETUPVAL  R12 U11      ; R12 := U11
131 [-]: SELF      R12 R12 K23  ; R13 := R12; R12 := R12[0x26e191c7]
132 [-]: CALL      R12 2 0      ; R12,... := R12(R13)
133 [-]: CALL      R10 0 2      ; R10 := R10(R11,...)
134 [-]: EQ        0 R10 K18    ; if R10 ~= 0.000000 then PC := 139
135 [-]: JMP       139          ; PC := 139
136 [-]: GETUPVAL  R10 U17      ; R10 := U17
137 [-]: SELF      R10 R10 K26  ; R11 := R10; R10 := R10[0x44373b1e]
138 [-]: CALL      R10 2 1      ; R10(R11)
139 [-]: GETUPVAL  R10 U19      ; R10 := U19
140 [-]: SELF      R10 R10 K24  ; R11 := R10; R10 := R10[0xfaa69527]
141 [-]: MOVE      R12 R1       ; R12 := R1
142 [-]: CALL      R10 3 1      ; R10(R11,R12)
143 [-]: GETGLOBAL R10 K27      ; R10 := 0xcbd666e1
144 [-]: LOADK     R11 0        ; R11 := 0.000000
145 [-]: CALL      R10 2 1      ; R10(R11)
146 [-]: JMP       8            ; PC := 8
147 [-]: GETGLOBAL R10 K28      ; R10 := _T
148 [-]: GETTABLE  R10 R10 K29  ; R10 := R10[0x1a41a3c1]
149 [-]: GETUPVAL  R11 U4       ; R11 := U4
150 [-]: CALL      R10 2 1      ; R10(R11)
151 [-]: GETUPVAL  R10 U3       ; R10 := U3
152 [-]: SELF      R10 R10 K30  ; R11 := R10; R10 := R10[0x588ed000]
