...
L 2:  13 [-]: GETIMPORT R1 10; var1 = 0xA60D144A
      ...
      16 [-]: JUMPIFNOTLT R1 R0 L6; goto L6 if var1 >= var786510
...
L18:  90 [-]: LOADK R1 K31 ; var1 = 0.25
      91 [-]: JUMPIFNOTLE R0 R1 L19; goto L19 if var0 > var263
      92 [-]: GETUPVAL R1 0; var1 = upvalues[0]
      93 [-]: LOADN R3 1   ; var3 = 1
      94 [-]: DIVK R4 R0 K31; var4 = var0 / 0.25
...
L 8:  36 [-]: LOADK R1 K14 ; var1 = 0.25
      37 [-]: JUMPIFNOTLE R0 R1 L9; goto L9 if var0 > var263
      38 [-]: GETUPVAL R1 0; var1 = upvalues[0]
      39 [-]: DIVK R2 R0 K14; var2 = var0 / 0.25
...
L 2:  12 [-]: JUMPIF R2 L3 ; goto L3 if var2
      ...
      16 [-]: JUMPIFNOTLT R3 R2 L3; goto L3 if var3 >= var197198
...
L 9:  65 [-]: JUMPIF R2 L10; goto L10 if var2
      ...
      69 [-]: JUMPIFNOTLT R3 R2 L10; goto L10 if var3 >= var197198
...
L 2:  12 [-]: JUMPIF R2 L3 ; goto L3 if var2
      ...
      14 [-]: GETTABLE R2 R3 R1; var2 = var3[var1]
      15 [-]: LOADN R3 0   ; var3 = 0
      16 [-]: JUMPIFNOTLT R3 R2 L3; goto L3 if var3 >= var459342
