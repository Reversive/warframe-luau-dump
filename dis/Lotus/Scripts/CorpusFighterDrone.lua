...
; Max Stack Size:  3
       ...
       6 [-]: DUPCLOSURE R1 K5; 
       7 [-]: CAPTURE VAL R0; 
       8 [-]: SETGLOBAL R1 K6; "ClearSupportList" = var1
       9 [-]: DUPCLOSURE R1 K7; 
      10 [-]: DUPCLOSURE R2 K8; 
      11 [-]: CAPTURE VAL R1; 
      12 [-]: SETGLOBAL R2 K9; "EvaluateCanAttachToFighter" = var2
      13 [-]: DUPCLOSURE R2 K10; 
      14 [-]: CAPTURE VAL R0; 
      15 [-]: SETGLOBAL R2 K11; "WaitForEndAttach" = var2
      16 [-]: DUPCLOSURE R2 K12; 
      17 [-]: CAPTURE VAL R1; 
      18 [-]: SETGLOBAL R2 K13; "AttachSelfToFormationMembers" = var2
      19 [-]: DUPCLOSURE R2 K14; 
      20 [-]: SETGLOBAL R2 K15; "DecoDrone" = var2
      21 [-]: DUPCLOSURE R2 K16; 
      22 [-]: SETGLOBAL R2 K17; "DebugAttachDroneOnSpawn" = var2
      23 [-]: RETURN R0 0  ; 
...
L10:  58 [-]: GETTABLEKS R11 R10 K8; var11 = var10["Weight"]
      59 [-]: JUMPIFNOTLE R5 R11 L12; goto L12 if var5 > var1242172444
...
L 9:  45 [-]: GETIMPORT R3 9; var3 = _T["SupportDroneParents"]
      ...
      51 [-]: JUMPIFNOTEQ R2 R3 L10; goto L10 if var2 ~= var66075
...
L11:  58 [-]: NAMECALL R7 R1 K11; var8 = var1; var7 = var1[0x388577D5]
      ...
      60 [-]: JUMPIFNOTEQ R6 R7 L12; goto L12 if var6 ~= var1819
...
L 5:  32 [-]: NAMECALL R3 R0 K9; var4 = var0; var3 = var0[0xFA9E477F]
...
L 6:  37 [-]: JUMPIF R2 L7 ; goto L7 if var2
      38 [-]: NAMECALL R2 R0 K9; var3 = var0; var2 = var0[0xFA9E477F]
      39 [-]: CALL R2 2 2  ; var2 = var2(var3)
      40 [-]: LOADB R4 1   ; var4 = true
      41 [-]: NAMECALL R2 R2 K10; var3 = var2; var2 = var2[0xA29EAF94]
...
L 2:  10 [-]: JUMPIFNOT R1 L3; goto L3 if not var1
      ...
      12 [-]: LOADK R2 K5  ; var2 = 0.10000000000000001
...
L10:  79 [-]: JUMPIF R6 L16; goto L16 if var6
      ...
      87 [-]: JUMPIFNOTLE R6 R7 L15; goto L15 if var6 > var50544203
