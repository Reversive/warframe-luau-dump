...
; Max Stack Size:  8
       ...
       5 [-]: CALL R2 1 1  
       6 [-]: GETIMPORT R5 6 [0xE8072DED]
       7 [-]: LOADK R6 K7 ["{\"status\":%s}"]
       8 [-]: MOVE R7 R2   
       9 [-]: CALL R5 2 -1 
      10 [-]: NAMECALL R3 R1 K8 [0x83BFAED0]
      11 [-]: CALL R3 -1 0 
L 0:  12 [-]: GETIMPORT R2 10 [0xD644C2F1]
...
L 5:  32 [-]: NAMECALL R2 R1 K8 [0x5963DABA]
      ...
      36 [-]: RETURN R0 0  
L 6:  37 [-]: GETIMPORT R2 10 ["_T"]
      38 [-]: LOADB R3 1   
      39 [-]: SETTABLEKS R3 R2 K11 ["HubOperatorsAllowed"]
      40 [-]: GETIMPORT R2 10 ["_T"]
      41 [-]: GETIMPORT R3 13 ["ToggleOperatorCallbacks"]
      42 [-]: JUMPIF R3 L7 
      43 [-]: NEWTABLE R3 0 0
L 7:  44 [-]: SETTABLEKS R3 R2 K12 ["ToggleOperatorCallbacks"]
      45 [-]: GETIMPORT R3 13 ["ToggleOperatorCallbacks"]
      46 [-]: GETUPVAL R4 0
      47 [-]: FASTCALL2 52 R3 R4 L8
      48 [-]: GETIMPORT R2 16 [0x23D5322F]
      49 [-]: CALL R2 2 0  
L 8:  50 [-]: LOADNIL R2   
      51 [-]: LOADNIL R3   
L 9:  52 [-]: GETIMPORT R4 18 [0x89326C93]
...
L11:  66 [-]: GETIMPORT R7 23 [0xBE190284]
      67 [-]: FASTCALL1 62 R7 L12
      68 [-]: GETIMPORT R6 4 [0x7B998233]
      69 [-]: CALL R6 1 1  
L12:  70 [-]: JUMPIF R6 L13
      71 [-]: GETIMPORT R6 23 [0xBE190284]
      72 [-]: NAMECALL R6 R6 K24 [0xFFE25891]
      73 [-]: CALL R6 1 1  
      74 [-]: JUMPIF R6 L15
L13:  75 [-]: GETIMPORT R7 13 ["ToggleOperatorCallbacks"]
      76 [-]: FASTCALL1 62 R7 L14
      77 [-]: GETIMPORT R6 4 [0x7B998233]
      78 [-]: CALL R6 1 1  
L14:  79 [-]: JUMPIF R6 L20
      80 [-]: GETIMPORT R6 26 [0x9C1F3B5A]
      81 [-]: GETIMPORT R7 13 ["ToggleOperatorCallbacks"]
      82 [-]: CALL R6 1 0  
      83 [-]: RETURN R0 0  
...
L18: 109 [-]: MOVE R2 R4   
     110 [-]: MOVE R3 R5   
L19: 111 [-]: GETIMPORT R5 6 [0xCBD666E1]
     112 [-]: LOADN R6 0   
     113 [-]: CALL R5 1 0  
     114 [-]: JUMPBACK L9  
L20: 115 [-]: RETURN R0 0  
...
; Max Stack Size:  13
       ...
       3 [-]: CALL R3 1 1  
L 0:   4 [-]: JUMPIF R3 L1 
       5 [-]: GETIMPORT R3 4 ["HubOperatorsAllowed"]
       6 [-]: JUMPIF R3 L2 
L 1:   7 [-]: RETURN R0 0  
...
L 4:  16 [-]: NAMECALL R4 R3 K6 [0xF596420F]
      17 [-]: CALL R4 1 0  
      18 [-]: GETIMPORT R4 8 [0xBE190284]
      19 [-]: MOVE R6 R2   
      20 [-]: NAMECALL R4 R4 K9 [0xDCD5F934]
      21 [-]: CALL R4 2 1  
      22 [-]: JUMPIFNOT R1 L7
      23 [-]: NEWTABLE R5 0 6
      24 [-]: GETIMPORT R6 11 [0x0469F296]
      ...
      32 [-]: CALL R8 1 1  
      33 [-]: GETIMPORT R9 11 [0x0469F296]
      34 [-]: LOADK R10 K15 ["TintColor3"]
      35 [-]: CALL R9 1 1  
      36 [-]: GETIMPORT R10 11 [0x0469F296]
      37 [-]: LOADK R11 K16 ["EmissiveTintColorHi"]
      38 [-]: CALL R10 1 1 
      39 [-]: GETIMPORT R11 11 [0x0469F296]
