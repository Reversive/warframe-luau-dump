...
L 0:   7 [-]: JUMPIF R2 L1 
      ...
      13 [-]: CALL R2 2 0  
      14 [-]: GETIMPORT R2 8 [0xE78011B2]
      15 [-]: LOADN R3 0   
      16 [-]: JUMPIFNOTLT R3 R2 L1
      17 [-]: GETIMPORT R2 10 [0xCBD666E1]
      18 [-]: GETIMPORT R3 8 [0xE78011B2]
      19 [-]: CALL R2 1 0  
      20 [-]: LOADB R4 1   
...
L 0:   7 [-]: JUMPIF R2 L3 
       ...
       9 [-]: NAMECALL R2 R1 K5 [0x543A0B5E]
      10 [-]: CALL R2 2 0  
      11 [-]: GETIMPORT R2 7 [0x48749AC8]
      12 [-]: GETIMPORT R3 9 ["EMPTY_SYMBOL"]
      13 [-]: JUMPIFNOTEQ R2 R3 L1
      14 [-]: GETIMPORT R4 11 [0xB8B2CFE2]
      15 [-]: NAMECALL R2 R1 K12 [0x8CFF1D7A]
      16 [-]: CALL R2 2 0  
      17 [-]: JUMP L2
     
L 1:  18 [-]: GETIMPORT R4 7 [0x48749AC8]
      19 [-]: NAMECALL R2 R1 K13 [0xFF185F7E]
      20 [-]: CALL R2 2 0  
L 2:  21 [-]: GETIMPORT R2 15 [0xE78011B2]
      22 [-]: LOADN R3 0   
      23 [-]: JUMPIFNOTLT R3 R2 L3
      24 [-]: GETIMPORT R2 17 [0xCBD666E1]
      25 [-]: GETIMPORT R3 15 [0xE78011B2]
      26 [-]: CALL R2 1 0  
      27 [-]: LOADB R4 1   
...
; Max Stack Size:  5
       ...
       6 [-]: CALL R2 1 1  
L 0:   7 [-]: JUMPIF R2 L4 
       8 [-]: GETIMPORT R4 6 [0x6038A54D]
       9 [-]: NAMECALL R2 R1 K7 [0x96AB9074]
      10 [-]: CALL R2 2 0  
      11 [-]: GETIMPORT R2 9 [0xB8B2CFE2]
      12 [-]: LOADN R3 0   
      13 [-]: JUMPIFLE R3 R2 L1
      14 [-]: GETIMPORT R2 11 [0x48749AC8]
...
L 1:  18 [-]: LOADB R4 0   
      ...
      22 [-]: LOADK R3 K16 [0.5]
      23 [-]: CALL R2 1 0  
      24 [-]: GETIMPORT R2 11 [0x48749AC8]
      25 [-]: GETIMPORT R3 18 ["EMPTY_SYMBOL"]
      26 [-]: JUMPIFNOTEQ R2 R3 L2
      27 [-]: GETIMPORT R4 9 [0xB8B2CFE2]
      28 [-]: NAMECALL R2 R1 K19 [0x8CFF1D7A]
      29 [-]: CALL R2 2 0  
      30 [-]: JUMP L3
     
L 2:  31 [-]: GETIMPORT R4 11 [0x48749AC8]
      32 [-]: NAMECALL R2 R1 K20 [0xFF185F7E]
      33 [-]: CALL R2 2 0  
L 3:  34 [-]: GETIMPORT R2 22 [0xE78011B2]
      35 [-]: LOADN R3 0   
      36 [-]: JUMPIFNOTLT R3 R2 L4
      37 [-]: GETIMPORT R2 15 [0xCBD666E1]
      38 [-]: GETIMPORT R3 22 [0xE78011B2]
      39 [-]: CALL R2 1 0  
      40 [-]: LOADB R4 1   
