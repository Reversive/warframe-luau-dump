...
; Max Stack Size:  10
       ...
       3 [-]: CALL R2 2 1  
       4 [-]: GETIMPORT R5 4 ["gSkeletalClothExType"]
...
L 0:   8 [-]: JUMPIF R6 L1 
      ...
      11 [-]: CALL R6 2 0  
      12 [-]: GETIMPORT R8 7 [0xF7F90318]
      13 [-]: GETIMPORT R10 10 [0x55156FF7]
      14 [-]: CALL R10 0 1 
      ...
      18 [-]: MUL R6 R7 R5 
      19 [-]: LOADN R9 3   
      20 [-]: GETIMPORT R10 12 [0xDFEBB754]
      21 [-]: GETIMPORT R13 10 [0x55156FF7]
      22 [-]: CALL R13 0 1 
      ...
      26 [-]: ADD R8 R9 R10
      27 [-]: MUL R7 R8 R5 
      28 [-]: GETIMPORT R10 7 [0xF7F90318]
      29 [-]: GETIMPORT R13 10 [0x55156FF7]
      30 [-]: CALL R13 0 1 
      ...
      34 [-]: MULK R9 R10 K5 [2]
      35 [-]: MUL R8 R9 R5 
      36 [-]: GETIMPORT R11 16 [0xA421AF95]
      37 [-]: MOVE R12 R6  
      38 [-]: MOVE R13 R7  
      39 [-]: MOVE R14 R8  
      40 [-]: CALL R11 3 1 
...
; Max Stack Size:  28
       ...
       0 [-]: MOVE R1 R0   
       1 [-]: GETIMPORT R2 1 [0x9C95A150]
       2 [-]: JUMPIFNOT R2 L0
       3 [-]: NAMECALL R2 R0 K2 [0x647915F6]
       4 [-]: CALL R2 1 1  
       5 [-]: MOVE R1 R2   
L 0:   6 [-]: GETIMPORT R4 4 ["gLotusAvatarType"]
       7 [-]: NAMECALL R2 R1 K5 [0xF2DEAF69]
       8 [-]: CALL R2 2 1  
       9 [-]: JUMPIF R2 L1 
      10 [-]: RETURN R0 0  
L 1:  11 [-]: GETIMPORT R2 8 ["DissolveInstigator"]
      12 [-]: LOADNIL R3   
      13 [-]: GETIMPORT R4 10 [0x60130201]
      14 [-]: CALL R4 0 1  
      15 [-]: LOADN R5 47  
      ...
      26 [-]: CALL R5 1 1  
L 2:  27 [-]: JUMPIF R5 L4 
      28 [-]: GETIMPORT R7 18 ["gTennoAvatarType"]
...
L 6:  68 [-]: MOVE R14 R11 
      ...
      73 [-]: MOVE R13 R5  
      74 [-]: GETIMPORT R12 16 [0x7B998233]
      75 [-]: CALL R12 1 1 
L 7:  76 [-]: JUMPIF R12 L8
      77 [-]: GETIMPORT R14 31 [0x393B6D88]
      78 [-]: GETIMPORT R15 33 ["EMPTY_SYMBOL"]
      79 [-]: GETIMPORT R16 35 ["ZERO_VECTOR"]
      80 [-]: GETIMPORT R17 37 ["ZERO_ROTATION"]
      81 [-]: MOVE R18 R3  
...
L 9:  86 [-]: GETIMPORT R11 31 [0x393B6D88]
      87 [-]: GETIMPORT R12 33 ["EMPTY_SYMBOL"]
      88 [-]: GETIMPORT R13 35 ["ZERO_VECTOR"]
      89 [-]: GETIMPORT R14 37 ["ZERO_ROTATION"]
      90 [-]: MOVE R15 R3  
...
L10:  93 [-]: NAMECALL R9 R1 K39 [0xEF8E8F7F]
     ...
     101 [-]: MOVE R13 R10 
     102 [-]: GETIMPORT R12 16 [0x7B998233]
     103 [-]: CALL R12 1 1 
L11: 104 [-]: JUMPIF R12 L12
     105 [-]: GETIMPORT R13 44 [0x3630E649]
     106 [-]: LOADN R14 1  
     107 [-]: LENGTH R15 R10
     108 [-]: CALL R13 2 1 
     109 [-]: GETTABLE R12 R10 R13
     110 [-]: GETTABLEKS R11 R12 K45 ["mBoneName"]
     111 [-]: GETIMPORT R13 47 [0x89326C93]
     112 [-]: GETIMPORT R15 49 [0x1B9C89BE]
     113 [-]: MOVE R18 R11 
     114 [-]: NAMECALL R16 R1 K50 [0x003C792F]
     115 [-]: CALL R16 2 1 
     116 [-]: GETIMPORT R17 37 ["ZERO_ROTATION"]
     117 [-]: MOVE R18 R3  
     118 [-]: NAMECALL R13 R13 K51 [0x05909209]
     119 [-]: CALL R13 5 0 
L12: 120 [-]: FASTCALL1 62 R11 L13
     121 [-]: MOVE R13 R11 
     122 [-]: GETIMPORT R12 16 [0x7B998233]
     123 [-]: CALL R12 1 1 
L13: 124 [-]: JUMPIFNOT R12 L14
     125 [-]: GETIMPORT R12 23 [0x0469F296]
...
L15: 144 [-]: LOADN R15 1  
     ...
     147 [-]: MOVE R16 R1  
     148 [-]: GETIMPORT R15 16 [0x7B998233]
     149 [-]: CALL R15 1 1 
...
L18: 170 [-]: JUMPIF R19 L23
     ...
     179 [-]: MOVE R23 R12 
     180 [-]: CALL R19 4 0 
     181 [-]: GETIMPORT R20 55 [0x42DCC9F5]
...
L24: 212 [-]: FASTCALL1 62 R5 L25
     213 [-]: MOVE R20 R5  
     214 [-]: GETIMPORT R19 16 [0x7B998233]
     215 [-]: CALL R19 1 1 
L25: 216 [-]: JUMPIF R19 L28
     ...
     224 [-]: GETIMPORT R27 62 [0x722615AB]
     225 [-]: MUL R25 R26 R27
     226 [-]: CALL R19 6 0 
     227 [-]: FASTCALL1 62 R11 L26
     228 [-]: MOVE R20 R11 
     229 [-]: GETIMPORT R19 16 [0x7B998233]
     230 [-]: CALL R19 1 1 
...
L27: 237 [-]: LOADK R19 K63 [0.69999999999999996]
     ...
     240 [-]: JUMPIF R19 L29
     241 [-]: GETIMPORT R19 66 [0xC48556BC]
     242 [-]: MOVE R20 R5  
     243 [-]: GETIMPORT R21 68 ["gParticleSysType"]
     244 [-]: CALL R19 2 0 
     245 [-]: LOADB R19 1  
...
L31: 254 [-]: GETUPVAL R15 2
     ...
     263 [-]: MOVE R16 R11 
     264 [-]: GETIMPORT R15 16 [0x7B998233]
     265 [-]: CALL R15 1 1 
L32: 266 [-]: JUMPIF R15 L33
     ...
     270 [-]: MOVE R18 R12 
     271 [-]: CALL R15 3 0 
L33: 272 [-]: GETIMPORT R15 70 [0xCBD666E1]
     273 [-]: LOADN R16 0  
     274 [-]: CALL R15 1 0 
     275 [-]: GETIMPORT R16 72 [0x67652851]
     276 [-]: CALL R16 0 1 
     277 [-]: GETIMPORT R17 74 [0x91BE34E1]
     278 [-]: MUL R15 R16 R17
     279 [-]: ADD R6 R6 R15
     280 [-]: JUMPBACK L15 
...
L36: 296 [-]: GETIMPORT R15 76 [0xBE190284]
     ...
     305 [-]: MOVE R18 R15 
     306 [-]: GETIMPORT R17 16 [0x7B998233]
     307 [-]: CALL R17 1 1 
L37: 308 [-]: JUMPIFNOT R17 L38
     309 [-]: RETURN R0 0  
L38: 310 [-]: FASTCALL1 62 R16 L39
     311 [-]: MOVE R18 R16 
     312 [-]: GETIMPORT R17 16 [0x7B998233]
     313 [-]: CALL R17 1 1 
L39: 314 [-]: JUMPIF R17 L40
     315 [-]: RETURN R0 0  
L40: 316 [-]: GETIMPORT R17 18 ["gTennoAvatarType"]
...
L41: 321 [-]: FASTCALL1 62 R1 L42
     322 [-]: MOVE R16 R1  
     323 [-]: GETIMPORT R15 16 [0x7B998233]
     324 [-]: CALL R15 1 1 
...
L 3:  14 [-]: NAMECALL R2 R0 K3 [0xF14AE078]
      15 [-]: CALL R2 1 1  
      16 [-]: GETIMPORT R5 5 ["gLotusAvatarType"]
...
L 0:  18 [-]: MOVE R5 R1   
      ...
      30 [-]: LOADN R1 0   
      31 [-]: GETIMPORT R3 19 [0x60130201]
      32 [-]: GETIMPORT R4 22 [0x3630E649]
      33 [-]: LOADN R5 0   
      34 [-]: LOADN R6 255 
      35 [-]: CALL R4 2 1  
      36 [-]: GETIMPORT R5 22 [0x3630E649]
      37 [-]: LOADN R6 0   
      38 [-]: LOADN R7 255 
      39 [-]: CALL R5 2 1  
      40 [-]: GETIMPORT R6 22 [0x3630E649]
      41 [-]: LOADN R7 0   
      42 [-]: LOADN R8 255 
      43 [-]: CALL R6 2 1  
      44 [-]: LOADN R7 255 
      ...
      55 [-]: CALL R4 6 0  
      56 [-]: GETIMPORT R4 3 [0xA421AF95]
      57 [-]: GETIMPORT R7 22 [0x3630E649]
      58 [-]: CALL R7 0 1  
      59 [-]: SUBK R6 R7 K27 [0.5]
      60 [-]: MULK R5 R6 K27 [0.5]
      61 [-]: GETIMPORT R7 22 [0x3630E649]
      62 [-]: CALL R7 0 1  
      63 [-]: MULK R6 R7 K15 [2]
      64 [-]: GETIMPORT R9 22 [0x3630E649]
      65 [-]: CALL R9 0 1  
      66 [-]: SUBK R8 R9 K27 [0.5]
      67 [-]: MULK R7 R8 K27 [0.5]
      68 [-]: CALL R4 3 1  
      69 [-]: MOVE R2 R4   
      70 [-]: GETIMPORT R6 8 [0x0469F296]
