...
L 0:   4 [-]: JUMPIFNOT R1 L1
       5 [-]: RETURN R0 0  
L 1:   6 [-]: GETIMPORT R1 4 ["gActiveMatchMakingMode"]
       7 [-]: GETIMPORT R2 6 ["MATCHMAKING_OFFLINE_GAMEMODE"]
       8 [-]: JUMPIFEQ R1 R2 L4
       9 [-]: GETIMPORT R1 8 [0xE7F2B02F]
...
L 3:  25 [-]: GETIMPORT R2 14 [0x3D106989]
...
L 4:  39 [-]: GETUPVAL R1 0
      40 [-]: LOADNIL R2   
      41 [-]: GETIMPORT R4 21 ["gPendingMission"]
      42 [-]: FASTCALL1 62 R4 L5
      43 [-]: GETIMPORT R3 1 [0x7B998233]
      44 [-]: CALL R3 1 1  
L 5:  45 [-]: JUMPIF R3 L7 
      46 [-]: GETIMPORT R4 23 ["tile"]
      47 [-]: FASTCALL1 62 R4 L6
      48 [-]: GETIMPORT R3 1 [0x7B998233]
      49 [-]: CALL R3 1 1  
L 6:  50 [-]: JUMPIF R3 L7 
      51 [-]: GETIMPORT R3 25 [0xB009BBC6]
      52 [-]: GETIMPORT R4 23 ["tile"]
      53 [-]: CALL R3 1 1  
      54 [-]: MOVE R2 R3   
      55 [-]: JUMP L9
...
L10:  69 [-]: JUMPIF R3 L12
      70 [-]: GETIMPORT R5 27 ["gDangerRoomTileItemType"]
...
L11:  80 [-]: JUMPIF R4 L12
      81 [-]: MOVE R1 R3   
L12:  82 [-]: GETIMPORT R3 32 [0x68D83431]
      83 [-]: CALL R3 0 1  
     ...
     103 [-]: GETIMPORT R6 42 [0xBE190284]
     104 [-]: FASTCALL1 62 R6 L13
     105 [-]: GETIMPORT R5 1 [0x7B998233]
     106 [-]: CALL R5 1 1  
L13: 107 [-]: JUMPIF R5 L15
     108 [-]: GETIMPORT R5 42 [0xBE190284]
     ...
     120 [-]: GETIMPORT R7 42 [0xBE190284]
...
L15: 125 [-]: GETUPVAL R6 1
     ...
     129 [-]: LOADB R8 0   
     130 [-]: CALL R5 3 0  
     131 [-]: GETIMPORT R5 8 [0xE7F2B02F]
     132 [-]: NAMECALL R5 R5 K48 [0xCA33534D]
     133 [-]: CALL R5 1 1  
     134 [-]: JUMPIFNOT R5 L16
     135 [-]: GETIMPORT R5 42 [0xBE190284]
     136 [-]: LOADB R7 1   
     137 [-]: NAMECALL R5 R5 K49 [0x39C667A9]
     138 [-]: CALL R5 2 0  
L16: 139 [-]: GETIMPORT R5 8 [0xE7F2B02F]
     ...
     146 [-]: GETIMPORT R6 8 [0xE7F2B02F]
     147 [-]: GETIMPORT R8 57 [0xB139D7BC]
     148 [-]: MOVE R9 R5   
     149 [-]: CALL R8 1 -1 
     150 [-]: NAMECALL R6 R6 K58 [0xD8F4F9D0]
     151 [-]: CALL R6 -1 0 
L17: 152 [-]: GETIMPORT R5 60 [0x4E0A1DFC]
     153 [-]: MOVE R6 R3   
     154 [-]: CALL R5 1 0  
     155 [-]: RETURN R0 0  
...
L 0:   7 [-]: JUMPIFNOT R2 L2
      ...
      20 [-]: GETIMPORT R3 9 [0xE7F2B02F]
      21 [-]: GETIMPORT R5 16 [0xB139D7BC]
      22 [-]: MOVE R6 R2   
      23 [-]: CALL R5 1 -1 
...
L 4:  50 [-]: GETTABLE R9 R4 R7
      ...
      52 [-]: GETIMPORT R10 26 ["gDangerRoomTileItemType"]
      ...
      59 [-]: MOVE R9 R2   
      60 [-]: GETIMPORT R8 30 [0x23D5322F]
      61 [-]: CALL R8 2 0  
L 5:  62 [-]: FORNLOOP R5 L4
L 6:  63 [-]: NEWTABLE R4 0 0
      64 [-]: GETIMPORT R7 26 ["gDangerRoomTileItemType"]
      65 [-]: LOADB R8 0   
...
L14: 150 [-]: JUMPIFNOT R0 L15
     ...
     159 [-]: GETIMPORT R7 9 [0xE7F2B02F]
     160 [-]: GETIMPORT R9 16 [0xB139D7BC]
     161 [-]: MOVE R10 R6  
     162 [-]: CALL R9 1 -1 
...
; Max Stack Size:  12
      ...
      10 [-]: GETIMPORT R4 10 ["gAvatarType"]
      11 [-]: NAMECALL R2 R2 K11 [0xFB669000]
      12 [-]: CALL R2 2 1  
      13 [-]: GETIMPORT R3 13 [0xC8802016]
      14 [-]: MOVE R4 R2   
      15 [-]: CALL R3 1 3  
...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R1 2 ["spawnedAgents"]
       1 [-]: FASTCALL1 62 R1 L0
       2 [-]: GETIMPORT R0 4 [0x7B998233]
       3 [-]: CALL R0 1 1  
L 0:   4 [-]: JUMPIF R0 L1 
       5 [-]: GETIMPORT R0 6 ["PauseAI"]
       6 [-]: JUMPIF R0 L2 
L 1:   7 [-]: RETURN R0 0  
L 2:   8 [-]: GETIMPORT R0 2 ["spawnedAgents"]
       9 [-]: LOADNIL R1   
      10 [-]: LENGTH R4 R0 
      11 [-]: LOADN R2 1   
      12 [-]: LOADN R3 -1  
