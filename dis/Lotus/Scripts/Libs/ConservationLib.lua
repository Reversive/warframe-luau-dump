...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R0 2 ["currentConservationEncounter"]
       1 [-]: JUMPIF R0 L0 
       2 [-]: RETURN R0 0  
...
L 1:   7 [-]: JUMPIFNOT R1 L6
       8 [-]: GETIMPORT R1 7 ["activeConservationEncounters"]
       9 [-]: LENGTH R4 R1 
      10 [-]: LOADN R2 1   
      11 [-]: LOADN R3 -1  
      12 [-]: FORNPREP R2 L5
...
L 3:  18 [-]: JUMPIFNOT R6 L4
      19 [-]: GETIMPORT R6 10 [0x9C1F3B5A]
      20 [-]: MOVE R7 R1   
      21 [-]: MOVE R8 R4   
      22 [-]: CALL R6 2 0  
L 4:  23 [-]: FORNLOOP R2 L2
L 5:  24 [-]: GETIMPORT R2 11 ["_T"]
      25 [-]: LOADNIL R3   
...
; Max Stack Size:  5
       ...
       0 [-]: GETIMPORT R1 2 ["activeConservationEncounters"]
       1 [-]: JUMPIF R1 L0 
       2 [-]: GETIMPORT R1 3 ["_T"]
       3 [-]: NEWTABLE R2 0 0
...
L 0:   5 [-]: GETUPVAL R1 0
       6 [-]: MOVE R2 R0   
       7 [-]: CALL R1 1 1  
       8 [-]: GETIMPORT R3 2 ["activeConservationEncounters"]
       9 [-]: FASTCALL2 52 R3 R1 L1
      10 [-]: MOVE R4 R1   
      11 [-]: GETIMPORT R2 6 [0x23D5322F]
      12 [-]: CALL R2 2 0  
L 1:  13 [-]: GETIMPORT R3 8 ["pendingRequestedConservationEncounter"]
...
; Max Stack Size:  10
       ...
       0 [-]: GETIMPORT R1 2 ["currentConservationEncounter"]
       1 [-]: JUMPIFNOT R1 L0
...
L 0:   8 [-]: GETIMPORT R2 6 ["activeConservationEncounters"]
       9 [-]: LOADN R5 1   
      10 [-]: LENGTH R3 R2 
      11 [-]: LOADN R4 1   
      12 [-]: FORNPREP R3 L3
...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R4 2 ["activeConservationEncounters"]
       1 [-]: LENGTH R3 R4 
       2 [-]: LOADN R1 1   
       3 [-]: LOADN R2 -1  
       4 [-]: FORNPREP R1 L7
L 0:   5 [-]: GETIMPORT R5 2 ["activeConservationEncounters"]
       6 [-]: GETTABLE R4 R5 R3
...
L 1:  11 [-]: JUMPIFNOT R5 L2
      12 [-]: GETIMPORT R5 8 [0x9C1F3B5A]
      13 [-]: GETIMPORT R6 2 ["activeConservationEncounters"]
      14 [-]: MOVE R7 R3   
      15 [-]: CALL R5 2 0  
      16 [-]: JUMP L6
