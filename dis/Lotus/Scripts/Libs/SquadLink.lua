...
; Max Stack Size:  3
  ...
  6 [-]: GETTABLE  R1 R1 K2     ; R82 := R1[0x1946aea6]
  7 [-]: MOVE      R2 R0        ; R2 := R0
  8 [-]: CALL      R1 2 1       ; R1(R2)
...
; Max Stack Size:  11
 ...
 34 [-]: GETTABLE  R7 R7 K7     ; R82 := R7[0x66edf04f]
...
; Max Stack Size:  7
 ...
 18 [-]: GETTABLE  R4 R4 K3     ; R82 := R4[0x23d5322f]
 19 [-]: MOVE      R5 R3        ; R5 := R3
 20 [-]: MOVE      R6 R1        ; R6 := R1
...
; Max Stack Size:  12
 ...
 26 [-]: GETTABLE  R9 R9 K3     ; R82 := R9[0x9c1f3b5a]
