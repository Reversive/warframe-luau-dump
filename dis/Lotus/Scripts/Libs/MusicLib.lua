...
; Max Stack Size:  4
  ...
  8 [-]: GETGLOBAL R1 K0        ; R1 := 0x80000000
 ...
 19 [-]: SELF      R1 R1 K2     ; R2 := R1; R1 := R1[0x00000000]
 20 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 21 [-]: SETUPVAL  R1 U1        ; U82 := 
 22 [-]: GETGLOBAL R1 K0        ; R1 := 0x80000000
 ...
 30 [-]: SELF      R1 R1 K3     ; R2 := R1; R1 := R1[0x80000000]
 31 [-]: LOADBOOL  R3 1 0       ; R3 := true
 32 [-]: CALL      R1 3 1       ; R1(R2,R3)
 33 [-]: JMP       43           ; PC := 43
 34 [-]: GETUPVAL  R1 U1        ; R1 := U1
 35 [-]: SELF      R1 R1 K3     ; R2 := R1; R1 := R1[0x80000000]
 36 [-]: LOADBOOL  R3 0 0       ; R3 := false
 37 [-]: CALL      R1 3 1       ; R1(R2,R3)
 38 [-]: GETUPVAL  R1 U1        ; R1 := U1
 39 [-]: SELF      R1 R1 K4     ; R2 := R1; R1 := R1[0x00000000]
...
; Max Stack Size:  5
  ...
  8 [-]: GETGLOBAL R2 K0        ; R2 := 0x80000000
  9 [-]: GETUPVAL  R3 U1        ; R3 := U1
 10 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 11 [-]: TEST      R2 0         ; if not R2 then PC := 22
 12 [-]: JMP       22           ; PC := 22
 13 [-]: GETGLOBAL R2 K0        ; R2 := 0x80000000
 14 [-]: GETUPVAL  R3 U0        ; R3 := U0
 15 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 16 [-]: TEST      R2 1         ; if R2 then PC := 22
 17 [-]: JMP       22           ; PC := 22
 18 [-]: GETUPVAL  R2 U0        ; R2 := U0
 19 [-]: SELF      R2 R2 K2     ; R3 := R2; R2 := R2[0x00000000]
 20 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 21 [-]: SETUPVAL  R2 U1        ; U82 := 
 22 [-]: GETGLOBAL R2 K0        ; R2 := 0x80000000
 23 [-]: MOVE      R3 R1        ; R3 := R1
 ...
 35 [-]: SELF      R2 R2 K5     ; R3 := R2; R2 := R2[0x80000000]
 36 [-]: LOADBOOL  R4 0 0       ; R4 := false
 37 [-]: CALL      R2 3 1       ; R2(R3,R4)
 38 [-]: GETGLOBAL R2 K0        ; R2 := 0x80000000
 39 [-]: MOVE      R3 R0        ; R3 := R0
 ...
 47 [-]: SELF      R2 R2 K7     ; R3 := R2; R2 := R2[0x00000000]
 48 [-]: MOVE      R4 R1        ; R4 := R1
 49 [-]: CALL      R2 3 1       ; R2(R3,R4)
 50 [-]: JMP       55           ; PC := 55
 51 [-]: GETUPVAL  R2 U1        ; R2 := U1
 52 [-]: SELF      R2 R2 K8     ; R3 := R2; R2 := R2[0x80000000]
 53 [-]: MOVE      R4 R0        ; R4 := R0
