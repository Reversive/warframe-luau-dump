...
; Max Stack Size:  25
 ...
 22 [-]: JMP       24           ; PC := 24
 23 [-]: OP_LOADBOOL R13 0 1      ; R13 := false; PC := 24
...
107 [-]: OP_LOADBOOL R21 0 0      ; R21 := false
...
144 [-]: LOADK     R23 15       ; R23 := 15.000000
...
; Max Stack Size:  12
 ...
 30 [-]: GETTABLE  R8 R8 K6     ; R82 := R8[0xb62ecfe0]
 31 [-]: MOVE      R9 R2        ; R9 := R2
 ...
 46 [-]: GETTABLE  R9 R9 K6     ; R82 := R9[0xb62ecfe0]
...
; Max Stack Size:  14
  ...
  9 [-]: OP_LOADBOOL R11 0 0      ; R11 := false
...
; Max Stack Size:  28
 ...
 60 [-]: JMP       62           ; PC := 62
 61 [-]: OP_LOADBOOL R13 0 1      ; R13 := false; PC := 62
...
120 [-]: OP_LOADBOOL R25 0 0      ; R25 := false
...
133 [-]: OP_LOADBOOL R25 0 0      ; R25 := false
...
; Max Stack Size:  28
  ...
  4 [-]: NOT       R6 R6        ; R6 := not R6
  5 [-]: LOADK     R7 30        ; R7 := 30.000000
  6 [-]: OP_LOADBOOL R8 1 0       ; R8 := true
  7 [-]: LOADK     R9 -1        ; R9 := -1.000000
  8 [-]: LOADNIL   R10 R10      ; R10 := nil
...
121 [-]: JMP       181          ; PC := 181
122 [-]: OP_LOADBOOL R15 0 0      ; R15 := false
...
186 [-]: LOADK     R26 40       ; R26 := 40.000000
187 [-]: LOADK     R27 60       ; R27 := 60.000000
...
; Max Stack Size:  6
 ...
 13 [-]: GETTABLE  R3 R3 K6     ; R82 := R3[0xa5c556b9]
 ...
 21 [-]: GETTABLE  R3 R3 K6     ; R82 := R3[0xa5c556b9]
 ...
 41 [-]: JMP       44           ; PC := 44
 42 [-]: OP_LOADBOOL R3 0 0       ; R3 := false
...
; Max Stack Size:  6
 ...
 16 [-]: GETTABLE  R3 R3 K4     ; R82 := R3[0x23d5322f]
