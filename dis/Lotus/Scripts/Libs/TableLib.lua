...
; Max Stack Size:  15
 ...
 16 [-]: LT        0 K1 R11     ; if 0.000000 >= R11 then PC := 24
 17 [-]: JMP       24           ; PC := 24
 ...
 23 [-]: ADD       R6 R6 K0     ; R6 := R6 + 1.000000
...
; Max Stack Size:  12
  ...
  5 [-]: JMP       9            ; PC := 9
  6 [-]: GETGLOBAL R5 K0        ; R5 := 0xcbd666e1
  7 [-]: LOADK     R6 0         ; R6 := 0.000000
  8 [-]: CALL      R5 2 1       ; R5(R6)
  9 [-]: GETGLOBAL R5 K1        ; R5 := 0x5bced4c4
 10 [-]: GETTABLE  R5 R5 K2     ; R82 := R5[0x55f27c30]
 11 [-]: SUB       R6 R2 R1     ; R6 := R2 - R1
 12 [-]: DIV       R6 R6 K3     ; R6 := R6 / 2.000000
...
; Max Stack Size:  8
  ...
  8 [-]: GETGLOBAL R2 K1        ; R2 := 0xcfc01047
  9 [-]: MOVE      R3 R0        ; R3 := R0
...
; Max Stack Size:  11
  ...
  4 [-]: GETGLOBAL R4 K0        ; R4 := 0xcfc01047
  5 [-]: MOVE      R5 R0        ; R5 := R0
...
; Max Stack Size:  16
  ...
  8 [-]: GETTABLE  R5 R5 K1     ; R82 := R5[0x59b0bc8a]
  9 [-]: MOVE      R6 R0        ; R6 := R0
 ...
 25 [-]: ADD       R3 R3 K2     ; R3 := R3 + 1.000000
 ...
 33 [-]: SETTABLE  R4 R15 K3    ; R4[R15] := nil
...
; Max Stack Size:  11
  ...
  8 [-]: GETGLOBAL R3 K1        ; R3 := 0xcfc01047
  9 [-]: MOVE      R4 R0        ; R4 := R0
...
; Max Stack Size:  6
  ...
  5 [-]: LT        0 K0 R2      ; if 0.000000 >= R2 then PC := 12
  6 [-]: JMP       12           ; PC := 12
  7 [-]: GETGLOBAL R3 K1        ; R3 := 0x33bdd652
  8 [-]: GETTABLE  R3 R3 K2     ; R82 := R3[0x9c1f3b5a]
  9 [-]: MOVE      R4 R0        ; R4 := R0
 10 [-]: MOVE      R5 R2        ; R5 := R2
...
; Max Stack Size:  17
  ...
  2 [-]: LEN       R3 R1        ; R3 := # R1
  3 [-]: LT        0 K0 R3      ; if 0.000000 >= R3 then PC := 23
  4 [-]: JMP       23           ; PC := 23
 ...
 13 [-]: EQ        0 R8 K0      ; if R8 ~= 0.000000 then PC := 20
 14 [-]: JMP       20           ; PC := 20
 15 [-]: GETGLOBAL R9 K2        ; R9 := 0x33bdd652
 16 [-]: GETTABLE  R9 R9 K3     ; R82 := R9[0x23d5322f]
 ...
 21 [-]: JMP       9            ; PC := 9
 22 [-]: JMP       34           ; PC := 34
 23 [-]: GETGLOBAL R9 K1        ; R9 := 0xc8802016
 24 [-]: MOVE      R10 R0       ; R10 := R0
 25 [-]: CALL      R9 2 4       ; R9,R10,R11 := R9(R10)
 26 [-]: JMP       32           ; PC := 32
 27 [-]: GETGLOBAL R14 K2       ; R14 := 0x33bdd652
 28 [-]: GETTABLE  R14 R14 K3   ; R82 := R14[0x23d5322f]
...
; Max Stack Size:  7
  ...
  4 [-]: JMP       28           ; PC := 28
  5 [-]: GETGLOBAL R3 K0        ; R3 := 0x0c5e62f9
 ...
 19 [-]: GETGLOBAL R4 K2        ; R4 := 0x33bdd652
 20 [-]: GETTABLE  R4 R4 K4     ; R82 := R4[0x9c1f3b5a]
 21 [-]: MOVE      R5 R0        ; R5 := R0
 22 [-]: MOVE      R6 R3        ; R6 := R3
...
; Max Stack Size:  9
  ...
  1 [-]: LEN       R3 R0        ; R3 := # R0
  2 [-]: EQ        0 R3 K0      ; if R3 ~= 1.000000 then PC := 5
  3 [-]: JMP       5            ; PC := 5
...
; Max Stack Size:  8
  ...
  2 [-]: GETTABLE  R1 R1 K1     ; R82 := R1[0x59b0bc8a]
  3 [-]: MOVE      R2 R0        ; R2 := R0
 ...
 14 [-]: GETTABLE  R5 R5 K3     ; R82 := R5[0x9c1f3b5a]
 15 [-]: MOVE      R6 R0        ; R6 := R0
 16 [-]: MOVE      R7 R4        ; R7 := R4
...
; Max Stack Size:  8
  ...
  5 [-]: GETGLOBAL R5 K0        ; R5 := 0x55730e1a
...
; Max Stack Size:  10
 ...
 13 [-]: ADD       R8 R8 K0     ; R8 := R8 + 1.000000
