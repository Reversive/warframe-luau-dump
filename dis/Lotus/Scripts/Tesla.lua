...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R2 1 [0xEC8BF25E]
       1 [-]: GETIMPORT R3 3 [0x476080CB]
       2 [-]: ADD R1 R2 R3 
       3 [-]: LOADN R3 0   
       4 [-]: GETIMPORT R5 5 [0xBE190284]
      ...
      10 [-]: CALL R2 2 1  
L 0:  11 [-]: GETIMPORT R3 11 [0xC62A6BE2]
      12 [-]: ADD R4 R0 R2 
      13 [-]: GETIMPORT R6 13 [0xFA1B5621]
      14 [-]: ADD R5 R1 R6 
      15 [-]: CALL R3 2 1  
      16 [-]: JUMPIFNOTLE R1 R3 L1
      17 [-]: LOADN R4 0   
      18 [-]: RETURN R4 1  
L 1:  19 [-]: GETIMPORT R4 1 [0xEC8BF25E]
      20 [-]: JUMPIFNOTLT R3 R4 L2
      21 [-]: GETIMPORT R5 1 [0xEC8BF25E]
      22 [-]: DIV R4 R3 R5 
      23 [-]: RETURN R4 1  
L 2:  24 [-]: SUB R5 R1 R3 
      25 [-]: GETIMPORT R6 3 [0x476080CB]
      26 [-]: DIV R4 R5 R6 
      27 [-]: RETURN R4 1  
...
L 0:   3 [-]: NAMECALL R1 R0 K2 [0xC3962B21]
       ...
       6 [-]: CALL R2 1 1  
       7 [-]: GETIMPORT R4 6 ["TeslaTracking"]
       8 [-]: FASTCALL1 62 R4 L1
       9 [-]: GETIMPORT R3 8 [0x7B998233]
      10 [-]: CALL R3 1 1  
L 1:  11 [-]: JUMPIFNOT R3 L2
      12 [-]: GETIMPORT R3 9 ["_T"]
      13 [-]: NEWTABLE R4 0 0
      14 [-]: SETTABLEKS R4 R3 K5 ["TeslaTracking"]
L 2:  15 [-]: GETIMPORT R3 6 ["TeslaTracking"]
      16 [-]: NEWTABLE R4 0 0
      17 [-]: SETTABLE R4 R3 R2
      18 [-]: GETIMPORT R4 6 ["TeslaTracking"]
...
L 3:  21 [-]: NAMECALL R5 R1 K10 [0x2047CFE7]
      ...
      32 [-]: CALL R6 1 -1 
      33 [-]: CALL R5 -1 1 
      34 [-]: GETIMPORT R7 16 [0xB8E7D9FD]
      35 [-]: GETIMPORT R10 18 [0xC2D46203]
      36 [-]: GETIMPORT R11 16 [0xB8E7D9FD]
      37 [-]: SUB R9 R10 R11
      38 [-]: MUL R8 R9 R5 
      39 [-]: ADD R6 R7 R8 
      40 [-]: LENGTH R7 R3 
      ...
      45 [-]: GETIMPORT R7 21 [0x35C16153]
      46 [-]: CALL R7 0 1  
      47 [-]: SETTABLEKS R6 R7 K22 ["baseAmount"]
      48 [-]: GETIMPORT R10 24 [0x0C212CB3]
      49 [-]: LOADN R11 1  
      ...
      60 [-]: CALL R8 2 0  
      61 [-]: GETIMPORT R8 30 [0xC8802016]
      62 [-]: MOVE R9 R3   
      63 [-]: CALL R8 1 3  
      64 [-]: FORGPREP_INEXT R8 L6
L 4:  65 [-]: FASTCALL1 62 R12 L5
      66 [-]: MOVE R14 R12 
      67 [-]: GETIMPORT R13 8 [0x7B998233]
      68 [-]: CALL R13 1 1 
...
L 7:  81 [-]: GETIMPORT R5 34 [0xCBD666E1]
      82 [-]: LOADN R6 0   
      83 [-]: CALL R5 1 0  
      84 [-]: JUMPBACK L3  
L 8:  85 [-]: GETIMPORT R5 6 ["TeslaTracking"]
      86 [-]: LOADNIL R6   
...
L 1:  10 [-]: NAMECALL R5 R4 K5 [0x388577D5]
      11 [-]: CALL R5 1 1  
      12 [-]: GETIMPORT R7 8 ["TeslaTracking"]
...
L 1:  14 [-]: NAMECALL R5 R4 K5 [0x388577D5]
      15 [-]: CALL R5 1 1  
      16 [-]: GETIMPORT R7 8 ["TeslaTracking"]
      17 [-]: GETTABLE R6 R7 R5
      18 [-]: GETIMPORT R7 10 [0xC8802016]
      19 [-]: MOVE R8 R6   
      20 [-]: CALL R7 1 3  
      21 [-]: FORGPREP_INEXT R7 L3
L 2:  22 [-]: JUMPIFNOTEQ R11 R1 L3
      23 [-]: GETIMPORT R12 13 [0x9C1F3B5A]
      24 [-]: MOVE R13 R6  
      25 [-]: MOVE R14 R10 
      26 [-]: CALL R12 2 0 
      27 [-]: RETURN R0 0  
