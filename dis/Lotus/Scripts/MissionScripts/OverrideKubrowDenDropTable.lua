...
; Max Stack Size:  12
      ...
      18 [-]: CALL R4 1 1  
      19 [-]: GETIMPORT R5 13 [0x55730E1A]
      20 [-]: MOVE R6 R3   
      21 [-]: MOVE R7 R4   
      22 [-]: CALL R5 2 1  
      23 [-]: GETIMPORT R7 16 ["KubrowQuestActive"]
      24 [-]: FASTCALL1 62 R7 L0
      25 [-]: GETIMPORT R6 18 [0x7B998233]
      26 [-]: CALL R6 1 1  
L 0:  27 [-]: JUMPIF R6 L1 
      28 [-]: GETIMPORT R6 16 ["KubrowQuestActive"]
      29 [-]: JUMPIFNOT R6 L1
      30 [-]: GETIMPORT R6 20 [0x3D106989]
      31 [-]: LOADK R7 K21 ["         the Kubrow quest is active! Updating the Drop table."]
      32 [-]: CALL R6 1 0  
      33 [-]: GETIMPORT R6 23 [0x41619A8F]
      34 [-]: MOVE R8 R0   
      35 [-]: MOVE R9 R2   
      36 [-]: MOVE R10 R5  
      37 [-]: GETIMPORT R11 25 [0xC49ED209]
      38 [-]: NAMECALL R6 R6 K26 [0xE4C98581]
      39 [-]: CALL R6 5 0  
      40 [-]: RETURN R0 0  
L 1:  41 [-]: GETIMPORT R6 20 [0x3D106989]
      42 [-]: LOADK R7 K27 ["         the Kubrow quest is not active! Using the default Drop table."]
      43 [-]: CALL R6 1 0  
      44 [-]: GETIMPORT R6 29 [0x4BDD194E]
      45 [-]: MOVE R8 R0   
      46 [-]: MOVE R9 R2   
      47 [-]: MOVE R10 R5  
      48 [-]: GETIMPORT R11 25 [0xC49ED209]
