...
; Max Stack Size:  4
 ...
 15 [-]: GETGLOBAL R1 K8        ; R1 := 0x74b75231
 16 [-]: CALL      R0 2 1       ; R0(R1)
 17 [-]: GETGLOBAL R0 K9        ; R0 := 0xbe190284
 18 [-]: SELF      R0 R0 K10    ; R1 := R0; R0 := R0[0xf9bfc5d9]
...
; Max Stack Size:  8
  ...
  2 [-]: GETGLOBAL R1 K1        ; R1 := 0xc45aa52c
  ...
  9 [-]: JMP       24           ; PC := 24
 10 [-]: SELF      R5 R4 K3     ; R6 := R4; R5 := R4[0x8eb2112d]
 11 [-]: LOADK     R7 K4        ; R7 := "Disable"
 12 [-]: CALL      R5 3 1       ; R5(R6,R7)
 13 [-]: SELF      R5 R4 K5     ; R6 := R4; R5 := R4[0xa2880940]
 14 [-]: CALL      R5 2 1       ; R5(R6)
 15 [-]: SELF      R5 R4 K6     ; R6 := R4; R5 := R4[0x1e3535e5]
 ...
 21 [-]: JMP       24           ; PC := 24
 22 [-]: SELF      R6 R5 K5     ; R7 := R5; R6 := R5[0xa2880940]
...
; Max Stack Size:  6
  ...
  2 [-]: GETTABLE  R0 R0 K0     ; R0 := R0[0x7e1c98b2]
  3 [-]: CALL      R0 1 2       ; R0 := R0()
 ...
 24 [-]: SELF      R2 R2 K9     ; R3 := R2; R2 := R2[0x66905cb0]
 25 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 26 [-]: SELF      R3 R2 K10    ; R4 := R2; R3 := R2[0xe2871589]
 27 [-]: GETGLOBAL R5 K6        ; R5 := 0xf614c2b0
...
; Max Stack Size:  15
 ...
 15 [-]: JMP       40           ; PC := 40
 16 [-]: SELF      R4 R3 K9     ; R5 := R3; R4 := R3[0x243148d6]
 ...
 23 [-]: SELF      R10 R0 K10   ; R11 := R0; R10 := R0[0x808b79e6]
 ...
 31 [-]: SELF      R11 R0 K11   ; R12 := R0; R11 := R0[0xe7c53f4e]
 32 [-]: MOVE      R13 R4       ; R13 := R4
 33 [-]: GETGLOBAL R14 K12      ; R14 := 0xdf4949c4
 34 [-]: SUB       R14 K6 R14   ; R14 := 1.000000 - R14
 35 [-]: CALL      R11 4 1      ; R11(R12,R13,R14)
 36 [-]: SELF      R11 R0 K11   ; R12 := R0; R11 := R0[0xe7c53f4e]
 37 [-]: MOVE      R13 R5       ; R13 := R5
 38 [-]: GETGLOBAL R14 K12      ; R14 := 0xdf4949c4
...
; Max Stack Size:  4
  ...
  1 [-]: GETGLOBAL R0 K0        ; R0 := 0xafc9267c
  2 [-]: LT        0 K1 R0      ; if 0.000000 >= R0 then PC := 7
  3 [-]: JMP       7            ; PC := 7
  4 [-]: GETGLOBAL R0 K2        ; R0 := 0xcbd666e1
  5 [-]: GETGLOBAL R1 K0        ; R1 := 0xafc9267c
  6 [-]: CALL      R0 2 1       ; R0(R1)
  7 [-]: GETUPVAL  R0 U0        ; R0 := U0
  8 [-]: GETTABLE  R0 R0 K3     ; R0 := R0[0xc474a99e]
  9 [-]: GETGLOBAL R1 K4        ; R1 := 0xf9f3cfcb
 10 [-]: GETGLOBAL R2 K5        ; R2 := 0x64fb1586
 11 [-]: GETGLOBAL R3 K6        ; R3 := 0x9ac423ae
 12 [-]: CALL      R2 2 0       ; R2,... := R2(R3)
 13 [-]: CALL      R0 0 1       ; R0(R1,...)
...
; Max Stack Size:  7
  ...
  6 [-]: SELF      R2 R1 K3     ; R3 := R1; R2 := R1[0x383d2e7d]
  7 [-]: LOADKB    R4 1 0       ; R4 := true
  8 [-]: CALL      R2 3 1       ; R2(R3,R4)
  9 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 10 [-]: GETGLOBAL R3 K5        ; R3 := 0xe91d7466
 11 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 12 [-]: TEST      R2 1         ; if R2 then PC := 17
 13 [-]: JMP       17           ; PC := 17
 14 [-]: GETGLOBAL R2 K6        ; R2 := _T
 15 [-]: GETGLOBAL R3 K5        ; R3 := 0xe91d7466
 16 [-]: SETTABLE  R2 K7 R3     ; R2["MissionTransmissionSet"] := R3
 17 [-]: GETGLOBAL R2 K8        ; R2 := 0x10752c3a
 18 [-]: TEST      R2 0         ; if not R2 then PC := 23
 19 [-]: JMP       23           ; PC := 23
 20 [-]: SELF      R2 R1 K9     ; R3 := R1; R2 := R1[0xe603bab2]
 21 [-]: LOADKB    R4 1 0       ; R4 := true
 22 [-]: CALL      R2 3 1       ; R2(R3,R4)
 23 [-]: SELF      R2 R1 K10    ; R3 := R1; R2 := R1[0x2faead12]
 24 [-]: GETGLOBAL R4 K11       ; R4 := 0x55907566
 25 [-]: CALL      R2 3 1       ; R2(R3,R4)
 26 [-]: GETGLOBAL R2 K12       ; R2 := 0x14459a1c
 27 [-]: TEST      R2 1         ; if R2 then PC := 106
 28 [-]: JMP       106          ; PC := 106
 29 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 30 [-]: GETGLOBAL R3 K13       ; R3 := 0x22cb4355
 31 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 32 [-]: TEST      R2 1         ; if R2 then PC := 40
 33 [-]: JMP       40           ; PC := 40
 34 [-]: GETUPVAL  R2 U0        ; R2 := U0
 35 [-]: GETTABLE  R2 R2 K14    ; R2 := R2[0x9742b85b]
 36 [-]: GETGLOBAL R3 K6        ; R3 := _T
 37 [-]: GETTABLE  R3 R3 K7     ; R3 := R3["MissionTransmissionSet"]
 38 [-]: GETGLOBAL R4 K13       ; R4 := 0x22cb4355
 39 [-]: CALL      R2 3 1       ; R2(R3,R4)
 40 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 41 [-]: GETGLOBAL R3 K15       ; R3 := 0x0757c943
 42 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 43 [-]: TEST      R2 0         ; if not R2 then PC := 68
 44 [-]: JMP       68           ; PC := 68
 45 [-]: GETGLOBAL R2 K16       ; R2 := 0x7e4a0241
 46 [-]: SELF      R2 R2 K17    ; R3 := R2; R2 := R2[0x56c01834]
 47 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 48 [-]: TEST      R2 0         ; if not R2 then PC := 68
 49 [-]: JMP       68           ; PC := 68
 50 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 51 [-]: MOVE      R3 R0        ; R3 := R0
 52 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 53 [-]: TEST      R2 1         ; if R2 then PC := 63
 54 [-]: JMP       63           ; PC := 63
 55 [-]: GETGLOBAL R2 K0        ; R2 := 0x89326c93
 56 [-]: SELF      R2 R2 K18    ; R3 := R2; R2 := R2[0xc7b81e8d]
 57 [-]: GETGLOBAL R4 K16       ; R4 := 0x7e4a0241
 58 [-]: SELF      R5 R0 K19    ; R6 := R0; R5 := R0[0xd1586535]
 59 [-]: CALL      R5 2 0       ; R5,... := R5(R6)
 60 [-]: CALL      R2 0 2       ; R2 := R2(R3,...)
 61 [-]: SETGLOBAL R2 K15       ; (0x0757c943) := R2
 62 [-]: JMP       68           ; PC := 68
 63 [-]: GETGLOBAL R2 K0        ; R2 := 0x89326c93
 64 [-]: SELF      R2 R2 K20    ; R3 := R2; R2 := R2[0x46a0ebf5]
 65 [-]: GETGLOBAL R4 K16       ; R4 := 0x7e4a0241
 66 [-]: CALL      R2 3 2       ; R2 := R2(R3,R4)
 67 [-]: SETGLOBAL R2 K15       ; (0x0757c943) := R2
 68 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 69 [-]: GETGLOBAL R3 K15       ; R3 := 0x0757c943
 70 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 71 [-]: TEST      R2 1         ; if R2 then PC := 80
 72 [-]: JMP       80           ; PC := 80
 73 [-]: GETGLOBAL R2 K15       ; R2 := 0x0757c943
 74 [-]: SELF      R2 R2 K21    ; R3 := R2; R2 := R2[0x8eb2112d]
 75 [-]: LOADK     R4 K22       ; R4 := "Enable"
 76 [-]: CALL      R2 3 1       ; R2(R3,R4)
 77 [-]: SELF      R2 R1 K23    ; R3 := R1; R2 := R1[0xe2871589]
 78 [-]: GETGLOBAL R4 K15       ; R4 := 0x0757c943
 79 [-]: CALL      R2 3 1       ; R2(R3,R4)
 80 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 81 [-]: GETGLOBAL R3 K24       ; R3 := 0x1bc64f74
 82 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 83 [-]: TEST      R2 1         ; if R2 then PC := 89
 84 [-]: JMP       89           ; PC := 89
 85 [-]: GETGLOBAL R2 K24       ; R2 := 0x1bc64f74
 86 [-]: SELF      R2 R2 K21    ; R3 := R2; R2 := R2[0x8eb2112d]
 87 [-]: LOADK     R4 K25       ; R4 := "TriggerPort"
 88 [-]: CALL      R2 3 1       ; R2(R3,R4)
 89 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 90 [-]: GETGLOBAL R3 K26       ; R3 := 0x8b08e32d
 91 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 92 [-]: TEST      R2 1         ; if R2 then PC := 106
 93 [-]: JMP       106          ; PC := 106
 94 [-]: GETGLOBAL R2 K26       ; R2 := 0x8b08e32d
 95 [-]: SELF      R2 R2 K17    ; R3 := R2; R2 := R2[0x56c01834]
 96 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 97 [-]: TEST      R2 0         ; if not R2 then PC := 106
 98 [-]: JMP       106          ; PC := 106
 99 [-]: GETUPVAL  R2 U1        ; R2 := U1
100 [-]: GETTABLE  R2 R2 K27    ; R2 := R2[0xa1df01d6]
101 [-]: GETGLOBAL R3 K28       ; R3 := 0x64fb1586
102 [-]: GETGLOBAL R4 K26       ; R4 := 0x8b08e32d
103 [-]: CALL      R3 2 2       ; R3 := R3(R4)
104 [-]: GETGLOBAL R4 K29       ; R4 := 0x9b6b3e3d
...
; Max Stack Size:  3
  ...
  3 [-]: GETGLOBAL R2 K2        ; R2 := 0x39312f1a
...
; Max Stack Size:  13
  ...
  5 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x8b5b1f58]
  6 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  7 [-]: GETGLOBAL R2 K2        ; R2 := 0xc8802016
  8 [-]: MOVE      R3 R1        ; R3 := R1
  9 [-]: CALL      R2 2 4       ; R2,R3,R4 := R2(R3)
 10 [-]: JMP       36           ; PC := 36
 11 [-]: SELF      R7 R6 K3     ; R8 := R6; R7 := R6[0xe79e7ef4]
 ...
 17 [-]: JMP       36           ; PC := 36
 18 [-]: SELF      R8 R7 K5     ; R9 := R7; R8 := R7[0x22da1852]
 ...
 29 [-]: JMP       35           ; PC := 35
 30 [-]: GETGLOBAL R9 K6        ; R9 := 0x0469f296
...
; Max Stack Size:  2
  ...
  1 [-]: GETUPVAL  R0 U0        ; R0 := U0
  2 [-]: GETGLOBAL R1 K0        ; R1 := 0xd4edb7e1
  3 [-]: CALL      R0 2 1       ; R0(R1)
...
; Max Stack Size:  4
  ...
  1 [-]: GETUPVAL  R0 U0        ; R0 := U0
  2 [-]: GETTABLE  R0 R0 K0     ; R0 := R0[0xedcef9d4]
  3 [-]: CALL      R0 1 1       ; R0()
  4 [-]: GETGLOBAL R0 K1        ; R0 := 0x10752c3a
 ...
 12 [-]: SELF      R1 R0 K5     ; R2 := R0; R1 := R0[0xe603bab2]
 13 [-]: GETGLOBAL R3 K1        ; R3 := 0x10752c3a
...
; Max Stack Size:  12
 ...
 17 [-]: GETGLOBAL R3 K6        ; R3 := 0xc8802016
 18 [-]: GETGLOBAL R4 K7        ; R4 := 0x14128b21
 ...
 25 [-]: JMP       21           ; PC := 21
 26 [-]: GETGLOBAL R8 K8        ; R8 := 0xb14b0088
 27 [-]: EQ        1 R1 R8      ; if R1 == R8 then PC := 31
 28 [-]: JMP       31           ; PC := 31
 29 [-]: TEST      R2 0         ; if not R2 then PC := 74
 30 [-]: JMP       74           ; PC := 74
 31 [-]: GETGLOBAL R8 K4        ; R8 := 0x7b998233
 32 [-]: GETGLOBAL R9 K9        ; R9 := 0x1bc64f74
 33 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 34 [-]: TEST      R8 1         ; if R8 then PC := 40
 35 [-]: JMP       40           ; PC := 40
 36 [-]: GETGLOBAL R8 K9        ; R8 := 0x1bc64f74
 37 [-]: SELF      R8 R8 K10    ; R9 := R8; R8 := R8[0x8eb2112d]
 38 [-]: LOADK     R10 K11      ; R10 := "TriggerPort"
 39 [-]: CALL      R8 3 1       ; R8(R9,R10)
 40 [-]: GETGLOBAL R8 K4        ; R8 := 0x7b998233
 41 [-]: GETGLOBAL R9 K12       ; R9 := 0x9c089cb8
 42 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 43 [-]: TEST      R8 1         ; if R8 then PC := 49
 44 [-]: JMP       49           ; PC := 49
 45 [-]: GETGLOBAL R8 K12       ; R8 := 0x9c089cb8
 46 [-]: SELF      R8 R8 K10    ; R9 := R8; R8 := R8[0x8eb2112d]
 47 [-]: LOADK     R10 K13      ; R10 := "Execute"
 48 [-]: CALL      R8 3 1       ; R8(R9,R10)
 49 [-]: GETGLOBAL R8 K4        ; R8 := 0x7b998233
 50 [-]: GETGLOBAL R9 K14       ; R9 := 0x4958f40c
 51 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 52 [-]: TEST      R8 1         ; if R8 then PC := 57
 53 [-]: JMP       57           ; PC := 57
 54 [-]: GETGLOBAL R8 K15       ; R8 := _T
 55 [-]: GETGLOBAL R9 K14       ; R9 := 0x4958f40c
 56 [-]: SETTABLE  R8 K16 R9    ; R8["MissionTransmissionSet"] := R9
 57 [-]: GETGLOBAL R8 K4        ; R8 := 0x7b998233
 58 [-]: GETGLOBAL R9 K17       ; R9 := 0xf9f3cfcb
 59 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 60 [-]: TEST      R8 1         ; if R8 then PC := 74
 61 [-]: JMP       74           ; PC := 74
 62 [-]: GETGLOBAL R8 K4        ; R8 := 0x7b998233
 63 [-]: GETGLOBAL R9 K18       ; R9 := 0x9ac423ae
 64 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 65 [-]: TEST      R8 1         ; if R8 then PC := 74
 66 [-]: JMP       74           ; PC := 74
 67 [-]: GETUPVAL  R8 U0        ; R8 := U0
 68 [-]: GETTABLE  R8 R8 K19    ; R8 := R8[0xc474a99e]
 69 [-]: GETGLOBAL R9 K17       ; R9 := 0xf9f3cfcb
 70 [-]: GETGLOBAL R10 K20      ; R10 := 0x64fb1586
 71 [-]: GETGLOBAL R11 K18      ; R11 := 0x9ac423ae
...
; Max Stack Size:  3
  ...
  8 [-]: GETGLOBAL R1 K3        ; R1 := 0xa2b4bebe
  9 [-]: CALL      R0 2 2       ; R0 := R0(R1)
 10 [-]: TEST      R0 1         ; if R0 then PC := 18
 11 [-]: JMP       18           ; PC := 18
 12 [-]: GETUPVAL  R0 U0        ; R0 := U0
 13 [-]: GETTABLE  R0 R0 K4     ; R0 := R0[0x9742b85b]
 14 [-]: GETGLOBAL R1 K1        ; R1 := _T
 15 [-]: GETTABLE  R1 R1 K2     ; R1 := R1["MissionTransmissionSet"]
 16 [-]: GETGLOBAL R2 K3        ; R2 := 0xa2b4bebe
 17 [-]: CALL      R0 3 1       ; R0(R1,R2)
 18 [-]: GETGLOBAL R0 K5        ; R0 := 0x074a456a
 19 [-]: TEST      R0 0         ; if not R0 then PC := 25
 20 [-]: JMP       25           ; PC := 25
 21 [-]: GETUPVAL  R0 U1        ; R0 := U1
 22 [-]: GETTABLE  R0 R0 K6     ; R0 := R0[0xdc3b2033]
 23 [-]: CALL      R0 1 1       ; R0()
 24 [-]: JMP       32           ; PC := 32
 25 [-]: GETUPVAL  R0 U1        ; R0 := U1
 26 [-]: GETTABLE  R0 R0 K7     ; R0 := R0[0xa1df01d6]
 27 [-]: GETGLOBAL R1 K8        ; R1 := 0x64fb1586
 28 [-]: GETGLOBAL R2 K9        ; R2 := 0x8b08e32d
 29 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 30 [-]: GETGLOBAL R2 K10       ; R2 := 0x9b6b3e3d
...
; Max Stack Size:  4
  ...
  2 [-]: SELF      R0 R0 K1     ; R1 := R0; R0 := R0[0x29ef273d]
  3 [-]: CALL      R0 2 2       ; R0 := R0(R1)
  4 [-]: SELF      R1 R0 K2     ; R2 := R0; R1 := R0[0x8955c0b5]
  5 [-]: GETGLOBAL R3 K3        ; R3 := 0x531eb85d
...
; Max Stack Size:  2
  ...
  1 [-]: GETGLOBAL R0 K0        ; R0 := 0x7b998233
  2 [-]: GETGLOBAL R1 K1        ; R1 := 0x4958f40c
  3 [-]: CALL      R0 2 2       ; R0 := R0(R1)
  4 [-]: TEST      R0 1         ; if R0 then PC := 9
  5 [-]: JMP       9            ; PC := 9
  6 [-]: GETGLOBAL R0 K2        ; R0 := _T
  7 [-]: GETGLOBAL R1 K1        ; R1 := 0x4958f40c
...
; Max Stack Size:  3
  ...
  4 [-]: SELF      R0 R0 K2     ; R1 := R0; R0 := R0[0x66905cb0]
  5 [-]: CALL      R0 2 2       ; R0 := R0(R1)
  6 [-]: SELF      R0 R0 K3     ; R1 := R0; R0 := R0[0xb8b90f91]
  7 [-]: GETGLOBAL R2 K4        ; R2 := 0x894a1eea
...
; Max Stack Size:  5
  ...
  3 [-]: GETGLOBAL R2 K2        ; R2 := 0x51b81345
...
; Max Stack Size:  4
  ...
  7 [-]: GETGLOBAL R3 K4        ; R3 := 0x55907566
...
; Max Stack Size:  4
  ...
  7 [-]: GETGLOBAL R3 K4        ; R3 := 0x10752c3a
  8 [-]: CALL      R1 3 1       ; R1(R2,R3)
  9 [-]: RETURN    R0 1         ; return 
...
; Max Stack Size:  4
  ...
  4 [-]: SELF      R0 R0 K2     ; R1 := R0; R0 := R0[0x66905cb0]
  5 [-]: CALL      R0 2 2       ; R0 := R0(R1)
  6 [-]: SELF      R1 R0 K3     ; R2 := R0; R1 := R0[0xc7c8dad6]
...
; Max Stack Size:  8
  ...
  6 [-]: SELF      R1 R0 K3     ; R2 := R0; R1 := R0[0x6968ea36]
  7 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  8 [-]: GETGLOBAL R2 K4        ; R2 := 0xb5985109
  9 [-]: SELF      R2 R2 K5     ; R3 := R2; R2 := R2[0x1e3535e5]
 10 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 11 [-]: SELF      R3 R2 K6     ; R4 := R2; R3 := R2[0x1fedcbcf]
 12 [-]: CONST     R5 -5        ; R5 := -5.000000
 13 [-]: CALL      R3 3 1       ; R3(R4,R5)
 14 [-]: SELF      R3 R2 K7     ; R4 := R2; R3 := R2[0x069d881f]
 15 [-]: LOADKB    R5 1 0       ; R5 := true
 16 [-]: CALL      R3 3 1       ; R3(R4,R5)
 17 [-]: SELF      R3 R2 K8     ; R4 := R2; R3 := R2[0x0cca925a]
 18 [-]: GETGLOBAL R5 K9        ; R5 := 0x0469f296
 19 [-]: LOADK     R6 K10       ; R6 := "TENNO"
 20 [-]: CALL      R5 2 0       ; R5,... := R5(R6)
 21 [-]: CALL      R3 0 1       ; R3(R4,...)
 22 [-]: GETGLOBAL R3 K11       ; R3 := 0x9784a4aa
 23 [-]: TEST      R3 0         ; if not R3 then PC := 37
 24 [-]: JMP       37           ; PC := 37
 25 [-]: GETGLOBAL R3 K12       ; R3 := 0x1dbe07c5
 26 [-]: GETUPVAL  R4 U0        ; R4 := U0
 27 [-]: POW       R4 R1 R4     ; R4 := R1 ^ R4
 28 [-]: MUL       R3 R3 R4     ; R3 := R3 * R4
 29 [-]: SELF      R4 R2 K13    ; R5 := R2; R4 := R2[0xa31ba7ee]
 30 [-]: MOVE      R6 R3        ; R6 := R3
 31 [-]: LOADKB    R7 1 0       ; R7 := true
 32 [-]: CALL      R4 4 1       ; R4(R5,R6,R7)
 33 [-]: SELF      R4 R2 K14    ; R5 := R2; R4 := R2[0x014db014]
 34 [-]: MOVE      R6 R3        ; R6 := R3
...
; Max Stack Size:  9
  ...
  8 [-]: JMP       63           ; PC := 63
  9 [-]: SELF      R2 R0 K3     ; R3 := R0; R2 := R0[0x1ac1655c]
 10 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 ...
 15 [-]: JMP       63           ; PC := 63
 16 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0[0x1ac1655c]
 17 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 18 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3[0xa383de31]
 19 [-]: MOVE      R5 R1        ; R5 := R1
 20 [-]: CONST     R6 25        ; R6 := 25.000000
 21 [-]: CONST     R7 6         ; R7 := 6.000000
 22 [-]: CONST     R8 0         ; R8 := 0.000000
 23 [-]: CALL      R3 6 1       ; R3(R4,R5,R6,R7,R8)
 24 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0[0x1ac1655c]
 25 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 26 [-]: SELF      R3 R3 K6     ; R4 := R3; R3 := R3[0x4cb29d1c]
 27 [-]: MOVE      R5 R1        ; R5 := R1
 28 [-]: CONST     R6 25        ; R6 := 25.000000
 29 [-]: CONST     R7 6         ; R7 := 6.000000
 30 [-]: CONST     R8 0         ; R8 := 0.000000
 31 [-]: CALL      R3 6 1       ; R3(R4,R5,R6,R7,R8)
 32 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0[0x1ac1655c]
 33 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 34 [-]: SELF      R3 R3 K7     ; R4 := R3; R3 := R3[0x3a0e0670]
 35 [-]: MOVE      R5 R1        ; R5 := R1
 ...
 41 [-]: GETGLOBAL R4 K9        ; R4 := 0x41a5e2f3
 ...
 47 [-]: JMP       63           ; PC := 63
 48 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0[0x1ac1655c]
 49 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 50 [-]: SELF      R3 R3 K10    ; R4 := R3; R3 := R3[0x8e3e343e]
 51 [-]: MOVE      R5 R1        ; R5 := R1
 52 [-]: CALL      R3 3 1       ; R3(R4,R5)
 53 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0[0x1ac1655c]
 54 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 55 [-]: SELF      R3 R3 K11    ; R4 := R3; R3 := R3[0x9326ca4b]
 56 [-]: MOVE      R5 R1        ; R5 := R1
 57 [-]: CALL      R3 3 1       ; R3(R4,R5)
 58 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0[0x1ac1655c]
 59 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 60 [-]: SELF      R3 R3 K12    ; R4 := R3; R3 := R3[0x34e75661]
 61 [-]: MOVE      R5 R1        ; R5 := R1
...
; Max Stack Size:  7
 ...
 12 [-]: JMP       31           ; PC := 31
 13 [-]: SELF      R2 R0 K4     ; R3 := R0; R2 := R0[0x3f384325]
 ...
 24 [-]: JMP       31           ; PC := 31
 25 [-]: SELF      R3 R2 K5     ; R4 := R2; R3 := R2[0xee0bc178]
 26 [-]: MOVE      R5 R1        ; R5 := R1
 27 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 28 [-]: TEST      R3 0         ; if not R3 then PC := 31
 29 [-]: JMP       31           ; PC := 31
 30 [-]: RETURN    R0 1         ; return 
 31 [-]: SELF      R3 R1 K6     ; R4 := R1; R3 := R1[0xd5f7912b]
...
; Max Stack Size:  11
  ...
  7 [-]: GETTABLE  R1 R1 K3     ; R1 := R1[0x7e1c98b2]
  8 [-]: CALL      R1 1 2       ; R1 := R1()
  9 [-]: GETGLOBAL R2 K4        ; R2 := 0x7b998233
 10 [-]: MOVE      R3 R1        ; R3 := R1
 11 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 ...
 17 [-]: SELF      R2 R0 K7     ; R3 := R0; R2 := R0[0xe2871589]
 18 [-]: MOVE      R4 R1        ; R4 := R1
 19 [-]: CALL      R2 3 1       ; R2(R3,R4)
 20 [-]: SELF      R2 R0 K8     ; R3 := R0; R2 := R0[0x5a76630b]
 21 [-]: CALL      R2 2 1       ; R2(R3)
 22 [-]: GETGLOBAL R2 K9        ; R2 := 0xcbd666e1
 23 [-]: CONST     R3 0         ; R3 := 0.250000
 24 [-]: CALL      R2 2 1       ; R2(R3)
 25 [-]: SELF      R2 R0 K10    ; R3 := R0; R2 := R0[0xe830ac3d]
 26 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 27 [-]: GETGLOBAL R3 K11       ; R3 := 0xbe190284
 28 [-]: CONST     R4 50        ; R4 := 50.000000
 29 [-]: CONST     R5 0         ; R5 := 0.000000
 30 [-]: GETGLOBAL R6 K12       ; R6 := 0x883b9812
 31 [-]: TEST      R6 0         ; if not R6 then PC := 38
 32 [-]: JMP       38           ; PC := 38
 33 [-]: SELF      R6 R0 K13    ; R7 := R0; R6 := R0[0x038c6583]
 34 [-]: GETGLOBAL R8 K14       ; R8 := 0x0757c943
 35 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 36 [-]: MOVE      R5 R6        ; R5 := R6
 37 [-]: JMP       41           ; PC := 41
 38 [-]: SELF      R6 R0 K15    ; R7 := R0; R6 := R0[0x07a9131a]
 39 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 40 [-]: MOVE      R5 R6        ; R5 := R6
 41 [-]: LT        0 K16 R5     ; if 0.000000 >= R5 then PC := 53
 42 [-]: JMP       53           ; PC := 53
 43 [-]: GETGLOBAL R6 K17       ; R6 := 0x5bced4c4
 44 [-]: GETTABLE  R6 R6 K18    ; R6 := R6[0xb62ecfe0]
 45 [-]: GETGLOBAL R7 K17       ; R7 := 0x5bced4c4
 46 [-]: GETTABLE  R7 R7 K19    ; R7 := R7[0x55f27c30]
 47 [-]: GETGLOBAL R8 K20       ; R8 := 0x725475cd
 48 [-]: DIV       R8 R5 R8     ; R8 := R5 / R8
 49 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 50 [-]: MOVE      R8 R2        ; R8 := R2
 51 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 52 [-]: MOVE      R4 R6        ; R4 := R6
 53 [-]: SELF      R6 R3 K21    ; R7 := R3; R6 := R3[0x751f061d]
 54 [-]: GETUPVAL  R8 U1        ; R8 := U1
 55 [-]: MOVE      R9 R4        ; R9 := R4
 56 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
 57 [-]: SELF      R6 R0 K22    ; R7 := R0; R6 := R0[0x01e435e9]
 58 [-]: GETGLOBAL R8 K23       ; R8 := _T
 59 [-]: GETTABLE  R8 R8 K24    ; R8 := R8["MaxEnemyCount"]
 60 [-]: CALL      R6 3 1       ; R6(R7,R8)
 61 [-]: SELF      R6 R0 K25    ; R7 := R0; R6 := R0[0x0213c6f0]
 62 [-]: SELF      R8 R0 K26    ; R9 := R0; R8 := R0[0x5bb68277]
 63 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 64 [-]: ADD       R8 R8 K27    ; R8 := R8 + 250.000000
 65 [-]: CALL      R6 3 1       ; R6(R7,R8)
 66 [-]: SELF      R6 R0 K28    ; R7 := R0; R6 := R0[0x84cb52af]
 67 [-]: LOADK     R8 K29       ; R8 := 0.050000
 68 [-]: CONST     R9 0         ; R9 := 0.000000
 69 [-]: CONST     R10 1        ; R10 := 1.500000
 70 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
 71 [-]: SELF      R6 R0 K28    ; R7 := R0; R6 := R0[0x84cb52af]
 72 [-]: LOADK     R8 K30       ; R8 := 0.960000
 73 [-]: CONST     R9 1         ; R9 := 1.000000
 74 [-]: CONST     R10 2        ; R10 := 2.000000
 75 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
 76 [-]: SELF      R6 R0 K31    ; R7 := R0; R6 := R0[0x9041d5d6]
 77 [-]: LOADKB    R8 1 0       ; R8 := true
 78 [-]: CALL      R6 3 1       ; R6(R7,R8)
 79 [-]: SELF      R6 R0 K32    ; R7 := R0; R6 := R0[0xbab10f46]
 80 [-]: CALL      R6 2 1       ; R6(R7)
 81 [-]: GETGLOBAL R6 K33       ; R6 := 0x744a780b
 82 [-]: SELF      R6 R6 K5     ; R7 := R6; R6 := R6[0x8eb2112d]
...
; Max Stack Size:  23
 ...
 24 [-]: JMP       28           ; PC := 28
 25 [-]: SELF      R8 R5 K9     ; R9 := R5; R8 := R5[0x8eb2112d]
 ...
 46 [-]: SELF      R14 R14 K1   ; R15 := R14; R14 := R14[0xc7fcada9]
 47 [-]: GETGLOBAL R16 K2       ; R16 := 0x0469f296
 48 [-]: LOADK     R17 K13      ; R17 := "DoorBossGate"
 49 [-]: CALL      R16 2 0      ; R16,... := R16(R17)
 50 [-]: CALL      R14 0 2      ; R14 := R14(R15,...)
 51 [-]: GETGLOBAL R15 K4       ; R15 := 0xc8802016
 52 [-]: MOVE      R16 R14      ; R16 := R14
 53 [-]: CALL      R15 2 4      ; R15,R16,R17 := R15(R16)
 54 [-]: JMP       58           ; PC := 58
 55 [-]: SELF      R20 R19 K9   ; R21 := R19; R20 := R19[0x8eb2112d]
 ...
 59 [-]: JMP       55           ; PC := 55
 60 [-]: GETGLOBAL R20 K14      ; R20 := 0xbe190284
 61 [-]: SELF      R20 R20 K15  ; R21 := R20; R20 := R20[0xd1961230]
 62 [-]: LOADKB    R22 1 0      ; R22 := true
...
; Max Stack Size:  15
  ...
  8 [-]: MOVE      R4 R2        ; R4 := R2
  9 [-]: GETGLOBAL R5 K5        ; R5 := 0xf8592a8b
 10 [-]: TEST      R5 0         ; if not R5 then PC := 13
 11 [-]: JMP       13           ; PC := 13
 12 [-]: MOVE      R4 R3        ; R4 := R3
 13 [-]: GETGLOBAL R5 K6        ; R5 := 0x74b75231
 14 [-]: LT        0 K7 R5      ; if 0.000000 >= R5 then PC := 19
 15 [-]: JMP       19           ; PC := 19
 16 [-]: GETGLOBAL R5 K8        ; R5 := 0xcbd666e1
 17 [-]: GETGLOBAL R6 K6        ; R6 := 0x74b75231
 18 [-]: CALL      R5 2 1       ; R5(R6)
 19 [-]: GETGLOBAL R5 K9        ; R5 := 0x7b998233
 20 [-]: GETGLOBAL R6 K10       ; R6 := 0x8b08e32d
 21 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 22 [-]: TEST      R5 1         ; if R5 then PC := 36
 23 [-]: JMP       36           ; PC := 36
 24 [-]: GETGLOBAL R5 K10       ; R5 := 0x8b08e32d
 25 [-]: SELF      R5 R5 K11    ; R6 := R5; R5 := R5[0x56c01834]
 26 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 27 [-]: TEST      R5 0         ; if not R5 then PC := 36
 28 [-]: JMP       36           ; PC := 36
 29 [-]: GETUPVAL  R5 U1        ; R5 := U1
 30 [-]: GETTABLE  R5 R5 K12    ; R5 := R5[0xa1df01d6]
 31 [-]: GETGLOBAL R6 K13       ; R6 := 0x64fb1586
 32 [-]: GETGLOBAL R7 K10       ; R7 := 0x8b08e32d
 33 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 34 [-]: GETGLOBAL R7 K14       ; R7 := 0x9b6b3e3d
 35 [-]: CALL      R5 3 1       ; R5(R6,R7)
 36 [-]: GETGLOBAL R5 K13       ; R5 := 0x64fb1586
 37 [-]: GETGLOBAL R6 K15       ; R6 := 0x0b4d4ede
 38 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 39 [-]: EQ        1 R1 K2      ; if R1 == 9999.000000 then PC := 51
 40 [-]: JMP       51           ; PC := 51
 41 [-]: GETUPVAL  R6 U1        ; R6 := U1
 42 [-]: GETTABLE  R6 R6 K16    ; R6 := R6[0xe8fa0e68]
 43 [-]: MOVE      R7 R4        ; R7 := R4
...
117 [-]: GETTABLE  R10 R10 K36  ; R10 := R10[0x604f119a]
118 [-]: LOADKB    R11 1 0      ; R11 := true
119 [-]: CALL      R10 2 1      ; R10(R11)
120 [-]: SELF      R10 R0 K26   ; R11 := R0; R10 := R0[0x751f061d]
...
; Max Stack Size:  3
  ...
  2 [-]: SETTABLE  R0 K1 K2     ; R0["gStopTimedStage"] := true
  3 [-]: GETUPVAL  R0 U0        ; R0 := U0
  4 [-]: GETTABLE  R0 R0 K3     ; R0 := R0[0x18dd08ac]
  5 [-]: CALL      R0 1 1       ; R0()
  6 [-]: GETUPVAL  R0 U1        ; R0 := U1
  7 [-]: GETTABLE  R0 R0 K4     ; R0 := R0[0x9742b85b]
  8 [-]: GETGLOBAL R1 K0        ; R1 := _T
  9 [-]: GETTABLE  R1 R1 K5     ; R1 := R1["MissionTransmissionSet"]
 10 [-]: GETGLOBAL R2 K6        ; R2 := 0xc3ce16d0
 11 [-]: CALL      R0 3 1       ; R0(R1,R2)
 12 [-]: GETGLOBAL R0 K7        ; R0 := 0x3b83413f
...
; Max Stack Size:  3
  ...
  4 [-]: JMP       9            ; PC := 9
  5 [-]: GETGLOBAL R0 K2        ; R0 := 0x1bc64f74
  6 [-]: SELF      R0 R0 K3     ; R1 := R0; R0 := R0[0x8eb2112d]
...
; Max Stack Size:  9
  ...
  1 [-]: GETGLOBAL R0 K0        ; R0 := 0x89326c93
  2 [-]: SELF      R0 R0 K1     ; R1 := R0; R0 := R0[0xc7fcada9]
  3 [-]: GETGLOBAL R2 K2        ; R2 := 0x6da1944e
