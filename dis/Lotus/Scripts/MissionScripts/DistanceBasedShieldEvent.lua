...
L 0:  16 [-]: NAMECALL R6 R2 K9 [0x4929DAAA]
      ...
      18 [-]: JUMPIF R6 L1 
      19 [-]: RETURN R5 1  
L 1:  20 [-]: GETIMPORT R6 3 [0x89326C93]
...
L 0:   4 [-]: JUMPIF R1 L1 
      ...
      40 [-]: CALL R2 1 0  
      41 [-]: GETIMPORT R4 20 ["ZERO_VECTOR"]
...
; Max Stack Size:  27
       ...
       6 [-]: GETIMPORT R6 5 ["gPlayerSpawnType"]
...
L 1:  22 [-]: GETUPVAL R8 0
      ...
      25 [-]: CALL R6 3 0  
      26 [-]: GETIMPORT R6 1 [0x89326C93]
      27 [-]: NAMECALL R6 R6 K12 [0x78298275]
      28 [-]: CALL R6 1 1  
      29 [-]: GETIMPORT R8 14 [0x09965C1A]
      30 [-]: LENGTH R7 R8 
      31 [-]: LOADN R8 0   
L 2:  32 [-]: JUMPIFNOTLT R8 R7 L20
      33 [-]: FASTCALL1 62 R6 L3
      34 [-]: MOVE R10 R6  
      35 [-]: GETIMPORT R9 16 [0x7B998233]
      36 [-]: CALL R9 1 1  
L 3:  37 [-]: JUMPIF R9 L20
      ...
      43 [-]: MOVE R8 R10  
      44 [-]: LOADN R12 1  
      45 [-]: GETIMPORT R13 14 [0x09965C1A]
      46 [-]: LENGTH R10 R13
      47 [-]: LOADN R11 1  
      48 [-]: FORNPREP R10 L19
L 4:  49 [-]: GETIMPORT R15 14 [0x09965C1A]
      ...
      65 [-]: CALL R16 2 0 
      66 [-]: GETIMPORT R16 1 [0x89326C93]
      67 [-]: GETIMPORT R18 21 [0xE77841BD]
...
L10: 108 [-]: GETUPVAL R18 4
     ...
     110 [-]: GETIMPORT R18 32 ["MissionTransmissionSet"]
     111 [-]: GETIMPORT R19 34 [0x0469F296]
     112 [-]: LOADK R20 K35 ["VorShieldEvent"]
     113 [-]: CALL R19 1 -1
     114 [-]: CALL R17 -1 0
     115 [-]: GETIMPORT R17 1 [0x89326C93]
     116 [-]: NAMECALL R17 R17 K36 [0x8B5B1F58]
     117 [-]: CALL R17 1 1 
     118 [-]: GETIMPORT R18 26 [0xC8802016]
     119 [-]: MOVE R19 R17 
     120 [-]: CALL R18 1 3 
     121 [-]: FORGPREP_INEXT R18 L12
L11: 122 [-]: GETIMPORT R25 34 [0x0469F296]
...
L12: 128 [-]: FORGLOOP R18 L11 2 [inext]
     ...
     132 [-]: CALL R18 3 0 
     133 [-]: GETIMPORT R18 9 [0xCBD666E1]
     134 [-]: LOADN R19 5  
     135 [-]: CALL R18 1 0 
     136 [-]: LOADB R20 1  
...
L19: 174 [-]: GETIMPORT R10 9 [0xCBD666E1]
     175 [-]: LOADN R11 0  
     176 [-]: CALL R10 1 0 
     177 [-]: JUMPBACK L2  
L20: 178 [-]: RETURN R0 0  
