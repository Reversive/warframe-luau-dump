...
L 6:  30 [-]: NAMECALL R6 R5 K5 [0xED4E0128]
      31 [-]: CALL R6 1 1  
      32 [-]: MOVE R3 R6   
      33 [-]: GETIMPORT R7 7 [0x25E3ED86]
      34 [-]: NOT R6 R7    
      35 [-]: JUMPIF R6 L7 
      36 [-]: GETIMPORT R8 9 ["gEntityType"]
      37 [-]: NAMECALL R6 R5 K10 [0xC1595BD5]
      38 [-]: CALL R6 2 1  
L 7:  39 [-]: MOVE R4 R6   
L 8:  40 [-]: NAMECALL R6 R2 K11 [0xAE962FA0]
      41 [-]: CALL R6 1 1  
      42 [-]: GETIMPORT R7 14 ["ProximityDialog"]
      43 [-]: JUMPIF R7 L9 
      44 [-]: NEWTABLE R7 0 0
L 9:  45 [-]: GETIMPORT R8 15 ["_T"]
...
L10:  52 [-]: GETIMPORT R8 18 [0xC163F229]
      53 [-]: LOADN R9 0   
      54 [-]: LOADN R10 1  
      55 [-]: CALL R8 2 1  
      56 [-]: GETIMPORT R9 20 [0x778EA816]
      57 [-]: JUMPIFNOTLT R8 R9 L14
      58 [-]: GETIMPORT R8 7 [0x25E3ED86]
      59 [-]: JUMPIFNOT R8 L11
      ...
      64 [-]: CALL R9 2 1  
      65 [-]: GETIMPORT R10 24 [0x89326C93]
      66 [-]: MOVE R12 R8  
      67 [-]: MOVE R13 R9  
      68 [-]: MOVE R14 R4  
...
L12:  76 [-]: SETTABLE R8 R7 R3
      ...
      78 [-]: GETIMPORT R9 28 [0xD14173B7]
      79 [-]: LOADN R10 0  
      80 [-]: JUMPIFNOTLE R10 R9 L13
      81 [-]: GETIMPORT R9 28 [0xD14173B7]
      82 [-]: ADD R8 R6 R9 
L13:  83 [-]: GETTABLE R9 R7 R3
      84 [-]: SETTABLEKS R8 R9 K16 ["resetTime"]
      85 [-]: GETUPVAL R10 1
      86 [-]: GETTABLEKS R9 R10 K29 [0x1F60D532]
      87 [-]: GETIMPORT R10 31 [0xE91D7466]
      88 [-]: GETIMPORT R12 33 [0xA2B4BEBE]
