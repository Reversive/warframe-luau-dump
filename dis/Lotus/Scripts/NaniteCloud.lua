...
L 0:   4 [-]: LOADN R3 1   ; var3 = 1
       ...
       6 [-]: MULK R5 R2 K3; var5 = var2 * 0.070000000000000007
...
L 1:  17 [-]: LOADK R5 K3  ; var5 = 0.070000000000000007
...
L 2:  28 [-]: LOADN R3 0   ; var3 = 0
      29 [-]: JUMPIFNOTLT R3 R2 L3; goto L3 if var3 >= var1639246
...
L 5:  45 [-]: GETIMPORT R4 28; var4 = 0xD3A7DDAA
      ...
      50 [-]: JUMPIFNOTLT R4 R3 L6; goto L6 if var4 >= var1073742661
...
L 1:  16 [-]: JUMPIF R2 L28; goto L28 if var2
      ...
      22 [-]: JUMPIFEQ R3 R4 L2; goto L2 if var3 == var16777755
...
L 3:  25 [-]: NAMECALL R4 R0 K12; var5 = var0; var4 = var0[0x2D0A291F]
      ...
      30 [-]: JUMPIFEQ R4 R5 L4; goto L4 if var4 == var16778011
...
L 5:  33 [-]: GETIMPORT R6 14; var6 = gLotusSentinelAvatarType
      ...
      45 [-]: JUMPIFNOTEQ R6 R0 L6; goto L6 if var6 ~= var-1241118395
...
L11:  97 [-]: LOADN R13 0  ; var13 = 0
      98 [-]: JUMPIFNOTLT R13 R11 L22; goto L22 if var13 >= var50413131
...
L13: 108 [-]: JUMPIF R13 L22; goto L22 if var13
     ...
     111 [-]: JUMPIFNOTEQ R12 R13 L22; goto L22 if var12 ~= var453053765
     112 [-]: NAMECALL R13 R1 K41; var14 = var1; var13 = var1[0x2B54251B]
     113 [-]: CALL R13 2 2 ; var13 = var13(var14)
     114 [-]: JUMPIFNOTEQ R13 R0 L22; goto L22 if var13 ~= var3015971
     ...
     130 [-]: JUMPIFNOTLT R14 R13 L14; goto L14 if var14 >= var592406
...
L15: 161 [-]: JUMPIF R14 L21; goto L21 if var14
     ...
     166 [-]: JUMPIFNOTEQ R14 R15 L21; goto L21 if var14 ~= var397390
...
L 5:  45 [-]: JUMPIF R4 L6 ; goto L6 if var4
      ...
      51 [-]: JUMPIFNOTEQ R4 R5 L6; goto L6 if var4 ~= var67094
