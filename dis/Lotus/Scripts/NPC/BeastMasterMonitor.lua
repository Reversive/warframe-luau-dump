...
; Max Stack Size:  6
 ...
 53 [-]: SELF      R3 R0 K9     ; R4 := R0; R3 := R0[0xfa9e477f]
 54 [-]: CALL      R3 2 0       ; R3,... := R3(R4)
 55 [-]: CALL      R2 0 2       ; R2 := R2(R3,...)
 56 [-]: TEST      R2 0         ; if not R2 then PC := 62
 57 [-]: JMP       62           ; PC := 62
 58 [-]: GETGLOBAL R2 K10       ; R2 := 0xcbd666e1
 59 [-]: LOADK     R3 0         ; R3 := 0.000000
 60 [-]: CALL      R2 2 1       ; R2(R3)
 61 [-]: JMP       52           ; PC := 52
 62 [-]: SELF      R2 R0 K9     ; R3 := R0; R2 := R0[0xfa9e477f]
 63 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 64 [-]: SELF      R2 R2 K11    ; R3 := R2; R2 := R2[0xae5c3faf]
 65 [-]: GETGLOBAL R4 K12       ; R4 := 0x0469f296
