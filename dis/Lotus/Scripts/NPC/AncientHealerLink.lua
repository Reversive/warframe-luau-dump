...
L 4:  35 [-]: JUMPIF R8 L6 
      ...
      54 [-]: CALL R11 1 1 
      55 [-]: GETIMPORT R12 22 [0x1C139F5C]
      56 [-]: ADD R10 R11 R12
      57 [-]: FASTCALL2 19 R9 R10 L5
      58 [-]: GETIMPORT R8 25 [0xAC1B386A]
      59 [-]: CALL R8 2 1  
L 5:  60 [-]: MOVE R11 R8  
      61 [-]: NAMECALL R9 R7 K26 [0x014DB014]
      62 [-]: CALL R9 2 0  
      63 [-]: GETIMPORT R11 28 [0x9D7B7644]
      64 [-]: NAMECALL R9 R7 K29 [0x0542D42B]
      65 [-]: CALL R9 2 1  
      66 [-]: JUMPIF R9 L6 
      67 [-]: GETIMPORT R11 28 [0x9D7B7644]
      68 [-]: GETIMPORT R12 31 ["EMPTY_SYMBOL"]
      69 [-]: NAMECALL R9 R7 K32 [0x47901F07]
      70 [-]: CALL R9 3 0  
L 6:  71 [-]: FORGLOOP R3 L3 2 [inext]
      72 [-]: GETIMPORT R3 10 [0x89326C93]
      73 [-]: GETIMPORT R5 34 [0xA55D1B5E]
      ...
      79 [-]: CALL R3 -1 0 
      80 [-]: GETIMPORT R3 39 [0xCBD666E1]
      81 [-]: GETIMPORT R4 41 [0xB2C6B0D9]
      82 [-]: CALL R3 1 0  
      83 [-]: JUMPBACK L0  
L 7:  84 [-]: RETURN R0 0  
...
L 0:   5 [-]: NAMECALL R2 R0 K3 [0xD2715720]
      ...
      15 [-]: CALL R4 1 1  
      16 [-]: GETIMPORT R6 8 [0x1BC62C71]
      17 [-]: MUL R5 R3 R6 
      18 [-]: GETIMPORT R7 10 [0x01033D0F]
      19 [-]: MUL R6 R4 R7 
      20 [-]: ADD R2 R2 R6 
...
L 3:  36 [-]: JUMPIFNOTLT R3 R2 L5
      37 [-]: GETIMPORT R5 16 [0x9492AD58]
      38 [-]: GETIMPORT R7 18 [0x990EC12F]
      39 [-]: GETIMPORT R9 20 [0x0A903432]
      40 [-]: SUB R11 R2 R3
      41 [-]: DIV R10 R11 R3
      42 [-]: MUL R8 R9 R10
      43 [-]: ADD R6 R7 R8 
      44 [-]: FASTCALL2 19 R5 R6 L4
      45 [-]: GETIMPORT R4 23 [0xAC1B386A]
      46 [-]: CALL R4 2 1  
L 4:  47 [-]: MOVE R7 R4   
      48 [-]: NAMECALL R5 R0 K24 [0x2D9BA74F]
      49 [-]: CALL R5 2 0  
      50 [-]: RETURN R0 0  
L 5:  51 [-]: GETIMPORT R6 18 [0x990EC12F]
...
; Max Stack Size:  14
       ...
       3 [-]: CALL R5 1 1  
       4 [-]: GETIMPORT R8 3 ["gLotusDamageControllerType"]
...
L 1:  25 [-]: NAMECALL R6 R4 K12 [0x4514B1E1]
      ...
      43 [-]: LOADN R11 63 
      44 [-]: LOADN R12 0  
      45 [-]: GETIMPORT R13 21 [0xB753771D]
...
; Max Stack Size:  13
       ...
       8 [-]: LOADN R10 63 
       9 [-]: LOADN R11 0  
      10 [-]: GETIMPORT R12 4 [0xB753771D]
      11 [-]: NAMECALL R7 R5 K5 [0x2722B5C3]
      12 [-]: CALL R7 5 0  
      13 [-]: GETIMPORT R9 7 ["gLotusDamageControllerType"]
