...
L 0:   7 [-]: JUMPIFNOT R3 L1
       8 [-]: RETURN R0 0  
L 1:   9 [-]: GETIMPORT R5 4 [0x78A39459]
      10 [-]: GETIMPORT R6 6 [0x126454DE]
      11 [-]: GETIMPORT R7 8 [0x062BE793]
      12 [-]: GETIMPORT R8 10 [0xA81B7796]
      13 [-]: MOVE R9 R1   
...
L 7:  53 [-]: JUMPIF R6 L9 
      ...
      60 [-]: GETIMPORT R7 21 [0x9BAFFFE3]
      61 [-]: GETIMPORT R8 23 [0xE406E787]
      62 [-]: GETIMPORT R9 25 [0x6D7648B5]
      63 [-]: MOVE R10 R6  
      64 [-]: CALL R7 3 1  
      65 [-]: MOVE R10 R5  
      66 [-]: MOVE R11 R7  
      ...
      68 [-]: CALL R8 3 0  
L 8:  69 [-]: GETIMPORT R7 28 [0xCBD666E1]
...
L 4:  26 [-]: JUMPIFNOT R4 L5
      27 [-]: GETIMPORT R6 9 ["gProjectileType"]
...
L 6:  38 [-]: JUMPIF R4 L7 
      ...
      44 [-]: RETURN R0 0  
L 7:  45 [-]: GETIMPORT R3 13 [0xC8802016]
      46 [-]: GETIMPORT R4 15 [0x69DCC1D1]
      47 [-]: CALL R3 1 3  
...
L 0:   8 [-]: JUMPIF R1 L3 
      ...
      16 [-]: CALL R3 1 1  
L 1:  17 [-]: JUMPIF R3 L2 
      18 [-]: GETIMPORT R5 8 ["gBaseAvatarType"]
      19 [-]: NAMECALL R3 R2 K9 [0xF2DEAF69]
      20 [-]: CALL R3 2 1  
      21 [-]: JUMPIFNOT R3 L2
      22 [-]: GETIMPORT R5 11 [0x9E5B81A7]
      ...
      27 [-]: CALL R3 1 0  
      28 [-]: RETURN R0 0  
L 2:  29 [-]: GETIMPORT R5 15 [0xC59C8863]
      30 [-]: GETIMPORT R6 17 ["EMPTY_SYMBOL"]
      31 [-]: GETIMPORT R7 19 ["ZERO_VECTOR"]
      32 [-]: GETIMPORT R8 21 ["ZERO_ROTATION"]
      33 [-]: MOVE R9 R1   
...
L 0:   7 [-]: JUMPIF R1 L1 
       ...
       9 [-]: CALL R1 1 1  
      10 [-]: GETIMPORT R4 7 [0xC59C8863]
      11 [-]: GETIMPORT R5 9 ["EMPTY_SYMBOL"]
      12 [-]: GETIMPORT R6 11 ["ZERO_VECTOR"]
      13 [-]: GETIMPORT R7 13 ["ZERO_ROTATION"]
      14 [-]: MOVE R8 R1   
