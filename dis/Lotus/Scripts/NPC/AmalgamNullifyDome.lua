...
L 5:  36 [-]: JUMPIFEQ R7 R12 L6; goto L6 if var7 == var3388
      37 [-]: GETUPVAL R13 0; var13 = upvalues[0]
      38 [-]: JUMPIFNOTEQ R12 R13 L7; goto L7 if var12 ~= var68870
...
L13:  67 [-]: NAMECALL R4 R0 K16; var5 = var0; var4 = var0[0x65D389CB]
      ...
      76 [-]: JUMPIFNOTLE R8 R10 L14; goto L14 if var8 > var526638
...
L14:  78 [-]: MOVE R12 R9  ; var12 = var9
      ...
      93 [-]: JUMPIFNOTLT R14 R13 L17; goto L17 if var14 >= var1838625
...
L28: 190 [-]: NAMECALL R19 R0 K16; var20 = var0; var19 = var0[0x65D389CB]
     ...
     194 [-]: JUMPIFNOTLE R19 R5 L29; goto L29 if var19 > var67604
...
L29: 197 [-]: GETIMPORT R19 62; var19 = 0x67652851
     ...
     204 [-]: JUMPIFNOTLT R19 R7 L30; goto L30 if var19 >= var3846
...
L30: 207 [-]: JUMPIF R15 L31; goto L31 if var15
     ...
     209 [-]: JUMPIFNOTLE R7 R19 L31; goto L31 if var7 > var1312545
...
L32: 216 [-]: LOADK R21 K66; var21 = 0.019999999552965164
     217 [-]: JUMPIFLT R21 R20 L33; goto L33 if var21 < var16782086
     218 [-]: LOADB R19 0 +1; var19 = false
L33: 219 [-]: LOADB R19 1  ; var19 = true
L34: 220 [-]: JUMPIF R19 L35; goto L35 if var19
     221 [-]: JUMPIFNOTEQ R7 R5 L35; goto L35 if var7 ~= var2692129
     ...
     226 [-]: JUMPIFNOTLE R5 R20 L52; goto L52 if var5 > var4068385
L35: 227 [-]: GETIMPORT R20 62; var20 = 0x67652851
     ...
     231 [-]: JUMPIFNOTLT R5 R7 L37; goto L37 if var5 >= var4462625
...
L37: 245 [-]: JUMPIFNOTEQ R20 R5 L38; goto L38 if var20 ~= var725780
...
L38: 247 [-]: MOVE R21 R5  ; var21 = var5
     ...
     250 [-]: JUMPIFNOTLE R21 R23 L39; goto L39 if var21 > var1381934
...
L40: 255 [-]: LOADN R21 0  ; var21 = 0
     256 [-]: JUMPIFNOTLE R11 R21 L52; goto L52 if var11 > var4724001
     257 [-]: GETIMPORT R21 72; var21 = 0xAC64F27B
     258 [-]: ADD R11 R11 R21; var11 = var11 + var21
     259 [-]: JUMPIFNOTLT R7 R5 L41; goto L41 if var7 >= var2352
     260 [-]: LOADN R9 0   ; var9 = 0
L41: 261 [-]: FASTCALL1 64 R13 L42; 
...
L43: 270 [-]: GETIMPORT R21 41; var21 = 0x107B1D2E
     ...
     273 [-]: JUMPIFNOTLE R20 R21 L48; goto L48 if var20 > var2427412
...
L48: 302 [-]: GETIMPORT R21 20; var21 = 0x7A7DBA3F
     303 [-]: JUMPIFNOTLT R21 R20 L51; goto L51 if var21 >= var2230861
...
L52: 329 [-]: GETIMPORT R20 88; var20 = 0x60BC07C8
     ...
     331 [-]: JUMPIFNOTEQ R5 R4 L53; goto L53 if var5 ~= var4068385
...
L59: 364 [-]: LOADN R20 1  ; var20 = 1
     365 [-]: JUMPIFNOTLE R19 R20 L61; goto L61 if var19 > var50413629
     366 [-]: FASTCALL1 64 R1 L60; 
...
L60: 370 [-]: JUMPIF R20 L61; goto L61 if var20
     ...
     381 [-]: ADDK R19 R20 K93; var19 = var20 + 0.029999999329447746
...
L62: 392 [-]: GETGLOBAL R20 K25; var20 = 0xA8FDF260
     ...
     395 [-]: JUMPIFNOTLT R20 R19 L63; goto L63 if var20 >= var267041
     396 [-]: GETIMPORT R19 4; var19 = 0xCBD666E1
     397 [-]: LOADK R20 K95; var20 = 0.10000000149011612
...
L17: 107 [-]: JUMPIF R8 L26; goto L26 if var8
     ...
     116 [-]: JUMPIFNOTLE R8 R9 L26; goto L26 if var8 > var1640993
