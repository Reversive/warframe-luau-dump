...
L 2:  12 [-]: JUMPIF R2 L18
      ...
      18 [-]: CALL R2 1 1  
      19 [-]: JUMPIF R2 L18
      20 [-]: GETIMPORT R2 8 [0xBC578DAA]
      21 [-]: JUMPIFNOT R2 L4
      22 [-]: GETIMPORT R4 10 ["gLotusNpcAvatarType"]
...
L 4:  37 [-]: GETIMPORT R4 10 ["gLotusNpcAvatarType"]
...
L 5:  45 [-]: NAMECALL R2 R1 K12 [0x1AC1655C]
      ...
      50 [-]: CALL R2 3 0  
L 6:  51 [-]: GETIMPORT R2 15 [0x89326C93]
      ...
      62 [-]: GETIMPORT R3 22 [0x99675E23]
      63 [-]: CALL R3 1 1  
L 7:  64 [-]: GETIMPORT R4 25 [0x5CB2ADF8]
      65 [-]: CALL R4 0 1  
      66 [-]: GETUPVAL R7 0
      67 [-]: LOADN R8 1   
...
L14: 128 [-]: JUMPIFNOT R3 L17
     ...
     141 [-]: GETIMPORT R4 49 [0xAC1B386A]
     142 [-]: CALL R4 1 1  
L15: 143 [-]: GETIMPORT R5 51 [0x35C16153]
     144 [-]: CALL R5 0 1  
     ...
     159 [-]: CALL R6 2 0  
L16: 160 [-]: GETIMPORT R5 55 [0x4B4C12B1]
     161 [-]: LOADB R6 1   
     162 [-]: LOADN R7 3   
     163 [-]: LOADN R8 1   
     164 [-]: LOADB R9 1   
