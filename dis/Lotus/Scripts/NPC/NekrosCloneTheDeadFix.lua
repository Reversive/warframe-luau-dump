...
; Max Stack Size:  13
       ...
       0 [-]: GETIMPORT R2 2 ["cloneTheDeadAbility"]
...
L 2:  10 [-]: LOADB R1 0   
      11 [-]: RETURN R1 1  
L 3:  12 [-]: GETIMPORT R1 6 [0xCFC01047]
      13 [-]: GETIMPORT R2 2 ["cloneTheDeadAbility"]
      14 [-]: CALL R1 1 3  
      15 [-]: FORGPREP_NEXT R1 L7
L 4:  16 [-]: GETTABLEKS R6 R5 K7 ["clones"]
      17 [-]: GETIMPORT R7 9 [0xC8802016]
      18 [-]: MOVE R8 R6   
      19 [-]: CALL R7 1 3  
...
L 0:   4 [-]: JUMPIFNOT R1 L1
       5 [-]: LOADNIL R1   
       6 [-]: RETURN R1 1  
L 1:   7 [-]: GETIMPORT R2 2 ["cloneTheDeadAbility"]
...
L 2:  11 [-]: JUMPIF R1 L8 
      ...
      14 [-]: CALL R1 1 1  
      15 [-]: GETIMPORT R2 9 [0xC8802016]
      16 [-]: MOVE R3 R1   
      17 [-]: CALL R2 1 3  
      18 [-]: FORGPREP_INEXT R2 L7
L 3:  19 [-]: NAMECALL R7 R6 K10 [0x388577D5]
      20 [-]: CALL R7 1 1  
      21 [-]: GETIMPORT R10 2 ["cloneTheDeadAbility"]
      22 [-]: GETTABLE R9 R10 R7
      23 [-]: FASTCALL1 62 R9 L4
      24 [-]: GETIMPORT R8 4 [0x7B998233]
      25 [-]: CALL R8 1 1  
L 4:  26 [-]: JUMPIF R8 L7 
      27 [-]: GETIMPORT R8 9 [0xC8802016]
      28 [-]: GETIMPORT R12 2 ["cloneTheDeadAbility"]
...
L 2:  14 [-]: RETURN R0 0  
L 3:  15 [-]: GETIMPORT R4 6 ["gLotusNpcAvatarType"]
      16 [-]: NAMECALL R2 R0 K7 [0xF2DEAF69]
      17 [-]: CALL R2 2 1  
      18 [-]: JUMPIFNOT R2 L5
      19 [-]: GETIMPORT R4 6 ["gLotusNpcAvatarType"]
...
L 5:  32 [-]: GETUPVAL R2 0
      ...
      38 [-]: CALL R3 1 1  
L 6:  39 [-]: JUMPIF R3 L7 
      40 [-]: GETIMPORT R5 11 [0x88EFC25E]
      41 [-]: GETUPVAL R6 1
      42 [-]: CALL R5 1 1  
      43 [-]: GETIMPORT R6 13 ["EMPTY_SYMBOL"]
      44 [-]: GETIMPORT R7 15 ["ZERO_VECTOR"]
      45 [-]: GETIMPORT R8 17 ["ZERO_ROTATION"]
      46 [-]: MOVE R9 R2   
      47 [-]: NAMECALL R3 R1 K18 [0x47901F07]
      48 [-]: CALL R3 6 0  
      49 [-]: GETIMPORT R5 6 ["gLotusNpcAvatarType"]
...
L 6:  39 [-]: JUMPIF R3 L7 
      ...
      43 [-]: LOADB R5 0   
      44 [-]: CALL R3 2 0  
      45 [-]: GETIMPORT R5 12 [0x88EFC25E]
      46 [-]: GETUPVAL R6 2
      47 [-]: CALL R5 1 1  
      48 [-]: GETIMPORT R6 14 ["EMPTY_SYMBOL"]
      49 [-]: GETIMPORT R7 16 ["ZERO_VECTOR"]
      50 [-]: GETIMPORT R8 18 ["ZERO_ROTATION"]
      51 [-]: MOVE R9 R0   
      52 [-]: NAMECALL R3 R1 K19 [0x47901F07]
      53 [-]: CALL R3 6 0  
      54 [-]: GETIMPORT R6 22 ["cloneTheDeadAbility"]
