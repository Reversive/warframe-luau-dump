...
; Max Stack Size:  18
       ...
       6 [-]: CALL R1 1 1  
L 0:   7 [-]: JUMPIF R1 L4 
L 1:   8 [-]: GETIMPORT R1 3 [0x83F4E77C]
      ...
      14 [-]: CALL R2 1 -1 
      15 [-]: FASTCALL 62 L2
      16 [-]: GETIMPORT R1 5 [0x7B998233]
      17 [-]: CALL R1 -1 1 
L 2:  18 [-]: JUMPIFNOT R1 L4
L 3:  19 [-]: GETIMPORT R1 1 [0xCBD666E1]
      20 [-]: LOADN R2 0   
      21 [-]: CALL R1 1 0  
      ...
      24 [-]: CALL R1 1 0  
      25 [-]: JUMPBACK L1  
L 4:  26 [-]: GETIMPORT R1 8 [0x89326C93]
...
L14: 102 [-]: JUMPIF R7 L20
     103 [-]: GETIMPORT R9 30 [0xC703B5D3]
...
L19: 139 [-]: JUMPIF R11 L20
     ...
     142 [-]: CALL R11 2 0 
     143 [-]: GETIMPORT R11 11 [0x3D106989]
...
L23: 166 [-]: GETIMPORT R10 46 [0x88EFC25E]
     167 [-]: GETIMPORT R11 42 [0x8EBEC830]
     168 [-]: CALL R10 1 1 
     169 [-]: GETIMPORT R11 48 ["EMPTY_SYMBOL"]
     170 [-]: NAMECALL R8 R0 K49 [0x47901F07]
     171 [-]: CALL R8 3 0  
L24: 172 [-]: GETIMPORT R10 42 [0x8EBEC830]
     173 [-]: NAMECALL R8 R0 K43 [0xC1595BD5]
     174 [-]: CALL R8 2 1  
     175 [-]: MOVE R7 R8   
     176 [-]: FASTCALL1 62 R7 L25
     177 [-]: MOVE R9 R7   
     178 [-]: GETIMPORT R8 5 [0x7B998233]
     179 [-]: CALL R8 1 1  
L25: 180 [-]: JUMPIF R8 L26
     ...
     187 [-]: CALL R8 2 0  
L26: 188 [-]: GETIMPORT R7 11 [0x3D106989]
...
L27: 197 [-]: JUMPIF R4 L28
     198 [-]: GETIMPORT R5 11 [0x3D106989]
     ...
     207 [-]: CALL R5 1 0  
     208 [-]: RETURN R0 0  
L28: 209 [-]: GETIMPORT R1 57 ["MonitoringAllyNpcs"]
     210 [-]: JUMPIF R1 L30
     211 [-]: GETIMPORT R1 8 [0x89326C93]
     212 [-]: NAMECALL R1 R1 K9 [0x78298275]
     213 [-]: CALL R1 1 1  
     214 [-]: FASTCALL1 62 R1 L29
     215 [-]: MOVE R3 R1   
     216 [-]: GETIMPORT R2 5 [0x7B998233]
     217 [-]: CALL R2 1 1  
L29: 218 [-]: JUMPIF R2 L30
     219 [-]: GETIMPORT R4 59 [0x0469F296]
...
; Max Stack Size:  22
       ...
       0 [-]: GETIMPORT R1 2 ["MonitoringAllyNpcs"]
       1 [-]: JUMPIFNOT R1 L0
       2 [-]: RETURN R0 0  
...
L 3:  14 [-]: GETIMPORT R1 8 ["_T"]
      ...
      32 [-]: GETIMPORT R3 21 [0x69F3932E]
      33 [-]: SETTABLEKS R3 R1 K22 ["abilityType"]
      34 [-]: GETIMPORT R3 24 [0xBE190284]
      35 [-]: GETUPVAL R5 0
      ...
      43 [-]: CALL R3 4 0  
L 4:  44 [-]: GETIMPORT R3 24 [0xBE190284]
      45 [-]: GETUPVAL R5 0
      46 [-]: NAMECALL R3 R3 K25 [0x0EB34C69]
      47 [-]: CALL R3 2 1  
      48 [-]: LOADN R4 0   
      49 [-]: JUMPIFNOTLT R4 R3 L28
      50 [-]: GETIMPORT R3 29 [0xCBD666E1]
      51 [-]: LOADN R4 1   
      52 [-]: CALL R3 1 0  
...
L 7:  74 [-]: JUMPIF R11 L15
      ...
      82 [-]: CALL R12 1 1 
      83 [-]: MOVE R11 R12 
      84 [-]: GETIMPORT R12 10 [0x3D106989]
...
L 9:  98 [-]: GETTABLE R17 R3 R15
     ...
     100 [-]: GETIMPORT R16 7 [0x7B998233]
     101 [-]: CALL R16 1 1 
...
L12: 110 [-]: JUMPIFNOT R12 L14
     ...
     112 [-]: MOVE R14 R4  
     113 [-]: MOVE R15 R10 
     114 [-]: GETIMPORT R13 44 [0x23D5322F]
     115 [-]: CALL R13 2 0 
L13: 116 [-]: JUMP L15
    
L14: 117 [-]: GETIMPORT R13 10 [0x3D106989]
...
L16: 130 [-]: LENGTH R6 R4 
     ...
     132 [-]: GETIMPORT R6 24 [0xBE190284]
     133 [-]: GETUPVAL R8 0
     134 [-]: LOADN R9 0   
...
L17: 138 [-]: LOADN R7 0   
     139 [-]: GETIMPORT R9 24 [0xBE190284]
     140 [-]: GETUPVAL R11 0
     141 [-]: NAMECALL R9 R9 K25 [0x0EB34C69]
     142 [-]: CALL R9 2 1  
     143 [-]: SUBK R8 R9 K51 [1]
     144 [-]: FASTCALL2 18 R7 R8 L18
     145 [-]: GETIMPORT R6 54 [0xB62ECFE0]
     146 [-]: CALL R6 2 1  
L18: 147 [-]: GETIMPORT R7 24 [0xBE190284]
     148 [-]: GETUPVAL R9 0
     149 [-]: MOVE R10 R6  
     150 [-]: NAMECALL R7 R7 K50 [0x751F061D]
     151 [-]: CALL R7 3 0  
     152 [-]: JUMPXEQKN R6 K55 L21 NOT [2]
     153 [-]: GETIMPORT R7 33 [0xC8802016]
     154 [-]: MOVE R8 R4   
     155 [-]: CALL R7 1 3  
     156 [-]: FORGPREP_INEXT R7 L20
L19: 157 [-]: GETIMPORT R14 57 [0xC767C2B2]
     158 [-]: GETIMPORT R15 59 [0x0469F296]
     159 [-]: LOADK R16 K60 ["GAME_C1_SPINE2"]
     160 [-]: CALL R15 1 1 
     161 [-]: GETIMPORT R16 62 ["ZERO_VECTOR"]
     162 [-]: GETIMPORT R17 64 ["ZERO_ROTATION"]
     163 [-]: MOVE R18 R0  
     164 [-]: LOADN R19 1  
...
L21: 169 [-]: JUMPXEQKN R6 K51 L24 NOT [1]
     170 [-]: GETIMPORT R7 33 [0xC8802016]
     171 [-]: MOVE R8 R4   
     172 [-]: CALL R7 1 3  
     173 [-]: FORGPREP_INEXT R7 L23
L22: 174 [-]: GETIMPORT R14 59 [0x0469F296]
...
L24: 182 [-]: JUMPXEQKN R6 K49 L27 NOT [0]
     ...
     191 [-]: CALL R7 1 0  
     192 [-]: GETIMPORT R7 33 [0xC8802016]
     193 [-]: MOVE R8 R4   
     194 [-]: CALL R7 1 3  
...
L27: 199 [-]: JUMPBACK L4  
L28: 200 [-]: GETIMPORT R3 4 [0x89326C93]
...
L29: 208 [-]: JUMPIF R3 L30
     209 [-]: GETIMPORT R3 14 [0x608BC054]
     210 [-]: CALL R3 0 1  
     211 [-]: MOVE R1 R3   
     212 [-]: LOADNIL R3   
     213 [-]: SETTABLEKS R3 R1 K15 ["instigator"]
     214 [-]: GETIMPORT R3 4 [0x89326C93]
     ...
     223 [-]: GETIMPORT R3 21 [0x69F3932E]
     ...
     231 [-]: CALL R3 4 0  
L30: 232 [-]: GETIMPORT R3 8 ["_T"]
     233 [-]: LOADB R4 0   
     234 [-]: SETTABLEKS R4 R3 K1 ["MonitoringAllyNpcs"]
     235 [-]: GETIMPORT R3 10 [0x3D106989]
