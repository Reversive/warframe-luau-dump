...
; Max Stack Size:  9
      ...
      24 [-]: NEWTABLE R3 0 1
      25 [-]: GETIMPORT R4 12 [0xB7CBD06B]
      26 [-]: LOADN R5 0   
      27 [-]: LOADN R6 1   
      28 [-]: CALL R4 2 1  
      29 [-]: LOADN R5 0   
      30 [-]: LOADB R6 0   
      31 [-]: GETIMPORT R7 14 [0x7ED0A956]
...
; Max Stack Size:  6
       ...
       0 [-]: GETIMPORT R3 1 [0x014A1A4C]
       1 [-]: LOADB R4 1   
       2 [-]: LOADB R5 0   
       3 [-]: NAMECALL R1 R0 K2 [0x5D985C7E]
       4 [-]: CALL R1 4 0  
       5 [-]: GETIMPORT R3 4 [0xF291C23D]
       6 [-]: LOADB R4 0   
       7 [-]: LOADB R5 1   
...
; Max Stack Size:  6
       ...
       0 [-]: GETIMPORT R3 1 [0x44919BE0]
       1 [-]: LOADB R4 1   
       2 [-]: LOADB R5 0   
       3 [-]: NAMECALL R1 R0 K2 [0x5D985C7E]
       4 [-]: CALL R1 4 0  
       5 [-]: GETIMPORT R3 4 [0xA9DBA931]
       6 [-]: LOADB R4 0   
       7 [-]: LOADB R5 1   
       8 [-]: NAMECALL R1 R0 K2 [0x5D985C7E]
       9 [-]: CALL R1 4 0  
...
; Max Stack Size:  18
       ...
       2 [-]: LOADB R2 1   
       3 [-]: CALL R1 1 0  
       4 [-]: GETIMPORT R2 3 ["OrdisCurrentVolume"]
...
L 1:  12 [-]: GETUPVAL R2 2
      ...
      15 [-]: CALL R1 1 1  
      16 [-]: SETUPVAL R1 1
      17 [-]: GETIMPORT R1 10 ["advancedQuestOrdis"]
      18 [-]: JUMPIF R1 L2 
      19 [-]: GETIMPORT R3 12 [0xA9DBA931]
      20 [-]: LOADB R4 0   
      21 [-]: LOADB R5 1   
...
L 2:  24 [-]: LOADNIL R1   
      25 [-]: LOADNIL R2   
      26 [-]: LOADNIL R3   
L 3:  27 [-]: GETIMPORT R4 10 ["advancedQuestOrdis"]
      28 [-]: JUMPIF R4 L8 
      29 [-]: GETIMPORT R4 15 [0x89326C93]
...
L 4:  37 [-]: JUMPIF R4 L5 
      ...
      51 [-]: CALL R4 2 0  
L 5:  52 [-]: GETIMPORT R5 23 ["curTransmission"]
      53 [-]: FASTCALL1 62 R5 L6
      54 [-]: GETIMPORT R4 5 [0x7B998233]
      55 [-]: CALL R4 1 1  
L 6:  56 [-]: JUMPIF R4 L7 
      57 [-]: GETIMPORT R4 23 ["curTransmission"]
      58 [-]: GETUPVAL R6 3
...
L 7:  73 [-]: GETUPVAL R4 4
      ...
      75 [-]: LOADB R4 0   
      76 [-]: SETUPVAL R4 4
      77 [-]: GETIMPORT R6 26 [0x0469F296]
      78 [-]: LOADK R7 K29 ["CloseMouth"]
      79 [-]: CALL R6 1 1  
      80 [-]: LOADB R7 0   
      81 [-]: NAMECALL R4 R0 K28 [0xD5F7912B]
      82 [-]: CALL R4 3 0  
L 8:  83 [-]: GETIMPORT R4 3 ["OrdisCurrentVolume"]
      84 [-]: GETIMPORT R5 31 [0x42DCC9F5]
      85 [-]: GETUPVAL R9 5
...
L10: 107 [-]: GETUPVAL R6 6
     ...
     111 [-]: GETIMPORT R7 38 [0xA40531D8]
     112 [-]: CALL R7 2 1  
...
L15: 142 [-]: GETUPVAL R13 7
     ...
     150 [-]: CALL R10 7 0 
     151 [-]: FORNLOOP R6 L12
L16: 152 [-]: GETIMPORT R6 43 [0xCBD666E1]
     153 [-]: LOADN R7 0   
     154 [-]: CALL R6 1 0  
     155 [-]: JUMPBACK L3  
     156 [-]: RETURN R0 0  
