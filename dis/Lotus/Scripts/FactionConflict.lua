...
L 0:   7 [-]: GETIMPORT R2 5 [0x89326C93]
      ...
      15 [-]: CALL R4 1 1  
L 1:  16 [-]: JUMPIF R4 L7 
      17 [-]: GETIMPORT R4 11 [0x59A86B70]
      18 [-]: GETIMPORT R5 14 ["faction"]
      19 [-]: JUMPIFNOTEQ R4 R5 L4
      20 [-]: GETIMPORT R4 16 [0x559B2179]
      21 [-]: JUMPIF R4 L2 
      22 [-]: NAMECALL R4 R3 K17 [0x152F5223]
      23 [-]: CALL R4 1 1  
      24 [-]: JUMPIF R4 L3 
L 2:  25 [-]: GETIMPORT R6 19 [0x0BDE36C0]
      26 [-]: LOADN R7 -8  
      ...
      31 [-]: CALL R4 2 0  
L 3:  32 [-]: GETIMPORT R6 23 [0xADF89ED2]
      33 [-]: GETIMPORT R7 25 [0xA20C21E2]
      34 [-]: GETIMPORT R8 27 [0x46B44448]
      35 [-]: GETIMPORT R9 29 [0xE8925DB8]
      36 [-]: NAMECALL R4 R3 K30 [0x6361B0B1]
      37 [-]: CALL R4 5 0  
      38 [-]: RETURN R0 0  
L 4:  39 [-]: GETIMPORT R4 16 [0x559B2179]
      40 [-]: JUMPIF R4 L5 
      41 [-]: NAMECALL R4 R3 K17 [0x152F5223]
      42 [-]: CALL R4 1 1  
      43 [-]: JUMPIF R4 L6 
L 5:  44 [-]: GETIMPORT R6 11 [0x59A86B70]
      45 [-]: LOADN R7 -8  
      ...
      50 [-]: CALL R4 2 0  
L 6:  51 [-]: GETIMPORT R6 25 [0xA20C21E2]
      52 [-]: GETIMPORT R7 23 [0xADF89ED2]
      53 [-]: GETIMPORT R8 29 [0xE8925DB8]
      54 [-]: GETIMPORT R9 27 [0x46B44448]
