...
L 7:  69 [-]: GETUPVAL R7 2; var7 = upvalues[2]
      ...
      72 [-]: JUMPIFNOTEQ R6 R7 L8; goto L8 if var6 ~= var132668
...
L 9:  85 [-]: LOADK R1 K37 ; var1 = "OpenRepStore"
      ...
      89 [-]: JUMPIFNOTLT R3 R2 L13; goto L13 if var3 >= var2687777
...
L14: 126 [-]: GETUPVAL R3 2; var3 = upvalues[2]
     ...
     129 [-]: JUMPIFNOTLE R2 R3 L15; goto L15 if var2 > var3408199
...
L20: 194 [-]: GETIMPORT R3 8; var3 = _T
     ...
     201 [-]: JUMPXEQKS R3 K49 L23 NOT; 
     202 [-]: GETIMPORT R4 73; var4 = _T["curTransmission"]
     203 [-]: FASTCALL1 64 R4 L21; 
     204 [-]: GETIMPORT R3 3; var3 = 0x7B998233
     205 [-]: CALL R3 2 2  ; var3 = var3(var4)
L21: 206 [-]: JUMPIF R3 L23; goto L23 if var3
     207 [-]: GETIMPORT R4 73; var4 = _T["curTransmission"]
     208 [-]: NAMECALL R4 R4 K74; var5 = var4; var4 = var4[0x22DA1852]
     209 [-]: CALL R4 2 0  ; var4, ... = var4(var5)
     210 [-]: FASTCALL 63 L22; 
     211 [-]: GETIMPORT R3 76; var3 = 0x64FB1586
     212 [-]: CALL R3 0 2  ; var3 = var3(var4, ...)
L22: 213 [-]: JUMPXEQKS R3 K37 L23 NOT; 
     214 [-]: GETUPVAL R4 1; var4 = upvalues[1]
     215 [-]: GETTABLEKS R3 R4 K77; var3 = var4[0xA5E42779]
     216 [-]: CALL R3 1 1  ; var3()
L23: 217 [-]: FASTCALL1 64 R0 L24; 
     218 [-]: MOVE R4 R0   ; var4 = var0
     219 [-]: GETIMPORT R3 3; var3 = 0x7B998233
     220 [-]: CALL R3 2 2  ; var3 = var3(var4)
L24: 221 [-]: JUMPIF R3 L25; goto L25 if var3
     222 [-]: LOADB R5 1   ; var5 = true
     223 [-]: NAMECALL R3 R0 K78; var4 = var0; var3 = var0[0x6CF1E476]
     224 [-]: CALL R3 3 1  ; var3(var4, var5)
L25: 225 [-]: GETIMPORT R4 80; var4 = 0xB607EFE1
     226 [-]: FASTCALL1 64 R4 L26; 
     227 [-]: GETIMPORT R3 3; var3 = 0x7B998233
     228 [-]: CALL R3 2 2  ; var3 = var3(var4)
L26: 229 [-]: JUMPIF R3 L27; goto L27 if var3
     230 [-]: GETUPVAL R4 0; var4 = upvalues[0]
     231 [-]: GETTABLEKS R3 R4 K12; var3 = var4[0x659D451F]
     232 [-]: GETIMPORT R4 80; var4 = 0xB607EFE1
...
L 0:   5 [-]: GETIMPORT R7 2; var7 = _T["LockedMovies"]
       6 [-]: FASTCALL1 63 R2 L1; 
       7 [-]: MOVE R9 R2   ; var9 = var2
       8 [-]: GETIMPORT R8 5; var8 = 0x64FB1586
       9 [-]: CALL R8 2 2  ; var8 = var8(var9)
L 1:  10 [-]: GETTABLE R6 R7 R8; var6 = var7[var8]
      11 [-]: JUMPXEQKNIL R6 L6 NOT; 
      12 [-]: GETIMPORT R6 7; var6 = 0x9BA7909F
      13 [-]: MOVE R8 R1   ; var8 = var1
      14 [-]: NAMECALL R6 R6 K8; var7 = var6; var6 = var6[0xCFBA257F]
...
L 2:  20 [-]: JUMPIF R7 L6 ; goto L6 if var7
      21 [-]: LOADK R9 K11 ; var9 = "SetMessage"
      22 [-]: MOVE R10 R3  ; var10 = var3
      23 [-]: NAMECALL R7 R6 K12; var8 = var6; var7 = var6[0xE4162EED]
      24 [-]: CALL R7 4 1  ; var7(var8, var9, var10)
      25 [-]: LOADK R9 K13 ; var9 = "SetOutOfService"
      26 [-]: LOADK R10 K14; var10 = "true"
      27 [-]: NAMECALL R7 R6 K12; var8 = var6; var7 = var6[0xE4162EED]
      28 [-]: CALL R7 4 1  ; var7(var8, var9, var10)
      29 [-]: LOADK R9 K15 ; var9 = "SetLiteMode"
      30 [-]: LOADK R10 K14; var10 = "true"
      31 [-]: NAMECALL R7 R6 K12; var8 = var6; var7 = var6[0xE4162EED]
...
L 3:  37 [-]: JUMPIF R7 L4 ; goto L4 if var7
      ...
      41 [-]: GETIMPORT R12 17; var12 = 0xA421AF95
      42 [-]: LOADN R13 1  ; var13 = 1
      43 [-]: LOADN R14 1  ; var14 = 1
      44 [-]: LOADN R15 1  ; var15 = 1
      45 [-]: CALL R12 4 0 ; var12, ... = var12(var13, var14, var15)
      46 [-]: NAMECALL R7 R6 K18; var8 = var6; var7 = var6[0xE395D771]
      47 [-]: CALL R7 0 1  ; var7(var8, ...)
L 4:  48 [-]: GETIMPORT R7 2; var7 = _T["LockedMovies"]
      49 [-]: FASTCALL1 63 R2 L5; 
      50 [-]: MOVE R9 R2   ; var9 = var2
      51 [-]: GETIMPORT R8 5; var8 = 0x64FB1586
      52 [-]: CALL R8 2 2  ; var8 = var8(var9)
L 5:  53 [-]: SETTABLE R6 R7 R8; var6[var7] = var8
L 6:  54 [-]: RETURN R0 0  ; 
...
L 1:   9 [-]: JUMPIF R0 L4 ; goto L4 if var0
      ...
      11 [-]: GETIMPORT R4 6; var4 = 0x5B45682D
      12 [-]: FASTCALL1 63 R4 L2; 
      13 [-]: GETIMPORT R3 8; var3 = 0x64FB1586
      14 [-]: CALL R3 2 2  ; var3 = var3(var4)
L 2:  15 [-]: GETTABLE R1 R2 R3; var1 = var2[var3]
      16 [-]: FASTCALL1 64 R1 L3; 
      17 [-]: GETIMPORT R0 4; var0 = 0x7B998233
      18 [-]: CALL R0 2 2  ; var0 = var0(var1)
L 3:  19 [-]: JUMPIFNOT R0 L5; goto L5 if not var0
L 4:  20 [-]: RETURN R0 0  ; 
L 5:  21 [-]: GETIMPORT R1 2; var1 = _T["LockedMovies"]
      22 [-]: GETIMPORT R3 6; var3 = 0x5B45682D
      23 [-]: FASTCALL1 63 R3 L6; 
      24 [-]: GETIMPORT R2 8; var2 = 0x64FB1586
      25 [-]: CALL R2 2 2  ; var2 = var2(var3)
L 6:  26 [-]: GETTABLE R0 R1 R2; var0 = var1[var2]
      27 [-]: LOADK R2 K9  ; var2 = "Close"
      28 [-]: LOADK R3 K10 ; var3 = ""
      29 [-]: NAMECALL R0 R0 K11; var1 = var0; var0 = var0[0xE4162EED]
      30 [-]: CALL R0 4 1  ; var0(var1, var2, var3)
      31 [-]: GETIMPORT R0 2; var0 = _T["LockedMovies"]
      32 [-]: GETIMPORT R2 6; var2 = 0x5B45682D
      33 [-]: FASTCALL1 63 R2 L7; 
      34 [-]: GETIMPORT R1 8; var1 = 0x64FB1586
      35 [-]: CALL R1 2 2  ; var1 = var1(var2)
L 7:  36 [-]: LOADNIL R2   ; var2 = nil
...
L 9:  53 [-]: GETTABLEKS R11 R10 K20; var11 = var10["mItemType"]
      ...
      55 [-]: JUMPIFNOTEQ R11 R12 L12; goto L12 if var11 ~= var1292503871
      56 [-]: GETTABLEKS R11 R10 K21; var11 = var10["mItemCount"]
      57 [-]: LOADN R12 0  ; var12 = 0
      58 [-]: JUMPIFLT R12 R11 L10; goto L10 if var12 < var16777734
...
L11:  60 [-]: NAMECALL R6 R5 K21; var7 = var5; var6 = var5[0xEFEE6C91]
      ...
      63 [-]: JUMPIFLE R7 R6 L12; goto L12 if var7 <= var16777990
...
L14:  70 [-]: GETIMPORT R5 5; var5 = 0xF6462F52
      71 [-]: FASTCALL1 64 R5 L15; 
      72 [-]: GETIMPORT R4 1; var4 = 0x7B998233
      73 [-]: CALL R4 2 2  ; var4 = var4(var5)
L15:  74 [-]: JUMPIF R4 L17; goto L17 if var4
      75 [-]: NAMECALL R4 R1 K23; var5 = var1; var4 = var1[0xF4E253B6]
      76 [-]: CALL R4 2 1  ; var4(var5)
      77 [-]: GETIMPORT R4 25; var4 = 0x603636AD
      78 [-]: GETIMPORT R6 27; var6 = 0x7B11D825
      79 [-]: FASTCALL1 63 R6 L16; 
      80 [-]: GETIMPORT R5 29; var5 = 0x64FB1586
      81 [-]: CALL R5 2 2  ; var5 = var5(var6)
L16:  82 [-]: LOADB R6 0   ; var6 = false
      83 [-]: CALL R4 3 2  ; var4 = var4(var5, var6)
      84 [-]: GETUPVAL R5 1; var5 = upvalues[1]
      85 [-]: MOVE R6 R1   ; var6 = var1
      86 [-]: GETIMPORT R7 5; var7 = 0xF6462F52
      87 [-]: GETIMPORT R8 7; var8 = 0x5B45682D
      88 [-]: MOVE R9 R4   ; var9 = var4
      89 [-]: GETIMPORT R10 31; var10 = 0x554E3EB0
      90 [-]: GETIMPORT R11 33; var11 = 0x00046924
      91 [-]: CALL R11 1 0 ; var11, ... = var11()
