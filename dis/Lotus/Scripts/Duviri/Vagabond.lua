...
L 6:  68 [-]: GETUPVAL R5 1
      ...
      72 [-]: GETIMPORT R3 14 [0x0469F296]
      73 [-]: LOADK R4 K25 ["VagabondCalm"]
      74 [-]: CALL R3 1 1  
      75 [-]: MOVE R2 R3   
L 7:  76 [-]: FASTCALL1 62 R2 L8
      77 [-]: MOVE R4 R2   
      78 [-]: GETIMPORT R3 27 [0x7B998233]
      79 [-]: CALL R3 1 1  
L 8:  80 [-]: JUMPIFNOT R3 L9
      81 [-]: RETURN R0 0  
L 9:  82 [-]: GETIMPORT R3 29 [0xC8802016]
      83 [-]: MOVE R4 R0   
      84 [-]: CALL R3 1 3  
...
L10:  86 [-]: MOVE R10 R2  
      ...
      93 [-]: CALL R8 3 0  
      94 [-]: GETIMPORT R10 33 ["gScriptTriggerType"]
      95 [-]: NAMECALL R8 R7 K34 [0xC1595BD5]
      96 [-]: CALL R8 2 1  
      97 [-]: FASTCALL1 62 R8 L11
      98 [-]: MOVE R10 R8  
      99 [-]: GETIMPORT R9 27 [0x7B998233]
     100 [-]: CALL R9 1 1  
L11: 101 [-]: JUMPIF R9 L14
     102 [-]: GETIMPORT R9 29 [0xC8802016]
     103 [-]: MOVE R10 R8  
     104 [-]: CALL R9 1 3  
...
; Max Stack Size:  15
       ...
       3 [-]: CALL R2 1 1  
       4 [-]: GETIMPORT R5 3 ["gSequencerType"]
       5 [-]: NAMECALL R3 R2 K4 [0xC9F6A7D7]
       6 [-]: CALL R3 2 1  
       7 [-]: GETIMPORT R6 6 ["gLookTriggerType"]
       8 [-]: NAMECALL R4 R2 K7 [0xC1595BD5]
       9 [-]: CALL R4 2 1  
      10 [-]: LOADNIL R5   
      11 [-]: GETIMPORT R6 9 [0xC8802016]
      12 [-]: MOVE R7 R4   
      13 [-]: CALL R6 1 3  
      14 [-]: FORGPREP_INEXT R6 L1
L 0:  15 [-]: GETIMPORT R13 11 [0x0469F296]
...
L 5:  40 [-]: JUMPIF R8 L9 
      ...
      45 [-]: LOADB R6 1   
L 6:  46 [-]: JUMPIF R6 L7 
      47 [-]: GETIMPORT R8 20 [0x67652851]
      48 [-]: CALL R8 0 1  
      49 [-]: ADD R7 R7 R8 
      50 [-]: GETIMPORT R8 22 [0x0C123964]
      51 [-]: JUMPIFNOTLT R7 R8 L8
      52 [-]: LOADB R6 1   
      53 [-]: JUMP L8
     
L 7:  54 [-]: LOADN R7 0   
L 8:  55 [-]: GETIMPORT R8 24 [0xCBD666E1]
      56 [-]: LOADN R9 0   
      57 [-]: CALL R8 1 0  
      58 [-]: JUMPBACK L4  
