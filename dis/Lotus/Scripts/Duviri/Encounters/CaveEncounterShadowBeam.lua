...
L 2:  23 [-]: JUMPIFNOT R2 L3; goto L3 if not var2
      24 [-]: RETURN R0 0  ; 
L 3:  25 [-]: GETIMPORT R2 9; var2 = _T
      26 [-]: SETTABLEKS R1 R2 K10; var1["CondrixExplicitSource"] = var2
      27 [-]: GETIMPORT R4 12; var4 = 0xD6C9F44C
      28 [-]: GETIMPORT R5 14; var5 = EMPTY_SYMBOL
      29 [-]: GETIMPORT R6 16; var6 = ZERO_VECTOR
      30 [-]: GETIMPORT R7 18; var7 = 0x20B7F774
      31 [-]: GETIMPORT R8 16; var8 = ZERO_VECTOR
      32 [-]: GETIMPORT R9 20; var9 = 0xA421AF95
      33 [-]: LOADN R10 0  ; var10 = 0
      34 [-]: LOADN R11 1  ; var11 = 1
      35 [-]: LOADN R12 0  ; var12 = 0
      36 [-]: CALL R9 4 0  ; var9, ... = var9(var10, var11, var12)
      37 [-]: CALL R7 0 0  ; var7, ... = var7(var8, ...)
      38 [-]: NAMECALL R2 R0 K21; var3 = var0; var2 = var0[0x47901F07]
      39 [-]: CALL R2 0 2  ; var2 = var2(var3, ...)
      40 [-]: SETUPVAL R2 0; upvalues[2] = var0
L 4:  41 [-]: RETURN R0 0  ; 
