...
L 1:   6 [-]: GETIMPORT R1 3; var1 = 0x89326C93
      ...
      40 [-]: JUMPIFNOTLT R10 R9 L3; goto L3 if var10 >= var84415273
...
L 9:  76 [-]: LOADN R12 0  ; var12 = 0
      77 [-]: JUMPIFNOTLT R12 R8 L17; goto L17 if var12 >= var69168
...
L11:  90 [-]: JUMPIF R16 L14; goto L14 if var16
      ...
      93 [-]: JUMPIFNOTLT R17 R16 L13; goto L13 if var17 >= var69436
      94 [-]: GETUPVAL R15 1; var15 = upvalues[1]
      95 [-]: LENGTH R16 R11; var16 = #var11
      96 [-]: JUMPIFNOTLT R16 R14 L12; goto L12 if var16 >= var724788
...
L17: 139 [-]: LOADN R12 0  ; var12 = 0
     140 [-]: JUMPIFNOTLT R12 R8 L18; goto L18 if var12 >= var1379361
     141 [-]: GETIMPORT R12 21; var12 = 0x3D106989
     142 [-]: LOADK R14 K46; var14 = " Patrol Spawned @"
     143 [-]: NAMECALL R15 R0 K47; var16 = var0; var15 = var0[0x7D7E07AB]
...
L18: 148 [-]: GETIMPORT R12 21; var12 = 0x3D106989
     ...
     150 [-]: NAMECALL R15 R0 K47; var16 = var0; var15 = var0[0x7D7E07AB]
...
L 3:  11 [-]: GETUPVAL R1 2; var1 = upvalues[2]
      ...
      14 [-]: JUMPIFNOTEQ R1 R2 L7; goto L7 if var1 ~= var262433
...
L 4:  22 [-]: GETUPVAL R1 5; var1 = upvalues[5]
      ...
      26 [-]: JUMPIFNOTEQ R1 R2 L5; goto L5 if var1 ~= var262460
...
L 6:  37 [-]: JUMPIF R1 L19; goto L19 if var1
      ...
      42 [-]: JUMPIFNOTLT R2 R1 L19; goto L19 if var2 >= var262460
...
L 8:  64 [-]: GETUPVAL R1 2; var1 = upvalues[2]
      ...
      67 [-]: JUMPIFNOTEQ R1 R2 L16; goto L16 if var1 ~= var525372
...
L15: 120 [-]: GETIMPORT R1 21; var1 = _T["TargetsRemaining"]
     ...
     124 [-]: JUMPIFNOTLE R1 R2 L19; goto L19 if var1 > var262460
...
L16: 142 [-]: GETUPVAL R1 2; var1 = upvalues[2]
     ...
     145 [-]: JUMPIFNOTEQ R1 R2 L17; goto L17 if var1 ~= var327996
...
L17: 156 [-]: GETUPVAL R1 2; var1 = upvalues[2]
     ...
     159 [-]: JUMPIFNOTEQ R1 R2 L18; goto L18 if var1 ~= var327996
...
L18: 170 [-]: GETUPVAL R1 2; var1 = upvalues[2]
     ...
     173 [-]: JUMPIFNOTEQ R1 R2 L19; goto L19 if var1 ~= var65571
L19: 174 [-]: RETURN R0 0  ; 
...
; Max Stack Size:  5
       ...
       7 [-]: JUMPIFNOTEQ R0 R1 L0; goto L0 if var0 ~= var65571
       8 [-]: RETURN R0 0  ; 
L 0:   9 [-]: GETUPVAL R0 0; var0 = upvalues[0]
      10 [-]: GETUPVAL R2 2; var2 = upvalues[2]
      11 [-]: GETTABLEKS R1 R2 K2; var1 = var2["STARTED"]
      12 [-]: JUMPIFNOTEQ R0 R1 L1; goto L1 if var0 ~= var196668
...
L11: 147 [-]: MOVE R8 R2   ; var8 = var2
     ...
     154 [-]: JUMPIFNOTEQ R3 R4 L12; goto L12 if var3 ~= var1246012
...
L14:  83 [-]: GETIMPORT R4 29; var4 = _T["DebugPersistentSideActivities"]
      ...
      88 [-]: JUMPIFNOTEQ R4 R5 L15; goto L15 if var4 ~= var-1241316276
...
L 0:   7 [-]: NAMECALL R2 R0 K1; var3 = var0; var2 = var0[0xEFE6CAD1]
       ...
       9 [-]: LOADN R3 4   ; var3 = 4
      10 [-]: JUMPIFNOTLT R2 R3 L5; goto L5 if var2 >= var197153
...
L 1:  25 [-]: GETUPVAL R2 5; var2 = upvalues[5]
      ...
      35 [-]: JUMPIFNOTLE R3 R2 L4; goto L4 if var3 > var394044
