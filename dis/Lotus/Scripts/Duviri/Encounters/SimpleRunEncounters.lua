...
L 1:  18 [-]: RETURN R0 0  
L 2:  19 [-]: GETIMPORT R3 14 [0xB7A88EC0]
      20 [-]: LENGTH R2 R3 
      21 [-]: LOADN R3 0   
      22 [-]: JUMPIFNOTLE R2 R3 L3
      23 [-]: GETIMPORT R2 4 [0x3D106989]
      24 [-]: LOADK R3 K15 ["ERROR: no encounters in the list"]
      25 [-]: CALL R2 1 0  
      26 [-]: RETURN R0 0  
L 3:  27 [-]: GETIMPORT R2 17 [0x43E5032C]
      28 [-]: JUMPIFNOT R2 L4
      29 [-]: GETUPVAL R3 0
...
L 4:  34 [-]: GETIMPORT R2 20 [0x89326C93]
      ...
      41 [-]: MOVE R4 R2   
      42 [-]: GETIMPORT R3 9 [0x7B998233]
      43 [-]: CALL R3 1 1  
L 5:  44 [-]: JUMPIF R3 L6 
      45 [-]: GETIMPORT R3 20 [0x89326C93]
      ...
      58 [-]: CALL R6 3 0  
L 6:  59 [-]: GETIMPORT R3 20 [0x89326C93]
...
L 7:  65 [-]: GETUPVAL R3 1
      ...
      67 [-]: CALL R3 1 1  
      68 [-]: JUMPIF R3 L8 
      69 [-]: GETIMPORT R3 32 [0xCBD666E1]
      70 [-]: LOADN R4 0   
      71 [-]: CALL R3 1 0  
      72 [-]: JUMPBACK L7  
L 8:  73 [-]: GETIMPORT R3 34 [0x44FF7B4E]
      74 [-]: GETIMPORT R4 36 ["EMPTY_SYMBOL"]
      75 [-]: JUMPIFEQ R3 R4 L9
      76 [-]: GETUPVAL R3 1
      77 [-]: GETIMPORT R5 34 [0x44FF7B4E]
      78 [-]: NAMECALL R3 R3 K37 [0x058C13A1]
      79 [-]: CALL R3 2 0  
L 9:  80 [-]: LOADN R3 1   
      81 [-]: MOVE R6 R3   
      82 [-]: GETIMPORT R7 14 [0xB7A88EC0]
      83 [-]: LENGTH R4 R7 
      84 [-]: LOADN R5 1   
      85 [-]: FORNPREP R4 L17
L10:  86 [-]: GETIMPORT R8 14 [0xB7A88EC0]
      87 [-]: GETTABLE R7 R8 R6
      88 [-]: GETIMPORT R8 20 [0x89326C93]
      89 [-]: GETIMPORT R11 39 [0xA60CB26E]
      90 [-]: GETTABLE R10 R11 R6
      91 [-]: NAMECALL R8 R8 K22 [0x46A0EBF5]
      92 [-]: CALL R8 2 1  
      93 [-]: NAMECALL R9 R7 K40 [0xE223E2B1]
      94 [-]: CALL R9 1 1  
      95 [-]: GETIMPORT R10 4 [0x3D106989]
     ...
     102 [-]: MOVE R12 R8  
     103 [-]: GETIMPORT R11 9 [0x7B998233]
     104 [-]: CALL R11 1 1 
...
L12: 114 [-]: GETUPVAL R11 1
     ...
     118 [-]: CALL R11 3 1 
     119 [-]: MOVE R10 R11 
L13: 120 [-]: GETIMPORT R11 32 [0xCBD666E1]
     121 [-]: LOADN R12 0  
     122 [-]: CALL R11 1 0 
     123 [-]: GETIMPORT R11 4 [0x3D106989]
...
L14: 128 [-]: FASTCALL1 62 R10 L15
     129 [-]: MOVE R12 R10 
     130 [-]: GETIMPORT R11 9 [0x7B998233]
     131 [-]: CALL R11 1 1 
L15: 132 [-]: JUMPIF R11 L16
     133 [-]: NAMECALL R11 R10 K45 [0xD8140B94]
     134 [-]: CALL R11 1 1 
     135 [-]: JUMPIFNOT R11 L16
     136 [-]: GETIMPORT R11 32 [0xCBD666E1]
     137 [-]: LOADN R12 0  
     138 [-]: CALL R11 1 0 
     139 [-]: JUMPBACK L14 
L16: 140 [-]: GETIMPORT R11 4 [0x3D106989]
     141 [-]: LOADK R13 K46 ["Encounter ended: "]
     142 [-]: MOVE R14 R9  
     143 [-]: CONCAT R12 R13 R14
     144 [-]: CALL R11 1 0 
     145 [-]: FORNLOOP R4 L10
L17: 146 [-]: GETIMPORT R4 34 [0x44FF7B4E]
     147 [-]: GETIMPORT R5 36 ["EMPTY_SYMBOL"]
     148 [-]: JUMPIFEQ R4 R5 L18
     149 [-]: GETUPVAL R4 1
     150 [-]: GETIMPORT R6 34 [0x44FF7B4E]
     151 [-]: NAMECALL R4 R4 K47 [0xD5E4FBC2]
     152 [-]: CALL R4 2 0  
L18: 153 [-]: GETIMPORT R4 4 [0x3D106989]
