...
L 0:   5 [-]: GETUPVAL R6 0; var6 = upvalues[0]
       ...
       8 [-]: JUMPIFNOTEQ R4 R0 L1; goto L1 if var4 ~= var131875
       9 [-]: RETURN R3 1  ; 
...
L 0:   4 [-]: JUMPIFNOTEQ R4 R0 L1; goto L1 if var4 ~= var67078
...
L 1:   8 [-]: JUMPIFNOTEQ R9 R4 L2; goto L2 if var9 ~= var66822
