...
; Max Stack Size:  10
       ...
       9 [-]: RETURN R0 0  
L 0:  10 [-]: GETIMPORT R1 6 [0xB5985109]
      11 [-]: NAMECALL R1 R1 K7 [0xF37943FF]
      12 [-]: CALL R1 1 1  
      13 [-]: JUMPIFNOT R1 L2
      14 [-]: GETIMPORT R1 6 [0xB5985109]
...
L 1:  21 [-]: JUMPIF R2 L2 
      ...
      27 [-]: CALL R2 -1 1 
      28 [-]: MOVE R5 R1   
      29 [-]: GETIMPORT R6 6 [0xB5985109]
      30 [-]: NAMECALL R6 R6 K15 [0xD1586535]
      31 [-]: CALL R6 1 1  
      32 [-]: GETIMPORT R7 6 [0xB5985109]
      ...
      40 [-]: CALL R3 6 0  
L 2:  41 [-]: GETIMPORT R1 22 [0xDC0F8C57]
      42 [-]: LOADK R3 K23 ["TriggerPort"]
      43 [-]: NAMECALL R1 R1 K24 [0x8EB2112D]
      44 [-]: CALL R1 2 0  
      45 [-]: GETIMPORT R2 26 [0xEFF358BB]
      46 [-]: FASTCALL1 62 R2 L3
      47 [-]: GETIMPORT R1 10 [0x7B998233]
      48 [-]: CALL R1 1 1  
L 3:  49 [-]: JUMPIF R1 L4 
      50 [-]: GETIMPORT R1 1 [0x89326C93]
      51 [-]: GETIMPORT R3 26 [0xEFF358BB]
...
L 1:   5 [-]: JUMPIFNOT R2 L2
      ...
      17 [-]: CALL R2 1 0  
      18 [-]: JUMPBACK L0  
L 2:  19 [-]: GETIMPORT R2 3 [0x89326C93]
...
L 3:  33 [-]: JUMPIF R4 L6 
      ...
      35 [-]: CALL R4 1 1  
      36 [-]: JUMPIFNOT R4 L6
      37 [-]: GETIMPORT R4 15 [0xB009BBC6]
      38 [-]: MOVE R5 R3   
      39 [-]: CALL R4 1 1  
      40 [-]: MOVE R3 R4   
      41 [-]: GETIMPORT R4 15 [0xB009BBC6]
      ...
      48 [-]: CALL R8 1 1  
      49 [-]: GETIMPORT R9 18 ["ZERO_ROTATION"]
...
L 4:  77 [-]: MOVE R13 R10 
      ...
      83 [-]: CALL R12 3 0 
      84 [-]: FORNLOOP R8 L4
L 5:  85 [-]: GETIMPORT R8 3 [0x89326C93]
      86 [-]: MOVE R10 R5  
