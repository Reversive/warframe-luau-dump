...
L 2:  27 [-]: JUMPIF R2 L3 
      ...
      32 [-]: CALL R2 -1 0 
L 3:  33 [-]: GETIMPORT R2 12 [0x89326C93]
      34 [-]: GETIMPORT R4 14 [0x0469F296]
...
L 4:  45 [-]: JUMPIFNOT R3 L5
      46 [-]: GETIMPORT R3 8 [0x3D106989]
      47 [-]: LOADK R4 K21 ["No prisoner avatar found to rescue. Aborting"]
      48 [-]: CALL R3 1 0  
      49 [-]: RETURN R0 0  
L 5:  50 [-]: GETIMPORT R4 23 [0xCCA58FC9]
      51 [-]: FASTCALL1 62 R4 L6
      52 [-]: GETIMPORT R3 4 [0x7B998233]
      53 [-]: CALL R3 1 1  
L 6:  54 [-]: JUMPIF R3 L7 
      55 [-]: GETIMPORT R3 23 [0xCCA58FC9]
      56 [-]: GETIMPORT R5 25 [0x0A966C47]
      57 [-]: LOADB R6 1   
      58 [-]: LOADB R7 0   
      59 [-]: NAMECALL R3 R3 K26 [0x5D985C7E]
      60 [-]: CALL R3 4 0  
      61 [-]: GETIMPORT R3 23 [0xCCA58FC9]
      62 [-]: GETIMPORT R5 28 [0xD1FCC7FD]
      63 [-]: LOADB R6 0   
      64 [-]: LOADB R7 1   
...
L 9:  76 [-]: NAMECALL R3 R2 K30 [0xFA9E477F]
      ...
      90 [-]: CALL R4 5 0  
      91 [-]: LOADN R6 6   
      92 [-]: GETIMPORT R7 14 [0x0469F296]
      93 [-]: LOADK R8 K33 ["InCell"]
      94 [-]: CALL R7 1 -1 
      95 [-]: NAMECALL R4 R3 K34 [0x31A3964D]
      96 [-]: CALL R4 -1 0 
      97 [-]: GETIMPORT R4 36 [0xCBD666E1]
      98 [-]: LOADN R5 1   
      99 [-]: CALL R4 1 0  
     100 [-]: GETIMPORT R5 38 [0xC102A528]
     101 [-]: FASTCALL1 62 R5 L10
     102 [-]: GETIMPORT R4 4 [0x7B998233]
     103 [-]: CALL R4 1 1  
...
L11: 109 [-]: JUMPIF R4 L12
     110 [-]: GETIMPORT R6 38 [0xC102A528]
     111 [-]: LOADB R7 1   
     112 [-]: LOADB R8 1   
     113 [-]: LOADB R9 0   
...
L14: 121 [-]: JUMPIF R5 L15
     122 [-]: GETIMPORT R5 41 [0x5A79A3A0]
     123 [-]: JUMPIFNOTLT R4 R5 L15
     124 [-]: GETIMPORT R7 38 [0xC102A528]
     125 [-]: NAMECALL R5 R2 K42 [0x68D0CBED]
     126 [-]: CALL R5 2 1  
     127 [-]: GETIMPORT R6 44 [0xE80B50B8]
     128 [-]: JUMPIFNOTLT R6 R5 L15
     129 [-]: GETIMPORT R5 36 [0xCBD666E1]
     130 [-]: LOADN R6 0   
     131 [-]: CALL R5 1 0  
     132 [-]: GETIMPORT R5 46 [0x67652851]
     133 [-]: CALL R5 0 1  
     134 [-]: ADD R4 R4 R5 
     135 [-]: JUMPBACK L13 
...
; Max Stack Size:  5
       ...
       0 [-]: GETIMPORT R1 1 [0xCCA58FC9]
       1 [-]: FASTCALL1 62 R1 L0
       2 [-]: GETIMPORT R0 3 [0x7B998233]
       3 [-]: CALL R0 1 1  
L 0:   4 [-]: JUMPIF R0 L1 
       5 [-]: GETIMPORT R0 1 [0xCCA58FC9]
       6 [-]: GETIMPORT R2 5 [0xCDB6F111]
       7 [-]: LOADB R3 0   
       8 [-]: LOADB R4 1   
