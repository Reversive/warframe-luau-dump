...
; Max Stack Size:  5
      ...
      21 [-]: CALL R1 3 0  
      22 [-]: JUMPIFNOT R0 L0
L 0:  23 [-]: GETIMPORT R1 1 [0x3D106989]
      24 [-]: LOADK R2 K16 ["Railjack Key Mission: Initialize host complete"]
      25 [-]: CALL R1 1 0  
      26 [-]: GETIMPORT R1 18 [0x14459A1C]
      27 [-]: JUMPIF R1 L1 
      28 [-]: GETUPVAL R1 3
      29 [-]: GETUPVAL R4 4
...
L 0:  21 [-]: SETUPVAL R1 2
      ...
      25 [-]: SETUPVAL R1 3
      26 [-]: JUMPIFNOT R0 L1
L 1:  27 [-]: GETIMPORT R1 1 [0x3D106989]
...
L 5:  38 [-]: GETUPVAL R1 3
      ...
      42 [-]: GETIMPORT R1 3 [0x89326C93]
      43 [-]: NAMECALL R1 R1 K19 [0x8B5B1F58]
      44 [-]: CALL R1 1 1  
      45 [-]: SETUPVAL R1 7
      46 [-]: GETIMPORT R1 21 [0xC8802016]
      47 [-]: GETUPVAL R2 7
      48 [-]: CALL R1 1 3  
...
L11: 104 [-]: GETUPVAL R1 3
     ...
     108 [-]: GETIMPORT R1 3 [0x89326C93]
     109 [-]: GETIMPORT R3 25 [0x0469F296]
     110 [-]: LOADK R4 K36 ["Sentient"]
     111 [-]: CALL R3 1 1  
     112 [-]: LOADB R4 0   
     113 [-]: NAMECALL R1 R1 K37 [0xA59B978B]
     114 [-]: CALL R1 3 1  
     115 [-]: GETIMPORT R2 21 [0xC8802016]
     116 [-]: MOVE R3 R1   
     117 [-]: CALL R2 1 3  
     118 [-]: FORGPREP_INEXT R2 L13
L12: 119 [-]: GETIMPORT R9 25 [0x0469F296]
...
L15: 141 [-]: JUMPIF R4 L16
     ...
     143 [-]: CALL R4 1 1  
     144 [-]: GETIMPORT R5 25 [0x0469F296]
     145 [-]: LOADK R6 K41 ["Exit"]
     146 [-]: CALL R5 1 1  
     147 [-]: JUMPIFNOTEQ R4 R5 L16
     148 [-]: GETUPVAL R5 10
     149 [-]: GETTABLEKS R4 R5 K42 [0x9742B85B]
     150 [-]: GETIMPORT R5 45 ["MissionTransmissionSet"]
     151 [-]: GETIMPORT R6 25 [0x0469F296]
...
L 2:  39 [-]: GETUPVAL R2 0
      ...
      47 [-]: GETIMPORT R2 12 ["MissionTransmissionSet"]
      48 [-]: GETIMPORT R3 14 [0x0469F296]
...
L 9:  67 [-]: GETUPVAL R3 0
      ...
      75 [-]: JUMPIFNOT R3 L10
      76 [-]: GETUPVAL R3 7
      77 [-]: GETIMPORT R4 20 [0x67652851]
      78 [-]: CALL R4 0 -1 
      79 [-]: CALL R3 -1 0 
L10:  80 [-]: GETIMPORT R3 20 [0x67652851]
      81 [-]: CALL R3 0 1  
      82 [-]: GETIMPORT R4 6 [0x89326C93]
      83 [-]: NAMECALL R4 R4 K21 [0x8B5B1F58]
      84 [-]: CALL R4 1 1  
      85 [-]: SETUPVAL R4 8
      86 [-]: GETIMPORT R6 6 [0x89326C93]
      87 [-]: NAMECALL R6 R6 K22 [0x61BE252A]
      88 [-]: CALL R6 1 1  
      89 [-]: GETIMPORT R7 24 [0x9BA7909F]
