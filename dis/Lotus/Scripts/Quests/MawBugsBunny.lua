...
L15: 111 [-]: JUMPIFNOT R10 L17; goto L17 if not var10
     ...
     124 [-]: JUMPIFNOTLE R12 R13 L16; goto L16 if var12 > var2493985
...
L35: 232 [-]: JUMPIF R12 L38; goto L38 if var12
     ...
     241 [-]: JUMPIFLE R12 R13 L36; goto L36 if var12 <= var3410977
     242 [-]: GETIMPORT R12 52; var12 = 0x46102A7B
     243 [-]: JUMPIFNOTLE R12 R11 L37; goto L37 if var12 > var67590
...
L52: 398 [-]: JUMPIF R10 L53; goto L53 if var10
     ...
     402 [-]: JUMPIFLE R10 R11 L53; goto L53 if var10 <= var-100464052
...
L 1:  14 [-]: JUMPIF R2 L2 ; goto L2 if var2
      ...
      22 [-]: NAMECALL R3 R1 K11; var4 = var1; var3 = var1[0x6F8BABF9]
      23 [-]: CALL R3 2 2  ; var3 = var3(var4)
      24 [-]: JUMPIF R3 L2 ; goto L2 if var3
      25 [-]: GETIMPORT R5 7; var5 = 0x233CF5B1
      26 [-]: NAMECALL R5 R5 K12; var6 = var5; var5 = var5[0xD1586535]
      27 [-]: CALL R5 2 2  ; var5 = var5(var6)
      28 [-]: GETIMPORT R6 14; var6 = 0x00046924
      29 [-]: CALL R6 1 0  ; var6, ... = var6()
      30 [-]: NAMECALL R3 R1 K15; var4 = var1; var3 = var1[0x589EF1C1]
