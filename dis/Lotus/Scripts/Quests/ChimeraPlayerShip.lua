...
; Max Stack Size:  8
 ...
 11 [-]: GETTABLE  R2 R2 K4     ; R82 := R2[0xa559eb32]
 12 [-]: CALL      R2 1 1       ; R2()
 13 [-]: GETUPVAL  R2 U0        ; R2 := U0
 14 [-]: GETTABLE  R2 R2 K5     ; R82 := R2[0xfe0d9469]
 15 [-]: CALL      R2 1 1       ; R2()
 ...
 32 [-]: GETTABLE  R3 R3 K11    ; R82 := R3[0x1f60d532]
 ...
 43 [-]: JMP       52           ; PC := 52
 44 [-]: SELF      R3 R2 K13    ; R4 := R2; R3 := R2[0x055478b1]
 45 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 46 [-]: LT        0 R3 K14     ; if R3 >= 0.990000 then PC := 52
 47 [-]: JMP       52           ; PC := 52
 48 [-]: GETGLOBAL R3 K15       ; R3 := 0xcbd666e1
 49 [-]: LOADK     R4 0         ; R4 := 0.000000
 50 [-]: CALL      R3 2 1       ; R3(R4)
 51 [-]: JMP       39           ; PC := 39
 52 [-]: GETGLOBAL R3 K16       ; R3 := 0x89326c93
 53 [-]: SELF      R3 R3 K17    ; R4 := R3; R3 := R3[0xfb669000]
 54 [-]: GETGLOBAL R5 K18       ; R5 := 0xa193d56b
 55 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 56 [-]: TEST      R3 1         ; if R3 then PC := 59
 57 [-]: JMP       59           ; PC := 59
 58 [-]: NEWTABLE  R3 0 0       ; R3 := {}
 59 [-]: GETTABLE  R3 R3 K19    ; R3 := R3[1.000000]
 60 [-]: GETGLOBAL R4 K7        ; R4 := 0x7b998233
 61 [-]: MOVE      R5 R3        ; R5 := R3
 62 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 63 [-]: TEST      R4 1         ; if R4 then PC := 73
 64 [-]: JMP       73           ; PC := 73
 65 [-]: SELF      R4 R3 K20    ; R5 := R3; R4 := R3[0x768274d6]
 66 [-]: OP_LOADBOOL R6 1 0       ; R6 := true
 67 [-]: OP_LOADBOOL R7 1 0       ; R7 := true
 68 [-]: CALL      R4 4 1       ; R4(R5,R6,R7)
 69 [-]: SELF      R4 R3 K21    ; R5 := R3; R4 := R3[0x47901f07]
 70 [-]: GETGLOBAL R6 K22       ; R6 := 0x4c1e78be
 71 [-]: GETGLOBAL R7 K23       ; R7 := EMPTY_SYMBOL
 72 [-]: CALL      R4 4 1       ; R4(R5,R6,R7)
 73 [-]: GETGLOBAL R4 K16       ; R4 := 0x89326c93
 74 [-]: SELF      R4 R4 K24    ; R5 := R4; R4 := R4[0x46a0ebf5]
 75 [-]: GETGLOBAL R6 K25       ; R6 := 0x0469f296
 76 [-]: LOADK     R7 K26       ; R7 := "ChimeraAction"
 ...
 83 [-]: JMP       86           ; PC := 86
 84 [-]: SELF      R5 R4 K27    ; R6 := R4; R5 := R4[0x383d2e7d]
...
; Max Stack Size:  8
 ...
 46 [-]: GETTABLE  R4 R4 K14    ; R82 := R4[0xac1b386a]
 47 [-]: MUL       R5 R2 K15    ; R5 := R2 * 2.000000
 48 [-]: LOADK     R6 60        ; R6 := 60.000000
...
; Max Stack Size:  9
  ...
  2 [-]: GETTABLE  R1 R1 K1     ; R82 := R1[0xc201b901]
  3 [-]: CALL      R1 1 2       ; R1 := R1()
 ...
 59 [-]: GETTABLE  R5 R5 K23    ; R82 := R5[0xac1b386a]
 60 [-]: MUL       R6 R2 K24    ; R6 := R2 * 2.000000
 61 [-]: LOADK     R7 60        ; R7 := 60.000000
...
; Max Stack Size:  18
 ...
 11 [-]: GETTABLE  R0 R0 K3     ; R82 := R0[0xa559eb32]
 12 [-]: CALL      R0 1 1       ; R0()
 13 [-]: GETUPVAL  R0 U1        ; R0 := U1
 14 [-]: GETTABLE  R0 R0 K4     ; R82 := R0[0xfe0d9469]
 15 [-]: CALL      R0 1 1       ; R0()
 16 [-]: GETGLOBAL R0 K5        ; R0 := 0xbd496aa1
 17 [-]: GETTABLE  R0 R0 K6     ; R82 := R0[0x42645da3]
...
144 [-]: GETTABLE  R14 R14 K41  ; R82 := R14[0xe05d242d]
...
; Max Stack Size:  16
 ...
 97 [-]: GETTABLE  R6 R6 K27    ; R82 := R6[0xb32054f8]
 98 [-]: MOVE      R7 R1        ; R7 := R1
...
; Max Stack Size:  4
 ...
 24 [-]: GETTABLE  R1 R1 K7     ; R82 := R1[0xd2a1d93b]
