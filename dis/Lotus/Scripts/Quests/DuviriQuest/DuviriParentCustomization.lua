...
; Max Stack Size:  24
     ...
     124 [-]: MOVE R7 R5   
     125 [-]: GETIMPORT R6 61 [nil]
     126 [-]: CALL R6 1 1  
L 0: 127 [-]: JUMPIFNOT R6 L1
     128 [-]: GETIMPORT R6 63 [nil]
     129 [-]: LOADK R7 K64 ["Failed to find player customization when customizing skin color"]
     130 [-]: CALL R6 1 0  
     131 [-]: RETURN R0 0  
L 1: 132 [-]: GETIMPORT R6 67 [nil]
     133 [-]: CALL R6 0 1  
     134 [-]: LOADNIL R7   
     135 [-]: GETIMPORT R8 69 [nil]
     136 [-]: JUMPIFNOT R8 L4
     137 [-]: GETIMPORT R9 71 [nil]
     138 [-]: JUMPIFNOT R9 L2
     139 [-]: GETIMPORT R8 73 [nil]
     140 [-]: GETUPVAL R9 0
     141 [-]: CALL R8 1 1  
     142 [-]: JUMPIF R8 L3 
L 2: 143 [-]: GETIMPORT R8 73 [nil]
     144 [-]: GETUPVAL R9 1
     145 [-]: CALL R8 1 1  
L 3: 146 [-]: MOVE R7 R8   
     147 [-]: JUMP L7
     
L 4: 148 [-]: GETIMPORT R9 71 [nil]
     149 [-]: JUMPIFNOT R9 L5
     150 [-]: GETIMPORT R8 73 [nil]
     151 [-]: GETUPVAL R9 2
     152 [-]: CALL R8 1 1  
     153 [-]: JUMPIF R8 L6 
L 5: 154 [-]: GETIMPORT R8 73 [nil]
     155 [-]: GETUPVAL R9 3
     156 [-]: CALL R8 1 1  
L 6: 157 [-]: MOVE R7 R8   
L 7: 158 [-]: GETIMPORT R8 75 [nil]
     159 [-]: MOVE R10 R7  
     ...
     166 [-]: MOVE R11 R9  
     167 [-]: GETIMPORT R10 61 [nil]
     168 [-]: CALL R10 1 1 
L 8: 169 [-]: JUMPIFNOT R10 L9
     170 [-]: GETIMPORT R10 63 [nil]
...
L 9: 174 [-]: MOVE R12 R9  
     ...
     176 [-]: CALL R10 2 0 
     177 [-]: GETIMPORT R10 80 [nil]
     178 [-]: CALL R10 0 1 
     179 [-]: GETIMPORT R11 80 [nil]
     180 [-]: CALL R11 0 1 
     181 [-]: GETIMPORT R12 80 [nil]
     182 [-]: CALL R12 0 1 
     183 [-]: GETIMPORT R13 82 [nil]
