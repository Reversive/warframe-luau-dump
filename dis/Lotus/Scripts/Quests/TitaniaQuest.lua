...
L 0:  13 [-]: GETIMPORT R2 2; var2 = 0xBE190284
      ...
      20 [-]: JUMPIFEQ R1 R2 L1; goto L1 if var1 == var197180
...
L 7: 128 [-]: JUMPIF R3 L12; goto L12 if var3
     ...
     133 [-]: JUMPIFNOTLT R4 R3 L12; goto L12 if var4 >= var3474209
...
L10: 154 [-]: GETUPVAL R4 0; var4 = upvalues[0]
     ...
     157 [-]: GETUPVAL R5 5; var5 = upvalues[5]
          159 [-]: JUMPIFNOTLT R3 R4 L11; goto L11 if var3 >= var590652
...
L17: 233 [-]: NAMECALL R10 R9 K70; var11 = var9; var10 = var9[0x2D0A291F]
     ...
     238 [-]: JUMPIFNOTEQ R10 R11 L18; goto L18 if var10 ~= var592929
...
; Max Stack Size:  21
      ...
      14 [-]: JUMPIFEQ R2 R3 L0; goto L0 if var2 == var66364
...
L 6:  80 [-]: JUMPIFEQ R14 R15 L8; goto L8 if var14 == var658988
      81 [-]: JUMPIFEQ R14 R3 L8; goto L8 if var14 == var528172
      82 [-]: JUMPIFEQ R15 R3 L8; goto L8 if var15 == var200215
      83 [-]: JUMPIFNOTEQ R14 R4 L7; goto L7 if var14 ~= var1771079
      84 [-]: LOADK R6 K27 ; var6 = "Warmer"
      85 [-]: JUMP L8      ; goto L8
L 7:  86 [-]: JUMPIFNOTEQ R15 R4 L8; goto L8 if var15 ~= var1836615
...
L 1:  17 [-]: JUMPIF R6 L2 ; goto L2 if var6
      ...
      31 [-]: JUMPIFNOTLT R7 R6 L2; goto L2 if var7 >= var132131
      32 [-]: RETURN R4 1  ; 
...
; Max Stack Size:  25
      ...
      12 [-]: JUMPIFEQ R2 R3 L0; goto L0 if var2 == var525089
      13 [-]: GETIMPORT R3 8; var3 = 0x0469F296
      14 [-]: LOADK R4 K10 ; var4 = "FairyQuestB"
      15 [-]: CALL R3 2 2  ; var3 = var3(var4)
      16 [-]: JUMPIFEQ R2 R3 L0; goto L0 if var2 == var525089
      17 [-]: GETIMPORT R3 8; var3 = 0x0469F296
      18 [-]: LOADK R4 K11 ; var4 = "FairyQuestC"
      19 [-]: CALL R3 2 2  ; var3 = var3(var4)
      20 [-]: JUMPIFNOTEQ R2 R3 L1; goto L1 if var2 ~= var65571
L 0:  21 [-]: RETURN R0 0  ; 
...
L10:  78 [-]: JUMPIF R11 L14; goto L14 if var11
      ...
      83 [-]: JUMPIFNOTLT R12 R11 L14; goto L14 if var12 >= var-200668340
...
L12: 102 [-]: NAMECALL R21 R19 K26; var22 = var19; var21 = var19[0x9435EB6D]
     ...
     105 [-]: JUMPIFEQ R13 R20 L13; goto L13 if var13 == var1829966924
...
L13: 116 [-]: FORGLOOP R15 L12 2 [inext]; 
     ...
     119 [-]: JUMPIFNOTLE R15 R16 L14; goto L14 if var15 > var135484
...
L 0:   4 [-]: JUMPIF R2 L13; goto L13 if var2
       ...
       8 [-]: LOADN R3 0   ; var3 = 0
       9 [-]: JUMPIFNOTLT R3 R2 L13; goto L13 if var3 >= var262945
...
L 3:  30 [-]: JUMPIF R7 L4 ; goto L4 if var7
      ...
      35 [-]: JUMPIFNOTEQ R7 R8 L4; goto L4 if var7 ~= var1862272844
...
L 5:  44 [-]: GETIMPORT R2 1; var2 = 0x89326C93
      ...
      79 [-]: JUMPIFNOTLT R9 R8 L6; goto L6 if var9 >= var1509409
...
L 6:  84 [-]: LOADN R10 3  ; var10 = 3
     ...
     106 [-]: JUMPIFNOTLT R13 R12 L7; goto L7 if var13 >= var134204
...
L11: 157 [-]: NAMECALL R13 R4 K42; var14 = var4; var13 = var4[0x831D3143]
     ...
     161 [-]: JUMPIFLE R14 R13 L12; goto L12 if var14 <= var1124339020
...
; Max Stack Size:  4
       ...
       5 [-]: LOADN R1 0   ; var1 = 0
       6 [-]: JUMPIFNOTLT R1 R0 L1; goto L1 if var1 >= var262945
...
; Max Stack Size:  4
       ...
       6 [-]: CALL R1 2 2  ; var1 = var1(var2)
       7 [-]: JUMPIFNOTEQ R0 R1 L0; goto L0 if var0 ~= var572
       8 [-]: GETUPVAL R2 0; var2 = upvalues[0]
...
L 0:  14 [-]: GETIMPORT R1 5; var1 = 0x0469F296
      ...
      17 [-]: JUMPIFNOTEQ R0 R1 L1; goto L1 if var0 ~= var572
...
L 1:  24 [-]: GETIMPORT R1 5; var1 = 0x0469F296
      ...
      27 [-]: JUMPIFNOTEQ R0 R1 L2; goto L2 if var0 ~= var572
