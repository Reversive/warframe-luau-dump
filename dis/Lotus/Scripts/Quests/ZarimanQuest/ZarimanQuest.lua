...
; Max Stack Size:  8
 ...
 28 [-]: CONST     R7 5000      ; R7 := 5000.000000
...
101 [-]: CONST     R7 -100      ; R7 := -100.000000
...
254 [-]: CONST     R8 1         ; R8 := 1.000000
255 [-]: CALL      R6 3 1       ; R6(R7,R8)
256 [-]: GETUPVAL  R6 U3        ; R6 := U3
257 [-]: LOADKB    R7 0 0       ; R7 := false
