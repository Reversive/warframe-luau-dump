...
L 1:   5 [-]: JUMPIFNOT R1 L2
      ...
      12 [-]: CALL R1 1 0  
      13 [-]: JUMPBACK L0  
L 2:  14 [-]: GETIMPORT R1 6 [0xCBD666E1]
      15 [-]: LOADN R2 2   
      16 [-]: CALL R1 1 0  
...
L 3:  21 [-]: JUMPIF R1 L4 
      ...
      24 [-]: JUMPIFNOT R1 L5
L 4:  25 [-]: RETURN R0 0  
L 5:  26 [-]: GETIMPORT R3 9 [0xE80E8D4E]
      27 [-]: LOADB R4 1   
...
L 6:  40 [-]: JUMPIF R1 L7 
      ...
      43 [-]: JUMPIFNOT R1 L8
L 7:  44 [-]: RETURN R0 0  
L 8:  45 [-]: GETIMPORT R3 15 [0x677D8C55]
      46 [-]: LOADB R4 1   
      47 [-]: NAMECALL R1 R0 K10 [0x511D26B8]
      48 [-]: CALL R1 3 0  
L 9:  49 [-]: GETIMPORT R1 16 ["podsUsed"]
      50 [-]: JUMPIF R1 L10
      51 [-]: GETIMPORT R1 6 [0xCBD666E1]
      52 [-]: LOADN R2 0   
      53 [-]: CALL R1 1 0  
      54 [-]: JUMPBACK L9  
L10:  55 [-]: LOADN R3 1   
      56 [-]: GETIMPORT R4 18 [0x8858B853]
      57 [-]: LENGTH R1 R4 
      58 [-]: LOADN R2 1   
      59 [-]: FORNPREP R1 L15
...
L12:  64 [-]: JUMPIF R4 L13
      ...
      67 [-]: JUMPIFNOT R4 L14
L13:  68 [-]: RETURN R0 0  
L14:  69 [-]: GETIMPORT R7 18 [0x8858B853]
      70 [-]: GETTABLE R6 R7 R3
      71 [-]: LOADB R7 1   
      72 [-]: NAMECALL R4 R0 K10 [0x511D26B8]
      73 [-]: CALL R4 3 0  
      74 [-]: GETIMPORT R4 6 [0xCBD666E1]
