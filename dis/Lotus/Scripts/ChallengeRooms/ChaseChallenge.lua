...
; Max Stack Size:  26
      ...
      27 [-]: CALL R8 1 1  
      28 [-]: GETIMPORT R9 9 [0xB009BBC6]
      29 [-]: LOADK R10 K17 ["/Lotus/Interface/EndOfMatch.swf"]
      30 [-]: CALL R9 1 1  
      31 [-]: GETIMPORT R10 9 [0xB009BBC6]
      32 [-]: LOADK R11 K18 ["/Lotus/Animations/Tenno/Emotes/Generic/StandToKneel_anim.fbx"]
      33 [-]: CALL R10 1 1 
      34 [-]: GETIMPORT R11 20 [0x0469F296]
      35 [-]: LOADK R12 K21 ["TimeLimit"]
      36 [-]: CALL R11 1 1 
      37 [-]: GETIMPORT R12 23 [0x89326C93]
      38 [-]: NAMECALL R12 R12 K24 [0x29EF273D]
      39 [-]: CALL R12 1 1 
      40 [-]: NAMECALL R13 R12 K25 [0x66905CB0]
      41 [-]: CALL R13 1 1 
      42 [-]: GETIMPORT R14 27 [0xBE190284]
      43 [-]: LOADNIL R15  
      44 [-]: LOADNIL R16  
      45 [-]: NEWTABLE R17 0 0
      46 [-]: GETIMPORT R18 29 [0x00046924]
      47 [-]: CALL R18 0 1 
      48 [-]: GETIMPORT R19 31 [0x60130201]
      49 [-]: LOADN R20 0  
      50 [-]: LOADN R21 255
      51 [-]: LOADN R22 0  
      52 [-]: CALL R19 3 1 
      53 [-]: LOADN R20 0  
      54 [-]: GETIMPORT R21 9 [0xB009BBC6]
...
; Max Stack Size:  12
      ...
      14 [-]: GETIMPORT R3 11 ["ShowImpactMessage"]
      15 [-]: GETIMPORT R4 13 [0x603636AD]
      16 [-]: LOADK R5 K14 ["/Lotus/Language/Dojo/ChaseChallengeProgress"]
      17 [-]: DUPTABLE R6 16
      18 [-]: GETIMPORT R7 19 [0xE8072DED]
      19 [-]: LOADK R8 K20 ["%.0f"]
      20 [-]: GETUPVAL R11 0
...
; Max Stack Size:  7
      ...
      14 [-]: GETIMPORT R2 11 ["HideImpactMessage"]
      15 [-]: CALL R2 0 0  
      16 [-]: LOADN R4 1   
      17 [-]: LENGTH R2 R1 
      18 [-]: LOADN R3 1   
...
L 0:  14 [-]: GETIMPORT R9 10 ["gTriggerType"]
      15 [-]: NAMECALL R7 R6 K11 [0xC9F6A7D7]
      16 [-]: CALL R7 2 1  
      17 [-]: GETIMPORT R8 13 [0x11A19C5E]
      18 [-]: MOVE R9 R7   
      19 [-]: LOADK R10 K14 ["OnTouched"]
      20 [-]: CALL R8 2 0  
      21 [-]: GETIMPORT R8 13 [0x11A19C5E]
      22 [-]: MOVE R9 R7   
      ...
      31 [-]: GETIMPORT R11 20 ["gBaseMarkerInfoType"]
      32 [-]: NAMECALL R9 R6 K11 [0xC9F6A7D7]
      33 [-]: CALL R9 2 1  
      34 [-]: SETTABLEKS R9 R8 K21 ["Marker"]
      35 [-]: GETIMPORT R11 23 [0x7ED0A956]
...
L 1:  49 [-]: FORGLOOP R2 L0 2 [inext]
      ...
      86 [-]: LOADN R4 3   
      87 [-]: CALL R3 1 0  
      88 [-]: GETIMPORT R3 5 [0x89326C93]
      89 [-]: GETIMPORT R5 23 [0x7ED0A956]
     ...
     124 [-]: GETIMPORT R5 32 [0x0469F296]
     ...
     163 [-]: MOVE R7 R5   
     164 [-]: GETIMPORT R6 60 [0x7B998233]
     165 [-]: CALL R6 1 1  
...
L 3: 177 [-]: GETUPVAL R6 11
     ...
     181 [-]: CALL R6 3 0  
L 4: 182 [-]: GETIMPORT R6 8 [0xC8802016]
     183 [-]: MOVE R7 R5   
     184 [-]: CALL R6 1 3  
...
L 7: 196 [-]: JUMPIF R6 L25
     ...
     200 [-]: GETIMPORT R8 60 [0x7B998233]
     201 [-]: CALL R8 1 1  
L 8: 202 [-]: JUMPIF R8 L10
     ...
     209 [-]: GETIMPORT R8 60 [0x7B998233]
     210 [-]: CALL R8 1 1  
L 9: 211 [-]: JUMPIFNOT R8 L11
L10: 212 [-]: GETIMPORT R8 73 ["HideImpactMessage"]
     213 [-]: CALL R8 0 0  
     214 [-]: GETUPVAL R9 7
...
L11: 228 [-]: GETIMPORT R8 77 [0xCFC01047]
     229 [-]: GETUPVAL R9 2
     230 [-]: CALL R8 1 3  
...
L12: 232 [-]: GETTABLEKS R13 R12 K17 ["Touching"]
     ...
     236 [-]: GETIMPORT R13 60 [0x7B998233]
     237 [-]: CALL R13 1 1 
...
L15: 254 [-]: SETTABLEKS R13 R12 K16 ["Progress"]
     ...
     263 [-]: CALL R13 -1 0
     264 [-]: GETIMPORT R13 89 [0x60130201]
     265 [-]: LOADN R14 74 
     266 [-]: LOADN R15 74 
     267 [-]: LOADN R16 74 
     268 [-]: CALL R13 3 1 
     ...
     275 [-]: GETIMPORT R16 93 ["EMISSIVE_TINT_COLOR"]
     ...
     295 [-]: CALL R14 1 0 
     296 [-]: GETIMPORT R14 73 ["HideImpactMessage"]
     297 [-]: CALL R14 0 0 
     298 [-]: GETIMPORT R14 5 [0x89326C93]
     299 [-]: GETIMPORT R16 32 [0x0469F296]
...
L16: 313 [-]: GETTABLE R19 R14 R17
     ...
     315 [-]: GETIMPORT R18 60 [0x7B998233]
     316 [-]: CALL R18 1 1 
...
L19: 322 [-]: GETIMPORT R14 106 ["ShowImpactMessage"]
     323 [-]: GETIMPORT R15 108 [0x603636AD]
     324 [-]: LOADK R16 K109 ["/Lotus/Language/Dojo/ChaseChallengeProgress"]
     325 [-]: DUPTABLE R17 111
     326 [-]: GETIMPORT R18 114 [0xE8072DED]
...
L24: 365 [-]: GETUPVAL R9 10
     ...
     367 [-]: CALL R8 0 0  
     368 [-]: GETUPVAL R8 0
     369 [-]: GETIMPORT R10 80 [0x67652851]
     370 [-]: CALL R10 0 -1
     371 [-]: NAMECALL R8 R8 K121 [0xFAA69527]
     372 [-]: CALL R8 -1 0 
     373 [-]: GETIMPORT R8 123 [0xCBD666E1]
     374 [-]: LOADN R9 0   
     375 [-]: CALL R8 1 0  
     376 [-]: JUMPBACK L7  
L25: 377 [-]: GETUPVAL R9 10
     ...
     385 [-]: GETUPVAL R11 21
     386 [-]: GETUPVAL R12 22
     387 [-]: GETIMPORT R13 127 [0xD2BB8F07]
     388 [-]: CALL R8 5 0  
     389 [-]: RETURN R0 0  
