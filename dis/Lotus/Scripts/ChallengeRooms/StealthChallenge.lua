...
; Max Stack Size:  8
      ...
      34 [-]: CALL R0 2 0  
      35 [-]: GETIMPORT R0 15 [0xC8802016]
      36 [-]: GETIMPORT R1 17 [0x3A28B8A2]
      37 [-]: CALL R0 1 3  
      38 [-]: FORGPREP_INEXT R0 L1
L 0:  39 [-]: GETIMPORT R5 19 [0x11A19C5E]
      40 [-]: MOVE R6 R4   
      41 [-]: LOADK R7 K20 ["OnAgentCombat"]
      42 [-]: CALL R5 2 0  
L 1:  43 [-]: FORGLOOP R0 L0 2 [inext]
      44 [-]: GETIMPORT R0 15 [0xC8802016]
      45 [-]: GETIMPORT R1 22 [0xEFB2C750]
      46 [-]: CALL R0 1 3  
      47 [-]: FORGPREP_INEXT R0 L3
L 2:  48 [-]: GETIMPORT R5 19 [0x11A19C5E]
      49 [-]: MOVE R6 R4   
      50 [-]: LOADK R7 K23 ["OnExecuted"]
      51 [-]: CALL R5 2 0  
L 3:  52 [-]: FORGLOOP R0 L2 2 [inext]
L 4:  53 [-]: GETUPVAL R0 3
      54 [-]: GETIMPORT R1 25 [0x83FBA472]
      55 [-]: JUMPIFNOTLT R0 R1 L5
      56 [-]: GETIMPORT R0 26 ["gChallengeComplete"]
      57 [-]: JUMPIF R0 L5 
      58 [-]: GETIMPORT R0 5 [0xCBD666E1]
      59 [-]: LOADN R1 0   
      60 [-]: CALL R0 1 0  
      61 [-]: JUMPBACK L4  
L 5:  62 [-]: GETUPVAL R1 2
      63 [-]: FASTCALL1 62 R1 L6
      64 [-]: GETIMPORT R0 28 [0x7B998233]
      65 [-]: CALL R0 1 1  
L 6:  66 [-]: JUMPIFNOT R0 L7
      67 [-]: GETIMPORT R0 30 [0x89326C93]
      68 [-]: LOADN R2 0   
      69 [-]: NAMECALL R0 R0 K31 [0xE3A0BBCA]
      70 [-]: CALL R0 2 1  
      71 [-]: SETUPVAL R0 2
L 7:  72 [-]: GETIMPORT R0 26 ["gChallengeComplete"]
      73 [-]: JUMPIFNOT R0 L8
      74 [-]: GETIMPORT R0 33 [0x2D0FAD09]
      75 [-]: LOADK R1 K34 ["Lotus.Interface.LotusUtilities"]
      76 [-]: CALL R0 1 1  
      77 [-]: GETTABLEKS R1 R0 K35 [0x0EDF1088]
      78 [-]: GETUPVAL R2 2
      79 [-]: GETIMPORT R3 37 [0x62B46842]
      80 [-]: GETIMPORT R4 39 [0xBB5B1BFE]
      81 [-]: GETIMPORT R5 41 [0x5B6123C1]
      82 [-]: GETIMPORT R6 43 [0xD2BB8F07]
      83 [-]: CALL R1 5 0  
      84 [-]: RETURN R0 0  
L 8:  85 [-]: GETUPVAL R0 2
      86 [-]: GETIMPORT R2 37 [0x62B46842]
      87 [-]: LOADB R3 1   
      88 [-]: LOADN R4 2   
      89 [-]: LOADN R5 3   
      90 [-]: LOADB R6 1   
      ...
      92 [-]: CALL R0 6 0  
      93 [-]: GETUPVAL R0 2
      94 [-]: GETIMPORT R2 46 [0x68A4A2B0]
      95 [-]: LOADB R3 1   
      96 [-]: NAMECALL R0 R0 K47 [0x511D26B8]
      97 [-]: CALL R0 3 0  
      98 [-]: GETIMPORT R0 5 [0xCBD666E1]
      99 [-]: LOADN R1 3   
     100 [-]: CALL R0 1 0  
     101 [-]: GETUPVAL R1 4
...
L 1:   6 [-]: GETIMPORT R1 5 ["_T"]
      ...
      10 [-]: ADDK R1 R2 K7 [1]
      11 [-]: SETUPVAL R1 0
      12 [-]: GETIMPORT R1 2 ["ShowImpactMessage"]
      13 [-]: GETIMPORT R2 9 [0x603636AD]
...
L 3:  30 [-]: GETUPVAL R1 1
      ...
      43 [-]: CALL R1 3 0  
      44 [-]: GETUPVAL R1 1
      45 [-]: GETIMPORT R4 19 [0xBCC1697A]
      46 [-]: GETIMPORT R5 21 ["gRsIndex"]
      47 [-]: GETTABLE R3 R4 R5
      48 [-]: NAMECALL R3 R3 K22 [0xD1586535]
      49 [-]: CALL R3 1 -1 
      50 [-]: NAMECALL R1 R1 K23 [0x589EF1C1]
      51 [-]: CALL R1 -1 0 
      52 [-]: GETIMPORT R1 13 [0xCBD666E1]
      53 [-]: LOADN R2 1   
      54 [-]: CALL R1 1 0  
      55 [-]: GETIMPORT R1 25 [0xC8802016]
      56 [-]: GETIMPORT R2 27 [0x3A28B8A2]
      57 [-]: CALL R1 1 3  
...
L 5:  62 [-]: FORGLOOP R1 L4 2 [inext]
      63 [-]: GETIMPORT R1 31 [0x89326C93]
      64 [-]: GETIMPORT R3 33 ["gLotusNpcAvatarType"]
      65 [-]: NAMECALL R1 R1 K34 [0xFB669000]
      66 [-]: CALL R1 2 1  
      67 [-]: GETIMPORT R2 25 [0xC8802016]
      68 [-]: MOVE R3 R1   
      69 [-]: CALL R2 1 3  
...
L 8:  79 [-]: JUMPIFNOT R7 L9
      80 [-]: GETIMPORT R7 13 [0xCBD666E1]
      81 [-]: LOADN R8 0   
      82 [-]: CALL R7 1 0  
      83 [-]: JUMPBACK L7  
L 9:  84 [-]: FORGLOOP R2 L6 2 [inext]
      85 [-]: GETIMPORT R2 31 [0x89326C93]
      86 [-]: GETIMPORT R4 38 ["gRagdollType"]
      87 [-]: NAMECALL R2 R2 K34 [0xFB669000]
      88 [-]: CALL R2 2 1  
      89 [-]: GETIMPORT R3 25 [0xC8802016]
      90 [-]: MOVE R4 R2   
      91 [-]: CALL R3 1 3  
...
L11:  95 [-]: FORGLOOP R3 L10 2 [inext]
      96 [-]: GETIMPORT R4 41 [0x94DCEF3C]
      97 [-]: GETIMPORT R5 21 ["gRsIndex"]
      98 [-]: GETTABLE R3 R4 R5
      99 [-]: LOADK R5 K42 ["Reset"]
     100 [-]: NAMECALL R3 R3 K29 [0x8EB2112D]
     101 [-]: CALL R3 2 0  
     102 [-]: GETUPVAL R3 1
     103 [-]: GETIMPORT R5 44 [0x19626B6C]
     104 [-]: LOADB R6 0   
     105 [-]: LOADN R7 3   
     ...
     112 [-]: LOADN R6 1   
     113 [-]: CALL R3 3 0  
     114 [-]: GETIMPORT R3 5 ["_T"]
     115 [-]: LOADB R4 0   
     116 [-]: SETTABLEKS R4 R3 K6 ["gSpotted"]
     117 [-]: GETIMPORT R3 2 ["ShowImpactMessage"]
     118 [-]: GETIMPORT R8 9 [0x603636AD]
     119 [-]: LOADK R9 K46 ["/Lotus/Language/Game/AttemptsLeft"]
     120 [-]: LOADNIL R10  
     121 [-]: CALL R8 2 1  
     122 [-]: MOVE R5 R8   
     123 [-]: LOADK R6 K47 [": "]
     124 [-]: GETIMPORT R8 49 [0x83FBA472]
     125 [-]: GETUPVAL R9 0
     126 [-]: SUB R7 R8 R9 
     127 [-]: CONCAT R4 R5 R7
     128 [-]: LOADN R5 5   
...
; Max Stack Size:  6
       ...
       6 [-]: MOVE R3 R1   
       7 [-]: GETIMPORT R4 4 [0xB7560D8C]
       8 [-]: GETIMPORT R5 6 [0x916A0A0C]
       9 [-]: CALL R2 3 0  
      10 [-]: RETURN R0 0  
...
L 5:  31 [-]: JUMPIFNOT R4 L6
      ...
      33 [-]: CALL R4 1 1  
      34 [-]: MOVE R2 R4   
      35 [-]: GETIMPORT R4 3 [0xCBD666E1]
      36 [-]: LOADN R5 0   
      37 [-]: CALL R4 1 0  
      38 [-]: JUMPBACK L4  
L 6:  39 [-]: JUMPBACK L3  
L 7:  40 [-]: GETIMPORT R5 12 [0x66C01AFD]
...
L 8:  44 [-]: JUMPIF R4 L9 
      ...
      55 [-]: CALL R4 6 0  
      56 [-]: GETIMPORT R4 3 [0xCBD666E1]
      57 [-]: GETIMPORT R5 17 [0x74B75231]
      58 [-]: CALL R4 1 0  
