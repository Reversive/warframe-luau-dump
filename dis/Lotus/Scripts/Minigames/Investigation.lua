...
; Max Stack Size:  6
 ...
 15 [-]: SETTABLE  R1 K6 R2     ; R1["ZoomExtraScriptTrigger"] := R2
...
156 [-]: TEST      R22 0        ; if not R22 then PC := 422
157 [-]: JMP       422          ; PC := 422
...
161 [-]: TEST      R22 1        ; if R22 then PC := 422
162 [-]: JMP       422          ; PC := 422
...
194 [-]: LOADK     R29 -180     ; R29 := -180.000000
195 [-]: LOADK     R30 180      ; R30 := 180.000000
...
203 [-]: LOADK     R29 -90      ; R29 := -90.000000
204 [-]: LOADK     R30 90       ; R30 := 90.000000
...
265 [-]: JMP       267          ; PC := 267
266 [-]: LOADBOOL  R23 0 1      ; R23 := false; PC := 267
...
374 [-]: TEST      R37 0        ; if not R37 then PC := 422
375 [-]: JMP       422          ; PC := 422
...
380 [-]: TEST      R37 0        ; if not R37 then PC := 422
381 [-]: JMP       422          ; PC := 422
382 [-]: TEST      R22 0        ; if not R22 then PC := 422
383 [-]: JMP       422          ; PC := 422
...
390 [-]: LOADK     R39 32       ; R39 := 32.000000
391 [-]: LOADK     R40 0        ; R40 := 0.000000
392 [-]: LOADK     R41 0        ; R41 := 0.000000
393 [-]: LOADK     R42 192      ; R42 := 192.000000
...
399 [-]: LOADK     R41 32       ; R41 := 32.000000
400 [-]: LOADK     R42 0        ; R42 := 0.000000
401 [-]: LOADK     R43 192      ; R43 := 192.000000
...
420 [-]: LOADK     R45 0        ; R45 := 0.000000
421 [-]: CALL      R39 7 1      ; R39(R40,R41,R42,R43,R44,R45)
422 [-]: GETGLOBAL R39 K5       ; R39 := _T
423 [-]: GETTABLE  R39 R39 K6   ; R39 := R39["InvestigationMinigame"]
424 [-]: GETTABLE  R39 R39 K27  ; R39 := R39["Interacting"]
425 [-]: TEST      R39 0        ; if not R39 then PC := 532
426 [-]: JMP       532          ; PC := 532
427 [-]: GETGLOBAL R39 K5       ; R39 := _T
428 [-]: GETTABLE  R39 R39 K6   ; R39 := R39["InvestigationMinigame"]
429 [-]: GETTABLE  R39 R39 K69  ; R39 := R39["ZoomItem"]
430 [-]: TEST      R39 0        ; if not R39 then PC := 532
431 [-]: JMP       532          ; PC := 532
432 [-]: GETUPVAL  R39 U15      ; R39 := U15
433 [-]: GETTABLE  R39 R39 K70  ; R39 := R39[0x06d055f9]
434 [-]: GETGLOBAL R40 K71      ; R40 := 0x34291f5c
435 [-]: GETTABLE  R40 R40 K72  ; R40 := R40[0x1467d5f4]
436 [-]: CALL      R40 1 2      ; R40 := R40()
437 [-]: LOADK     R41 K73      ; R41 := "<MENU_CANCEL>"
438 [-]: LOADK     R42 K74      ; R42 := "<MENU_RIGHT_CLICK>"
439 [-]: CALL      R39 4 2      ; R39 := R39(R40,R41,R42)
440 [-]: NEWTABLE  R40 0 2      ; R40 := {}
441 [-]: SETTABLE  R40 K75 R39  ; R40["EXIT_CALLOUT"] := R39
442 [-]: GETUPVAL  R41 U16      ; R41 := U16
443 [-]: SETTABLE  R40 K76 R41  ; R40["REQUIRED"] := R41
444 [-]: GETGLOBAL R41 K5       ; R41 := _T
445 [-]: GETTABLE  R41 R41 K6   ; R41 := R41["InvestigationMinigame"]
446 [-]: GETTABLE  R41 R41 K77  ; R41 := R41["FoundAllClues"]
447 [-]: TEST      R41 0        ; if not R41 then PC := 462
448 [-]: JMP       462          ; PC := 462
449 [-]: GETGLOBAL R41 K16      ; R41 := 0x7b998233
450 [-]: GETGLOBAL R42 K5       ; R42 := _T
451 [-]: GETTABLE  R42 R42 K6   ; R42 := R42["InvestigationMinigame"]
452 [-]: GETTABLE  R42 R42 K78  ; R42 := R42["ZoomExtraScriptTrigger"]
453 [-]: CALL      R41 2 2      ; R41 := R41(R42)
454 [-]: TEST      R41 1        ; if R41 then PC := 462
455 [-]: JMP       462          ; PC := 462
456 [-]: GETGLOBAL R41 K5       ; R41 := _T
457 [-]: GETTABLE  R41 R41 K29  ; R41 := R41[0x1de6f231]
458 [-]: LOADK     R42 K79      ; R42 := "/Lotus/Language/NightwaveSeasonThree/InvestigationUnzoomSpecial"
459 [-]: MOVE      R43 R40      ; R43 := R40
460 [-]: CALL      R41 3 1      ; R41(R42,R43)
461 [-]: JMP       467          ; PC := 467
462 [-]: GETGLOBAL R41 K5       ; R41 := _T
463 [-]: GETTABLE  R41 R41 K29  ; R41 := R41[0x1de6f231]
464 [-]: LOADK     R42 K80      ; R42 := "/Lotus/Language/NightwaveSeasonThree/InvestigationUnzoom"
465 [-]: MOVE      R43 R40      ; R43 := R40
466 [-]: CALL      R41 3 1      ; R41(R42,R43)
467 [-]: GETUPVAL  R41 U5       ; R41 := U5
468 [-]: TEST      R41 0        ; if not R41 then PC := 473
469 [-]: JMP       473          ; PC := 473
470 [-]: GETUPVAL  R41 U17      ; R41 := U17
471 [-]: CALL      R41 1 1      ; R41()
472 [-]: JMP       532          ; PC := 532
473 [-]: GETUPVAL  R41 U3       ; R41 := U3
474 [-]: TEST      R41 0        ; if not R41 then PC := 532
475 [-]: JMP       532          ; PC := 532
476 [-]: GETUPVAL  R41 U4       ; R41 := U4
477 [-]: TEST      R41 0        ; if not R41 then PC := 532
478 [-]: JMP       532          ; PC := 532
479 [-]: GETGLOBAL R41 K16      ; R41 := 0x7b998233
480 [-]: GETGLOBAL R42 K5       ; R42 := _T
481 [-]: GETTABLE  R42 R42 K6   ; R42 := R42["InvestigationMinigame"]
482 [-]: GETTABLE  R42 R42 K78  ; R42 := R42["ZoomExtraScriptTrigger"]
483 [-]: CALL      R41 2 2      ; R41 := R41(R42)
484 [-]: TEST      R41 1        ; if R41 then PC := 532
485 [-]: JMP       532          ; PC := 532
486 [-]: GETGLOBAL R41 K5       ; R41 := _T
487 [-]: GETTABLE  R41 R41 K6   ; R41 := R41["InvestigationMinigame"]
488 [-]: GETTABLE  R41 R41 K77  ; R41 := R41["FoundAllClues"]
489 [-]: TEST      R41 0        ; if not R41 then PC := 532
490 [-]: JMP       532          ; PC := 532
491 [-]: GETGLOBAL R41 K81      ; R41 := 0x25d99d89
492 [-]: SELF      R41 R41 K82  ; R42 := R41; R41 := R41[0x25a6e75e]
493 [-]: CALL      R41 2 2      ; R41 := R41(R42)
494 [-]: SELF      R42 R41 K83  ; R43 := R41; R42 := R41[0xbadb2a78]
495 [-]: GETUPVAL  R44 U18      ; R44 := U18
496 [-]: CALL      R42 3 2      ; R42 := R42(R43,R44)
497 [-]: GETGLOBAL R43 K5       ; R43 := _T
498 [-]: GETTABLE  R43 R43 K6   ; R43 := R43["InvestigationMinigame"]
499 [-]: GETTABLE  R43 R43 K84  ; R43 := R43["SpentTimePoints"]
500 [-]: TEST      R43 1        ; if R43 then PC := 532
501 [-]: JMP       532          ; PC := 532
502 [-]: GETUPVAL  R43 U16      ; R43 := U16
503 [-]: LE        0 R43 R42    ; if R43 > R42 then PC := 516
504 [-]: JMP       516          ; PC := 516
505 [-]: GETGLOBAL R43 K5       ; R43 := _T
506 [-]: GETTABLE  R43 R43 K6   ; R43 := R43["InvestigationMinigame"]
507 [-]: SETTABLE  R43 K84 K58  ; R43["SpentTimePoints"] := true
508 [-]: GETUPVAL  R43 U0       ; R43 := U0
509 [-]: CALL      R43 1 2      ; R43 := R43()
510 [-]: SELF      R43 R43 K85  ; R44 := R43; R43 := R43[0x89f5abe4]
511 [-]: GETUPVAL  R45 U19      ; R45 := U19
512 [-]: CALL      R43 3 1      ; R43(R44,R45)
513 [-]: GETUPVAL  R43 U20      ; R43 := U20
514 [-]: CALL      R43 1 1      ; R43()
515 [-]: JMP       532          ; PC := 532
516 [-]: LOADBOOL  R43 1 0      ; R43 := true
517 [-]: SETUPVAL  R43 U21      ; U82 := R21
518 [-]: GETGLOBAL R43 K86      ; R43 := 0x603636ad
519 [-]: LOADK     R44 K87      ; R44 := "/Lotus/Language/NightwaveSeasonThree/InsufficientWeaveResonance"
520 [-]: NEWTABLE  R45 0 2      ; R45 := {}
521 [-]: SETTABLE  R45 K88 R42  ; R45["AMOUNT"] := R42
522 [-]: GETUPVAL  R46 U16      ; R46 := U16
523 [-]: SETTABLE  R45 K76 R46  ; R45["REQUIRED"] := R46
524 [-]: CALL      R43 3 2      ; R43 := R43(R44,R45)
525 [-]: GETUPVAL  R44 U15      ; R44 := U15
526 [-]: GETTABLE  R44 R44 K89  ; R44 := R44[0xe0cba3ca]
527 [-]: MOVE      R45 R43      ; R45 := R43
528 [-]: GETUPVAL  R46 U22      ; R46 := U22
529 [-]: LOADNIL   R47 R47      ; R47 := nil
530 [-]: LOADBOOL  R48 1 0      ; R48 := true
531 [-]: CALL      R44 5 1      ; R44(R45,R46,R47,R48)
532 [-]: LOADBOOL  R44 0 0      ; R44 := false
533 [-]: SETUPVAL  R44 U5       ; U82 := R5
534 [-]: LOADBOOL  R44 0 0      ; R44 := false
535 [-]: SETUPVAL  R44 U4       ; U82 := R4
536 [-]: LOADK     R44 0        ; R44 := 0.000000
537 [-]: SETUPVAL  R44 U8       ; U82 := R8
538 [-]: LOADK     R44 0        ; R44 := 0.000000
539 [-]: SETUPVAL  R44 U12      ; U82 := R12
...
159 [-]: LOADBOOL  R10 0 0      ; R10 := false
...
227 [-]: LOADK     R10 11       ; R10 := 11.000000
228 [-]: LOADBOOL  R11 1 0      ; R11 := true
...
398 [-]: LOADBOOL  R15 0 0      ; R15 := false
...
404 [-]: LOADBOOL  R15 0 0      ; R15 := false
