...
; Max Stack Size:  8
       ...
       3 [-]: CALL R1 1 1  
L 0:   4 [-]: JUMPIF R1 L2 
       5 [-]: GETIMPORT R2 3 [0x656D204C]
       6 [-]: FASTCALL1 62 R2 L1
       7 [-]: GETIMPORT R1 1 [0x7B998233]
       8 [-]: CALL R1 1 1  
L 1:   9 [-]: JUMPIFNOT R1 L3
L 2:  10 [-]: RETURN R0 0  
L 3:  11 [-]: GETIMPORT R1 5 [0xE993B32C]
      12 [-]: JUMPIFNOT R1 L4
...
L10:  50 [-]: JUMPIF R4 L11
      51 [-]: GETIMPORT R6 16 [0x91305260]
      52 [-]: GETIMPORT R7 18 [0xEA518087]
      53 [-]: NAMECALL R4 R1 K19 [0xF916F0C1]
      54 [-]: CALL R4 3 0  
      55 [-]: LOADB R3 1   
      56 [-]: RETURN R0 0  
L11:  57 [-]: GETIMPORT R4 11 [0xCBD666E1]
      58 [-]: LOADN R5 0   
      59 [-]: CALL R4 1 0  
      60 [-]: JUMPBACK L8  
L12:  61 [-]: RETURN R0 0  
