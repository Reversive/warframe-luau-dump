...
L 1:   6 [-]: JUMPIFNOT R1 L2
       ...
       9 [-]: CALL R1 1 0  
      10 [-]: JUMPBACK L0  
L 2:  11 [-]: GETIMPORT R2 9 ["WeaponTypes"]
...
L 4:  19 [-]: GETIMPORT R1 9 ["WeaponTypes"]
      20 [-]: GETIMPORT R2 12 [0x2FEE6DE7]
      21 [-]: GETIMPORT R4 14 [0x51DB9667]
      22 [-]: GETTABLEN R3 R4 1
      23 [-]: SETTABLE R3 R1 R2
      24 [-]: GETIMPORT R2 16 ["WeaponPickupDescriptions"]
...
L 6:  32 [-]: GETIMPORT R1 16 ["WeaponPickupDescriptions"]
      33 [-]: GETIMPORT R2 12 [0x2FEE6DE7]
      34 [-]: GETIMPORT R4 18 [0x6E6FBB39]
      35 [-]: GETTABLEN R3 R4 1
      36 [-]: SETTABLE R3 R1 R2
      37 [-]: GETIMPORT R3 20 [0x64FB1586]
      38 [-]: GETIMPORT R5 22 [0x43969573]
      39 [-]: GETTABLEN R4 R5 1
      40 [-]: CALL R3 1 -1 
      41 [-]: NAMECALL R1 R0 K23 [0x3961202B]
      42 [-]: CALL R1 -1 0 
      43 [-]: LOADNIL R1   
      44 [-]: GETIMPORT R2 25 [0xC8802016]
      45 [-]: GETIMPORT R3 27 [0x4E37703E]
      46 [-]: CALL R2 1 3  
...
L15:  79 [-]: FORGLOOP R3 L13 2 [inext]
      ...
      81 [-]: CALL R3 1 1  
      82 [-]: MOVE R2 R3   
L16:  83 [-]: GETIMPORT R3 6 [0xCBD666E1]
      84 [-]: LOADN R4 0   
      85 [-]: CALL R3 1 0  
      86 [-]: JUMPBACK L12 
      87 [-]: RETURN R0 0  
...
; Max Stack Size:  9
       ...
       2 [-]: CALL R2 1 1  
       3 [-]: GETTABLEN R1 R2 1
       4 [-]: GETIMPORT R5 5 ["WeaponTypes"]
       5 [-]: GETIMPORT R6 7 [0x2FEE6DE7]
       6 [-]: GETTABLE R4 R5 R6
       7 [-]: LOADB R5 1   
       8 [-]: NAMECALL R2 R1 K8 [0x511D26B8]
       9 [-]: CALL R2 3 0  
      10 [-]: GETIMPORT R2 10 [0x3D106989]
      11 [-]: LOADK R4 K11 ["Tutorial: Picked up weapon: "]
      12 [-]: GETIMPORT R5 13 [0x64FB1586]
      13 [-]: GETIMPORT R7 5 ["WeaponTypes"]
      14 [-]: GETIMPORT R8 7 [0x2FEE6DE7]
      ...
      21 [-]: CALL R2 2 0  
      22 [-]: GETIMPORT R2 17 [0x9BA7909F]
      23 [-]: GETIMPORT R4 19 [0xC8410706]
      24 [-]: NAMECALL R2 R2 K20 [0xBCFB64AB]
      25 [-]: CALL R2 2 1  
      26 [-]: FASTCALL1 62 R2 L0
      27 [-]: MOVE R4 R2   
      28 [-]: GETIMPORT R3 22 [0x7B998233]
      29 [-]: CALL R3 1 1  
L 0:  30 [-]: JUMPIF R3 L1 
...
L 1:  35 [-]: FASTCALL1 62 R2 L2
      36 [-]: MOVE R4 R2   
      37 [-]: GETIMPORT R3 22 [0x7B998233]
      38 [-]: CALL R3 1 1  
L 2:  39 [-]: JUMPIF R3 L3 
      40 [-]: GETIMPORT R3 27 [0xCBD666E1]
      41 [-]: LOADN R4 0   
      42 [-]: CALL R3 1 0  
      43 [-]: JUMPBACK L1  
L 3:  44 [-]: FASTCALL1 62 R2 L4
      45 [-]: MOVE R4 R2   
      46 [-]: GETIMPORT R3 22 [0x7B998233]
      47 [-]: CALL R3 1 1  
L 4:  48 [-]: JUMPIFNOT R3 L5
      49 [-]: GETIMPORT R3 17 [0x9BA7909F]
      50 [-]: GETIMPORT R5 19 [0xC8410706]
      51 [-]: NAMECALL R3 R3 K28 [0x6DD7AA66]
      52 [-]: CALL R3 2 1  
      53 [-]: MOVE R2 R3   
      54 [-]: GETUPVAL R3 0
      55 [-]: GETIMPORT R6 5 ["WeaponTypes"]
      56 [-]: GETIMPORT R7 7 [0x2FEE6DE7]
      57 [-]: GETTABLE R5 R6 R7
      58 [-]: NAMECALL R3 R3 K29 [0x105074FB]
      59 [-]: CALL R3 2 1  
      60 [-]: GETIMPORT R4 31 ["DisplayReward"]
      61 [-]: MOVE R5 R3   
      62 [-]: LOADN R6 1   
      63 [-]: CALL R4 2 0  
L 5:  64 [-]: RETURN R0 0  
...
; Max Stack Size:  22
       ...
       1 [-]: GETIMPORT R4 4 ["WeaponPickupDescriptions"]
       2 [-]: GETIMPORT R5 6 [0x2FEE6DE7]
       3 [-]: GETTABLE R3 R4 R5
       4 [-]: CALL R2 1 1  
       5 [-]: FASTCALL1 43 R2 L0
       6 [-]: MOVE R4 R2   
       7 [-]: GETIMPORT R3 9 [0x41E2AE25]
       8 [-]: CALL R3 1 1  
L 0:   9 [-]: LOADN R4 0   
      10 [-]: JUMPIFNOTLT R4 R3 L12
      11 [-]: GETIMPORT R4 11 ["WeaponPickupDetailMovie"]
      12 [-]: FASTCALL1 62 R4 L1
      13 [-]: GETIMPORT R3 13 [0x7B998233]
      14 [-]: CALL R3 1 1  
L 1:  15 [-]: JUMPIFNOT R3 L2
      16 [-]: GETIMPORT R3 14 ["_T"]
      17 [-]: GETIMPORT R4 16 [0x9BA7909F]
      18 [-]: GETUPVAL R6 0
      19 [-]: NAMECALL R4 R4 K17 [0xCFBA257F]
      20 [-]: CALL R4 2 1  
      21 [-]: SETTABLEKS R4 R3 K10 ["WeaponPickupDetailMovie"]
      22 [-]: GETIMPORT R3 11 ["WeaponPickupDetailMovie"]
      23 [-]: MOVE R5 R0   
      24 [-]: GETIMPORT R6 19 [0xA421AF95]
      25 [-]: CALL R6 0 1  
      26 [-]: GETIMPORT R7 21 [0x00046924]
      27 [-]: CALL R7 0 1  
      28 [-]: GETIMPORT R8 19 [0xA421AF95]
      29 [-]: LOADN R9 1   
      30 [-]: LOADN R10 1  
      31 [-]: LOADN R11 1  
      32 [-]: CALL R8 3 -1 
...
L 3:  59 [-]: NAMECALL R3 R0 K32 [0x49E04A3F]
      ...
      65 [-]: MOVE R5 R3   
      66 [-]: GETIMPORT R4 13 [0x7B998233]
      67 [-]: CALL R4 1 1  
L 4:  68 [-]: JUMPIF R4 L14
      69 [-]: GETIMPORT R4 11 ["WeaponPickupDetailMovie"]
      70 [-]: NAMECALL R4 R4 K34 [0xDC8D36B6]
      71 [-]: CALL R4 1 1  
      72 [-]: NAMECALL R5 R3 K35 [0x6C321A10]
      73 [-]: CALL R5 1 1  
      74 [-]: GETIMPORT R6 11 ["WeaponPickupDetailMovie"]
...
L 6:  95 [-]: JUMPIF R9 L7 
      ...
      99 [-]: GETIMPORT R10 41 [0xC2892F65]
     100 [-]: MOVE R11 R9  
     101 [-]: CALL R10 1 0 
     102 [-]: NAMECALL R10 R6 K42 [0x5280B883]
     103 [-]: CALL R10 1 1 
     104 [-]: MOVE R8 R10  
     105 [-]: GETIMPORT R11 44 [0x492C7F2A]
     106 [-]: MOVE R12 R9  
     107 [-]: GETIMPORT R13 21 [0x00046924]
     ...
     118 [-]: CALL R12 1 1 
     119 [-]: ADD R11 R10 R12
     120 [-]: GETIMPORT R12 11 ["WeaponPickupDetailMovie"]
     121 [-]: MOVE R14 R11 
     122 [-]: NAMECALL R12 R12 K49 [0x5A2BED52]
     123 [-]: CALL R12 2 0 
L 7: 124 [-]: GETIMPORT R9 11 ["WeaponPickupDetailMovie"]
...
L 8: 139 [-]: GETUPVAL R12 1
     ...
     147 [-]: MOVE R14 R0  
     148 [-]: GETIMPORT R13 13 [0x7B998233]
     149 [-]: CALL R13 1 1 
...
L11: 157 [-]: LOADN R13 360
     158 [-]: SUB R12 R13 R12
     159 [-]: GETIMPORT R13 11 ["WeaponPickupDetailMovie"]
     160 [-]: MOVE R15 R0  
     161 [-]: GETUPVAL R16 2
     162 [-]: GETIMPORT R17 21 [0x00046924]
     163 [-]: MOVE R18 R12 
     164 [-]: LOADN R19 0  
     165 [-]: LOADN R20 0  
     166 [-]: CALL R17 3 1 
     167 [-]: GETIMPORT R18 19 [0xA421AF95]
     168 [-]: LOADN R19 1  
     169 [-]: LOADN R20 1  
     170 [-]: LOADN R21 1  
     171 [-]: CALL R18 3 -1
...
L12: 175 [-]: GETIMPORT R4 11 ["WeaponPickupDetailMovie"]
     176 [-]: FASTCALL1 62 R4 L13
     177 [-]: GETIMPORT R3 13 [0x7B998233]
     178 [-]: CALL R3 1 1  
L13: 179 [-]: JUMPIF R3 L14
     180 [-]: GETIMPORT R3 11 ["WeaponPickupDetailMovie"]
     181 [-]: NAMECALL R3 R3 K57 [0x32302B4A]
     182 [-]: CALL R3 1 0  
     183 [-]: GETIMPORT R3 14 ["_T"]
     184 [-]: LOADNIL R4   
