...
; Max Stack Size:  4
       ...
       4 [-]: JUMPIFEQ R1 R3 L1; goto L1 if var1 == var1377095
       5 [-]: LOADN R3 21  ; var3 = 21
       6 [-]: JUMPIFEQ R1 R3 L0; goto L0 if var1 == var16777755
...
L 0:   1 [-]: NAMECALL R3 R0 K0; var4 = var0; var3 = var0[0xE668799A]
       ...
       5 [-]: JUMPIFEQ R3 R4 L2; goto L2 if var3 == var1377351
...
L 4:  26 [-]: GETIMPORT R2 7; var2 = 0xCBAD146E
      27 [-]: JUMPIFNOTLT R1 R2 L7; goto L7 if var1 >= var-1711275195
      28 [-]: NAMECALL R3 R0 K0; var4 = var0; var3 = var0[0xE668799A]
      29 [-]: CALL R3 2 2  ; var3 = var3(var4)
      30 [-]: LOADB R2 1   ; var2 = true
      31 [-]: LOADN R4 20  ; var4 = 20
      32 [-]: JUMPIFEQ R3 R4 L6; goto L6 if var3 == var1377351
      33 [-]: LOADN R4 21  ; var4 = 21
      34 [-]: JUMPIFEQ R3 R4 L5; goto L5 if var3 == var16777755
...
L 7:  45 [-]: GETIMPORT R2 7; var2 = 0xCBAD146E
      46 [-]: JUMPIFNOTLE R2 R1 L8; goto L8 if var2 > var721486
...
L 2:  13 [-]: GETIMPORT R3 6; var3 = 0x0ED0EFD4
      ...
      16 [-]: JUMPIFNOTLT R3 R2 L13; goto L13 if var3 >= var2163012
