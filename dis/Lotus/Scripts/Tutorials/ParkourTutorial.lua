...
L 2:  10 [-]: JUMPIF R2 L3 
      ...
      18 [-]: CALL R2 1 0  
      19 [-]: JUMPBACK L0  
L 3:  20 [-]: GETIMPORT R2 2 [0x6D2E45E6]
      21 [-]: MOVE R4 R0   
      22 [-]: NAMECALL R2 R2 K3 [0x13D5D3FB]
      23 [-]: CALL R2 2 1  
      24 [-]: JUMPIF R2 L4 
      25 [-]: RETURN R0 0  
L 4:  26 [-]: GETIMPORT R2 7 [0xCBAD146E]
...
L 6:  37 [-]: JUMPIFNOT R2 L7
      ...
      43 [-]: CALL R2 1 0  
      44 [-]: JUMPBACK L4  
L 7:  45 [-]: GETIMPORT R2 7 [0xCBAD146E]
      46 [-]: JUMPIFNOTLE R2 R1 L8
      47 [-]: GETIMPORT R2 11 [0xDD7F36D1]
...
; Max Stack Size:  10
       ...
       5 [-]: GETIMPORT R3 6 [0x0ED0EFD4]
       6 [-]: CALL R2 1 3  
       7 [-]: FORGPREP_INEXT R2 L1
L 0:   8 [-]: GETIMPORT R7 8 [0x11A19C5E]
       9 [-]: MOVE R8 R6   
      10 [-]: LOADK R9 K9 ["OnDestroyed"]
      11 [-]: CALL R7 2 0  
L 1:  12 [-]: FORGLOOP R2 L0 2 [inext]
L 2:  13 [-]: GETIMPORT R3 6 [0x0ED0EFD4]
      14 [-]: LENGTH R2 R3 
      15 [-]: GETUPVAL R3 0
...
L 3:  25 [-]: JUMPIFNOT R2 L7
      26 [-]: LOADB R1 1   
      27 [-]: GETIMPORT R2 4 [0xC8802016]
      28 [-]: GETIMPORT R3 6 [0x0ED0EFD4]
      29 [-]: CALL R2 1 3  
      30 [-]: FORGPREP_INEXT R2 L6
L 4:  31 [-]: FASTCALL1 62 R6 L5
      32 [-]: MOVE R8 R6   
      33 [-]: GETIMPORT R7 12 [0x7B998233]
      34 [-]: CALL R7 1 1  
L 5:  35 [-]: JUMPIF R7 L6 
...
L 8:  51 [-]: JUMPIF R2 L12
      52 [-]: LOADB R1 0   
      53 [-]: GETIMPORT R2 4 [0xC8802016]
      54 [-]: GETIMPORT R3 6 [0x0ED0EFD4]
      55 [-]: CALL R2 1 3  
...
L12:  68 [-]: GETIMPORT R2 18 [0xCBD666E1]
      69 [-]: LOADN R3 0   
      70 [-]: CALL R2 1 0  
      71 [-]: JUMPBACK L2  
L13:  72 [-]: RETURN R0 0  
...
L 4:  42 [-]: JUMPIF R3 L8 
      ...
      48 [-]: LOADN R4 1   
      49 [-]: FORNPREP R3 L8
L 5:  50 [-]: GETIMPORT R6 1 ["_T"]
      51 [-]: LOADNIL R7   
      52 [-]: SETTABLEKS R7 R6 K20 ["CallbackFromTutorialFlag"]
      53 [-]: LOADK R8 K21 ["OnSetTutorialFlag"]
      54 [-]: NAMECALL R6 R2 K22 [0x765C68B3]
      55 [-]: CALL R6 2 0  
L 6:  56 [-]: GETIMPORT R6 23 ["CallbackFromTutorialFlag"]
      57 [-]: JUMPXEQKNIL R6 L7 NOT
      58 [-]: GETIMPORT R6 7 [0xCBD666E1]
      59 [-]: LOADN R7 0   
      60 [-]: CALL R6 1 0  
      61 [-]: JUMPBACK L6  
L 7:  62 [-]: GETIMPORT R6 23 ["CallbackFromTutorialFlag"]
      63 [-]: JUMPIF R6 L8 
      64 [-]: FORNLOOP R3 L5
...
L 0:  12 [-]: JUMPIF R3 L1 
      ...
      16 [-]: CALL R3 -1 0 
L 1:  17 [-]: GETIMPORT R5 10 [0xE6A9DB4C]
      18 [-]: LOADB R6 0   
...
L 2:  28 [-]: JUMPIF R4 L3 
      ...
      32 [-]: CALL R4 -1 0 
L 3:  33 [-]: GETIMPORT R6 13 [0x04D6F03C]
      34 [-]: LOADB R7 0   
