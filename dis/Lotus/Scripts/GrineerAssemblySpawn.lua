...
; Max Stack Size:  3
       ...
       3 [-]: JUMPIFNOT R0 L0
       4 [-]: RETURN R0 0  
L 0:   5 [-]: GETIMPORT R0 2 [0xCBD666E1]
       6 [-]: GETIMPORT R1 4 [0x5587EDA7]
       7 [-]: CALL R0 1 0  
       8 [-]: GETIMPORT R0 7 ["InWorldTransmissionQueue"]
       9 [-]: JUMPIF R0 L1 
      10 [-]: GETIMPORT R0 8 ["_T"]
      11 [-]: NEWTABLE R1 0 0
      12 [-]: SETTABLEKS R1 R0 K6 ["InWorldTransmissionQueue"]
L 1:  13 [-]: GETIMPORT R1 7 ["InWorldTransmissionQueue"]
      14 [-]: GETIMPORT R2 10 [0xBB5B1BFE]
      15 [-]: FASTCALL2 52 R1 R2 L2
      16 [-]: GETIMPORT R0 13 [0x23D5322F]
      17 [-]: CALL R0 2 0  
L 2:  18 [-]: GETIMPORT R0 2 [0xCBD666E1]
      19 [-]: LOADN R1 1   
      20 [-]: CALL R0 1 0  
L 3:  21 [-]: GETIMPORT R0 15 ["InWorldTransmissionPlaying"]
      22 [-]: JUMPIFNOT R0 L4
      23 [-]: GETIMPORT R0 2 [0xCBD666E1]
      24 [-]: LOADN R1 0   
      25 [-]: CALL R0 1 0  
      26 [-]: JUMPBACK L3  
L 4:  27 [-]: RETURN R0 0  
...
L 1:  10 [-]: NAMECALL R1 R0 K6 [0x66905CB0]
      ...
      30 [-]: CALL R7 2 1  
      31 [-]: SUB R8 R6 R7 
      32 [-]: GETIMPORT R11 17 [0x6BB54AA5]
      33 [-]: MOD R10 R8 R11
      34 [-]: SUB R9 R8 R10
      35 [-]: GETIMPORT R10 1 [0x89326C93]
      36 [-]: GETIMPORT R12 8 [0x0469F296]
      37 [-]: LOADK R13 K18 ["AssemblySpawns"]
      38 [-]: CALL R12 1 -1
      39 [-]: NAMECALL R10 R10 K19 [0xC7FCADA9]
      40 [-]: CALL R10 -1 1
      41 [-]: GETIMPORT R12 21 [0x97321BBF]
      42 [-]: FASTCALL1 62 R12 L2
      43 [-]: GETIMPORT R11 23 [0x7B998233]
      44 [-]: CALL R11 1 1 
L 2:  45 [-]: JUMPIFNOT R11 L3
      46 [-]: RETURN R0 0  
L 3:  47 [-]: GETIMPORT R11 21 [0x97321BBF]
      48 [-]: NAMECALL R11 R11 K24 [0x2E333568]
      49 [-]: CALL R11 1 1 
      50 [-]: LOADN R12 0  
      51 [-]: JUMPIFNOTLT R12 R11 L10
      52 [-]: GETIMPORT R11 26 [0xC8802016]
      53 [-]: GETIMPORT R12 28 [0x58C8430E]
      54 [-]: CALL R11 1 3 
...
L 4:  56 [-]: NAMECALL R16 R15 K29 [0x1E3535E5]
      ...
      59 [-]: MOVE R18 R16 
      60 [-]: GETIMPORT R17 23 [0x7B998233]
      61 [-]: CALL R17 1 1 
...
L 6:  67 [-]: FORGLOOP R11 L4 2 [inext]
      68 [-]: GETIMPORT R11 26 [0xC8802016]
      69 [-]: GETIMPORT R12 33 [0x181B1BC7]
      70 [-]: CALL R11 1 3 
...
L 9:  83 [-]: FORGLOOP R11 L7 2 [inext]
      84 [-]: RETURN R0 0  
L10:  85 [-]: GETIMPORT R11 21 [0x97321BBF]
...
L11:  99 [-]: GETIMPORT R11 1 [0x89326C93]
...
L12: 107 [-]: GETTABLE R15 R10 R13
     ...
     109 [-]: GETIMPORT R14 23 [0x7B998233]
     110 [-]: CALL R14 1 1 
...
L16: 118 [-]: GETUPVAL R12 1
     ...
     120 [-]: CALL R11 0 1 
     121 [-]: JUMPIF R11 L18
     122 [-]: GETIMPORT R11 43 ["InWorldTransmissionQueue"]
     123 [-]: JUMPIF R11 L17
     124 [-]: GETIMPORT R11 44 ["_T"]
     125 [-]: NEWTABLE R12 0 0
     126 [-]: SETTABLEKS R12 R11 K42 ["InWorldTransmissionQueue"]
L17: 127 [-]: GETIMPORT R12 43 ["InWorldTransmissionQueue"]
     128 [-]: GETIMPORT R13 46 [0xBB5B1BFE]
     129 [-]: FASTCALL2 52 R12 R13 L18
     130 [-]: GETIMPORT R11 49 [0x23D5322F]
     131 [-]: CALL R11 2 0 
L18: 132 [-]: NAMECALL R11 R1 K50 [0xCEA36880]
     ...
     138 [-]: CALL R13 1 1 
     139 [-]: GETIMPORT R15 54 [0x9BAFFFE3]
     140 [-]: MOVE R16 R11 
     141 [-]: MOVE R17 R12 
     142 [-]: DIVK R18 R13 K55 [4]
     143 [-]: CALL R15 3 1 
     144 [-]: FASTCALL1 12 R15 L19
     145 [-]: GETIMPORT R14 58 [0x55F27C30]
     146 [-]: CALL R14 1 1 
L19: 147 [-]: GETIMPORT R15 1 [0x89326C93]
     148 [-]: NAMECALL R15 R15 K39 [0x18D05D30]
     149 [-]: CALL R15 1 1 
     150 [-]: JUMPIFNOT R15 L26
     151 [-]: GETIMPORT R17 33 [0x181B1BC7]
     152 [-]: LENGTH R16 R17
     153 [-]: FASTCALL2 19 R16 R9 L20
     154 [-]: MOVE R17 R9  
     155 [-]: GETIMPORT R15 60 [0xAC1B386A]
     156 [-]: CALL R15 2 1 
L20: 157 [-]: SUB R16 R9 R15
     158 [-]: GETIMPORT R17 26 [0xC8802016]
     159 [-]: GETIMPORT R18 28 [0x58C8430E]
     160 [-]: CALL R17 1 3 
     161 [-]: FORGPREP_INEXT R17 L22
L21: 162 [-]: JUMPIFLT R16 R20 L23
     163 [-]: GETIMPORT R24 62 [0x97D5B279]
     164 [-]: MOVE R25 R21 
     165 [-]: GETIMPORT R26 8 [0x0469F296]
     166 [-]: LOADK R27 K9 ["Assembly"]
     167 [-]: CALL R26 1 1 
     168 [-]: MOVE R27 R14 
     169 [-]: NAMECALL R22 R1 K63 [0x33FC842F]
     170 [-]: CALL R22 5 1 
     171 [-]: GETIMPORT R25 65 [0xCD76041E]
     ...
     179 [-]: CALL R23 2 0 
     180 [-]: GETIMPORT R23 5 [0xCBD666E1]
     181 [-]: LOADN R24 0  
     182 [-]: CALL R23 1 0 
L22: 183 [-]: FORGLOOP R17 L21 2 [inext]
L23: 184 [-]: LOADN R17 3  
     185 [-]: JUMPIFNOTLT R13 R17 L26
     186 [-]: GETIMPORT R17 26 [0xC8802016]
     187 [-]: GETIMPORT R18 33 [0x181B1BC7]
     188 [-]: CALL R17 1 3 
     189 [-]: FORGPREP_INEXT R17 L25
L24: 190 [-]: JUMPIFLT R15 R20 L26
     191 [-]: GETIMPORT R24 70 [0x29CE6BE8]
     192 [-]: MOVE R25 R21 
     193 [-]: GETIMPORT R26 8 [0x0469F296]
     194 [-]: LOADK R27 K9 ["Assembly"]
     195 [-]: CALL R26 1 1 
     196 [-]: MOVE R27 R14 
     197 [-]: NAMECALL R22 R1 K63 [0x33FC842F]
     198 [-]: CALL R22 5 1 
     199 [-]: GETIMPORT R25 65 [0xCD76041E]
     ...
     207 [-]: CALL R23 2 0 
     208 [-]: GETIMPORT R23 5 [0xCBD666E1]
     209 [-]: LOADN R24 0  
     210 [-]: CALL R23 1 0 
L25: 211 [-]: FORGLOOP R17 L24 2 [inext]
L26: 212 [-]: GETIMPORT R15 5 [0xCBD666E1]
     213 [-]: LOADN R16 1  
     214 [-]: CALL R15 1 0 
L27: 215 [-]: GETIMPORT R15 72 ["InWorldTransmissionPlaying"]
     216 [-]: JUMPIFNOT R15 L28
     217 [-]: GETIMPORT R15 5 [0xCBD666E1]
     218 [-]: LOADN R16 0  
     219 [-]: CALL R15 1 0 
     220 [-]: JUMPBACK L27 
...
L30: 234 [-]: GETIMPORT R15 26 [0xC8802016]
     235 [-]: GETIMPORT R16 28 [0x58C8430E]
     236 [-]: CALL R15 1 3 
...
L31: 238 [-]: NAMECALL R20 R19 K29 [0x1E3535E5]
     ...
     241 [-]: MOVE R22 R20 
     242 [-]: GETIMPORT R21 23 [0x7B998233]
     243 [-]: CALL R21 1 1 
...
L33: 252 [-]: FORGLOOP R15 L31 2 [inext]
     253 [-]: GETIMPORT R15 26 [0xC8802016]
     254 [-]: GETIMPORT R16 33 [0x181B1BC7]
     255 [-]: CALL R15 1 3 
...
L34: 257 [-]: NAMECALL R20 R19 K29 [0x1E3535E5]
     ...
     260 [-]: MOVE R22 R20 
     261 [-]: GETIMPORT R21 23 [0x7B998233]
     262 [-]: CALL R21 1 1 
...
L 0:   6 [-]: JUMPIF R2 L1 
       ...
       8 [-]: CALL R2 1 1  
       9 [-]: MOVE R5 R2   
      10 [-]: GETIMPORT R6 5 [0x20B7F774]
      11 [-]: MOVE R7 R2   
      12 [-]: GETIMPORT R8 7 [0x4D154541]
...
L 1:  18 [-]: GETIMPORT R2 10 [0xCBD666E1]
      19 [-]: LOADN R3 0   
      20 [-]: CALL R2 1 0  
      21 [-]: GETIMPORT R3 12 [0xA1DD8F7B]
      22 [-]: LENGTH R2 R3 
      23 [-]: LOADN R3 0   
      24 [-]: JUMPIFNOTLT R3 R2 L9
      25 [-]: GETIMPORT R4 15 [0x3630E649]
      26 [-]: CALL R4 0 1  
      27 [-]: GETIMPORT R6 17 [0xA8AD9EDE]
      28 [-]: GETIMPORT R7 19 [0xA9A34A6C]
      29 [-]: SUB R5 R6 R7 
      30 [-]: MUL R3 R4 R5 
      31 [-]: GETIMPORT R4 19 [0xA9A34A6C]
      32 [-]: ADD R2 R3 R4 
      33 [-]: GETIMPORT R3 10 [0xCBD666E1]
      34 [-]: MOVE R4 R2   
      35 [-]: CALL R3 1 0  
...
L 2:  40 [-]: JUMPIFNOT R3 L3
      41 [-]: RETURN R0 0  
L 3:  42 [-]: GETIMPORT R5 7 [0x4D154541]
      43 [-]: LOADB R6 0   
      44 [-]: LOADB R7 1   
      45 [-]: LOADB R8 0   
...
L 7:  64 [-]: JUMPIFNOT R3 L8
      65 [-]: RETURN R0 0  
L 8:  66 [-]: GETIMPORT R3 15 [0x3630E649]
      67 [-]: LOADN R4 1   
      68 [-]: GETIMPORT R6 12 [0xA1DD8F7B]
      69 [-]: LENGTH R5 R6 
      70 [-]: CALL R3 2 1  
      71 [-]: GETIMPORT R7 12 [0xA1DD8F7B]
