...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R1 3 [0xC62A6BE2]
       1 [-]: GETIMPORT R2 5 [0x55156FF7]
       2 [-]: CALL R2 0 1  
       3 [-]: LOADK R3 K0 [1.5]
       4 [-]: CALL R1 2 1  
       5 [-]: DIVK R0 R1 K0 [1.5]
...
L 0:  11 [-]: MULK R2 R3 K6 [0.5]
      ...
      17 [-]: GETIMPORT R4 13 [0x3EDA26FC]
      18 [-]: CALL R4 1 1  
L 1:  19 [-]: MUL R2 R3 R4 
      20 [-]: MINUS R5 R0  
      21 [-]: MULK R4 R5 K14 [4]
      22 [-]: FASTCALL1 11 R4 L2
      23 [-]: GETIMPORT R3 16 [0x2B043591]
      24 [-]: CALL R3 1 1  
L 2:  25 [-]: MUL R1 R2 R3 
      26 [-]: RETURN R1 1  
...
L 0:   6 [-]: FASTCALL1 62 R0 L1
       ...
       9 [-]: CALL R2 1 1  
L 1:  10 [-]: JUMPIF R2 L7 
      11 [-]: GETIMPORT R4 11 [0xC62A6BE2]
      12 [-]: GETIMPORT R5 13 [0x55156FF7]
      13 [-]: CALL R5 0 1  
      14 [-]: LOADK R6 K8 [1.5]
      15 [-]: CALL R4 2 1  
...
L 2:  22 [-]: MULK R5 R6 K14 [0.5]
      ...
      28 [-]: GETIMPORT R7 21 [0x3EDA26FC]
      29 [-]: CALL R7 1 1  
L 3:  30 [-]: MUL R5 R6 R7 
      31 [-]: MINUS R8 R3  
      32 [-]: MULK R7 R8 K22 [4]
      33 [-]: FASTCALL1 11 R7 L4
      34 [-]: GETIMPORT R6 24 [0x2B043591]
      35 [-]: CALL R6 1 1  
L 4:  36 [-]: MUL R4 R5 R6 
      37 [-]: MOVE R2 R4   
      38 [-]: GETIMPORT R3 27 ["HelminthSpeaking"]
      39 [-]: JUMPIF R3 L5 
      40 [-]: LOADN R3 0   
L 5:  41 [-]: LOADK R4 K28 [0.0001]
      42 [-]: JUMPIFNOTLT R4 R3 L6
      43 [-]: MOVE R2 R3   
L 6:  44 [-]: GETIMPORT R4 30 [0x9BAFFFE3]
      45 [-]: LOADN R5 2   
      46 [-]: LOADN R6 8   
      47 [-]: MOVE R7 R2   
      48 [-]: CALL R4 3 1  
