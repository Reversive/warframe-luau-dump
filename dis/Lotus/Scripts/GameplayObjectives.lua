...
L 0:   6 [-]: LOADN R3 255 ; var3 = 255
       7 [-]: JUMPIFNOTLE R3 R2 L1; goto L1 if var3 > var66119
       8 [-]: LOADN R2 1   ; var2 = 1
...
L 2:  16 [-]: JUMPIFNOTLE R6 R2 L3; goto L3 if var6 > var100861751
      ...
      23 [-]: JUMPIFNOTLE R7 R2 L4; goto L4 if var7 > var100861751
...
L 1:  16 [-]: GETIMPORT R4 4; var4 = 0xBE190284
      ...
      25 [-]: JUMPIFEQ R4 R5 L2; goto L2 if var4 == var460103
      26 [-]: LOADN R5 7   ; var5 = 7
      27 [-]: JUMPIFNOTEQ R4 R5 L3; goto L3 if var4 ~= var263502
L 2:  28 [-]: GETIMPORT R5 4; var5 = 0xBE190284
      ...
      36 [-]: LOADK R6 K22 ; var6 = 0.20000000000000001
...
L 3:  29 [-]: JUMPIF R3 L4 ; goto L4 if var3
      ...
      42 [-]: GETIMPORT R7 18; var7 = 0x64FB1586
      43 [-]: MOVE R8 R3   ; var8 = var3
      44 [-]: CALL R7 2 2  ; var7 = var7(var8)
      45 [-]: CONCAT R5 R6 R7; var5 = var6 .. var7
      46 [-]: CALL R4 2 1  ; var4(var5)
      47 [-]: RETURN R0 0  ; 
L 4:  48 [-]: NAMECALL R3 R0 K19; var4 = var0; var3 = var0[0xD1586535]
      49 [-]: CALL R3 2 2  ; var3 = var3(var4)
      50 [-]: GETIMPORT R4 21; var4 = 0x89326C93
...
L 5:  58 [-]: JUMPIF R6 L6 ; goto L6 if var6
      59 [-]: NAMECALL R6 R4 K23; var7 = var4; var6 = var4[0x66905CB0]
      60 [-]: CALL R6 2 2  ; var6 = var6(var7)
      61 [-]: MOVE R5 R6   ; var5 = var6
L 6:  62 [-]: MOVE R8 R3   ; var8 = var3
      63 [-]: NAMECALL R6 R5 K24; var7 = var5; var6 = var5[0x0E8C38E5]
      64 [-]: CALL R6 3 2  ; var6 = var6(var7, var8)
      65 [-]: GETIMPORT R7 26; var7 = ZERO_VECTOR
      66 [-]: JUMPIFNOTEQ R6 R7 L7; goto L7 if var6 ~= var984910
      67 [-]: GETIMPORT R7 15; var7 = 0x3D106989
      68 [-]: LOADK R8 K27 ; var8 = "GetClosestWorldPointOnNavMeshScript failed, relying on teleport triggers to handle the key!"
      69 [-]: CALL R7 2 1  ; var7(var8)
      70 [-]: RETURN R0 0  ; 
L 7:  71 [-]: GETIMPORT R7 29; var7 = 0x03EA2485
      72 [-]: MOVE R8 R6   ; var8 = var6
      73 [-]: MOVE R9 R3   ; var9 = var3
      74 [-]: CALL R7 3 2  ; var7 = var7(var8, var9)
      75 [-]: LOADN R8 1   ; var8 = 1
      76 [-]: JUMPIFNOTLT R8 R7 L8; goto L8 if var8 >= var-1744435172
      77 [-]: GETTABLEKS R8 R6 K10; var8 = var6["y"]
      78 [-]: ADDK R7 R8 K9; var7 = var8 + 1
      79 [-]: SETTABLEKS R7 R6 K10; var7["y"] = var6
      80 [-]: MOVE R9 R6   ; var9 = var6
      81 [-]: GETIMPORT R10 12; var10 = 0x00046924
      82 [-]: CALL R10 1 0 ; var10, ... = var10()
      83 [-]: NAMECALL R7 R0 K13; var8 = var0; var7 = var0[0x589EF1C1]
      84 [-]: CALL R7 0 1  ; var7(var8, ...)
      85 [-]: GETIMPORT R7 15; var7 = 0x3D106989
      86 [-]: LOADK R9 K30 ; var9 = "Key teleported to "
      87 [-]: GETIMPORT R10 18; var10 = 0x64FB1586
      88 [-]: MOVE R11 R6  ; var11 = var6
      89 [-]: CALL R10 2 2 ; var10 = var10(var11)
      90 [-]: CONCAT R8 R9 R10; var8 = var9 .. var10
