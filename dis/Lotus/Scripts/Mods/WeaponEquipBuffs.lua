...
L 1:  13 [-]: JUMPIF R5 L2 ; goto L2 if var5
      ...
      17 [-]: JUMPIFEQ R5 R6 L2; goto L2 if var5 == var-1828453051
...
; Max Stack Size:  3
       ...
       2 [-]: JUMPIFNOTEQ R1 R2 L0; goto L0 if var1 ~= var65819
...
L 1:   9 [-]: JUMPIF R1 L2 ; goto L2 if var1
      ...
      13 [-]: JUMPIFNOTEQ R1 R2 L2; goto L2 if var1 ~= var65819
...
L 3:  11 [-]: GETIMPORT R5 3; var5 = 0xCBD666E1
      ...
      19 [-]: JUMPIFNOTEQ R6 R7 L4; goto L4 if var6 ~= var65581
      20 [-]: RETURN R0 0  ; 
...
L11:  66 [-]: JUMPIF R13 L22; goto L22 if var13
      ...
      74 [-]: JUMPIFNOTLT R14 R10 L12; goto L12 if var14 >= var1576526
      75 [-]: GETIMPORT R14 24; var14 = 0x67652851
      76 [-]: CALL R14 1 2 ; var14 = var14()
      77 [-]: SUB R10 R10 R14; var10 = var10 - var14
L12:  78 [-]: JUMPIFEQ R13 R1 L13; goto L13 if var13 == var68379
      79 [-]: LOADB R11 1  ; var11 = true
L13:  80 [-]: JUMPIFNOT R9 L15; goto L15 if not var9
      81 [-]: JUMPIFNOTEQ R13 R1 L14; goto L14 if var13 ~= var3655
      82 [-]: LOADN R14 0  ; var14 = 0
      83 [-]: JUMPIFNOTLE R10 R14 L15; goto L15 if var10 > var2331
...
L15:  98 [-]: JUMPIF R9 L21; goto L21 if var9
      99 [-]: JUMPIFNOTEQ R13 R1 L21; goto L21 if var13 ~= var2755363
     ...
     104 [-]: JUMPIFNOTEQ R16 R17 L16; goto L16 if var16 ~= var69147
...
L17: 111 [-]: JUMPIF R16 L18; goto L18 if var16
     ...
     115 [-]: JUMPIFNOTEQ R16 R17 L18; goto L18 if var16 ~= var69147
