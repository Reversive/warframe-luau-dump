...
; Max Stack Size:  19
 ...
 22 [-]: EQ        0 R14 K7     ; if R14 ~= 2.000000 then PC := 29
 23 [-]: JMP       29           ; PC := 29
 24 [-]: GETGLOBAL R14 K8       ; R14 := 0x22e00fee
 25 [-]: GETTABLE  R14 R14 R13  ; R14 := R14[R13]
 26 [-]: TEST      R14 0        ; if not R14 then PC := 29
 27 [-]: JMP       29           ; PC := 29
 28 [-]: SUB       R12 K2 R12   ; R12 := 1.000000 - R12
 29 [-]: GETGLOBAL R14 K9       ; R14 := 0xec8bb434
 30 [-]: GETTABLE  R14 R14 R13  ; R14 := R14[R13]
 31 [-]: EQ        0 R14 K10    ; if R14 ~= true then PC := 38
 32 [-]: JMP       38           ; PC := 38
 33 [-]: GETGLOBAL R14 K11      ; R14 := 0x5bced4c4
 34 [-]: GETTABLE  R14 R14 K12  ; R14 := R14[0xe4a5b3ca]
 35 [-]: MOVE      R15 R12      ; R15 := R12
 36 [-]: CALL      R14 2 2      ; R14 := R14(R15)
 37 [-]: MOVE      R12 R14      ; R12 := R14
 38 [-]: LE        1 K13 R12    ; if 0.000000 <= R12 then PC := 41
 39 [-]: JMP       41           ; PC := 41
 40 [-]: LOADKB    R14 0 1      ; R14 := false; PC := 41
 41 [-]: LOADKB    R14 1 0      ; R14 := true
 42 [-]: GETGLOBAL R15 K14      ; R15 := 0x010c7595
 43 [-]: GETTABLE  R15 R15 R13  ; R15 := R15[R13]
 44 [-]: EQ        0 R15 K10    ; if R15 ~= true then PC := 55
 45 [-]: JMP       55           ; PC := 55
 46 [-]: GETUPVAL  R15 U0       ; R15 := U0
 47 [-]: GETTABLE  R15 R15 K15  ; R15 := R15[0x1142c7a8]
 48 [-]: MUL       R16 R12 K16  ; R16 := R12 * 100.000000
 49 [-]: GETGLOBAL R17 K17      ; R17 := 0xefb8513c
 50 [-]: GETTABLE  R17 R17 R13  ; R17 := R17[R13]
 51 [-]: LOADKB    R18 0 0      ; R18 := false
 52 [-]: CALL      R15 4 2      ; R15 := R15(R16,R17,R18)
 53 [-]: MOVE      R12 R15      ; R12 := R15
 54 [-]: JMP       71           ; PC := 71
 55 [-]: GETGLOBAL R15 K17      ; R15 := 0xefb8513c
 56 [-]: GETTABLE  R15 R15 R13  ; R15 := R15[R13]
 57 [-]: EQ        1 R15 K18    ; if R15 == nil then PC := 71
 58 [-]: JMP       71           ; PC := 71
 59 [-]: GETGLOBAL R15 K17      ; R15 := 0xefb8513c
 60 [-]: GETTABLE  R15 R15 R13  ; R15 := R15[R13]
 61 [-]: LE        0 K13 R15    ; if 0.000000 > R15 then PC := 71
 62 [-]: JMP       71           ; PC := 71
 63 [-]: GETUPVAL  R15 U0       ; R15 := U0
 64 [-]: GETTABLE  R15 R15 K15  ; R15 := R15[0x1142c7a8]
 65 [-]: MOVE      R16 R12      ; R16 := R12
 66 [-]: GETGLOBAL R17 K17      ; R17 := 0xefb8513c
 67 [-]: GETTABLE  R17 R17 R13  ; R17 := R17[R13]
 68 [-]: LOADKB    R18 0 0      ; R18 := false
 69 [-]: CALL      R15 4 2      ; R15 := R15(R16,R17,R18)
 70 [-]: MOVE      R12 R15      ; R12 := R15
 71 [-]: GETGLOBAL R15 K19      ; R15 := 0x227224ea
 72 [-]: GETTABLE  R15 R15 R13  ; R15 := R15[R13]
 73 [-]: EQ        0 R15 K10    ; if R15 ~= true then PC := 80
 74 [-]: JMP       80           ; PC := 80
 75 [-]: TEST      R14 0        ; if not R14 then PC := 80
 76 [-]: JMP       80           ; PC := 80
 77 [-]: LOADK     R15 K20      ; R15 := "+"
 78 [-]: MOVE      R16 R12      ; R16 := R12
 79 [-]: CONCAT    R12 R15 R16  ; R12 := R15 .. R16
 80 [-]: LOADK     R15 K21      ; R15 := "STAT"
 ...
 85 [-]: GETGLOBAL R15 K22      ; R15 := _T
 86 [-]: GETTABLE  R15 R15 K23  ; R15 := R15["ModSetDescription"]
 87 [-]: EQ        1 R15 K18    ; if R15 == nil then PC := 97
 88 [-]: JMP       97           ; PC := 97
 89 [-]: GETGLOBAL R15 K22      ; R15 := _T
 90 [-]: GETTABLE  R15 R15 K23  ; R15 := R15["ModSetDescription"]
 91 [-]: GETTABLE  R15 R15 K25  ; R15 := R15["Equipped"]
 92 [-]: SETTABLE  R6 K24 R15   ; R6["EQUIPPED"] := R15
 93 [-]: GETGLOBAL R15 K22      ; R15 := _T
 94 [-]: GETTABLE  R15 R15 K23  ; R15 := R15["ModSetDescription"]
 95 [-]: GETTABLE  R15 R15 K27  ; R15 := R15["Max"]
 96 [-]: SETTABLE  R6 K26 R15   ; R6["MAX"] := R15
 97 [-]: GETGLOBAL R15 K28      ; R15 := cjson
 98 [-]: GETTABLE  R15 R15 K29  ; R15 := R15[0xb139d7bc]
