...
; Max Stack Size:  7
      ...
      10 [-]: CALL R3 3 0  
      11 [-]: GETIMPORT R3 9 [0xCBD666E1]
      12 [-]: LOADN R4 15  
      13 [-]: CALL R3 1 0  
      14 [-]: GETIMPORT R3 11 [0x14459A1C]
      15 [-]: JUMPIF R3 L1 
      16 [-]: GETIMPORT R4 13 [0xC516EB74]
      17 [-]: FASTCALL1 62 R4 L0
      18 [-]: GETIMPORT R3 15 [0x7B998233]
      19 [-]: CALL R3 1 1  
L 0:  20 [-]: JUMPIF R3 L1 
      21 [-]: GETUPVAL R3 0
      22 [-]: GETIMPORT R4 13 [0xC516EB74]
      23 [-]: CALL R3 1 0  
L 1:  24 [-]: NAMECALL R3 R2 K16 [0x07A9131A]
      25 [-]: CALL R3 1 1  
L 2:  26 [-]: LOADN R4 250 
      27 [-]: JUMPIFNOTLT R4 R3 L3
      28 [-]: GETIMPORT R4 9 [0xCBD666E1]
      29 [-]: LOADK R5 K17 [0.5]
      30 [-]: CALL R4 1 0  
      ...
      33 [-]: MOVE R3 R4   
      34 [-]: JUMPBACK L2  
L 3:  35 [-]: GETIMPORT R4 11 [0x14459A1C]
      36 [-]: JUMPIF R4 L4 
      37 [-]: GETIMPORT R4 19 [0x3D106989]
      38 [-]: LOADK R5 K20 ["     playing enroute transmission"]
      39 [-]: CALL R4 1 0  
      40 [-]: GETUPVAL R4 0
      41 [-]: GETIMPORT R5 22 [0x32AC41F6]
      42 [-]: CALL R4 1 0  
L 4:  43 [-]: RETURN R0 0  
