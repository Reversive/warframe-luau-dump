...
L 1:  12 [-]: JUMPIFNOT R0 L2
      ...
      15 [-]: CALL R0 1 0  
      16 [-]: JUMPBACK L0  
L 2:  17 [-]: GETIMPORT R0 1 [0x3D106989]
      18 [-]: LOADK R1 K11 ["avatar spawned. proceeding with hack panel swap"]
      19 [-]: CALL R0 1 0  
      20 [-]: NEWTABLE R0 0 0
      21 [-]: GETIMPORT R1 5 [0x89326C93]
      22 [-]: GETIMPORT R3 13 ["gOverlayWaitForInputActionType"]
      23 [-]: NAMECALL R1 R1 K14 [0xFB669000]
      24 [-]: CALL R1 2 1  
      25 [-]: MOVE R0 R1   
      26 [-]: GETIMPORT R1 16 [0xCFC01047]
      27 [-]: MOVE R2 R0   
      28 [-]: CALL R1 1 3  
      29 [-]: FORGPREP_NEXT R1 L4
L 3:  30 [-]: GETIMPORT R8 18 [0x566D4BC0]
      31 [-]: NAMECALL R6 R5 K19 [0xE28B1316]
      32 [-]: CALL R6 2 0  
L 4:  33 [-]: FORGLOOP R1 L3 2
      34 [-]: GETIMPORT R1 1 [0x3D106989]
