...
; Max Stack Size:  5
 ...
 10 [-]: SELF      R1 R1 K1     ; R2 := R1; R1 := R1[0x29ef273d]
 ...
 16 [-]: JMP       4            ; PC := 4
 17 [-]: SELF      R1 R0 K4     ; R2 := R0; R1 := R0[0x66905cb0]
 ...
 23 [-]: JMP       31           ; PC := 31
 24 [-]: SELF      R2 R0 K4     ; R3 := R0; R2 := R0[0x66905cb0]
 ...
 30 [-]: JMP       19           ; PC := 19
 31 [-]: SELF      R2 R1 K5     ; R3 := R1; R2 := R1[0xa7fb023f]
 32 [-]: GETGLOBAL R4 K6        ; R4 := 0xdfda639e
