...
; Max Stack Size:  8
       ...
       0 [-]: GETIMPORT R2 1 [0x0E058AD6]
       1 [-]: FASTCALL1 62 R2 L0
       2 [-]: GETIMPORT R1 3 [0x7B998233]
       3 [-]: CALL R1 1 1  
L 0:   4 [-]: JUMPIF R1 L1 
       5 [-]: GETIMPORT R3 1 [0x0E058AD6]
       6 [-]: LOADB R4 0   
       7 [-]: LOADN R5 1   
       8 [-]: LOADB R6 0   
       9 [-]: NAMECALL R1 R0 K4 [0x659D451F]
      10 [-]: CALL R1 5 0  
L 1:  11 [-]: GETIMPORT R3 6 ["gPickUpActionType"]
...
L 6:  35 [-]: JUMPIFNOT R2 L7
      ...
      41 [-]: MOVE R1 R2   
      42 [-]: JUMPBACK L5  
L 7:  43 [-]: GETIMPORT R4 14 ["gShipDecoItemType"]
      44 [-]: NAMECALL R2 R1 K7 [0xF2DEAF69]
      45 [-]: CALL R2 2 1  
      46 [-]: JUMPIF R2 L8 
      47 [-]: GETIMPORT R4 16 ["gShipDecoStoreItemType"]
...
; Max Stack Size:  3
       ...
       0 [-]: GETIMPORT R2 2 ["FusionTreasureDecosRequested"]
       1 [-]: SETTABLE R0 R2 R1
       2 [-]: RETURN R0 0  
