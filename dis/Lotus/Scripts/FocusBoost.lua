...
162 [-]: JMP       165          ; PC := 165
163 [-]: LOADBOOL  R22 0 1      ; R22 := false; PC := 164
164 [-]: LOADBOOL  R22 1 0      ; R22 := true
...
246 [-]: JMP       250          ; PC := 250
247 [-]: LOADBOOL  R32 1 0      ; R32 := true
248 [-]: JMP       250          ; PC := 250
249 [-]: LOADBOOL  R32 1 0      ; R32 := true
...
271 [-]: JMP       273          ; PC := 273
272 [-]: LOADBOOL  R32 0 0      ; R32 := false
