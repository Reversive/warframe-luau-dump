...
L 2:  10 [-]: JUMPIFNOT R2 L4
      ...
      12 [-]: LOADNIL R2   
      13 [-]: RETURN R2 1  
L 3:  14 [-]: GETIMPORT R2 6 [0xCBD666E1]
      15 [-]: LOADN R3 0   
      16 [-]: CALL R2 1 0  
...
L 6:  29 [-]: JUMPIFNOT R3 L8
      ...
      31 [-]: LOADNIL R3   
      32 [-]: RETURN R3 1  
L 7:  33 [-]: GETIMPORT R3 6 [0xCBD666E1]
      34 [-]: LOADN R4 0   
      35 [-]: CALL R3 1 0  
...
L 2:  18 [-]: GETUPVAL R6 1
      ...
      26 [-]: GETUPVAL R5 3
      27 [-]: GETIMPORT R7 9 [0x0469F296]
      28 [-]: LOADK R8 K10 ["FoundryClaim"]
      29 [-]: CALL R7 1 -1 
      30 [-]: NAMECALL R5 R5 K11 [0x10C9EEF2]
      31 [-]: CALL R5 -1 -1
      32 [-]: CALL R4 -1 0 
      33 [-]: GETIMPORT R4 13 ["_T"]
      34 [-]: GETUPVAL R5 3
      35 [-]: GETIMPORT R7 9 [0x0469F296]
...
L 1:  14 [-]: GETIMPORT R2 10 ["_T"]
      ...
      21 [-]: CALL R2 1 1  
      22 [-]: GETIMPORT R3 10 ["_T"]
      23 [-]: GETIMPORT R4 14 ["FoundryStartCallbacks"]
      24 [-]: JUMPIF R4 L2 
      25 [-]: NEWTABLE R4 0 0
L 2:  26 [-]: SETTABLEKS R4 R3 K13 ["FoundryStartCallbacks"]
      27 [-]: GETIMPORT R3 10 ["_T"]
      28 [-]: GETIMPORT R4 16 ["FoundryClaimCallbacks"]
      29 [-]: JUMPIF R4 L3 
      30 [-]: NEWTABLE R4 0 0
L 3:  31 [-]: SETTABLEKS R4 R3 K15 ["FoundryClaimCallbacks"]
      32 [-]: GETIMPORT R3 14 ["FoundryStartCallbacks"]
      33 [-]: DUPCLOSURE R4 K17 []
      34 [-]: MOVE R2 R2   
      35 [-]: MOVE R2 R3   
      36 [-]: SETTABLE R4 R3 R2
      37 [-]: GETIMPORT R3 16 ["FoundryClaimCallbacks"]
      38 [-]: GETIMPORT R4 18 ["CheckPersonalQuartersDoor"]
      39 [-]: SETTABLE R4 R3 R2
L 4:  40 [-]: GETIMPORT R3 20 ["syncingInventory"]
      41 [-]: JUMPXEQKNIL R3 L5
      42 [-]: GETIMPORT R3 20 ["syncingInventory"]
      43 [-]: JUMPXEQKB R3 1 L8 NOT
L 5:  44 [-]: GETIMPORT R4 22 [0xBE190284]
      45 [-]: FASTCALL1 62 R4 L6
      46 [-]: GETIMPORT R3 7 [0x7B998233]
      47 [-]: CALL R3 1 1  
L 6:  48 [-]: JUMPIF R3 L7 
      49 [-]: GETIMPORT R3 22 [0xBE190284]
      50 [-]: GETIMPORT R5 24 ["gLotusPhotoBoothGameRulesType"]
      51 [-]: NAMECALL R3 R3 K25 [0xF2DEAF69]
      52 [-]: CALL R3 2 1  
      53 [-]: JUMPIF R3 L8 
L 7:  54 [-]: GETIMPORT R3 27 [0xCBD666E1]
      55 [-]: LOADN R4 0   
      56 [-]: CALL R3 1 0  
      57 [-]: JUMPBACK L4  
...
L 1:   9 [-]: GETUPVAL R2 0
      10 [-]: CALL R2 0 1  
      11 [-]: GETIMPORT R3 6 ["PersonalQuartersTransmission"]
...
L 5:  50 [-]: LOADN R8 5   
      ...
      53 [-]: LOADK R8 K17 [60]
      54 [-]: GETIMPORT R6 20 [0xAC1B386A]
      55 [-]: CALL R6 2 1  
L 6:  56 [-]: JUMPIFNOTLT R5 R6 L7
      57 [-]: GETIMPORT R6 15 [0xCBD666E1]
      58 [-]: LOADN R7 0   
      59 [-]: CALL R6 1 0  
      60 [-]: GETIMPORT R6 22 [0x67652851]
      61 [-]: CALL R6 0 1  
      62 [-]: ADD R5 R5 R6 
      63 [-]: JUMPBACK L5  
L 7:  64 [-]: GETUPVAL R8 2
      ...
      69 [-]: CALL R6 5 0  
L 8:  70 [-]: JUMPBACK L4  
L 9:  71 [-]: GETIMPORT R5 1 [0x89326C93]
      72 [-]: GETIMPORT R7 24 [0x0469F296]
...
L10:  81 [-]: JUMPIF R6 L11
      ...
      83 [-]: CALL R6 1 0  
L11:  84 [-]: GETIMPORT R7 29 ["RefreshTennoGuide"]
      85 [-]: FASTCALL1 62 R7 L12
      86 [-]: GETIMPORT R6 8 [0x7B998233]
      87 [-]: CALL R6 1 1  
L12:  88 [-]: JUMPIF R6 L13
      89 [-]: GETIMPORT R6 29 ["RefreshTennoGuide"]
      90 [-]: CALL R6 0 0  
L13:  91 [-]: RETURN R0 0  
