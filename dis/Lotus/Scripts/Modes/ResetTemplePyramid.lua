...
; Max Stack Size:  18
       ...
       0 [-]: GETIMPORT R2 2 ["PlayerWhoHasSpentToken"]
       1 [-]: LOADNIL R3   
...
L 2:  14 [-]: JUMPIF R4 L14
      ...
      22 [-]: CALL R5 1 1  
      23 [-]: GETIMPORT R6 14 [0x99CD4E94]
      24 [-]: JUMPIFEQ R5 R6 L3
      25 [-]: GETIMPORT R8 16 [0x556B9BBB]
      26 [-]: LOADB R9 0   
      27 [-]: LOADB R10 0  
      28 [-]: LOADN R11 0  
      29 [-]: GETIMPORT R12 18 ["EMPTY_SYMBOL"]
      30 [-]: LOADN R13 1  
      31 [-]: NAMECALL R6 R4 K19 [0x5D985C7E]
      32 [-]: CALL R6 7 0  
      33 [-]: GETIMPORT R8 14 [0x99CD4E94]
      34 [-]: LOADB R9 1   
      35 [-]: NAMECALL R6 R4 K20 [0x4C91B5D8]
      36 [-]: CALL R6 3 0  
L 3:  37 [-]: GETIMPORT R6 7 [0x89326C93]
      38 [-]: GETIMPORT R8 22 [0xB009BBC6]
      ...
      45 [-]: CALL R6 4 0  
      46 [-]: GETIMPORT R6 27 ["CorpusLeaderLoreTransmission"]
      47 [-]: MOVE R9 R6   
      48 [-]: NAMECALL R7 R3 K28 [0x2A748F85]
      49 [-]: CALL R7 2 0  
      50 [-]: GETIMPORT R7 30 ["CorpusReliefDeco"]
      51 [-]: GETIMPORT R8 31 ["_T"]
      52 [-]: LOADNIL R9   
      53 [-]: SETTABLEKS R9 R8 K1 ["PlayerWhoHasSpentToken"]
      54 [-]: LOADN R8 0   
L 4:  55 [-]: LOADK R9 K32 [2.3300000000000001]
      56 [-]: JUMPIFNOTLT R8 R9 L5
      57 [-]: GETIMPORT R9 34 [0x67652851]
      58 [-]: CALL R9 0 1  
      59 [-]: ADD R8 R8 R9 
      60 [-]: GETIMPORT R9 36 [0xCBD666E1]
      61 [-]: LOADN R10 0  
      62 [-]: CALL R9 1 0  
      63 [-]: JUMPBACK L4  
L 5:  64 [-]: NAMECALL R9 R4 K24 [0xD1586535]
      65 [-]: CALL R9 1 1  
      66 [-]: GETIMPORT R10 7 [0x89326C93]
      67 [-]: GETIMPORT R12 38 [0xCA491FF3]
      68 [-]: MOVE R13 R9  
      69 [-]: LOADN R14 0  
      70 [-]: LOADN R15 30 
...
L 6:  77 [-]: GETTABLE R14 R10 R13
      78 [-]: GETIMPORT R17 41 ["gLotusEffectDecorationType"]
...
L 7:  89 [-]: GETIMPORT R17 47 ["gSpawnerType"]
...
L 8:  97 [-]: GETIMPORT R17 50 ["gParticleSysType"]
...
L 9: 105 [-]: GETIMPORT R17 53 ["gLightType"]
...
L15: 128 [-]: LOADN R5 8   
     ...
     130 [-]: GETIMPORT R5 34 [0x67652851]
     131 [-]: CALL R5 0 1  
     132 [-]: ADD R4 R4 R5 
     133 [-]: GETIMPORT R5 36 [0xCBD666E1]
     134 [-]: LOADN R6 0   
     135 [-]: CALL R5 1 0  
     136 [-]: JUMPBACK L15 
L16: 137 [-]: GETIMPORT R5 7 [0x89326C93]
     138 [-]: GETIMPORT R7 9 [0x0469F296]
     ...
     144 [-]: CALL R6 1 0  
     145 [-]: GETIMPORT R6 7 [0x89326C93]
     146 [-]: GETIMPORT R8 9 [0x0469F296]
     ...
     152 [-]: CALL R7 1 0  
     153 [-]: GETIMPORT R7 7 [0x89326C93]
     154 [-]: GETIMPORT R9 9 [0x0469F296]
     ...
     160 [-]: CALL R8 1 0  
     161 [-]: GETIMPORT R8 7 [0x89326C93]
     162 [-]: GETIMPORT R10 9 [0x0469F296]
     ...
     168 [-]: CALL R9 1 0  
     169 [-]: GETIMPORT R9 7 [0x89326C93]
     170 [-]: GETIMPORT R11 9 [0x0469F296]
