...
L 0:  16 [-]: LOADN R4 1   
      ...
      20 [-]: LOADN R1 8   
      21 [-]: LOADN R2 12  
L 1:  22 [-]: GETIMPORT R4 5 [0x89326C93]
...
; Max Stack Size:  14
       ...
       1 [-]: JUMPIF R0 L0 
       2 [-]: GETUPVAL R0 0
       3 [-]: GETIMPORT R1 3 [0x15FD6E72]
       4 [-]: CALL R0 1 0  
L 0:   5 [-]: GETIMPORT R0 5 ["_T"]
       6 [-]: LOADB R1 1   
      ...
      47 [-]: CALL R3 3 0  
      48 [-]: GETIMPORT R3 5 ["_T"]
      49 [-]: LOADN R4 0   
      50 [-]: SETTABLEKS R4 R3 K19 ["raidCratesDestroyed"]
      51 [-]: LENGTH R4 R1 
      52 [-]: FASTCALL2K 19 R4 K20 L1 [3]
      53 [-]: LOADK R5 K20 [3]
      54 [-]: GETIMPORT R3 23 [0xAC1B386A]
      55 [-]: CALL R3 2 1  
L 1:  56 [-]: LOADN R6 1   
      57 [-]: MOVE R4 R3   
      58 [-]: LOADN R5 1   
      59 [-]: FORNPREP R4 L3
L 2:  60 [-]: GETIMPORT R7 9 [0x89326C93]
      61 [-]: GETIMPORT R9 25 [0x02E85837]
      62 [-]: GETTABLE R10 R1 R6
      63 [-]: NAMECALL R10 R10 K26 [0xD1586535]
      64 [-]: CALL R10 1 1 
      65 [-]: GETIMPORT R11 28 ["ZERO_ROTATION"]
...
L 3:  70 [-]: LOADN R4 3   
      ...
      82 [-]: LOADN R7 1   
      83 [-]: FORNPREP R6 L5
L 4:  84 [-]: GETIMPORT R9 9 [0x89326C93]
      85 [-]: GETIMPORT R11 25 [0x02E85837]
      86 [-]: GETTABLE R12 R4 R8
      87 [-]: NAMECALL R12 R12 K26 [0xD1586535]
      88 [-]: CALL R12 1 1 
      89 [-]: GETIMPORT R13 28 ["ZERO_ROTATION"]
...
L 5:  94 [-]: GETUPVAL R4 4
      ...
      98 [-]: CALL R4 3 0  
      99 [-]: GETIMPORT R5 33 ["RaidCrateProgressBar"]
     100 [-]: FASTCALL1 62 R5 L6
     101 [-]: GETIMPORT R4 35 [0x7B998233]
     102 [-]: CALL R4 1 1  
L 6: 103 [-]: JUMPIFNOT R4 L7
     104 [-]: GETIMPORT R4 5 ["_T"]
     105 [-]: GETIMPORT R5 37 ["AddHudTracker"]
     ...
     112 [-]: GETIMPORT R4 41 ["SetLabel"]
     113 [-]: LOADK R5 K42 [""]
     114 [-]: CALL R4 1 0  
     115 [-]: GETIMPORT R4 44 ["SetValue"]
     116 [-]: LOADN R5 -1  
     117 [-]: CALL R4 1 0  
L 7: 118 [-]: GETIMPORT R4 46 ["SetGoalLabel"]
     119 [-]: GETIMPORT R10 48 ["Localize"]
     ...
     135 [-]: CONCAT R5 R6 R9
     136 [-]: CALL R4 1 0  
     137 [-]: GETIMPORT R4 16 [0xCBD666E1]
     138 [-]: LOADN R5 3   
     139 [-]: CALL R4 1 0  
     140 [-]: LOADN R6 1   
     141 [-]: GETIMPORT R7 53 [0x3CDF8CF3]
     142 [-]: LENGTH R4 R7 
     143 [-]: LOADN R5 1   
     144 [-]: FORNPREP R4 L9
L 8: 145 [-]: GETUPVAL R7 0
     146 [-]: GETIMPORT R9 53 [0x3CDF8CF3]
     147 [-]: GETTABLE R8 R9 R6
     148 [-]: CALL R7 1 0  
     149 [-]: GETIMPORT R7 16 [0xCBD666E1]
...
L 9: 153 [-]: GETUPVAL R4 4
     ...
     164 [-]: GETIMPORT R6 5 ["_T"]
     165 [-]: LOADB R7 1   
     166 [-]: SETTABLEKS R7 R6 K54 ["raidComplete"]
     167 [-]: JUMP L11
    
L10: 168 [-]: GETIMPORT R6 16 [0xCBD666E1]
     169 [-]: LOADN R7 0   
     170 [-]: CALL R6 1 0  
     171 [-]: JUMPBACK L9  
L11: 172 [-]: GETUPVAL R4 0
     173 [-]: GETIMPORT R5 56 [0x5DB40813]
     174 [-]: CALL R4 1 0  
     175 [-]: GETIMPORT R4 16 [0xCBD666E1]
     176 [-]: LOADK R5 K17 [0.5]
     177 [-]: CALL R4 1 0  
     178 [-]: GETUPVAL R4 0
     179 [-]: GETIMPORT R5 58 [0xD3691783]
     180 [-]: CALL R4 1 0  
     181 [-]: GETIMPORT R5 9 [0x89326C93]
     182 [-]: GETIMPORT R7 11 [0x0469F296]
     183 [-]: LOADK R8 K59 ["RaidDialog"]
     184 [-]: CALL R7 1 -1 
     185 [-]: NAMECALL R5 R5 K13 [0xC7FCADA9]
     186 [-]: CALL R5 -1 1 
     187 [-]: GETTABLEN R4 R5 1
     188 [-]: GETIMPORT R5 16 [0xCBD666E1]
     189 [-]: LOADN R6 4   
     190 [-]: CALL R5 1 0  
     191 [-]: GETUPVAL R5 1
     192 [-]: LOADB R7 1   
...
; Max Stack Size:  23
      ...
      13 [-]: CALL R0 2 0  
      14 [-]: GETIMPORT R1 11 [0x89326C93]
      15 [-]: GETIMPORT R3 4 [0x0469F296]
...
L 1:  41 [-]: GETUPVAL R3 4
      ...
      44 [-]: CALL R2 1 0  
      45 [-]: GETIMPORT R3 22 [0x5F05C2B4]
      46 [-]: FASTCALL1 62 R3 L2
      47 [-]: GETIMPORT R2 24 [0x7B998233]
      48 [-]: CALL R2 1 1  
L 2:  49 [-]: JUMPIF R2 L7 
      50 [-]: GETIMPORT R2 11 [0x89326C93]
      51 [-]: GETIMPORT R4 22 [0x5F05C2B4]
      ...
      57 [-]: CALL R3 1 1  
      58 [-]: MOVE R2 R3   
      59 [-]: GETIMPORT R3 28 [0xC8802016]
      60 [-]: MOVE R4 R2   
      61 [-]: CALL R3 1 3  
      62 [-]: FORGPREP_INEXT R3 L6
L 3:  63 [-]: GETUPVAL R10 6
      64 [-]: GETIMPORT R11 30 ["EMPTY_SYMBOL"]
      65 [-]: GETIMPORT R12 32 [0xA421AF95]
      66 [-]: LOADN R13 0  
      ...
      80 [-]: CALL R9 5 1  
      81 [-]: GETIMPORT R11 39 [0xCD91CC7E]
      82 [-]: GETTABLE R10 R11 R6
      83 [-]: GETIMPORT R11 28 [0xC8802016]
      84 [-]: MOVE R12 R9  
      85 [-]: CALL R11 1 3 
...
L 8: 104 [-]: JUMPIFNOTLT R2 R1 L9
     ...
     109 [-]: CALL R3 3 1  
     110 [-]: MOVE R2 R3   
     111 [-]: GETIMPORT R3 18 [0xCBD666E1]
     112 [-]: LOADN R4 0   
     113 [-]: CALL R3 1 0  
     114 [-]: JUMPBACK L8  
...
L 2:  11 [-]: GETUPVAL R0 0
      ...
      15 [-]: RETURN R0 0  
L 3:  16 [-]: GETIMPORT R1 5 [0xCBD666E1]
      17 [-]: LOADN R2 1   
      18 [-]: CALL R1 1 0  
      19 [-]: LOADNIL R1   
...
L 6:  33 [-]: NAMECALL R2 R1 K11 [0x5E651723]
      ...
      36 [-]: CALL R3 1 1  
L 7:  37 [-]: GETIMPORT R4 15 ["raidComplete"]
      38 [-]: JUMPIF R4 L8 
      39 [-]: GETIMPORT R4 5 [0xCBD666E1]
      40 [-]: LOADN R5 0   
      41 [-]: CALL R4 1 0  
      42 [-]: JUMPBACK L7  
L 8:  43 [-]: LOADB R6 1   
      ...
      45 [-]: CALL R4 2 0  
      46 [-]: GETIMPORT R5 9 [0x89326C93]
      47 [-]: GETIMPORT R7 18 [0x0469F296]
