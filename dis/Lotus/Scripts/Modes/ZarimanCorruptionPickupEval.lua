...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R3 2 ["PlayerEnergyCap"]
...
L 0:   4 [-]: JUMPIFNOT R2 L1
       5 [-]: LOADB R2 1   
       6 [-]: RETURN R2 1  
L 1:   7 [-]: GETIMPORT R3 6 ["PlayerVoidEnergyAmt"]
...
L 3:  15 [-]: FASTCALL1 62 R1 L4
      ...
      18 [-]: CALL R2 1 1  
L 4:  19 [-]: JUMPIF R2 L9 
      20 [-]: GETIMPORT R3 6 ["PlayerVoidEnergyAmt"]
...
L 6:  31 [-]: JUMPIF R3 L9 
      ...
      33 [-]: CALL R4 1 1  
      34 [-]: ADDK R3 R4 K9 [1]
      35 [-]: GETIMPORT R6 6 ["PlayerVoidEnergyAmt"]
      36 [-]: GETTABLE R5 R6 R3
      37 [-]: FASTCALL1 62 R5 L7
      38 [-]: GETIMPORT R4 4 [0x7B998233]
      39 [-]: CALL R4 1 1  
L 7:  40 [-]: JUMPIFNOT R4 L8
      41 [-]: GETIMPORT R4 6 ["PlayerVoidEnergyAmt"]
      42 [-]: LOADN R5 0   
      43 [-]: SETTABLE R5 R4 R3
L 8:  44 [-]: GETIMPORT R5 6 ["PlayerVoidEnergyAmt"]
      45 [-]: GETTABLE R4 R5 R3
      46 [-]: GETIMPORT R5 2 ["PlayerEnergyCap"]
