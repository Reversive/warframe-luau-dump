...
; Max Stack Size:  11
       ...
       1 [-]: GETIMPORT R1 3 [0x2677CE18]
       2 [-]: CALL R0 1 3  
       3 [-]: FORGPREP_INEXT R0 L1
L 0:   4 [-]: NAMECALL R5 R4 K4 [0xA2880940]
       5 [-]: CALL R5 1 0  
L 1:   6 [-]: FORGLOOP R0 L0 2 [inext]
       7 [-]: GETIMPORT R0 1 [0xC8802016]
       8 [-]: GETIMPORT R1 6 [0x73F4B1F3]
       9 [-]: CALL R0 1 3  
      10 [-]: FORGPREP_INEXT R0 L5
L 2:  11 [-]: GETIMPORT R7 8 [0xBA119994]
...
L 5:  23 [-]: FORGLOOP R0 L2 2 [inext]
      24 [-]: GETIMPORT R0 1 [0xC8802016]
      25 [-]: GETIMPORT R1 14 [0x0D96E21B]
      26 [-]: CALL R0 1 3  
      27 [-]: FORGPREP_INEXT R0 L7
L 6:  28 [-]: GETIMPORT R5 16 [0x89326C93]
      29 [-]: GETIMPORT R7 18 [0xB672B2BE]
...
L 7:  36 [-]: FORGLOOP R0 L6 2 [inext]
      37 [-]: GETIMPORT R1 23 [0x343774C9]
      38 [-]: FASTCALL1 62 R1 L8
      39 [-]: GETIMPORT R0 11 [0x7B998233]
      40 [-]: CALL R0 1 1  
L 8:  41 [-]: JUMPIF R0 L11
      42 [-]: GETIMPORT R1 25 [0x9C4A1CD5]
      43 [-]: FASTCALL1 62 R1 L9
      44 [-]: GETIMPORT R0 11 [0x7B998233]
      45 [-]: CALL R0 1 1  
L 9:  46 [-]: JUMPIF R0 L11
      47 [-]: GETIMPORT R1 27 [0xBF132EBE]
      48 [-]: FASTCALL1 62 R1 L10
      49 [-]: GETIMPORT R0 11 [0x7B998233]
      50 [-]: CALL R0 1 1  
L10:  51 [-]: JUMPIFNOT R0 L12
L11:  52 [-]: RETURN R0 0  
L12:  53 [-]: GETIMPORT R0 29 [0xD56EF1A3]
      54 [-]: GETIMPORT R2 31 [0x0469F296]
      55 [-]: LOADK R3 K32 ["EmissiveMapAtten"]
      56 [-]: CALL R2 1 1  
      57 [-]: LOADN R3 0   
      58 [-]: NAMECALL R0 R0 K33 [0x986D2AB8]
      59 [-]: CALL R0 3 0  
      60 [-]: GETIMPORT R0 25 [0x9C4A1CD5]
      61 [-]: LOADK R2 K34 ["Enable"]
      62 [-]: NAMECALL R0 R0 K35 [0x8EB2112D]
      63 [-]: CALL R0 2 0  
      64 [-]: GETIMPORT R0 27 [0xBF132EBE]
      65 [-]: LOADK R2 K34 ["Enable"]
      66 [-]: NAMECALL R0 R0 K35 [0x8EB2112D]
      67 [-]: CALL R0 2 0  
      68 [-]: GETIMPORT R0 37 [0xCBD666E1]
      69 [-]: LOADN R1 1   
      70 [-]: CALL R0 1 0  
      71 [-]: GETIMPORT R0 25 [0x9C4A1CD5]
      72 [-]: LOADK R2 K38 ["Disable"]
      73 [-]: NAMECALL R0 R0 K35 [0x8EB2112D]
      74 [-]: CALL R0 2 0  
      75 [-]: GETIMPORT R0 27 [0xBF132EBE]
...
L 1:   6 [-]: NAMECALL R1 R0 K2 [0xD2715720]
      ...
      10 [-]: GETIMPORT R1 4 [0xC8802016]
      11 [-]: GETIMPORT R2 6 [0x74EAA489]
      12 [-]: CALL R1 1 3  
...
L 3:  17 [-]: FORGLOOP R1 L2 2 [inext]
      18 [-]: GETIMPORT R1 4 [0xC8802016]
      19 [-]: GETIMPORT R2 10 [0x980FCEEA]
      20 [-]: CALL R1 1 3  
...
L 7:  33 [-]: FORGLOOP R1 L6 2 [inext]
      34 [-]: GETIMPORT R1 4 [0xC8802016]
      35 [-]: GETIMPORT R2 16 [0x0D96E21B]
      36 [-]: CALL R1 1 3  
      37 [-]: FORGPREP_INEXT R1 L9
L 8:  38 [-]: GETIMPORT R6 18 [0x89326C93]
      39 [-]: GETIMPORT R8 20 [0xB672B2BE]
...
; Max Stack Size:  12
       ...
       6 [-]: GETIMPORT R2 5 [0x9BAFFFE3]
       7 [-]: GETIMPORT R3 7 [0x9C43F480]
       8 [-]: GETIMPORT R4 9 [0x672BEA46]
       9 [-]: MOVE R5 R1   
      10 [-]: CALL R2 3 1  
      11 [-]: GETIMPORT R3 11 [0x82D33839]
      12 [-]: JUMPIFNOT R3 L0
      13 [-]: MULK R2 R2 K12 [2.5]
L 0:  14 [-]: GETIMPORT R3 14 [0xC8802016]
      15 [-]: GETIMPORT R4 16 [0xCC38DA78]
      16 [-]: CALL R3 1 3  
...
L 0:   6 [-]: JUMPIFNOT R2 L1
       7 [-]: RETURN R0 0  
L 1:   8 [-]: GETIMPORT R4 5 ["EMISSIVE_TINT_COLOR"]
       9 [-]: LOADN R5 1   
      10 [-]: LOADN R6 0   
      11 [-]: LOADN R7 0   
      12 [-]: LOADN R8 1   
      ...
      17 [-]: LOADN R3 10  
      18 [-]: CALL R2 1 0  
      19 [-]: GETIMPORT R4 5 ["EMISSIVE_TINT_COLOR"]
