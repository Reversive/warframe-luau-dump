...
L 0:  15 [-]: JUMPIF R4 L1 ; goto L1 if var4
      16 [-]: JUMPIFEQ R3 R1 L1; goto L1 if var3 == var1030
...
L 3:  26 [-]: JUMPIF R11 L37; goto L37 if var11
      ...
      30 [-]: JUMPIFNOTLT R12 R11 L37; goto L37 if var12 >= var50872381
...
L 6:  51 [-]: JUMPIF R15 L7; goto L7 if var15
      ...
      62 [-]: JUMPIFNOTEQ R15 R16 L7; goto L7 if var15 ~= var235605789
...
L 8:  73 [-]: LENGTH R15 R11; var15 = #var11
      ...
      75 [-]: JUMPIFNOTLT R16 R15 L10; goto L10 if var16 >= var50937917
...
L 9:  80 [-]: JUMPIF R15 L10; goto L10 if var15
      ...
      82 [-]: JUMPIFNOTEQ R15 R9 L10; goto L10 if var15 ~= var1576737
...
L12:  92 [-]: JUMPIF R12 L37; goto L37 if var12
      ...
      95 [-]: JUMPIFNOTLT R13 R12 L37; goto L37 if var13 >= var1707041
...
L14: 122 [-]: JUMPIF R16 L15; goto L15 if var16
     123 [-]: JUMPIFEQ R15 R13 L15; goto L15 if var15 == var3078
...
L18: 149 [-]: NAMECALL R12 R6 K39; var13 = var6; var12 = var6[0xB14438B6]
     ...
     151 [-]: JUMPIFEQ R12 R8 L20; goto L20 if var12 == var50872381
...
L25: 182 [-]: GETIMPORT R11 48; var11 = 0x67652851
     ...
     189 [-]: JUMPIFNOTLT R11 R10 L27; goto L27 if var11 >= var2608
     190 [-]: LOADN R10 0  ; var10 = 0
     191 [-]: MOVE R9 R8   ; var9 = var8
     192 [-]: LOADNIL R8   ; var8 = nil
     193 [-]: FASTCALL1 64 R7 L26; 
...
L29: 222 [-]: JUMPIF R15 L30; goto L30 if var15
     223 [-]: JUMPIFEQ R14 R12 L30; goto L30 if var14 == var2822
...
L 0:  13 [-]: JUMPIF R3 L2 ; goto L2 if var3
      ...
      18 [-]: JUMPIFNOTLE R3 R4 L2; goto L2 if var3 > var1328
