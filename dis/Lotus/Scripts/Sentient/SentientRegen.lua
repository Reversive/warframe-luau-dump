...
L 0:   7 [-]: JUMPIFNOT R5 L1
       8 [-]: RETURN R0 0  
L 1:   9 [-]: LOADN R5 0   
      10 [-]: GETIMPORT R8 6 [0x16C5AE55]
      11 [-]: LOADB R9 1   
      12 [-]: NAMECALL R6 R1 K7 [0x5D985C7E]
      13 [-]: CALL R6 3 0  
      14 [-]: GETIMPORT R8 9 [0xEA52F7BB]
      15 [-]: LOADB R9 0   
      16 [-]: NAMECALL R6 R1 K7 [0x5D985C7E]
      17 [-]: CALL R6 3 0  
L 2:  18 [-]: LOADN R6 1   
      19 [-]: JUMPIFNOTLT R5 R6 L3
      20 [-]: GETIMPORT R6 11 [0x67652851]
      21 [-]: CALL R6 0 1  
      22 [-]: ADD R5 R5 R6 
      23 [-]: GETIMPORT R6 13 [0xCBD666E1]
      24 [-]: LOADN R7 0   
      25 [-]: CALL R6 1 0  
      26 [-]: JUMPBACK L2  
L 3:  27 [-]: GETIMPORT R6 15 [0xD9587AB2]
      28 [-]: JUMPIFNOT R6 L5
      29 [-]: GETIMPORT R7 17 [0xFCA7217E]
      30 [-]: FASTCALL1 62 R7 L4
      31 [-]: GETIMPORT R6 4 [0x7B998233]
      32 [-]: CALL R6 1 1  
L 4:  33 [-]: JUMPIF R6 L6 
      34 [-]: GETIMPORT R8 17 [0xFCA7217E]
      35 [-]: LOADB R9 1   
      36 [-]: NAMECALL R6 R1 K18 [0x511D26B8]
      37 [-]: CALL R6 3 0  
      38 [-]: JUMP L6
     
L 5:  39 [-]: GETIMPORT R8 20 [0xB81B4AAA]
      40 [-]: GETIMPORT R9 22 [0xF5305A6C]
      41 [-]: NAMECALL R6 R1 K23 [0x47901F07]
      42 [-]: CALL R6 3 0  
      43 [-]: GETIMPORT R8 17 [0xFCA7217E]
      44 [-]: GETIMPORT R9 25 ["EMPTY_SYMBOL"]
      45 [-]: NAMECALL R6 R1 K23 [0x47901F07]
      46 [-]: CALL R6 3 0  
L 6:  47 [-]: GETIMPORT R8 27 [0x48EB1C4C]
      48 [-]: LOADB R9 0   
...
; Max Stack Size:  6
       ...
       7 [-]: CALL R2 1 0  
L 0:   8 [-]: GETIMPORT R4 6 [0x48EB1C4C]
       9 [-]: LOADB R5 1   
