...
L 1:  11 [-]: GETIMPORT R1 7; var1 = 0x653688C5
      ...
      13 [-]: JUMPIFNOTLE R2 R1 L2; goto L2 if var2 > var459086
      14 [-]: GETIMPORT R1 7; var1 = 0x653688C5
      15 [-]: LOADN R2 1   ; var2 = 1
      16 [-]: JUMPIFNOTLT R1 R2 L2; goto L2 if var1 >= var590158
      ...
      22 [-]: JUMPIFNOTLT R1 R2 L2; goto L2 if var1 >= var65581
      23 [-]: RETURN R0 0  ; 
...
L 0:   5 [-]: GETIMPORT R0 6; var0 = 0x653688C5
       6 [-]: LOADN R1 0   ; var1 = 0
       7 [-]: JUMPIFNOTLE R1 R0 L1; goto L1 if var1 > var393294
       8 [-]: GETIMPORT R0 6; var0 = 0x653688C5
       9 [-]: LOADN R1 1   ; var1 = 1
      10 [-]: JUMPIFNOTLT R0 R1 L1; goto L1 if var0 >= var524366
      ...
      16 [-]: JUMPIFNOTLT R0 R1 L1; goto L1 if var0 >= var65581
      17 [-]: RETURN R0 0  ; 
