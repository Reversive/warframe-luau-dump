...
; Max Stack Size:  4
       ...
       0 [-]: GETIMPORT R0 1 [0x653688C5]
       1 [-]: LOADN R1 0   
       2 [-]: JUMPIFNOTLE R1 R0 L0
       3 [-]: GETIMPORT R0 1 [0x653688C5]
       4 [-]: LOADN R1 1   
       5 [-]: JUMPIFNOTLT R0 R1 L0
       6 [-]: GETIMPORT R0 3 [0xDD6E4CF8]
       7 [-]: LOADN R1 0   
       8 [-]: LOADN R2 1   
       9 [-]: CALL R0 2 1  
      10 [-]: GETIMPORT R1 1 [0x653688C5]
      11 [-]: JUMPIFNOTLT R0 R1 L0
      12 [-]: RETURN R0 0  
L 0:  13 [-]: GETIMPORT R0 5 [0xDDA7E021]
      14 [-]: LOADN R1 0   
      15 [-]: JUMPIFNOTLE R1 R0 L1
      16 [-]: GETIMPORT R0 7 [0xCBD666E1]
      17 [-]: GETIMPORT R1 5 [0xDDA7E021]
      18 [-]: CALL R0 1 0  
L 1:  19 [-]: GETIMPORT R0 9 [0x4E9CA548]
      20 [-]: JUMPIFNOT R0 L3
      21 [-]: GETIMPORT R1 12 ["curTransmission"]
...
L 2:  25 [-]: JUMPIF R0 L3 
      ...
      31 [-]: CALL R0 0 0  
L 3:  32 [-]: GETIMPORT R0 18 [0xF6366930]
      33 [-]: JUMPIFNOT R0 L4
      34 [-]: GETIMPORT R0 20 [0xBE190284]
      35 [-]: GETIMPORT R2 22 [0xBB5B1BFE]
      36 [-]: NAMECALL R0 R0 K23 [0xC19D05D7]
      37 [-]: CALL R0 2 0  
      38 [-]: RETURN R0 0  
L 4:  39 [-]: GETIMPORT R0 25 [0x89326C93]
      40 [-]: NAMECALL R0 R0 K26 [0x78298275]
      41 [-]: CALL R0 1 1  
      42 [-]: FASTCALL1 62 R0 L5
      43 [-]: MOVE R2 R0   
      44 [-]: GETIMPORT R1 14 [0x7B998233]
      45 [-]: CALL R1 1 1  
L 5:  46 [-]: JUMPIF R1 L7 
      47 [-]: GETIMPORT R2 22 [0xBB5B1BFE]
      48 [-]: FASTCALL1 62 R2 L6
      49 [-]: GETIMPORT R1 14 [0x7B998233]
      50 [-]: CALL R1 1 1  
L 6:  51 [-]: JUMPIF R1 L7 
      52 [-]: GETIMPORT R3 22 [0xBB5B1BFE]
...
L 2:  25 [-]: JUMPIF R0 L3 
      ...
      30 [-]: GETTABLEKS R0 R1 K16 [0xFE0D9469]
      31 [-]: CALL R0 0 0  
L 3:  32 [-]: GETIMPORT R0 18 [0x89326C93]
      33 [-]: NAMECALL R0 R0 K19 [0x78298275]
      34 [-]: CALL R0 1 1  
      35 [-]: GETIMPORT R1 21 [0xCFC01047]
      36 [-]: GETIMPORT R2 23 [0x7D6C5EF7]
      37 [-]: CALL R1 1 3  
      38 [-]: FORGPREP_NEXT R1 L8
L 4:  39 [-]: GETIMPORT R6 25 [0xF6366930]
      40 [-]: JUMPIFNOT R6 L5
      41 [-]: GETIMPORT R6 27 [0xBE190284]
      42 [-]: MOVE R8 R5   
...
L 5:  46 [-]: FASTCALL1 62 R0 L6
      47 [-]: MOVE R7 R0   
      48 [-]: GETIMPORT R6 14 [0x7B998233]
      49 [-]: CALL R6 1 1  
L 6:  50 [-]: JUMPIF R6 L8 
      51 [-]: FASTCALL1 62 R5 L7
      52 [-]: MOVE R7 R5   
      53 [-]: GETIMPORT R6 14 [0x7B998233]
      54 [-]: CALL R6 1 1  
L 7:  55 [-]: JUMPIF R6 L8 
      56 [-]: MOVE R8 R5   
...
L 0:  13 [-]: GETUPVAL R1 0
      ...
      15 [-]: GETIMPORT R1 6 [0xE91D7466]
      16 [-]: GETIMPORT R2 8 [0xDFDA639E]
      17 [-]: CALL R0 2 0  
      18 [-]: RETURN R0 0  
...
; Max Stack Size:  4
       ...
       0 [-]: GETIMPORT R0 1 [0x9E952E33]
       1 [-]: JUMPIF R0 L0 
       2 [-]: GETIMPORT R0 4 ["gQuestMission"]
       3 [-]: JUMPIFNOT R0 L0
       4 [-]: RETURN R0 0  
L 0:   5 [-]: GETUPVAL R1 0
       ...
       9 [-]: JUMPIF R0 L1 
      10 [-]: RETURN R0 0  
L 1:  11 [-]: GETIMPORT R1 7 [0x653688C5]
      12 [-]: LOADN R2 0   
      13 [-]: JUMPIFNOTLE R2 R1 L2
      14 [-]: GETIMPORT R1 7 [0x653688C5]
      15 [-]: LOADN R2 1   
      16 [-]: JUMPIFNOTLT R1 R2 L2
      17 [-]: GETIMPORT R1 9 [0xDD6E4CF8]
      18 [-]: LOADN R2 0   
      19 [-]: LOADN R3 1   
      20 [-]: CALL R1 2 1  
      21 [-]: GETIMPORT R2 7 [0x653688C5]
      22 [-]: JUMPIFNOTLT R1 R2 L2
      23 [-]: RETURN R0 0  
L 2:  24 [-]: GETUPVAL R2 2
      25 [-]: GETTABLEKS R1 R2 K10 [0x11DCFE97]
      26 [-]: GETIMPORT R2 12 [0xDFDA639E]
      27 [-]: CALL R1 1 0  
      28 [-]: RETURN R0 0  
...
L 3:  32 [-]: GETIMPORT R0 18 [0xF6366930]
      33 [-]: JUMPIFNOT R0 L8
      34 [-]: GETIMPORT R0 20 [0x89326C93]
      35 [-]: NAMECALL R0 R0 K21 [0x8B5B1F58]
      36 [-]: CALL R0 1 1  
      37 [-]: GETIMPORT R1 23 [0xC8802016]
      38 [-]: MOVE R2 R0   
      39 [-]: CALL R1 1 3  
      40 [-]: FORGPREP_INEXT R1 L7
L 4:  41 [-]: FASTCALL1 62 R5 L5
      42 [-]: MOVE R7 R5   
      43 [-]: GETIMPORT R6 14 [0x7B998233]
      44 [-]: CALL R6 1 1  
L 5:  45 [-]: JUMPIF R6 L7 
      46 [-]: GETIMPORT R7 25 [0xBB5B1BFE]
      47 [-]: FASTCALL1 62 R7 L6
      48 [-]: GETIMPORT R6 14 [0x7B998233]
      49 [-]: CALL R6 1 1  
L 6:  50 [-]: JUMPIF R6 L7 
      51 [-]: GETIMPORT R8 25 [0xBB5B1BFE]
      52 [-]: NAMECALL R6 R5 K26 [0x2A748F85]
      53 [-]: CALL R6 2 0  
L 7:  54 [-]: FORGLOOP R1 L4 2 [inext]
      55 [-]: RETURN R0 0  
L 8:  56 [-]: GETIMPORT R0 20 [0x89326C93]
...
; Max Stack Size:  5
       ...
       3 [-]: JUMPIFNOT R0 L0
       4 [-]: RETURN R0 0  
L 0:   5 [-]: GETIMPORT R0 6 [0x653688C5]
       6 [-]: LOADN R1 0   
       7 [-]: JUMPIFNOTLE R1 R0 L1
       8 [-]: GETIMPORT R0 6 [0x653688C5]
       9 [-]: LOADN R1 1   
      10 [-]: JUMPIFNOTLT R0 R1 L1
      11 [-]: GETIMPORT R0 8 [0xDD6E4CF8]
      12 [-]: LOADN R1 0   
      13 [-]: LOADN R2 1   
      14 [-]: CALL R0 2 1  
      15 [-]: GETIMPORT R1 6 [0x653688C5]
      16 [-]: JUMPIFNOTLT R0 R1 L1
      17 [-]: RETURN R0 0  
L 1:  18 [-]: GETIMPORT R0 10 [0xBE190284]
      19 [-]: GETUPVAL R3 0
      ...
      27 [-]: GETIMPORT R2 16 [0xE91D7466]
      28 [-]: GETIMPORT R3 18 [0x0469F296]
...
L 2:  32 [-]: JUMPXEQKN R0 K20 L3 NOT [2]
      ...
      35 [-]: GETIMPORT R2 16 [0xE91D7466]
      36 [-]: GETIMPORT R3 18 [0x0469F296]
...
L 5:  56 [-]: JUMPXEQKN R0 K26 L6 NOT [5]
      ...
      59 [-]: GETIMPORT R2 16 [0xE91D7466]
      60 [-]: GETIMPORT R3 18 [0x0469F296]
...
L 6:  64 [-]: JUMPXEQKN R0 K28 L7 NOT [6]
      ...
      67 [-]: GETIMPORT R2 16 [0xE91D7466]
      68 [-]: GETIMPORT R3 18 [0x0469F296]
