...
L 0:   5 [-]: JUMPIFNOT R1 L1
       6 [-]: RETURN R0 0  
L 1:   7 [-]: GETIMPORT R1 6 [0xB412AFB3]
       8 [-]: JUMPIFNOT R1 L3
L 2:   9 [-]: GETIMPORT R1 2 ["curTransmission"]
      ...
      13 [-]: CALL R1 1 0  
      14 [-]: JUMPBACK L2  
L 3:  15 [-]: GETIMPORT R1 10 [0x74B75231]
      16 [-]: LOADN R2 0   
      17 [-]: JUMPIFNOTLT R2 R1 L4
      18 [-]: GETIMPORT R1 8 [0xCBD666E1]
      19 [-]: GETIMPORT R2 10 [0x74B75231]
      20 [-]: CALL R1 1 0  
L 4:  21 [-]: GETIMPORT R2 12 [0x520E413D]
      22 [-]: FASTCALL1 62 R2 L5
      23 [-]: GETIMPORT R1 4 [0x7B998233]
      24 [-]: CALL R1 1 1  
L 5:  25 [-]: JUMPIF R1 L10
      26 [-]: LOADNIL R1   
      27 [-]: GETIMPORT R2 14 [0xAC6BF1A3]
      28 [-]: NAMECALL R2 R2 K15 [0x56C01834]
      29 [-]: CALL R2 1 1  
      30 [-]: JUMPIFNOT R2 L7
      31 [-]: GETIMPORT R2 17 [0x89326C93]
      32 [-]: GETIMPORT R4 14 [0xAC6BF1A3]
...
L 7:  41 [-]: FASTCALL1 62 R1 L8
      ...
      44 [-]: CALL R2 1 1  
L 8:  45 [-]: JUMPIF R2 L9 
      46 [-]: GETIMPORT R4 12 [0x520E413D]
      47 [-]: LOADB R5 0   
      48 [-]: NAMECALL R2 R1 K19 [0x659D451F]
      49 [-]: CALL R2 3 0  
      50 [-]: JUMP L10
    
L 9:  51 [-]: GETIMPORT R2 17 [0x89326C93]
      52 [-]: GETIMPORT R4 12 [0x520E413D]
      53 [-]: GETIMPORT R5 21 ["ZERO_VECTOR"]
      54 [-]: LOADB R6 0   
      55 [-]: NAMECALL R2 R2 K19 [0x659D451F]
      56 [-]: CALL R2 4 0  
L10:  57 [-]: GETIMPORT R1 23 [0xC8802016]
      58 [-]: GETIMPORT R2 25 [0xBECFBE8A]
      59 [-]: CALL R1 1 3  
...
L11:  61 [-]: NAMECALL R6 R5 K15 [0x56C01834]
      ...
      67 [-]: CALL R6 2 1  
      68 [-]: GETIMPORT R7 23 [0xC8802016]
      69 [-]: MOVE R8 R6   
      70 [-]: CALL R7 1 3  
      71 [-]: FORGPREP_INEXT R7 L13
L12:  72 [-]: GETIMPORT R14 28 ["gSequencerType"]
...
L14:  79 [-]: FORGLOOP R1 L11 2 [inext]
      80 [-]: GETIMPORT R1 23 [0xC8802016]
      81 [-]: GETIMPORT R2 32 [0x22B1EF45]
      82 [-]: CALL R1 1 3  
      83 [-]: FORGPREP_INEXT R1 L18
L15:  84 [-]: NAMECALL R6 R5 K15 [0x56C01834]
      85 [-]: CALL R6 1 1  
      86 [-]: JUMPIFNOT R6 L18
      87 [-]: GETIMPORT R6 17 [0x89326C93]
      88 [-]: MOVE R8 R5   
      89 [-]: NAMECALL R6 R6 K26 [0xC7FCADA9]
      90 [-]: CALL R6 2 1  
      91 [-]: GETIMPORT R7 23 [0xC8802016]
      92 [-]: MOVE R8 R6   
      93 [-]: CALL R7 1 3  
      94 [-]: FORGPREP_INEXT R7 L17
L16:  95 [-]: GETIMPORT R14 28 ["gSequencerType"]
