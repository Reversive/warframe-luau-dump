...
; Max Stack Size:  12
       ...
       0 [-]: GETIMPORT R4 1 [0x41DCA3CD]
       1 [-]: FASTCALL1 62 R4 L0
       2 [-]: GETIMPORT R3 3 [0x7B998233]
       3 [-]: CALL R3 1 1  
L 0:   4 [-]: JUMPIF R3 L2 
       5 [-]: GETIMPORT R4 5 [0x2F0F8B3C]
...
L 4:  15 [-]: LOADN R4 1   
      ...
      21 [-]: CALL R4 3 1  
      22 [-]: LOADN R7 1   
      23 [-]: GETIMPORT R8 5 [0x2F0F8B3C]
      24 [-]: LENGTH R5 R8 
      25 [-]: LOADN R6 1   
      26 [-]: FORNPREP R5 L6
L 5:  27 [-]: GETIMPORT R9 5 [0x2F0F8B3C]
      28 [-]: GETTABLE R8 R9 R7
      29 [-]: GETIMPORT R10 1 [0x41DCA3CD]
      30 [-]: MOVE R11 R4  
      31 [-]: NAMECALL R8 R8 K9 [0x59E5566E]
      32 [-]: CALL R8 3 0  
      33 [-]: FORNLOOP R5 L5
L 6:  34 [-]: GETIMPORT R6 11 [0xB693B6C1]
      35 [-]: CALL R6 0 1  
      36 [-]: GETGLOBAL R7 K6 [0xBA7D82A1]
      37 [-]: DIV R5 R6 R7 
      38 [-]: ADD R3 R3 R5 
      39 [-]: GETIMPORT R5 13 [0xCBD666E1]
      40 [-]: LOADN R6 0   
      41 [-]: CALL R5 1 0  
      42 [-]: JUMPBACK L4  
L 7:  43 [-]: JUMPXEQKN R2 K14 L9 NOT [0]
      44 [-]: LOADN R5 1   
      45 [-]: GETIMPORT R6 5 [0x2F0F8B3C]
      46 [-]: LENGTH R3 R6 
      47 [-]: LOADN R4 1   
      48 [-]: FORNPREP R3 L11
L 8:  49 [-]: GETIMPORT R7 5 [0x2F0F8B3C]
      ...
      54 [-]: RETURN R0 0  
L 9:  55 [-]: LOADN R5 1   
      56 [-]: GETIMPORT R6 5 [0x2F0F8B3C]
      57 [-]: LENGTH R3 R6 
      58 [-]: LOADN R4 1   
      59 [-]: FORNPREP R3 L11
L10:  60 [-]: GETIMPORT R7 5 [0x2F0F8B3C]
      61 [-]: GETTABLE R6 R7 R5
      62 [-]: GETIMPORT R8 1 [0x41DCA3CD]
      63 [-]: MOVE R9 R2   
...
L 2:  12 [-]: JUMPIFNOT R4 L3
      ...
      19 [-]: MOVE R1 R4   
      20 [-]: JUMPBACK L1  
L 3:  21 [-]: GETIMPORT R4 7 [0xCBD666E1]
      22 [-]: LOADN R5 0   
      23 [-]: CALL R4 1 0  
...
L 4:  28 [-]: JUMPIF R4 L8 
      ...
      44 [-]: CALL R4 4 0  
      45 [-]: LOADB R3 1   
L 5:  46 [-]: GETIMPORT R4 15 [0x67652851]
      47 [-]: CALL R4 0 1  
      48 [-]: ADD R2 R2 R4 
      49 [-]: LOADN R4 1   
      50 [-]: JUMPIFNOTLT R4 R2 L12
      51 [-]: GETIMPORT R6 17 [0x97563B31]
      52 [-]: GETIMPORT R7 10 [0x786992EE]
      53 [-]: NAMECALL R7 R7 K11 [0x2E333568]
      54 [-]: CALL R7 1 1  
      55 [-]: MUL R5 R6 R7 
      56 [-]: GETIMPORT R6 10 [0x786992EE]
      ...
      61 [-]: CALL R6 1 1  
      62 [-]: SUB R5 R6 R4 
      63 [-]: GETIMPORT R6 21 [0x9C43F480]
      64 [-]: JUMPIFNOTLT R5 R6 L6
      65 [-]: NAMECALL R7 R1 K19 [0xD2715720]
      66 [-]: CALL R7 1 1  
      67 [-]: SUB R6 R7 R4 
      68 [-]: GETIMPORT R7 21 [0x9C43F480]
      69 [-]: SUB R5 R6 R7 
      70 [-]: ADD R4 R4 R5 
L 6:  71 [-]: LOADN R5 0   
...
L10:  75 [-]: LOADN R5 0   
      ...
      89 [-]: MOVE R6 R2   
      90 [-]: GETIMPORT R5 3 [0x7B998233]
      91 [-]: CALL R5 1 1  
L11:  92 [-]: JUMPIF R5 L12
      93 [-]: NAMECALL R5 R1 K15 [0x0B4BCFB6]
      94 [-]: CALL R5 1 1  
      95 [-]: GETIMPORT R8 18 [0xDE993596]
