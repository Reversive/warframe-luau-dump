...
; Max Stack Size:  6
 ...
 25 [-]: JMP       36           ; PC := 36
 26 [-]: SELF      R3 R1 K6     ; R4 := R1; R3 := R1[0x5ea1328f]
 27 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 28 [-]: MOVE      R2 R3        ; R2 := R3
 29 [-]: SELF      R3 R0 K7     ; R4 := R0; R3 := R0[0x9e9c67cb]
 30 [-]: MOVE      R5 R2        ; R5 := R2
 31 [-]: CALL      R3 3 1       ; R3(R4,R5)
 32 [-]: GETGLOBAL R3 K8        ; R3 := 0xcbd666e1
 33 [-]: LOADK     R4 K9        ; R4 := 0.100000
