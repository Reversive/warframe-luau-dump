...
L21: 134 [-]: JUMPIFNOT R4 L22; goto L22 if not var4
     135 [-]: JUMPIFNOTEQ R3 R2 L47; goto L47 if var3 ~= var525360
L22: 136 [-]: LOADN R4 8   ; var4 = 8
     137 [-]: LOADNIL R5   ; var5 = nil
L23: 138 [-]: LOADN R6 0   ; var6 = 0
     139 [-]: JUMPIFNOTLT R6 R4 L28; goto L28 if var6 >= var50675773
     140 [-]: FASTCALL1 64 R5 L24; 
...
L40: 239 [-]: LOADNIL R7   ; var7 = nil
     ...
     247 [-]: JUMPIFNOTEQ R9 R10 L41; goto L41 if var9 ~= var2862
...
L43: 266 [-]: GETIMPORT R9 20; var9 = 0x60130201
     ...
     273 [-]: JUMPIFNOTEQ R9 R10 L44; goto L44 if var9 ~= var2862
...
L19: 129 [-]: LOADN R7 1   ; var7 = 1
     130 [-]: JUMPIFNOTLT R6 R7 L20; goto L20 if var6 >= var65571
     131 [-]: RETURN R0 0  ; 
...
L14: 107 [-]: LOADN R7 1   ; var7 = 1
     108 [-]: JUMPIFNOTLT R6 R7 L15; goto L15 if var6 >= var65571
     109 [-]: RETURN R0 0  ; 
...
L17: 114 [-]: LOADN R7 0   ; var7 = 0
     115 [-]: JUMPIFNOTLT R7 R6 L19; goto L19 if var7 >= var-804976820
...
L 3:  15 [-]: NAMECALL R2 R0 K7; var3 = var0; var2 = var0[0x28E744CF]
      ...
      22 [-]: JUMPIFNOTLT R2 R1 L4; goto L4 if var2 >= var184615170
...
L 7:  37 [-]: JUMPIFNOT R4 L8; goto L8 if not var4
      ...
      39 [-]: JUMPIFNOTLT R4 R3 L8; goto L8 if var4 >= var1862403148
