...
L 0:   4 [-]: GETIMPORT R3 4; var3 = 0xC163F229
       ...
       8 [-]: LOADN R4 0   ; var4 = 0
       9 [-]: JUMPIFNOTLT R3 R4 L1; goto L1 if var3 >= var33752081
...
L 0:   6 [-]: GETIMPORT R6 7; var6 = 0xC163F229
      ...
      11 [-]: JUMPIFNOTLT R6 R7 L1; goto L1 if var6 >= var84280337
...
L 3:  28 [-]: GETIMPORT R8 7; var8 = 0xC163F229
      ...
      33 [-]: JUMPIFNOTLT R8 R9 L4; goto L4 if var8 >= var117966353
...
L 6:  43 [-]: LOADN R4 3   ; var4 = 3
      44 [-]: JUMPIFNOTLT R3 R4 L15; goto L15 if var3 >= var918561
...
L 8:  63 [-]: GETIMPORT R9 7; var9 = 0xC163F229
      ...
      68 [-]: JUMPIFNOTLT R9 R10 L9; goto L9 if var9 >= var134809361
...
L11:  85 [-]: GETIMPORT R11 7; var11 = 0xC163F229
      ...
      90 [-]: JUMPIFNOTLT R11 R12 L12; goto L12 if var11 >= var168495377
...
L12:  72 [-]: LOADN R10 3  ; var10 = 3
      73 [-]: JUMPIFNOTLE R10 R9 L13; goto L13 if var10 > var67590
...
L15:  83 [-]: JUMPIF R9 L26; goto L26 if var9
      ...
      85 [-]: LOADK R10 K2 ; var10 = 0.20000000298023224
      86 [-]: LOADK R11 K31; var11 = 0.30000001192092896
...
L20: 122 [-]: JUMPIF R11 L25; goto L25 if var11
     ...
     124 [-]: JUMPIFNOTEQ R10 R11 L21; goto L21 if var10 ~= var3334
...
L21: 130 [-]: LOADB R13 1  ; var13 = true
     ...
     143 [-]: JUMPIFNOTEQ R5 R2 L22; goto L22 if var5 ~= var197934
...
L24: 152 [-]: GETIMPORT R11 18; var11 = 0xA421AF95
     ...
     155 [-]: MULK R13 R14 K50; var13 = var14 * 0.80000001192092896
     156 [-]: SUBK R12 R13 K49; var12 = var13 - 0.40000000596046448
     157 [-]: GETIMPORT R15 53; var15 = 0x5BCED4C4[0x3630E649]
     158 [-]: CALL R15 1 2 ; var15 = var15()
     159 [-]: MULK R14 R15 K50; var14 = var15 * 0.80000001192092896
     160 [-]: SUBK R13 R14 K49; var13 = var14 - 0.40000000596046448
     161 [-]: GETIMPORT R16 53; var16 = 0x5BCED4C4[0x3630E649]
     162 [-]: CALL R16 1 2 ; var16 = var16()
     163 [-]: MULK R15 R16 K50; var15 = var16 * 0.80000001192092896
     164 [-]: SUBK R14 R15 K49; var14 = var15 - 0.40000000596046448
