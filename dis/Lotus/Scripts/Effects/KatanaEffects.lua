...
; Max Stack Size:  5
       ...
       0 [-]: GETIMPORT R1 1 [0x691ECA81]
       1 [-]: JUMPIFNOT R1 L0
       2 [-]: NAMECALL R1 R0 K2 [0x28E744CF]
       3 [-]: CALL R1 1 1  
       4 [-]: MOVE R0 R1   
L 0:   5 [-]: GETIMPORT R1 4 [0xD522826D]
       6 [-]: JUMPIFNOT R1 L1
...
; Max Stack Size:  17
       ...
       8 [-]: LOADN R5 0   
       9 [-]: SETTABLE R5 R3 R4
L 0:  10 [-]: GETIMPORT R3 1 ["_T"]
      11 [-]: NAMECALL R4 R0 K2 [0xED4E0128]
      12 [-]: CALL R4 1 1  
      13 [-]: GETIMPORT R7 1 ["_T"]
      ...
      23 [-]: GETIMPORT R6 5 ["gDecorationType"]
      24 [-]: NAMECALL R4 R0 K6 [0xC1595BD5]
      25 [-]: CALL R4 2 1  
      26 [-]: GETIMPORT R5 8 [0xC0013CAA]
      27 [-]: JUMPIFNOT R5 L4
      28 [-]: LOADN R7 1   
      29 [-]: LENGTH R5 R4 
      30 [-]: LOADN R6 1   
...
L 6:  50 [-]: LOADN R7 1   
      ...
      52 [-]: GETIMPORT R8 1 ["_T"]
      53 [-]: NAMECALL R9 R0 K2 [0xED4E0128]
      54 [-]: CALL R9 1 1  
      55 [-]: GETTABLE R7 R8 R9
      56 [-]: JUMPIFEQ R7 R3 L7
      57 [-]: RETURN R0 0  
L 7:  58 [-]: GETIMPORT R9 14 ["UNLIT_ATTEN"]
      59 [-]: GETIMPORT R10 16 [0x9BAFFFE3]
      60 [-]: MOVE R11 R1  
      61 [-]: MOVE R12 R2  
      62 [-]: MOVE R13 R6  
      63 [-]: CALL R10 3 -1
...
L 8:  72 [-]: GETTABLE R11 R4 R9
      ...
      74 [-]: GETIMPORT R10 10 [0x7B998233]
      75 [-]: CALL R10 1 1 
L 9:  76 [-]: JUMPIF R10 L10
      77 [-]: GETTABLE R10 R4 R9
      78 [-]: GETIMPORT R12 14 ["UNLIT_ATTEN"]
      79 [-]: GETIMPORT R13 16 [0x9BAFFFE3]
      80 [-]: MOVE R14 R1  
      81 [-]: MOVE R15 R2  
      82 [-]: MOVE R16 R6  
      83 [-]: CALL R13 3 -1
...
L11:  87 [-]: GETIMPORT R9 23 [0x67652851]
      88 [-]: CALL R9 0 1  
      89 [-]: MULK R8 R9 K21 [4]
      90 [-]: MULK R7 R8 K20 [0.5]
      91 [-]: ADD R6 R6 R7 
      92 [-]: GETIMPORT R7 25 [0xCBD666E1]
      93 [-]: LOADN R8 0   
      94 [-]: CALL R7 1 0  
      95 [-]: JUMPBACK L6  
L12:  96 [-]: GETIMPORT R9 14 ["UNLIT_ATTEN"]
      97 [-]: MOVE R10 R2  
      98 [-]: NAMECALL R7 R0 K17 [0x986D2AB8]
      99 [-]: CALL R7 3 0  
     100 [-]: GETIMPORT R7 19 [0xA535D6A7]
...
L 0:   6 [-]: JUMPIF R2 L1 
      ...
      28 [-]: RETURN R0 0  
L 1:  29 [-]: GETIMPORT R4 14 ["UNLIT_ATTEN"]
      30 [-]: LOADN R5 1   
