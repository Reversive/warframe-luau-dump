...
; Max Stack Size:  10
       ...
       5 [-]: CALL R3 1 1  
L 0:   6 [-]: JUMPIF R3 L1 
       7 [-]: GETIMPORT R5 5 ["gLotusPvpGameRulesType"]
      ...
      18 [-]: GETIMPORT R5 10 [0xAF36EC96]
      19 [-]: GETIMPORT R6 12 ["EMPTY_SYMBOL"]
      20 [-]: GETIMPORT R7 14 ["ZERO_VECTOR"]
      21 [-]: GETIMPORT R8 16 ["ZERO_ROTATION"]
      22 [-]: MOVE R9 R0   
...
L 1:  27 [-]: GETIMPORT R5 19 [0x80E77DBE]
      28 [-]: GETIMPORT R6 12 ["EMPTY_SYMBOL"]
      29 [-]: GETIMPORT R7 14 ["ZERO_VECTOR"]
