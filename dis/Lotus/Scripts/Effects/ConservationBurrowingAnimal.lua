...
; Max Stack Size:  16
      ...
      26 [-]: CALL R5 9 1  
      27 [-]: JUMPIFNOT R5 L3
      28 [-]: GETIMPORT R6 8 [0xB03A5E89]
      29 [-]: JUMPIFNOT R6 L0
      30 [-]: GETIMPORT R6 10 [0x3D106989]
      31 [-]: LOADK R7 K11 ["Hit: "]
      32 [-]: MOVE R8 R4   
      33 [-]: CALL R6 2 0  
L 0:  34 [-]: GETIMPORT R6 3 [0x00046924]
      35 [-]: GETIMPORT R8 15 [0x3630E649]
      36 [-]: LOADN R9 0   
      37 [-]: LOADN R10 3600
      38 [-]: CALL R8 2 1  
      ...
      42 [-]: CALL R6 3 1  
      43 [-]: GETIMPORT R7 5 [0x89326C93]
      44 [-]: GETIMPORT R9 19 [0x1D7B11AA]
      45 [-]: GETIMPORT R11 21 [0x051BD934]
      46 [-]: ADD R10 R3 R11
      47 [-]: MOVE R11 R6  
      48 [-]: NAMECALL R7 R7 K22 [0x05909209]
      49 [-]: CALL R7 4 1  
      50 [-]: GETIMPORT R8 15 [0x3630E649]
      51 [-]: LOADN R9 0   
      52 [-]: LOADN R10 10 
      53 [-]: CALL R8 2 1  
      54 [-]: GETIMPORT R9 24 [0x4BE9992C]
      55 [-]: JUMPIFNOTLE R9 R8 L2
      56 [-]: GETIMPORT R10 26 [0x2C03CCA7]
      57 [-]: FASTCALL1 62 R10 L1
      58 [-]: GETIMPORT R9 28 [0x7B998233]
      59 [-]: CALL R9 1 1  
L 1:  60 [-]: JUMPIF R9 L2 
      61 [-]: GETIMPORT R9 3 [0x00046924]
      62 [-]: GETTABLEKS R10 R4 K29 ["heading"]
      63 [-]: GETTABLEKS R11 R4 K16 ["pitch"]
      64 [-]: GETIMPORT R13 15 [0x3630E649]
      65 [-]: LOADN R14 0  
      66 [-]: LOADN R15 3600
      67 [-]: CALL R13 2 1 
      68 [-]: DIVK R12 R13 K12 [10]
      69 [-]: CALL R9 3 1  
      70 [-]: GETIMPORT R10 5 [0x89326C93]
      71 [-]: GETIMPORT R12 26 [0x2C03CCA7]
      72 [-]: MOVE R13 R3  
      73 [-]: MOVE R14 R9  
...
L 0:   4 [-]: JUMPIF R1 L2 
       ...
       6 [-]: CALL R1 1 1  
       7 [-]: NEWTABLE R2 0 4
       8 [-]: GETIMPORT R3 4 ["gBaseAvatarType"]
       9 [-]: GETIMPORT R4 6 ["gPickUpType"]
      10 [-]: GETIMPORT R5 8 ["gRagdollType"]
      11 [-]: GETIMPORT R6 10 ["gHitProxyType"]
      12 [-]: SETLIST R2 R3 4 [1]
      13 [-]: GETIMPORT R4 12 [0xA421AF95]
      14 [-]: LOADN R5 0   
      15 [-]: LOADN R6 2   
      16 [-]: LOADN R7 0   
      17 [-]: CALL R4 3 1  
      ...
      23 [-]: CALL R5 3 1  
      24 [-]: SUB R4 R1 R5 
      25 [-]: GETIMPORT R5 12 [0xA421AF95]
      26 [-]: CALL R5 0 1  
      27 [-]: GETIMPORT R6 14 [0x00046924]
      28 [-]: CALL R6 0 1  
      29 [-]: GETIMPORT R7 16 [0x89326C93]
      30 [-]: MOVE R9 R3   
      31 [-]: MOVE R10 R4  
      32 [-]: LOADNIL R11  
      33 [-]: MOVE R12 R2  
      ...
      39 [-]: CALL R7 9 1  
      40 [-]: JUMPIFNOT R7 L2
      41 [-]: GETIMPORT R8 19 [0xB03A5E89]
      42 [-]: JUMPIFNOT R8 L1
      43 [-]: GETIMPORT R8 21 [0x3D106989]
      44 [-]: LOADK R9 K22 ["Hit: "]
      45 [-]: MOVE R10 R6  
      46 [-]: CALL R8 2 0  
L 1:  47 [-]: GETIMPORT R8 14 [0x00046924]
      48 [-]: GETIMPORT R10 26 [0x3630E649]
      49 [-]: LOADN R11 0  
      50 [-]: LOADN R12 3600
      51 [-]: CALL R10 2 1 
...
L 3:  22 [-]: JUMPIF R2 L7 
      ...
      29 [-]: CALL R4 1 1  
L 4:  30 [-]: JUMPIF R4 L5 
      31 [-]: GETIMPORT R4 9 [0x03EA2485]
      32 [-]: MOVE R5 R2   
      33 [-]: GETUPVAL R6 0
      34 [-]: CALL R4 2 1  
      35 [-]: MOVE R3 R4   
      36 [-]: GETIMPORT R4 11 [0x28BCBEBC]
...
L 5:  42 [-]: GETUPVAL R4 1
      43 [-]: MOVE R5 R2   
      44 [-]: CALL R4 1 0  
L 6:  45 [-]: GETIMPORT R4 13 [0xCBD666E1]
      46 [-]: GETIMPORT R5 15 [0x74B75231]
      47 [-]: CALL R4 1 0  
      48 [-]: JUMPBACK L2  
L 7:  49 [-]: RETURN R0 0  
...
L 1:   4 [-]: JUMPIF R2 L3 
      ...
      12 [-]: CALL R2 5 1  
      13 [-]: JUMPIFNOT R2 L2
      14 [-]: GETIMPORT R5 9 [0x43ECDA7C]
      15 [-]: LOADB R6 0   
      16 [-]: NAMECALL R3 R0 K10 [0x5D985C7E]
      17 [-]: CALL R3 3 0  
      18 [-]: RETURN R0 0  
L 2:  19 [-]: GETIMPORT R3 12 [0xCBD666E1]
      20 [-]: LOADN R4 0   
      21 [-]: CALL R3 1 0  
      22 [-]: JUMPBACK L0  
L 3:  23 [-]: RETURN R0 0  
