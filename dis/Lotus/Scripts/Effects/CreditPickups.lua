...
104 [-]: CLOSURE   R2 1         ; R2 := closure(Function #2)
105 [-]: MOVE      R0 R1        ; R0 := R1
106 [-]: SETGLOBAL R2 K24       ; CircuitsPickup := R2
...
; Max Stack Size:  15
  ...
  6 [-]: GETGLOBAL R3 K3        ; R3 := 0xe6c6c9f2
 ...
 16 [-]: GETGLOBAL R4 K6        ; R4 := 0x00046924
 ...
 29 [-]: JMP       127          ; PC := 127
 30 [-]: LT        0 R2 K9      ; if R2 >= 2.000000 then PC := 127
 31 [-]: JMP       127          ; PC := 127
 32 [-]: LT        0 R3 K10     ; if R3 >= 10.000000 then PC := 85
 33 [-]: JMP       85           ; PC := 85
 34 [-]: GETGLOBAL R6 K12       ; R6 := 0xc163f229
 35 [-]: CONST     R7 -180      ; R7 := -180.000000
 36 [-]: CONST     R8 180       ; R8 := 180.000000
 37 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 38 [-]: SETTABLE  R4 K11 R6    ; R4["heading"] := R6
 39 [-]: GETGLOBAL R6 K12       ; R6 := 0xc163f229
 40 [-]: CONST     R7 -180      ; R7 := -180.000000
 41 [-]: CONST     R8 180       ; R8 := 180.000000
 42 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 43 [-]: SETTABLE  R4 K13 R6    ; R4["pitch"] := R6
 44 [-]: GETGLOBAL R6 K12       ; R6 := 0xc163f229
 45 [-]: CONST     R7 -180      ; R7 := -180.000000
 46 [-]: CONST     R8 180       ; R8 := 180.000000
 47 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 48 [-]: SETTABLE  R4 K14 R6    ; R4["bank"] := R6
 49 [-]: GETGLOBAL R6 K1        ; R6 := 0x89326c93
 50 [-]: SELF      R6 R6 K2     ; R7 := R6; R6 := R6[0x05909209]
 51 [-]: GETGLOBAL R8 K15       ; R8 := 0x01e24fb5
 ...
 70 [-]: JMP       84           ; PC := 84
 71 [-]: GETGLOBAL R7 K12       ; R7 := 0xc163f229
 72 [-]: CONST     R8 -100      ; R8 := -100.000000
 73 [-]: CONST     R9 100       ; R9 := 100.000000
 74 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
 75 [-]: SETTABLE  R5 K19 R7    ; R5["x"] := R7
 76 [-]: GETGLOBAL R7 K12       ; R7 := 0xc163f229
 77 [-]: CONST     R8 -100      ; R8 := -100.000000
 78 [-]: CONST     R9 100       ; R9 := 100.000000
 79 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
 80 [-]: SETTABLE  R5 K20 R7    ; R5["z"] := R7
 81 [-]: SELF      R7 R6 K21    ; R8 := R6; R7 := R6[0xa645aaad]
 82 [-]: MOVE      R9 R5        ; R9 := R5
 ...
 92 [-]: SELF      R7 R0 K5     ; R8 := R0; R7 := R0[0x5280b883]
 93 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 94 [-]: GETGLOBAL R8 K24       ; R8 := 0x5db3ce80
 95 [-]: SELF      R9 R1 K4     ; R10 := R1; R9 := R1[0xf6ebd926]
 96 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 97 [-]: SELF      R10 R0 K4    ; R11 := R0; R10 := R0[0xf6ebd926]
 98 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 99 [-]: MUL       R11 K25 R2   ; R11 := 0.050000 * R2
100 [-]: ADD       R11 K26 R11  ; R11 := 0.020000 + R11
101 [-]: CALL      R8 4 2       ; R8 := R8(R9,R10,R11)
102 [-]: SELF      R9 R1 K27    ; R10 := R1; R9 := R1[0x9307aa51]
103 [-]: MOVE      R11 R8       ; R11 := R8
104 [-]: CALL      R9 3 1       ; R9(R10,R11)
105 [-]: GETTABLE  R9 R7 K11    ; R9 := R7["heading"]
106 [-]: MUL       R9 R9 R2     ; R9 := R9 * R2
107 [-]: MUL       R9 R9 K28    ; R9 := R9 * 0.500000
108 [-]: SETTABLE  R7 K11 R9    ; R7["heading"] := R9
109 [-]: GETTABLE  R9 R7 K13    ; R9 := R7["pitch"]
110 [-]: MUL       R9 R9 R2     ; R9 := R9 * R2
111 [-]: MUL       R9 R9 K28    ; R9 := R9 * 0.500000
112 [-]: SETTABLE  R7 K13 R9    ; R7["pitch"] := R9
113 [-]: GETTABLE  R9 R7 K14    ; R9 := R7["bank"]
114 [-]: MUL       R9 R9 R2     ; R9 := R9 * R2
115 [-]: MUL       R9 R9 K28    ; R9 := R9 * 0.500000
116 [-]: SETTABLE  R7 K14 R9    ; R7["bank"] := R9
117 [-]: SELF      R9 R1 K29    ; R10 := R1; R9 := R1[0x70b8836c]
118 [-]: MOVE      R11 R7       ; R11 := R7
119 [-]: CALL      R9 3 1       ; R9(R10,R11)
120 [-]: GETGLOBAL R9 K30       ; R9 := 0x67652851
121 [-]: CALL      R9 1 2       ; R9 := R9()
122 [-]: ADD       R2 R2 R9     ; R2 := R2 + R9
123 [-]: GETGLOBAL R9 K31       ; R9 := 0xcbd666e1
124 [-]: CONST     R10 0        ; R10 := 0.000000
125 [-]: CALL      R9 2 1       ; R9(R10)
126 [-]: JMP       20           ; PC := 20
127 [-]: GETGLOBAL R9 K8        ; R9 := 0x7b998233
128 [-]: MOVE      R10 R0       ; R10 := R0
129 [-]: CALL      R9 2 2       ; R9 := R9(R10)
130 [-]: TEST      R9 1         ; if R9 then PC := 139
131 [-]: JMP       139          ; PC := 139
132 [-]: SELF      R9 R0 K0     ; R10 := R0; R9 := R0[0x66472bf5]
133 [-]: CONST     R11 0        ; R11 := 0.000000
134 [-]: CALL      R9 3 1       ; R9(R10,R11)
135 [-]: SELF      R9 R0 K32    ; R10 := R0; R9 := R0[0x47901f07]
136 [-]: GETGLOBAL R11 K33      ; R11 := 0x23f50a9f
137 [-]: GETGLOBAL R12 K34      ; R12 := EMPTY_SYMBOL
...
143 [-]: JMP       146          ; PC := 146
144 [-]: SELF      R9 R1 K35    ; R10 := R1; R9 := R1[0xa2880940]
...
; Max Stack Size:  9
  ...
  5 [-]: CALL      R3 1 2       ; R3 := R3()
  6 [-]: LT        0 R1 K1      ; if R1 >= 4.500000 then PC := 55
  7 [-]: JMP       55           ; PC := 55
 ...
 29 [-]: SELF      R4 R0 K5     ; R5 := R0; R4 := R0[0x47901f07]
 30 [-]: GETGLOBAL R6 K6        ; R6 := 0x78a39459
 31 [-]: MOVE      R7 R2        ; R7 := R2
 ...
 37 [-]: JMP       42           ; PC := 42
 38 [-]: SELF      R5 R4 K7     ; R6 := R4; R5 := R4[0xb94b0ab4]
 39 [-]: MOVE      R7 R0        ; R7 := R0
 40 [-]: MOVE      R8 R3        ; R8 := R3
 41 [-]: CALL      R5 4 1       ; R5(R6,R7,R8)
 42 [-]: SELF      R5 R0 K5     ; R6 := R0; R5 := R0[0x47901f07]
 43 [-]: GETGLOBAL R7 K8        ; R7 := 0xc6b2d2e7
 44 [-]: MOVE      R8 R3        ; R8 := R3
 45 [-]: CALL      R5 4 1       ; R5(R6,R7,R8)
 46 [-]: GETGLOBAL R5 K9        ; R5 := 0xc163f229
 47 [-]: LOADK     R6 K10       ; R6 := 0.100000
 48 [-]: LOADK     R7 K11       ; R7 := 0.300000
