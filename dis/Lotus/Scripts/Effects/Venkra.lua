...
L 1:   7 [-]: JUMPIF R2 L3 
      ...
      19 [-]: MUL R5 R1 R1 
      20 [-]: SUB R3 R4 R5 
      21 [-]: GETIMPORT R7 9 [0x3F1505FC]
      22 [-]: MUL R6 R3 R7 
      23 [-]: NAMECALL R4 R0 K10 [0x5004BE24]
      24 [-]: CALL R4 2 0  
      25 [-]: GETUPVAL R6 1
      26 [-]: GETIMPORT R8 12 [0x084DF3B2]
      27 [-]: LOADN R10 1  
      28 [-]: FASTCALL2K 21 R1 K13 L2 [0.5]
      29 [-]: MOVE R12 R1  
      30 [-]: LOADK R13 K13 [0.5]
      31 [-]: GETIMPORT R11 16 [0xA40531D8]
      32 [-]: CALL R11 2 1 
L 2:  33 [-]: SUB R9 R10 R11
      34 [-]: MUL R7 R8 R9 
      35 [-]: NAMECALL R4 R0 K7 [0x986D2AB8]
      36 [-]: CALL R4 3 0  
      37 [-]: GETIMPORT R5 18 [0x67652851]
      38 [-]: CALL R5 0 1  
      39 [-]: GETIMPORT R6 20 [0x15E065F1]
      40 [-]: MUL R4 R5 R6 
      41 [-]: ADD R1 R1 R4 
      42 [-]: GETIMPORT R4 22 [0xCBD666E1]
      43 [-]: LOADN R5 0   
      44 [-]: CALL R4 1 0  
      45 [-]: JUMPBACK L0  
...
L 0:   4 [-]: JUMPIF R1 L2 
       ...
       6 [-]: GETIMPORT R3 5 [0x2526E821]
       7 [-]: NAMECALL R4 R0 K6 [0xD1586535]
       8 [-]: CALL R4 1 1  
       9 [-]: GETIMPORT R5 9 ["x"]
      10 [-]: GETIMPORT R6 11 ["y"]
