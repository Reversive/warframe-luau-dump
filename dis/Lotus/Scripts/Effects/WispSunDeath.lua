...
L 0:   8 [-]: JUMPIF R6 L1 ; goto L1 if var6
      ...
      17 [-]: MULK R11 R12 K10; var11 = var12 * 0.20000000298023224
      ...
      27 [-]: MULK R11 R12 K10; var11 = var12 * 0.20000000298023224
      ...
      37 [-]: MULK R13 R14 K10; var13 = var14 * 0.20000000298023224
...
L 9: 103 [-]: LOADN R15 1  ; var15 = 1
     104 [-]: JUMPIFNOTLT R6 R15 L26; goto L26 if var6 >= var50413629
     105 [-]: FASTCALL1 64 R1 L10; 
...
L10: 109 [-]: JUMPIF R15 L26; goto L26 if var15
     ...
     113 [-]: JUMPIFNOTLT R16 R15 L23; goto L23 if var16 >= var4102
...
L12: 128 [-]: JUMPIF R20 L17; goto L17 if var20
     ...
     165 [-]: JUMPIFNOTEQ R19 R20 L13; goto L13 if var19 ~= var69638
...
L20: 207 [-]: LOADK R20 K47; var20 = 0.69999998807907104
     208 [-]: JUMPIFNOTLT R20 R6 L21; goto L21 if var20 >= var319689757
...
L26: 248 [-]: NAMECALL R15 R1 K34; var16 = var1; var15 = var1[0xFF7A9352]
     ...
     251 [-]: JUMPIFNOTLT R16 R15 L28; goto L28 if var16 >= var4656
...
; Max Stack Size:  11
       ...
       5 [-]: LOADK R3 K4  ; var3 = 0.20000000298023224
       6 [-]: LOADK R4 K5  ; var4 = 1.2000000476837158
       7 [-]: LOADK R5 K6  ; var5 = 0.15000000596046448
...
L 0:  18 [-]: MOVE R5 R1   ; var5 = var1
      ...
      29 [-]: JUMPIFNOTLT R3 R1 L1; goto L1 if var3 >= var304
