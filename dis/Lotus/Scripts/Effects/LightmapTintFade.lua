...
; Max Stack Size:  11
 ...
 26 [-]: LOADK     R4 255       ; R4 := 255.000000
 27 [-]: LOADK     R5 255       ; R5 := 255.000000
 28 [-]: LOADK     R6 255       ; R6 := 255.000000
 29 [-]: CALL      R3 4 2       ; R3 := R3(R4,R5,R6)
 30 [-]: GETGLOBAL R4 K10       ; R4 := 0x60130201
 31 [-]: LOADK     R5 40        ; R5 := 40.000000
 32 [-]: LOADK     R6 40        ; R6 := 40.000000
 33 [-]: LOADK     R7 40        ; R7 := 40.000000
...
; Max Stack Size:  8
 ...
 26 [-]: GETGLOBAL R4 K10       ; R4 := 0x07e9d557
 27 [-]: LT        0 R3 R4      ; if R3 >= R4 then PC := 49
 28 [-]: JMP       49           ; PC := 49
 29 [-]: GETGLOBAL R4 K11       ; R4 := 0x42dcc9f5
 30 [-]: GETGLOBAL R5 K12       ; R5 := 0x67652851
 31 [-]: CALL      R5 1 2       ; R5 := R5()
 32 [-]: GETGLOBAL R6 K13       ; R6 := 0xba7d82a1
 33 [-]: DIV       R5 R5 R6     ; R5 := R5 / R6
 34 [-]: ADD       R5 R3 R5     ; R5 := R3 + R5
 35 [-]: LOADK     R6 0         ; R6 := 0.000000
 36 [-]: LOADK     R7 1         ; R7 := 1.000000
 37 [-]: CALL      R4 4 2       ; R4 := R4(R5,R6,R7)
 38 [-]: MOVE      R3 R4        ; R3 := R4
 39 [-]: GETGLOBAL R4 K15       ; R4 := 0x9b46d5df
 40 [-]: SELF      R4 R4 K16    ; R5 := R4; R4 := R4[0x9bafffe3]
 41 [-]: GETGLOBAL R6 K17       ; R6 := 0x6e52a7a6
 42 [-]: MOVE      R7 R3        ; R7 := R3
 43 [-]: CALL      R4 4 2       ; R4 := R4(R5,R6,R7)
 44 [-]: SETTABLE  R1 K14 R4    ; R1["lightMapTint"] := R4
