...
; Max Stack Size:  21
       ...
       3 [-]: NEWTABLE R1 0 0
       4 [-]: NEWTABLE R2 0 0
       5 [-]: GETIMPORT R3 3 [0xA421AF95]
       6 [-]: LOADN R4 1   
       7 [-]: LOADN R5 1   
       8 [-]: LOADN R6 1   
       9 [-]: CALL R3 3 1  
      10 [-]: GETIMPORT R4 3 [0xA421AF95]
      11 [-]: CALL R4 0 1  
      12 [-]: LOADN R7 1   
      13 [-]: LOADN R5 42  
      14 [-]: LOADN R6 1   
      15 [-]: FORNPREP R5 L1
L 0:  16 [-]: GETIMPORT R8 5 [0x0469F296]
...
L 2:  29 [-]: FASTCALL1 62 R0 L3
      30 [-]: MOVE R7 R0   
      31 [-]: GETIMPORT R6 9 [0x7B998233]
      32 [-]: CALL R6 1 1  
L 3:  33 [-]: JUMPIF R6 L14
      34 [-]: GETIMPORT R7 12 ["TransmissionSoundInstance"]
      35 [-]: FASTCALL1 62 R7 L4
      36 [-]: GETIMPORT R6 9 [0x7B998233]
      37 [-]: CALL R6 1 1  
L 4:  38 [-]: JUMPIF R6 L13
      39 [-]: GETIMPORT R7 12 ["TransmissionSoundInstance"]
...
L 6:  54 [-]: GETTABLE R10 R2 R9
      55 [-]: GETIMPORT R15 19 [0x107BF6DA]
...
L12: 102 [-]: MUL R13 R14 R15
     ...
     108 [-]: GETIMPORT R15 40 ["ZERO_ROTATION"]
     109 [-]: MOVE R16 R4  
     110 [-]: MOVE R17 R3  
     111 [-]: NAMECALL R12 R0 K41 [0x2BA5938D]
     112 [-]: CALL R12 5 0 
     113 [-]: FORNLOOP R7 L6
L13: 114 [-]: GETIMPORT R6 1 [0xCBD666E1]
     115 [-]: LOADN R7 0   
     116 [-]: CALL R6 1 0  
     117 [-]: JUMPBACK L2  
L14: 118 [-]: RETURN R0 0  
...
L 0:   6 [-]: FASTCALL1 62 R0 L1
       ...
       9 [-]: CALL R2 1 1  
L 1:  10 [-]: JUMPIF R2 L5 
      11 [-]: GETIMPORT R3 9 ["TransmissionSoundInstance"]
      12 [-]: FASTCALL1 62 R3 L2
      13 [-]: GETIMPORT R2 6 [0x7B998233]
      14 [-]: CALL R2 1 1  
L 2:  15 [-]: JUMPIF R2 L4 
      16 [-]: GETIMPORT R3 11 ["curTransmission"]
      17 [-]: FASTCALL1 62 R3 L3
      18 [-]: GETIMPORT R2 6 [0x7B998233]
      19 [-]: CALL R2 1 1  
L 3:  20 [-]: JUMPIF R2 L4 
      21 [-]: GETIMPORT R2 11 ["curTransmission"]
      22 [-]: GETIMPORT R4 13 [0xA953861E]
      23 [-]: NAMECALL R2 R2 K14 [0xF2DEAF69]
      24 [-]: CALL R2 2 1  
      25 [-]: JUMPIFNOT R2 L4
      26 [-]: GETIMPORT R2 9 ["TransmissionSoundInstance"]
      27 [-]: NAMECALL R2 R2 K15 [0xDAE5BCB5]
      28 [-]: CALL R2 1 1  
      29 [-]: MUL R3 R2 R2 
      30 [-]: GETIMPORT R4 17 [0x9BAFFFE3]
      ...
      43 [-]: CALL R4 7 0  
L 4:  44 [-]: GETIMPORT R2 4 [0xCBD666E1]
      45 [-]: LOADN R3 0   
      46 [-]: CALL R2 1 0  
      47 [-]: JUMPBACK L0  
L 5:  48 [-]: RETURN R0 0  
