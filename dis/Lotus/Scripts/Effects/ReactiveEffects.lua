...
L 1:   7 [-]: GETIMPORT R0 1 [0xBE190284]
      ...
      13 [-]: GETIMPORT R2 8 ["gLotusAttractModeGameRulesType"]
...
L 5:  40 [-]: JUMPIF R4 L6 
      ...
      43 [-]: CALL R4 2 0  
L 6:  44 [-]: GETIMPORT R5 22 [0xBE190284]
...
L 8:  51 [-]: GETIMPORT R3 22 [0xBE190284]
      52 [-]: GETIMPORT R5 24 ["gLotusHubGameRulesType"]
      53 [-]: NAMECALL R3 R3 K5 [0xF2DEAF69]
      54 [-]: CALL R3 2 1  
      55 [-]: JUMPIF R3 L9 
      56 [-]: GETIMPORT R3 22 [0xBE190284]
      57 [-]: GETIMPORT R5 26 ["gLotusAttractModeGameRulesType"]
      58 [-]: NAMECALL R3 R3 K5 [0xF2DEAF69]
      59 [-]: CALL R3 2 1  
L 9:  60 [-]: JUMPIFNOT R3 L10
      61 [-]: GETIMPORT R5 28 [0x0469F296]
      62 [-]: LOADK R6 K29 ["UnlitAtten"]
      63 [-]: CALL R5 1 1  
      64 [-]: GETIMPORT R6 31 [0xB3B5E747]
      65 [-]: LOADN R7 0   
      66 [-]: LOADN R8 0   
      67 [-]: LOADN R9 0   
      68 [-]: LOADB R10 1  
      ...
      70 [-]: CALL R3 7 0  
      71 [-]: GETIMPORT R5 28 [0x0469F296]
      72 [-]: LOADK R6 K33 ["blueClipThreshold"]
      73 [-]: CALL R5 1 1  
      74 [-]: GETIMPORT R6 35 [0x523BB43E]
      75 [-]: LOADN R7 0   
      76 [-]: LOADN R8 0   
      77 [-]: LOADN R9 0   
      78 [-]: LOADB R10 1  
      ...
      80 [-]: CALL R3 7 0  
      81 [-]: RETURN R0 0  
L10:  82 [-]: GETIMPORT R3 37 [0xD23BE1A9]
      83 [-]: JUMPIFNOT R3 L11
      84 [-]: GETIMPORT R3 39 [0x83A25D60]
      85 [-]: JUMPIFNOT R3 L11
...
L17: 113 [-]: JUMPIF R9 L24
     ...
     117 [-]: CALL R9 1 1  
     118 [-]: JUMPIF R8 L18
     119 [-]: GETIMPORT R10 45 [0x67652851]
     120 [-]: CALL R10 0 1 
     121 [-]: ADD R7 R7 R10
     122 [-]: GETIMPORT R10 47 [0xAE4D6B07]
     123 [-]: JUMPIFNOTLE R10 R7 L18
     124 [-]: LOADB R8 1   
     125 [-]: LOADN R7 0   
     126 [-]: MOVE R5 R9   
L18: 127 [-]: GETIMPORT R10 45 [0x67652851]
     128 [-]: CALL R10 0 1 
     129 [-]: ADD R6 R6 R10
     130 [-]: GETIMPORT R10 49 [0xCC266B8E]
     131 [-]: JUMPIFNOTLE R10 R6 L19
     132 [-]: LOADN R6 0   
     133 [-]: MOVE R5 R9   
L19: 134 [-]: JUMPIFNOT R8 L23
     135 [-]: GETIMPORT R11 51 [0xB5C81E3E]
     136 [-]: ADD R10 R5 R11
     137 [-]: JUMPIFNOTLE R10 R9 L23
     138 [-]: GETIMPORT R11 53 [0xF75EB95F]
     139 [-]: FASTCALL1 62 R11 L20
     140 [-]: GETIMPORT R10 2 [0x7B998233]
     141 [-]: CALL R10 1 1 
L20: 142 [-]: JUMPIF R10 L21
     143 [-]: GETIMPORT R12 53 [0xF75EB95F]
     144 [-]: GETIMPORT R13 55 ["EMPTY_SYMBOL"]
     145 [-]: GETIMPORT R14 57 ["ZERO_VECTOR"]
     146 [-]: GETIMPORT R15 59 ["ZERO_ROTATION"]
     147 [-]: MOVE R16 R1  
     148 [-]: NAMECALL R10 R1 K60 [0x47901F07]
     149 [-]: CALL R10 6 0 
L21: 150 [-]: GETIMPORT R10 37 [0xD23BE1A9]
...
L22: 154 [-]: MOVE R5 R9   
     155 [-]: LOADB R8 0   
     156 [-]: LOADN R6 0   
L23: 157 [-]: GETIMPORT R10 7 [0xCBD666E1]
     158 [-]: LOADN R11 0  
     159 [-]: CALL R10 1 0 
     160 [-]: JUMPBACK L16 
L24: 161 [-]: RETURN R0 0  
