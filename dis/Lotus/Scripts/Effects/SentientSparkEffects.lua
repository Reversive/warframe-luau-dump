...
L 2:  10 [-]: LOADN R5 0   ; var5 = 0
      11 [-]: JUMPIFNOTLT R5 R1 L4; goto L4 if var5 >= var50398489
...
L22: 107 [-]: GETIMPORT R9 29; var9 = 0x89326C93
     ...
     117 [-]: JUMPIFNOTLT R10 R9 L24; goto L24 if var10 >= var2427425
     118 [-]: GETIMPORT R10 37; var10 = 0x517BB55C
     119 [-]: FASTCALL1 64 R10 L23; 
...
L25: 142 [-]: GETTABLE R12 R3 R11; var12 = var3[var11]
     ...
     144 [-]: JUMPIFNOTLT R13 R12 L28; goto L28 if var13 >= var2756385
     ...
     149 [-]: LOADK R19 K47; var19 = 1.7999999523162842
...
L 0:   5 [-]: LOADN R4 1   ; var4 = 1
       6 [-]: JUMPIFNOTLT R1 R4 L8; goto L8 if var1 >= var197703
       7 [-]: LOADK R4 K3  ; var4 = 1.2000000476837158
...
L 2:  20 [-]: MUL R7 R2 R8 ; var7 = var2 * var8
      ...
      22 [-]: LOADK R12 K15; var12 = -0.60000002384185791
...
L 7:  62 [-]: GETIMPORT R5 28; var5 = 0x67652851
      ...
      64 [-]: MULK R4 R5 K26; var4 = var5 * 0.44999998807907104
