...
; Max Stack Size:  17
  ...
  2 [-]: CONST     R1 212       ; R1 := 212.000000
  3 [-]: CONST     R2 227       ; R2 := 227.000000
  4 [-]: CONST     R3 255       ; R3 := 255.000000
 ...
 52 [-]: GETTABLE  R10 R10 K15  ; R10 := R10[0x7ab914d8]
...
; Max Stack Size:  19
  ...
  8 [-]: CONST     R2 108       ; R2 := 108.000000
  9 [-]: CONST     R3 117       ; R3 := 117.000000
 10 [-]: CONST     R4 125       ; R4 := 125.000000
 11 [-]: CONST     R5 128       ; R5 := 128.000000
 12 [-]: CALL      R1 5 2       ; R1 := R1(R2,R3,R4,R5)
 13 [-]: GETGLOBAL R2 K0        ; R2 := 0x60130201
 14 [-]: CONST     R3 179       ; R3 := 179.000000
 15 [-]: CONST     R4 179       ; R4 := 179.000000
 16 [-]: CONST     R5 179       ; R5 := 179.000000
 17 [-]: CONST     R6 128       ; R6 := 128.000000
 18 [-]: CALL      R2 5 2       ; R2 := R2(R3,R4,R5,R6)
 19 [-]: GETGLOBAL R3 K0        ; R3 := 0x60130201
 20 [-]: CONST     R4 101       ; R4 := 101.000000
 21 [-]: CONST     R5 111       ; R5 := 111.000000
 22 [-]: CONST     R6 133       ; R6 := 133.000000
 23 [-]: CONST     R7 128       ; R7 := 128.000000
 24 [-]: CALL      R3 5 2       ; R3 := R3(R4,R5,R6,R7)
 25 [-]: GETGLOBAL R4 K0        ; R4 := 0x60130201
 26 [-]: CONST     R5 114       ; R5 := 114.000000
 27 [-]: CONST     R6 114       ; R6 := 114.000000
 28 [-]: CONST     R7 120       ; R7 := 120.000000
 29 [-]: CONST     R8 128       ; R8 := 128.000000
 30 [-]: CALL      R4 5 2       ; R4 := R4(R5,R6,R7,R8)
 31 [-]: GETGLOBAL R5 K0        ; R5 := 0x60130201
 32 [-]: CONST     R6 128       ; R6 := 128.000000
 33 [-]: CONST     R7 128       ; R7 := 128.000000
 34 [-]: CONST     R8 128       ; R8 := 128.000000
 35 [-]: CONST     R9 128       ; R9 := 128.000000
...
138 [-]: CONST     R30 1        ; R30 := 1.000000
139 [-]: LEN       R31 R29      ; R31 := # R29
140 [-]: CONST     R32 1        ; R32 := 1.000000
...
279 [-]: CONST     R49 1        ; R49 := 1.000000
280 [-]: LOADKB    R50 1 0      ; R50 := true
...
290 [-]: CONST     R49 1        ; R49 := 1.000000
291 [-]: LOADKB    R50 1 0      ; R50 := true
292 [-]: CALL      R43 8 1      ; R43(R44,R45,R46,R47,R48,R49,R50)
293 [-]: GETUPVAL  R43 U5       ; R43 := U5
294 [-]: GETTABLE  R43 R43 K29  ; R43 := R43[0x6bcd0a85]
...
304 [-]: GETTABLE  R52 R52 K29  ; R52 := R52[0x6bcd0a85]
305 [-]: MOVE      R53 R51      ; R53 := R51
306 [-]: CALL      R52 2 4      ; R52,R53,R54 := R52(R53)
307 [-]: GETUPVAL  R55 U5       ; R55 := U5
308 [-]: GETTABLE  R55 R55 K32  ; R55 := R55[0x6b70106d]
...
321 [-]: GETTABLE  R57 R57 K32  ; R57 := R57[0x6b70106d]
...
; Max Stack Size:  6
  ...
  6 [-]: GETTABLE  R2 R2 K1     ; R2 := R2[0xa627f28c]
  7 [-]: MOVE      R3 R0        ; R3 := R0
  8 [-]: MOVE      R4 R1        ; R4 := R1
...
; Max Stack Size:  9
 ...
 12 [-]: GETTABLE  R2 R2 K5     ; R2 := R2[0xa627f28c]
 13 [-]: MOVE      R3 R0        ; R3 := R0
 14 [-]: MOVE      R4 R1        ; R4 := R1
...
; Max Stack Size:  12
 ...
 14 [-]: GETGLOBAL R3 K5        ; R3 := gDojoPlaceableDecorationType
 15 [-]: CALL      R1 3 2       ; R1 := R1(R2,R3)
 16 [-]: TEST      R1 0         ; if not R1 then PC := 29
 17 [-]: JMP       29           ; PC := 29
 18 [-]: SELF      R1 R0 K6     ; R2 := R0; R1 := R0[0xf9753e28]
 19 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 20 [-]: EQ        0 R1 K8      ; if R1 ~= 1.000000 then PC := 29
 21 [-]: JMP       29           ; PC := 29
 22 [-]: SELF      R2 R0 K6     ; R3 := R0; R2 := R0[0xf9753e28]
 ...
 31 [-]: SELF      R3 R0 K4     ; R4 := R0; R3 := R0[0xf2deaf69]
 32 [-]: GETGLOBAL R5 K9        ; R5 := gLightType
 33 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 34 [-]: TEST      R3 0         ; if not R3 then PC := 40
 35 [-]: JMP       40           ; PC := 40
 36 [-]: SELF      R3 R0 K10    ; R4 := R0; R3 := R0[0xa3927fe9]
 37 [-]: MOVE      R5 R2        ; R5 := R2
 ...
 44 [-]: GETGLOBAL R3 K11       ; R3 := 0x48d96444
 45 [-]: TEST      R3 0         ; if not R3 then PC := 92
 46 [-]: JMP       92           ; PC := 92
 47 [-]: GETUPVAL  R3 U2        ; R3 := U2
 48 [-]: GETTABLE  R3 R3 K12    ; R3 := R3[0xc2938d8b]
 49 [-]: MOVE      R4 R0        ; R4 := R0
 50 [-]: MOVE      R5 R2        ; R5 := R2
 51 [-]: CALL      R3 3 1       ; R3(R4,R5)
 52 [-]: GETGLOBAL R3 K13       ; R3 := 0x2d5c5020
 53 [-]: GETTABLE  R3 R3 K14    ; R3 := R3[0xc06cb5e5]
 54 [-]: MOVE      R4 R0        ; R4 := R0
 55 [-]: GETGLOBAL R5 K15       ; R5 := gEffectType
 56 [-]: MOVE      R6 R2        ; R6 := R2
 57 [-]: MOVE      R7 R2        ; R7 := R2
 58 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
 59 [-]: SELF      R3 R0 K16    ; R4 := R0; R3 := R0[0xc1595bd5]
 60 [-]: GETGLOBAL R5 K17       ; R5 := gEntityType
 61 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 62 [-]: CONST     R4 1         ; R4 := 1.000000
 63 [-]: LEN       R5 R3        ; R5 := # R3
 64 [-]: CONST     R6 1         ; R6 := 1.000000
 65 [-]: FORPREP   R4 91        ; R4 -= R6; PC := 91
 66 [-]: GETTABLE  R8 R3 R7     ; R8 := R3[R7]
 67 [-]: GETGLOBAL R9 K18       ; R9 := 0x7b998233
 68 [-]: MOVE      R10 R8       ; R10 := R8
 69 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 70 [-]: TEST      R9 1         ; if R9 then PC := 91
 71 [-]: JMP       91           ; PC := 91
 72 [-]: SELF      R9 R8 K4     ; R10 := R8; R9 := R8[0xf2deaf69]
 73 [-]: GETGLOBAL R11 K9       ; R11 := gLightType
 74 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
 75 [-]: TEST      R9 0         ; if not R9 then PC := 81
 76 [-]: JMP       81           ; PC := 81
 77 [-]: SELF      R9 R8 K10    ; R10 := R8; R9 := R8[0xa3927fe9]
 78 [-]: MOVE      R11 R2       ; R11 := R2
 79 [-]: CALL      R9 3 1       ; R9(R10,R11)
 80 [-]: JMP       91           ; PC := 91
 81 [-]: SELF      R9 R8 K4     ; R10 := R8; R9 := R8[0xf2deaf69]
 82 [-]: GETGLOBAL R11 K19      ; R11 := gParticleSysType
 83 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
 84 [-]: TEST      R9 0         ; if not R9 then PC := 87
 85 [-]: JMP       87           ; PC := 87
 86 [-]: JMP       91           ; PC := 91
 ...
 91 [-]: FORLOOP   R4 66        ; R4 += R6; if R4 <= R5 then begin PC := 66; R7 := R4 end
...
; Max Stack Size:  19
 ...
 32 [-]: GETTABLE  R2 R2 K8     ; R2 := R2[0xc2938d8b]
 33 [-]: MOVE      R3 R0        ; R3 := R0
 34 [-]: MOVE      R4 R1        ; R4 := R1
 ...
 42 [-]: GETTABLE  R6 R6 K11    ; R6 := R6[0xc06cb5e5]
 43 [-]: MOVE      R7 R0        ; R7 := R0
...
; Max Stack Size:  17
 ...
 17 [-]: GETTABLE  R1 R1 K4     ; R1 := R1[0xe82b9b03]
 18 [-]: MOVE      R2 R0        ; R2 := R0
 ...
 54 [-]: GETTABLE  R12 R12 K13  ; R12 := R12[0x3eda26fc]
 ...
 75 [-]: GETTABLE  R12 R12 K19  ; R12 := R12[0xb62ecfe0]
...
; Max Stack Size:  19
 ...
 83 [-]: GETTABLE  R14 R14 K18  ; R14 := R14[0xb72a399c]
...
128 [-]: GETTABLE  R14 R14 K18  ; R14 := R14[0xb72a399c]
