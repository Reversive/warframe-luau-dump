...
L 0:  40 [-]: GETIMPORT R8 33; var8 = 0x07E9D557
      41 [-]: JUMPIFNOTLT R1 R8 L20; goto L20 if var1 >= var2295841
      42 [-]: GETIMPORT R8 35; var8 = 0x7D813E5D
      43 [-]: JUMPIFNOTLT R1 R8 L4; goto L4 if var1 >= var2426913
      ...
      52 [-]: JUMPIFNOTEQ R8 R11 L1; goto L1 if var8 ~= var168362558
...
L 4:  73 [-]: GETIMPORT R8 49; var8 = 0xD8E0B159
      74 [-]: JUMPIFNOTLT R1 R8 L8; goto L8 if var1 >= var3344417
      ...
      83 [-]: JUMPIFNOTEQ R8 R11 L5; goto L5 if var8 ~= var168362814
...
L 8: 103 [-]: GETIMPORT R8 49; var8 = 0xD8E0B159
     104 [-]: JUMPIFNOTLT R8 R1 L9; goto L9 if var8 >= var3605281
...
L 9: 110 [-]: GETIMPORT R8 59; var8 = 0x8CC0DD84
     111 [-]: JUMPIFNOTLT R1 R8 L19; goto L19 if var1 >= var3999777
     ...
     123 [-]: JUMPIFNOTEQ R8 R11 L10; goto L10 if var8 ~= var168363070
...
L12: 138 [-]: MOVE R8 R1   ; var8 = var1
     ...
     147 [-]: JUMPIFNOTEQ R8 R11 L13; goto L13 if var8 ~= var168363326
...
L15: 162 [-]: MOVE R8 R1   ; var8 = var1
     ...
     171 [-]: JUMPIFNOTEQ R8 R11 L16; goto L16 if var8 ~= var168363582
