...
L 0:   5 [-]: JUMPIFNOT R1 L1
      ...
      15 [-]: CALL R1 4 0  
      16 [-]: RETURN R0 0  
L 1:  17 [-]: GETIMPORT R1 9 [0xCFC01047]
      18 [-]: GETUPVAL R4 0
...
L 3:  18 [-]: JUMPIFNOT R2 L4
      ...
      26 [-]: CALL R2 4 0  
      27 [-]: RETURN R0 0  
L 4:  28 [-]: GETIMPORT R2 9 [0xCFC01047]
      29 [-]: GETUPVAL R5 0
...
L 1:   6 [-]: NAMECALL R2 R1 K2 [0x5E651723]
      ...
      13 [-]: CALL R2 1 1  
      14 [-]: GETIMPORT R3 9 ["VoidEclipseAvatarEnterDaxBuffAreaCount"]
      15 [-]: JUMPIF R3 L2 
      16 [-]: GETIMPORT R3 10 ["_T"]
      17 [-]: NEWTABLE R4 0 0
      18 [-]: SETTABLEKS R4 R3 K8 ["VoidEclipseAvatarEnterDaxBuffAreaCount"]
L 2:  19 [-]: GETIMPORT R4 9 ["VoidEclipseAvatarEnterDaxBuffAreaCount"]
      20 [-]: GETTABLE R3 R4 R2
      21 [-]: JUMPIF R3 L3 
      22 [-]: GETIMPORT R3 9 ["VoidEclipseAvatarEnterDaxBuffAreaCount"]
      23 [-]: LOADN R4 0   
      24 [-]: SETTABLE R4 R3 R2
L 3:  25 [-]: GETIMPORT R4 9 ["VoidEclipseAvatarEnterDaxBuffAreaCount"]
      26 [-]: GETTABLE R3 R4 R2
      27 [-]: GETIMPORT R4 12 [0xE618A3D8]
      28 [-]: JUMPIFNOTLT R3 R4 L4
      29 [-]: GETIMPORT R3 14 ["ShowImpactMessage"]
      30 [-]: GETIMPORT R4 16 [0x603636AD]
      ...
      35 [-]: LOADB R6 1   
      36 [-]: CALL R3 3 0  
      37 [-]: GETIMPORT R3 9 ["VoidEclipseAvatarEnterDaxBuffAreaCount"]
      38 [-]: GETIMPORT R6 9 ["VoidEclipseAvatarEnterDaxBuffAreaCount"]
      39 [-]: GETTABLE R5 R6 R2
      40 [-]: ADDK R4 R5 K18 [1]
      41 [-]: SETTABLE R4 R3 R2
L 4:  42 [-]: GETIMPORT R5 20 [0x1868EBA7]
      43 [-]: LOADB R6 0   
      44 [-]: LOADN R7 1   
      45 [-]: LOADB R8 0   
      46 [-]: NAMECALL R3 R1 K21 [0x659D451F]
      47 [-]: CALL R3 5 0  
L 5:  48 [-]: GETIMPORT R2 4 [0x89326C93]
      49 [-]: NAMECALL R2 R2 K22 [0x18D05D30]
      50 [-]: CALL R2 1 1  
      51 [-]: JUMPIF R2 L6 
      52 [-]: RETURN R0 0  
L 6:  53 [-]: GETIMPORT R2 24 ["ActiveVoidPocketsAvatars"]
      54 [-]: JUMPXEQKNIL R2 L7 NOT
      55 [-]: GETIMPORT R2 10 ["_T"]
      56 [-]: NEWTABLE R3 0 0
      57 [-]: SETTABLEKS R3 R2 K23 ["ActiveVoidPocketsAvatars"]
L 7:  58 [-]: GETIMPORT R3 24 ["ActiveVoidPocketsAvatars"]
...
L 1:   6 [-]: NAMECALL R2 R1 K2 [0x5E651723]
      ...
      12 [-]: GETIMPORT R4 7 [0x7112F0B5]
      13 [-]: LOADB R5 0   
      14 [-]: LOADN R6 1   
      15 [-]: LOADB R7 0   
      16 [-]: NAMECALL R2 R1 K8 [0x659D451F]
      17 [-]: CALL R2 5 0  
L 2:  18 [-]: GETIMPORT R2 4 [0x89326C93]
      19 [-]: NAMECALL R2 R2 K9 [0x18D05D30]
      20 [-]: CALL R2 1 1  
      21 [-]: JUMPIF R2 L3 
      22 [-]: RETURN R0 0  
L 3:  23 [-]: GETIMPORT R2 12 ["ActiveVoidPocketsAvatars"]
      24 [-]: JUMPXEQKNIL R2 L4 NOT
      25 [-]: GETIMPORT R2 13 ["_T"]
      26 [-]: NEWTABLE R3 0 0
      27 [-]: SETTABLEKS R3 R2 K11 ["ActiveVoidPocketsAvatars"]
L 4:  28 [-]: GETIMPORT R2 15 [0xCFC01047]
      29 [-]: GETIMPORT R3 12 ["ActiveVoidPocketsAvatars"]
      30 [-]: CALL R2 1 3  
...
L 1:   9 [-]: JUMPIF R1 L2 
      ...
      16 [-]: CALL R1 1 0  
      17 [-]: JUMPBACK L0  
L 2:  18 [-]: GETIMPORT R1 12 ["ActiveVoidPocketsAvatars"]
      19 [-]: JUMPXEQKNIL R1 L5
      20 [-]: GETIMPORT R1 14 [0xFFF641AF]
      21 [-]: CALL R1 0 1  
      22 [-]: GETIMPORT R2 16 [0xCFC01047]
      23 [-]: GETIMPORT R3 12 ["ActiveVoidPocketsAvatars"]
      24 [-]: CALL R2 1 3  
...
L 5:  40 [-]: GETIMPORT R1 9 [0xCBD666E1]
      41 [-]: LOADN R2 0   
      42 [-]: CALL R1 1 0  
      43 [-]: JUMPBACK L2  
      44 [-]: RETURN R0 0  
