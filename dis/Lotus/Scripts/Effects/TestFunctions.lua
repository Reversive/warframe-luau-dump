...
; Max Stack Size:  8
       ...
       4 [-]: CALL R1 1 0  
L 0:   5 [-]: LOADNIL R1   
       6 [-]: GETIMPORT R2 6 [0x60186FCA]
       7 [-]: JUMPIFNOT R2 L1
       8 [-]: GETIMPORT R2 8 [0x89326C93]
       9 [-]: GETIMPORT R4 10 [0x2526E821]
      10 [-]: NAMECALL R5 R0 K11 [0xD1586535]
      11 [-]: CALL R5 1 1  
      12 [-]: LOADN R6 0   
      13 [-]: GETIMPORT R7 13 [0xF4C4639B]
      14 [-]: NAMECALL R2 R2 K14 [0x462C251C]
      15 [-]: CALL R2 5 1  
      16 [-]: MOVE R1 R2   
      17 [-]: JUMP L2
     
L 1:  18 [-]: GETIMPORT R2 8 [0x89326C93]
      19 [-]: GETIMPORT R4 10 [0x2526E821]
...
L 3:  27 [-]: GETTABLE R6 R1 R4
      ...
      29 [-]: GETIMPORT R5 17 [0x7B998233]
      30 [-]: CALL R5 1 1  
L 4:  31 [-]: JUMPIF R5 L5 
      32 [-]: GETTABLE R5 R1 R4
      33 [-]: NAMECALL R5 R5 K18 [0x1DB57C6B]
      34 [-]: CALL R5 1 0  
L 5:  35 [-]: GETIMPORT R5 4 [0xCBD666E1]
      36 [-]: LOADN R6 0   
      37 [-]: CALL R5 1 0  
      38 [-]: FORNLOOP R2 L3
L 6:  39 [-]: RETURN R0 0  
...
L 4:  31 [-]: JUMPIF R5 L5 
      32 [-]: GETTABLE R5 R1 R4
      33 [-]: GETIMPORT R7 19 [0x6BDD0BDF]
      34 [-]: GETIMPORT R8 21 ["EMPTY_SYMBOL"]
      35 [-]: GETIMPORT R9 23 ["ZERO_VECTOR"]
      36 [-]: GETIMPORT R10 25 ["ZERO_ROTATION"]
      37 [-]: NAMECALL R5 R5 K26 [0x47901F07]
      38 [-]: CALL R5 5 0  
L 5:  39 [-]: GETIMPORT R5 4 [0xCBD666E1]
      40 [-]: LOADN R6 0   
      41 [-]: CALL R5 1 0  
      42 [-]: FORNLOOP R2 L3
L 6:  43 [-]: RETURN R0 0  
...
L 4:  31 [-]: JUMPIF R5 L5 
      ...
      35 [-]: CALL R5 2 0  
L 5:  36 [-]: GETIMPORT R5 4 [0xCBD666E1]
      37 [-]: LOADN R6 0   
      38 [-]: CALL R5 1 0  
      39 [-]: FORNLOOP R2 L3
L 6:  40 [-]: RETURN R0 0  
