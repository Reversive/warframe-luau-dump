...
L 1:  11 [-]: JUMPIF R8 L2 ; goto L2 if var8
      ...
      14 [-]: JUMPIFNOTEQ R8 R1 L2; goto L2 if var8 ~= var-1241053115
...
; Max Stack Size:  20
      ...
      29 [-]: LOADK R4 K4  ; var4 = 0.10000000000000001
      30 [-]: LOADK R5 K5  ; var5 = 0.59999999999999998
      31 [-]: CALL R3 3 2  ; var3 = var3(var4, var5)
      32 [-]: GETIMPORT R4 3; var4 = 0xC163F229
      33 [-]: LOADK R5 K4  ; var5 = 0.10000000000000001
      34 [-]: LOADK R6 K5  ; var6 = 0.59999999999999998
...
L 4:  70 [-]: JUMPIF R9 L14; goto L14 if var9
      ...
      72 [-]: JUMPIFNOTLT R9 R5 L14; goto L14 if var9 >= var84219215
...
L 5:  78 [-]: GETIMPORT R11 22; var11 = 0xF7F90318
      ...
      81 [-]: MULK R12 R13 K23; var12 = var13 * 0.20000000000000001
      ...
      89 [-]: MULK R15 R16 K23; var15 = var16 * 0.20000000000000001
      ...
      97 [-]: MULK R14 R15 K23; var14 = var15 * 0.20000000000000001
      98 [-]: CALL R13 2 2 ; var13 = var13(var14)
      99 [-]: MUL R12 R13 R9; var12 = var13 * var9
     100 [-]: LOADN R13 0  ; var13 = 0
     101 [-]: JUMPIFNOTLT R13 R3 L6; goto L6 if var13 >= var69454
...
L 6: 113 [-]: LOADN R13 0  ; var13 = 0
     114 [-]: JUMPIFNOTLT R13 R4 L7; goto L7 if var13 >= var69454
...
L 7: 126 [-]: JUMPIFNOTLT R5 R3 L10; goto L10 if var5 >= var68942
...
L10: 142 [-]: JUMPIFNOTLT R5 R4 L13; goto L13 if var5 >= var68942
...
L13: 158 [-]: GETIMPORT R14 36; var14 = 0x67652851
     ...
     160 [-]: MULK R13 R14 K34; var13 = var14 * 0.34999999999999998
