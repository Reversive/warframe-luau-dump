...
; Max Stack Size:  12
       ...
       8 [-]: CALL R2 1 1  
L 0:   9 [-]: JUMPIF R2 L1 
      10 [-]: GETIMPORT R2 7 [0x0F1F9FDD]
      11 [-]: JUMPIF R2 L2 
L 1:  12 [-]: RETURN R0 0  
L 2:  13 [-]: LOADNIL R2   
      14 [-]: LOADN R3 100 
      15 [-]: LOADB R4 0   
      16 [-]: GETIMPORT R5 7 [0x0F1F9FDD]
      17 [-]: JUMPIFNOT R5 L6
      18 [-]: GETIMPORT R7 9 ["gLotusWeaponAttachmentType"]
...
L 5:  41 [-]: LOADN R5 0   
      ...
      43 [-]: LOADN R3 1   
L 6:  44 [-]: GETIMPORT R5 17 [0xE82B9B03]
      45 [-]: MOVE R6 R0   
      46 [-]: CALL R5 1 0  
...
L 8:  51 [-]: JUMPIF R5 L14
      ...
      53 [-]: MOVE R6 R1   
      54 [-]: GETIMPORT R5 5 [0x7B998233]
      55 [-]: CALL R5 1 1  
L 9:  56 [-]: JUMPIF R5 L14
      57 [-]: GETIMPORT R5 7 [0x0F1F9FDD]
      58 [-]: JUMPIFNOT R5 L13
...
L12:  73 [-]: GETUPVAL R8 0
      ...
      78 [-]: CALL R6 3 0  
L13:  79 [-]: GETIMPORT R5 1 [0xCBD666E1]
      80 [-]: LOADN R6 0   
      81 [-]: CALL R5 1 0  
      82 [-]: JUMPBACK L7  
L14:  83 [-]: RETURN R0 0  
...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R1 1 [0xA5C4CE1E]
       1 [-]: JUMPXEQKN R1 K2 L0 NOT [1]
       2 [-]: GETUPVAL R1 0
       3 [-]: MOVE R2 R0   
       4 [-]: CALL R1 1 0  
       5 [-]: RETURN R0 0  
L 0:   6 [-]: GETIMPORT R1 1 [0xA5C4CE1E]
