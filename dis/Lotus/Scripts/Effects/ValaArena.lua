...
L 2:  19 [-]: GETIMPORT R2 7; var2 = 0xCBD666E1
      20 [-]: LOADK R3 K8  ; var3 = 3.5666666030883789
...
L 4:  26 [-]: JUMPIF R2 L5 ; goto L5 if var2
      ...
      28 [-]: JUMPIFNOTLT R2 R1 L5; goto L5 if var2 >= var197409
...
L 2:  46 [-]: JUMPIF R5 L3 ; goto L3 if var5
      ...
      62 [-]: LOADK R9 K27 ; var9 = 0.10000000149011612
...
L 9:  85 [-]: LOADN R11 195; var11 = 195
      86 [-]: JUMPIFNOTLT R11 R8 L10; goto L10 if var11 >= var774
...
L11:  77 [-]: JUMPIF R13 L12; goto L12 if var13
      ...
      79 [-]: LOADK R17 K26; var17 = 0.10000000149011612
...
L14:  89 [-]: JUMPIF R9 L16; goto L16 if var9
      90 [-]: MULK R13 R7 K31; var13 = var7 * 2
      91 [-]: MULK R12 R13 K30; var12 = var13 * 3.1415927410125732
      92 [-]: FASTCALL1 24 R12 L15; 
      93 [-]: GETIMPORT R11 34; var11 = 0x5BCED4C4[0x3EDA26FC]
      94 [-]: CALL R11 2 2 ; var11 = var11(var12)
L15:  95 [-]: MULK R10 R11 K29; var10 = var11 * 0.5
      96 [-]: ADDK R9 R10 K29; var9 = var10 + 0.5
      97 [-]: GETIMPORT R12 36; var12 = 0x5DB3CE80
      98 [-]: MOVE R13 R4  ; var13 = var4
      99 [-]: MOVE R14 R6  ; var14 = var6
     100 [-]: LOADN R16 1  ; var16 = 1
     101 [-]: SUB R15 R16 R9; var15 = var16 - var9
     102 [-]: CALL R12 4 0 ; var12, ... = var12(var13, var14, var15)
     103 [-]: NAMECALL R10 R3 K37; var11 = var3; var10 = var3[0x9307AA51]
     104 [-]: CALL R10 0 1 ; var10(var11, ...)
     105 [-]: GETIMPORT R11 40; var11 = 0x67652851
     106 [-]: CALL R11 1 2 ; var11 = var11()
     107 [-]: MULK R10 R11 K38; var10 = var11 * 0.019999999552965164
     108 [-]: ADD R7 R7 R10; var7 = var7 + var10
     109 [-]: LOADN R10 1  ; var10 = 1
     110 [-]: JUMPIFNOTLT R10 R7 L16; goto L16 if var10 >= var453445378
     111 [-]: SUBK R7 R7 K27; var7 = var7 - 1
L16: 112 [-]: GETIMPORT R9 1; var9 = 0xCBD666E1
