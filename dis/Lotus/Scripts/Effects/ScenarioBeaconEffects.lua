...
L 5:  34 [-]: MULK R14 R7 K22; var14 = var7 * 1
      35 [-]: LOADK R15 K23; var15 = 3.1415927410125732
      36 [-]: DIV R13 R14 R15; var13 = var14 / var15
      37 [-]: MULK R14 R2 K24; var14 = var2 * 0.40000000000000002
      38 [-]: ADD R12 R13 R14; var12 = var13 + var14
      39 [-]: FASTCALL1 24 R12 L6; 
      40 [-]: GETIMPORT R11 27; var11 = 0x5BCED4C4[0x3EDA26FC]
      41 [-]: CALL R11 2 2 ; var11 = var11(var12)
L 6:  42 [-]: MULK R10 R11 K21; var10 = var11 * 30
      43 [-]: SUBK R9 R10 K21; var9 = var10 - 30
      44 [-]: SETTABLEKS R9 R3 K28; var9["pitch"] = var3
      45 [-]: GETIMPORT R11 30; var11 = ZERO_VECTOR
      46 [-]: MOVE R12 R3  ; var12 = var3
      47 [-]: NAMECALL R9 R8 K31; var10 = var8; var9 = var8[0xE28AA928]
      48 [-]: CALL R9 4 1  ; var9(var10, var11, var12)
L 7:  49 [-]: FORGLOOP R4 L5 2 [inext]; 
      50 [-]: GETIMPORT R4 4; var4 = 0xCBD666E1
      51 [-]: LOADN R5 0   ; var5 = 0
      52 [-]: CALL R4 2 1  ; var4(var5)
      53 [-]: GETIMPORT R4 33; var4 = 0x67652851
      54 [-]: CALL R4 1 2  ; var4 = var4()
      55 [-]: ADD R2 R2 R4 ; var2 = var2 + var4
...
L25: 198 [-]: LOADN R11 1  ; var11 = 1
     199 [-]: JUMPIFNOTLT R10 R11 L30; goto L30 if var10 >= var3607374
...
L 6:  31 [-]: JUMPIF R5 L7 ; goto L7 if var5
      ...
      33 [-]: JUMPIFNOTLT R5 R3 L7; goto L7 if var5 >= var50595630
      ...
      39 [-]: MULK R5 R6 K14; var5 = var6 * 0.40000000000000002
