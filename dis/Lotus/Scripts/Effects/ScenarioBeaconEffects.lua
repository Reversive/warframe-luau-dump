...
; Max Stack Size:  16
       ...
       5 [-]: LOADN R2 1   
       6 [-]: CALL R1 1 0  
L 0:   7 [-]: GETIMPORT R3 6 [0xD262C28D]
...
L 2:  17 [-]: NEWTABLE R1 0 0
      18 [-]: GETIMPORT R4 6 [0xD262C28D]
      19 [-]: GETIMPORT R5 12 ["EMPTY_SYMBOL"]
      20 [-]: NAMECALL R2 R0 K13 [0x47901F07]
      21 [-]: CALL R2 3 1  
      22 [-]: FASTCALL2 52 R1 R2 L3
      23 [-]: MOVE R4 R1   
      24 [-]: MOVE R5 R2   
      25 [-]: GETIMPORT R3 16 [0x23D5322F]
      26 [-]: CALL R3 2 0  
L 3:  27 [-]: LOADN R2 0   
      28 [-]: GETIMPORT R3 18 [0x00046924]
      29 [-]: CALL R3 0 1  
L 4:  30 [-]: GETIMPORT R4 20 [0xC8802016]
      31 [-]: MOVE R5 R1   
      32 [-]: CALL R4 1 3  
...
L 5:  34 [-]: MULK R14 R7 K22 [1]
      ...
      40 [-]: GETIMPORT R11 27 [0x3EDA26FC]
      41 [-]: CALL R11 1 1 
...
L 7:  49 [-]: FORGLOOP R4 L5 2 [inext]
      50 [-]: GETIMPORT R4 4 [0xCBD666E1]
      51 [-]: LOADN R5 0   
      52 [-]: CALL R4 1 0  
      53 [-]: GETIMPORT R4 33 [0x67652851]
      54 [-]: CALL R4 0 1  
      55 [-]: ADD R2 R2 R4 
      56 [-]: JUMPBACK L4  
      57 [-]: RETURN R0 0  
...
; Max Stack Size:  27
       ...
       2 [-]: LOADNIL R2   
       3 [-]: LOADNIL R3   
       4 [-]: GETIMPORT R5 3 ["CondrixExplicitSource"]
       5 [-]: FASTCALL1 62 R5 L0
       6 [-]: GETIMPORT R4 5 [0x7B998233]
       7 [-]: CALL R4 1 1  
L 0:   8 [-]: JUMPIF R4 L1 
       9 [-]: GETIMPORT R2 3 ["CondrixExplicitSource"]
      10 [-]: GETIMPORT R3 7 ["CondrixExplicitSourceBone"]
      11 [-]: GETIMPORT R4 8 ["_T"]
      12 [-]: LOADNIL R5   
      13 [-]: SETTABLEKS R5 R4 K2 ["CondrixExplicitSource"]
      14 [-]: JUMP L2
     
L 1:  15 [-]: GETIMPORT R4 10 [0xEAA94B86]
      16 [-]: NAMECALL R4 R4 K11 [0x56C01834]
      17 [-]: CALL R4 1 1  
      18 [-]: JUMPIFNOT R4 L2
      19 [-]: GETIMPORT R4 13 [0x89326C93]
      20 [-]: GETIMPORT R6 10 [0xEAA94B86]
      21 [-]: MOVE R7 R1   
      22 [-]: LOADN R8 0   
      23 [-]: LOADN R9 70  
...
L 3:  32 [-]: JUMPIFNOT R5 L4
      33 [-]: GETIMPORT R5 13 [0x89326C93]
      34 [-]: GETIMPORT R7 16 [0x0469F296]
...
L 4:  43 [-]: FASTCALL1 62 R2 L5
      44 [-]: MOVE R6 R2   
      45 [-]: GETIMPORT R5 5 [0x7B998233]
      46 [-]: CALL R5 1 1  
L 5:  47 [-]: JUMPIFNOT R5 L7
      48 [-]: GETIMPORT R5 13 [0x89326C93]
      49 [-]: GETIMPORT R7 16 [0x0469F296]
...
L 6:  62 [-]: JUMPIFNOT R5 L7
      63 [-]: GETIMPORT R5 20 [0xA421AF95]
      64 [-]: GETIMPORT R6 22 [0x55730E1A]
      65 [-]: LOADN R7 -1  
      66 [-]: LOADN R8 1   
      67 [-]: CALL R6 2 1  
      68 [-]: GETIMPORT R7 22 [0x55730E1A]
      69 [-]: LOADN R8 10  
      70 [-]: LOADN R9 15  
      71 [-]: CALL R7 2 1  
      72 [-]: GETIMPORT R8 22 [0x55730E1A]
      73 [-]: LOADN R9 -1  
      74 [-]: LOADN R10 1  
      75 [-]: CALL R8 2 -1 
      76 [-]: CALL R5 -1 1 
...
L11:  94 [-]: NAMECALL R5 R2 K0 [0xD1586535]
      95 [-]: CALL R5 1 1  
      96 [-]: MOVE R4 R5   
L12:  97 [-]: GETIMPORT R5 25 [0x20B7F774]
      98 [-]: MOVE R6 R4   
      99 [-]: MOVE R7 R1   
     100 [-]: CALL R5 2 1  
     101 [-]: LOADN R6 0   
     102 [-]: SETTABLEKS R6 R5 K26 ["pitch"]
     103 [-]: GETIMPORT R6 28 [0xE6BD96F0]
     ...
     110 [-]: CALL R7 2 1  
     111 [-]: GETIMPORT R8 31 [0x492C7F2A]
     112 [-]: GETIMPORT R9 33 [0xC4CE3AE3]
     113 [-]: MOVE R10 R7  
     114 [-]: CALL R8 2 1  
     115 [-]: GETIMPORT R9 25 [0x20B7F774]
     116 [-]: GETIMPORT R10 35 ["ZERO_VECTOR"]
     117 [-]: MOVE R11 R8  
     118 [-]: CALL R9 2 1  
     119 [-]: MOVE R5 R9   
L13: 120 [-]: LOADNIL R6   
     121 [-]: GETIMPORT R7 37 [0xE30103C3]
     122 [-]: JUMPIFNOT R7 L14
     123 [-]: GETIMPORT R9 39 [0x14022392]
     124 [-]: GETIMPORT R10 41 ["EMPTY_SYMBOL"]
     125 [-]: GETIMPORT R11 35 ["ZERO_VECTOR"]
     126 [-]: MOVE R12 R5  
...
L14: 131 [-]: GETIMPORT R7 13 [0x89326C93]
     132 [-]: GETIMPORT R9 39 [0x14022392]
     133 [-]: MOVE R10 R4  
     134 [-]: MOVE R11 R5  
...
L17: 146 [-]: NEWTABLE R7 0 0
     147 [-]: GETIMPORT R8 20 [0xA421AF95]
     148 [-]: CALL R8 0 1  
     149 [-]: NEWTABLE R9 0 0
     150 [-]: GETIMPORT R11 46 [0xB6DC0F20]
     151 [-]: FASTCALL1 62 R11 L18
     152 [-]: GETIMPORT R10 5 [0x7B998233]
     153 [-]: CALL R10 1 1 
...
L19: 159 [-]: GETIMPORT R13 13 [0x89326C93]
     160 [-]: GETIMPORT R15 46 [0xB6DC0F20]
     161 [-]: MOVE R16 R4  
     162 [-]: GETIMPORT R17 48 ["ZERO_ROTATION"]
...
L20: 169 [-]: JUMPIF R14 L22
     ...
     171 [-]: MOVE R15 R9  
     172 [-]: MOVE R16 R13 
     173 [-]: GETIMPORT R14 51 [0x23D5322F]
     174 [-]: CALL R14 2 0 
L21: 175 [-]: GETIMPORT R14 20 [0xA421AF95]
     176 [-]: GETIMPORT R15 53 [0xC163F229]
     177 [-]: LOADN R16 -4 
     178 [-]: LOADN R17 4  
     179 [-]: CALL R15 2 1 
     180 [-]: GETIMPORT R16 53 [0xC163F229]
     181 [-]: LOADN R17 -2 
     182 [-]: LOADN R18 4  
     183 [-]: CALL R16 2 1 
     184 [-]: GETIMPORT R17 53 [0xC163F229]
     185 [-]: LOADN R18 -4 
     186 [-]: LOADN R19 4  
     187 [-]: CALL R17 2 -1
     188 [-]: CALL R14 -1 1
     ...
     190 [-]: MOVE R16 R7  
     191 [-]: MOVE R17 R14 
     192 [-]: GETIMPORT R15 51 [0x23D5322F]
     193 [-]: CALL R15 2 0 
...
L25: 198 [-]: LOADN R11 1  
     ...
     200 [-]: GETIMPORT R11 55 [0xC8802016]
     201 [-]: MOVE R12 R9  
     202 [-]: CALL R11 1 3 
     203 [-]: FORGPREP_INEXT R11 L29
L26: 204 [-]: FASTCALL1 62 R15 L27
     205 [-]: MOVE R17 R15 
     206 [-]: GETIMPORT R16 5 [0x7B998233]
     207 [-]: CALL R16 1 1 
L27: 208 [-]: JUMPIF R16 L29
     209 [-]: GETIMPORT R16 57 [0x5DB3CE80]
     210 [-]: MOVE R17 R4  
     211 [-]: MOVE R18 R1  
     212 [-]: MOVE R19 R10 
     213 [-]: CALL R16 3 1 
     214 [-]: GETTABLE R18 R7 R14
     215 [-]: GETIMPORT R19 59 [0xA533083A]
     216 [-]: LOADN R21 1  
     217 [-]: LOADN R23 2  
     218 [-]: LOADK R26 K60 [0.5]
     219 [-]: SUB R25 R26 R10
     220 [-]: FASTCALL1 2 R25 L28
     221 [-]: GETIMPORT R24 63 [0xE4A5B3CA]
     222 [-]: CALL R24 1 1 
...
L29: 231 [-]: FORGLOOP R11 L26 2 [inext]
     232 [-]: GETIMPORT R12 67 [0x67652851]
     233 [-]: CALL R12 0 1 
     234 [-]: MULK R11 R12 K65 [2]
     235 [-]: ADD R10 R10 R11
     236 [-]: GETIMPORT R11 69 [0xCBD666E1]
     237 [-]: LOADN R12 0  
     238 [-]: CALL R11 1 0 
     239 [-]: JUMPBACK L25 
L30: 240 [-]: RETURN R0 0  
...
L 0:   6 [-]: JUMPIFNOT R2 L1
       7 [-]: RETURN R0 0  
L 1:   8 [-]: GETIMPORT R4 4 ["gRayMarchedFogVolumeType"]
...
L 2:  16 [-]: JUMPIFNOT R4 L3
      17 [-]: RETURN R0 0  
L 3:  18 [-]: GETIMPORT R6 7 ["gLotusAvatarType"]
      19 [-]: NAMECALL R4 R1 K8 [0xF2DEAF69]
      20 [-]: CALL R4 2 1  
      21 [-]: JUMPIFNOT R4 L4
      22 [-]: GETIMPORT R6 10 [0x59637D73]
