...
; Max Stack Size:  5
       ...
       3 [-]: LOADN R3 -600
       4 [-]: CALL R0 3 1  
L 0:   5 [-]: GETIMPORT R2 3 [0x0C498DD3]
...
L 2:  16 [-]: JUMPIF R1 L3 
      ...
      18 [-]: GETIMPORT R4 12 [0x67652851]
      19 [-]: CALL R4 0 1  
      20 [-]: MULK R3 R4 K10 [2]
      21 [-]: SUB R1 R2 R3 
      22 [-]: SETTABLEKS R1 R0 K9 ["z"]
      23 [-]: GETIMPORT R1 3 [0x0C498DD3]
      24 [-]: MOVE R3 R0   
...
L 0:   6 [-]: JUMPIFNOT R2 L1
       7 [-]: RETURN R0 0  
L 1:   8 [-]: GETIMPORT R4 4 [0x8E471DA2]
...
L 2:  25 [-]: GETTABLE R5 R1 R4
      ...
      27 [-]: CALL R5 1 0  
      28 [-]: FORNLOOP R2 L2
L 3:  29 [-]: GETIMPORT R2 1 [0x89326C93]
...
L 4:  39 [-]: GETTABLE R6 R2 R5
      ...
      41 [-]: CALL R6 1 0  
      42 [-]: FORNLOOP R3 L4
L 5:  43 [-]: GETIMPORT R3 1 [0x89326C93]
      44 [-]: GETIMPORT R5 3 [0x0469F296]
...
L 0:  16 [-]: GETTABLE R5 R1 R4
      ...
      18 [-]: CALL R5 1 0  
      19 [-]: FORNLOOP R2 L0
L 1:  20 [-]: GETIMPORT R2 1 [0x89326C93]
      21 [-]: GETIMPORT R4 3 [0x0469F296]
...
L 2:  30 [-]: GETTABLE R6 R2 R5
      ...
      32 [-]: CALL R6 1 0  
      33 [-]: FORNLOOP R3 L2
L 3:  34 [-]: GETIMPORT R3 1 [0x89326C93]
      35 [-]: GETIMPORT R5 3 [0x0469F296]
...
L 4:  44 [-]: GETTABLE R7 R3 R6
      ...
      46 [-]: CALL R7 1 0  
      47 [-]: FORNLOOP R4 L4
L 5:  48 [-]: GETIMPORT R4 1 [0x89326C93]
      49 [-]: GETIMPORT R6 3 [0x0469F296]
...
L 8:  66 [-]: FASTCALL1 62 R4 L9
      67 [-]: MOVE R7 R4   
      68 [-]: GETIMPORT R6 15 [0x7B998233]
      69 [-]: CALL R6 1 1  
L 9:  70 [-]: JUMPIF R6 L10
L10:  71 [-]: GETIMPORT R6 17 [0xCBD666E1]
      72 [-]: LOADN R7 0   
      73 [-]: CALL R6 1 0  
      74 [-]: GETIMPORT R7 20 [0x67652851]
      75 [-]: CALL R7 0 1  
...
L 0:  11 [-]: FASTCALL1 62 R0 L1
      ...
      14 [-]: CALL R2 1 1  
L 1:  15 [-]: JUMPIF R2 L5 
      16 [-]: GETIMPORT R2 3 [0xCBD666E1]
      17 [-]: GETIMPORT R3 5 [0xC163F229]
      18 [-]: LOADN R4 1   
      19 [-]: LOADN R5 3   
      20 [-]: CALL R3 2 -1 
      21 [-]: CALL R2 -1 0 
      22 [-]: GETIMPORT R2 9 [0xA421AF95]
      23 [-]: GETTABLEKS R3 R1 K10 ["x"]
      24 [-]: GETTABLEKS R4 R1 K11 ["y"]
      25 [-]: GETTABLEKS R5 R1 K12 ["z"]
      26 [-]: CALL R2 3 1  
      27 [-]: GETTABLEKS R4 R2 K10 ["x"]
      28 [-]: GETIMPORT R5 5 [0xC163F229]
      29 [-]: LOADN R6 -30 
      30 [-]: LOADN R7 30  
      31 [-]: CALL R5 2 1  
      32 [-]: ADD R3 R4 R5 
...
L 2:  56 [-]: LOADN R5 1   
      ...
      66 [-]: MOVE R8 R5   
      67 [-]: GETIMPORT R7 20 [0xE4A5B3CA]
      68 [-]: CALL R7 1 1  
L 3:  69 [-]: SUB R5 R6 R7 
      70 [-]: GETIMPORT R6 22 [0xA533083A]
      71 [-]: MOVE R7 R5   
      72 [-]: CALL R6 1 1  
      73 [-]: MOVE R5 R6   
      74 [-]: MOVE R8 R5   
