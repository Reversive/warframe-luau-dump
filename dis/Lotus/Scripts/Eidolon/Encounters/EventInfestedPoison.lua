...
L 0:  20 [-]: GETUPVAL R1 0
      ...
      27 [-]: CALL R1 3 0  
L 1:  28 [-]: GETIMPORT R1 11 [0x3D106989]
      29 [-]: LOADK R3 K12 ["EventInfestedPoison.lua::SetModeState - New State: "]
      30 [-]: GETUPVAL R4 0
      31 [-]: CONCAT R2 R3 R4
      32 [-]: CALL R1 1 0  
      33 [-]: RETURN R0 0  
L 2:  34 [-]: GETIMPORT R1 11 [0x3D106989]
...
; Max Stack Size:  7
      ...
      66 [-]: CALL R5 1 1  
      67 [-]: GETIMPORT R6 28 ["ZERO_ROTATION"]
      ...
      74 [-]: CALL R2 2 0  
      75 [-]: GETUPVAL R2 14
      76 [-]: GETIMPORT R4 32 [0xB7CBD06B]
      77 [-]: LOADN R5 30  
      78 [-]: LOADN R6 5000
      79 [-]: CALL R4 2 -1 
      80 [-]: NAMECALL R2 R2 K33 [0x53BC0559]
      81 [-]: CALL R2 -1 0 
      82 [-]: GETIMPORT R2 4 [0x89326C93]
      83 [-]: GETIMPORT R4 20 [0x0469F296]
...
L 4:  28 [-]: NAMECALL R5 R0 K12 [0xF4E253B6]
      ...
      46 [-]: CALL R5 3 0  
      47 [-]: GETIMPORT R6 20 [0x5E0DADE6]
      48 [-]: FASTCALL1 62 R6 L5
      49 [-]: GETIMPORT R5 7 [0x7B998233]
      50 [-]: CALL R5 1 1  
L 5:  51 [-]: JUMPIF R5 L6 
      52 [-]: GETIMPORT R5 20 [0x5E0DADE6]
      53 [-]: NAMECALL R5 R5 K21 [0xA2880940]
      54 [-]: CALL R5 1 0  
L 6:  55 [-]: GETIMPORT R5 23 [0x89326C93]
...
L 3:  14 [-]: NAMECALL R2 R0 K6 [0xE86A236E]
      ...
      17 [-]: CALL R3 1 1  
      18 [-]: GETIMPORT R4 9 ["TransmissionSet"]
...
L 4:  23 [-]: JUMPIFNOT R5 L5
      ...
      25 [-]: CALL R5 1 1  
      26 [-]: MOVE R4 R5   
L 5:  27 [-]: GETIMPORT R5 12 [0x89326C93]
      ...
      51 [-]: CALL R5 1 1  
      52 [-]: GETIMPORT R6 12 [0x89326C93]
      53 [-]: MOVE R8 R5   
      54 [-]: NAMECALL R10 R0 K22 [0xD1586535]
      55 [-]: CALL R10 1 1 
      56 [-]: GETIMPORT R11 24 [0x0639523F]
      57 [-]: ADD R9 R10 R11
      58 [-]: GETIMPORT R10 26 ["ZERO_ROTATION"]
      ...
      64 [-]: CALL R7 -1 0 
      65 [-]: LOADNIL R7   
      66 [-]: GETIMPORT R8 31 ["AddHudTracker"]
...
L 6: 110 [-]: FASTCALL1 62 R0 L7
     111 [-]: MOVE R14 R0  
     112 [-]: GETIMPORT R13 1 [0x7B998233]
     113 [-]: CALL R13 1 1 
...
L 8: 119 [-]: JUMPIFNOT R13 L9
     120 [-]: GETIMPORT R13 49 ["GetHudTracker"]
     121 [-]: LOADK R14 K50 ["MissionTimer"]
     122 [-]: CALL R13 1 1 
     123 [-]: MOVE R7 R13  
L 9: 124 [-]: JUMPIF R11 L14
     125 [-]: GETIMPORT R13 52 [0xC8802016]
     126 [-]: GETUPVAL R14 0
     127 [-]: CALL R13 1 3 
...
L11: 135 [-]: JUMPIF R19 L13
     ...
     139 [-]: MOVE R21 R19 
     140 [-]: GETIMPORT R20 1 [0x7B998233]
     141 [-]: CALL R20 1 1 
L12: 142 [-]: JUMPIF R20 L13
     ...
     148 [-]: MOVE R21 R4  
     149 [-]: GETIMPORT R22 19 [0x0469F296]
...
L17: 172 [-]: GETIMPORT R13 59 [0xCBD666E1]
     173 [-]: LOADN R14 0  
     174 [-]: CALL R13 1 0 
     175 [-]: JUMPBACK L6  
...
L19: 180 [-]: JUMPIF R13 L20
     ...
     182 [-]: CALL R13 1 0 
L20: 183 [-]: GETIMPORT R13 62 ["RemoveHudTracker"]
     184 [-]: MOVE R14 R8  
     185 [-]: CALL R13 1 0 
...
L22: 204 [-]: JUMPIF R13 L23
     ...
     209 [-]: GETIMPORT R13 59 [0xCBD666E1]
     210 [-]: LOADN R14 0  
     211 [-]: CALL R13 1 0 
     212 [-]: JUMPBACK L21 
L23: 213 [-]: GETIMPORT R13 3 ["_T"]
     214 [-]: LOADB R14 0  
