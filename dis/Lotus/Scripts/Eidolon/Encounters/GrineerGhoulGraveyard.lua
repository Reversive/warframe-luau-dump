...
L 5:  29 [-]: GETIMPORT R4 6 [0x89326C93]
      30 [-]: GETIMPORT R6 8 [0x4302DE9F]
      31 [-]: MOVE R7 R1   
      32 [-]: LOADN R8 0   
      33 [-]: MULK R9 R2 K9 [1.5]
      34 [-]: NAMECALL R4 R4 K10 [0xFB669000]
      35 [-]: CALL R4 5 1  
      36 [-]: GETIMPORT R5 12 [0xC8802016]
      37 [-]: MOVE R6 R4   
      38 [-]: CALL R5 1 3  
...
L 6:  40 [-]: NAMECALL R10 R9 K13 [0x14A55974]
      ...
      43 [-]: MOVE R12 R10 
      44 [-]: GETIMPORT R11 2 [0x7B998233]
      45 [-]: CALL R11 1 1 
L 7:  46 [-]: JUMPIF R11 L8
      47 [-]: GETIMPORT R13 15 ["gEncounterHintType"]
...
L 0:   8 [-]: NAMECALL R2 R1 K7 [0xA2D83ED4]
      ...
      13 [-]: CALL R2 1 0  
      14 [-]: JUMPBACK L0  
L 1:  15 [-]: GETIMPORT R2 1 [0xD644C2F1]
...
L 2:  44 [-]: MULK R12 R7 K26 [0.75]
      ...
      49 [-]: CALL R14 3 1 
      50 [-]: GETIMPORT R15 30 ["_T"]
      51 [-]: SETTABLEKS R14 R15 K31 ["maxGhoulCount"]
      52 [-]: GETIMPORT R15 33 ["ghoulEventActive"]
      53 [-]: JUMPIF R15 L4
      54 [-]: GETIMPORT R15 35 [0x66BEFE0F]
      55 [-]: JUMPIF R15 L4
      56 [-]: MULK R16 R11 K36 [0.65000000000000002]
      57 [-]: FASTCALL1 7 R16 L3
      58 [-]: GETIMPORT R15 25 [0x99675E23]
      59 [-]: CALL R15 1 1 
L 3:  60 [-]: MOVE R11 R15 
L 4:  61 [-]: LOADNIL R15  
      62 [-]: LOADB R16 0  
      ...
      80 [-]: MOVE R15 R18 
      81 [-]: JUMPIF R2 L5 
      82 [-]: GETIMPORT R18 35 [0x66BEFE0F]
      83 [-]: JUMPIF R18 L5
      84 [-]: GETIMPORT R18 44 [0xC163F229]
      85 [-]: LOADN R19 0  
      86 [-]: LOADN R20 1  
      87 [-]: CALL R18 2 1 
      ...
      92 [-]: MOVE R19 R4  
      93 [-]: GETIMPORT R20 48 [0x0469F296]
...
L 6: 102 [-]: GETIMPORT R18 1 [0xD644C2F1]
     103 [-]: LOADK R19 K51 ["GRAVEYARD: Retrieved graves after migration"]
     104 [-]: CALL R18 1 0 
     105 [-]: MULK R18 R7 K52 [1.5]
     106 [-]: GETIMPORT R19 4 [0x89326C93]
     107 [-]: GETIMPORT R21 42 [0x4302DE9F]
     108 [-]: MOVE R22 R6  
     109 [-]: LOADN R23 0  
     110 [-]: MOVE R24 R18 
     ...
     112 [-]: CALL R19 5 1 
     113 [-]: MOVE R15 R19 
L 7: 114 [-]: GETIMPORT R18 55 [0xC8802016]
     115 [-]: MOVE R19 R15 
     116 [-]: CALL R18 1 3 
...
L 9: 124 [-]: FORGLOOP R18 L8 2 [inext]
     125 [-]: GETIMPORT R18 1 [0xD644C2F1]
...
L10: 138 [-]: GETIMPORT R18 35 [0x66BEFE0F]
     139 [-]: JUMPIF R18 L20
     140 [-]: LOADN R18 0  
     141 [-]: LOADB R19 0  
...
L11: 144 [-]: JUMPIF R19 L20
     145 [-]: GETIMPORT R21 4 [0x89326C93]
     146 [-]: NAMECALL R21 R21 K61 [0x8B5B1F58]
     147 [-]: CALL R21 1 1 
     148 [-]: LOADB R22 0  
     149 [-]: GETIMPORT R23 55 [0xC8802016]
     150 [-]: MOVE R24 R21 
     151 [-]: CALL R23 1 3 
     152 [-]: FORGPREP_INEXT R23 L16
L12: 153 [-]: FASTCALL1 62 R27 L13
     154 [-]: MOVE R29 R27 
     155 [-]: GETIMPORT R28 63 [0x7B998233]
     156 [-]: CALL R28 1 1 
...
L19: 179 [-]: GETIMPORT R23 9 [0xCBD666E1]
     180 [-]: LOADN R24 1  
     181 [-]: CALL R23 1 0 
     182 [-]: JUMPBACK L11 
L20: 183 [-]: JUMPIF R2 L21
     184 [-]: GETIMPORT R18 35 [0x66BEFE0F]
     185 [-]: JUMPIF R18 L21
     186 [-]: JUMPIF R16 L21
     187 [-]: GETIMPORT R18 44 [0xC163F229]
     188 [-]: LOADN R19 0  
     189 [-]: LOADN R20 1  
     190 [-]: CALL R18 2 1 
     ...
     195 [-]: MOVE R19 R4  
     196 [-]: GETIMPORT R20 48 [0x0469F296]
     197 [-]: LOADK R21 K68 ["GraveyardAttack"]
     198 [-]: CALL R20 1 -1
     199 [-]: CALL R18 -1 0
L21: 200 [-]: GETIMPORT R18 1 [0xD644C2F1]
...
L22: 212 [-]: NAMECALL R21 R0 K59 [0x4EC91A07]
     ...
     220 [-]: GETIMPORT R23 1 [0xD644C2F1]
...
L23: 224 [-]: NAMECALL R22 R5 K72 [0x39E33D94]
     ...
     227 [-]: MOVE R24 R19 
     228 [-]: MOVE R25 R22 
     229 [-]: GETIMPORT R23 74 [0xB62ECFE0]
     230 [-]: CALL R23 2 1 
...
L25: 248 [-]: NEWTABLE R23 0 0
     ...
     254 [-]: GETIMPORT R25 4 [0x89326C93]
     255 [-]: NAMECALL R25 R25 K61 [0x8B5B1F58]
     256 [-]: CALL R25 1 1 
     257 [-]: GETIMPORT R26 80 [0x55730E1A]
     258 [-]: LOADN R27 1  
     259 [-]: LENGTH R28 R25
     260 [-]: CALL R26 2 1 
     261 [-]: LENGTH R27 R25
     ...
     266 [-]: GETIMPORT R27 63 [0x7B998233]
     267 [-]: CALL R27 1 1 
...
L29: 289 [-]: JUMPIF R32 L31
     ...
     301 [-]: MOVE R34 R23 
     302 [-]: GETIMPORT R33 87 [0x23D5322F]
     303 [-]: CALL R33 2 0 
...
L31: 310 [-]: GETIMPORT R32 89 [0x9C1F3B5A]
     311 [-]: MOVE R33 R15 
     312 [-]: MOVE R34 R30 
     313 [-]: CALL R32 2 0 
     314 [-]: JUMP L33
    
L32: 315 [-]: GETIMPORT R31 89 [0x9C1F3B5A]
     316 [-]: MOVE R32 R15 
     317 [-]: MOVE R33 R30 
     318 [-]: CALL R31 2 0 
...
L34: 320 [-]: JUMPIFNOT R20 L39
     ...
     322 [-]: MOVE R28 R23 
     323 [-]: GETIMPORT R27 63 [0x7B998233]
     324 [-]: CALL R27 1 1 
L35: 325 [-]: JUMPIF R27 L36
     326 [-]: LENGTH R27 R23
     327 [-]: LOADN R28 0  
     328 [-]: JUMPIFNOTLT R28 R27 L36
     329 [-]: GETIMPORT R27 80 [0x55730E1A]
     330 [-]: LOADN R28 1  
     331 [-]: LENGTH R29 R23
     332 [-]: CALL R27 2 1 
     ...
     336 [-]: CALL R28 2 0 
     337 [-]: GETIMPORT R28 1 [0xD644C2F1]
...
L39: 365 [-]: GETTABLEKS R28 R24 K75 ["script"]
     ...
     367 [-]: GETIMPORT R27 63 [0x7B998233]
     368 [-]: CALL R27 1 1 
...
L43: 395 [-]: LOADN R23 3  
     ...
     397 [-]: CALL R21 2 0 
L44: 398 [-]: GETIMPORT R21 1 [0xD644C2F1]
...
; Max Stack Size:  11
       ...
       4 [-]: GETIMPORT R3 3 [0x4302DE9F]
       5 [-]: LOADN R4 4   
       6 [-]: GETIMPORT R5 5 [0x979453AC]
       7 [-]: MOVE R6 R1   
       8 [-]: GETIMPORT R7 7 [0x65F7971E]
       9 [-]: LOADB R8 1   
      10 [-]: LOADN R9 25  
      11 [-]: LOADN R10 2  
      12 [-]: CALL R2 8 1  
...
L 1:  30 [-]: GETUPVAL R14 1
      ...
      39 [-]: LOADN R21 2  
      40 [-]: CALL R13 8 1 
      41 [-]: GETIMPORT R14 23 [0xC8802016]
      42 [-]: MOVE R15 R13 
      43 [-]: CALL R14 1 3 
...
L 3:  51 [-]: FORGLOOP R14 L2 2 [inext]
      52 [-]: JUMPIF R1 L4 
      53 [-]: GETIMPORT R14 27 [0xC163F229]
      54 [-]: LOADN R15 0  
      55 [-]: LOADN R16 1  
      56 [-]: CALL R14 2 1 
      ...
      61 [-]: MOVE R15 R3  
      62 [-]: GETIMPORT R16 31 [0x0469F296]
...
L 5:  70 [-]: NAMECALL R15 R0 K34 [0xD9531187]
      71 [-]: CALL R15 1 1 
      72 [-]: JUMPIF R15 L22
      73 [-]: GETIMPORT R15 36 [0x89326C93]
      74 [-]: NAMECALL R15 R15 K37 [0x8B5B1F58]
      75 [-]: CALL R15 1 1 
      76 [-]: LOADB R16 0  
      77 [-]: GETIMPORT R17 23 [0xC8802016]
      78 [-]: MOVE R18 R15 
      79 [-]: CALL R17 1 3 
      80 [-]: FORGPREP_INEXT R17 L8
L 6:  81 [-]: FASTCALL1 62 R21 L7
      82 [-]: MOVE R23 R21 
      83 [-]: GETIMPORT R22 39 [0x7B998233]
      84 [-]: CALL R22 1 1 
...
L11: 101 [-]: DUPTABLE R17 44
     ...
     106 [-]: GETIMPORT R18 36 [0x89326C93]
     107 [-]: NAMECALL R18 R18 K37 [0x8B5B1F58]
     108 [-]: CALL R18 1 1 
     109 [-]: GETIMPORT R19 47 [0x55730E1A]
     110 [-]: LOADN R20 1  
     111 [-]: LENGTH R21 R18
     112 [-]: CALL R19 2 1 
     113 [-]: LENGTH R20 R18
     ...
     118 [-]: GETIMPORT R20 39 [0x7B998233]
     119 [-]: CALL R20 1 1 
...
L16: 155 [-]: GETIMPORT R25 54 [0x9C1F3B5A]
     156 [-]: MOVE R26 R13 
     157 [-]: MOVE R27 R23 
     158 [-]: CALL R25 2 0 
     159 [-]: JUMP L18
    
L17: 160 [-]: GETIMPORT R24 54 [0x9C1F3B5A]
     161 [-]: MOVE R25 R13 
     162 [-]: MOVE R26 R23 
     163 [-]: CALL R24 2 0 
...
L19: 165 [-]: GETTABLEKS R21 R17 K42 ["script"]
     ...
     167 [-]: GETIMPORT R20 39 [0x7B998233]
     168 [-]: CALL R20 1 1 
...
L21: 174 [-]: ADDK R14 R14 K57 [1.5]
     175 [-]: GETIMPORT R17 59 [0xCBD666E1]
