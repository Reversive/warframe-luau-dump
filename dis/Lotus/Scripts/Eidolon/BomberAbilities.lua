...
; Max Stack Size:  14
       ...
       3 [-]: JUMPIF R1 L0 
       4 [-]: RETURN R0 0  
L 0:   5 [-]: GETIMPORT R2 4 [0x6A4D2884]
       6 [-]: FASTCALL1 62 R2 L1
       7 [-]: GETIMPORT R1 6 [0x7B998233]
       8 [-]: CALL R1 1 1  
L 1:   9 [-]: JUMPIF R1 L4 
      10 [-]: GETIMPORT R3 4 [0x6A4D2884]
...
L 4:  21 [-]: NAMECALL R1 R0 K9 [0xFA9E477F]
      ...
      27 [-]: RETURN R0 0  
L 5:  28 [-]: GETIMPORT R4 12 [0x105D9429]
      29 [-]: LOADB R5 1   
      30 [-]: NAMECALL R2 R0 K13 [0x003C792F]
      31 [-]: CALL R2 3 1  
      32 [-]: GETIMPORT R5 15 [0xC556BF30]
      33 [-]: LOADB R6 1   
      34 [-]: NAMECALL R3 R0 K16 [0xEA0832EA]
      35 [-]: CALL R3 3 1  
      36 [-]: GETIMPORT R4 18 [0x6D811B71]
      37 [-]: JUMPIF R4 L6 
      38 [-]: GETIMPORT R4 1 [0x89326C93]
      39 [-]: GETIMPORT R6 20 [0x945F9957]
      40 [-]: MOVE R7 R2   
      41 [-]: MOVE R8 R3   
      42 [-]: NAMECALL R4 R4 K21 [0x05909209]
      43 [-]: CALL R4 4 0  
L 6:  44 [-]: LOADN R6 1   
      45 [-]: GETIMPORT R4 23 [0x08EC01EA]
      46 [-]: LOADN R5 1   
      47 [-]: FORNPREP R4 L16
L 7:  48 [-]: GETIMPORT R7 25 [0xC9E646E9]
      49 [-]: JUMPIFNOT R7 L8
...
L11:  70 [-]: GETIMPORT R9 12 [0x105D9429]
      71 [-]: LOADB R10 1  
      72 [-]: NAMECALL R7 R0 K13 [0x003C792F]
      73 [-]: CALL R7 3 1  
      74 [-]: MOVE R2 R7   
      75 [-]: GETIMPORT R9 15 [0xC556BF30]
      76 [-]: LOADB R10 1  
      77 [-]: NAMECALL R7 R0 K16 [0xEA0832EA]
      78 [-]: CALL R7 3 1  
      79 [-]: MOVE R3 R7   
      80 [-]: GETIMPORT R7 18 [0x6D811B71]
      81 [-]: JUMPIFNOT R7 L12
      82 [-]: GETIMPORT R7 1 [0x89326C93]
      83 [-]: GETIMPORT R9 20 [0x945F9957]
      84 [-]: MOVE R10 R2  
      85 [-]: MOVE R11 R3  
      86 [-]: NAMECALL R7 R7 K21 [0x05909209]
      87 [-]: CALL R7 4 0  
L12:  88 [-]: GETIMPORT R7 28 [0x87EFC3BC]
      89 [-]: JUMPIFNOT R7 L13
      90 [-]: GETIMPORT R9 30 [0xAEC1ADA0]
      91 [-]: LOADB R10 0  
      92 [-]: NAMECALL R7 R0 K31 [0x659D451F]
      93 [-]: CALL R7 3 0  
L13:  94 [-]: GETIMPORT R7 1 [0x89326C93]
      95 [-]: GETIMPORT R9 33 [0x78403F35]
      96 [-]: MOVE R10 R2  
      97 [-]: MOVE R11 R3  
     ...
     102 [-]: CALL R8 2 0  
     103 [-]: GETIMPORT R12 37 [0x3630E649]
     104 [-]: LENGTH R13 R1
     105 [-]: CALL R12 1 1 
...
L14: 117 [-]: LOADN R10 2  
     ...
     119 [-]: CALL R8 2 0  
L15: 120 [-]: GETIMPORT R8 43 [0xCBD666E1]
     121 [-]: GETIMPORT R9 45 [0x0B03BC9B]
     122 [-]: CALL R8 1 0  
     123 [-]: FORNLOOP R4 L7
L16: 124 [-]: GETIMPORT R4 28 [0x87EFC3BC]
     125 [-]: JUMPIF R4 L17
     126 [-]: GETIMPORT R6 30 [0xAEC1ADA0]
     127 [-]: LOADB R7 0   
...
; Max Stack Size:  6
       ...
       1 [-]: GETIMPORT R3 2 [0x359137E5]
       2 [-]: FASTCALL1 62 R3 L0
       3 [-]: GETIMPORT R2 4 [0x7B998233]
       4 [-]: CALL R2 1 1  
L 0:   5 [-]: JUMPIF R2 L6 
       6 [-]: GETIMPORT R4 2 [0x359137E5]
       7 [-]: LOADB R5 0   
