...
L 1:  10 [-]: JUMPIFNOT R2 L2
      11 [-]: RETURN R0 0  
L 2:  12 [-]: GETIMPORT R2 4 [0x9BAFFFE3]
      13 [-]: LOADN R3 0   
      14 [-]: LOADN R4 1   
      15 [-]: MOVE R5 R1   
      16 [-]: CALL R2 3 1  
...
; Max Stack Size:  13
       ...
       5 [-]: CALL R4 1 1  
       6 [-]: GETIMPORT R5 4 [0xC2892F65]
       7 [-]: MOVE R6 R4   
       8 [-]: CALL R5 1 0  
       9 [-]: MULK R4 R4 K5 [0.11]
      10 [-]: GETIMPORT R7 7 [0x63E055B1]
      11 [-]: LOADB R8 0   
      12 [-]: NAMECALL R5 R2 K8 [0x659D451F]
      13 [-]: CALL R5 3 0  
      14 [-]: GETIMPORT R7 10 [0x2852ECC3]
      15 [-]: LOADB R8 1   
      16 [-]: LOADB R9 0   
      17 [-]: LOADN R10 0  
      18 [-]: GETIMPORT R11 12 [0x0469F296]
      19 [-]: CALL R11 0 1 
      20 [-]: GETIMPORT R12 14 [0xF6ABD318]
      21 [-]: NAMECALL R5 R2 K15 [0x5D985C7E]
      22 [-]: CALL R5 7 0  
      23 [-]: GETIMPORT R7 17 [0x2793519F]
      24 [-]: LOADB R8 0   
      25 [-]: LOADB R9 1   
      26 [-]: LOADN R10 0  
      27 [-]: GETIMPORT R11 12 [0x0469F296]
      28 [-]: CALL R11 0 1 
      29 [-]: GETIMPORT R12 19 [0x5B2F4640]
      30 [-]: NAMECALL R5 R2 K15 [0x5D985C7E]
      31 [-]: CALL R5 7 0  
      32 [-]: LOADN R5 0   
L 0:  33 [-]: FASTCALL1 62 R2 L1
      34 [-]: MOVE R7 R2   
      35 [-]: GETIMPORT R6 21 [0x7B998233]
      36 [-]: CALL R6 1 1  
...
L 2:  39 [-]: NAMECALL R6 R2 K1 [0xD1586535]
      ...
      48 [-]: CALL R6 2 0  
      49 [-]: GETIMPORT R6 26 [0x67652851]
      50 [-]: CALL R6 0 1  
      51 [-]: ADD R5 R5 R6 
      52 [-]: GETIMPORT R6 28 [0x312AE1BD]
      53 [-]: JUMPIFLT R6 R5 L3
      54 [-]: GETIMPORT R6 30 [0xCBD666E1]
      55 [-]: LOADN R7 0   
      56 [-]: CALL R6 1 0  
      57 [-]: JUMPBACK L0  
...
; Max Stack Size:  7
       ...
       1 [-]: LOADN R2 0   
       2 [-]: CALL R1 1 0  
       3 [-]: GETIMPORT R3 3 [0x66C01AFD]
       4 [-]: LOADB R4 0   
       5 [-]: LOADB R5 1   
       6 [-]: LOADN R6 0   
       7 [-]: NAMECALL R1 R0 K4 [0x5D985C7E]
       8 [-]: CALL R1 5 0  
       9 [-]: GETIMPORT R3 6 ["gScriptTriggerType"]
...
L 0:   6 [-]: MOVE R4 R1   
      ...
      13 [-]: CALL R2 1 0  
      14 [-]: JUMPBACK L0  
L 1:  15 [-]: GETIMPORT R2 3 [0x89326C93]
      16 [-]: GETIMPORT R4 7 [0xADA36A99]
