...
L 1:   6 [-]: JUMPIFNOT R0 L2
       ...
       9 [-]: CALL R0 1 0  
      10 [-]: JUMPBACK L0  
L 2:  11 [-]: GETIMPORT R0 8 [0x15FFEB6D]
...
L 4:  22 [-]: JUMPIFNOT R1 L5
      ...
      29 [-]: MOVE R0 R1   
      30 [-]: JUMPBACK L3  
L 5:  31 [-]: GETIMPORT R3 8 [0x15FFEB6D]
      32 [-]: NAMECALL R1 R0 K11 [0x7BA514CA]
      33 [-]: CALL R1 2 1  
      34 [-]: GETIMPORT R2 13 [0xC88050A5]
      35 [-]: JUMPIFNOTLT R1 R2 L9
      36 [-]: GETIMPORT R1 6 [0xCBD666E1]
      37 [-]: LOADN R2 5   
      38 [-]: CALL R1 1 0  
...
L 7:  43 [-]: JUMPIFNOT R1 L8
      44 [-]: GETIMPORT R1 6 [0xCBD666E1]
      45 [-]: LOADN R2 0   
      46 [-]: CALL R1 1 0  
      47 [-]: GETIMPORT R1 1 [0x89326C93]
...
L10:  55 [-]: NAMECALL R1 R0 K14 [0xD8159207]
      56 [-]: CALL R1 1 1  
      57 [-]: GETIMPORT R2 16 [0x704DBFD1]
      58 [-]: JUMPIFNOTLT R1 R2 L11
      59 [-]: GETIMPORT R1 6 [0xCBD666E1]
      60 [-]: LOADN R2 10  
      61 [-]: CALL R1 1 0  
      62 [-]: JUMPBACK L10 
L11:  63 [-]: LOADNIL R1   
      64 [-]: LOADN R2 -1  
      65 [-]: GETIMPORT R3 18 [0x5FA50FE9]
      66 [-]: JUMPIFNOT R3 L21
...
L15:  98 [-]: JUMPXEQKN R4 K21 L18 NOT [0]
      99 [-]: GETIMPORT R5 1 [0x89326C93]
     100 [-]: GETIMPORT R7 24 ["gDynamicSkyType"]
...
L16: 107 [-]: GETTABLE R9 R5 R8
     ...
     113 [-]: FORNLOOP R6 L16
L17: 114 [-]: GETIMPORT R6 6 [0xCBD666E1]
     115 [-]: LOADN R7 0   
     116 [-]: CALL R6 1 0  
     117 [-]: JUMPBACK L15 
L18: 118 [-]: LOADNIL R5   
...
L20: 126 [-]: LOADN R7 1   
     ...
     129 [-]: DIV R7 R8 R4 
     130 [-]: MUL R2 R6 R7 
     131 [-]: GETIMPORT R6 30 [0xCB2F6C8F]
     132 [-]: CALL R6 0 1  
     133 [-]: MOVE R1 R6   
     134 [-]: GETIMPORT R6 33 [0xE8072DED]
     135 [-]: LOADK R7 K34 ["%u"]
     136 [-]: GETIMPORT R9 36 [0xBE190284]
...
L21: 142 [-]: NEWTABLE R3 0 0
     143 [-]: GETIMPORT R4 40 [0xF483CA6D]
     144 [-]: JUMPXEQKS R4 K41 L23 NOT ["hunt"]
     145 [-]: GETIMPORT R4 43 ["_T"]
     146 [-]: GETIMPORT R5 45 ["HuntJobs"]
     147 [-]: JUMPIF R5 L22
     148 [-]: NEWTABLE R5 0 0
L22: 149 [-]: SETTABLEKS R5 R4 K44 ["HuntJobs"]
     150 [-]: GETIMPORT R4 45 ["HuntJobs"]
     151 [-]: GETIMPORT R5 47 [0x944E6B95]
     152 [-]: NAMECALL R5 R5 K48 [0x6D604BA7]
     153 [-]: CALL R5 1 1  
     154 [-]: SETTABLE R3 R4 R5
     155 [-]: JUMP L24
    
L23: 156 [-]: GETIMPORT R4 50 [0x72839268]
     157 [-]: LOADK R6 K51 ["Job category \""]
     158 [-]: GETIMPORT R7 40 [0xF483CA6D]
     159 [-]: LOADK R8 K52 ["\" unsupported"]
     160 [-]: CONCAT R5 R6 R8
     161 [-]: CALL R4 1 0  
     162 [-]: RETURN R0 0  
L24: 163 [-]: GETIMPORT R4 54 [0xC331F376]
...
L27: 185 [-]: GETTABLE R19 R9 R14
     ...
     189 [-]: MOVE R16 R10 
     190 [-]: GETIMPORT R15 61 [0x23D5322F]
     191 [-]: CALL R15 2 0 
L28: 192 [-]: LENGTH R15 R9
     ...
     198 [-]: MOVE R16 R11 
     199 [-]: GETIMPORT R15 61 [0x23D5322F]
     200 [-]: CALL R15 2 0 
L29: 201 [-]: JUMP L31
...
L30: 202 [-]: FASTCALL2K 52 R11 K21 L31 [0]
     203 [-]: MOVE R16 R11 
     204 [-]: LOADK R17 K21 [0]
     205 [-]: GETIMPORT R15 61 [0x23D5322F]
     206 [-]: CALL R15 2 0 
...
L34: 236 [-]: SETTABLEKS R15 R14 K73 ["skipInventoryUpdate"]
     ...
     241 [-]: MOVE R13 R3  
     242 [-]: GETIMPORT R12 61 [0x23D5322F]
     243 [-]: CALL R12 2 0 
L35: 244 [-]: FORNLOOP R5 L25
L36: 245 [-]: GETIMPORT R5 43 ["_T"]
     246 [-]: LOADB R6 1   
     247 [-]: SETTABLEKS R6 R5 K85 ["RefreshJobs"]
     248 [-]: LOADN R5 0   
     249 [-]: JUMPIFNOTLT R5 R2 L37
     250 [-]: GETIMPORT R5 6 [0xCBD666E1]
