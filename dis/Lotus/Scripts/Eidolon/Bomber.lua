...
L 2:  16 [-]: NAMECALL R3 R2 K7; var4 = var2; var3 = var2[0x65EE9B66]
      ...
      22 [-]: JUMPIFNOTLE R3 R4 L3; goto L3 if var3 > var816
...
L22: 161 [-]: JUMPIFNOT R16 L25; goto L25 if not var16
     ...
     164 [-]: JUMPIFNOTLT R17 R16 L23; goto L23 if var17 >= var1118241
...
L27: 191 [-]: GETUPVAL R20 1; var20 = upvalues[1]
     ...
     195 [-]: JUMPIFLE R22 R21 L28; goto L28 if var22 <= var16782342
...
L43: 294 [-]: JUMPIF R10 L46; goto L46 if var10
     ...
     300 [-]: JUMPIFNOTLT R10 R11 L44; goto L44 if var10 >= var68614
...
L44: 305 [-]: JUMPIFNOT R8 L45; goto L45 if not var8
     ...
     307 [-]: JUMPIFNOTLT R10 R9 L45; goto L45 if var10 >= var4393505
     ...
     312 [-]: JUMPIFNOTLT R9 R10 L45; goto L45 if var9 >= var3078
...
L45: 316 [-]: GETIMPORT R10 69; var10 = 0xCBD666E1
     317 [-]: LOADK R11 K70; var11 = 0.10000000149011612
     318 [-]: CALL R10 2 1 ; var10(var11)
     319 [-]: JUMPBACK L41 ; goto L41
L46: 320 [-]: FASTCALL1 64 R3 L47; 
