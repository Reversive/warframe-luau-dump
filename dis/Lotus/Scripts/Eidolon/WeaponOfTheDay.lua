...
L 5:  38 [-]: SETTABLEKS R1 R0 K0 ["mAvatar"]
      ...
      46 [-]: CALL R3 2 0  
      47 [-]: GETIMPORT R5 28 [nil]
      48 [-]: NAMECALL R3 R1 K29 [0x768274D6]
      49 [-]: CALL R3 2 0  
      50 [-]: GETIMPORT R5 31 [nil]
...
L 9:  79 [-]: GETIMPORT R5 39 [nil]
      ...
      94 [-]: CALL R3 1 1  
      95 [-]: JUMPIF R3 L10
      96 [-]: GETIMPORT R3 16 [nil]
      97 [-]: LOADK R5 K44 ["Error: Failed to create modular weapon from parts. "]
      98 [-]: GETIMPORT R6 19 [nil]
      99 [-]: GETIMPORT R7 21 [nil]
     100 [-]: CALL R6 1 1  
     101 [-]: CONCAT R4 R5 R6
     102 [-]: CALL R3 1 0  
     103 [-]: RETURN R0 0  
...
L18: 170 [-]: JUMPIF R8 L19
     ...
     176 [-]: MOVE R10 R7  
     177 [-]: GETIMPORT R11 23 [nil]
     178 [-]: NAMECALL R8 R8 K55 [0xB6B094B2]
     179 [-]: CALL R8 3 0  
     180 [-]: GETIMPORT R10 31 [nil]
