...
L 2:  10 [-]: RETURN R0 0  
L 3:  11 [-]: GETIMPORT R0 7 ["_T"]
      12 [-]: GETIMPORT R1 1 [0x7DADE620]
      13 [-]: NAMECALL R1 R1 K8 [0x5AC015B9]
      14 [-]: CALL R1 1 1  
      15 [-]: SETTABLEKS R1 R0 K9 ["SelectingFishManifest"]
      16 [-]: GETIMPORT R0 11 ["GetScreenRes"]
      17 [-]: LOADK R1 K12 ["Inventory"]
      18 [-]: CALL R0 1 1  
      19 [-]: GETIMPORT R1 14 [0x9BA7909F]
      20 [-]: MOVE R3 R0   
...
L 1:  10 [-]: JUMPIFNOT R0 L4
      ...
      14 [-]: GETIMPORT R4 12 [0x86C7C4FB]
      15 [-]: LOADB R5 1   
      16 [-]: LOADB R6 0   
      17 [-]: CALL R2 4 0  
      18 [-]: GETIMPORT R2 15 [0x7AB914D8]
      19 [-]: MOVE R3 R1   
      20 [-]: CALL R2 1 1  
...
L 0:   6 [-]: JUMPIF R1 L1 
      ...
      11 [-]: CALL R1 3 0  
L 1:  12 [-]: RETURN R0 0  
L 2:  13 [-]: GETIMPORT R2 6 [0x25D99D89]
...
L 3:  72 [-]: GETUPVAL R3 5
      ...
      75 [-]: CALL R2 1 1  
L 4:  76 [-]: JUMPIF R2 L5 
      77 [-]: GETIMPORT R2 29 [0xCBD666E1]
      78 [-]: LOADN R3 0   
      79 [-]: CALL R2 1 0  
      80 [-]: JUMPBACK L3  
L 5:  81 [-]: GETIMPORT R2 5 ["_T"]
      82 [-]: LOADB R3 0   
      83 [-]: SETTABLEKS R3 R2 K6 ["InFishMgmt"]
      84 [-]: GETIMPORT R2 5 ["_T"]
      85 [-]: LOADNIL R3   
...
L 0:  15 [-]: GETIMPORT R4 1 ["_T"]
      16 [-]: DUPTABLE R5 13
      17 [-]: LOADK R6 K14 ["CutFish"]
      18 [-]: SETTABLEKS R6 R5 K11 ["FunctName"]
      19 [-]: GETIMPORT R6 17 [0x3F3E4D12]
      20 [-]: GETIMPORT R7 19 [0x603636AD]
      21 [-]: MOVE R8 R1   
      22 [-]: LOADB R9 0   
      23 [-]: CALL R7 2 -1 
      24 [-]: CALL R6 -1 1 
      ...
      46 [-]: GETUPVAL R4 9
      47 [-]: CALL R4 0 0  
      48 [-]: GETIMPORT R5 23 [0xE91D7466]
      49 [-]: FASTCALL1 62 R5 L1
      50 [-]: GETIMPORT R4 25 [0x7B998233]
      51 [-]: CALL R4 1 1  
L 1:  52 [-]: JUMPIF R4 L2 
      53 [-]: GETUPVAL R5 8
      54 [-]: GETTABLEKS R4 R5 K26 [0x947DE44C]
      55 [-]: GETIMPORT R5 23 [0xE91D7466]
...
L 3:  64 [-]: JUMPIFNOT R4 L5
      ...
      67 [-]: GETIMPORT R4 25 [0x7B998233]
      68 [-]: CALL R4 1 1  
L 4:  69 [-]: JUMPIF R4 L6 
L 5:  70 [-]: GETIMPORT R4 29 [0xCBD666E1]
      71 [-]: LOADN R5 0   
      72 [-]: CALL R4 1 0  
      73 [-]: JUMPBACK L2  
L 6:  74 [-]: GETIMPORT R4 1 ["_T"]
      75 [-]: LOADB R5 0   
