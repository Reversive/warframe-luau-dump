...
L 8:  48 [-]: GETTABLE R11 R6 R9
      ...
      50 [-]: GETIMPORT R12 13 [0xB4D16664]
...
L11:  62 [-]: JUMPIF R6 L17
      63 [-]: GETIMPORT R6 17 [0xA421AF95]
      64 [-]: LOADN R7 0   
      65 [-]: LOADK R8 K18 [0.59999999999999998]
      66 [-]: LOADN R9 0   
      67 [-]: CALL R6 3 1  
      68 [-]: MOVE R9 R4   
      69 [-]: GETIMPORT R10 20 ["EMPTY_SYMBOL"]
      70 [-]: MOVE R11 R6  
      71 [-]: GETIMPORT R12 22 ["ZERO_ROTATION"]
      72 [-]: NAMECALL R7 R5 K23 [0x3BB4F460]
      73 [-]: CALL R7 5 0  
      74 [-]: GETIMPORT R7 4 [0x89326C93]
      75 [-]: NAMECALL R7 R7 K24 [0x18D05D30]
      76 [-]: CALL R7 1 1  
      77 [-]: LOADN R8 0   
L12:  78 [-]: GETIMPORT R9 26 [0x40A082E4]
      79 [-]: JUMPIFNOTLT R8 R9 L14
      80 [-]: GETIMPORT R9 28 [0x67652851]
      81 [-]: CALL R9 0 1  
      82 [-]: ADD R8 R8 R9 
      83 [-]: JUMPIF R7 L13
      ...
      87 [-]: MOVE R11 R4  
      88 [-]: GETIMPORT R12 20 ["EMPTY_SYMBOL"]
      89 [-]: MOVE R13 R6  
      90 [-]: GETIMPORT R14 22 ["ZERO_ROTATION"]
      91 [-]: NAMECALL R9 R5 K23 [0x3BB4F460]
      92 [-]: CALL R9 5 0  
L13:  93 [-]: GETIMPORT R9 9 [0xCBD666E1]
      94 [-]: LOADN R10 0  
      95 [-]: CALL R9 1 0  
      96 [-]: JUMPBACK L12 
L14:  97 [-]: NAMECALL R9 R3 K29 [0xF6EBD926]
     ...
     101 [-]: GETIMPORT R12 32 [0xD6D4F2CC]
     102 [-]: ADD R11 R10 R12
     103 [-]: LOADN R8 0   
L15: 104 [-]: GETIMPORT R12 34 [0xFAA68C08]
     105 [-]: JUMPIFNOTLT R8 R12 L16
     106 [-]: GETIMPORT R12 28 [0x67652851]
     107 [-]: CALL R12 0 1 
     108 [-]: ADD R8 R8 R12
     109 [-]: GETIMPORT R12 36 [0x9BAFFFE3]
     110 [-]: MOVE R13 R10 
     111 [-]: MOVE R14 R11 
     112 [-]: GETIMPORT R16 34 [0xFAA68C08]
     113 [-]: DIV R15 R8 R16
     114 [-]: CALL R12 3 1 
     ...
     120 [-]: CALL R12 -1 0
     121 [-]: GETIMPORT R12 9 [0xCBD666E1]
     122 [-]: LOADN R13 0  
     123 [-]: CALL R12 1 0 
     ...
     126 [-]: MOVE R9 R12  
     127 [-]: JUMPBACK L15 
L16: 128 [-]: GETIMPORT R12 4 [0x89326C93]
     129 [-]: GETIMPORT R14 40 [0x5E1BFA79]
     130 [-]: NAMECALL R15 R5 K29 [0xF6EBD926]
     131 [-]: CALL R15 1 1 
     132 [-]: GETIMPORT R16 22 ["ZERO_ROTATION"]
     133 [-]: NAMECALL R12 R12 K41 [0x05909209]
     134 [-]: CALL R12 4 0 
     135 [-]: GETIMPORT R14 4 [0x89326C93]
