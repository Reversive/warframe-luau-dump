...
; Max Stack Size:  14
       ...
       8 [-]: LOADK R5 K4  ; var5 = " "
       9 [-]: GETIMPORT R6 6; var6 = 0x603636AD
      10 [-]: NAMECALL R7 R0 K7; var8 = var0; var7 = var0[0xD3A9D01F]
      11 [-]: CALL R7 2 2  ; var7 = var7(var8)
      12 [-]: NAMECALL R7 R7 K8; var8 = var7; var7 = var7[0x6D604BA7]
      ...
      19 [-]: JUMPIFNOTLT R1 R5 L0; goto L0 if var1 >= var591109
      20 [-]: LOADK R5 K9  ; var5 = "<p><font color=\"#"
      21 [-]: GETIMPORT R10 12; var10 = 0x7F5022CF[0xE8072DED]
      22 [-]: LOADK R11 K13; var11 = "%X"
      23 [-]: GETIMPORT R13 15; var13 = 0x0032441C
      24 [-]: GETTABLEKS R12 R13 K16; var12 = var13["UIColor_Red"]
      25 [-]: CALL R10 3 2 ; var10 = var10(var11, var12)
      26 [-]: MOVE R6 R10  ; var6 = var10
      27 [-]: LOADK R7 K17 ; var7 = "\"><b>"
      28 [-]: MOVE R8 R3   ; var8 = var3
      29 [-]: LOADK R9 K18 ; var9 = "</b></font>"
      30 [-]: CONCAT R4 R5 R9; var4 = var5 .. var9
      31 [-]: JUMP L1      ; goto L1
L 0:  32 [-]: MOVE R4 R3   ; var4 = var3
L 1:  33 [-]: GETIMPORT R5 21; var5 = _T["AddLogMessage"]
...
L 2:  19 [-]: NAMECALL R5 R1 K10; var6 = var1; var5 = var1[0xDE321E6F]
      ...
      24 [-]: JUMPIFNOTLE R3 R5 L6; goto L6 if var3 > var853838
