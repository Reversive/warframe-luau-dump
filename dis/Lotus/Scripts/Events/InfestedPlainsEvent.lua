...
L 0:   6 [-]: MOVE R7 R4   ; var7 = var4
      ...
      10 [-]: JUMPIFNOTEQ R5 R6 L1; goto L1 if var5 ~= var66822
...
L10:  73 [-]: LENGTH R3 R1 ; var3 = #var1
      ...
      75 [-]: JUMPIFNOTLT R4 R3 L27; goto L27 if var4 >= var1180449
...
L11:  86 [-]: JUMPIF R4 L28; goto L28 if var4
L12:  87 [-]: FASTCALL1 64 R3 L13; 
...
L13:  91 [-]: JUMPIF R4 L14; goto L14 if var4
      ...
      94 [-]: JUMPIFNOT R4 L16; goto L16 if not var4
L14:  95 [-]: GETIMPORT R5 26; var5 = _T["MissionInitReady"]
      96 [-]: FASTCALL1 64 R5 L15; 
      97 [-]: GETIMPORT R4 1; var4 = 0x7B998233
      98 [-]: CALL R4 2 2  ; var4 = var4(var5)
L15:  99 [-]: JUMPIF R4 L17; goto L17 if var4
     100 [-]: GETIMPORT R4 26; var4 = _T["MissionInitReady"]
     101 [-]: JUMPXEQKB R4 0 L17 NOT; 
L16: 102 [-]: GETIMPORT R4 28; var4 = 0xCBD666E1
     103 [-]: LOADN R5 0   ; var5 = 0
     104 [-]: CALL R4 2 1  ; var4(var5)
     105 [-]: JUMPBACK L12 ; goto L12
L17: 106 [-]: GETIMPORT R4 18; var4 = 0x3D106989
     107 [-]: LOADK R5 K29 ; var5 = "Agent loading complete"
     108 [-]: CALL R4 2 1  ; var4(var5)
     109 [-]: GETIMPORT R4 18; var4 = 0x3D106989
     110 [-]: LOADK R6 K30 ; var6 = "Adding "
     111 [-]: LENGTH R7 R2 ; var7 = #var2
     112 [-]: LOADK R8 K31 ; var8 = " enemy agent types"
     113 [-]: CONCAT R5 R6 R8; var5 = var6 .. var8
     114 [-]: CALL R4 2 1  ; var4(var5)
     115 [-]: GETIMPORT R4 7; var4 = 0xC8802016
     116 [-]: MOVE R5 R2   ; var5 = var2
     117 [-]: CALL R4 2 4  ; var4, var5, var6 = var4(var5)
     118 [-]: FORGPREP_INEXT R4 L20; 
L18: 119 [-]: GETTABLEKS R9 R8 K32; var9 = var8["probability"]
     120 [-]: GETTABLEKS R10 R8 K33; var10 = var8["maxSimultaneous"]
     121 [-]: GETTABLEKS R11 R8 K34; var11 = var8["tier"]
     122 [-]: GETIMPORT R12 36; var12 = 0x88EFC25E
     123 [-]: GETTABLEKS R13 R8 K8; var13 = var8["agent"]
     124 [-]: CALL R12 2 2 ; var12 = var12(var13)
     125 [-]: FASTCALL1 64 R12 L19; 
     126 [-]: MOVE R14 R12 ; var14 = var12
     127 [-]: GETIMPORT R13 1; var13 = 0x7B998233
     128 [-]: CALL R13 2 2 ; var13 = var13(var14)
L19: 129 [-]: JUMPIF R13 L20; goto L20 if var13
     130 [-]: MOVE R15 R12 ; var15 = var12
     131 [-]: MOVE R16 R9  ; var16 = var9
     132 [-]: MOVE R17 R10 ; var17 = var10
     133 [-]: MOVE R18 R11 ; var18 = var11
     134 [-]: NAMECALL R13 R0 K37; var14 = var0; var13 = var0[0x6D1A3A23]
     135 [-]: CALL R13 6 1 ; var13(var14, var15, var16, var17, var18)
L20: 136 [-]: FORGLOOP R4 L18 2 [inext]; 
     137 [-]: GETIMPORT R4 18; var4 = 0x3D106989
     138 [-]: LOADK R6 K30 ; var6 = "Adding "
     139 [-]: GETUPVAL R9 1; var9 = upvalues[1]
     140 [-]: LENGTH R7 R9 ; var7 = #var9
     141 [-]: LOADK R8 K38 ; var8 = " advanced spawners"
     142 [-]: CONCAT R5 R6 R8; var5 = var6 .. var8
     143 [-]: CALL R4 2 1  ; var4(var5)
     144 [-]: GETIMPORT R4 7; var4 = 0xC8802016
     145 [-]: GETUPVAL R5 1; var5 = upvalues[1]
     146 [-]: CALL R4 2 4  ; var4, var5, var6 = var4(var5)
     147 [-]: FORGPREP_INEXT R4 L23; 
L21: 148 [-]: FASTCALL1 64 R8 L22; 
...
L22: 152 [-]: JUMPIF R9 L23; goto L23 if var9
     153 [-]: GETIMPORT R11 14; var11 = gAdvancedDirectorAiSpawnerType
     154 [-]: NAMECALL R9 R8 K4; var10 = var8; var9 = var8[0xF2DEAF69]
     155 [-]: CALL R9 3 2  ; var9 = var9(var10, var11)
     156 [-]: JUMPIFNOT R9 L23; goto L23 if not var9
     157 [-]: GETIMPORT R11 36; var11 = 0x88EFC25E
     158 [-]: MOVE R12 R8  ; var12 = var8
     159 [-]: CALL R11 2 0 ; var11, ... = var11(var12)
     160 [-]: NAMECALL R9 R0 K39; var10 = var0; var9 = var0[0x0933C4F1]
     161 [-]: CALL R9 0 1  ; var9(var10, ...)
L23: 162 [-]: FORGLOOP R4 L21 2 [inext]; 
     163 [-]: GETIMPORT R4 18; var4 = 0x3D106989
     164 [-]: LOADK R6 K30 ; var6 = "Adding "
     165 [-]: GETUPVAL R9 2; var9 = upvalues[2]
     166 [-]: LENGTH R7 R9 ; var7 = #var9
     167 [-]: LOADK R8 K40 ; var8 = " encounters"
     168 [-]: CONCAT R5 R6 R8; var5 = var6 .. var8
     169 [-]: CALL R4 2 1  ; var4(var5)
     170 [-]: GETIMPORT R4 7; var4 = 0xC8802016
     171 [-]: GETUPVAL R5 2; var5 = upvalues[2]
     172 [-]: CALL R4 2 4  ; var4, var5, var6 = var4(var5)
     173 [-]: FORGPREP_INEXT R4 L26; 
L24: 174 [-]: FASTCALL1 64 R8 L25; 
     175 [-]: MOVE R10 R8  ; var10 = var8
     176 [-]: GETIMPORT R9 1; var9 = 0x7B998233
     177 [-]: CALL R9 2 2  ; var9 = var9(var10)
L25: 178 [-]: JUMPIF R9 L26; goto L26 if var9
     179 [-]: GETIMPORT R11 16; var11 = gEncounterTemplateType
     180 [-]: NAMECALL R9 R8 K4; var10 = var8; var9 = var8[0xF2DEAF69]
     181 [-]: CALL R9 3 2  ; var9 = var9(var10, var11)
     182 [-]: JUMPIFNOT R9 L26; goto L26 if not var9
     183 [-]: GETIMPORT R11 36; var11 = 0x88EFC25E
     184 [-]: MOVE R12 R8  ; var12 = var8
     185 [-]: CALL R11 2 0 ; var11, ... = var11(var12)
     186 [-]: NAMECALL R9 R0 K41; var10 = var0; var9 = var0[0x5ADEE8F2]
     187 [-]: CALL R9 0 1  ; var9(var10, ...)
L26: 188 [-]: FORGLOOP R4 L24 2 [inext]; 
     189 [-]: RETURN R0 0  ; 
L27: 190 [-]: GETIMPORT R3 18; var3 = 0x3D106989
     191 [-]: LOADK R4 K42 ; var4 = "No agents to load"
...
L 1:   7 [-]: JUMPIFNOT R7 L2; goto L2 if not var7
       ...
       9 [-]: LOADK R8 K7  ; var8 = 0.10000000149011612
...
L14:  87 [-]: JUMPIF R17 L19; goto L19 if var17
      ...
      89 [-]: JUMPIFEQ R11 R17 L15; goto L15 if var11 == var201020
      90 [-]: GETUPVAL R17 3; var17 = upvalues[3]
      91 [-]: JUMPIFNOTEQ R11 R17 L16; goto L16 if var11 ~= var2167623
...
L23: 128 [-]: GETIMPORT R9 48; var9 = 0xB7CBD06B
     ...
     138 [-]: JUMPIFLT R14 R13 L24; goto L24 if var14 < var16780294
...
L33: 179 [-]: JUMPIFNOTLT R8 R3 L36; goto L36 if var8 >= var1313812
...
L39: 220 [-]: GETIMPORT R13 62; var13 = _T["InfestedPlainsEventActive"]
     221 [-]: JUMPIFNOT R13 L45; goto L45 if not var13
...
L41: 241 [-]: GETIMPORT R14 1; var14 = 0x89326C93
     242 [-]: NAMECALL R14 R14 K67; var15 = var14; var14 = var14[0x18D05D30]
     243 [-]: CALL R14 2 2 ; var14 = var14(var15)
     244 [-]: JUMPIFNOT R14 L45; goto L45 if not var14
L42: 245 [-]: NAMECALL R14 R13 K68; var15 = var13; var14 = var13[0xF37943FF]
     246 [-]: CALL R14 2 2 ; var14 = var14(var15)
     247 [-]: JUMPIFNOT R14 L43; goto L43 if not var14
     248 [-]: NAMECALL R14 R13 K69; var15 = var13; var14 = var13[0xA2D83ED4]
     249 [-]: CALL R14 2 2 ; var14 = var14(var15)
     250 [-]: JUMPIF R14 L44; goto L44 if var14
L43: 251 [-]: GETIMPORT R14 6; var14 = 0xCBD666E1
     252 [-]: LOADN R15 0  ; var15 = 0
     253 [-]: CALL R14 2 1 ; var14(var15)
     254 [-]: JUMPBACK L42 ; goto L42
L44: 255 [-]: GETUPVAL R16 6; var16 = upvalues[6]
     256 [-]: NAMECALL R14 R13 K70; var15 = var13; var14 = var13[0x058C13A1]
     257 [-]: CALL R14 3 1 ; var14(var15, var16)
     258 [-]: GETIMPORT R16 72; var16 = 0x0469F296
     259 [-]: LOADK R17 K73; var17 = "Infestation"
     260 [-]: CALL R16 2 2 ; var16 = var16(var17)
     261 [-]: LOADN R17 2  ; var17 = 2
     262 [-]: NAMECALL R14 R13 K74; var15 = var13; var14 = var13[0xB568825A]
     263 [-]: CALL R14 4 1 ; var14(var15, var16, var17)
     264 [-]: GETIMPORT R16 72; var16 = 0x0469F296
     265 [-]: LOADK R17 K75; var17 = "Vomvalysts"
     266 [-]: CALL R16 2 2 ; var16 = var16(var17)
     267 [-]: LOADN R17 8  ; var17 = 8
     268 [-]: NAMECALL R14 R13 K74; var15 = var13; var14 = var13[0xB568825A]
     269 [-]: CALL R14 4 1 ; var14(var15, var16, var17)
L45: 270 [-]: RETURN R0 0  ; 
...
L 1:   4 [-]: JUMPIF R0 L2 ; goto L2 if var0
      ...
      10 [-]: JUMPIFEQ R0 R1 L3; goto L3 if var0 == var655393
...
L 4:  21 [-]: GETIMPORT R0 10; var0 = 0xCBD666E1
      ...
      32 [-]: JUMPIFNOTEQ R0 R1 L6; goto L6 if var0 ~= var1179937
...
L15:  88 [-]: GETTABLE R13 R4 R12; var13 = var4[var12]
      ...
      91 [-]: JUMPIFNOTEQ R14 R15 L18; goto L18 if var14 ~= var2166305
      ...
      99 [-]: JUMPIFNOTLE R14 R16 L18; goto L18 if var14 > var4144
     100 [-]: LOADN R16 0  ; var16 = 0
     101 [-]: JUMPIFNOTLE R16 R15 L17; goto L17 if var16 > var-1509355457
...
L20: 125 [-]: GETTABLE R13 R5 R12; var13 = var5[var12]
     ...
     128 [-]: JUMPIFNOTEQ R14 R15 L23; goto L23 if var14 ~= var2166305
     ...
     136 [-]: JUMPIFNOTLE R14 R16 L23; goto L23 if var14 > var4144
     137 [-]: LOADN R16 0  ; var16 = 0
     138 [-]: JUMPIFNOTLE R16 R15 L22; goto L22 if var16 > var-1509355457
...
; Max Stack Size:  6
      ...
      11 [-]: JUMPIFNOTEQ R2 R3 L1; goto L1 if var2 ~= var656161
L 0:  12 [-]: GETIMPORT R3 10; var3 = _T["ActiveJob"]
      ...
      18 [-]: JUMPIFNOTEQ R3 R4 L2; goto L2 if var3 ~= var816
