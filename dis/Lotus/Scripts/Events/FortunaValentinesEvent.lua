...
; Max Stack Size:  14
       ...
       6 [-]: JUMPIFNOT R0 L0
       7 [-]: GETIMPORT R0 6 [0xA5C556B9]
       8 [-]: GETIMPORT R1 8 [0x64FB1586]
...
L 0:  17 [-]: RETURN R0 0  
L 1:  18 [-]: GETIMPORT R0 12 [0x76EA806B]
      19 [-]: LOADN R2 0   
...
L 3:  33 [-]: JUMPIF R2 L7 
      ...
      41 [-]: CALL R3 1 1  
L 4:  42 [-]: JUMPIF R3 L7 
      43 [-]: GETIMPORT R3 20 [0xC8802016]
      44 [-]: GETUPVAL R4 0
      45 [-]: CALL R3 1 3  
      46 [-]: FORGPREP_INEXT R3 L6
L 5:  47 [-]: JUMPIFNOTEQ R2 R7 L6
      48 [-]: GETIMPORT R8 22 [0x3D106989]
      49 [-]: GETIMPORT R12 8 [0x64FB1586]
      50 [-]: MOVE R13 R2  
      51 [-]: CALL R12 1 1 
      52 [-]: MOVE R10 R12 
...
L 7:  58 [-]: GETIMPORT R1 25 ["_T"]
      59 [-]: GETIMPORT R2 27 ["TaggedDialog"]
      60 [-]: JUMPIF R2 L8 
      61 [-]: NEWTABLE R2 0 0
L 8:  62 [-]: SETTABLEKS R2 R1 K26 ["TaggedDialog"]
      63 [-]: GETIMPORT R1 27 ["TaggedDialog"]
      64 [-]: DUPTABLE R2 31
...
L 3:  30 [-]: GETIMPORT R3 17 [0x3D106989]
      31 [-]: LOADK R5 K18 ["Couldn't find hub NPC with tag "]
      32 [-]: GETIMPORT R6 20 [0x64FB1586]
      33 [-]: GETIMPORT R7 1 [0xBC448E20]
      34 [-]: CALL R6 1 1  
      35 [-]: CONCAT R4 R5 R6
      36 [-]: CALL R3 1 0  
      37 [-]: RETURN R0 0  
L 4:  38 [-]: GETIMPORT R3 11 [0x89326C93]
      39 [-]: GETUPVAL R5 0
...
L 6:  47 [-]: JUMPIFNOT R5 L7
      ...
      53 [-]: CALL R5 2 1  
      54 [-]: MOVE R3 R5   
      55 [-]: GETIMPORT R5 4 [0xCBD666E1]
      56 [-]: LOADN R6 0   
      57 [-]: CALL R5 1 0  
      58 [-]: GETIMPORT R5 22 [0x67652851]
      59 [-]: CALL R5 0 1  
      60 [-]: SUB R4 R4 R5 
      61 [-]: JUMPBACK L5  
L 7:  62 [-]: FASTCALL1 62 R3 L8
      63 [-]: MOVE R6 R3   
      64 [-]: GETIMPORT R5 14 [0x7B998233]
      65 [-]: CALL R5 1 1  
L 8:  66 [-]: JUMPIFNOT R5 L9
      67 [-]: GETIMPORT R5 17 [0x3D106989]
      68 [-]: LOADK R6 K23 ["Early exit from Star Days event as Tick's waypoint couldn't be found!"]
      69 [-]: CALL R5 1 0  
      70 [-]: RETURN R0 0  
L 9:  71 [-]: NAMECALL R5 R3 K15 [0xD1586535]
      72 [-]: CALL R5 1 1  
      73 [-]: GETIMPORT R6 25 [0xA421AF95]
      74 [-]: LOADN R7 0   
      75 [-]: LOADN R8 0   
      76 [-]: LOADN R9 0   
      77 [-]: CALL R6 3 1  
      78 [-]: GETIMPORT R7 27 [0x83DDCC65]
      79 [-]: MOVE R8 R6   
      80 [-]: MOVE R9 R5   
      81 [-]: MOVE R10 R1  
      82 [-]: CALL R7 3 0  
      ...
      85 [-]: CALL R7 2 0  
      86 [-]: GETIMPORT R7 11 [0x89326C93]
      87 [-]: GETIMPORT R9 30 [0x0469F296]
...
L10:  99 [-]: JUMPIF R8 L11
     ...
     111 [-]: CALL R10 2 0 
L11: 112 [-]: GETIMPORT R9 37 [0xC38F9B52]
     113 [-]: FASTCALL1 62 R9 L12
     114 [-]: GETIMPORT R8 14 [0x7B998233]
     115 [-]: CALL R8 1 1  
L12: 116 [-]: JUMPIF R8 L16
     117 [-]: GETIMPORT R9 37 [0xC38F9B52]
     118 [-]: LENGTH R8 R9 
     119 [-]: LOADN R9 0   
     120 [-]: JUMPIFNOTLT R9 R8 L16
     121 [-]: GETIMPORT R8 39 [0xC8802016]
     122 [-]: GETIMPORT R9 37 [0xC38F9B52]
     123 [-]: CALL R8 1 3  
     124 [-]: FORGPREP_INEXT R8 L15
L13: 125 [-]: FASTCALL1 62 R12 L14
     126 [-]: MOVE R14 R12 
     127 [-]: GETIMPORT R13 14 [0x7B998233]
     128 [-]: CALL R13 1 1 
L14: 129 [-]: JUMPIF R13 L15
     130 [-]: GETIMPORT R13 25 [0xA421AF95]
     131 [-]: LOADN R14 0  
     132 [-]: LOADN R15 0  
     133 [-]: LOADN R16 0  
     134 [-]: CALL R13 3 1 
     135 [-]: GETIMPORT R14 35 [0x808DC004]
     136 [-]: MOVE R15 R13 
...
L16: 145 [-]: GETIMPORT R10 41 [0x66C01AFD]
...
L21: 179 [-]: GETIMPORT R9 11 [0x89326C93]
     180 [-]: GETUPVAL R11 2
     ...
     188 [-]: MOVE R11 R9  
     189 [-]: GETIMPORT R10 14 [0x7B998233]
     190 [-]: CALL R10 1 1 
...
; Max Stack Size:  16
       ...
       3 [-]: LOADN R4 0   
       4 [-]: CALL R3 1 0  
       5 [-]: GETIMPORT R5 3 [0xBC448E20]
       6 [-]: FASTCALL1 62 R5 L0
       7 [-]: GETIMPORT R4 5 [0x7B998233]
       8 [-]: CALL R4 1 1  
L 0:   9 [-]: NOT R3 R4    
      10 [-]: JUMPIFNOT R3 L2
      11 [-]: GETIMPORT R4 3 [0xBC448E20]
...
L 4:  25 [-]: FASTCALL1 62 R2 L5
      ...
      28 [-]: CALL R4 1 1  
L 5:  29 [-]: JUMPIF R4 L6 
      30 [-]: GETIMPORT R6 12 ["gLotusHubNpcEntityType"]
      31 [-]: NAMECALL R4 R2 K13 [0xF2DEAF69]
      32 [-]: CALL R4 2 1  
      33 [-]: JUMPIF R4 L7 
L 6:  34 [-]: RETURN R0 0  
L 7:  35 [-]: GETIMPORT R5 15 [0x21B576B1]
      36 [-]: JUMPIFNOT R5 L8
      37 [-]: LOADN R4 -1  
      38 [-]: JUMP L9
     
L 8:  39 [-]: GETIMPORT R4 17 [0xC163F229]
      40 [-]: GETIMPORT R5 19 [0x81AA1949]
      41 [-]: GETIMPORT R6 21 [0xC8DBDE7B]
      42 [-]: CALL R4 2 1  
L 9:  43 [-]: LOADB R5 0   
L10:  44 [-]: FASTCALL1 62 R2 L11
      45 [-]: MOVE R7 R2   
      46 [-]: GETIMPORT R6 5 [0x7B998233]
      47 [-]: CALL R6 1 1  
L11:  48 [-]: JUMPIF R6 L29
      49 [-]: JUMPIFNOT R1 L25
      50 [-]: GETIMPORT R6 24 ["CurrentConversation"]
      51 [-]: JUMPIFNOT R6 L24
      52 [-]: GETIMPORT R6 26 ["mHubNpc"]
      53 [-]: JUMPIFNOTEQ R6 R2 L24
      54 [-]: GETIMPORT R6 28 [0x67652851]
      55 [-]: CALL R6 0 1  
      56 [-]: SUB R4 R4 R6 
      57 [-]: LOADN R6 0   
      58 [-]: JUMPIFNOTLT R4 R6 L28
      59 [-]: GETIMPORT R6 15 [0x21B576B1]
      60 [-]: JUMPIFNOT R6 L12
      61 [-]: JUMPIF R5 L13
L12:  62 [-]: GETIMPORT R6 15 [0x21B576B1]
      63 [-]: JUMPIF R6 L14
L13:  64 [-]: GETIMPORT R6 17 [0xC163F229]
      65 [-]: GETIMPORT R7 19 [0x81AA1949]
      66 [-]: GETIMPORT R8 21 [0xC8DBDE7B]
      67 [-]: CALL R6 2 1  
      68 [-]: MOVE R4 R6   
L14:  69 [-]: GETIMPORT R6 30 ["mTransmissionSet"]
      70 [-]: GETIMPORT R8 32 ["curTransmission"]
      71 [-]: FASTCALL1 62 R8 L15
      72 [-]: GETIMPORT R7 5 [0x7B998233]
      73 [-]: CALL R7 1 1  
...
L16:  79 [-]: JUMPIF R7 L28
      80 [-]: GETIMPORT R8 17 [0xC163F229]
      81 [-]: LOADN R9 0   
      82 [-]: LOADN R10 1  
      83 [-]: CALL R8 2 1  
      84 [-]: GETIMPORT R9 34 [0xEC797C59]
      85 [-]: JUMPIFLT R8 R9 L17
      86 [-]: LOADB R7 0 +1
L17:  87 [-]: LOADB R7 1   
L18:  88 [-]: GETIMPORT R8 30 ["mTransmissionSet"]
      89 [-]: JUMPIFNOT R7 L19
      90 [-]: GETUPVAL R10 0
      91 [-]: JUMPIF R10 L20
...
L20:  93 [-]: NAMECALL R8 R8 K35 [0x10C9EEF2]
      ...
      96 [-]: MOVE R10 R8  
      97 [-]: GETIMPORT R9 5 [0x7B998233]
      98 [-]: CALL R9 1 1  
L21:  99 [-]: JUMPIF R9 L28
     100 [-]: LOADB R5 1   
     101 [-]: GETIMPORT R9 24 ["CurrentConversation"]
     102 [-]: MOVE R11 R8  
     103 [-]: LOADNIL R12  
     104 [-]: LOADB R13 0  
     105 [-]: LOADB R14 0  
...
L25: 116 [-]: GETIMPORT R6 24 ["CurrentConversation"]
     117 [-]: JUMPIFNOT R6 L28
     118 [-]: GETIMPORT R6 26 ["mHubNpc"]
     119 [-]: JUMPIFNOTEQ R6 R2 L28
     120 [-]: GETIMPORT R7 15 [0x21B576B1]
     121 [-]: JUMPIFNOT R7 L26
     122 [-]: LOADN R6 -1  
     123 [-]: JUMP L27
    
L26: 124 [-]: GETIMPORT R6 17 [0xC163F229]
     125 [-]: GETIMPORT R7 19 [0x81AA1949]
     126 [-]: GETIMPORT R8 21 [0xC8DBDE7B]
     127 [-]: CALL R6 2 1  
L27: 128 [-]: MOVE R4 R6   
     129 [-]: LOADB R1 1   
L28: 130 [-]: GETIMPORT R6 1 [0xCBD666E1]
     131 [-]: LOADN R7 0   
     132 [-]: CALL R6 1 0  
     133 [-]: JUMPBACK L10 
L29: 134 [-]: RETURN R0 0  
