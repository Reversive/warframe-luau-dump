...
; Max Stack Size:  15
       ...
       4 [-]: CALL R2 1 1  
       5 [-]: JUMPIFNOT R2 L0
       6 [-]: GETIMPORT R2 6 ["RelayEventCaptures"]
       7 [-]: NAMECALL R3 R1 K7 [0x8B72B36E]
       8 [-]: CALL R3 1 1  
       9 [-]: LOADB R4 1   
      10 [-]: SETTABLE R4 R2 R3
L 0:  11 [-]: GETIMPORT R4 9 [0x8DBC0C42]
      12 [-]: GETIMPORT R5 11 ["EMPTY_SYMBOL"]
      13 [-]: NAMECALL R2 R0 K12 [0x47901F07]
      14 [-]: CALL R2 3 0  
      15 [-]: GETIMPORT R3 14 ["RelayEventCapturedEnemy"]
      16 [-]: FASTCALL1 62 R3 L1
      17 [-]: GETIMPORT R2 16 [0x7B998233]
      18 [-]: CALL R2 1 1  
L 1:  19 [-]: JUMPIF R2 L3 
      20 [-]: GETIMPORT R2 14 ["RelayEventCapturedEnemy"]
      21 [-]: GETIMPORT R4 18 [0x3332BE79]
      22 [-]: GETIMPORT R5 11 ["EMPTY_SYMBOL"]
      23 [-]: NAMECALL R2 R2 K12 [0x47901F07]
      24 [-]: CALL R2 3 0  
      25 [-]: GETIMPORT R2 14 ["RelayEventCapturedEnemy"]
      26 [-]: NAMECALL R2 R2 K19 [0xFA9E477F]
      27 [-]: CALL R2 1 1  
      28 [-]: FASTCALL1 62 R2 L2
      29 [-]: MOVE R4 R2   
      30 [-]: GETIMPORT R3 16 [0x7B998233]
      31 [-]: CALL R3 1 1  
L 2:  32 [-]: JUMPIF R3 L3 
      33 [-]: LOADN R5 6   
...
L 4:  40 [-]: JUMPIF R2 L5 
      ...
      45 [-]: GETIMPORT R4 23 [0xBA16F1C9]
      46 [-]: NAMECALL R2 R0 K24 [0x16E0B3DA]
      47 [-]: CALL R2 2 1  
      48 [-]: JUMPIF R2 L5 
      49 [-]: GETIMPORT R4 23 [0xBA16F1C9]
      50 [-]: LOADB R5 0   
      51 [-]: LOADN R6 2   
      52 [-]: LOADN R7 2   
      53 [-]: LOADB R8 1   
      ...
      55 [-]: CALL R2 6 0  
L 5:  56 [-]: GETIMPORT R2 27 [0xCBD666E1]
      57 [-]: LOADN R3 2   
      58 [-]: CALL R2 1 0  
      59 [-]: FASTCALL1 62 R0 L6
      60 [-]: MOVE R3 R0   
      61 [-]: GETIMPORT R2 16 [0x7B998233]
      62 [-]: CALL R2 1 1  
L 6:  63 [-]: JUMPIF R2 L7 
      64 [-]: GETIMPORT R4 23 [0xBA16F1C9]
...
L 7:  75 [-]: FASTCALL1 62 R0 L8
      76 [-]: MOVE R3 R0   
      77 [-]: GETIMPORT R2 16 [0x7B998233]
      78 [-]: CALL R2 1 1  
L 8:  79 [-]: JUMPIF R2 L39
      80 [-]: NAMECALL R2 R0 K28 [0xA5E492D4]
      81 [-]: CALL R2 1 1  
      82 [-]: JUMPIFNOT R2 L39
      83 [-]: GETIMPORT R2 31 ["item"]
      84 [-]: LOADB R3 1   
      85 [-]: JUMPIFNOT R3 L11
      86 [-]: GETIMPORT R5 33 [0xDCDB4505]
      87 [-]: FASTCALL1 62 R5 L9
      88 [-]: GETIMPORT R4 16 [0x7B998233]
      89 [-]: CALL R4 1 1  
L 9:  90 [-]: JUMPIF R4 L11
      91 [-]: GETIMPORT R4 35 [0xBA7DFCD2]
      92 [-]: GETIMPORT R6 33 [0xDCDB4505]
...
L17: 122 [-]: NOT R3 R6    
     ...
     124 [-]: GETIMPORT R8 43 ["gLotusOperatorAvatarType"]
...
L24: 152 [-]: JUMPIFNOT R3 L32
     153 [-]: GETIMPORT R5 47 [0x25D99D89]
     154 [-]: FASTCALL1 62 R5 L25
     155 [-]: GETIMPORT R4 16 [0x7B998233]
     156 [-]: CALL R4 1 1  
L25: 157 [-]: JUMPIF R4 L32
     158 [-]: GETIMPORT R4 47 [0x25D99D89]
...
L32: 179 [-]: JUMPIFNOT R3 L35
     180 [-]: GETIMPORT R4 51 [0xC8802016]
     181 [-]: GETIMPORT R5 53 [0x7887F096]
     182 [-]: CALL R4 1 3  
...
L35: 188 [-]: GETIMPORT R4 56 [0x9BA7909F]
     189 [-]: GETIMPORT R6 58 [0x63879A7C]
     190 [-]: NAMECALL R4 R4 K59 [0x6DD7AA66]
     191 [-]: CALL R4 2 1  
     192 [-]: FASTCALL1 62 R4 L36
     193 [-]: MOVE R6 R4   
     194 [-]: GETIMPORT R5 16 [0x7B998233]
     195 [-]: CALL R5 1 1  
L36: 196 [-]: JUMPIF R5 L38
     197 [-]: FASTCALL1 62 R2 L37
     198 [-]: MOVE R6 R2   
     199 [-]: GETIMPORT R5 16 [0x7B998233]
     200 [-]: CALL R5 1 1  
L37: 201 [-]: JUMPIF R5 L38
     202 [-]: GETIMPORT R5 61 ["DisplayReward"]
     203 [-]: MOVE R6 R2   
     204 [-]: GETIMPORT R7 63 ["itemAmount"]
     205 [-]: CALL R5 2 0  
L38: 206 [-]: NAMECALL R5 R0 K0 [0x5E651723]
     207 [-]: CALL R5 1 1  
     208 [-]: MOVE R7 R2   
     209 [-]: GETIMPORT R8 63 ["itemAmount"]
...
; Max Stack Size:  19
       ...
       2 [-]: CALL R1 1 1  
       3 [-]: JUMPIFNOT R1 L0
       4 [-]: GETIMPORT R1 5 ["RelayEventCaptureTimer"]
       5 [-]: JUMPXEQKNIL R1 L1
L 0:   6 [-]: RETURN R0 0  
L 1:   7 [-]: GETIMPORT R1 6 ["_T"]
       8 [-]: NEWTABLE R2 0 0
       9 [-]: SETTABLEKS R2 R1 K7 ["RelayEventCaptures"]
      10 [-]: GETIMPORT R1 6 ["_T"]
      11 [-]: LOADN R2 30  
      12 [-]: SETTABLEKS R2 R1 K4 ["RelayEventCaptureTimer"]
L 2:  13 [-]: GETIMPORT R1 5 ["RelayEventCaptureTimer"]
      14 [-]: LOADN R2 0   
      15 [-]: JUMPIFNOTLT R2 R1 L8
      16 [-]: GETIMPORT R2 9 ["RelayEventTargetEnemy"]
...
L 4:  29 [-]: GETTABLE R6 R2 R5
      30 [-]: GETIMPORT R8 13 ["RelayEventCaptures"]
      31 [-]: NAMECALL R9 R6 K14 [0x8B72B36E]
      32 [-]: CALL R9 1 1  
      33 [-]: GETTABLE R7 R8 R9
      34 [-]: JUMPIF R7 L6 
      35 [-]: GETIMPORT R7 16 [0xBE190284]
      ...
      43 [-]: GETIMPORT R16 21 [0x64FB1586]
      44 [-]: GETIMPORT R18 5 ["RelayEventCaptureTimer"]
      45 [-]: FASTCALL1 12 R18 L5
      46 [-]: GETIMPORT R17 24 [0x55F27C30]
      47 [-]: CALL R17 1 -1
L 5:  48 [-]: CALL R16 -1 1
      49 [-]: LOADNIL R17  
...
L 7:  54 [-]: JUMPIF R1 L8 
      55 [-]: GETIMPORT R3 27 [0xCBD666E1]
      56 [-]: LOADN R4 1   
      57 [-]: CALL R3 1 0  
      58 [-]: GETIMPORT R3 6 ["_T"]
      59 [-]: GETIMPORT R5 5 ["RelayEventCaptureTimer"]
      60 [-]: SUBK R4 R5 K28 [1]
      61 [-]: SETTABLEKS R4 R3 K4 ["RelayEventCaptureTimer"]
      62 [-]: JUMPBACK L2  
L 8:  63 [-]: GETIMPORT R2 9 ["RelayEventTargetEnemy"]
      64 [-]: FASTCALL1 62 R2 L9
      65 [-]: GETIMPORT R1 11 [0x7B998233]
      66 [-]: CALL R1 1 1  
L 9:  67 [-]: JUMPIF R1 L10
      68 [-]: GETIMPORT R1 9 ["RelayEventTargetEnemy"]
      69 [-]: NAMECALL R1 R1 K29 [0x1AC1655C]
      70 [-]: CALL R1 1 1  
      71 [-]: LOADB R3 0   
      72 [-]: NAMECALL R1 R1 K30 [0x53376C85]
      73 [-]: CALL R1 2 0  
      74 [-]: GETIMPORT R1 9 ["RelayEventTargetEnemy"]
      75 [-]: NAMECALL R1 R1 K29 [0x1AC1655C]
      76 [-]: CALL R1 1 1  
      77 [-]: GETIMPORT R3 32 ["RELAY_EVENT_INJURY_IMMUNITY_TAG"]
      78 [-]: NAMECALL R1 R1 K33 [0x571105C9]
      79 [-]: CALL R1 2 0  
      80 [-]: GETIMPORT R1 9 ["RelayEventTargetEnemy"]
      81 [-]: NAMECALL R1 R1 K29 [0x1AC1655C]
      82 [-]: CALL R1 1 1  
      83 [-]: LOADN R3 0   
      84 [-]: NAMECALL R1 R1 K34 [0x57369B8B]
      85 [-]: CALL R1 2 0  
      86 [-]: GETIMPORT R1 9 ["RelayEventTargetEnemy"]
      87 [-]: NAMECALL R1 R1 K35 [0xFB3BBA96]
      88 [-]: CALL R1 1 0  
L10:  89 [-]: FASTCALL1 62 R0 L11
      90 [-]: MOVE R2 R0   
      91 [-]: GETIMPORT R1 11 [0x7B998233]
      92 [-]: CALL R1 1 1  
L11:  93 [-]: JUMPIF R1 L12
      94 [-]: GETIMPORT R1 1 [0x89326C93]
      95 [-]: MOVE R3 R0   
      96 [-]: NAMECALL R1 R1 K36 [0x59C96E77]
      97 [-]: CALL R1 2 0  
L12:  98 [-]: GETIMPORT R1 38 ["ResetElementalVIP"]
      99 [-]: CALL R1 0 0  
     100 [-]: RETURN R0 0  
