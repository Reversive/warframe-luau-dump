...
L 0:   4 [-]: GETTABLE R5 R0 R4; var5 = var0[var4]
       ...
       6 [-]: JUMPIFNOTEQ R6 R1 L3; goto L3 if var6 ~= var1292175167
       7 [-]: GETTABLEKS R7 R5 K1; var7 = var5["mItemCount"]
       8 [-]: LOADN R8 0   ; var8 = 0
       9 [-]: JUMPIFLT R8 R7 L1; goto L1 if var8 < var16778758
...
L 4:  40 [-]: JUMPIF R2 L5 ; goto L5 if var2
      ...
      44 [-]: JUMPIFNOTLT R3 R2 L5; goto L5 if var3 >= var1508385
...
L 9:  90 [-]: JUMPIF R4 L11; goto L11 if var4
      ...
      98 [-]: JUMPIFLE R4 R5 L10; goto L10 if var4 <= var16777990
...
L12: 111 [-]: GETTABLE R11 R7 R10; var11 = var7[var10]
     ...
     113 [-]: JUMPIFNOTEQ R12 R2 L15; goto L15 if var12 ~= var1292569663
     114 [-]: GETTABLEKS R12 R11 K41; var12 = var11["mItemCount"]
     115 [-]: LOADN R13 0  ; var13 = 0
     116 [-]: JUMPIFLT R13 R12 L13; goto L13 if var13 < var16778758
...
L18: 140 [-]: GETTABLE R12 R8 R11; var12 = var8[var11]
     ...
     142 [-]: JUMPIFNOTEQ R13 R2 L21; goto L21 if var13 ~= var1292635455
     143 [-]: GETTABLEKS R13 R12 K41; var13 = var12["mItemCount"]
     144 [-]: LOADN R14 0  ; var14 = 0
     145 [-]: JUMPIFLT R14 R13 L19; goto L19 if var14 < var16779014
...
L26: 167 [-]: GETTABLE R10 R5 R9; var10 = var5[var9]
     ...
     169 [-]: JUMPIFNOTEQ R11 R2 L29; goto L29 if var11 ~= var1292503871
     170 [-]: GETTABLEKS R11 R10 K41; var11 = var10["mItemCount"]
     171 [-]: LOADN R12 0  ; var12 = 0
     172 [-]: JUMPIFLT R12 R11 L27; goto L27 if var12 < var16778758
...
L 4:  29 [-]: GETTABLE R6 R2 R5; var6 = var2[var5]
      ...
      34 [-]: JUMPIF R7 L7 ; goto L7 if var7
      ...
      43 [-]: GETIMPORT R18 5; var18 = _T["RelayEventCaptureTimer"]
      44 [-]: FASTCALL1 12 R18 L5; 
      45 [-]: GETIMPORT R17 22; var17 = 0x5BCED4C4[0x55F27C30]
      46 [-]: CALL R17 2 2 ; var17 = var17(var18)
L 5:  47 [-]: FASTCALL1 63 R17 L6; 
      48 [-]: GETIMPORT R16 24; var16 = 0x64FB1586
      49 [-]: CALL R16 2 2 ; var16 = var16(var17)
L 6:  50 [-]: LOADNIL R17  ; var17 = nil
      51 [-]: NAMECALL R7 R7 K25; var8 = var7; var7 = var7[0x06D4C9EB]
      52 [-]: CALL R7 11 1 ; var7(var8, var9, var10, var11, var12, var13, var14, var15, var16, var17)
      53 [-]: LOADB R1 0   ; var1 = false
L 7:  54 [-]: FORNLOOP R3 L4; nforloop end - iterate + goto L4
L 8:  55 [-]: JUMPIF R1 L9 ; goto L9 if var1
      56 [-]: GETIMPORT R3 27; var3 = 0xCBD666E1
      57 [-]: LOADN R4 1   ; var4 = 1
      58 [-]: CALL R3 2 1  ; var3(var4)
      59 [-]: GETIMPORT R3 6; var3 = _T
      60 [-]: GETIMPORT R5 5; var5 = _T["RelayEventCaptureTimer"]
      61 [-]: SUBK R4 R5 K28; var4 = var5 - 1
      62 [-]: SETTABLEKS R4 R3 K4; var4["RelayEventCaptureTimer"] = var3
      63 [-]: JUMPBACK L2  ; goto L2
L 9:  64 [-]: GETIMPORT R2 9; var2 = _T["RelayEventTargetEnemy"]
      65 [-]: FASTCALL1 64 R2 L10; 
      66 [-]: GETIMPORT R1 11; var1 = 0x7B998233
      67 [-]: CALL R1 2 2  ; var1 = var1(var2)
L10:  68 [-]: JUMPIF R1 L11; goto L11 if var1
      69 [-]: GETIMPORT R1 9; var1 = _T["RelayEventTargetEnemy"]
      70 [-]: NAMECALL R1 R1 K29; var2 = var1; var1 = var1[0x1AC1655C]
      71 [-]: CALL R1 2 2  ; var1 = var1(var2)
      72 [-]: LOADB R3 0   ; var3 = false
      73 [-]: NAMECALL R1 R1 K30; var2 = var1; var1 = var1[0x53376C85]
      74 [-]: CALL R1 3 1  ; var1(var2, var3)
      75 [-]: GETIMPORT R1 9; var1 = _T["RelayEventTargetEnemy"]
      76 [-]: NAMECALL R1 R1 K29; var2 = var1; var1 = var1[0x1AC1655C]
      77 [-]: CALL R1 2 2  ; var1 = var1(var2)
      78 [-]: GETIMPORT R3 32; var3 = _T["RELAY_EVENT_INJURY_IMMUNITY_TAG"]
      79 [-]: NAMECALL R1 R1 K33; var2 = var1; var1 = var1[0x571105C9]
      80 [-]: CALL R1 3 1  ; var1(var2, var3)
      81 [-]: GETIMPORT R1 9; var1 = _T["RelayEventTargetEnemy"]
      82 [-]: NAMECALL R1 R1 K29; var2 = var1; var1 = var1[0x1AC1655C]
      83 [-]: CALL R1 2 2  ; var1 = var1(var2)
      84 [-]: LOADN R3 0   ; var3 = 0
      85 [-]: NAMECALL R1 R1 K34; var2 = var1; var1 = var1[0x57369B8B]
      86 [-]: CALL R1 3 1  ; var1(var2, var3)
      87 [-]: GETIMPORT R1 9; var1 = _T["RelayEventTargetEnemy"]
      88 [-]: NAMECALL R1 R1 K35; var2 = var1; var1 = var1[0xFB3BBA96]
      89 [-]: CALL R1 2 1  ; var1(var2)
L11:  90 [-]: FASTCALL1 64 R0 L12; 
      91 [-]: MOVE R2 R0   ; var2 = var0
      92 [-]: GETIMPORT R1 11; var1 = 0x7B998233
      93 [-]: CALL R1 2 2  ; var1 = var1(var2)
L12:  94 [-]: JUMPIF R1 L13; goto L13 if var1
      95 [-]: GETIMPORT R1 1; var1 = 0x89326C93
      96 [-]: MOVE R3 R0   ; var3 = var0
      97 [-]: NAMECALL R1 R1 K36; var2 = var1; var1 = var1[0x59C96E77]
      98 [-]: CALL R1 3 1  ; var1(var2, var3)
L13:  99 [-]: GETIMPORT R1 38; var1 = _T["ResetElementalVIP"]
