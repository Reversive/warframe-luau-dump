...
; Max Stack Size:  3
       ...
       5 [-]: JUMPIFEQ R0 R2 L1; goto L1 if var0 == var1442375
...
L 2:  16 [-]: GETIMPORT R7 6; var7 = 0x72A150D7
      ...
      19 [-]: JUMPIFNOTEQ R6 R7 L3; goto L3 if var6 ~= var-821950907
...
L 7:  49 [-]: JUMPIF R3 L15; goto L15 if var3
      ...
      52 [-]: JUMPIFNOTEQ R3 R4 L15; goto L15 if var3 ~= var1946157893
...
L 8:  59 [-]: JUMPIF R4 L12; goto L12 if var4
      ...
      70 [-]: JUMPIFEQ R4 R5 L9; goto L9 if var4 == var-117308347
...
L16: 114 [-]: NAMECALL R3 R2 K23; var4 = var2; var3 = var2[0xE668799A]
     ...
     117 [-]: JUMPIFNOTEQ R3 R4 L17; goto L17 if var3 ~= var66587
...
L18: 124 [-]: JUMPIF R4 L20; goto L20 if var4
     ...
     127 [-]: JUMPIFNOTEQ R4 R5 L20; goto L20 if var4 ~= var1946158149
...
L19: 134 [-]: JUMPIF R5 L28; goto L28 if var5
     ...
     145 [-]: JUMPIFNOTEQ R5 R6 L28; goto L28 if var5 ~= var66843
...
L20: 149 [-]: GETIMPORT R5 25; var5 = 0xFFB05D25
     ...
     152 [-]: JUMPIFEQ R5 R6 L22; goto L22 if var5 == var66587
     153 [-]: LOADB R4 1   ; var4 = true
     154 [-]: LOADN R6 21  ; var6 = 21
     155 [-]: JUMPIFEQ R5 R6 L22; goto L22 if var5 == var1443399
     156 [-]: LOADN R6 22  ; var6 = 22
     157 [-]: JUMPIFEQ R5 R6 L21; goto L21 if var5 == var16778267
...
L22: 160 [-]: JUMPIFNOT R4 L28; goto L28 if not var4
     ...
     163 [-]: JUMPIFEQ R3 R5 L24; goto L24 if var3 == var66587
     164 [-]: LOADB R4 1   ; var4 = true
     165 [-]: LOADN R5 21  ; var5 = 21
     166 [-]: JUMPIFEQ R3 R5 L24; goto L24 if var3 == var1443143
     167 [-]: LOADN R5 22  ; var5 = 22
     168 [-]: JUMPIFEQ R3 R5 L23; goto L23 if var3 == var16778267
