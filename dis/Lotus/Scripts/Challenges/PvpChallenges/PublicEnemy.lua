...
; Max Stack Size:  6
       ...
       1 [-]: CALL R3 1 1  
       2 [-]: GETIMPORT R4 3 ["gPublicEnemyChallengeData"]
       3 [-]: JUMPXEQKNIL R4 L0
       4 [-]: GETIMPORT R5 3 ["gPublicEnemyChallengeData"]
       5 [-]: GETTABLE R4 R5 R3
       6 [-]: JUMPXEQKNIL R4 L0
       7 [-]: GETIMPORT R4 3 ["gPublicEnemyChallengeData"]
       8 [-]: LOADNIL R5   
       9 [-]: SETTABLE R5 R4 R3
L 0:  10 [-]: LOADB R4 0   
      11 [-]: RETURN R4 1  
...
L 0:   9 [-]: JUMPIF R4 L7 
      ...
      13 [-]: CALL R4 1 1  
      14 [-]: GETIMPORT R5 7 ["gPublicEnemyChallengeData"]
      15 [-]: JUMPXEQKNIL R5 L1 NOT
      16 [-]: GETIMPORT R5 8 ["_T"]
      17 [-]: NEWTABLE R6 0 0
      18 [-]: SETTABLEKS R6 R5 K6 ["gPublicEnemyChallengeData"]
L 1:  19 [-]: GETIMPORT R6 7 ["gPublicEnemyChallengeData"]
      20 [-]: GETTABLE R5 R6 R2
      21 [-]: JUMPXEQKNIL R5 L2 NOT
      22 [-]: GETIMPORT R5 7 ["gPublicEnemyChallengeData"]
      23 [-]: NEWTABLE R6 0 0
      24 [-]: SETTABLE R6 R5 R2
L 2:  25 [-]: GETIMPORT R6 7 ["gPublicEnemyChallengeData"]
...
L 3:  34 [-]: LOADN R6 0   
      ...
      41 [-]: LOADN R9 1   
      42 [-]: FORNPREP R8 L6
L 4:  43 [-]: GETIMPORT R13 7 ["gPublicEnemyChallengeData"]
...
L 6:  54 [-]: LOADN R8 4   
      ...
      56 [-]: GETIMPORT R8 7 ["gPublicEnemyChallengeData"]
      57 [-]: LOADNIL R9   
