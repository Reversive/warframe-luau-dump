...
; Max Stack Size:  3
  ...
  3 [-]: LOADK     R2 K1        ; R2 := "SUICIDE_ASSIST"
  4 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  5 [-]: CLOSURE   R2 0         ; R2 := closure(Function #1)
  6 [-]: MOVE      R0 R0        ; R0 := R0
  7 [-]: MOVE      R0 R1        ; R0 := R1
  8 [-]: SETGLOBAL R2 K2        ; MatchTagEvent := R2
...
; Max Stack Size:  20
  ...
  7 [-]: SELF      R4 R0 K1     ; R5 := R0; R4 := R0[0x5ca33548]
  8 [-]: CALL      R4 2 2       ; R4 := R4(R5)
  9 [-]: SELF      R5 R0 K2     ; R6 := R0; R5 := R0[0xbb610e5b]
 ...
 19 [-]: JMP       31           ; PC := 31
 20 [-]: SELF      R6 R3 K6     ; R7 := R3; R6 := R3[0xf2deaf69]
 21 [-]: GETGLOBAL R8 K7        ; R8 := gDamageTriggerType
 22 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 23 [-]: TEST      R6 0         ; if not R6 then PC := 93
 24 [-]: JMP       93           ; PC := 93
 25 [-]: SELF      R6 R3 K8     ; R7 := R3; R6 := R3[0x65c63fbe]
 26 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 27 [-]: SELF      R6 R6 K9     ; R7 := R6; R6 := R6[0x56c01834]
 ...
 57 [-]: SELF      R13 R13 K2   ; R14 := R13; R13 := R13[0xbb610e5b]
 ...
 85 [-]: JMP       92           ; PC := 92
 86 [-]: GETGLOBAL R15 K15      ; R15 := 0xba7dfcd2
 87 [-]: SELF      R15 R15 K16  ; R16 := R15; R15 := R15[0xf056b179]
...
; Max Stack Size:  7
 ...
 34 [-]: GETGLOBAL R6 K7        ; R6 := 0x0a8f62a7
