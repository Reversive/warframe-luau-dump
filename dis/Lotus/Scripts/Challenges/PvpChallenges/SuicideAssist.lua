...
L 1:   6 [-]: NAMECALL R4 R0 K2 [0x5CA33548]
       ...
       9 [-]: CALL R5 1 1  
      10 [-]: GETIMPORT R6 6 ["gSuicideAssistData"]
      11 [-]: JUMPXEQKNIL R6 L2 NOT
      12 [-]: GETIMPORT R6 7 ["_T"]
      13 [-]: NEWTABLE R7 0 0
      14 [-]: SETTABLEKS R7 R6 K5 ["gSuicideAssistData"]
L 2:  15 [-]: JUMPIFEQ R3 R5 L3
      16 [-]: GETIMPORT R8 9 ["gDamageTriggerType"]
      ...
      23 [-]: CALL R6 1 1  
      24 [-]: JUMPIFNOT R6 L9
L 3:  25 [-]: GETIMPORT R8 6 ["gSuicideAssistData"]
      26 [-]: GETTABLE R7 R8 R4
      27 [-]: FASTCALL1 62 R7 L4
      28 [-]: GETIMPORT R6 1 [0x7B998233]
      29 [-]: CALL R6 1 1  
L 4:  30 [-]: JUMPIF R6 L9 
      31 [-]: GETIMPORT R6 14 [0x0A8F62A7]
      32 [-]: CALL R6 0 1  
      33 [-]: LOADN R7 0   
      ...
      37 [-]: LOADN R7 1   
L 5:  38 [-]: GETIMPORT R8 17 [0x89326C93]
...
L 9:  79 [-]: GETIMPORT R6 6 ["gSuicideAssistData"]
      80 [-]: NEWTABLE R7 0 0
...
L 0:   9 [-]: JUMPIF R4 L3 
      ...
      13 [-]: CALL R4 1 1  
      14 [-]: GETIMPORT R5 7 ["gSuicideAssistData"]
      15 [-]: JUMPXEQKNIL R5 L1 NOT
      16 [-]: GETIMPORT R5 8 ["_T"]
      17 [-]: NEWTABLE R6 0 0
      18 [-]: SETTABLEKS R6 R5 K6 ["gSuicideAssistData"]
L 1:  19 [-]: GETIMPORT R6 7 ["gSuicideAssistData"]
      20 [-]: GETTABLE R5 R6 R4
      21 [-]: JUMPXEQKNIL R5 L2 NOT
      22 [-]: GETIMPORT R5 7 ["gSuicideAssistData"]
      23 [-]: NEWTABLE R6 0 0
      24 [-]: SETTABLE R6 R5 R4
L 2:  25 [-]: GETIMPORT R6 7 ["gSuicideAssistData"]
      26 [-]: GETTABLE R5 R6 R4
      27 [-]: GETIMPORT R6 10 [0x0A8F62A7]
      28 [-]: CALL R6 0 1  
