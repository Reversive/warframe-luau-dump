...
; Max Stack Size:  9
  ...
  1 [-]: GETGLOBAL R5 K0        ; R5 := 0x5bf84945
  2 [-]: SELF      R5 R5 K1     ; R6 := R5; R5 := R5[0xbb610e5b]
  ...
  8 [-]: JMP       17           ; PC := 17
  9 [-]: SELF      R6 R5 K3     ; R7 := R5; R6 := R5[0xe668799a]
 10 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 11 [-]: EQ        0 R6 K5      ; if R6 ~= 5.000000 then PC := 17
 12 [-]: JMP       17           ; PC := 17
 13 [-]: GETUPVAL  R7 U0        ; R7 := U0
 14 [-]: GETTABLE  R7 R7 K6     ; R82 := R7[0x098c2676]
