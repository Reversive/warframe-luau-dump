...
; Max Stack Size:  6
 ...
 15 [-]: LT        0 K3 R3      ; if 0.000000 >= R3 then PC := 30
 16 [-]: JMP       30           ; PC := 30
 17 [-]: GETUPVAL  R3 U0        ; R3 := U0
 18 [-]: GETTABLE  R3 R3 K0     ; R3 := R3["KillStreaks"]
 19 [-]: GETGLOBAL R4 K1        ; R4 := 0x5bf84945
 20 [-]: SELF      R4 R4 K2     ; R5 := R4; R4 := R4[0x5ca33548]
 21 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 22 [-]: GETTABLE  R3 R3 R4     ; R3 := R3[R4]
 23 [-]: MOD       R3 R3 K4     ; R3 := R3 % 3.000000
 24 [-]: EQ        0 R3 K3      ; if R3 ~= 0.000000 then PC := 30
 25 [-]: JMP       30           ; PC := 30
 26 [-]: GETUPVAL  R3 U1        ; R3 := U1
 27 [-]: GETTABLE  R3 R3 K5     ; R82 := R3[0x098c2676]
