...
; Max Stack Size:  17
  ...
  5 [-]: SELF      R4 R0 K2     ; R5 := R0; R4 := R0[0x14a55974]
  6 [-]: CALL      R4 2 2       ; R4 := R4(R5)
  7 [-]: GETGLOBAL R5 K3        ; R5 := 0x64fb1586
  8 [-]: GETGLOBAL R6 K4        ; R6 := 0x761c7428
  9 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 10 [-]: LOADK     R6 K5        ; R6 := ""
 11 [-]: GETGLOBAL R7 K6        ; R7 := 0x8f5a2eab
 12 [-]: EQ        0 R7 K7      ; if R7 ~= 1.000000 then PC := 22
 13 [-]: JMP       22           ; PC := 22
 ...
 21 [-]: JMP       31           ; PC := 31
 22 [-]: GETGLOBAL R7 K6        ; R7 := 0x8f5a2eab
 23 [-]: EQ        0 R7 K12     ; if R7 ~= 2.000000 then PC := 27
 24 [-]: JMP       27           ; PC := 27
 25 [-]: LOADK     R6 K13       ; R6 := "ComboKillData"
 26 [-]: JMP       31           ; PC := 31
 27 [-]: GETGLOBAL R7 K6        ; R7 := 0x8f5a2eab
 28 [-]: EQ        0 R7 K14     ; if R7 ~= 3.000000 then PC := 31
 29 [-]: JMP       31           ; PC := 31
 ...
 43 [-]: JMP       159          ; PC := 159
 44 [-]: GETGLOBAL R7 K18       ; R7 := 0x7b998233
 45 [-]: MOVE      R8 R4        ; R8 := R4
 46 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 47 [-]: TEST      R7 1         ; if R7 then PC := 159
 48 [-]: JMP       159          ; PC := 159
 49 [-]: SELF      R7 R3 K19    ; R8 := R3; R7 := R3[0x5e651723]
 50 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 51 [-]: SELF      R7 R7 K0     ; R8 := R7; R7 := R7[0x5ca33548]
 ...
 80 [-]: MOVE      R8 R4        ; R8 := R4
 81 [-]: SELF      R9 R4 K22    ; R10 := R4; R9 := R4[0xf2deaf69]
 82 [-]: GETGLOBAL R11 K23      ; R11 := gLotusWeaponType
 83 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
 84 [-]: TEST      R9 0         ; if not R9 then PC := 95
 85 [-]: JMP       95           ; PC := 95
 86 [-]: GETGLOBAL R9 K18       ; R9 := 0x7b998233
 87 [-]: SELF      R10 R4 K24   ; R11 := R4; R10 := R4[0xd2073b32]
 88 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
 89 [-]: CALL      R9 0 2       ; R9 := R9(R10,...)
 90 [-]: TEST      R9 1         ; if R9 then PC := 95
 91 [-]: JMP       95           ; PC := 95
 92 [-]: SELF      R9 R4 K24    ; R10 := R4; R9 := R4[0xd2073b32]
 93 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 94 [-]: MOVE      R8 R9        ; R8 := R9
 95 [-]: LOADK     R9 K5        ; R9 := ""
 96 [-]: SELF      R10 R8 K22   ; R11 := R8; R10 := R8[0xf2deaf69]
...
102 [-]: GETTABLE  R9 R10 K7    ; R9 := R10[1.000000]
103 [-]: JMP       114          ; PC := 114
104 [-]: SELF      R10 R8 K22   ; R11 := R8; R10 := R8[0xf2deaf69]
...
110 [-]: GETTABLE  R9 R10 K12   ; R9 := R10[2.000000]
111 [-]: JMP       114          ; PC := 114
112 [-]: GETUPVAL  R10 U0       ; R10 := U0
113 [-]: GETTABLE  R9 R10 K14   ; R9 := R10[3.000000]
...
118 [-]: SETTABLE  R10 R9 K27   ; R10[R9] := true
119 [-]: SELF      R10 R0 K28   ; R11 := R0; R10 := R0[0x36822477]
...
143 [-]: JMP       155          ; PC := 155
144 [-]: GETGLOBAL R16 K6       ; R16 := 0x8f5a2eab
145 [-]: EQ        0 R16 K7     ; if R16 ~= 1.000000 then PC := 154
146 [-]: JMP       154          ; PC := 154
