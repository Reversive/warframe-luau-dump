...
; Max Stack Size:  13
       ...
       7 [-]: LOADB R1 1   
L 0:   8 [-]: GETIMPORT R3 4 [0x89326C93]
...
L 1:  18 [-]: GETIMPORT R3 8 [0x55730E1A]
      19 [-]: LOADN R4 1   
      20 [-]: GETIMPORT R5 10 [0x6A927A0C]
      21 [-]: CALL R3 2 1  
      22 [-]: GETUPVAL R6 0
      23 [-]: MOVE R7 R3   
      24 [-]: NAMECALL R4 R0 K6 [0x751F061D]
      25 [-]: CALL R4 3 0  
L 2:  26 [-]: GETIMPORT R3 12 [0xC8802016]
      27 [-]: GETIMPORT R4 14 [0x9858301B]
      28 [-]: CALL R3 1 3  
...
L11:  76 [-]: GETIMPORT R5 34 [0xDEA71A38]
      77 [-]: LENGTH R4 R5 
      78 [-]: JUMPIFNOTLE R3 R4 L14
      79 [-]: GETIMPORT R4 4 [0x89326C93]
      80 [-]: GETIMPORT R7 34 [0xDEA71A38]
      81 [-]: GETTABLE R6 R7 R3
      82 [-]: NAMECALL R4 R4 K31 [0xC7FCADA9]
      83 [-]: CALL R4 2 1  
      84 [-]: GETIMPORT R5 12 [0xC8802016]
      85 [-]: MOVE R6 R4   
      86 [-]: CALL R5 1 3  
...
L14:  92 [-]: GETIMPORT R5 37 [0x2F46AD0A]
      93 [-]: LENGTH R4 R5 
      94 [-]: JUMPIFNOTLE R3 R4 L17
      95 [-]: GETIMPORT R4 4 [0x89326C93]
      96 [-]: GETIMPORT R7 37 [0x2F46AD0A]
      97 [-]: GETTABLE R6 R7 R3
      98 [-]: NAMECALL R4 R4 K31 [0xC7FCADA9]
      99 [-]: CALL R4 2 1  
     100 [-]: GETIMPORT R5 12 [0xC8802016]
     101 [-]: MOVE R6 R4   
     102 [-]: CALL R5 1 3  
