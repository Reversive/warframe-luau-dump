...
; Max Stack Size:  28
       ...
       8 [-]: GETIMPORT R2 8 [0x3D106989]
       9 [-]: LOADK R3 K9 ["No valid groups found. Closing Worker spawner."]
      10 [-]: CALL R2 1 0  
      11 [-]: RETURN R0 0  
L 0:  12 [-]: GETIMPORT R2 8 [0x3D106989]
      13 [-]: LOADK R4 K10 ["There are "]
      14 [-]: LENGTH R5 R1 
      15 [-]: LOADK R6 K11 [" possible groups in this mission"]
      16 [-]: CONCAT R3 R4 R6
      17 [-]: CALL R2 1 0  
      18 [-]: GETIMPORT R2 13 [0x55730E1A]
      19 [-]: GETIMPORT R3 15 [0xE026C064]
      20 [-]: GETIMPORT R4 17 [0xEE3A5E26]
      21 [-]: CALL R2 2 1  
...
L 2:  37 [-]: LOADN R6 1   
      ...
      39 [-]: LOADN R5 1   
      40 [-]: FORNPREP R4 L5
L 3:  41 [-]: GETIMPORT R7 13 [0x55730E1A]
      42 [-]: LOADN R8 1   
      43 [-]: LENGTH R9 R1 
      44 [-]: CALL R7 2 1  
      ...
      47 [-]: MOVE R9 R3   
      48 [-]: GETIMPORT R8 22 [0x23D5322F]
      49 [-]: CALL R8 2 0  
L 4:  50 [-]: GETIMPORT R8 24 [0x9C1F3B5A]
      51 [-]: MOVE R9 R1   
      52 [-]: MOVE R10 R7  
      53 [-]: CALL R8 2 0  
      54 [-]: FORNLOOP R4 L3
...
L 8:  86 [-]: FASTCALL1 62 R9 L9
      87 [-]: MOVE R11 R9  
      88 [-]: GETIMPORT R10 35 [0x7B998233]
      89 [-]: CALL R10 1 1 
L 9:  90 [-]: JUMPIFNOT R10 L10
      91 [-]: NAMECALL R10 R6 K33 [0x8026755D]
      92 [-]: CALL R10 1 1 
      93 [-]: MOVE R9 R10  
      94 [-]: GETIMPORT R10 37 [0xCBD666E1]
      95 [-]: LOADN R11 0  
      96 [-]: CALL R10 1 0 
      97 [-]: JUMPBACK L8  
L10:  98 [-]: GETIMPORT R10 1 [0x89326C93]
      99 [-]: GETIMPORT R12 3 [0x0469F296]
     ...
     109 [-]: MOVE R12 R10 
     110 [-]: GETIMPORT R11 35 [0x7B998233]
     111 [-]: CALL R11 1 1 
L11: 112 [-]: JUMPIFNOT R11 L12
     113 [-]: GETIMPORT R11 8 [0x3D106989]
...
L12: 117 [-]: NAMECALL R11 R10 K38 [0xD1586535]
     118 [-]: CALL R11 1 1 
     119 [-]: LOADNIL R12  
L13: 120 [-]: GETIMPORT R13 37 [0xCBD666E1]
     121 [-]: LOADN R14 2  
     122 [-]: CALL R13 1 0 
     ...
     127 [-]: MOVE R14 R12 
     128 [-]: GETIMPORT R13 35 [0x7B998233]
     129 [-]: CALL R13 1 1 
...
L16: 137 [-]: GETIMPORT R15 3 [0x0469F296]
     138 [-]: CALL R15 0 -1
     139 [-]: NAMECALL R13 R10 K26 [0x3273BA96]
     140 [-]: CALL R13 -1 0
     141 [-]: GETIMPORT R13 1 [0x89326C93]
     142 [-]: GETIMPORT R15 3 [0x0469F296]
     143 [-]: LOADK R16 K42 ["GrineerWorkerPatrol"]
     144 [-]: CALL R15 1 1 
     145 [-]: MOVE R16 R11 
     146 [-]: LOADN R17 0  
     147 [-]: GETIMPORT R18 44 [0x9830FB4F]
     148 [-]: NAMECALL R13 R13 K45 [0xF16592C8]
     149 [-]: CALL R13 5 1 
     150 [-]: LENGTH R14 R13
     151 [-]: JUMPXEQKN R14 K6 L17 NOT [0]
     152 [-]: GETIMPORT R14 8 [0x3D106989]
     153 [-]: LOADK R15 K46 ["No valid patrols for the Group, not spawning any workers."]
     154 [-]: CALL R14 1 0 
     155 [-]: JUMP L23
    
L17: 156 [-]: GETIMPORT R14 13 [0x55730E1A]
     157 [-]: GETIMPORT R16 48 [0x3B35329C]
     158 [-]: LENGTH R17 R13
     159 [-]: FASTCALL2 19 R16 R17 L18
     160 [-]: GETIMPORT R15 51 [0xAC1B386A]
     161 [-]: CALL R15 2 1 
L18: 162 [-]: GETIMPORT R17 53 [0x29218E8E]
     163 [-]: LENGTH R18 R13
     164 [-]: FASTCALL2 19 R17 R18 L19
     165 [-]: GETIMPORT R16 51 [0xAC1B386A]
     166 [-]: CALL R16 2 -1
...
L20: 172 [-]: NAMECALL R18 R6 K54 [0xE830AC3D]
     ...
     183 [-]: GETIMPORT R23 57 [0x1E2425BB]
     184 [-]: MOVE R24 R4  
     185 [-]: GETIMPORT R25 13 [0x55730E1A]
     186 [-]: MOVE R26 R7  
     187 [-]: MOVE R27 R8  
     188 [-]: CALL R25 2 -1
     189 [-]: NAMECALL R19 R6 K58 [0x2883E796]
     190 [-]: CALL R19 -1 1
     191 [-]: GETIMPORT R20 37 [0xCBD666E1]
     192 [-]: LOADN R21 0  
     193 [-]: CALL R20 1 0 
     194 [-]: FASTCALL1 62 R19 L21
     195 [-]: MOVE R21 R19 
     196 [-]: GETIMPORT R20 35 [0x7B998233]
     197 [-]: CALL R20 1 1 
...
L23: 203 [-]: GETIMPORT R14 37 [0xCBD666E1]
     204 [-]: LOADN R15 0  
     205 [-]: CALL R14 1 0 
     206 [-]: JUMPBACK L10 
     207 [-]: RETURN R0 0  
...
L 1:  20 [-]: GETUPVAL R6 1
      ...
      22 [-]: GETIMPORT R8 10 [0xF3B3055F]
      23 [-]: CALL R6 2 1  
      24 [-]: MOVE R9 R6   
      25 [-]: GETTABLE R10 R0 R5
      26 [-]: GETIMPORT R11 12 [0x1E2425BB]
      27 [-]: MOVE R12 R1  
      28 [-]: LOADN R13 15 
      29 [-]: NAMECALL R7 R2 K13 [0x2883E796]
      30 [-]: CALL R7 6 1  
      31 [-]: GETIMPORT R8 15 [0xCBD666E1]
      32 [-]: LOADN R9 0   
      33 [-]: CALL R8 1 0  
      34 [-]: FASTCALL1 62 R7 L2
      35 [-]: MOVE R9 R7   
      36 [-]: GETIMPORT R8 17 [0x7B998233]
      37 [-]: CALL R8 1 1  
L 2:  38 [-]: JUMPIF R8 L3 
