...
; Max Stack Size:  18
       ...
       0 [-]: GETIMPORT R4 2 [0xDE14D6BF]
       1 [-]: GETIMPORT R5 4 [0x89326C93]
      ...
      14 [-]: CALL R5 1 1  
      15 [-]: GETIMPORT R6 12 [0x3630E649]
      16 [-]: MOVE R7 R4   
      17 [-]: MOVE R8 R5   
      18 [-]: CALL R6 2 1  
      19 [-]: GETIMPORT R8 12 [0x3630E649]
      20 [-]: LOADN R9 1   
      21 [-]: LENGTH R10 R1
      22 [-]: CALL R8 2 1  
      23 [-]: GETTABLE R7 R1 R8
      24 [-]: GETIMPORT R8 14 [0x0469F296]
      ...
      38 [-]: MOVE R12 R9  
      39 [-]: GETIMPORT R11 18 [0x7B998233]
      40 [-]: CALL R11 1 1 
...
L 1:  45 [-]: FASTCALL1 62 R10 L2
      46 [-]: MOVE R12 R10 
      47 [-]: GETIMPORT R11 18 [0x7B998233]
      48 [-]: CALL R11 1 1 
L 2:  49 [-]: JUMPIF R11 L3
      ...
      58 [-]: GETIMPORT R11 12 [0x3630E649]
      59 [-]: LOADN R12 1  
      60 [-]: LENGTH R13 R1
      61 [-]: CALL R11 2 1 
      62 [-]: GETTABLE R7 R1 R11
      63 [-]: GETIMPORT R11 12 [0x3630E649]
      64 [-]: MOVE R12 R4  
      65 [-]: MOVE R13 R5  
      66 [-]: CALL R11 2 1 
      67 [-]: MOVE R6 R11  
...
L 3:  25 [-]: NAMECALL R5 R1 K10 [0xF37943FF]
      ...
      30 [-]: CALL R5 1 0  
      31 [-]: JUMPBACK L3  
L 4:  32 [-]: GETIMPORT R5 14 [0xBE190284]
      33 [-]: GETUPVAL R8 0
      34 [-]: LOADN R9 0   
      35 [-]: NAMECALL R6 R5 K15 [0x0EB34C69]
      36 [-]: CALL R6 3 1  
      37 [-]: GETIMPORT R7 17 [0x8E8F081A]
      38 [-]: JUMPIFNOTLE R7 R6 L5
      39 [-]: RETURN R0 0  
L 5:  40 [-]: GETIMPORT R7 19 [0x14459A1C]
      41 [-]: JUMPIF R7 L8 
L 6:  42 [-]: GETIMPORT R8 22 ["musicTimer"]
      43 [-]: FASTCALL1 62 R8 L7
      44 [-]: GETIMPORT R7 5 [0x7B998233]
      45 [-]: CALL R7 1 1  
L 7:  46 [-]: JUMPIFNOT R7 L8
      47 [-]: GETIMPORT R7 12 [0xCBD666E1]
      48 [-]: LOADN R8 1   
      49 [-]: CALL R7 1 0  
      50 [-]: JUMPBACK L6  
L 8:  51 [-]: GETIMPORT R7 24 [0x2B389BF9]
...
L10:  81 [-]: MOVE R16 R13 
      ...
      86 [-]: GETIMPORT R15 29 [0x69838949]
...
L13:  96 [-]: LENGTH R11 R10
      ...
      98 [-]: RETURN R0 0  
L14:  99 [-]: GETIMPORT R11 17 [0x8E8F081A]
...
L15: 112 [-]: LOADB R14 1  
     ...
     118 [-]: GETIMPORT R12 38 [0xC8802016]
     119 [-]: MOVE R13 R10 
     120 [-]: CALL R12 1 3 
     121 [-]: FORGPREP_INEXT R12 L18
L16: 122 [-]: JUMPIFNOTEQ R16 R11 L18
     123 [-]: GETIMPORT R17 40 [0x9C1F3B5A]
     124 [-]: MOVE R18 R10 
     125 [-]: MOVE R19 R15 
     126 [-]: CALL R17 2 0 
     127 [-]: GETIMPORT R17 43 [0x3630E649]
     128 [-]: CALL R17 0 1 
     ...
     137 [-]: MOVE R19 R4  
     138 [-]: CALL R17 2 0 
     139 [-]: GETIMPORT R7 24 [0x2B389BF9]
     140 [-]: JUMP L18
    
L17: 141 [-]: GETIMPORT R18 17 [0x8E8F081A]
     142 [-]: SUBK R17 R18 K44 [1]
     143 [-]: JUMPIFNOTLT R6 R17 L18
     144 [-]: GETIMPORT R17 47 [0x2959E287]
     145 [-]: ADD R7 R7 R17
L18: 146 [-]: FORGLOOP R12 L16 2 [inext]
L19: 147 [-]: GETIMPORT R12 12 [0xCBD666E1]
...
L21: 154 [-]: GETIMPORT R9 17 [0x8E8F081A]
     155 [-]: JUMPIFNOTLT R6 R9 L25
     156 [-]: GETIMPORT R9 1 [0x89326C93]
...
L22: 165 [-]: LOADB R11 1  
     ...
     171 [-]: GETIMPORT R9 43 [0x3630E649]
     172 [-]: CALL R9 0 1  
     ...
     181 [-]: MOVE R11 R4  
     182 [-]: CALL R9 2 0  
     183 [-]: GETIMPORT R7 24 [0x2B389BF9]
     184 [-]: GETIMPORT R9 12 [0xCBD666E1]
     185 [-]: GETIMPORT R10 50 [0xE39E7096]
     186 [-]: CALL R9 1 0  
     187 [-]: JUMP L24
    
L23: 188 [-]: GETIMPORT R10 17 [0x8E8F081A]
     189 [-]: SUBK R9 R10 K44 [1]
     190 [-]: JUMPIFNOTLT R6 R9 L24
     191 [-]: GETIMPORT R9 47 [0x2959E287]
     192 [-]: ADD R7 R7 R9 
L24: 193 [-]: GETIMPORT R9 12 [0xCBD666E1]
     194 [-]: GETIMPORT R10 52 [0x8AED8073]
     195 [-]: CALL R9 1 0  
     196 [-]: JUMPBACK L21 
L25: 197 [-]: RETURN R0 0  
