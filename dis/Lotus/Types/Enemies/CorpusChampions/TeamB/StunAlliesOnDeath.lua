...
L 0:   4 [-]: JUMPIFNOT R1 L1
       5 [-]: RETURN R0 0  
L 1:   6 [-]: GETIMPORT R3 3 ["gRagdollType"]
...
L 5:  33 [-]: JUMPIF R3 L16
      ...
      37 [-]: GETIMPORT R3 13 [0xA421AF95]
      38 [-]: CALL R3 0 1  
      39 [-]: NAMECALL R4 R0 K14 [0xF6EBD926]
      40 [-]: CALL R4 1 1  
      41 [-]: GETIMPORT R5 17 [0x35C16153]
      42 [-]: CALL R5 0 1  
      43 [-]: GETIMPORT R6 19 [0x9B5DDF0B]
      44 [-]: SETTABLEKS R6 R5 K20 ["baseAmount"]
      45 [-]: LOADN R8 5   
      46 [-]: LOADN R9 1   
      47 [-]: NAMECALL R6 R5 K21 [0x1586E35E]
      48 [-]: CALL R6 3 0  
      49 [-]: GETIMPORT R8 23 [0x5EBB02A2]
      50 [-]: LOADB R9 1   
      51 [-]: NAMECALL R6 R5 K24 [0xFC0E440A]
      52 [-]: CALL R6 3 0  
      53 [-]: GETIMPORT R8 26 [0xD2B462B0]
      54 [-]: LOADB R9 1   
...
L 7:  66 [-]: JUMPIF R10 L11
      ...
      69 [-]: CALL R10 1 1 
      70 [-]: JUMPIF R10 L11
      71 [-]: GETIMPORT R10 10 [0x89326C93]
      ...
      78 [-]: CALL R10 2 0 
L 8:  79 [-]: GETIMPORT R11 31 [0x4E452188]
...
L 9:  83 [-]: JUMPIF R10 L11
      ...
      89 [-]: CALL R10 4 1 
      90 [-]: MOVE R3 R10  
      91 [-]: GETIMPORT R10 34 [0xAE2294FA]
      92 [-]: MOVE R11 R3  
      93 [-]: CALL R10 1 1 
      94 [-]: LOADK R11 K35 [0.10000000000000001]
      95 [-]: JUMPIFNOTLT R11 R10 L11
      96 [-]: GETIMPORT R12 31 [0x4E452188]
      97 [-]: GETIMPORT R13 37 ["EMPTY_SYMBOL"]
      98 [-]: GETIMPORT R14 13 [0xA421AF95]
      99 [-]: LOADN R15 0  
     100 [-]: LOADK R16 K38 [0.90000000000000002]
     101 [-]: LOADN R17 0  
     102 [-]: CALL R14 3 1 
     103 [-]: GETIMPORT R15 40 ["ZERO_ROTATION"]
     104 [-]: MOVE R16 R0  
...
L10: 111 [-]: JUMPIF R11 L11
     112 [-]: GETIMPORT R13 43 [0xA68CD094]
     ...
     119 [-]: MOVE R12 R6  
     120 [-]: MOVE R13 R10 
     121 [-]: GETIMPORT R11 48 [0x23D5322F]
     122 [-]: CALL R11 2 0 
L11: 123 [-]: FORNLOOP R7 L6
L12: 124 [-]: GETIMPORT R7 50 [0xCBD666E1]
     125 [-]: GETIMPORT R8 52 [0xFD8C7F61]
     126 [-]: CALL R7 1 0  
     127 [-]: LOADN R9 1   
     128 [-]: LENGTH R7 R6 
     129 [-]: LOADN R8 1   
