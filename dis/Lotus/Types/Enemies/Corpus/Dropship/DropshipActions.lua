...
; Max Stack Size:  28
 ...
 10 [-]: LOADK     R3 -2147483648; R3 := 2147483648.000000
 ...
 17 [-]: LOADK     R8 17        ; R8 := 17.000000
 18 [-]: LOADK     R9 13        ; R9 := 13.000000
 19 [-]: SETLIST   R5 4 1       ; R5[(1-1)*FPF+i] := R(5+i), 1 <= i <= 4
 20 [-]: LOADK     R6 180       ; R6 := 180.000000
 21 [-]: LOADK     R7 300       ; R7 := 300.000000
 ...
 40 [-]: LOADK     R16 20       ; R16 := 20.000000
 41 [-]: LOADK     R17 40       ; R17 := 40.000000
 42 [-]: LOADK     R18 5        ; R18 := 5.000000
 43 [-]: LOADK     R19 2        ; R19 := 2.000000
 44 [-]: LOADK     R20 7        ; R20 := 7.000000
...
; Max Stack Size:  13
 ...
 50 [-]: GETTABLE  R8 R8 K21    ; R82 := R8[0x9dc3bebe]
 ...
 71 [-]: GETTABLE  R9 R9 K26    ; R82 := R9[0xc9890f54]
...
; Max Stack Size:  19
 ...
 98 [-]: GETTABLE  R12 R12 K14  ; R82 := R12[0x20251605]
...
164 [-]: GETTABLE  R14 R14 K24  ; R82 := R14[0xc48556bc]
...
205 [-]: GETTABLE  R14 R14 K32  ; R82 := R14[0xe0feaa27]
...
218 [-]: LOADBOOL  R16 0 0      ; R16 := false
...
190 [-]: JMP       193          ; PC := 193
191 [-]: LOADBOOL  R18 0 0      ; R18 := false
...
; Max Stack Size:  25
 ...
 47 [-]: GETTABLE  R9 R9 K8     ; R82 := R9[0xc9890f54]
 ...
 63 [-]: GETTABLE  R10 R10 K13  ; R82 := R10[0x5e35d4d6]
...
; Max Stack Size:  8
 ...
 35 [-]: GETTABLE  R4 R4 K5     ; R82 := R4[0xc9890f54]
 36 [-]: MOVE      R5 R3        ; R5 := R3
...
111 [-]: GETTABLE  R13 R13 K20  ; R82 := R13[0xc9890f54]
...
; Max Stack Size:  13
 ...
 60 [-]: GETTABLE  R6 R6 K14    ; R82 := R6[0xc9890f54]
 61 [-]: MOVE      R7 R5        ; R7 := R5
 ...
 82 [-]: GETTABLE  R8 R8 K14    ; R82 := R8[0xc9890f54]
 83 [-]: MOVE      R9 R7        ; R9 := R7
 ...
 93 [-]: GETTABLE  R9 R9 K14    ; R82 := R9[0xc9890f54]
...
; Max Stack Size:  8
 ...
 20 [-]: GETTABLE  R1 R1 K6     ; R82 := R1[0x0deacd54]
 ...
 79 [-]: GETTABLE  R4 R4 K18    ; R82 := R4[0xc9890f54]
 80 [-]: MOVE      R5 R3        ; R5 := R3
...
127 [-]: LOADBOOL  R10 0 0      ; R10 := false
