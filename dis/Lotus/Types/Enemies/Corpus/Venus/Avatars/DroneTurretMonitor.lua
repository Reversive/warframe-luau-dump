...
; Max Stack Size:  15
       ...
       1 [-]: CALL R3 1 1  
       2 [-]: GETIMPORT R5 3 ["VenusTurretDrones"]
       3 [-]: FASTCALL1 62 R5 L0
       4 [-]: GETIMPORT R4 5 [0x7B998233]
       5 [-]: CALL R4 1 1  
L 0:   6 [-]: JUMPIF R4 L2 
       7 [-]: GETIMPORT R6 3 ["VenusTurretDrones"]
       8 [-]: GETTABLE R5 R6 R3
       9 [-]: FASTCALL1 62 R5 L1
      10 [-]: GETIMPORT R4 5 [0x7B998233]
      11 [-]: CALL R4 1 1  
L 1:  12 [-]: JUMPIF R4 L2 
      13 [-]: GETIMPORT R5 3 ["VenusTurretDrones"]
...
L 4:  31 [-]: NAMECALL R7 R5 K9 [0xD1586535]
      ...
      40 [-]: LOADN R7 1   
      41 [-]: RETURN R7 1  
L 5:  42 [-]: GETIMPORT R7 14 [0xC2892F65]
      43 [-]: MOVE R8 R6   
      44 [-]: CALL R7 1 0  
      45 [-]: NAMECALL R7 R1 K15 [0x40272000]
      46 [-]: CALL R7 1 1  
      47 [-]: GETIMPORT R11 17 [0x42DCC9F5]
      48 [-]: GETTABLEKS R12 R6 K12 ["z"]
      49 [-]: LOADN R13 -1 
      50 [-]: LOADN R14 1  
      51 [-]: CALL R11 3 1 
      52 [-]: FASTCALL1 3 R11 L6
      53 [-]: GETIMPORT R10 20 [0x450C9504]
      54 [-]: CALL R10 1 1 
L 6:  55 [-]: FASTCALL1 10 R10 L7
      56 [-]: GETIMPORT R9 22 [0xBF79B942]
      57 [-]: CALL R9 1 1  
...
L11:  80 [-]: SUB R9 R10 R11
      81 [-]: GETIMPORT R10 27 [0x357B2DFA]
      82 [-]: JUMPIFNOTLE R9 R10 L12
      83 [-]: GETIMPORT R11 27 [0x357B2DFA]
      84 [-]: MINUS R10 R11
...
; Max Stack Size:  14
      ...
      12 [-]: CALL R5 1 1  
      13 [-]: GETIMPORT R8 8 [0xE10E2947]
      14 [-]: NAMECALL R6 R1 K9 [0x003C792F]
      15 [-]: CALL R6 2 1  
      16 [-]: GETIMPORT R7 4 [0x89326C93]
      17 [-]: GETIMPORT R9 11 [0x8BBD6689]
      18 [-]: MOVE R10 R6  
      19 [-]: MOVE R11 R5  
      ...
      25 [-]: CALL R8 -1 0 
      26 [-]: GETIMPORT R10 16 [0x614C03A1]
      ...
      38 [-]: CALL R8 2 0  
      39 [-]: GETIMPORT R8 23 [0x492C7F2A]
      40 [-]: GETIMPORT R9 25 [0xB531E758]
      41 [-]: MOVE R10 R5  
      42 [-]: CALL R8 2 1  
      ...
      47 [-]: CALL R9 2 0  
      48 [-]: GETIMPORT R10 30 ["VenusTurretDrones"]
      49 [-]: FASTCALL1 62 R10 L0
      50 [-]: GETIMPORT R9 32 [0x7B998233]
      51 [-]: CALL R9 1 1  
L 0:  52 [-]: JUMPIFNOT R9 L1
      53 [-]: GETIMPORT R9 33 ["_T"]
      54 [-]: NEWTABLE R10 0 0
      55 [-]: SETTABLEKS R10 R9 K29 ["VenusTurretDrones"]
L 1:  56 [-]: NAMECALL R9 R1 K34 [0x388577D5]
      57 [-]: CALL R9 1 1  
      58 [-]: GETIMPORT R10 30 ["VenusTurretDrones"]
...
L 1:  10 [-]: JUMPIFNOT R2 L4
      11 [-]: GETIMPORT R2 7 [0x67652851]
      12 [-]: CALL R2 0 1  
      13 [-]: ADD R1 R1 R2 
      14 [-]: LOADN R2 5   
      15 [-]: JUMPIFNOTLT R2 R1 L2
      16 [-]: RETURN R0 0  
L 2:  17 [-]: GETIMPORT R2 9 [0xCBD666E1]
      18 [-]: LOADN R3 0   
      19 [-]: CALL R2 1 0  
      20 [-]: JUMPBACK L0  
      21 [-]: JUMP L4
     
L 3:  22 [-]: GETIMPORT R1 9 [0xCBD666E1]
      23 [-]: LOADN R2 0   
      24 [-]: CALL R1 1 0  
L 4:  25 [-]: FASTCALL1 62 R0 L5
      26 [-]: MOVE R2 R0   
      27 [-]: GETIMPORT R1 5 [0x7B998233]
      28 [-]: CALL R1 1 1  
...
L14:  79 [-]: JUMPIF R4 L15
      ...
      81 [-]: CALL R4 1 0  
L15:  82 [-]: GETIMPORT R4 1 [0x89326C93]
      83 [-]: NAMECALL R4 R4 K2 [0x18D05D30]
      84 [-]: CALL R4 1 1  
      85 [-]: JUMPIFNOT R4 L18
      86 [-]: GETIMPORT R5 25 ["VenusTurretDrones"]
      87 [-]: FASTCALL1 62 R5 L16
      88 [-]: GETIMPORT R4 5 [0x7B998233]
      89 [-]: CALL R4 1 1  
L16:  90 [-]: JUMPIF R4 L17
      91 [-]: GETIMPORT R4 25 ["VenusTurretDrones"]
      92 [-]: LOADNIL R5   
