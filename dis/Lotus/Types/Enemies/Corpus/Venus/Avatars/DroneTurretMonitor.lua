...
L 7:  58 [-]: GETUPVAL R11 0; var11 = upvalues[0]
      ...
      62 [-]: JUMPIFLE R13 R12 L8; goto L8 if var13 <= var16780038
...
L 1:  10 [-]: JUMPIFNOT R2 L4; goto L4 if not var2
      ...
      15 [-]: JUMPIFNOTLT R2 R1 L2; goto L2 if var2 >= var65571
      16 [-]: RETURN R0 0  ; 
