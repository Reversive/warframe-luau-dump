...
; Max Stack Size:  13
       ...
       0 [-]: GETIMPORT R3 1 [0xE734D0BD]
       1 [-]: GETIMPORT R4 3 [0x191FF3FA]
       2 [-]: GETTABLE R2 R3 R4
...
L 1:   9 [-]: NAMECALL R3 R0 K6 [0xF6EBD926]
      ...
      17 [-]: RETURN R1 1  
L 2:  18 [-]: GETIMPORT R6 10 [0xA421AF95]
      19 [-]: LOADN R7 0   
      20 [-]: LOADK R8 K11 [0.10000000000000001]
      21 [-]: LOADN R9 0   
      22 [-]: CALL R6 3 1  
      23 [-]: ADD R5 R3 R6 
      24 [-]: GETIMPORT R6 13 [0x89326C93]
      25 [-]: MOVE R8 R2   
      26 [-]: MOVE R9 R5   
...
L 3:  19 [-]: NAMECALL R4 R2 K5 [0xFF005826]
      ...
      30 [-]: GETIMPORT R6 12 [0xEE5605A8]
      31 [-]: JUMP L5
     
L 4:  32 [-]: GETIMPORT R6 14 [0x663A9D95]
...
L 7:  44 [-]: JUMPIF R8 L8 
      45 [-]: LOADB R10 1  
      46 [-]: GETIMPORT R11 17 [0x0469F296]
...
L13:  79 [-]: NAMECALL R6 R1 K23 [0x6F8BABF9]
      ...
      85 [-]: CALL R6 0 1  
      86 [-]: ADD R5 R5 R6 
      87 [-]: GETIMPORT R6 1 [0xCBD666E1]
      88 [-]: LOADN R7 0   
      89 [-]: CALL R6 1 0  
      90 [-]: JUMPBACK L13 
L14:  91 [-]: GETIMPORT R6 7 [0x89326C93]
      92 [-]: NAMECALL R6 R6 K8 [0x18D05D30]
      93 [-]: CALL R6 1 1  
      94 [-]: JUMPIFNOT R6 L17
      95 [-]: FASTCALL1 62 R4 L15
      96 [-]: MOVE R7 R4   
      97 [-]: GETIMPORT R6 4 [0x7B998233]
      98 [-]: CALL R6 1 1  
L15:  99 [-]: JUMPIF R6 L17
     ...
     103 [-]: MOVE R8 R6   
     104 [-]: GETIMPORT R7 4 [0x7B998233]
     105 [-]: CALL R7 1 1  
L16: 106 [-]: JUMPIF R7 L17
     107 [-]: LOADB R9 0   
     108 [-]: GETIMPORT R10 17 [0x0469F296]
...
; Max Stack Size:  10
       ...
       9 [-]: CALL R2 1 1  
L 0:  10 [-]: JUMPIF R2 L2 
      11 [-]: GETIMPORT R4 8 ["gLotusVehicleAvatarType"]
...
L 1:  21 [-]: JUMPIF R3 L2 
      22 [-]: MOVE R5 R2   
      23 [-]: GETIMPORT R6 12 ["ZERO_VECTOR"]
      24 [-]: LOADB R7 1   
      25 [-]: NAMECALL R3 R1 K13 [0xCAA5DE6D]
      26 [-]: CALL R3 4 0  
      27 [-]: GETIMPORT R3 15 [0xCBD666E1]
      28 [-]: LOADN R4 0   
      29 [-]: CALL R3 1 0  
