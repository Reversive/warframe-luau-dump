...
205 [-]: LOADBOOL  R14 0 0      ; R14 := false
...
212 [-]: LOADK     R15 2        ; R15 := 2.000000
213 [-]: LOADK     R16 2        ; R16 := 2.000000
214 [-]: LOADBOOL  R17 1 0      ; R17 := true
...
231 [-]: LOADBOOL  R14 0 0      ; R14 := false
232 [-]: LOADK     R15 2        ; R15 := 2.000000
233 [-]: LOADK     R16 2        ; R16 := 2.000000
234 [-]: LOADBOOL  R17 1 0      ; R17 := true
...
; Max Stack Size:  10
 ...
 10 [-]: JMP       107          ; PC := 107
 11 [-]: TEST      R2 0         ; if not R2 then PC := 90
 12 [-]: JMP       90           ; PC := 90
 ...
 29 [-]: SELF      R3 R1 K8     ; R4 := R1; R3 := R1[0x47901f07]
 30 [-]: GETGLOBAL R5 K9        ; R5 := 0xeeae2709
 31 [-]: GETGLOBAL R6 K2        ; R6 := 0x0469f296
 32 [-]: LOADK     R7 K10       ; R7 := "GAME_C1_NECK1"
 33 [-]: CALL      R6 2 0       ; R6,... := R6(R7)
 34 [-]: CALL      R3 0 1       ; R3(R4,...)
 35 [-]: SELF      R3 R1 K11    ; R4 := R1; R3 := R1[0xc9f6a7d7]
 36 [-]: GETGLOBAL R5 K12       ; R5 := 0xdcd428b2
 37 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 38 [-]: SELF      R4 R1 K11    ; R5 := R1; R4 := R1[0xc9f6a7d7]
 39 [-]: GETGLOBAL R6 K13       ; R6 := 0x1cd42e54
 40 [-]: CALL      R4 3 2       ; R4 := R4(R5,R6)
 41 [-]: SELF      R5 R1 K11    ; R6 := R1; R5 := R1[0xc9f6a7d7]
 42 [-]: GETGLOBAL R7 K14       ; R7 := 0xb9d48530
 ...
 48 [-]: JMP       53           ; PC := 53
 49 [-]: GETGLOBAL R6 K15       ; R6 := 0x89326c93
 50 [-]: SELF      R6 R6 K16    ; R7 := R6; R6 := R6[0x59c96e77]
 51 [-]: MOVE      R8 R3        ; R8 := R3
 ...
 57 [-]: JMP       62           ; PC := 62
 58 [-]: GETGLOBAL R6 K15       ; R6 := 0x89326c93
 59 [-]: SELF      R6 R6 K16    ; R7 := R6; R6 := R6[0x59c96e77]
 60 [-]: MOVE      R8 R4        ; R8 := R4
 ...
 66 [-]: JMP       71           ; PC := 71
 67 [-]: GETGLOBAL R6 K15       ; R6 := 0x89326c93
 68 [-]: SELF      R6 R6 K16    ; R7 := R6; R6 := R6[0x59c96e77]
 69 [-]: MOVE      R8 R5        ; R8 := R5
 70 [-]: CALL      R6 3 1       ; R6(R7,R8)
 71 [-]: SELF      R6 R1 K17    ; R7 := R1; R6 := R1[0x10ba8e3e]
 72 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 73 [-]: TEST      R6 1         ; if R6 then PC := 79
 74 [-]: JMP       79           ; PC := 79
 75 [-]: SELF      R6 R0 K17    ; R7 := R0; R6 := R0[0x10ba8e3e]
 76 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 77 [-]: TEST      R6 0         ; if not R6 then PC := 83
 78 [-]: JMP       83           ; PC := 83
 79 [-]: GETGLOBAL R6 K18       ; R6 := 0xcbd666e1
 80 [-]: LOADK     R7 0         ; R7 := 0.000000
 81 [-]: CALL      R6 2 1       ; R6(R7)
 82 [-]: JMP       71           ; PC := 71
 83 [-]: SELF      R6 R1 K19    ; R7 := R1; R6 := R1[0xd5f7912b]
 84 [-]: GETGLOBAL R8 K2        ; R8 := 0x0469f296
 85 [-]: LOADK     R9 K20       ; R9 := "turnFriendly"
 86 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 87 [-]: LOADBOOL  R9 0 0       ; R9 := false
 88 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
 89 [-]: JMP       99           ; PC := 99
 90 [-]: GETGLOBAL R6 K18       ; R6 := 0xcbd666e1
 91 [-]: LOADK     R7 1         ; R7 := 1.000000
 92 [-]: CALL      R6 2 1       ; R6(R7)
 93 [-]: SELF      R6 R1 K19    ; R7 := R1; R6 := R1[0xd5f7912b]
 94 [-]: GETGLOBAL R8 K2        ; R8 := 0x0469f296
 95 [-]: LOADK     R9 K21       ; R9 := "failedRescue"
 96 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 97 [-]: LOADBOOL  R9 0 0       ; R9 := false
 98 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
 99 [-]: GETGLOBAL R6 K15       ; R6 := 0x89326c93
100 [-]: SELF      R6 R6 K22    ; R7 := R6; R6 := R6[0x29ef273d]
101 [-]: CALL      R6 2 2       ; R6 := R6(R7)
102 [-]: SELF      R7 R6 K23    ; R8 := R6; R7 := R6[0x66905cb0]
103 [-]: CALL      R7 2 2       ; R7 := R7(R8)
104 [-]: SELF      R7 R7 K24    ; R8 := R7; R7 := R7[0xb8b90f91]
