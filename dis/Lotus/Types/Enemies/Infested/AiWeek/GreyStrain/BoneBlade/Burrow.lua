...
; Max Stack Size:  5
       ...
       9 [-]: CALL R1 3 0  
L 0:  10 [-]: GETIMPORT R1 6 [0x9BA7909F]
      11 [-]: GETUPVAL R3 1
      12 [-]: NAMECALL R1 R1 K7 [0x5374B92E]
      13 [-]: CALL R1 2 1  
      14 [-]: JUMPIFNOT R1 L1
      15 [-]: GETIMPORT R3 9 [0xF0A45DE2]
      16 [-]: GETIMPORT R4 11 ["EMPTY_SYMBOL"]
      17 [-]: NAMECALL R1 R0 K12 [0x47901F07]
      18 [-]: CALL R1 3 0  
      19 [-]: RETURN R0 0  
L 1:  20 [-]: GETIMPORT R3 14 [0xCFCB8785]
      21 [-]: GETIMPORT R4 11 ["EMPTY_SYMBOL"]
...
; Max Stack Size:  17
       ...
       6 [-]: JUMPIF R1 L0 
       7 [-]: RETURN R0 0  
L 0:   8 [-]: GETIMPORT R1 4 [0xB009BBC6]
...
L 2:  66 [-]: MOVE R11 R1  
      ...
      68 [-]: GETIMPORT R13 27 [0xA421AF95]
      69 [-]: LOADN R14 0  
      ...
      78 [-]: MOVE R11 R9  
      79 [-]: GETIMPORT R10 25 [0x7B998233]
      80 [-]: CALL R10 1 1 
...
L 5:  36 [-]: JUMPIF R4 L6 
      ...
      38 [-]: CALL R4 1 1  
      39 [-]: JUMPIF R4 L6 
      40 [-]: GETIMPORT R4 2 [0xCBD666E1]
      41 [-]: LOADK R5 K8 [0.10000000000000001]
      42 [-]: CALL R4 1 0  
      43 [-]: JUMPBACK L4  
L 6:  44 [-]: GETIMPORT R6 10 [0x1D43B3E9]
...
L 7:  51 [-]: JUMPIFNOT R4 L8
      52 [-]: RETURN R0 0  
L 8:  53 [-]: GETIMPORT R4 13 [0x89326C93]
      54 [-]: GETIMPORT R6 15 [0xCFCB8785]
      55 [-]: NAMECALL R7 R1 K16 [0xD1586535]
      56 [-]: CALL R7 1 1  
      57 [-]: GETIMPORT R8 18 ["ZERO_ROTATION"]
      58 [-]: MOVE R9 R1   
      59 [-]: MOVE R10 R1  
...
L 9:  63 [-]: LOADN R4 5   
      ...
      65 [-]: GETIMPORT R4 2 [0xCBD666E1]
      66 [-]: LOADN R5 0   
      67 [-]: CALL R4 1 0  
      68 [-]: GETIMPORT R4 4 [0x67652851]
      69 [-]: CALL R4 0 1  
      70 [-]: ADD R2 R2 R4 
      71 [-]: JUMPBACK L9  
L10:  72 [-]: GETIMPORT R4 13 [0x89326C93]
      73 [-]: NAMECALL R4 R4 K20 [0x18D05D30]
      74 [-]: CALL R4 1 1  
      75 [-]: JUMPIFNOT R4 L12
      76 [-]: FASTCALL1 62 R0 L11
      77 [-]: MOVE R5 R0   
      78 [-]: GETIMPORT R4 6 [0x7B998233]
      79 [-]: CALL R4 1 1  
