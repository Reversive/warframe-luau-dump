...
L 1:  20 [-]: JUMPIFNOTLT R3 R0 L2
      21 [-]: GETIMPORT R5 12 ["gStopCameraShake"]
      22 [-]: JUMPIF R5 L2 
      23 [-]: GETTABLEKS R5 R4 K13 ["postProcess"]
      24 [-]: GETIMPORT R8 15 [0x7FA0B32A]
      25 [-]: GETIMPORT R9 17 [0xDC4F8F5C]
      26 [-]: MOVE R10 R3  
      27 [-]: CALL R9 1 -1 
      28 [-]: CALL R8 -1 1 
      29 [-]: MUL R7 R8 R1 
      ...
      31 [-]: CALL R5 2 0  
      32 [-]: GETIMPORT R5 20 [0x67652851]
      33 [-]: CALL R5 0 1  
      34 [-]: ADD R3 R3 R5 
      35 [-]: GETIMPORT R5 22 [0xCBD666E1]
      36 [-]: LOADN R6 0   
      37 [-]: CALL R5 1 0  
      38 [-]: JUMPBACK L1  
...
; Max Stack Size:  9
       ...
       0 [-]: LOADN R2 1   
       1 [-]: GETIMPORT R3 1 [0x7A70CDCA]
       2 [-]: LENGTH R0 R3 
       3 [-]: LOADN R1 1   
       4 [-]: FORNPREP R0 L6
L 0:   5 [-]: GETIMPORT R3 3 [0xCBD666E1]
       6 [-]: GETIMPORT R5 5 [0xFE967DE6]
       7 [-]: GETTABLE R4 R5 R2
       8 [-]: CALL R3 1 0  
       9 [-]: GETIMPORT R5 7 [0x96A448C5]
      10 [-]: GETTABLE R4 R5 R2
      11 [-]: FASTCALL1 62 R4 L1
      12 [-]: GETIMPORT R3 9 [0x7B998233]
      13 [-]: CALL R3 1 1  
L 1:  14 [-]: JUMPIF R3 L2 
      15 [-]: GETIMPORT R4 7 [0x96A448C5]
      16 [-]: GETTABLE R3 R4 R2
      17 [-]: LOADK R5 K10 ["Enable"]
      18 [-]: NAMECALL R3 R3 K11 [0x8EB2112D]
      19 [-]: CALL R3 2 0  
L 2:  20 [-]: GETIMPORT R5 1 [0x7A70CDCA]
...
L 3:  25 [-]: JUMPIF R3 L4 
      ...
      27 [-]: GETIMPORT R6 1 [0x7A70CDCA]
      28 [-]: GETTABLE R5 R6 R2
      29 [-]: GETIMPORT R6 15 [0xE464D591]
      30 [-]: NAMECALL R6 R6 K16 [0xD1586535]
      31 [-]: CALL R6 1 1  
      32 [-]: LOADB R7 0   
      33 [-]: NAMECALL R3 R3 K17 [0x659D451F]
      34 [-]: CALL R3 4 0  
L 4:  35 [-]: GETIMPORT R3 13 [0x89326C93]
      36 [-]: NAMECALL R3 R3 K18 [0x18D05D30]
      37 [-]: CALL R3 1 1  
      38 [-]: JUMPIFNOT R3 L5
      39 [-]: GETIMPORT R4 1 [0x7A70CDCA]
      40 [-]: LENGTH R3 R4 
      41 [-]: JUMPIFNOTEQ R2 R3 L5
      42 [-]: GETIMPORT R3 20 [0xD9F018B6]
      43 [-]: JUMPIFNOT R3 L5
      44 [-]: GETIMPORT R3 22 [0x9C4A1CD5]
      45 [-]: LOADK R5 K10 ["Enable"]
      46 [-]: NAMECALL R3 R3 K11 [0x8EB2112D]
      47 [-]: CALL R3 2 0  
L 5:  48 [-]: GETUPVAL R3 0
      49 [-]: GETIMPORT R5 24 [0x6E52C156]
      50 [-]: GETTABLE R4 R5 R2
      51 [-]: GETIMPORT R6 26 [0x9FE820D4]
      52 [-]: GETTABLE R5 R6 R2
      53 [-]: GETIMPORT R7 28 [0x87738833]
      54 [-]: GETTABLE R6 R7 R2
      55 [-]: CALL R3 3 0  
      56 [-]: FORNLOOP R0 L0
L 6:  57 [-]: GETIMPORT R0 13 [0x89326C93]
      58 [-]: NAMECALL R0 R0 K18 [0x18D05D30]
      59 [-]: CALL R0 1 1  
      60 [-]: JUMPIF R0 L7 
      61 [-]: RETURN R0 0  
L 7:  62 [-]: GETIMPORT R0 3 [0xCBD666E1]
      63 [-]: GETIMPORT R1 30 [0xC84E5CDD]
      64 [-]: CALL R0 1 0  
      65 [-]: GETIMPORT R0 13 [0x89326C93]
      66 [-]: GETIMPORT R2 32 [0x3F2C0286]
      67 [-]: GETIMPORT R3 15 [0xE464D591]
...
L11:  87 [-]: GETIMPORT R1 13 [0x89326C93]
...
L12:  94 [-]: GETTABLE R5 R1 R4
      95 [-]: GETIMPORT R7 37 [0x83F08796]
      96 [-]: NAMECALL R5 R5 K38 [0xF2DEAF69]
      97 [-]: CALL R5 2 1  
      98 [-]: JUMPIFNOT R5 L13
      99 [-]: GETTABLE R5 R1 R4
     100 [-]: GETIMPORT R7 40 ["gLotusSentinelAvatarType"]
...
L14: 108 [-]: GETIMPORT R2 13 [0x89326C93]
...
L15: 115 [-]: GETTABLE R6 R2 R5
     116 [-]: GETIMPORT R8 43 ["gLotusOperatorAvatarType"]
