...
L 1:   9 [-]: JUMPIF R2 L2 
      ...
      12 [-]: JUMPIFNOT R2 L3
L 2:  13 [-]: RETURN R0 0  
L 3:  14 [-]: GETIMPORT R3 4 [0x483E0E58]
...
L 7:  30 [-]: JUMPIF R3 L8 
      ...
      32 [-]: GETIMPORT R5 8 ["gLotusAvatarType"]
...
L10:  38 [-]: NAMECALL R4 R2 K10 [0xF7F0D585]
      ...
      51 [-]: RETURN R0 0  
L11:  52 [-]: JUMPBACK L10 
L12:  53 [-]: GETIMPORT R6 4 [0x483E0E58]
      54 [-]: LOADB R7 0   
...
L13:  61 [-]: JUMPIFNOT R5 L14
      ...
      65 [-]: CALL R5 1 0  
      66 [-]: RETURN R0 0  
L14:  67 [-]: GETIMPORT R7 18 [0x88B962B8]
...
L20: 104 [-]: GETIMPORT R7 12 [0xCBD666E1]
     105 [-]: LOADN R8 0   
     106 [-]: CALL R7 1 0  
     107 [-]: JUMPBACK L19 
...
; Max Stack Size:  4
       ...
       1 [-]: CALL R1 0 1  
L 0:   2 [-]: GETIMPORT R3 1 [0x55156FF7]
       3 [-]: CALL R3 0 1  
       4 [-]: SUB R2 R3 R1 
       5 [-]: GETIMPORT R3 3 [0x94FD2679]
...
L 7:  35 [-]: JUMPIF R2 L8 
      ...
      38 [-]: CALL R2 1 0  
      39 [-]: JUMPBACK L5  
L 8:  40 [-]: GETIMPORT R2 7 [0xCBD666E1]
      41 [-]: LOADN R3 0   
      42 [-]: CALL R2 1 0  
...
L 9:  47 [-]: JUMPIF R2 L10
      ...
      49 [-]: CALL R2 1 0  
L10:  50 [-]: RETURN R0 0  
L11:  51 [-]: GETIMPORT R2 7 [0xCBD666E1]
      52 [-]: LOADN R3 0   
      53 [-]: CALL R2 1 0  
      54 [-]: JUMPBACK L0  
      55 [-]: RETURN R0 0  
...
L 2:  10 [-]: LOADB R4 0   
      ...
      12 [-]: CALL R2 2 0  
      13 [-]: GETIMPORT R2 5 [0xBA7D82A1]
      14 [-]: GETIMPORT R3 7 [0x89326C93]
      15 [-]: NAMECALL R3 R3 K8 [0x7C1A0374]
      16 [-]: CALL R3 1 1  
L 3:  17 [-]: LOADN R4 0   
      18 [-]: JUMPIFNOTLT R4 R2 L4
      19 [-]: GETIMPORT R4 10 [0x67652851]
      20 [-]: CALL R4 0 1  
      21 [-]: SUB R2 R2 R4 
      22 [-]: LOADN R7 1   
      23 [-]: GETIMPORT R9 5 [0xBA7D82A1]
      24 [-]: DIV R8 R2 R9 
      25 [-]: SUB R6 R7 R8 
      26 [-]: NAMECALL R4 R3 K11 [0xB6DF3E50]
      27 [-]: CALL R4 2 0  
      28 [-]: GETIMPORT R4 13 [0xCBD666E1]
      29 [-]: LOADN R5 0   
      30 [-]: CALL R4 1 0  
      31 [-]: JUMPBACK L3  
L 4:  32 [-]: GETIMPORT R4 13 [0xCBD666E1]
      33 [-]: LOADN R5 1   
      34 [-]: CALL R4 1 0  
      35 [-]: LOADN R6 0   
