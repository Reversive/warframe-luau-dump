...
L 1:   6 [-]: LOADB R1 0   
       ...
       8 [-]: CALL R2 1 1  
       9 [-]: GETIMPORT R5 4 ["gLotusVehicleAvatarType"]
      10 [-]: NAMECALL R3 R2 K5 [0xF2DEAF69]
      11 [-]: CALL R3 2 1  
      12 [-]: JUMPIF R3 L2 
      13 [-]: RETURN R0 0  
L 2:  14 [-]: LOADNIL R3   
      15 [-]: GETIMPORT R5 7 [0xDFA278D9]
      16 [-]: FASTCALL1 62 R5 L3
      17 [-]: GETIMPORT R4 1 [0x7B998233]
      18 [-]: CALL R4 1 1  
L 3:  19 [-]: JUMPIF R4 L4 
      20 [-]: GETIMPORT R6 7 [0xDFA278D9]
...
L11:  62 [-]: JUMPIF R6 L12
      ...
      64 [-]: CALL R6 1 0  
L12:  65 [-]: MOVE R1 R5   
L13:  66 [-]: GETIMPORT R6 20 [0xCBD666E1]
...
L 2:  14 [-]: NAMECALL R3 R2 K6 [0x020D4331]
      15 [-]: CALL R3 1 1  
      16 [-]: LOADNIL R4   
      17 [-]: GETIMPORT R6 8 [0xDFA278D9]
      18 [-]: FASTCALL1 62 R6 L3
      19 [-]: GETIMPORT R5 1 [0x7B998233]
      20 [-]: CALL R5 1 1  
L 3:  21 [-]: JUMPIF R5 L4 
      22 [-]: GETIMPORT R7 8 [0xDFA278D9]
      23 [-]: GETIMPORT R8 10 ["EMPTY_SYMBOL"]
      24 [-]: GETIMPORT R9 12 ["ZERO_VECTOR"]
      25 [-]: GETIMPORT R10 14 ["ZERO_ROTATION"]
      26 [-]: MOVE R11 R2  
...
L12:  70 [-]: JUMPIF R7 L13
      ...
      72 [-]: CALL R7 1 0  
L13:  73 [-]: GETIMPORT R7 21 [0xCBD666E1]
      74 [-]: LOADN R8 0   
      75 [-]: CALL R7 1 0  
      76 [-]: JUMPBACK L4  
      77 [-]: RETURN R0 0  
