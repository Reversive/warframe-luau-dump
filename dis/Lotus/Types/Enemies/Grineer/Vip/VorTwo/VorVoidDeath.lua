...
L 0:  13 [-]: JUMPIF R2 L1 
      ...
      17 [-]: CALL R2 1 0  
L 1:  18 [-]: GETIMPORT R4 10 [0x78A39459]
...
L 2:  25 [-]: JUMPIF R3 L3 
      ...
      27 [-]: CALL R3 1 0  
L 3:  28 [-]: GETIMPORT R4 12 [0x83F4E77C]
...
L 5:  34 [-]: NAMECALL R3 R0 K13 [0xD1586535]
      ...
      44 [-]: GETUPVAL R6 1
      45 [-]: MOVE R7 R0   
      46 [-]: GETIMPORT R8 21 ["gParticleSysType"]
      47 [-]: CALL R6 2 0  
      48 [-]: GETUPVAL R6 1
      49 [-]: MOVE R7 R5   
      50 [-]: GETIMPORT R8 21 ["gParticleSysType"]
      51 [-]: CALL R6 2 0  
      52 [-]: GETUPVAL R6 1
      53 [-]: MOVE R7 R0   
      54 [-]: GETIMPORT R8 23 ["gLensFlareType"]
      55 [-]: CALL R6 2 0  
      56 [-]: GETUPVAL R6 1
      57 [-]: MOVE R7 R5   
      58 [-]: GETIMPORT R8 23 ["gLensFlareType"]
      59 [-]: CALL R6 2 0  
      60 [-]: GETIMPORT R8 25 [0x84FD0E75]
      61 [-]: GETIMPORT R9 27 ["EMPTY_SYMBOL"]
      62 [-]: NAMECALL R6 R0 K28 [0x47901F07]
      63 [-]: CALL R6 3 0  
      64 [-]: LOADK R8 K29 ["PlayTriggeredAnim"]
      65 [-]: NAMECALL R6 R5 K30 [0x8EB2112D]
      66 [-]: CALL R6 2 0  
      67 [-]: GETIMPORT R8 32 ["gDecorationType"]
      68 [-]: NAMECALL R6 R0 K33 [0xC1595BD5]
      69 [-]: CALL R6 2 1  
      70 [-]: FASTCALL2 52 R6 R0 L6
      71 [-]: MOVE R8 R6   
      72 [-]: MOVE R9 R0   
      73 [-]: GETIMPORT R7 36 [0x23D5322F]
      74 [-]: CALL R7 2 0  
L 6:  75 [-]: FASTCALL2 52 R6 R5 L7
      76 [-]: MOVE R8 R6   
      77 [-]: MOVE R9 R5   
      78 [-]: GETIMPORT R7 36 [0x23D5322F]
      79 [-]: CALL R7 2 0  
L 7:  80 [-]: LOADN R9 1   
      81 [-]: LENGTH R7 R6 
      82 [-]: LOADN R8 1   
...
L 8:  84 [-]: GETTABLE R10 R6 R9
      85 [-]: GETIMPORT R12 38 [0x0469F296]
      ...
      93 [-]: CALL R10 6 0 
      94 [-]: FORNLOOP R7 L8
L 9:  95 [-]: GETIMPORT R7 43 [0xCBD666E1]
      96 [-]: LOADN R8 1   
      97 [-]: CALL R7 1 0  
      98 [-]: LOADN R7 0   
L10:  99 [-]: GETIMPORT R9 46 [0x7D1E7F87]
     100 [-]: SUBK R8 R9 K44 [1]
     101 [-]: JUMPIFNOTLT R7 R8 L15
     102 [-]: GETIMPORT R10 46 [0x7D1E7F87]
...
L11: 109 [-]: GETTABLE R12 R6 R11
     ...
     111 [-]: MOVE R14 R12 
     112 [-]: GETIMPORT R13 6 [0x7B998233]
     113 [-]: CALL R13 1 1 
...
L14: 119 [-]: GETIMPORT R9 43 [0xCBD666E1]
     120 [-]: LOADN R10 0  
     121 [-]: CALL R9 1 0  
     122 [-]: GETIMPORT R9 49 [0x67652851]
     123 [-]: CALL R9 0 1  
     124 [-]: ADD R7 R7 R9 
     125 [-]: JUMPBACK L10 
