...
; Max Stack Size:  14
      ...
      47 [-]: DUPCLOSURE R5 K17; 
      48 [-]: SETGLOBAL R5 K18; "VorSetup" = var5
      49 [-]: RETURN R0 0  ; 
...
L 1:  22 [-]: GETUPVAL R14 0; var14 = upvalues[0]
      ...
      24 [-]: JUMPIFNOTEQ R9 R13 L2; goto L2 if var9 ~= var2054
...
L 6:  45 [-]: JUMPIF R9 L7 ; goto L7 if var9
      ...
      50 [-]: JUMPIFNOTLT R10 R9 L7; goto L7 if var10 >= var67873
...
L 8:  56 [-]: GETIMPORT R5 19; var5 = 0x6C97A788["MT_ASSASSINATE"]
      57 [-]: JUMPIFNOTEQ R3 R5 L10; goto L10 if var3 ~= var263472
      58 [-]: LOADN R5 4   ; var5 = 4
      59 [-]: JUMPIFEQ R3 R5 L41; goto L41 if var3 == var-1828583873
...
L10:  65 [-]: GETTABLEKS R5 R2 K20; var5 = var2["vipAgent"]
      ...
      67 [-]: JUMPIFNOTEQ R5 R6 L41; goto L41 if var5 ~= var1508641
      ...
      76 [-]: JUMPIFNOTLE R6 R5 L11; goto L11 if var6 > var-234879481
...
L12:  97 [-]: JUMPIFNOT R7 L37; goto L37 if not var7
     ...
     102 [-]: JUMPIFNOTLT R9 R6 L34; goto L34 if var9 >= var526640
     103 [-]: LOADN R9 8   ; var9 = 8
     104 [-]: JUMPIFNOTEQ R3 R9 L15; goto L15 if var3 ~= var264481
L13: 105 [-]: GETIMPORT R9 4; var9 = 0xBE190284
     ...
     115 [-]: JUMPIFNOTLT R10 R9 L14; goto L14 if var10 >= var654903810
...
L22: 179 [-]: JUMPIFNOTLT R9 R11 L23; goto L23 if var9 >= var592686
...
; Max Stack Size:  10
       ...
       4 [-]: LOADK R4 K4  ; var4 = "GAME_C1_HIP1"
       5 [-]: CALL R3 2 2  ; var3 = var3(var4)
       6 [-]: GETIMPORT R4 6; var4 = ZERO_ROTATION
       7 [-]: GETIMPORT R5 8; var5 = 0xA421AF95
       8 [-]: LOADN R6 0   ; var6 = 0
       9 [-]: LOADK R7 K9  ; var7 = 0.30000001192092896
      ...
      17 [-]: NAMECALL R1 R0 K10; var2 = var0; var1 = var0[0x2BA5938D]
