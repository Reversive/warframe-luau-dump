...
L 0:  12 [-]: GETIMPORT R2 1 ["_T"]
      13 [-]: LOADB R3 0   
      14 [-]: SETTABLEKS R3 R2 K6 ["ObjOneComplete"]
L 1:  15 [-]: GETIMPORT R1 8 [0xFE4879C0]
      16 [-]: JUMPIFNOT R1 L2
      17 [-]: GETIMPORT R2 1 ["_T"]
      18 [-]: LOADB R3 1   
      19 [-]: SETTABLEKS R3 R2 K9 ["ObjTwoComplete"]
      20 [-]: JUMP L3
     
L 2:  21 [-]: GETIMPORT R2 1 ["_T"]
      22 [-]: LOADB R3 0   
      23 [-]: SETTABLEKS R3 R2 K9 ["ObjTwoComplete"]
L 3:  24 [-]: GETIMPORT R1 11 [0x7898DFC8]
      25 [-]: JUMPIFNOT R1 L4
      26 [-]: GETIMPORT R2 1 ["_T"]
      27 [-]: LOADB R3 1   
...
L 0:   9 [-]: GETIMPORT R1 5 ["_T"]
      10 [-]: LOADB R2 0   
      11 [-]: SETTABLEKS R2 R1 K6 ["ObjOneComplete"]
L 1:  12 [-]: GETIMPORT R0 8 [0xFE4879C0]
      13 [-]: JUMPIFNOT R0 L2
      14 [-]: GETIMPORT R1 5 ["_T"]
      15 [-]: LOADB R2 1   
      16 [-]: SETTABLEKS R2 R1 K9 ["ObjTwoComplete"]
      17 [-]: JUMP L3
     
L 2:  18 [-]: GETIMPORT R1 5 ["_T"]
      19 [-]: LOADB R2 0   
      20 [-]: SETTABLEKS R2 R1 K9 ["ObjTwoComplete"]
L 3:  21 [-]: GETIMPORT R0 11 [0x7898DFC8]
      22 [-]: JUMPIFNOT R0 L4
      23 [-]: GETIMPORT R1 5 ["_T"]
      24 [-]: LOADB R2 1   
      25 [-]: SETTABLEKS R2 R1 K12 ["VorSleep"]
      26 [-]: RETURN R0 0  
L 4:  27 [-]: GETIMPORT R1 5 ["_T"]
      28 [-]: LOADB R2 0   
...
; Max Stack Size:  5
       ...
       0 [-]: GETIMPORT R1 1 [0x04B3C8B0]
       1 [-]: LENGTH R0 R1 
       2 [-]: LOADN R1 0   
       3 [-]: JUMPIFNOTLT R1 R0 L1
       4 [-]: LOADN R2 1   
       5 [-]: GETIMPORT R3 1 [0x04B3C8B0]
       6 [-]: LENGTH R0 R3 
       7 [-]: LOADN R1 1   
       8 [-]: FORNPREP R0 L1
L 0:   9 [-]: GETIMPORT R4 1 [0x04B3C8B0]
      10 [-]: GETTABLE R3 R4 R2
      11 [-]: NAMECALL R3 R3 K2 [0xA2880940]
      12 [-]: CALL R3 1 0  
      13 [-]: FORNLOOP R0 L0
L 1:  14 [-]: GETIMPORT R0 4 [0xCBD666E1]
      15 [-]: LOADN R1 0   
      16 [-]: CALL R0 1 0  
      17 [-]: GETIMPORT R0 6 ["_T"]
      18 [-]: GETIMPORT R1 8 [0xA421AF95]
      19 [-]: CALL R1 0 1  
      20 [-]: SETTABLEKS R1 R0 K9 ["TeleportPos"]
      21 [-]: GETIMPORT R0 6 ["_T"]
      22 [-]: LOADB R1 1   
      23 [-]: SETTABLEKS R1 R0 K10 ["ForceTeleport"]
      24 [-]: GETIMPORT R0 12 [0x7898DFC8]
      25 [-]: JUMPIFNOT R0 L2
      26 [-]: GETIMPORT R1 6 ["_T"]
      27 [-]: LOADB R2 1   
      28 [-]: SETTABLEKS R2 R1 K13 ["VorSleep"]
      29 [-]: JUMP L3
     
L 2:  30 [-]: GETIMPORT R1 6 ["_T"]
      31 [-]: LOADB R2 0   
      32 [-]: SETTABLEKS R2 R1 K13 ["VorSleep"]
L 3:  33 [-]: GETIMPORT R0 15 [0x0DAA6056]
      34 [-]: JUMPIFNOT R0 L4
      35 [-]: GETIMPORT R1 6 ["_T"]
      36 [-]: LOADB R2 1   
      37 [-]: SETTABLEKS R2 R1 K16 ["ObjOneComplete"]
      38 [-]: RETURN R0 0  
L 4:  39 [-]: GETIMPORT R1 6 ["_T"]
      40 [-]: LOADB R2 0   
...
; Max Stack Size:  20
       ...
       4 [-]: MOVE R3 R1   
       5 [-]: CALL R2 1 0  
       6 [-]: GETIMPORT R3 5 ["MissionTransmissionSet"]
...
L 0:  10 [-]: JUMPIFNOT R2 L1
      ...
      13 [-]: GETIMPORT R3 10 [0xE91D7466]
      14 [-]: CALL R2 1 0  
L 1:  15 [-]: GETIMPORT R2 1 [0x89326C93]
...
L 2:  24 [-]: JUMPIFNOT R3 L3
      25 [-]: RETURN R0 0  
L 3:  26 [-]: GETIMPORT R3 13 ["_T"]
      27 [-]: LOADB R4 0   
      28 [-]: SETTABLEKS R4 R3 K14 ["VorStart"]
      29 [-]: GETIMPORT R3 13 ["_T"]
      30 [-]: LOADB R4 0   
      31 [-]: SETTABLEKS R4 R3 K15 ["VorDefeated"]
      32 [-]: GETIMPORT R3 13 ["_T"]
      33 [-]: LOADN R4 0   
...
L 4:  44 [-]: JUMPIF R5 L5 
      ...
      48 [-]: CALL R5 3 1  
      49 [-]: MOVE R4 R5   
L 5:  50 [-]: GETIMPORT R5 1 [0x89326C93]
...
L 8:  71 [-]: JUMPIF R6 L9 
      ...
      75 [-]: CALL R6 3 0  
L 9:  76 [-]: GETIMPORT R6 29 [0xCBD666E1]
      77 [-]: LOADN R7 0   
      78 [-]: CALL R6 1 0  
      79 [-]: JUMPBACK L7  
...
L11:  84 [-]: JUMPIF R6 L12
      ...
      88 [-]: CALL R6 3 0  
L12:  89 [-]: GETIMPORT R6 1 [0x89326C93]
...
L13:  99 [-]: JUMPIF R7 L14
     ...
     102 [-]: CALL R7 2 0  
L14: 103 [-]: GETIMPORT R7 1 [0x89326C93]
     104 [-]: GETUPVAL R9 2
...
L16: 114 [-]: JUMPIFNOT R8 L17
     115 [-]: GETIMPORT R8 29 [0xCBD666E1]
     116 [-]: LOADN R9 0   
     117 [-]: CALL R8 1 0  
     118 [-]: JUMPBACK L15 
L17: 119 [-]: LOADN R8 0   
L18: 120 [-]: LOADK R9 K34 [1.5]
     ...
     122 [-]: GETIMPORT R9 29 [0xCBD666E1]
     123 [-]: LOADN R10 0  
     124 [-]: CALL R9 1 0  
     125 [-]: GETIMPORT R9 36 [0x67652851]
     126 [-]: CALL R9 0 1  
     127 [-]: ADD R8 R8 R9 
     128 [-]: JUMPBACK L18 
L19: 129 [-]: GETIMPORT R9 13 ["_T"]
     130 [-]: LOADB R10 1  
     131 [-]: SETTABLEKS R10 R9 K14 ["VorStart"]
     132 [-]: GETIMPORT R9 38 ["SetupBossAvatar"]
     133 [-]: MOVE R10 R7  
     134 [-]: CALL R9 1 0  
     135 [-]: LOADN R11 1  
     136 [-]: NAMECALL R9 R2 K39 [0xE2809E87]
     137 [-]: CALL R9 2 0  
     138 [-]: GETIMPORT R11 41 [0xB5F96E33]
...
L21: 145 [-]: JUMPIF R9 L22
     146 [-]: GETIMPORT R9 29 [0xCBD666E1]
     147 [-]: LOADN R10 0  
     148 [-]: CALL R9 1 0  
     149 [-]: JUMPBACK L20 
L22: 150 [-]: GETIMPORT R9 38 ["SetupBossAvatar"]
     151 [-]: LOADNIL R10  
     152 [-]: CALL R9 1 0  
     153 [-]: GETIMPORT R9 13 ["_T"]
     154 [-]: LOADB R10 1  
     155 [-]: SETTABLEKS R10 R9 K15 ["VorDefeated"]
     156 [-]: GETUPVAL R10 1
     157 [-]: GETTABLEKS R9 R10 K43 [0x9742B85B]
     158 [-]: GETIMPORT R10 5 ["MissionTransmissionSet"]
     159 [-]: GETIMPORT R11 21 [0x0469F296]
     ...
     165 [-]: CALL R9 0 0  
     166 [-]: GETIMPORT R9 29 [0xCBD666E1]
     167 [-]: LOADK R10 K46 [2.5]
     168 [-]: CALL R9 1 0  
     169 [-]: GETUPVAL R10 1
     170 [-]: GETTABLEKS R9 R10 K43 [0x9742B85B]
     171 [-]: GETIMPORT R10 5 ["MissionTransmissionSet"]
     172 [-]: GETIMPORT R11 21 [0x0469F296]
     173 [-]: LOADK R12 K47 ["LotusConsoleObj"]
     174 [-]: CALL R11 1 -1
     175 [-]: CALL R9 -1 0 
     176 [-]: GETIMPORT R9 29 [0xCBD666E1]
     177 [-]: LOADK R10 K34 [1.5]
     178 [-]: CALL R9 1 0  
     179 [-]: GETIMPORT R9 1 [0x89326C93]
     180 [-]: GETIMPORT R11 21 [0x0469F296]
     181 [-]: LOADK R12 K48 ["VorFightConsole"]
     182 [-]: CALL R11 1 -1
     183 [-]: NAMECALL R9 R9 K23 [0x46A0EBF5]
     184 [-]: CALL R9 -1 1 
     185 [-]: GETIMPORT R10 1 [0x89326C93]
     186 [-]: GETIMPORT R12 21 [0x0469F296]
...
L25: 214 [-]: NAMECALL R13 R10 K54 [0xF37943FF]
     ...
     217 [-]: GETIMPORT R13 36 [0x67652851]
     218 [-]: CALL R13 0 1 
     219 [-]: ADD R12 R12 R13
     220 [-]: LOADN R13 45 
     ...
     224 [-]: GETIMPORT R14 5 ["MissionTransmissionSet"]
     225 [-]: GETIMPORT R15 21 [0x0469F296]
     226 [-]: LOADK R16 K55 ["LotusConsoleReminder"]
     227 [-]: CALL R15 1 -1
     228 [-]: CALL R13 -1 0
     229 [-]: LOADN R12 0  
L26: 230 [-]: GETIMPORT R13 29 [0xCBD666E1]
     231 [-]: LOADN R14 0  
     232 [-]: CALL R13 1 0 
     233 [-]: JUMPBACK L25 
L27: 234 [-]: GETIMPORT R13 1 [0x89326C93]
     235 [-]: GETIMPORT R15 21 [0x0469F296]
     ...
     241 [-]: MOVE R15 R13 
     242 [-]: GETIMPORT R14 7 [0x7B998233]
     243 [-]: CALL R14 1 1 
L28: 244 [-]: JUMPIF R14 L29
     245 [-]: LOADK R16 K57 ["Increment"]
     246 [-]: NAMECALL R14 R13 K25 [0x8EB2112D]
     247 [-]: CALL R14 2 0 
L29: 248 [-]: GETIMPORT R14 29 [0xCBD666E1]
     249 [-]: LOADN R15 3  
     250 [-]: CALL R14 1 0 
     251 [-]: GETIMPORT R14 1 [0x89326C93]
     252 [-]: GETIMPORT R16 21 [0x0469F296]
     ...
     262 [-]: GETIMPORT R16 5 ["MissionTransmissionSet"]
     263 [-]: GETIMPORT R17 21 [0x0469F296]
...
L30: 269 [-]: NAMECALL R16 R1 K60 [0xE79E7EF4]
     ...
     272 [-]: GETIMPORT R16 29 [0xCBD666E1]
     273 [-]: LOADN R17 0  
     274 [-]: CALL R16 1 0 
     275 [-]: JUMPBACK L30 
L31: 276 [-]: GETIMPORT R16 1 [0x89326C93]
     277 [-]: GETIMPORT R18 21 [0x0469F296]
     ...
     284 [-]: CALL R17 2 0 
     285 [-]: GETIMPORT R17 29 [0xCBD666E1]
     286 [-]: LOADN R18 5  
     287 [-]: CALL R17 1 0 
     288 [-]: RETURN R0 0  
...
L 2:  23 [-]: GETIMPORT R2 1 ["_T"]
      24 [-]: LOADB R3 0   
      25 [-]: SETTABLEKS R3 R2 K13 ["VorSleep"]
L 3:  26 [-]: GETIMPORT R1 15 [0x89326C93]
