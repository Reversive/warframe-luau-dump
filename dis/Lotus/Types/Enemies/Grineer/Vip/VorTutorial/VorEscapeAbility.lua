...
; Max Stack Size:  17
       ...
       3 [-]: CALL R3 1 1  
       4 [-]: GETIMPORT R5 4 ["VorShieldAtTeleport"]
...
L 3:  18 [-]: NAMECALL R4 R1 K8 [0xFA9E477F]
      ...
      28 [-]: CALL R6 1 1  
      29 [-]: GETIMPORT R9 4 ["VorShieldAtTeleport"]
      30 [-]: SUB R8 R9 R6 
      31 [-]: DIV R7 R8 R3 
...
L 5:  48 [-]: LOADN R9 1   
      49 [-]: RETURN R9 1  
L 6:  50 [-]: GETIMPORT R9 18 [0x7AE5576E]
...
L10:  68 [-]: JUMPIF R9 L13
      ...
      72 [-]: CALL R9 2 1  
      73 [-]: GETIMPORT R10 22 [0xAF413E42]
...
L13:  87 [-]: GETUPVAL R11 0
      ...
      94 [-]: JUMPIF R12 L16
      95 [-]: GETIMPORT R12 26 [0xC827C0A0]
      96 [-]: JUMPIFNOTLE R12 R11 L16
      97 [-]: FASTCALL1 62 R4 L14
      98 [-]: MOVE R13 R4  
      99 [-]: GETIMPORT R12 6 [0x7B998233]
     100 [-]: CALL R12 1 1 
...
L 1:  17 [-]: GETIMPORT R7 9 ["_T"]
      ...
      27 [-]: CALL R11 1 1 
      28 [-]: LOADN R12 15 
      29 [-]: GETIMPORT R13 14 [0xE7B3C4E8]
...
L 4:  59 [-]: MOVE R13 R1  
      ...
      67 [-]: GETIMPORT R11 28 [0x9C1F3B5A]
      68 [-]: MOVE R12 R8  
      69 [-]: MOVE R13 R9  
      70 [-]: CALL R11 2 0 
      71 [-]: GETIMPORT R11 24 [0x55730E1A]
      72 [-]: LOADN R12 1  
      73 [-]: LENGTH R13 R8
      74 [-]: CALL R11 2 1 
      75 [-]: MOVE R9 R11  
...
L 5:  79 [-]: GETIMPORT R11 19 [0xCBD666E1]
      80 [-]: LOADN R12 0  
      81 [-]: CALL R11 1 0 
      82 [-]: JUMPBACK L4  
L 6:  83 [-]: NAMECALL R11 R10 K12 [0xD1586535]
      84 [-]: CALL R11 1 1 
      85 [-]: MOVE R12 R10 
      86 [-]: GETIMPORT R14 29 ["VorShieldAtTeleport"]
      ...
      92 [-]: LOADB R14 0  
      93 [-]: LOADNIL R15  
      94 [-]: GETIMPORT R16 9 ["_T"]
      95 [-]: LOADN R17 98 
      96 [-]: SETTABLEKS R17 R16 K31 ["TutorialTierOverride"]
      97 [-]: GETIMPORT R16 33 ["ReinforceCount"]
      98 [-]: GETIMPORT R18 35 [0xA3C25457]
      99 [-]: LENGTH R17 R18
     100 [-]: JUMPIFNOTLT R16 R17 L12
     101 [-]: LOADN R18 1  
     102 [-]: GETIMPORT R19 35 [0xA3C25457]
     103 [-]: LENGTH R16 R19
     104 [-]: LOADN R17 1  
     105 [-]: FORNPREP R16 L12
L 7: 106 [-]: GETIMPORT R20 35 [0xA3C25457]
     107 [-]: GETTABLE R19 R20 R18
     108 [-]: JUMPIFNOTLE R13 R19 L11
     109 [-]: GETIMPORT R19 33 ["ReinforceCount"]
     110 [-]: JUMPIFNOTLT R19 R18 L11
     111 [-]: GETIMPORT R19 1 [0x89326C93]
     112 [-]: NAMECALL R19 R19 K2 [0x78298275]
     113 [-]: CALL R19 1 1 
     114 [-]: MOVE R22 R19 
     115 [-]: NAMECALL R20 R1 K36 [0x68D0CBED]
     116 [-]: CALL R20 2 1 
     117 [-]: GETIMPORT R21 38 [0xAA0D86A3]
     118 [-]: JUMPIFNOTLT R21 R20 L10
     119 [-]: GETIMPORT R20 1 [0x89326C93]
     120 [-]: GETUPVAL R22 2
     ...
     127 [-]: MOVE R21 R15 
     128 [-]: GETIMPORT R20 7 [0x7B998233]
     129 [-]: CALL R20 1 1 
L 8: 130 [-]: JUMPIF R20 L9
     ...
     133 [-]: JUMPIF R20 L9
     134 [-]: MOVE R22 R15 
     135 [-]: GETIMPORT R23 42 [0xB5F96E33]
     136 [-]: NAMECALL R20 R6 K43 [0x79275474]
     137 [-]: CALL R20 3 0 
     138 [-]: GETIMPORT R20 9 ["_T"]
     139 [-]: GETIMPORT R22 33 ["ReinforceCount"]
     140 [-]: ADDK R21 R22 K44 [1]
     141 [-]: SETTABLEKS R21 R20 K32 ["ReinforceCount"]
     142 [-]: LOADB R14 0  
     143 [-]: GETIMPORT R20 9 ["_T"]
     144 [-]: LOADN R21 2  
     145 [-]: SETTABLEKS R21 R20 K10 ["EscapePhrase"]
     146 [-]: GETIMPORT R20 19 [0xCBD666E1]
...
L14: 168 [-]: NAMECALL R16 R12 K12 [0xD1586535]
     ...
     171 [-]: CALL R17 1 1 
     172 [-]: GETIMPORT R18 52 ["EscapePhrase"]
     173 [-]: JUMPXEQKN R18 K44 L15 NOT [1]
     174 [-]: LOADN R20 32 
     175 [-]: GETIMPORT R21 54 [0x0469F296]
...
L15: 181 [-]: GETIMPORT R18 52 ["EscapePhrase"]
     182 [-]: JUMPXEQKN R18 K57 L16 NOT [2]
     183 [-]: LOADN R20 32 
     184 [-]: GETIMPORT R21 54 [0x0469F296]
     185 [-]: LOADK R22 K58 ["PlayerAnger"]
     186 [-]: CALL R21 1 -1
     187 [-]: NAMECALL R18 R17 K56 [0x31A3964D]
     188 [-]: CALL R18 -1 0
     189 [-]: GETIMPORT R18 19 [0xCBD666E1]
     190 [-]: LOADK R19 K45 [0.5]
     191 [-]: CALL R18 1 0 
L16: 192 [-]: GETIMPORT R18 1 [0x89326C93]
     193 [-]: GETIMPORT R20 60 [0x6BED0635]
     194 [-]: NAMECALL R21 R1 K12 [0xD1586535]
     195 [-]: CALL R21 1 1 
     196 [-]: GETIMPORT R22 62 ["ZERO_ROTATION"]
     197 [-]: MOVE R23 R1  
     198 [-]: NAMECALL R18 R18 K63 [0x05909209]
     199 [-]: CALL R18 5 0 
     200 [-]: GETIMPORT R20 65 [0x8EE0547A]
     201 [-]: LOADB R21 0  
     202 [-]: LOADN R22 2  
     203 [-]: LOADN R23 1  
     204 [-]: LOADB R24 1  
     ...
     206 [-]: CALL R18 6 0 
     207 [-]: GETIMPORT R18 1 [0x89326C93]
     208 [-]: NAMECALL R18 R18 K67 [0x18D05D30]
     209 [-]: CALL R18 1 1 
     210 [-]: JUMPIFNOT R18 L17
     211 [-]: MOVE R20 R16 
     212 [-]: GETIMPORT R21 69 [0x20B7F774]
     213 [-]: MOVE R22 R16 
...
L18: 220 [-]: FASTCALL1 62 R15 L19
     221 [-]: MOVE R19 R15 
     222 [-]: GETIMPORT R18 7 [0x7B998233]
     223 [-]: CALL R18 1 1 
L19: 224 [-]: JUMPIF R18 L20
     ...
     229 [-]: GETIMPORT R18 19 [0xCBD666E1]
     230 [-]: LOADN R19 0  
     231 [-]: CALL R18 1 0 
     232 [-]: JUMPBACK L18 
L20: 233 [-]: GETIMPORT R18 19 [0xCBD666E1]
     234 [-]: LOADN R19 1  
     235 [-]: CALL R18 1 0 
     236 [-]: MOVE R16 R11 
     237 [-]: GETIMPORT R18 1 [0x89326C93]
     238 [-]: NAMECALL R18 R18 K67 [0x18D05D30]
     239 [-]: CALL R18 1 1 
     240 [-]: JUMPIFNOT R18 L22
     241 [-]: MOVE R20 R16 
     242 [-]: GETIMPORT R21 69 [0x20B7F774]
     243 [-]: MOVE R22 R16 
...
L21: 252 [-]: GETIMPORT R18 29 ["VorShieldAtTeleport"]
     253 [-]: LOADN R19 0  
     254 [-]: JUMPIFNOTLE R18 R19 L22
     255 [-]: NAMECALL R18 R1 K73 [0xA2880940]
     256 [-]: CALL R18 1 0 
     257 [-]: RETURN R0 0  
L22: 258 [-]: GETIMPORT R18 1 [0x89326C93]
     259 [-]: GETIMPORT R20 75 [0x30E03E08]
     260 [-]: MOVE R21 R16 
     261 [-]: GETIMPORT R22 62 ["ZERO_ROTATION"]
     262 [-]: MOVE R23 R1  
