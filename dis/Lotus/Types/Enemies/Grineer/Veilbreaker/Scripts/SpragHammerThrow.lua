...
L 5:  36 [-]: GETTABLEKS R4 R3 K12 ["avatar"]
      ...
      39 [-]: CALL R5 2 0  
      40 [-]: GETIMPORT R7 15 ["gHumanPlayerType"]
...
L 0:   8 [-]: JUMPIF R4 L1 
      ...
      13 [-]: CALL R4 -1 1 
      14 [-]: MOVE R3 R4   
L 1:  15 [-]: GETIMPORT R6 9 [0x00AEB791]
      16 [-]: NAMECALL R4 R0 K7 [0x003C792F]
      17 [-]: CALL R4 2 1  
      18 [-]: GETIMPORT R5 11 [0x20B7F774]
      19 [-]: MOVE R6 R4   
      20 [-]: MOVE R7 R3   
      21 [-]: CALL R5 2 1  
      22 [-]: GETIMPORT R6 13 [0x89326C93]
      23 [-]: GETIMPORT R8 15 [0x78403F35]
      24 [-]: MOVE R9 R4   
      25 [-]: MOVE R10 R5  
      26 [-]: MOVE R11 R0  
...
L 0:   5 [-]: JUMPIF R4 L1 
       6 [-]: MOVE R3 R2   
L 1:   7 [-]: GETIMPORT R4 3 [0xCBD666E1]
       8 [-]: LOADN R5 0   
       9 [-]: CALL R4 1 0  
      10 [-]: MOVE R6 R1   
...
L 3:  22 [-]: GETIMPORT R5 6 [0x67652851]
      23 [-]: CALL R5 0 1  
      24 [-]: SUB R3 R3 R5 
L 4:  25 [-]: GETUPVAL R6 0
      ...
      30 [-]: LOADB R5 1   
      31 [-]: RETURN R5 1  
L 5:  32 [-]: GETIMPORT R5 3 [0xCBD666E1]
      33 [-]: LOADN R6 0   
      34 [-]: CALL R5 1 0  
      35 [-]: JUMPBACK L2  
L 6:  36 [-]: LOADB R5 0   
...
; Max Stack Size:  20
      ...
      23 [-]: CALL R6 2 0  
      24 [-]: GETIMPORT R7 14 [0xFE5C450C]
      25 [-]: ADDK R6 R7 K12 [0.20000000000000001]
      26 [-]: GETIMPORT R9 16 [0x7C842614]
      27 [-]: LOADB R10 0  
      28 [-]: LOADN R11 3  
      29 [-]: LOADN R12 3  
      30 [-]: LOADB R13 1  
      ...
      32 [-]: CALL R7 6 1  
      33 [-]: GETIMPORT R8 19 [0xCBD666E1]
      34 [-]: FASTCALL2 19 R7 R6 L0
      35 [-]: MOVE R10 R7  
      36 [-]: MOVE R11 R6  
      37 [-]: GETIMPORT R9 22 [0xAC1B386A]
      38 [-]: CALL R9 2 -1 
L 0:  39 [-]: CALL R8 -1 0 
      40 [-]: GETIMPORT R10 24 [0x60190690]
      41 [-]: NAMECALL R8 R1 K25 [0xC9F6A7D7]
      42 [-]: CALL R8 2 1  
      43 [-]: FASTCALL1 62 R8 L1
      44 [-]: MOVE R10 R8  
      45 [-]: GETIMPORT R9 27 [0x7B998233]
      46 [-]: CALL R9 1 1  
L 1:  47 [-]: JUMPIF R9 L2 
      48 [-]: GETIMPORT R11 29 [0xAD9AFC9D]
      49 [-]: GETIMPORT R12 31 [0x0469F296]
...
L 2:  54 [-]: GETUPVAL R9 0
      55 [-]: MOVE R10 R1  
      56 [-]: GETIMPORT R11 16 [0x7C842614]
      57 [-]: GETIMPORT R12 14 [0xFE5C450C]
      58 [-]: CALL R9 3 1  
      59 [-]: JUMPIFNOT R9 L3
      60 [-]: RETURN R0 0  
L 3:  61 [-]: GETUPVAL R9 1
      ...
      64 [-]: MOVE R12 R2  
      65 [-]: CALL R9 3 1  
      66 [-]: GETIMPORT R12 35 [0x3C230F8F]
      67 [-]: LOADB R13 0  
      68 [-]: LOADN R14 3  
      69 [-]: LOADN R15 1  
      70 [-]: LOADB R16 1  
      ...
      73 [-]: GETUPVAL R10 0
      74 [-]: MOVE R11 R1  
      75 [-]: GETIMPORT R12 35 [0x3C230F8F]
      76 [-]: CALL R10 2 1 
      77 [-]: JUMPIFNOT R10 L4
      78 [-]: RETURN R0 0  
L 4:  79 [-]: GETIMPORT R10 37 [0xE7AF0E32]
      80 [-]: GETIMPORT R13 39 [0xD4E57F6D]
      81 [-]: LOADB R14 0  
      82 [-]: LOADN R15 3  
      83 [-]: LOADN R16 2  
      84 [-]: LOADB R17 1  
...
L 5:  87 [-]: FASTCALL1 62 R9 L6
      88 [-]: MOVE R12 R9  
      89 [-]: GETIMPORT R11 27 [0x7B998233]
      90 [-]: CALL R11 1 1 
L 6:  91 [-]: JUMPIF R11 L8
      ...
      95 [-]: CALL R11 1 0 
L 7:  96 [-]: GETIMPORT R11 19 [0xCBD666E1]
      97 [-]: LOADN R12 0  
      98 [-]: CALL R11 1 0 
      99 [-]: GETIMPORT R11 42 [0x67652851]
     100 [-]: CALL R11 0 1 
     101 [-]: SUB R10 R10 R11
     102 [-]: JUMPBACK L5  
...
L 9: 109 [-]: NAMECALL R11 R1 K4 [0xDE321E6F]
     ...
     114 [-]: CALL R12 3 0 
     115 [-]: GETIMPORT R12 46 [0x8290BEEC]
     116 [-]: GETIMPORT R14 31 [0x0469F296]
     117 [-]: GETIMPORT R15 48 [0x443BDAEE]
     118 [-]: CALL R14 1 -1
     119 [-]: NAMECALL R12 R12 K49 [0x11CCB9FF]
     120 [-]: CALL R12 -1 1
     121 [-]: GETIMPORT R15 46 [0x8290BEEC]
     122 [-]: LOADB R16 0  
     123 [-]: LOADN R17 3  
     124 [-]: LOADN R18 1  
     125 [-]: LOADB R19 0  
...
L10: 128 [-]: LOADN R13 0  
     ...
     135 [-]: LOADB R13 1  
     136 [-]: RETURN R13 1 
L11: 137 [-]: GETIMPORT R13 19 [0xCBD666E1]
     138 [-]: LOADN R14 0  
     139 [-]: CALL R13 1 0 
     140 [-]: GETIMPORT R13 42 [0x67652851]
     141 [-]: CALL R13 0 1 
     142 [-]: SUB R12 R12 R13
     143 [-]: JUMPBACK L10 
L12: 144 [-]: GETIMPORT R14 1 ["_T"]
     ...
     152 [-]: GETIMPORT R13 19 [0xCBD666E1]
     153 [-]: LOADK R14 K50 [0.5]
     154 [-]: CALL R13 1 0 
     155 [-]: RETURN R0 0  
L13: 156 [-]: GETIMPORT R15 52 [0xECED6F2B]
     157 [-]: LOADB R16 0  
     158 [-]: LOADN R17 2  
     159 [-]: LOADN R18 1  
     160 [-]: LOADB R19 1  
     ...
     162 [-]: CALL R13 6 0 
     163 [-]: GETIMPORT R13 19 [0xCBD666E1]
     164 [-]: LOADN R14 0  
     165 [-]: CALL R13 1 0 
     ...
     173 [-]: GETUPVAL R13 0
     174 [-]: MOVE R14 R1  
     175 [-]: GETIMPORT R15 52 [0xECED6F2B]
     176 [-]: CALL R13 2 1 
     177 [-]: JUMPIFNOT R13 L14
     178 [-]: RETURN R0 0  
L14: 179 [-]: GETIMPORT R15 58 [0x3F11767E]
     180 [-]: LOADB R16 0  
     181 [-]: LOADN R17 3  
     182 [-]: LOADN R18 1  
     183 [-]: LOADB R19 1  
     ...
     186 [-]: GETUPVAL R13 0
     187 [-]: MOVE R14 R1  
     188 [-]: GETIMPORT R15 58 [0x3F11767E]
     189 [-]: CALL R13 2 1 
