...
L 6:  30 [-]: JUMPIF R3 L7 
      31 [-]: MOVE R5 R0   
      32 [-]: GETIMPORT R6 7 ["EMPTY_SYMBOL"]
      33 [-]: NAMECALL R3 R2 K8 [0xB6B094B2]
      34 [-]: CALL R3 3 0  
      35 [-]: GETIMPORT R5 10 [0x5CA213A9]
      36 [-]: GETIMPORT R6 12 ["ZERO_ROTATION"]
      37 [-]: NAMECALL R3 R2 K13 [0xE28AA928]
      38 [-]: CALL R3 3 0  
      39 [-]: RETURN R0 0  
L 7:  40 [-]: GETIMPORT R5 15 [0x8D8F4D30]
      41 [-]: GETIMPORT R6 7 ["EMPTY_SYMBOL"]
      42 [-]: GETIMPORT R7 17 ["ZERO_VECTOR"]
      43 [-]: GETIMPORT R8 12 ["ZERO_ROTATION"]
      44 [-]: MOVE R9 R0   
