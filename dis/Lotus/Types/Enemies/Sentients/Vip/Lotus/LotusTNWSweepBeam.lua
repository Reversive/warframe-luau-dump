...
L 0:  10 [-]: JUMPIF R3 L1 
      ...
      21 [-]: GETIMPORT R3 14 ["AllowLotusAttack"]
      22 [-]: JUMPIFNOT R3 L1
...
L 1:   6 [-]: NAMECALL R4 R1 K2 [0xEEA7F8C4]
      ...
      12 [-]: CALL R5 2 0  
      13 [-]: GETIMPORT R7 6 [0xCC79FF20]
      14 [-]: GETIMPORT R10 8 [0x0ED8B456]
      15 [-]: LOADB R11 0  
      16 [-]: LOADN R12 2  
      17 [-]: LOADN R13 1  
      18 [-]: LOADB R14 0  
...
L 2:  27 [-]: JUMPIF R5 L3 
      ...
      30 [-]: GETIMPORT R6 12 [0xE91D7466]
      31 [-]: GETIMPORT R7 15 [0x0469F296]
      32 [-]: LOADK R8 K16 ["LotusFound"]
      33 [-]: CALL R7 1 -1 
      34 [-]: CALL R5 -1 0 
L 3:  35 [-]: GETIMPORT R5 18 [0x89326C93]
...
L 4:  45 [-]: JUMPIF R6 L21
      ...
      47 [-]: CALL R6 1 0  
      48 [-]: GETIMPORT R8 23 [0x78A39459]
      49 [-]: GETIMPORT R9 25 [0x8751F1A3]
      50 [-]: GETIMPORT R10 27 [0x062BE793]
      51 [-]: GETIMPORT R11 29 ["ZERO_ROTATION"]
...
L 8:  67 [-]: NAMECALL R8 R2 K32 [0xD1586535]
      ...
      80 [-]: CALL R12 1 1 
      81 [-]: GETIMPORT R13 38 [0xC78EF8B0]
      82 [-]: MUL R11 R12 R13
      83 [-]: ADD R9 R10 R11
      84 [-]: GETIMPORT R10 18 [0x89326C93]
      ...
      94 [-]: CALL R11 1 1 
      95 [-]: GETIMPORT R12 43 [0xC28112D8]
      96 [-]: JUMPIFNOT R12 L9
...
L 9: 106 [-]: NAMECALL R12 R2 K32 [0xD1586535]
     ...
     109 [-]: CALL R14 1 1 
     110 [-]: GETIMPORT R15 47 [0x009EE153]
     111 [-]: MUL R13 R14 R15
     112 [-]: ADD R11 R12 R13
L10: 113 [-]: SUB R12 R11 R9
     114 [-]: GETIMPORT R13 34 [0xC2892F65]
     115 [-]: MOVE R14 R12 
     116 [-]: CALL R13 1 0 
     117 [-]: GETIMPORT R14 49 [0x9D10A958]
     118 [-]: MUL R13 R12 R14
     119 [-]: ADD R11 R9 R13
     120 [-]: GETIMPORT R13 51 [0x9808FB37]
     121 [-]: JUMPIFNOT R13 L11
     122 [-]: GETIMPORT R13 18 [0x89326C93]
     123 [-]: MOVE R15 R9  
     124 [-]: LOADK R16 K52 [0.20000000000000001]
     125 [-]: GETIMPORT R17 54 [0x60130201]
     126 [-]: LOADN R18 0  
     127 [-]: LOADN R19 255
     128 [-]: LOADN R20 0  
     129 [-]: CALL R17 3 1 
     ...
     132 [-]: CALL R13 5 0 
     133 [-]: GETIMPORT R13 18 [0x89326C93]
     134 [-]: MOVE R15 R11 
     135 [-]: LOADK R16 K52 [0.20000000000000001]
     136 [-]: GETIMPORT R17 54 [0x60130201]
     137 [-]: LOADN R18 255
     138 [-]: LOADN R19 0  
     139 [-]: LOADN R20 0  
     140 [-]: CALL R17 3 1 
...
L12: 149 [-]: JUMPIF R14 L13
     ...
     152 [-]: CALL R14 2 0 
L13: 153 [-]: GETIMPORT R14 18 [0x89326C93]
     154 [-]: GETIMPORT R16 58 [0xF1C03D7E]
     155 [-]: MOVE R17 R9  
     156 [-]: GETIMPORT R18 29 ["ZERO_ROTATION"]
     157 [-]: NAMECALL R14 R14 K59 [0x05909209]
     158 [-]: CALL R14 4 1 
     159 [-]: MOVE R17 R14 
     160 [-]: GETIMPORT R18 15 [0x0469F296]
     161 [-]: CALL R18 0 1 
     162 [-]: GETIMPORT R19 61 ["ZERO_VECTOR"]
     163 [-]: GETIMPORT R20 29 ["ZERO_ROTATION"]
     164 [-]: NAMECALL R15 R1 K62 [0x3BB4F460]
     165 [-]: CALL R15 5 0 
     166 [-]: GETIMPORT R17 64 [0x849B6AD9]
     167 [-]: LOADB R18 0  
     168 [-]: LOADN R19 2  
     169 [-]: LOADN R20 2  
     170 [-]: LOADB R21 0  
     ...
     172 [-]: CALL R15 6 0 
L14: 173 [-]: GETIMPORT R15 67 [0xFD8C7F61]
...
L15: 179 [-]: JUMPIF R15 L21
     180 [-]: GETIMPORT R15 69 [0x67652851]
     181 [-]: CALL R15 0 1 
     182 [-]: ADD R13 R13 R15
...
L18: 195 [-]: JUMPIF R16 L20
     ...
     197 [-]: CALL R16 1 1 
     198 [-]: GETIMPORT R17 73 [0x5DB3CE80]
     199 [-]: MOVE R18 R16 
     200 [-]: MOVE R19 R11 
     201 [-]: GETIMPORT R20 75 [0x42DCC9F5]
     202 [-]: GETIMPORT R23 77 [0x97EDB50C]
     203 [-]: GETIMPORT R24 79 [0x03EA2485]
     204 [-]: MOVE R25 R16 
     205 [-]: MOVE R26 R11 
     206 [-]: CALL R24 2 1 
     207 [-]: DIV R22 R23 R24
     ...
     212 [-]: CALL R17 -1 1
     213 [-]: MOVE R16 R17 
     214 [-]: GETIMPORT R19 25 [0x8751F1A3]
     ...
     220 [-]: ADD R17 R17 R19
     221 [-]: GETIMPORT R19 83 [0xA421AF95]
     222 [-]: CALL R19 0 1 
     223 [-]: GETIMPORT R20 18 [0x89326C93]
     224 [-]: MOVE R22 R17 
     225 [-]: SUB R25 R16 R17
...
L19: 236 [-]: MOVE R22 R16 
     ...
     241 [-]: CALL R20 2 0 
L20: 242 [-]: GETIMPORT R16 87 [0xCBD666E1]
     243 [-]: LOADN R17 0  
     244 [-]: CALL R16 1 0 
     245 [-]: JUMPBACK L14 
L21: 246 [-]: RETURN R0 0  
...
L 2:  19 [-]: JUMPIF R4 L3 
      ...
      21 [-]: CALL R4 1 0  
L 3:  22 [-]: GETIMPORT R6 11 [0xF1C03D7E]
