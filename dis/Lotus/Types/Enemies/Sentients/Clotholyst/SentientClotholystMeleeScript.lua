...
L 0:   5 [-]: NAMECALL R3 R0 K3; var4 = var0; var3 = var0[0x28E744CF]
       ...
       7 [-]: JUMPIFNOTEQ R3 R0 L1; goto L1 if var3 ~= var65571
       8 [-]: RETURN R0 0  ; 
...
L 6:  46 [-]: GETIMPORT R8 20; var8 = 0xE15169D2
      47 [-]: JUMPIFNOTLT R7 R8 L9; goto L9 if var7 >= var50413629
...
L 8:  65 [-]: CALL R8 4 2  ; var8 = var8(var9, var10, var11)
...
L 7:  40 [-]: GETIMPORT R14 7; var14 = _T["clothAegis"]
      ...
      44 [-]: JUMPIFNOTEQ R11 R2 L10; goto L10 if var11 ~= var462881
...
L18: 122 [-]: NAMECALL R12 R2 K35; var13 = var2; var12 = var2[0x9BA17154]
     ...
     124 [-]: LOADK R13 K36; var13 = 0.34999999403953552
L19: 125 [-]: LOADN R14 0  ; var14 = 0
     126 [-]: JUMPIFNOTLT R14 R13 L21; goto L21 if var14 >= var50348093
