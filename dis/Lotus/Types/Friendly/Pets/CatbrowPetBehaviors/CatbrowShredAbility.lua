...
L 7:  47 [-]: JUMPIF R8 L8 ; goto L8 if var8
      48 [-]: JUMPIFNOTEQ R7 R0 L8; goto L8 if var7 ~= var2075
...
L 0:  15 [-]: GETTABLE R11 R5 R10; var11 = var5[var10]
      ...
      24 [-]: JUMPIFNOTLT R12 R7 L1; goto L1 if var12 >= var722454
...
L 7:  37 [-]: LOADN R6 0   ; var6 = 0
      38 [-]: JUMPIFNOTLT R6 R5 L13; goto L13 if var6 >= var50413131
...
L 8:  43 [-]: JUMPIFNOT R6 L9; goto L9 if not var6
      44 [-]: RETURN R0 0  ; 
L 9:  45 [-]: MOVE R8 R2   ; var8 = var2
      46 [-]: NAMECALL R6 R1 K13; var7 = var1; var6 = var1[0xBEBAD19F]
      47 [-]: CALL R6 3 2  ; var6 = var6(var7, var8)
      48 [-]: GETIMPORT R7 15; var7 = 0x2BF8491D
      49 [-]: JUMPIFLT R6 R7 L13; goto L13 if var6 < var591438
      50 [-]: GETIMPORT R6 9; var6 = 0xCBD666E1
      51 [-]: LOADN R7 0   ; var7 = 0
      52 [-]: CALL R6 2 1  ; var6(var7)
      53 [-]: GETIMPORT R6 17; var6 = 0x67652851
      54 [-]: CALL R6 1 2  ; var6 = var6()
      55 [-]: SUB R5 R5 R6 ; var5 = var5 - var6
      56 [-]: LOADN R6 0   ; var6 = 0
      57 [-]: JUMPIFLT R5 R6 L11; goto L11 if var5 < var50478667
      58 [-]: FASTCALL1 62 R2 L10; 
      59 [-]: MOVE R7 R2   ; var7 = var2
      60 [-]: GETIMPORT R6 1; var6 = 0x7B998233
      61 [-]: CALL R6 2 2  ; var6 = var6(var7)
L10:  62 [-]: JUMPIFNOT R6 L12; goto L12 if not var6
L11:  63 [-]: RETURN R0 0  ; 
L12:  64 [-]: JUMPBACK L7  ; goto L7
L13:  65 [-]: GETUPVAL R6 0; var6 = upvalues[0]
      66 [-]: MOVE R7 R2   ; var7 = var2
      67 [-]: MOVE R8 R1   ; var8 = var1
      68 [-]: CALL R6 3 2  ; var6 = var6(var7, var8)
      69 [-]: JUMPIF R6 L14; goto L14 if var6
      70 [-]: RETURN R0 0  ; 
L14:  71 [-]: GETIMPORT R8 19; var8 = 0x974399A2
      72 [-]: LOADB R9 0   ; var9 = false
      73 [-]: LOADN R10 2  ; var10 = 2
      74 [-]: NAMECALL R6 R1 K20; var7 = var1; var6 = var1[0x5D985C7E]
      75 [-]: CALL R6 5 1  ; var6(var7, var8, var9, var10)
      76 [-]: GETIMPORT R6 6; var6 = 0x89326C93
      77 [-]: NAMECALL R6 R6 K7; var7 = var6; var6 = var6[0x18D05D30]
      78 [-]: CALL R6 2 2  ; var6 = var6(var7)
      79 [-]: JUMPIFNOT R6 L27; goto L27 if not var6
      80 [-]: NAMECALL R6 R1 K21; var7 = var1; var6 = var1[0xDE321E6F]
      81 [-]: CALL R6 2 2  ; var6 = var6(var7)
      82 [-]: LOADN R8 0   ; var8 = 0
      83 [-]: NAMECALL R6 R6 K22; var7 = var6; var6 = var6[0x881B6B90]
...
L15:  91 [-]: JUMPIF R9 L16; goto L16 if var9
      92 [-]: NAMECALL R9 R6 K23; var10 = var6; var9 = var6[0x327F2778]
      93 [-]: CALL R9 2 2  ; var9 = var9(var10)
      94 [-]: LOADB R11 1  ; var11 = true
      95 [-]: LOADB R12 1  ; var12 = true
      96 [-]: NAMECALL R13 R1 K24; var14 = var1; var13 = var1[0x35844CF2]
      97 [-]: CALL R13 2 0 ; var13, ... = var13(var14)
      98 [-]: NAMECALL R9 R9 K25; var10 = var9; var9 = var9[0x95A65687]
      99 [-]: CALL R9 0 2  ; var9 = var9(var10, ...)
     100 [-]: MOVE R7 R9   ; var7 = var9
     101 [-]: GETIMPORT R11 27; var11 = 0x7EF5C346
     102 [-]: MUL R10 R11 R3; var10 = var11 * var3
     103 [-]: MUL R9 R7 R10; var9 = var7 * var10
     104 [-]: ADD R8 R7 R9 ; var8 = var7 + var9
L16: 105 [-]: NAMECALL R9 R2 K28; var10 = var2; var9 = var2[0x1AC1655C]
     106 [-]: CALL R9 2 2  ; var9 = var9(var10)
     107 [-]: NAMECALL R10 R2 K29; var11 = var2; var10 = var2[0xD2715720]
     108 [-]: CALL R10 2 2 ; var10 = var10(var11)
     109 [-]: NAMECALL R11 R9 K30; var12 = var9; var11 = var9[0xF456C2D7]
     110 [-]: CALL R11 2 2 ; var11 = var11(var12)
     111 [-]: GETIMPORT R12 33; var12 = 0x34291F5C[0x35C16153]
     112 [-]: CALL R12 1 2 ; var12 = var12()
     113 [-]: SETTABLEKS R8 R12 K34; var8["baseAmount"] = var12
     114 [-]: LOADN R15 2  ; var15 = 2
     115 [-]: LOADN R16 1  ; var16 = 1
     116 [-]: NAMECALL R13 R12 K35; var14 = var12; var13 = var12[0x1586E35E]
     117 [-]: CALL R13 4 1 ; var13(var14, var15, var16)
     118 [-]: MOVE R15 R1  ; var15 = var1
     119 [-]: NAMECALL R13 R12 K36; var14 = var12; var13 = var12[0x86CD00CB]
     120 [-]: CALL R13 3 1 ; var13(var14, var15)
     121 [-]: MOVE R15 R0  ; var15 = var0
     122 [-]: NAMECALL R13 R12 K37; var14 = var12; var13 = var12[0xF4DC3420]
     123 [-]: CALL R13 3 1 ; var13(var14, var15)
     124 [-]: LOADN R15 0  ; var15 = 0
     125 [-]: NAMECALL R13 R12 K38; var14 = var12; var13 = var12[0xCA73DD2A]
     126 [-]: CALL R13 3 1 ; var13(var14, var15)
     127 [-]: MOVE R15 R12 ; var15 = var12
     128 [-]: NAMECALL R13 R2 K39; var14 = var2; var13 = var2[0x479483BB]
     129 [-]: CALL R13 3 1 ; var13(var14, var15)
     130 [-]: FASTCALL1 62 R2 L17; 
     131 [-]: MOVE R14 R2  ; var14 = var2
     132 [-]: GETIMPORT R13 1; var13 = 0x7B998233
     133 [-]: CALL R13 2 2 ; var13 = var13(var14)
L17: 134 [-]: JUMPIF R13 L19; goto L19 if var13
     135 [-]: NAMECALL R13 R2 K29; var14 = var2; var13 = var2[0xD2715720]
     136 [-]: CALL R13 2 2 ; var13 = var13(var14)
     137 [-]: JUMPIFLT R13 R10 L18; goto L18 if var13 < var-687272635
     138 [-]: NAMECALL R13 R9 K30; var14 = var9; var13 = var9[0xF456C2D7]
     139 [-]: CALL R13 2 2 ; var13 = var13(var14)
     140 [-]: JUMPIFNOTLT R13 R11 L19; goto L19 if var13 >= var1862405445
L18: 141 [-]: NAMECALL R13 R2 K21; var14 = var2; var13 = var2[0xDE321E6F]
     142 [-]: CALL R13 2 2 ; var13 = var13(var14)
     143 [-]: LOADN R15 15 ; var15 = 15
     144 [-]: LOADN R16 3  ; var16 = 3
     145 [-]: GETIMPORT R19 41; var19 = 0xA6F5DA68
     146 [-]: MUL R18 R19 R3; var18 = var19 * var3
     147 [-]: MINUS R17 R18; 
     148 [-]: NAMECALL R13 R13 K42; var14 = var13; var13 = var13[0x5E6704FF]
     149 [-]: CALL R13 5 1 ; var13(var14, var15, var16, var17)
L19: 150 [-]: GETIMPORT R13 45; var13 = _T["catbrowShredAvatars"]
     151 [-]: JUMPIFNOT R13 L25; goto L25 if not var13
     152 [-]: LOADN R13 1  ; var13 = 1
L20: 153 [-]: GETIMPORT R15 45; var15 = _T["catbrowShredAvatars"]
     154 [-]: LENGTH R14 R15; var14 = #var15
     155 [-]: JUMPIFNOTLE R13 R14 L26; goto L26 if var13 > var2953038
     156 [-]: GETIMPORT R15 45; var15 = _T["catbrowShredAvatars"]
     157 [-]: GETTABLE R14 R15 R13; var14 = var15[var13]
     158 [-]: FASTCALL1 62 R14 L21; 
     159 [-]: MOVE R16 R14 ; var16 = var14
     160 [-]: GETIMPORT R15 1; var15 = 0x7B998233
     161 [-]: CALL R15 2 2 ; var15 = var15(var16)
L21: 162 [-]: JUMPIF R15 L22; goto L22 if var15
     163 [-]: NAMECALL R15 R14 K2; var16 = var14; var15 = var14[0x2047CFE7]
     164 [-]: CALL R15 2 2 ; var15 = var15(var16)
     165 [-]: JUMPIFNOT R15 L23; goto L23 if not var15
L22: 166 [-]: GETIMPORT R15 48; var15 = 0x33BDD652[0x9C1F3B5A]
     167 [-]: GETIMPORT R16 45; var16 = _T["catbrowShredAvatars"]
     168 [-]: MOVE R17 R13 ; var17 = var13
     169 [-]: CALL R15 3 1 ; var15(var16, var17)
     170 [-]: JUMP L24     ; goto L24
L23: 171 [-]: ADDK R13 R13 K49; var13 = var13 + 1
L24: 172 [-]: JUMPBACK L20 ; goto L20
     173 [-]: JUMP L26     ; goto L26
L25: 174 [-]: GETIMPORT R13 50; var13 = _T
     175 [-]: NEWTABLE R14 0 0; var14 = {}
     176 [-]: SETTABLEKS R14 R13 K44; var14["catbrowShredAvatars"] = var13
L26: 177 [-]: GETIMPORT R14 45; var14 = _T["catbrowShredAvatars"]
     178 [-]: FASTCALL2 52 R14 R2 L27; 
     179 [-]: MOVE R15 R2  ; var15 = var2
     180 [-]: GETIMPORT R13 52; var13 = 0x33BDD652[0x23D5322F]
