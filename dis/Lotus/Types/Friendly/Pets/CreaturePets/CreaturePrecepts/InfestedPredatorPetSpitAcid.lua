...
; Max Stack Size:  4
       ...
       0 [-]: GETIMPORT R1 2 ["infestedPredatorSpitAcidTime"]
       1 [-]: JUMPIF R1 L0 
       2 [-]: LOADNIL R1   
       3 [-]: RETURN R1 1  
L 0:   4 [-]: NAMECALL R1 R0 K3 [0x388577D5]
       5 [-]: CALL R1 1 1  
       6 [-]: GETIMPORT R3 2 ["infestedPredatorSpitAcidTime"]
       7 [-]: GETTABLE R2 R3 R1
       8 [-]: JUMPIF R2 L1 
       9 [-]: LOADNIL R2   
      10 [-]: RETURN R2 1  
L 1:  11 [-]: GETIMPORT R3 2 ["infestedPredatorSpitAcidTime"]
...
; Max Stack Size:  4
       ...
       0 [-]: GETIMPORT R2 2 ["infestedPredatorSpitAcidTime"]
       1 [-]: JUMPIF R2 L0 
       2 [-]: GETIMPORT R2 3 ["_T"]
       3 [-]: NEWTABLE R3 0 0
...
L 0:   5 [-]: NAMECALL R2 R0 K4 [0x388577D5]
       6 [-]: CALL R2 1 1  
       7 [-]: GETIMPORT R3 2 ["infestedPredatorSpitAcidTime"]
       8 [-]: SETTABLE R1 R3 R2
       9 [-]: RETURN R0 0  
...
L 5:  26 [-]: LOADNIL R5   
L 6:  27 [-]: GETIMPORT R7 9 ["infestedPredatorSpitAcidTime"]
      28 [-]: JUMPIF R7 L7 
      29 [-]: LOADNIL R6   
      30 [-]: JUMP L9
...
L 7:  31 [-]: NAMECALL R7 R1 K10 [0x388577D5]
      32 [-]: CALL R7 1 1  
      33 [-]: GETIMPORT R9 9 ["infestedPredatorSpitAcidTime"]
      34 [-]: GETTABLE R8 R9 R7
      35 [-]: JUMPIF R8 L8 
      36 [-]: LOADNIL R6   
      37 [-]: JUMP L9
     
L 8:  38 [-]: GETIMPORT R8 9 ["infestedPredatorSpitAcidTime"]
...
L 1:   6 [-]: NAMECALL R5 R1 K2 [0xF6EBD926]
      ...
      20 [-]: CALL R8 -1 0 
      21 [-]: GETUPVAL R10 0
      22 [-]: GETIMPORT R13 12 [0xC5321A17]
      23 [-]: LOADB R14 0  
      24 [-]: LOADN R15 2  
      25 [-]: LOADN R16 1  
      26 [-]: LOADB R17 1  
...
L 2:  35 [-]: JUMPIFNOT R8 L3
      36 [-]: RETURN R0 0  
L 3:  37 [-]: GETIMPORT R10 5 [0x0469F296]
      38 [-]: LOADK R11 K6 ["GAME_C1_SPINE1"]
      39 [-]: CALL R10 1 -1
      40 [-]: NAMECALL R8 R2 K7 [0x003C792F]
      41 [-]: CALL R8 -1 1 
      42 [-]: MOVE R7 R8   
      43 [-]: GETIMPORT R10 9 [0x20B7F774]
      44 [-]: MOVE R11 R5  
      45 [-]: MOVE R12 R7  
      46 [-]: CALL R10 2 -1
      47 [-]: NAMECALL R8 R6 K10 [0x553549E8]
      48 [-]: CALL R8 -1 0 
      49 [-]: GETIMPORT R11 16 [0x931BA514]
      50 [-]: NAMECALL R9 R1 K7 [0x003C792F]
      51 [-]: CALL R9 2 1  
      52 [-]: SUB R8 R7 R9 
      53 [-]: GETIMPORT R9 18 [0xC2892F65]
      54 [-]: MOVE R10 R8  
      55 [-]: CALL R9 1 0  
      56 [-]: GETIMPORT R9 9 [0x20B7F774]
      57 [-]: GETIMPORT R10 20 ["ZERO_VECTOR"]
      58 [-]: MOVE R11 R8  
      59 [-]: CALL R9 2 1  
      60 [-]: MOVE R10 R3  
      61 [-]: GETIMPORT R12 22 [0x93239B32]
      62 [-]: LENGTH R11 R12
      63 [-]: JUMPIFNOTLT R11 R3 L4
      64 [-]: GETIMPORT R11 22 [0x93239B32]
      65 [-]: LENGTH R10 R11
L 4:  66 [-]: GETIMPORT R12 22 [0x93239B32]
      67 [-]: GETTABLE R11 R12 R10
      68 [-]: GETIMPORT R14 16 [0x931BA514]
      69 [-]: NAMECALL R12 R1 K7 [0x003C792F]
      70 [-]: CALL R12 2 1 
      71 [-]: GETIMPORT R13 24 [0x89326C93]
      72 [-]: MOVE R15 R11 
      73 [-]: MOVE R16 R12 
      74 [-]: MOVE R17 R9  
...
L 5:  81 [-]: JUMPIF R14 L6
      ...
      97 [-]: CALL R15 2 0 
L 6:  98 [-]: GETIMPORT R14 33 [0x55156FF7]
      99 [-]: CALL R14 0 1 
     100 [-]: GETIMPORT R15 36 ["infestedPredatorSpitAcidTime"]
     101 [-]: JUMPIF R15 L7
     102 [-]: GETIMPORT R15 37 ["_T"]
     103 [-]: NEWTABLE R16 0 0
     104 [-]: SETTABLEKS R16 R15 K35 ["infestedPredatorSpitAcidTime"]
L 7: 105 [-]: NAMECALL R15 R1 K38 [0x388577D5]
     106 [-]: CALL R15 1 1 
     107 [-]: GETIMPORT R16 36 ["infestedPredatorSpitAcidTime"]
