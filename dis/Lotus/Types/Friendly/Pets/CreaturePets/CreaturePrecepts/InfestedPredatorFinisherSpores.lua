...
; Max Stack Size:  9
       ...
       0 [-]: DUPTABLE R1 5
       1 [-]: GETIMPORT R3 7 [0xCF64B7BA]
       2 [-]: GETIMPORT R7 7 [0xCF64B7BA]
       3 [-]: LENGTH R6 R7 
       4 [-]: FASTCALL2 19 R0 R6 L0
       5 [-]: MOVE R5 R0   
       6 [-]: GETIMPORT R4 10 [0xAC1B386A]
       7 [-]: CALL R4 2 1  
L 0:   8 [-]: GETTABLE R2 R3 R4
       9 [-]: SETTABLEKS R2 R1 K0 ["DAMAGE"]
      10 [-]: GETIMPORT R2 12 [0xB0A5EE7A]
      11 [-]: SETTABLEKS R2 R1 K1 ["RANGE"]
      12 [-]: GETIMPORT R3 14 [0x0CDEF741]
      13 [-]: GETIMPORT R7 14 [0x0CDEF741]
      14 [-]: LENGTH R6 R7 
      15 [-]: FASTCALL2 19 R0 R6 L1
      16 [-]: MOVE R5 R0   
      17 [-]: GETIMPORT R4 10 [0xAC1B386A]
      18 [-]: CALL R4 2 1  
L 1:  19 [-]: GETTABLE R2 R3 R4
      20 [-]: SETTABLEKS R2 R1 K2 ["RANGE2"]
      21 [-]: GETIMPORT R2 16 [0x5CD1E4B2]
      22 [-]: SETTABLEKS R2 R1 K3 ["DURATION"]
      23 [-]: MOVE R3 R0   
      24 [-]: GETIMPORT R4 18 [0x42DCC9F5]
      25 [-]: MOVE R5 R3   
      26 [-]: LOADN R6 1   
      27 [-]: GETIMPORT R8 20 [0xD2FCBC86]
      28 [-]: LENGTH R7 R8 
      29 [-]: CALL R4 3 1  
      30 [-]: MOVE R3 R4   
      31 [-]: GETIMPORT R4 20 [0xD2FCBC86]
      32 [-]: GETTABLE R2 R4 R3
      33 [-]: SETTABLEKS R2 R1 K4 ["COOLDOWN"]
      34 [-]: GETIMPORT R2 23 [0xB139D7BC]
      35 [-]: MOVE R3 R1   
      36 [-]: CALL R2 1 -1 
      37 [-]: RETURN R2 -1 
...
L 7:  44 [-]: GETIMPORT R8 11 [0x0CDEF741]
      45 [-]: GETIMPORT R12 11 [0x0CDEF741]
      46 [-]: LENGTH R11 R12
      47 [-]: FASTCALL2 19 R2 R11 L8
      48 [-]: MOVE R10 R2  
      49 [-]: GETIMPORT R9 14 [0xAC1B386A]
      50 [-]: CALL R9 2 1  
...
L 9:  56 [-]: GETTABLE R11 R4 R10
      ...
      58 [-]: GETIMPORT R13 17 [0x380507E8]
      59 [-]: JUMPIFNOTLE R13 R12 L13
      60 [-]: GETIMPORT R13 19 [0xB0A5EE7A]
...
L 0:  28 [-]: JUMPIF R8 L1 
      ...
      31 [-]: CALL R8 2 0  
      32 [-]: GETIMPORT R10 16 [0x060795C1]
      33 [-]: LOADB R11 0  
...
L 4:  45 [-]: MOVE R10 R2  
      ...
      47 [-]: CALL R8 2 1  
      48 [-]: GETIMPORT R9 20 [0x2BF8491D]
      49 [-]: JUMPIFLT R8 R9 L8
      50 [-]: GETIMPORT R8 22 [0xCBD666E1]
      51 [-]: LOADN R9 0   
      52 [-]: CALL R8 1 0  
      53 [-]: GETIMPORT R8 24 [0x67652851]
      54 [-]: CALL R8 0 1  
      55 [-]: SUB R7 R7 R8 
      56 [-]: LOADN R8 0   
      ...
      59 [-]: MOVE R9 R2   
      60 [-]: GETIMPORT R8 13 [0x7B998233]
      61 [-]: CALL R8 1 1  
L 5:  62 [-]: JUMPIFNOT R8 L7
L 6:  63 [-]: RETURN R0 0  
L 7:  64 [-]: JUMPBACK L2  
L 8:  65 [-]: GETIMPORT R10 26 [0x631463B2]
      66 [-]: LOADB R11 0  
      67 [-]: LOADN R12 2  
      ...
      75 [-]: MOVE R9 R2   
      76 [-]: GETIMPORT R8 13 [0x7B998233]
      77 [-]: CALL R8 1 1  
L 9:  78 [-]: JUMPIF R8 L10
      79 [-]: GETIMPORT R8 30 [0x35C16153]
      80 [-]: CALL R8 0 1  
      81 [-]: GETIMPORT R10 32 [0xCF64B7BA]
      ...
      99 [-]: CALL R9 2 0  
L10: 100 [-]: GETIMPORT R8 9 [0x89326C93]
     101 [-]: GETIMPORT R10 40 [0x4C2DAC28]
     102 [-]: NAMECALL R11 R1 K41 [0xD1586535]
     103 [-]: CALL R11 1 1 
     104 [-]: GETIMPORT R12 43 ["ZERO_ROTATION"]
     105 [-]: MOVE R13 R0  
     106 [-]: NAMECALL R8 R8 K44 [0x05909209]
     107 [-]: CALL R8 5 0  
     108 [-]: GETIMPORT R8 9 [0x89326C93]
     109 [-]: NAMECALL R8 R8 K10 [0x18D05D30]
     110 [-]: CALL R8 1 1  
     111 [-]: JUMPIFNOT R8 L14
     112 [-]: GETIMPORT R8 9 [0x89326C93]
     113 [-]: GETIMPORT R10 46 ["gBaseAvatarType"]
     114 [-]: NAMECALL R11 R1 K41 [0xD1586535]
     115 [-]: CALL R11 1 1 
     116 [-]: LOADN R12 0  
     117 [-]: GETIMPORT R14 48 [0x0CDEF741]
...
L11: 125 [-]: GETTABLE R12 R8 R11
     ...
     127 [-]: MOVE R14 R12 
     128 [-]: GETIMPORT R13 13 [0x7B998233]
     129 [-]: CALL R13 1 1 
L12: 130 [-]: JUMPIF R13 L13
     ...
     139 [-]: CALL R13 2 1 
     140 [-]: JUMPIF R13 L13
     141 [-]: GETIMPORT R13 30 [0x35C16153]
     142 [-]: CALL R13 0 1 
     143 [-]: LOADN R16 18 
     144 [-]: LOADB R17 1  
     ...
     149 [-]: CALL R14 2 0 
     150 [-]: GETIMPORT R16 55 [0xCD9D0AE6]
     151 [-]: GETIMPORT R17 57 ["EMPTY_SYMBOL"]
     152 [-]: GETIMPORT R18 59 ["ZERO_VECTOR"]
     153 [-]: GETIMPORT R19 43 ["ZERO_ROTATION"]
     154 [-]: GETIMPORT R20 61 [0x5CD1E4B2]
