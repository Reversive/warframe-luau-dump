...
; Max Stack Size:  14
       ...
       6 [-]: CALL R1 1 1  
L 0:   7 [-]: JUMPIF R1 L2 
       8 [-]: GETIMPORT R2 5 [0x51FE62F3]
       9 [-]: FASTCALL1 62 R2 L1
      10 [-]: GETIMPORT R1 3 [0x7B998233]
      11 [-]: CALL R1 1 1  
L 1:  12 [-]: JUMPIFNOT R1 L3
L 2:  13 [-]: RETURN R0 0  
L 3:  14 [-]: GETIMPORT R1 7 [0x89326C93]
...
L 6:  30 [-]: JUMPIFNOT R3 L7
      31 [-]: RETURN R0 0  
L 7:  32 [-]: GETIMPORT R3 13 ["DroneDecos"]
      33 [-]: JUMPXEQKNIL R3 L8 NOT
      34 [-]: GETIMPORT R3 14 ["_T"]
      35 [-]: NEWTABLE R4 0 0
      36 [-]: SETTABLEKS R4 R3 K12 ["DroneDecos"]
L 8:  37 [-]: GETIMPORT R4 13 ["DroneDecos"]
...
L 9:  42 [-]: NAMECALL R3 R0 K18 [0xADBDC520]
      43 [-]: CALL R3 1 1  
      44 [-]: GETIMPORT R4 7 [0x89326C93]
      45 [-]: JUMPIFEQ R3 R4 L12
      46 [-]: GETIMPORT R3 20 [0x9DBE37C5]
      47 [-]: JUMPIFNOT R3 L11
      48 [-]: GETIMPORT R4 22 [0xB95A6A18]
      49 [-]: FASTCALL1 62 R4 L10
      50 [-]: GETIMPORT R3 3 [0x7B998233]
      51 [-]: CALL R3 1 1  
L10:  52 [-]: JUMPIF R3 L11
      53 [-]: GETIMPORT R5 22 [0xB95A6A18]
      54 [-]: GETIMPORT R6 24 ["EMPTY_SYMBOL"]
...
L11:  57 [-]: LOADB R5 1   
      ...
      60 [-]: CALL R3 3 0  
      61 [-]: RETURN R0 0  
L12:  62 [-]: GETIMPORT R4 28 [0xBE190284]
      63 [-]: FASTCALL1 62 R4 L13
      64 [-]: GETIMPORT R3 3 [0x7B998233]
      65 [-]: CALL R3 1 1  
L13:  66 [-]: JUMPIFNOT R3 L14
      67 [-]: GETIMPORT R3 1 [0xCBD666E1]
      68 [-]: LOADN R4 0   
      69 [-]: CALL R3 1 0  
      70 [-]: JUMPBACK L12 
L14:  71 [-]: GETIMPORT R3 30 [0x76EA806B]
      72 [-]: NAMECALL R3 R3 K31 [0x8792AAAB]
      73 [-]: CALL R3 1 1  
      74 [-]: JUMPIF R3 L15
      75 [-]: GETIMPORT R3 1 [0xCBD666E1]
      76 [-]: LOADN R4 0   
      77 [-]: CALL R3 1 0  
      78 [-]: JUMPBACK L14 
L15:  79 [-]: GETIMPORT R4 7 [0x89326C93]
...
L16:  85 [-]: JUMPIFNOT R3 L17
      ...
      88 [-]: CALL R3 1 0  
      89 [-]: JUMPBACK L15 
L17:  90 [-]: GETIMPORT R3 34 [0x11A19C5E]
      91 [-]: MOVE R4 R0   
...
L21: 107 [-]: JUMPIFNOT R4 L22
     108 [-]: RETURN R0 0  
L22: 109 [-]: GETIMPORT R6 22 [0xB95A6A18]
     110 [-]: GETIMPORT R7 24 ["EMPTY_SYMBOL"]
...
L24: 133 [-]: FASTCALL1 62 R5 L25
     134 [-]: MOVE R7 R5   
     135 [-]: GETIMPORT R6 3 [0x7B998233]
     136 [-]: CALL R6 1 1  
L25: 137 [-]: JUMPIF R6 L28
     138 [-]: GETIMPORT R8 41 ["gDecoModeActionType"]
     ...
     145 [-]: GETIMPORT R6 1 [0xCBD666E1]
     146 [-]: LOADN R7 1   
     147 [-]: CALL R6 1 0  
     148 [-]: FASTCALL1 62 R4 L26
     149 [-]: MOVE R7 R4   
     150 [-]: GETIMPORT R6 3 [0x7B998233]
     151 [-]: CALL R6 1 1  
...
L28: 159 [-]: FASTCALL1 62 R0 L29
     160 [-]: MOVE R6 R0   
     161 [-]: GETIMPORT R5 3 [0x7B998233]
     162 [-]: CALL R5 1 1  
L29: 163 [-]: JUMPIFNOT R5 L30
     164 [-]: RETURN R0 0  
L30: 165 [-]: GETIMPORT R5 45 [0xA421AF95]
     166 [-]: LOADN R6 0   
     167 [-]: LOADN R7 0   
     168 [-]: LOADN R8 1   
     169 [-]: CALL R5 3 1  
     170 [-]: GETIMPORT R6 47 [0x492C7F2A]
     171 [-]: MOVE R7 R5   
     172 [-]: NAMECALL R8 R0 K48 [0xCB3851B8]
     173 [-]: CALL R8 1 -1 
     174 [-]: CALL R6 -1 1 
     175 [-]: GETIMPORT R7 50 [0x00046924]
     ...
     185 [-]: ADD R8 R9 R10
     186 [-]: GETIMPORT R11 5 [0x51FE62F3]
     187 [-]: MOVE R12 R8  
     188 [-]: MOVE R13 R7  
...
L34: 218 [-]: GETUPVAL R10 1
     ...
     223 [-]: GETIMPORT R10 7 [0x89326C93]
     224 [-]: GETUPVAL R12 3
     225 [-]: NAMECALL R10 R10 K63 [0x46A0EBF5]
     226 [-]: CALL R10 2 1 
     227 [-]: FASTCALL1 62 R10 L35
     228 [-]: MOVE R12 R10 
     229 [-]: GETIMPORT R11 3 [0x7B998233]
     230 [-]: CALL R11 1 1 
...
L36: 234 [-]: LOADB R12 0  
     ...
     242 [-]: MOVE R11 R3  
     243 [-]: GETIMPORT R10 3 [0x7B998233]
     244 [-]: CALL R10 1 1 
L37: 245 [-]: JUMPIF R10 L38
     246 [-]: NAMECALL R10 R3 K65 [0xA2880940]
     247 [-]: CALL R10 1 0 
L38: 248 [-]: GETIMPORT R4 1 [0xCBD666E1]
