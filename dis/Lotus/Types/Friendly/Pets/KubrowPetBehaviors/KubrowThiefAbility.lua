...
L 1:   6 [-]: GETIMPORT R5 3; var5 = 0xF7F4779B
      ...
      10 [-]: RETURN R0 0  ; 
L 2:  11 [-]: LOADK R4 K5  ; var4 = 0.15000000596046448
      ...
      18 [-]: JUMPIFNOTLT R4 R3 L3; goto L3 if var4 >= var1596
...
L 6:  49 [-]: GETUPVAL R8 0; var8 = upvalues[0]
      ...
      57 [-]: JUMPIFNOTLT R8 R9 L7; goto L7 if var8 >= var2126
...
L 7:  60 [-]: NAMECALL R8 R7 K17; var9 = var7; var8 = var7[0xEF8E8F7F]
      ...
      71 [-]: JUMPIFEQ R10 R7 L9; goto L9 if var10 == var2894
...
L 8:  75 [-]: NAMECALL R9 R0 K18; var10 = var0; var9 = var0[0xEBFBA9E4]
      ...
      83 [-]: JUMPIFEQ R10 R7 L9; goto L9 if var10 == var2894
...
L 9:  86 [-]: NAMECALL R9 R7 K20; var10 = var7; var9 = var7[0x22DA1852]
      ...
      91 [-]: JUMPIFNOTEQ R9 R10 L10; goto L10 if var9 ~= var2382
...
; Max Stack Size:  10
       ...
       7 [-]: JUMPIFNOTLT R1 R2 L0; goto L0 if var1 >= var65798
...
L 2:  23 [-]: GETUPVAL R8 0; var8 = upvalues[0]
      ...
      27 [-]: JUMPIFNOTLT R8 R9 L4; goto L4 if var8 >= var1594296383
...
L 5:  28 [-]: NAMECALL R11 R6 K11; var12 = var6; var11 = var6[0xCDE10C4A]
      ...
      32 [-]: JUMPIFNOTEQ R11 R12 L6; goto L6 if var11 ~= var67334
...
L11:  91 [-]: GETIMPORT R10 31; var10 = 0xA421AF95
      ...
      96 [-]: LOADK R16 K32; var16 = 0.20000000298023224
