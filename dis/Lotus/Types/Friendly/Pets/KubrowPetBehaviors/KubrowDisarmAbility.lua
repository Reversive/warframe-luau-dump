...
L 4:  36 [-]: NAMECALL R3 R0 K5 [0xFA9E477F]
      ...
      39 [-]: CALL R3 1 1  
      40 [-]: GETIMPORT R4 10 [0x3BE6F756]
      41 [-]: JUMPIFNOTEQ R3 R4 L5
      42 [-]: LOADB R3 0   
      43 [-]: RETURN R3 1  
L 5:  44 [-]: GETIMPORT R3 13 ["kubrowDisarmedAvatars"]
      45 [-]: JUMPIFNOT R3 L9
      46 [-]: GETIMPORT R3 15 [0xCFC01047]
      47 [-]: GETIMPORT R4 13 ["kubrowDisarmedAvatars"]
      48 [-]: CALL R3 1 3  
...
L 2:  27 [-]: LOADN R7 0   
      ...
      32 [-]: CALL R7 2 1  
      33 [-]: JUMPIFNOT R7 L3
      34 [-]: GETIMPORT R7 12 [0xC0DA2B81]
      35 [-]: NAMECALL R8 R1 K13 [0xF6EBD926]
      36 [-]: CALL R8 1 1  
      37 [-]: NAMECALL R9 R2 K13 [0xF6EBD926]
      38 [-]: CALL R9 1 -1 
      39 [-]: CALL R7 -1 1 
      40 [-]: GETIMPORT R9 15 [0x2BF8491D]
      41 [-]: GETIMPORT R10 15 [0x2BF8491D]
      42 [-]: MUL R8 R9 R10
      43 [-]: JUMPIFLT R7 R8 L3
      44 [-]: GETIMPORT R8 17 [0xCBD666E1]
      45 [-]: LOADN R9 0   
      46 [-]: CALL R8 1 0  
      47 [-]: GETIMPORT R8 19 [0x67652851]
      48 [-]: CALL R8 0 1  
      49 [-]: SUB R6 R6 R8 
      50 [-]: JUMPBACK L2  
L 3:  51 [-]: LOADN R7 0   
      ...
      69 [-]: MOVE R9 R2   
      70 [-]: GETIMPORT R10 26 [0x3BE6F756]
      71 [-]: GETIMPORT R11 28 [0x021C0996]
      72 [-]: GETIMPORT R12 30 [0x68140A47]
      73 [-]: CALL R8 4 0  
      74 [-]: JUMP L6
...
L 4:  75 [-]: LOADN R8 2   
      ...
      78 [-]: CALL R8 1 1  
      79 [-]: GETIMPORT R11 33 ["gSentientDamageControllerType"]
      80 [-]: NAMECALL R9 R8 K34 [0xF2DEAF69]
      81 [-]: CALL R9 2 1  
      82 [-]: JUMPIF R9 L5 
      83 [-]: GETIMPORT R11 36 ["gZombieDamageControllerType"]
...
L 5:  87 [-]: LOADN R11 4  
      ...
      92 [-]: CALL R9 2 0  
L 6:  93 [-]: GETIMPORT R8 40 ["kubrowDisarmedAvatars"]
      94 [-]: JUMPIFNOT R8 L12
      95 [-]: LOADN R8 1   
L 7:  96 [-]: GETIMPORT R10 40 ["kubrowDisarmedAvatars"]
      97 [-]: LENGTH R9 R10
      98 [-]: JUMPIFNOTLE R8 R9 L13
      99 [-]: GETIMPORT R10 40 ["kubrowDisarmedAvatars"]
     100 [-]: GETTABLE R9 R10 R8
     101 [-]: FASTCALL1 62 R9 L8
     102 [-]: MOVE R11 R9  
     103 [-]: GETIMPORT R10 4 [0x7B998233]
     104 [-]: CALL R10 1 1 
L 8: 105 [-]: JUMPIF R10 L9
     106 [-]: NAMECALL R10 R9 K5 [0x2047CFE7]
     107 [-]: CALL R10 1 1 
     108 [-]: JUMPIFNOT R10 L10
L 9: 109 [-]: GETIMPORT R10 43 [0x9C1F3B5A]
     110 [-]: GETIMPORT R11 40 ["kubrowDisarmedAvatars"]
     111 [-]: MOVE R12 R8  
     112 [-]: CALL R10 2 0 
     113 [-]: JUMP L11
...
L12: 117 [-]: GETIMPORT R8 45 ["_T"]
     118 [-]: NEWTABLE R9 0 0
     119 [-]: SETTABLEKS R9 R8 K39 ["kubrowDisarmedAvatars"]
L13: 120 [-]: GETIMPORT R9 40 ["kubrowDisarmedAvatars"]
     121 [-]: FASTCALL2 52 R9 R2 L14
     122 [-]: MOVE R10 R2  
     123 [-]: GETIMPORT R8 47 [0x23D5322F]
     124 [-]: CALL R8 2 0  
L14: 125 [-]: RETURN R0 0  
