...
L 0:   4 [-]: GETUPVAL R2 0; var2 = upvalues[0]
       ...
       6 [-]: JUMPIFNOTLT R1 R0 L1; goto L1 if var1 >= var263
...
L 0:   6 [-]: GETUPVAL R5 0; var5 = upvalues[0]
       ...
       8 [-]: JUMPIFNOTLT R4 R3 L1; goto L1 if var4 >= var1031
...
L 3:  28 [-]: NAMECALL R2 R0 K7; var3 = var0; var2 = var0[0xC24805FA]
      ...
      31 [-]: JUMPIFEQ R2 R3 L4; goto L4 if var2 == var66375
      32 [-]: LOADN R3 1   ; var3 = 1
      33 [-]: JUMPIFEQ R2 R3 L4; goto L4 if var2 == var795
...
L 4:  36 [-]: NAMECALL R3 R0 K5; var4 = var0; var3 = var0[0xFA9E477F]
      ...
      41 [-]: JUMPIFNOTEQ R3 R4 L5; goto L5 if var3 ~= var795
...
L 7:  54 [-]: JUMPIF R8 L8 ; goto L8 if var8
      55 [-]: JUMPIFNOTEQ R7 R0 L8; goto L8 if var7 ~= var2075
...
; Max Stack Size:  13
       ...
       7 [-]: JUMPIFNOTLT R10 R11 L0; goto L0 if var10 >= var68167
       8 [-]: LOADN R10 1  ; var10 = 1
       9 [-]: JUMP L1      ; goto L1
L 0:  10 [-]: GETUPVAL R12 0; var12 = upvalues[0]
      11 [-]: LENGTH R11 R12; var11 = #var12
      12 [-]: JUMPIFNOTLT R11 R10 L1; goto L1 if var11 >= var2823
...
L 2:  23 [-]: JUMPIF R5 L5 ; goto L5 if var5
      ...
      26 [-]: JUMPIFNOTLT R6 R5 L5; goto L5 if var6 >= var591182
...
L 2:  27 [-]: LOADN R7 0   ; var7 = 0
      28 [-]: JUMPIFNOTLT R7 R6 L3; goto L3 if var7 >= var1799
      ...
      43 [-]: JUMPIFLT R7 R8 L3; goto L3 if var7 < var1116238
...
L 3:  51 [-]: LOADN R7 0   ; var7 = 0
      52 [-]: JUMPIFNOTLT R7 R6 L14; goto L14 if var7 >= var1799
      ...
      66 [-]: JUMPIFNOTEQ R7 R8 L4; goto L4 if var7 ~= var67847
...
L 4:  75 [-]: LOADN R8 2   ; var8 = 2
      76 [-]: JUMPIFNOTEQ R7 R8 L6; goto L6 if var7 ~= var1543637061
...
L 7:  96 [-]: GETIMPORT R10 40; var10 = _T["kubrowDisarmedAvatars"]
      ...
      98 [-]: JUMPIFNOTLE R8 R9 L13; goto L13 if var8 > var2624078
