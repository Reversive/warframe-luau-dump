...
; Max Stack Size:  12
       ...
       3 [-]: CALL R6 1 1  
L 0:   4 [-]: JUMPIF R6 L6 
       5 [-]: GETIMPORT R8 3 ["gLotusMeleeWeaponType"]
...
L 2:  18 [-]: NAMECALL R8 R3 K7 [0x327F2778]
      ...
      24 [-]: CALL R8 1 1  
      25 [-]: GETIMPORT R9 12 ["meleeComboCounter"]
      26 [-]: JUMPXEQKNIL R9 L3 NOT
      27 [-]: GETIMPORT R9 13 ["_T"]
      28 [-]: NEWTABLE R10 0 0
      29 [-]: SETTABLEKS R10 R9 K11 ["meleeComboCounter"]
L 3:  30 [-]: LOADN R9 0   
      31 [-]: GETIMPORT R11 12 ["meleeComboCounter"]
      32 [-]: GETTABLE R10 R11 R8
      33 [-]: JUMPXEQKNIL R10 L4
      34 [-]: GETIMPORT R10 12 ["meleeComboCounter"]
      35 [-]: GETTABLE R9 R10 R8
L 4:  36 [-]: GETIMPORT R10 12 ["meleeComboCounter"]
      37 [-]: SETTABLE R7 R10 R8
      38 [-]: GETIMPORT R10 15 [0x41ACF4A3]
      39 [-]: JUMPIFNOTLE R10 R7 L6
      40 [-]: GETIMPORT R10 15 [0x41ACF4A3]
...
L 1:   9 [-]: NAMECALL R3 R0 K3 [0x14A55974]
      ...
      14 [-]: CALL R4 1 1  
L 2:  15 [-]: JUMPIF R4 L3 
      16 [-]: GETIMPORT R6 5 ["gLotusMeleeWeaponType"]
