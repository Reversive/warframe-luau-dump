...
; Max Stack Size:  13
       ...
       1 [-]: LOADN R4 7   ; var4 = 7
       2 [-]: LOADN R6 1   ; var6 = 1
       3 [-]: SUBK R7 R0 K3; var7 = var0 - 1
       4 [-]: MUL R5 R6 R7 ; var5 = var6 * var7
       5 [-]: SUB R3 R4 R5 ; var3 = var4 - var5
       6 [-]: SETTABLEKS R3 R2 K0; var3["TIME"] = var2
       7 [-]: LOADN R7 1   ; var7 = 1
       8 [-]: LOADK R9 K6  ; var9 = 0.25
       9 [-]: LOADK R11 K6 ; var11 = 0.25
      10 [-]: SUBK R12 R0 K3; var12 = var0 - 1
      11 [-]: MUL R10 R11 R12; var10 = var11 * var12
      12 [-]: ADD R8 R9 R10; var8 = var9 + var10
      13 [-]: FASTCALL2 19 R7 R8 L0; 
      14 [-]: GETIMPORT R6 9; var6 = 0x5BCED4C4[0xAC1B386A]
      15 [-]: CALL R6 3 2  ; var6 = var6(var7, var8)
L 0:  16 [-]: MULK R5 R6 K5; var5 = var6 * 100
      17 [-]: ADDK R4 R5 K4; var4 = var5 + 0.5
      18 [-]: FASTCALL1 12 R4 L1; 
      19 [-]: GETIMPORT R3 11; var3 = 0x5BCED4C4[0x55F27C30]
      20 [-]: CALL R3 2 2  ; var3 = var3(var4)
L 1:  21 [-]: SETTABLEKS R3 R2 K1; var3["PERCENT"] = var2
      22 [-]: GETIMPORT R3 14; var3 = cjson[0xB139D7BC]
...
L 1:  29 [-]: LENGTH R8 R5 ; var8 = #var5
      ...
      33 [-]: JUMPIFNOTLT R9 R8 L3; goto L3 if var9 >= var1050629
      34 [-]: LOADK R8 K16 ; var8 = 1.5
      35 [-]: JUMPIFLE R7 R8 L2; goto L2 if var7 <= var198192
...
L 3:  26 [-]: NAMECALL R10 R5 K11; var11 = var5; var10 = var5[0xA33C8780]
      ...
      31 [-]: JUMPIFEQ R11 R5 L4; goto L4 if var11 == var16779803
...
L 9:  65 [-]: JUMPIF R19 L10; goto L10 if var19
      ...
      68 [-]: JUMPIFNOTEQ R19 R5 L10; goto L10 if var19 ~= var1819
...
L13:  95 [-]: JUMPIFNOT R14 L14; goto L14 if not var14
      ...
      97 [-]: JUMPIFNOTLE R14 R11 L14; goto L14 if var14 > var1642574
...
L14: 104 [-]: NAMECALL R14 R5 K11; var15 = var5; var14 = var5[0xA33C8780]
     ...
     109 [-]: JUMPIFEQ R15 R5 L15; goto L15 if var15 == var16780827
...
L17: 117 [-]: JUMPIF R14 L18; goto L18 if var14
     ...
     121 [-]: JUMPIFNOT R10 L19; goto L19 if not var10
L18: 122 [-]: NAMECALL R14 R5 K30; var15 = var5; var14 = var5[0x3BD38FC3]
     123 [-]: CALL R14 2 1 ; var14(var15)
     124 [-]: JUMPIFNOT R10 L20; goto L20 if not var10
     125 [-]: LOADB R16 1  ; var16 = true
     126 [-]: NAMECALL R14 R5 K14; var15 = var5; var14 = var5[0x7CDBE8CB]
     127 [-]: CALL R14 3 1 ; var14(var15, var16)
     128 [-]: JUMP L20     ; goto L20
L19: 129 [-]: GETIMPORT R14 9; var14 = 0xCBD666E1
     130 [-]: LOADN R15 0  ; var15 = 0
     131 [-]: CALL R14 2 1 ; var14(var15)
     132 [-]: JUMPBACK L6  ; goto L6
L20: 133 [-]: GETIMPORT R12 33; var12 = _T["sentinelRevive"]
     134 [-]: FASTCALL1 62 R12 L21; 
     135 [-]: GETIMPORT R11 5; var11 = 0x7B998233
     136 [-]: CALL R11 2 2 ; var11 = var11(var12)
L21: 137 [-]: JUMPIFNOT R11 L22; goto L22 if not var11
     138 [-]: GETIMPORT R11 34; var11 = _T
     139 [-]: NEWTABLE R12 0 0; var12 = {}
     140 [-]: SETTABLEKS R12 R11 K32; var12["sentinelRevive"] = var11
L22: 141 [-]: FASTCALL1 62 R5 L23; 
     142 [-]: MOVE R12 R5  ; var12 = var5
     143 [-]: GETIMPORT R11 5; var11 = 0x7B998233
     144 [-]: CALL R11 2 2 ; var11 = var11(var12)
L23: 145 [-]: JUMPIF R11 L24; goto L24 if var11
     146 [-]: NAMECALL R11 R5 K6; var12 = var5; var11 = var5[0x1AC1655C]
     147 [-]: CALL R11 2 2 ; var11 = var11(var12)
     148 [-]: LOADB R13 0  ; var13 = false
     149 [-]: NAMECALL R11 R11 K19; var12 = var11; var11 = var11[0x2A6E6979]
     150 [-]: CALL R11 3 1 ; var11(var12, var13)
     151 [-]: NAMECALL R11 R5 K35; var12 = var5; var11 = var5[0x5B89142C]
     152 [-]: CALL R11 2 2 ; var11 = var11(var12)
     153 [-]: NAMECALL R11 R11 K36; var12 = var11; var11 = var11[0x5CA33548]
     154 [-]: CALL R11 2 2 ; var11 = var11(var12)
     155 [-]: GETIMPORT R12 33; var12 = _T["sentinelRevive"]
     156 [-]: SETTABLE R7 R12 R11; var7[var12] = var11
L24: 157 [-]: RETURN R0 0  ; 
