...
; Max Stack Size:  4
  ...
  1 [-]: GETGLOBAL R1 K0        ; R1 := 0xa0807f50
  2 [-]: SUB       R2 R0 K1     ; R2 := R0 - 1.000000
  3 [-]: GETGLOBAL R3 K2        ; R3 := 0xa97c9525
...
; Max Stack Size:  10
  ...
  5 [-]: JMP       23           ; PC := 23
  6 [-]: SELF      R4 R1 K1     ; R5 := R1; R4 := R1[0x1c881607]
 ...
 12 [-]: JMP       23           ; PC := 23
 13 [-]: SELF      R5 R4 K2     ; R6 := R4; R5 := R4[0x5b89142c]
 ...
 19 [-]: JMP       23           ; PC := 23
 20 [-]: SELF      R6 R5 K3     ; R7 := R5; R6 := R5[0x5ca33548]
 ...
 47 [-]: SELF      R8 R1 K7     ; R9 := R1; R8 := R1[0x388577d5]
 ...
 64 [-]: SELF      R7 R1 K7     ; R8 := R1; R7 := R1[0x388577d5]
