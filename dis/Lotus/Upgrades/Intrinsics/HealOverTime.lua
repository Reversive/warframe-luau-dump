...
; Max Stack Size:  6
       ...
       2 [-]: LOADN R5 1   ; var5 = 1
       3 [-]: JUMPIFEQ R4 R5 L0; goto L0 if var4 == var-1291844539
       4 [-]: NAMECALL R4 R0 K0; var5 = var0; var4 = var0[0xE8B105B3]
       5 [-]: CALL R4 2 2  ; var4 = var4(var5)
       6 [-]: LOADN R5 2   ; var5 = 2
       7 [-]: JUMPIFNOTEQ R4 R5 L1; goto L1 if var4 ~= var66587
...
; Max Stack Size:  9
      ...
      21 [-]: JUMPIFLT R8 R2 L0; goto L0 if var8 < var16779035
...
L 0:  11 [-]: JUMPIF R6 L4 ; goto L4 if var6
      ...
      18 [-]: JUMPIFNOTEQ R0 R6 L2; goto L2 if var0 ~= var50806347
...
L 1:  23 [-]: JUMPIF R8 L2 ; goto L2 if var8
      ...
      29 [-]: RETURN R0 0  ; 
L 2:  30 [-]: JUMPIFNOTEQ R0 R7 L4; goto L4 if var0 ~= var50740811
