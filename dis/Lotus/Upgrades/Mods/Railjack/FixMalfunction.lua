...
; Max Stack Size:  9
  ...
  2 [-]: CONST     R1 300       ; R1 := 300.000000
  3 [-]: CONST     R2 290       ; R2 := 290.000000
  4 [-]: CONST     R3 275       ; R3 := 275.000000
  5 [-]: CONST     R4 260       ; R4 := 260.000000
  6 [-]: CONST     R5 245       ; R5 := 245.000000
  7 [-]: CONST     R6 230       ; R6 := 230.000000
  8 [-]: CONST     R7 215       ; R7 := 215.000000
  9 [-]: CONST     R8 200       ; R8 := 200.000000
