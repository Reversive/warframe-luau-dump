...
; Max Stack Size:  15
       ...
       0 [-]: JUMPIFEQ R1 R2 L1; goto L1 if var1 == var50347595
...
L 2:   7 [-]: NAMECALL R4 R0 K2; var5 = var0; var4 = var0[0x1AC1655C]
       ...
       9 [-]: LOADN R5 0   ; var5 = 0
      10 [-]: JUMPIFNOTLT R5 R1 L4; goto L4 if var5 >= var263502
      ...
      22 [-]: LOADN R9 123 ; var9 = 123
      23 [-]: LOADN R10 3  ; var10 = 3
      24 [-]: MULK R11 R6 K10; var11 = var6 * 0.01
      ...
      37 [-]: JUMPIFNOTLT R9 R8 L4; goto L4 if var9 >= var117770507
      38 [-]: SUB R9 R5 R7 ; var9 = var5 - var7
      39 [-]: JUMPIFNOTLT R9 R8 L3; goto L3 if var9 >= var591894
...
L 4:  46 [-]: LOADN R5 0   ; var5 = 0
      47 [-]: JUMPIFNOTLT R5 R2 L5; goto L5 if var5 >= var263502
      ...
      59 [-]: LOADN R9 123 ; var9 = 123
      60 [-]: LOADN R10 3  ; var10 = 3
      61 [-]: MULK R11 R6 K10; var11 = var6 * 0.01
      ...
      69 [-]: JUMPIFNOTLT R9 R8 L5; goto L5 if var9 >= var-687600571
...
L 5:  27 [-]: GETIMPORT R5 10; var5 = _T["RJMaxShieldOnKill"]
      ...
      36 [-]: JUMPIFNOTLT R7 R6 L7; goto L7 if var7 >= var919630
      37 [-]: GETIMPORT R8 14; var8 = 0x20AC4C71
      38 [-]: JUMPIFNOTLT R8 R6 L6; goto L6 if var8 >= var919118
...
L 7:  51 [-]: LOADN R8 0   ; var8 = 0
      52 [-]: JUMPIFNOTLT R8 R7 L10; goto L10 if var8 >= var-989525732
      ...
      58 [-]: JUMPIFNOTLE R8 R9 L9; goto L9 if var8 > var2311
...
L 7:  25 [-]: NAMECALL R6 R5 K6; var7 = var5; var6 = var5[0x388577D5]
      ...
      34 [-]: JUMPIFNOTLT R8 R7 L8; goto L8 if var8 >= var329806
