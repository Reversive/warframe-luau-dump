...
L22: 129 [-]: GETIMPORT R13 34; var13 = 0x67652851
     ...
     134 [-]: JUMPIFNOTLE R12 R10 L30; goto L30 if var12 > var50990155
...
L23: 139 [-]: NAMECALL R13 R0 K35; var14 = var0; var13 = var0[0x73901ACF]
     ...
     142 [-]: NAMECALL R16 R0 K36; var17 = var0; var16 = var0[0xD2715720]
     143 [-]: CALL R16 2 2 ; var16 = var16(var17)
     144 [-]: ADD R15 R16 R12; var15 = var16 + var12
     145 [-]: NAMECALL R13 R0 K37; var14 = var0; var13 = var0[0x014DB014]
     146 [-]: CALL R13 3 1 ; var13(var14, var15)
     147 [-]: NAMECALL R15 R0 K17; var16 = var0; var15 = var0[0xC8442850]
     148 [-]: CALL R15 2 2 ; var15 = var15(var16)
     149 [-]: MULK R14 R15 K16; var14 = var15 * 100
     150 [-]: FASTCALL1 12 R14 L24; 
     151 [-]: GETIMPORT R13 20; var13 = 0x5BCED4C4[0x55F27C30]
     152 [-]: CALL R13 2 2 ; var13 = var13(var14)
L24: 153 [-]: JUMPIFEQ R13 R9 L29; goto L29 if var13 == var50740811
     154 [-]: FASTCALL1 62 R6 L25; 
     155 [-]: MOVE R15 R6  ; var15 = var6
     156 [-]: GETIMPORT R14 4; var14 = 0x7B998233
     157 [-]: CALL R14 2 2 ; var14 = var14(var15)
L25: 158 [-]: JUMPIF R14 L28; goto L28 if var14
     159 [-]: SETTABLEKS R13 R11 K26; var13["buffData"] = var11
     160 [-]: MOVE R16 R11 ; var16 = var11
     161 [-]: JUMPXEQKN R13 K16 L26 NOT; 
     162 [-]: LOADB R17 0 +1; var17 = false
L26: 163 [-]: LOADB R17 1  ; var17 = true
L27: 164 [-]: LOADB R18 1  ; var18 = true
     165 [-]: NAMECALL R14 R6 K30; var15 = var6; var14 = var6[0x37E45FB5]
     166 [-]: CALL R14 5 1 ; var14(var15, var16, var17, var18)
L28: 167 [-]: MOVE R9 R13  ; var9 = var13
L29: 168 [-]: SUB R10 R10 R12; var10 = var10 - var12
L30: 169 [-]: GETIMPORT R12 7; var12 = 0xCBD666E1
...
L31: 173 [-]: FASTCALL1 62 R6 L32; 
     ...
     175 [-]: GETIMPORT R12 4; var12 = 0x7B998233
...
L32: 177 [-]: JUMPIF R12 L33; goto L33 if var12
     ...
     181 [-]: NAMECALL R12 R6 K30; var13 = var6; var12 = var6[0x37E45FB5]
