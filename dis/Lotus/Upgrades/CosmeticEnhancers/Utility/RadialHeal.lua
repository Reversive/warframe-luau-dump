...
L 0:  13 [-]: MOVE R13 R10 ; var13 = var10
      ...
      18 [-]: JUMPIFNOTLT R11 R12 L6; goto L6 if var11 >= var658710
...
L 2:  49 [-]: MOVE R11 R15 ; var11 = var15
      ...
      51 [-]: JUMPIFNOTLT R15 R11 L5; goto L5 if var15 >= var725270
      52 [-]: MOVE R17 R11 ; var17 = var11
      53 [-]: NAMECALL R15 R12 K25; var16 = var12; var15 = var12[0xFC80301E]
      54 [-]: CALL R15 3 1 ; var15(var16, var17)
      55 [-]: JUMP L5      ; goto L5
L 3:  56 [-]: NAMECALL R14 R10 K26; var15 = var10; var14 = var10[0xB40C191A]
      57 [-]: CALL R14 2 2 ; var14 = var14(var15)
      58 [-]: NAMECALL R15 R10 K27; var16 = var10; var15 = var10[0xD2715720]
      59 [-]: CALL R15 2 2 ; var15 = var15(var16)
      60 [-]: SUB R13 R14 R15; var13 = var14 - var15
      61 [-]: GETIMPORT R15 21; var15 = 0x1C139F5C
      62 [-]: GETTABLE R14 R15 R2; var14 = var15[var2]
      63 [-]: FASTCALL2 19 R13 R14 L4; 
      64 [-]: GETIMPORT R12 24; var12 = 0x5BCED4C4[0xAC1B386A]
      65 [-]: CALL R12 3 2 ; var12 = var12(var13, var14)
L 4:  66 [-]: MOVE R11 R12 ; var11 = var12
      67 [-]: LOADN R12 0  ; var12 = 0
      68 [-]: JUMPIFNOTLT R12 R11 L5; goto L5 if var12 >= var658966
      69 [-]: MOVE R14 R10 ; var14 = var10
      70 [-]: MOVE R15 R11 ; var15 = var11
      71 [-]: NAMECALL R12 R0 K28; var13 = var0; var12 = var0[0x1F135DE0]
      72 [-]: CALL R12 4 1 ; var12(var13, var14, var15)
L 5:  73 [-]: LOADN R12 0  ; var12 = 0
      74 [-]: JUMPIFNOTLT R12 R11 L6; goto L6 if var12 >= var1862929477
      75 [-]: NAMECALL R12 R10 K14; var13 = var10; var12 = var10[0xDE321E6F]
      76 [-]: CALL R12 2 2 ; var12 = var12(var13)
      77 [-]: GETIMPORT R14 30; var14 = 0x66AB09F6
      78 [-]: MOVE R15 R11 ; var15 = var11
      79 [-]: NAMECALL R12 R12 K31; var13 = var12; var12 = var12[0x7BC127AA]
      80 [-]: CALL R12 4 1 ; var12(var13, var14, var15)
L 6:  81 [-]: FORGLOOP R6 L0 2 [inext]; 
L 7:  82 [-]: GETIMPORT R5 1; var5 = 0x89326C93
      83 [-]: GETIMPORT R7 33; var7 = 0x4F468D45
      84 [-]: NAMECALL R8 R0 K34; var9 = var0; var8 = var0[0xD1586535]
      85 [-]: CALL R8 2 2  ; var8 = var8(var9)
      86 [-]: GETIMPORT R9 36; var9 = ZERO_ROTATION
      87 [-]: MOVE R10 R0  ; var10 = var0
      88 [-]: NAMECALL R5 R5 K37; var6 = var5; var5 = var5[0x05909209]
