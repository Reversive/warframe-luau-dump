...
; Max Stack Size:  16
       ...
       3 [-]: CALL R5 1 1  
L 0:   4 [-]: JUMPIF R5 L1 
       5 [-]: GETIMPORT R7 3 ["gProjectileType"]
       6 [-]: NAMECALL R5 R3 K4 [0xF2DEAF69]
       7 [-]: CALL R5 2 1  
       8 [-]: JUMPIF R5 L2 
L 1:   9 [-]: LOADB R5 0   
      10 [-]: RETURN R5 1  
L 2:  11 [-]: GETIMPORT R5 7 ["EvoShotgunAmmoEffOnPunchthrough"]
      12 [-]: JUMPXEQKNIL R5 L3 NOT
      13 [-]: GETIMPORT R5 8 ["_T"]
      14 [-]: NEWTABLE R6 0 0
      15 [-]: SETTABLEKS R6 R5 K6 ["EvoShotgunAmmoEffOnPunchthrough"]
L 3:  16 [-]: GETIMPORT R5 11 [0x397B920F]
      17 [-]: LOADN R6 0   
      18 [-]: CALL R5 1 1  
      19 [-]: NEWTABLE R6 0 0
      20 [-]: GETIMPORT R7 13 [0xCFC01047]
      21 [-]: GETIMPORT R8 7 ["EvoShotgunAmmoEffOnPunchthrough"]
      22 [-]: CALL R7 1 3  
...
L 4:  24 [-]: GETTABLEKS R13 R11 K14 ["lastHitTime"]
      ...
      29 [-]: MOVE R13 R6  
      30 [-]: MOVE R14 R10 
      31 [-]: GETIMPORT R12 17 [0x23D5322F]
      32 [-]: CALL R12 2 0 
L 5:  33 [-]: FORGLOOP R7 L4 2
      34 [-]: GETIMPORT R7 19 [0xC8802016]
      35 [-]: MOVE R8 R6   
      36 [-]: CALL R7 1 3  
      37 [-]: FORGPREP_INEXT R7 L7
L 6:  38 [-]: GETIMPORT R12 7 ["EvoShotgunAmmoEffOnPunchthrough"]
      39 [-]: LOADNIL R13  
      40 [-]: SETTABLE R13 R12 R11
L 7:  41 [-]: FORGLOOP R7 L6 2 [inext]
      42 [-]: NAMECALL R7 R3 K20 [0x3B4896D5]
      43 [-]: CALL R7 1 1  
      44 [-]: GETIMPORT R9 7 ["EvoShotgunAmmoEffOnPunchthrough"]
      45 [-]: GETTABLE R8 R9 R7
      46 [-]: JUMPXEQKNIL R8 L8 NOT
      47 [-]: GETIMPORT R8 7 ["EvoShotgunAmmoEffOnPunchthrough"]
      48 [-]: DUPTABLE R9 23
      49 [-]: LOADB R10 0  
...
L 8:  55 [-]: GETIMPORT R10 7 ["EvoShotgunAmmoEffOnPunchthrough"]
...
L10:  67 [-]: JUMPIF R9 L14
      68 [-]: GETIMPORT R11 27 ["gAvatarType"]
      69 [-]: NAMECALL R9 R8 K4 [0xF2DEAF69]
      70 [-]: CALL R9 2 1  
      71 [-]: JUMPIFNOT R9 L14
      72 [-]: NAMECALL R9 R8 K28 [0x388577D5]
      73 [-]: CALL R9 1 1  
      74 [-]: GETIMPORT R10 19 [0xC8802016]
      75 [-]: GETIMPORT R14 7 ["EvoShotgunAmmoEffOnPunchthrough"]
...
L12:  83 [-]: FORGLOOP R10 L11 2 [inext]
      84 [-]: GETIMPORT R13 7 ["EvoShotgunAmmoEffOnPunchthrough"]
      85 [-]: GETTABLE R12 R13 R7
      86 [-]: GETTABLEKS R11 R12 K22 ["hitAvatars"]
      87 [-]: FASTCALL2 52 R11 R9 L13
      88 [-]: MOVE R12 R9  
      89 [-]: GETIMPORT R10 17 [0x23D5322F]
      90 [-]: CALL R10 2 0 
L13:  91 [-]: GETIMPORT R13 7 ["EvoShotgunAmmoEffOnPunchthrough"]
      92 [-]: GETTABLE R12 R13 R7
      93 [-]: GETTABLEKS R11 R12 K22 ["hitAvatars"]
      94 [-]: LENGTH R10 R11
      95 [-]: JUMPXEQKN R10 K29 L14 NOT [3]
      96 [-]: GETIMPORT R11 7 ["EvoShotgunAmmoEffOnPunchthrough"]
