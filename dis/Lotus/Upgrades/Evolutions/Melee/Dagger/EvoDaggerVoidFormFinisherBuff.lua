...
L 2:  14 [-]: LOADB R4 0   
      15 [-]: RETURN R4 1  
L 3:  16 [-]: GETIMPORT R5 8 ["ZarimanDaggerVoidFormActive"]
      17 [-]: FASTCALL1 62 R5 L4
      18 [-]: GETIMPORT R4 2 [0x7B998233]
      19 [-]: CALL R4 1 1  
L 4:  20 [-]: JUMPIF R4 L6 
      21 [-]: GETIMPORT R6 8 ["ZarimanDaggerVoidFormActive"]
...
L 6:  29 [-]: LOADB R4 0   
      30 [-]: RETURN R4 1  
L 7:  31 [-]: GETIMPORT R5 11 ["ZarimanDaggerFinisherBuff"]
      32 [-]: FASTCALL1 62 R5 L8
      33 [-]: GETIMPORT R4 2 [0x7B998233]
      34 [-]: CALL R4 1 1  
L 8:  35 [-]: JUMPIFNOT R4 L9
      36 [-]: GETIMPORT R4 12 ["_T"]
      37 [-]: NEWTABLE R5 0 0
      38 [-]: SETTABLEKS R5 R4 K10 ["ZarimanDaggerFinisherBuff"]
L 9:  39 [-]: NAMECALL R4 R3 K9 [0x388577D5]
      40 [-]: CALL R4 1 1  
      41 [-]: GETIMPORT R7 11 ["ZarimanDaggerFinisherBuff"]
      42 [-]: GETTABLE R6 R7 R4
      43 [-]: FASTCALL1 62 R6 L10
      44 [-]: GETIMPORT R5 2 [0x7B998233]
      45 [-]: CALL R5 1 1  
L10:  46 [-]: JUMPIF R5 L11
      47 [-]: GETIMPORT R6 14 [0x55156FF7]
      48 [-]: CALL R6 0 1  
      49 [-]: GETIMPORT R8 11 ["ZarimanDaggerFinisherBuff"]
      50 [-]: GETTABLE R7 R8 R4
      51 [-]: SUB R5 R6 R7 
      52 [-]: LOADK R6 K15 [1.5]
      53 [-]: JUMPIFNOTLE R6 R5 L12
L11:  54 [-]: GETIMPORT R5 11 ["ZarimanDaggerFinisherBuff"]
      55 [-]: GETIMPORT R6 14 [0x55156FF7]
      56 [-]: CALL R6 0 1  
      57 [-]: SETTABLE R6 R5 R4
      58 [-]: LOADB R5 0   
      59 [-]: RETURN R5 1  
L12:  60 [-]: GETIMPORT R5 11 ["ZarimanDaggerFinisherBuff"]
      61 [-]: LOADNIL R6   
