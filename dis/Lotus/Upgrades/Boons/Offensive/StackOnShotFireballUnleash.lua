...
L 0:  23 [-]: JUMPIF R10 L9; goto L9 if var10
      ...
      28 [-]: NAMECALL R10 R9 K13; var11 = var9; var10 = var9[0x1FB77C2F]
      29 [-]: CALL R10 3 1 ; var10(var11, var12)
      30 [-]: JUMPXEQKNIL R4 L1; 
      31 [-]: MOVE R12 R4  ; var12 = var4
      32 [-]: NAMECALL R10 R9 K14; var11 = var9; var10 = var9[0x419785D7]
      33 [-]: CALL R10 3 1 ; var10(var11, var12)
L 1:  34 [-]: NAMECALL R10 R0 K15; var11 = var0; var10 = var0[0xA5E492D4]
      35 [-]: CALL R10 2 2 ; var10 = var10(var11)
      36 [-]: JUMPIF R10 L2; goto L2 if var10
      37 [-]: LOADN R12 0  ; var12 = 0
      38 [-]: NAMECALL R10 R9 K16; var11 = var9; var10 = var9[0xB643CA98]
      39 [-]: CALL R10 3 1 ; var10(var11, var12)
      40 [-]: RETURN R0 0  ; 
L 2:  41 [-]: LOADN R12 0  ; var12 = 0
      42 [-]: NAMECALL R10 R9 K17; var11 = var9; var10 = var9[0xED516F46]
      43 [-]: CALL R10 3 1 ; var10(var11, var12)
      44 [-]: LOADN R12 0  ; var12 = 0
      45 [-]: NAMECALL R10 R9 K18; var11 = var9; var10 = var9[0x4C4E6C0A]
      46 [-]: CALL R10 3 1 ; var10(var11, var12)
      47 [-]: LOADN R10 0  ; var10 = 0
      48 [-]: NAMECALL R11 R3 K19; var12 = var3; var11 = var3[0x870E163A]
      49 [-]: CALL R11 2 2 ; var11 = var11(var12)
      50 [-]: NAMECALL R12 R3 K20; var13 = var3; var12 = var3[0x327F2778]
...
L 3:  56 [-]: JUMPIF R13 L7; goto L7 if var13
      57 [-]: GETIMPORT R15 22; var15 = gWeaponProjectileFireBehaviorType
      58 [-]: NAMECALL R13 R11 K23; var14 = var11; var13 = var11[0xF2DEAF69]
      ...
      64 [-]: NAMECALL R13 R3 K24; var14 = var3; var13 = var3[0x34D4B1DC]
      65 [-]: CALL R13 5 2 ; var13 = var13(var14, var15, var16, var17)
      66 [-]: MOVE R10 R13 ; var10 = var13
      67 [-]: JUMP L6      ; goto L6
L 4:  68 [-]: FASTCALL1 64 R12 L5; 
      69 [-]: MOVE R14 R12 ; var14 = var12
      70 [-]: GETIMPORT R13 11; var13 = 0x7B998233
      71 [-]: CALL R13 2 2 ; var13 = var13(var14)
L 5:  72 [-]: JUMPIF R13 L6; goto L6 if var13
      73 [-]: LOADB R15 1  ; var15 = true
      74 [-]: LOADB R16 1  ; var16 = true
      75 [-]: NAMECALL R17 R0 K25; var18 = var0; var17 = var0[0x35844CF2]
      76 [-]: CALL R17 2 0 ; var17, ... = var17(var18)
      77 [-]: NAMECALL R13 R12 K26; var14 = var12; var13 = var12[0x95A65687]
      78 [-]: CALL R13 0 2 ; var13 = var13(var14, ...)
      79 [-]: MOVE R10 R13 ; var10 = var13
L 6:  80 [-]: GETIMPORT R13 28; var13 = 0x64D9F944
      81 [-]: JUMPIFNOT R13 L7; goto L7 if not var13
      82 [-]: NAMECALL R13 R11 K29; var14 = var11; var13 = var11[0xD5EAE97E]
      83 [-]: CALL R13 2 2 ; var13 = var13(var14)
      84 [-]: MUL R10 R10 R13; var10 = var10 * var13
L 7:  85 [-]: GETIMPORT R14 31; var14 = 0x310E6526
      86 [-]: GETIMPORT R17 31; var17 = 0x310E6526
      87 [-]: LENGTH R16 R17; var16 = #var17
      88 [-]: FASTCALL2 19 R16 R2 L8; 
      89 [-]: MOVE R17 R2  ; var17 = var2
      90 [-]: GETIMPORT R15 34; var15 = 0x5BCED4C4[0xAC1B386A]
      91 [-]: CALL R15 3 2 ; var15 = var15(var16, var17)
L 8:  92 [-]: GETTABLE R13 R14 R15; var13 = var14[var15]
      93 [-]: MUL R10 R10 R13; var10 = var10 * var13
      94 [-]: MOVE R15 R10 ; var15 = var10
      95 [-]: NAMECALL R13 R9 K35; var14 = var9; var13 = var9[0x5C9C7040]
      96 [-]: CALL R13 3 1 ; var13(var14, var15)
      97 [-]: GETIMPORT R15 37; var15 = 0x3DE944A9
      98 [-]: NAMECALL R13 R9 K38; var14 = var9; var13 = var9[0x76CE1FD1]
...
L 1:  11 [-]: JUMPIF R3 L4 ; goto L4 if var3
      ...
      15 [-]: JUMPIFNOTLT R5 R3 L2; goto L2 if var5 >= var722465
...
L 2:  20 [-]: LOADN R5 0   ; var5 = 0
      21 [-]: JUMPIFNOTLT R5 R4 L3; goto L3 if var5 >= var722465
...
L 7:  46 [-]: GETIMPORT R7 5; var7 = _T["StackOnShotFireballUnleash"]
      ...
      49 [-]: JUMPIFEQ R7 R4 L8; goto L8 if var7 == var329505
...
L11:  74 [-]: GETTABLEKS R9 R7 K22; var9 = var7["hitType"]
      ...
      76 [-]: JUMPIFEQ R9 R10 L12; goto L12 if var9 == var133680
      77 [-]: LOADN R10 2  ; var10 = 2
      78 [-]: JUMPIFEQ R9 R10 L12; goto L12 if var9 == var65571
      79 [-]: RETURN R0 0  ; 
L12:  80 [-]: GETTABLEKS R10 R6 K11; var10 = var6["hitCooldownTimer"]
      81 [-]: LOADN R11 0  ; var11 = 0
      82 [-]: JUMPIFNOTLT R10 R11 L13; goto L13 if var10 >= var1575457
...
L13:  88 [-]: GETTABLEKS R10 R6 K9; var10 = var6["numSuccessHits"]
      ...
      90 [-]: JUMPIFNOTLE R11 R10 L18; goto L18 if var11 > var-754578881
      91 [-]: GETTABLEKS R10 R6 K10; var10 = var6["projCooldownTimer"]
      92 [-]: LOADN R11 0  ; var11 = 0
      93 [-]: JUMPIFNOTLT R10 R11 L18; goto L18 if var10 >= var1903137
     ...
     105 [-]: JUMPIFNOTLT R13 R12 L17; goto L17 if var13 >= var68656
     106 [-]: LOADN R12 1  ; var12 = 1
L14: 107 [-]: LENGTH R13 R10; var13 = #var10
     108 [-]: LOADN R14 0  ; var14 = 0
     109 [-]: JUMPIFNOTLT R14 R13 L17; goto L17 if var14 >= var1706818
     ...
     123 [-]: JUMPIFEQ R13 R14 L15; goto L15 if var13 == var201984797
