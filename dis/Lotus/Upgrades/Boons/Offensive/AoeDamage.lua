...
L 1:  11 [-]: JUMPIF R6 L2 
      ...
      16 [-]: RETURN R0 0  
L 2:  17 [-]: LOADNIL R6   
      18 [-]: GETIMPORT R7 7 [0x16FA3E90]
      19 [-]: JUMPIFNOT R7 L3
      20 [-]: NAMECALL R7 R0 K8 [0xD1586535]
      21 [-]: CALL R7 1 1  
      22 [-]: MOVE R6 R7   
      23 [-]: GETIMPORT R7 10 [0x2C5714C2]
      24 [-]: NAMECALL R7 R7 K11 [0x56C01834]
      25 [-]: CALL R7 1 1  
      26 [-]: JUMPIFNOT R7 L3
      27 [-]: GETIMPORT R9 10 [0x2C5714C2]
      28 [-]: LOADB R10 0  
      29 [-]: NAMECALL R7 R0 K12 [0x003C792F]
      30 [-]: CALL R7 3 1  
      31 [-]: MOVE R6 R7   
L 3:  32 [-]: GETIMPORT R9 14 [0x058DA733]
      33 [-]: GETIMPORT R10 16 ["EMPTY_SYMBOL"]
      34 [-]: GETIMPORT R11 18 ["ZERO_VECTOR"]
      35 [-]: GETIMPORT R12 20 ["ZERO_ROTATION"]
      36 [-]: MOVE R13 R1  
      37 [-]: NAMECALL R7 R0 K21 [0x47901F07]
      38 [-]: CALL R7 6 1  
      39 [-]: GETIMPORT R8 23 [0xCBD666E1]
      40 [-]: GETIMPORT R9 25 [0x04CE8171]
      41 [-]: CALL R8 1 0  
...
L 4:  46 [-]: JUMPIF R8 L5 
      ...
      48 [-]: CALL R8 1 0  
L 5:  49 [-]: GETIMPORT R8 7 [0x16FA3E90]
      50 [-]: JUMPIF R8 L6 
      51 [-]: NAMECALL R8 R0 K8 [0xD1586535]
      52 [-]: CALL R8 1 1  
      53 [-]: MOVE R6 R8   
      54 [-]: GETIMPORT R8 10 [0x2C5714C2]
      55 [-]: NAMECALL R8 R8 K11 [0x56C01834]
      56 [-]: CALL R8 1 1  
      57 [-]: JUMPIFNOT R8 L6
      58 [-]: GETIMPORT R10 10 [0x2C5714C2]
      59 [-]: LOADB R11 0  
      60 [-]: NAMECALL R8 R0 K12 [0x003C792F]
      61 [-]: CALL R8 3 1  
      62 [-]: MOVE R6 R8   
L 6:  63 [-]: GETIMPORT R10 28 ["gPowerSuitType"]
      ...
      71 [-]: GETIMPORT R9 32 [0xB7A3816D]
      72 [-]: MUL R8 R8 R9 
      73 [-]: SETGLOBAL R8 K30 [0xB499339E]
      74 [-]: GETIMPORT R8 34 [0x89326C93]
      75 [-]: GETIMPORT R10 36 [0xA34E0230]
      76 [-]: MOVE R11 R6  
      77 [-]: GETIMPORT R12 20 ["ZERO_ROTATION"]
      78 [-]: MOVE R13 R1  
      79 [-]: NAMECALL R8 R8 K37 [0x05909209]
      80 [-]: CALL R8 5 0  
      81 [-]: JUMP L8
     
L 7:  82 [-]: GETIMPORT R8 34 [0x89326C93]
      83 [-]: GETIMPORT R10 39 [0x4F468D45]
      84 [-]: MOVE R11 R6  
      85 [-]: GETIMPORT R12 20 ["ZERO_ROTATION"]
      86 [-]: MOVE R13 R1  
...
L 8:  89 [-]: GETGLOBAL R10 K40 [0x43E34CBC]
     ...
     116 [-]: CALL R9 2 0  
     117 [-]: GETIMPORT R11 54 [0x0C212CB3]
     118 [-]: LOADN R12 1  
     ...
     126 [-]: GETIMPORT R9 59 [0xC8802016]
     127 [-]: GETIMPORT R10 61 [0xC3615873]
     128 [-]: CALL R9 1 3  
...
L10: 134 [-]: FORGLOOP R9 L9 2 [inext]
     135 [-]: GETIMPORT R9 34 [0x89326C93]
     136 [-]: MOVE R11 R8  
