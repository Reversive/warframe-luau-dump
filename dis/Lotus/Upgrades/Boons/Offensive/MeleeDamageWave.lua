...
L 7:  33 [-]: NAMECALL R6 R5 K9; var7 = var5; var6 = var5[0xE6D4CCD2]
      ...
      36 [-]: JUMPIFEQ R6 R8 L8; goto L8 if var6 == var16779035
...
L 6:  64 [-]: GETTABLEKS R15 R13 K27; var15 = var13["y"]
      ...
      66 [-]: JUMPIFNOTLT R16 R15 L7; goto L7 if var16 >= var2100997
      67 [-]: LOADK R15 K32; var15 = 3.1415927410125732
      68 [-]: DIVK R14 R15 K31; var14 = var15 / 2
      69 [-]: JUMP L8      ; goto L8
L 7:  70 [-]: GETTABLEKS R15 R13 K27; var15 = var13["y"]
      71 [-]: LOADN R16 0  ; var16 = 0
      72 [-]: JUMPIFNOTLT R15 R16 L8; goto L8 if var15 >= var2101253
      73 [-]: LOADK R16 K32; var16 = 3.1415927410125732
      74 [-]: DIVK R15 R16 K31; var15 = var16 / 2
      75 [-]: MINUS R14 R15; 
L 8:  76 [-]: FASTCALL1 10 R14 L9; 
      77 [-]: MOVE R16 R14 ; var16 = var14
      78 [-]: GETIMPORT R15 34; var15 = 0x5BCED4C4[0xBF79B942]
      79 [-]: CALL R15 2 2 ; var15 = var15(var16)
L 9:  80 [-]: SETTABLEKS R15 R8 K35; var15["bank"] = var8
L10:  81 [-]: GETIMPORT R10 37; var10 = 0x89326C93
      82 [-]: GETIMPORT R12 39; var12 = 0x78403F35
      83 [-]: MOVE R13 R7  ; var13 = var7
      84 [-]: MOVE R14 R8  ; var14 = var8
      85 [-]: MOVE R15 R6  ; var15 = var6
      86 [-]: NAMECALL R10 R10 K40; var11 = var10; var10 = var10[0x05909209]
      87 [-]: CALL R10 6 2 ; var10 = var10(var11, var12, var13, var14, var15)
...
L11:  92 [-]: JUMPIFNOT R11 L12; goto L12 if not var11
      93 [-]: RETURN R0 0  ; 
L12:  94 [-]: MOVE R13 R0  ; var13 = var0
      95 [-]: NAMECALL R11 R10 K41; var12 = var10; var11 = var10[0x263A3CC2]
      96 [-]: CALL R11 3 1 ; var11(var12, var13)
      97 [-]: MOVE R13 R6  ; var13 = var6
      98 [-]: NAMECALL R11 R10 K42; var12 = var10; var11 = var10[0xFE447379]
      99 [-]: CALL R11 3 1 ; var11(var12, var13)
     100 [-]: NAMECALL R11 R0 K43; var12 = var0; var11 = var0[0xA5E492D4]
     101 [-]: CALL R11 2 2 ; var11 = var11(var12)
     102 [-]: JUMPIF R11 L13; goto L13 if var11
     103 [-]: LOADN R13 0  ; var13 = 0
     104 [-]: NAMECALL R11 R10 K44; var12 = var10; var11 = var10[0xB643CA98]
     105 [-]: CALL R11 3 1 ; var11(var12, var13)
     106 [-]: RETURN R0 0  ; 
L13: 107 [-]: NAMECALL R11 R6 K45; var12 = var6; var11 = var6[0x327F2778]
     108 [-]: CALL R11 2 2 ; var11 = var11(var12)
     109 [-]: LOADB R16 0  ; var16 = false
     110 [-]: LOADB R17 0  ; var17 = false
     111 [-]: NAMECALL R18 R0 K46; var19 = var0; var18 = var0[0x35844CF2]
     112 [-]: CALL R18 2 0 ; var18, ... = var18(var19)
     113 [-]: NAMECALL R14 R11 K47; var15 = var11; var14 = var11[0x95A65687]
     114 [-]: CALL R14 0 0 ; var14, ... = var14(var15, ...)
     115 [-]: NAMECALL R12 R10 K48; var13 = var10; var12 = var10[0xED516F46]
     116 [-]: CALL R12 0 1 ; var12(var13, ...)
     117 [-]: NAMECALL R13 R11 K50; var14 = var11; var13 = var11[0xDB875EBA]
     118 [-]: CALL R13 2 2 ; var13 = var13(var14)
     119 [-]: MULK R12 R13 K49; var12 = var13 * 0.25
     120 [-]: NAMECALL R13 R6 K51; var14 = var6; var13 = var6[0x68F619A3]
     121 [-]: CALL R13 2 2 ; var13 = var13(var14)
     122 [-]: JUMPIFNOT R13 L14; goto L14 if not var13
     123 [-]: NAMECALL R13 R6 K52; var14 = var6; var13 = var6[0xAABC0325]
     124 [-]: CALL R13 2 2 ; var13 = var13(var14)
     125 [-]: ADD R12 R12 R13; var12 = var12 + var13
L14: 126 [-]: GETIMPORT R13 55; var13 = 0x34291F5C[0x30F5F791]
     127 [-]: CALL R13 1 2 ; var13 = var13()
     128 [-]: JUMPIFNOT R13 L15; goto L15 if not var13
     129 [-]: LOADN R15 3  ; var15 = 3
     130 [-]: MOVE R16 R12 ; var16 = var12
     131 [-]: NAMECALL R13 R10 K56; var14 = var10; var13 = var10[0xA383DE31]
     132 [-]: CALL R13 4 1 ; var13(var14, var15, var16)
     133 [-]: JUMP L16     ; goto L16
L15: 134 [-]: LOADN R15 2  ; var15 = 2
     135 [-]: LOADN R17 1  ; var17 = 1
     136 [-]: ADD R16 R17 R12; var16 = var17 + var12
     137 [-]: NAMECALL R13 R10 K56; var14 = var10; var13 = var10[0xA383DE31]
     138 [-]: CALL R13 4 1 ; var13(var14, var15, var16)
L16: 139 [-]: LOADN R15 2  ; var15 = 2
     140 [-]: GETIMPORT R17 58; var17 = 0xD2B9D984
     141 [-]: MUL R16 R17 R2; var16 = var17 * var2
     142 [-]: NAMECALL R13 R10 K56; var14 = var10; var13 = var10[0xA383DE31]
