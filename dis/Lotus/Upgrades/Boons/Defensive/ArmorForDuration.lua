...
; Max Stack Size:  6
       ...
       3 [-]: GETIMPORT R3 5 [0xAE66A50C]
       4 [-]: LOADN R4 0   
       5 [-]: LOADB R5 0   
       6 [-]: CALL R2 3 1  
       7 [-]: SETTABLEKS R2 R1 K0 ["val"]
       8 [-]: GETIMPORT R2 7 [0xE15169D2]
       9 [-]: SETTABLEKS R2 R1 K1 ["dur"]
      10 [-]: GETIMPORT R2 10 [0xB139D7BC]
      11 [-]: MOVE R3 R1   
      12 [-]: CALL R2 1 -1 
      13 [-]: RETURN R2 -1 
...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R4 1 [0xAE66A50C]
       1 [-]: GETIMPORT R7 3 ["gPowerSuitType"]
       ...
       6 [-]: CALL R5 1 1  
       7 [-]: JUMPIFNOT R5 L0
       8 [-]: GETIMPORT R5 1 [0xAE66A50C]
       9 [-]: GETIMPORT R6 7 [0xBFD85FE6]
      10 [-]: MUL R4 R5 R6 
L 0:  11 [-]: GETIMPORT R5 10 [0x608BC054]
      12 [-]: CALL R5 0 1  
...
L 5:  28 [-]: JUMPIFNOT R6 L6
      ...
      33 [-]: MOVE R10 R4  
      34 [-]: CALL R6 4 0  
      35 [-]: GETIMPORT R8 12 [0x0469F296]
      36 [-]: LOADK R9 K13 ["Update"]
      37 [-]: CALL R8 1 1  
      38 [-]: LOADB R9 0   
      39 [-]: NAMECALL R6 R0 K14 [0xD5F7912B]
      40 [-]: CALL R6 3 0  
L 6:  41 [-]: GETIMPORT R7 8 ["ArmorForDuration"]
...
L 1:   4 [-]: JUMPIF R1 L10
       ...
       6 [-]: CALL R1 1 1  
       7 [-]: JUMPIF R1 L10
       8 [-]: GETIMPORT R2 5 ["ArmorForDuration"]
       9 [-]: FASTCALL1 62 R2 L2
      10 [-]: GETIMPORT R1 1 [0x7B998233]
      11 [-]: CALL R1 1 1  
L 2:  12 [-]: JUMPIF R1 L9 
      13 [-]: GETIMPORT R2 5 ["ArmorForDuration"]
...
L 8:  65 [-]: GETTABLEKS R5 R1 K16 ["statusStruct"]
      ...
      69 [-]: CALL R3 4 0  
L 9:  70 [-]: GETIMPORT R1 20 [0xCBD666E1]
      71 [-]: LOADN R2 0   
      72 [-]: CALL R1 1 0  
      73 [-]: JUMPBACK L0  
L10:  74 [-]: GETIMPORT R2 5 ["ArmorForDuration"]
      75 [-]: FASTCALL1 62 R2 L11
      76 [-]: GETIMPORT R1 1 [0x7B998233]
      77 [-]: CALL R1 1 1  
L11:  78 [-]: JUMPIF R1 L15
      79 [-]: NAMECALL R1 R0 K6 [0x388577D5]
      80 [-]: CALL R1 1 1  
      81 [-]: GETIMPORT R3 5 ["ArmorForDuration"]
      82 [-]: GETTABLE R2 R3 R1
      83 [-]: FASTCALL1 62 R2 L12
      84 [-]: MOVE R4 R2   
      85 [-]: GETIMPORT R3 1 [0x7B998233]
      86 [-]: CALL R3 1 1  
...
L13:  92 [-]: JUMPIF R3 L14
      ...
      97 [-]: CALL R3 4 0  
L14:  98 [-]: GETIMPORT R3 5 ["ArmorForDuration"]
      99 [-]: LOADNIL R4   
