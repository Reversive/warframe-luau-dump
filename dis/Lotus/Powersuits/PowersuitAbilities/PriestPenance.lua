...
; Max Stack Size:  19
 ...
 11 [-]: LOADK     R4 120       ; R4 := 120.000000
 12 [-]: LOADK     R5 250       ; R5 := 250.000000
 13 [-]: LOADK     R6 K4        ; R6 := 0.050000
 14 [-]: LOADK     R7 0         ; R7 := 0.500000
 15 [-]: LOADK     R8 0         ; R8 := 0.500000
 16 [-]: LOADK     R9 50        ; R9 := 50.000000
 ...
 71 [-]: SETGLOBAL R17 K13      ; ActivateAbility := R17
 72 [-]: CLOSURE   R17 8        ; R17 := closure(Function #9)
 73 [-]: MOVE      R0 R4        ; R0 := R4
 74 [-]: MOVE      R0 R7        ; R0 := R7
 75 [-]: MOVE      R0 R8        ; R0 := R8
 76 [-]: SETGLOBAL R17 K14      ; ApplyBuffs := R17
 77 [-]: CLOSURE   R17 9        ; R17 := closure(Function #10)
 78 [-]: MOVE      R0 R7        ; R0 := R7
 79 [-]: MOVE      R0 R8        ; R0 := R8
 80 [-]: SETGLOBAL R17 K15      ; BuffLoop := R17
 81 [-]: CLOSURE   R17 10       ; R17 := closure(Function #11)
 82 [-]: MOVE      R0 R12       ; R0 := R12
 83 [-]: MOVE      R0 R16       ; R0 := R16
 84 [-]: CLOSURE   R18 11       ; R18 := closure(Function #12)
 85 [-]: MOVE      R0 R17       ; R0 := R17
 86 [-]: SETGLOBAL R18 K16      ; OnHit := R18
 87 [-]: CLOSURE   R18 12       ; R18 := closure(Function #13)
 88 [-]: MOVE      R0 R17       ; R0 := R17
 89 [-]: SETGLOBAL R18 K17      ; CondemnAugmentHit := R18
 90 [-]: CLOSURE   R18 13       ; R18 := closure(Function #14)
 91 [-]: MOVE      R0 R13       ; R0 := R13
 92 [-]: MOVE      R0 R2        ; R0 := R2
 93 [-]: SETGLOBAL R18 K18      ; ParticleColor := R18
 94 [-]: CLOSURE   R18 14       ; R18 := closure(Function #15)
 95 [-]: SETGLOBAL R18 K19      ; UpdateAmountHealed := R18
...
114 [-]: JMP       21           ; PC := 21
115 [-]: LT        0 K26 R4     ; if 0.000000 >= R4 then PC := 152
116 [-]: JMP       152          ; PC := 152
117 [-]: GETGLOBAL R22 K27      ; R22 := 0x7b998233
118 [-]: MOVE      R23 R1       ; R23 := R1
119 [-]: CALL      R22 2 2      ; R22 := R22(R23)
120 [-]: TEST      R22 1        ; if R22 then PC := 138
121 [-]: JMP       138          ; PC := 138
122 [-]: SELF      R22 R1 K28   ; R23 := R1; R22 := R1[0x35844cf2]
123 [-]: CALL      R22 2 2      ; R22 := R22(R23)
124 [-]: TEST      R22 0        ; if not R22 then PC := 138
125 [-]: JMP       138          ; PC := 138
126 [-]: SELF      R22 R1 K29   ; R23 := R1; R22 := R1[0x5e651723]
127 [-]: CALL      R22 2 2      ; R22 := R22(R23)
128 [-]: SELF      R22 R22 K30  ; R23 := R22; R22 := R22[0x61c34fa9]
129 [-]: CALL      R22 2 2      ; R22 := R22(R23)
130 [-]: GETGLOBAL R23 K27      ; R23 := 0x7b998233
131 [-]: MOVE      R24 R22      ; R24 := R22
132 [-]: CALL      R23 2 2      ; R23 := R23(R24)
133 [-]: TEST      R23 1        ; if R23 then PC := 138
134 [-]: JMP       138          ; PC := 138
135 [-]: SELF      R23 R22 K31  ; R24 := R22; R23 := R22[0xce421810]
136 [-]: MOVE      R25 R4       ; R25 := R4
137 [-]: CALL      R23 3 1      ; R23(R24,R25)
138 [-]: GETGLOBAL R23 K13      ; R23 := 0x6c97a788
139 [-]: GETTABLE  R23 R23 K32  ; R23 := R23[0x733fc736]
140 [-]: LOADBOOL  R24 1 0      ; R24 := true
141 [-]: CALL      R23 2 2      ; R23 := R23(R24)
142 [-]: SELF      R24 R23 K33  ; R25 := R23; R24 := R23[0x80925b98]
143 [-]: MOVE      R26 R4       ; R26 := R4
144 [-]: CALL      R24 3 1      ; R24(R25,R26)
145 [-]: SELF      R24 R0 K34   ; R25 := R0; R24 := R0[0x3cc932f9]
146 [-]: GETGLOBAL R26 K9       ; R26 := 0x6687f6e0
147 [-]: GETGLOBAL R27 K35      ; R27 := 0x0469f296
148 [-]: LOADK     R28 K36      ; R28 := "UpdateAmountHealed"
149 [-]: CALL      R27 2 2      ; R27 := R27(R28)
150 [-]: MOVE      R28 R23      ; R28 := R23
...
123 [-]: LOADK     R9 233       ; R9 := 233.000000
124 [-]: LOADK     R10 2        ; R10 := 2.000000
125 [-]: GETUPVAL  R11 U0       ; R11 := U0
126 [-]: CALL      R7 5 1       ; R7(R8,R9,R10,R11)
127 [-]: SELF      R7 R1 K33    ; R8 := R1; R7 := R1[0x12dd9da2]
128 [-]: LOADK     R9 325       ; R9 := 325.000000
129 [-]: LOADK     R10 2        ; R10 := 2.000000
...
; Max Stack Size:  13
  ...
  7 [-]: SELF      R8 R0 K1     ; R9 := R0; R8 := R0[0x5163741e]
  8 [-]: CALL      R8 2 2       ; R8 := R8(R9)
