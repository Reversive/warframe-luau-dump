...
112 [-]: GETGLOBAL R18 K42      ; R18 := _T
113 [-]: GETTABLE  R18 R18 K43  ; R18 := R18["AddAbilityTimer"]
114 [-]: TEST      R18 0        ; if not R18 then PC := 123
115 [-]: JMP       123          ; PC := 123
116 [-]: GETGLOBAL R18 K42      ; R18 := _T
117 [-]: GETTABLE  R18 R18 K44  ; R18 := R18[0xcc4ac7a6]
118 [-]: MOVE      R19 R17      ; R19 := R17
119 [-]: MOVE      R20 R1       ; R20 := R1
120 [-]: MOVE      R21 R6       ; R21 := R6
121 [-]: CONST     R22 0        ; R22 := 0.000000
122 [-]: CALL      R18 5 1      ; R18(R19,R20,R21,R22)
123 [-]: LT        0 K45 R6     ; if 0.000000 >= R6 then PC := 226
124 [-]: JMP       226          ; PC := 226
125 [-]: GETGLOBAL R18 K4       ; R18 := 0x7b998233
126 [-]: GETGLOBAL R19 K1       ; R19 := 0x6687f6e0
127 [-]: CALL      R18 2 2      ; R18 := R18(R19)
128 [-]: TEST      R18 1        ; if R18 then PC := 226
129 [-]: JMP       226          ; PC := 226
130 [-]: GETGLOBAL R18 K1       ; R18 := 0x6687f6e0
131 [-]: SELF      R18 R18 K46  ; R19 := R18; R18 := R18[0x30f46140]
132 [-]: CALL      R18 2 2      ; R18 := R18(R19)
133 [-]: TEST      R18 1        ; if R18 then PC := 226
134 [-]: JMP       226          ; PC := 226
135 [-]: TEST      R7 0         ; if not R7 then PC := 216
136 [-]: JMP       216          ; PC := 216
137 [-]: LT        0 K45 R15    ; if 0.000000 >= R15 then PC := 216
138 [-]: JMP       216          ; PC := 216
139 [-]: LT        0 R8 K45     ; if R8 >= 0.000000 then PC := 216
140 [-]: JMP       216          ; PC := 216
141 [-]: GETGLOBAL R18 K47      ; R18 := 0x808dc004
142 [-]: MOVE      R19 R12      ; R19 := R12
143 [-]: MOVE      R20 R10      ; R20 := R10
144 [-]: GETGLOBAL R21 K48      ; R21 := 0xf6c6e505
145 [-]: MOVE      R22 R14      ; R22 := R14
146 [-]: CALL      R21 2 2      ; R21 := R21(R22)
147 [-]: MUL       R21 R21 R4   ; R21 := R21 * R4
148 [-]: GETGLOBAL R22 K32      ; R22 := 0xa421af95
149 [-]: GETGLOBAL R23 K49      ; R23 := 0x5bced4c4
150 [-]: GETTABLE  R23 R23 K50  ; R23 := R23[0x3630e649]
151 [-]: CONST     R24 -8       ; R24 := -8.000000
152 [-]: CONST     R25 8        ; R25 := 8.000000
153 [-]: CALL      R23 3 2      ; R23 := R23(R24,R25)
154 [-]: GETGLOBAL R24 K49      ; R24 := 0x5bced4c4
155 [-]: GETTABLE  R24 R24 K50  ; R24 := R24[0x3630e649]
156 [-]: CONST     R25 -8       ; R25 := -8.000000
157 [-]: CONST     R26 8        ; R26 := 8.000000
158 [-]: CALL      R24 3 2      ; R24 := R24(R25,R26)
159 [-]: GETGLOBAL R25 K49      ; R25 := 0x5bced4c4
160 [-]: GETTABLE  R25 R25 K50  ; R25 := R25[0x3630e649]
161 [-]: CONST     R26 -8       ; R26 := -8.000000
162 [-]: CONST     R27 8        ; R27 := 8.000000
163 [-]: CALL      R25 3 0      ; R25,... := R25(R26,R27)
164 [-]: CALL      R22 0 2      ; R22 := R22(R23,...)
165 [-]: ADD       R21 R21 R22  ; R21 := R21 + R22
166 [-]: CALL      R18 4 1      ; R18(R19,R20,R21)
167 [-]: GETGLOBAL R18 K20      ; R18 := 0x89326c93
168 [-]: SELF      R18 R18 K51  ; R19 := R18; R18 := R18[0xdb88e2d9]
169 [-]: MOVE      R20 R10      ; R20 := R10
170 [-]: MOVE      R21 R12      ; R21 := R12
171 [-]: LOADNIL   R22 R22      ; R22 := nil
172 [-]: MOVE      R23 R16      ; R23 := R16
173 [-]: LOADNIL   R24 R24      ; R24 := nil
174 [-]: MOVE      R25 R13      ; R25 := R13
175 [-]: MOVE      R26 R14      ; R26 := R14
176 [-]: CALL      R18 9 2      ; R18 := R18(R19,R20,R21,R22,R23,R24,R25,R26)
177 [-]: TEST      R18 0        ; if not R18 then PC := 216
178 [-]: JMP       216          ; PC := 216
179 [-]: GETGLOBAL R18 K20      ; R18 := 0x89326c93
180 [-]: SELF      R18 R18 K21  ; R19 := R18; R18 := R18[0x05909209]
181 [-]: GETGLOBAL R20 K52      ; R20 := 0x9e567492
182 [-]: MOVE      R21 R11      ; R21 := R11
183 [-]: GETGLOBAL R22 K18      ; R22 := ZERO_ROTATION
184 [-]: MOVE      R23 R0       ; R23 := R0
185 [-]: CALL      R18 6 2      ; R18 := R18(R19,R20,R21,R22,R23)
186 [-]: MOVE      R9 R18       ; R9 := R18
187 [-]: GETGLOBAL R18 K4       ; R18 := 0x7b998233
188 [-]: MOVE      R19 R9       ; R19 := R9
189 [-]: CALL      R18 2 2      ; R18 := R18(R19)
190 [-]: TEST      R18 1        ; if R18 then PC := 215
191 [-]: JMP       215          ; PC := 215
192 [-]: SUB       R15 R15 K53  ; R15 := R15 - 1.000000
193 [-]: GETGLOBAL R18 K54      ; R18 := 0x5db3ce80
194 [-]: MOVE      R19 R11      ; R19 := R11
195 [-]: MOVE      R20 R13      ; R20 := R13
196 [-]: LOADK     R21 K55      ; R21 := 0.980000
197 [-]: CALL      R18 4 2      ; R18 := R18(R19,R20,R21)
198 [-]: MOVE      R11 R18      ; R11 := R18
199 [-]: SELF      R18 R9 K56   ; R19 := R9; R18 := R9[0x9e9c67cb]
200 [-]: MOVE      R20 R11      ; R20 := R11
201 [-]: CALL      R18 3 1      ; R18(R19,R20)
202 [-]: GETGLOBAL R18 K54      ; R18 := 0x5db3ce80
203 [-]: MOVE      R19 R11      ; R19 := R11
204 [-]: MOVE      R20 R13      ; R20 := R13
205 [-]: LOADK     R21 K57      ; R21 := 0.700000
206 [-]: CALL      R18 4 2      ; R18 := R18(R19,R20,R21)
207 [-]: MOVE      R10 R18      ; R10 := R18
208 [-]: GETTABLE  R18 R14 K34  ; R18 := R14["pitch"]
209 [-]: GETGLOBAL R19 K58      ; R19 := 0xc163f229
210 [-]: CONST     R20 -40      ; R20 := -40.000000
211 [-]: CONST     R21 40       ; R21 := 40.000000
212 [-]: CALL      R19 3 2      ; R19 := R19(R20,R21)
213 [-]: ADD       R18 R18 R19  ; R18 := R18 + R19
214 [-]: SETTABLE  R14 K34 R18  ; R14["pitch"] := R18
215 [-]: LOADK     R8 K59       ; R8 := 0.100000
216 [-]: GETGLOBAL R18 K60      ; R18 := 0xcbd666e1
217 [-]: CONST     R19 0        ; R19 := 0.000000
218 [-]: CALL      R18 2 1      ; R18(R19)
219 [-]: GETGLOBAL R18 K61      ; R18 := 0x67652851
220 [-]: CALL      R18 1 2      ; R18 := R18()
221 [-]: SUB       R8 R8 R18    ; R8 := R8 - R18
222 [-]: GETGLOBAL R18 K61      ; R18 := 0x67652851
223 [-]: CALL      R18 1 2      ; R18 := R18()
224 [-]: SUB       R6 R6 R18    ; R6 := R6 - R18
225 [-]: JMP       123          ; PC := 123
...
; Max Stack Size:  7
 ...
 15 [-]: GETTABLE  R2 R2 K5     ; R2 := R2[0x68d66e6e]
 16 [-]: MOVE      R3 R0        ; R3 := R0
...
135 [-]: CONST     R33 25       ; R33 := 25.000000
136 [-]: MOVE      R34 R28      ; R34 := R28
137 [-]: CONST     R35 0        ; R35 := 0.000000
...
216 [-]: JMP       218          ; PC := 218
217 [-]: LOADKB    R20 0 1      ; R20 := false; PC := 218
