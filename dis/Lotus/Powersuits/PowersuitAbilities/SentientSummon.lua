...
; Max Stack Size:  24
 ...
 78 [-]: CONST     R21 10       ; R21 := 10.000000
 79 [-]: CONST     R22 0        ; R22 := 0.000000
 80 [-]: CONST     R23 -10      ; R23 := -10.000000
...
172 [-]: CONST     R25 120      ; R25 := 120.000000
173 [-]: CONST     R26 2        ; R26 := 2.000000
...
; Max Stack Size:  10
 ...
 18 [-]: SELF      R3 R3 K5     ; R4 := R3; R3 := R3[0xf7d48ee0]
 ...
 25 [-]: JMP       35           ; PC := 35
 26 [-]: SELF      R3 R0 K6     ; R4 := R0; R3 := R0[0x47901f07]
 27 [-]: GETGLOBAL R5 K7        ; R5 := 0x84fd0e75
 28 [-]: GETGLOBAL R6 K8        ; R6 := 0x0469f296
 29 [-]: LOADK     R7 K9        ; R7 := "GAME_C1_SPINE2"
 30 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 31 [-]: GETGLOBAL R7 K10       ; R7 := ZERO_VECTOR
 32 [-]: GETGLOBAL R8 K11       ; R8 := ZERO_ROTATION
 33 [-]: MOVE      R9 R2        ; R9 := R2
