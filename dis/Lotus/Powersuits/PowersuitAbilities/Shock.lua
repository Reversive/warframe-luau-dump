...
; Max Stack Size:  15
  ...
  2 [-]: GETTABLE  R3 R3 K0     ; R82 := R3[0x7baa66e1]
  3 [-]: CALL      R3 1 2       ; R3 := R3()
...
; Max Stack Size:  5
 ...
 24 [-]: GETTABLE  R1 R1 K8     ; R82 := R1[0x23d5322f]
 25 [-]: MOVE      R2 R0        ; R2 := R0
...
; Max Stack Size:  6
 ...
 21 [-]: GETTABLE  R3 R3 K9     ; R82 := R3[0xb139d7bc]
 22 [-]: MOVE      R4 R2        ; R4 := R2
...
; Max Stack Size:  26
 ...
 28 [-]: GETTABLE  R12 R12 K7   ; R82 := R12[0x7258f36f]
 ...
 51 [-]: GETTABLE  R18 R18 K14  ; R82 := R18[0x30f5f791]
 ...
 59 [-]: OP_LOADBOOL R20 0 0      ; R20 := false
 60 [-]: CALL      R18 3 1      ; R18(R19,R20)
 61 [-]: GETUPVAL  R18 U1       ; R18 := U1
 62 [-]: GETTABLE  R18 R18 K16  ; R82 := R18[0x688dff79]
 ...
 71 [-]: CONST     R23 5        ; R23 := 5.000000
 72 [-]: CONST     R24 0        ; R24 := 0.000000
 73 [-]: OP_LOADBOOL R25 0 0      ; R25 := false
...
; Max Stack Size:  8
 ...
 19 [-]: GETTABLE  R5 R5 K5     ; R82 := R5[0x9c1f3b5a]
 20 [-]: MOVE      R6 R0        ; R6 := R0
 21 [-]: MOVE      R7 R4        ; R7 := R4
...
; Max Stack Size:  21
 ...
 51 [-]: GETTABLE  R12 R12 K13  ; R82 := R12[0x32316a21]
 ...
 60 [-]: OP_LOADBOOL R16 0 0      ; R16 := false
 ...
 66 [-]: GETTABLE  R12 R12 K18  ; R82 := R12[0x7baa66e1]
...
; Max Stack Size:  42
 ...
 53 [-]: GETTABLE  R13 R13 K12  ; R82 := R13[0x32316a21]
 ...
 76 [-]: GETTABLE  R18 R18 K14  ; R82 := R18[0xfabc505b]
 ...
 83 [-]: GETTABLE  R18 R18 K16  ; R82 := R18[0x23d5322f]
 ...
 95 [-]: CONST     R23 0        ; R23 := 0.000000
 96 [-]: GETUPVAL  R24 U1       ; R24 := U1
 97 [-]: GETTABLE  R24 R24 K12  ; R82 := R24[0x32316a21]
...
104 [-]: GETTABLE  R24 R24 K20  ; R82 := R24[0x35c16153]
...
113 [-]: CONST     R27 5        ; R27 := 5.000000
114 [-]: CONST     R28 1        ; R28 := 1.000000
...
188 [-]: OP_LOADBOOL R34 1 0      ; R34 := true
...
193 [-]: GETTABLE  R27 R27 K16  ; R82 := R27[0x23d5322f]
...
211 [-]: GETTABLE  R27 R27 K31  ; R82 := R27[0x7258f36f]
...
242 [-]: CONST     R38 8        ; R38 := 8.000000
243 [-]: CALL      R36 3 2      ; R36 := R36(R37,R38)
244 [-]: NOT       R36 R36      ; R36 := not R36
245 [-]: JMP       248          ; PC := 248
246 [-]: OP_LOADBOOL R36 0 1      ; R36 := false; PC := 247
247 [-]: OP_LOADBOOL R36 1 0      ; R36 := true
...
260 [-]: GETTABLE  R33 R33 K40  ; R82 := R33[0x30f5f791]
...
268 [-]: OP_LOADBOOL R35 0 0      ; R35 := false
269 [-]: CALL      R33 3 1      ; R33(R34,R35)
270 [-]: GETUPVAL  R33 U8       ; R33 := U8
271 [-]: GETTABLE  R33 R33 K42  ; R82 := R33[0x688dff79]
...
278 [-]: CONST     R38 5        ; R38 := 5.000000
279 [-]: CONST     R39 0        ; R39 := 0.000000
280 [-]: OP_LOADBOOL R40 0 0      ; R40 := false
...
; Max Stack Size:  35
 ...
 13 [-]: GETTABLE  R10 R10 K1   ; R82 := R10[0x32316a21]
 ...
 31 [-]: GETTABLE  R11 R11 K7   ; R82 := R11[0x35c16153]
...
116 [-]: GETTABLE  R16 R16 K21  ; R82 := R16[0x7258f36f]
...
148 [-]: CONST     R27 8        ; R27 := 8.000000
149 [-]: CALL      R25 3 2      ; R25 := R25(R26,R27)
150 [-]: NOT       R25 R25      ; R25 := not R25
151 [-]: JMP       154          ; PC := 154
152 [-]: OP_LOADBOOL R25 0 1      ; R25 := false; PC := 153
153 [-]: OP_LOADBOOL R25 1 0      ; R25 := true
...
166 [-]: GETTABLE  R22 R22 K33  ; R82 := R22[0x30f5f791]
...
174 [-]: OP_LOADBOOL R24 0 0      ; R24 := false
175 [-]: CALL      R22 3 1      ; R22(R23,R24)
176 [-]: GETUPVAL  R22 U7       ; R22 := U7
177 [-]: GETTABLE  R22 R22 K35  ; R82 := R22[0x688dff79]
...
184 [-]: CONST     R27 5        ; R27 := 5.000000
185 [-]: CONST     R28 0        ; R28 := 0.000000
186 [-]: OP_LOADBOOL R29 0 0      ; R29 := false
...
; Max Stack Size:  11
 ...
 56 [-]: OP_LOADBOOL R9 0 0       ; R9 := false
...
; Max Stack Size:  61
 ...
 35 [-]: SETUPVAL  R13 U6       ; U82 := 
 36 [-]: SETUPVAL  R12 U5       ; U82 := 
 37 [-]: SETUPVAL  R11 U4       ; U82 := 
...
159 [-]: OP_LOADBOOL R24 0 0      ; R24 := false
...
235 [-]: GETTABLE  R23 R23 K58  ; R82 := R23[0x7baa66e1]
...
258 [-]: GETTABLE  R27 R27 K61  ; R82 := R27[0xac1b386a]
...
294 [-]: GETTABLE  R36 R36 K66  ; R82 := R36[0x30f5f791]
...
305 [-]: GETTABLE  R36 R36 K68  ; R82 := R36[0x688dff79]
...
312 [-]: GETTABLE  R39 R39 K69  ; R82 := R39[0x7258f36f]
...
365 [-]: GETTABLE  R40 R40 K72  ; R82 := R40[0x32316a21]
...
389 [-]: OP_LOADBOOL R44 0 0      ; R44 := false
390 [-]: CONST     R45 0        ; R45 := 0.000000
...
429 [-]: CONST     R44 5        ; R44 := 5.000000
430 [-]: CONST     R45 1        ; R45 := 1.000000
...
477 [-]: GETTABLE  R47 R47 K66  ; R82 := R47[0x30f5f791]
...
485 [-]: OP_LOADBOOL R49 0 0      ; R49 := false
486 [-]: CALL      R47 3 1      ; R47(R48,R49)
487 [-]: GETUPVAL  R47 U9       ; R47 := U9
488 [-]: GETTABLE  R47 R47 K68  ; R82 := R47[0x688dff79]
...
495 [-]: CONST     R52 5        ; R52 := 5.000000
496 [-]: CONST     R53 0        ; R53 := 0.000000
497 [-]: OP_LOADBOOL R54 0 0      ; R54 := false
498 [-]: CALL      R50 5 1      ; R50(R51,R52,R53,R54)
499 [-]: GETGLOBAL R50 K90      ; R50 := 0x33bdd652
500 [-]: GETTABLE  R50 R50 K91  ; R82 := R50[0x23d5322f]
...
566 [-]: GETTABLE  R50 R50 K66  ; R82 := R50[0x30f5f791]
...
574 [-]: OP_LOADBOOL R52 0 0      ; R52 := false
