...
; Max Stack Size:  22
 ...
 13 [-]: LOADK     R6 K5        ; R6 := 0.010000
 14 [-]: GETGLOBAL R7 K2        ; R7 := 0x0469f296
 15 [-]: LOADK     R8 K6        ; R8 := "RHINO_STOMP_GETUP"
 16 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 17 [-]: GETGLOBAL R8 K2        ; R8 := 0x0469f296
 18 [-]: LOADK     R9 K7        ; R9 := "RhinoStompAbilityUsedInSegment"
 ...
 41 [-]: SETGLOBAL R13 K8       ; GetAbilityUpgradeLevelInfo := R13
 ...
 47 [-]: MOVE      R0 R2        ; R0 := R2
 48 [-]: SETGLOBAL R13 K10      ; InitializeAbility := R13
 49 [-]: CLOSURE   R13 7        ; R13 := closure(Function #8)
 50 [-]: MOVE      R0 R8        ; R0 := R8
 51 [-]: SETGLOBAL R13 K11      ; NpcEvaluateAbility := R13
 52 [-]: LOADNIL   R13 R17      ; R13 := R14 := R15 := R16 := R17 := nil
 53 [-]: NEWTABLE  R18 0 3      ; R18 := {}
 54 [-]: SETTABLE  R18 K12 K13  ; R18["npc"] := true
 55 [-]: SETTABLE  R18 K14 K15  ; R18["duration"] := 0.000000
 56 [-]: SETTABLE  R18 K16 K15  ; R18["animIndex"] := 0.000000
 ...
 66 [-]: MOVE      R0 R2        ; R0 := R2
 67 [-]: MOVE      R0 R7        ; R0 := R7
 68 [-]: SETGLOBAL R19 K17      ; TargetStomp := R19
 69 [-]: NEWTABLE  R19 0 0      ; R19 := {}
 70 [-]: CLOSURE   R20 9        ; R20 := closure(Function #10)
 71 [-]: MOVE      R0 R19       ; R0 := R19
 72 [-]: SETGLOBAL R20 K18      ; StompWait := R20
 ...
 97 [-]: SETGLOBAL R21 K19      ; ActivateAbility := R21
 98 [-]: CLOSURE   R21 12       ; R21 := closure(Function #13)
 99 [-]: MOVE      R0 R0        ; R0 := R0
100 [-]: SETGLOBAL R21 K20      ; DeactivateAbility := R21
...
106 [-]: SETGLOBAL R21 K21      ; CrewShipInfo := R21
...
115 [-]: SETGLOBAL R21 K22      ; CrewShipActivate := R21
...
; Max Stack Size:  2
 ...
 13 [-]: JMP       23           ; PC := 23
 14 [-]: CONST     R1 300       ; R1 := 300.000000
 15 [-]: SETUPVAL  R1 U0        ; U82 := R0
 16 [-]: CONST     R1 18        ; R1 := 18.000000
 ...
 64 [-]: JMP       76           ; PC := 76
 65 [-]: CONST     R1 288       ; R1 := 288.000000
 66 [-]: SETUPVAL  R1 U0        ; U82 := R0
 67 [-]: CONST     R1 5         ; R1 := 5.000000
 ...
 77 [-]: JMP       89           ; PC := 89
 78 [-]: CONST     R1 298       ; R1 := 298.000000
 79 [-]: SETUPVAL  R1 U0        ; U82 := R0
 80 [-]: CONST     R1 6         ; R1 := 6.000000
 81 [-]: SETUPVAL  R1 U1        ; U82 := R1
 82 [-]: CONST     R1 0         ; R1 := 0.500000
 83 [-]: SETGLOBAL R1 K1        ; (0x91be34e1) := R1
 84 [-]: CONST     R1 2         ; R1 := 2.000000
 ...
 90 [-]: JMP       102          ; PC := 102
 91 [-]: CONST     R1 308       ; R1 := 308.000000
 92 [-]: SETUPVAL  R1 U0        ; U82 := R0
 93 [-]: CONST     R1 7         ; R1 := 7.000000
 94 [-]: SETUPVAL  R1 U1        ; U82 := R1
 95 [-]: CONST     R1 0         ; R1 := 0.500000
 96 [-]: SETGLOBAL R1 K1        ; (0x91be34e1) := R1
 97 [-]: CONST     R1 2         ; R1 := 2.500000
 98 [-]: SETGLOBAL R1 K3        ; (0xd74896f8) := R1
 99 [-]: CONST     R1 7         ; R1 := 7.000000
100 [-]: SETUPVAL  R1 U3        ; U82 := R3
101 [-]: JMP       112          ; PC := 112
102 [-]: CONST     R1 318       ; R1 := 318.000000
103 [-]: SETUPVAL  R1 U0        ; U82 := R0
104 [-]: CONST     R1 8         ; R1 := 8.000000
...
; Max Stack Size:  3
 ...
 14 [-]: JMP       18           ; PC := 18
 15 [-]: LOADK     R2 K6        ; R2 := 0.030000
 16 [-]: SETUPVAL  R2 U0        ; U82 := R0
 17 [-]: JMP       20           ; PC := 20
 18 [-]: LOADK     R2 K7        ; R2 := 0.040000
...
; Max Stack Size:  13
 ...
 44 [-]: SETTABLE  R10 K12 K13  ; R10["Label"] := "/Lotus/Language/Suits/RhinoStompAbilityAugment1Name"
 ...
 51 [-]: SETTABLE  R10 K12 K16  ; R10["Label"] := "/Lotus/Language/Game/RESTORATION_NO_UNIT"
 52 [-]: GETGLOBAL R11 K18      ; R11 := 0x5bced4c4
 53 [-]: GETTABLE  R11 R11 K19  ; R11 := R11[0x55f27c30]
 54 [-]: GETUPVAL  R12 U1       ; R12 := U1
 55 [-]: MUL       R12 R12 K20  ; R12 := R12 * 1000.000000
 56 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 57 [-]: DIV       R11 R11 K21  ; R11 := R11 / 10.000000
 58 [-]: SETTABLE  R10 K17 R11  ; R10["Value"] := R11
 59 [-]: SETTABLE  R10 K22 K23  ; R10["ValueUnit"] := "/Lotus/Language/Game/UNIT_PERCENT"
...
; Max Stack Size:  5
 ...
 26 [-]: GETTABLE  R1 R1 K9     ; R1 := R1[0x23d5322f]
 27 [-]: MOVE      R2 R0        ; R2 := R0
...
118 [-]: GETTABLE  R11 R11 K39  ; R11 := R11[0x35c16153]
...
162 [-]: GETTABLE  R12 R12 K39  ; R12 := R12[0x35c16153]
...
177 [-]: GETTABLE  R13 R13 K47  ; R13 := R13[0x32316a21]
...
203 [-]: GETTABLE  R13 R13 K47  ; R13 := R13[0x32316a21]
...
223 [-]: GETTABLE  R14 R14 K53  ; R14 := R14[0x608bc054]
...
287 [-]: CONST     R17 20       ; R17 := 20.000000
288 [-]: LOADKB    R18 0 0      ; R18 := false
...
328 [-]: CONST     R19 3        ; R19 := 3.000000
329 [-]: CONST     R20 1        ; R20 := 1.000000
...
335 [-]: LOADKB    R18 0 0      ; R18 := false
336 [-]: CONST     R19 3        ; R19 := 3.000000
337 [-]: CONST     R20 1        ; R20 := 1.000000
338 [-]: LOADKB    R21 1 0      ; R21 := true
...
; Max Stack Size:  41
 ...
 52 [-]: GETTABLE  R8 R8 K14    ; R8 := R8[0x32316a21]
...
143 [-]: GETTABLE  R18 R18 K39  ; R18 := R18[0x23d5322f]
...
150 [-]: SETTABLE  R20 K40 R21  ; R20["instance"] := R21
...
184 [-]: GETTABLE  R18 R18 K44  ; R18 := R18[0x5cb2adf8]
...
209 [-]: SETTABLE  R18 K55 R7   ; R18["fallOff"] := R7
...
236 [-]: GETTABLE  R22 R22 K14  ; R22 := R22[0x32316a21]
...
258 [-]: GETTABLE  R28 R28 K65  ; R28 := R28[0xfabc505b]
...
276 [-]: GETTABLE  R28 R28 K39  ; R28 := R28[0x23d5322f]
...
328 [-]: LOADKB    R37 0 0      ; R37 := false
329 [-]: CONST     R38 0        ; R38 := 0.000000
...
; Max Stack Size:  16
 ...
 28 [-]: GETTABLE  R7 R7 K6     ; R7 := R7[0xb443c7bd]
 29 [-]: MOVE      R8 R1        ; R8 := R1
 30 [-]: GETGLOBAL R9 K7        ; R9 := 0x99cb4b90
 31 [-]: GETGLOBAL R10 K8       ; R10 := 0x0ed8b456
 32 [-]: LOADK     R11 K9       ; R11 := "RhinoStompImpact"
 33 [-]: CALL      R7 5 2       ; R7 := R7(R8,R9,R10,R11)
 34 [-]: TEST      R7 1         ; if R7 then PC := 37
 35 [-]: JMP       37           ; PC := 37
 36 [-]: RETURN    R0 1         ; return 
 37 [-]: SELF      R7 R1 K10    ; R8 := R1; R7 := R1[0xd1586535]
 38 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 39 [-]: TEST      R6 0         ; if not R6 then PC := 57
 40 [-]: JMP       57           ; PC := 57
 41 [-]: SELF      R8 R0 K11    ; R9 := R0; R8 := R0[0x689412a5]
 42 [-]: GETGLOBAL R10 K12      ; R10 := 0x7ed0a956
 43 [-]: LOADK     R11 K13      ; R11 := "/Lotus/Powersuits/PowersuitAbilities/IronSkinAbility"
 ...
 50 [-]: JMP       55           ; PC := 55
 51 [-]: SELF      R9 R8 K15    ; R10 := R8; R9 := R8[0xd8140b94]
 ...
 65 [-]: SELF      R9 R0 K16    ; R10 := R0; R9 := R0[0x0d0482e0]
 66 [-]: CALL      R9 2 1       ; R9(R10)
 67 [-]: SELF      R9 R1 K17    ; R10 := R1; R9 := R1[0xd5f7912b]
 68 [-]: GETGLOBAL R11 K18      ; R11 := 0x0469f296
 69 [-]: LOADK     R12 K19      ; R12 := "StompWait"
...
; Max Stack Size:  14
 ...
 32 [-]: GETTABLE  R8 R8 K5     ; R8 := R8[0x6b3430b5]
 33 [-]: MOVE      R9 R7        ; R9 := R7
