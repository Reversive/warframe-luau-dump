...
; Max Stack Size:  21
      ...
      44 [-]: GETIMPORT R14 12 [0x0ED8B456]
      45 [-]: LOADB R15 0  
      46 [-]: LOADN R16 2  
      47 [-]: LOADN R17 1  
      48 [-]: LOADB R18 1  
...
L 0:  55 [-]: LOADK R11 K10 ["Push"]
      56 [-]: GETIMPORT R14 12 [0x0ED8B456]
      57 [-]: LOADB R15 0  
      58 [-]: LOADN R16 2  
      59 [-]: LOADN R17 1  
      60 [-]: LOADB R18 1  
      ...
      64 [-]: CALL R9 -1 0 
L 1:  65 [-]: GETIMPORT R11 16 [0x4F468D45]
      66 [-]: GETIMPORT R12 18 ["EMPTY_SYMBOL"]
      67 [-]: NAMECALL R9 R1 K19 [0x47901F07]
      68 [-]: CALL R9 3 0  
      69 [-]: NAMECALL R9 R1 K9 [0xA5E492D4]
      70 [-]: CALL R9 1 1  
      71 [-]: JUMPIFNOT R9 L2
      72 [-]: GETIMPORT R11 21 [0xC0345C16]
      73 [-]: LOADB R12 0  
      74 [-]: LOADN R13 0  
      75 [-]: LOADB R14 0  
...
L 2:  79 [-]: GETIMPORT R11 24 [0xAD292A29]
      80 [-]: LOADB R12 0  
      81 [-]: LOADN R13 0  
      82 [-]: LOADB R14 0  
      83 [-]: NAMECALL R9 R1 K22 [0x659D451F]
      84 [-]: CALL R9 5 0  
L 3:  85 [-]: GETIMPORT R9 26 [0x89326C93]
      ...
      91 [-]: MOVE R11 R1  
      92 [-]: CALL R9 2 1  
      93 [-]: GETIMPORT R10 30 [0x35C16153]
      94 [-]: CALL R10 0 1 
     ...
     116 [-]: GETIMPORT R11 38 [0xC8802016]
     117 [-]: MOVE R12 R9  
     118 [-]: CALL R11 1 3 
...
L 5: 128 [-]: NAMECALL R17 R15 K41 [0xF6EBD926]
     ...
     131 [-]: CALL R18 1 1 
     132 [-]: SUB R16 R17 R18
     133 [-]: GETIMPORT R17 43 [0xC2892F65]
     134 [-]: MOVE R18 R16 
     135 [-]: CALL R17 1 0 
     136 [-]: GETIMPORT R20 45 [0xEA2D2D0D]
     137 [-]: MUL R19 R16 R20
...
L 8: 149 [-]: LOADN R11 1  
     ...
     151 [-]: GETIMPORT R12 51 [0x67652851]
     152 [-]: CALL R12 0 1 
     ...
     162 [-]: CALL R11 5 0 
     163 [-]: GETIMPORT R11 55 [0xCBD666E1]
     164 [-]: LOADN R12 0  
     165 [-]: CALL R11 1 0 
     166 [-]: JUMPBACK L8  
     167 [-]: RETURN R0 0  
L 9: 168 [-]: LOADN R11 1  
     ...
     170 [-]: GETIMPORT R12 51 [0x67652851]
     171 [-]: CALL R12 0 1 
     172 [-]: MULK R11 R12 K49 [4]
     173 [-]: ADD R10 R10 R11
     174 [-]: GETIMPORT R11 55 [0xCBD666E1]
     175 [-]: LOADN R12 0  
     176 [-]: CALL R11 1 0 
     177 [-]: JUMPBACK L9  
L10: 178 [-]: RETURN R0 0  
