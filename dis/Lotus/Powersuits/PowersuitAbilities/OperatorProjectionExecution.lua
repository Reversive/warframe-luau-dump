...
L 4:  36 [-]: GETIMPORT R5 1 [0x0469F296]
      ...
      49 [-]: GETIMPORT R6 12 [0x55F27C30]
      50 [-]: CALL R6 1 1  
L 5:  51 [-]: SETTABLEKS R6 R5 K15 ["PERCENT"]
      52 [-]: MOVE R3 R5   
L 6:  53 [-]: GETIMPORT R5 21 [0xB139D7BC]
      54 [-]: MOVE R6 R3   
      55 [-]: CALL R5 1 -1 
      56 [-]: RETURN R5 -1 
...
; Max Stack Size:  11
      ...
      24 [-]: CALL R6 2 0  
      25 [-]: LOADNIL R6   
      26 [-]: GETIMPORT R8 13 [0x6D655F77]
      27 [-]: FASTCALL1 62 R8 L0
      28 [-]: GETIMPORT R7 15 [0x7B998233]
      29 [-]: CALL R7 1 1  
L 0:  30 [-]: JUMPIF R7 L1 
      31 [-]: GETIMPORT R9 13 [0x6D655F77]
      32 [-]: GETIMPORT R10 17 ["EMPTY_SYMBOL"]
...
L 1:  36 [-]: GETUPVAL R7 0
      ...
      41 [-]: CALL R7 1 1  
      42 [-]: JUMPIFNOT R7 L2
      43 [-]: GETIMPORT R7 22 ["SetAbilityActiveAnim"]
      44 [-]: LOADN R8 1   
      45 [-]: LOADB R9 1   
      46 [-]: CALL R7 2 0  
L 2:  47 [-]: LOADB R7 1   
...
L 4:  52 [-]: JUMPIF R8 L7 
      ...
      57 [-]: CALL R8 1 1  
      58 [-]: JUMPIF R8 L5 
      59 [-]: GETIMPORT R8 22 ["SetAbilityActiveAnim"]
      60 [-]: LOADN R9 1   
      61 [-]: LOADB R10 0  
      62 [-]: CALL R8 2 0  
      63 [-]: LOADB R7 0   
...
L 5:  65 [-]: JUMPIF R7 L6 
      66 [-]: GETIMPORT R8 22 ["SetAbilityActiveAnim"]
      67 [-]: LOADN R9 1   
      68 [-]: LOADB R10 1  
      69 [-]: CALL R8 2 0  
      70 [-]: LOADB R7 1   
L 6:  71 [-]: GETIMPORT R8 25 [0xCBD666E1]
      72 [-]: LOADN R9 0   
      73 [-]: CALL R8 1 0  
      74 [-]: JUMPBACK L3  
L 7:  75 [-]: FASTCALL1 62 R1 L8
      76 [-]: MOVE R9 R1   
      77 [-]: GETIMPORT R8 15 [0x7B998233]
      78 [-]: CALL R8 1 1  
L 8:  79 [-]: JUMPIF R8 L11
      ...
      84 [-]: CALL R8 1 1  
      85 [-]: JUMPIF R8 L9 
      86 [-]: GETIMPORT R8 22 ["SetAbilityActiveAnim"]
      87 [-]: LOADN R9 1   
      88 [-]: LOADB R10 0  
      89 [-]: CALL R8 2 0  
      90 [-]: LOADB R7 0   
...
L 9:  92 [-]: JUMPIF R7 L10
      93 [-]: GETIMPORT R8 22 ["SetAbilityActiveAnim"]
      94 [-]: LOADN R9 1   
      95 [-]: LOADB R10 1  
      96 [-]: CALL R8 2 0  
      97 [-]: LOADB R7 1   
L10:  98 [-]: GETIMPORT R8 25 [0xCBD666E1]
      99 [-]: LOADN R9 0   
     100 [-]: CALL R8 1 0  
     101 [-]: JUMPBACK L7  
L11: 102 [-]: FASTCALL1 62 R6 L12
     103 [-]: MOVE R9 R6   
     104 [-]: GETIMPORT R8 15 [0x7B998233]
     105 [-]: CALL R8 1 1  
