...
100 [-]: JMP       103          ; PC := 103
101 [-]: CONST     R11 5        ; R11 := 5.000000
102 [-]: JMP       112          ; PC := 112
103 [-]: EQ        0 R3 K8      ; if R3 ~= 2.000000 then PC := 107
104 [-]: JMP       107          ; PC := 107
105 [-]: CONST     R11 6        ; R11 := 6.000000
106 [-]: JMP       112          ; PC := 112
107 [-]: EQ        0 R3 K9      ; if R3 ~= 3.000000 then PC := 111
108 [-]: JMP       111          ; PC := 111
109 [-]: CONST     R11 7        ; R11 := 7.000000
110 [-]: JMP       112          ; PC := 112
