...
; Max Stack Size:  8
 ...
 23 [-]: SETGLOBAL R6 K4        ; NpcEvaluateAbility := R6
 24 [-]: CLOSURE   R6 4         ; R6 := closure(Function #5)
 25 [-]: MOVE      R0 R1        ; R0 := R1
 26 [-]: SETGLOBAL R6 K5        ; InitializeAbility := R6
 ...
 31 [-]: MOVE      R0 R5        ; R0 := R5
 32 [-]: MOVE      R0 R0        ; R0 := R0
 33 [-]: SETGLOBAL R6 K6        ; ActivateAbility := R6
 34 [-]: CLOSURE   R6 6         ; R6 := closure(Function #7)
 35 [-]: SETGLOBAL R6 K7        ; DeactivateAbility := R6
 36 [-]: CLOSURE   R6 7         ; R6 := closure(Function #8)
 37 [-]: SETGLOBAL R6 K8        ; OnReflect := R6
 38 [-]: CLOSURE   R6 8         ; R6 := closure(Function #9)
 39 [-]: MOVE      R0 R3        ; R0 := R3
 40 [-]: SETGLOBAL R6 K9        ; StunTarget := R6
 41 [-]: CLOSURE   R6 9         ; R6 := closure(Function #10)
 42 [-]: MOVE      R0 R3        ; R0 := R3
 43 [-]: SETGLOBAL R6 K10       ; DoStun := R6
 44 [-]: CLOSURE   R6 10        ; R6 := closure(Function #11)
 45 [-]: SETGLOBAL R6 K11       ; SetCharges := R6
 46 [-]: NEWTABLE  R6 0 2       ; R6 := {}
 47 [-]: SETTABLE  R6 K12 K13   ; R6["instigatorAvatar"] := nil
 48 [-]: SETTABLE  R6 K14 K13   ; R6["suit"] := nil
 49 [-]: CLOSURE   R7 11        ; R7 := closure(Function #12)
 50 [-]: MOVE      R0 R6        ; R0 := R6
 51 [-]: SETGLOBAL R7 K15       ; TempCharge := R7
 52 [-]: CLOSURE   R7 12        ; R7 := closure(Function #13)
 53 [-]: MOVE      R0 R6        ; R0 := R6
 54 [-]: SETGLOBAL R7 K16       ; GiveCharge := R7
 55 [-]: CLOSURE   R7 13        ; R7 := closure(Function #14)
 56 [-]: SETGLOBAL R7 K17       ; FogVolume := R7
...
127 [-]: LOADK     R7 94        ; R7 := 94.000000
128 [-]: LOADK     R8 3         ; R8 := 3.000000
...
177 [-]: NOT       R9 R9        ; R9 := not R9
178 [-]: EQ        1 R7 R9      ; if R7 == R9 then PC := 198
179 [-]: JMP       198          ; PC := 198
180 [-]: NOT       R7 R7        ; R7 := not R7
...
213 [-]: LOADK     R11 10       ; R11 := 10.000000
...
; Max Stack Size:  13
 ...
 69 [-]: GETGLOBAL R7 K10       ; R7 := 0x55156ff7
 70 [-]: CALL      R7 1 2       ; R7 := R7()
 71 [-]: SETTABLE  R6 K9 R7     ; R6["hitTime"] := R7
 72 [-]: GETGLOBAL R6 K1        ; R6 := 0x6687f6e0
 73 [-]: GETGLOBAL R7 K12       ; R7 := 0x6c97a788
 74 [-]: GETTABLE  R7 R7 K13    ; R7 := R7[0x733fc736]
 75 [-]: LOADBOOL  R8 1 0       ; R8 := true
 76 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 77 [-]: SELF      R8 R3 K14    ; R9 := R3; R8 := R3[0xc4dff581]
 78 [-]: LOADK     R10 4        ; R10 := 4.000000
 79 [-]: CALL      R8 3 2       ; R8 := R8(R9,R10)
 80 [-]: TEST      R8 0         ; if not R8 then PC := 86
 81 [-]: JMP       86           ; PC := 86
 82 [-]: SELF      R8 R7 K15    ; R9 := R7; R8 := R7[0x277bf617]
 83 [-]: LOADNIL   R10 R10      ; R10 := nil
 84 [-]: CALL      R8 3 1       ; R8(R9,R10)
 85 [-]: JMP       89           ; PC := 89
 86 [-]: SELF      R8 R7 K15    ; R9 := R7; R8 := R7[0x277bf617]
 87 [-]: MOVE      R10 R3       ; R10 := R3
 88 [-]: CALL      R8 3 1       ; R8(R9,R10)
 89 [-]: SELF      R8 R7 K16    ; R9 := R7; R8 := R7[0x80925b98]
 90 [-]: GETGLOBAL R10 K4       ; R10 := _T
 91 [-]: GETTABLE  R10 R10 K5   ; R10 := R10["revenantSentinel"]
 92 [-]: GETTABLE  R10 R10 R5   ; R10 := R10[R5]
 93 [-]: GETTABLE  R10 R10 K17  ; R10 := R10["stunDuration"]
 94 [-]: CALL      R8 3 1       ; R8(R9,R10)
 95 [-]: GETGLOBAL R8 K4        ; R8 := _T
 96 [-]: GETTABLE  R8 R8 K5     ; R8 := R8["revenantSentinel"]
 97 [-]: GETTABLE  R8 R8 R5     ; R8 := R8[R5]
 98 [-]: GETTABLE  R8 R8 K18    ; R8 := R8["freeCharge"]
 99 [-]: EQ        0 R8 K19     ; if R8 ~= true then PC := 116
100 [-]: JMP       116          ; PC := 116
101 [-]: GETGLOBAL R8 K4        ; R8 := _T
102 [-]: GETTABLE  R8 R8 K5     ; R8 := R8["revenantSentinel"]
103 [-]: GETTABLE  R8 R8 R5     ; R8 := R8[R5]
104 [-]: GETTABLE  R0 R8 K20    ; R0 := R8["suit"]
105 [-]: GETGLOBAL R8 K4        ; R8 := _T
106 [-]: GETTABLE  R8 R8 K5     ; R8 := R8["revenantSentinel"]
107 [-]: GETTABLE  R8 R8 R5     ; R8 := R8[R5]
108 [-]: GETTABLE  R6 R8 K21    ; R6 := R8["ability"]
109 [-]: SELF      R8 R7 K16    ; R9 := R7; R8 := R7[0x80925b98]
110 [-]: LOADK     R10 0        ; R10 := 0.000000
111 [-]: CALL      R8 3 1       ; R8(R9,R10)
112 [-]: SELF      R8 R7 K15    ; R9 := R7; R8 := R7[0x277bf617]
113 [-]: MOVE      R10 R2       ; R10 := R2
114 [-]: CALL      R8 3 1       ; R8(R9,R10)
115 [-]: JMP       137          ; PC := 137
116 [-]: GETGLOBAL R8 K4        ; R8 := _T
117 [-]: GETTABLE  R8 R8 K5     ; R8 := R8["revenantSentinel"]
118 [-]: GETTABLE  R8 R8 R5     ; R8 := R8[R5]
119 [-]: GETGLOBAL R9 K4        ; R9 := _T
120 [-]: GETTABLE  R9 R9 K5     ; R9 := R9["revenantSentinel"]
121 [-]: GETTABLE  R9 R9 R5     ; R9 := R9[R5]
122 [-]: GETTABLE  R9 R9 K22    ; R9 := R9["numCharges"]
123 [-]: SUB       R9 R9 K23    ; R9 := R9 - 1.000000
124 [-]: SETTABLE  R8 K22 R9    ; R8["numCharges"] := R9
125 [-]: GETGLOBAL R8 K4        ; R8 := _T
126 [-]: GETTABLE  R8 R8 K5     ; R8 := R8["revenantSentinel"]
127 [-]: GETTABLE  R8 R8 R5     ; R8 := R8[R5]
128 [-]: GETTABLE  R8 R8 K22    ; R8 := R8["numCharges"]
129 [-]: LT        0 K24 R8     ; if 0.000000 >= R8 then PC := 137
130 [-]: JMP       137          ; PC := 137
131 [-]: SELF      R8 R7 K16    ; R9 := R7; R8 := R7[0x80925b98]
132 [-]: GETGLOBAL R10 K4       ; R10 := _T
133 [-]: GETTABLE  R10 R10 K5   ; R10 := R10["revenantSentinel"]
134 [-]: GETTABLE  R10 R10 R5   ; R10 := R10[R5]
135 [-]: GETTABLE  R10 R10 K22  ; R10 := R10["numCharges"]
...
141 [-]: JMP       149          ; PC := 149
142 [-]: SELF      R8 R0 K25    ; R9 := R0; R8 := R0[0x3cc932f9]
143 [-]: MOVE      R10 R6       ; R10 := R6
144 [-]: GETGLOBAL R11 K26      ; R11 := 0x0469f296
145 [-]: LOADK     R12 K27      ; R12 := "StunTarget"
146 [-]: CALL      R11 2 2      ; R11 := R11(R12)
147 [-]: MOVE      R12 R7       ; R12 := R7
...
160 [-]: TEST      R10 0        ; if not R10 then PC := 177
161 [-]: JMP       177          ; PC := 177
162 [-]: SELF      R10 R4 K47   ; R11 := R4; R10 := R4[0x12dd9da2]
163 [-]: LOADK     R12 94       ; R12 := 94.000000
164 [-]: LOADK     R13 3        ; R13 := 3.000000
