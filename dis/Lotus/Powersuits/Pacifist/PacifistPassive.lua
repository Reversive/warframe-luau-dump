...
; Max Stack Size:  19
       ...
       0 [-]: GETIMPORT R2 2 ["pacifistPassive"]
       1 [-]: JUMPXEQKNIL R2 L1
...
L 2:   9 [-]: NAMECALL R2 R0 K6 [0x388577D5]
      10 [-]: CALL R2 1 1  
      11 [-]: GETIMPORT R4 2 ["pacifistPassive"]
...
L 3:  15 [-]: NAMECALL R3 R0 K7 [0x1AC1655C]
      ...
      19 [-]: CALL R4 2 0  
      20 [-]: GETIMPORT R4 2 ["pacifistPassive"]
      21 [-]: GETIMPORT R5 10 [0x42DCC9F5]
      22 [-]: GETIMPORT R8 2 ["pacifistPassive"]
      ...
      36 [-]: CALL R5 1 1  
L 4:  37 [-]: JUMPIF R5 L5 
      38 [-]: GETIMPORT R8 2 ["pacifistPassive"]
...
L 5:  42 [-]: NAMECALL R5 R0 K14 [0xA5E492D4]
      43 [-]: CALL R5 1 1  
      44 [-]: JUMPIFNOT R5 L6
      45 [-]: GETIMPORT R5 16 ["BARUUK_SetEdgeProp"]
      46 [-]: JUMPXEQKNIL R5 L6
      47 [-]: GETIMPORT R5 16 ["BARUUK_SetEdgeProp"]
      48 [-]: GETIMPORT R8 2 ["pacifistPassive"]
      49 [-]: GETTABLE R7 R8 R2
      50 [-]: DIVK R6 R7 K17 [250]
      51 [-]: CALL R5 1 0  
L 6:  52 [-]: GETIMPORT R6 2 ["pacifistPassive"]
      ...
      59 [-]: LOADN R10 0  
      60 [-]: LOADN R12 1  
      61 [-]: GETIMPORT R13 19 [0x9BAFFFE3]
      62 [-]: LOADN R14 0  
      63 [-]: LOADK R15 K20 [0.5]
      64 [-]: GETIMPORT R18 2 ["pacifistPassive"]
...
L 7:  66 [-]: JUMPIF R4 L9 
      ...
      77 [-]: CALL R4 2 0  
L 8:  78 [-]: GETIMPORT R4 17 [0xCBD666E1]
...
L 1:  12 [-]: JUMPIFNOT R2 L2
      13 [-]: RETURN R0 0  
L 2:  14 [-]: GETIMPORT R2 6 ["pacifistPassive"]
      15 [-]: JUMPXEQKNIL R2 L4
      16 [-]: GETIMPORT R2 6 ["pacifistPassive"]
      ...
      22 [-]: CALL R2 1 1  
      23 [-]: JUMPIFNOT R2 L3
      24 [-]: GETIMPORT R2 10 ["BARUUK_SetEdgeProp"]
      25 [-]: JUMPXEQKNIL R2 L3
      26 [-]: GETIMPORT R2 10 ["BARUUK_SetEdgeProp"]
      27 [-]: LOADN R3 0   
      28 [-]: CALL R2 1 0  
L 3:  29 [-]: GETIMPORT R2 12 [0x4EC73E73]
      30 [-]: GETIMPORT R3 6 ["pacifistPassive"]
      31 [-]: CALL R2 1 1  
...
L 1:  16 [-]: FASTCALL1 62 R1 L2
      ...
      19 [-]: CALL R2 1 1  
L 2:  20 [-]: JUMPIF R2 L3 
      21 [-]: GETIMPORT R4 9 ["gPowerSuitType"]
      ...
      26 [-]: CALL R2 1 1  
      27 [-]: JUMPIFNOT R2 L3
      28 [-]: GETIMPORT R4 12 [0xF58F7E44]
      29 [-]: LOADB R5 0   
      30 [-]: LOADB R6 0   
      31 [-]: NAMECALL R2 R0 K13 [0x2970F52F]
      32 [-]: CALL R2 4 0  
      33 [-]: GETIMPORT R4 15 [0xAFC26970]
