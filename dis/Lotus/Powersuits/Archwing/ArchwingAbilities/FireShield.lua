...
; Max Stack Size:  7
       ...
       4 [-]: LOADN R4 1   ; var4 = 1
       5 [-]: JUMPIFNOTEQ R1 R4 L3; goto L3 if var1 ~= var262192
...
L 3:  21 [-]: LOADN R4 1   ; var4 = 1
      22 [-]: JUMPIFNOTEQ R1 R4 L4; goto L4 if var1 ~= var394273
      23 [-]: DUPTABLE R4 6; 
...
L 7:  30 [-]: GETUPVAL R5 2; var5 = upvalues[2]
      ...
      39 [-]: JUMPIFNOTLT R9 R6 L9; goto L9 if var9 >= var67911
      40 [-]: LOADN R9 1   ; var9 = 1
      41 [-]: JUMPIFEQ R7 R9 L8; goto L8 if var7 == var16779291
      42 [-]: LOADB R8 0 +1; var8 = false
L 8:  43 [-]: LOADB R8 1   ; var8 = true
L 9:  44 [-]: JUMPIFNOT R8 L13; goto L13 if not var8
      45 [-]: LOADN R9 1   ; var9 = 1
      46 [-]: JUMPIFNOTEQ R7 R9 L13; goto L13 if var7 ~= var263728
...
L22: 119 [-]: JUMPIF R18 L24; goto L24 if var18
     ...
     124 [-]: JUMPIFNOTLE R18 R11 L24; goto L24 if var18 > var332295
...
L25: 152 [-]: LOADN R15 0  ; var15 = 0
     153 [-]: JUMPIFNOTLT R15 R5 L33; goto L33 if var15 >= var1314638
