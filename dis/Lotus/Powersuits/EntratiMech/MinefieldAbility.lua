...
; Max Stack Size:  2
 ...
 21 [-]: JMP       26           ; PC := 26
 22 [-]: CONST     R1 24        ; R1 := 24.000000
 23 [-]: SETUPVAL  R1 U0        ; U82 := R0
 24 [-]: CONST     R1 8         ; R1 := 8.000000
