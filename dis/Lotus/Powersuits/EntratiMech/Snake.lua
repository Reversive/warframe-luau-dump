...
L11: 107 [-]: NAMECALL R7 R6 K27 [0x86E05B7D]
     ...
     111 [-]: CALL R7 1 1  
     112 [-]: JUMPIF R7 L15
L12: 113 [-]: GETIMPORT R7 23 [0xC8802016]
     114 [-]: MOVE R8 R4   
     115 [-]: CALL R7 1 3  
...
L15: 125 [-]: GETIMPORT R7 30 ["SnakeMechAbilityState"]
...
L16: 131 [-]: GETTABLE R10 R4 R9
     ...
     136 [-]: GETIMPORT R13 30 ["SnakeMechAbilityState"]
...
L20: 143 [-]: GETIMPORT R5 30 ["SnakeMechAbilityState"]
...
L22: 159 [-]: JUMPIF R8 L23
     ...
     164 [-]: CALL R8 3 0  
L23: 165 [-]: GETIMPORT R7 4 [0xCBD666E1]
     166 [-]: LOADN R8 0   
     167 [-]: CALL R7 1 0  
     168 [-]: JUMPBACK L8  
     169 [-]: RETURN R0 0  
...
L 1:   8 [-]: NAMECALL R3 R0 K3 [0xF4E253B6]
      ...
      13 [-]: CALL R3 1 0  
      14 [-]: GETIMPORT R5 7 [0xD3A1651D]
      15 [-]: GETIMPORT R6 9 ["EMPTY_SYMBOL"]
      16 [-]: GETIMPORT R7 11 ["ZERO_VECTOR"]
      17 [-]: GETIMPORT R8 13 ["ZERO_ROTATION"]
      18 [-]: MOVE R9 R2   
      19 [-]: NAMECALL R3 R2 K14 [0x47901F07]
      20 [-]: CALL R3 6 1  
      21 [-]: GETIMPORT R4 16 [0xCBD666E1]
      22 [-]: LOADN R5 1   
      23 [-]: CALL R4 1 0  
L 2:  24 [-]: LOADN R6 15  
      ...
      30 [-]: CALL R4 1 0  
      31 [-]: JUMPBACK L2  
L 3:  32 [-]: GETIMPORT R4 19 [0x89326C93]
      33 [-]: GETIMPORT R6 21 [0x5902725E]
      34 [-]: NAMECALL R7 R2 K22 [0xD1586535]
      35 [-]: CALL R7 1 1  
      36 [-]: GETIMPORT R8 13 ["ZERO_ROTATION"]
      37 [-]: MOVE R9 R2   
      38 [-]: NAMECALL R4 R4 K23 [0x05909209]
      39 [-]: CALL R4 5 0  
      40 [-]: GETIMPORT R6 25 [0x6D354BC7]
      41 [-]: LOADN R7 10  
...
L 7:  62 [-]: LOADB R7 0   
      ...
      67 [-]: CALL R5 2 0  
      68 [-]: GETIMPORT R5 36 ["SetupBossAvatar"]
      69 [-]: MOVE R6 R2   
      70 [-]: CALL R5 1 0  
      71 [-]: RETURN R0 0  
...
; Max Stack Size:  9
       ...
       1 [-]: GETIMPORT R3 3 [0xABA2BEB7]
       2 [-]: MOVE R4 R0   
       3 [-]: GETIMPORT R5 5 [0x00046924]
       4 [-]: LOADN R6 0   
       5 [-]: LOADN R7 0   
       6 [-]: LOADN R8 180 
       7 [-]: CALL R5 3 -1 
...
L 0:  14 [-]: JUMPIF R3 L3 
      ...
      27 [-]: CALL R3 5 0  
      28 [-]: RETURN R0 0  
L 1:  29 [-]: GETIMPORT R5 2 [0x1A79D56D]
...
L 0:   4 [-]: NAMECALL R2 R1 K1 [0x1AC1655C]
      ...
      10 [-]: CALL R4 2 0  
      11 [-]: GETIMPORT R4 5 [0xCBD666E1]
      12 [-]: LOADN R5 0   
      13 [-]: CALL R4 1 0  
      14 [-]: GETIMPORT R6 7 [0x0A9437CC]
      ...
      30 [-]: GETIMPORT R5 18 [0x86693B80]
      31 [-]: CALL R4 1 0  
      32 [-]: GETIMPORT R5 20 [0x76ACAA81]
      33 [-]: FASTCALL1 62 R5 L1
      34 [-]: GETIMPORT R4 22 [0x7B998233]
      35 [-]: CALL R4 1 1  
L 1:  36 [-]: JUMPIF R4 L2 
      37 [-]: GETIMPORT R6 20 [0x76ACAA81]
      38 [-]: LOADB R7 0   
      39 [-]: LOADN R8 4   
      40 [-]: LOADN R9 1   
      41 [-]: LOADB R10 1  
...
L 3:  55 [-]: JUMPIF R4 L4 
      ...
      60 [-]: CALL R5 2 0  
L 4:  61 [-]: GETIMPORT R4 31 [0x3D106989]
      62 [-]: LOADK R5 K32 ["         start fade"]
      63 [-]: CALL R4 1 0  
      64 [-]: GETIMPORT R4 5 [0xCBD666E1]
      65 [-]: LOADK R5 K33 [0.01]
      66 [-]: CALL R4 1 0  
      67 [-]: GETIMPORT R4 35 [0x89326C93]
      ...
      73 [-]: LOADN R7 0   
      74 [-]: LOADNIL R8   
      75 [-]: GETIMPORT R9 39 [0xA64AF0F2]
      76 [-]: JUMPXEQKN R9 K40 L5 NOT [0]
      77 [-]: MOVE R11 R6  
      78 [-]: NAMECALL R9 R4 K41 [0xB6DF3E50]
      79 [-]: CALL R9 2 0  
      80 [-]: GETIMPORT R9 5 [0xCBD666E1]
      81 [-]: LOADN R10 0  
      82 [-]: CALL R9 1 0  
      83 [-]: RETURN R0 0  
L 5:  84 [-]: LOADN R9 1   
      85 [-]: JUMPIFNOTLT R7 R9 L6
      86 [-]: GETIMPORT R9 43 [0x9BAFFFE3]
      87 [-]: MOVE R10 R5  
      88 [-]: MOVE R11 R6  
      89 [-]: MOVE R12 R7  
      90 [-]: CALL R9 3 1  
      ...
      94 [-]: CALL R9 2 0  
      95 [-]: GETIMPORT R10 45 [0x67652851]
      96 [-]: CALL R10 0 1 
      97 [-]: GETIMPORT R11 39 [0xA64AF0F2]
      98 [-]: DIV R9 R10 R11
      99 [-]: ADD R7 R7 R9 
     100 [-]: GETIMPORT R9 5 [0xCBD666E1]
     101 [-]: LOADN R10 0  
     102 [-]: CALL R9 1 0  
     103 [-]: JUMPBACK L5  
L 6: 104 [-]: GETIMPORT R9 5 [0xCBD666E1]
     105 [-]: GETIMPORT R11 48 [0x0E68DDFC]
     ...
     117 [-]: MOVE R11 R9  
     118 [-]: GETIMPORT R10 22 [0x7B998233]
     119 [-]: CALL R10 1 1 
L 7: 120 [-]: JUMPIF R10 L8
     ...
     125 [-]: CALL R10 4 0 
L 8: 126 [-]: GETIMPORT R10 5 [0xCBD666E1]
     127 [-]: GETIMPORT R12 48 [0x0E68DDFC]
...
L 9: 133 [-]: LOADN R10 1  
     ...
     135 [-]: GETIMPORT R10 43 [0x9BAFFFE3]
     136 [-]: MOVE R11 R5  
     137 [-]: MOVE R12 R6  
     138 [-]: MOVE R13 R7  
     139 [-]: CALL R10 3 1 
     ...
     143 [-]: CALL R10 2 0 
     144 [-]: GETIMPORT R11 45 [0x67652851]
     145 [-]: CALL R11 0 1 
     146 [-]: GETIMPORT R12 39 [0xA64AF0F2]
     147 [-]: DIV R10 R11 R12
     148 [-]: ADD R7 R7 R10
     149 [-]: GETIMPORT R10 5 [0xCBD666E1]
     150 [-]: LOADN R11 0  
     151 [-]: CALL R10 1 0 
     152 [-]: JUMPBACK L9  
L10: 153 [-]: MOVE R12 R6  
