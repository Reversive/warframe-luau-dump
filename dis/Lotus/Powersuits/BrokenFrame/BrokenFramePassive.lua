...
; Max Stack Size:  12
       ...
       0 [-]: GETIMPORT R3 2 ["brokenFrameDissolve"]
       1 [-]: JUMPIF R3 L0 
       2 [-]: GETIMPORT R3 3 ["_T"]
       3 [-]: NEWTABLE R4 0 0
...
L 0:   5 [-]: NAMECALL R3 R0 K4 [0x388577D5]
       6 [-]: CALL R3 1 1  
       7 [-]: GETIMPORT R5 2 ["brokenFrameDissolve"]
       8 [-]: GETTABLE R4 R5 R3
       9 [-]: JUMPIFNOT R1 L1
      10 [-]: LOADN R5 0   
      11 [-]: JUMP L2
...
L 6:  38 [-]: GETIMPORT R6 2 ["brokenFrameDissolve"]
      39 [-]: DUPTABLE R7 8
...
; Max Stack Size:  6
       ...
       0 [-]: GETIMPORT R1 2 ["brokenFrameDissolve"]
       1 [-]: JUMPIFNOT R1 L2
       2 [-]: NAMECALL R1 R0 K3 [0x388577D5]
       3 [-]: CALL R1 1 1  
       4 [-]: GETIMPORT R3 2 ["brokenFrameDissolve"]
       5 [-]: GETTABLE R2 R3 R1
       6 [-]: JUMPIFNOT R2 L2
...
L 1:  12 [-]: JUMPIF R2 L2 
      ...
      18 [-]: JUMPIFNOT R2 L3
L 2:  19 [-]: RETURN R0 0  
L 3:  20 [-]: GETIMPORT R2 9 [0x89326C93]
...
L 4:  31 [-]: NAMECALL R2 R1 K14 [0x1AC1655C]
      ...
      41 [-]: CALL R2 6 0  
      42 [-]: GETIMPORT R2 22 ["BROKEN_SetDecoVisibility"]
      43 [-]: JUMPIF R2 L5 
      44 [-]: GETIMPORT R2 23 ["_T"]
      45 [-]: GETUPVAL R3 1
      46 [-]: SETTABLEKS R3 R2 K21 ["BROKEN_SetDecoVisibility"]
      47 [-]: GETIMPORT R2 23 ["_T"]
      48 [-]: GETUPVAL R3 2
      49 [-]: SETTABLEKS R3 R2 K24 ["BROKEN_GetDecoVisibility"]
L 5:  50 [-]: GETIMPORT R2 26 ["brokenFrameDissolve"]
      51 [-]: JUMPIFNOT R2 L8
      52 [-]: NAMECALL R2 R1 K27 [0x388577D5]
      53 [-]: CALL R2 1 1  
      54 [-]: GETIMPORT R4 26 ["brokenFrameDissolve"]
...
L 7:  64 [-]: LOADN R7 0   
      65 [-]: CALL R4 3 0  
L 8:  66 [-]: GETIMPORT R2 30 [0xCBD666E1]
      67 [-]: LOADN R3 0   
      68 [-]: CALL R2 1 0  
      69 [-]: GETUPVAL R4 3
...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R2 2 ["brokenFrameDissolve"]
       1 [-]: JUMPIFNOT R2 L2
       2 [-]: NAMECALL R2 R1 K3 [0x388577D5]
       3 [-]: CALL R2 1 1  
       4 [-]: GETIMPORT R4 2 ["brokenFrameDissolve"]
       5 [-]: GETTABLE R3 R4 R2
       6 [-]: JUMPIFNOT R3 L2
       7 [-]: GETUPVAL R4 0
       8 [-]: MOVE R5 R1   
...
L 4:  27 [-]: JUMPIF R9 L5 
      ...
      29 [-]: CALL R9 1 1  
      30 [-]: JUMPIFNOT R9 L5
      31 [-]: GETIMPORT R11 15 [0xA3CE258E]
      32 [-]: GETIMPORT R12 17 ["EMPTY_SYMBOL"]
      33 [-]: GETIMPORT R13 19 ["ZERO_VECTOR"]
...
; Max Stack Size:  20
       ...
       1 [-]: CALL R1 1 1  
       2 [-]: GETIMPORT R3 3 ["brokenFrameDissolve"]
       3 [-]: GETTABLE R2 R3 R1
       4 [-]: LOADB R3 1   
...
L 0:  22 [-]: GETTABLEKS R9 R2 K10 ["time"]
      23 [-]: GETIMPORT R10 12 [0x67652851]
      24 [-]: CALL R10 0 1 
      25 [-]: ADD R8 R9 R10
...
L 2:  45 [-]: LENGTH R9 R5 
      ...
      50 [-]: LOADB R9 0 +1
L 3:  51 [-]: LOADB R9 1   
L 4:  52 [-]: GETIMPORT R12 22 ["gDecorationType"]
      53 [-]: NAMECALL R10 R0 K23 [0xC1595BD5]
      54 [-]: CALL R10 2 1 
      55 [-]: GETIMPORT R11 25 [0xC8802016]
      56 [-]: MOVE R12 R10 
      57 [-]: CALL R11 1 3 
...
L 5:  59 [-]: MOVE R18 R4  
      ...
      64 [-]: MOVE R17 R5  
      65 [-]: MOVE R18 R15 
      66 [-]: GETIMPORT R16 29 [0x23D5322F]
      67 [-]: CALL R16 2 0 
...
L 7:  76 [-]: FORGLOOP R11 L5 2 [inext]
      ...
      78 [-]: MOVE R12 R3  
      79 [-]: GETIMPORT R11 33 [0x7B998233]
      80 [-]: CALL R11 1 1 
...
L 9:  86 [-]: GETTABLE R16 R6 R13
      ...
      90 [-]: MOVE R16 R14 
      91 [-]: GETIMPORT R15 33 [0x7B998233]
      92 [-]: CALL R15 1 1 
L10:  93 [-]: JUMPIF R15 L12
      94 [-]: FASTCALL2 52 R5 R14 L11
      95 [-]: MOVE R16 R5  
      96 [-]: MOVE R17 R14 
      97 [-]: GETIMPORT R15 29 [0x23D5322F]
      98 [-]: CALL R15 2 0 
...
L15: 114 [-]: GETTABLE R12 R5 R11
     ...
     116 [-]: MOVE R14 R12 
     117 [-]: GETIMPORT R13 33 [0x7B998233]
     118 [-]: CALL R13 1 1 
L16: 119 [-]: JUMPIFNOT R13 L17
     120 [-]: GETIMPORT R13 36 [0x9C1F3B5A]
     121 [-]: MOVE R14 R5  
     122 [-]: MOVE R15 R11 
     123 [-]: CALL R13 2 0 
     124 [-]: JUMP L18
