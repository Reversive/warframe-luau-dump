...
; Max Stack Size:  36
       ...
       0 [-]: GETIMPORT R6 1 [0x4C40FF7A]
       1 [-]: NAMECALL R4 R1 K2 [0xB2532845]
       2 [-]: CALL R4 2 0  
       3 [-]: GETIMPORT R6 4 [0x520E413D]
       4 [-]: LOADB R7 0   
       5 [-]: LOADN R8 0   
       6 [-]: LOADB R9 1   
       7 [-]: NAMECALL R4 R1 K5 [0x659D451F]
       8 [-]: CALL R4 5 0  
       9 [-]: GETIMPORT R6 7 [0x64FB1586]
      10 [-]: GETIMPORT R7 9 [0xDE3C39C2]
      11 [-]: CALL R6 1 1  
      12 [-]: LOADN R7 1   
      13 [-]: NAMECALL R4 R1 K10 [0x21B4C60E]
      14 [-]: CALL R4 3 0  
      15 [-]: LOADB R4 0   
      16 [-]: GETIMPORT R5 12 [0xF25DB561]
      17 [-]: GETIMPORT R6 14 ["EMPTY_SYMBOL"]
      18 [-]: JUMPIFNOTEQ R5 R6 L0
      19 [-]: LOADB R4 1   
      20 [-]: JUMP L2
     
L 0:  21 [-]: GETIMPORT R6 16 [0xBE190284]
      ...
      26 [-]: CALL R5 -1 1 
L 1:  27 [-]: JUMPIF R5 L2 
      28 [-]: GETIMPORT R6 16 [0xBE190284]
      29 [-]: NAMECALL R6 R6 K17 [0xEF893AEC]
      30 [-]: CALL R6 1 1  
      31 [-]: GETTABLEKS R5 R6 K20 ["goalTag"]
      32 [-]: GETIMPORT R6 12 [0xF25DB561]
      33 [-]: JUMPIFNOTEQ R5 R6 L2
      34 [-]: LOADB R4 1   
L 2:  35 [-]: GETIMPORT R6 22 [0x6C7A6BF3]
      36 [-]: FASTCALL1 62 R6 L3
      37 [-]: GETIMPORT R5 19 [0x7B998233]
      38 [-]: CALL R5 1 1  
L 3:  39 [-]: JUMPIF R5 L4 
      40 [-]: GETIMPORT R7 22 [0x6C7A6BF3]
      41 [-]: GETIMPORT R8 24 [0x0469F296]
      42 [-]: LOADK R9 K25 ["GAME_L1_WEAPON1"]
      43 [-]: CALL R8 1 1  
      44 [-]: GETIMPORT R9 27 ["ZERO_VECTOR"]
      45 [-]: GETIMPORT R10 29 ["ZERO_ROTATION"]
      46 [-]: MOVE R11 R1  
      47 [-]: NAMECALL R5 R1 K30 [0x47901F07]
      48 [-]: CALL R5 6 0  
L 4:  49 [-]: GETIMPORT R5 32 [0x89326C93]
      ...
      61 [-]: GETIMPORT R10 38 [0xF6C6E505]
      62 [-]: MOVE R11 R9  
      63 [-]: CALL R10 1 1 
      64 [-]: MOVE R7 R10  
      65 [-]: MOVE R8 R9   
      ...
      69 [-]: CALL R7 1 1  
      70 [-]: GETIMPORT R8 41 [0x00046924]
      71 [-]: CALL R8 0 1  
      72 [-]: GETIMPORT R9 32 [0x89326C93]
      73 [-]: GETIMPORT R11 43 [0xCD6EE907]
      74 [-]: NAMECALL R13 R2 K39 [0xF6EBD926]
      75 [-]: CALL R13 1 1 
      76 [-]: GETIMPORT R14 45 [0xA421AF95]
      77 [-]: LOADN R15 0  
      78 [-]: LOADN R16 1  
      79 [-]: LOADN R17 0  
      80 [-]: CALL R14 3 1 
      81 [-]: ADD R12 R13 R14
      82 [-]: GETIMPORT R13 29 ["ZERO_ROTATION"]
      83 [-]: MOVE R14 R1  
      84 [-]: NAMECALL R9 R9 K46 [0x05909209]
      85 [-]: CALL R9 5 1  
      86 [-]: GETIMPORT R10 45 [0xA421AF95]
      87 [-]: CALL R10 0 1 
      88 [-]: GETIMPORT R11 45 [0xA421AF95]
      89 [-]: CALL R11 0 1 
      90 [-]: GETIMPORT R12 45 [0xA421AF95]
      91 [-]: CALL R12 0 1 
      92 [-]: NAMECALL R14 R2 K39 [0xF6EBD926]
      93 [-]: CALL R14 1 1 
      94 [-]: SUB R13 R14 R7
      95 [-]: GETIMPORT R14 48 [0xC2892F65]
      96 [-]: MOVE R15 R13 
      97 [-]: CALL R14 1 0 
      98 [-]: LOADN R14 0  
L 5:  99 [-]: GETIMPORT R15 50 [0xCB032E94]
     100 [-]: JUMPIFNOTLT R14 R15 L15
     101 [-]: FASTCALL1 62 R2 L6
     102 [-]: MOVE R16 R2  
     103 [-]: GETIMPORT R15 19 [0x7B998233]
     104 [-]: CALL R15 1 1 
L 6: 105 [-]: JUMPIF R15 L15
     ...
     108 [-]: CALL R15 1 1 
     109 [-]: SUB R13 R15 R7
     110 [-]: GETIMPORT R15 48 [0xC2892F65]
     111 [-]: MOVE R16 R13 
     112 [-]: CALL R15 1 0 
L 7: 113 [-]: GETIMPORT R17 52 [0xF5ECED26]
     114 [-]: MUL R16 R13 R17
     115 [-]: ADD R15 R16 R7
     ...
     131 [-]: CALL R16 1 1 
     132 [-]: MOVE R8 R16  
     133 [-]: GETIMPORT R16 32 [0x89326C93]
     134 [-]: MOVE R18 R10 
     135 [-]: MOVE R19 R11 
     136 [-]: GETIMPORT R20 60 [0xC4E6B4CC]
     137 [-]: LOADNIL R21  
     138 [-]: MOVE R22 R12 
     ...
     142 [-]: MOVE R7 R12  
     143 [-]: GETIMPORT R16 63 [0x55730E1A]
     144 [-]: LOADN R17 0  
     145 [-]: LOADN R18 360
     146 [-]: CALL R16 2 1 
     147 [-]: SETTABLEKS R16 R8 K64 ["heading"]
     148 [-]: GETIMPORT R16 63 [0x55730E1A]
     149 [-]: LOADN R17 -40
     150 [-]: LOADN R18 40 
     151 [-]: CALL R16 2 1 
     152 [-]: SETTABLEKS R16 R8 K35 ["pitch"]
     153 [-]: GETIMPORT R16 32 [0x89326C93]
     154 [-]: GETIMPORT R18 66 [0x5991EFC5]
     155 [-]: MOVE R19 R12 
     156 [-]: MOVE R20 R8  
     ...
     160 [-]: MOVE R18 R16 
     161 [-]: GETIMPORT R17 19 [0x7B998233]
     162 [-]: CALL R17 1 1 
...
L 9: 167 [-]: FASTCALL1 62 R9 L10
     168 [-]: MOVE R18 R9  
     169 [-]: GETIMPORT R17 19 [0x7B998233]
     170 [-]: CALL R17 1 1 
L10: 171 [-]: JUMPIF R17 L11
     172 [-]: GETIMPORT R20 45 [0xA421AF95]
     173 [-]: LOADN R21 0  
     174 [-]: LOADN R22 1  
     175 [-]: LOADN R23 0  
     176 [-]: CALL R20 3 1 
     177 [-]: ADD R19 R12 R20
     178 [-]: GETIMPORT R20 41 [0x00046924]
     179 [-]: CALL R20 0 -1
...
L12: 191 [-]: LOADN R17 2  
L13: 192 [-]: GETIMPORT R18 32 [0x89326C93]
     193 [-]: MOVE R20 R1  
     194 [-]: MOVE R21 R12 
     195 [-]: LOADN R22 100
     196 [-]: LOADK R23 K71 [1.5]
     197 [-]: LOADN R24 100
     198 [-]: GETIMPORT R25 73 [0xA86196B8]
     199 [-]: LOADNIL R26  
     200 [-]: MOVE R27 R0  
     201 [-]: LOADN R28 -1 
     202 [-]: LOADB R29 1  
...
L14: 213 [-]: ADDK R14 R14 K75 [1]
     214 [-]: GETIMPORT R16 77 [0xCBD666E1]
     215 [-]: GETIMPORT R17 79 [0x81C79974]
     216 [-]: CALL R16 1 0 
     217 [-]: JUMPBACK L5  
L15: 218 [-]: FASTCALL1 62 R9 L16
     219 [-]: MOVE R16 R9  
     220 [-]: GETIMPORT R15 19 [0x7B998233]
     221 [-]: CALL R15 1 1 
