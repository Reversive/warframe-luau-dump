...
; Max Stack Size:  26
      ...
      20 [-]: CALL R7 5 0  
      21 [-]: GETIMPORT R9 9 [0x618C8DF6]
      22 [-]: GETIMPORT R10 11 ["EMPTY_SYMBOL"]
      ...
      28 [-]: CALL R7 -1 0 
      29 [-]: GETIMPORT R9 16 [0x945F9957]
      30 [-]: GETIMPORT R10 11 ["EMPTY_SYMBOL"]
      31 [-]: NAMECALL R7 R1 K14 [0x47901F07]
      32 [-]: CALL R7 3 0  
      33 [-]: GETIMPORT R9 18 [0x520E413D]
      34 [-]: LOADB R10 0  
      35 [-]: LOADN R11 0  
      36 [-]: LOADB R12 1  
      37 [-]: NAMECALL R7 R1 K19 [0x659D451F]
      38 [-]: CALL R7 5 0  
      39 [-]: GETIMPORT R7 21 [0xCBD666E1]
      ...
      50 [-]: GETIMPORT R12 27 [0xF6C6E505]
      51 [-]: MOVE R13 R11 
      52 [-]: CALL R12 1 1 
      53 [-]: MOVE R9 R12  
      54 [-]: MOVE R10 R11 
      55 [-]: MOVE R7 R9   
      56 [-]: MOVE R8 R10  
      57 [-]: GETIMPORT R11 29 [0xEF71A06B]
...
L 1:  69 [-]: NAMECALL R9 R1 K34 [0xF6EBD926]
      70 [-]: CALL R9 1 1  
      71 [-]: JUMPIFNOT R6 L2
      72 [-]: GETIMPORT R11 36 [0x91BE34E1]
      73 [-]: MUL R10 R7 R11
      74 [-]: MOVE R13 R10 
...
L 3:  82 [-]: GETGLOBAL R14 K38 [0xADCAFC3E]
      ...
      85 [-]: GETIMPORT R16 40 [0x91E0D2B4]
...
L 5:  92 [-]: SUB R15 R14 R9
      ...
      98 [-]: MUL R18 R19 R20
      99 [-]: ADD R16 R17 R18
     100 [-]: GETIMPORT R18 45 [0xF5234725]
     101 [-]: GETIMPORT R19 45 [0xF5234725]
     102 [-]: MUL R17 R18 R19
     103 [-]: JUMPIFNOTLT R17 R16 L7
     104 [-]: GETIMPORT R17 47 [0xC2892F65]
     105 [-]: MOVE R18 R15 
     106 [-]: CALL R17 1 0 
     107 [-]: GETIMPORT R18 45 [0xF5234725]
     108 [-]: MUL R17 R15 R18
     109 [-]: ADD R9 R9 R17
     110 [-]: GETIMPORT R17 49 [0x89326C93]
     111 [-]: GETIMPORT R19 51 ["gLotusNpcAvatarType"]
     112 [-]: MOVE R20 R9  
     113 [-]: LOADN R21 0  
     114 [-]: GETIMPORT R22 45 [0xF5234725]
     ...
     119 [-]: MOVE R18 R1  
     120 [-]: MOVE R19 R0  
     121 [-]: GETIMPORT R20 54 [0xF2F9EC30]
     122 [-]: MOVE R21 R10 
     123 [-]: MOVE R22 R11 
     124 [-]: CALL R17 5 0 
     125 [-]: JUMP L6
...
L 6: 127 [-]: JUMPBACK L5  
L 7: 128 [-]: GETIMPORT R15 56 [0x03EA2485]
     129 [-]: MOVE R16 R14 
     130 [-]: MOVE R17 R12 
     131 [-]: CALL R15 2 1 
     132 [-]: GETIMPORT R16 58 [0x09326334]
...
L 9: 144 [-]: GETUPVAL R18 2
     ...
     146 [-]: CALL R16 2 1 
     147 [-]: GETIMPORT R17 63 [0x20B7F774]
     148 [-]: MOVE R18 R16 
     149 [-]: GETIMPORT R19 65 [0xA421AF95]
     ...
     154 [-]: CALL R19 3 -1
     155 [-]: CALL R17 -1 1
     156 [-]: GETIMPORT R18 49 [0x89326C93]
     157 [-]: GETIMPORT R20 69 [0x74DCAE95]
     158 [-]: MOVE R21 R16 
     159 [-]: MOVE R22 R17 
     160 [-]: MOVE R23 R1  
     ...
     164 [-]: MOVE R20 R18 
     165 [-]: GETIMPORT R19 33 [0x7B998233]
     166 [-]: CALL R19 1 1 
...
L12: 178 [-]: GETGLOBAL R15 K38 [0xADCAFC3E]
     179 [-]: GETIMPORT R16 75 [0x38AEC3DC]
     180 [-]: JUMPIFNOTLT R15 R16 L13
     181 [-]: JUMPIF R13 L13
     182 [-]: GETIMPORT R17 40 [0x91E0D2B4]
     183 [-]: LOADB R18 0  
     184 [-]: LOADN R19 2  
     185 [-]: LOADN R20 1  
     186 [-]: LOADB R21 1  
...
L13: 190 [-]: GETGLOBAL R16 K38 [0xADCAFC3E]
     191 [-]: GETIMPORT R17 78 [0x67652851]
     192 [-]: CALL R17 0 1 
     193 [-]: SUB R15 R16 R17
     194 [-]: SETGLOBAL R15 K38 [0xADCAFC3E]
     195 [-]: GETIMPORT R15 21 [0xCBD666E1]
     196 [-]: LOADN R16 0  
     197 [-]: CALL R15 1 0 
     198 [-]: JUMPBACK L3  
L14: 199 [-]: JUMPIFNOT R6 L15
     200 [-]: GETIMPORT R14 49 [0x89326C93]
     201 [-]: MOVE R16 R1  
     202 [-]: NAMECALL R17 R1 K34 [0xF6EBD926]
     203 [-]: CALL R17 1 1 
     204 [-]: GETIMPORT R18 54 [0xF2F9EC30]
     205 [-]: GETIMPORT R19 45 [0xF5234725]
     206 [-]: LOADN R20 20 
     207 [-]: LOADN R21 2  
     208 [-]: LOADNIL R22  
     209 [-]: MOVE R23 R0  
     ...
     213 [-]: CALL R14 1 1 
     214 [-]: GETIMPORT R16 81 ["ZERO_VECTOR"]
...
L16: 226 [-]: LOADN R14 2  
L17: 227 [-]: LOADN R17 1  
     228 [-]: GETIMPORT R15 83 [0xB3A37B4D]
     229 [-]: LOADN R16 1  
     230 [-]: FORNPREP R15 L21
L18: 231 [-]: GETIMPORT R18 85 [0x00046924]
     232 [-]: CALL R18 0 1 
     ...
     240 [-]: LOADN R21 -40
     241 [-]: LOADN R24 80 
     242 [-]: GETIMPORT R25 83 [0xB3A37B4D]
     243 [-]: DIV R23 R24 R25
     ...
     254 [-]: GETIMPORT R20 49 [0x89326C93]
     255 [-]: GETIMPORT R22 90 [0xA52DD556]
     256 [-]: GETUPVAL R25 2
     ...
     264 [-]: MOVE R22 R20 
     265 [-]: GETIMPORT R21 33 [0x7B998233]
     266 [-]: CALL R21 1 1 
L19: 267 [-]: JUMPIF R21 L20
     ...
     276 [-]: CALL R21 2 0 
L20: 277 [-]: GETIMPORT R21 21 [0xCBD666E1]
     278 [-]: LOADK R22 K91 [0.050000000000000003]
     279 [-]: CALL R21 1 0 
     280 [-]: FORNLOOP R15 L18
L21: 281 [-]: GETIMPORT R15 21 [0xCBD666E1]
     282 [-]: GETIMPORT R16 75 [0x38AEC3DC]
     283 [-]: CALL R15 1 0 
     284 [-]: RETURN R0 0  
...
; Max Stack Size:  5
       ...
       9 [-]: CALL R2 1 1  
      10 [-]: GETIMPORT R4 5 ["ZERO_VECTOR"]
      11 [-]: NAMECALL R2 R2 K6 [0xCDADCD5D]
      12 [-]: CALL R2 2 0  
L 0:  13 [-]: GETIMPORT R2 8 [0xCBD666E1]
      14 [-]: GETIMPORT R3 10 [0x38AEC3DC]
      15 [-]: CALL R2 1 0  
