...
; Max Stack Size:  17
       ...
       2 [-]: CALL R3 1 1  
       3 [-]: GETIMPORT R4 2 [0x55156FF7]
       4 [-]: CALL R4 0 1  
       5 [-]: GETUPVAL R7 0
       6 [-]: NAMECALL R5 R3 K3 [0xC733A04B]
       7 [-]: CALL R5 2 1  
       8 [-]: SUB R6 R4 R5 
       9 [-]: GETIMPORT R7 5 [0x07763AAB]
...
L 2:  30 [-]: GETTABLE R11 R7 R10
      ...
      36 [-]: GETIMPORT R12 13 [0x443A8D0B]
      37 [-]: JUMPIFNOTLE R11 R12 L3
      38 [-]: LOADN R14 1  
      39 [-]: GETIMPORT R16 13 [0x443A8D0B]
      40 [-]: DIV R15 R11 R16
      41 [-]: SUB R13 R14 R15
      42 [-]: LENGTH R14 R7
      43 [-]: DIV R12 R13 R14
...
L 1:   8 [-]: GETIMPORT R3 3 [0x89326C93]
      ...
      35 [-]: CALL R5 2 1  
      36 [-]: SUB R6 R4 R5 
      37 [-]: GETIMPORT R7 16 [0xCF8D3657]
      38 [-]: JUMPIFNOTLE R7 R6 L3
      39 [-]: GETIMPORT R6 18 [0x0C5E62F9]
      40 [-]: LOADN R7 0   
      41 [-]: LOADN R8 2   
      42 [-]: CALL R6 2 1  
      43 [-]: JUMPXEQKN R6 K19 L3 NOT [0]
      44 [-]: GETIMPORT R8 21 [0x1FE40F97]
      45 [-]: FASTCALL1 62 R8 L2
      46 [-]: GETIMPORT R7 23 [0x7B998233]
      47 [-]: CALL R7 1 1  
L 2:  48 [-]: JUMPIF R7 L3 
      49 [-]: GETUPVAL R8 3
      ...
      51 [-]: CALL R7 0 1  
      52 [-]: JUMPIF R7 L3 
      53 [-]: GETIMPORT R7 26 [0xB009BBC6]
      54 [-]: GETIMPORT R8 21 [0x1FE40F97]
      55 [-]: CALL R7 1 1  
      56 [-]: GETUPVAL R9 4
      57 [-]: GETTABLEKS R8 R9 K27 [0x9742B85B]
      58 [-]: MOVE R9 R7   
      59 [-]: GETIMPORT R10 12 [0x0469F296]
      ...
      66 [-]: CALL R8 3 0  
L 3:  67 [-]: GETIMPORT R5 30 [0x17517254]
      68 [-]: LOADB R6 0   
...
L 4:  89 [-]: NAMECALL R7 R1 K0 [0x73901ACF]
      ...
      95 [-]: JUMPIFNOT R7 L6
L 5:  96 [-]: RETURN R0 0  
L 6:  97 [-]: GETIMPORT R9 41 [0xCC79FF20]
      98 [-]: GETIMPORT R12 43 [0x68FEFDDB]
      99 [-]: LOADB R13 0  
     100 [-]: LOADN R14 2  
     101 [-]: LOADN R15 1  
     102 [-]: LOADB R16 1  
     ...
     106 [-]: CALL R7 -1 0 
     107 [-]: GETIMPORT R7 3 [0x89326C93]
     108 [-]: GETIMPORT R9 46 [0x7A3D3090]
     ...
     115 [-]: CALL R7 5 0  
     116 [-]: GETIMPORT R7 51 [0xCBD666E1]
...
L 7: 120 [-]: NAMECALL R4 R1 K0 [0x73901ACF]
     ...
     126 [-]: JUMPIFNOT R4 L9
L 8: 127 [-]: RETURN R0 0  
L 9: 128 [-]: GETIMPORT R6 54 [0x6853797E]
     129 [-]: LOADB R7 0   
     130 [-]: NAMECALL R4 R1 K31 [0x659D451F]
     131 [-]: CALL R4 3 0  
     132 [-]: GETIMPORT R6 41 [0xCC79FF20]
     133 [-]: GETIMPORT R9 56 [0x13277DB7]
     134 [-]: LOADB R10 0  
     135 [-]: LOADN R11 2  
     136 [-]: LOADN R12 1  
     137 [-]: LOADB R13 1  
...
L10: 149 [-]: RETURN R0 0  
L11: 150 [-]: GETIMPORT R4 3 [0x89326C93]
     151 [-]: GETIMPORT R6 59 [0x24ED1D64]
