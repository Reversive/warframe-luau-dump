...
L 0:   8 [-]: JUMPIF R3 L2 ; goto L2 if var3
      ...
      15 [-]: JUMPIFNOTLT R3 R4 L1; goto L1 if var3 >= var66352
...
L 1:  18 [-]: NAMECALL R3 R1 K0; var4 = var1; var3 = var1[0xFA9E477F]
      ...
      24 [-]: JUMPIFNOTLT R6 R5 L2; goto L2 if var6 >= var722209
      25 [-]: GETIMPORT R5 11; var5 = 0xA8FDC20A
      26 [-]: JUMPIFNOTLE R5 R4 L2; goto L2 if var5 > var66864
...
L 5:  23 [-]: GETIMPORT R5 10; var5 = 0x447D2892
      24 [-]: JUMPIFLT R4 R5 L6; goto L6 if var4 < var1852
...
L 4:  36 [-]: JUMPIF R8 L8 ; goto L8 if var8
      ...
      39 [-]: JUMPIFNOTLT R8 R9 L8; goto L8 if var8 >= var1246029
      40 [-]: JUMPIF R3 L7 ; goto L7 if var3
      41 [-]: LOADN R10 86 ; var10 = 86
...
L 8:  60 [-]: GETTABLEKS R8 R7 K13; var8 = var7["distanceToTarget"]
      ...
      62 [-]: JUMPIFNOTLT R9 R8 L12; goto L12 if var9 >= var1180436
      63 [-]: JUMPIFNOT R3 L11; goto L11 if not var3
      64 [-]: LOADN R10 86 ; var10 = 86
...
L12:  83 [-]: GETTABLEKS R8 R7 K13; var8 = var7["distanceToTarget"]
      ...
      85 [-]: JUMPIFNOTLE R9 R8 L13; goto L13 if var9 > var1903137
...
L13:  90 [-]: GETIMPORT R8 31; var8 = 0xCBD666E1
      91 [-]: LOADK R9 K32 ; var9 = 0.10000000149011612
