...
L 3:  23 [-]: NAMECALL R8 R1 K4 [0xD1586535]
      24 [-]: CALL R8 1 1  
      25 [-]: GETIMPORT R9 8 [0xA421AF95]
      26 [-]: LOADN R10 0  
      27 [-]: LOADK R11 K9 [1.5]
      28 [-]: LOADN R12 0  
      29 [-]: CALL R9 3 1  
      30 [-]: ADD R7 R8 R9 
      31 [-]: GETIMPORT R8 12 [0xD96DCC3B]
      32 [-]: MOVE R9 R7   
      33 [-]: MOVE R10 R6  
      34 [-]: GETIMPORT R11 14 [0x74DCAE95]
      35 [-]: LOADB R12 1  
      36 [-]: CALL R8 4 1  
      37 [-]: MOVE R11 R6  
      ...
      44 [-]: CALL R9 2 0  
      45 [-]: GETIMPORT R11 19 [0xCC79FF20]
      46 [-]: GETIMPORT R14 21 [0x0ED8B456]
      47 [-]: LOADB R15 0  
      48 [-]: LOADN R16 2  
      49 [-]: LOADN R17 1  
      50 [-]: LOADB R18 1  
      ...
      54 [-]: CALL R9 -1 0 
      55 [-]: GETIMPORT R9 25 [0x89326C93]
      56 [-]: GETIMPORT R11 14 [0x74DCAE95]
      57 [-]: MOVE R12 R7  
      58 [-]: MOVE R13 R8  
      59 [-]: MOVE R14 R1  
...
L 1:   6 [-]: NAMECALL R1 R0 K2 [0xCD73323E]
       ...
       9 [-]: CALL R2 1 1  
      10 [-]: GETIMPORT R3 5 [0x20B7F774]
      11 [-]: GETIMPORT R4 7 ["ZERO_VECTOR"]
      12 [-]: MOVE R5 R2   
      13 [-]: CALL R3 2 1  
      ...
      28 [-]: CALL R7 1 1  
      29 [-]: DIV R5 R6 R7 
      30 [-]: GETIMPORT R6 17 [0x89326C93]
      31 [-]: GETIMPORT R8 19 [0x2E4C37DA]
      32 [-]: MOVE R9 R4   
      33 [-]: MOVE R10 R3  
      34 [-]: MOVE R11 R1  
      35 [-]: NAMECALL R6 R6 K20 [0x05909209]
      36 [-]: CALL R6 5 0  
      37 [-]: GETIMPORT R6 17 [0x89326C93]
      38 [-]: GETIMPORT R8 22 [0xA2A5F8FD]
      39 [-]: MOVE R9 R4   
      40 [-]: MOVE R10 R3  
      41 [-]: MOVE R11 R1  
...
L 2:  48 [-]: JUMPIF R7 L3 
      ...
      61 [-]: CALL R7 2 0  
      62 [-]: GETIMPORT R9 29 [0x0469F296]
      63 [-]: LOADK R10 K30 ["DestroyElement"]
      64 [-]: CALL R9 1 1  
      65 [-]: LOADB R10 0  
      66 [-]: NAMECALL R7 R6 K31 [0xD5F7912B]
      67 [-]: CALL R7 3 0  
L 3:  68 [-]: GETIMPORT R7 17 [0x89326C93]
      69 [-]: GETIMPORT R9 33 [0x98FE0CEE]
      70 [-]: MOVE R10 R4  
      71 [-]: MOVE R11 R3  
      72 [-]: MOVE R12 R1  
