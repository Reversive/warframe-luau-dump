...
L 6:  67 [-]: GETIMPORT R10 34; var10 = 0xFCD2D467
      68 [-]: JUMPIFNOTLT R7 R10 L32; goto L32 if var7 >= var264782
...
L18: 136 [-]: GETTABLE R18 R9 R17; var18 = var9[var17]
     137 [-]: JUMPIFNOTEQ R13 R18 L19; goto L19 if var13 ~= var69147
...
L24: 166 [-]: JUMPIFNOTLE R8 R7 L31; goto L31 if var8 > var68679
...
L 2:  72 [-]: GETIMPORT R12 38; var12 = 0xD3463304
      73 [-]: JUMPIFNOTLT R10 R12 L19; goto L19 if var10 >= var50871883
...
L 3:  78 [-]: JUMPIF R12 L5; goto L5 if var12
      ...
      87 [-]: JUMPIFNOTLE R5 R12 L4; goto L4 if var5 > var1074269253
...
L 5:  93 [-]: GETIMPORT R13 49; var13 = 0x67652851
      ...
      98 [-]: JUMPIFNOTLE R11 R10 L18; goto L18 if var11 > var-1073279931
...
L20: 205 [-]: GETIMPORT R14 40; var14 = 0x10994E17
     206 [-]: JUMPIFNOTLT R10 R14 L32; goto L32 if var10 >= var3215182
     ...
     212 [-]: JUMPIFNOTLE R11 R10 L28; goto L28 if var11 > var-1073279419
...
L28: 264 [-]: GETIMPORT R15 40; var15 = 0x10994E17
     265 [-]: SUBK R14 R15 K62; var14 = var15 - 0.40000000000000002
     266 [-]: JUMPIFNOTLE R14 R10 L30; goto L30 if var14 > var51134027
...
L30: 274 [-]: GETIMPORT R15 40; var15 = 0x10994E17
     275 [-]: SUBK R14 R15 K63; var14 = var15 - 0.20000000000000001
     276 [-]: JUMPIFNOTLE R14 R10 L31; goto L31 if var14 > var855331
...
L37: 327 [-]: GETIMPORT R17 76; var17 = 0xFCD2D467
     328 [-]: JUMPIFNOTLT R10 R17 L63; goto L63 if var10 >= var1053456
...
L48: 384 [-]: GETTABLE R25 R17 R20; var25 = var17[var20]
     ...
     386 [-]: JUMPIFNOTEQ R25 R26 L49; goto L49 if var25 ~= var70939
...
L54: 425 [-]: JUMPIFNOTLE R11 R10 L62; goto L62 if var11 > var-1073278651
...
L76: 558 [-]: GETTABLE R26 R18 R21; var26 = var18[var21]
     ...
     560 [-]: JUMPIFNOTEQ R26 R27 L77; goto L77 if var26 ~= var71195
...
L82: 599 [-]: JUMPIFNOTLE R11 R10 L90; goto L90 if var11 > var-1073278395
...
L11:  79 [-]: JUMPIFNOT R7 L13; goto L13 if not var7
      ...
      83 [-]: JUMPIFNOTLE R7 R8 L13; goto L13 if var7 > var264014
...
L14: 117 [-]: JUMPIFNOT R7 L15; goto L15 if not var7
     ...
     121 [-]: JUMPIFNOTLT R8 R7 L15; goto L15 if var8 >= var100796215
