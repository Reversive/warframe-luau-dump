...
L 0:   6 [-]: JUMPIFNOT R3 L1
       7 [-]: LOADN R3 0   
       8 [-]: RETURN R3 1  
L 1:   9 [-]: GETIMPORT R4 5 ["paxTeleportHomeArena"]
...
L 3:  17 [-]: GETIMPORT R5 5 ["paxTeleportHomeArena"]
...
L 4:  24 [-]: JUMPIFNOT R3 L5
      25 [-]: GETIMPORT R3 5 ["paxTeleportHomeArena"]
...
L 5:  35 [-]: NAMECALL R3 R1 K12 [0xCB4FCB36]
      36 [-]: CALL R3 1 1  
      37 [-]: GETIMPORT R5 5 ["paxTeleportHomeArena"]
...
L 9:  59 [-]: LOADN R5 0   
      60 [-]: RETURN R5 1  
L10:  61 [-]: GETIMPORT R5 16 [0x3D106989]
      62 [-]: LOADK R6 K17 ["We're getting too far away, teleport home"]
      63 [-]: CALL R5 1 0  
      64 [-]: GETIMPORT R5 9 [0x89326C93]
...
; Max Stack Size:  5
       ...
       0 [-]: GETIMPORT R3 2 ["gracefullyEndedPaxTeleportHome"]
       1 [-]: FASTCALL1 62 R3 L0
       2 [-]: GETIMPORT R2 4 [0x7B998233]
       3 [-]: CALL R2 1 1  
L 0:   4 [-]: NOT R1 R2    
       5 [-]: JUMPIFNOT R1 L1
       6 [-]: GETIMPORT R2 2 ["gracefullyEndedPaxTeleportHome"]
...
L 9:  61 [-]: GETUPVAL R9 1
      62 [-]: GETIMPORT R10 24 ["EMPTY_SYMBOL"]
...
L12:  85 [-]: LOADN R9 1   
     ...
     105 [-]: CALL R7 -1 0 
L13: 106 [-]: GETIMPORT R7 9 ["gracefullyEndedPaxTeleportHome"]
     107 [-]: NAMECALL R8 R1 K10 [0x388577D5]
     108 [-]: CALL R8 1 1  
     109 [-]: LOADB R9 1   
     110 [-]: SETTABLE R9 R7 R8
     111 [-]: GETIMPORT R7 29 [0x89326C93]
     112 [-]: GETUPVAL R9 2
     113 [-]: MOVE R10 R4  
     ...
     123 [-]: CALL R7 4 0  
     124 [-]: GETUPVAL R9 3
     125 [-]: GETIMPORT R10 24 ["EMPTY_SYMBOL"]
     126 [-]: NAMECALL R7 R1 K25 [0x47901F07]
     127 [-]: CALL R7 3 0  
     128 [-]: GETIMPORT R7 15 [0xC8802016]
     129 [-]: MOVE R8 R5   
     130 [-]: CALL R7 1 3  
...
; Max Stack Size:  12
       ...
       2 [-]: LOADB R6 0   
       3 [-]: CALL R4 2 0  
       4 [-]: GETIMPORT R6 2 ["gracefullyEndedPaxTeleportHome"]
       5 [-]: FASTCALL1 62 R6 L0
       6 [-]: GETIMPORT R5 4 [0x7B998233]
       7 [-]: CALL R5 1 1  
L 0:   8 [-]: NOT R4 R5    
       9 [-]: JUMPIFNOT R4 L1
      10 [-]: GETIMPORT R5 2 ["gracefullyEndedPaxTeleportHome"]
