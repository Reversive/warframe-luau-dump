...
L 0:  10 [-]: JUMPIF R3 L5 ; goto L5 if var3
      ...
      17 [-]: JUMPIFNOTLE R4 R3 L5; goto L5 if var4 > var1593967388
      18 [-]: GETTABLEKS R3 R2 K7; var3 = var2["distanceToTarget"]
      19 [-]: GETIMPORT R4 11; var4 = 0x86F495D5
      20 [-]: JUMPIFNOTLT R3 R4 L5; goto L5 if var3 >= var2130772805
      ...
      39 [-]: JUMPIFNOTLT R9 R8 L1; goto L1 if var9 >= var302384679
      40 [-]: SUBK R6 R6 K18; var6 = var6 - 360
L 1:  41 [-]: SUB R8 R6 R7 ; var8 = var6 - var7
      42 [-]: LOADN R9 -180; var9 = -180
      43 [-]: JUMPIFNOTLT R8 R9 L2; goto L2 if var8 >= var302384680
...
L 3:  49 [-]: GETIMPORT R5 23; var5 = 0x5201B3B5
      50 [-]: JUMPIFNOTLT R5 R4 L4; goto L4 if var5 >= var1351
...
L 6:  54 [-]: GETIMPORT R7 1; var7 = 0x89326C93
      ...
      64 [-]: JUMPIFNOTLT R11 R10 L7; goto L7 if var11 >= var487197223
      65 [-]: SUBK R10 R10 K29; var10 = var10 - 360
      66 [-]: JUMP L8      ; goto L8
L 7:  67 [-]: LOADN R11 -360; var11 = -360
      68 [-]: JUMPIFNOTLT R10 R11 L8; goto L8 if var10 >= var487197224
...
L 8:  70 [-]: MOVE R8 R10  ; var8 = var10
      ...
      76 [-]: JUMPIFNOTLT R12 R11 L9; goto L9 if var12 >= var487263015
      77 [-]: SUBK R11 R11 K29; var11 = var11 - 360
      78 [-]: JUMP L10     ; goto L10
L 9:  79 [-]: LOADN R12 -360; var12 = -360
      80 [-]: JUMPIFNOTLT R11 R12 L10; goto L10 if var11 >= var487263016
...
L14: 122 [-]: GETGLOBAL R7 K20; var7 = 0xA045103D
     ...
     124 [-]: JUMPIFLE R7 R8 L17; goto L17 if var7 <= var3082062
     ...
     135 [-]: JUMPIFNOTLT R10 R9 L15; goto L15 if var10 >= var486999847
     136 [-]: SUBK R7 R7 K29; var7 = var7 - 360
L15: 137 [-]: SUB R9 R7 R8 ; var9 = var7 - var8
     138 [-]: LOADN R10 -180; var10 = -180
     139 [-]: JUMPIFNOTLT R9 R10 L16; goto L16 if var9 >= var486999848
