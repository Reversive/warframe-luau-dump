...
; Max Stack Size:  3
       ...
       5 [-]: GETIMPORT R0 5 [0x0469F296]
       6 [-]: LOADK R1 K6 ["FIRE"]
       7 [-]: CALL R0 1 1  
       8 [-]: GETIMPORT R1 5 [0x0469F296]
...
; Max Stack Size:  7
       ...
       3 [-]: CALL R2 1 1  
       4 [-]: GETIMPORT R5 3 [0x18E0C11B]
       5 [-]: NAMECALL R3 R1 K4 [0xF2DEAF69]
       6 [-]: CALL R3 2 1  
       7 [-]: JUMPIFNOT R3 L1
       8 [-]: GETIMPORT R4 7 ["GolemAttached"]
       9 [-]: FASTCALL1 62 R4 L0
      10 [-]: GETIMPORT R3 9 [0x7B998233]
      11 [-]: CALL R3 1 1  
L 0:  12 [-]: JUMPIF R3 L1 
      13 [-]: GETIMPORT R3 7 ["GolemAttached"]
      14 [-]: JUMPIF R3 L1 
...
L 2:  25 [-]: RETURN R0 0  
L 3:  26 [-]: LOADN R5 1   
      27 [-]: GETIMPORT R8 10 [0x18E0C11B]
      28 [-]: NAMECALL R6 R1 K11 [0xF2DEAF69]
      29 [-]: CALL R6 2 1  
      30 [-]: JUMPIFNOT R6 L4
      31 [-]: GETIMPORT R6 13 [0x55730E1A]
      32 [-]: GETIMPORT R7 15 [0x2A32125A]
      33 [-]: GETIMPORT R8 17 [0x180AD95C]
      34 [-]: CALL R6 2 1  
      35 [-]: MOVE R5 R6   
      36 [-]: JUMP L5
     
L 4:  37 [-]: GETIMPORT R6 13 [0x55730E1A]
      38 [-]: GETIMPORT R7 19 [0x7505CA76]
      39 [-]: GETIMPORT R8 21 [0x955367CC]
      40 [-]: CALL R6 2 1  
      41 [-]: MOVE R5 R6   
L 5:  42 [-]: LOADNIL R6   
      43 [-]: LOADNIL R7   
      ...
      50 [-]: CALL R8 2 0  
      51 [-]: GETIMPORT R10 24 [0x07BAF0E0]
      52 [-]: LOADN R11 5  
      53 [-]: NAMECALL R8 R1 K25 [0x21B4C60E]
      54 [-]: CALL R8 3 0  
      55 [-]: GETIMPORT R10 27 [0xBA6EAE3D]
      56 [-]: LOADB R11 0  
      57 [-]: LOADN R12 0  
      58 [-]: LOADB R13 1  
      59 [-]: NAMECALL R8 R1 K28 [0x659D451F]
      60 [-]: CALL R8 5 0  
      61 [-]: GETIMPORT R9 30 [0xA04C5AD0]
      62 [-]: FASTCALL1 62 R9 L6
      63 [-]: GETIMPORT R8 6 [0x7B998233]
      64 [-]: CALL R8 1 1  
L 6:  65 [-]: JUMPIF R8 L7 
      66 [-]: GETIMPORT R10 30 [0xA04C5AD0]
      67 [-]: GETIMPORT R11 32 [0x0469F296]
      68 [-]: LOADK R12 K33 ["GAME_C1_HEAD"]
      69 [-]: CALL R11 1 1 
      70 [-]: GETIMPORT R12 35 [0xA421AF95]
      71 [-]: LOADN R13 -7 
      72 [-]: LOADN R14 0  
      73 [-]: LOADN R15 0  
      74 [-]: CALL R12 3 1 
      75 [-]: GETIMPORT R13 37 [0x00046924]
      76 [-]: LOADN R14 -90
      77 [-]: LOADN R15 0  
      78 [-]: LOADN R16 0  
      79 [-]: CALL R13 3 -1
      ...
      81 [-]: CALL R8 -1 0 
L 7:  82 [-]: GETIMPORT R10 40 [0x3745D006]
      83 [-]: LOADN R11 5  
      84 [-]: NAMECALL R8 R1 K25 [0x21B4C60E]
      85 [-]: CALL R8 3 0  
      86 [-]: GETIMPORT R10 42 [0x9035A6AC]
      87 [-]: LOADB R11 0  
      88 [-]: LOADN R12 0  
      89 [-]: LOADB R13 1  
...
L10: 107 [-]: MOVE R10 R2  
     ...
     111 [-]: CALL R8 -1 0 
     112 [-]: GETIMPORT R8 13 [0x55730E1A]
     113 [-]: GETIMPORT R9 19 [0x7505CA76]
     114 [-]: GETIMPORT R10 21 [0x955367CC]
     115 [-]: CALL R8 2 1  
     116 [-]: MOVE R5 R8   
     117 [-]: LOADN R10 1  
     118 [-]: MOVE R8 R5   
     119 [-]: LOADN R9 1   
     120 [-]: FORNPREP R8 L15
L11: 121 [-]: GETIMPORT R13 46 [0xDB106B8B]
     122 [-]: LOADB R14 1  
     ...
     129 [-]: GETIMPORT R13 46 [0xDB106B8B]
     130 [-]: LOADB R14 1  
     ...
     136 [-]: GETIMPORT R13 54 [0xC163F229]
     137 [-]: LOADN R14 -30
     138 [-]: LOADN R15 30 
     139 [-]: CALL R13 2 1 
     140 [-]: ADD R11 R12 R13
     ...
     143 [-]: GETIMPORT R13 54 [0xC163F229]
     144 [-]: LOADN R14 -30
     145 [-]: LOADN R15 30 
     146 [-]: CALL R13 2 1 
     147 [-]: ADD R11 R12 R13
     148 [-]: SETTABLEKS R11 R7 K55 ["pitch"]
     149 [-]: GETIMPORT R11 1 [0x89326C93]
     150 [-]: GETIMPORT R13 57 [0x74DCAE95]
     151 [-]: MOVE R14 R6  
     152 [-]: MOVE R15 R7  
     153 [-]: NAMECALL R11 R11 K58 [0x05909209]
     154 [-]: CALL R11 4 1 
     155 [-]: GETIMPORT R12 1 [0x89326C93]
     156 [-]: GETIMPORT R14 60 [0x1D0A1605]
     157 [-]: MOVE R15 R6  
     158 [-]: GETIMPORT R16 62 ["ZERO_ROTATION"]
     159 [-]: NAMECALL R12 R12 K58 [0x05909209]
     160 [-]: CALL R12 4 0 
     161 [-]: FASTCALL1 62 R11 L12
     162 [-]: MOVE R13 R11 
     163 [-]: GETIMPORT R12 6 [0x7B998233]
     164 [-]: CALL R12 1 1 
...
L13: 173 [-]: JUMPIF R12 L14
     174 [-]: GETIMPORT R12 66 [0x733FC736]
     175 [-]: LOADB R13 1  
     176 [-]: LOADB R14 1  
     177 [-]: CALL R12 2 1 
     178 [-]: MOVE R15 R2  
     ...
     183 [-]: CALL R13 2 0 
     184 [-]: GETIMPORT R15 69 [0x6687F6E0]
     185 [-]: NAMECALL R15 R15 K70 [0x24B019AC]
     186 [-]: CALL R15 1 1 
     187 [-]: GETIMPORT R16 32 [0x0469F296]
     188 [-]: LOADK R17 K71 ["SetProjectileTarget"]
     189 [-]: CALL R16 1 1 
     190 [-]: MOVE R17 R12 
     191 [-]: NAMECALL R13 R0 K72 [0xCBAE1D7C]
     192 [-]: CALL R13 4 0 
L14: 193 [-]: GETIMPORT R12 74 [0xCBD666E1]
     194 [-]: GETIMPORT R13 54 [0xC163F229]
     195 [-]: GETIMPORT R14 76 [0x5FE15B3F]
     196 [-]: GETIMPORT R15 78 [0x1D2A0129]
     197 [-]: CALL R13 2 -1
     198 [-]: CALL R12 -1 0
     199 [-]: FORNLOOP R8 L11
L15: 200 [-]: LOADN R10 0  
     ...
     206 [-]: CALL R8 2 0  
     207 [-]: GETIMPORT R10 80 [0xBA90D344]
     208 [-]: LOADN R11 5  
...
L11:  49 [-]: JUMPIF R4 L13
      50 [-]: GETIMPORT R6 9 ["gBaseAvatarType"]
...
L12:  58 [-]: NAMECALL R4 R0 K11 [0xA2880940]
      59 [-]: CALL R4 1 0  
      60 [-]: RETURN R0 0  
L13:  61 [-]: GETIMPORT R4 5 [0xCBD666E1]
