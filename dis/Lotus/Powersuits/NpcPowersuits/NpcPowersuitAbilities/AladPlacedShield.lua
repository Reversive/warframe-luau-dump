...
L 0:  18 [-]: JUMPIFNOT R6 L2
      ...
      29 [-]: RETURN R0 0  
L 1:  30 [-]: GETIMPORT R7 18 [nil]
      31 [-]: LOADN R8 1   
      32 [-]: LENGTH R9 R6 
      33 [-]: CALL R7 2 1  
      34 [-]: GETTABLE R5 R6 R7
L 2:  35 [-]: GETIMPORT R6 20 [nil]
      ...
      93 [-]: GETIMPORT R16 47 [nil]
      94 [-]: MOVE R17 R10 
      95 [-]: MOVE R18 R13 
      96 [-]: MOVE R19 R1  
      97 [-]: NAMECALL R14 R14 K48 [0x05909209]
      98 [-]: CALL R14 5 0 
      99 [-]: GETIMPORT R16 50 [nil]
     100 [-]: LOADB R17 0  
     101 [-]: LOADN R18 3  
     102 [-]: LOADN R19 2  
     103 [-]: LOADB R20 1  
...
L 5: 133 [-]: GETIMPORT R18 31 [nil]
     134 [-]: GETUPVAL R20 0
     135 [-]: NAMECALL R18 R18 K54 [0x0EB34C69]
     136 [-]: CALL R18 2 1 
     137 [-]: MOVE R8 R18  
L 6: 138 [-]: GETIMPORT R18 27 [nil]
     139 [-]: LOADN R19 0  
     140 [-]: CALL R18 1 0 
     141 [-]: JUMPBACK L3  
L 7: 142 [-]: GETIMPORT R20 56 [nil]
     143 [-]: LOADB R21 0  
     144 [-]: LOADN R22 3  
     145 [-]: LOADN R23 1  
     146 [-]: LOADB R24 1  
...
L 9: 175 [-]: LOADN R6 0   
     ...
     177 [-]: GETIMPORT R6 27 [nil]
     178 [-]: LOADN R7 0   
     179 [-]: CALL R6 1 0  
     180 [-]: GETIMPORT R6 31 [nil]
     181 [-]: GETUPVAL R8 0
     182 [-]: NAMECALL R6 R6 K54 [0x0EB34C69]
     183 [-]: CALL R6 2 1  
     184 [-]: MOVE R4 R6   
     185 [-]: JUMPBACK L9  
L10: 186 [-]: GETIMPORT R8 56 [nil]
     187 [-]: LOADB R9 0   
     188 [-]: LOADN R10 3  
     189 [-]: LOADN R11 1  
     190 [-]: LOADB R12 1  
...
L 4:  47 [-]: JUMPIF R4 L5 
      ...
      60 [-]: MUL R4 R5 R6 
      61 [-]: ADD R2 R2 R4 
      62 [-]: GETIMPORT R4 33 [nil]
      63 [-]: LOADN R5 0   
      64 [-]: CALL R4 1 0  
      65 [-]: JUMPBACK L3  
L 5:  66 [-]: GETIMPORT R4 35 [nil]
      67 [-]: GETUPVAL R6 0
      68 [-]: NAMECALL R4 R4 K36 [0x0EB34C69]
      69 [-]: CALL R4 2 1  
      70 [-]: GETIMPORT R5 2 [nil]
...
L11: 113 [-]: JUMPIFNOTLT R1 R2 L12
     114 [-]: GETIMPORT R7 29 [nil]
     115 [-]: MOVE R8 R2   
     116 [-]: NAMECALL R5 R0 K25 [0x986D2AB8]
     117 [-]: CALL R5 3 0  
     118 [-]: GETIMPORT R7 27 [nil]
     119 [-]: MOVE R8 R2   
