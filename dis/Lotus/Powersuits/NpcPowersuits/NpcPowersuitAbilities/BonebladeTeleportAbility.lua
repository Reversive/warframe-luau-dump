...
; Max Stack Size:  17
      ...
      36 [-]: JUMPIFEQ R8 R9 L0; goto L0 if var8 == var68123
...
L 0:  41 [-]: MOVE R10 R0  ; var10 = var0
      ...
      45 [-]: LOADK R14 K20; var14 = -0.90000000000000002
...
; Max Stack Size:  13
      ...
      36 [-]: JUMPIFEQ R7 R8 L0; goto L0 if var7 == var67867
...
L 7:  39 [-]: GETTABLE R10 R6 R9; var10 = var6[var9]
      ...
      50 [-]: JUMPIFNOTEQ R11 R12 L8; goto L8 if var11 ~= var1594493724
      51 [-]: GETTABLEKS R11 R10 K13; var11 = var10["distanceToTarget"]
      52 [-]: GETIMPORT R12 15; var12 = 0x55AC929B
      53 [-]: JUMPIFNOTLE R11 R12 L8; goto L8 if var11 > var656662
...
L11:  69 [-]: JUMPIF R7 L12; goto L12 if var7
      ...
      78 [-]: JUMPIFNOTLT R7 R8 L13; goto L13 if var7 >= var1863
...
L11: 119 [-]: LENGTH R11 R9; var11 = #var9
     ...
     121 [-]: JUMPIFNOTLT R12 R11 L17; goto L17 if var12 >= var2952014
...
L21: 202 [-]: LENGTH R11 R9; var11 = #var9
     ...
     204 [-]: JUMPIFNOTLT R12 R11 L24; goto L24 if var12 >= var2952014
