...
L 0:  13 [-]: JUMPIF R4 L3 ; goto L3 if var4
      ...
      20 [-]: JUMPIFNOTLE R5 R4 L3; goto L3 if var5 > var1594033215
      21 [-]: GETTABLEKS R4 R3 K8; var4 = var3["distanceToTarget"]
      22 [-]: GETIMPORT R5 12; var5 = 0x443A8D0B
      23 [-]: JUMPIFNOTLT R4 R5 L3; goto L3 if var4 >= var918561
...
L 2:  56 [-]: LENGTH R6 R4 ; var6 = #var4
      ...
      58 [-]: JUMPIFNOTLT R6 R7 L3; goto L3 if var6 >= var329216
      59 [-]: LENGTH R6 R5 ; var6 = #var5
      60 [-]: GETIMPORT R7 27; var7 = 0x4ECB7844
      61 [-]: JUMPIFNOTLT R6 R7 L3; goto L3 if var6 >= var1661143103
...
L 3:  33 [-]: LENGTH R10 R6; var10 = #var6
      ...
      35 [-]: JUMPIFNOTLT R11 R10 L5; goto L5 if var11 >= var985889
      36 [-]: GETIMPORT R11 15; var11 = 0x266B4A23
      37 [-]: GETTABLE R10 R11 R7; var10 = var11[var7]
      38 [-]: LOADN R11 0  ; var11 = 0
      39 [-]: JUMPIFNOTLT R11 R10 L5; goto L5 if var11 >= var985889
...
L 7:  59 [-]: LENGTH R10 R6; var10 = #var6
      ...
      61 [-]: JUMPIFNOTLT R11 R10 L9; goto L9 if var11 >= var1510177
      62 [-]: GETIMPORT R11 23; var11 = 0x1BA1291A
      63 [-]: GETTABLE R10 R11 R7; var10 = var11[var7]
      64 [-]: LOADN R11 0  ; var11 = 0
      65 [-]: JUMPIFNOTLT R11 R10 L9; goto L9 if var11 >= var1510177
...
L12: 113 [-]: GETIMPORT R13 33; var13 = 0x4ECB7844
     ...
     119 [-]: JUMPIFNOTLT R12 R8 L13; goto L13 if var12 >= var788526
     120 [-]: MOVE R8 R12  ; var8 = var12
L13: 121 [-]: JUMPIFNOTLT R13 R9 L14; goto L14 if var13 >= var854318
...
L17: 146 [-]: JUMPIFNOTLT R15 R14 L23; goto L23 if var15 >= var2757665
     ...
     153 [-]: LOADK R19 K46; var19 = 0.15000000596046448
...
L18: 155 [-]: GETIMPORT R20 48; var20 = 0xDB106B8B
     ...
     159 [-]: SUBK R19 R20 K50; var19 = var20 - 2.2000000476837158
     ...
     174 [-]: ADDK R20 R21 K59; var20 = var21 + 1.7000000476837158
     ...
     188 [-]: JUMPIFNOTLT R16 R9 L20; goto L20 if var16 >= var1052992
     189 [-]: JUMPIFNOTLT R17 R8 L20; goto L20 if var17 >= var1185057
...
L20: 201 [-]: JUMPIFNOTLT R16 R9 L21; goto L21 if var16 >= var332055
     202 [-]: JUMPIFNOTEQ R17 R8 L21; goto L21 if var17 ~= var4527137
