...
L 3:  18 [-]: GETTABLEKS R4 R3 K4; var4 = var3["avatar"]
      ...
      32 [-]: JUMPIFLT R5 R4 L4; goto L4 if var5 < var-469695419
...
L 4:  36 [-]: GETTABLEKS R4 R3 K9; var4 = var3["distanceToTarget"]
      ...
      38 [-]: JUMPIFNOTLT R4 R5 L6; goto L6 if var4 >= var1661142044
...
L 6: 117 [-]: JUMPIFNOTLT R11 R15 L13; goto L13 if var11 >= var1315399
...
L 7: 130 [-]: JUMPIF R16 L9; goto L9 if var16
     ...
     135 [-]: JUMPIFNOTLT R16 R17 L8; goto L8 if var16 >= var985878
...
L10: 162 [-]: JUMPIF R16 L13; goto L13 if var16
     ...
     177 [-]: JUMPIFNOTLT R16 R17 L11; goto L11 if var16 >= var3543118
     ...
     182 [-]: JUMPIFLE R16 R10 L13; goto L13 if var16 <= var65600
...
L 1:  16 [-]: GETIMPORT R7 9; var7 = 0x661D93DF
      ...
      32 [-]: LOADK R9 K17 ; var9 = 0.20000000000000001
...
L 2:  39 [-]: JUMPIF R6 L3 ; goto L3 if var6
      ...
      47 [-]: JUMPIFNOTEQ R6 R7 L3; goto L3 if var6 ~= var133142
      ...
      52 [-]: JUMPIFNOTLT R6 R7 L3; goto L3 if var6 >= var1705550
      ...
      74 [-]: LOADK R11 K35; var11 = 0.55000000000000004
