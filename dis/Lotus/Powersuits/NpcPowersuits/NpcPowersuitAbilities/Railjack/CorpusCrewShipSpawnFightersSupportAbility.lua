...
L 2:  21 [-]: JUMPIF R4 L12
      ...
      25 [-]: GETIMPORT R6 13 [0xAC4715F7]
      26 [-]: NAMECALL R7 R1 K14 [0xD1586535]
      27 [-]: CALL R7 1 1  
      28 [-]: GETIMPORT R8 16 [0x4243A037]
      29 [-]: GETIMPORT R9 18 [0x86F495D5]
...
L 5:  46 [-]: GETTABLE R11 R4 R10
      47 [-]: GETIMPORT R14 21 [0xC8FFE0A5]
...
L11:  72 [-]: GETIMPORT R8 26 [0x2B912143]
...
L 1:   9 [-]: JUMPIFNOT R4 L2
      10 [-]: RETURN R0 0  
L 2:  11 [-]: GETIMPORT R5 6 [0xD2D9F768]
      12 [-]: GETIMPORT R6 8 [0x0C5E62F9]
      13 [-]: LOADN R7 1   
      14 [-]: GETIMPORT R9 6 [0xD2D9F768]
      15 [-]: LENGTH R8 R9 
      16 [-]: CALL R6 2 1  
...
L 3:  24 [-]: JUMPIF R6 L4 
      ...
      27 [-]: CALL R6 2 1  
      28 [-]: MOVE R5 R6   
L 4:  29 [-]: GETIMPORT R8 12 [0xBAB895E9]
      30 [-]: LOADB R9 0   
      31 [-]: NAMECALL R6 R1 K13 [0x659D451F]
      32 [-]: CALL R6 3 0  
      33 [-]: GETIMPORT R6 1 [0x89326C93]
      34 [-]: GETIMPORT R8 15 [0x78403F35]
      35 [-]: MOVE R9 R5   
...
L 9:  65 [-]: JUMPIF R7 L11
      ...
      70 [-]: CALL R8 2 1  
      71 [-]: GETIMPORT R9 22 [0xBB179EBC]
      72 [-]: JUMPIFNOTLT R8 R9 L10
      73 [-]: GETIMPORT R11 24 [0xC8FFE0A5]
      74 [-]: GETIMPORT R12 26 ["EMPTY_SYMBOL"]
      75 [-]: GETIMPORT R13 28 [0xA421AF95]
      76 [-]: LOADN R14 1  
      77 [-]: LOADN R15 8  
      78 [-]: LOADN R16 5  
      79 [-]: CALL R13 3 1 
      80 [-]: GETIMPORT R14 30 ["ZERO_ROTATION"]
      81 [-]: NAMECALL R9 R7 K31 [0x47901F07]
      82 [-]: CALL R9 5 0  
      83 [-]: NAMECALL R9 R6 K32 [0xA2880940]
      84 [-]: CALL R9 1 0  
      85 [-]: RETURN R0 0  
L10:  86 [-]: GETIMPORT R9 34 [0xCBD666E1]
