...
L 4:  32 [-]: NEWTABLE R7 0 4
      33 [-]: GETIMPORT R8 11 ["gBaseAvatarType"]
      34 [-]: GETIMPORT R9 13 ["gPickUpType"]
      35 [-]: GETIMPORT R10 15 ["gRagdollType"]
      36 [-]: GETIMPORT R11 17 ["gHitProxyType"]
      37 [-]: SETLIST R7 R8 4 [1]
      38 [-]: GETIMPORT R8 19 [0xA421AF95]
      39 [-]: CALL R8 0 1  
      40 [-]: GETIMPORT R9 1 [0x89326C93]
      41 [-]: GETIMPORT R11 19 [0xA421AF95]
      42 [-]: GETTABLEKS R12 R5 K20 ["x"]
      43 [-]: GETTABLEKS R14 R5 K22 ["y"]
      44 [-]: ADDK R13 R14 K21 [3]
      45 [-]: GETTABLEKS R14 R5 K23 ["z"]
      46 [-]: CALL R11 3 1 
      47 [-]: GETIMPORT R12 19 [0xA421AF95]
      ...
      58 [-]: JUMPIFNOT R9 L5
      59 [-]: MOVE R5 R8   
L 5:  60 [-]: GETIMPORT R9 1 [0x89326C93]
      61 [-]: GETIMPORT R11 26 [0x071DCBE3]
      62 [-]: MOVE R12 R5  
      63 [-]: GETIMPORT R13 28 ["ZERO_ROTATION"]
      64 [-]: MOVE R14 R0  
      65 [-]: NAMECALL R9 R9 K29 [0x05909209]
      66 [-]: CALL R9 5 1  
      67 [-]: GETIMPORT R10 31 [0xCBD666E1]
      68 [-]: LOADN R11 0  
      69 [-]: CALL R10 1 0 
...
L 6:  74 [-]: JUMPIF R10 L9
      ...
      81 [-]: CALL R10 3 0 
      82 [-]: GETIMPORT R10 31 [0xCBD666E1]
      83 [-]: LOADK R11 K34 [0.20000000000000001]
      84 [-]: CALL R10 1 0 
      85 [-]: FASTCALL1 62 R2 L7
      86 [-]: MOVE R11 R2  
      87 [-]: GETIMPORT R10 4 [0x7B998233]
      88 [-]: CALL R10 1 1 
...
L 0:  18 [-]: JUMPIF R2 L1 
      ...
      22 [-]: CALL R5 1 1  
      23 [-]: GETIMPORT R6 14 [0xA421AF95]
      24 [-]: LOADN R7 0   
      25 [-]: LOADK R8 K15 [0.14999999999999999]
      26 [-]: LOADN R9 0   
      27 [-]: CALL R6 3 1  
      28 [-]: GETIMPORT R7 17 [0x00046924]
      29 [-]: LOADN R8 0   
      30 [-]: LOADN R9 0   
      31 [-]: LOADN R10 90 
      32 [-]: CALL R7 3 -1 
...
L 0:   4 [-]: JUMPIF R1 L1 
       ...
       7 [-]: CALL R1 1 1  
       8 [-]: SETUPVAL R1 1
L 1:   9 [-]: GETIMPORT R1 4 [0xCBD666E1]
...
L 3:  18 [-]: LOADB R3 1   
      ...
      36 [-]: CALL R8 1 1  
L 4:  37 [-]: JUMPIF R8 L5 
      38 [-]: GETIMPORT R10 11 ["gAvatarType"]
...
L13:  99 [-]: JUMPIF R8 L14
     ...
     102 [-]: CALL R8 2 0  
     103 [-]: GETIMPORT R10 24 [0xBB36C76B]
     104 [-]: LOADB R11 1  
     105 [-]: LOADB R12 0  
     106 [-]: NAMECALL R8 R0 K28 [0x5D985C7E]
     107 [-]: CALL R8 4 0  
     108 [-]: GETIMPORT R10 26 [0x2A7D6C87]
...
L14: 112 [-]: NAMECALL R8 R0 K29 [0x65D389CB]
     113 [-]: CALL R8 1 1  
     114 [-]: GETIMPORT R9 31 [0xCDD0C718]
L15: 115 [-]: LOADN R10 0  
...
L16: 121 [-]: JUMPIF R10 L17
     122 [-]: GETIMPORT R10 33 [0x67652851]
     123 [-]: CALL R10 0 1 
     124 [-]: SUB R9 R9 R10
     125 [-]: GETIMPORT R12 35 [0x9BAFFFE3]
     126 [-]: GETIMPORT R13 37 [0xA6D4EAFE]
     127 [-]: MOVE R14 R8  
     128 [-]: GETIMPORT R16 31 [0xCDD0C718]
     129 [-]: DIV R15 R9 R16
     130 [-]: CALL R12 3 -1
     131 [-]: NAMECALL R10 R0 K38 [0x2D9BA74F]
     132 [-]: CALL R10 -1 0
     133 [-]: GETIMPORT R10 4 [0xCBD666E1]
     134 [-]: LOADN R11 0  
     135 [-]: CALL R10 1 0 
     136 [-]: JUMPBACK L15 
L17: 137 [-]: GETIMPORT R12 37 [0xA6D4EAFE]
     138 [-]: NAMECALL R10 R0 K38 [0x2D9BA74F]
     139 [-]: CALL R10 2 0 
L18: 140 [-]: GETIMPORT R10 40 [0x24ECDE7D]
...
L22: 159 [-]: RETURN R0 0  
L23: 160 [-]: GETIMPORT R11 44 [0xA8E4F5A6]
     ...
     170 [-]: CALL R11 2 1 
     171 [-]: LOADN R12 5  
     172 [-]: GETIMPORT R13 15 [0x89326C93]
     173 [-]: NAMECALL R13 R13 K16 [0x18D05D30]
     174 [-]: CALL R13 1 1 
     175 [-]: JUMPIFNOT R13 L31
     176 [-]: GETIMPORT R14 49 ["BeaconsPlanted"]
...
L24: 180 [-]: JUMPIFNOT R13 L25
     ...
     182 [-]: CALL R13 1 0 
     183 [-]: RETURN R0 0  
L25: 184 [-]: GETIMPORT R14 49 ["BeaconsPlanted"]
     185 [-]: FASTCALL2 52 R14 R0 L26
     186 [-]: MOVE R15 R0  
     187 [-]: GETIMPORT R13 53 [0x23D5322F]
     188 [-]: CALL R13 2 0 
L26: 189 [-]: GETUPVAL R13 2
     ...
     197 [-]: CALL R13 3 0 
     198 [-]: GETIMPORT R13 15 [0x89326C93]
     199 [-]: GETIMPORT R15 58 [0x0469F296]
     200 [-]: LOADK R16 K59 ["VenusBeacon"]
     201 [-]: CALL R15 1 1 
     202 [-]: MOVE R16 R6  
     203 [-]: LOADN R17 0  
     204 [-]: GETIMPORT R18 61 [0xBD1C95A0]
...
L29: 218 [-]: JUMPIF R14 L31
     ...
     221 [-]: GETIMPORT R16 1 [0x7B998233]
     222 [-]: CALL R16 1 1 
L30: 223 [-]: JUMPIF R16 L31
     ...
     228 [-]: GETUPVAL R16 1
     229 [-]: MOVE R18 R6  
     230 [-]: GETIMPORT R19 65 [0x1893792F]
     231 [-]: MOVE R20 R4  
     232 [-]: LOADN R21 0  
...
L31: 236 [-]: FASTCALL1 62 R9 L32
     237 [-]: MOVE R14 R9  
     238 [-]: GETIMPORT R13 1 [0x7B998233]
     239 [-]: CALL R13 1 1 
L32: 240 [-]: JUMPIF R13 L33
     241 [-]: NAMECALL R13 R9 K42 [0x383D2E7D]
     242 [-]: CALL R13 1 0 
L33: 243 [-]: GETIMPORT R13 15 [0x89326C93]
...
L35: 251 [-]: JUMPIF R13 L41
     252 [-]: GETIMPORT R13 15 [0x89326C93]
     253 [-]: NAMECALL R15 R0 K8 [0xD1586535]
     254 [-]: CALL R15 1 1 
     255 [-]: GETIMPORT R16 61 [0xBD1C95A0]
...
L36: 262 [-]: JUMPIFNOT R14 L39
     ...
     264 [-]: GETIMPORT R15 33 [0x67652851]
     265 [-]: CALL R15 0 1 
     266 [-]: SUB R12 R14 R15
     267 [-]: LOADN R14 0  
     268 [-]: JUMPIFNOTLE R12 R14 L40
     269 [-]: GETIMPORT R17 49 ["BeaconsPlanted"]
     270 [-]: LENGTH R16 R17
     271 [-]: LOADN R14 1  
     272 [-]: LOADN R15 -1 
     273 [-]: FORNPREP R14 L40
L37: 274 [-]: GETIMPORT R18 49 ["BeaconsPlanted"]
     275 [-]: GETTABLE R17 R18 R16
     276 [-]: JUMPIFNOTEQ R17 R0 L38
     277 [-]: GETIMPORT R17 70 [0x9C1F3B5A]
     278 [-]: GETIMPORT R18 49 ["BeaconsPlanted"]
     279 [-]: MOVE R19 R16 
     280 [-]: CALL R17 2 0 
...
L39: 286 [-]: JUMPXEQKN R12 K71 L40 [5]
     287 [-]: LOADN R12 5  
L40: 288 [-]: GETIMPORT R14 4 [0xCBD666E1]
...
; Max Stack Size:  11
       ...
       3 [-]: LOADN R2 1   
       4 [-]: FORNPREP R1 L2
L 0:   5 [-]: GETIMPORT R5 2 ["BeaconsPlanted"]
       6 [-]: GETTABLE R4 R5 R3
       7 [-]: JUMPIFNOTEQ R4 R0 L1
       8 [-]: GETIMPORT R4 5 [0x9C1F3B5A]
       9 [-]: GETIMPORT R5 2 ["BeaconsPlanted"]
      10 [-]: MOVE R6 R3   
      11 [-]: CALL R4 2 0  
      12 [-]: GETUPVAL R4 0
      13 [-]: GETUPVAL R6 1
...
L 2:  22 [-]: GETIMPORT R3 10 [0xA8E4F5A6]
