...
; Max Stack Size:  14
 ...
 14 [-]: CONST     R3 120       ; R3 := 120.000000
 15 [-]: CONST     R4 180       ; R4 := 180.000000
 16 [-]: CONST     R5 240       ; R5 := 240.000000
...
; Max Stack Size:  20
  ...
  9 [-]: SETTABLE  R6 K1 R8     ; R6[0xcbd666e1] := R8
