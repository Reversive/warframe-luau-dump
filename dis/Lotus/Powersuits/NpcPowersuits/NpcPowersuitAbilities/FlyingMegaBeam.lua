...
L 3:  15 [-]: NAMECALL R3 R0 K3 [0x5280B883]
      ...
      21 [-]: GETIMPORT R4 7 [0xF6C6E505]
      22 [-]: MOVE R5 R3   
      23 [-]: CALL R4 1 1  
      24 [-]: MOVE R2 R4   
      25 [-]: GETIMPORT R3 9 [0xCA00478E]
      26 [-]: LOADN R4 360 
      ...
      34 [-]: SUB R6 R5 R4 
      35 [-]: GETIMPORT R7 13 [0xC2892F65]
      36 [-]: MOVE R8 R6   
      37 [-]: CALL R7 1 0  
      38 [-]: GETIMPORT R7 15 [0xBF52F20F]
      39 [-]: MOVE R8 R2   
      40 [-]: MOVE R9 R6   
      41 [-]: CALL R7 2 1  
      42 [-]: GETIMPORT R8 9 [0xCA00478E]
...
L 6:  49 [-]: MOVE R5 R1   
      ...
      53 [-]: CALL R4 1 1  
      54 [-]: JUMPIFNOT R4 L7
      55 [-]: GETIMPORT R4 19 [0x4243A037]
      56 [-]: JUMPIFNOTLE R4 R3 L7
      57 [-]: GETIMPORT R4 21 [0x86F495D5]
...
L 2:  13 [-]: RETURN R0 0  
L 3:  14 [-]: LOADNIL R4   
      15 [-]: GETIMPORT R6 5 [0x429D2762]
      16 [-]: FASTCALL1 62 R6 L4
      17 [-]: GETIMPORT R5 1 [0x7B998233]
      18 [-]: CALL R5 1 1  
L 4:  19 [-]: JUMPIF R5 L6 
      20 [-]: GETIMPORT R7 5 [0x429D2762]
...
L 5:  28 [-]: JUMPIFNOT R5 L6
      29 [-]: RETURN R0 0  
L 6:  30 [-]: LOADNIL R5   
      31 [-]: GETIMPORT R7 8 [0x48CE03A5]
      32 [-]: FASTCALL1 62 R7 L7
      33 [-]: GETIMPORT R6 1 [0x7B998233]
      34 [-]: CALL R6 1 1  
L 7:  35 [-]: JUMPIF R6 L9 
      36 [-]: GETIMPORT R8 8 [0x48CE03A5]
...
L 8:  44 [-]: JUMPIFNOT R6 L9
      45 [-]: RETURN R0 0  
L 9:  46 [-]: GETIMPORT R6 10 [0x89326C93]
      47 [-]: NAMECALL R6 R6 K11 [0x18D05D30]
      48 [-]: CALL R6 1 1  
      49 [-]: JUMPIFNOT R6 L10
      50 [-]: GETIMPORT R8 13 [0x46EC767E]
      51 [-]: GETIMPORT R9 15 [0xDB106B8B]
      52 [-]: NAMECALL R6 R1 K16 [0x47901F07]
      53 [-]: CALL R6 3 0  
L10:  54 [-]: GETIMPORT R8 18 [0x17517254]
      55 [-]: LOADB R9 0   
      56 [-]: LOADN R10 1  
      57 [-]: LOADB R11 0  
      58 [-]: NAMECALL R6 R1 K19 [0x659D451F]
      59 [-]: CALL R6 5 0  
      60 [-]: GETIMPORT R8 21 [0xB4C8705B]
      61 [-]: GETIMPORT R9 23 ["EMPTY_SYMBOL"]
      62 [-]: NAMECALL R6 R1 K16 [0x47901F07]
      63 [-]: CALL R6 3 0  
      64 [-]: GETIMPORT R8 25 [0x2631F300]
      65 [-]: GETIMPORT R9 27 [0x0469F296]
...
L11:  82 [-]: GETIMPORT R9 33 [0x0ED8B456]
      83 [-]: LOADB R10 1  
      84 [-]: LOADN R11 3  
      85 [-]: LOADN R12 1  
      86 [-]: LOADB R13 1  
      ...
      88 [-]: CALL R7 6 0  
L12:  89 [-]: GETIMPORT R9 35 [0xC6F642B0]
      90 [-]: LOADB R10 0  
      91 [-]: LOADN R11 3  
      92 [-]: LOADN R12 2  
      93 [-]: LOADB R13 1  
      ...
      95 [-]: CALL R7 6 0  
      96 [-]: GETIMPORT R7 37 [0xA421AF95]
      97 [-]: CALL R7 0 1  
      98 [-]: GETIMPORT R10 39 [0x78A39459]
      99 [-]: GETIMPORT R11 15 [0xDB106B8B]
     100 [-]: GETIMPORT R12 41 ["ZERO_VECTOR"]
...
L13: 110 [-]: JUMPIF R9 L14
     ...
     113 [-]: CALL R9 2 0  
L14: 114 [-]: GETIMPORT R9 45 [0xCBD666E1]
     115 [-]: LOADN R10 0  
     116 [-]: CALL R9 1 0  
     117 [-]: GETIMPORT R11 15 [0xDB106B8B]
     118 [-]: LOADB R12 1  
     ...
     123 [-]: CALL R10 1 1 
     124 [-]: SUB R9 R10 R7
     125 [-]: GETIMPORT R10 49 [0xAE2294FA]
     126 [-]: MOVE R11 R9  
     127 [-]: CALL R10 1 1 
     128 [-]: LOADN R11 1  
     ...
     131 [-]: CALL R10 1 1 
     132 [-]: MOVE R9 R10  
L15: 133 [-]: GETIMPORT R10 52 [0xC2892F65]
     134 [-]: MOVE R11 R9  
     135 [-]: CALL R10 1 0 
     136 [-]: LOADN R10 0  
     137 [-]: GETIMPORT R13 54 [0x520E413D]
     138 [-]: LOADB R14 0  
     139 [-]: LOADN R15 1  
     140 [-]: LOADB R16 1  
     ...
     142 [-]: CALL R11 5 0 
     143 [-]: LOADN R11 0  
L16: 144 [-]: GETIMPORT R12 56 [0xFD8C7F61]
     145 [-]: JUMPIFNOTLT R11 R12 L31
     146 [-]: FASTCALL1 62 R1 L17
     147 [-]: MOVE R13 R1  
     148 [-]: GETIMPORT R12 1 [0x7B998233]
     149 [-]: CALL R12 1 1 
...
L19: 166 [-]: JUMPIF R12 L31
     167 [-]: GETIMPORT R12 45 [0xCBD666E1]
     168 [-]: LOADN R13 0  
     169 [-]: CALL R12 1 0 
     170 [-]: GETUPVAL R12 0
     171 [-]: MOVE R13 R1  
     ...
     175 [-]: GETIMPORT R13 5 [0x429D2762]
...
L22: 185 [-]: GETIMPORT R13 8 [0x48CE03A5]
     186 [-]: FASTCALL1 62 R13 L23
     187 [-]: GETIMPORT R12 1 [0x7B998233]
     188 [-]: CALL R12 1 1 
...
L25: 195 [-]: GETIMPORT R14 15 [0xDB106B8B]
     196 [-]: LOADB R15 1  
...
L27: 213 [-]: SUB R13 R12 R7
     214 [-]: GETIMPORT R14 52 [0xC2892F65]
     215 [-]: MOVE R15 R13 
     216 [-]: CALL R14 1 0 
     217 [-]: GETIMPORT R14 61 [0xB968557F]
     218 [-]: MOVE R15 R9  
     219 [-]: MOVE R16 R13 
     220 [-]: GETIMPORT R18 63 [0xBDD0E96E]
     221 [-]: GETIMPORT R19 65 [0x67652851]
     222 [-]: CALL R19 0 1 
     223 [-]: MUL R17 R18 R19
     224 [-]: CALL R14 3 1 
     225 [-]: GETIMPORT R15 67 [0x20B7F774]
     226 [-]: GETIMPORT R16 41 ["ZERO_VECTOR"]
     227 [-]: MOVE R17 R14 
     228 [-]: CALL R15 2 1 
     229 [-]: GETIMPORT R18 41 ["ZERO_VECTOR"]
     230 [-]: MOVE R19 R15 
     ...
     238 [-]: CALL R16 2 1 
     239 [-]: JUMPIF R16 L31
     240 [-]: GETIMPORT R18 35 [0xC6F642B0]
...
L28: 250 [-]: JUMPIF R17 L30
     ...
     265 [-]: CALL R19 2 0 
     266 [-]: GETIMPORT R19 65 [0x67652851]
     267 [-]: CALL R19 0 1 
     268 [-]: ADD R10 R10 R19
     269 [-]: JUMP L30
    
L29: 270 [-]: LOADN R10 0  
L30: 271 [-]: GETIMPORT R17 65 [0x67652851]
     272 [-]: CALL R17 0 1 
     273 [-]: ADD R11 R11 R17
     274 [-]: MOVE R9 R14  
     275 [-]: JUMPBACK L16 
L31: 276 [-]: FASTCALL1 62 R8 L32
     277 [-]: MOVE R13 R8  
     278 [-]: GETIMPORT R12 1 [0x7B998233]
     279 [-]: CALL R12 1 1 
...
L35: 290 [-]: LOADN R14 29 
     ...
     294 [-]: GETIMPORT R14 77 [0x2AABFA78]
     295 [-]: LOADB R15 1  
     296 [-]: LOADN R16 3  
     297 [-]: LOADN R17 1  
     298 [-]: LOADB R18 1  
     ...
     300 [-]: CALL R12 6 0 
     301 [-]: RETURN R0 0  
L36: 302 [-]: GETIMPORT R14 79 [0x9797D881]
     303 [-]: LOADB R15 1  
     304 [-]: LOADN R16 3  
     305 [-]: LOADN R17 1  
     306 [-]: LOADB R18 1  
