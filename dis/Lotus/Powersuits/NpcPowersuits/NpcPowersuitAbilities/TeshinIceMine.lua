...
L 7:  57 [-]: JUMPIF R3 L8 ; goto L8 if var3
      ...
      60 [-]: JUMPIFNOTLE R4 R3 L8; goto L8 if var4 > var1593967423
      61 [-]: GETTABLEKS R3 R2 K19; var3 = var2["distanceToTarget"]
      62 [-]: GETIMPORT R4 23; var4 = 0x86F495D5
      63 [-]: JUMPIFNOTLT R3 R4 L8; goto L8 if var3 >= var66352
...
L 1:  22 [-]: NAMECALL R8 R7 K12; var9 = var7; var8 = var7[0xD1586535]
      ...
      28 [-]: JUMPIFNOTLE R9 R10 L2; goto L2 if var9 > var1116705
      ...
      51 [-]: JUMPIFEQ R10 R11 L2; goto L2 if var10 == var264993
