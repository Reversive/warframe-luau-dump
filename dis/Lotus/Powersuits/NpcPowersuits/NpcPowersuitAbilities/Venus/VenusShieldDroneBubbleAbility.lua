...
L 2:  23 [-]: GETIMPORT R7 4 [0x9C1F3B5A]
      24 [-]: MOVE R8 R0   
      25 [-]: MOVE R9 R6   
      26 [-]: CALL R7 2 0  
      27 [-]: JUMP L8
...
L 5:  43 [-]: LOADN R9 1   
      44 [-]: GETIMPORT R10 11 [0x7F04C2E4]
      45 [-]: LENGTH R7 R10
      46 [-]: LOADN R8 1   
      47 [-]: FORNPREP R7 L8
L 6:  48 [-]: GETTABLE R10 R0 R6
      49 [-]: GETIMPORT R13 11 [0x7F04C2E4]
      50 [-]: GETTABLE R12 R13 R9
      51 [-]: NAMECALL R10 R10 K12 [0xF2DEAF69]
      52 [-]: CALL R10 2 1 
      53 [-]: JUMPIFNOT R10 L7
      54 [-]: GETIMPORT R10 4 [0x9C1F3B5A]
      55 [-]: MOVE R11 R0  
      56 [-]: MOVE R12 R6  
      57 [-]: CALL R10 2 0 
      58 [-]: JUMP L8
...
; Max Stack Size:  11
       ...
       2 [-]: CALL R2 1 1  
       3 [-]: GETIMPORT R3 4 [0xA421AF95]
       4 [-]: LOADN R4 0   
       5 [-]: LOADK R5 K5 [0.59999999999999998]
       6 [-]: LOADN R6 0   
       7 [-]: CALL R3 3 1  
       8 [-]: LOADN R6 1   
       9 [-]: GETIMPORT R7 7 [0x08130E1D]
      10 [-]: LENGTH R4 R7 
      11 [-]: LOADN R5 1   
      12 [-]: FORNPREP R4 L2
L 0:  13 [-]: GETIMPORT R10 7 [0x08130E1D]
      14 [-]: GETTABLE R9 R10 R6
      15 [-]: NAMECALL R7 R0 K8 [0xF2DEAF69]
      16 [-]: CALL R7 2 1  
      17 [-]: JUMPIFNOT R7 L1
      18 [-]: GETIMPORT R7 10 [0x395409D3]
      19 [-]: GETTABLE R2 R7 R6
      20 [-]: GETIMPORT R7 12 [0x3503B8AC]
      21 [-]: GETTABLE R3 R7 R6
L 1:  22 [-]: FORNLOOP R4 L0
L 2:  23 [-]: GETIMPORT R6 14 [0x7BF93DCE]
      24 [-]: MOVE R7 R2   
      25 [-]: MOVE R8 R3   
      26 [-]: GETIMPORT R9 16 ["ZERO_ROTATION"]
      27 [-]: MOVE R10 R1  
      28 [-]: NAMECALL R4 R0 K17 [0x47901F07]
      29 [-]: CALL R4 6 0  
      30 [-]: GETIMPORT R6 19 [0x03FCE12E]
      31 [-]: MOVE R7 R2   
      32 [-]: MOVE R8 R3   
      33 [-]: GETIMPORT R9 16 ["ZERO_ROTATION"]
      34 [-]: MOVE R10 R1  
...
L 3:  24 [-]: NAMECALL R5 R3 K8 [0x78072CA1]
      25 [-]: CALL R5 1 1  
      26 [-]: GETIMPORT R6 10 [0xF540AA09]
      27 [-]: JUMPIFNOTLT R5 R6 L4
      28 [-]: RETURN R2 1  
L 4:  29 [-]: GETIMPORT R5 1 [0x89326C93]
      30 [-]: GETIMPORT R7 12 [0x7BF93DCE]
      ...
      36 [-]: CALL R5 5 1  
      37 [-]: LENGTH R6 R5 
      38 [-]: GETIMPORT R8 16 [0x6C078E20]
      39 [-]: GETIMPORT R9 1 [0x89326C93]
...
L 5:  45 [-]: GETUPVAL R6 0
      ...
      48 [-]: CALL R6 2 1  
      49 [-]: LENGTH R7 R6 
      50 [-]: GETIMPORT R8 19 [0x1BBED640]
      51 [-]: JUMPIFNOTLE R8 R7 L6
      52 [-]: RETURN R2 1  
L 6:  53 [-]: GETIMPORT R7 1 [0x89326C93]
      54 [-]: GETIMPORT R9 21 ["gLotusNpcAvatarType"]
      55 [-]: NAMECALL R10 R1 K13 [0xD1586535]
      56 [-]: CALL R10 1 1 
      57 [-]: LOADN R11 0  
      58 [-]: GETIMPORT R12 23 [0xFE97161B]
...
; Max Stack Size:  14
      ...
      18 [-]: MOVE R6 R1   
      19 [-]: CALL R5 1 1  
      20 [-]: GETIMPORT R7 10 [0x1BBED640]
      21 [-]: LENGTH R8 R5 
      22 [-]: SUB R6 R7 R8 
      23 [-]: LENGTH R9 R4 
      24 [-]: FASTCALL2 19 R6 R9 L0
      25 [-]: MOVE R8 R6   
      26 [-]: GETIMPORT R7 13 [0xAC1B386A]
      27 [-]: CALL R7 2 1  
L 0:  28 [-]: LOADN R10 1  
      29 [-]: MOVE R8 R7   
      30 [-]: LOADN R9 1   
