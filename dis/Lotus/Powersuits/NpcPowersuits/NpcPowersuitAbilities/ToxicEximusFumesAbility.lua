...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R3 1 [0xD8A1B93C]
       1 [-]: NAMECALL R1 R0 K2 [0xC9F6A7D7]
       2 [-]: CALL R1 2 1  
       3 [-]: GETIMPORT R4 4 [0x1CE1C336]
...
L 2:  19 [-]: JUMPIF R4 L5 
      ...
      21 [-]: CALL R4 1 1  
      22 [-]: JUMPIFNOT R4 L5
      23 [-]: GETIMPORT R5 11 [0xAB161EDC]
      24 [-]: FASTCALL1 62 R5 L3
      25 [-]: GETIMPORT R4 8 [0x7B998233]
      26 [-]: CALL R4 1 1  
L 3:  27 [-]: JUMPIF R4 L4 
      28 [-]: GETIMPORT R6 11 [0xAB161EDC]
...
; Max Stack Size:  15
       ...
       0 [-]: GETIMPORT R4 1 [0xC26EF028]
       1 [-]: GETIMPORT R5 3 ["EMPTY_SYMBOL"]
       2 [-]: JUMPIFEQ R4 R5 L2
       3 [-]: GETIMPORT R6 1 [0xC26EF028]
...
L 1:  22 [-]: GETIMPORT R7 8 [0xA12B9818]
      23 [-]: GETIMPORT R10 12 [0x0ED8B456]
      24 [-]: LOADB R11 0  
      25 [-]: LOADN R12 2  
      26 [-]: LOADN R13 1  
      27 [-]: LOADB R14 1  
      ...
      31 [-]: CALL R5 -1 0 
L 2:  32 [-]: GETIMPORT R4 14 [0x89326C93]
      ...
      37 [-]: CALL R4 1 1  
      38 [-]: LOADN R7 41  
      39 [-]: GETIMPORT R8 18 [0x0469F296]
      40 [-]: LOADK R9 K19 ["Toxic"]
      41 [-]: CALL R8 1 -1 
      42 [-]: NAMECALL R5 R4 K20 [0x31A3964D]
      43 [-]: CALL R5 -1 0 
L 3:  44 [-]: GETIMPORT R6 22 [0x7F711132]
      45 [-]: LOADB R7 0   
      46 [-]: NAMECALL R4 R1 K23 [0x659D451F]
      47 [-]: CALL R4 3 0  
      48 [-]: GETIMPORT R6 25 [0xD8A1B93C]
      49 [-]: GETIMPORT R7 3 ["EMPTY_SYMBOL"]
      50 [-]: GETIMPORT R8 27 ["ZERO_VECTOR"]
      51 [-]: GETIMPORT R9 29 ["ZERO_ROTATION"]
      52 [-]: MOVE R10 R1  
      53 [-]: NAMECALL R4 R1 K30 [0x47901F07]
      54 [-]: CALL R4 6 0  
      55 [-]: GETIMPORT R6 32 [0x1CE1C336]
      56 [-]: GETIMPORT R7 3 ["EMPTY_SYMBOL"]
      57 [-]: GETIMPORT R8 27 ["ZERO_VECTOR"]
      58 [-]: GETIMPORT R9 29 ["ZERO_ROTATION"]
      59 [-]: NAMECALL R4 R1 K30 [0x47901F07]
      60 [-]: CALL R4 5 1  
      61 [-]: MOVE R7 R1   
      62 [-]: NAMECALL R5 R4 K33 [0xA9365339]
      63 [-]: CALL R5 2 0  
      64 [-]: GETIMPORT R7 18 [0x0469F296]
