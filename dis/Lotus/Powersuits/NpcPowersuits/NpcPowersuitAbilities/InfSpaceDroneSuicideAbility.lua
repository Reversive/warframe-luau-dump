...
L 2:  23 [-]: LOADN R5 2   
L 3:  24 [-]: GETIMPORT R6 1 [0x89326C93]
      25 [-]: MOVE R8 R1   
      26 [-]: MOVE R9 R4   
      27 [-]: GETIMPORT R10 11 [0x80130B23]
      28 [-]: GETIMPORT R11 13 [0x92072ED8]
      29 [-]: LOADN R12 20 
      30 [-]: GETIMPORT R13 15 [0x0C212CB3]
      31 [-]: LOADNIL R14  
      32 [-]: MOVE R15 R0  
      33 [-]: GETIMPORT R16 17 [0x5EBB02A2]
      34 [-]: LOADB R17 1  
      35 [-]: LOADB R18 1  
      36 [-]: LOADB R19 0  
      37 [-]: LOADN R20 1  
...
L 0:   3 [-]: LOADN R3 0   
       ...
       5 [-]: GETIMPORT R3 2 [0x67652851]
       6 [-]: CALL R3 0 1  
       7 [-]: SUB R1 R1 R3 
       8 [-]: GETIMPORT R5 4 [0x9BAFFFE3]
       9 [-]: GETIMPORT R6 6 [0xA6D4EAFE]
      10 [-]: MOVE R7 R2   
      11 [-]: DIVK R8 R1 K7 [2]
      12 [-]: CALL R5 3 -1 
      13 [-]: NAMECALL R3 R0 K8 [0x2D9BA74F]
      14 [-]: CALL R3 -1 0 
      15 [-]: GETIMPORT R3 10 [0xCBD666E1]
      16 [-]: LOADN R4 0   
      17 [-]: CALL R3 1 0  
      18 [-]: JUMPBACK L0  
L 1:  19 [-]: RETURN R0 0  
...
L 0:   5 [-]: LOADNIL R1   
       6 [-]: LOADNIL R2   
       7 [-]: GETIMPORT R4 4 [0xA16C548C]
       8 [-]: FASTCALL1 62 R4 L1
       9 [-]: GETIMPORT R3 6 [0x7B998233]
      10 [-]: CALL R3 1 1  
L 1:  11 [-]: JUMPIF R3 L2 
      12 [-]: GETIMPORT R5 4 [0xA16C548C]
...
L 3:  20 [-]: JUMPIF R3 L4 
      ...
      31 [-]: GETIMPORT R5 4 [0xA16C548C]
      32 [-]: MOVE R6 R2   
      33 [-]: GETIMPORT R7 15 ["ZERO_ROTATION"]
      34 [-]: NAMECALL R3 R3 K16 [0x05909209]
      35 [-]: CALL R3 4 0  
L 4:  36 [-]: GETIMPORT R3 1 [0x89326C93]
      37 [-]: GETIMPORT R5 18 [0x56076F52]
      38 [-]: NAMECALL R6 R0 K19 [0xEF8E8F7F]
      39 [-]: CALL R6 1 1  
      40 [-]: GETIMPORT R7 15 ["ZERO_ROTATION"]
