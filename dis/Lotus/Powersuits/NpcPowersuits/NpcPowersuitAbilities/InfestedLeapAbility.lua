...
L 3:  23 [-]: GETTABLEKS R3 R2 K8 ["distanceToTarget"]
      24 [-]: GETIMPORT R4 10 [0x4243A037]
      25 [-]: JUMPIFNOTLT R4 R3 L4
      26 [-]: GETIMPORT R4 12 [0x86F495D5]
...
L 4:  16 [-]: NAMECALL R2 R1 K4 [0x2047CFE7]
      ...
      18 [-]: JUMPIFNOT R2 L5
      19 [-]: RETURN R0 0  
L 5:  20 [-]: GETIMPORT R2 7 [0x733FC736]
      21 [-]: LOADB R3 1   
      22 [-]: CALL R2 1 1  
      23 [-]: GETIMPORT R5 9 [0xFD508727]
      24 [-]: NAMECALL R3 R2 K10 [0x80925B98]
      25 [-]: CALL R3 2 0  
      26 [-]: GETIMPORT R5 3 [0x6687F6E0]
...
L 0:   4 [-]: JUMPIFNOT R4 L1
       5 [-]: RETURN R0 0  
L 1:   6 [-]: GETIMPORT R6 3 [0x71995A4C]
       7 [-]: LOADB R7 0   
       8 [-]: LOADN R8 3   
       9 [-]: LOADN R9 3   
      10 [-]: LOADB R10 1  
...
L 5:  33 [-]: JUMPIFNOT R4 L6
      34 [-]: RETURN R0 0  
L 6:  35 [-]: GETIMPORT R6 9 [0x520E413D]
      36 [-]: LOADB R7 0   
      37 [-]: LOADN R8 0   
      38 [-]: LOADB R9 0   
...
L10:  63 [-]: NAMECALL R4 R1 K12 [0xF6EBD926]
      ...
      90 [-]: CALL R7 6 0  
      91 [-]: RETURN R0 0  
L11:  92 [-]: GETIMPORT R7 6 [0xCBD666E1]
      93 [-]: LOADN R8 0   
      94 [-]: CALL R7 1 0  
      95 [-]: JUMPBACK L7  
...
L15: 106 [-]: RETURN R0 0  
L16: 107 [-]: GETIMPORT R4 21 [0xA421AF95]
     108 [-]: CALL R4 0 1  
     109 [-]: NAMECALL R5 R2 K12 [0xF6EBD926]
     110 [-]: CALL R5 1 1  
     111 [-]: GETIMPORT R6 23 [0x89326C93]
     ...
     121 [-]: GETIMPORT R6 27 [0x03EA2485]
     122 [-]: MOVE R7 R4   
     123 [-]: MOVE R8 R5   
     124 [-]: CALL R6 2 1  
...
L17: 135 [-]: NAMECALL R8 R2 K12 [0xF6EBD926]
     ...
     139 [-]: CALL R6 3 0  
     140 [-]: GETIMPORT R8 31 [0xA0FD95DF]
     141 [-]: LOADB R9 0   
     142 [-]: LOADN R10 3  
     143 [-]: LOADN R11 1  
     144 [-]: LOADB R12 1  
     ...
     146 [-]: CALL R6 6 0  
     147 [-]: GETIMPORT R6 23 [0x89326C93]
     ...
     158 [-]: CALL R6 5 0  
L18: 159 [-]: GETIMPORT R6 6 [0xCBD666E1]
     160 [-]: LOADN R7 0   
     161 [-]: CALL R6 1 0  
     162 [-]: FASTCALL1 62 R1 L19
     163 [-]: MOVE R7 R1   
     164 [-]: GETIMPORT R6 1 [0x7B998233]
     165 [-]: CALL R6 1 1  
...
L20: 168 [-]: NAMECALL R6 R1 K35 [0x0F82DD11]
     ...
     174 [-]: CALL R8 2 1  
     175 [-]: GETIMPORT R10 38 [0x0E2842F0]
     176 [-]: MUL R9 R6 R10
     177 [-]: ADD R7 R8 R9 
L21: 178 [-]: FASTCALL1 62 R1 L22
     179 [-]: MOVE R9 R1   
     180 [-]: GETIMPORT R8 1 [0x7B998233]
     181 [-]: CALL R8 1 1  
L22: 182 [-]: JUMPIF R8 L23
     183 [-]: GETIMPORT R10 31 [0xA0FD95DF]
     184 [-]: NAMECALL R8 R1 K7 [0x22EB4BBC]
     185 [-]: CALL R8 2 1  
     186 [-]: JUMPIFNOT R8 L23
     187 [-]: GETIMPORT R8 6 [0xCBD666E1]
     188 [-]: LOADN R9 0   
     189 [-]: CALL R8 1 0  
     190 [-]: JUMPBACK L21 
...
L25: 197 [-]: NAMECALL R8 R1 K39 [0x808B79E6]
     198 [-]: CALL R8 1 1  
     199 [-]: GETIMPORT R9 23 [0x89326C93]
     200 [-]: MOVE R11 R8  
     ...
     208 [-]: MOVE R14 R9  
     209 [-]: GETIMPORT R13 1 [0x7B998233]
     210 [-]: CALL R13 1 1 
...
L28: 219 [-]: JUMPIF R13 L43
     220 [-]: GETIMPORT R15 31 [0xA0FD95DF]
     221 [-]: NAMECALL R13 R1 K11 [0x16E0B3DA]
     222 [-]: CALL R13 2 1 
     223 [-]: JUMPIFNOT R13 L43
     224 [-]: GETIMPORT R13 23 [0x89326C93]
     ...
     233 [-]: CALL R14 2 1 
     234 [-]: GETIMPORT R16 38 [0x0E2842F0]
     235 [-]: MUL R15 R6 R16
     236 [-]: ADD R13 R14 R15
     237 [-]: LOADNIL R14  
     238 [-]: SUB R15 R13 R7
L29: 239 [-]: GETIMPORT R16 42 [0xC0DA2B81]
     240 [-]: GETIMPORT R17 44 ["ZERO_VECTOR"]
     241 [-]: MOVE R18 R15 
     242 [-]: CALL R16 2 1 
     243 [-]: GETIMPORT R18 46 [0xF5234725]
     244 [-]: GETIMPORT R19 46 [0xF5234725]
     245 [-]: MUL R17 R18 R19
...
L32: 260 [-]: GETIMPORT R20 50 [0x9C1F3B5A]
     261 [-]: MOVE R21 R9  
     262 [-]: MOVE R22 R18 
     263 [-]: CALL R20 2 0 
     264 [-]: JUMP L40
...
L34: 280 [-]: GETIMPORT R21 50 [0x9C1F3B5A]
     281 [-]: MOVE R22 R9  
     282 [-]: MOVE R23 R18 
     283 [-]: CALL R21 2 0 
     284 [-]: JUMP L40
    
L35: 285 [-]: GETIMPORT R21 27 [0x03EA2485]
     286 [-]: LOADN R24 0  
     287 [-]: NAMECALL R22 R20 K36 [0xA36FA4E8]
     288 [-]: CALL R22 2 1 
     289 [-]: MOVE R23 R7  
     290 [-]: CALL R21 2 1 
     291 [-]: GETIMPORT R22 46 [0xF5234725]
     292 [-]: JUMPIFNOTLE R21 R22 L40
     293 [-]: JUMPXEQKNIL R10 L38 NOT
     294 [-]: GETIMPORT R21 56 [0x35C16153]
     295 [-]: CALL R21 0 1 
     296 [-]: MOVE R10 R21 
     297 [-]: GETIMPORT R21 58 [0xBE190284]
     298 [-]: GETIMPORT R23 60 [0xF2F9EC30]
     299 [-]: LOADN R24 0  
     300 [-]: MOVE R25 R1  
...
L39: 335 [-]: MOVE R23 R10 
     ...
     337 [-]: CALL R21 2 0 
     338 [-]: GETIMPORT R23 75 [0xF8F4B71B]
     339 [-]: LOADB R24 0  
     340 [-]: LOADN R25 0  
     341 [-]: LOADB R26 0  
     ...
     343 [-]: CALL R21 5 0 
     344 [-]: LOADB R12 1  
     345 [-]: GETIMPORT R21 50 [0x9C1F3B5A]
     346 [-]: MOVE R22 R9  
     347 [-]: MOVE R23 R18 
     348 [-]: CALL R21 2 0 
L40: 349 [-]: FORNLOOP R16 L30
L41: 350 [-]: GETIMPORT R16 77 [0xC2892F65]
     351 [-]: MOVE R17 R15 
     352 [-]: CALL R16 1 0 
     353 [-]: GETIMPORT R17 46 [0xF5234725]
     354 [-]: MUL R16 R15 R17
     355 [-]: ADD R7 R7 R16
     356 [-]: SUB R15 R13 R7
     357 [-]: JUMPBACK L29 
L42: 358 [-]: GETIMPORT R13 6 [0xCBD666E1]
     359 [-]: LOADN R14 0  
     360 [-]: CALL R13 1 0 
     361 [-]: JUMPBACK L27 
L43: 362 [-]: FASTCALL1 62 R1 L44
     363 [-]: MOVE R14 R1  
     364 [-]: GETIMPORT R13 1 [0x7B998233]
     365 [-]: CALL R13 1 1 
L44: 366 [-]: JUMPIFNOT R13 L45
     367 [-]: RETURN R0 0  
L45: 368 [-]: GETIMPORT R15 79 [0x91E0D2B4]
     369 [-]: LOADB R16 1  
     370 [-]: LOADN R17 2  
     371 [-]: LOADN R18 1  
     372 [-]: LOADB R19 1  
     ...
     374 [-]: CALL R13 6 0 
     375 [-]: GETIMPORT R13 81 [0x8D72004B]
