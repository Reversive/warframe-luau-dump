...
; Max Stack Size:  6
      ...
      14 [-]: CAPTURE VAL R2; 
      15 [-]: SETGLOBAL R3 K12; "NpcEvaluateAbility" = var3
      16 [-]: DUPCLOSURE R3 K13; 
      17 [-]: CAPTURE VAL R0; 
      18 [-]: CAPTURE VAL R1; 
      19 [-]: SETGLOBAL R3 K14; "ActivateAbility" = var3
      20 [-]: DUPCLOSURE R3 K15; 
      21 [-]: SETGLOBAL R3 K16; "DeactivateAbility" = var3
      22 [-]: RETURN R0 0  ; 
...
L 0:  14 [-]: JUMPIF R6 L1 ; goto L1 if var6
      ...
      24 [-]: JUMPIFNOTEQ R6 R7 L1; goto L1 if var6 ~= var1594164764
      25 [-]: GETTABLEKS R6 R5 K12; var6 = var5["distanceToTarget"]
      26 [-]: GETIMPORT R7 4; var7 = 0xB7CBD06B
      27 [-]: JUMPIFNOTLE R7 R6 L2; goto L2 if var7 > var1607
...
L 2:  30 [-]: NAMECALL R6 R1 K13; var7 = var1; var6 = var1[0x2EC61863]
      ...
      40 [-]: GETTABLEKS R11 R7 K17; var11 = var7["heading"]
      41 [-]: GETTABLEKS R12 R6 K17; var12 = var6["heading"]
      42 [-]: CALL R10 3 0 ; var10, ... = var10(var11, var12)
      43 [-]: FASTCALL 2 L3; 
      44 [-]: GETIMPORT R9 20; var9 = 0x5BCED4C4[0xE4A5B3CA]
      45 [-]: CALL R9 0 2  ; var9 = var9(var10, ...)
L 3:  46 [-]: LOADN R10 45 ; var10 = 45
      47 [-]: JUMPIFLE R9 R10 L4; goto L4 if var9 <= var16779291
      48 [-]: LOADB R8 0 +1; var8 = false
L 4:  49 [-]: LOADB R8 1   ; var8 = true
L 5:  50 [-]: GETTABLEKS R11 R5 K7; var11 = var5["avatar"]
      51 [-]: NAMECALL R9 R0 K21; var10 = var0; var9 = var0[0x48D05257]
      52 [-]: CALL R9 3 1  ; var9(var10, var11)
      53 [-]: JUMPIFNOT R8 L6; goto L6 if not var8
      54 [-]: LOADN R9 1   ; var9 = 1
      55 [-]: RETURN R9 1  ; 
L 6:  56 [-]: LOADK R9 K22 ; var9 = 0.5
      57 [-]: RETURN R9 1  ; 
...
L 4:  22 [-]: JUMPIF R6 L5 ; goto L5 if var6
      ...
      28 [-]: LOADK R13 K11; var13 = 0.59999999999999998
...
L 5:  35 [-]: NAMECALL R6 R2 K15; var7 = var2; var6 = var2[0x9BA17154]
      ...
      39 [-]: MULK R8 R7 K17; var8 = var7 * 0.20000000000000001
...
L10: 108 [-]: GETIMPORT R13 40; var13 = 0xCC79FF20
     ...
     146 [-]: LOADK R17 K17; var17 = 0.20000000000000001
     147 [-]: LOADK R18 K17; var18 = 0.20000000000000001
     ...
     162 [-]: DIVK R23 R24 K62; var23 = var24 / 2
     ...
     177 [-]: JUMPIFNOTEQ R16 R17 L11; goto L11 if var16 ~= var1158550019
...
L15: 197 [-]: GETIMPORT R16 75; var16 = 0xE15169D2
     198 [-]: JUMPIFNOTLT R15 R16 L18; goto L18 if var15 >= var50413131
...
L16: 203 [-]: JUMPIF R16 L18; goto L18 if var16
     ...
     229 [-]: LOADK R17 K17; var17 = 0.20000000000000001
     230 [-]: LOADK R18 K17; var18 = 0.20000000000000001
     ...
     243 [-]: DIVK R22 R23 K62; var22 = var23 / 2
