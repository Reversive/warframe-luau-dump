...
L 2:  36 [-]: JUMPIF R5 L3 ; goto L3 if var5
      ...
      44 [-]: JUMPIFNOTLE R6 R5 L3; goto L3 if var6 > var1594033436
      45 [-]: GETTABLEKS R5 R3 K17; var5 = var3["distanceToTarget"]
      46 [-]: GETIMPORT R6 21; var6 = 0x443A8D0B
      47 [-]: JUMPIFNOTLT R5 R6 L3; goto L3 if var5 >= var1661142812
...
L 6:  79 [-]: GETGLOBAL R13 K25; var13 = 0x0A62B2CE
      80 [-]: JUMPIFNOTLT R10 R13 L7; goto L7 if var10 >= var-838858174
...
L 8:  90 [-]: JUMPIFNOTLT R13 R16 L18; goto L18 if var13 >= var1905998
      ...
      97 [-]: LOADK R20 K34; var20 = 0.14999999999999999
...
L 9:  99 [-]: GETIMPORT R21 36; var21 = 0xE33017F9
     ...
     103 [-]: SUBK R20 R21 K38; var20 = var21 - 2.2000000000000002
     ...
     115 [-]: ADDK R21 R22 K45; var21 = var22 + 1.7
     ...
     129 [-]: JUMPIFNOTLT R14 R11 L11; goto L11 if var14 >= var1314572
     130 [-]: JUMPIFNOTLT R15 R12 L11; goto L11 if var15 >= var3479374
     ...
     138 [-]: JUMPIFNOTLE R24 R23 L10; goto L10 if var24 > var3741262
...
L11: 145 [-]: JUMPIFNOTLT R14 R11 L12; goto L12 if var14 >= var331587
     146 [-]: JUMPIFNOTEQ R15 R12 L12; goto L12 if var15 ~= var3937870
     147 [-]: GETIMPORT R22 60; var22 = 0x2C5832C8
     148 [-]: ADDK R14 R14 K58; var14 = var14 + 1
     149 [-]: JUMP L14     ; goto L14
L12: 150 [-]: JUMPIFNOTLT R15 R12 L13; goto L13 if var15 >= var331331
     151 [-]: JUMPIFNOTEQ R14 R11 L13; goto L13 if var14 ~= var3741262
