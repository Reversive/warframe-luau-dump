...
L 3:  12 [-]: MOVE R4 R1   ; var4 = var1
      ...
      19 [-]: JUMPIFNOTLE R3 R2 L4; goto L4 if var3 > var459553
      20 [-]: GETIMPORT R3 7; var3 = 0x86F495D5
      21 [-]: JUMPIFNOTLE R2 R3 L4; goto L4 if var2 > var66310
...
L16: 126 [-]: SUB R11 R4 R8; var11 = var4 - var8
     ...
     137 [-]: JUMPIFNOTLT R11 R12 L17; goto L17 if var11 >= var1409354572
...
L18: 157 [-]: GETIMPORT R14 57; var14 = 0xFD8C7F61
     158 [-]: JUMPIFNOTLT R12 R14 L33; goto L33 if var12 >= var50413629
     159 [-]: FASTCALL1 64 R1 L19; 
...
L25: 195 [-]: MOVE R17 R2  ; var17 = var2
     ...
     202 [-]: JUMPIFNOTLE R16 R15 L26; goto L26 if var16 > var4198433
     203 [-]: GETIMPORT R16 64; var16 = 0x86F495D5
     204 [-]: JUMPIFNOTLE R15 R16 L26; goto L26 if var15 > var69126
...
L30: 264 [-]: JUMPIF R18 L32; goto L32 if var18
     265 [-]: JUMPIFNOTEQ R17 R2 L31; goto L31 if var17 ~= var-234745268
