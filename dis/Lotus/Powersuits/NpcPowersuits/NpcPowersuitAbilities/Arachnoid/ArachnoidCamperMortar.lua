...
L 7:  37 [-]: GETTABLE R9 R4 R8; var9 = var4[var8]
      ...
      44 [-]: JUMPIFNOTLT R11 R12 L9; goto L9 if var11 >= var920654
      45 [-]: GETIMPORT R12 14; var12 = 0x4243A037
      46 [-]: JUMPIFNOTLT R12 R11 L9; goto L9 if var12 >= var1409879109
...
L 8:  55 [-]: LOADN R15 2  ; var15 = 2
      ...
      65 [-]: JUMPIFNOTLT R16 R15 L9; goto L9 if var16 >= var1577249
      66 [-]: DUPTABLE R17 24; 
...
L10:  75 [-]: LENGTH R6 R5 ; var6 = #var5
      ...
      77 [-]: JUMPIFNOTLT R7 R6 L11; goto L11 if var7 >= var1836600
...
L15: 108 [-]: GETIMPORT R12 7; var12 = 0x89326C93
     ...
     117 [-]: JUMPIFNOTLT R12 R10 L16; goto L16 if var12 >= var889785925
     ...
     123 [-]: JUMPIFNOTLE R13 R12 L21; goto L21 if var13 > var593430
...
L16: 133 [-]: GETIMPORT R12 42; var12 = _T["CamperFiringTarget"]
     134 [-]: JUMPIFNOTEQ R12 R9 L20; goto L20 if var12 ~= var2886990
...
L18: 144 [-]: JUMPIF R12 L20; goto L20 if var12
     ...
     150 [-]: JUMPIFNOTLT R12 R13 L19; goto L19 if var12 >= var593430
...
L20: 163 [-]: GETIMPORT R12 14; var12 = 0x4243A037
     164 [-]: JUMPIFNOTLT R12 R10 L21; goto L21 if var12 >= var593430
...
; Max Stack Size:  22
       ...
       1 [-]: GETIMPORT R8 3; var8 = 0x59A1DC7F
       2 [-]: CALL R7 2 2  ; var7 = var7(var8)
       3 [-]: GETIMPORT R10 5; var10 = 0x3F87ED3B
       4 [-]: LOADB R11 0  ; var11 = false
       5 [-]: LOADN R12 2  ; var12 = 2
       6 [-]: LOADN R13 1  ; var13 = 1
       7 [-]: LOADB R14 1  ; var14 = true
       8 [-]: NAMECALL R8 R1 K6; var9 = var1; var8 = var1[0x7027C544]
       9 [-]: CALL R8 7 0  ; var8, ... = var8(var9, var10, var11, var12, var13, var14)
      10 [-]: NAMECALL R5 R1 K7; var6 = var1; var5 = var1[0x21B4C60E]
...
L 0:  17 [-]: JUMPIFNOT R6 L2; goto L2 if not var6
      18 [-]: GETIMPORT R7 12; var7 = _T["CamperFiringPos"]
      19 [-]: FASTCALL1 62 R7 L1; 
      20 [-]: GETIMPORT R6 9; var6 = 0x7B998233
      21 [-]: CALL R6 2 2  ; var6 = var6(var7)
L 1:  22 [-]: JUMPIF R6 L2 ; goto L2 if var6
      23 [-]: GETIMPORT R5 12; var5 = _T["CamperFiringPos"]
L 2:  24 [-]: GETIMPORT R6 14; var6 = 0xA421AF95
      25 [-]: CALL R6 1 2  ; var6 = var6()
      26 [-]: GETIMPORT R7 16; var7 = 0x89326C93
      27 [-]: GETIMPORT R9 14; var9 = 0xA421AF95
      28 [-]: GETTABLEKS R10 R5 K17; var10 = var5["x"]
      29 [-]: GETTABLEKS R12 R5 K19; var12 = var5["y"]
      30 [-]: ADDK R11 R12 K18; var11 = var12 + 20
      31 [-]: GETTABLEKS R12 R5 K20; var12 = var5["z"]
      32 [-]: CALL R9 4 2  ; var9 = var9(var10, var11, var12)
      33 [-]: GETIMPORT R10 14; var10 = 0xA421AF95
      34 [-]: GETTABLEKS R11 R5 K17; var11 = var5["x"]
      35 [-]: GETTABLEKS R13 R5 K19; var13 = var5["y"]
      36 [-]: SUBK R12 R13 K21; var12 = var13 - 1000
      37 [-]: GETTABLEKS R13 R5 K20; var13 = var5["z"]
      ...
      43 [-]: NAMECALL R7 R7 K22; var8 = var7; var7 = var7[0xBD5D0EC1]
      44 [-]: CALL R7 8 2  ; var7 = var7(var8, var9, var10, var11, var12, var13, var14)
      45 [-]: JUMPIFNOT R7 L3; goto L3 if not var7
      46 [-]: MOVE R5 R6   ; var5 = var6
L 3:  47 [-]: MOVE R9 R5   ; var9 = var5
      48 [-]: NAMECALL R7 R1 K23; var8 = var1; var7 = var1[0x1F420A3A]
      49 [-]: CALL R7 3 2  ; var7 = var7(var8, var9)
      50 [-]: GETIMPORT R8 25; var8 = 0x00046924
      51 [-]: CALL R8 1 2  ; var8 = var8()
      52 [-]: GETIMPORT R9 26; var9 = _T
      53 [-]: GETIMPORT R10 28; var10 = 0x55156FF7
      54 [-]: CALL R10 1 2 ; var10 = var10()
      55 [-]: SETTABLEKS R10 R9 K29; var10["CamperFiringPosValidTime"] = var9
      56 [-]: GETIMPORT R9 26; var9 = _T
      57 [-]: SETTABLEKS R5 R9 K11; var5["CamperFiringPos"] = var9
      58 [-]: GETIMPORT R9 26; var9 = _T
      59 [-]: SETTABLEKS R2 R9 K30; var2["CamperFiringTarget"] = var9
      60 [-]: LOADN R11 1  ; var11 = 1
      61 [-]: GETIMPORT R9 32; var9 = 0x95061336
      62 [-]: LOADN R10 1  ; var10 = 1
      63 [-]: FORNPREP R9 L17; nforprep start - [escape at L17] -- var9 = iterator
L 4:  64 [-]: FASTCALL1 62 R1 L5; 
      65 [-]: MOVE R13 R1  ; var13 = var1
      66 [-]: GETIMPORT R12 9; var12 = 0x7B998233
      67 [-]: CALL R12 2 2 ; var12 = var12(var13)
L 5:  68 [-]: JUMPIFNOT R12 L6; goto L6 if not var12
      69 [-]: RETURN R0 0  ; 
L 6:  70 [-]: GETIMPORT R13 34; var13 = _T["CamperFireBone"]
      71 [-]: FASTCALL1 62 R13 L7; 
      72 [-]: GETIMPORT R12 9; var12 = 0x7B998233
      73 [-]: CALL R12 2 2 ; var12 = var12(var13)
L 7:  74 [-]: JUMPIFNOT R12 L8; goto L8 if not var12
      75 [-]: GETIMPORT R12 26; var12 = _T
      76 [-]: LOADN R13 1  ; var13 = 1
      77 [-]: SETTABLEKS R13 R12 K33; var13["CamperFireBone"] = var12
L 8:  78 [-]: GETIMPORT R13 36; var13 = 0x0DB4FB35
      79 [-]: LENGTH R12 R13; var12 = #var13
      80 [-]: LOADN R13 1  ; var13 = 1
      81 [-]: JUMPIFNOTLT R13 R12 L9; goto L9 if var13 >= var1707086
      82 [-]: GETIMPORT R12 26; var12 = _T
      83 [-]: GETIMPORT R15 34; var15 = _T["CamperFireBone"]
      84 [-]: GETIMPORT R17 36; var17 = 0x0DB4FB35
      85 [-]: LENGTH R16 R17; var16 = #var17
      86 [-]: MOD R14 R15 R16; var14 = var15 var16
      87 [-]: ADDK R13 R14 K37; var13 = var14 + 1
      88 [-]: SETTABLEKS R13 R12 K33; var13["CamperFireBone"] = var12
L 9:  89 [-]: GETIMPORT R15 36; var15 = 0x0DB4FB35
      90 [-]: GETIMPORT R16 34; var16 = _T["CamperFireBone"]
      91 [-]: GETTABLE R14 R15 R16; var14 = var15[var16]
      92 [-]: NAMECALL R12 R1 K38; var13 = var1; var12 = var1[0x003C792F]
      93 [-]: CALL R12 3 2 ; var12 = var12(var13, var14)
      94 [-]: GETIMPORT R13 40; var13 = 0x4168FF63
      95 [-]: JUMPIFNOTLT R13 R7 L11; goto L11 if var13 >= var2755918
      96 [-]: GETIMPORT R13 42; var13 = 0x20B7F774
      97 [-]: MOVE R14 R12 ; var14 = var12
      98 [-]: MOVE R15 R5  ; var15 = var5
      99 [-]: CALL R13 3 2 ; var13 = var13(var14, var15)
     100 [-]: MOVE R8 R13  ; var8 = var13
     101 [-]: GETTABLEKS R15 R8 K43; var15 = var8["pitch"]
     102 [-]: MINUS R14 R15; 
     103 [-]: FASTCALL2K 18 R14 K44 L10; 
     104 [-]: LOADK R15 K44; var15 = 45
     105 [-]: GETIMPORT R13 47; var13 = 0x5BCED4C4[0xB62ECFE0]
     106 [-]: CALL R13 3 2 ; var13 = var13(var14, var15)
L10: 107 [-]: SETTABLEKS R13 R8 K43; var13["pitch"] = var8
     108 [-]: JUMP L12     ; goto L12
L11: 109 [-]: GETIMPORT R13 50; var13 = 0x34291F5C[0xD96DCC3B]
     110 [-]: MOVE R14 R12 ; var14 = var12
     111 [-]: MOVE R15 R5  ; var15 = var5
     112 [-]: GETIMPORT R16 52; var16 = 0x1D0FD8FD
     113 [-]: LOADB R17 0  ; var17 = false
     114 [-]: CALL R13 5 2 ; var13 = var13(var14, var15, var16, var17)
     115 [-]: MOVE R8 R13  ; var8 = var13
L12: 116 [-]: GETIMPORT R13 16; var13 = 0x89326C93
     117 [-]: GETIMPORT R15 54; var15 = 0x526825AD
     118 [-]: MOVE R16 R12 ; var16 = var12
     119 [-]: MOVE R17 R8  ; var17 = var8
     120 [-]: MOVE R18 R1  ; var18 = var1
     121 [-]: NAMECALL R13 R13 K55; var14 = var13; var13 = var13[0x05909209]
     122 [-]: CALL R13 6 1 ; var13(var14, var15, var16, var17, var18)
     123 [-]: GETIMPORT R13 16; var13 = 0x89326C93
     124 [-]: GETIMPORT R15 52; var15 = 0x1D0FD8FD
     125 [-]: MOVE R16 R12 ; var16 = var12
     126 [-]: MOVE R17 R8  ; var17 = var8
     127 [-]: MOVE R18 R1  ; var18 = var1
     128 [-]: NAMECALL R13 R13 K55; var14 = var13; var13 = var13[0x05909209]
     129 [-]: CALL R13 6 2 ; var13 = var13(var14, var15, var16, var17, var18)
     130 [-]: FASTCALL1 62 R13 L13; 
     131 [-]: MOVE R15 R13 ; var15 = var13
     132 [-]: GETIMPORT R14 9; var14 = 0x7B998233
     133 [-]: CALL R14 2 2 ; var14 = var14(var15)
L13: 134 [-]: JUMPIFNOT R14 L14; goto L14 if not var14
     135 [-]: RETURN R0 0  ; 
L14: 136 [-]: MOVE R16 R1  ; var16 = var1
     137 [-]: NAMECALL R14 R13 K56; var15 = var13; var14 = var13[0x263A3CC2]
     138 [-]: CALL R14 3 1 ; var14(var15, var16)
     139 [-]: MOVE R16 R0  ; var16 = var0
     140 [-]: NAMECALL R14 R13 K57; var15 = var13; var14 = var13[0xFE447379]
     141 [-]: CALL R14 3 1 ; var14(var15, var16)
     142 [-]: MOVE R16 R1  ; var16 = var1
     143 [-]: NAMECALL R14 R13 K58; var15 = var13; var14 = var13[0x89A5A28D]
     144 [-]: CALL R14 3 1 ; var14(var15, var16)
     145 [-]: NAMECALL R16 R1 K59; var17 = var1; var16 = var1[0x13FE5C2E]
     146 [-]: CALL R16 2 0 ; var16, ... = var16(var17)
     147 [-]: NAMECALL R14 R13 K60; var15 = var13; var14 = var13[0xA5A2E4AA]
     148 [-]: CALL R14 0 1 ; var14(var15, ...)
     149 [-]: GETIMPORT R14 40; var14 = 0x4168FF63
     150 [-]: JUMPIFNOTLT R14 R7 L15; goto L15 if var14 >= var331798
     151 [-]: MOVE R16 R5  ; var16 = var5
     152 [-]: GETTABLEKS R17 R8 K43; var17 = var8["pitch"]
     153 [-]: NAMECALL R14 R13 K61; var15 = var13; var14 = var13[0xFB8735AB]
     154 [-]: CALL R14 4 1 ; var14(var15, var16, var17)
L15: 155 [-]: MOVE R14 R5  ; var14 = var5
     156 [-]: GETTABLEKS R16 R14 K19; var16 = var14["y"]
     157 [-]: ADDK R15 R16 K37; var15 = var16 + 1
     158 [-]: SETTABLEKS R15 R14 K19; var15["y"] = var14
     159 [-]: GETIMPORT R15 16; var15 = 0x89326C93
     160 [-]: GETIMPORT R17 63; var17 = 0x8313B758
     161 [-]: MOVE R18 R14 ; var18 = var14
     162 [-]: GETIMPORT R19 65; var19 = ZERO_ROTATION
     163 [-]: MOVE R20 R13 ; var20 = var13
     164 [-]: MOVE R21 R13 ; var21 = var13
     165 [-]: NAMECALL R15 R15 K55; var16 = var15; var15 = var15[0x05909209]
     166 [-]: CALL R15 7 1 ; var15(var16, var17, var18, var19, var20, var21)
     167 [-]: GETIMPORT R15 32; var15 = 0x95061336
     168 [-]: JUMPIFNOTLT R11 R15 L16; goto L16 if var11 >= var4394830
     169 [-]: GETIMPORT R15 67; var15 = 0xCBD666E1
     170 [-]: GETIMPORT R16 69; var16 = 0xFADC8C37
     171 [-]: CALL R15 2 1 ; var15(var16)
L16: 172 [-]: FORNLOOP R9 L4; nforloop end - iterate + goto L4
L17: 173 [-]: RETURN R0 0  ; 
