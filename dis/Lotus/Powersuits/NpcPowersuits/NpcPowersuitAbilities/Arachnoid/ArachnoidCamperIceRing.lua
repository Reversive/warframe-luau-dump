...
L 7:  48 [-]: JUMPIF R9 L8 
      ...
      51 [-]: GETIMPORT R10 13 [0x443A8D0B]
...
L 1:  10 [-]: GETIMPORT R6 7 [0xBA6EAE3D]
      ...
      22 [-]: CALL R4 -1 1 
      23 [-]: GETIMPORT R7 15 [0xCC79FF20]
      24 [-]: GETIMPORT R10 17 [0xB010A310]
      25 [-]: LOADB R11 0  
      26 [-]: LOADN R12 2  
      27 [-]: LOADN R13 1  
      28 [-]: LOADB R14 1  
...
L 2:  37 [-]: JUMPIFNOT R5 L3
      38 [-]: RETURN R0 0  
L 3:  39 [-]: GETIMPORT R7 21 [0x17517254]
      40 [-]: LOADB R8 0   
      41 [-]: NAMECALL R5 R1 K8 [0x659D451F]
      42 [-]: CALL R5 3 0  
      43 [-]: GETIMPORT R7 23 [0xA066148F]
      44 [-]: GETUPVAL R8 0
      45 [-]: GETIMPORT R9 12 [0xA421AF95]
      46 [-]: LOADN R10 0  
      47 [-]: LOADN R11 -1 
      48 [-]: LOADN R12 0  
      49 [-]: CALL R9 3 -1 
      ...
      51 [-]: CALL R5 -1 0 
      52 [-]: GETIMPORT R5 25 [0x91D85E5F]
      53 [-]: NAMECALL R6 R1 K26 [0xC45C884B]
      54 [-]: CALL R6 1 1  
      55 [-]: GETIMPORT R8 28 [0x661D93DF]
      56 [-]: MUL R7 R6 R8 
      57 [-]: GETIMPORT R8 25 [0x91D85E5F]
      58 [-]: ADD R5 R7 R8 
      59 [-]: LOADN R7 0   
...
L 5:  66 [-]: NAMECALL R8 R1 K30 [0xF6EBD926]
      67 [-]: CALL R8 1 1  
      68 [-]: GETIMPORT R9 32 [0x89326C93]
      69 [-]: MOVE R11 R1  
      70 [-]: MOVE R12 R8  
      71 [-]: MOVE R13 R5  
      72 [-]: GETIMPORT R14 34 [0x1440942F]
      73 [-]: LOADN R15 200
      74 [-]: LOADN R16 0  
      75 [-]: LOADNIL R17  
      76 [-]: MOVE R18 R0  
      ...
      86 [-]: CALL R9 17 0 
      87 [-]: GETIMPORT R9 37 [0x00046924]
      88 [-]: CALL R9 0 1  
      89 [-]: NAMECALL R11 R1 K38 [0xD1586535]
      90 [-]: CALL R11 1 1 
      91 [-]: GETIMPORT R12 40 [0x492C7F2A]
      92 [-]: GETIMPORT R13 12 [0xA421AF95]
      93 [-]: LOADN R14 0  
      94 [-]: LOADN R15 0  
      95 [-]: GETIMPORT R16 42 [0x95699D60]
      96 [-]: CALL R13 3 1 
      97 [-]: MOVE R14 R9  
      98 [-]: CALL R12 2 1 
      99 [-]: ADD R10 R11 R12
...
L 6: 104 [-]: MULK R14 R13 K43 [9]
     ...
     106 [-]: GETIMPORT R14 40 [0x492C7F2A]
     107 [-]: GETIMPORT R15 12 [0xA421AF95]
     108 [-]: LOADN R16 0  
     109 [-]: LOADN R17 0  
     110 [-]: GETIMPORT R18 42 [0x95699D60]
     111 [-]: CALL R15 3 1 
     112 [-]: MOVE R16 R9  
     113 [-]: CALL R14 2 1 
     114 [-]: ADD R10 R8 R14
     115 [-]: GETIMPORT R14 12 [0xA421AF95]
     116 [-]: CALL R14 0 1 
     117 [-]: GETIMPORT R15 32 [0x89326C93]
     118 [-]: GETIMPORT R17 12 [0xA421AF95]
     119 [-]: GETTABLEKS R18 R10 K45 ["x"]
     120 [-]: GETTABLEKS R20 R10 K47 ["y"]
     121 [-]: ADDK R19 R20 K46 [30]
     122 [-]: GETTABLEKS R20 R10 K48 ["z"]
     123 [-]: CALL R17 3 1 
     124 [-]: GETIMPORT R18 12 [0xA421AF95]
     ...
     137 [-]: MOVE R10 R14 
     138 [-]: GETIMPORT R15 52 [0x20B7F774]
     139 [-]: MOVE R16 R10 
     140 [-]: MOVE R17 R8  
     141 [-]: CALL R15 2 1 
     142 [-]: GETIMPORT R16 32 [0x89326C93]
     143 [-]: GETIMPORT R19 54 [0x0FBB935C]
     144 [-]: GETIMPORT R20 56 [0x0C5E62F9]
     145 [-]: LOADN R21 1  
     146 [-]: GETIMPORT R23 54 [0x0FBB935C]
     147 [-]: LENGTH R22 R23
     148 [-]: CALL R20 2 1 
     149 [-]: GETTABLE R18 R19 R20
     150 [-]: MOVE R19 R10 
     151 [-]: GETIMPORT R20 37 [0x00046924]
