...
L 1:  23 [-]: GETTABLE R11 R7 R10
      ...
      29 [-]: GETIMPORT R12 8 [0x86F495D5]
      30 [-]: JUMPIFNOTLE R11 R12 L2
      31 [-]: LOADN R14 1  
      32 [-]: GETIMPORT R16 8 [0x86F495D5]
      33 [-]: DIV R15 R11 R16
      34 [-]: SUB R13 R14 R15
      35 [-]: LENGTH R14 R7
      36 [-]: DIV R12 R13 R14
...
L 1:   8 [-]: NAMECALL R3 R1 K2 [0xC45C884B]
       9 [-]: CALL R3 1 1  
      10 [-]: GETIMPORT R6 4 [0x661D93DF]
      11 [-]: MUL R5 R3 R6 
      12 [-]: GETIMPORT R6 6 [0x9B5DDF0B]
      13 [-]: ADD R4 R5 R6 
      14 [-]: GETIMPORT R7 8 [0x17517254]
      15 [-]: LOADB R8 0   
      16 [-]: NAMECALL R5 R1 K9 [0x659D451F]
      17 [-]: CALL R5 3 0  
      18 [-]: GETIMPORT R7 11 [0x0ED8B456]
      19 [-]: LOADB R8 0   
      20 [-]: LOADN R9 2   
      21 [-]: LOADN R10 1  
      22 [-]: LOADB R11 1  
...
L 2:  38 [-]: NAMECALL R10 R6 K16 [0xB87F958D]
      39 [-]: CALL R10 1 1 
      40 [-]: GETIMPORT R11 19 [0x61A71BFB]
      41 [-]: MUL R9 R10 R11
      42 [-]: DIV R10 R9 R5
      43 [-]: LOADN R11 0  
L 3:  44 [-]: JUMPIFNOTLT R11 R5 L5
      ...
      46 [-]: MOVE R13 R6  
      47 [-]: GETIMPORT R12 21 [0x7B998233]
      48 [-]: CALL R12 1 1 
L 4:  49 [-]: JUMPIF R12 L5
      ...
      52 [-]: CALL R12 2 1 
      53 [-]: JUMPIF R12 L5
      54 [-]: GETIMPORT R15 23 [0x67652851]
      55 [-]: CALL R15 0 1 
      56 [-]: MUL R14 R10 R15
      57 [-]: LOADB R15 1  
      58 [-]: NAMECALL R12 R6 K24 [0x60BF5F59]
      59 [-]: CALL R12 3 0 
      60 [-]: GETIMPORT R12 23 [0x67652851]
      61 [-]: CALL R12 0 1 
      62 [-]: ADD R11 R11 R12
      63 [-]: GETIMPORT R12 14 [0xCBD666E1]
      64 [-]: LOADN R13 0  
      65 [-]: CALL R12 1 0 
      66 [-]: JUMPBACK L3  
L 5:  67 [-]: NAMECALL R12 R6 K25 [0xF456C2D7]
      ...
      72 [-]: CALL R12 2 1 
      73 [-]: JUMPIFNOT R12 L7
      74 [-]: GETIMPORT R12 27 [0x89326C93]
      ...
      81 [-]: CALL R12 1 0 
L 6:  82 [-]: RETURN R0 0  
L 7:  83 [-]: GETIMPORT R13 23 [0x67652851]
      84 [-]: CALL R13 0 1 
      85 [-]: NAMECALL R14 R1 K31 [0xFAD0177C]
      86 [-]: CALL R14 1 1 
      87 [-]: MUL R12 R13 R14
      88 [-]: GETIMPORT R15 33 [0xE37E4382]
      89 [-]: LOADB R16 0  
      90 [-]: LOADN R17 2  
      91 [-]: LOADN R18 2  
      92 [-]: LOADB R19 0  
      ...
      94 [-]: CALL R13 6 0 
      95 [-]: GETIMPORT R14 23 [0x67652851]
      96 [-]: CALL R14 0 1 
...
L 8: 106 [-]: GETIMPORT R20 35 [0xFD8C7F61]
     107 [-]: JUMPIFNOTLT R16 R20 L24
     108 [-]: FASTCALL1 62 R1 L9
     109 [-]: MOVE R21 R1  
     110 [-]: GETIMPORT R20 21 [0x7B998233]
     111 [-]: CALL R20 1 1 
L 9: 112 [-]: JUMPIF R20 L24
     ...
     117 [-]: CALL R20 1 1 
     118 [-]: JUMPIF R20 L24
     119 [-]: GETIMPORT R20 14 [0xCBD666E1]
     120 [-]: LOADN R21 0  
     121 [-]: CALL R20 1 0 
     ...
     127 [-]: CALL R20 2 1 
     128 [-]: JUMPIF R20 L24
     129 [-]: GETIMPORT R22 33 [0xE37E4382]
     130 [-]: NAMECALL R20 R1 K37 [0x16E0B3DA]
     131 [-]: CALL R20 2 1 
     132 [-]: JUMPIFNOT R20 L24
     133 [-]: LOADK R20 K38 [0.5]
     134 [-]: JUMPIFNOTLE R20 R17 L14
     135 [-]: GETIMPORT R21 40 [0xD2D9F768]
     136 [-]: LENGTH R20 R21
     137 [-]: JUMPIFNOTLE R18 R20 L13
     138 [-]: GETIMPORT R22 42 [0x78A39459]
     139 [-]: GETIMPORT R24 40 [0xD2D9F768]
     140 [-]: GETTABLE R23 R24 R18
     141 [-]: GETIMPORT R24 44 ["ZERO_VECTOR"]
     142 [-]: GETIMPORT R25 46 [0x00046924]
     143 [-]: LOADN R26 0  
     144 [-]: GETIMPORT R28 48 [0xE6BE06D4]
     ...
     151 [-]: MOVE R22 R14 
     152 [-]: MOVE R23 R20 
     153 [-]: GETIMPORT R21 52 [0x23D5322F]
     154 [-]: CALL R21 2 0 
L10: 155 [-]: FASTCALL2K 52 R19 K53 L11 [0]
     156 [-]: MOVE R22 R19 
     157 [-]: LOADK R23 K53 [0]
     158 [-]: GETIMPORT R21 52 [0x23D5322F]
     159 [-]: CALL R21 2 0 
L11: 160 [-]: GETIMPORT R21 27 [0x89326C93]
     161 [-]: NAMECALL R21 R21 K28 [0x18D05D30]
     162 [-]: CALL R21 1 1 
     163 [-]: JUMPIFNOT R21 L13
     164 [-]: GETIMPORT R21 55 [0xA421AF95]
     165 [-]: LOADN R22 1  
     166 [-]: LOADN R23 1  
     ...
     171 [-]: CALL R24 -1 -1
     172 [-]: CALL R21 -1 1
     173 [-]: GETIMPORT R24 59 [0x17DB3A36]
     174 [-]: GETIMPORT R26 40 [0xD2D9F768]
     175 [-]: GETTABLE R25 R26 R18
     176 [-]: GETIMPORT R26 55 [0xA421AF95]
     177 [-]: LOADN R27 0  
     178 [-]: LOADN R28 0  
     179 [-]: GETTABLEKS R30 R21 K60 ["z"]
     180 [-]: DIVK R29 R30 K17 [2]
     181 [-]: CALL R26 3 1 
     182 [-]: GETIMPORT R27 62 ["ZERO_ROTATION"]
     183 [-]: MOVE R28 R1  
...
L12: 200 [-]: MOVE R26 R23 
     ...
     204 [-]: MOVE R25 R15 
     205 [-]: MOVE R26 R22 
     206 [-]: GETIMPORT R24 52 [0x23D5322F]
     207 [-]: CALL R24 2 0 
...
L15: 214 [-]: GETTABLE R24 R19 R22
     215 [-]: GETIMPORT R26 23 [0x67652851]
     216 [-]: CALL R26 0 1 
...
L27: 317 [-]: GETTABLE R24 R14 R22
     ...
     319 [-]: GETIMPORT R23 21 [0x7B998233]
     320 [-]: CALL R23 1 1 
...
L30: 326 [-]: GETIMPORT R22 78 [0x99E0F6D2]
     327 [-]: LOADB R23 1  
     328 [-]: LOADN R24 2  
     329 [-]: LOADN R25 1  
     330 [-]: LOADB R26 0  
     ...
     332 [-]: CALL R20 6 1 
     333 [-]: GETIMPORT R21 14 [0xCBD666E1]
     334 [-]: LOADN R22 1  
     335 [-]: CALL R21 1 0 
     336 [-]: RETURN R0 0  
