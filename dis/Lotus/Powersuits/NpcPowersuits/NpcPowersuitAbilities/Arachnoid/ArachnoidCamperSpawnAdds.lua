...
L 4:  30 [-]: LOADN R5 6   
      31 [-]: LENGTH R6 R4 
      32 [-]: MUL R3 R5 R6 
L 5:  33 [-]: GETIMPORT R5 5 [nil]
      34 [-]: JUMPIFNOTLE R3 R5 L6
      35 [-]: LOADN R5 0   
      36 [-]: RETURN R5 1  
L 6:  37 [-]: GETIMPORT R5 12 [nil]
...
L 3:  71 [-]: JUMPIF R8 L4 
      ...
      81 [-]: GETIMPORT R11 42 [nil]
      82 [-]: ADDK R10 R11 K40 [1]
      83 [-]: SETTABLEKS R10 R9 K41 ["exploiterAddCount"]
L 4:  84 [-]: GETIMPORT R8 44 [nil]
      85 [-]: NAMECALL R6 R1 K45 [0x16E0B3DA]
      86 [-]: CALL R6 2 1  
      87 [-]: JUMPIFNOT R6 L29
      88 [-]: GETIMPORT R6 47 [nil]
      89 [-]: LOADN R7 0   
      90 [-]: CALL R6 1 0  
      91 [-]: JUMPBACK L4  
      92 [-]: RETURN R0 0  
L 5:  93 [-]: GETIMPORT R8 49 [nil]
      94 [-]: GETIMPORT R11 44 [nil]
      95 [-]: LOADB R12 0  
      96 [-]: LOADN R13 2  
      97 [-]: LOADN R14 1  
      98 [-]: LOADB R15 1  
...
L 7: 115 [-]: GETIMPORT R6 56 [nil]
     116 [-]: JUMPXEQKN R6 K57 L8 NOT [0]
     117 [-]: GETUPVAL R7 3
     118 [-]: GETTABLEKS R6 R7 K58 [0x9742B85B]
     119 [-]: GETIMPORT R7 60 [nil]
     120 [-]: GETIMPORT R8 62 [nil]
     121 [-]: LOADK R9 K63 ["SpawnOne"]
     122 [-]: CALL R8 1 -1 
     123 [-]: CALL R6 -1 0 
     124 [-]: JUMP L10
    
L 8: 125 [-]: GETIMPORT R6 56 [nil]
     126 [-]: JUMPXEQKN R6 K40 L9 NOT [1]
     127 [-]: GETUPVAL R7 3
     128 [-]: GETTABLEKS R6 R7 K58 [0x9742B85B]
     129 [-]: GETIMPORT R7 60 [nil]
     130 [-]: GETIMPORT R8 62 [nil]
     131 [-]: LOADK R9 K64 ["SpawnTwo"]
     132 [-]: CALL R8 1 -1 
     133 [-]: CALL R6 -1 0 
     134 [-]: JUMP L10
    
L 9: 135 [-]: GETIMPORT R6 56 [nil]
     136 [-]: JUMPXEQKN R6 K52 L10 NOT [2]
     137 [-]: GETUPVAL R7 3
     138 [-]: GETTABLEKS R6 R7 K58 [0x9742B85B]
     139 [-]: GETIMPORT R7 60 [nil]
     140 [-]: GETIMPORT R8 62 [nil]
     141 [-]: LOADK R9 K65 ["SpawnThree"]
     142 [-]: CALL R8 1 -1 
     143 [-]: CALL R6 -1 0 
L10: 144 [-]: GETIMPORT R7 24 [nil]
     145 [-]: FASTCALL1 62 R7 L11
     146 [-]: GETIMPORT R6 7 [nil]
     147 [-]: CALL R6 1 1  
L11: 148 [-]: JUMPIF R6 L12
     149 [-]: GETIMPORT R8 24 [nil]
     150 [-]: GETUPVAL R9 1
     151 [-]: GETIMPORT R10 26 [nil]
     152 [-]: LOADN R11 0  
     153 [-]: LOADN R12 -1 
     154 [-]: LOADN R13 0  
     155 [-]: CALL R10 3 -1
...
L24: 252 [-]: JUMPXEQKNIL R8 L28
     ...
     254 [-]: GETIMPORT R11 84 [nil]
     255 [-]: MOVE R12 R8  
     256 [-]: GETIMPORT R13 34 [nil]
...
L27: 286 [-]: NAMECALL R11 R1 K29 [0xFA9E477F]
     ...
     290 [-]: CALL R12 2 0 
     291 [-]: GETIMPORT R12 4 [nil]
     292 [-]: GETIMPORT R14 42 [nil]
