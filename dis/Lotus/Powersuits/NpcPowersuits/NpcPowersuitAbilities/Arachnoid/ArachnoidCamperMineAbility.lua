...
; Max Stack Size:  9
       ...
       3 [-]: JUMPIFNOTLT R3 R2 L0; goto L0 if var3 >= var560
       4 [-]: LOADN R2 0   ; var2 = 0
       5 [-]: RETURN R2 1  ; 
...
L 2:  19 [-]: JUMPIF R6 L3 ; goto L3 if var6
      ...
      23 [-]: JUMPIFNOTLE R6 R7 L3; goto L3 if var6 > var67120
...
L 1:  19 [-]: JUMPIF R9 L2 ; goto L2 if var9
      ...
      26 [-]: JUMPIFNOTLE R9 R10 L2; goto L2 if var9 > var84161577
...
L11:  87 [-]: JUMPIF R12 L12; goto L12 if var12
     ...
     105 [-]: JUMPIFEQ R8 R12 L12; goto L12 if var8 == var2493473
...
L 1:  10 [-]: JUMPIF R6 L14; goto L14 if var6
      11 [-]: LOADN R6 1   ; var6 = 1
      12 [-]: JUMPIFNOTLT R6 R4 L11; goto L11 if var6 >= var6160717
...
L11:  83 [-]: JUMPIFNOT R1 L12; goto L12 if not var1
      ...
      85 [-]: JUMPIFNOTLT R5 R6 L12; goto L12 if var5 >= var2360865
...
L12:  96 [-]: JUMPIFNOT R1 L13; goto L13 if not var1
      ...
      98 [-]: JUMPIFNOTLE R6 R5 L13; goto L13 if var6 > var-1073740212
