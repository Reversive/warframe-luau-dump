...
; Max Stack Size:  27
       ...
       0 [-]: GETIMPORT R3 1 [0x86939583]
       1 [-]: NAMECALL R1 R0 K2 [0xF2DEAF69]
       2 [-]: CALL R1 2 1  
       3 [-]: GETIMPORT R4 4 [0xA3BAB5E1]
       4 [-]: NAMECALL R2 R0 K2 [0xF2DEAF69]
       5 [-]: CALL R2 2 1  
       6 [-]: GETIMPORT R3 6 [0x89326C93]
       7 [-]: GETIMPORT R5 8 [0x1DDF0CE8]
       8 [-]: NAMECALL R7 R0 K9 [0xD1586535]
       9 [-]: CALL R7 1 1  
      10 [-]: GETIMPORT R8 11 [0x5F5C3D83]
      11 [-]: ADD R6 R7 R8 
      12 [-]: GETIMPORT R7 13 [0x8F945E66]
      13 [-]: NAMECALL R3 R3 K14 [0x05909209]
      14 [-]: CALL R3 4 0  
      15 [-]: LOADN R4 360 
      16 [-]: GETIMPORT R6 16 [0xE0276800]
      17 [-]: LENGTH R5 R6 
      18 [-]: DIV R3 R4 R5 
      ...
      30 [-]: CALL R7 1 1  
      31 [-]: GETIMPORT R9 16 [0xE0276800]
      32 [-]: LENGTH R8 R9 
      33 [-]: DIV R6 R7 R8 
      34 [-]: GETIMPORT R7 16 [0xE0276800]
      35 [-]: JUMPIFNOT R2 L0
      36 [-]: GETIMPORT R7 24 [0xEA0F6F63]
L 0:  37 [-]: NAMECALL R8 R0 K25 [0x7B0BB351]
      38 [-]: CALL R8 1 1  
      39 [-]: GETIMPORT R9 6 [0x89326C93]
      ...
      44 [-]: CALL R9 1 1  
      45 [-]: LOADNIL R10  
      46 [-]: GETIMPORT R11 29 [0x0469F296]
      47 [-]: LOADK R12 K30 ["RandomTeam"]
      48 [-]: CALL R11 1 1 
      49 [-]: FASTCALL1 62 R9 L1
      50 [-]: MOVE R13 R9  
      51 [-]: GETIMPORT R12 32 [0x7B998233]
      52 [-]: CALL R12 1 1 
...
L 2:  61 [-]: GETIMPORT R12 36 [0x3D106989]
...
L 3:  69 [-]: GETTABLEN R13 R7 1
      ...
      71 [-]: GETIMPORT R12 32 [0x7B998233]
      72 [-]: CALL R12 1 1 
L 4:  73 [-]: JUMPIFNOT R12 L5
      74 [-]: GETIMPORT R12 36 [0x3D106989]
      ...
      81 [-]: CALL R12 1 0 
L 5:  82 [-]: GETIMPORT R14 42 [0xA1958125]
      83 [-]: LOADB R15 0  
      84 [-]: LOADN R16 0  
      85 [-]: LOADB R17 1  
      ...
      90 [-]: LOADN R13 1  
      91 [-]: FORNPREP R12 L25
L 6:  92 [-]: GETIMPORT R15 6 [0x89326C93]
     ...
     113 [-]: MOVE R17 R15 
     114 [-]: GETIMPORT R16 32 [0x7B998233]
     115 [-]: CALL R16 1 1 
L 7: 116 [-]: JUMPIF R16 L24
     117 [-]: GETIMPORT R16 49 ["PauseAI"]
     118 [-]: JUMPIFNOT R16 L8
     119 [-]: LOADB R18 1  
     120 [-]: GETIMPORT R19 29 [0x0469F296]
...
L 9: 131 [-]: JUMPIF R17 L24
     ...
     139 [-]: GETIMPORT R17 56 [0x0B1531BA]
     ...
     150 [-]: MOVE R19 R17 
     151 [-]: GETIMPORT R18 32 [0x7B998233]
     152 [-]: CALL R18 1 1 
...
L11: 158 [-]: NAMECALL R17 R16 K61 [0xDE321E6F]
     ...
     161 [-]: MOVE R19 R17 
     162 [-]: GETIMPORT R18 32 [0x7B998233]
     163 [-]: CALL R18 1 1 
L12: 164 [-]: JUMPIF R18 L18
     ...
     168 [-]: MOVE R20 R18 
     169 [-]: GETIMPORT R19 32 [0x7B998233]
     170 [-]: CALL R19 1 1 
...
L14: 179 [-]: GETTABLE R24 R19 R23
     180 [-]: GETIMPORT R26 65 [0x52D433A4]
...
L18: 195 [-]: NAMECALL R18 R16 K69 [0x020D4331]
     ...
     207 [-]: MOVE R19 R9  
     208 [-]: GETIMPORT R18 32 [0x7B998233]
     209 [-]: CALL R18 1 1 
L19: 210 [-]: JUMPIF R18 L22
     211 [-]: FASTCALL1 62 R15 L20
     212 [-]: MOVE R19 R15 
     213 [-]: GETIMPORT R18 32 [0x7B998233]
     214 [-]: CALL R18 1 1 
L20: 215 [-]: JUMPIF R18 L22
     ...
     222 [-]: MOVE R19 R10 
     223 [-]: GETIMPORT R18 32 [0x7B998233]
     224 [-]: CALL R18 1 1 
...
L22: 229 [-]: FASTCALL1 62 R5 L23
     230 [-]: MOVE R19 R5  
     231 [-]: GETIMPORT R18 32 [0x7B998233]
     232 [-]: CALL R18 1 1 
...
L25: 240 [-]: GETIMPORT R9 82 [0xCF7BFF6F]
     241 [-]: JUMPIFNOT R9 L31
     242 [-]: FASTCALL1 62 R0 L26
     243 [-]: MOVE R10 R0  
     244 [-]: GETIMPORT R9 32 [0x7B998233]
     245 [-]: CALL R9 1 1  
L26: 246 [-]: JUMPIF R9 L31
     247 [-]: FASTCALL1 62 R5 L27
     248 [-]: MOVE R10 R5  
     249 [-]: GETIMPORT R9 32 [0x7B998233]
     250 [-]: CALL R9 1 1  
L27: 251 [-]: JUMPIF R9 L30
     ...
     255 [-]: MOVE R11 R9  
     256 [-]: GETIMPORT R10 32 [0x7B998233]
     257 [-]: CALL R10 1 1 
L28: 258 [-]: JUMPIF R10 L30
     ...
     267 [-]: GETIMPORT R12 87 [0xB62ECFE0]
     268 [-]: CALL R12 2 1 
...
L 4:  25 [-]: JUMPIFNOT R3 L5
      ...
      50 [-]: CALL R6 2 0  
      51 [-]: RETURN R0 0  
L 5:  52 [-]: GETIMPORT R4 18 [0xCBD666E1]
      53 [-]: LOADN R5 0   
      54 [-]: CALL R4 1 0  
      55 [-]: JUMPBACK L0  
L 6:  56 [-]: RETURN R0 0  
