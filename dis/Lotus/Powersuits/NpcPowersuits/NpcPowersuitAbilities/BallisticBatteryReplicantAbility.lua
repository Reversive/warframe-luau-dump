...
; Max Stack Size:  13
 ...
 63 [-]: MOVE      R0 R8        ; R0 := R8
 64 [-]: SETGLOBAL R12 K14      ; DeactivateAbility := R12
 65 [-]: CLOSURE   R12 9        ; R12 := closure(Function #10)
 66 [-]: MOVE      R0 R2        ; R0 := R2
 67 [-]: MOVE      R0 R4        ; R0 := R4
 68 [-]: SETGLOBAL R12 K15      ; ChargedEffects := R12
 69 [-]: CLOSURE   R12 10       ; R12 := closure(Function #11)
 70 [-]: SETGLOBAL R12 K16      ; DecoFade := R12
