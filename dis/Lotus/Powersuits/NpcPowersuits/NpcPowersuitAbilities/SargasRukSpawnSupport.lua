...
L 0:  10 [-]: LOADN R2 0   
      11 [-]: LOADN R5 1   
      12 [-]: GETIMPORT R6 8 [0xA3623295]
      13 [-]: LENGTH R3 R6 
      14 [-]: LOADN R4 1   
      15 [-]: FORNPREP R3 L2
L 1:  16 [-]: GETIMPORT R7 10 [0x89326C93]
      17 [-]: GETIMPORT R10 8 [0xA3623295]
      ...
      26 [-]: ADD R2 R2 R6 
      27 [-]: FORNLOOP R3 L1
L 2:  28 [-]: GETIMPORT R3 14 [0xB78E1C45]
...
L 0:   5 [-]: GETIMPORT R4 1 [0x89326C93]
       6 [-]: GETIMPORT R6 4 ["gCinematicType"]
...
L 3:  24 [-]: GETIMPORT R5 10 [0xCBD666E1]
      25 [-]: GETIMPORT R6 12 [0x1A7DB484]
      26 [-]: CALL R5 1 0  
...
L 6:  43 [-]: JUMPIFNOT R7 L7
      44 [-]: RETURN R0 0  
L 7:  45 [-]: GETIMPORT R7 1 [0x89326C93]
      ...
      52 [-]: MOVE R11 R8  
      53 [-]: GETIMPORT R10 15 [0x7B998233]
      54 [-]: CALL R10 1 1 
L 8:  55 [-]: JUMPIF R10 L9
      56 [-]: NAMECALL R10 R8 K19 [0xC45C884B]
      57 [-]: CALL R10 1 1 
      58 [-]: MOVE R9 R10  
L 9:  59 [-]: GETIMPORT R10 1 [0x89326C93]
      60 [-]: GETIMPORT R12 21 ["gNpcSpawnPointType"]
...
L16: 100 [-]: GETTABLE R18 R10 R17
     ...
     108 [-]: MOVE R19 R11 
     109 [-]: GETIMPORT R18 31 [0x23D5322F]
     110 [-]: CALL R18 2 0 
...
L20: 116 [-]: LOADN R12 0  
     117 [-]: LOADN R15 1  
     118 [-]: GETIMPORT R16 33 [0xA3623295]
     119 [-]: LENGTH R13 R16
     120 [-]: LOADN R14 1  
     121 [-]: FORNPREP R13 L22
L21: 122 [-]: GETIMPORT R17 1 [0x89326C93]
     123 [-]: GETIMPORT R20 33 [0xA3623295]
...
L22: 134 [-]: LOADNIL R13  
     ...
     137 [-]: LOADNIL R16  
     138 [-]: LOADNIL R17  
     139 [-]: GETIMPORT R20 35 [0xEEB4F0E6]
     140 [-]: SUB R19 R20 R12
     141 [-]: LENGTH R21 R7
     ...
     146 [-]: MOVE R21 R18 
     147 [-]: GETIMPORT R19 39 [0xAC1B386A]
     148 [-]: CALL R19 2 1 
L23: 149 [-]: MOVE R18 R19 
     150 [-]: LOADN R19 0  
     151 [-]: NEWTABLE R20 0 0
     152 [-]: LOADN R23 1  
     153 [-]: GETIMPORT R24 41 [0x7179A40E]
     154 [-]: LENGTH R21 R24
     155 [-]: LOADN R22 1  
     156 [-]: FORNPREP R21 L29
L24: 157 [-]: GETIMPORT R25 43 [0x3702DF5C]
     158 [-]: LENGTH R24 R25
...
L29: 175 [-]: LOADN R21 1  
     ...
     178 [-]: MOVE R22 R1  
     179 [-]: GETIMPORT R21 15 [0x7B998233]
     180 [-]: CALL R21 1 1 
...
L31: 186 [-]: GETIMPORT R25 47 [0x3630E649]
     187 [-]: CALL R25 0 1 
     188 [-]: MUL R24 R25 R19
     189 [-]: LOADN R27 1  
     190 [-]: LENGTH R25 R20
...
L34: 198 [-]: GETIMPORT R25 47 [0x3630E649]
     199 [-]: LOADN R26 1  
     200 [-]: LENGTH R27 R11
     201 [-]: CALL R25 2 1 
     202 [-]: MOVE R14 R25 
L35: 203 [-]: JUMPIFNOTEQ R14 R15 L36
     204 [-]: GETIMPORT R25 47 [0x3630E649]
     205 [-]: LOADN R26 1  
     206 [-]: LENGTH R27 R11
     207 [-]: CALL R25 2 1 
     208 [-]: MOVE R14 R25 
     209 [-]: GETIMPORT R25 10 [0xCBD666E1]
     210 [-]: LOADN R26 0  
     211 [-]: CALL R25 1 0 
     212 [-]: JUMPBACK L35 
L36: 213 [-]: GETIMPORT R28 41 [0x7179A40E]
     214 [-]: GETTABLE R27 R28 R13
     215 [-]: GETTABLE R28 R11 R14
     216 [-]: GETIMPORT R29 24 [0x0469F296]
     217 [-]: LOADK R30 K48 ["RandomTeam"]
     218 [-]: CALL R29 1 1 
     219 [-]: LOADN R31 1  
     220 [-]: GETIMPORT R33 50 [0x1F65A0FE]
     221 [-]: MUL R32 R9 R33
     222 [-]: FASTCALL2 18 R31 R32 L37
     223 [-]: GETIMPORT R30 45 [0xB62ECFE0]
     224 [-]: CALL R30 2 -1
L37: 225 [-]: NAMECALL R25 R6 K51 [0x33FC842F]
     226 [-]: CALL R25 -1 1
     227 [-]: MOVE R16 R25 
     228 [-]: GETIMPORT R25 1 [0x89326C93]
     229 [-]: GETIMPORT R27 53 [0xE604A35B]
     230 [-]: GETTABLE R28 R11 R14
     231 [-]: NAMECALL R28 R28 K5 [0xD1586535]
     232 [-]: CALL R28 1 1 
     233 [-]: GETIMPORT R29 55 ["ZERO_ROTATION"]
     ...
     239 [-]: MOVE R26 R16 
     240 [-]: GETIMPORT R25 15 [0x7B998233]
     241 [-]: CALL R25 1 1 
