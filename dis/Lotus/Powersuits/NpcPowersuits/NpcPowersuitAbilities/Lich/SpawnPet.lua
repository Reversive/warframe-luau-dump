...
; Max Stack Size:  16
 ...
 11 [-]: SELF      R4 R1 K3     ; R5 := R1; R4 := R1[0xac99e72c]
 12 [-]: GETUPVAL  R6 U0        ; R6 := U0
 13 [-]: CALL      R4 3 2       ; R4 := R4(R5,R6)
 14 [-]: TEST      R4 0         ; if not R4 then PC := 25
 15 [-]: JMP       25           ; PC := 25
 16 [-]: SELF      R5 R3 K4     ; R6 := R3; R5 := R3[0xdb6046e1]
 17 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 18 [-]: SELF      R6 R1 K5     ; R7 := R1; R6 := R1[0x22a3741f]
 19 [-]: GETUPVAL  R8 U0        ; R8 := U0
 20 [-]: CALL      R6 3 2       ; R6 := R6(R7,R8)
 21 [-]: EQ        0 R6 R5      ; if R6 ~= R5 then PC := 25
 22 [-]: JMP       25           ; PC := 25
 23 [-]: CONST     R7 0         ; R7 := 0.000000
 24 [-]: RETURN    R7 2         ; return R7
 25 [-]: GETGLOBAL R7 K6        ; R7 := 0x89326c93
 26 [-]: SELF      R7 R7 K7     ; R8 := R7; R7 := R7[0xfb669000]
 27 [-]: GETGLOBAL R9 K8        ; R9 := gLotusAvatarType
 28 [-]: CALL      R7 3 2       ; R7 := R7(R8,R9)
 29 [-]: CONST     R8 1         ; R8 := 1.000000
 30 [-]: LEN       R9 R7        ; R9 := # R7
 31 [-]: CONST     R10 1        ; R10 := 1.000000
 32 [-]: FORPREP   R8 51        ; R8 -= R10; PC := 51
 33 [-]: GETGLOBAL R12 K9       ; R12 := 0x7b998233
 34 [-]: GETTABLE  R13 R7 R11   ; R13 := R7[R11]
 35 [-]: CALL      R12 2 2      ; R12 := R12(R13)
 36 [-]: TEST      R12 1        ; if R12 then PC := 51
 37 [-]: JMP       51           ; PC := 51
 38 [-]: GETTABLE  R12 R7 R11   ; R12 := R7[R11]
 39 [-]: SELF      R12 R12 K10  ; R13 := R12; R12 := R12[0xe4b9db64]
 40 [-]: CALL      R12 2 2      ; R12 := R12(R13)
 41 [-]: EQ        0 R12 R1     ; if R12 ~= R1 then PC := 51
 42 [-]: JMP       51           ; PC := 51
 43 [-]: GETGLOBAL R12 K11      ; R12 := 0x6687f6e0
 44 [-]: SELF      R12 R12 K12  ; R13 := R12; R12 := R12[0x80e3597e]
 45 [-]: GETGLOBAL R14 K11      ; R14 := 0x6687f6e0
 46 [-]: SELF      R14 R14 K13  ; R15 := R14; R14 := R14[0x2a0a08df]
 47 [-]: CALL      R14 2 0      ; R14,... := R14(R15)
 48 [-]: CALL      R12 0 1      ; R12(R13,...)
 49 [-]: CONST     R12 0        ; R12 := 0.000000
 50 [-]: RETURN    R12 2        ; return R12
 51 [-]: FORLOOP   R8 33        ; R8 += R10; if R8 <= R9 then begin PC := 33; R11 := R8 end
...
; Max Stack Size:  24
 ...
 90 [-]: CONST     R18 75       ; R18 := 75.000000
 91 [-]: CONST     R19 110      ; R19 := 110.000000
