...
L 2:  16 [-]: NAMECALL R4 R3 K5 [0x73901ACF]
      17 [-]: CALL R4 1 1  
      18 [-]: JUMPIFNOT R4 L4
      19 [-]: GETIMPORT R5 8 ["StalkerTargetPlayer"]
...
L 4:  24 [-]: LOADN R4 0   
      25 [-]: RETURN R4 1  
L 5:  26 [-]: GETIMPORT R4 8 ["StalkerTargetPlayer"]
...
L 0:  10 [-]: JUMPIF R5 L1 
      ...
      13 [-]: CALL R5 2 0  
L 1:  14 [-]: GETIMPORT R5 9 [0x733FC736]
      15 [-]: LOADB R6 1   
      16 [-]: CALL R5 1 1  
      17 [-]: MOVE R8 R2   
      18 [-]: NAMECALL R6 R5 K10 [0x277BF617]
      19 [-]: CALL R6 2 0  
      20 [-]: GETIMPORT R8 12 [0x6687F6E0]
...
; Max Stack Size:  26
       ...
       3 [-]: JUMPIF R3 L0 
       4 [-]: RETURN R0 0  
L 0:   5 [-]: GETIMPORT R3 4 [0xA6F2693C]
...
L 8:  50 [-]: NAMECALL R7 R4 K15 [0xD1586535]
      51 [-]: CALL R7 1 1  
      52 [-]: GETIMPORT R8 17 [0xC0DA2B81]
      53 [-]: NAMECALL R9 R2 K15 [0xD1586535]
      54 [-]: CALL R9 1 1  
      55 [-]: MOVE R10 R7  
      56 [-]: CALL R8 2 1  
      57 [-]: GETIMPORT R10 19 [0xB499339E]
      58 [-]: GETIMPORT R11 19 [0xB499339E]
      59 [-]: MUL R9 R10 R11
      60 [-]: JUMPIFNOTLE R8 R9 L9
      61 [-]: GETIMPORT R8 1 [0x89326C93]
      62 [-]: MOVE R10 R4  
      63 [-]: MOVE R11 R7  
      64 [-]: GETIMPORT R12 21 [0x43E34CBC]
      65 [-]: GETIMPORT R13 23 [0x1514640F]
      66 [-]: LOADN R14 20 
      67 [-]: LOADN R15 7  
      68 [-]: LOADNIL R16  
      69 [-]: MOVE R17 R0  
      ...
      79 [-]: CALL R8 17 0 
      80 [-]: GETIMPORT R8 1 [0x89326C93]
      81 [-]: GETIMPORT R10 26 [0x7A6F1C50]
      82 [-]: MOVE R11 R7  
      ...
      88 [-]: CALL R8 7 0  
      89 [-]: GETIMPORT R8 1 [0x89326C93]
      90 [-]: GETIMPORT R10 31 [0x49162ADD]
     ...
     102 [-]: CALL R8 1 0  
     103 [-]: RETURN R0 0  
L 9: 104 [-]: GETIMPORT R9 37 [0x67652851]
     105 [-]: CALL R9 0 1  
     106 [-]: ADDK R8 R9 K35 [0.5]
     107 [-]: SUB R3 R3 R8 
     108 [-]: GETIMPORT R8 39 [0xCBD666E1]
