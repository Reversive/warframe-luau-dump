...
; Max Stack Size:  9
       ...
       0 [-]: GETIMPORT R4 1 [0xDB106B8B]
       1 [-]: LOADB R5 1   
       2 [-]: NAMECALL R2 R1 K2 [0x003C792F]
       3 [-]: CALL R2 3 1  
       4 [-]: GETIMPORT R3 5 [0xD96DCC3B]
       5 [-]: MOVE R4 R2   
       6 [-]: MOVE R5 R0   
       7 [-]: GETIMPORT R6 7 [0x78403F35]
       8 [-]: CALL R3 3 1  
...
L 0:  13 [-]: JUMPIFNOT R4 L1
      14 [-]: RETURN R0 0  
L 1:  15 [-]: GETIMPORT R4 11 [0x89326C93]
      16 [-]: GETIMPORT R6 7 [0x78403F35]
      17 [-]: MOVE R7 R2   
      18 [-]: MOVE R8 R3   
...
L 2:  28 [-]: JUMPIFNOT R6 L3
      29 [-]: RETURN R0 0  
L 3:  30 [-]: GETIMPORT R6 11 [0xC163F229]
      31 [-]: GETIMPORT R8 13 [0x8DDD16BE]
      32 [-]: MINUS R7 R8  
      33 [-]: GETIMPORT R8 13 [0x8DDD16BE]
      34 [-]: CALL R6 2 1  
      35 [-]: GETIMPORT R8 15 [0x492C7F2A]
      36 [-]: NAMECALL R9 R2 K16 [0xF376ADF1]
      37 [-]: CALL R9 1 1  
      38 [-]: GETIMPORT R10 18 [0x00046924]
      39 [-]: MOVE R11 R6  
      40 [-]: LOADN R12 0  
      41 [-]: LOADN R13 0  
      42 [-]: CALL R10 3 -1
      43 [-]: CALL R8 -1 1 
      44 [-]: GETIMPORT R9 20 [0x3E51E366]
      45 [-]: MUL R7 R8 R9 
      46 [-]: GETIMPORT R9 15 [0x492C7F2A]
      47 [-]: NAMECALL R10 R2 K21 [0x9BA17154]
      48 [-]: CALL R10 1 1 
      49 [-]: GETIMPORT R11 18 [0x00046924]
      50 [-]: MOVE R12 R6  
      51 [-]: LOADN R13 0  
      52 [-]: LOADN R14 0  
      53 [-]: CALL R11 3 -1
      54 [-]: CALL R9 -1 1 
      55 [-]: GETIMPORT R10 23 [0x8DE44E7E]
      56 [-]: MUL R8 R9 R10
      57 [-]: ADD R10 R5 R7
      58 [-]: ADD R9 R10 R8
      59 [-]: MOVE R12 R9  
...
L 6:  42 [-]: JUMPIF R5 L7 
      ...
      47 [-]: LOADN R9 0   
      48 [-]: CALL R5 4 0  
L 7:  49 [-]: GETIMPORT R5 1 [0xCBD666E1]
      50 [-]: GETIMPORT R6 11 [0x725A87AC]
      51 [-]: CALL R5 1 0  
      52 [-]: JUMPBACK L0  
L 8:  53 [-]: RETURN R0 0  
