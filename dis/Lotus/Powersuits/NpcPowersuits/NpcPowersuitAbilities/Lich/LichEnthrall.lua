...
L 0:   7 [-]: NAMECALL R2 R1 K3 [0x2D0A291F]
      ...
      10 [-]: GETIMPORT R5 7 ["gLotusNpcAvatarType"]
...
L 2:  38 [-]: JUMPIFNOT R8 L4
      ...
      40 [-]: CALL R9 1 -1 
      41 [-]: FASTCALL 62 L3
      42 [-]: GETIMPORT R8 14 [0x7B998233]
      43 [-]: CALL R8 -1 1 
L 3:  44 [-]: JUMPIFNOT R8 L4
      45 [-]: GETIMPORT R10 17 ["gAutoTurretAvatarType"]
      46 [-]: NAMECALL R8 R7 K18 [0xF2DEAF69]
      47 [-]: CALL R8 2 1  
      48 [-]: JUMPIF R8 L4 
      49 [-]: GETIMPORT R10 20 ["gSecurityCameraAvatarType"]
      50 [-]: NAMECALL R8 R7 K18 [0xF2DEAF69]
      51 [-]: CALL R8 2 1  
      52 [-]: JUMPIFNOT R8 L5
L 4:  53 [-]: GETIMPORT R8 23 [0x9C1F3B5A]
      54 [-]: MOVE R9 R3   
      55 [-]: MOVE R10 R6  
      56 [-]: CALL R8 2 0  
...
L 6:  58 [-]: LENGTH R4 R3 
      ...
      60 [-]: LOADN R4 0   
      61 [-]: RETURN R4 1  
L 7:  62 [-]: GETIMPORT R5 27 [0x3630E649]
      63 [-]: LOADN R6 1   
      64 [-]: LENGTH R7 R3 
      65 [-]: CALL R5 2 1  
...
L 0:   4 [-]: JUMPIFNOT R3 L1
       5 [-]: RETURN R0 0  
L 1:   6 [-]: GETIMPORT R5 3 [0x055E6EC5]
       7 [-]: GETIMPORT R8 5 [0x0ED8B456]
       8 [-]: LOADB R9 0   
       9 [-]: LOADN R10 4  
      10 [-]: LOADN R11 1  
      11 [-]: LOADB R12 1  
...
L 2:  20 [-]: JUMPIF R3 L3 
      ...
      26 [-]: LOADN R8 1   
      27 [-]: LOADB R9 1   
      28 [-]: GETIMPORT R10 12 [0x55730E1A]
      29 [-]: LOADN R11 0  
      30 [-]: LOADN R12 2  
      31 [-]: CALL R10 2 -1
      32 [-]: NAMECALL R3 R2 K13 [0x0F89A4D4]
      33 [-]: CALL R3 -1 0 
      34 [-]: GETIMPORT R5 15 [0x1871B199]
      35 [-]: GETIMPORT R6 17 ["EMPTY_SYMBOL"]
      36 [-]: GETIMPORT R7 19 ["ZERO_VECTOR"]
      37 [-]: GETIMPORT R8 21 ["ZERO_ROTATION"]
      38 [-]: MOVE R9 R0   
      39 [-]: NAMECALL R3 R2 K22 [0x47901F07]
      40 [-]: CALL R3 6 0  
      41 [-]: GETIMPORT R3 25 ["ConvertToHenchman"]
      42 [-]: JUMPIFNOT R3 L3
      43 [-]: GETIMPORT R3 25 ["ConvertToHenchman"]
      44 [-]: MOVE R4 R2   
      45 [-]: CALL R3 1 0  
L 3:  46 [-]: RETURN R0 0  
