...
; Max Stack Size:  15
       ...
       1 [-]: CALL R3 1 1  
       2 [-]: GETIMPORT R6 2 ["gKuvaLichDamageControllerType"]
...
L 2:  32 [-]: JUMPIF R9 L3 
      ...
      43 [-]: GETIMPORT R10 16 [0x443A8D0B]
      44 [-]: JUMPIFNOTLE R9 R10 L3
      45 [-]: LOADN R12 1  
      46 [-]: GETIMPORT R14 16 [0x443A8D0B]
      47 [-]: DIV R13 R9 R14
      48 [-]: SUB R11 R12 R13
      49 [-]: LENGTH R12 R5
      50 [-]: DIV R10 R11 R12
...
L 2:  20 [-]: GETIMPORT R7 11 [0x0ED8B456]
      ...
      37 [-]: GETIMPORT R11 18 [0xBA16F1C9]
      38 [-]: LOADB R12 0  
      39 [-]: LOADN R13 2  
      40 [-]: LOADN R14 2  
      41 [-]: LOADB R15 1  
...
L 3:  61 [-]: GETTABLE R15 R10 R13
      ...
      64 [-]: MOVE R16 R14 
      65 [-]: GETIMPORT R15 3 [0x7B998233]
      66 [-]: CALL R15 1 1 
L 4:  67 [-]: JUMPIF R15 L7
      68 [-]: GETIMPORT R17 27 ["gPetAvatarType"]
      ...
      77 [-]: CALL R17 1 1 
      78 [-]: GETIMPORT R18 14 [0x252BBE98]
      79 [-]: MUL R8 R18 R17
...
L 5:  89 [-]: JUMPIF R21 L6
      ...
      92 [-]: CALL R21 2 1 
      93 [-]: MOVE R20 R21 
L 6:  94 [-]: GETIMPORT R21 20 [0x89326C93]
      95 [-]: GETIMPORT R23 35 [0xAE4C6100]
      96 [-]: MOVE R24 R20 
      97 [-]: MOVE R25 R18 
      98 [-]: MOVE R26 R1  
...
L 8: 102 [-]: JUMPIFNOT R7 L18
     103 [-]: GETIMPORT R10 38 [0x67652851]
     104 [-]: CALL R10 0 1 
     105 [-]: ADD R5 R5 R10
     106 [-]: GETIMPORT R10 38 [0x67652851]
     107 [-]: CALL R10 0 1 
     108 [-]: ADD R6 R6 R10
     109 [-]: GETIMPORT R10 20 [0x89326C93]
     110 [-]: NAMECALL R10 R10 K23 [0x18D05D30]
     111 [-]: CALL R10 1 1 
     112 [-]: JUMPIFNOT R10 L16
     113 [-]: GETGLOBAL R10 K16 [0x50B549E1]
     114 [-]: JUMPIFNOTLE R10 R6 L16
     115 [-]: GETIMPORT R10 20 [0x89326C93]
...
L10: 125 [-]: NAMECALL R13 R1 K5 [0xFA9E477F]
     ...
     131 [-]: GETIMPORT R14 45 [0x3630E649]
     132 [-]: LOADN R15 1  
     133 [-]: LENGTH R16 R13
     134 [-]: CALL R14 2 1 
     ...
     138 [-]: MOVE R17 R15 
     139 [-]: GETIMPORT R16 3 [0x7B998233]
     140 [-]: CALL R16 1 1 
L11: 141 [-]: JUMPIF R16 L15
     ...
     147 [-]: CALL R18 1 1 
     148 [-]: GETIMPORT R19 14 [0x252BBE98]
     149 [-]: MUL R8 R19 R18
     ...
     156 [-]: CALL R21 2 1 
     157 [-]: GETIMPORT R23 48 [0x102F6838]
     158 [-]: GETIMPORT R24 48 [0x102F6838]
     159 [-]: MUL R22 R23 R24
     160 [-]: JUMPIFNOTLT R21 R22 L12
     161 [-]: NAMECALL R22 R1 K29 [0xD1586535]
     162 [-]: CALL R22 1 1 
     163 [-]: SUB R23 R20 R22
     164 [-]: GETIMPORT R24 50 [0xC2892F65]
     165 [-]: MOVE R25 R23 
     166 [-]: CALL R24 1 0 
     167 [-]: GETIMPORT R25 48 [0x102F6838]
     168 [-]: MUL R24 R23 R25
     169 [-]: ADD R20 R22 R24
L12: 170 [-]: MOVE R22 R20 
     171 [-]: FASTCALL1 62 R9 L13
     172 [-]: MOVE R24 R9  
     173 [-]: GETIMPORT R23 3 [0x7B998233]
     174 [-]: CALL R23 1 1 
L13: 175 [-]: JUMPIF R23 L14
     ...
     178 [-]: CALL R23 2 1 
     179 [-]: MOVE R22 R23 
L14: 180 [-]: GETIMPORT R23 20 [0x89326C93]
     181 [-]: GETIMPORT R25 35 [0xAE4C6100]
     182 [-]: MOVE R26 R22 
     183 [-]: MOVE R27 R19 
     184 [-]: MOVE R28 R1  
     185 [-]: NAMECALL R23 R23 K36 [0x05909209]
     186 [-]: CALL R23 5 0 
     187 [-]: GETIMPORT R23 20 [0x89326C93]
...
L23: 229 [-]: JUMPIFNOT R10 L25
     ...
     231 [-]: GETIMPORT R13 38 [0x67652851]
     232 [-]: CALL R13 0 1 
     233 [-]: SUB R11 R12 R13
     ...
     238 [-]: LOADB R10 0  
L24: 239 [-]: GETIMPORT R11 53 [0xCBD666E1]
     240 [-]: LOADN R12 0  
     241 [-]: CALL R11 1 0 
     242 [-]: JUMPBACK L23 
L25: 243 [-]: GETIMPORT R11 20 [0x89326C93]
     244 [-]: NAMECALL R11 R11 K23 [0x18D05D30]
     245 [-]: CALL R11 1 1 
     246 [-]: JUMPIFNOT R11 L26
     247 [-]: NAMECALL R11 R1 K58 [0x1AC1655C]
     248 [-]: CALL R11 1 1 
     249 [-]: GETIMPORT R14 60 ["gKuvaLichDamageControllerType"]
     ...
     258 [-]: CALL R13 3 0 
L26: 259 [-]: GETIMPORT R13 64 [0x701F5E21]
     260 [-]: LOADB R14 0  
     261 [-]: LOADN R15 2  
     262 [-]: LOADN R16 1  
     263 [-]: LOADB R17 1  
...
L 3:  52 [-]: MOVE R5 R0   
      ...
      57 [-]: CALL R3 2 0  
L 4:  58 [-]: GETIMPORT R3 24 [0x89326C93]
      59 [-]: MOVE R5 R1   
