...
L 4:  22 [-]: LOADN R4 0   
      ...
      25 [-]: CALL R4 1 1  
      26 [-]: JUMPIF R4 L5 
      27 [-]: GETIMPORT R4 1 [0xCBD666E1]
      28 [-]: LOADN R5 0   
      29 [-]: CALL R4 1 0  
      30 [-]: GETIMPORT R4 9 [0x67652851]
      31 [-]: CALL R4 0 1  
      32 [-]: SUB R3 R3 R4 
      33 [-]: JUMPBACK L4  
...
L11:  56 [-]: NAMECALL R4 R0 K12 [0xA2880940]
      57 [-]: CALL R4 1 0  
      58 [-]: RETURN R0 0  
L12:  59 [-]: GETIMPORT R6 14 [0x1E415306]
      60 [-]: GETIMPORT R7 16 ["EMPTY_SYMBOL"]
      61 [-]: GETIMPORT R8 18 [0xA421AF95]
      62 [-]: LOADN R9 0   
      63 [-]: LOADN R10 1  
      64 [-]: LOADN R11 0  
      65 [-]: CALL R8 3 1  
      66 [-]: GETIMPORT R9 20 [0x00046924]
      67 [-]: LOADN R10 0  
      68 [-]: LOADN R11 90 
      69 [-]: LOADN R12 0  
      70 [-]: CALL R9 3 1  
...
L13:  78 [-]: JUMPIF R5 L14
      79 [-]: LOADN R8 2   
      80 [-]: GETIMPORT R9 23 [0x443A8D0B]
      81 [-]: MUL R7 R8 R9 
      82 [-]: LOADB R8 0   
      83 [-]: NAMECALL R5 R4 K24 [0x2D9BA74F]
      84 [-]: CALL R5 3 0  
L14:  85 [-]: GETIMPORT R7 26 [0x213EBE1D]
      86 [-]: GETIMPORT R8 16 ["EMPTY_SYMBOL"]
      87 [-]: GETIMPORT R9 28 ["ZERO_VECTOR"]
      88 [-]: GETIMPORT R10 20 [0x00046924]
      89 [-]: LOADN R11 0  
      90 [-]: LOADN R12 -90
      91 [-]: LOADN R13 0  
      92 [-]: CALL R10 3 1 
...
L16: 103 [-]: JUMPIF R7 L17
     104 [-]: LOADN R10 2  
     105 [-]: GETIMPORT R11 23 [0x443A8D0B]
     106 [-]: MUL R9 R10 R11
     107 [-]: MUL R8 R9 R6 
     108 [-]: GETIMPORT R9 30 [0xB09A8D83]
     109 [-]: DIV R7 R8 R9 
     110 [-]: GETUPVAL R10 0
     111 [-]: MOVE R11 R7  
     112 [-]: MOVE R12 R7  
     ...
     116 [-]: CALL R8 6 0  
L17: 117 [-]: GETIMPORT R7 1 [0xCBD666E1]
     118 [-]: LOADN R8 0   
     119 [-]: CALL R7 1 0  
     120 [-]: GETIMPORT R7 9 [0x67652851]
     121 [-]: CALL R7 0 1  
     122 [-]: SUB R6 R6 R7 
     123 [-]: JUMPBACK L15 
...
L19: 128 [-]: JUMPIF R7 L20
     ...
     130 [-]: CALL R7 1 0  
L20: 131 [-]: GETIMPORT R7 34 [0x492C7F2A]
     132 [-]: GETIMPORT R8 18 [0xA421AF95]
     133 [-]: LOADN R9 0   
     134 [-]: LOADN R10 0  
     135 [-]: LOADN R11 100
     136 [-]: CALL R8 3 1  
     137 [-]: GETIMPORT R9 20 [0x00046924]
     138 [-]: GETIMPORT R10 37 [0x3630E649]
     139 [-]: LOADN R11 0  
     140 [-]: LOADN R12 360
     141 [-]: CALL R10 2 1 
     142 [-]: LOADN R11 -75
     ...
     147 [-]: CALL R8 1 1  
     148 [-]: GETIMPORT R9 40 [0x89326C93]
     149 [-]: GETIMPORT R11 42 [0x001CDB1D]
     150 [-]: MOVE R12 R8  
     151 [-]: GETIMPORT R13 44 [0x20B7F774]
     152 [-]: GETIMPORT R14 28 ["ZERO_VECTOR"]
     153 [-]: MOVE R15 R7  
     154 [-]: CALL R13 2 1 
     155 [-]: MOVE R14 R2  
     156 [-]: NAMECALL R9 R9 K45 [0x05909209]
     157 [-]: CALL R9 5 0  
     158 [-]: GETIMPORT R9 40 [0x89326C93]
     159 [-]: NAMECALL R9 R9 K46 [0x18D05D30]
     160 [-]: CALL R9 1 1  
     161 [-]: JUMPIFNOT R9 L21
     162 [-]: GETIMPORT R9 49 [0x5CB2ADF8]
     163 [-]: CALL R9 0 1  
     164 [-]: MOVE R12 R1  
     ...
     169 [-]: CALL R10 2 0 
     170 [-]: GETIMPORT R12 53 [0x7258F36F]
     171 [-]: GETIMPORT R13 55 [0x9B5DDF0B]
     172 [-]: CALL R12 1 -1
     173 [-]: NAMECALL R10 R9 K56 [0xF326045F]
     174 [-]: CALL R10 -1 0
     175 [-]: GETIMPORT R10 23 [0x443A8D0B]
     ...
     197 [-]: GETIMPORT R10 40 [0x89326C93]
     198 [-]: MOVE R12 R9  
