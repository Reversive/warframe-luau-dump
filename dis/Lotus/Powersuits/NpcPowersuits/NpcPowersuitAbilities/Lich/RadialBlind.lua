...
L 1:   9 [-]: NAMECALL R4 R3 K3; var5 = var3; var4 = var3[0x9A61D35A]
      ...
      12 [-]: JUMPIFNOTLT R5 R4 L2; goto L2 if var5 >= var1328
...
L 1:  19 [-]: MOVE R12 R9  ; var12 = var9
      ...
      25 [-]: JUMPIFNOTLT R11 R10 L2; goto L2 if var11 >= var592942
...
L 0:  10 [-]: JUMPIF R4 L4 ; goto L4 if var4
      ...
      13 [-]: JUMPIFNOTLT R5 R4 L4; goto L4 if var5 >= var590881
...
L 8: 110 [-]: NAMECALL R13 R12 K48; var14 = var12; var13 = var12[0xA5E492D4]
     ...
     118 [-]: JUMPIFNOTLE R14 R15 L9; goto L9 if var14 > var-771748089
