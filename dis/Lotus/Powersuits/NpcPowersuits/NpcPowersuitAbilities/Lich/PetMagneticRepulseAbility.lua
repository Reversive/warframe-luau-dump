...
; Max Stack Size:  10
       ...
       3 [-]: GETIMPORT R4 6 [0x422E1719]
       4 [-]: GETIMPORT R8 6 [0x422E1719]
       5 [-]: LENGTH R7 R8 
       6 [-]: FASTCALL2 19 R0 R7 L0
       7 [-]: MOVE R6 R0   
       8 [-]: GETIMPORT R5 9 [0xAC1B386A]
       9 [-]: CALL R5 2 1  
L 0:  10 [-]: GETTABLE R3 R4 R5
      ...
      17 [-]: GETIMPORT R4 11 [0x0D639913]
      18 [-]: GETIMPORT R8 6 [0x422E1719]
      19 [-]: LENGTH R7 R8 
      20 [-]: FASTCALL2 19 R0 R7 L1
      21 [-]: MOVE R6 R0   
      22 [-]: GETIMPORT R5 9 [0xAC1B386A]
      23 [-]: CALL R5 2 1  
L 1:  24 [-]: GETTABLE R3 R4 R5
      ...
      31 [-]: GETIMPORT R5 14 [0xB03A662C]
      32 [-]: GETIMPORT R9 14 [0xB03A662C]
      33 [-]: LENGTH R8 R9 
      34 [-]: FASTCALL2 19 R0 R8 L2
      35 [-]: MOVE R7 R0   
      36 [-]: GETIMPORT R6 9 [0xAC1B386A]
      37 [-]: CALL R6 2 1  
...
; Max Stack Size:  23
       ...
       0 [-]: GETIMPORT R3 1 [0xA38238BD]
       1 [-]: GETIMPORT R4 3 ["EMPTY_SYMBOL"]
       2 [-]: GETIMPORT R5 5 ["ZERO_VECTOR"]
       3 [-]: GETIMPORT R6 7 ["ZERO_ROTATION"]
       4 [-]: NAMECALL R1 R0 K8 [0x47901F07]
       5 [-]: CALL R1 5 1  
       6 [-]: GETIMPORT R4 10 [0xAD9D2D22]
       7 [-]: GETIMPORT R5 3 ["EMPTY_SYMBOL"]
       8 [-]: GETIMPORT R6 5 ["ZERO_VECTOR"]
       9 [-]: GETIMPORT R7 7 ["ZERO_ROTATION"]
      10 [-]: NAMECALL R2 R0 K8 [0x47901F07]
      11 [-]: CALL R2 5 1  
      12 [-]: LOADNIL R3   
      13 [-]: GETIMPORT R4 12 [0x89326C93]
      14 [-]: NAMECALL R4 R4 K13 [0x18D05D30]
      15 [-]: CALL R4 1 1  
      16 [-]: JUMPIFNOT R4 L0
      17 [-]: GETIMPORT R4 15 [0x9BA911DD]
      18 [-]: JUMPIF R4 L0 
      19 [-]: GETIMPORT R6 17 [0x37D88641]
      20 [-]: GETIMPORT R7 3 ["EMPTY_SYMBOL"]
      21 [-]: GETIMPORT R8 5 ["ZERO_VECTOR"]
      22 [-]: GETIMPORT R9 7 ["ZERO_ROTATION"]
      23 [-]: MOVE R10 R0  
      ...
      32 [-]: CALL R4 2 0  
L 0:  33 [-]: GETIMPORT R5 21 [0xB03A662C]
      34 [-]: GETUPVAL R7 0
      35 [-]: GETIMPORT R9 21 [0xB03A662C]
      36 [-]: LENGTH R8 R9 
      37 [-]: FASTCALL2 19 R7 R8 L1
      38 [-]: GETIMPORT R6 24 [0xAC1B386A]
      39 [-]: CALL R6 2 1  
...
L 2:  55 [-]: NAMECALL R6 R0 K28 [0xDE321E6F]
      ...
      63 [-]: CALL R6 5 0  
      64 [-]: GETIMPORT R7 31 [0x422E1719]
      65 [-]: GETUPVAL R9 0
      66 [-]: GETIMPORT R11 31 [0x422E1719]
      67 [-]: LENGTH R10 R11
      68 [-]: FASTCALL2 19 R9 R10 L3
      69 [-]: GETIMPORT R8 24 [0xAC1B386A]
      70 [-]: CALL R8 2 1  
L 3:  71 [-]: GETTABLE R6 R7 R8
      72 [-]: GETIMPORT R8 33 [0x0D639913]
      73 [-]: GETUPVAL R10 0
      74 [-]: GETIMPORT R12 33 [0x0D639913]
      75 [-]: LENGTH R11 R12
      76 [-]: FASTCALL2 19 R10 R11 L4
      77 [-]: GETIMPORT R9 24 [0xAC1B386A]
      78 [-]: CALL R9 2 1  
...
L 6:  86 [-]: JUMPIF R9 L20
      ...
      94 [-]: MOVE R12 R3  
      95 [-]: GETIMPORT R11 35 [0x7B998233]
      96 [-]: CALL R11 1 1 
...
L 8: 101 [-]: NAMECALL R12 R9 K39 [0x022CE583]
     ...
     108 [-]: GETIMPORT R12 42 [0xCBD666E1]
     109 [-]: GETIMPORT R13 44 [0xBC469AC2]
     110 [-]: CALL R12 1 0 
     111 [-]: GETIMPORT R12 44 [0xBC469AC2]
     112 [-]: ADD R8 R8 R12
     113 [-]: FASTCALL1 62 R0 L9
     114 [-]: MOVE R13 R0  
     115 [-]: GETIMPORT R12 35 [0x7B998233]
     116 [-]: CALL R12 1 1 
L 9: 117 [-]: JUMPIF R12 L20
     ...
     125 [-]: MOVE R13 R3  
     126 [-]: GETIMPORT R12 35 [0x7B998233]
     127 [-]: CALL R12 1 1 
...
L11: 132 [-]: NAMECALL R12 R9 K39 [0x022CE583]
     ...
     135 [-]: CALL R12 1 1 
     136 [-]: ADD R11 R12 R10
     137 [-]: GETIMPORT R12 46 [0x292CBEE4]
     138 [-]: JUMPIF R12 L12
     139 [-]: GETIMPORT R12 48 [0x1A78334E]
     140 [-]: MUL R11 R11 R12
L12: 141 [-]: GETIMPORT R12 50 [0x254B51B6]
     142 [-]: LOADN R13 0  
     143 [-]: JUMPIFNOTLT R13 R12 L14
     144 [-]: GETIMPORT R14 50 [0x254B51B6]
     145 [-]: FASTCALL2 19 R11 R14 L13
     146 [-]: MOVE R13 R11 
     147 [-]: GETIMPORT R12 24 [0xAC1B386A]
     148 [-]: CALL R12 2 1 
L13: 149 [-]: MOVE R11 R12 
L14: 150 [-]: GETIMPORT R12 53 [0x5CB2ADF8]
     151 [-]: CALL R12 0 1 
     152 [-]: GETIMPORT R15 55 [0x7258F36F]
     153 [-]: MOVE R16 R11 
     154 [-]: CALL R15 1 -1
     ...
     167 [-]: CALL R13 3 0 
     168 [-]: GETIMPORT R13 63 [0x27638981]
...
L15: 174 [-]: LOADN R15 200
     ...
     179 [-]: CALL R13 2 0 
     180 [-]: GETIMPORT R13 12 [0x89326C93]
     181 [-]: GETIMPORT R15 68 [0xDB1A2F42]
     182 [-]: NAMECALL R16 R0 K59 [0xF6EBD926]
     183 [-]: CALL R16 1 1 
     184 [-]: GETIMPORT R17 7 ["ZERO_ROTATION"]
     185 [-]: MOVE R18 R0  
     186 [-]: MOVE R19 R0  
     187 [-]: LOADN R20 1  
     188 [-]: NAMECALL R13 R13 K69 [0x05909209]
     189 [-]: CALL R13 7 0 
     190 [-]: GETIMPORT R13 12 [0x89326C93]
     191 [-]: GETIMPORT R15 71 [0x248AB2E3]
     ...
     201 [-]: CALL R13 9 0 
     202 [-]: GETIMPORT R13 12 [0x89326C93]
     203 [-]: MOVE R15 R12 
...
L18: 221 [-]: GETIMPORT R12 75 [0x67652851]
     222 [-]: CALL R12 0 1 
     223 [-]: ADD R8 R8 R12
     224 [-]: GETIMPORT R12 42 [0xCBD666E1]
     225 [-]: LOADN R13 0  
     226 [-]: CALL R12 1 0 
L19: 227 [-]: JUMPBACK L5  
L20: 228 [-]: FASTCALL1 62 R0 L21
     229 [-]: MOVE R10 R0  
     230 [-]: GETIMPORT R9 35 [0x7B998233]
     231 [-]: CALL R9 1 1  
...
L22: 234 [-]: NAMECALL R9 R0 K28 [0xDE321E6F]
     ...
     244 [-]: MOVE R10 R1  
     245 [-]: GETIMPORT R9 35 [0x7B998233]
     246 [-]: CALL R9 1 1  
...
L24: 250 [-]: FASTCALL1 62 R3 L25
     251 [-]: MOVE R10 R3  
     252 [-]: GETIMPORT R9 35 [0x7B998233]
     253 [-]: CALL R9 1 1  
...
L26: 260 [-]: FASTCALL1 62 R2 L27
     261 [-]: MOVE R10 R2  
     262 [-]: GETIMPORT R9 35 [0x7B998233]
     263 [-]: CALL R9 1 1  
