...
; Max Stack Size:  2
  ...
  2 [-]: JMP       12           ; PC := 12
  3 [-]: CONST     R1 10000     ; R1 := 10000.000000
 ...
 13 [-]: JMP       22           ; PC := 22
 14 [-]: CONST     R1 20000     ; R1 := 20000.000000
...
; Max Stack Size:  8
 ...
 15 [-]: JMP       30           ; PC := 30
 16 [-]: SELF      R3 R1 K5     ; R4 := R1; R3 := R1[0xac99e72c]
 17 [-]: GETUPVAL  R5 U0        ; R5 := U0
 18 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 19 [-]: TEST      R3 0         ; if not R3 then PC := 30
 20 [-]: JMP       30           ; PC := 30
 21 [-]: SELF      R4 R2 K6     ; R5 := R2; R4 := R2[0xdb6046e1]
 22 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 23 [-]: SELF      R5 R1 K7     ; R6 := R1; R5 := R1[0x22a3741f]
 24 [-]: GETUPVAL  R7 U0        ; R7 := U0
 25 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
 26 [-]: EQ        0 R5 R4      ; if R5 ~= R4 then PC := 30
 27 [-]: JMP       30           ; PC := 30
...
188 [-]: CONST     R21 47       ; R21 := 47.000000
189 [-]: CONST     R22 2        ; R22 := 2.000000
190 [-]: CONST     R23 0        ; R23 := 0.000000
...
237 [-]: LOADKB    R25 0 0      ; R25 := false
238 [-]: LOADKB    R26 1 0      ; R26 := true
...
; Max Stack Size:  23
 ...
 79 [-]: CONST     R13 2000     ; R13 := 2000.000000
...
216 [-]: CONST     R14 47       ; R14 := 47.000000
217 [-]: CONST     R15 2        ; R15 := 2.000000
