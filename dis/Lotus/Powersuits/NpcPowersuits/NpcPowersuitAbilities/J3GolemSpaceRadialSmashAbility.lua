...
L 0:   8 [-]: JUMPIFNOT R3 L1
       9 [-]: LOADN R3 0   
      10 [-]: RETURN R3 1  
L 1:  11 [-]: GETIMPORT R5 5 [0x0469F296]
...
; Max Stack Size:  11
       ...
       2 [-]: CALL R3 1 1  
       3 [-]: JUMPIFNOT R3 L0
       4 [-]: GETIMPORT R5 4 [0x46A222A5]
       5 [-]: NAMECALL R3 R1 K5 [0xB2532845]
       6 [-]: CALL R3 2 0  
L 0:   7 [-]: GETIMPORT R5 7 [0xBD3A2CDD]
       8 [-]: LOADN R6 5   
       9 [-]: NAMECALL R3 R1 K8 [0x21B4C60E]
      10 [-]: CALL R3 3 0  
      11 [-]: GETIMPORT R5 10 [0x105D9429]
      12 [-]: LOADB R6 1   
      13 [-]: NAMECALL R3 R1 K11 [0x003C792F]
      14 [-]: CALL R3 3 1  
      15 [-]: GETIMPORT R4 13 [0x492C7F2A]
      16 [-]: GETIMPORT R5 15 [0xA421AF95]
      17 [-]: LOADN R6 -5  
      18 [-]: LOADN R7 0   
      19 [-]: LOADN R8 0   
      20 [-]: CALL R5 3 1  
      ...
      23 [-]: CALL R4 -1 1 
      24 [-]: ADD R3 R3 R4 
      25 [-]: GETIMPORT R6 18 [0xF1E00E2A]
      26 [-]: FASTCALL1 62 R6 L1
      27 [-]: GETIMPORT R5 20 [0x7B998233]
      28 [-]: CALL R5 1 1  
L 1:  29 [-]: JUMPIF R5 L2 
      30 [-]: GETIMPORT R5 1 [0x89326C93]
      31 [-]: GETIMPORT R7 18 [0xF1E00E2A]
      32 [-]: MOVE R8 R3   
      33 [-]: GETIMPORT R9 22 ["ZERO_ROTATION"]
      34 [-]: MOVE R10 R1  
      35 [-]: NAMECALL R5 R5 K23 [0x05909209]
      36 [-]: CALL R5 5 0  
L 2:  37 [-]: GETIMPORT R5 1 [0x89326C93]
      38 [-]: NAMECALL R5 R5 K2 [0x18D05D30]
      39 [-]: CALL R5 1 1  
      40 [-]: JUMPIFNOT R5 L3
      41 [-]: GETIMPORT R7 25 [0xA7743868]
      42 [-]: NAMECALL R5 R1 K5 [0xB2532845]
      43 [-]: CALL R5 2 0  
L 3:  44 [-]: GETIMPORT R7 27 [0x261193A6]
      45 [-]: LOADN R8 3   
      46 [-]: NAMECALL R5 R1 K8 [0x21B4C60E]
      47 [-]: CALL R5 3 0  
      48 [-]: GETIMPORT R5 29 [0xCBD666E1]
      49 [-]: LOADN R6 1   
      50 [-]: CALL R5 1 0  
      51 [-]: RETURN R0 0  
