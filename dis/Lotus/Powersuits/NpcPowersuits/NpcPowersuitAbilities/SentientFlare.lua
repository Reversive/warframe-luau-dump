...
L 0:   8 [-]: JUMPIF R4 L1 ; goto L1 if var4
      ...
      12 [-]: JUMPIFLT R5 R4 L1; goto L1 if var5 < var1594033215
      13 [-]: GETTABLEKS R4 R3 K7; var4 = var3["distanceToTarget"]
      14 [-]: GETIMPORT R5 9; var5 = 0x443A8D0B
      15 [-]: JUMPIFNOTLT R5 R4 L2; goto L2 if var5 >= var1072
...
L 3:  37 [-]: GETIMPORT R7 23; var7 = 0x965CAFD0
      38 [-]: JUMPIFNOTLE R6 R7 L11; goto L11 if var6 > var50610237
...
L 8:  66 [-]: JUMPIF R13 L9; goto L9 if var13
     ...
     104 [-]: JUMPIFNOTLT R16 R15 L9; goto L9 if var16 >= var2822177
