...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R4 2 ["IsAngelChanneling"]
       1 [-]: FASTCALL1 62 R4 L0
       2 [-]: GETIMPORT R3 4 [0x7B998233]
       3 [-]: CALL R3 1 1  
L 0:   4 [-]: JUMPIF R3 L1 
       5 [-]: GETIMPORT R3 2 ["IsAngelChanneling"]
       6 [-]: CALL R3 0 1  
       7 [-]: JUMPIFNOT R3 L1
       8 [-]: LOADN R3 0   
       9 [-]: RETURN R3 1  
L 1:  10 [-]: GETIMPORT R3 6 [0x89326C93]
...
L 3:  22 [-]: JUMPIF R4 L5 
      ...
      30 [-]: JUMPIFNOT R4 L4
      31 [-]: RETURN R0 0  
L 4:  32 [-]: GETIMPORT R4 10 [0xCBD666E1]
      33 [-]: LOADN R5 0   
      34 [-]: CALL R4 1 0  
      35 [-]: JUMPBACK L2  
...
L 6:  40 [-]: JUMPIFNOT R4 L7
      41 [-]: RETURN R0 0  
L 7:  42 [-]: GETIMPORT R4 3 [0x89326C93]
      43 [-]: GETIMPORT R6 12 [0x0469F296]
...
L10:  71 [-]: JUMPIFNOTLT R8 R7 L11
      ...
      73 [-]: LOADN R11 0  
      74 [-]: CALL R10 1 0 
      75 [-]: GETIMPORT R10 22 [0xFFF641AF]
      76 [-]: CALL R10 0 1 
      77 [-]: ADD R8 R8 R10
      78 [-]: GETIMPORT R10 24 [0x5DB3CE80]
      79 [-]: MOVE R11 R9  
      80 [-]: MOVE R12 R6  
      81 [-]: DIV R13 R8 R7
      82 [-]: CALL R10 3 1 
...
L13:  98 [-]: RETURN R0 0  
L14:  99 [-]: GETIMPORT R11 30 ["StartAngelChannel"]
     100 [-]: FASTCALL1 62 R11 L15
     101 [-]: GETIMPORT R10 1 [0x7B998233]
     102 [-]: CALL R10 1 1 
L15: 103 [-]: JUMPIF R10 L16
     104 [-]: GETIMPORT R10 30 ["StartAngelChannel"]
     105 [-]: CALL R10 0 0 
L16: 106 [-]: GETIMPORT R12 32 [0x24ADDB37]
     107 [-]: GETIMPORT R13 34 [0x26887B76]
     ...
     113 [-]: CALL R11 3 0 
     114 [-]: GETIMPORT R13 38 [0xBA16F1C9]
     115 [-]: LOADB R14 0  
     116 [-]: LOADN R15 3  
     117 [-]: LOADN R16 2  
     ...
     119 [-]: CALL R11 5 0 
     120 [-]: LOADN R8 0   
L17: 121 [-]: GETIMPORT R11 40 [0xA6D2CC49]
     122 [-]: JUMPIFNOTLT R8 R11 L21
     123 [-]: GETIMPORT R11 10 [0xCBD666E1]
     124 [-]: LOADN R12 0  
     125 [-]: CALL R11 1 0 
...
L19: 134 [-]: RETURN R0 0  
L20: 135 [-]: GETIMPORT R11 22 [0xFFF641AF]
     136 [-]: CALL R11 0 1 
     137 [-]: ADD R8 R8 R11
     138 [-]: JUMPBACK L17 
...
L22: 143 [-]: JUMPIF R11 L23
     ...
     145 [-]: CALL R11 1 0 
L23: 146 [-]: GETIMPORT R13 43 [0x99E0F6D2]
     147 [-]: LOADB R14 1  
     148 [-]: LOADN R15 2  
     149 [-]: LOADN R16 1  
     150 [-]: LOADB R17 1  
...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R5 2 ["StopAngelChannel"]
       1 [-]: FASTCALL1 62 R5 L0
       2 [-]: GETIMPORT R4 4 [0x7B998233]
       3 [-]: CALL R4 1 1  
L 0:   4 [-]: JUMPIF R4 L1 
       5 [-]: GETIMPORT R4 2 ["StopAngelChannel"]
       6 [-]: CALL R4 0 0  
L 1:   7 [-]: GETIMPORT R6 6 [0x24ADDB37]
