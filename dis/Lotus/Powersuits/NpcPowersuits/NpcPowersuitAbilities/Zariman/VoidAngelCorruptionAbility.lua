...
L 0:   5 [-]: JUMPIF R3 L1 ; goto L1 if var3
       ...
       7 [-]: LOADN R4 0   ; var4 = 0
       8 [-]: JUMPIFNOTLT R4 R3 L1; goto L1 if var4 >= var131617
...
L 1:  10 [-]: LOADN R4 1   ; var4 = 1
      ...
      17 [-]: JUMPIFNOTLT R4 R5 L2; goto L2 if var4 >= var1584
...
L 4:  35 [-]: JUMPIF R12 L5; goto L5 if var12
      ...
      42 [-]: JUMPIFNOTLE R12 R13 L5; goto L5 if var12 > var84358185
...
L 7:  53 [-]: JUMPIF R8 L9 ; goto L9 if var8
      ...
      56 [-]: JUMPIFNOTLT R9 R8 L9; goto L9 if var9 >= var1181985
...
L 2:  21 [-]: GETIMPORT R7 11; var7 = 0x3FB94900
      22 [-]: JUMPIFNOTLE R5 R7 L4; goto L4 if var5 > var2098692
      23 [-]: JUMPIFNOTLE R6 R5 L3; goto L3 if var6 > var263969
...
L 4:  57 [-]: LOADN R12 0  ; var12 = 0
      58 [-]: JUMPIFNOTLT R12 R11 L32; goto L32 if var12 >= var50413629
      59 [-]: FASTCALL1 64 R1 L5; 
...
L 7:  76 [-]: JUMPIFNOTEQ R17 R0 L8; goto L8 if var17 ~= var68614
...
L 9:  80 [-]: JUMPIFNOT R12 L32; goto L32 if not var12
      ...
      82 [-]: JUMPIFNOTLE R10 R12 L25; goto L25 if var10 > var3125
...
L16: 114 [-]: NAMECALL R20 R19 K37; var21 = var19; var20 = var19[0x808B79E6]
     ...
     118 [-]: JUMPIFEQ R20 R21 L22; goto L22 if var20 == var302912271
     ...
     133 [-]: CALL R20 0 2 ; var20 = var20(var21, ...)
...
L23: 172 [-]: GETIMPORT R21 33; var21 = _T["gooPoolEnemies"]
     ...
     183 [-]: JUMPIFNOTLE R20 R21 L24; goto L24 if var20 > var2167841
...
L25: 190 [-]: LOADK R12 K54; var12 = 1.5
     191 [-]: JUMPIFNOTLT R11 R12 L31; goto L31 if var11 >= var461824
...
L26: 198 [-]: LOADN R12 0  ; var12 = 0
     199 [-]: JUMPIFNOTLT R12 R5 L31; goto L31 if var12 >= var1969185
...
L33: 238 [-]: GETIMPORT R18 33; var18 = _T["gooPoolEnemies"]
     ...
     249 [-]: JUMPIFNOTLE R17 R18 L34; goto L34 if var17 > var2167073
...
L37: 277 [-]: JUMPIFNOTEQ R16 R0 L38; goto L38 if var16 ~= var4460833
...
L41: 300 [-]: LOADN R12 0  ; var12 = 0
     301 [-]: JUMPIFNOTLT R12 R5 L46; goto L46 if var12 >= var1969185
...
L 2:  32 [-]: GETIMPORT R7 15; var7 = 0xBD7A4E32
      33 [-]: JUMPIFNOTLT R6 R7 L5; goto L5 if var6 >= var50413629
...
L 9: 104 [-]: JUMPIF R9 L10; goto L10 if var9
     ...
     107 [-]: JUMPIFNOTLT R10 R9 L10; goto L10 if var10 >= var2689057
