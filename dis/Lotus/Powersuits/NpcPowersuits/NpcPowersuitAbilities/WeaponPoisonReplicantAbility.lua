...
129 [-]: CONST     R17 301      ; R17 := 301.000000
...
; Max Stack Size:  14
 ...
 47 [-]: CONST     R8 301       ; R8 := 301.000000
 48 [-]: CONST     R9 3         ; R9 := 3.000000
...
; Max Stack Size:  33
  ...
  1 [-]: EQ        1 R9 K1      ; if R9 == 7.000000 then PC := 7
  2 [-]: JMP       7            ; PC := 7
  3 [-]: EQ        1 R9 K2      ; if R9 == 6.000000 then PC := 7
  4 [-]: JMP       7            ; PC := 7
  5 [-]: EQ        0 R9 K3      ; if R9 ~= 5.000000 then PC := 8
  6 [-]: JMP       8            ; PC := 8
  7 [-]: RETURN    R0 1         ; return 
  8 [-]: GETGLOBAL R10 K4       ; R10 := 0x7b998233
  9 [-]: MOVE      R11 R3       ; R11 := R3
 10 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 11 [-]: TEST      R10 1        ; if R10 then PC := 28
 12 [-]: JMP       28           ; PC := 28
 13 [-]: GETGLOBAL R10 K4       ; R10 := 0x7b998233
 14 [-]: MOVE      R11 R2       ; R11 := R2
 15 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 16 [-]: TEST      R10 1        ; if R10 then PC := 28
 17 [-]: JMP       28           ; PC := 28
 18 [-]: SELF      R10 R2 K5    ; R11 := R2; R10 := R2[0xf2deaf69]
 19 [-]: GETGLOBAL R12 K6       ; R12 := gWeaponExType
 20 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 21 [-]: TEST      R10 0        ; if not R10 then PC := 28
 22 [-]: JMP       28           ; PC := 28
 23 [-]: SELF      R10 R2 K5    ; R11 := R2; R10 := R2[0xf2deaf69]
 24 [-]: GETGLOBAL R12 K7       ; R12 := gPowerSuitType
 25 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 26 [-]: TEST      R10 0        ; if not R10 then PC := 29
 27 [-]: JMP       29           ; PC := 29
 28 [-]: RETURN    R0 1         ; return 
 29 [-]: SELF      R10 R0 K8    ; R11 := R0; R10 := R0[0x5163741e]
 30 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 31 [-]: GETGLOBAL R11 K4       ; R11 := 0x7b998233
 32 [-]: MOVE      R12 R10      ; R12 := R10
 33 [-]: CALL      R11 2 2      ; R11 := R11(R12)
 34 [-]: TEST      R11 0        ; if not R11 then PC := 37
 35 [-]: JMP       37           ; PC := 37
 36 [-]: RETURN    R0 1         ; return 
 ...
 41 [-]: GETTABLE  R11 R11 K9   ; R11 := R11[0xb43a6753]
 42 [-]: MOVE      R12 R0       ; R12 := R0
 43 [-]: GETGLOBAL R13 K10      ; R13 := 0x6687f6e0
 44 [-]: CALL      R11 3 2      ; R11 := R11(R12,R13)
 45 [-]: GETGLOBAL R12 K4       ; R12 := 0x7b998233
 46 [-]: MOVE      R13 R11      ; R13 := R11
 47 [-]: CALL      R12 2 2      ; R12 := R12(R13)
 48 [-]: TEST      R12 1        ; if R12 then PC := 52
 49 [-]: JMP       52           ; PC := 52
 50 [-]: GETTABLE  R12 R11 K11  ; R12 := R11["multiplier"]
 51 [-]: SETUPVAL  R12 U2       ; U82 := R2
 52 [-]: GETGLOBAL R12 K10      ; R12 := 0x6687f6e0
 53 [-]: SELF      R12 R12 K12  ; R13 := R12; R12 := R12[0x855eb96d]
 54 [-]: GETUPVAL  R14 U3       ; R14 := U3
 55 [-]: LOADKB    R15 0 0      ; R15 := false
 56 [-]: CALL      R12 4 1      ; R12(R13,R14,R15)
 57 [-]: SELF      R12 R3 K13   ; R13 := R3; R12 := R3[0x2047cfe7]
 58 [-]: CALL      R12 2 2      ; R12 := R12(R13)
 59 [-]: TEST      R12 1        ; if R12 then PC := 149
 60 [-]: JMP       149          ; PC := 149
 61 [-]: GETGLOBAL R12 K0       ; R12 := 0x34291f5c
 62 [-]: GETTABLE  R12 R12 K14  ; R12 := R12[0x35c16153]
 63 [-]: CALL      R12 1 2      ; R12 := R12()
 64 [-]: SELF      R13 R2 K15   ; R14 := R2; R13 := R2[0x327f2778]
 65 [-]: CALL      R13 2 2      ; R13 := R13(R14)
 66 [-]: SELF      R14 R13 K16  ; R15 := R13; R14 := R13[0xc9524d85]
 67 [-]: MOVE      R16 R12      ; R16 := R12
 68 [-]: CALL      R14 3 1      ; R14(R15,R16)
 69 [-]: SELF      R14 R13 K17  ; R15 := R13; R14 := R13[0xea8f8bda]
 70 [-]: MOVE      R16 R12      ; R16 := R12
 71 [-]: CALL      R14 3 1      ; R14(R15,R16)
 72 [-]: CONST     R14 0        ; R14 := 0.000000
 73 [-]: CONST     R15 0        ; R15 := 0.000000
 74 [-]: CONST     R16 12       ; R16 := 12.000000
 75 [-]: CONST     R17 1        ; R17 := 1.000000
 76 [-]: FORPREP   R15 81       ; R15 -= R17; PC := 81
 77 [-]: SELF      R19 R12 K18  ; R20 := R12; R19 := R12[0x56b2aae2]
 78 [-]: MOVE      R21 R18      ; R21 := R18
 79 [-]: CALL      R19 3 2      ; R19 := R19(R20,R21)
 80 [-]: ADD       R14 R14 R19  ; R14 := R14 + R19
 81 [-]: FORLOOP   R15 77       ; R15 += R17; if R15 <= R16 then begin PC := 77; R18 := R15 end
 82 [-]: GETGLOBAL R19 K0       ; R19 := 0x34291f5c
 83 [-]: GETTABLE  R19 R19 K14  ; R19 := R19[0x35c16153]
 84 [-]: CALL      R19 1 2      ; R19 := R19()
 85 [-]: GETUPVAL  R20 U2       ; R20 := U2
 86 [-]: MUL       R20 R20 R14  ; R20 := R20 * R14
 87 [-]: MUL       R20 R20 R4   ; R20 := R20 * R4
 88 [-]: SETTABLE  R19 K19 R20  ; R19["baseAmount"] := R20
 89 [-]: SETTABLE  R19 K20 K3   ; R19["hitType"] := 5.000000
 90 [-]: SELF      R20 R19 K21  ; R21 := R19; R20 := R19[0x1586e35e]
 91 [-]: CONST     R22 6        ; R22 := 6.000000
 92 [-]: CONST     R23 1        ; R23 := 1.000000
 93 [-]: CALL      R20 4 1      ; R20(R21,R22,R23)
 94 [-]: SELF      R20 R19 K22  ; R21 := R19; R20 := R19[0xfc0e440a]
 95 [-]: CONST     R22 6        ; R22 := 6.000000
 96 [-]: LOADKB    R23 1 0      ; R23 := true
 97 [-]: CALL      R20 4 1      ; R20(R21,R22,R23)
 98 [-]: SELF      R20 R19 K23  ; R21 := R19; R20 := R19[0x86cd00cb]
 99 [-]: MOVE      R22 R10      ; R22 := R10
100 [-]: CALL      R20 3 1      ; R20(R21,R22)
101 [-]: SELF      R20 R19 K24  ; R21 := R19; R20 := R19[0xf4dc3420]
102 [-]: MOVE      R22 R0       ; R22 := R0
103 [-]: CALL      R20 3 1      ; R20(R21,R22)
104 [-]: SELF      R20 R19 K25  ; R21 := R19; R20 := R19[0xca73dd2a]
105 [-]: CONST     R22 0        ; R22 := 0.000000
106 [-]: CALL      R20 3 1      ; R20(R21,R22)
107 [-]: EQ        0 R9 K26     ; if R9 ~= 3.000000 then PC := 113
108 [-]: JMP       113          ; PC := 113
109 [-]: GETTABLE  R20 R19 K19  ; R20 := R19["baseAmount"]
110 [-]: GETUPVAL  R21 U4       ; R21 := U4
111 [-]: MUL       R20 R20 R21  ; R20 := R20 * R21
112 [-]: SETTABLE  R19 K19 R20  ; R19["baseAmount"] := R20
113 [-]: SELF      R20 R3 K27   ; R21 := R3; R20 := R3[0xc1595bd5]
114 [-]: GETGLOBAL R22 K28      ; R22 := 0xd271f31b
115 [-]: CALL      R20 3 2      ; R20 := R20(R21,R22)
116 [-]: GETGLOBAL R21 K29      ; R21 := 0xc8802016
...
123 [-]: TEST      R26 1        ; if R26 then PC := 135
124 [-]: JMP       135          ; PC := 135
125 [-]: SELF      R26 R25 K30  ; R27 := R25; R26 := R25[0xd2715720]
126 [-]: CALL      R26 2 2      ; R26 := R26(R27)
127 [-]: SELF      R27 R25 K31  ; R28 := R25; R27 := R25[0x8fc72941]
128 [-]: CALL      R27 2 2      ; R27 := R27(R28)
129 [-]: EQ        0 R26 R27    ; if R26 ~= R27 then PC := 135
130 [-]: JMP       135          ; PC := 135
131 [-]: SELF      R26 R25 K32  ; R27 := R25; R26 := R25[0x479483bb]
132 [-]: MOVE      R28 R19      ; R28 := R19
133 [-]: CALL      R26 3 1      ; R26(R27,R28)
134 [-]: JMP       137          ; PC := 137
135 [-]: TFORLOOP  R21 2        ; R24,R25 :=  R21(R22,R23); if R24 ~= nil then begin PC = 120; R23 := R24 end
136 [-]: JMP       120          ; PC := 120
137 [-]: GETGLOBAL R26 K4       ; R26 := 0x7b998233
138 [-]: MOVE      R27 R3       ; R27 := R3
139 [-]: CALL      R26 2 2      ; R26 := R26(R27)
140 [-]: TEST      R26 1        ; if R26 then PC := 149
141 [-]: JMP       149          ; PC := 149
142 [-]: SELF      R26 R3 K13   ; R27 := R3; R26 := R3[0x2047cfe7]
143 [-]: CALL      R26 2 2      ; R26 := R26(R27)
144 [-]: TEST      R26 1        ; if R26 then PC := 149
145 [-]: JMP       149          ; PC := 149
146 [-]: SELF      R26 R3 K32   ; R27 := R3; R26 := R3[0x479483bb]
147 [-]: MOVE      R28 R19      ; R28 := R19
148 [-]: CALL      R26 3 1      ; R26(R27,R28)
149 [-]: GETGLOBAL R26 K4       ; R26 := 0x7b998233
150 [-]: MOVE      R27 R3       ; R27 := R3
151 [-]: CALL      R26 2 2      ; R26 := R26(R27)
152 [-]: TEST      R26 1        ; if R26 then PC := 180
153 [-]: JMP       180          ; PC := 180
154 [-]: SELF      R26 R3 K13   ; R27 := R3; R26 := R3[0x2047cfe7]
155 [-]: CALL      R26 2 2      ; R26 := R26(R27)
156 [-]: TEST      R26 0        ; if not R26 then PC := 180
157 [-]: JMP       180          ; PC := 180
158 [-]: SELF      R26 R0 K33   ; R27 := R0; R26 := R0[0x5063edc3]
159 [-]: GETUPVAL  R28 U5       ; R28 := U5
160 [-]: CALL      R26 3 2      ; R26 := R26(R27,R28)
161 [-]: LT        0 K34 R26    ; if 0.000000 >= R26 then PC := 180
162 [-]: JMP       180          ; PC := 180
163 [-]: SELF      R26 R0 K35   ; R27 := R0; R26 := R0[0x75ecaf0b]
164 [-]: GETUPVAL  R28 U5       ; R28 := U5
165 [-]: CALL      R26 3 2      ; R26 := R26(R27,R28)
166 [-]: EQ        0 R26 K37    ; if R26 ~= 1.000000 then PC := 180
167 [-]: JMP       180          ; PC := 180
168 [-]: GETGLOBAL R26 K38      ; R26 := 0x8ea4f530
169 [-]: EQ        0 R9 K26     ; if R9 ~= 3.000000 then PC := 172
170 [-]: JMP       172          ; PC := 172
171 [-]: GETGLOBAL R26 K39      ; R26 := 0xfa60e288
172 [-]: GETGLOBAL R27 K40      ; R27 := 0x89326c93
173 [-]: SELF      R27 R27 K41  ; R28 := R27; R27 := R27[0x05909209]
174 [-]: MOVE      R29 R26      ; R29 := R26
175 [-]: SELF      R30 R3 K42   ; R31 := R3; R30 := R3[0xef8e8f7f]
176 [-]: CALL      R30 2 2      ; R30 := R30(R31)
177 [-]: GETGLOBAL R31 K43      ; R31 := ZERO_ROTATION
178 [-]: MOVE      R32 R10      ; R32 := R10
179 [-]: CALL      R27 6 1      ; R27(R28,R29,R30,R31,R32)
180 [-]: GETGLOBAL R27 K10      ; R27 := 0x6687f6e0
181 [-]: SELF      R27 R27 K12  ; R28 := R27; R27 := R27[0x855eb96d]
182 [-]: GETUPVAL  R29 U3       ; R29 := U3
