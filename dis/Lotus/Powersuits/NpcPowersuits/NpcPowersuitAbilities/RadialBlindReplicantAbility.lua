...
L 0:  36 [-]: LOADN R8 4   ; var8 = 4
      37 [-]: JUMPIFNOTEQ R7 R8 L1; goto L1 if var7 ~= var264764
...
L 4:  75 [-]: GETIMPORT R10 23; var10 = 0x2B436E72
      ...
      80 [-]: LOADK R13 K29; var13 = 0.013000000268220901
      81 [-]: LOADN R14 0  ; var14 = 0
      82 [-]: LOADK R15 K30; var15 = -0.013000000268220901
...
L12: 166 [-]: JUMPIF R10 L14; goto L14 if var10
     ...
     174 [-]: JUMPIFNOTEQ R10 R7 L14; goto L14 if var10 ~= var68656
...
L16: 207 [-]: JUMPIF R12 L27; goto L27 if var12
     ...
     210 [-]: JUMPIFNOTLT R13 R12 L27; goto L27 if var13 >= var4131873
...
L19: 231 [-]: MOVE R21 R16 ; var21 = var16
     ...
     237 [-]: JUMPIFNOTLT R20 R19 L20; goto L20 if var20 >= var1053998
...
L23: 267 [-]: MOVE R22 R16 ; var22 = var16
     ...
     273 [-]: JUMPIFNOTLT R21 R20 L26; goto L26 if var21 >= var5680
...
L 2:  20 [-]: JUMPIF R5 L6 ; goto L6 if var5
      ...
      23 [-]: JUMPIFNOTLT R6 R5 L6; goto L6 if var6 >= var853281
...
L 1:  18 [-]: LOADN R6 1   ; var6 = 1
      ...
      26 [-]: JUMPIFNOTLT R7 R4 L7; goto L7 if var7 >= var132924
      ...
      36 [-]: JUMPIFNOTEQ R5 R7 L4; goto L4 if var5 ~= var50544701
...
L 4:  46 [-]: LOADN R7 4   ; var7 = 4
      47 [-]: JUMPIFNOTEQ R5 R7 L7; goto L7 if var5 ~= var50544701
...
L13: 178 [-]: NAMECALL R15 R14 K63; var16 = var14; var15 = var14[0xA5E492D4]
     ...
     186 [-]: JUMPIFNOTLE R16 R17 L14; goto L14 if var16 > var-771747577
...
L18: 253 [-]: LOADN R15 4  ; var15 = 4
     254 [-]: JUMPIFNOTEQ R6 R15 L20; goto L20 if var6 ~= var1838881
