...
L 4:  33 [-]: GETTABLEKS R3 R2 K2 ["avatar"]
      ...
      41 [-]: GETIMPORT R6 16 [0xC2892F65]
      42 [-]: MOVE R7 R5   
      43 [-]: CALL R6 1 0  
      44 [-]: NAMECALL R6 R1 K17 [0x2EC61863]
      45 [-]: CALL R6 1 1  
      46 [-]: GETIMPORT R7 19 [0xF6C6E505]
      47 [-]: MOVE R8 R6   
      48 [-]: CALL R7 1 1  
      49 [-]: LOADN R8 0   
      50 [-]: SETTABLEKS R8 R7 K14 ["y"]
      51 [-]: GETIMPORT R8 16 [0xC2892F65]
      52 [-]: MOVE R9 R7   
      53 [-]: CALL R8 1 0  
...
L 3:  19 [-]: NAMECALL R6 R1 K6 [0xFA9E477F]
      ...
      26 [-]: CALL R7 -1 0 
      27 [-]: GETIMPORT R9 11 [0x04616611]
      28 [-]: LOADB R10 0  
      29 [-]: LOADN R11 0  
      30 [-]: LOADB R12 1  
      31 [-]: NAMECALL R7 R1 K12 [0x659D451F]
      32 [-]: CALL R7 5 0  
      33 [-]: GETIMPORT R9 14 [0x5DC88037]
      34 [-]: LOADB R10 1  
      35 [-]: LOADN R11 3  
      36 [-]: LOADN R12 1  
      37 [-]: LOADB R13 0  
      ...
      39 [-]: CALL R7 6 0  
L 4:  40 [-]: GETIMPORT R9 14 [0x5DC88037]
      41 [-]: NAMECALL R7 R1 K16 [0x22EB4BBC]
      42 [-]: CALL R7 2 1  
      43 [-]: JUMPIF R7 L5 
      44 [-]: GETIMPORT R9 14 [0x5DC88037]
...
L 5:  48 [-]: NAMECALL R7 R1 K18 [0xF6EBD926]
      ...
      64 [-]: CALL R10 3 0 
      65 [-]: GETIMPORT R10 27 [0xCBD666E1]
      66 [-]: LOADN R11 0  
      67 [-]: CALL R10 1 0 
      68 [-]: JUMPBACK L4  
L 6:  69 [-]: LOADN R9 24  
      70 [-]: GETIMPORT R10 29 [0x55156FF7]
      71 [-]: CALL R10 0 -1
      ...
      82 [-]: GETIMPORT R12 33 [0xF6C6E505]
      83 [-]: MOVE R13 R11 
      84 [-]: CALL R12 1 1 
      85 [-]: MOVE R9 R12  
      86 [-]: MOVE R10 R11 
      ...
      96 [-]: CALL R10 2 0 
      97 [-]: GETIMPORT R10 38 [0x89326C93]
      98 [-]: GETIMPORT R12 40 [0xA04C5AD0]
     ...
     107 [-]: CALL R10 2 0 
     108 [-]: GETIMPORT R12 44 [0xA88DE0C9]
     109 [-]: LOADB R13 0  
     110 [-]: LOADN R14 2  
     111 [-]: LOADN R15 2  
     112 [-]: LOADB R16 1  
     ...
     114 [-]: CALL R10 6 0 
     115 [-]: GETIMPORT R11 46 [0x91BE34E1]
     116 [-]: MUL R10 R7 R11
     117 [-]: LOADN R11 -100
     ...
     128 [-]: MOVE R16 R11 
     129 [-]: MOVE R17 R11 
     130 [-]: GETIMPORT R18 51 [0x35C16153]
     131 [-]: CALL R18 0 1 
     132 [-]: LOADN R19 50 
     133 [-]: SETTABLEKS R19 R18 K52 ["baseAmount"]
     134 [-]: GETIMPORT R21 54 [0x0C212CB3]
     135 [-]: LOADN R22 1  
     136 [-]: NAMECALL R19 R18 K55 [0x1586E35E]
     137 [-]: CALL R19 3 0 
     138 [-]: GETIMPORT R21 57 [0x5EBB02A2]
     139 [-]: LOADB R22 1  
...
L 7: 150 [-]: JUMPIFNOT R12 L13
     ...
     157 [-]: GETIMPORT R20 2 [0x7B998233]
     158 [-]: CALL R20 1 1 
L 8: 159 [-]: JUMPIF R20 L9
     ...
     190 [-]: CALL R22 1 1 
     191 [-]: GETIMPORT R23 66 [0x3190A9CC]
     192 [-]: MUL R21 R22 R23
...
L 9: 201 [-]: NAMECALL R20 R1 K20 [0xD1586535]
     202 [-]: CALL R20 1 1 
     203 [-]: MOVE R17 R20 
     204 [-]: GETIMPORT R20 74 [0x03EA2485]
     205 [-]: MOVE R21 R11 
     206 [-]: MOVE R22 R17 
     207 [-]: CALL R20 2 1 
     208 [-]: MOVE R14 R20 
     209 [-]: GETIMPORT R20 74 [0x03EA2485]
     210 [-]: MOVE R21 R17 
     211 [-]: MOVE R22 R16 
     212 [-]: CALL R20 2 1 
     213 [-]: MOVE R15 R20 
     214 [-]: MOVE R16 R17 
     215 [-]: GETIMPORT R20 76 [0xAC9AFA0B]
     216 [-]: JUMPIFNOTLT R20 R14 L10
     217 [-]: NAMECALL R20 R1 K34 [0x020D4331]
     218 [-]: CALL R20 1 1 
     219 [-]: GETIMPORT R22 78 ["ZERO_VECTOR"]
     220 [-]: NAMECALL R20 R20 K48 [0xCDADCD5D]
     221 [-]: CALL R20 2 0 
     222 [-]: LOADB R12 0  
     223 [-]: JUMP L12
    
L10: 224 [-]: GETIMPORT R20 80 [0x3BD062E9]
     ...
     230 [-]: CALL R20 1 1 
     231 [-]: GETIMPORT R22 78 ["ZERO_VECTOR"]
...
L11: 236 [-]: LOADN R13 0  
L12: 237 [-]: GETIMPORT R20 27 [0xCBD666E1]
     238 [-]: LOADN R21 0  
     239 [-]: CALL R20 1 0 
     240 [-]: JUMPBACK L7  
