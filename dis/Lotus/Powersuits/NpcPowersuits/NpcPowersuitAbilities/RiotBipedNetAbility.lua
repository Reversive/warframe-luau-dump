...
L 0:  11 [-]: LOADN R2 0   
      12 [-]: RETURN R2 1  
L 1:  13 [-]: GETIMPORT R2 8 [0xE28E5D65]
      14 [-]: JUMPIF R2 L2 
...
L 5:  42 [-]: JUMPIF R9 L6 
      ...
      50 [-]: CALL R9 1 1  
      51 [-]: JUMPIF R9 L6 
      52 [-]: GETIMPORT R11 23 [0xB7FC2D52]
      ...
      59 [-]: GETIMPORT R10 27 [0x4243A037]
      60 [-]: JUMPIFNOTLE R10 R9 L6
      61 [-]: MOVE R4 R9   
      62 [-]: MOVE R3 R8   
L 6:  63 [-]: FORNLOOP R5 L4
L 7:  64 [-]: GETIMPORT R5 15 [0x86F495D5]
      65 [-]: JUMPIFLT R5 R4 L9
      66 [-]: FASTCALL1 62 R3 L8
      67 [-]: MOVE R6 R3   
      68 [-]: GETIMPORT R5 18 [0x7B998233]
      69 [-]: CALL R5 1 1  
...
L 0:   4 [-]: JUMPIFNOT R4 L1
       5 [-]: RETURN R0 0  
L 1:   6 [-]: GETIMPORT R5 3 [0x0ED8B456]
       7 [-]: FASTCALL1 62 R5 L2
       8 [-]: GETIMPORT R4 1 [0x7B998233]
       9 [-]: CALL R4 1 1  
L 2:  10 [-]: JUMPIF R4 L4 
      11 [-]: GETIMPORT R4 5 [0xF2169FB0]
      12 [-]: JUMPIFNOT R4 L3
      13 [-]: GETIMPORT R6 7 [0x7652C062]
      14 [-]: GETIMPORT R9 3 [0x0ED8B456]
      15 [-]: LOADB R10 0  
      16 [-]: LOADN R11 2  
      17 [-]: LOADN R12 1  
      18 [-]: LOADB R13 1  
...
L 3:  24 [-]: GETIMPORT R6 7 [0x7652C062]
      25 [-]: GETIMPORT R9 3 [0x0ED8B456]
      26 [-]: LOADB R10 0  
      27 [-]: LOADN R11 2  
      28 [-]: LOADN R12 1  
      29 [-]: LOADB R13 0  
      ...
      34 [-]: CALL R4 -1 0 
L 4:  35 [-]: GETIMPORT R4 12 [0x89326C93]
...
L 9:  57 [-]: NAMECALL R5 R2 K16 [0xF6EBD926]
      ...
      60 [-]: CALL R6 1 1  
      61 [-]: SUB R4 R5 R6 
      62 [-]: GETIMPORT R5 18 [0xAE2294FA]
      63 [-]: MOVE R6 R4   
      64 [-]: CALL R5 1 1  
      65 [-]: GETIMPORT R6 20 [0xC2892F65]
      66 [-]: MOVE R7 R4   
      67 [-]: CALL R6 1 0  
      68 [-]: GETIMPORT R6 22 [0x20B7F774]
      69 [-]: GETIMPORT R7 24 ["ZERO_VECTOR"]
      70 [-]: MOVE R8 R4   
      71 [-]: CALL R6 2 1  
      72 [-]: GETIMPORT R7 26 [0x4243A037]
      73 [-]: JUMPIFLT R5 R7 L10
      74 [-]: LOADN R7 1   
      75 [-]: JUMPIFNOTLT R5 R7 L11
L10:  76 [-]: GETIMPORT R7 28 [0x20459BA9]
      77 [-]: SETTABLEKS R7 R6 K29 ["pitch"]
      78 [-]: JUMP L13
    
L11:  79 [-]: GETIMPORT R12 26 [0x4243A037]
      80 [-]: SUB R11 R5 R12
      81 [-]: LOADN R13 1  
      82 [-]: GETIMPORT R15 31 [0x86F495D5]
      83 [-]: GETIMPORT R16 26 [0x4243A037]
      84 [-]: SUB R14 R15 R16
      85 [-]: FASTCALL2 18 R13 R14 L12
      86 [-]: GETIMPORT R12 34 [0xB62ECFE0]
      87 [-]: CALL R12 2 1 
L12:  88 [-]: DIV R10 R11 R12
      89 [-]: MINUS R9 R10 
      90 [-]: GETIMPORT R11 36 [0x91424F93]
      91 [-]: GETIMPORT R12 28 [0x20459BA9]
      92 [-]: SUB R10 R11 R12
      93 [-]: MUL R8 R9 R10
      94 [-]: GETIMPORT R9 28 [0x20459BA9]
      95 [-]: ADD R7 R8 R9 
      96 [-]: SETTABLEKS R7 R6 K29 ["pitch"]
L13:  97 [-]: GETIMPORT R9 38 [0x931BA514]
      98 [-]: NAMECALL R7 R1 K39 [0x003C792F]
      99 [-]: CALL R7 2 1  
     100 [-]: GETIMPORT R8 12 [0x89326C93]
     101 [-]: GETIMPORT R10 41 [0x74DCAE95]
     102 [-]: MOVE R11 R7  
     103 [-]: MOVE R12 R6  
