...
; Max Stack Size:  12
      ...
      16 [-]: CALL R2 1 1  
      17 [-]: GETIMPORT R4 10 [0x88EC88A0]
      18 [-]: GETIMPORT R7 12 [0x148BAC1C]
...
L 0:  11 [-]: JUMPIF R3 L1 
      ...
      13 [-]: CALL R3 1 0  
L 1:  14 [-]: GETIMPORT R5 10 [0xCE9CC7B2]
      ...
      20 [-]: CALL R4 1 1  
L 2:  21 [-]: JUMPIF R4 L3 
      22 [-]: GETIMPORT R6 12 [0x50D26EEF]
      23 [-]: LOADB R7 1   
      24 [-]: LOADB R8 0   
      25 [-]: LOADN R9 1   
      26 [-]: NAMECALL R4 R3 K13 [0x5D985C7E]
      27 [-]: CALL R4 5 0  
      28 [-]: GETIMPORT R6 15 [0x1243BC4F]
      29 [-]: LOADB R7 1   
      30 [-]: LOADB R8 0   
      31 [-]: LOADN R9 1   
      32 [-]: NAMECALL R4 R3 K13 [0x5D985C7E]
      33 [-]: CALL R4 5 0  
L 3:  34 [-]: GETIMPORT R4 1 [0x89326C93]
      35 [-]: NAMECALL R4 R4 K16 [0x29EF273D]
      36 [-]: CALL R4 1 1  
      37 [-]: GETIMPORT R6 18 [0x88EC88A0]
      38 [-]: GETIMPORT R9 20 [0x148BAC1C]
...
L 5:  53 [-]: NAMECALL R5 R4 K25 [0xBB610E5B]
      ...
      66 [-]: MOVE R7 R5   
      67 [-]: CALL R6 1 0  
      68 [-]: GETIMPORT R6 27 [0xCBD666E1]
      69 [-]: LOADK R7 K28 [2.5]
      70 [-]: CALL R6 1 0  
      71 [-]: FASTCALL1 62 R3 L6
      72 [-]: MOVE R7 R3   
      73 [-]: GETIMPORT R6 7 [0x7B998233]
      74 [-]: CALL R6 1 1  
L 6:  75 [-]: JUMPIF R6 L7 
      76 [-]: GETIMPORT R8 30 [0x928DA50C]
      77 [-]: LOADB R9 0   
      78 [-]: LOADB R10 0  
      79 [-]: LOADN R11 1  
