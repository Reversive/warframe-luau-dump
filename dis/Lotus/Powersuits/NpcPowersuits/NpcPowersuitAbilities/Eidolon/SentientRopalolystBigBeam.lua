...
; Max Stack Size:  6
       ...
       2 [-]: LOADN R3 0   ; var3 = 0
       3 [-]: JUMPIFEQ R2 R3 L0; goto L0 if var2 == var583
       4 [-]: LOADN R2 0   ; var2 = 0
       5 [-]: RETURN R2 1  ; 
...
L 3:  12 [-]: GETIMPORT R2 3; var2 = 0xC0DA2B81
      ...
      24 [-]: JUMPIFNOTLE R3 R2 L4; goto L4 if var3 > var590926
      25 [-]: GETIMPORT R4 9; var4 = 0x86F495D5
      26 [-]: GETIMPORT R5 9; var5 = 0x86F495D5
      27 [-]: MUL R3 R4 R5 ; var3 = var4 * var5
      28 [-]: JUMPIFNOTLE R2 R3 L4; goto L4 if var2 > var66331
...
L 7:  39 [-]: LOADN R6 1   ; var6 = 1
      40 [-]: JUMPIFNOTLT R5 R6 L17; goto L17 if var5 >= var1181262
...
L11:  84 [-]: LOADK R10 K34; var10 = 0.96599999999999997
      85 [-]: JUMPIFLT R10 R9 L12; goto L12 if var10 < var16779291
...
L27: 223 [-]: GETUPVAL R10 1; var10 = upvalues[1]
     ...
     227 [-]: JUMPIFNOT R10 L38; goto L38 if not var10
     ...
     248 [-]: CALL R14 0 0 ; var14, ... = var14(var15, ...)
     249 [-]: FASTCALL 2 L28; 
     250 [-]: GETIMPORT R13 33; var13 = 0x5BCED4C4[0xE4A5B3CA]
     251 [-]: CALL R13 0 2 ; var13 = var13(var14, ...)
L28: 252 [-]: LOADK R14 K34; var14 = 0.96599999999999997
     253 [-]: JUMPIFLT R14 R13 L29; goto L29 if var14 < var16780315
...
L31: 289 [-]: NAMECALL R13 R1 K4; var14 = var1; var13 = var1[0x73901ACF]
     ...
     300 [-]: JUMPIFNOT R13 L38; goto L38 if not var13
...
L32: 307 [-]: JUMPIF R14 L37; goto L37 if var14
     308 [-]: JUMPIFNOTEQ R13 R2 L33; goto L33 if var13 ~= var-234746299
...
L33: 327 [-]: GETIMPORT R16 82; var16 = gScriptTriggerType
     ...
     330 [-]: JUMPIFNOT R14 L36; goto L36 if not var14
     ...
     338 [-]: JUMPXEQKS R14 K88 L37 NOT; 
L34: 339 [-]: NAMECALL R15 R13 K89; var16 = var13; var15 = var13[0xF37943FF]
     340 [-]: CALL R15 2 2 ; var15 = var15(var16)
     341 [-]: JUMPIF R15 L35; goto L35 if var15
     342 [-]: NAMECALL R15 R13 K90; var16 = var13; var15 = var13[0x383D2E7D]
     343 [-]: CALL R15 2 1 ; var15(var16)
     344 [-]: LOADB R7 1   ; var7 = true
L35: 345 [-]: GETIMPORT R16 93; var16 = _T["RopalolystConduitTriggers"]
     346 [-]: LENGTH R15 R16; var15 = #var16
     347 [-]: JUMPXEQKN R15 K94 L37 NOT; 
     348 [-]: GETIMPORT R15 95; var15 = _T
     349 [-]: GETIMPORT R16 97; var16 = 0x0469F296
     350 [-]: LOADK R17 K98; var17 = "Charged"
     351 [-]: CALL R16 2 2 ; var16 = var16(var17)
     352 [-]: SETTABLEKS R16 R15 K99; var16["RopalolystReminderTag"] = var15
     353 [-]: JUMP L37     ; goto L37
L36: 354 [-]: LOADN R5 0   ; var5 = 0
L37: 355 [-]: GETIMPORT R14 20; var14 = 0x67652851
     356 [-]: CALL R14 1 2 ; var14 = var14()
     357 [-]: ADD R9 R9 R14; var9 = var9 + var14
     358 [-]: JUMPBACK L22 ; goto L22
L38: 359 [-]: FASTCALL1 62 R6 L39; 
     360 [-]: MOVE R11 R6  ; var11 = var6
     361 [-]: GETIMPORT R10 1; var10 = 0x7B998233
     362 [-]: CALL R10 2 2 ; var10 = var10(var11)
L39: 363 [-]: JUMPIF R10 L40; goto L40 if var10
     364 [-]: NAMECALL R10 R6 K100; var11 = var6; var10 = var6[0xA2880940]
     365 [-]: CALL R10 2 1 ; var10(var11)
L40: 366 [-]: JUMPIFNOT R7 L43; goto L43 if not var7
     367 [-]: GETIMPORT R10 7; var10 = 0x89326C93
     368 [-]: NAMECALL R10 R10 K101; var11 = var10; var10 = var10[0x8B5B1F58]
     369 [-]: CALL R10 2 2 ; var10 = var10(var11)
     370 [-]: LOADNIL R11  ; var11 = nil
     371 [-]: LENGTH R12 R10; var12 = #var10
     372 [-]: LOADN R13 2  ; var13 = 2
     373 [-]: JUMPIFNOTLE R13 R12 L41; goto L41 if var13 > var461902
     374 [-]: GETIMPORT R12 7; var12 = 0x89326C93
     375 [-]: GETIMPORT R14 97; var14 = 0x0469F296
     376 [-]: LOADK R15 K102; var15 = "TowerAdds1"
     377 [-]: CALL R14 2 0 ; var14, ... = var14(var15)
     378 [-]: NAMECALL R12 R12 K103; var13 = var12; var12 = var12[0x46A0EBF5]
     379 [-]: CALL R12 0 2 ; var12 = var12(var13, ...)
     380 [-]: MOVE R11 R12 ; var11 = var12
...
L42: 385 [-]: JUMPIF R12 L43; goto L43 if var12
     386 [-]: NAMECALL R12 R11 K104; var13 = var11; var12 = var11[0x36FCC811]
     387 [-]: CALL R12 2 1 ; var12(var13)
     388 [-]: LOADK R14 K105; var14 = "Start"
     389 [-]: NAMECALL R12 R11 K106; var13 = var11; var12 = var11[0x8EB2112D]
     390 [-]: CALL R12 3 1 ; var12(var13, var14)
     391 [-]: LOADB R7 0   ; var7 = false
L43: 392 [-]: GETIMPORT R12 108; var12 = 0x2AABFA78
     393 [-]: LOADB R13 1  ; var13 = true
     394 [-]: LOADN R14 3  ; var14 = 3
     395 [-]: LOADN R15 1  ; var15 = 1
     396 [-]: LOADB R16 1  ; var16 = true
     397 [-]: NAMECALL R10 R1 K16; var11 = var1; var10 = var1[0x5D985C7E]
     398 [-]: CALL R10 7 1 ; var10(var11, var12, var13, var14, var15, var16)
     399 [-]: RETURN R0 0  ; 
