...
L 4:  22 [-]: NAMECALL R4 R3 K7 [0x891629FA]
      ...
      25 [-]: CALL R4 1 1  
      26 [-]: GETIMPORT R5 10 [0x33132FF6]
      27 [-]: JUMPIFNOTLT R5 R4 L5
      28 [-]: LOADN R5 0   
      29 [-]: RETURN R5 1  
L 5:  30 [-]: GETIMPORT R5 12 [0x89326C93]
      ...
      37 [-]: CALL R6 2 1  
      38 [-]: GETIMPORT R7 17 [0x86F495D5]
      39 [-]: JUMPIFNOTLT R7 R6 L7
      40 [-]: GETIMPORT R6 5 [0x261556FA]
      41 [-]: JUMPIFNOT R6 L6
...
L 7:  46 [-]: NAMECALL R8 R1 K18 [0xD1586535]
      47 [-]: CALL R8 1 1  
      48 [-]: LOADN R9 5   
      49 [-]: GETIMPORT R10 20 [0xE3B4B93B]
      50 [-]: LOADB R11 1  
      51 [-]: LOADN R12 5  
      52 [-]: LOADN R13 8  
...
; Max Stack Size:  33
       ...
       6 [-]: JUMPIF R2 L0 
       7 [-]: RETURN R0 0  
L 0:   8 [-]: GETIMPORT R2 7 [0xCBD666E1]
       9 [-]: LOADN R3 3   
      10 [-]: CALL R2 1 0  
...
L 4:  23 [-]: NAMECALL R2 R1 K10 [0xFA9E477F]
      ...
      29 [-]: GETIMPORT R3 9 [0x7B998233]
      30 [-]: CALL R3 1 1  
L 5:  31 [-]: JUMPIFNOT R3 L6
      32 [-]: RETURN R0 0  
L 6:  33 [-]: GETIMPORT R2 4 [0x89326C93]
...
L13:  76 [-]: NAMECALL R6 R1 K15 [0xD1586535]
      ...
      89 [-]: CALL R5 1 1  
      90 [-]: GETIMPORT R8 22 [0xDB106B8B]
      91 [-]: NAMECALL R6 R1 K23 [0x003C792F]
      92 [-]: CALL R6 2 1  
      93 [-]: ADD R4 R5 R6 
      94 [-]: GETIMPORT R5 25 [0x00046924]
      95 [-]: CALL R5 0 1  
      96 [-]: GETIMPORT R7 27 [0xA421AF95]
      97 [-]: LOADN R8 0   
      98 [-]: LOADK R9 K28 [-9.8000000000000007]
      99 [-]: LOADN R10 0  
     100 [-]: CALL R7 3 1  
     101 [-]: GETIMPORT R8 30 [0x272CE85B]
     102 [-]: MUL R6 R7 R8 
L14: 103 [-]: LENGTH R7 R3 
     104 [-]: LOADN R8 0   
     105 [-]: JUMPIFNOTLT R8 R7 L35
     106 [-]: GETIMPORT R7 32 [0x55730E1A]
     107 [-]: LOADN R8 1   
     108 [-]: LENGTH R9 R3 
     109 [-]: CALL R7 2 1  
     ...
     113 [-]: CALL R9 2 1  
     114 [-]: GETIMPORT R10 17 [0xE3B4B93B]
     115 [-]: JUMPIFNOTLT R10 R9 L15
     116 [-]: GETIMPORT R9 36 [0x9C1F3B5A]
     117 [-]: MOVE R10 R3  
     118 [-]: MOVE R11 R7  
     119 [-]: CALL R9 2 0  
     120 [-]: JUMP L34
    
L15: 121 [-]: GETIMPORT R9 27 [0xA421AF95]
     122 [-]: CALL R9 0 1  
     123 [-]: GETIMPORT R10 27 [0xA421AF95]
     ...
     132 [-]: GETIMPORT R11 4 [0x89326C93]
     133 [-]: MOVE R13 R8  
     134 [-]: MOVE R14 R10 
     135 [-]: GETIMPORT R15 43 [0x722CD32C]
     136 [-]: LOADNIL R16  
     137 [-]: MOVE R17 R9  
     ...
     143 [-]: GETIMPORT R11 9 [0x7B998233]
     144 [-]: CALL R11 1 1 
...
L17: 147 [-]: LOADK R12 K44 [0.5]
     ...
     149 [-]: MUL R11 R12 R13
     150 [-]: GETIMPORT R12 46 [0xF2115BFE]
     ...
     162 [-]: GETIMPORT R15 36 [0x9C1F3B5A]
     163 [-]: MOVE R16 R3  
     164 [-]: MOVE R17 R7  
     165 [-]: CALL R15 2 0 
     166 [-]: JUMP L34
...
L18: 167 [-]: MINUS R18 R12
     ...
     174 [-]: GETIMPORT R19 50 [0x34E9F45C]
     175 [-]: CALL R19 1 1 
L19: 176 [-]: SUB R17 R18 R19
     ...
     187 [-]: GETIMPORT R20 50 [0x34E9F45C]
     188 [-]: CALL R20 1 1 
L20: 189 [-]: ADD R18 R19 R20
     ...
     194 [-]: GETIMPORT R15 52 [0xB62ECFE0]
     195 [-]: CALL R15 2 1 
L21: 196 [-]: GETIMPORT R16 54 [0x03EA2485]
     197 [-]: MOVE R17 R4  
     198 [-]: GETIMPORT R18 27 [0xA421AF95]
...
L28: 240 [-]: MOVE R23 R8  
     ...
     242 [-]: LOADN R25 2  
     243 [-]: MOVE R26 R20 
     244 [-]: GETIMPORT R28 60 [0x902F882A]
     245 [-]: ADD R27 R15 R28
     ...
     250 [-]: CALL R22 1 1 
     251 [-]: JUMPIF R22 L30
L29: 252 [-]: GETIMPORT R22 36 [0x9C1F3B5A]
     253 [-]: MOVE R23 R3  
     254 [-]: MOVE R24 R7  
     255 [-]: CALL R22 2 0 
     256 [-]: JUMP L34
...
L30: 257 [-]: NAMECALL R22 R21 K62 [0x4C976EDA]
     ...
     262 [-]: CALL R24 1 1 
     263 [-]: GETIMPORT R25 4 [0x89326C93]
     264 [-]: GETIMPORT R27 66 [0x78403F35]
     265 [-]: MOVE R28 R4  
     266 [-]: MOVE R29 R5  
     ...
     270 [-]: MOVE R27 R25 
     271 [-]: GETIMPORT R26 9 [0x7B998233]
     272 [-]: CALL R26 1 1 
L31: 273 [-]: JUMPIF R26 L32
     274 [-]: GETIMPORT R26 4 [0x89326C93]
     275 [-]: GETIMPORT R28 69 [0x3D0A4865]
     276 [-]: MOVE R29 R4  
     277 [-]: MOVE R30 R5  
     ...
     282 [-]: CALL R26 2 0 
     283 [-]: GETIMPORT R28 30 [0x272CE85B]
     284 [-]: NAMECALL R26 R25 K71 [0xD8E9BAFE]
     285 [-]: CALL R26 2 0 
     286 [-]: GETIMPORT R28 73 [0x89DFA1CF]
     ...
     296 [-]: CALL R27 2 0 
     297 [-]: GETIMPORT R29 78 [0xD5B78A32]
...
L35: 325 [-]: GETIMPORT R7 1 [0x3D106989]
