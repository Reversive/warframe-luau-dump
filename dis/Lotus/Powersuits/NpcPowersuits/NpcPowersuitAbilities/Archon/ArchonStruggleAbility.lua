...
L 6:  38 [-]: JUMPIF R11 L9
      ...
      43 [-]: CALL R11 1 1 
      44 [-]: JUMPIF R11 L9
      45 [-]: GETIMPORT R13 15 ["gTennoAvatarType"]
      46 [-]: NAMECALL R11 R10 K16 [0xF2DEAF69]
      47 [-]: CALL R11 2 1 
      48 [-]: JUMPIFNOT R11 L9
      49 [-]: GETIMPORT R11 18 [0xC0DA2B81]
...
L10:  64 [-]: GETIMPORT R5 10 [0x89326C93]
...
L12:  72 [-]: JUMPIFNOT R5 L13
      73 [-]: LOADN R5 0   
      74 [-]: RETURN R5 1  
L13:  75 [-]: GETIMPORT R5 18 [0xC0DA2B81]
      76 [-]: NAMECALL R6 R4 K6 [0xD1586535]
      77 [-]: CALL R6 1 1  
      78 [-]: MOVE R7 R3   
      79 [-]: CALL R5 2 1  
      80 [-]: GETIMPORT R7 21 [0xA6F847E3]
      81 [-]: GETIMPORT R8 21 [0xA6F847E3]
      82 [-]: MUL R6 R7 R8 
...
L 5:  24 [-]: NAMECALL R6 R1 K6 [0xD1586535]
      ...
      27 [-]: CALL R7 1 1  
      28 [-]: MOVE R8 R6   
      29 [-]: GETIMPORT R9 8 [0xB7CBD06B]
      30 [-]: GETIMPORT R10 10 [0x4243A037]
      31 [-]: GETIMPORT R11 12 [0x86F495D5]
      32 [-]: CALL R9 2 1  
      33 [-]: LOADNIL R10  
      34 [-]: GETIMPORT R11 14 [0xC464E0E9]
      35 [-]: JUMPIFNOT R11 L7
      36 [-]: GETIMPORT R11 1 [0x89326C93]
      37 [-]: GETIMPORT R13 16 [0x8E82F0C9]
      38 [-]: MOVE R14 R6  
      39 [-]: NAMECALL R11 R11 K17 [0xC7B81E8D]
      40 [-]: CALL R11 3 1 
      41 [-]: FASTCALL1 62 R11 L6
      42 [-]: MOVE R13 R11 
      43 [-]: GETIMPORT R12 4 [0x7B998233]
      44 [-]: CALL R12 1 1 
L 6:  45 [-]: JUMPIF R12 L7
      ...
      48 [-]: MOVE R8 R12  
      49 [-]: LOADB R3 1   
L 7:  50 [-]: GETIMPORT R11 1 [0x89326C93]
      ...
      87 [-]: CALL R11 8 0 
      88 [-]: MOVE R13 R6  
      89 [-]: GETIMPORT R14 8 [0xB7CBD06B]
      90 [-]: LOADN R15 0  
      91 [-]: GETIMPORT R16 12 [0x86F495D5]
      92 [-]: CALL R14 2 1 
      ...
      99 [-]: CALL R11 8 0 
     100 [-]: GETIMPORT R13 8 [0xB7CBD06B]
     101 [-]: GETIMPORT R14 30 [0x0B46C687]
...
L 8: 108 [-]: LOADB R11 0  
     109 [-]: LOADNIL R12  
     110 [-]: GETIMPORT R13 1 [0x89326C93]
...
L 9: 118 [-]: JUMPIF R11 L10
     ...
     120 [-]: CALL R13 1 1 
     121 [-]: MOVE R11 R13 
     122 [-]: GETIMPORT R13 36 [0xCBD666E1]
     123 [-]: LOADN R14 0  
     124 [-]: CALL R13 1 0 
     125 [-]: JUMPBACK L9  
...
L11: 129 [-]: JUMPIF R3 L13
     ...
     133 [-]: GETIMPORT R15 16 [0x8E82F0C9]
     134 [-]: MOVE R16 R6  
...
L13: 147 [-]: JUMPIF R3 L14
     148 [-]: GETIMPORT R13 40 [0x0C5E62F9]
     149 [-]: LOADN R14 1  
     150 [-]: LENGTH R15 R12
     151 [-]: CALL R13 2 1 
...
L14: 154 [-]: MOVE R15 R8  
     ...
     161 [-]: MOVE R15 R2  
     162 [-]: GETIMPORT R14 4 [0x7B998233]
     163 [-]: CALL R14 1 1 
L15: 164 [-]: JUMPIF R14 L16
     165 [-]: GETIMPORT R14 44 [0x20B7F774]
     166 [-]: MOVE R15 R8  
...
L16: 175 [-]: MOVE R16 R8  
     ...
     178 [-]: CALL R14 3 0 
     179 [-]: GETIMPORT R14 36 [0xCBD666E1]
     180 [-]: LOADN R15 0  
     181 [-]: CALL R14 1 0 
L17: 182 [-]: FASTCALL1 62 R2 L18
     183 [-]: MOVE R14 R2  
     184 [-]: GETIMPORT R13 4 [0x7B998233]
     185 [-]: CALL R13 1 1 
L18: 186 [-]: JUMPIFNOT R13 L19
     187 [-]: RETURN R0 0  
L19: 188 [-]: GETIMPORT R13 1 [0x89326C93]
     189 [-]: GETIMPORT R15 49 [0x7731D61E]
     ...
     195 [-]: CALL R13 5 1 
     196 [-]: GETIMPORT R14 52 [0xCFC01047]
     197 [-]: MOVE R15 R13 
     198 [-]: CALL R14 1 3 
...
L21: 202 [-]: FORGLOOP R14 L20 2
     203 [-]: GETIMPORT R14 1 [0x89326C93]
     204 [-]: GETIMPORT R16 55 [0xC757A1C4]
     ...
     210 [-]: CALL R14 5 1 
     211 [-]: GETIMPORT R15 52 [0xCFC01047]
     212 [-]: MOVE R16 R14 
     213 [-]: CALL R15 1 3 
...
L23: 217 [-]: FORGLOOP R15 L22 2
     218 [-]: GETIMPORT R15 57 [0x8599D938]
     ...
     223 [-]: SETUPVAL R2 1
     224 [-]: GETUPVAL R15 1
     225 [-]: GETIMPORT R17 60 [0x0469F296]
...
L26: 268 [-]: GETIMPORT R16 76 [0x3D106989]
     ...
     283 [-]: MOVE R18 R16 
     284 [-]: GETIMPORT R17 4 [0x7B998233]
     285 [-]: CALL R17 1 1 
...
L 4:  25 [-]: JUMPIF R1 L5 
      ...
      27 [-]: CALL R1 1 1  
      28 [-]: GETIMPORT R3 13 [0xEFC1DAAC]
      29 [-]: NAMECALL R1 R1 K14 [0x55481E0D]
      30 [-]: CALL R1 2 0  
L 5:  31 [-]: GETIMPORT R1 16 [0x3D106989]
