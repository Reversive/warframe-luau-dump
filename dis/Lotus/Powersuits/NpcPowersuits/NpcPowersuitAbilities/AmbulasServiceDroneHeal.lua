...
L 1:  13 [-]: JUMPIF R10 L9; goto L9 if var10
      ...
      17 [-]: JUMPIFEQ R9 R1 L9; goto L9 if var9 == var-821491124
      ...
      26 [-]: JUMPIFNOTEQ R10 R11 L9; goto L9 if var10 ~= var854561
...
L 2:  37 [-]: JUMPIFNOT R11 L4; goto L4 if not var11
      ...
      40 [-]: LOADK R12 K16; var12 = 0.89999997615814209
      41 [-]: JUMPIFNOTLT R11 R12 L6; goto L6 if var11 >= var1182753
      42 [-]: GETIMPORT R12 18; var12 = 0x443A8D0B
      43 [-]: GETIMPORT R13 18; var13 = 0x443A8D0B
      44 [-]: MUL R11 R12 R13; var11 = var12 * var13
      45 [-]: JUMPIFNOTLE R10 R11 L3; goto L3 if var10 > var590894
...
L 1:   6 [-]: GETIMPORT R4 3; var4 = 0xC0DA2B81
      ...
      15 [-]: JUMPIFNOTLT R5 R4 L2; goto L2 if var5 >= var65571
      16 [-]: RETURN R0 0  ; 
...
L 4:  47 [-]: GETIMPORT R11 24; var11 = 0x9B110393
      ...
      61 [-]: ADDK R13 R9 K31; var13 = var9 + 0.89999997615814209
L 5:  62 [-]: GETIMPORT R14 33; var14 = 0xE15169D2
      63 [-]: JUMPIFNOTLT R9 R14 L12; goto L12 if var9 >= var50479165
...
L 6:  68 [-]: JUMPIF R14 L12; goto L12 if var14
      ...
      83 [-]: JUMPIFNOTLT R14 R4 L7; goto L7 if var14 >= var1542
...
L 7:  86 [-]: LOADB R6 1   ; var6 = true
      ...
      92 [-]: JUMPIFLE R10 R14 L12; goto L12 if var10 <= var2559777
     ...
     102 [-]: JUMPIFNOTLT R16 R12 L9; goto L9 if var16 >= var51121213
...
L 9: 111 [-]: JUMPIFNOTLT R13 R9 L11; goto L11 if var13 >= var1543638860
     ...
     117 [-]: JUMPIFNOTLE R15 R16 L10; goto L10 if var15 > var1543639116
...
L10: 123 [-]: ADDK R13 R9 K31; var13 = var9 + 0.89999997615814209
...
L13: 140 [-]: JUMPIF R14 L15; goto L15 if var14
     ...
     148 [-]: JUMPIFNOTLT R14 R12 L15; goto L15 if var14 >= var51119933
