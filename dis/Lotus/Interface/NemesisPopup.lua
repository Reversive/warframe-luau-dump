...
103 [-]: JMP       106          ; PC := 106
104 [-]: LOADBOOL  R3 0 1       ; R3 := false; PC := 105
...
115 [-]: JMP       118          ; PC := 118
116 [-]: LOADBOOL  R3 0 1       ; R3 := false; PC := 117
117 [-]: LOADBOOL  R3 1 0       ; R3 := true
