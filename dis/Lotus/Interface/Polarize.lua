...
; Max Stack Size:  33
 ...
 25 [-]: OP_LOADBOOL R19 0 0      ; R19 := false
 ...
 36 [-]: OP_LOADBOOL R24 0 0      ; R24 := false
...
; Max Stack Size:  6
 ...
 72 [-]: JMP       75           ; PC := 75
 73 [-]: OP_LOADBOOL R3 0 0       ; R3 := false
...
156 [-]: OP_LOADBOOL R10 0 0      ; R10 := false
...
181 [-]: OP_LOADBOOL R3 0 0       ; R3 := false
...
200 [-]: OP_LOADBOOL R3 1 0       ; R3 := true
...
254 [-]: OP_LOADBOOL R6 1 0       ; R6 := true
...
272 [-]: JMP       274          ; PC := 274
273 [-]: OP_LOADBOOL R4 0 1       ; R4 := false; PC := 274
274 [-]: OP_LOADBOOL R4 1 0       ; R4 := true
...
308 [-]: JMP       310          ; PC := 310
309 [-]: OP_LOADBOOL R4 0 1       ; R4 := false; PC := 310
310 [-]: OP_LOADBOOL R4 1 0       ; R4 := true
...
334 [-]: JMP       337          ; PC := 337
335 [-]: OP_LOADBOOL R4 0 1       ; R4 := false; PC := 336
336 [-]: OP_LOADBOOL R4 1 0       ; R4 := true
...
346 [-]: JMP       348          ; PC := 348
347 [-]: OP_LOADBOOL R4 0 1       ; R4 := false; PC := 348
348 [-]: OP_LOADBOOL R4 1 0       ; R4 := true
...
389 [-]: JMP       391          ; PC := 391
390 [-]: OP_LOADBOOL R4 0 1       ; R4 := false; PC := 391
391 [-]: OP_LOADBOOL R4 1 0       ; R4 := true
...
181 [-]: OP_LOADBOOL R11 0 0      ; R11 := false
...
193 [-]: OP_LOADBOOL R12 1 0      ; R12 := true
