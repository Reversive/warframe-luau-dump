...
L 8:  62 [-]: JUMPIF R3 L12
      63 [-]: GETIMPORT R5 17 ["gLotusInventoryControllerType"]
...
L 9:  74 [-]: JUMPIF R4 L10
      75 [-]: GETIMPORT R6 21 ["gLotusMeleeWeaponType"]
...
L13:  96 [-]: JUMPIF R1 L17
      ...
      99 [-]: CALL R1 1 1  
     100 [-]: GETIMPORT R3 25 [0x0032441C]
     101 [-]: GETTABLEKS R2 R3 K26 ["UIColor_White"]
     102 [-]: GETUPVAL R3 5
     103 [-]: JUMPIFEQ R3 R1 L16
     104 [-]: SETUPVAL R1 5
     105 [-]: LOADN R4 100 
     106 [-]: GETIMPORT R5 28 [0x42DCC9F5]
     107 [-]: GETUPVAL R7 5
...
L15: 152 [-]: LOADK R6 K37 [44526]
     153 [-]: GETIMPORT R8 25 [0x0032441C]
...
; Max Stack Size:  8
      ...
      22 [-]: NAMECALL R0 R0 K3 [0x67BC869F]
      23 [-]: CALL R0 4 0  
      24 [-]: GETIMPORT R0 9 ["HUD_GetAnchorMgr"]
      25 [-]: CALL R0 0 1  
