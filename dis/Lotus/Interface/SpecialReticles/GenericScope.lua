...
; Max Stack Size:  22
 ...
 63 [-]: SETGLOBAL R19 K16      ; Shutdown := R19
 64 [-]: CLOSURE   R19 10       ; R19 := closure(Function #11)
 65 [-]: MOVE      R0 R4        ; R0 := R4
 66 [-]: MOVE      R0 R7        ; R0 := R7
 67 [-]: SETGLOBAL R19 K17      ; SetWeapon := R19
 68 [-]: CLOSURE   R19 11       ; R19 := closure(Function #12)
 ...
 76 [-]: MOVE      R0 R5        ; R0 := R5
 77 [-]: CLOSURE   R21 13       ; R21 := closure(Function #14)
 78 [-]: MOVE      R0 R11       ; R0 := R11
 79 [-]: MOVE      R0 R20       ; R0 := R20
 80 [-]: SETGLOBAL R21 K18      ; SetAiming := R21
 81 [-]: CLOSURE   R21 14       ; R21 := closure(Function #15)
 82 [-]: MOVE      R0 R5        ; R0 := R5
 83 [-]: SETGLOBAL R21 K19      ; IsAiming := R21
 84 [-]: CLOSURE   R21 15       ; R21 := closure(Function #16)
 85 [-]: MOVE      R0 R20       ; R0 := R20
 86 [-]: SETGLOBAL R21 K20      ; SetEnabled := R21
 87 [-]: CLOSURE   R21 16       ; R21 := closure(Function #17)
 88 [-]: SETGLOBAL R21 K21      ; OnFire := R21
 89 [-]: CLOSURE   R21 17       ; R21 := closure(Function #18)
 90 [-]: MOVE      R0 R10       ; R0 := R10
 91 [-]: SETGLOBAL R21 K22      ; ClearCustomReticleAiming := R21
 92 [-]: CLOSURE   R21 18       ; R21 := closure(Function #19)
 93 [-]: SETGLOBAL R21 K23      ; UpdateRangeFinder := R21
 94 [-]: CLOSURE   R21 19       ; R21 := closure(Function #20)
 95 [-]: SETGLOBAL R21 K24      ; ScanUpdate := R21
 96 [-]: CLOSURE   R21 20       ; R21 := closure(Function #21)
 97 [-]: MOVE      R0 R1        ; R0 := R1
 98 [-]: MOVE      R0 R3        ; R0 := R3
 99 [-]: MOVE      R0 R18       ; R0 := R18
100 [-]: SETGLOBAL R21 K25      ; onViewportSizeChanged := R21
101 [-]: CLOSURE   R21 21       ; R21 := closure(Function #22)
102 [-]: MOVE      R0 R11       ; R0 := R11
103 [-]: SETGLOBAL R21 K26      ; HandleHudScale := R21
104 [-]: CLOSURE   R21 22       ; R21 := closure(Function #23)
105 [-]: MOVE      R0 R13       ; R0 := R13
106 [-]: MOVE      R0 R0        ; R0 := R0
107 [-]: MOVE      R0 R4        ; R0 := R4
108 [-]: SETGLOBAL R21 K27      ; OnBuffStacksChanged := R21
109 [-]: CLOSURE   R21 23       ; R21 := closure(Function #24)
110 [-]: SETGLOBAL R21 K28      ; PlayHeadshotAnimation := R21
111 [-]: CLOSURE   R21 24       ; R21 := closure(Function #25)
112 [-]: SETGLOBAL R21 K29      ; OnDamageDone := R21
113 [-]: CLOSURE   R21 25       ; R21 := closure(Function #26)
114 [-]: MOVE      R0 R15       ; R0 := R15
115 [-]: SETGLOBAL R21 K30      ; OnFrameEnter := R21
...
; Max Stack Size:  19
 ...
 49 [-]: JMP       51           ; PC := 51
 50 [-]: LOADBOOL  R11 0 1      ; R11 := false; PC := 51
 51 [-]: LOADBOOL  R11 1 0      ; R11 := true
 52 [-]: LOADK     R12 100      ; R12 := 100.000000
 53 [-]: LOADK     R13 25       ; R13 := 25.000000
...
102 [-]: LOADK     R9 29        ; R9 := 29.000000
103 [-]: GETUPVAL  R10 U4       ; R10 := U4
104 [-]: GETTABLE  R10 R10 K18  ; R10 := R10[0x1142c7a8]
105 [-]: DIV       R11 K12 R0   ; R11 := 1.000000 / R0
106 [-]: LOADK     R12 1        ; R12 := 1.000000
107 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
108 [-]: LOADK     R11 K19      ; R11 := "x"
109 [-]: CONCAT    R10 R10 R11  ; R10 := R10 .. R11
110 [-]: CALL      R6 5 1       ; R6(R7,R8,R9,R10)
111 [-]: GETUPVAL  R6 U0        ; R6 := U0
112 [-]: SELF      R6 R6 K20    ; R7 := R6; R6 := R6[0xca9b5cb1]
113 [-]: CALL      R6 2 2       ; R6 := R6(R7)
114 [-]: GETUPVAL  R7 U0        ; R7 := U0
115 [-]: SELF      R7 R7 K21    ; R8 := R7; R7 := R7[0x547e80ae]
116 [-]: CALL      R7 2 2       ; R7 := R7(R8)
117 [-]: LOADK     R8 K22       ; R8 := ""
118 [-]: LOADK     R9 1         ; R9 := 1.000000
119 [-]: LEN       R10 R6       ; R10 := # R6
120 [-]: LOADK     R11 1        ; R11 := 1.000000
121 [-]: FORPREP   R9 142       ; R9 -= R11; PC := 142
122 [-]: GETGLOBAL R13 K23      ; R13 := EMPTY_SYMBOL
...
129 [-]: GETTABLE  R15 R7 R12   ; R15 := R7[R12]
130 [-]: CALL      R14 2 2      ; R14 := R14(R15)
131 [-]: TEST      R14 1        ; if R14 then PC := 134
132 [-]: JMP       134          ; PC := 134
133 [-]: GETTABLE  R13 R7 R12   ; R13 := R7[R12]
134 [-]: MOVE      R14 R8       ; R14 := R8
135 [-]: GETTABLE  R15 R6 R12   ; R15 := R6[R12]
136 [-]: SELF      R15 R15 K24  ; R16 := R15; R15 := R15[0xafb43737]
137 [-]: LOADBOOL  R17 0 0      ; R17 := false
138 [-]: MOVE      R18 R13      ; R18 := R13
139 [-]: CALL      R15 4 2      ; R15 := R15(R16,R17,R18)
140 [-]: LOADK     R16 K25      ; R16 := "\r\n"
141 [-]: CONCAT    R8 R14 R16   ; R8 := R14 .. R15 .. R16
142 [-]: FORLOOP   R9 122       ; R9 += R11; if R9 <= R10 then begin PC := 122; R12 := R9 end
143 [-]: GETGLOBAL R14 K3       ; R14 := 0xae91e43b
144 [-]: SELF      R14 R14 K17  ; R15 := R14; R14 := R14[0x5f56eeab]
145 [-]: LOADK     R16 K6       ; R16 := "Scope.Reticle.ZoomBuffDescription"
146 [-]: LOADK     R17 29       ; R17 := 29.000000
...
108 [-]: LOADK     R15 11       ; R15 := 11.000000
...
129 [-]: LOADK     R15 11       ; R15 := 11.000000
130 [-]: LOADBOOL  R16 0 0      ; R16 := false
...
158 [-]: LOADK     R16 12       ; R16 := 12.000000
...
165 [-]: LOADK     R16 13       ; R16 := 13.000000
...
; Max Stack Size:  7
  ...
  9 [-]: JMP       12           ; PC := 12
 10 [-]: SELF      R5 R4 K2     ; R6 := R4; R5 := R4[0x32302b4a]
...
; Max Stack Size:  14
 ...
 58 [-]: LOADK     R8 2         ; R8 := 2.000000
 59 [-]: NEWTABLE  R9 2 0       ; R9 := {}
 60 [-]: LOADK     R10 10       ; R10 := 10.000000
 61 [-]: LOADK     R11 4        ; R11 := 4.000000
...
107 [-]: LOADK     R16 11       ; R16 := 11.000000
...
113 [-]: LOADK     R16 29       ; R16 := 29.000000
