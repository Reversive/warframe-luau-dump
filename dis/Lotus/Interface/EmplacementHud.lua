...
; Max Stack Size:  15
 ...
 31 [-]: SETGLOBAL R14 K2       ; SetAmmo := R14
 ...
 38 [-]: MOVE      R0 R5        ; R0 := R5
 39 [-]: MOVE      R0 R6        ; R0 := R6
 40 [-]: SETGLOBAL R14 K3       ; Initialize := R14
 ...
 47 [-]: SETGLOBAL R14 K4       ; Update := R14
...
; Max Stack Size:  9
 ...
 11 [-]: LOADK     R7 -3000     ; R7 := -3000.000000
...
; Max Stack Size:  6
  ...
  8 [-]: GETGLOBAL R2 K0        ; R2 := 0x38f10e85
 ...
 15 [-]: GETGLOBAL R2 K0        ; R2 := 0x38f10e85
 ...
 22 [-]: GETGLOBAL R2 K0        ; R2 := 0x38f10e85
 ...
 29 [-]: GETGLOBAL R2 K0        ; R2 := 0x38f10e85
 ...
 36 [-]: GETGLOBAL R2 K0        ; R2 := 0x38f10e85
 37 [-]: GETGLOBAL R3 K1        ; R3 := 0xae91e43b
 38 [-]: MOVE      R4 R0        ; R4 := R0
...
; Max Stack Size:  8
  ...
  8 [-]: GETGLOBAL R2 K0        ; R2 := 0x42dcc9f5
  9 [-]: GETUPVAL  R3 U3        ; R3 := U3
 10 [-]: GETTABLE  R3 R3 K1     ; R82 := R3[0x74a11ec6]
 ...
 18 [-]: LOADK     R4 K2        ; R4 := "Heat"
 19 [-]: MOVE      R5 R2        ; R5 := R2
 20 [-]: CALL      R3 3 1       ; R3(R4,R5)
 21 [-]: GETGLOBAL R3 K3        ; R3 := 0xae91e43b
 22 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3[0xaade900e]
 23 [-]: LOADK     R5 K5        ; R5 := "Heat.Warning"
 24 [-]: LOADK     R6 11        ; R6 := 11.000000
 25 [-]: LE        1 R1 K6      ; if R1 <= 0.350000 then PC := 28
 26 [-]: JMP       28           ; PC := 28
...
; Max Stack Size:  8
  ...
  9 [-]: GETUPVAL  R3 U3        ; R3 := U3
 10 [-]: GETTABLE  R3 R3 K1     ; R82 := R3[0x74a11ec6]
 11 [-]: SUB       R4 K2 R1     ; R4 := 1.000000 - R1
 ...
 23 [-]: SELF      R3 R3 K5     ; R4 := R3; R3 := R3[0xaade900e]
 24 [-]: LOADK     R5 K6        ; R5 := "Integrity.Warning"
 25 [-]: LOADK     R6 11        ; R6 := 11.000000
 26 [-]: LE        1 R1 K7      ; if R1 <= 0.350000 then PC := 29
 27 [-]: JMP       29           ; PC := 29
...
; Max Stack Size:  8
 ...
 19 [-]: LOADK     R4 -3000     ; R4 := -3000.000000
 20 [-]: CALL      R0 5 1       ; R0(R1,R2,R3,R4)
 21 [-]: GETGLOBAL R0 K0        ; R0 := 0xae91e43b
 22 [-]: SELF      R0 R0 K3     ; R1 := R0; R0 := R0[0x20b98db3]
 23 [-]: LOADK     R2 K4        ; R2 := "Heat.Label.text"
 24 [-]: LOADK     R3 K5        ; R3 := "/Lotus/Language/Menu/Emplacement_Ammo"
 25 [-]: CALL      R0 4 1       ; R0(R1,R2,R3)
 26 [-]: GETGLOBAL R0 K0        ; R0 := 0xae91e43b
 27 [-]: SELF      R0 R0 K3     ; R1 := R0; R0 := R0[0x20b98db3]
 28 [-]: LOADK     R2 K6        ; R2 := "Integrity.Label.text"
 29 [-]: LOADK     R3 K7        ; R3 := "/Lotus/Language/Menu/Emplacement_Health"
 30 [-]: CALL      R0 4 1       ; R0(R1,R2,R3)
 31 [-]: GETGLOBAL R0 K0        ; R0 := 0xae91e43b
 32 [-]: SELF      R0 R0 K8     ; R1 := R0; R0 := R0[0x91a24e4b]
 33 [-]: LOADK     R2 K9        ; R2 := "Heat.Top.Left"
 34 [-]: LOADK     R3 8         ; R3 := 8.000000
 35 [-]: CALL      R0 4 2       ; R0 := R0(R1,R2,R3)
 36 [-]: SETUPVAL  R0 U1        ; U82 := 
 37 [-]: GETGLOBAL R0 K0        ; R0 := 0xae91e43b
 38 [-]: SELF      R0 R0 K8     ; R1 := R0; R0 := R0[0x91a24e4b]
 39 [-]: LOADK     R2 K10       ; R2 := "Integrity.Top.Left"
 40 [-]: LOADK     R3 8         ; R3 := 8.000000
 41 [-]: CALL      R0 4 2       ; R0 := R0(R1,R2,R3)
 42 [-]: SETUPVAL  R0 U2        ; U82 := 
 43 [-]: GETGLOBAL R0 K0        ; R0 := 0xae91e43b
 44 [-]: SELF      R0 R0 K11    ; R1 := R0; R0 := R0[0xcd73323e]
 45 [-]: CALL      R0 2 2       ; R0 := R0(R1)
 46 [-]: SETUPVAL  R0 U3        ; U82 := 
 47 [-]: GETGLOBAL R0 K12       ; R0 := 0x7b998233
 48 [-]: GETUPVAL  R1 U3        ; R1 := U3
 49 [-]: CALL      R0 2 2       ; R0 := R0(R1)
 50 [-]: TEST      R0 1         ; if R0 then PC := 90
 51 [-]: JMP       90           ; PC := 90
 52 [-]: GETUPVAL  R0 U3        ; R0 := U3
 53 [-]: SELF      R0 R0 K13    ; R1 := R0; R0 := R0[0x73a8846a]
 ...
 62 [-]: SELF      R0 R0 K14    ; R1 := R0; R0 := R0[0xd6bd1155]
 63 [-]: CALL      R0 2 2       ; R0 := R0(R1)
 64 [-]: SETUPVAL  R0 U5        ; U82 := 
 65 [-]: GETUPVAL  R0 U3        ; R0 := U3
 66 [-]: SELF      R0 R0 K15    ; R1 := R0; R0 := R0[0x8fc72941]
 67 [-]: CALL      R0 2 2       ; R0 := R0(R1)
 68 [-]: SETUPVAL  R0 U6        ; U82 := 
 69 [-]: GETUPVAL  R0 U3        ; R0 := U3
 70 [-]: SELF      R0 R0 K16    ; R1 := R0; R0 := R0[0xf9108c00]
 ...
 78 [-]: SELF      R1 R1 K17    ; R2 := R1; R1 := R1[0xe395d771]
 79 [-]: MOVE      R3 R0        ; R3 := R0
 80 [-]: GETUPVAL  R4 U3        ; R4 := U3
 81 [-]: SELF      R4 R4 K18    ; R5 := R4; R4 := R4[0x2110c3cf]
 82 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 83 [-]: GETUPVAL  R5 U3        ; R5 := U3
 84 [-]: SELF      R5 R5 K19    ; R6 := R5; R5 := R5[0x50fec064]
 85 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 86 [-]: GETUPVAL  R6 U3        ; R6 := U3
 87 [-]: SELF      R6 R6 K20    ; R7 := R6; R6 := R6[0x092a5197]
...
; Max Stack Size:  3
 ...
 22 [-]: SELF      R1 R1 K4     ; R2 := R1; R1 := R1[0x7a7373f5]
 ...
 32 [-]: SELF      R1 R1 K5     ; R2 := R1; R1 := R1[0xd2715720]
