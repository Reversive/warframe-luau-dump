...
; Max Stack Size:  4
 ...
 43 [-]: SETTABLE  R0 K8 R1     ; R0["Background3"] := R1
 ...
 51 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x5d10207d]
 52 [-]: CONST     R2 3         ; R2 := 3.000000
 ...
 71 [-]: GETTABLE  R1 R1 K15    ; R1 := R1[0x9f57dd7d]
 ...
 78 [-]: GETTABLE  R1 R1 K15    ; R1 := R1[0x9f57dd7d]
 ...
 85 [-]: GETTABLE  R1 R1 K15    ; R1 := R1[0x9f57dd7d]
...
; Max Stack Size:  4
 ...
 11 [-]: GETTABLE  R0 R0 K5     ; R0 := R0[0x80172c74]
 12 [-]: CALL      R0 1 1       ; R0()
 ...
 26 [-]: GETTABLE  R0 R0 K9     ; R0 := R0[0x56d89411]
 27 [-]: LOADKB    R1 0 0       ; R1 := false
 28 [-]: CALL      R0 2 1       ; R0(R1)
 29 [-]: GETUPVAL  R0 U2        ; R0 := U2
 30 [-]: GETTABLE  R0 R0 K10    ; R0 := R0[0x15deabb1]
...
; Max Stack Size:  3
 ...
 11 [-]: GETTABLE  R1 R1 K5     ; R1 := R1[0x1c5b5b33]
 ...
 18 [-]: GETTABLE  R1 R1 K7     ; R1 := R1[0x4e4e6b0c]
 19 [-]: CALL      R1 1 1       ; R1()
 20 [-]: JMP       23           ; PC := 23
...
; Max Stack Size:  6
  ...
  3 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x1c5b546f]
...
; Max Stack Size:  4
 ...
 11 [-]: GETTABLE  R1 R1 K3     ; R1 := R1[0x6d147816]
...
; Max Stack Size:  2
  ...
  1 [-]: GETUPVAL  R0 U0        ; R0 := U0
  2 [-]: GETTABLE  R0 R0 K0     ; R0 := R0[0xf0a898e9]
...
; Max Stack Size:  12
 ...
 32 [-]: GETTABLE  R3 R3 K4     ; R3 := R3[0x06d055f9]
 33 [-]: MOVE      R4 R1        ; R4 := R1
 34 [-]: CONST     R5 340       ; R5 := 340.000000
 35 [-]: CONST     R6 260       ; R6 := 260.000000
...
111 [-]: GETTABLE  R4 R4 K16    ; R4 := R4[0x2f8cf3ac]
...
121 [-]: GETTABLE  R7 R7 K4     ; R7 := R7[0x06d055f9]
...
133 [-]: GETTABLE  R7 R7 K4     ; R7 := R7[0x06d055f9]
...
145 [-]: GETTABLE  R7 R7 K4     ; R7 := R7[0x06d055f9]
...
141 [-]: GETTABLE  R1 R1 K40    ; R1 := R1[0x1467d5f4]
...
153 [-]: GETTABLE  R1 R1 K43    ; R1 := R1[0x2f8cf3ac]
154 [-]: MOVE      R2 R0        ; R2 := R0
155 [-]: CALL      R1 2 1       ; R1(R2)
156 [-]: GETUPVAL  R1 U0        ; R1 := U0
157 [-]: GETTABLE  R1 R1 K44    ; R1 := R1[0xf0a898e9]
...
; Max Stack Size:  12
 ...
 82 [-]: GETTABLE  R8 R8 K0     ; R8 := R8[0x06d055f9]
 83 [-]: MOVE      R9 R1        ; R9 := R1
 84 [-]: CONST     R10 100      ; R10 := 100.000000
 85 [-]: CONST     R11 50       ; R11 := 50.000000
 ...
 94 [-]: GETTABLE  R8 R8 K0     ; R8 := R8[0x06d055f9]
 95 [-]: MOVE      R9 R1        ; R9 := R1
 96 [-]: CONST     R10 100      ; R10 := 100.000000
 97 [-]: CONST     R11 50       ; R11 := 50.000000
...
; Max Stack Size:  4
  ...
  9 [-]: GETTABLE  R1 R1 K4     ; R1 := R1[0x056bfe8b]
...
; Max Stack Size:  25
 ...
 72 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x23d5322f]
 73 [-]: MOVE      R2 R0        ; R2 := R0
 ...
 95 [-]: GETTABLE  R1 R1 K1     ; R1 := R1[0x23d5322f]
 96 [-]: MOVE      R2 R0        ; R2 := R0
...
180 [-]: GETTABLE  R17 R17 K58  ; R17 := R17[0x1467d5f4]
...
193 [-]: CONST     R17 40       ; R17 := 40.000000
194 [-]: CONST     R18 100      ; R18 := 100.000000
195 [-]: GETUPVAL  R19 U3       ; R19 := U3
196 [-]: GETTABLE  R19 R19 K61  ; R19 := R19[0x74a11ec6]
...
135 [-]: CONST     R7 260       ; R7 := 260.000000
136 [-]: CONST     R8 1         ; R8 := 1.000000
137 [-]: SETLIST   R6 2 1       ; R6[(1-1)*FPF+i] := R(6+i), 1 <= i <= 2
138 [-]: CONST     R7 0         ; R7 := 0.250000
...
; Max Stack Size:  9
 ...
 67 [-]: CONST     R3 2         ; R3 := 2.000000
 68 [-]: NEWTABLE  R4 1 0       ; R4 := {}
 69 [-]: CONST     R5 10        ; R5 := 10.000000
...
; Max Stack Size:  9
 ...
 33 [-]: GETTABLE  R0 R0 K7     ; R0 := R0[0xa460d8df]
 ...
 63 [-]: SETUPVAL  R0 U2        ; U82 := R2
 64 [-]: NEWTABLE  R0 5 0       ; R0 := {}
 65 [-]: CONST     R1 2         ; R1 := 2.000000
 ...
 80 [-]: GETTABLE  R5 R5 K24    ; R5 := R5[0x23d5322f]
...
; Max Stack Size:  7
  ...
  8 [-]: GETTABLE  R0 R0 K2     ; R0 := R0[0x3b0face1]
  9 [-]: CALL      R0 1 1       ; R0()
 10 [-]: GETUPVAL  R0 U1        ; R0 := U1
 11 [-]: GETTABLE  R0 R0 K3     ; R0 := R0[0x56d89411]
 12 [-]: LOADKB    R1 1 0       ; R1 := true
 13 [-]: CALL      R0 2 1       ; R0(R1)
 14 [-]: GETUPVAL  R0 U1        ; R0 := U1
 15 [-]: GETTABLE  R0 R0 K4     ; R0 := R0[0x15deabb1]
 ...
 32 [-]: GETTABLE  R0 R0 K8     ; R0 := R0[0x659d451f]
