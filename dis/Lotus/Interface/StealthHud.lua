...
; Max Stack Size:  13
       ...
       2 [-]: RETURN R0 0  
L 0:   3 [-]: GETIMPORT R6 3 [0x3B32B92D]
       4 [-]: DIVK R5 R6 K1 [2]
       5 [-]: MUL R4 R0 R5 
       6 [-]: SUBK R6 R0 K5 [1]
       7 [-]: MULK R5 R6 K4 [7]
      ...
      18 [-]: CALL R4 3 1  
      19 [-]: ADDK R3 R4 K6 [35]
      20 [-]: GETIMPORT R4 16 ["NumSegments"]
...
L 1:  23 [-]: GETUPVAL R5 0
      ...
      39 [-]: MOVE R11 R4  
      40 [-]: CALL R5 6 0  
      41 [-]: GETIMPORT R5 21 [0x25312C9B]
      42 [-]: GETIMPORT R6 8 [0xAE91E43B]
...
; Max Stack Size:  10
       ...
       0 [-]: LOADN R2 1   
       1 [-]: GETIMPORT R0 3 ["NumSegments"]
       2 [-]: LOADN R1 1   
       3 [-]: FORNPREP R0 L1
L 0:   4 [-]: LOADK R4 K4 ["PipContainer.List.Element"]
       5 [-]: GETIMPORT R5 6 [0x64FB1586]
       6 [-]: MOVE R6 R2   
       7 [-]: CALL R5 1 1  
       8 [-]: CONCAT R3 R4 R5
      ...
      11 [-]: LOADK R7 K9 ["Fill"]
      12 [-]: LOADN R8 12  
      13 [-]: GETIMPORT R9 11 [0x3B32B92D]
      14 [-]: NAMECALL R4 R4 K12 [0xF64B7262]
      15 [-]: CALL R4 5 0  
      16 [-]: FORNLOOP R0 L0
L 1:  17 [-]: GETUPVAL R0 0
      18 [-]: GETIMPORT R1 3 ["NumSegments"]
      19 [-]: LOADB R2 1   
      20 [-]: CALL R0 2 0  
      21 [-]: RETURN R0 0  
...
; Max Stack Size:  8
       ...
       0 [-]: GETIMPORT R0 2 ["DetectionHud_Info"]
       ...
       7 [-]: CALL R0 1 0  
       8 [-]: RETURN R0 0  
L 0:   9 [-]: GETIMPORT R0 10 ["HUD_GetAnchorMgr"]
      10 [-]: CALL R0 0 1  
      11 [-]: GETIMPORT R3 7 [0xAE91E43B]
      ...
      49 [-]: GETUPVAL R1 1
      50 [-]: CALL R1 0 0  
      51 [-]: GETIMPORT R1 23 ["GetHudScale"]
      52 [-]: CALL R1 0 1  
...
L 0:  22 [-]: JUMPIFNOT R2 L2
      ...
      25 [-]: GETIMPORT R3 12 [0x2972D202]
      26 [-]: CALL R2 1 1  
      27 [-]: SETUPVAL R2 1
      28 [-]: JUMP L2
     
L 1:  29 [-]: GETIMPORT R2 5 [0xAE91E43B]
      30 [-]: LOADK R4 K6 ["PipContainer"]
      31 [-]: LOADN R5 10  
      32 [-]: NAMECALL R2 R2 K13 [0x91A24E4B]
      33 [-]: CALL R2 3 1  
      34 [-]: GETIMPORT R3 15 [0x42DCC9F5]
      35 [-]: GETIMPORT R6 18 [0x67652851]
      36 [-]: CALL R6 0 1  
...
L 4:  61 [-]: GETUPVAL R3 0
      ...
      63 [-]: GETIMPORT R2 22 [0x99675E23]
      64 [-]: CALL R2 1 1  
L 5:  65 [-]: FASTCALL1 7 R0 L6
      66 [-]: MOVE R4 R0   
      67 [-]: GETIMPORT R3 22 [0x99675E23]
      68 [-]: CALL R3 1 1  
L 6:  69 [-]: JUMPIFEQ R2 R3 L9
      70 [-]: LOADK R3 K23 ["PipContainer.List.Element"]
      71 [-]: GETIMPORT R4 25 [0x64FB1586]
      72 [-]: GETUPVAL R6 0
      73 [-]: FASTCALL1 7 R6 L7
      74 [-]: GETIMPORT R5 22 [0x99675E23]
      75 [-]: CALL R5 1 1  
L 7:  76 [-]: CALL R4 1 1  
      77 [-]: CONCAT R2 R3 R4
      78 [-]: GETIMPORT R3 27 [0x89326C93]
      79 [-]: GETIMPORT R5 29 [0xCF74D4CC]
      80 [-]: GETIMPORT R6 31 ["ZERO_VECTOR"]
      81 [-]: LOADB R7 0   
      82 [-]: LOADN R8 1   
      ...
      88 [-]: MOVE R5 R2   
      89 [-]: GETIMPORT R6 34 [0x0849FF2F]
      90 [-]: GETIMPORT R8 37 [0x3B32B92D]
      91 [-]: DIVK R7 R8 K35 [2]
      92 [-]: LOADN R8 0   
      93 [-]: CALL R3 5 0  
     ...
     102 [-]: MOVE R5 R0   
     103 [-]: GETIMPORT R4 22 [0x99675E23]
     104 [-]: CALL R4 1 1  
L 8: 105 [-]: CALL R3 1 0  
L 9: 106 [-]: LOADK R3 K23 ["PipContainer.List.Element"]
     107 [-]: GETIMPORT R4 25 [0x64FB1586]
     108 [-]: FASTCALL1 7 R0 L10
     109 [-]: MOVE R6 R0   
     110 [-]: GETIMPORT R5 22 [0x99675E23]
     111 [-]: CALL R5 1 1  
L10: 112 [-]: CALL R4 1 1  
     113 [-]: CONCAT R2 R3 R4
     114 [-]: LOADN R3 1   
     ...
     116 [-]: MOVE R5 R0   
     117 [-]: GETIMPORT R4 40 [0x55F27C30]
     118 [-]: CALL R4 1 1  
L11: 119 [-]: JUMPIFEQ R0 R4 L13
     120 [-]: FASTCALL1 12 R0 L12
     121 [-]: MOVE R5 R0   
     122 [-]: GETIMPORT R4 40 [0x55F27C30]
     123 [-]: CALL R4 1 1  
L12: 124 [-]: SUB R3 R0 R4 
L13: 125 [-]: GETIMPORT R4 5 [0xAE91E43B]
     126 [-]: MOVE R6 R2   
     127 [-]: LOADK R7 K41 ["Fill"]
     128 [-]: LOADN R8 12  
     129 [-]: GETIMPORT R10 37 [0x3B32B92D]
     130 [-]: MUL R9 R10 R3
...
; Max Stack Size:  4
       ...
       1 [-]: GETIMPORT R3 4 ["Chimera_Restart"]
       2 [-]: NOT R2 R3    
       3 [-]: NAMECALL R0 R0 K5 [0x368AD758]
       4 [-]: CALL R0 2 0  
       5 [-]: GETIMPORT R0 1 [0xAE91E43B]
       6 [-]: GETIMPORT R2 7 [0x67652851]
       7 [-]: CALL R2 0 -1 
      ...
      11 [-]: CALL R0 0 0  
      12 [-]: GETUPVAL R0 1
      13 [-]: GETIMPORT R1 10 ["Chimera_FailureCount"]
      14 [-]: JUMPIFEQ R0 R1 L0
      15 [-]: GETIMPORT R0 10 ["Chimera_FailureCount"]
      16 [-]: SETUPVAL R0 1
      17 [-]: GETUPVAL R0 2
      18 [-]: CALL R0 0 0  
L 0:  19 [-]: RETURN R0 0  
