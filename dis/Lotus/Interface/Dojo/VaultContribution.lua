...
L 0:  15 [-]: GETUPVAL R8 0
      ...
      18 [-]: GETIMPORT R10 4 ["gFusionTreasureType"]
      19 [-]: NAMECALL R8 R8 K5 [0xF2DEAF69]
      20 [-]: CALL R8 2 1  
      21 [-]: JUMPIFNOT R8 L2
      22 [-]: GETIMPORT R8 8 [0x92EB260B]
...
L 2:  33 [-]: GETUPVAL R10 1
      ...
      37 [-]: MOVE R12 R2  
      38 [-]: CALL R9 3 1  
      39 [-]: GETIMPORT R10 17 [0x925E2BBB]
      40 [-]: GETTABLEKS R11 R7 K2 ["Type"]
      41 [-]: GETTABLEKS R12 R7 K10 ["Count"]
      42 [-]: CALL R10 2 -1
      43 [-]: FASTCALL 52 L3
      44 [-]: GETIMPORT R8 14 [0x23D5322F]
      45 [-]: CALL R8 -1 0 
...
L 5:  52 [-]: GETIMPORT R5 23 ["mGameRules"]
      53 [-]: GETUPVAL R7 4
      54 [-]: GETUPVAL R8 5
      55 [-]: MOVE R9 R4   
      56 [-]: GETUPVAL R10 6
...
L 4:  53 [-]: GETIMPORT R2 2 [0x603636AD]
...
L 9:  94 [-]: GETIMPORT R3 18 ["_T"]
     ...
     120 [-]: LOADB R10 0 +1
L10: 121 [-]: LOADB R10 1  
L11: 122 [-]: GETIMPORT R11 33 [0x04981AB3]
     123 [-]: GETUPVAL R12 1
     124 [-]: CALL R11 1 1 
     125 [-]: GETUPVAL R12 1
     126 [-]: CALL R9 3 1  
     ...
     137 [-]: GETIMPORT R4 38 [0x9BA7909F]
     138 [-]: GETIMPORT R7 40 [0x0032441C]
...
L 1:   8 [-]: GETIMPORT R1 1 ["_T"]
      ...
      15 [-]: GETIMPORT R1 6 ["GetScreenRes"]
      16 [-]: LOADK R2 K7 ["Inventory"]
      17 [-]: CALL R1 1 1  
      18 [-]: GETIMPORT R2 9 [0x9BA7909F]
      19 [-]: MOVE R4 R1   
...
L 2:  26 [-]: LENGTH R3 R1 
      ...
      33 [-]: SETUPVAL R3 2
      34 [-]: RETURN R0 0  
L 3:  35 [-]: GETIMPORT R3 14 [0x9BA7909F]
      36 [-]: GETIMPORT R6 16 [0x0032441C]
...
; Max Stack Size:  17
       ...
       2 [-]: JUMPIF R2 L0 
       3 [-]: RETURN R0 0  
L 0:   4 [-]: GETIMPORT R2 2 [0x76EA806B]
       5 [-]: LOADN R4 0   
...
L 4:  23 [-]: GETUPVAL R3 0
      ...
      25 [-]: CALL R3 1 1  
      26 [-]: SETUPVAL R3 1
      27 [-]: GETIMPORT R3 10 ["ChangeHubVisCounter"]
      28 [-]: LOADN R4 1   
      29 [-]: CALL R3 1 0  
      30 [-]: GETUPVAL R3 0
      31 [-]: NAMECALL R3 R3 K11 [0x713CE380]
      32 [-]: CALL R3 1 1  
      33 [-]: GETIMPORT R4 14 ["mGameRules"]
...
L10: 113 [-]: GETUPVAL R6 10
     ...
     117 [-]: GETIMPORT R6 39 [0xCBD666E1]
     118 [-]: LOADN R7 0   
     119 [-]: CALL R6 1 0  
     120 [-]: JUMPBACK L10 
...
L15: 159 [-]: MOVE R10 R6  
     ...
     165 [-]: FORNLOOP R7 L14
L16: 166 [-]: GETIMPORT R7 47 [0x603636AD]
...
L17: 191 [-]: GETIMPORT R10 47 [0x603636AD]
     ...
     198 [-]: CALL R10 2 1 
     199 [-]: MOVE R9 R10  
     200 [-]: GETIMPORT R10 47 [0x603636AD]
...
L19: 228 [-]: GETUPVAL R11 11
     ...
     238 [-]: MOVE R13 R11 
     239 [-]: GETIMPORT R12 5 [0x7B998233]
     240 [-]: CALL R12 1 1 
...
L21: 246 [-]: GETUPVAL R10 10
     ...
     248 [-]: GETIMPORT R10 39 [0xCBD666E1]
     249 [-]: LOADN R11 0  
     250 [-]: CALL R10 1 0 
     251 [-]: JUMPBACK L21 
...
L24: 268 [-]: GETIMPORT R7 47 [0x603636AD]
     269 [-]: MOVE R8 R6   
     270 [-]: DUPTABLE R9 76
     271 [-]: GETUPVAL R10 15
     ...
     282 [-]: GETIMPORT R9 47 [0x603636AD]
...
L25: 288 [-]: GETIMPORT R9 47 [0x603636AD]
...
L26: 293 [-]: MOVE R9 R7   
     294 [-]: LOADK R10 K79 [" "]
     295 [-]: GETIMPORT R11 47 [0x603636AD]
     ...
     305 [-]: CALL R9 2 0  
L27: 306 [-]: GETIMPORT R6 10 ["ChangeHubVisCounter"]
     307 [-]: LOADN R7 -1  
     308 [-]: CALL R6 1 0  
     309 [-]: RETURN R0 0  
