...
107 [-]: CONST     R11 100      ; R11 := 100.000000
108 [-]: SETLIST   R10 1 1      ; R10[(1-1)*FPF+i] := R(10+i), 1 <= i <= 1
109 [-]: CONST     R11 0        ; R11 := 0.250000
