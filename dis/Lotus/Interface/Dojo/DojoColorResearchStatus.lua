...
L 3:  11 [-]: GETIMPORT R0 4; var0 = 0x34291F5C[0x397B920F]
      ...
      28 [-]: JUMPIFLE R0 R2 L4; goto L4 if var0 <= var16777499
...
L 3:  31 [-]: GETTABLEKS R7 R6 K13; var7 = var6["mState"]
      ...
      41 [-]: JUMPIFNOTLT R8 R7 L6; goto L6 if var8 >= var1799
...
L 7:  58 [-]: GETUPVAL R3 0; var3 = upvalues[0]
      ...
      62 [-]: JUMPIFEQ R3 R1 L12; goto L12 if var3 == var794
...
L15: 165 [-]: GETIMPORT R2 48; var2 = 0x7F5022CF[0x3F3E4D12]
     ...
     196 [-]: JUMPIFLT R9 R8 L16; goto L16 if var9 < var16779035
...
L24: 263 [-]: GETTABLE R12 R7 R10; var12 = var7[var10]
     ...
     266 [-]: JUMPIFNOTEQ R11 R12 L25; goto L25 if var11 ~= var4328270
...
L28: 308 [-]: GETIMPORT R5 35; var5 = 0xAE91E43B
     ...
     316 [-]: JUMPIFNOTLT R6 R5 L30; goto L30 if var6 >= var1351
...
L 5:  31 [-]: GETUPVAL R1 4; var1 = upvalues[4]
      ...
      35 [-]: JUMPIFNOTLT R2 R1 L6; goto L6 if var2 >= var262663
      ...
      41 [-]: JUMPIFNOTLE R1 R2 L6; goto L6 if var1 > var786766
...
L 6:  60 [-]: GETUPVAL R1 8; var1 = upvalues[8]
      ...
      64 [-]: JUMPIFNOTLT R2 R1 L7; goto L7 if var2 >= var524807
...
L 7:  68 [-]: GETUPVAL R1 9; var1 = upvalues[9]
      ...
      74 [-]: JUMPIFNOTLE R1 R2 L10; goto L10 if var1 > var283
