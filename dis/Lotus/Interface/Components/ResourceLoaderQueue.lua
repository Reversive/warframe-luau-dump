...
; Max Stack Size:  7
 ...
 14 [-]: GETGLOBAL R4 K8        ; R4 := 0xbe190284
 15 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 16 [-]: TEST      R3 1         ; if R3 then PC := 23
 17 [-]: JMP       23           ; PC := 23
 18 [-]: GETGLOBAL R3 K8        ; R3 := 0xbe190284
 19 [-]: SELF      R3 R3 K9     ; R4 := R3; R3 := R3[0x8e07e77f]
 20 [-]: MOVE      R5 R1        ; R5 := R1
 21 [-]: GETTABLE  R6 R0 K10    ; R6 := R0["mCallback"]
 22 [-]: CALL      R3 4 1       ; R3(R4,R5,R6)
 23 [-]: SETTABLE  R0 K6 K11    ; R0["mLoading"] := true
...
; Max Stack Size:  9
  ...
  2 [-]: LEN       R2 R2        ; R2 := # R2
  3 [-]: LT        0 K1 R2      ; if 0.000000 >= R2 then PC := 36
  4 [-]: JMP       36           ; PC := 36
 ...
 11 [-]: JMP       31           ; PC := 31
 12 [-]: GETGLOBAL R3 K5        ; R3 := 0xb009bbc6
 13 [-]: MOVE      R4 R1        ; R4 := R1
 14 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 15 [-]: SELF      R4 R3 K6     ; R5 := R3; R4 := R3[0xf2deaf69]
 16 [-]: GETGLOBAL R6 K7        ; R6 := gTextureType
 17 [-]: CALL      R4 3 2       ; R4 := R4(R5,R6)
 18 [-]: TEST      R4 0         ; if not R4 then PC := 24
 19 [-]: JMP       24           ; PC := 24
 20 [-]: SELF      R4 R3 K8     ; R5 := R3; R4 := R3[0x011cdf03]
 ...
 38 [-]: LEN       R4 R4        ; R4 := # R4
 39 [-]: LT        0 K1 R4      ; if 0.000000 >= R4 then PC := 59
 40 [-]: JMP       59           ; PC := 59
