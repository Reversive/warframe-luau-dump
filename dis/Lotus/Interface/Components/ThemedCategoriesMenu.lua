...
115 [-]: SETTABLE  R4 K73 R5    ; R4["Redraw"] := R5
116 [-]: GETTABLE  R5 R4 K75    ; R5 := R4["OnFirstRedraw"]
117 [-]: SETTABLE  R4 K74 R5    ; R4["_CategoryMenu_OnFirstRedraw"] := R5
118 [-]: CLOSURE   R5 12        ; R5 := closure(Function #1.13)
119 [-]: SETTABLE  R4 K75 R5    ; R4["OnFirstRedraw"] := R5
120 [-]: CLOSURE   R5 13        ; R5 := closure(Function #1.14)
121 [-]: SETTABLE  R4 K76 R5    ; R4["OnGamepadTransition"] := R5
122 [-]: CLOSURE   R5 14        ; R5 := closure(Function #1.15)
123 [-]: SETTABLE  R4 K77 R5    ; R4["GetParentEnv"] := R5
124 [-]: CLOSURE   R5 15        ; R5 := closure(Function #1.16)
125 [-]: SETTABLE  R4 K78 R5    ; R4["HookUpCallbacks"] := R5
126 [-]: SELF      R5 R4 K79    ; R6 := R4; R5 := R4[0xe91c55ec]
127 [-]: CALL      R5 2 1       ; R5(R6)
128 [-]: SELF      R5 R4 K80    ; R6 := R4; R5 := R4[0x71e9ac81]
...
; Max Stack Size:  8
 ...
 10 [-]: GETTABLE  R2 R2 K2     ; R2 := R2[0xf6e70fb6]
...
; Max Stack Size:  7
  ...
  6 [-]: GETTABLE  R2 R2 K3     ; R2 := R2[0x1467d5f4]
  7 [-]: CALL      R2 1 2       ; R2 := R2()
  8 [-]: TEST      R2 1         ; if R2 then PC := 15
  9 [-]: JMP       15           ; PC := 15
 10 [-]: GETGLOBAL R2 K2        ; R2 := 0x34291f5c
 11 [-]: GETTABLE  R2 R2 K4     ; R2 := R2[0x399826a5]
...
; Max Stack Size:  30
 ...
 86 [-]: GETTABLE  R15 R15 K26  ; R15 := R15[0x74a11ec6]
 ...
 98 [-]: GETTABLE  R15 R15 K29  ; R15 := R15[0x06d055f9]
...
; Max Stack Size:  10
 ...
 55 [-]: GETTABLE  R3 R3 K11    ; R3 := R3[0x659d451f]
...
122 [-]: CONST     R19 10       ; R19 := 10.000000
...
129 [-]: CONST     R19 10       ; R19 := 10.000000
...
149 [-]: GETTABLE  R16 R16 K21  ; R16 := R16[0x8bcd12b6]
150 [-]: GETUPVAL  R17 U0       ; R17 := U0
151 [-]: GETTABLE  R17 R17 K3   ; R17 := R17[0x06d055f9]
...
185 [-]: CONST     R21 36       ; R21 := 36.000000
...
; Max Stack Size:  21
 ...
 36 [-]: JMP       38           ; PC := 38
 37 [-]: LOADKB    R11 0 1      ; R11 := false; PC := 38
 ...
 66 [-]: CONST     R10 29       ; R10 := 29.000000
 67 [-]: GETGLOBAL R11 K17      ; R11 := 0x7f5022cf
 68 [-]: GETTABLE  R11 R11 K18  ; R11 := R11[0x3f3e4d12]
 ...
 95 [-]: CONST     R10 33       ; R10 := 33.000000
 96 [-]: CALL      R7 4 2       ; R7 := R7(R8,R9,R10)
 97 [-]: GETUPVAL  R8 U0        ; R8 := U0
 98 [-]: GETTABLE  R8 R8 K26    ; R8 := R8[0x06d055f9]
...
112 [-]: GETTABLE  R8 R8 K29    ; R8 := R8[0xb62ecfe0]
...
158 [-]: CONST     R13 33       ; R13 := 33.000000
...
180 [-]: GETTABLE  R12 R12 K26  ; R12 := R12[0x06d055f9]
...
185 [-]: JMP       187          ; PC := 187
186 [-]: LOADKB    R13 0 1      ; R13 := false; PC := 187
187 [-]: LOADKB    R13 1 0      ; R13 := true
188 [-]: CONST     R14 30       ; R14 := 30.000000
...
206 [-]: CONST     R17 13       ; R17 := 13.000000
...
212 [-]: CONST     R17 12       ; R17 := 12.000000
...
218 [-]: CONST     R17 13       ; R17 := 13.000000
...
224 [-]: CONST     R17 12       ; R17 := 12.000000
...
230 [-]: CONST     R17 12       ; R17 := 12.000000
...
236 [-]: CONST     R17 12       ; R17 := 12.000000
...
317 [-]: CONST     R18 12       ; R18 := 12.000000
...
323 [-]: CONST     R18 13       ; R18 := 13.000000
...
336 [-]: CONST     R18 13       ; R18 := 13.000000
...
; Max Stack Size:  12
 ...
 23 [-]: CONST     R9 29        ; R9 := 29.000000
 24 [-]: GETGLOBAL R10 K11      ; R10 := 0x7f5022cf
 25 [-]: GETTABLE  R10 R10 K12  ; R10 := R10[0x3f3e4d12]
 ...
 37 [-]: SELF      R5 R0 K13    ; R6 := R0; R5 := R0[0x8edbf3cd]
 38 [-]: CALL      R5 2 1       ; R5(R6)
 39 [-]: SELF      R5 R0 K14    ; R6 := R0; R5 := R0[0xafb670c2]
 40 [-]: MOVE      R7 R1        ; R7 := R1
 41 [-]: MOVE      R8 R2        ; R8 := R2
 42 [-]: MOVE      R9 R3        ; R9 := R3
