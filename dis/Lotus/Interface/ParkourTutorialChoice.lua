...
; Max Stack Size:  27
 ...
 84 [-]: CLOSURE   R25 15       ; R25 := closure(Function #16)
 85 [-]: MOVE      R0 R2        ; R0 := R2
 86 [-]: MOVE      R0 R24       ; R0 := R24
 87 [-]: SETGLOBAL R25 K8       ; KickOffCinematicChild := R25
 88 [-]: CLOSURE   R25 16       ; R25 := closure(Function #17)
 89 [-]: MOVE      R0 R2        ; R0 := R2
 90 [-]: MOVE      R0 R24       ; R0 := R24
 91 [-]: CLOSURE   R26 17       ; R26 := closure(Function #18)
 92 [-]: MOVE      R0 R7        ; R0 := R7
 93 [-]: MOVE      R0 R25       ; R0 := R25
 94 [-]: SETGLOBAL R26 K9       ; OnConfirmTutorial := R26
 95 [-]: CLOSURE   R26 18       ; R26 := closure(Function #19)
 96 [-]: SETGLOBAL R26 K10      ; Close := R26
 97 [-]: CLOSURE   R26 19       ; R26 := closure(Function #20)
 98 [-]: MOVE      R0 R18       ; R0 := R18
 99 [-]: SETGLOBAL R26 K11      ; IconCacheFlushed := R26
100 [-]: CLOSURE   R26 20       ; R26 := closure(Function #21)
101 [-]: MOVE      R0 R21       ; R0 := R21
102 [-]: SETGLOBAL R26 K12      ; onViewportSizeChanged := R26
103 [-]: CLOSURE   R26 21       ; R26 := closure(Function #22)
104 [-]: MOVE      R0 R4        ; R0 := R4
105 [-]: MOVE      R0 R10       ; R0 := R10
106 [-]: SETGLOBAL R26 K13      ; onKeyDown_MENU_MOUSE_Z := R26
107 [-]: CLOSURE   R26 22       ; R26 := closure(Function #23)
108 [-]: MOVE      R0 R4        ; R0 := R4
109 [-]: MOVE      R0 R10       ; R0 := R10
110 [-]: SETGLOBAL R26 K14      ; onKeyDown_MENU_RIGHT_Y := R26
111 [-]: CLOSURE   R26 23       ; R26 := closure(Function #24)
112 [-]: MOVE      R0 R4        ; R0 := R4
113 [-]: MOVE      R0 R10       ; R0 := R10
114 [-]: SETGLOBAL R26 K15      ; onKeyUp_MENU_RIGHT_Y := R26
115 [-]: CLOSURE   R26 24       ; R26 := closure(Function #25)
116 [-]: MOVE      R0 R4        ; R0 := R4
117 [-]: SETGLOBAL R26 K16      ; onKeyDown_MENU_CANCEL := R26
118 [-]: CLOSURE   R26 25       ; R26 := closure(Function #26)
119 [-]: SETGLOBAL R26 K17      ; SupportsThemes := R26
...
103 [-]: SETTABLE  R2 K25 R3    ; R2["mScrollStep"] := R3
...
111 [-]: JMP       113          ; PC := 113
112 [-]: LOADKB    R4 0 1       ; R4 := false; PC := 113
...
158 [-]: CONST     R12 10       ; R12 := 10.000000
...
177 [-]: CONST     R15 36       ; R15 := 36.000000
...
; Max Stack Size:  9
 ...
 16 [-]: SETTABLE  R7 K5 R8     ; R7["SubTitle"] := R8
...
; Max Stack Size:  5
  ...
  2 [-]: SELF      R0 R0 K1     ; R1 := R0; R0 := R0[0x58245b4c]
  3 [-]: CALL      R0 2 2       ; R0 := R0(R1)
  4 [-]: GETGLOBAL R1 K2        ; R1 := 0xd1f7992b
  5 [-]: GETTABLE  R1 R1 K3     ; R1 := R1[0x4523e640]
  6 [-]: GETGLOBAL R2 K4        ; R2 := 0x89326c93
  7 [-]: SELF      R2 R2 K5     ; R3 := R2; R2 := R2[0xca9ea368]
  8 [-]: CALL      R2 2 0       ; R2,... := R2(R3)
  9 [-]: CALL      R1 0 2       ; R1 := R1(R2,...)
 10 [-]: GETGLOBAL R2 K6        ; R2 := 0x7ed0a956
 11 [-]: LOADK     R3 K7        ; R3 := "/Lotus/Levels/Proc/PlayerShip"
 12 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 13 [-]: EQ        0 R0 K8      ; if R0 ~= nil then PC := 16
 14 [-]: JMP       16           ; PC := 16
 15 [-]: MOVE      R0 R2        ; R0 := R2
 16 [-]: EQ        0 R1 K8      ; if R1 ~= nil then PC := 24
 17 [-]: JMP       24           ; PC := 24
 18 [-]: GETGLOBAL R3 K4        ; R3 := 0x89326c93
 19 [-]: SELF      R3 R3 K5     ; R4 := R3; R3 := R3[0xca9ea368]
 20 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 21 [-]: TESTSET   R1 R3 1      ; if R3 then PC := 24 else R1 := R3
 22 [-]: JMP       24           ; PC := 24
 23 [-]: MOVE      R1 R2        ; R1 := R2
 24 [-]: EQ        1 R0 R1      ; if R0 == R1 then PC := 30
 25 [-]: JMP       30           ; PC := 30
 26 [-]: GETGLOBAL R3 K9        ; R3 := 0x34291f5c
 27 [-]: GETTABLE  R3 R3 K10    ; R3 := R3[0x8ee24660]
...
; Max Stack Size:  4
 ...
 14 [-]: GETTABLE  R0 R0 K6     ; R0 := R0["StoryLib_PlayingCin"]
 15 [-]: TEST      R0 0         ; if not R0 then PC := 21
 16 [-]: JMP       21           ; PC := 21
 17 [-]: GETGLOBAL R0 K7        ; R0 := 0xcbd666e1
