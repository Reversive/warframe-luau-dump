...
151 [-]: JMP       154          ; PC := 154
152 [-]: LOADKB    R4 0 1       ; R4 := false; PC := 153
153 [-]: LOADKB    R4 1 0       ; R4 := true
...
159 [-]: NOT       R5 R5        ; R5 :=  R5
160 [-]: JMP       163          ; PC := 163
161 [-]: LOADKB    R5 0 1       ; R5 := false; PC := 162
162 [-]: LOADKB    R5 1 0       ; R5 := true
163 [-]: GETUPVAL  R6 U9        ; R6 := U9
164 [-]: GETTABLE  R6 R6 K30    ; R6 := R6[0x06d055f9]
165 [-]: MOVE      R7 R4        ; R7 := R4
166 [-]: CONST     R8 40        ; R8 := 40.000000
...
172 [-]: CONST     R10 11       ; R10 := 11.000000
...
197 [-]: CONST     R11 29       ; R11 := 29.000000
...
203 [-]: CONST     R11 11       ; R11 := 11.000000
...
220 [-]: CONST     R11 13       ; R11 := 13.000000
