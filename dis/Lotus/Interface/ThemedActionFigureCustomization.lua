...
L 5:  74 [-]: GETUPVAL R2 4
      ...
      85 [-]: CALL R2 7 0  
      86 [-]: RETURN R0 0  
L 6:  87 [-]: GETIMPORT R0 9 [nil]
      88 [-]: GETUPVAL R2 1
      89 [-]: LOADB R3 1   
      90 [-]: NAMECALL R0 R0 K26 [0xEF977697]
      91 [-]: CALL R0 3 0  
L 7:  92 [-]: GETIMPORT R0 7 [nil]
...
L11: 345 [-]: GETTABLE R13 R7 R10
     ...
     347 [-]: MOVE R12 R6  
     348 [-]: GETIMPORT R11 66 [nil]
     349 [-]: CALL R11 2 0 
L12: 350 [-]: FORNLOOP R8 L11
L13: 351 [-]: GETIMPORT R7 85 [nil]
     352 [-]: MOVE R8 R6   
     353 [-]: CALL R7 1 3  
...
L15: 391 [-]: GETUPVAL R15 6
     ...
     394 [-]: GETIMPORT R13 97 [nil]
     395 [-]: CALL R13 1 1 
L16: 396 [-]: JUMPIF R13 L20
     397 [-]: GETUPVAL R14 20
     398 [-]: FASTCALL1 62 R14 L17
     399 [-]: GETIMPORT R13 97 [nil]
     400 [-]: CALL R13 1 1 
L17: 401 [-]: JUMPIF R13 L20
     ...
     405 [-]: CALL R13 2 1 
     406 [-]: GETIMPORT R14 100 [nil]
     407 [-]: MOVE R15 R13 
     408 [-]: CALL R14 1 3 
     409 [-]: FORGPREP_NEXT R14 L19
L18: 410 [-]: GETIMPORT R19 91 [nil]
...
L22: 447 [-]: GETTABLEKS R12 R11 K26 ["Tag"]
     ...
     456 [-]: GETIMPORT R12 97 [nil]
     457 [-]: CALL R12 1 1 
L23: 458 [-]: JUMPIF R12 L32
     459 [-]: GETIMPORT R12 110 [nil]
...
L 2:  17 [-]: JUMPIF R1 L3 
      ...
      23 [-]: CALL R2 3 -1 
      24 [-]: CALL R1 -1 0 
L 3:  25 [-]: GETIMPORT R1 16 [nil]
      26 [-]: JUMPXEQKNIL R1 L4 NOT
      27 [-]: GETUPVAL R1 1
      28 [-]: CALL R1 0 0  
      29 [-]: RETURN R0 0  
L 4:  30 [-]: GETIMPORT R1 12 [nil]
...
L 5:  63 [-]: GETUPVAL R2 4
      ...
      73 [-]: GETIMPORT R2 9 [nil]
      74 [-]: CALL R2 1 1  
L 6:  75 [-]: JUMPIF R2 L10
      76 [-]: FASTCALL1 62 R1 L7
      77 [-]: MOVE R3 R1   
      78 [-]: GETIMPORT R2 9 [nil]
      79 [-]: CALL R2 1 1  
...
L13: 150 [-]: GETIMPORT R2 36 [nil]
     151 [-]: GETUPVAL R5 4
     152 [-]: GETTABLEKS R4 R5 K18 ["Anim"]
     153 [-]: LOADB R5 0   
     154 [-]: LOADB R6 0   
     155 [-]: LOADN R7 0   
     156 [-]: GETIMPORT R8 40 [nil]
     157 [-]: CALL R8 0 1  
     158 [-]: LOADN R9 0   
     159 [-]: LOADB R10 0  
     160 [-]: GETUPVAL R12 4
...
L14: 168 [-]: GETIMPORT R2 4 [nil]
     169 [-]: FASTCALL1 62 R2 L15
     170 [-]: GETIMPORT R1 9 [nil]
     171 [-]: CALL R1 1 1  
L15: 172 [-]: JUMPIF R1 L17
     173 [-]: GETIMPORT R1 4 [nil]
