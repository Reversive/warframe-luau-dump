...
; Max Stack Size:  8
 ...
 70 [-]: CONST     R7 70        ; R7 := 70.000000
 71 [-]: SETLIST   R6 1 1       ; R6[(1-1)*FPF+i] := R(6+i), 1 <= i <= 1
 72 [-]: CONST     R7 0         ; R7 := 0.500000
