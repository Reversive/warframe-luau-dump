...
L 3:  20 [-]: JUMPIF R0 L4 
      ...
      24 [-]: CALL R0 2 0  
L 4:  25 [-]: GETIMPORT R0 6 [0x89326C93]
      ...
      34 [-]: CALL R1 1 1  
L 5:  35 [-]: JUMPIF R1 L6 
      36 [-]: GETIMPORT R3 12 [0xB607EFE1]
      37 [-]: LOADB R4 0   
      38 [-]: NAMECALL R1 R0 K13 [0x659D451F]
      39 [-]: CALL R1 3 0  
L 6:  40 [-]: GETIMPORT R1 15 [0xAE91E43B]
...
L 2:  29 [-]: LOADK R9 K12 ["UpdateHistory_Next"]
      ...
      44 [-]: CALL R4 4 0  
      45 [-]: LOADN R1 100 
L 3:  46 [-]: GETIMPORT R2 18 [0x25312C9B]
      47 [-]: GETIMPORT R3 3 [0xAE91E43B]
      ...
      57 [-]: CALL R2 6 0  
      58 [-]: GETIMPORT R3 23 ["SetButtons"]
      59 [-]: FASTCALL1 62 R3 L4
      60 [-]: GETIMPORT R2 25 [0x7B998233]
      61 [-]: CALL R2 1 1  
L 4:  62 [-]: JUMPIF R2 L5 
      63 [-]: GETIMPORT R2 23 ["SetButtons"]
      64 [-]: GETIMPORT R3 3 [0xAE91E43B]
      65 [-]: MOVE R4 R0   
      66 [-]: GETIMPORT R5 27 [0xCD0165A3]
      67 [-]: LOADN R6 1   
      68 [-]: CALL R5 1 1  
      69 [-]: LOADNIL R6   
      70 [-]: LOADB R7 1   
...
; Max Stack Size:  7
       ...
       6 [-]: CALL R1 1 1  
L 0:   7 [-]: JUMPIF R1 L1 
       8 [-]: GETIMPORT R1 4 [0x38F10E85]
       9 [-]: GETIMPORT R2 6 [0xAE91E43B]
...
L 1:  18 [-]: GETTABLEKS R2 R0 K11 ["SoundIndex"]
      ...
      21 [-]: CALL R1 1 1  
L 2:  22 [-]: JUMPIF R1 L5 
      23 [-]: GETIMPORT R3 13 [0x783030E3]
      24 [-]: GETTABLEKS R4 R0 K11 ["SoundIndex"]
      25 [-]: GETTABLE R2 R3 R4
      26 [-]: FASTCALL1 62 R2 L3
      27 [-]: GETIMPORT R1 2 [0x7B998233]
      28 [-]: CALL R1 1 1  
L 3:  29 [-]: JUMPIF R1 L5 
      30 [-]: GETIMPORT R1 15 [0x89326C93]
      31 [-]: GETIMPORT R3 17 [0x0469F296]
...
L 6:  58 [-]: GETTABLEKS R2 R0 K8 ["Tag"]
      ...
      60 [-]: GETIMPORT R1 2 [0x7B998233]
      61 [-]: CALL R1 1 1  
L 7:  62 [-]: JUMPIF R1 L9 
      63 [-]: GETIMPORT R2 25 [0x08AEE1A4]
      64 [-]: GETIMPORT R4 17 [0x0469F296]
      65 [-]: GETTABLEKS R5 R0 K8 ["Tag"]
      66 [-]: CALL R4 1 -1 
      67 [-]: NAMECALL R2 R2 K26 [0x10C9EEF2]
      68 [-]: CALL R2 -1 1 
      69 [-]: FASTCALL1 62 R2 L8
      70 [-]: GETIMPORT R1 2 [0x7B998233]
      71 [-]: CALL R1 1 1  
L 8:  72 [-]: JUMPIF R1 L9 
      73 [-]: GETUPVAL R2 5
      74 [-]: GETTABLEKS R1 R2 K27 [0x947DE44C]
      75 [-]: GETIMPORT R2 25 [0x08AEE1A4]
      76 [-]: GETIMPORT R3 17 [0x0469F296]
...
; Max Stack Size:  7
       ...
       0 [-]: GETIMPORT R2 2 ["NewWarLesson_AttachInfo"]
...
L 0:   4 [-]: NOT R0 R1    
      ...
      29 [-]: GETUPVAL R1 0
      30 [-]: JUMPIFNOT R1 L3
      31 [-]: GETIMPORT R2 16 ["NoInput"]
      32 [-]: JUMPXEQKB R2 1 L1
      33 [-]: LOADB R1 0 +1
L 1:  34 [-]: LOADB R1 1   
L 2:  35 [-]: SETUPVAL R1 3
      36 [-]: GETIMPORT R1 6 [0xAE91E43B]
      37 [-]: GETIMPORT R3 18 ["AttachEntity"]
      38 [-]: GETIMPORT R4 20 ["Offset"]
      39 [-]: GETIMPORT R5 22 ["Rotation"]
      40 [-]: GETIMPORT R6 24 ["Scale"]
      41 [-]: NAMECALL R1 R1 K25 [0xE395D771]
      42 [-]: CALL R1 5 0  
      43 [-]: GETIMPORT R1 26 ["_T"]
      44 [-]: LOADNIL R2   
      45 [-]: SETTABLEKS R2 R1 K1 ["NewWarLesson_AttachInfo"]
L 3:  46 [-]: GETIMPORT R1 6 [0xAE91E43B]
      47 [-]: GETUPVAL R3 3
      48 [-]: NAMECALL R1 R1 K27 [0xBED40E9C]
      49 [-]: CALL R1 2 0  
      50 [-]: GETUPVAL R1 4
      51 [-]: JUMPXEQKNIL R1 L5 NOT
      52 [-]: GETIMPORT R1 29 [0x89326C93]
      53 [-]: GETIMPORT R3 31 [0x0469F296]
      ...
      61 [-]: CALL R2 1 1  
L 4:  62 [-]: JUMPIF R2 L5 
      63 [-]: GETIMPORT R4 35 [0x3D7EA73B]
      64 [-]: LOADB R5 0   
      65 [-]: NAMECALL R2 R1 K36 [0x659D451F]
      66 [-]: CALL R2 3 1  
      67 [-]: SETUPVAL R2 4
L 5:  68 [-]: GETIMPORT R1 6 [0xAE91E43B]
...
L 1:  15 [-]: GETUPVAL R1 1
      ...
      18 [-]: GETIMPORT R1 14 ["curTransmission"]
...
L 3:  27 [-]: GETUPVAL R1 1
      ...
      30 [-]: GETIMPORT R1 14 ["curTransmission"]
...
; Max Stack Size:  7
       ...
       9 [-]: CALL R1 1 1  
L 0:  10 [-]: JUMPIF R1 L1 
      11 [-]: GETIMPORT R1 9 ["_T"]
      12 [-]: DUPTABLE R2 15
      13 [-]: GETIMPORT R3 17 [0xAC9CE333]
      14 [-]: SETTABLEKS R3 R2 K10 ["NoInput"]
      15 [-]: SETTABLEKS R0 R2 K11 ["AttachEntity"]
      16 [-]: GETIMPORT R3 19 [0xA421AF95]
      17 [-]: LOADN R4 0   
      18 [-]: LOADK R5 K20 [1.8]
      19 [-]: LOADK R6 K21 [-0.5]
      20 [-]: CALL R3 3 1  
      21 [-]: SETTABLEKS R3 R2 K12 ["Offset"]
      22 [-]: GETIMPORT R3 23 [0x00046924]
      23 [-]: LOADN R4 -90 
      24 [-]: LOADN R5 0   
      25 [-]: LOADN R6 0   
      26 [-]: CALL R3 3 1  
      27 [-]: SETTABLEKS R3 R2 K13 ["Rotation"]
      28 [-]: GETIMPORT R3 19 [0xA421AF95]
      29 [-]: LOADK R4 K24 [1.5]
      30 [-]: LOADK R5 K24 [1.5]
      31 [-]: LOADK R6 K24 [1.5]
      32 [-]: CALL R3 3 1  
...
L 1:  35 [-]: GETIMPORT R1 27 [0x9BA7909F]
      36 [-]: GETIMPORT R3 29 [0x7ED0A956]
