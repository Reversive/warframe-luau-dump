...
; Max Stack Size:  9
 ...
 12 [-]: GETTABLE  R7 R0 K5     ; R7 := R0["CallOut"]
 13 [-]: CALL      R2 6 2       ; R2 := R2(R3,R4,R5,R6,R7)
 14 [-]: MOVE      R1 R2        ; R1 := R2
 15 [-]: SELF      R2 R1 K6     ; R3 := R1; R2 := R1[0x1403231b]
 16 [-]: GETTABLE  R4 R0 K7     ; R4 := R0["Id"]
 17 [-]: CALL      R2 3 1       ; R2(R3,R4)
 18 [-]: CLOSURE   R2 0         ; R2 := closure(Function #1.1.1)
 19 [-]: GETUPVAL  R0 U1        ; R0 := U1
 20 [-]: SETTABLE  R1 K8 R2     ; R1["mOnPressedCallback"] := R2
 21 [-]: GETTABLE  R2 R1 K10    ; R2 := R1["SetFocus"]
 22 [-]: SETTABLE  R1 K9 R2     ; R1["ContextListSetFocus"] := R2
 23 [-]: CLOSURE   R2 1         ; R2 := closure(Function #1.1.2)
 24 [-]: GETUPVAL  R0 U2        ; R0 := U2
 25 [-]: GETUPVAL  R0 U1        ; R0 := U1
 26 [-]: SETTABLE  R1 K10 R2    ; R1["SetFocus"] := R2
 27 [-]: SETTABLE  R0 K0 R1     ; R0["mButton"] := R1
 28 [-]: GETTABLE  R2 R0 K11    ; R2 := R0["IsLockedCheck"]
 29 [-]: EQ        1 R2 K12     ; if R2 == nil then PC := 34
 30 [-]: JMP       34           ; PC := 34
 31 [-]: GETTABLE  R2 R0 K13    ; R2 := R0[0xa8d1afec]
 32 [-]: CALL      R2 1 2       ; R2 := R2()
 33 [-]: JMP       36           ; PC := 36
 34 [-]: LOADKB    R2 0 1       ; R2 := false; PC := 35
 35 [-]: LOADKB    R2 1 0       ; R2 := true
 36 [-]: SETTABLE  R0 K14 R2    ; R0["Locked"] := R2
 37 [-]: GETUPVAL  R3 U3        ; R3 := U3
 38 [-]: GETTABLE  R3 R3 K16    ; R3 := R3[0x06d055f9]
 39 [-]: MOVE      R4 R2        ; R4 := R2
 40 [-]: GETGLOBAL R5 K3        ; R5 := 0xae91e43b
 41 [-]: SELF      R5 R5 K17    ; R6 := R5; R5 := R5[0x42b04007]
 42 [-]: LOADK     R7 K18       ; R7 := "<LOCKED>"
 43 [-]: LOADKB    R8 1 0       ; R8 := true
 44 [-]: CALL      R5 4 2       ; R5 := R5(R6,R7,R8)
 45 [-]: LOADK     R6 K19       ; R6 := ""
 46 [-]: CALL      R3 4 2       ; R3 := R3(R4,R5,R6)
 47 [-]: SETTABLE  R1 K15 R3    ; R1["mLabelPrefix"] := R3
 48 [-]: GETGLOBAL R3 K1        ; R3 := 0x7b998233
 49 [-]: GETTABLE  R4 R0 K20    ; R4 := R0["FormatPrefix"]
 50 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 51 [-]: TEST      R3 1         ; if R3 then PC := 59
 52 [-]: JMP       59           ; PC := 59
 53 [-]: GETGLOBAL R3 K3        ; R3 := 0xae91e43b
 54 [-]: SELF      R3 R3 K17    ; R4 := R3; R3 := R3[0x42b04007]
 55 [-]: GETTABLE  R5 R0 K20    ; R5 := R0["FormatPrefix"]
 56 [-]: LOADKB    R6 1 0       ; R6 := true
 57 [-]: CALL      R3 4 2       ; R3 := R3(R4,R5,R6)
 58 [-]: SETTABLE  R1 K21 R3    ; R1["mFormatPrefix"] := R3
 59 [-]: SETTABLE  R1 K22 K23   ; R1["mForceBacker"] := true
 60 [-]: GETTABLE  R3 R0 K24    ; R3 := R0["Tooltip"]
 61 [-]: SETTABLE  R1 K24 R3    ; R1["Tooltip"] := R3
 62 [-]: GETTABLE  R3 R0 K25    ; R3 := R0["ShowTooltipCheck"]
 63 [-]: SETTABLE  R1 K25 R3    ; R1["ShowTooltipCheck"] := R3
 64 [-]: SELF      R3 R1 K26    ; R4 := R1; R3 := R1[0x9b71e815]
 65 [-]: GETTABLE  R5 R0 K27    ; R5 := R0["Name"]
 66 [-]: CALL      R3 3 1       ; R3(R4,R5)
 67 [-]: SELF      R3 R1 K28    ; R4 := R1; R3 := R1[0x6b2ab44e]
 68 [-]: LOADK     R5 K29       ; R5 := "left"
 69 [-]: CALL      R3 3 1       ; R3(R4,R5)
 70 [-]: SELF      R3 R1 K30    ; R4 := R1; R3 := R1[0x557b7601]
...
; Max Stack Size:  12
 ...
 52 [-]: SETTABLE  R5 K15 R6    ; R5[0xee122c82] := R6
 53 [-]: JMP       56           ; PC := 56
