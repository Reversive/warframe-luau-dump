...
; Max Stack Size:  2
  ...
  2 [-]: SETTABLE  R0 K1 K2     ; R0["BlessingPopup_Info"] := nil
...
107 [-]: CONST     R5 10        ; R5 := 10.000000
108 [-]: CONST     R6 60        ; R6 := 60.000000
