...
L 0:   4 [-]: JUMPIF R0 L1 
       ...
       9 [-]: CALL R0 -1 0 
L 1:  10 [-]: GETIMPORT R0 9 ["HudReplacement_ForceVisibility"]
      11 [-]: JUMPXEQKNIL R0 L5 NOT
      12 [-]: GETIMPORT R3 11 [0x89326C93]
...
L 2:  18 [-]: NOT R1 R2    
      19 [-]: JUMPIF R1 L4 
      20 [-]: GETIMPORT R1 14 [0x9BA7909F]
      21 [-]: GETIMPORT R3 16 [0x82FD6CC3]
...
L 6:  37 [-]: JUMPIF R0 L11
      38 [-]: GETIMPORT R1 9 ["HudReplacement_ForceVisibility"]
...
L12:  77 [-]: GETIMPORT R1 1 [0xAE91E43B]
...
L13:  83 [-]: GETUPVAL R2 0
      ...
      85 [-]: GETIMPORT R1 3 [0x7B998233]
      86 [-]: CALL R1 1 1  
L14:  87 [-]: JUMPIFNOT R1 L16
      88 [-]: GETIMPORT R1 11 [0x89326C93]
...
L17: 103 [-]: JUMPIF R1 L21
     ...
     109 [-]: SETUPVAL R1 1
     110 [-]: GETIMPORT R2 11 [0x89326C93]
     111 [-]: NAMECALL R2 R2 K19 [0xFB64E76C]
     112 [-]: CALL R2 1 1  
     113 [-]: FASTCALL1 62 R2 L18
     114 [-]: MOVE R4 R2   
     115 [-]: GETIMPORT R3 3 [0x7B998233]
     116 [-]: CALL R3 1 1  
L18: 117 [-]: JUMPIF R3 L21
     118 [-]: LOADN R3 100 
     119 [-]: GETIMPORT R4 11 [0x89326C93]
...
L19: 126 [-]: JUMPIF R5 L20
     127 [-]: GETIMPORT R7 29 ["gLotusVehicleAvatarType"]
     128 [-]: NAMECALL R5 R4 K30 [0xF2DEAF69]
     129 [-]: CALL R5 2 1  
     130 [-]: JUMPIFNOT R5 L20
     131 [-]: LOADN R3 0   
L20: 132 [-]: GETIMPORT R5 32 [0x25312C9B]
     ...
     148 [-]: CALL R5 6 0  
L21: 149 [-]: GETIMPORT R2 11 [0x89326C93]
...
L22: 155 [-]: JUMPIF R1 L25
     156 [-]: GETIMPORT R1 11 [0x89326C93]
...
; Max Stack Size:  9
      ...
      12 [-]: CALL R1 4 0  
      13 [-]: RETURN R0 0  
L 0:  14 [-]: GETIMPORT R1 2 [0xAE91E43B]
