...
; Max Stack Size:  3
  ...
  2 [-]: GETTABLE  R0 R0 K1     ; R0 := R0[0xf21b1d8e]
...
; Max Stack Size:  12
  ...
  3 [-]: GETTABLE  R2 R2 K1     ; R2 := R2[0x99675e23]
  4 [-]: MOVE      R3 R0        ; R3 := R0
 ...
 22 [-]: GETTABLE  R3 R3 K3     ; R3 := R3[0x659d451f]
...
; Max Stack Size:  5
 ...
 13 [-]: SETTABLE  R4 K4 R0     ; R4[0x20b98db3] := R0
...
; Max Stack Size:  12
 ...
 11 [-]: GETTABLE  R4 R4 K2     ; R4 := R4[0xae6791ba]
