...
; Max Stack Size:  23
 ...
 18 [-]: SETGLOBALHASH R3 K7        ; SANCTUARY_ONSLAUGHT_NODE := R3
 19 [-]: GETGLOBAL R3 K8        ; R3 := 0x0469f296
 20 [-]: LOADK     R4 K11       ; R4 := "SolNode802"
 21 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 22 [-]: SETGLOBALHASH R3 K10       ; SANCTUARY_ONSLAUGHT_CHALLENGE_NODE := R3
 23 [-]: GETGLOBAL R3 K8        ; R3 := 0x0469f296
 24 [-]: LOADK     R4 K13       ; R4 := "SolNode973"
 25 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 26 [-]: SETGLOBALHASH R3 K12       ; FRAME_FIGHTER_NODE := R3
 27 [-]: CONST     R3 0         ; R3 := 0.000000
 28 [-]: SETGLOBALHASH R3 K14       ; JCE_CAN_PLAY := R3
 29 [-]: CONST     R3 1         ; R3 := 1.000000
 30 [-]: SETGLOBALHASH R3 K15       ; JCE_MASTERY_LOCKED := R3
 31 [-]: CONST     R3 2         ; R3 := 2.000000
 32 [-]: SETGLOBALHASH R3 K16       ; JCE_SYNDICATE_TITLE_LOCKED := R3
 33 [-]: CONST     R3 3         ; R3 := 3.000000
 34 [-]: SETGLOBALHASH R3 K17       ; JCE_CHAIN_PROGRESS_LOCKED := R3
 35 [-]: CONST     R3 4         ; R3 := 4.000000
 36 [-]: SETGLOBALHASH R3 K18       ; JCE_ITEM_LOCKED := R3
 37 [-]: CONST     R3 5         ; R3 := 5.000000
 38 [-]: SETGLOBALHASH R3 K19       ; JCE_ERROR := R3
...
; Max Stack Size:  34
 ...
 92 [-]: JMP       95           ; PC := 95
 93 [-]: OP_LOADBOOL R10 1 0      ; R10 := true
...
119 [-]: JMP       123          ; PC := 123
120 [-]: OP_LOADBOOL R10 1 0      ; R10 := true
...
134 [-]: OP_LOADBOOL R32 0 0      ; R32 := false
...
156 [-]: OP_LOADBOOL R32 0 0      ; R32 := false
...
; Max Stack Size:  37
 ...
 31 [-]: JMP       151          ; PC := 151
 32 [-]: OP_LOADBOOL R15 0 0      ; R15 := false
 ...
 65 [-]: JMP       79           ; PC := 79
 66 [-]: OP_LOADBOOL R15 1 0      ; R15 := true
 67 [-]: JMP       79           ; PC := 79
 ...
 77 [-]: JMP       79           ; PC := 79
 78 [-]: OP_LOADBOOL R15 1 0      ; R15 := true
...
133 [-]: OP_LOADBOOL R35 0 0      ; R35 := false
...
147 [-]: OP_LOADBOOL R35 0 0      ; R35 := false
...
; Max Stack Size:  174
 ...
 92 [-]: JMP       94           ; PC := 94
 93 [-]: OP_LOADBOOL R9 0 1       ; R9 := false; PC := 94
 94 [-]: OP_LOADBOOL R9 1 0       ; R9 := true
...
383 [-]: JMP       385          ; PC := 385
384 [-]: OP_LOADBOOL R5 0 1       ; R5 := false; PC := 385
385 [-]: OP_LOADBOOL R5 1 0       ; R5 := true
386 [-]: JMP       416          ; PC := 416
...
442 [-]: JMP       444          ; PC := 444
443 [-]: OP_LOADBOOL R5 0 1       ; R5 := false; PC := 444
444 [-]: OP_LOADBOOL R5 1 0       ; R5 := true
...
499 [-]: CONST     R25 1        ; R25 := 1.000000
500 [-]: LEN       R26 R24      ; R26 := # R24
501 [-]: CONST     R27 1        ; R27 := 1.000000
...
524 [-]: OP_LOADBOOL R30 0 0      ; R30 := false
525 [-]: TEST      R30 0        ; if not R30 then PC := 554
526 [-]: JMP       554          ; PC := 554
527 [-]: OP_LOADBOOL R30 0 0      ; R30 := false
...
544 [-]: JMP       547          ; PC := 547
545 [-]: OP_LOADBOOL R30 0 1      ; R30 := false; PC := 546
546 [-]: OP_LOADBOOL R30 1 0      ; R30 := true
...
638 [-]: JMP       712          ; PC := 712
639 [-]: CONST     R37 0        ; R37 := 0.000000
640 [-]: CONST     R38 6        ; R38 := 6.000000
641 [-]: CONST     R39 1        ; R39 := 1.000000
642 [-]: FORPREP   R37 710      ; R37 -= R39; PC := 710
643 [-]: SELF      R41 R36 K102 ; R42 := R36; R41 := R36[0xc9f592a7]
644 [-]: CONST     R43 0        ; R43 := 0.000000
...
663 [-]: OP_LOADBOOL R45 0 0      ; R45 := false
...
697 [-]: OP_LOADBOOL R47 0 0      ; R47 := false
...
742 [-]: CONST     R48 1        ; R48 := 1.000000
743 [-]: LEN       R49 R47      ; R49 := # R47
744 [-]: CONST     R50 1        ; R50 := 1.000000
...
843 [-]: CONST     R59 2        ; R59 := 2.000000
844 [-]: CONST     R60 0        ; R60 := 0.000000
845 [-]: CALL      R57 4 2      ; R57 := R57(R58,R59,R60)
846 [-]: SELF      R58 R56 K103 ; R59 := R56; R58 := R56[0xb61abfd2]
847 [-]: CONST     R60 2        ; R60 := 2.000000
848 [-]: CONST     R61 2        ; R61 := 2.000000
849 [-]: CALL      R58 4 2      ; R58 := R58(R59,R60,R61)
850 [-]: SELF      R59 R56 K103 ; R60 := R56; R59 := R56[0xb61abfd2]
851 [-]: CONST     R61 2        ; R61 := 2.000000
852 [-]: CONST     R62 3        ; R62 := 3.000000
...
868 [-]: JMP       871          ; PC := 871
869 [-]: OP_LOADBOOL R60 0 1      ; R60 := false; PC := 870
870 [-]: OP_LOADBOOL R60 1 0      ; R60 := true
...
884 [-]: JMP       923          ; PC := 923
885 [-]: CONST     R62 1        ; R62 := 1.000000
886 [-]: LEN       R63 R54      ; R63 := # R54
887 [-]: CONST     R64 1        ; R64 := 1.000000
...
1011 [-]: CONST     R73 1        ; R73 := 1.000000
1012 [-]: CONST     R74 2        ; R74 := 2.000000
1013 [-]: CONST     R75 3        ; R75 := 3.000000
1014 [-]: SETLIST   R72 3 1      ; R72[(1-1)*FPF+i] := R(72+i), 1 <= i <= 3
1015 [-]: OP_LOADBOOL R73 0 0      ; R73 := false
1016 [-]: CONST     R74 0        ; R74 := 0.000000
1017 [-]: CONST     R75 1        ; R75 := 1.000000
1018 [-]: LEN       R76 R72      ; R76 := # R72
1019 [-]: CONST     R77 1        ; R77 := 1.000000
1020 [-]: FORPREP   R75 1047     ; R75 -= R77; PC := 1047
1021 [-]: SELF      R79 R71 K103 ; R80 := R71; R79 := R71[0xb61abfd2]
1022 [-]: CONST     R81 0        ; R81 := 0.000000
...
1046 [-]: OP_LOADBOOL R73 1 0      ; R73 := true
...
1058 [-]: OP_LOADBOOL R82 0 0      ; R82 := false
...
1066 [-]: CONST     R82 1        ; R82 := 1.000000
1067 [-]: LEN       R83 R69      ; R83 := # R69
1068 [-]: CONST     R84 1        ; R84 := 1.000000
...
1083 [-]: OP_LOADBOOL R88 0 0      ; R88 := false
1084 [-]: CONST     R89 0        ; R89 := 0.000000
1085 [-]: CONST     R90 1        ; R90 := 1.000000
1086 [-]: LEN       R91 R87      ; R91 := # R87
1087 [-]: CONST     R92 1        ; R92 := 1.000000
...
1126 [-]: OP_LOADBOOL R88 1 0      ; R88 := true
...
1138 [-]: OP_LOADBOOL R96 0 0      ; R96 := false
...
1187 [-]: OP_LOADBOOL R96 0 1      ; R96 := false; PC := 1188
1188 [-]: OP_LOADBOOL R96 1 0      ; R96 := true
...
1222 [-]: OP_LOADBOOL R97 0 1      ; R97 := false; PC := 1223
1223 [-]: OP_LOADBOOL R97 1 0      ; R97 := true
...
1258 [-]: CONST     R101 0       ; R101 := 0.000000
...
1265 [-]: CONST     R102 0       ; R102 := 0.000000
1266 [-]: CONST     R103 0       ; R103 := 0.000000
...
1284 [-]: OP_LOADBOOL R101 0 1     ; R101 := false; PC := 1285
1285 [-]: OP_LOADBOOL R101 1 0     ; R101 := true
...
1304 [-]: OP_LOADBOOL R101 0 1     ; R101 := false; PC := 1305
1305 [-]: OP_LOADBOOL R101 1 0     ; R101 := true
...
1312 [-]: CONST     R102 1       ; R102 := 1.000000
1313 [-]: LEN       R103 R98     ; R103 := # R98
1314 [-]: CONST     R104 1       ; R104 := 1.000000
...
1335 [-]: OP_LOADBOOL R108 0 1     ; R108 := false; PC := 1336
1336 [-]: OP_LOADBOOL R108 1 0     ; R108 := true
...
1351 [-]: OP_LOADBOOL R108 0 1     ; R108 := false; PC := 1352
1352 [-]: OP_LOADBOOL R108 1 0     ; R108 := true
...
1442 [-]: CONST     R112 0       ; R112 := 0.000000
...
1452 [-]: OP_LOADBOOL R112 0 0     ; R112 := false
...
1498 [-]: CONST     R113 2       ; R113 := 2.000000
...
1504 [-]: CONST     R117 1       ; R117 := 1.000000
1505 [-]: LEN       R118 R116    ; R118 := # R116
1506 [-]: CONST     R119 1       ; R119 := 1.000000
...
1517 [-]: CONST     R123 1       ; R123 := 1.000000
1518 [-]: LEN       R124 R122    ; R124 := # R122
1519 [-]: CONST     R125 1       ; R125 := 1.000000
...
1585 [-]: OP_LOADBOOL R129 1 0     ; R129 := true
...
1600 [-]: CONST     R133 0       ; R133 := 0.000000
...
1619 [-]: CONST     R135 0       ; R135 := 0.000000
...
1648 [-]: OP_LOADBOOL R129 1 0     ; R129 := true
...
1654 [-]: CONST     R134 0       ; R134 := 0.000000
...
1661 [-]: OP_LOADBOOL R129 0 1     ; R129 := false; PC := 1662
1662 [-]: OP_LOADBOOL R129 1 0     ; R129 := true
...
1674 [-]: OP_LOADBOOL R129 0 0     ; R129 := false
...
1685 [-]: OP_LOADBOOL R129 0 0     ; R129 := false
...
1695 [-]: CONST     R138 0       ; R138 := 0.000000
...
1706 [-]: OP_LOADBOOL R129 0 0     ; R129 := false
...
1715 [-]: CONST     R138 0       ; R138 := 0.000000
...
1726 [-]: OP_LOADBOOL R129 0 0     ; R129 := false
...
1754 [-]: CONST     R139 0       ; R139 := 0.000000
...
1764 [-]: CONST     R139 0       ; R139 := 0.000000
1765 [-]: CONST     R140 1       ; R140 := 1.000000
1766 [-]: LEN       R141 R137    ; R141 := # R137
1767 [-]: CONST     R142 1       ; R142 := 1.000000
...
1793 [-]: OP_LOADBOOL R147 0 0     ; R147 := false
...
1864 [-]: CONST     R150 0       ; R150 := 0.000000
...
1916 [-]: CONST     R153 0       ; R153 := 0.000000
...
1999 [-]: CONST     R161 0       ; R161 := 0.000000
...
2011 [-]: CONST     R167 5       ; R167 := 5.000000
...
2035 [-]: CONST     R171 0       ; R171 := 0.000000
...
2042 [-]: CONST     R170 0       ; R170 := 0.000000
...
2063 [-]: OP_LOADBOOL R170 0 0     ; R170 := false
...
2083 [-]: OP_LOADBOOL R170 1 0     ; R170 := true
