...
; Max Stack Size:  42
  ...
  1 [-]: LEN       R5 R2        ; R5 := # R2
  2 [-]: EQ        0 R5 K0      ; if R5 ~= 0.000000 then PC := 5
  3 [-]: JMP       5            ; PC := 5
 ...
 27 [-]: GETTABLE  R6 R6 K3     ; R82 := R6[0x06d055f9]
 28 [-]: MOVE      R7 R4        ; R7 := R4
 ...
 39 [-]: LOADK     R12 K1       ; R12 := ""
 40 [-]: GETGLOBAL R13 K4       ; R13 := 0x0c5e62f9
 41 [-]: GETTABLE  R14 R11 K5   ; R14 := R11["mNumToUse"]
 42 [-]: GETTABLE  R14 R14 K6   ; R14 := R14["minValue"]
 43 [-]: GETTABLE  R15 R11 K5   ; R15 := R11["mNumToUse"]
 44 [-]: GETTABLE  R15 R15 K7   ; R15 := R15["maxValue"]
 45 [-]: CALL      R13 3 2      ; R13 := R13(R14,R15)
 46 [-]: NEWTABLE  R14 0 0      ; R14 := {}
 47 [-]: GETTABLE  R15 R11 K5   ; R15 := R11["mNumToUse"]
 48 [-]: GETTABLE  R15 R15 K7   ; R15 := R15["maxValue"]
 49 [-]: GETTABLE  R16 R11 K8   ; R16 := R11["mMaxLocTagSuffix"]
 50 [-]: LT        0 R16 R15    ; if R16 >= R15 then PC := 58
 51 [-]: JMP       58           ; PC := 58
 52 [-]: GETGLOBAL R15 K9       ; R15 := 0x3d106989
 ...
 70 [-]: JMP       72           ; PC := 72
 71 [-]: JMP       59           ; PC := 59
 72 [-]: SETTABLE  R14 R17 K13  ; R14[R17] := true
 73 [-]: GETTABLE  R18 R11 K14  ; R18 := R11["mLocTagPrefix"]
 74 [-]: SELF      R18 R18 K15  ; R19 := R18; R18 := R18[0x6d604ba7]
 75 [-]: CALL      R18 2 2      ; R18 := R18(R19)
 76 [-]: EQ        0 R18 K16    ; if R18 ~= "NUMBER" then PC := 82
 77 [-]: JMP       82           ; PC := 82
 ...
 81 [-]: JMP       162          ; PC := 162
 82 [-]: LOADK     R19 K1       ; R19 := ""
 83 [-]: GETTABLE  R20 R11 K17  ; R20 := R11["mHasGenderVariants"]
 ...
 90 [-]: GETGLOBAL R21 K2       ; R21 := 0x7b998233
 ...
 97 [-]: OP_LOADBOOL R24 1 0      ; R24 := true
 98 [-]: CALL      R21 4 2      ; R21 := R21(R22,R23,R24)
 99 [-]: MOVE      R19 R21      ; R19 := R21
100 [-]: JMP       106          ; PC := 106
101 [-]: GETGLOBAL R21 K19      ; R21 := 0x603636ad
...
149 [-]: LT        0 K20 R15    ; if 1.000000 >= R15 then PC := 159
150 [-]: JMP       159          ; PC := 159
151 [-]: GETTABLE  R21 R11 K21  ; R21 := R11["mTrailingLocLowercase"]
152 [-]: TEST      R21 0        ; if not R21 then PC := 159
153 [-]: JMP       159          ; PC := 159
154 [-]: GETGLOBAL R21 K22      ; R21 := 0x7f5022cf
155 [-]: GETTABLE  R21 R21 K23  ; R82 := R21[0x04981ab3]
...
169 [-]: JMP       178          ; PC := 178
170 [-]: SELF      R22 R0 K18   ; R23 := R0; R22 := R0[0x42b04007]
...
204 [-]: JMP       207          ; PC := 207
205 [-]: OP_LOADBOOL R28 1 0      ; R28 := true
206 [-]: JMP       208          ; PC := 208
...
217 [-]: SETTABLE  R14 R37 K13  ; R14[R37] := true
...
220 [-]: ADD       R15 R15 K20  ; R15 := R15 + 1.000000
221 [-]: JMP       59           ; PC := 59
222 [-]: GETTABLE  R37 R11 K27  ; R37 := R11["mReplacementLocTagKey"]
223 [-]: SELF      R37 R37 K15  ; R38 := R37; R37 := R37[0x6d604ba7]
...
227 [-]: GETGLOBAL R37 K2       ; R37 := 0x7b998233
...
235 [-]: OP_LOADBOOL R40 1 0      ; R40 := true
236 [-]: MOVE      R41 R6       ; R41 := R6
237 [-]: CALL      R37 5 2      ; R37 := R37(R38,R39,R40,R41)
238 [-]: RETURN    R37 2        ; return R37
239 [-]: JMP       246          ; PC := 246
240 [-]: GETGLOBAL R37 K19      ; R37 := 0x603636ad
241 [-]: SELF      R38 R3 K15   ; R39 := R3; R38 := R3[0x6d604ba7]
