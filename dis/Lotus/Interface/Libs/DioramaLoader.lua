...
; Max Stack Size:  47
 ...
 34 [-]: CONST     R13 255      ; R13 := 255.000000
 ...
 61 [-]: GETTABLE  R10 R10 K17  ; R10 := R10[0xc06cb5e5]
...
113 [-]: TEST      R13 1        ; if R13 then PC := 335
114 [-]: JMP       335          ; PC := 335
...
232 [-]: CONST     R28 1        ; R28 := 1.000000
233 [-]: LEN       R29 R27      ; R29 := # R27
234 [-]: CONST     R30 1        ; R30 := 1.000000
...
267 [-]: JMP       270          ; PC := 270
268 [-]: TEST      R32 0        ; if not R32 then PC := 335
269 [-]: JMP       335          ; PC := 335
270 [-]: SELF      R33 R26 K0   ; R34 := R26; R33 := R26[0x905bb2bd]
271 [-]: CALL      R33 2 2      ; R33 := R33(R34)
272 [-]: CONST     R34 1        ; R34 := 1.000000
273 [-]: LEN       R35 R33      ; R35 := # R33
274 [-]: CONST     R36 1        ; R36 := 1.000000
275 [-]: FORPREP   R34 326      ; R34 -= R36; PC := 326
276 [-]: LOADKB    R38 1 0      ; R38 := true
277 [-]: GETTABLE  R39 R33 R37  ; R39 := R33[R37]
278 [-]: GETGLOBAL R40 K6       ; R40 := 0x7b998233
279 [-]: MOVE      R41 R39      ; R41 := R39
280 [-]: CALL      R40 2 2      ; R40 := R40(R41)
281 [-]: TEST      R40 1        ; if R40 then PC := 326
282 [-]: JMP       326          ; PC := 326
283 [-]: SELF      R40 R39 K3   ; R41 := R39; R40 := R39[0xf2deaf69]
284 [-]: GETGLOBAL R42 K41      ; R42 := gEffectType
285 [-]: CALL      R40 3 2      ; R40 := R40(R41,R42)
286 [-]: TEST      R40 0        ; if not R40 then PC := 301
287 [-]: JMP       301          ; PC := 301
288 [-]: LOADKB    R38 0 0      ; R38 := false
289 [-]: CONST     R40 1        ; R40 := 1.000000
290 [-]: LEN       R41 R3       ; R41 := # R3
291 [-]: CONST     R42 1        ; R42 := 1.000000
292 [-]: FORPREP   R40 300      ; R40 -= R42; PC := 300
293 [-]: SELF      R44 R39 K3   ; R45 := R39; R44 := R39[0xf2deaf69]
294 [-]: GETTABLE  R46 R3 R43   ; R46 := R3[R43]
295 [-]: CALL      R44 3 2      ; R44 := R44(R45,R46)
296 [-]: TEST      R44 0        ; if not R44 then PC := 300
297 [-]: JMP       300          ; PC := 300
298 [-]: LOADKB    R38 1 0      ; R38 := true
299 [-]: JMP       301          ; PC := 301
300 [-]: FORLOOP   R40 293      ; R40 += R42; if R40 <= R41 then begin PC := 293; R43 := R40 end
301 [-]: TEST      R38 0        ; if not R38 then PC := 326
302 [-]: JMP       326          ; PC := 326
303 [-]: SELF      R44 R39 K3   ; R45 := R39; R44 := R39[0xf2deaf69]
304 [-]: GETGLOBAL R46 K42      ; R46 := gSequencerType
305 [-]: CALL      R44 3 2      ; R44 := R44(R45,R46)
306 [-]: TEST      R44 0        ; if not R44 then PC := 322
307 [-]: JMP       322          ; PC := 322
308 [-]: SELF      R44 R39 K43  ; R45 := R39; R44 := R39[0x383d2e7d]
309 [-]: CALL      R44 2 1      ; R44(R45)
310 [-]: SELF      R44 R39 K44  ; R45 := R39; R44 := R39[0xf4e253b6]
311 [-]: CALL      R44 2 1      ; R44(R45)
312 [-]: SELF      R44 R39 K45  ; R45 := R39; R44 := R39[0x2935187e]
313 [-]: CALL      R44 2 2      ; R44 := R44(R45)
314 [-]: GETGLOBAL R45 K6       ; R45 := 0x7b998233
315 [-]: MOVE      R46 R44      ; R46 := R44
316 [-]: CALL      R45 2 2      ; R45 := R45(R46)
317 [-]: TEST      R45 1        ; if R45 then PC := 322
318 [-]: JMP       322          ; PC := 322
319 [-]: SELF      R45 R44 K46  ; R46 := R44; R45 := R44[0x6cf1e476]
320 [-]: LOADKB    R47 1 0      ; R47 := true
321 [-]: CALL      R45 3 1      ; R45(R46,R47)
322 [-]: GETGLOBAL R45 K19      ; R45 := 0x89326c93
323 [-]: SELF      R45 R45 K47  ; R46 := R45; R45 := R45[0x59c96e77]
324 [-]: MOVE      R47 R39      ; R47 := R39
325 [-]: CALL      R45 3 1      ; R45(R46,R47)
326 [-]: FORLOOP   R34 276      ; R34 += R36; if R34 <= R35 then begin PC := 276; R37 := R34 end
327 [-]: GETUPVAL  R45 U6       ; R45 := U6
328 [-]: MOVE      R46 R12      ; R46 := R12
329 [-]: MOVE      R47 R26      ; R47 := R26
330 [-]: MOVE      R48 R2       ; R48 := R2
331 [-]: MOVE      R49 R3       ; R49 := R3
332 [-]: LOADKB    R50 1 0      ; R50 := true
333 [-]: MOVE      R51 R5       ; R51 := R5
334 [-]: CALL      R45 7 1      ; R45(R46,R47,R48,R49,R50,R51)
335 [-]: FORLOOP   R8 10        ; R8 += R10; if R8 <= R9 then begin PC := 10; R11 := R8 end
...
150 [-]: CONST     R27 1        ; R27 := 1.000000
151 [-]: LEN       R28 R26      ; R28 := # R26
152 [-]: CONST     R29 1        ; R29 := 1.000000
...
169 [-]: GETTABLE  R36 R36 K29  ; R36 := R36[0x23d5322f]
...
175 [-]: GETTABLE  R36 R36 K29  ; R36 := R36[0x23d5322f]
...
180 [-]: GETTABLE  R36 R36 K29  ; R36 := R36[0x23d5322f]
...
185 [-]: GETTABLE  R36 R36 K29  ; R36 := R36[0x23d5322f]
...
190 [-]: GETTABLE  R36 R36 K29  ; R36 := R36[0x23d5322f]
...
223 [-]: CONST     R38 1        ; R38 := 1.000000
224 [-]: LEN       R39 R37      ; R39 := # R37
225 [-]: CONST     R40 1        ; R40 := 1.000000
...
; Max Stack Size:  20
 ...
 49 [-]: GETTABLE  R16 R16 K7   ; R16 := R16[0x23d5322f]
 ...
 58 [-]: GETTABLE  R16 R16 K7   ; R16 := R16[0x23d5322f]
...
; Max Stack Size:  18
 ...
 42 [-]: GETTABLE  R9 R9 K10    ; R9 := R9[0xc14d48af]
...
104 [-]: GETTABLE  R14 R14 K13  ; R14 := R14[0x23d5322f]
...
; Max Stack Size:  44
 ...
 18 [-]: GETTABLE  R8 R8 K5     ; R8 := R8[0xa5c556b9]
 19 [-]: MOVE      R9 R3        ; R9 := R3
 ...
 57 [-]: GETTABLE  R9 R9 K18    ; R9 := R9[0x6ef45ebc]
...
130 [-]: GETTABLE  R17 R17 K32  ; R17 := R17[0x23d5322f]
...
202 [-]: GETTABLE  R22 R22 K32  ; R22 := R22[0x23d5322f]
203 [-]: MOVE      R23 R12      ; R23 := R12
204 [-]: GETUPVAL  R24 U1       ; R24 := U1
205 [-]: GETTABLE  R24 R24 K18  ; R24 := R24[0x6ef45ebc]
...
219 [-]: LOADKB    R32 0 0      ; R32 := false
220 [-]: LOADKB    R33 0 0      ; R33 := false
...
238 [-]: LOADKB    R36 0 0      ; R36 := false
239 [-]: LOADKB    R37 0 0      ; R37 := false
...
354 [-]: LOADKB    R42 0 0      ; R42 := false
355 [-]: LOADKB    R43 1 0      ; R43 := true
...
; Max Stack Size:  5
  ...
  5 [-]: GETTABLE  R2 R2 K2     ; R2 := R2[0x23d5322f]
  6 [-]: MOVE      R3 R0        ; R3 := R0
