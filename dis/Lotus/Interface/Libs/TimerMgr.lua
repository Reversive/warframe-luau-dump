...
; Max Stack Size:  2
  ...
  6 [-]: SETTABLE  R0 K2 K3     ; R0["mMaxIndex"] := 0.000000
...
; Max Stack Size:  16
  ...
  8 [-]: JMP       48           ; PC := 48
  9 [-]: GETTABLE  R9 R8 K3     ; R9 := R8["Delta"]
 10 [-]: ADD       R9 R9 R1     ; R9 := R9 + R1
 11 [-]: SETTABLE  R8 K3 R9     ; R8["Delta"] := R9
 12 [-]: GETTABLE  R9 R8 K3     ; R9 := R8["Delta"]
 13 [-]: GETTABLE  R10 R8 K4    ; R10 := R8["Duration"]
 14 [-]: LE        0 R10 R9     ; if R10 > R9 then PC := 48
 15 [-]: JMP       48           ; PC := 48
 16 [-]: GETGLOBAL R9 K5        ; R9 := 0x7b998233
 17 [-]: GETTABLE  R10 R8 K6    ; R10 := R8["Callback"]
 18 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 19 [-]: TEST      R9 1         ; if R9 then PC := 34
 20 [-]: JMP       34           ; PC := 34
 21 [-]: EQ        0 R2 K2      ; if R2 ~= nil then PC := 25
 22 [-]: JMP       25           ; PC := 25
 ...
 34 [-]: GETTABLE  R9 R8 K12    ; R9 := R8["Loop"]
 35 [-]: TEST      R9 0         ; if not R9 then PC := 42
 36 [-]: JMP       42           ; PC := 42
 37 [-]: GETTABLE  R9 R8 K3     ; R9 := R8["Delta"]
 38 [-]: GETTABLE  R10 R8 K4    ; R10 := R8["Duration"]
 ...
 47 [-]: SETTABLE  R3 R7 K2     ; R3[R7] := nil
...
; Max Stack Size:  7
  ...
  2 [-]: JMP       8            ; PC := 8
  3 [-]: LT        1 R1 K1      ; if R1 < 1.000000 then PC := 8
  4 [-]: JMP       8            ; PC := 8
...
; Max Stack Size:  13
  ...
  3 [-]: LEN       R8 R6        ; R8 := # R6
  4 [-]: LT        0 K2 R8      ; if 0.000000 >= R8 then PC := 27
  5 [-]: JMP       27           ; PC := 27
  6 [-]: LEN       R8 R6        ; R8 := # R6
 ...
 14 [-]: SETTABLE  R8 K6 K2     ; R8["Delta"] := 0.000000
...
; Max Stack Size:  9
  ...
  2 [-]: GETGLOBAL R3 K1        ; R3 := 0xcfc01047
  3 [-]: MOVE      R4 R2        ; R4 := R2
