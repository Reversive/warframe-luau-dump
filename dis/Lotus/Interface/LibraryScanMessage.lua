...
; Max Stack Size:  22
 ...
 83 [-]: CONST     R16 11       ; R16 := 11.000000
 84 [-]: LE        1 R8 R1      ; if R8 <= R1 then PC := 87
 85 [-]: JMP       87           ; PC := 87
 86 [-]: LOADKB    R17 0 1      ; R17 := false; PC := 87
