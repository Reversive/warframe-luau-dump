...
; Max Stack Size:  22
 ...
 82 [-]: SETGLOBAL R21 K33      ; Initialize := R21
 83 [-]: CLOSURE   R21 6        ; R21 := closure(Function #7)
 84 [-]: MOVE      R0 R11       ; R0 := R11
 85 [-]: MOVE      R0 R12       ; R0 := R12
 86 [-]: MOVE      R0 R13       ; R0 := R13
 87 [-]: MOVE      R0 R15       ; R0 := R15
 88 [-]: MOVE      R0 R8        ; R0 := R8
 89 [-]: SETGLOBAL R21 K34      ; Update := R21
 90 [-]: CLOSURE   R21 7        ; R21 := closure(Function #8)
 91 [-]: MOVE      R0 R14       ; R0 := R14
 92 [-]: MOVE      R0 R13       ; R0 := R13
 93 [-]: SETGLOBAL R21 K35      ; Shutdown := R21
 94 [-]: CLOSURE   R21 8        ; R21 := closure(Function #9)
 95 [-]: MOVE      R0 R15       ; R0 := R15
 96 [-]: SETGLOBAL R21 K36      ; ElementSelected := R21
 97 [-]: CLOSURE   R21 9        ; R21 := closure(Function #10)
 98 [-]: MOVE      R0 R15       ; R0 := R15
 99 [-]: SETGLOBAL R21 K37      ; ElementFocused := R21
100 [-]: CLOSURE   R21 10       ; R21 := closure(Function #11)
101 [-]: MOVE      R0 R15       ; R0 := R15
102 [-]: SETGLOBAL R21 K38      ; ElementUnfocused := R21
103 [-]: CLOSURE   R21 11       ; R21 := closure(Function #12)
104 [-]: MOVE      R0 R15       ; R0 := R15
105 [-]: SETGLOBAL R21 K39      ; onKeyDown_MENU_MOUSE_Z := R21
106 [-]: CLOSURE   R21 12       ; R21 := closure(Function #13)
107 [-]: MOVE      R0 R17       ; R0 := R17
108 [-]: SETGLOBAL R21 K40      ; onViewportSizeChanged := R21
109 [-]: CLOSURE   R21 13       ; R21 := closure(Function #14)
110 [-]: SETGLOBAL R21 K41      ; SupportsThemes := R21
...
; Max Stack Size:  6
 ...
 29 [-]: CLOSURE   R2 0         ; R2 := closure(Function #4.1)
 ...
 51 [-]: CLOSURE   R2 3         ; R2 := closure(Function #4.4)
 ...
 58 [-]: CLOSURE   R2 4         ; R2 := closure(Function #4.5)
 59 [-]: GETUPVAL  R0 U8        ; R0 := U8
 60 [-]: SETTABLE  R1 K20 R2    ; R1["mOnSelectedCallback"] := R2
...
141 [-]: JMP       143          ; PC := 143
142 [-]: LOADKB    R15 0 1      ; R15 := false; PC := 143
...
161 [-]: JMP       163          ; PC := 163
162 [-]: LOADKB    R18 0 1      ; R18 := false; PC := 163
...
244 [-]: JMP       246          ; PC := 246
245 [-]: LOADKB    R24 0 1      ; R24 := false; PC := 246
246 [-]: LOADKB    R24 1 0      ; R24 := true
...
265 [-]: JMP       267          ; PC := 267
266 [-]: LOADKB    R28 0 1      ; R28 := false; PC := 267
267 [-]: LOADKB    R28 1 0      ; R28 := true
...
323 [-]: JMP       325          ; PC := 325
324 [-]: LOADKB    R32 0 1      ; R32 := false; PC := 325
325 [-]: LOADKB    R32 1 0      ; R32 := true
...
338 [-]: JMP       340          ; PC := 340
339 [-]: LOADKB    R33 0 1      ; R33 := false; PC := 340
340 [-]: LOADKB    R33 1 0      ; R33 := true
...
356 [-]: JMP       358          ; PC := 358
357 [-]: LOADKB    R33 0 1      ; R33 := false; PC := 358
358 [-]: LOADKB    R33 1 0      ; R33 := true
...
373 [-]: JMP       375          ; PC := 375
374 [-]: LOADKB    R32 0 1      ; R32 := false; PC := 375
...
; Max Stack Size:  4
  ...
  2 [-]: GETTABLE  R1 R1 K0     ; R1 := R1[0x06c0f069]
  3 [-]: GETTABLE  R2 R0 K1     ; R2 := R0["State"]
  4 [-]: GETGLOBAL R3 K2        ; R3 := 0xdf1cdd7a
