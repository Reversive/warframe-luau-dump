...
; Max Stack Size:  10
  ...
  4 [-]: GETTABLE  R3 R3 K1     ; R82 := R3[0xa5c556b9]
  5 [-]: MOVE      R4 R0        ; R4 := R0
  6 [-]: LOADK     R5 K2        ; R5 := "/"
 ...
 11 [-]: GETTABLE  R4 R4 K1     ; R82 := R4[0xa5c556b9]
 12 [-]: MOVE      R5 R0        ; R5 := R0
 13 [-]: LOADK     R6 K2        ; R6 := "/"
 ...
 20 [-]: GETTABLE  R6 R6 K6     ; R82 := R6[0x1a94c9cc]
 21 [-]: MOVE      R7 R0        ; R7 := R0
 ...
 29 [-]: GETTABLE  R6 R6 K6     ; R82 := R6[0x1a94c9cc]
 30 [-]: MOVE      R7 R0        ; R7 := R0
...
128 [-]: CONST     R19 30       ; R19 := 30.000000
...
134 [-]: CONST     R18 36       ; R18 := 36.000000
...
142 [-]: CONST     R18 36       ; R18 := 36.000000
...
150 [-]: CONST     R18 36       ; R18 := 36.000000
...
166 [-]: CONST     R18 10       ; R18 := 10.000000
167 [-]: CONST     R19 20       ; R19 := 20.000000
...
; Max Stack Size:  36
 ...
 72 [-]: OP_LOADBOOL R8 0 0       ; R8 := false
 ...
 79 [-]: CONST     R9 29        ; R9 := 29.000000
 80 [-]: GETGLOBAL R10 K26      ; R10 := 0x7f5022cf
 81 [-]: GETTABLE  R10 R10 K27  ; R82 := R10[0x3f3e4d12]
 82 [-]: MOVE      R11 R4       ; R11 := R4
 83 [-]: CALL      R10 2 0      ; R10,... := R10(R11)
 84 [-]: CALL      R5 0 1       ; R5(R6,...)
 85 [-]: GETUPVAL  R5 U1        ; R5 := U1
 86 [-]: GETTABLE  R5 R5 K28    ; R82 := R5[0x056dcf06]
 87 [-]: MOVE      R6 R2        ; R6 := R2
 88 [-]: OP_LOADBOOL R7 0 0       ; R7 := false
...
159 [-]: GETTABLE  R17 R17 K46  ; R82 := R17[0x06d055f9]
160 [-]: EQ        1 R11 R14    ; if R11 == R14 then PC := 163
161 [-]: JMP       163          ; PC := 163
162 [-]: OP_LOADBOOL R18 0 1      ; R18 := false; PC := 163
163 [-]: OP_LOADBOOL R18 1 0      ; R18 := true
...
175 [-]: OP_LOADBOOL R20 0 0      ; R20 := false
...
184 [-]: OP_LOADBOOL R21 0 0      ; R21 := false
...
208 [-]: CONST     R23 34       ; R23 := 34.000000
...
214 [-]: CONST     R24 34       ; R24 := 34.000000
...
220 [-]: CONST     R25 34       ; R25 := 34.000000
...
234 [-]: OP_LOADBOOL R23 1 0      ; R23 := true
...
244 [-]: JMP       246          ; PC := 246
245 [-]: OP_LOADBOOL R24 0 1      ; R24 := false; PC := 246
246 [-]: OP_LOADBOOL R24 1 0      ; R24 := true
247 [-]: GETUPVAL  R25 U4       ; R25 := U4
248 [-]: GETTABLE  R25 R25 K46  ; R82 := R25[0x06d055f9]
249 [-]: MOVE      R26 R24      ; R26 := R24
250 [-]: CONST     R27 32       ; R27 := 32.000000
251 [-]: CONST     R28 50       ; R28 := 50.000000
...
260 [-]: GETTABLE  R27 R27 K46  ; R82 := R27[0x06d055f9]
...
265 [-]: JMP       267          ; PC := 267
266 [-]: OP_LOADBOOL R28 0 1      ; R28 := false; PC := 267
267 [-]: OP_LOADBOOL R28 1 0      ; R28 := true
...
290 [-]: CONST     R31 11       ; R31 := 11.000000
...
297 [-]: CONST     R31 12       ; R31 := 12.000000
...
304 [-]: CONST     R31 13       ; R31 := 13.000000
...
311 [-]: CONST     R31 11       ; R31 := 11.000000
...
318 [-]: CONST     R31 11       ; R31 := 11.000000
...
323 [-]: JMP       325          ; PC := 325
324 [-]: OP_LOADBOOL R32 0 1      ; R32 := false; PC := 325
325 [-]: OP_LOADBOOL R32 1 0      ; R32 := true
...
331 [-]: CONST     R31 12       ; R31 := 12.000000
332 [-]: GETUPVAL  R32 U4       ; R32 := U4
333 [-]: GETTABLE  R32 R32 K46  ; R82 := R32[0x06d055f9]
...
338 [-]: JMP       340          ; PC := 340
339 [-]: OP_LOADBOOL R33 0 1      ; R33 := false; PC := 340
340 [-]: OP_LOADBOOL R33 1 0      ; R33 := true
341 [-]: CONST     R34 17       ; R34 := 17.000000
342 [-]: CONST     R35 7        ; R35 := 7.000000
...
349 [-]: CONST     R31 10       ; R31 := 10.000000
350 [-]: GETUPVAL  R32 U4       ; R32 := U4
351 [-]: GETTABLE  R32 R32 K46  ; R82 := R32[0x06d055f9]
...
356 [-]: JMP       358          ; PC := 358
357 [-]: OP_LOADBOOL R33 0 1      ; R33 := false; PC := 358
358 [-]: OP_LOADBOOL R33 1 0      ; R33 := true
359 [-]: CONST     R34 100      ; R34 := 100.000000
360 [-]: CONST     R35 20       ; R35 := 20.000000
...
366 [-]: CONST     R30 10       ; R30 := 10.000000
367 [-]: GETUPVAL  R31 U4       ; R31 := U4
368 [-]: GETTABLE  R31 R31 K46  ; R82 := R31[0x06d055f9]
...
373 [-]: JMP       375          ; PC := 375
374 [-]: OP_LOADBOOL R32 0 1      ; R32 := false; PC := 375
375 [-]: OP_LOADBOOL R32 1 0      ; R32 := true
376 [-]: CONST     R33 40       ; R33 := 40.000000
377 [-]: CONST     R34 100      ; R34 := 100.000000
...
; Max Stack Size:  8
 ...
 13 [-]: GETTABLE  R1 R1 K3     ; R82 := R1[0x5e35d4d6]
 ...
 26 [-]: GETTABLE  R4 R4 K8     ; R82 := R4[0xdebdf69b]
 27 [-]: MOVE      R5 R1        ; R5 := R1
 ...
 34 [-]: GETTABLE  R5 R5 K10    ; R82 := R5[0xf616a184]
 ...
 40 [-]: GETTABLE  R5 R5 K13    ; R82 := R5[0xe0cba3ca]
...
; Max Stack Size:  22
 ...
 16 [-]: GETTABLE  R8 R8 K6     ; R82 := R8[0x397b920f]
 ...
 47 [-]: GETTABLE  R16 R16 K15  ; R82 := R16[0x23d5322f]
 ...
 56 [-]: GETTABLE  R17 R17 K6   ; R82 := R17[0x397b920f]
 ...
 62 [-]: GETTABLE  R17 R17 K6   ; R82 := R17[0x397b920f]
 ...
 87 [-]: OP_LOADBOOL R20 1 0      ; R20 := true
 ...
 97 [-]: OP_LOADBOOL R20 1 0      ; R20 := true
...
110 [-]: GETTABLE  R18 R18 K33  ; R82 := R18[0x42645da3]
...
118 [-]: OP_LOADBOOL R20 1 0      ; R20 := true
119 [-]: OP_LOADBOOL R21 1 0      ; R21 := true
...
; Max Stack Size:  5
 ...
 29 [-]: GETTABLE  R1 R1 K7     ; R82 := R1[0x8bcd12b6]
 ...
 43 [-]: GETTABLE  R1 R1 K7     ; R82 := R1[0x8bcd12b6]
 ...
 53 [-]: GETTABLE  R0 R0 K12    ; R82 := R0[0xb6ba7af3]
 ...
 63 [-]: GETTABLE  R0 R0 K15    ; R82 := R0[0xa460d8df]
 64 [-]: CONST     R1 0         ; R1 := 0.250000
 65 [-]: CALL      R0 2 1       ; R0(R1)
 66 [-]: GETUPVAL  R0 U5        ; R0 := U5
 67 [-]: GETTABLE  R0 R0 K16    ; R82 := R0[0xb73d420f]
 ...
 79 [-]: OP_LOADBOOL R3 0 0       ; R3 := false
 80 [-]: CALL      R0 4 2       ; R0 := R0(R1,R2,R3)
 81 [-]: GETGLOBAL R1 K10       ; R1 := _T
 82 [-]: GETTABLE  R1 R1 K21    ; R82 := R1[0xdf29a9d6]
 83 [-]: MOVE      R2 R0        ; R2 := R0
...
; Max Stack Size:  20
 ...
 53 [-]: GETTABLE  R3 R3 K14    ; R82 := R3[0x23d5322f]
 54 [-]: MOVE      R4 R0        ; R4 := R0
 ...
 63 [-]: GETTABLE  R4 R4 K18    ; R82 := R4[0x42645da3]
 64 [-]: MOVE      R5 R0        ; R5 := R0
...
112 [-]: OP_LOADBOOL R5 0 0       ; R5 := false
...
204 [-]: GETTABLE  R8 R8 K49    ; R82 := R8[0x6d147816]
205 [-]: CALL      R8 1 1       ; R8()
...
218 [-]: GETTABLE  R9 R9 K53    ; R82 := R9[0x3eda26fc]
...
225 [-]: GETTABLE  R10 R10 K55  ; R82 := R10[0x00fa6bf1]
...
247 [-]: CONST     R17 90       ; R17 := 90.000000
...
; Max Stack Size:  5
 ...
 15 [-]: GETTABLE  R0 R0 K4     ; R82 := R0[0xa460d8df]
 ...
 32 [-]: GETTABLE  R0 R0 K9     ; R82 := R0[0x6d147816]
 33 [-]: CALL      R0 1 1       ; R0()
 34 [-]: GETUPVAL  R0 U1        ; R0 := U1
 ...
 64 [-]: GETTABLE  R0 R0 K20    ; R82 := R0[0xdf29a9d6]
 65 [-]: CALL      R0 1 1       ; R0()
