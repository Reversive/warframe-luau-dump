...
; Max Stack Size:  9
      ...
      42 [-]: SETUPVAL R1 0
      43 [-]: RETURN R0 0  
L 0:  44 [-]: GETIMPORT R1 2 [0x38F10E85]
...
L14:  93 [-]: JUMPIFNOT R1 L20
      94 [-]: GETIMPORT R3 11 [0xBE190284]
      95 [-]: FASTCALL1 62 R3 L15
      96 [-]: GETIMPORT R2 3 [0x7B998233]
      97 [-]: CALL R2 1 1  
L15:  98 [-]: NOT R1 R2    
      99 [-]: JUMPIFNOT R1 L16
     100 [-]: GETIMPORT R1 11 [0xBE190284]
...
L17: 113 [-]: GETIMPORT R3 11 [0xBE190284]
     114 [-]: FASTCALL1 62 R3 L18
     115 [-]: GETIMPORT R2 3 [0x7B998233]
     116 [-]: CALL R2 1 1  
L18: 117 [-]: NOT R1 R2    
     118 [-]: JUMPIFNOT R1 L19
     119 [-]: GETIMPORT R1 11 [0xBE190284]
...
; Max Stack Size:  10
       ...
       9 [-]: LOADK R3 K7 ["off"]
      10 [-]: CALL R0 3 0  
      11 [-]: GETIMPORT R0 10 ["HUD_GetAnchorMgr"]
      12 [-]: CALL R0 0 1  
      ...
      30 [-]: CALL R1 5 0  
      31 [-]: GETIMPORT R1 20 ["HUD_AddMotionClip"]
...
L 0: 120 [-]: JUMPIF R1 L3 
     ...
     125 [-]: MOVE R3 R1   
     126 [-]: GETIMPORT R2 56 [0x7B998233]
     127 [-]: CALL R2 1 1  
