...
L 8:  57 [-]: JUMPIFNOT R1 L14
      58 [-]: GETIMPORT R1 13 ["khoraKavat"]
      59 [-]: JUMPXEQKNIL R1 L14
      60 [-]: GETIMPORT R1 15 [0x4EC73E73]
      61 [-]: GETIMPORT R2 13 ["khoraKavat"]
      62 [-]: CALL R1 1 1  
      63 [-]: JUMPXEQKNIL R1 L14
      64 [-]: GETIMPORT R1 17 [0x89326C93]
...
L 9:  71 [-]: JUMPIF R2 L16
      ...
      73 [-]: CALL R2 1 1  
      74 [-]: GETIMPORT R4 13 ["khoraKavat"]
      75 [-]: GETTABLE R3 R4 R2
      76 [-]: JUMPXEQKNIL R3 L16
      77 [-]: GETIMPORT R6 13 ["khoraKavat"]
...
L10:  83 [-]: JUMPIF R3 L16
      ...
      92 [-]: GETIMPORT R3 3 [0x7B998233]
      93 [-]: CALL R3 1 1  
L11:  94 [-]: JUMPIFNOT R3 L13
      95 [-]: LOADN R3 3   
      96 [-]: GETIMPORT R4 17 [0x89326C93]
      97 [-]: NAMECALL R4 R4 K21 [0x18D05D30]
      98 [-]: CALL R4 1 1  
      99 [-]: JUMPIF R4 L12
     100 [-]: LOADN R3 4   
L12: 101 [-]: GETIMPORT R4 17 [0x89326C93]
     102 [-]: GETUPVAL R6 8
     103 [-]: LOADNIL R7   
     104 [-]: MOVE R8 R3   
...
L13: 108 [-]: GETUPVAL R3 7
     ...
     126 [-]: CALL R3 1 0  
     127 [-]: GETIMPORT R3 31 [0x25312C9B]
...
L14: 147 [-]: GETUPVAL R1 6
     ...
     151 [-]: GETIMPORT R1 3 [0x7B998233]
     152 [-]: CALL R1 1 1  
L15: 153 [-]: JUMPIFNOT R1 L16
     154 [-]: LOADB R1 0   
     155 [-]: SETUPVAL R1 6
     156 [-]: GETIMPORT R1 31 [0x25312C9B]
     157 [-]: GETIMPORT R2 1 [0xAE91E43B]
...
L25: 223 [-]: JUMPIF R1 L26
     224 [-]: GETIMPORT R1 1 [0xAE91E43B]
     225 [-]: NAMECALL R1 R1 K42 [0xD4CC05B4]
     226 [-]: CALL R1 1 1  
     227 [-]: JUMPIFNOT R1 L26
     228 [-]: GETIMPORT R1 1 [0xAE91E43B]
     229 [-]: LOADB R3 0   
     230 [-]: NAMECALL R1 R1 K43 [0x368AD758]
     231 [-]: CALL R1 2 0  
     232 [-]: JUMP L30
    
L26: 233 [-]: GETIMPORT R2 8 [0xBE190284]
...
; Max Stack Size:  15
      ...
      69 [-]: GETIMPORT R2 24 [0x0469F296]
      70 [-]: LOADK R3 K28 ["/Lotus/Language/Suits/KhoraKavatMode2"]
      71 [-]: CALL R2 1 1  
      72 [-]: SETTABLEKS R2 R1 K26 ["Name"]
      73 [-]: GETIMPORT R2 30 ["HUD_GetAnchorMgr"]
      74 [-]: FASTCALL1 62 R2 L0
      75 [-]: GETIMPORT R1 32 [0x7B998233]
      76 [-]: CALL R1 1 1  
L 0:  77 [-]: JUMPIF R1 L1 
      78 [-]: GETIMPORT R1 30 ["HUD_GetAnchorMgr"]
      79 [-]: CALL R1 0 1  
      80 [-]: JUMPIFNOT R1 L1
      ...
      85 [-]: SETUPVAL R2 3
L 1:  86 [-]: GETIMPORT R1 36 [0x89326C93]
      87 [-]: NAMECALL R1 R1 K37 [0x78298275]
      88 [-]: CALL R1 1 1  
      89 [-]: SETUPVAL R1 4
      90 [-]: GETIMPORT R1 39 ["KHORA_CurrentMode"]
      91 [-]: JUMPXEQKNIL R1 L3
      92 [-]: GETUPVAL R2 4
      93 [-]: FASTCALL1 62 R2 L2
      94 [-]: GETIMPORT R1 32 [0x7B998233]
      95 [-]: CALL R1 1 1  
L 2:  96 [-]: JUMPIF R1 L3 
      97 [-]: GETUPVAL R1 4
      98 [-]: NAMECALL R1 R1 K40 [0x388577D5]
      99 [-]: CALL R1 1 1  
     100 [-]: GETIMPORT R3 39 ["KHORA_CurrentMode"]
     101 [-]: GETTABLE R2 R3 R1
     102 [-]: JUMPXEQKNIL R2 L3
     103 [-]: GETIMPORT R2 41 ["KHORA_SetActiveMode"]
     104 [-]: GETIMPORT R6 39 ["KHORA_CurrentMode"]
...
L 3: 111 [-]: GETUPVAL R2 4
     ...
     113 [-]: GETIMPORT R1 32 [0x7B998233]
     114 [-]: CALL R1 1 1  
L 4: 115 [-]: JUMPIF R1 L12
     ...
     120 [-]: MOVE R3 R1   
     121 [-]: GETIMPORT R2 32 [0x7B998233]
     122 [-]: CALL R2 1 1  
...
L 6: 127 [-]: GETUPVAL R2 4
     ...
     131 [-]: MOVE R4 R2   
     132 [-]: GETIMPORT R3 32 [0x7B998233]
     133 [-]: CALL R3 1 1  
L 7: 134 [-]: JUMPIF R3 L12
     ...
     138 [-]: MOVE R5 R3   
     139 [-]: GETIMPORT R4 32 [0x7B998233]
     140 [-]: CALL R4 1 1  
L 8: 141 [-]: JUMPIF R4 L12
     142 [-]: GETIMPORT R6 48 [0x7ED0A956]
     ...
     148 [-]: MOVE R6 R4   
     149 [-]: GETIMPORT R5 32 [0x7B998233]
     150 [-]: CALL R5 1 1  
L 9: 151 [-]: JUMPIFNOT R5 L12
     152 [-]: GETIMPORT R5 52 [0xC8802016]
     153 [-]: NEWTABLE R6 0 5
...
L10: 162 [-]: GETIMPORT R10 1 [0xAE91E43B]
