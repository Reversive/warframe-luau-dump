...
L 5:  38 [-]: JUMPIF R1 L21
      39 [-]: GETIMPORT R1 13 ["wispReservoir"]
...
L 7:  62 [-]: GETUPVAL R4 2
      ...
      67 [-]: CALL R5 1 1  
      68 [-]: GETIMPORT R6 21 [0xC0DA2B81]
      69 [-]: MOVE R7 R4   
      70 [-]: MOVE R8 R5   
      71 [-]: CALL R6 2 1  
      72 [-]: LOADK R7 K22 [3.4028234663852886e+38]
      73 [-]: GETIMPORT R8 24 [0xAE91E43B]
      74 [-]: MOVE R10 R5  
      ...
      79 [-]: CALL R9 1 1  
      80 [-]: GETIMPORT R11 13 ["wispReservoir"]
...
L11: 115 [-]: MOVE R13 R21 
     ...
     128 [-]: GETIMPORT R21 21 [0xC0DA2B81]
     129 [-]: MOVE R22 R4  
     130 [-]: MOVE R23 R11 
     131 [-]: CALL R21 2 1 
     132 [-]: MOVE R17 R21 
...
L13: 142 [-]: GETIMPORT R4 33 ["FocusedReservoir"]
...
L14: 148 [-]: JUMPIFNOT R4 L15
     149 [-]: GETIMPORT R4 35 [0x25312C9B]
     150 [-]: GETIMPORT R5 24 [0xAE91E43B]
...
L15: 166 [-]: GETIMPORT R4 35 [0x25312C9B]
     167 [-]: GETIMPORT R5 24 [0xAE91E43B]
...
L 9:  41 [-]: LOADNIL R0   
      42 [-]: SETUPVAL R0 1
      43 [-]: RETURN R0 0  
L10:  44 [-]: GETIMPORT R0 10 [0x67652851]
      45 [-]: CALL R0 0 1  
...
L19: 117 [-]: JUMPIFNOT R1 L27
     118 [-]: GETIMPORT R2 13 [0xBE190284]
...
L23: 140 [-]: GETIMPORT R2 13 [0xBE190284]
...
; Max Stack Size:  11
      ...
      39 [-]: GETIMPORT R3 11 [0x8F312210]
      40 [-]: NAMECALL R0 R0 K12 [0x1CB415C1]
      41 [-]: CALL R0 3 0  
      42 [-]: GETIMPORT R0 15 ["HUD_GetAnchorMgr"]
      43 [-]: CALL R0 0 1  
...
L 3: 101 [-]: JUMPIF R4 L9 
     ...
     106 [-]: MOVE R6 R4   
     107 [-]: GETIMPORT R5 33 [0x7B998233]
     108 [-]: CALL R5 1 1  
L 4: 109 [-]: JUMPIF R5 L9 
     110 [-]: GETIMPORT R7 39 [0x7ED0A956]
     ...
     116 [-]: MOVE R7 R5   
     117 [-]: GETIMPORT R6 33 [0x7B998233]
     118 [-]: CALL R6 1 1  
...
L 9: 144 [-]: GETUPVAL R3 1
     145 [-]: GETIMPORT R4 46 [0x2C6B44F7]
...
L11: 152 [-]: SETTABLEKS R4 R3 K48 ["MAX_ABILITIES"]
     ...
     184 [-]: GETIMPORT R4 60 [0x0469F296]
     ...
     191 [-]: GETIMPORT R4 60 [0x0469F296]
     ...
     198 [-]: GETIMPORT R4 60 [0x0469F296]
     ...
     206 [-]: GETIMPORT R4 60 [0x0469F296]
...
L12: 213 [-]: GETIMPORT R3 68 ["wispReservoirLocal"]
     214 [-]: JUMPXEQKNIL R3 L13
     215 [-]: GETIMPORT R3 69 ["WISP_SetActiveReservoir"]
     216 [-]: GETIMPORT R6 68 ["wispReservoirLocal"]
     217 [-]: GETUPVAL R8 1
