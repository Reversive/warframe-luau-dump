...
; Max Stack Size:  27
 ...
 69 [-]: CLOSURE   R26 12       ; R26 := closure(Function #13)
 70 [-]: MOVE      R0 R4        ; R0 := R4
 71 [-]: MOVE      R0 R2        ; R0 := R2
 ...
 79 [-]: MOVE      R0 R3        ; R0 := R3
 80 [-]: SETGLOBAL R26 K7       ; Initialize := R26
 81 [-]: CLOSURE   R26 13       ; R26 := closure(Function #14)
 82 [-]: MOVE      R0 R6        ; R0 := R6
 83 [-]: MOVE      R0 R0        ; R0 := R0
 84 [-]: SETGLOBAL R26 K8       ; HandleHudScale := R26
...
; Max Stack Size:  8
  ...
  2 [-]: SELF      R0 R0 K1     ; R1 := R0; R0 := R0[0xaf9fda9f]
  3 [-]: CALL      R0 2 2       ; R0 := R0(R1)
  4 [-]: DIV       R0 K2 R0     ; R0 := 12.500000 / R0
  5 [-]: GETUPVAL  R1 U0        ; R1 := U0
  6 [-]: MUL       R1 R1 K4     ; R1 := R1 * 3.141593
  7 [-]: MUL       R1 R1 K5     ; R1 := R1 * 2.000000
  8 [-]: GETGLOBAL R2 K3        ; R2 := 0x5bced4c4
  9 [-]: GETTABLE  R2 R2 K6     ; R2 := R2[0x3eda26fc]
 10 [-]: MOVE      R3 R1        ; R3 := R1
 ...
 16 [-]: GETTABLE  R3 R3 K7     ; R3 := R3[0x00fa6bf1]
 17 [-]: MOVE      R4 R1        ; R4 := R1
 18 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 19 [-]: MUL       R3 R3 R0     ; R3 := R3 * R0
...
; Max Stack Size:  7
 ...
 12 [-]: GETTABLE  R2 R2 K3     ; R2 := R2[0x5a22d251]
 13 [-]: GETGLOBAL R3 K0        ; R3 := 0xae91e43b
 14 [-]: GETGLOBAL R4 K4        ; R4 := 0xb9d9d1a0
 15 [-]: MOVE      R5 R0        ; R5 := R0
 16 [-]: MOVE      R6 R1        ; R6 := R1
 ...
 26 [-]: SELF      R3 R3 K6     ; R4 := R3; R3 := R3[0x8feccd8b]
 27 [-]: MOVE      R5 R2        ; R5 := R2
 28 [-]: MOVE      R6 R2        ; R6 := R2
...
; Max Stack Size:  13
 ...
 24 [-]: JMP       29           ; PC := 29
 25 [-]: GETGLOBAL R1 K5        ; R1 := 0xbe190284
 26 [-]: SELF      R1 R1 K6     ; R2 := R1; R1 := R1[0x33307f92]
 ...
 33 [-]: JMP       38           ; PC := 38
 34 [-]: GETGLOBAL R1 K7        ; R1 := 0x89326c93
 35 [-]: SELF      R1 R1 K8     ; R2 := R1; R1 := R1[0xb4364067]
 36 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 37 [-]: SETUPVAL  R1 U3        ; U82 := R3
 38 [-]: GETGLOBAL R1 K0        ; R1 := 0x7b998233
 39 [-]: GETUPVAL  R2 U2        ; R2 := U2
 40 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 41 [-]: TEST      R1 1         ; if R1 then PC := 71
 42 [-]: JMP       71           ; PC := 71
 43 [-]: GETUPVAL  R1 U2        ; R1 := U2
 44 [-]: SELF      R1 R1 K9     ; R2 := R1; R1 := R1[0x91a24e4b]
 45 [-]: LOADK     R3 K10       ; R3 := "_root"
 46 [-]: CONST     R4 10        ; R4 := 10.000000
 47 [-]: CALL      R1 4 2       ; R1 := R1(R2,R3,R4)
 48 [-]: GETUPVAL  R2 U4        ; R2 := U4
 49 [-]: EQ        1 R2 R1      ; if R2 == R1 then PC := 71
 50 [-]: JMP       71           ; PC := 71
 ...
 59 [-]: EQ        0 R2 K12     ; if R2 ~= 0.000000 then PC := 71
 60 [-]: JMP       71           ; PC := 71
 ...
 67 [-]: SELF      R2 R2 K13    ; R3 := R2; R2 := R2[0xa2880940]
 68 [-]: CALL      R2 2 1       ; R2(R3)
 69 [-]: LOADNIL   R2 R2        ; R2 := nil
 70 [-]: SETUPVAL  R2 U5        ; U82 := R5
 71 [-]: GETUPVAL  R2 U6        ; R2 := U6
 72 [-]: TEST      R2 0         ; if not R2 then PC := 124
 73 [-]: JMP       124          ; PC := 124
 74 [-]: GETUPVAL  R2 U4        ; R2 := U4
 75 [-]: LT        0 K12 R2     ; if 0.000000 >= R2 then PC := 124
 76 [-]: JMP       124          ; PC := 124
 ...
 83 [-]: CALL      R2 1 1       ; R2()
 84 [-]: GETGLOBAL R2 K0        ; R2 := 0x7b998233
 85 [-]: GETUPVAL  R3 U5        ; R3 := U5
 86 [-]: CALL      R2 2 2       ; R2 := R2(R3)
 87 [-]: TEST      R2 1         ; if R2 then PC := 124
 88 [-]: JMP       124          ; PC := 124
 89 [-]: GETGLOBAL R2 K1        ; R2 := 0xae91e43b
 90 [-]: SELF      R2 R2 K9     ; R3 := R2; R2 := R2[0x91a24e4b]
 91 [-]: LOADK     R4 K14       ; R4 := "EdgeCounter"
 92 [-]: CONST     R5 0         ; R5 := 0.000000
 93 [-]: CALL      R2 4 2       ; R2 := R2(R3,R4,R5)
 94 [-]: GETGLOBAL R3 K1        ; R3 := 0xae91e43b
 95 [-]: SELF      R3 R3 K9     ; R4 := R3; R3 := R3[0x91a24e4b]
 96 [-]: LOADK     R5 K14       ; R5 := "EdgeCounter"
 97 [-]: CONST     R6 1         ; R6 := 1.000000
 98 [-]: CALL      R3 4 2       ; R3 := R3(R4,R5,R6)
 99 [-]: GETUPVAL  R4 U8        ; R4 := U8
100 [-]: GETTABLE  R4 R4 K15    ; R4 := R4[0x3e145a1a]
101 [-]: GETGLOBAL R5 K1        ; R5 := 0xae91e43b
102 [-]: MOVE      R6 R2        ; R6 := R2
103 [-]: MOVE      R7 R3        ; R7 := R3
104 [-]: GETUPVAL  R8 U3        ; R8 := U3
105 [-]: CALL      R4 5 3       ; R4,R5 := R4(R5,R6,R7,R8)
106 [-]: GETUPVAL  R6 U9        ; R6 := U9
107 [-]: MUL       R4 R4 R6     ; R4 := R4 * R6
108 [-]: GETUPVAL  R6 U9        ; R6 := U9
109 [-]: MUL       R5 R5 R6     ; R5 := R5 * R6
110 [-]: GETUPVAL  R6 U5        ; R6 := U5
111 [-]: SELF      R6 R6 K16    ; R7 := R6; R6 := R6[0xe28aa928]
112 [-]: GETGLOBAL R8 K17       ; R8 := 0xa421af95
113 [-]: MOVE      R9 R4        ; R9 := R4
114 [-]: MOVE      R10 R5       ; R10 := R5
115 [-]: CONST     R11 1        ; R11 := 1.000000
116 [-]: CALL      R8 4 2       ; R8 := R8(R9,R10,R11)
117 [-]: GETGLOBAL R9 K18       ; R9 := ZERO_ROTATION
118 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
119 [-]: GETUPVAL  R6 U5        ; R6 := U5
120 [-]: SELF      R6 R6 K19    ; R7 := R6; R6 := R6[0x119b677c]
121 [-]: GETUPVAL  R8 U10       ; R8 := U10
122 [-]: CALL      R8 1 0       ; R8,... := R8()
123 [-]: CALL      R6 0 1       ; R6(R7,...)
124 [-]: LOADKB    R6 1 0       ; R6 := true
125 [-]: SETUPVAL  R6 U11       ; U82 := R11
126 [-]: GETUPVAL  R6 U12       ; R6 := U12
127 [-]: LEN       R6 R6        ; R6 := # R6
128 [-]: LT        0 K12 R6     ; if 0.000000 >= R6 then PC := 148
129 [-]: JMP       148          ; PC := 148
130 [-]: CONST     R6 1         ; R6 := 1.000000
131 [-]: GETUPVAL  R7 U12       ; R7 := U12
132 [-]: LEN       R7 R7        ; R7 := # R7
133 [-]: CONST     R8 1         ; R8 := 1.000000
134 [-]: FORPREP   R6 145       ; R6 -= R8; PC := 145
135 [-]: GETUPVAL  R10 U12      ; R10 := U12
136 [-]: GETTABLE  R10 R10 R9   ; R10 := R10[R9]
137 [-]: GETTABLE  R10 R10 K20  ; R10 := R10[1.000000]
138 [-]: GETUPVAL  R11 U12      ; R11 := U12
139 [-]: GETTABLE  R11 R11 R9   ; R11 := R11[R9]
140 [-]: GETTABLE  R11 R11 K21  ; R11 := R11[2.000000]
141 [-]: GETUPVAL  R12 U12      ; R12 := U12
142 [-]: GETTABLE  R12 R12 R9   ; R12 := R12[R9]
143 [-]: GETTABLE  R12 R12 K22  ; R12 := R12[3.000000]
144 [-]: CALL      R10 3 1      ; R10(R11,R12)
145 [-]: FORLOOP   R6 135       ; R6 += R8; if R6 <= R7 then begin PC := 135; R9 := R6 end
146 [-]: NEWTABLE  R10 0 0      ; R10 := {}
147 [-]: SETUPVAL  R10 U12      ; U82 := R12
148 [-]: LOADKB    R10 0 0      ; R10 := false
149 [-]: SETUPVAL  R10 U11      ; U82 := R11
...
; Max Stack Size:  5
 ...
 37 [-]: SELF      R1 R1 K12    ; R2 := R1; R1 := R1[0xa2880940]
...
; Max Stack Size:  7
  ...
  7 [-]: SELF      R1 R1 K0     ; R2 := R1; R1 := R1[0xa5d5c8f6]
  8 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  9 [-]: GETGLOBAL R2 K1        ; R2 := 0xae91e43b
 10 [-]: SELF      R2 R2 K2     ; R3 := R2; R2 := R2[0x67bc869f]
 ...
 22 [-]: SELF      R2 R2 K5     ; R3 := R2; R2 := R2[0x1bff969c]
 23 [-]: LOADK     R4 K6        ; R4 := 0.350000
 24 [-]: CALL      R2 3 1       ; R2(R3,R4)
 25 [-]: GETUPVAL  R2 U4        ; R2 := U4
 26 [-]: SELF      R2 R2 K7     ; R3 := R2; R2 := R2[0xbd2e96ea]
 27 [-]: LOADK     R4 K6        ; R4 := 0.350000
...
; Max Stack Size:  5
 ...
 14 [-]: SELF      R0 R0 K6     ; R1 := R0; R0 := R0[0xa2880940]
...
; Max Stack Size:  8
 ...
 18 [-]: LOADK     R5 K9        ; R5 := "EdgeCounter.Icon"
 ...
 24 [-]: LOADK     R5 K9        ; R5 := "EdgeCounter.Icon"
...
; Max Stack Size:  11
 ...
 19 [-]: LOADK     R4 K4        ; R4 := "EdgeCounter"
 20 [-]: CONST     R5 2         ; R5 := 2.000000
 21 [-]: NEWTABLE  R6 2 0       ; R6 := {}
 22 [-]: LOADK     R7 K5        ; R7 := "_xscale"
 23 [-]: LOADK     R8 K6        ; R8 := "_yscale"
 24 [-]: SETLIST   R6 2 1       ; R6[(1-1)*FPF+i] := R(6+i), 1 <= i <= 2
 25 [-]: NEWTABLE  R7 2 0       ; R7 := {}
 26 [-]: CONST     R8 135       ; R8 := 135.000000
 27 [-]: CONST     R9 135       ; R9 := 135.000000
 28 [-]: SETLIST   R7 2 1       ; R7[(1-1)*FPF+i] := R(7+i), 1 <= i <= 2
 29 [-]: LOADK     R8 K7        ; R8 := 0.200000
 30 [-]: CONST     R9 0         ; R9 := 0.000000
 31 [-]: CLOSURE   R10 2        ; R10 := closure(Function #11.3)
...
; Max Stack Size:  6
  ...
  5 [-]: MUL       R5 R0 K3     ; R5 := R0 * 60.000000
  6 [-]: ADD       R5 K4 R5     ; R5 := 40.000000 + R5
...
; Max Stack Size:  10
  ...
  7 [-]: GETGLOBAL R1 K0        ; R1 := 0x25312c9b
...
; Max Stack Size:  9
 ...
 17 [-]: SETTABLE  R0 K5 R1     ; R0["BARUUK_SetEdgeActive"] := R1
 18 [-]: GETGLOBAL R0 K4        ; R0 := _T
 19 [-]: CLOSURE   R1 1         ; R1 := closure(Function #13.2)
 20 [-]: GETUPVAL  R0 U3        ; R0 := U3
 21 [-]: GETUPVAL  R0 U5        ; R0 := U5
 22 [-]: SETTABLE  R0 K6 R1     ; R0["BARUUK_SetEdgeProp"] := R1
 23 [-]: GETGLOBAL R0 K4        ; R0 := _T
 24 [-]: CLOSURE   R1 2         ; R1 := closure(Function #13.3)
 25 [-]: GETUPVAL  R0 U3        ; R0 := U3
 26 [-]: GETUPVAL  R0 U6        ; R0 := U6
 27 [-]: SETTABLE  R0 K7 R1     ; R0["BARUUK_NotEnoughEdge"] := R1
 28 [-]: GETGLOBAL R0 K4        ; R0 := _T
 29 [-]: GETTABLE  R0 R0 K8     ; R0 := R0[0xf6b77431]
 30 [-]: CALL      R0 1 2       ; R0 := R0()
 31 [-]: SELF      R1 R0 K9     ; R2 := R0; R1 := R0[0x20ff29f7]
 32 [-]: GETGLOBAL R3 K1        ; R3 := 0xae91e43b
 33 [-]: LOADK     R4 K10       ; R4 := "EdgeCounter"
 34 [-]: NEWTABLE  R5 2 0       ; R5 := {}
 35 [-]: GETTABLE  R6 R0 K11    ; R6 := R0["ANCHOR_V_BOTTOM"]
 36 [-]: GETTABLE  R7 R0 K12    ; R7 := R0["ANCHOR_H_RIGHT"]
 37 [-]: SETLIST   R5 2 1       ; R5[(1-1)*FPF+i] := R(5+i), 1 <= i <= 2
 38 [-]: CALL      R1 5 1       ; R1(R2,R3,R4,R5)
 39 [-]: SELF      R1 R0 K13    ; R2 := R0; R1 := R0[0xfaa69527]
 40 [-]: GETGLOBAL R3 K1        ; R3 := 0xae91e43b
 41 [-]: SELF      R3 R3 K14    ; R4 := R3; R3 := R3[0x6b837788]
 42 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 43 [-]: GETGLOBAL R4 K1        ; R4 := 0xae91e43b
 44 [-]: SELF      R4 R4 K15    ; R5 := R4; R4 := R4[0xaf9fda9f]
 45 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 46 [-]: LOADKB    R5 1 0       ; R5 := true
 47 [-]: GETTABLE  R6 R0 K16    ; R6 := R0["mHudScalePadding"]
 48 [-]: CALL      R1 6 1       ; R1(R2,R3,R4,R5,R6)
 49 [-]: GETGLOBAL R1 K4        ; R1 := _T
 50 [-]: GETTABLE  R1 R1 K17    ; R1 := R1[0x6b23d28b]
 51 [-]: GETGLOBAL R2 K1        ; R2 := 0xae91e43b
 52 [-]: LOADK     R3 K10       ; R3 := "EdgeCounter"
 53 [-]: CALL      R1 3 1       ; R1(R2,R3)
 54 [-]: GETUPVAL  R1 U7        ; R1 := U7
 55 [-]: CALL      R1 1 1       ; R1()
 56 [-]: GETGLOBAL R1 K1        ; R1 := 0xae91e43b
 57 [-]: SELF      R1 R1 K2     ; R2 := R1; R1 := R1[0x67bc869f]
 58 [-]: LOADK     R3 K18       ; R3 := "EdgeCounter.Progress"
 59 [-]: CONST     R4 9         ; R4 := 9.000000
 60 [-]: GETGLOBAL R5 K19       ; R5 := 0x0032441c
 61 [-]: GETTABLE  R5 R5 K20    ; R5 := R5["UIColor_White"]
 62 [-]: CALL      R1 5 1       ; R1(R2,R3,R4,R5)
 63 [-]: GETGLOBAL R1 K1        ; R1 := 0xae91e43b
 64 [-]: SELF      R1 R1 K21    ; R2 := R1; R1 := R1[0x1cb415c1]
 65 [-]: LOADK     R3 K22       ; R3 := "EdgeCounter.Icon"
 66 [-]: GETGLOBAL R4 K23       ; R4 := 0x606811bd
 67 [-]: CALL      R1 4 1       ; R1(R2,R3,R4)
 68 [-]: GETGLOBAL R1 K1        ; R1 := 0xae91e43b
 69 [-]: SELF      R1 R1 K24    ; R2 := R1; R1 := R1[0xd5181643]
 70 [-]: LOADK     R3 K18       ; R3 := "EdgeCounter.Progress"
 71 [-]: GETGLOBAL R4 K25       ; R4 := 0xd3aeedfc
 72 [-]: CALL      R1 4 1       ; R1(R2,R3,R4)
 73 [-]: GETGLOBAL R1 K1        ; R1 := 0xae91e43b
 74 [-]: SELF      R1 R1 K26    ; R2 := R1; R1 := R1[0x91e13703]
 75 [-]: LOADK     R3 K18       ; R3 := "EdgeCounter.Progress"
 76 [-]: LOADK     R4 K27       ; R4 := "AlphaTestThreshold"
 ...
 82 [-]: GETGLOBAL R1 K1        ; R1 := 0xae91e43b
 83 [-]: SELF      R1 R1 K28    ; R2 := R1; R1 := R1[0x20b98db3]
 84 [-]: LOADK     R3 K29       ; R3 := "EdgeCounter.Label.text"
 85 [-]: LOADK     R4 K30       ; R4 := "/Lotus/Language/Suits/PacifistPassiveMeterLabel"
 86 [-]: CALL      R1 4 1       ; R1(R2,R3,R4)
 87 [-]: CONST     R1 0         ; R1 := 0.000000
 88 [-]: CONST     R2 0         ; R2 := 0.000000
 89 [-]: GETGLOBAL R3 K31       ; R3 := 0x89326c93
 90 [-]: SELF      R3 R3 K32    ; R4 := R3; R3 := R3[0x78298275]
 91 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 92 [-]: GETGLOBAL R4 K33       ; R4 := 0x7b998233
 93 [-]: MOVE      R5 R3        ; R5 := R3
 94 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 95 [-]: TEST      R4 1         ; if R4 then PC := 118
 96 [-]: JMP       118          ; PC := 118
 97 [-]: GETGLOBAL R4 K4        ; R4 := _T
 98 [-]: GETTABLE  R4 R4 K34    ; R4 := R4["pacifistPassive"]
 99 [-]: EQ        1 R4 K35     ; if R4 == nil then PC := 111
100 [-]: JMP       111          ; PC := 111
101 [-]: SELF      R4 R3 K36    ; R5 := R3; R4 := R3[0x388577d5]
102 [-]: CALL      R4 2 2       ; R4 := R4(R5)
103 [-]: GETGLOBAL R5 K4        ; R5 := _T
104 [-]: GETTABLE  R5 R5 K34    ; R5 := R5["pacifistPassive"]
105 [-]: GETTABLE  R5 R5 R4     ; R5 := R5[R4]
106 [-]: EQ        1 R5 K35     ; if R5 == nil then PC := 111
107 [-]: JMP       111          ; PC := 111
108 [-]: GETGLOBAL R5 K4        ; R5 := _T
109 [-]: GETTABLE  R5 R5 K34    ; R5 := R5["pacifistPassive"]
110 [-]: GETTABLE  R1 R5 R4     ; R1 := R5[R4]
111 [-]: GETGLOBAL R5 K4        ; R5 := _T
112 [-]: GETTABLE  R5 R5 K37    ; R5 := R5["PACIFIST_MaxEdge"]
113 [-]: EQ        1 R5 K35     ; if R5 == nil then PC := 118
114 [-]: JMP       118          ; PC := 118
115 [-]: GETGLOBAL R5 K4        ; R5 := _T
116 [-]: GETTABLE  R5 R5 K37    ; R5 := R5["PACIFIST_MaxEdge"]
117 [-]: DIV       R2 R1 R5     ; R2 := R1 / R5
118 [-]: GETGLOBAL R5 K33       ; R5 := 0x7b998233
119 [-]: GETUPVAL  R6 U8        ; R6 := U8
120 [-]: CALL      R5 2 2       ; R5 := R5(R6)
121 [-]: TEST      R5 1         ; if R5 then PC := 141
122 [-]: JMP       141          ; PC := 141
123 [-]: GETUPVAL  R5 U8        ; R5 := U8
124 [-]: SELF      R5 R5 K38    ; R6 := R5; R5 := R5[0x689412a5]
125 [-]: GETGLOBAL R7 K39       ; R7 := 0x7ed0a956
126 [-]: LOADK     R8 K40       ; R8 := "/Lotus/Powersuits/PowersuitAbilities/PacifistFistAbility"
127 [-]: CALL      R7 2 0       ; R7,... := R7(R8)
128 [-]: CALL      R5 0 2       ; R5 := R5(R6,...)
129 [-]: GETUPVAL  R6 U4        ; R6 := U4
130 [-]: GETGLOBAL R7 K33       ; R7 := 0x7b998233
131 [-]: MOVE      R8 R5        ; R8 := R5
132 [-]: CALL      R7 2 2       ; R7 := R7(R8)
133 [-]: TEST      R7 1         ; if R7 then PC := 138
134 [-]: JMP       138          ; PC := 138
135 [-]: SELF      R7 R5 K41    ; R8 := R5; R7 := R5[0xd8140b94]
136 [-]: CALL      R7 2 2       ; R7 := R7(R8)
137 [-]: JMP       140          ; PC := 140
138 [-]: LOADKB    R7 0 1       ; R7 := false; PC := 139
139 [-]: LOADKB    R7 1 0       ; R7 := true
140 [-]: CALL      R6 2 1       ; R6(R7)
141 [-]: GETUPVAL  R6 U5        ; R6 := U5
142 [-]: MOVE      R7 R2        ; R7 := R2
143 [-]: CALL      R6 2 1       ; R6(R7)
144 [-]: LOADKB    R6 1 0       ; R6 := true
