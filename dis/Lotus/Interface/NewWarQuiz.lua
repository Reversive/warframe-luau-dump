...
; Max Stack Size:  30
 ...
 54 [-]: CONST     R21 100      ; R21 := 100.000000
 55 [-]: LOADK     R22 K33      ; R22 := 0.050000
 56 [-]: CALL      R20 3 2      ; R20 := R20(R21,R22)
 57 [-]: GETGLOBAL R21 K34      ; R21 := 0x60130201
 58 [-]: CONST     R22 255      ; R22 := 255.000000
 59 [-]: CONST     R23 255      ; R23 := 255.000000
 60 [-]: CONST     R24 255      ; R24 := 255.000000
 61 [-]: CALL      R21 4 2      ; R21 := R21(R22,R23,R24)
 62 [-]: GETGLOBAL R22 K34      ; R22 := 0x60130201
 63 [-]: CONST     R23 88       ; R23 := 88.000000
 64 [-]: CONST     R24 159      ; R24 := 159.000000
 65 [-]: CONST     R25 219      ; R25 := 219.000000
...
; Max Stack Size:  9
 ...
 30 [-]: CONST     R4 8         ; R4 := 8.000000
 31 [-]: NEWTABLE  R5 2 0       ; R5 := {}
 32 [-]: CONST     R6 10        ; R6 := 10.000000
 33 [-]: CONST     R7 5         ; R7 := 5.000000
...
; Max Stack Size:  9
 ...
 33 [-]: CONST     R8 50        ; R8 := 50.000000
 34 [-]: SETLIST   R6 2 1       ; R6[(1-1)*FPF+i] := R(6+i), 1 <= i <= 2
 35 [-]: CONST     R7 0         ; R7 := 0.250000
 ...
 62 [-]: CONST     R7 50        ; R7 := 50.000000
 63 [-]: CONST     R8 50        ; R8 := 50.000000
...
; Max Stack Size:  8
 ...
 33 [-]: CONST     R5 5         ; R5 := 5.000000
 34 [-]: CONST     R6 50        ; R6 := 50.000000
...
; Max Stack Size:  11
 ...
 15 [-]: JMP       17           ; PC := 17
 16 [-]: LOADKB    R8 0 1       ; R8 := false; PC := 17
 17 [-]: LOADKB    R8 1 0       ; R8 := true
 18 [-]: CONST     R9 30        ; R9 := 30.000000
 19 [-]: CONST     R10 60       ; R10 := 60.000000
...
; Max Stack Size:  15
 ...
 81 [-]: SETTABLE  R7 K29 R8    ; R7["Choice"] := R8
...
124 [-]: CONST     R3 10        ; R3 := 10.000000
125 [-]: CONST     R4 0         ; R4 := 0.000000
...
163 [-]: CONST     R3 8         ; R3 := 8.000000
164 [-]: NEWTABLE  R4 1 0       ; R4 := {}
165 [-]: CONST     R5 10        ; R5 := 10.000000
166 [-]: SETLIST   R4 1 1       ; R4[(1-1)*FPF+i] := R(4+i), 1 <= i <= 1
167 [-]: NEWTABLE  R5 1 0       ; R5 := {}
168 [-]: CONST     R6 100       ; R6 := 100.000000
169 [-]: SETLIST   R5 1 1       ; R5[(1-1)*FPF+i] := R(5+i), 1 <= i <= 1
170 [-]: CONST     R6 0         ; R6 := 0.500000
171 [-]: CONST     R7 3         ; R7 := 3.250000
