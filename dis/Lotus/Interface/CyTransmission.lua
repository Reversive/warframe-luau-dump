...
; Max Stack Size:  21
       ...
       0 [-]: GETIMPORT R0 2 ["TransmissionSoundInstance"]
       1 [-]: GETIMPORT R1 4 [0xCBD666E1]
       2 [-]: GETIMPORT R2 6 [0x74B75231]
       3 [-]: CALL R1 1 0  
       4 [-]: GETIMPORT R2 8 [0x74ACBBE0]
       5 [-]: FASTCALL1 62 R2 L0
       6 [-]: GETIMPORT R1 10 [0x7B998233]
       7 [-]: CALL R1 1 1  
...
L 1:  10 [-]: LOADN R1 1   
      ...
      16 [-]: GETIMPORT R3 6 [0x74B75231]
      17 [-]: CALL R2 1 0  
L 2:  18 [-]: GETIMPORT R3 8 [0x74ACBBE0]
      19 [-]: FASTCALL1 62 R3 L3
      20 [-]: GETIMPORT R2 10 [0x7B998233]
      21 [-]: CALL R2 1 1  
L 3:  22 [-]: JUMPIFNOT R2 L4
      23 [-]: RETURN R0 0  
L 4:  24 [-]: GETIMPORT R2 8 [0x74ACBBE0]
      25 [-]: GETIMPORT R4 12 ["gDecorationType"]
      26 [-]: NAMECALL R2 R2 K13 [0xFB669000]
      27 [-]: CALL R2 2 1  
      28 [-]: GETIMPORT R3 15 [0xE15169D2]
      29 [-]: NEWTABLE R4 0 4
...
L 5:  41 [-]: FASTCALL1 62 R0 L6
      42 [-]: MOVE R7 R0   
      43 [-]: GETIMPORT R6 10 [0x7B998233]
      44 [-]: CALL R6 1 1  
L 6:  45 [-]: JUMPIF R6 L11
      46 [-]: GETIMPORT R7 8 [0x74ACBBE0]
...
L 9:  67 [-]: GETTABLE R10 R2 R9
      ...
      92 [-]: CALL R11 -1 0
      93 [-]: FORNLOOP R7 L9
L10:  94 [-]: GETIMPORT R7 4 [0xCBD666E1]
      95 [-]: LOADN R8 0   
      96 [-]: CALL R7 1 0  
      97 [-]: JUMPBACK L5  
L11:  98 [-]: FASTCALL1 62 R0 L12
      99 [-]: MOVE R7 R0   
     100 [-]: GETIMPORT R6 10 [0x7B998233]
     101 [-]: CALL R6 1 1  
L12: 102 [-]: JUMPIF R6 L17
     103 [-]: GETIMPORT R7 8 [0x74ACBBE0]
     104 [-]: FASTCALL1 62 R7 L13
     105 [-]: GETIMPORT R6 10 [0x7B998233]
     106 [-]: CALL R6 1 1  
L13: 107 [-]: JUMPIF R6 L17
     108 [-]: LOADN R6 0   
     109 [-]: JUMPIFNOTLT R6 R1 L17
     110 [-]: LOADN R7 0   
     111 [-]: GETIMPORT R9 21 [0x67652851]
     112 [-]: CALL R9 0 1  
     113 [-]: SUB R8 R1 R9 
     114 [-]: FASTCALL2 18 R7 R8 L14
     115 [-]: GETIMPORT R6 32 [0xB62ECFE0]
     116 [-]: CALL R6 2 1  
L14: 117 [-]: MOVE R1 R6   
     118 [-]: LOADN R8 1   
     119 [-]: LENGTH R6 R2 
...
L15: 122 [-]: GETTABLE R9 R2 R8
     ...
     147 [-]: CALL R10 -1 0
     148 [-]: FORNLOOP R6 L15
L16: 149 [-]: GETIMPORT R6 4 [0xCBD666E1]
     150 [-]: LOADN R7 0   
     151 [-]: CALL R6 1 0  
     152 [-]: JUMPBACK L11 
L17: 153 [-]: RETURN R0 0  
