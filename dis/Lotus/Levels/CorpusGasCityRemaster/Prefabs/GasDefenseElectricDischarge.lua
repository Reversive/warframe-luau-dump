...
; Max Stack Size:  8
       ...
       0 [-]: LOADN R0 1   
       1 [-]: GETIMPORT R2 1 [0x81DB3D24]
       2 [-]: GETTABLE R1 R2 R0
       3 [-]: GETIMPORT R2 3 [0x11A19C5E]
       4 [-]: GETIMPORT R3 5 [0xF1B9FB5A]
       5 [-]: LOADK R4 K6 ["OnActivated"]
       6 [-]: CALL R2 2 0  
L 0:   7 [-]: GETGLOBAL R2 K7 [0xE97906BD]
       8 [-]: JUMPXEQKB R2 0 L2 NOT
       9 [-]: GETIMPORT R2 9 [0x89326C93]
      10 [-]: GETIMPORT R4 11 [0xFE3DE5DE]
      11 [-]: GETIMPORT R5 13 [0x947D5A36]
      12 [-]: NAMECALL R5 R5 K14 [0xD1586535]
      13 [-]: CALL R5 1 1  
      14 [-]: GETIMPORT R6 13 [0x947D5A36]
      ...
      21 [-]: CALL R2 2 0  
      22 [-]: ADDK R0 R0 K19 [1]
      23 [-]: GETIMPORT R3 1 [0x81DB3D24]
      24 [-]: LENGTH R2 R3 
      25 [-]: JUMPIFNOTLT R2 R0 L1
      26 [-]: LOADN R0 1   
      27 [-]: LOADB R2 1   
      28 [-]: SETGLOBAL R2 K7 [0xE97906BD]
      29 [-]: GETIMPORT R2 5 [0xF1B9FB5A]
      30 [-]: LOADK R4 K20 ["Enable"]
      31 [-]: NAMECALL R2 R2 K18 [0x8EB2112D]
      32 [-]: CALL R2 2 0  
L 1:  33 [-]: GETIMPORT R2 1 [0x81DB3D24]
      34 [-]: GETTABLE R1 R2 R0
      35 [-]: GETIMPORT R2 22 [0xC163F229]
      36 [-]: GETIMPORT R3 24 [0xE33DE7A1]
      37 [-]: GETIMPORT R4 26 [0x2CD740A7]
      38 [-]: CALL R2 2 1  
      39 [-]: GETIMPORT R3 28 [0xCBD666E1]
      40 [-]: MOVE R4 R2   
      41 [-]: CALL R3 1 0  
L 2:  42 [-]: GETIMPORT R2 28 [0xCBD666E1]
      43 [-]: LOADN R3 0   
      44 [-]: CALL R2 1 0  
      45 [-]: JUMPBACK L0  
      46 [-]: RETURN R0 0  
...
L 1:  25 [-]: FORGLOOP R2 L0 2 [inext]
      ...
      27 [-]: GETIMPORT R3 18 [0x1AF37CA0]
      28 [-]: CALL R2 1 0  
      29 [-]: LOADK R4 K19 ["Hide"]
      30 [-]: NAMECALL R2 R1 K13 [0x8EB2112D]
      31 [-]: CALL R2 2 0  
      32 [-]: GETIMPORT R2 15 [0xC8802016]
      33 [-]: MOVE R3 R0   
      34 [-]: CALL R2 1 3  
...
L 3:  39 [-]: FORGLOOP R2 L2 2 [inext]
      40 [-]: GETIMPORT R2 15 [0xC8802016]
      41 [-]: GETIMPORT R3 22 [0xBE0E005E]
      42 [-]: CALL R2 1 3  
...
L 5:  47 [-]: FORGLOOP R2 L4 2 [inext]
      48 [-]: GETIMPORT R2 1 [0xCBD666E1]
      49 [-]: GETIMPORT R3 25 [0xE33DE7A1]
      50 [-]: CALL R2 1 0  
      51 [-]: LOADB R2 0   
