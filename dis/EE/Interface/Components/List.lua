...
; Max Stack Size:  5
  ...
  2 [-]: GETTABLE  R1 R1 K1     ; R82 := R1[0x06d055f9]
...
; Max Stack Size:  7
 ...
 31 [-]: GETTABLE  R4 R4 K10    ; R82 := R4[0x74a11ec6]
...
; Max Stack Size:  8
 ...
 43 [-]: GETTABLE  R5 R5 K14    ; R82 := R5[0x74a11ec6]
...
; Max Stack Size:  17
 ...
 36 [-]: GETTABLE  R8 R8 K8     ; R82 := R8[0xb62ecfe0]
 ...
 46 [-]: GETTABLE  R8 R8 K15    ; R82 := R8[0x23d5322f]
...
107 [-]: OP_LOADBOOL R16 0 0      ; R16 := false
...
129 [-]: GETTABLE  R13 R13 K25  ; R82 := R13[0x9c1f3b5a]
...
; Max Stack Size:  18
 ...
 20 [-]: OP_LOADBOOL R13 1 0      ; R13 := true
 21 [-]: GETTABLE  R14 R0 K8    ; R14 := R0["mPreserveClips"]
 22 [-]: OP_LOADBOOL R15 1 0      ; R15 := true
 ...
 67 [-]: OP_LOADBOOL R17 0 0      ; R17 := false
...
; Max Stack Size:  4
  ...
  5 [-]: JMP       9            ; PC := 9
  6 [-]: GETTABLE  R2 R0 K2     ; R82 := R2[0xd838387b]
  7 [-]: MOVE      R3 R1        ; R3 := R1
  8 [-]: CALL      R2 2 1       ; R2(R3)
  9 [-]: RETURN    R0 1         ; return 
...
; Max Stack Size:  4
  ...
  4 [-]: TEST      R2 1         ; if R2 then PC := 9
  5 [-]: JMP       9            ; PC := 9
  6 [-]: GETTABLE  R2 R0 K2     ; R82 := R2[0xaf2cb9be]
  7 [-]: MOVE      R3 R1        ; R3 := R1
  8 [-]: CALL      R2 2 1       ; R2(R3)
  9 [-]: RETURN    R0 1         ; return 
...
; Max Stack Size:  10
 ...
 64 [-]: GETTABLE  R4 R4 K17    ; R82 := R4[0x38a41ce7]
 65 [-]: MOVE      R5 R3        ; R5 := R3
 66 [-]: MOVE      R6 R1        ; R6 := R1
...
; Max Stack Size:  10
 ...
 18 [-]: JMP       23           ; PC := 23
 19 [-]: GETTABLE  R3 R0 K4     ; R82 := R3[0xbd054f2d]
 20 [-]: MOVE      R4 R2        ; R4 := R2
...
; Max Stack Size:  9
 ...
 63 [-]: JMP       66           ; PC := 66
 64 [-]: GETTABLE  R5 R0 K18    ; R82 := R5[0x64fa5be5]
 65 [-]: CALL      R5 1 1       ; R5()
 ...
 81 [-]: GETTABLE  R5 R5 K23    ; R82 := R5[0x1467d5f4]
 ...
 90 [-]: JMP       92           ; PC := 92
 91 [-]: OP_LOADBOOL R5 0 1       ; R5 := false; PC := 92
 ...
 98 [-]: JMP       104          ; PC := 104
 99 [-]: GETTABLE  R6 R0 K27    ; R82 := R6[0xfea5918c]
...
108 [-]: JMP       113          ; PC := 113
109 [-]: GETTABLE  R6 R0 K29    ; R82 := R6[0x0274aa4e]
...
; Max Stack Size:  13
 ...
 50 [-]: GETTABLE  R10 R10 K13  ; R82 := R10[0xb62ecfe0]
...
; Max Stack Size:  6
 ...
 21 [-]: JMP       25           ; PC := 25
 22 [-]: GETTABLE  R3 R0 K8     ; R82 := R3[0xb15e6aca]
 23 [-]: MOVE      R4 R1        ; R4 := R1
...
; Max Stack Size:  10
 ...
 14 [-]: GETTABLE  R6 R6 K6     ; R82 := R6[0xb62ecfe0]
 15 [-]: CONST     R7 1         ; R7 := 1.000000
 16 [-]: GETGLOBAL R8 K5        ; R8 := 0x5bced4c4
 17 [-]: GETTABLE  R8 R8 K7     ; R82 := R8[0x55f27c30]
 18 [-]: MOVE      R9 R5        ; R9 := R5
 ...
 25 [-]: GETTABLE  R6 R6 K7     ; R82 := R6[0x55f27c30]
...
; Max Stack Size:  4
  ...
  3 [-]: JMP       9            ; PC := 9
  4 [-]: GETTABLE  R1 R0 K2     ; R82 := R1[0x1eed44f2]
...
; Max Stack Size:  38
 ...
 39 [-]: OP_LOADBOOL R12 1 0      ; R12 := true
 ...
 53 [-]: JMP       55           ; PC := 55
 54 [-]: OP_LOADBOOL R18 0 1      ; R18 := false; PC := 55
...
110 [-]: OP_LOADBOOL R28 1 0      ; R28 := true
...
128 [-]: OP_LOADBOOL R28 0 0      ; R28 := false
...
150 [-]: JMP       152          ; PC := 152
151 [-]: OP_LOADBOOL R12 0 1      ; R12 := false; PC := 152
152 [-]: OP_LOADBOOL R12 1 0      ; R12 := true
...
167 [-]: CONST     R27 10       ; R27 := 10.000000
168 [-]: CONST     R28 0        ; R28 := 0.000000
...
173 [-]: CONST     R27 59       ; R27 := 59.000000
...
209 [-]: JMP       214          ; PC := 214
210 [-]: GETTABLE  R25 R0 K35   ; R82 := R25[0x1eed44f2]
...
230 [-]: CONST     R28 59       ; R28 := 59.000000
231 [-]: OP_LOADBOOL R29 1 0      ; R29 := true
...
245 [-]: CONST     R28 85       ; R28 := 85.000000
...
270 [-]: CONST     R28 10       ; R28 := 10.000000
271 [-]: CONST     R29 0        ; R29 := 0.000000
...
279 [-]: GETTABLE  R25 R25 K46  ; R82 := R25[0x06d055f9]
...
306 [-]: JMP       328          ; PC := 328
307 [-]: CONST     R29 1        ; R29 := 1.000000
308 [-]: LEN       R30 R26      ; R30 := # R26
309 [-]: CONST     R31 1        ; R31 := 1.000000
...
332 [-]: OP_LOADBOOL R7 0 0       ; R7 := false
...
; Max Stack Size:  9
  ...
  5 [-]: GETTABLE  R6 R6 K3     ; R82 := R6[0xb62ecfe0]
...
; Max Stack Size:  12
 ...
 10 [-]: GETTABLE  R5 R5 K2     ; R82 := R5[0xac1b386a]
 11 [-]: MOVE      R6 R4        ; R6 := R4
...
; Max Stack Size:  12
 ...
 10 [-]: GETTABLE  R5 R5 K5     ; R82 := R5[0x74a11ec6]
 ...
 45 [-]: GETTABLE  R6 R6 K14    ; R82 := R6[0x55f27c30]
 46 [-]: MOVE      R7 R5        ; R7 := R5
 47 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 48 [-]: GETGLOBAL R7 K13       ; R7 := 0x5bced4c4
 49 [-]: GETTABLE  R7 R7 K14    ; R82 := R7[0x55f27c30]
...
; Max Stack Size:  11
 ...
 15 [-]: GETTABLE  R5 R4 K6     ; R82 := R5[0x3b3ea08c]
...
; Max Stack Size:  9
 ...
 68 [-]: OP_LOADBOOL R8 0 0       ; R8 := false
 ...
 73 [-]: GETTABLE  R4 R4 K25    ; R82 := R4[0x659d451f]
...
; Max Stack Size:  3
  ...
  2 [-]: GETTABLE  R2 R2 K1     ; R82 := R2[0xe6b41adb]
  3 [-]: CALL      R2 1 2       ; R2 := R2()
...
; Max Stack Size:  17
 ...
 76 [-]: GETTABLE  R8 R8 K25    ; R82 := R8[0xb5be5d4a]
...
130 [-]: GETTABLE  R14 R0 K32   ; R82 := R14[0xeb93bb45]
...
146 [-]: GETTABLE  R15 R0 K34   ; R82 := R15[0x15242be4]
...
; Max Stack Size:  8
  ...
  8 [-]: GETTABLE  R3 R3 K2     ; R82 := R3[0x65c1816c]
  9 [-]: MOVE      R4 R0        ; R4 := R0
...
; Max Stack Size:  21
 ...
 31 [-]: GETTABLE  R3 R3 K10    ; R82 := R3[0x06d055f9]
...
117 [-]: GETTABLE  R13 R13 K23  ; R82 := R13[0x78c740cc]
...
166 [-]: OP_LOADBOOL R15 1 0      ; R15 := true
