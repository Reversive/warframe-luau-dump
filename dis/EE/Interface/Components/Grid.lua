...
; Max Stack Size:  16
 ...
 27 [-]: GETTABLE  R8 R7 K7     ; R8 := R7[0x9383bc56]
 28 [-]: MOVE      R9 R0        ; R9 := R0
 ...
 45 [-]: SETTABLE  R8 K18 R2    ; R8["mPaginationClip"] := R2
...
100 [-]: CONST     R14 33       ; R14 := 33.000000
...
107 [-]: CONST     R14 12       ; R14 := 12.000000
...
143 [-]: CONST     R14 12       ; R14 := 12.000000
...
172 [-]: CONST     R14 33       ; R14 := 33.000000
...
179 [-]: CONST     R14 12       ; R14 := 12.000000
...
274 [-]: GETTABLE  R10 R10 K127 ; R10 := R10[0xe6b41adb]
...
; Max Stack Size:  6
  ...
  9 [-]: GETTABLE  R3 R3 K5     ; R3 := R3[0x55f27c30]
...
; Max Stack Size:  7
 ...
 11 [-]: GETTABLE  R4 R4 K5     ; R4 := R4[0x55f27c30]
 ...
 17 [-]: GETTABLE  R5 R5 K5     ; R5 := R5[0x55f27c30]
...
; Max Stack Size:  7
  ...
  8 [-]: GETTABLE  R3 R3 K3     ; R3 := R3[0x55f27c30]
...
; Max Stack Size:  6
 ...
 13 [-]: GETTABLE  R3 R3 K6     ; R3 := R3[0x74a11ec6]
 ...
 22 [-]: GETTABLE  R3 R3 K6     ; R3 := R3[0x74a11ec6]
 23 [-]: MOVE      R4 R2        ; R4 := R2
...
; Max Stack Size:  35
 ...
 15 [-]: GETTABLE  R4 R4 K7     ; R4 := R4[0x99675e23]
 ...
 80 [-]: CONST     R9 33        ; R9 := 33.000000
 81 [-]: CALL      R5 5 2       ; R5 := R5(R6,R7,R8,R9)
 82 [-]: ADD       R3 R3 R5     ; R3 := R3 + R5
 83 [-]: CONST     R5 100       ; R5 := 100.000000
 84 [-]: CONST     R6 20        ; R6 := 20.000000
 ...
 90 [-]: JMP       92           ; PC := 92
 91 [-]: LOADKB    R7 0 1       ; R7 := false; PC := 92
 92 [-]: LOADKB    R7 1 0       ; R7 := true
 93 [-]: GETTABLE  R8 R0 K2     ; R8 := R0["UTIL"]
 94 [-]: GETTABLE  R8 R8 K3     ; R8 := R8[0x06d055f9]
 95 [-]: MOVE      R9 R7        ; R9 := R7
...
103 [-]: CONST     R13 59       ; R13 := 59.000000
...
110 [-]: CONST     R13 10       ; R13 := 10.000000
...
152 [-]: GETTABLE  R15 R15 K36  ; R15 := R15[0x55f27c30]
...
163 [-]: JMP       165          ; PC := 165
164 [-]: LOADKB    R14 0 1      ; R14 := false; PC := 165
...
186 [-]: CONST     R20 29       ; R20 := 29.000000
...
192 [-]: CONST     R20 10       ; R20 := 10.000000
193 [-]: GETTABLE  R21 R0 K2    ; R21 := R0["UTIL"]
194 [-]: GETTABLE  R21 R21 K3   ; R21 := R21[0x06d055f9]
195 [-]: EQ        1 R4 R12     ; if R4 == R12 then PC := 198
196 [-]: JMP       198          ; PC := 198
197 [-]: LOADKB    R22 0 1      ; R22 := false; PC := 198
198 [-]: LOADKB    R22 1 0      ; R22 := true
199 [-]: CONST     R23 90       ; R23 := 90.000000
200 [-]: CONST     R24 100      ; R24 := 100.000000
...
207 [-]: CONST     R21 59       ; R21 := 59.000000
208 [-]: EQ        0 R4 R12     ; if R4 ~= R12 then PC := 211
209 [-]: JMP       211          ; PC := 211
210 [-]: LOADKB    R22 0 1      ; R22 := false; PC := 211
...
244 [-]: CONST     R20 33       ; R20 := 33.000000
...
258 [-]: CONST     R22 33       ; R22 := 33.000000
...
282 [-]: GETTABLE  R21 R21 K58  ; R21 := R21[0x74a11ec6]
...
287 [-]: GETTABLE  R21 R21 K58  ; R21 := R21[0x74a11ec6]
...
301 [-]: GETTABLE  R21 R21 K58  ; R21 := R21[0x74a11ec6]
...
349 [-]: JMP       351          ; PC := 351
350 [-]: LOADKB    R24 0 1      ; R24 := false; PC := 351
...
356 [-]: CONST     R29 59       ; R29 := 59.000000
...
363 [-]: CONST     R29 10       ; R29 := 10.000000
364 [-]: GETTABLE  R30 R0 K2    ; R30 := R0["UTIL"]
365 [-]: GETTABLE  R30 R30 K3   ; R30 := R30[0x06d055f9]
...
378 [-]: JMP       380          ; PC := 380
379 [-]: LOADKB    R25 0 1      ; R25 := false; PC := 380
380 [-]: LOADKB    R25 1 0      ; R25 := true
...
385 [-]: CONST     R30 59       ; R30 := 59.000000
...
392 [-]: CONST     R30 10       ; R30 := 10.000000
393 [-]: GETTABLE  R31 R0 K2    ; R31 := R0["UTIL"]
394 [-]: GETTABLE  R31 R31 K3   ; R31 := R31[0x06d055f9]
...
414 [-]: JMP       416          ; PC := 416
415 [-]: LOADKB    R7 0 1       ; R7 := false; PC := 416
416 [-]: LOADKB    R7 1 0       ; R7 := true
417 [-]: GETTABLE  R26 R0 K2    ; R26 := R0["UTIL"]
418 [-]: GETTABLE  R26 R26 K3   ; R26 := R26[0x06d055f9]
...
428 [-]: CONST     R30 59       ; R30 := 59.000000
...
435 [-]: CONST     R30 10       ; R30 := 10.000000
...
; Max Stack Size:  30
 ...
 74 [-]: GETTABLE  R8 R8 K20    ; R8 := R8[0x99675e23]
 ...
 89 [-]: GETTABLE  R10 R10 K23  ; R10 := R10[0x06d055f9]
...
109 [-]: GETTABLE  R13 R13 K4   ; R13 := R13[0x55f27c30]
...
124 [-]: GETTABLE  R14 R14 K20  ; R14 := R14[0x99675e23]
...
135 [-]: GETTABLE  R14 R14 K29  ; R14 := R14[0x38a41ce7]
...
157 [-]: GETTABLE  R14 R14 K23  ; R14 := R14[0x06d055f9]
158 [-]: GETTABLE  R15 R0 K32   ; R15 := R0["LEFT"]
159 [-]: EQ        1 R1 R15     ; if R1 == R15 then PC := 162
160 [-]: JMP       162          ; PC := 162
161 [-]: LOADKB    R15 0 1      ; R15 := false; PC := 162
...
177 [-]: GETTABLE  R17 R17 K4   ; R17 := R17[0x55f27c30]
...
185 [-]: GETTABLE  R18 R18 K20  ; R18 := R18[0x99675e23]
...
193 [-]: JMP       195          ; PC := 195
194 [-]: LOADKB    R18 0 1      ; R18 := false; PC := 195
...
200 [-]: JMP       202          ; PC := 202
201 [-]: LOADKB    R18 0 1      ; R18 := false; PC := 202
...
215 [-]: GETTABLE  R19 R19 K29  ; R19 := R19[0x38a41ce7]
216 [-]: MOVE      R20 R6       ; R20 := R6
217 [-]: MOVE      R21 R14      ; R21 := R14
218 [-]: CONST     R22 1        ; R22 := 1.000000
...
284 [-]: GETTABLE  R22 R22 K4   ; R22 := R22[0x55f27c30]
...
292 [-]: GETTABLE  R23 R23 K43  ; R23 := R23[0xb62ecfe0]
293 [-]: CONST     R24 0        ; R24 := 0.000000
294 [-]: GETTABLE  R25 R0 K22   ; R25 := R0["UTIL"]
295 [-]: GETTABLE  R25 R25 K44  ; R25 := R25[0x74a11ec6]
...
; Max Stack Size:  8
  ...
  2 [-]: GETTABLE  R2 R2 K1     ; R2 := R2[0x99675e23]
 ...
 11 [-]: GETTABLE  R3 R3 K5     ; R3 := R3[0xb62ecfe0]
...
; Max Stack Size:  10
  ...
  5 [-]: GETTABLE  R4 R4 K3     ; R4 := R4[0x99675e23]
 ...
 14 [-]: GETTABLE  R7 R7 K8     ; R7 := R7[0x74a11ec6]
 ...
 23 [-]: GETTABLE  R8 R8 K10    ; R8 := R8[0x55f27c30]
 24 [-]: MOVE      R9 R6        ; R9 := R6
...
; Max Stack Size:  16
 ...
 16 [-]: GETTABLE  R7 R7 K8     ; R7 := R7[0x74a11ec6]
 ...
 52 [-]: GETTABLE  R9 R9 K18    ; R9 := R9[0x55f27c30]
 53 [-]: MOVE      R10 R8       ; R10 := R8
 54 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 55 [-]: GETGLOBAL R10 K3       ; R10 := 0x5bced4c4
 56 [-]: GETTABLE  R10 R10 K18  ; R10 := R10[0x55f27c30]
...
; Max Stack Size:  11
 ...
 14 [-]: GETTABLE  R2 R2 K6     ; R2 := R2[0x99675e23]
...
; Max Stack Size:  7
 ...
 18 [-]: GETTABLE  R5 R5 K8     ; R5 := R5[0x99675e23]
...
; Max Stack Size:  15
 ...
 45 [-]: CONST     R9 16711680  ; R9 := 16711680.000000
 ...
 51 [-]: CONST     R8 2000      ; R8 := 2000.000000
 52 [-]: MOVE      R9 R3        ; R9 := R3
 ...
 57 [-]: CONST     R8 4000      ; R8 := 4000.000000
 58 [-]: MOVE      R9 R3        ; R9 := R3
 ...
 63 [-]: CONST     R8 2000      ; R8 := 2000.000000
 64 [-]: MOVE      R9 R4        ; R9 := R4
 ...
 69 [-]: CONST     R8 4000      ; R8 := 4000.000000
 70 [-]: MOVE      R9 R4        ; R9 := R4
...
118 [-]: CONST     R13 11       ; R13 := 11.000000
119 [-]: NOT       R14 R8       ; R14 :=  R8
...
127 [-]: CONST     R13 13       ; R13 := 13.000000
...
143 [-]: JMP       145          ; PC := 145
144 [-]: LOADKB    R14 0 1      ; R14 := false; PC := 145
